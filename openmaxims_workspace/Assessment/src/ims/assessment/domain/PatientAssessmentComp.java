...
public interface PatientAssessmentComp extends ims.domain.DomainInterface
{
	...
	*/
	public ims.assessment.vo.PatientUserDefinedObjectListVoCollection listPatientUserDefinedObjects(ims.core.admin.vo.CareContextRefVo careContextRefVo);
