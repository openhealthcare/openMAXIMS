...
import ims.assessment.domain.base.impl.BasePatientAssessmentImpl;
...
public class PatientAssessmentImpl extends BasePatientAssessmentImpl
{
	/**
	...
	*/
	...
	public PatientUserDefinedObjectListVoCollection listPatientUserDefinedObjects(PatientRefVo patient, EpisodeOfCareRefVo episodeOfCareRef, CareContextRefVo careContextRefVo)
	{
		//WDEV-11526, WDEV-11721
		if(patient == null || !patient.getID_PatientIsNotNull())
			throw new RuntimeException("Cannot list PatientUserDefinedObjectList for null Patient.");
		...
		else if(episodeOfCareRef != null && episodeOfCareRef.getID_EpisodeOfCareIsNotNull())
		{
			hql.append(" where patAss.episodeOfCare.id = :episodeOfCareId");
			params.add("episodeOfCareId");
			values.add(episodeOfCareRef.getID_EpisodeOfCare());
		}
		else
		{
			hql.append(" where patAss.patient.id = :patient");
			params.add("patient");
	...
	*/
	...
	//wdev-13604
	public PatientAssessmentListVoCollection getPatinetAssessmentListById(PatientUserDefinedObjectRefVo recordId) 
	{

		if(recordId == null)
			return null;
		PatientUserDefinedObject doPatientUserDefinedObject = (PatientUserDefinedObject)getDomainFactory().getDomainObject(PatientUserDefinedObject.class, recordId.getID_PatientUserDefinedObject());
		PatientUserDefinedObjectListVo tempVo = PatientUserDefinedObjectListVoAssembler.create(doPatientUserDefinedObject);
		if(tempVo != null)
			return tempVo.getPatientAssessments();
