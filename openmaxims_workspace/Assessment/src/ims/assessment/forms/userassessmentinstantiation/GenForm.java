...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 416, 512, 432, 64, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		ims.framework.FormUiLogic m_customControlAuthoringForm = loader.loadComponent(102228, appForm, startControlID * 10 + 1000, anchoringHelper2.getSize(), instance1, -1, skipContextValidation);
		//ims.framework.Control m_customControlAuthoringControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(416), new Integer(512), new Integer(432), new Integer(64), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, new Integer(-1), m_customControlAuthoringForm, instance1 } );
		ims.framework.Control m_customControlAuthoringControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1002),  new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, new Integer(-1), m_customControlAuthoringForm, instance1, Boolean.FALSE } );
		...
		// Label Controls
		RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 16, 552, 90, 17, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		...
		RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 16, 522, 45, 17, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1006), new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.HIDDEN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 754, 592, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		// ComboBox Controls
		RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 112, 552, 264, 21, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
		ComboBox m_cmbReasonTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 112, 520, 264, 21, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
		ComboBox m_cmbStatusTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.DISABLED, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.TRUE, new Integer(-1)});
		...
		RuntimeAnchoring anchoringHelper10 = new RuntimeAnchoring(designSize, runtimeSize, 16, 40, 816, 456, ims.framework.enumerations.ControlAnchoring.ALL);
		...
		// Link Controls
		RuntimeAnchoring anchoringHelper11 = new RuntimeAnchoring(designSize, runtimeSize, 713, 6, 92, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RuntimeAnchoring anchoringHelper12 = new RuntimeAnchoring(designSize, runtimeSize, 16, 576, 814, 8, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
	...
	{
		return (Link)super.getControl(10);
	}
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_CurrentAssessment = new ims.framework.ContextVariable("CurrentAssessment", prefix + "_lv_Assessment.UserAssessmentInstantiation.__internal_x_context__CurrentAssessment_" + componentIdentifier + "");
		}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[71] = new ims.framework.ReportField(this.context, "_cv_Assessment.PatientUserDefinedObject", "BO-1085100000-ID", "ID_PatientUserDefinedObject");
			...
			fields[73] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientAssessment.SelectedAssessment", "BO-1003100048-ID", "ID_PatientAssessment");
			fields[74] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentInstantiation.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-ID", "ID_PatientAssessment");
			fields[75] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentInstantiation.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-STATUS", "Status");
			fields[76] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentInstantiation.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-COMPLETEDDATETIME", "CompletedDateTime");
			fields[77] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentInstantiation.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-STATUSREASON", "StatusReason");
			fields[78] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentInstantiation.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-STATUSREASONTEXT", "StatusReasonText");
			fields[79] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentInstantiation.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-DPPTYPE", "DPPType");
			fields[80] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentInstantiation.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-DPPTYPETEXT", "DPPTypeText");
			fields[81] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentInstantiation.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-ISCURRENTFORTYPE", "IsCurrentForType");
			fields[82] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentInstantiation.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-CLINICALCONTACT", "ClinicalContact");
			fields[83] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentInstantiation.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-CARECONTEXT", "CareContext");
			fields[84] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentInstantiation.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-EPISODEOFCARE", "EpisodeOfCare");
			fields[85] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentInstantiation.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-PATIENT", "Patient");
			fields[86] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentInstantiation.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-SCORE", "Score");
			fields[87] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.UserAssessmentInstantiation.__internal_x_context__CurrentAssessment_" + componentIdentifier, "BO-1003100048-ISASSESSMENTDOCUMENTSAVED", "IsAssessmentDocumentSaved");
			return fields;
		}
