...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		ims.framework.utils.SizeInfo designSize = new ims.framework.utils.SizeInfo(816, 520);
		if(runtimeSize == null)
		...
		RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 0, 0, 816, 520, ims.framework.enumerations.ControlAnchoring.ALL);
		super.addControl(factory.getControl(DynamicGrid.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), new Integer(-1), ControlState.EDITABLE, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.ALL, contextMenus.contextMenuPatientAssessment, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE}));
	}
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_VoPatientAssessment = new ims.framework.ContextVariable("VoPatientAssessment", prefix + "_lv_Assessment.PatientAssessmentComp.__internal_x_context__VoPatientAssessment_" + componentIdentifier + "");
			cxl_isFormOpenedFromGraphicImage = new ims.framework.ContextVariable("isFormOpenedFromGraphicImage", prefix + "_lv_Assessment.PatientAssessmentComp.__internal_x_context__isFormOpenedFromGraphicImage_" + componentIdentifier + "");
			cxl_PatientUserDefinedObjectListVoCollection = new ims.framework.ContextVariable("PatientUserDefinedObjectListVoCollection", prefix + "_lv_Assessment.PatientAssessmentComp.__internal_x_context__PatientUserDefinedObjectListVoCollection_" + componentIdentifier + "");
		}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[76] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientAssessment.SelectedAssessment", "BO-1003100048-ID", "ID_PatientAssessment");
			fields[77] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientAssessment.EditedComponent", "BO-1028100005-ID", "ID_UserDefinedObjectComponent");
			fields[78] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientAssessmentComp.__internal_x_context__VoPatientAssessment_" + componentIdentifier, "BO-1003100048-ID", "ID_PatientAssessment");
			fields[79] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientAssessmentComp.__internal_x_context__VoPatientAssessment_" + componentIdentifier, "BO-1003100048-CLINICALCONTACT", "ClinicalContact");
			fields[80] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientAssessmentComp.__internal_x_context__VoPatientAssessment_" + componentIdentifier, "BO-1003100048-CARECONTEXT", "CareContext");
			fields[81] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientAssessmentComp.__internal_x_context__VoPatientAssessment_" + componentIdentifier, "BO-1003100048-STATUS", "Status");
			fields[82] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientAssessmentComp.__internal_x_context__VoPatientAssessment_" + componentIdentifier, "BO-1003100048-STATUSREASON", "StatusReason");
			fields[83] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientAssessmentComp.__internal_x_context__VoPatientAssessment_" + componentIdentifier, "BO-1003100048-ISCURRENTFORTYPE", "IsCurrentForType");
			fields[84] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientAssessmentComp.__internal_x_context__VoPatientAssessment_" + componentIdentifier, "BO-1003100048-DPPTYPE", "DPPType");
			fields[85] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientAssessmentComp.__internal_x_context__VoPatientAssessment_" + componentIdentifier, "BO-1003100048-COMPLETEDDATETIME", "CompletedDateTime");
			fields[86] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientAssessmentComp.__internal_x_context__VoPatientAssessment_" + componentIdentifier, "BO-1003100048-EPISODEOFCARE", "EpisodeOfCare");
			fields[87] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.PatientAssessmentComp.__internal_x_context__VoPatientAssessment_" + componentIdentifier, "BO-1003100048-PATIENT", "Patient");
			return fields;
		}
