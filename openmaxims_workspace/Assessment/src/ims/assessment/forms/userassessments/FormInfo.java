...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.UserAssessmentAction", "_cv_Core.SelectedUserAssessment", "_cv_Core.UserAssessmentFilter" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Assessment.UserAssessments.__internal_x_context__" + String.valueOf(getFormId());
	}
