...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.UserDefinedObjectShort", "_cv_Core.UserDefinedObjectSearchFilter", "_cv_Core.UserDefinedObjectSelected", "_cv_Core.UserDefinedFormMode" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Assessment.UserDefinedForm.__internal_x_context__" + String.valueOf(getFormId());
	}
