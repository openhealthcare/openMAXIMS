...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "UserAssessmentInstantiationWithComponent";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Clinical.ReturnToFormName", "_cv_Clinical.PatientAssessment.EditedComponent", "_cv_Clinical.PatientAssessment.SelectedAssessment", "_cv_Clinical.PatientAssessment.EditComponent" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Assessment.UserAssessmentInstantiationWithComponent.__internal_x_context__" + String.valueOf(getFormId());
	}
