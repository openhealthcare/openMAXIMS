...
{
	abstract protected void bindgrdUserDefinedFormColActiveLookup();
	...
	abstract protected void onGrdUserDefinedFormSelectionChanged() throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.grdUserDefinedForm().setSelectionChangedEvent(new GridSelectionChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.enumerations.MouseButton mouseButton) throws ims.framework.exceptions.PresentationLogicException
			{
				onGrdUserDefinedFormSelectionChanged();
			}
		});
	...
	{
		bindgrdUserDefinedFormColActiveLookup();
		bindcmbTypeLookup();
		bindcmbStatusLookup();
	}
