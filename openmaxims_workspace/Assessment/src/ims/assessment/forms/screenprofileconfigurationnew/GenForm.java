...
public class GenForm extends FormBridge
{
	...
	public static class grdUserDefinedFormRow extends GridRowBridge
	{
		private static final long serialVersionUID = 1L;
		
		protected grdUserDefinedFormRow(GridRow row)
		{
			super(row);
		}
		...
		public void setcolClassificationReadOnly(boolean value)
		{
			super.row.setReadOnly(0, value);
		}
		public boolean iscolClassificationReadOnly()
		{
			return super.row.isReadOnly(0);
		}
		public void showcolClassificationOpened()
		{
			super.row.showOpened(0);
		}
		public String getcolClassification()
		{
			return (String)super.row.get(0);
		}
		public void setcolClassification(String value)
		{
			super.row.set(0, value);
		}
		public void setCellcolClassificationTooltip(String value)
		{
		...
		public ims.core.vo.lookups.PreActiveActiveInactiveStatus getColActive()
		{
			return (ims.core.vo.lookups.PreActiveActiveInactiveStatus)super.row.get(2);
		}
		public void setColActive(ims.core.vo.lookups.PreActiveActiveInactiveStatus value)
		{
		...
		public ims.assessment.vo.ScreeningProfileComponentVo getValue()
		{
			return (ims.assessment.vo.ScreeningProfileComponentVo)super.row.getValue();
		}
		public void setValue(ims.assessment.vo.ScreeningProfileComponentVo value)
		{
			super.row.setValue(value);
		}
	}
	public static class grdUserDefinedFormRowCollection extends GridRowCollectionBridge
	{
		private static final long serialVersionUID = 1L;
		
		private grdUserDefinedFormRowCollection(GridRowCollection collection)
		{
			super(collection);
		}
		public grdUserDefinedFormRow get(int index)
		{
			return new grdUserDefinedFormRow(super.collection.get(index));
		}
		public grdUserDefinedFormRow newRow()
		{
			return new grdUserDefinedFormRow(super.collection.newRow());
		}
		public grdUserDefinedFormRow newRow(boolean autoSelect)
		{
			return new grdUserDefinedFormRow(super.collection.newRow(autoSelect));
		}
		public grdUserDefinedFormRow newRowAt(int index)
		{
			return new grdUserDefinedFormRow(super.collection.newRowAt(index));
		}
		public grdUserDefinedFormRow newRowAt(int index, boolean autoSelect)
		{
			return new grdUserDefinedFormRow(super.collection.newRowAt(index, autoSelect));
		}
	}
	public static class grdUserDefinedFormGrid extends GridBridge
	{
		private static final long serialVersionUID = 1L;
		...
		public ims.assessment.vo.ScreeningProfileComponentVoCollection getValues()
		{
			ims.assessment.vo.ScreeningProfileComponentVoCollection listOfValues = new ims.assessment.vo.ScreeningProfileComponentVoCollection();
		...
		public ims.assessment.vo.ScreeningProfileComponentVo getValue()
		{
			return (ims.assessment.vo.ScreeningProfileComponentVo)super.grid.getValue();
		}
		public void setValue(ims.assessment.vo.ScreeningProfileComponentVo value)
		{
			super.grid.setValue(value);
		}
		public grdUserDefinedFormRow getSelectedRow()
		{
			return super.grid.getSelectedRow() == null ? null : new grdUserDefinedFormRow(super.grid.getSelectedRow());
		}
		public int getSelectedRowIndex()
		{
			return super.grid.getSelectedRowIndex();
		}
		public grdUserDefinedFormRowCollection getRows()
		{
			return new grdUserDefinedFormRowCollection(super.grid.getRows());
		}
		public grdUserDefinedFormRow getRowByValue(ims.assessment.vo.ScreeningProfileComponentVo value)
		{
			GridRow row = super.grid.getRowByValue(value);
			return row == null?null:new grdUserDefinedFormRow(row);
		}
		public void setcolClassificationHeaderTooltip(String value)
		{
			super.grid.setColumnHeaderTooltip(0, value);
		}
		public String getcolClassificationHeaderTooltip()
		{
		...
		public GridMutableAnswerBox ColActiveAnswerBox()
		{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Panel.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,"Screening Profile Configuration", new Integer(1), ""}));

		// Label Controls
		RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 16, 82, 84, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Context Type:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 16, 50, 41, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Name:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 298, 82, 45, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// TextBox Controls
		RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 104, 48, 728, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), new Integer(startTabIndex.intValue() + 1), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.FALSE, new Integer(255), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.TRUE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));

		// ComboBox Controls
		RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 104, 80, 176, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper10 = new RuntimeAnchoring(designSize, runtimeSize, 352, 80, 216, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// Grid Controls
		RuntimeAnchoring anchoringHelper11 = new RuntimeAnchoring(designSize, runtimeSize, 16, 112, 814, 467, ims.framework.enumerations.ControlAnchoring.ALL);
		Grid m_grdUserDefinedFormTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.READONLY, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuGenericGrid, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
		addControl(m_grdUserDefinedFormTemp);
		grdUserDefinedFormGrid grdUserDefinedForm = (grdUserDefinedFormGrid)GridFlyweightFactory.getInstance().createGridBridge(grdUserDefinedFormGrid.class, m_grdUserDefinedFormTemp);
		grdUserDefinedForm.addStringColumn("Component Type", 0, 0, 250, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdUserDefinedForm.addStringColumn("Name", 0, 0, 450, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdUserDefinedForm.addAnswerBoxColumn("Status", 1, 1, -1, false, false, 10, true, true);
		super.addGrid(grdUserDefinedForm);

		// Link Controls
		RuntimeAnchoring anchoringHelper12 = new RuntimeAnchoring(designSize, runtimeSize, 707, 6, 92, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
	...
	public grdUserDefinedFormGrid grdUserDefinedForm()
	{
		return (grdUserDefinedFormGrid)super.getGrid(0);
	}
	...
	public static class Forms implements java.io.Serializable
	{
		...
		public final class AssessmentForms implements java.io.Serializable
		{
			...
			{
				UserDefinedFormSearch = new LocalFormName(102188);
				ScreeningProfileConfiguration = new LocalFormName(127119);
			}
			public final FormName UserDefinedFormSearch;
			public final FormName ScreeningProfileConfiguration;
		}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[71] = new ims.framework.ReportField(this.context, "_cv_Assessment.CurrentProfile", "BO-1083100007-ID", "ID_ScreeningProfile");
			fields[72] = new ims.framework.ReportField(this.context, "_cv_Assessment.CurrentProfile", "BO-1083100007-PROFILENAME", "ProfileName");
			fields[73] = new ims.framework.ReportField(this.context, "_cv_Assessment.CurrentProfile", "BO-1083100007-CONTEXTTYPE", "ContextType");
			fields[74] = new ims.framework.ReportField(this.context, "_cv_Assessment.CurrentProfile", "BO-1083100007-ACTIVESTATUS", "ActiveStatus");
			return fields;
		}
