...
public abstract class BaseLogic extends Handlers
{
	...
	{
		return ims.assessment.domain.UserDefinedFormNew.class;
	}
	public final void setContext(ims.framework.UIEngine engine, GenForm form, ims.assessment.domain.UserDefinedFormNew domain)
	{
	...
	{
		this.form.cmbType().setValue((ims.core.vo.lookups.UserDefinedObjectType)domain.getLookupService().getDefaultInstance(ims.core.vo.lookups.UserDefinedObjectType.class, engine.getFormName().getID(), ims.core.vo.lookups.UserDefinedObjectType.TYPE_ID));
	}
	...
	protected void populateScreenFromData(ims.assessment.vo.UserDefinedObjectVo value)
	{
		...
		this.form.cmbType().setValue(value.getObjectTypeIsNotNull() ? value.getObjectType() : null);
	...
	protected ims.assessment.vo.UserDefinedObjectVo populateDataFromScreen(ims.assessment.vo.UserDefinedObjectVo value)
	{
		...
		value.setObjectType(this.form.cmbType().getValue());
	...
	protected ims.assessment.domain.UserDefinedFormNew domain;
}
