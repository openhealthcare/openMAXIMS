...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.UserDefinedObject", "_cv_Core.UserDefinedObjectComponents" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Assessment.UserDefinedFormSearch.__internal_x_context__" + String.valueOf(getFormId());
	}
