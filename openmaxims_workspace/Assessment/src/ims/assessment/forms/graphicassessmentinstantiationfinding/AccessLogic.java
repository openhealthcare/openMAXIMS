...
public final class AccessLogic extends BaseAccessLogic implements Serializable
{
	...
	public boolean isAccessible()
	{
		...
		//WDEV-12215
		if ((form.getGlobalContext().Core.getPatientAssessmentFullIsNotNull() && form.getGlobalContext().Core.getPatientGraphicAssessmentFindingIsNotNull()) 
				|| (form.getGlobalContext().Core.getPatient_AssessmentFullIsNotNull() && form.getGlobalContext().Core.getPatient_GraphicAssessmentFindingIsNotNull()))
			return true;
