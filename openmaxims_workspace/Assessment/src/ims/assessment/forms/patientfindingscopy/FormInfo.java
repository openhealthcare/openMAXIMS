...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.PatientAssessmentFull", "_cv_Assessment.PatientGraphicAssessmentFinding", "_cv_Assessment.AutoSubmit" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Assessment.PatientFindingsCopy.__internal_x_context__" + String.valueOf(getFormId());
	}
