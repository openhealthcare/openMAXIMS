...
//#############################################################################
//#EOH
// This code was generated by Daniel Laffan using IMS Development Environment (version 1.53 build 2511.27271)
...
public final class AccessLogic extends BaseAccessLogic implements Serializable
{
	...
	public boolean isAccessible()
	{
		...
		/*
		if(engine.getFormName().equals(form.getForms().Assessment.DynamicAssessments)) //WDEV-11526
		{
		...
		*/
		...
		if(engine.getFormName().equals(form.getForms().Assessment.DynamicAssessments))
		{
