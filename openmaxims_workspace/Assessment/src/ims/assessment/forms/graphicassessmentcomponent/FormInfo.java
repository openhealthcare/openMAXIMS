...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "GraphicAssessmentComponent";
	}
	public int getWidth()
	{
		return 806;
	...
	{
		return new String[] { "_cv_Core.PatientGraphicAssessmentFinding", "_cv_Core.PatientAssessmentFull", "_cv_Assessment.AutoSubmit" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Assessment.GraphicAssessmentComponent.__internal_x_context__" + String.valueOf(getFormId());
	}
