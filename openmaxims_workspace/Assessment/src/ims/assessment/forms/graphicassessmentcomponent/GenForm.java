...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		ims.framework.utils.SizeInfo designSize = new ims.framework.utils.SizeInfo(806, 480);
		if(runtimeSize == null)
		...
		// Drawing Controls
		RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 0, 0, 806, 480, ims.framework.enumerations.ControlAnchoring.ALL);
		super.addControl(factory.getControl(DrawingControl.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), new Integer(startTabIndex.intValue() + 1), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Boolean(true)}));
	}
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_PatientAssessment = new ims.framework.ContextVariable("PatientAssessment", prefix + "_lv_Assessment.GraphicAssessmentComponent.__internal_x_context__PatientAssessment_" + componentIdentifier + "");
			cxl_CurrentPatientAssessmentData = new ims.framework.ContextVariable("CurrentPatientAssessmentData", prefix + "_lv_Assessment.GraphicAssessmentComponent.__internal_x_context__CurrentPatientAssessmentData_" + componentIdentifier + "");
		}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[90] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentComponent.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-ID", "ID_PatientAssessment");
			fields[91] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentComponent.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-STATUS", "Status");
			fields[92] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentComponent.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-COMPLETEDDATETIME", "CompletedDateTime");
			fields[93] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentComponent.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-STATUSREASON", "StatusReason");
			fields[94] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentComponent.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-STATUSREASONTEXT", "StatusReasonText");
			fields[95] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentComponent.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-DPPTYPE", "DPPType");
			fields[96] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentComponent.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-DPPTYPETEXT", "DPPTypeText");
			fields[97] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentComponent.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-ISCURRENTFORTYPE", "IsCurrentForType");
			fields[98] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentComponent.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-CLINICALCONTACT", "ClinicalContact");
			fields[99] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentComponent.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-CARECONTEXT", "CareContext");
			fields[100] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentComponent.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-EPISODEOFCARE", "EpisodeOfCare");
			fields[101] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentComponent.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-PATIENT", "Patient");
			fields[102] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentComponent.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-SCORE", "Score");
			fields[103] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentComponent.__internal_x_context__PatientAssessment_" + componentIdentifier, "BO-1003100048-ISASSESSMENTDOCUMENTSAVED", "IsAssessmentDocumentSaved");
			fields[104] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentComponent.__internal_x_context__CurrentPatientAssessmentData_" + componentIdentifier, "BO-1003100050-ID", "ID_PatientAssessmentData");
			fields[105] = new ims.framework.ReportField(this.context, prefix + "_lv_Assessment.GraphicAssessmentComponent.__internal_x_context__CurrentPatientAssessmentData_" + componentIdentifier, "BO-1003100050-GROUPQUESTIONWIDTH", "GroupQuestionWidth");
			return fields;
		}
