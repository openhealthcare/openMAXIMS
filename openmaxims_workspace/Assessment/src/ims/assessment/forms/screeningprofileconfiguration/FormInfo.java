...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "ScreeningProfileConfiguration";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Core.UserDefinedFormMode", "_cv_Assessment.CurrentProfile", "_cv_Assessment.ContextType" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Assessment.ScreeningProfileConfiguration.__internal_x_context__" + String.valueOf(getFormId());
	}
