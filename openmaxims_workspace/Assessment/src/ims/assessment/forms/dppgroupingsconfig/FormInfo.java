...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Nursing.AppRoleShortVoCollection" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Assessment.DPPGroupingsConfig.__internal_x_context__" + String.valueOf(getFormId());
	}
