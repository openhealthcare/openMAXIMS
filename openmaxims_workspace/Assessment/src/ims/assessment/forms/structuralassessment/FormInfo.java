...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Clinical.PatientAssessment.EditedComponent" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Assessment.StructuralAssessment.__internal_x_context__" + String.valueOf(getFormId());
	}
