...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void onDyngrdAnswersCellButtonClicked(ims.framework.controls.DynamicGridCell cell);
	...
	public final void setContext(ims.framework.UIComponentEngine engine, GenForm form)
	{
		...
		this.form.dyngrdAnswers().setDynamicGridCellButtonClickedEvent(new DynamicGridCellButtonClicked()
		{
			private static final long serialVersionUID = 1L;
			...
			{
				onDyngrdAnswersCellButtonClicked(cell);
			}
		});
	}
