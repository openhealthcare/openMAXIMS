...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "GraphicAssessmentInstantiationFindingCustom";
	}
	public int getWidth()
	{
		return 776;
	...
	{
		return new String[] { "_cv_Assessment.PatientGraphicalAssessmentStage", "_cv_Assessment.AutoSubmit", "_cv_Core.PatientAssessmentFull", "_cv_Core.PatientGraphicAssessmentFinding" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Assessment.GraphicAssessmentInstantiationFindingCustom.__internal_x_context__" + String.valueOf(getFormId());
	}
