...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.PatientAssessmentFull", "_cv_Core.PatientGraphicAssessmentFinding", "_cv_Core.Patient_AssessmentFull", "_cv_Core.Patient_GraphicAssessmentFinding" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Assessment.GraphicalAssessment.__internal_x_context__" + String.valueOf(getFormId());
	}
