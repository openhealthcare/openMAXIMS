...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "AssessmentsForSpecialty";
	}
	public int getWidth()
	{
		return 536;
	...
	{
		return new String[] { "_cv_Assessment.AssessmentsForSpecialtyCollection", "_cv_Core.SelectedUserAssessmentLite" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Assessment.AssessmentsForSpecialty.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Assessment/assessment_specialty_48.png";
	}
}
