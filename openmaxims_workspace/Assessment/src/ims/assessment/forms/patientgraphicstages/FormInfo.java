...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.PatientAssessmentFull", "_cv_Assessment.PatientGraphicAssessmentFinding", "_cv_Assessment.AutoSubmit", "_cv_Core.PatientGraphicAssessmentFinding", "_cv_Assessment.PatientGraphicalAssessmentStage" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Assessment.PatientGraphicStages.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Assessment/patient_graphic_stages_48.png";
	}
}
