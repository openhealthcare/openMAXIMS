...
import ims.assessment.forms.graphicassessmentsforspecialty.GenForm.grdDetailsRow;
...
public class Logic extends BaseLogic
{
	...
	protected void onFormOpen(Object[] args) throws ims.framework.exceptions.PresentationLogicException
	{
		...
		GraphicAssessmentLiteVoCollection coll = form.getGlobalContext().Assessment.getGraphicAssessmentsForSpecialtyCollection();
	...
	{
		form.getGlobalContext().Core.setSelectedGraphicAssessmentLite(form.grdDetails().getSelectedRow().getValue());
