...
public class GenForm extends FormBridge
{
	...
	public static class grdDetailsRow extends GridRowBridge
	{
		...
		public ims.assessment.vo.GraphicAssessmentLiteVo getValue()
		{
			return (ims.assessment.vo.GraphicAssessmentLiteVo)super.row.getValue();
		}
		public void setValue(ims.assessment.vo.GraphicAssessmentLiteVo value)
		{
	...
	public static class grdDetailsGrid extends GridBridge
	{
		...
		public ims.assessment.vo.GraphicAssessmentLiteVoCollection getValues()
		{
			ims.assessment.vo.GraphicAssessmentLiteVoCollection listOfValues = new ims.assessment.vo.GraphicAssessmentLiteVoCollection();
		...
		public ims.assessment.vo.GraphicAssessmentLiteVo getValue()
		{
			return (ims.assessment.vo.GraphicAssessmentLiteVo)super.grid.getValue();
		}
		public void setValue(ims.assessment.vo.GraphicAssessmentLiteVo value)
		{
		...
		public grdDetailsRow getRowByValue(ims.assessment.vo.GraphicAssessmentLiteVo value)
		{
	...
	{
		if(new ims.framework.ContextVariable("Assessment.GraphicAssessmentsForSpecialtyCollection", "_cv_Assessment.GraphicAssessmentsForSpecialtyCollection").getValueIsNull(context))
			throw new ims.framework.exceptions.FormMandatoryContextMissingException("The required context data 'Assessment.GraphicAssessmentsForSpecialtyCollection' is not available.");
	}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		// Button Controls
		RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 362, 401, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), new Integer(startTabIndex.intValue() + 2), ControlState.HIDDEN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Select", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 442, 401, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		// Grid Controls
		RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 16, 17, 504, 368, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
