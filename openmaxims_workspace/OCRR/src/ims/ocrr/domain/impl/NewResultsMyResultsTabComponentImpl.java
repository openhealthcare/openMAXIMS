...
import ims.ocrr.domain.base.impl.BaseNewResultsMyResultsTabComponentImpl;

public class NewResultsMyResultsTabComponentImpl extends BaseNewResultsMyResultsTabComponentImpl
{
	...
	{
		NewResultsAllTabComponent newResultsAllImpl = (NewResultsAllTabComponent) getDomainImpl(NewResultsAllTabComponentImpl.class);
		return newResultsAllImpl.listClinics(nameFilter, voLocRef);
	}
	...
	{
		NewResultsAllTabComponent newResultsAllImpl = (NewResultsAllTabComponent) getDomainImpl(NewResultsAllTabComponentImpl.class);
		return newResultsAllImpl.listErDepts(nameFilter, voLocRef);
	}
	...
	{
		NewResultsAllTabComponent newResultsAllImpl = (NewResultsAllTabComponent) getDomainImpl(NewResultsAllTabComponentImpl.class);
		return newResultsAllImpl.listOtherLocations(nameFilter, voLocRef);
	}

	public LocationLiteVoCollection listOutpatientDepartments(String name, LocationRefVo hospital) 
	{
		NewResultsAllTabComponent newResultsAllImpl = (NewResultsAllTabComponent) getDomainImpl(NewResultsAllTabComponentImpl.class);
		return newResultsAllImpl.listOutpatientDepartments(name, hospital);
	}
