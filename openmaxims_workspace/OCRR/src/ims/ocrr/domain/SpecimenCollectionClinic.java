...
public interface SpecimenCollectionClinic extends ims.domain.DomainInterface
{
	...
	*/
	public ims.ocrr.vo.SpecimenWorkListItemListVoCollection listWorkListItems(Integer patientId, ims.ocrr.vo.lookups.SpecimenCollectionMethod listType, ims.ocrr.vo.lookups.SpecimenCollectionStatus specimenCollectionStatus);

	// Generated from form domain interface definition
	public ims.core.vo.Patient getPatient(ims.core.vo.PatientShort voPatShort) throws ims.domain.exceptions.StaleObjectException, ims.domain.exceptions.UniqueKeyViolationException;
}
