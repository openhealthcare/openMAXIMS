...
public abstract class BaseOrdersRequiringAuthorisationImpl extends DomainImpl implements ims.ocrr.domain.OrdersRequiringAuthorisation, ims.domain.impl.Transactional
{
	...
	@SuppressWarnings("unused")
	public void validatelistOrdersRequiringAuthorisation(ims.framework.utils.Date dateFrom, ims.framework.utils.Date dateTo, ims.core.resource.place.vo.ClinicRefVo clinic, ims.core.resource.place.vo.LocationRefVo location, ims.core.resource.people.vo.HcpRefVo responsibleClinician)
	{
	}
