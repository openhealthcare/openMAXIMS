...
public interface NewResultsSearch extends ims.domain.DomainInterface
{
	// Generated from form domain interface definition
	public ims.ocrr.vo.NewResultsSearchListVoCollection listNewResults(ims.ocrr.vo.NewResultsCriteriaVo criteria);
