...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "SpecimenContainerAddEdit";
	}
	public int getWidth()
	{
		return 424;
	...
	{
		return new String[] { "_cv_Admin.ColourChosen", "_cv_OCRR.UpdatePathSpecimenContainer", "_cv_OCRR.PathSpecimenContainerVo", "_cv_Core.TaxonomyMap" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_OCRR.SpecimenContainerAddEdit.__internal_x_context__" + String.valueOf(getFormId());
	}
