...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_OCRR.OrderSetEditorReadOnly", "_cv_OCRR.OrderSetListSearchCriteria", "_cv_OCRR.SelectedOrderSetID" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_OCRR.OrderSetList.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/OCRR/order_sets_48.png";
	}
}
