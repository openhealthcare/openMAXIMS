...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "CentricityWebPACSViewer";
	}
	public int getWidth()
	{
		return 856;
	...
	{
		return new String[] { "_cv_OCRR.CentricityWebPACS.AccessionNumber" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_OCRR.CentricityWebPACSViewer.__internal_x_context__" + String.valueOf(getFormId());
	}
