...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "LeadConsultantForSpecialtyConfigDialog";
	}
	public int getWidth()
	{
		return 500;
	...
	{
		return new String[] { "_cv_OCRR.LeadConsultantForSpecialtyConfigFB" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_OCRR.LeadConsultantForSpecialtyConfigDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
