...
public class GenForm extends FormBridge
{
	...
	public static class grdInvestigationsRow extends GridRowBridge
	{
		...
		public ims.ocrr.vo.GenderInvestigationVo getValue()
		{
			return (ims.ocrr.vo.GenderInvestigationVo)super.row.getValue();
		}
		public void setValue(ims.ocrr.vo.GenderInvestigationVo value)
		{
			super.row.setValue(value);
		}
		public grdInvestigationsRow getParentRow()
		{
			return super.row.getParent() == null ? null : new grdInvestigationsRow(super.row.getParent());
		}
		public grdInvestigationsRowCollection getRows()
		{
			if(this.collection == null)
				this.collection = new grdInvestigationsRowCollection(super.row.getRows());
			return this.collection;
		}
		private grdInvestigationsRowCollection collection;
	}
	...
	public static class grdInvestigationsGrid extends GridBridge
	{
		...
		public GenForm.grdInvestigationsRow[] getAllRows()
		{
			java.util.ArrayList rows = new java.util.ArrayList();
			for(int x = 0; x < getRows().size(); x++)
			{
				GenForm.grdInvestigationsRow row = getRows().get(x);
				rows.add(row);
				GenForm.grdInvestigationsRow[] childRows = getAllRows(row);
				for(int i = 0; i < childRows.length; i++)
				{
					rows.add(childRows[i]);
				}
			}
			GenForm.grdInvestigationsRow[] result = new GenForm.grdInvestigationsRow[rows.size()];
			for(int x = 0; x < rows.size(); x++)
			{
				result[x] = (GenForm.grdInvestigationsRow)rows.get(x);
			}
			return result;
		}
		public GenForm.grdInvestigationsRow[] getAllRows(GenForm.grdInvestigationsRow parentRow)
		{
			java.util.ArrayList rows = new java.util.ArrayList();
			for(int x = 0; x < parentRow.getRows().size(); x++)
			{
				GenForm.grdInvestigationsRow row = parentRow.getRows().get(x);
				rows.add(row);
				GenForm.grdInvestigationsRow[] childRows = getAllRows(row);
				for(int i = 0; i < childRows.length; i++)
				{
		...
		private void expandCollapseRow(GenForm.grdInvestigationsRow parentRow, boolean expand)
		{
			for(int x = 0; x < parentRow.getRows().size(); x++)
			{
				GenForm.grdInvestigationsRow row = parentRow.getRows().get(x);
		...
		public ims.ocrr.vo.GenderInvestigationVoCollection getValues()
		{
			ims.ocrr.vo.GenderInvestigationVoCollection listOfValues = new ims.ocrr.vo.GenderInvestigationVoCollection();
		...
		public ims.ocrr.vo.GenderInvestigationVo getValue()
		{
			return (ims.ocrr.vo.GenderInvestigationVo)super.grid.getValue();
		}
		public void setValue(ims.ocrr.vo.GenderInvestigationVo value)
		{
		...
		public grdInvestigationsRow getRowByValue(ims.ocrr.vo.GenderInvestigationVo value)
		{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		ims.framework.utils.SizeInfo designSize = new ims.framework.utils.SizeInfo(680, 472);
		if(runtimeSize == null)
		...
		// Label Controls
		RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 664, 32, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, "These investigations have been configured as appropriate for patients of Male gender.\nDo you still wish to include this item in the order for this patient?", new Integer(1), null, new Integer(0)}));

		// Button Controls
		RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 520, 440, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 597, 440, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		// Grid Controls
		RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 8, 40, 664, 392, ims.framework.enumerations.ControlAnchoring.ALL);
		Grid m_grdInvestigationsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), new Integer(startTabIndex.intValue() + 1), ControlState.EDITABLE, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.FALSE, Boolean.FALSE, new Integer(24), Boolean.FALSE, null, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
		...
		grdInvestigations.addTreeColumn("Profile/Investigation", 0, 550, false, true);
		grdInvestigations.addBoolColumn("Select", 0, 0, -1, false, false, 0, true);
