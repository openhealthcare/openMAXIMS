...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "SecurityLevelDescriptionDialog";
	}
	public int getWidth()
	{
		return 536;
	...
	{
		return new String[] { "_cv_OCRR.SecurityLevelConfigVoRecord" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_OCRR.SecurityLevelDescriptionDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
