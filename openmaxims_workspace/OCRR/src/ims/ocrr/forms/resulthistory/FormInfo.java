...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_OCRR.SelectedInvsWithResults" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_OCRR.ResultHistory.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/results_history_48.png";
	}
}
