...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "OrderEntryTemplatePreview";
	}
	public int getWidth()
	{
		return 650;
	...
	{
		return new String[] { "_cv_OCRR.OrderEntryTemplateListSearchCriteria", "_cv_OCRR.SelectedOrderEntryTemplateID", "_cv_OCRR.PreviewedOrderEntryTemplate" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_OCRR.OrderEntryTemplatePreview.__internal_x_context__" + String.valueOf(getFormId());
	}
