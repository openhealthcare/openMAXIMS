...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		// Button Controls
		RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 556, 600, 75, 23, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), new Integer(-1), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Close", Boolean.FALSE, null, Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));

		// Dynamic Grid Controls
		RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 20, 16, 610, 573, ims.framework.enumerations.ControlAnchoring.ALL);
	...
	public DynamicGrid dyngrdPreview()
	{
	...
	public static class Forms implements java.io.Serializable
	{
		...
		public final class OCRRForms implements java.io.Serializable
		{
			...
			private OCRRForms()
			{
				...
				OrderEntryTemplatePreview = new LocalFormName(116109);
			}
			public final FormName OrderEntryTemplatePreviewDialog;
			public final FormName OrderEntryTemplatePreview;
		}
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_PreviewedItem = new ims.framework.ContextVariable("PreviewedItem", prefix + "_lv_OCRR.OrderEntryTemplatePreview.__internal_x_context__PreviewedItem_" + componentIdentifier + "");
		}
		
		public boolean getPreviewedItemIsNotNull()
		{
			return !cxl_PreviewedItem.getValueIsNull(context);
		}
		public ims.ocrr.vo.OrderEntryTemplateVo getPreviewedItem()
		{
			return (ims.ocrr.vo.OrderEntryTemplateVo)cxl_PreviewedItem.getValue(context);
		}
		public void setPreviewedItem(ims.ocrr.vo.OrderEntryTemplateVo value)
		{
			cxl_PreviewedItem.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_PreviewedItem = null;
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[78] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.OrderEntryTemplatePreview.__internal_x_context__PreviewedItem_" + componentIdentifier, "BO-1061100005-ID", "ID_OrderEntryTemplate");
			fields[79] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.OrderEntryTemplatePreview.__internal_x_context__PreviewedItem_" + componentIdentifier, "BO-1061100005-FORMNAME", "FormName");
			fields[80] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.OrderEntryTemplatePreview.__internal_x_context__PreviewedItem_" + componentIdentifier, "BO-1061100005-MENUNAME", "MenuName");
			fields[81] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.OrderEntryTemplatePreview.__internal_x_context__PreviewedItem_" + componentIdentifier, "BO-1061100005-DESCRIPTION", "Description");
			fields[82] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.OrderEntryTemplatePreview.__internal_x_context__PreviewedItem_" + componentIdentifier, "BO-1061100005-TEMPLATECATEGORY", "TemplateCategory");
			fields[83] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.OrderEntryTemplatePreview.__internal_x_context__PreviewedItem_" + componentIdentifier, "BO-1061100005-ACTIVESTATUS", "ActiveStatus");
			fields[84] = new ims.framework.ReportField(this.context, prefix + "_lv_OCRR.OrderEntryTemplatePreview.__internal_x_context__PreviewedItem_" + componentIdentifier, "BO-1061100005-FORMTEXT", "FormText");
			return fields;
		}
