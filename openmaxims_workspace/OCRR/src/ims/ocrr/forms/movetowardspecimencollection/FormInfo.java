...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "MoveToWardSpecimenCollection";
	}
	public int getWidth()
	{
		return 424;
	...
	{
		return new String[] { "_cv_OCRR.MoveToWardDetails" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_OCRR.MoveToWardSpecimenCollection.__internal_x_context__" + String.valueOf(getFormId());
	}
