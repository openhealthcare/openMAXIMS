...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_OCRR.CurrentPathRadResult" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_OCRR.ResultCommentsDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
