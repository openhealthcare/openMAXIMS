...
//#############################################################################
//#EOH
// This code was generated by Daniel Laffan using IMS Development Environment (version 1.65 build 3209.26627)
...
public class Logic extends BaseLogic
{
	...
	protected void onBtnOkClick() throws ims.framework.exceptions.PresentationLogicException
	{
		...
		if(voCollItems.getSelectedItemCount() == 0)
			errors.add("Please select an Investigation");
		if(form.cmbCancelReason().getValue() == null)
			errors.add("Cancel Reason is mandatory");
		...
		form.getGlobalContext().OCRR.setInvestigationCancelComment(form.txtComment().getValue());
		form.getGlobalContext().OCRR.setInvestigationStatusChangeReason(form.cmbCancelReason().getValue());
