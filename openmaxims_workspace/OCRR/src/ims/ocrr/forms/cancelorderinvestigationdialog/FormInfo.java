...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "CancelOrderInvestigationDialog";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Core.Items", "_cv_OCRR.InvestigationStatusChangeReason", "_cv_OCRR.InvestigationCancelComment" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_OCRR.CancelOrderInvestigationDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
