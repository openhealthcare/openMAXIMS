...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.QuestionType", "_cv_Core.QuestionFormMode", "_cv_Admin.SelectedQuestions" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_OCRR.CategoryQuestions.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/OCRR/category_questions_48.png";
	}
}
