...
import ims.ocrr.forms.newresultsalltabcomponent.GenForm.ListResultsByEnumeration;
import ims.ocrr.forms.newresultsalltabcomponent.GenForm.OrdLocGrpEnumeration;
import ims.ocrr.forms.newresultsalltabcomponent.GenForm.grdDisciplinesRow;
...
//		}
	...
	private void updateControlsState() 
	{
		...
		form.lblResponsibleHCPFor().setVisible(true);
		form.chkOrder().setVisible(true);
		form.chkCurrentIP().setVisible(true);
		form.lblHCP().setVisible(true);
		form.ccResponsibleHCP().setVisible(true);
		form.ccResponsibleHCP().isRequired(false /*form.chkOrder().getValue() || form.chkCurrentIP().getValue()*/);
		form.lblOrderingHCP().setVisible(true);
		form.ccOrderingHCP().setVisible(true);
		form.lblReviewingHCP().setVisible(true);
		form.qmbReviewingHCP().setVisible(true);
	...
	private boolean getIsOutpatientDepartment() 
	{
		...
		if (OrdLocGrpEnumeration.rdoClinic.equals(form.OrdLocGrp().getValue()) 
				&& (OUTPATIENT_DEPARTMENT_CONFIG.equals(clinicConfig) || OUTPATIENT_DEPARTMENT_HIDE_CLINIC_CONFIG.equals(clinicConfig)))
			return true;
...
//		if((form.chkOrder().getValue() || form.chkCurrentIP().getValue()) && form.ccResponsibleHCP().getValue() == null)
//		{
//			errors.add("HCP is mandatory.");
//		}
...
//		boolean generalValidationMessage = false;
//		if (form.ccResponsibleHCP().getValue() == null && form.ccOrderingHCP().getValue() == null && form.qmbReviewingHCP().getValue() == null	&& form.qmbOrderingLocation().getValue() == null)
//		{
//			generalValidationMessage = true;
//			errors.add("A Location, Responsible HCP, Ordering HCP or Reviewing HCP must be specified.");
//		}
		
//		if(!generalValidationMessage && form.ccResponsibleHCP().getValue() == null && form.ccOrderingHCP().getValue() == null && form.qmbReviewingHCP().getValue() == null)
//		{
...
//		}
	...
	{
		// Nothing to do - it's a component, but keep because auto bind
	}
