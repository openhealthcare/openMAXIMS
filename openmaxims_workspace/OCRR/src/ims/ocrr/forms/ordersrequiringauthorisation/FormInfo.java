...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "OrdersRequiringAuthorisation";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_OCRR.PathologyResults.Order", "_cv_OCRR.OrderAwaitingAuthorisation" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_OCRR.OrdersRequiringAuthorisation.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/OCRR/order_sets_auth_48.png";
	}
}
