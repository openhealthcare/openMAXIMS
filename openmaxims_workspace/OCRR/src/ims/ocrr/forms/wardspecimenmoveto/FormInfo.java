...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_OCRR.SpecimenWorkListItemList" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_OCRR.WardSpecimenMoveTo.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/OCRR/ward_specimen_move_48.png";
	}
}
