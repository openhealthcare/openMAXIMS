...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_OCRR.PathologyResults.Order" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_OCRR.PathologyOrders.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/OCRR/pathology_48.png";
	}
}
