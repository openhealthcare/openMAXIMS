...
public class GenForm extends FormBridge
{
	...
	public static class grdTestsRow extends GridRowBridge
	{
		...
		public ims.ocrr.vo.InvestigationIndexShortVo getValue()
		{
			return (ims.ocrr.vo.InvestigationIndexShortVo)super.row.getValue();
		}
		public void setValue(ims.ocrr.vo.InvestigationIndexShortVo value)
		{
	...
	public static class grdTestsGrid extends GridBridge
	{
		...
		public ims.ocrr.vo.InvestigationIndexShortVoCollection getValues()
		{
			ims.ocrr.vo.InvestigationIndexShortVoCollection listOfValues = new ims.ocrr.vo.InvestigationIndexShortVoCollection();
		...
		public ims.ocrr.vo.InvestigationIndexShortVo getValue()
		{
			return (ims.ocrr.vo.InvestigationIndexShortVo)super.grid.getValue();
		}
		public void setValue(ims.ocrr.vo.InvestigationIndexShortVo value)
		{
		...
		public grdTestsRow getRowByValue(ims.ocrr.vo.InvestigationIndexShortVo value)
		{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		contextMenus.contextMenuOCRRTestList = factory.createMenu(startControlID.intValue() + 1);
		contextMenus.contextMenuOCRRTestListADD_TESTItem = factory.createMenuItem(startControlID.intValue() + 1, "Add New Investigation", true, false, new Integer(102179), true, false);
		contextMenus.contextMenuOCRRTestList.add(contextMenus.contextMenuOCRRTestListADD_TESTItem);
		contextMenus.contextMenuOCRRTestListUPDATE_TESTItem = factory.createMenuItem(startControlID.intValue() + 2, "Edit Selected Investigation", true, false, new Integer(102150), true, false);
		contextMenus.contextMenuOCRRTestList.add(contextMenus.contextMenuOCRRTestListUPDATE_TESTItem);
		contextMenus.contextMenuOCRRTestListVIEW_TESTItem = factory.createMenuItem(startControlID.intValue() + 3, "View Selected Investigation", true, false, new Integer(102223), false, true);
		contextMenus.contextMenuOCRRTestList.add(contextMenus.contextMenuOCRRTestListVIEW_TESTItem);
		form.registerMenu(contextMenus.contextMenuOCRRTestList);


		// Label Controls
		RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 16, 42, 37, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Code:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 16, 17, 41, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Name:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 264, 43, 138, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Discipline/Department:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 264, 17, 60, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Category:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 560, 17, 45, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		// TextBox Controls
		RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 64, 40, 192, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 64, 15, 192, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// ComboBox Controls
		RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 408, 40, 144, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		ComboBox m_cmbDisciplineTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 408, 14, 144, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		ComboBox m_cmbCategoryTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.TRUE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		RuntimeAnchoring anchoringHelper10 = new RuntimeAnchoring(designSize, runtimeSize, 608, 14, 144, 21, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		// Grid Controls
		RuntimeAnchoring anchoringHelper11 = new RuntimeAnchoring(designSize, runtimeSize, 16, 85, 816, 528, ims.framework.enumerations.ControlAnchoring.ALL);
		Grid m_grdTestsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.READONLY, ControlState.READONLY, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuOCRRTestList, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.TRUE, Boolean.TRUE});
		...
		grdTests.addImageColumn(" ", 0, 0, 24, false, 0);
		grdTests.addStringColumn("Name", 0, 0, 240, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdTests.addStringColumn("Description", 0, 0, 240, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdTests.addStringColumn("Category", 0, 0, 150, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdTests.addImageColumn("Colour", 1, 1, 55, false, 2);
		grdTests.addStringColumn("Status", 0, 0, -1, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		super.addGrid(grdTests);

		// Image Buttons Controls
		RuntimeAnchoring anchoringHelper12 = new RuntimeAnchoring(designSize, runtimeSize, 768, 10, 30, 30, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, this.getImages().Core.FindEnabled24, this.getImages().Core.FindDisabled24, "Search", Boolean.FALSE, Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null}));
		RuntimeAnchoring anchoringHelper13 = new RuntimeAnchoring(designSize, runtimeSize, 802, 10, 30, 30, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, this.getImages().Core.ClearEnabled24, this.getImages().Core.ClearDisabled24, "Clear", Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
	}
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_IsNew = new ims.framework.ContextVariable("IsNew", prefix + "_lv_OCRR.TestList.__internal_x_context__IsNew_" + componentIdentifier + "");
			cxl_SortOrder = new ims.framework.ContextVariable("SortOrder", prefix + "_lv_OCRR.TestList.__internal_x_context__SortOrder_" + componentIdentifier + "");
		}
	...
	{
		private static final long serialVersionUID = 1L;
		public final class OCRRTestList implements java.io.Serializable
		{
			private static final long serialVersionUID = 1L;
			public static final int ADD_TEST = 1;
			public static final int UPDATE_TEST = 2;
			public static final int VIEW_TEST = 3;
		}
		public void disableAllOCRRTestListMenuItems()
		{
			this.contextMenuOCRRTestListADD_TESTItem.setEnabled(false);
			this.contextMenuOCRRTestListUPDATE_TESTItem.setEnabled(false);
			this.contextMenuOCRRTestListVIEW_TESTItem.setEnabled(false);
		}
		public void hideAllOCRRTestListMenuItems()
		{
			this.contextMenuOCRRTestListADD_TESTItem.setVisible(false);
			this.contextMenuOCRRTestListUPDATE_TESTItem.setVisible(false);
			this.contextMenuOCRRTestListVIEW_TESTItem.setVisible(false);
		}
		private Menu contextMenuOCRRTestList;
		public MenuItem getOCRRTestListADD_TESTItem()
		{
			return this.contextMenuOCRRTestListADD_TESTItem;
		}
		private MenuItem contextMenuOCRRTestListADD_TESTItem;
		public MenuItem getOCRRTestListUPDATE_TESTItem()
		{
			return this.contextMenuOCRRTestListUPDATE_TESTItem;
		}
		private MenuItem contextMenuOCRRTestListUPDATE_TESTItem;
		public MenuItem getOCRRTestListVIEW_TESTItem()
		{
			return this.contextMenuOCRRTestListVIEW_TESTItem;
		}
		private MenuItem contextMenuOCRRTestListVIEW_TESTItem;
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[71] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-ID", "ID_InvestigationIndex");
			fields[72] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-NAME", "Name");
			fields[73] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-CATEGORY", "Category");
			fields[74] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-ORDERABILITY", "Orderability");
			fields[75] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-TIMESERIESINSTRUCTIONSURL", "TimeSeriesInstructionsURL");
			fields[76] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-DESCRIPTION", "Description");
			fields[77] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-COLOUR", "Colour");
			fields[78] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-ISPROFILE", "IsProfile");
			fields[79] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-ACTIVESTATUS", "ActiveStatus");
			fields[80] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-GENDERSPECIFIC", "GenderSpecific");
			fields[81] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-PHLEBMAYCOLLECT", "PhlebMayCollect");
			fields[82] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-REQUIRESSITESPECIFIER", "RequiresSiteSpecifier");
			fields[83] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-SHOWLAST", "ShowLast");
			fields[84] = new ims.framework.ReportField(this.context, "_cv_OCRR.SelectedTest", "BO-1061100003-NOINTERFACE", "NoInterface");
			return fields;
		}
