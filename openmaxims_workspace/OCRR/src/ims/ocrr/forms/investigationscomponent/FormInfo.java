...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_OCRR.ResultDisplayDate", "_cv_OCRR.SelectedPathRadResults", "_cv_OCRR.CurrentPathRadResult", "_cv_OCRR.PathologyResults.Order" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_OCRR.InvestigationsComponent.__internal_x_context__" + String.valueOf(getFormId());
	}
