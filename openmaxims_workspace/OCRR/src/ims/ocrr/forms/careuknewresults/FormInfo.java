...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_OCRR.CurrentPathRadResult", "_cv_OCRR.SelectedPathRadResults" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_OCRR.CAREUKNewResults.__internal_x_context__" + String.valueOf(getFormId());
	}
