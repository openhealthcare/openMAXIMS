...
public class GenForm extends FormBridge
{
	...
	private void validateContext(ims.framework.Context context)
	{
		...
		if(!context.isValidContextType(ims.ocrr.vo.NewResultsSearchCriteriaVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.ocrr.vo.NewResultsSearchCriteriaVo' of the global context variable 'OCRR.CareUkNewResultsSearchCriteria' is not supported.");
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_bTimerOn = new ims.framework.ContextVariable("bTimerOn", prefix + "_lv_OCRR.CAREUKNewResults.__internal_x_context__bTimerOn_" + componentIdentifier + "");
		}
