...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.Report", "_cv_Core.PrinterSelect", "_cv_Core.PrepareForPrinting", "_cv_Core.Template", "_cv_Core.SpecimenWorkListItemsForPrint" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_OCRR.PhlebotomyCollect.__internal_x_context__" + String.valueOf(getFormId());
	}
