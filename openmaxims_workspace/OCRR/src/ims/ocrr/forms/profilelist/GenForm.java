...
public class GenForm extends FormBridge
{
	...
	public static class grdProfilesGrid extends GridBridge
	{
		...
		public grdProfilesRow getRowByValue(ims.ocrr.vo.InvestigationIndexShortVo value)
		{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		contextMenus.contextMenuOCRRProfileList = factory.createMenu(startControlID.intValue() + 1);
		contextMenus.contextMenuOCRRProfileListADD_PROFILEItem = factory.createMenuItem(startControlID.intValue() + 1, "Add New Profile", true, false, new Integer(102179), true, false);
		contextMenus.contextMenuOCRRProfileList.add(contextMenus.contextMenuOCRRProfileListADD_PROFILEItem);
		contextMenus.contextMenuOCRRProfileListUPDATE_PROFILEItem = factory.createMenuItem(startControlID.intValue() + 2, "Edit Selected Profile", true, false, new Integer(102150), true, false);
		contextMenus.contextMenuOCRRProfileList.add(contextMenus.contextMenuOCRRProfileListUPDATE_PROFILEItem);
		contextMenus.contextMenuOCRRProfileListVIEW_PROFILEItem = factory.createMenuItem(startControlID.intValue() + 3, "View Selected Profile", true, false, new Integer(102223), false, true);
		contextMenus.contextMenuOCRRProfileList.add(contextMenus.contextMenuOCRRProfileListVIEW_PROFILEItem);
		form.registerMenu(contextMenus.contextMenuOCRRProfileList);


		// Label Controls
		RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 16, 17, 41, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Name:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 560, 17, 45, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		// TextBox Controls
		RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 64, 15, 192, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// ComboBox Controls
		RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 608, 14, 152, 21, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		ComboBox m_cmbStatusTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1005), new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 408, 40, 144, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		...
		RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 408, 14, 144, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		...
		// Grid Controls
		RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 16, 85, 816, 528, ims.framework.enumerations.ControlAnchoring.ALL);
		Grid m_grdProfilesTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.READONLY, ControlState.READONLY, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuOCRRProfileList, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.TRUE, Boolean.TRUE});
		...
		grdProfiles.addImageColumn(" ", 0, 0, 24, false, 0);
		grdProfiles.addStringColumn("Name", 0, 0, 250, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdProfiles.addStringColumn("Description", 0, 0, 250, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdProfiles.addStringColumn("Category", 0, 0, 150, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdProfiles.addImageColumn("Colour", 1, 1, 55, false, 2);
		grdProfiles.addStringColumn("Status", 0, 0, -1, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		super.addGrid(grdProfiles);

		// Image Buttons Controls
		RuntimeAnchoring anchoringHelper10 = new RuntimeAnchoring(designSize, runtimeSize, 768, 10, 30, 30, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(anchoringHelper10.getX()), new Integer(anchoringHelper10.getY()), new Integer(anchoringHelper10.getWidth()), new Integer(anchoringHelper10.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, this.getImages().Core.FindEnabled24, this.getImages().Core.FindDisabled24, "Search", Boolean.FALSE, Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null}));
		RuntimeAnchoring anchoringHelper11 = new RuntimeAnchoring(designSize, runtimeSize, 802, 10, 30, 30, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, this.getImages().Core.ClearEnabled24, this.getImages().Core.ClearDisabled24, "Clear", Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
	}
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_IsNew = new ims.framework.ContextVariable("IsNew", prefix + "_lv_OCRR.ProfileList.__internal_x_context__IsNew_" + componentIdentifier + "");
			cxl_SortOrder = new ims.framework.ContextVariable("SortOrder", prefix + "_lv_OCRR.ProfileList.__internal_x_context__SortOrder_" + componentIdentifier + "");
		}
	...
	{
		private static final long serialVersionUID = 1L;
		public final class OCRRProfileList implements java.io.Serializable
		{
			private static final long serialVersionUID = 1L;
		...
		public void disableAllOCRRProfileListMenuItems()
		{
			this.contextMenuOCRRProfileListADD_PROFILEItem.setEnabled(false);
			this.contextMenuOCRRProfileListUPDATE_PROFILEItem.setEnabled(false);
			this.contextMenuOCRRProfileListVIEW_PROFILEItem.setEnabled(false);
		}
		public void hideAllOCRRProfileListMenuItems()
		{
			this.contextMenuOCRRProfileListADD_PROFILEItem.setVisible(false);
			this.contextMenuOCRRProfileListUPDATE_PROFILEItem.setVisible(false);
			this.contextMenuOCRRProfileListVIEW_PROFILEItem.setVisible(false);
		}
		private Menu contextMenuOCRRProfileList;
		public MenuItem getOCRRProfileListADD_PROFILEItem()
		{
			return this.contextMenuOCRRProfileListADD_PROFILEItem;
		}
		private MenuItem contextMenuOCRRProfileListADD_PROFILEItem;
		public MenuItem getOCRRProfileListUPDATE_PROFILEItem()
		{
			return this.contextMenuOCRRProfileListUPDATE_PROFILEItem;
		}
		private MenuItem contextMenuOCRRProfileListUPDATE_PROFILEItem;
		public MenuItem getOCRRProfileListVIEW_PROFILEItem()
		{
			return this.contextMenuOCRRProfileListVIEW_PROFILEItem;
		}
		private MenuItem contextMenuOCRRProfileListVIEW_PROFILEItem;
	}
