...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 0, 592, 648, 40, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), new Integer(startTabIndex.intValue() + 1004), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));

		// Dynamic Grid Controls
		RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 8, 16, 832, 576, ims.framework.enumerations.ControlAnchoring.ALL);
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_OrderInvestigarionID = new ims.framework.ContextVariable("OrderInvestigarionID", prefix + "_lv_OCRR.PrintMultipleResults.__internal_x_context__OrderInvestigarionID_" + componentIdentifier + "");
			cxl_SelectedPrinter = new ims.framework.ContextVariable("SelectedPrinter", prefix + "_lv_OCRR.PrintMultipleResults.__internal_x_context__SelectedPrinter_" + componentIdentifier + "");
		}
		
		public boolean getOrderInvestigarionIDIsNotNull()
		{
			return !cxl_OrderInvestigarionID.getValueIsNull(context);
		}
		public ims.ocrr.orderingresults.vo.OrderInvestigationRefVoCollection getOrderInvestigarionID()
		{
			return (ims.ocrr.orderingresults.vo.OrderInvestigationRefVoCollection)cxl_OrderInvestigarionID.getValue(context);
		}
		public void setOrderInvestigarionID(ims.ocrr.orderingresults.vo.OrderInvestigationRefVoCollection value)
		{
			if(value != null)
			{
				for(int x = 0; x < value.size(); x++)
				{
					if(value.get(x) != null && (value.get(x).getBoId() == null || value.get(x).getBoId().intValue() < 1))
						throw new ims.framework.exceptions.CodingRuntimeException("Invalid domain object id found in 'OrderInvestigarionID' RefVoCollection context variable.");
				}
			}
			if(value == null)
				cxl_OrderInvestigarionID.setValue(context, null);
			else
			{
				ims.ocrr.orderingresults.vo.OrderInvestigationRefVoCollection copy = new ims.ocrr.orderingresults.vo.OrderInvestigationRefVoCollection();
				for(int x = 0; x < value.size(); x++)
				{
				...
				for(int x = 0; x < copy.size(); x++)
				{
					if(copy.get(x) == null)
						...
						value.add(new ims.ocrr.orderingresults.vo.OrderInvestigationRefVo(copy.get(x).getBoId(), copy.get(x).getBoVersion()));
				}
				cxl_OrderInvestigarionID.setValue(context, value);
			}
		}
		private ims.framework.ContextVariable cxl_OrderInvestigarionID = null;
		...
		{
			return (String)cxl_SelectedPrinter.getValue(context);
		}
