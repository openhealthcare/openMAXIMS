...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_OCRR.UpdatePathSpecimenContainer", "_cv_OCRR.PathSpecimenContainerVo" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_OCRR.SpecimenContainerList.__internal_x_context__" + String.valueOf(getFormId());
	}
