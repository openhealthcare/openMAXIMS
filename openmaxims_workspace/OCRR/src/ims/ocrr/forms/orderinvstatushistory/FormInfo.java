...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_OCRR.SelectedInvs" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_OCRR.OrderInvStatusHistory.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/OCRR/my_order_status_48.png";
	}
}
