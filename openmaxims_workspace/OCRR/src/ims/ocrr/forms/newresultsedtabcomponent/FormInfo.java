...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "NewResultsEDTabComponent";
	}
	public int getWidth()
	{
		return 824;
	...
	{
		return new String[] { "_cv_OCRR.SelectedDisciplines" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_OCRR.NewResultsEDTabComponent.__internal_x_context__" + String.valueOf(getFormId());
	}
