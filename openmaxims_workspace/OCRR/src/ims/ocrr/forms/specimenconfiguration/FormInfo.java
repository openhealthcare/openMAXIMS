...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_OCRR.AdultSpecimenContainer", "_cv_OCRR.PaediatricsContainer", "_cv_OCRR.AlternativePaediatricsContainer" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_OCRR.SpecimenConfiguration.__internal_x_context__" + String.valueOf(getFormId());
	}
