...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Admin.SelectedQuestions", "_cv_Core.QuestionFormMode", "_cv_Core.QuestionType" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_OCRR.ServiceQuestions.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/OCRR/service_questions_48.png";
	}
}
