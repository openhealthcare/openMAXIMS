...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "ChooseAlternativeContainersDialog";
	}
	public int getWidth()
	{
		return 664;
	...
	{
		return new String[] { "_cv_OCRR.MyOrderPotentialSpecimens", "_cv_OCRR.ReWrittenOrderInvestigations" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_OCRR.ChooseAlternativeContainersDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
