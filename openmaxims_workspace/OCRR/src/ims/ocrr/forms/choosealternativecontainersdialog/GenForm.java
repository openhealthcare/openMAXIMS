...
public class GenForm extends FormBridge
{
	...
	public static class grdItemsRow extends GridRowBridge
	{
		...
		public ims.framework.controls.GridMutableComboBox getColContainer()
		{
	...
	public static class grdItemsGrid extends GridBridge
	{
		...
		public grdItemsRow getRowByValue(ims.ocrr.vo.OrderInvestigationVo value)
		{
	...
	{
		if(new ims.framework.ContextVariable("OCRR.MyOrderPotentialSpecimens", "_cv_OCRR.MyOrderPotentialSpecimens").getValueIsNull(context))
			throw new ims.framework.exceptions.FormMandatoryContextMissingException("The required context data 'OCRR.MyOrderPotentialSpecimens' is not available.");
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		// Button Controls
		RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 504, 432, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 584, 432, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		// Grid Controls
		RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 648, 416, ims.framework.enumerations.ControlAnchoring.ALL);
		...
		grdItems.addTreeColumn("Item", 0, 450, false, true);
		grdItems.addMutableComboBoxColumn("Container", 0, 1, -1, false, true, false, false, false, true, -1);
