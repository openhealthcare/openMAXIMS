...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_OCRR.MyOrderComponents", "_cv_OCRR.OrderInvestigationCollection", "_cv_OCRR.SelectedOrderPriority" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_OCRR.OrderPriorityDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/OCRR/my_order_priority_48.png";
	}
}
