...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.DocumentStatus", "_cv_Core.DocumentID" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Correspondence.PatientDocuments.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/patient_documents_view_48.png";
	}
}
