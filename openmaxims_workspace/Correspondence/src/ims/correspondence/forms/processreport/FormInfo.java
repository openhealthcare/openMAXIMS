...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Correspondence.DocDetailIdReportSeed", "_cv_Core.ReportID", "_cv_Core.TemplateID", "_cv_Core.DocumentID" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Correspondence.ProcessReport.__internal_x_context__" + String.valueOf(getFormId());
	}
