...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void onHtmViewerHTMLViewerClick(int value) throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.htmViewer().setHTMLViewerClickEvent(new HTMLViewerClick()
		{
			private static final long serialVersionUID = 1L;
			public void handle(int value) throws ims.framework.exceptions.PresentationLogicException
			{
				onHtmViewerHTMLViewerClick(value);
			}
		});
