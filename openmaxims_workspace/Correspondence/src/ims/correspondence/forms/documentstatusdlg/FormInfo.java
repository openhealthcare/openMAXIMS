...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Correspondence.currentCspStatusHistory" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Correspondence.DocumentStatusDlg.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Correspondence/documents_info_48.png";
	}
}
