...
public abstract class BaseLogic extends Handlers
{
	...
	{
		return ims.correspondence.domain.CorrespondenceOutpatientList.class;
	}
	public final void setContext(ims.framework.UIEngine engine, GenForm form, ims.correspondence.domain.CorrespondenceOutpatientList domain)
	{
		setContext(engine, form);
		this.domain = domain;
	}
	protected final void oncmbStatusOfLetterValueSet(Object value)
	{
		java.util.ArrayList listOfValues = this.form.cmbStatusOfLetter().getValues();
		...
		else if(value instanceof ims.core.vo.lookups.DocumentStatus)
		{
			...
			this.form.cmbStatusOfLetter().newRow(instance, instance.getText(), instance.getImage(), instance.getTextColor());
		}
	}
	protected final void bindcmbStatusOfLetterLookup()
	{
		this.form.cmbStatusOfLetter().clear();
		...
		{
			this.form.cmbStatusOfLetter().newRow(lookupCollection.get(x), lookupCollection.get(x).getText(), lookupCollection.get(x).getImage(), lookupCollection.get(x).getTextColor());
		}
	}
	protected final void setcmbStatusOfLetterLookupValue(int id)
	{
		...
		if(instance != null)
			this.form.cmbStatusOfLetter().setValue(instance);
	}
	protected final void defaultcmbStatusOfLetterLookupValue()
	{
		this.form.cmbStatusOfLetter().setValue((ims.core.vo.lookups.DocumentStatus)domain.getLookupService().getDefaultInstance(ims.core.vo.lookups.DocumentStatus.class, engine.getFormName().getID(), ims.core.vo.lookups.DocumentStatus.TYPE_ID));
	}
	...
	protected ims.correspondence.domain.CorrespondenceOutpatientList domain;
}
