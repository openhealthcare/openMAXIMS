...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "_lv_Correspondence.DocumentCategoryConfig.__internal_x_context__" + String.valueOf(getFormId());
	}
	public ims.framework.FormInfo[] getComponentsFormInfo()
	{
		ims.framework.FormInfo[] componentsInfo = new ims.framework.FormInfo[1];
		componentsInfo[0] = new ims.core.forms.lookupmultiselectioncomponent.FormInfo(102361);
		return componentsInfo;
	}
	public String getImagePath()
	{
		return "Images/Correspondence/correspondence_headers_config_48.png";
	}
}
