...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Rules.RuleToEdit" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Rules.RuleXMLImport.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/rule_up_48.png";
	}
}
