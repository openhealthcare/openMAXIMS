...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Rules.RulesCodePreview.XmlRule" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Rules.RuleCodePreview.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/rule_zoom_48.png";
	}
}
