 ...
 */
public interface ICareUKDomainHelper extends DomainInterface{
	// Generated from form domain interface definition
	public ims.careuk.vo.IFCATSExternalEventVo getCATSIFValues(ims.ocs_if.vo.IfOrderInvestigationVo investigationRef, Boolean includeApptStatus);
