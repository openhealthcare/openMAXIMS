...
public class HL7Inbound extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1106100000;
	private static final long serialVersionUID = 1106100000L;
	...
	private java.util.Date messageDateTime;
	/** Flag to determine whether the message was successfully parsed and received  */
	private Boolean successfulOutcome;
	/** SystemInformation */
	private ims.domain.SystemInformation systemInformation = new ims.domain.SystemInformation();
    public HL7Inbound (Integer id, int ver)
    {
    	super(id, ver);
    }
    public HL7Inbound ()
    ...
    public HL7Inbound (Integer id, int ver, Boolean includeRecord)
    {
	...
	public String toAuditString()
	{
	    ...
	    auditStr.append("; ");
		auditStr.append("\r\n*messageDateTime* :");
		auditStr.append(messageDateTime);
	    auditStr.append("; ");
		auditStr.append("\r\n*successfulOutcome* :");
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "HL7Inbound";
	...
	public String fieldsToXMLString(java.util.HashMap domMap)
	{
		...
		if (this.getMessageDateTime() != null)
		{
			sb.append("<messageDateTime>");
			sb.append(new ims.framework.utils.DateTime(this.getMessageDateTime()).toString(ims.framework.utils.DateTimeFormat.MILLI));
			sb.append("</messageDateTime>");		
		}
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			HL7Inbound domainObject = getHL7InboundfromXML(itemEl, factory, domMap);
	...
	public static HL7Inbound getHL7InboundfromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getHL7InboundfromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static HL7Inbound getHL7InboundfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!HL7Inbound.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!HL7Inbound.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the HL7Inbound class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (HL7Inbound)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(HL7Inbound.CLASSVERSION))
		{
		...
		ret = (HL7Inbound)factory.getImportedDomainObject(HL7Inbound.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new HL7Inbound();
		}
		...
		if (impObj != null)
		{
			return (HL7Inbound)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, HL7Inbound obj, java.util.HashMap domMap) throws Exception
	{
		...
		fldEl = el.element("messageDateTime");
		if(fldEl != null)
		{	
    		obj.setMessageDateTime(new java.text.SimpleDateFormat("yyyyMMddHHmmssSSS").parse(fldEl.getTextTrim()));
		}
