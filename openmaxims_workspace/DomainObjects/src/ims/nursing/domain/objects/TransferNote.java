...
public class TransferNote extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1011100003;
	private static final long serialVersionUID = 1011100003L;
	...
	/** ClinicalContact (previously episode) */
	private ims.core.admin.domain.objects.ClinicalContact clinicalContact;
	/** Care Context */
	private ims.core.admin.domain.objects.CareContext careContext;
	/** SystemInformation */
	private ims.domain.SystemInformation systemInformation = new ims.domain.SystemInformation();
    public TransferNote (Integer id, int ver)
    {
    	super(id, ver);
    }
    public TransferNote ()
    ...
    public TransferNote (Integer id, int ver, Boolean includeRecord)
    {
    	super(id, ver, includeRecord);
    }
	public Class getRealDomainClass()
	{
		return ims.nursing.domain.objects.TransferNote.class;
	}
	...
	public void setTransferNote(String transferNote) {
		if ( null != transferNote && transferNote.length() > 1500 ) {
			throw new ims.domain.exceptions.DomainRuntimeException("MaxLength ($MaxLength) exceeded for transferNote. Tried to set value: "+
				transferNote);
		}
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "TransferNote";
	...
	public String fieldsToXMLString(java.util.HashMap domMap)
	{
		...
		if (this.getTransferNote() != null)
		{
			sb.append("<transferNote>");
			sb.append(ims.framework.utils.StringUtils.encodeXML(this.getTransferNote().toString()));
			sb.append("</transferNote>");		
		}
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			TransferNote domainObject = getTransferNotefromXML(itemEl, factory, domMap);
	...
	public static TransferNote getTransferNotefromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getTransferNotefromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static TransferNote getTransferNotefromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!TransferNote.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!TransferNote.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the TransferNote class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (TransferNote)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(TransferNote.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		TransferNote ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (TransferNote)factory.getImportedDomainObject(TransferNote.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new TransferNote();
		}
		String keyClassName = "TransferNote";
		...
		if (impObj != null)
		{
			return (TransferNote)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, TransferNote obj, java.util.HashMap domMap) throws Exception
	{
		...
		fldEl = el.element("transferNote");
		if(fldEl != null)
		{	
    		obj.setTransferNote(new String(fldEl.getTextTrim()));	
		}
