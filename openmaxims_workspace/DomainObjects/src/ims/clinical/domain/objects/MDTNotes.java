...
public class MDTNotes extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1072100023;
	private static final long serialVersionUID = 1072100023L;
    ...
    public MDTNotes (Integer id, int ver)
    {
    	super(id, ver);
    }
    public MDTNotes ()
    ...
    public MDTNotes (Integer id, int ver, Boolean includeRecord)
    {
    	super(id, ver, includeRecord);
    }
	public Class getRealDomainClass()
	{
		return ims.clinical.domain.objects.MDTNotes.class;
	}
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			MDTNotes domainObject = getMDTNotesfromXML(itemEl, factory, domMap);
	...
	public static MDTNotes getMDTNotesfromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getMDTNotesfromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static MDTNotes getMDTNotesfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!MDTNotes.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!MDTNotes.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the MDTNotes class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (MDTNotes)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(MDTNotes.CLASSVERSION))
		{
		...
		ret = (MDTNotes)factory.getImportedDomainObject(MDTNotes.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new MDTNotes();
		}
		...
		if (impObj != null)
		{
			return (MDTNotes)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, MDTNotes obj, java.util.HashMap domMap) throws Exception
	{
