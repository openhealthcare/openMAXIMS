...
public class GraphicAssessmentQuestion extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1028100015;
	private static final long serialVersionUID = 1028100015L;
    ...
    public GraphicAssessmentQuestion (Integer id, int ver)
    {
    	super(id, ver);
    }
    public GraphicAssessmentQuestion ()
    {
    	super();
    }
    public GraphicAssessmentQuestion (Integer id, int ver, Boolean includeRecord)
    {
    	super(id, ver, includeRecord);
    }
	public Class getRealDomainClass()
	{
		return ims.assessment.configuration.domain.objects.GraphicAssessmentQuestion.class;
	}
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "GraphicAssessmentQuestion";
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			GraphicAssessmentQuestion domainObject = getGraphicAssessmentQuestionfromXML(itemEl, factory, domMap);
	...
	public static GraphicAssessmentQuestion getGraphicAssessmentQuestionfromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getGraphicAssessmentQuestionfromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static GraphicAssessmentQuestion getGraphicAssessmentQuestionfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!GraphicAssessmentQuestion.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!GraphicAssessmentQuestion.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the GraphicAssessmentQuestion class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (GraphicAssessmentQuestion)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(GraphicAssessmentQuestion.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		GraphicAssessmentQuestion ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (GraphicAssessmentQuestion)factory.getImportedDomainObject(GraphicAssessmentQuestion.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new GraphicAssessmentQuestion();
		}
		String keyClassName = "GraphicAssessmentQuestion";
		...
		if (impObj != null)
		{
			return (GraphicAssessmentQuestion)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, GraphicAssessmentQuestion obj, java.util.HashMap domMap) throws Exception
	{
