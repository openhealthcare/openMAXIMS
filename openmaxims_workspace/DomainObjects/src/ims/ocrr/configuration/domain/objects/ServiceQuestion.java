...
public class ServiceQuestion extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1061100008;
	private static final long serialVersionUID = 1061100008L;
    ...
    public ServiceQuestion (Integer id, int ver)
    {
    	super(id, ver);
    }
    ...
    public ServiceQuestion (Integer id, int ver, Boolean includeRecord)
    {
    	super(id, ver, includeRecord);
    }
	public Class getRealDomainClass()
	{
		return ims.ocrr.configuration.domain.objects.ServiceQuestion.class;
	}
	...
	// method generated based on 'ocrr_servicequest_unq1' unique index.
	public static boolean recordExistForServiceAndQuestionInformation(ims.domain.ILightweightDomainFactory factory,
		 ims.core.clinical.domain.objects.Service service
	,
	 ims.core.clinical.domain.objects.QuestionInformation questionInformation
	)	
	{
		return recordExistForServiceAndQuestionInformation(factory, service, questionInformation, null);
	}	
	...
	, Integer recordId)	
	{
		...
		hql.append("from ServiceQuestion c where ");
	...
	// method generated based on 'ocrr_servicequest_unq1' unique index.
	public static ServiceQuestion getRecordByServiceAndQuestionInformation(ims.domain.ILightweightDomainFactory factory,
	 ims.core.clinical.domain.objects.Service service
	,
	 ims.core.clinical.domain.objects.QuestionInformation questionInformation
	)
	{
		...
		return (ServiceQuestion)l.get(0);
	}

	public static ServiceQuestion getServiceQuestionFromocrr_servicequest_unq1(ims.domain.ILightweightDomainFactory factory,
	 ims.core.clinical.domain.objects.Service service
	,
	 ims.core.clinical.domain.objects.QuestionInformation questionInformation
	)
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "ServiceQuestion";
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			ServiceQuestion domainObject = getServiceQuestionfromXML(itemEl, factory, domMap);
	...
	public static ServiceQuestion getServiceQuestionfromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getServiceQuestionfromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static ServiceQuestion getServiceQuestionfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!ServiceQuestion.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!ServiceQuestion.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the ServiceQuestion class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (ServiceQuestion)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(ServiceQuestion.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		ServiceQuestion ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (ServiceQuestion)factory.getImportedDomainObject(ServiceQuestion.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new ServiceQuestion();
		}
		String keyClassName = "ServiceQuestion";
		...
		if (impObj != null)
		{
			return (ServiceQuestion)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, ServiceQuestion obj, java.util.HashMap domMap) throws Exception
	{
