...
public class InPatientADTMessageQueue extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1103100003;
	private static final long serialVersionUID = 1103100003L;
	...
	private ims.emergency.domain.objects.EDPartialAdmission partialAdmission;
	/** SystemInformation */
	private ims.domain.SystemInformation systemInformation = new ims.domain.SystemInformation();
    public InPatientADTMessageQueue (Integer id, int ver)
    {
    	super(id, ver);
    }
    public InPatientADTMessageQueue ()
    {
    	super();
    }
    public InPatientADTMessageQueue (Integer id, int ver, Boolean includeRecord)
    {
	...
	public ims.emergency.domain.objects.EDPartialAdmission getPartialAdmission() {
		return partialAdmission;
	}
	public void setPartialAdmission(ims.emergency.domain.objects.EDPartialAdmission partialAdmission) {
		this.partialAdmission = partialAdmission;
	}
	...
	public String toAuditString()
	{
		...
		{
			auditStr.append(toShortClassName(partialAdmission));
				
		    auditStr.append(partialAdmission.getId());
		}
	    auditStr.append("; ");
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "InPatientADTMessageQueue";
	...
	public String fieldsToXMLString(java.util.HashMap domMap)
	{
		...
		if (this.getPartialAdmission() != null)
		{
			sb.append("<partialAdmission>");
			sb.append(this.getPartialAdmission().toXMLString(domMap)); 	
			sb.append("</partialAdmission>");		
		}
		return sb.toString();
	}
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			InPatientADTMessageQueue domainObject = getInPatientADTMessageQueuefromXML(itemEl, factory, domMap);
	...
	public static InPatientADTMessageQueue getInPatientADTMessageQueuefromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getInPatientADTMessageQueuefromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static InPatientADTMessageQueue getInPatientADTMessageQueuefromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!InPatientADTMessageQueue.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!InPatientADTMessageQueue.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the InPatientADTMessageQueue class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (InPatientADTMessageQueue)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(InPatientADTMessageQueue.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		InPatientADTMessageQueue ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (InPatientADTMessageQueue)factory.getImportedDomainObject(InPatientADTMessageQueue.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new InPatientADTMessageQueue();
		}
		String keyClassName = "InPatientADTMessageQueue";
		...
		if (impObj != null)
		{
			return (InPatientADTMessageQueue)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, InPatientADTMessageQueue obj, java.util.HashMap domMap) throws Exception
	{
		...
		fldEl = el.element("partialAdmission");
		if(fldEl != null)
		{
			fldEl = fldEl.element("class");		
			obj.setPartialAdmission(ims.emergency.domain.objects.EDPartialAdmission.getEDPartialAdmissionfromXML(fldEl, factory, domMap)); 
		}
	}
	...
	public static final String ID = "id";
		...
		public static final String PartialAdmission = "partialAdmission";
	}
}
