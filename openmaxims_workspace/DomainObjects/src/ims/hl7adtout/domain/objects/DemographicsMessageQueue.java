...
public class DemographicsMessageQueue extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1103100000;
	private static final long serialVersionUID = 1103100000L;
	...
	/** The old patient for merge messages */
	private ims.core.patient.domain.objects.Patient priorPatient;
	/** Patient Merge History Record */
	private ims.core.patient.domain.objects.PatientMergeHistory mergeHistory;
	/** SystemInformation */
	private ims.domain.SystemInformation systemInformation = new ims.domain.SystemInformation();
    public DemographicsMessageQueue (Integer id, int ver)
    {
    	super(id, ver);
    }
    public DemographicsMessageQueue ()
    {
    	super();
    }
    public DemographicsMessageQueue (Integer id, int ver, Boolean includeRecord)
    {
    	super(id, ver, includeRecord);
    }
	public Class getRealDomainClass()
	{
		return ims.hl7adtout.domain.objects.DemographicsMessageQueue.class;
	}
	...
	public ims.core.patient.domain.objects.Patient getPriorPatient() {
		return priorPatient;
	}
	public void setPriorPatient(ims.core.patient.domain.objects.Patient priorPatient) {
		this.priorPatient = priorPatient;
	}

	public ims.core.patient.domain.objects.PatientMergeHistory getMergeHistory() {
		return mergeHistory;
	}
	public void setMergeHistory(ims.core.patient.domain.objects.PatientMergeHistory mergeHistory) {
	...
	public String toAuditString()
	{
		...
		{
			auditStr.append(toShortClassName(priorPatient));
				
		    auditStr.append(priorPatient.getId());
		}
	    auditStr.append("; ");
		auditStr.append("\r\n*mergeHistory* :");
		if (mergeHistory != null)
		{
			auditStr.append(toShortClassName(mergeHistory));
				
		    auditStr.append(mergeHistory.getId());
		}
	    auditStr.append("; ");
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "DemographicsMessageQueue";
	...
	public String fieldsToXMLString(java.util.HashMap domMap)
	{
		...
		if (this.getPriorPatient() != null)
		{
			sb.append("<priorPatient>");
			sb.append(this.getPriorPatient().toXMLString(domMap)); 	
			sb.append("</priorPatient>");		
		}
		if (this.getMergeHistory() != null)
		{
			sb.append("<mergeHistory>");
			sb.append(this.getMergeHistory().toXMLString(domMap)); 	
			sb.append("</mergeHistory>");		
		}
		return sb.toString();
	}
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			DemographicsMessageQueue domainObject = getDemographicsMessageQueuefromXML(itemEl, factory, domMap);
	...
	public static DemographicsMessageQueue getDemographicsMessageQueuefromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getDemographicsMessageQueuefromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static DemographicsMessageQueue getDemographicsMessageQueuefromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!DemographicsMessageQueue.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!DemographicsMessageQueue.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the DemographicsMessageQueue class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (DemographicsMessageQueue)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(DemographicsMessageQueue.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		DemographicsMessageQueue ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (DemographicsMessageQueue)factory.getImportedDomainObject(DemographicsMessageQueue.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new DemographicsMessageQueue();
		}
		String keyClassName = "DemographicsMessageQueue";
		...
		if (impObj != null)
		{
			return (DemographicsMessageQueue)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, DemographicsMessageQueue obj, java.util.HashMap domMap) throws Exception
	{
		...
		fldEl = el.element("priorPatient");
		if(fldEl != null)
		{
			fldEl = fldEl.element("class");		
			obj.setPriorPatient(ims.core.patient.domain.objects.Patient.getPatientfromXML(fldEl, factory, domMap)); 
		}
		fldEl = el.element("mergeHistory");
		if(fldEl != null)
		{
			fldEl = fldEl.element("class");		
			obj.setMergeHistory(ims.core.patient.domain.objects.PatientMergeHistory.getPatientMergeHistoryfromXML(fldEl, factory, domMap)); 
		}
	}
	...
	public static final String ID = "id";
		...
		public static final String PriorPatient = "priorPatient";
		public static final String MergeHistory = "mergeHistory";
	}
}
