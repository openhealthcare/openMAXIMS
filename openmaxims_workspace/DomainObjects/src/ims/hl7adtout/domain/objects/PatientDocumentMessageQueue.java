...
public class PatientDocumentMessageQueue extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1103100001;
	private static final long serialVersionUID = 1103100001L;
	...
	private ims.core.documents.domain.objects.PatientDocument patientDocument;
	/** SystemInformation */
	private ims.domain.SystemInformation systemInformation = new ims.domain.SystemInformation();
    public PatientDocumentMessageQueue (Integer id, int ver)
    {
    	super(id, ver);
    }
    public PatientDocumentMessageQueue ()
    {
    	super();
    }
    public PatientDocumentMessageQueue (Integer id, int ver, Boolean includeRecord)
    {
    	super(id, ver, includeRecord);
    }
	public Class getRealDomainClass()
	{
		return ims.hl7adtout.domain.objects.PatientDocumentMessageQueue.class;
	}
	...
	public ims.core.documents.domain.objects.PatientDocument getPatientDocument() {
		return patientDocument;
	}
	public void setPatientDocument(ims.core.documents.domain.objects.PatientDocument patientDocument) {
	...
	public String toAuditString()
	{
		...
		{
			auditStr.append(toShortClassName(patientDocument));
				
		    auditStr.append(patientDocument.getId());
		}
	    auditStr.append("; ");
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "PatientDocumentMessageQueue";
	...
	public String fieldsToXMLString(java.util.HashMap domMap)
	{
		...
		if (this.getPatientDocument() != null)
		{
			sb.append("<patientDocument>");
			sb.append(this.getPatientDocument().toXMLString(domMap)); 	
			sb.append("</patientDocument>");		
		}
		return sb.toString();
	}
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			PatientDocumentMessageQueue domainObject = getPatientDocumentMessageQueuefromXML(itemEl, factory, domMap);
	...
	public static PatientDocumentMessageQueue getPatientDocumentMessageQueuefromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getPatientDocumentMessageQueuefromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static PatientDocumentMessageQueue getPatientDocumentMessageQueuefromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!PatientDocumentMessageQueue.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!PatientDocumentMessageQueue.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the PatientDocumentMessageQueue class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (PatientDocumentMessageQueue)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(PatientDocumentMessageQueue.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		PatientDocumentMessageQueue ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (PatientDocumentMessageQueue)factory.getImportedDomainObject(PatientDocumentMessageQueue.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new PatientDocumentMessageQueue();
		}
		String keyClassName = "PatientDocumentMessageQueue";
		...
		if (impObj != null)
		{
			return (PatientDocumentMessageQueue)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, PatientDocumentMessageQueue obj, java.util.HashMap domMap) throws Exception
	{
		...
		fldEl = el.element("patientDocument");
		if(fldEl != null)
		{
			fldEl = fldEl.element("class");		
			obj.setPatientDocument(ims.core.documents.domain.objects.PatientDocument.getPatientDocumentfromXML(fldEl, factory, domMap)); 
		}
	}
	...
	public static final String ID = "id";
		...
		public static final String PatientDocument = "patientDocument";
	}
}
