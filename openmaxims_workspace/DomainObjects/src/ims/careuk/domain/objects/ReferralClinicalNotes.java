...
public class ReferralClinicalNotes extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	...
	/** ClinicalNotes
	  * Collection of ims.careuk.domain.objects.AppointmentClinicalNotes.
	  */
	private java.util.Set clinicalNotes;
	/** Diagnosis
	  * Collection of ims.careuk.domain.objects.PatientDiagnosisApptDetail.
	  */
	private java.util.Set diagnosis;
	/** Procedures
	  * Collection of ims.careuk.domain.objects.PatientProcedureApptDetail.
	  */
	...
	public String toAuditString()
	{
		...
		if (clinicalNotes != null)
		{
			...
			while (it2.hasNext())
			{
				if (i2 > 0)
					auditStr.append(",");
				ims.careuk.domain.objects.AppointmentClinicalNotes obj = (ims.careuk.domain.objects.AppointmentClinicalNotes)it2.next();
		if (obj != null)
		{
		   if (i2 == 0)
		   {
		...
		if (diagnosis != null)
		{
			...
			while (it3.hasNext())
			{
				if (i3 > 0)
					auditStr.append(",");
				ims.careuk.domain.objects.PatientDiagnosisApptDetail obj = (ims.careuk.domain.objects.PatientDiagnosisApptDetail)it3.next();
		if (obj != null)
		{
		   if (i3 == 0)
		   {
		...
		if (procedures != null)
		{
			...
			while (it4.hasNext())
			{
				if (i4 > 0)
					auditStr.append(",");
				ims.careuk.domain.objects.PatientProcedureApptDetail obj = (ims.careuk.domain.objects.PatientProcedureApptDetail)it4.next();
		if (obj != null)
		{
		   if (i4 == 0)
		   {
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, ReferralClinicalNotes obj, java.util.HashMap domMap) throws Exception
	{
		...
		if(fldEl != null)
		{
			...
			obj.setClinicalNotes(ims.careuk.domain.objects.AppointmentClinicalNotes.fromSetXMLString(fldEl, factory, obj.getClinicalNotes(), domMap));
		}
		fldEl = el.element("diagnosis");
		if(fldEl != null)
		{
			fldEl = fldEl.element("set");	
			obj.setDiagnosis(ims.careuk.domain.objects.PatientDiagnosisApptDetail.fromSetXMLString(fldEl, factory, obj.getDiagnosis(), domMap));
		}
		fldEl = el.element("procedures");
		if(fldEl != null)
		{
			fldEl = fldEl.element("set");	
			obj.setProcedures(ims.careuk.domain.objects.PatientProcedureApptDetail.fromSetXMLString(fldEl, factory, obj.getProcedures(), domMap));
		}
	}
