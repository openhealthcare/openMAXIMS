...
public class PatientElectiveList extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	...
	/** ElectiveListStatus */
	private ims.careuk.domain.objects.ElectiveListStatus electiveListStatus;
	/** ElectiveListStatus History
	  * Collection of ims.careuk.domain.objects.ElectiveListStatus.
	  */
	private java.util.List electiveListStatusHistory;
	/** Patient */
	private ims.core.patient.domain.objects.Patient patient;
	/** Referral */
	private ims.careuk.domain.objects.CatsReferral referral;
	/** EpisodeOfCare */
	...
	/** Suspensions
	  * Collection of ims.careuk.domain.objects.SuspensionDetailsForPatientElectiveList.
	  */
	...
	/** TCIDetails */
	private ims.careuk.domain.objects.TCIForPatientElectiveList tCIDetails;
	/** TCIHistory
	  * Collection of ims.careuk.domain.objects.TCIForPatientElectiveList.
	  */
	...
	/** Notes
	  * Collection of ims.careuk.domain.objects.NotesForPatientElectiveList.
	  */
	private java.util.Set notes;
	/** EROD */
	private ims.careuk.domain.objects.ReferralEROD eROD;
	/** EROD history
	...
	/** Reviews
	  * Collection of ims.careuk.domain.objects.ReviewPatientElectiveList.
	  */
	...
	{
		return ims.careuk.domain.objects.PatientElectiveList.class;
	}
	...
	public ims.careuk.domain.objects.ElectiveListStatus getElectiveListStatus() {
		return electiveListStatus;
	}
	public void setElectiveListStatus(ims.careuk.domain.objects.ElectiveListStatus electiveListStatus) {
	...
	public ims.careuk.domain.objects.CatsReferral getReferral() {
		return referral;
	}
	public void setReferral(ims.careuk.domain.objects.CatsReferral referral) {
	...
	public ims.careuk.domain.objects.TCIForPatientElectiveList getTCIDetails() {
		return tCIDetails;
	}
	public void setTCIDetails(ims.careuk.domain.objects.TCIForPatientElectiveList tCIDetails) {
	...
	public ims.careuk.domain.objects.ReferralEROD getEROD() {
		return eROD;
	}
	public void setEROD(ims.careuk.domain.objects.ReferralEROD eROD) {
		this.eROD = eROD;
	}
	...
	public String toAuditString()
	{
		...
		for (i3=0; i3<electiveListStatusHistory.size(); i3++)
		{
			if (i3 > 0)
				auditStr.append(",");
			ims.careuk.domain.objects.ElectiveListStatus obj = (ims.careuk.domain.objects.ElectiveListStatus)electiveListStatusHistory.get(i3);
		    if (obj != null)
			{
				if (i3 == 0)
				{
		...
		for (i20=0; i20<suspensions.size(); i20++)
		{
			if (i20 > 0)
				auditStr.append(",");
			ims.careuk.domain.objects.SuspensionDetailsForPatientElectiveList obj = (ims.careuk.domain.objects.SuspensionDetailsForPatientElectiveList)suspensions.get(i20);
		    if (obj != null)
			{
				if (i20 == 0)
				{
		...
		for (i28=0; i28<tCIHistory.size(); i28++)
		{
			if (i28 > 0)
				auditStr.append(",");
			ims.careuk.domain.objects.TCIForPatientElectiveList obj = (ims.careuk.domain.objects.TCIForPatientElectiveList)tCIHistory.get(i28);
		    if (obj != null)
			{
				if (i28 == 0)
				{
		...
		if (notes != null)
		{
			...
			while (it36.hasNext())
			{
				if (i36 > 0)
					auditStr.append(",");
				ims.careuk.domain.objects.NotesForPatientElectiveList obj = (ims.careuk.domain.objects.NotesForPatientElectiveList)it36.next();
		if (obj != null)
		{
		   if (i36 == 0)
		   {
		...
		for (i38=0; i38<eRODHistory.size(); i38++)
		{
			if (i38 > 0)
				auditStr.append(",");
			ims.careuk.domain.objects.ReferralEROD obj = (ims.careuk.domain.objects.ReferralEROD)eRODHistory.get(i38);
		    if (obj != null)
			{
				if (i38 == 0)
				{
		...
		if (reviews != null)
		{
			...
			while (it41.hasNext())
			{
				if (i41 > 0)
					auditStr.append(",");
				ims.careuk.domain.objects.ReviewPatientElectiveList obj = (ims.careuk.domain.objects.ReviewPatientElectiveList)it41.next();
		if (obj != null)
		{
		   if (i41 == 0)
		   {
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, PatientElectiveList obj, java.util.HashMap domMap) throws Exception
	{
		...
		{
			fldEl = fldEl.element("class");		
			obj.setElectiveListStatus(ims.careuk.domain.objects.ElectiveListStatus.getElectiveListStatusfromXML(fldEl, factory, domMap)); 
		}
		fldEl = el.element("electiveListStatusHistory");
		if(fldEl != null)
		{
			fldEl = fldEl.element("list");	
			obj.setElectiveListStatusHistory(ims.careuk.domain.objects.ElectiveListStatus.fromListXMLString(fldEl, factory, obj.getElectiveListStatusHistory(), domMap));
		}
		...
		{
			fldEl = fldEl.element("class");		
			obj.setReferral(ims.careuk.domain.objects.CatsReferral.getCatsReferralfromXML(fldEl, factory, domMap)); 
		}
		...
		{
			fldEl = fldEl.element("list");	
			obj.setSuspensions(ims.careuk.domain.objects.SuspensionDetailsForPatientElectiveList.fromListXMLString(fldEl, factory, obj.getSuspensions(), domMap));
		}
		...
		{
			fldEl = fldEl.element("class");		
			obj.setTCIDetails(ims.careuk.domain.objects.TCIForPatientElectiveList.getTCIForPatientElectiveListfromXML(fldEl, factory, domMap)); 
		}
		fldEl = el.element("tCIHistory");
		if(fldEl != null)
		{
			fldEl = fldEl.element("list");	
			obj.setTCIHistory(ims.careuk.domain.objects.TCIForPatientElectiveList.fromListXMLString(fldEl, factory, obj.getTCIHistory(), domMap));
		}
		...
		if(fldEl != null)
		{
			...
			obj.setNotes(ims.careuk.domain.objects.NotesForPatientElectiveList.fromSetXMLString(fldEl, factory, obj.getNotes(), domMap));
		}
		fldEl = el.element("eROD");
		if(fldEl != null)
		{
			fldEl = fldEl.element("class");		
			obj.setEROD(ims.careuk.domain.objects.ReferralEROD.getReferralERODfromXML(fldEl, factory, domMap)); 
		}
		fldEl = el.element("eRODHistory");
		if(fldEl != null)
		{
			fldEl = fldEl.element("list");	
			obj.setERODHistory(ims.careuk.domain.objects.ReferralEROD.fromListXMLString(fldEl, factory, obj.getERODHistory(), domMap));
		}
		...
		{
			fldEl = fldEl.element("set");	
			obj.setReviews(ims.careuk.domain.objects.ReviewPatientElectiveList.fromSetXMLString(fldEl, factory, obj.getReviews(), domMap));
		}
