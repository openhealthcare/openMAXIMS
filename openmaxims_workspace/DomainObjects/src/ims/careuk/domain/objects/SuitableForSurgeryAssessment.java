...
public class SuitableForSurgeryAssessment extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	...
	/** Comments
	  * Collection of ims.careuk.domain.objects.SuitableForSurgeryComment.
	  */
	...
	{
		return ims.careuk.domain.objects.SuitableForSurgeryAssessment.class;
	}
	...
	public String toAuditString()
	{
		...
		if (comments != null)
		{
			...
			while (it12.hasNext())
			{
				if (i12 > 0)
					auditStr.append(",");
				ims.careuk.domain.objects.SuitableForSurgeryComment obj = (ims.careuk.domain.objects.SuitableForSurgeryComment)it12.next();
		if (obj != null)
		{
		   if (i12 == 0)
		   {
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, SuitableForSurgeryAssessment obj, java.util.HashMap domMap) throws Exception
	{
		...
		if(fldEl != null)
		{
			...
			obj.setComments(ims.careuk.domain.objects.SuitableForSurgeryComment.fromSetXMLString(fldEl, factory, obj.getComments(), domMap));
		}
	...
	{	
		// Private keys for engine hash map
            ...
            if (engine.getValue(IsFitKey) == null)
            {
                  ...
                  java.util.List<ims.careuk.domain.objects.FitForSurgeryAssesment> list = factory.find(hqlQuery, keys, values);
            ...
            ims.careuk.domain.objects.FitForSurgeryAssesment fitForSurgery = (ims.careuk.domain.objects.FitForSurgeryAssesment) engine.getValue(IsFitKey);
