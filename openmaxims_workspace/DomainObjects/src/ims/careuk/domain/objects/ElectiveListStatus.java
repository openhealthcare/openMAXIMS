...
public class ElectiveListStatus extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1096100066;
	private static final long serialVersionUID = 1096100066L;
	...
	/** ElectiveListStatus */
	private ims.domain.lookups.LookupInstance electiveListStatus;
	/** User */
    ...
    public ElectiveListStatus ()
    {
    	super();
    }
    public ElectiveListStatus (Integer id, int ver, Boolean includeRecord)
    {
    	super(id, ver, includeRecord);
    }
	public Class getRealDomainClass()
	{
		return ims.careuk.domain.objects.ElectiveListStatus.class;
	}


	public ims.domain.lookups.LookupInstance getElectiveListStatus() {
		return electiveListStatus;
	}
	public void setElectiveListStatus(ims.domain.lookups.LookupInstance electiveListStatus) {
	...
	public ims.domain.lookups.LookupInstance getRemovalOtherReason() {
		return removalOtherReason;
	}
	public void setRemovalOtherReason(ims.domain.lookups.LookupInstance removalOtherReason) {
	...
	public String toAuditString()
	{
		...
		if (electiveListStatus != null)
			auditStr.append(electiveListStatus.getText());
	    auditStr.append("; ");
		auditStr.append("\r\n*authoringUser* :");
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "ElectiveListStatus";
	...
	public String fieldsToXMLString(java.util.HashMap domMap)
	{
		...
		if (this.getElectiveListStatus() != null)
		{
			...
			sb.append(this.getElectiveListStatus().toXMLString()); 
			sb.append("</electiveListStatus>");		
		}
		...
		if (this.getRemovalOtherReason() != null)
		{
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			ElectiveListStatus domainObject = getElectiveListStatusfromXML(itemEl, factory, domMap);
	...
	public static ElectiveListStatus getElectiveListStatusfromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getElectiveListStatusfromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static ElectiveListStatus getElectiveListStatusfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!ElectiveListStatus.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!ElectiveListStatus.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the ElectiveListStatus class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (ElectiveListStatus)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(ElectiveListStatus.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		ElectiveListStatus ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (ElectiveListStatus)factory.getImportedDomainObject(ElectiveListStatus.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new ElectiveListStatus();
		}
		String keyClassName = "ElectiveListStatus";
		...
		if (impObj != null)
		{
			return (ElectiveListStatus)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, ElectiveListStatus obj, java.util.HashMap domMap) throws Exception
	{
		...
		if(fldEl != null)
		{
			...
			obj.setElectiveListStatus(ims.domain.lookups.LookupInstance.fromXMLString(fldEl, factory)); 	
		}
		...
		fldEl = el.element("removalOtherReason");
		if(fldEl != null)
		{
			fldEl = fldEl.element("lki");
