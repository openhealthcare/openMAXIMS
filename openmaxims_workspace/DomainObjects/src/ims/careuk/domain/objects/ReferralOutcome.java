...
public class ReferralOutcome extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	...
	private ims.careuk.domain.objects.DischargeOutcome referralDischarge;
	/** Further Management Details
	  * Collection of ims.careuk.domain.objects.FurtherManagement.
	  */
	private java.util.Set furtherManagementDetails;
	/** Prescriptions
	  * Collection of ims.careuk.domain.objects.Prescription.
	  */
	private java.util.Set prescriptions;
	/** Discharge Details for the Referral
	  * Collection of ims.careuk.domain.objects.DischargeOutcome.
	  */
	...
	/** Active Monitoring */
	private ims.careuk.domain.objects.ActiveMonitoring activeMonitoring;
	/** SystemInformation */
	...
	{
		return ims.careuk.domain.objects.ReferralOutcome.class;
	}
	...
	public ims.careuk.domain.objects.DischargeOutcome getReferralDischarge() {
		return referralDischarge;
	}
	public void setReferralDischarge(ims.careuk.domain.objects.DischargeOutcome referralDischarge) {
	...
	public ims.careuk.domain.objects.ActiveMonitoring getActiveMonitoring() {
		return activeMonitoring;
	}
	public void setActiveMonitoring(ims.careuk.domain.objects.ActiveMonitoring activeMonitoring) {
	...
	public String toAuditString()
	{
		...
		if (furtherManagementDetails != null)
		{
			...
			while (it4.hasNext())
			{
				if (i4 > 0)
					auditStr.append(",");
				ims.careuk.domain.objects.FurtherManagement obj = (ims.careuk.domain.objects.FurtherManagement)it4.next();
		if (obj != null)
		{
		   if (i4 == 0)
		   {
		...
		if (prescriptions != null)
		{
			...
			while (it5.hasNext())
			{
				if (i5 > 0)
					auditStr.append(",");
				ims.careuk.domain.objects.Prescription obj = (ims.careuk.domain.objects.Prescription)it5.next();
		if (obj != null)
		{
		   if (i5 == 0)
		   {
		...
		if (referralDischargeHistory != null)
		{
			...
			while (it6.hasNext())
			{
				if (i6 > 0)
					auditStr.append(",");
				ims.careuk.domain.objects.DischargeOutcome obj = (ims.careuk.domain.objects.DischargeOutcome)it6.next();
		if (obj != null)
		{
		   if (i6 == 0)
		   {
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, ReferralOutcome obj, java.util.HashMap domMap) throws Exception
	{
		...
		{
			fldEl = fldEl.element("class");		
			obj.setReferralDischarge(ims.careuk.domain.objects.DischargeOutcome.getDischargeOutcomefromXML(fldEl, factory, domMap)); 
		}
		fldEl = el.element("furtherManagementDetails");
		if(fldEl != null)
		{
			fldEl = fldEl.element("set");	
			obj.setFurtherManagementDetails(ims.careuk.domain.objects.FurtherManagement.fromSetXMLString(fldEl, factory, obj.getFurtherManagementDetails(), domMap));
		}
		fldEl = el.element("prescriptions");
		if(fldEl != null)
		{
			fldEl = fldEl.element("set");	
			obj.setPrescriptions(ims.careuk.domain.objects.Prescription.fromSetXMLString(fldEl, factory, obj.getPrescriptions(), domMap));
		}
		fldEl = el.element("referralDischargeHistory");
		if(fldEl != null)
		{
			fldEl = fldEl.element("set");	
			obj.setReferralDischargeHistory(ims.careuk.domain.objects.DischargeOutcome.fromSetXMLString(fldEl, factory, obj.getReferralDischargeHistory(), domMap));
		}
		...
		{
			fldEl = fldEl.element("class");		
			obj.setActiveMonitoring(ims.careuk.domain.objects.ActiveMonitoring.getActiveMonitoringfromXML(fldEl, factory, domMap)); 
		}
	}
