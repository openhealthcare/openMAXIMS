...
public class ReferralCoding extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	...
	/** CodingItems
	  * Collection of ims.careuk.domain.objects.ReferralCodingItem.
	  */
	...
	{
		return ims.careuk.domain.objects.ReferralCoding.class;
	}
	...
	public String toAuditString()
	{
		...
		for (i3=0; i3<codingItems.size(); i3++)
		{
			if (i3 > 0)
				auditStr.append(",");
			ims.careuk.domain.objects.ReferralCodingItem obj = (ims.careuk.domain.objects.ReferralCodingItem)codingItems.get(i3);
		    if (obj != null)
			{
				if (i3 == 0)
				{
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, ReferralCoding obj, java.util.HashMap domMap) throws Exception
	{
		...
		if(fldEl != null)
		{
			...
			obj.setCodingItems(ims.careuk.domain.objects.ReferralCodingItem.fromListXMLString(fldEl, factory, obj.getCodingItems(), domMap));
		}
