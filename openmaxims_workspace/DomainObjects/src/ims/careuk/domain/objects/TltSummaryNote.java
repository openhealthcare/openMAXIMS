...
public class TltSummaryNote extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1096100035;
	private static final long serialVersionUID = 1096100035L;
    ...
    public TltSummaryNote (Integer id, int ver)
    {
    	super(id, ver);
    }
    public TltSummaryNote ()
    {
    	super();
    }
    public TltSummaryNote (Integer id, int ver, Boolean includeRecord)
    {
    	super(id, ver, includeRecord);
    }
	public Class getRealDomainClass()
	{
		return ims.careuk.domain.objects.TltSummaryNote.class;
	}
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "TltSummaryNote";
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			TltSummaryNote domainObject = getTltSummaryNotefromXML(itemEl, factory, domMap);
	...
	public static TltSummaryNote getTltSummaryNotefromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getTltSummaryNotefromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static TltSummaryNote getTltSummaryNotefromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!TltSummaryNote.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!TltSummaryNote.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the TltSummaryNote class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (TltSummaryNote)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(TltSummaryNote.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		TltSummaryNote ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (TltSummaryNote)factory.getImportedDomainObject(TltSummaryNote.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new TltSummaryNote();
		}
		String keyClassName = "TltSummaryNote";
		...
		if (impObj != null)
		{
			return (TltSummaryNote)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, TltSummaryNote obj, java.util.HashMap domMap) throws Exception
	{
