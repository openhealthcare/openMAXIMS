...
public class ConsultationDetails extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	...
	/** ConsultationTime
	  * Collection of ims.careuk.domain.objects.ConsultationTime.
	  */
	private java.util.Set consultationTimes;
	/** ClinicalContactTime
	  * Collection of ims.careuk.domain.objects.ClinicalContactTime.
	  */
	private java.util.Set clinicalContactTime;
	/** ClinicalContactTime
	  * Collection of ims.careuk.domain.objects.TltContactTime.
	  */
	private java.util.Set tltTimes;
	/** Referral Summary */
	private ims.careuk.domain.objects.PresentationReferralSummary referralSummary;
	/** Baseline Observations */
	private ims.careuk.domain.objects.NursingNotes baselineObs;
	/** OnExam */
	private ims.careuk.domain.objects.OnExamination onExam;
	/** At Consultation */
	private ims.careuk.domain.objects.AtConsultation atConsultation;
	/** Outcome */
	private ims.careuk.domain.objects.ReferralOutcome outcome;
	/** SystemInformation */
	...
	{
		return ims.careuk.domain.objects.ConsultationDetails.class;
	}
	...
	public ims.careuk.domain.objects.PresentationReferralSummary getReferralSummary() {
		return referralSummary;
	}
	public void setReferralSummary(ims.careuk.domain.objects.PresentationReferralSummary referralSummary) {
		this.referralSummary = referralSummary;
	}

	public ims.careuk.domain.objects.NursingNotes getBaselineObs() {
		return baselineObs;
	}
	public void setBaselineObs(ims.careuk.domain.objects.NursingNotes baselineObs) {
		this.baselineObs = baselineObs;
	}

	public ims.careuk.domain.objects.OnExamination getOnExam() {
		return onExam;
	}
	public void setOnExam(ims.careuk.domain.objects.OnExamination onExam) {
		this.onExam = onExam;
	}

	public ims.careuk.domain.objects.AtConsultation getAtConsultation() {
		return atConsultation;
	}
	public void setAtConsultation(ims.careuk.domain.objects.AtConsultation atConsultation) {
		this.atConsultation = atConsultation;
	}

	public ims.careuk.domain.objects.ReferralOutcome getOutcome() {
		return outcome;
	}
	public void setOutcome(ims.careuk.domain.objects.ReferralOutcome outcome) {
	...
	public String toAuditString()
	{
		...
		if (consultationTimes != null)
		{
			...
			while (it3.hasNext())
			{
				if (i3 > 0)
					auditStr.append(",");
				ims.careuk.domain.objects.ConsultationTime obj = (ims.careuk.domain.objects.ConsultationTime)it3.next();
		if (obj != null)
		{
		   if (i3 == 0)
		   {
		...
		if (clinicalContactTime != null)
		{
			...
			while (it4.hasNext())
			{
				if (i4 > 0)
					auditStr.append(",");
				ims.careuk.domain.objects.ClinicalContactTime obj = (ims.careuk.domain.objects.ClinicalContactTime)it4.next();
		if (obj != null)
		{
		   if (i4 == 0)
		   {
		...
		if (tltTimes != null)
		{
			...
			while (it5.hasNext())
			{
				if (i5 > 0)
					auditStr.append(",");
				ims.careuk.domain.objects.TltContactTime obj = (ims.careuk.domain.objects.TltContactTime)it5.next();
		if (obj != null)
		{
		   if (i5 == 0)
		   {
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, ConsultationDetails obj, java.util.HashMap domMap) throws Exception
	{
		...
		if(fldEl != null)
		{
			...
			obj.setConsultationTimes(ims.careuk.domain.objects.ConsultationTime.fromSetXMLString(fldEl, factory, obj.getConsultationTimes(), domMap));
		}
		fldEl = el.element("clinicalContactTime");
		if(fldEl != null)
		{
			fldEl = fldEl.element("set");	
			obj.setClinicalContactTime(ims.careuk.domain.objects.ClinicalContactTime.fromSetXMLString(fldEl, factory, obj.getClinicalContactTime(), domMap));
		}
		fldEl = el.element("tltTimes");
		if(fldEl != null)
		{
			fldEl = fldEl.element("set");	
			obj.setTltTimes(ims.careuk.domain.objects.TltContactTime.fromSetXMLString(fldEl, factory, obj.getTltTimes(), domMap));
		}
		fldEl = el.element("referralSummary");
		if(fldEl != null)
		{
			fldEl = fldEl.element("class");		
			obj.setReferralSummary(ims.careuk.domain.objects.PresentationReferralSummary.getPresentationReferralSummaryfromXML(fldEl, factory, domMap)); 
		}
		fldEl = el.element("baselineObs");
		if(fldEl != null)
		{
			fldEl = fldEl.element("class");		
			obj.setBaselineObs(ims.careuk.domain.objects.NursingNotes.getNursingNotesfromXML(fldEl, factory, domMap)); 
		}
		fldEl = el.element("onExam");
		if(fldEl != null)
		{
			fldEl = fldEl.element("class");		
			obj.setOnExam(ims.careuk.domain.objects.OnExamination.getOnExaminationfromXML(fldEl, factory, domMap)); 
		}
		fldEl = el.element("atConsultation");
		if(fldEl != null)
		{
			fldEl = fldEl.element("class");		
			obj.setAtConsultation(ims.careuk.domain.objects.AtConsultation.getAtConsultationfromXML(fldEl, factory, domMap)); 
		}
		fldEl = el.element("outcome");
		if(fldEl != null)
		{
			fldEl = fldEl.element("class");		
			obj.setOutcome(ims.careuk.domain.objects.ReferralOutcome.getReferralOutcomefromXML(fldEl, factory, domMap)); 
		}
	}
