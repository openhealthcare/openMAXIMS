...
public class CatsReferral extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	...
	private ims.careuk.domain.objects.CATSReferralStatus currentStatus;
	/** CATS Referral Status History
	  * Collection of ims.careuk.domain.objects.CATSReferralStatus.
	  */
	private java.util.Set statusHistory;
	/** Order Investigation Appointments
	  * Collection of ims.careuk.domain.objects.OrderInvAppt.
	  */
	private java.util.Set orderInvAppts;
	/** Appointment Call Attempts
	  * Collection of ims.careuk.domain.objects.AppointmentCallAttempts.
	  */
	...
	private ims.careuk.domain.objects.ReferralReject rejectReferralDetail;
	/** Referral has a Rejected Investigation requiring Review */
	private Boolean hasRejectedInv;
	/** Provider Cancellation */
	private ims.careuk.domain.objects.ProviderCancellation providerCancellation;
	/** Is the Referral Flagged For Review */
	private Boolean isFlaggedForReview;
	/** Current Review Detail 
	  * Collection of ims.careuk.domain.objects.ReviewReferralDetail.
	  */
	...
	/** Used to hold a collection of Reports Required to be printed
	  * Collection of ims.careuk.domain.objects.ReportsRequiredForPrinting.
	  */
	...
	private ims.careuk.domain.objects.AwaitingClinicalInfo awaitingClinicalInfo;
	...
	/** Elective EROD
	  * Collection of ims.careuk.domain.objects.ReferralEROD.
	  */
	...
	/** Referral Transfer */
	private ims.careuk.domain.objects.ReferralTransfer referralTransfer;
	...
	{
		return ims.careuk.domain.objects.CatsReferral.class;
	}
	...
	public ims.careuk.domain.objects.CATSReferralStatus getCurrentStatus() {
		return currentStatus;
	}
	public void setCurrentStatus(ims.careuk.domain.objects.CATSReferralStatus currentStatus) {
	...
	public ims.careuk.domain.objects.ReferralReject getRejectReferralDetail() {
		return rejectReferralDetail;
	}
	public void setRejectReferralDetail(ims.careuk.domain.objects.ReferralReject rejectReferralDetail) {
	...
	public ims.careuk.domain.objects.ProviderCancellation getProviderCancellation() {
		return providerCancellation;
	}
	public void setProviderCancellation(ims.careuk.domain.objects.ProviderCancellation providerCancellation) {
	...
	public ims.careuk.domain.objects.AwaitingClinicalInfo getAwaitingClinicalInfo() {
		return awaitingClinicalInfo;
	}
	public void setAwaitingClinicalInfo(ims.careuk.domain.objects.AwaitingClinicalInfo awaitingClinicalInfo) {
	...
	public ims.careuk.domain.objects.ReferralTransfer getReferralTransfer() {
		return referralTransfer;
	}
	public void setReferralTransfer(ims.careuk.domain.objects.ReferralTransfer referralTransfer) {
	...
	public String toAuditString()
	{
		...
		if (statusHistory != null)
		{
			...
			while (it13.hasNext())
			{
				if (i13 > 0)
					auditStr.append(",");
				ims.careuk.domain.objects.CATSReferralStatus obj = (ims.careuk.domain.objects.CATSReferralStatus)it13.next();
		if (obj != null)
		{
		   if (i13 == 0)
		   {
		...
		if (orderInvAppts != null)
		{
			...
			while (it14.hasNext())
			{
				if (i14 > 0)
					auditStr.append(",");
				ims.careuk.domain.objects.OrderInvAppt obj = (ims.careuk.domain.objects.OrderInvAppt)it14.next();
		if (obj != null)
		{
		   if (i14 == 0)
		   {
		...
		if (callAttempts != null)
		{
			...
			while (it15.hasNext())
			{
				if (i15 > 0)
					auditStr.append(",");
				ims.careuk.domain.objects.AppointmentCallAttempts obj = (ims.careuk.domain.objects.AppointmentCallAttempts)it15.next();
		if (obj != null)
		{
		   if (i15 == 0)
		   {
		...
		if (currentReviewDetail != null)
		{
			...
			while (it24.hasNext())
			{
				if (i24 > 0)
					auditStr.append(",");
				ims.careuk.domain.objects.ReviewReferralDetail obj = (ims.careuk.domain.objects.ReviewReferralDetail)it24.next();
		if (obj != null)
		{
		   if (i24 == 0)
		   {
		...
		if (reviewHistory != null)
		{
			...
			while (it25.hasNext())
			{
				if (i25 > 0)
					auditStr.append(",");
				ims.careuk.domain.objects.ReviewReferralDetail obj = (ims.careuk.domain.objects.ReviewReferralDetail)it25.next();
		if (obj != null)
		{
		   if (i25 == 0)
		   {
		...
		if (reportsRequired != null)
		{
			...
			while (it50.hasNext())
			{
				if (i50 > 0)
					auditStr.append(",");
				ims.careuk.domain.objects.ReportsRequiredForPrinting obj = (ims.careuk.domain.objects.ReportsRequiredForPrinting)it50.next();
		if (obj != null)
		{
		   if (i50 == 0)
		   {
		...
		for (i69=0; i69<electiveEROD.size(); i69++)
		{
			if (i69 > 0)
				auditStr.append(",");
			ims.careuk.domain.objects.ReferralEROD obj = (ims.careuk.domain.objects.ReferralEROD)electiveEROD.get(i69);
		    if (obj != null)
			{
				if (i69 == 0)
				{
		...
		for (i70=0; i70<electiveERODHistory.size(); i70++)
		{
			if (i70 > 0)
				auditStr.append(",");
			ims.careuk.domain.objects.ReferralEROD obj = (ims.careuk.domain.objects.ReferralEROD)electiveERODHistory.get(i70);
		    if (obj != null)
			{
				if (i70 == 0)
				{
		...
		for (i71=0; i71<outpatientEROD.size(); i71++)
		{
			if (i71 > 0)
				auditStr.append(",");
			ims.careuk.domain.objects.ReferralEROD obj = (ims.careuk.domain.objects.ReferralEROD)outpatientEROD.get(i71);
		    if (obj != null)
			{
				if (i71 == 0)
				{
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, CatsReferral obj, java.util.HashMap domMap) throws Exception
	{
		...
		{
			fldEl = fldEl.element("class");		
			obj.setCurrentStatus(ims.careuk.domain.objects.CATSReferralStatus.getCATSReferralStatusfromXML(fldEl, factory, domMap)); 
		}
		fldEl = el.element("statusHistory");
		if(fldEl != null)
		{
			fldEl = fldEl.element("set");	
			obj.setStatusHistory(ims.careuk.domain.objects.CATSReferralStatus.fromSetXMLString(fldEl, factory, obj.getStatusHistory(), domMap));
		}
		fldEl = el.element("orderInvAppts");
		if(fldEl != null)
		{
			fldEl = fldEl.element("set");	
			obj.setOrderInvAppts(ims.careuk.domain.objects.OrderInvAppt.fromSetXMLString(fldEl, factory, obj.getOrderInvAppts(), domMap));
		}
		fldEl = el.element("callAttempts");
		if(fldEl != null)
		{
			fldEl = fldEl.element("set");	
			obj.setCallAttempts(ims.careuk.domain.objects.AppointmentCallAttempts.fromSetXMLString(fldEl, factory, obj.getCallAttempts(), domMap));
		}
		...
		{
			fldEl = fldEl.element("class");		
			obj.setRejectReferralDetail(ims.careuk.domain.objects.ReferralReject.getReferralRejectfromXML(fldEl, factory, domMap)); 
		}
		...
		{
			fldEl = fldEl.element("class");		
			obj.setProviderCancellation(ims.careuk.domain.objects.ProviderCancellation.getProviderCancellationfromXML(fldEl, factory, domMap)); 
		}
		...
		{
			fldEl = fldEl.element("set");	
			obj.setCurrentReviewDetail(ims.careuk.domain.objects.ReviewReferralDetail.fromSetXMLString(fldEl, factory, obj.getCurrentReviewDetail(), domMap));
		}
		fldEl = el.element("reviewHistory");
		if(fldEl != null)
		{
			fldEl = fldEl.element("set");	
			obj.setReviewHistory(ims.careuk.domain.objects.ReviewReferralDetail.fromSetXMLString(fldEl, factory, obj.getReviewHistory(), domMap));
		}
		...
		{
			fldEl = fldEl.element("set");	
			obj.setReportsRequired(ims.careuk.domain.objects.ReportsRequiredForPrinting.fromSetXMLString(fldEl, factory, obj.getReportsRequired(), domMap));
		}
		...
		{
			fldEl = fldEl.element("class");		
			obj.setAwaitingClinicalInfo(ims.careuk.domain.objects.AwaitingClinicalInfo.getAwaitingClinicalInfofromXML(fldEl, factory, domMap)); 
		}
		...
		if(fldEl != null)
		{
			...
			obj.setElectiveEROD(ims.careuk.domain.objects.ReferralEROD.fromListXMLString(fldEl, factory, obj.getElectiveEROD(), domMap));
		}
		fldEl = el.element("electiveERODHistory");
		if(fldEl != null)
		{
			fldEl = fldEl.element("list");	
			obj.setElectiveERODHistory(ims.careuk.domain.objects.ReferralEROD.fromListXMLString(fldEl, factory, obj.getElectiveERODHistory(), domMap));
		}
		fldEl = el.element("outpatientEROD");
		if(fldEl != null)
		{
			fldEl = fldEl.element("list");	
			obj.setOutpatientEROD(ims.careuk.domain.objects.ReferralEROD.fromListXMLString(fldEl, factory, obj.getOutpatientEROD(), domMap));
		}
		...
		{
			fldEl = fldEl.element("class");		
			obj.setReferralTransfer(ims.careuk.domain.objects.ReferralTransfer.getReferralTransferfromXML(fldEl, factory, domMap)); 
		}
