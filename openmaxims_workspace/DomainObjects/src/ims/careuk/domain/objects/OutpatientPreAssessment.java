...
public class OutpatientPreAssessment extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	...
	private ims.careuk.domain.objects.SuitableForSurgeryAssessment suitableForSurgeryAssessment;
	/** Fit for Surgery Assesment */
	private ims.careuk.domain.objects.FitForSurgeryAssesment fitForSurgeryAssesment;
	/** SystemInformation */
	...
	{
		return ims.careuk.domain.objects.OutpatientPreAssessment.class;
	}
	...
	public ims.careuk.domain.objects.SuitableForSurgeryAssessment getSuitableForSurgeryAssessment() {
		return suitableForSurgeryAssessment;
	}
	public void setSuitableForSurgeryAssessment(ims.careuk.domain.objects.SuitableForSurgeryAssessment suitableForSurgeryAssessment) {
		this.suitableForSurgeryAssessment = suitableForSurgeryAssessment;
	}

	public ims.careuk.domain.objects.FitForSurgeryAssesment getFitForSurgeryAssesment() {
		return fitForSurgeryAssesment;
	}
	public void setFitForSurgeryAssesment(ims.careuk.domain.objects.FitForSurgeryAssesment fitForSurgeryAssesment) {
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, OutpatientPreAssessment obj, java.util.HashMap domMap) throws Exception
	{
		...
		{
			fldEl = fldEl.element("class");		
			obj.setSuitableForSurgeryAssessment(ims.careuk.domain.objects.SuitableForSurgeryAssessment.getSuitableForSurgeryAssessmentfromXML(fldEl, factory, domMap)); 
		}
		fldEl = el.element("fitForSurgeryAssesment");
		if(fldEl != null)
		{
			fldEl = fldEl.element("class");		
			obj.setFitForSurgeryAssesment(ims.careuk.domain.objects.FitForSurgeryAssesment.getFitForSurgeryAssesmentfromXML(fldEl, factory, domMap)); 
		}
	}
