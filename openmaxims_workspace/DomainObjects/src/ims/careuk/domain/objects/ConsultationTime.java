...
public class ConsultationTime extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1096100006;
	private static final long serialVersionUID = 1096100006L;
    ...
    public ConsultationTime (Integer id, int ver)
    {
    	super(id, ver);
    }
    ...
    public ConsultationTime (Integer id, int ver, Boolean includeRecord)
    {
    	super(id, ver, includeRecord);
    }
	public Class getRealDomainClass()
	{
		return ims.careuk.domain.objects.ConsultationTime.class;
	}
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "ConsultationTime";
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			ConsultationTime domainObject = getConsultationTimefromXML(itemEl, factory, domMap);
	...
	public static ConsultationTime getConsultationTimefromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getConsultationTimefromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static ConsultationTime getConsultationTimefromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!ConsultationTime.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!ConsultationTime.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the ConsultationTime class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (ConsultationTime)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(ConsultationTime.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		ConsultationTime ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (ConsultationTime)factory.getImportedDomainObject(ConsultationTime.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new ConsultationTime();
		}
		String keyClassName = "ConsultationTime";
		...
		if (impObj != null)
		{
			return (ConsultationTime)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, ConsultationTime obj, java.util.HashMap domMap) throws Exception
	{
