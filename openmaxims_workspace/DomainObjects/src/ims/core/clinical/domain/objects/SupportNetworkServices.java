...
public class SupportNetworkServices extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1003100011;
	private static final long serialVersionUID = 1003100011L;
    ...
    public SupportNetworkServices (Integer id, int ver)
    {
    	super(id, ver);
    }
    public SupportNetworkServices ()
    {
    	super();
    }
    public SupportNetworkServices (Integer id, int ver, Boolean includeRecord)
    {
    	super(id, ver, includeRecord);
    }
	public Class getRealDomainClass()
	{
		return ims.core.clinical.domain.objects.SupportNetworkServices.class;
	}
	...
	public void setFrequencyOfService(String frequencyOfService) {
		if ( null != frequencyOfService && frequencyOfService.length() > 255 ) {
			throw new ims.domain.exceptions.DomainRuntimeException("MaxLength ($MaxLength) exceeded for frequencyOfService. Tried to set value: "+
				frequencyOfService);
		}
	...
	public String toAuditString()
	{
	    ...
	    auditStr.append("; ");
		auditStr.append("\r\n*frequencyOfService* :");
		auditStr.append(frequencyOfService);
	    auditStr.append("; ");
		auditStr.append("\r\n*comments* :");
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "SupportNetworkServices";
	...
	public String fieldsToXMLString(java.util.HashMap domMap)
	{
		...
		if (this.getFrequencyOfService() != null)
		{
			sb.append("<frequencyOfService>");
			sb.append(ims.framework.utils.StringUtils.encodeXML(this.getFrequencyOfService().toString()));
			sb.append("</frequencyOfService>");		
		}
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			SupportNetworkServices domainObject = getSupportNetworkServicesfromXML(itemEl, factory, domMap);
	...
	public static SupportNetworkServices getSupportNetworkServicesfromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getSupportNetworkServicesfromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static SupportNetworkServices getSupportNetworkServicesfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!SupportNetworkServices.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!SupportNetworkServices.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the SupportNetworkServices class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (SupportNetworkServices)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(SupportNetworkServices.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		SupportNetworkServices ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (SupportNetworkServices)factory.getImportedDomainObject(SupportNetworkServices.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new SupportNetworkServices();
		}
		String keyClassName = "SupportNetworkServices";
		...
		if (impObj != null)
		{
			return (SupportNetworkServices)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, SupportNetworkServices obj, java.util.HashMap domMap) throws Exception
	{
		...
		fldEl = el.element("frequencyOfService");
		if(fldEl != null)
		{	
    		obj.setFrequencyOfService(new String(fldEl.getTextTrim()));	
		}
	...
	public static final String ID = "id";
		...
		public static final String FrequencyOfService = "frequencyOfService";
