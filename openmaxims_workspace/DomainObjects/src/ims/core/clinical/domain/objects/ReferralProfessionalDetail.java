...
public class ReferralProfessionalDetail extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1072100063;
	private static final long serialVersionUID = 1072100063L;
    ...
    public ReferralProfessionalDetail (Integer id, int ver)
    {
    	super(id, ver);
    }
    public ReferralProfessionalDetail ()
    {
    	super();
    }
    public ReferralProfessionalDetail (Integer id, int ver, Boolean includeRecord)
    {
    	super(id, ver, includeRecord);
    }
	public Class getRealDomainClass()
	{
		return ims.core.clinical.domain.objects.ReferralProfessionalDetail.class;
	}
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "ReferralProfessionalDetail";
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			ReferralProfessionalDetail domainObject = getReferralProfessionalDetailfromXML(itemEl, factory, domMap);
	...
	public static ReferralProfessionalDetail getReferralProfessionalDetailfromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getReferralProfessionalDetailfromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static ReferralProfessionalDetail getReferralProfessionalDetailfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!ReferralProfessionalDetail.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!ReferralProfessionalDetail.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the ReferralProfessionalDetail class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (ReferralProfessionalDetail)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(ReferralProfessionalDetail.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		ReferralProfessionalDetail ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (ReferralProfessionalDetail)factory.getImportedDomainObject(ReferralProfessionalDetail.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new ReferralProfessionalDetail();
		}
		String keyClassName = "ReferralProfessionalDetail";
		...
		if (impObj != null)
		{
			return (ReferralProfessionalDetail)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, ReferralProfessionalDetail obj, java.util.HashMap domMap) throws Exception
	{
