...
public class SuppNetworkServiceProfessionDetail extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1003100076;
	private static final long serialVersionUID = 1003100076L;
    ...
    public SuppNetworkServiceProfessionDetail (Integer id, int ver)
    {
    	super(id, ver);
    }
    public SuppNetworkServiceProfessionDetail ()
    {
    	super();
    }
    public SuppNetworkServiceProfessionDetail (Integer id, int ver, Boolean includeRecord)
    {
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "SuppNetworkServiceProfessionDetail";
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			SuppNetworkServiceProfessionDetail domainObject = getSuppNetworkServiceProfessionDetailfromXML(itemEl, factory, domMap);
	...
	public static SuppNetworkServiceProfessionDetail getSuppNetworkServiceProfessionDetailfromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getSuppNetworkServiceProfessionDetailfromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static SuppNetworkServiceProfessionDetail getSuppNetworkServiceProfessionDetailfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!SuppNetworkServiceProfessionDetail.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!SuppNetworkServiceProfessionDetail.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the SuppNetworkServiceProfessionDetail class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (SuppNetworkServiceProfessionDetail)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(SuppNetworkServiceProfessionDetail.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		SuppNetworkServiceProfessionDetail ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (SuppNetworkServiceProfessionDetail)factory.getImportedDomainObject(SuppNetworkServiceProfessionDetail.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new SuppNetworkServiceProfessionDetail();
		}
		String keyClassName = "SuppNetworkServiceProfessionDetail";
		...
		if (impObj != null)
		{
			return (SuppNetworkServiceProfessionDetail)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, SuppNetworkServiceProfessionDetail obj, java.util.HashMap domMap) throws Exception
	{
