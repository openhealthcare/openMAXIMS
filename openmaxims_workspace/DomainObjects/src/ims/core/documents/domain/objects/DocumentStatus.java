...
public class DocumentStatus extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1068100006;
	private static final long serialVersionUID = 1068100006L;
    ...
    public DocumentStatus (Integer id, int ver)
    {
    	super(id, ver);
    }
    ...
    public DocumentStatus (Integer id, int ver, Boolean includeRecord)
    {
    	super(id, ver, includeRecord);
    }
	public Class getRealDomainClass()
	{
		return ims.core.documents.domain.objects.DocumentStatus.class;
	}
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "DocumentStatus";
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			DocumentStatus domainObject = getDocumentStatusfromXML(itemEl, factory, domMap);
	...
	public static DocumentStatus getDocumentStatusfromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getDocumentStatusfromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static DocumentStatus getDocumentStatusfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!DocumentStatus.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!DocumentStatus.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the DocumentStatus class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (DocumentStatus)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(DocumentStatus.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		DocumentStatus ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (DocumentStatus)factory.getImportedDomainObject(DocumentStatus.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new DocumentStatus();
		}
		String keyClassName = "DocumentStatus";
		...
		if (impObj != null)
		{
			return (DocumentStatus)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, DocumentStatus obj, java.util.HashMap domMap) throws Exception
	{
