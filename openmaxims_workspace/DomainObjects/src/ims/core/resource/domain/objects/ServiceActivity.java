...
public class ServiceActivity extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1005100005;
	private static final long serialVersionUID = 1005100005L;
    ...
    public ServiceActivity (Integer id, int ver, Boolean includeRecord)
    {
    	super(id, ver, includeRecord);
    }
	public Class getRealDomainClass()
	{
		return ims.core.resource.domain.objects.ServiceActivity.class;
	}
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "ServiceActivity";
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			ServiceActivity domainObject = getServiceActivityfromXML(itemEl, factory, domMap);
	...
	public static ServiceActivity getServiceActivityfromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getServiceActivityfromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static ServiceActivity getServiceActivityfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!ServiceActivity.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!ServiceActivity.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the ServiceActivity class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (ServiceActivity)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(ServiceActivity.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		ServiceActivity ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (ServiceActivity)factory.getImportedDomainObject(ServiceActivity.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new ServiceActivity();
		}
		String keyClassName = "ServiceActivity";
		...
		if (impObj != null)
		{
			return (ServiceActivity)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, ServiceActivity obj, java.util.HashMap domMap) throws Exception
	{
