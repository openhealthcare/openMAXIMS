...
public class MergeRequest extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1001100007;
	private static final long serialVersionUID = 1001100007L;
	...
	/** The Patient unique id data is being merged from */
	private Integer sourcePatId;
	/** The Patient unique id data is being merged to */
	private Integer destinationPatId;
	/** User Requesting the Merge Operation */
	private ims.core.resource.people.domain.objects.MemberOfStaff requestedBy;
	/** Pending or Failed ( Failed = true ) */
    ...
    public MergeRequest (Integer id, int ver)
    {
    	super(id, ver);
    }
    public MergeRequest ()
    ...
    public MergeRequest (Integer id, int ver, Boolean includeRecord)
    {
    	super(id, ver, includeRecord);
    }
	public Class getRealDomainClass()
	{
		return ims.core.patient.domain.objects.MergeRequest.class;
	}
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "MergeRequest";
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			MergeRequest domainObject = getMergeRequestfromXML(itemEl, factory, domMap);
	...
	public static MergeRequest getMergeRequestfromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getMergeRequestfromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static MergeRequest getMergeRequestfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!MergeRequest.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!MergeRequest.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the MergeRequest class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (MergeRequest)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(MergeRequest.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		MergeRequest ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (MergeRequest)factory.getImportedDomainObject(MergeRequest.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new MergeRequest();
		}
		String keyClassName = "MergeRequest";
		...
		if (impObj != null)
		{
			return (MergeRequest)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, MergeRequest obj, java.util.HashMap domMap) throws Exception
	{
