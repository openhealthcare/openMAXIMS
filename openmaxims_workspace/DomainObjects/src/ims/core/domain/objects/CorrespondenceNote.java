...
public class CorrespondenceNote extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1096100013;
	private static final long serialVersionUID = 1096100013L;
    ...
    public CorrespondenceNote (Integer id, int ver)
    {
    	super(id, ver);
    }
    ...
    public CorrespondenceNote (Integer id, int ver, Boolean includeRecord)
    {
    	super(id, ver, includeRecord);
    }
	public Class getRealDomainClass()
	{
		return ims.core.domain.objects.CorrespondenceNote.class;
	}
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "CorrespondenceNote";
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			CorrespondenceNote domainObject = getCorrespondenceNotefromXML(itemEl, factory, domMap);
	...
	public static CorrespondenceNote getCorrespondenceNotefromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getCorrespondenceNotefromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static CorrespondenceNote getCorrespondenceNotefromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!CorrespondenceNote.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!CorrespondenceNote.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the CorrespondenceNote class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (CorrespondenceNote)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(CorrespondenceNote.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		CorrespondenceNote ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (CorrespondenceNote)factory.getImportedDomainObject(CorrespondenceNote.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new CorrespondenceNote();
		}
		String keyClassName = "CorrespondenceNote";
		...
		if (impObj != null)
		{
			return (CorrespondenceNote)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, CorrespondenceNote obj, java.util.HashMap domMap) throws Exception
	{
