...
public class EpisodeOfCareHistory extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1004100051;
	private static final long serialVersionUID = 1004100051L;
    ...
    public EpisodeOfCareHistory (Integer id, int ver)
    {
    	super(id, ver);
    }
    public EpisodeOfCareHistory ()
    {
    	super();
    }
    public EpisodeOfCareHistory (Integer id, int ver, Boolean includeRecord)
    {
    	super(id, ver, includeRecord);
    }
	public Class getRealDomainClass()
	{
		return ims.core.admin.domain.objects.EpisodeOfCareHistory.class;
	}
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "EpisodeOfCareHistory";
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			EpisodeOfCareHistory domainObject = getEpisodeOfCareHistoryfromXML(itemEl, factory, domMap);
	...
	public static EpisodeOfCareHistory getEpisodeOfCareHistoryfromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getEpisodeOfCareHistoryfromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static EpisodeOfCareHistory getEpisodeOfCareHistoryfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!EpisodeOfCareHistory.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!EpisodeOfCareHistory.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the EpisodeOfCareHistory class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (EpisodeOfCareHistory)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(EpisodeOfCareHistory.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		EpisodeOfCareHistory ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (EpisodeOfCareHistory)factory.getImportedDomainObject(EpisodeOfCareHistory.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new EpisodeOfCareHistory();
		}
		String keyClassName = "EpisodeOfCareHistory";
		...
		if (impObj != null)
		{
			return (EpisodeOfCareHistory)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, EpisodeOfCareHistory obj, java.util.HashMap domMap) throws Exception
	{
