...
public class OutpatientAttendance extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1014100001;
	private static final long serialVersionUID = 1014100001L;
    ...
    public OutpatientAttendance (Integer id, int ver)
    {
    	super(id, ver);
    }
    public OutpatientAttendance ()
    {
    	super();
    }
    public OutpatientAttendance (Integer id, int ver, Boolean includeRecord)
    {
    	super(id, ver, includeRecord);
    }
	public Class getRealDomainClass()
	{
		return ims.core.admin.pas.domain.objects.OutpatientAttendance.class;
	}
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "OutpatientAttendance";
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			OutpatientAttendance domainObject = getOutpatientAttendancefromXML(itemEl, factory, domMap);
	...
	public static OutpatientAttendance getOutpatientAttendancefromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getOutpatientAttendancefromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static OutpatientAttendance getOutpatientAttendancefromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!OutpatientAttendance.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!OutpatientAttendance.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the OutpatientAttendance class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (OutpatientAttendance)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(OutpatientAttendance.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		OutpatientAttendance ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (OutpatientAttendance)factory.getImportedDomainObject(OutpatientAttendance.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new OutpatientAttendance();
		}
		String keyClassName = "OutpatientAttendance";
		...
		if (impObj != null)
		{
			return (OutpatientAttendance)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, OutpatientAttendance obj, java.util.HashMap domMap) throws Exception
	{
