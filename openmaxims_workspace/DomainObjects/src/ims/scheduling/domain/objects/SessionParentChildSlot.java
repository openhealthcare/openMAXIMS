...
public class SessionParentChildSlot extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1090100019;
	private static final long serialVersionUID = 1090100019L;
	...
	/** Profile Slot */
	private ims.scheduling.domain.objects.ProfileParentChildSlot profileSlot;
	/** Session Date & Time  */
    ...
    public SessionParentChildSlot ()
    {
    	super();
    }
    public SessionParentChildSlot (Integer id, int ver, Boolean includeRecord)
    {
    	super(id, ver, includeRecord);
    }
	public Class getRealDomainClass()
	{
		return ims.scheduling.domain.objects.SessionParentChildSlot.class;
	}
	...
	public ims.scheduling.domain.objects.ProfileParentChildSlot getProfileSlot() {
		return profileSlot;
	}
	public void setProfileSlot(ims.scheduling.domain.objects.ProfileParentChildSlot profileSlot) {
	...
	public ims.scheduling.domain.objects.SessionParentChildSlot getParentSlot() {
		return parentSlot;
	}
	public void setParentSlot(ims.scheduling.domain.objects.SessionParentChildSlot parentSlot) {
	...
	public String toAuditString()
	{
		...
		if (parentSlot != null)
		{
			auditStr.append(toShortClassName(parentSlot));
				
		    auditStr.append(parentSlot.getId());
		}
	    auditStr.append("; ");
		auditStr.append("\r\n*duration* :");
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "SessionParentChildSlot";
	...
	public String fieldsToXMLString(java.util.HashMap domMap)
	{
		...
		{
			sb.append("<parentSlot>");
			sb.append(this.getParentSlot().toXMLString(domMap)); 	
			sb.append("</parentSlot>");		
		}
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			SessionParentChildSlot domainObject = getSessionParentChildSlotfromXML(itemEl, factory, domMap);
	...
	public static SessionParentChildSlot getSessionParentChildSlotfromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getSessionParentChildSlotfromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static SessionParentChildSlot getSessionParentChildSlotfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!SessionParentChildSlot.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!SessionParentChildSlot.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the SessionParentChildSlot class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (SessionParentChildSlot)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(SessionParentChildSlot.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		SessionParentChildSlot ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (SessionParentChildSlot)factory.getImportedDomainObject(SessionParentChildSlot.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new SessionParentChildSlot();
		}
		String keyClassName = "SessionParentChildSlot";
		...
		if (impObj != null)
		{
			return (SessionParentChildSlot)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, SessionParentChildSlot obj, java.util.HashMap domMap) throws Exception
	{
		...
		if(fldEl != null)
		{
			...
			obj.setProfileSlot(ims.scheduling.domain.objects.ProfileParentChildSlot.getProfileParentChildSlotfromXML(fldEl, factory, domMap)); 
		}
		...
		fldEl = el.element("parentSlot");
		if(fldEl != null)
		{
			fldEl = fldEl.element("class");		
			obj.setParentSlot(ims.scheduling.domain.objects.SessionParentChildSlot.getSessionParentChildSlotfromXML(fldEl, factory, domMap)); 
		}
