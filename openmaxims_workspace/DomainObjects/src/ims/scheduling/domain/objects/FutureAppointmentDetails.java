...
public class FutureAppointmentDetails extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	...
	/** FutureApptByDate */
	private java.util.Date futureApptByDate;
	/** SystemInformation */
	...
	public java.util.Date getFutureApptByDate() {
		return futureApptByDate;
	}
	public void setFutureApptByDate(java.util.Date futureApptByDate) {
		this.futureApptByDate = futureApptByDate;
	}
	...
	public String toAuditString()
	{
	    ...
	    auditStr.append("; ");
		auditStr.append("\r\n*futureApptByDate* :");
		auditStr.append(futureApptByDate);
	    auditStr.append("; ");
	...
	public String fieldsToXMLString(java.util.HashMap domMap)
	{
		...
		if (this.getFutureApptByDate() != null)
		{
			sb.append("<futureApptByDate>");
			sb.append(new ims.framework.utils.DateTime(this.getFutureApptByDate()).toString(ims.framework.utils.DateTimeFormat.MILLI));
			sb.append("</futureApptByDate>");		
		}
		return sb.toString();
	}
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, FutureAppointmentDetails obj, java.util.HashMap domMap) throws Exception
	{
		...
		fldEl = el.element("futureApptByDate");
		if(fldEl != null)
		{	
    		obj.setFutureApptByDate(new java.text.SimpleDateFormat("yyyyMMddHHmmssSSS").parse(fldEl.getTextTrim()));
		}
	}
	...
	public static final String ID = "id";
		...
		public static final String FutureApptByDate = "futureApptByDate";
	}
}
