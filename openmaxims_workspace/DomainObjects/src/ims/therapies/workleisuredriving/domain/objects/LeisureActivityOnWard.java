...
public class LeisureActivityOnWard extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1019100070;
	private static final long serialVersionUID = 1019100070L;
	...
	/** On Ward Activity Date */
	private java.util.Date activityDate;
	/** On Ward Activity */
	private String activity;
	/** On Ward Activity Comment */
    ...
    public LeisureActivityOnWard (Integer id, int ver)
    {
    	super(id, ver);
    }
    public LeisureActivityOnWard ()
    {
    	super();
    }
    public LeisureActivityOnWard (Integer id, int ver, Boolean includeRecord)
    {
    	super(id, ver, includeRecord);
    }
	public Class getRealDomainClass()
	{
		return ims.therapies.workleisuredriving.domain.objects.LeisureActivityOnWard.class;
	}
	...
	public void setActivity(String activity) {
		if ( null != activity && activity.length() > 100 ) {
			throw new ims.domain.exceptions.DomainRuntimeException("MaxLength ($MaxLength) exceeded for activity. Tried to set value: "+
				activity);
		}
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "LeisureActivityOnWard";
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			LeisureActivityOnWard domainObject = getLeisureActivityOnWardfromXML(itemEl, factory, domMap);
	...
	public static LeisureActivityOnWard getLeisureActivityOnWardfromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getLeisureActivityOnWardfromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static LeisureActivityOnWard getLeisureActivityOnWardfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!LeisureActivityOnWard.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!LeisureActivityOnWard.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the LeisureActivityOnWard class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (LeisureActivityOnWard)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(LeisureActivityOnWard.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		LeisureActivityOnWard ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (LeisureActivityOnWard)factory.getImportedDomainObject(LeisureActivityOnWard.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new LeisureActivityOnWard();
		}
		String keyClassName = "LeisureActivityOnWard";
		...
		if (impObj != null)
		{
			return (LeisureActivityOnWard)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, LeisureActivityOnWard obj, java.util.HashMap domMap) throws Exception
	{
		...
		if(fldEl != null)
		{	
    		obj.setActivity(new String(fldEl.getTextTrim()));	
		}
