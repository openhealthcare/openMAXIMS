...
public class HandRangeOfMovement extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1019100060;
	private static final long serialVersionUID = 1019100060L;
	...
	/** Details
	  * Collection of ims.medical.domain.objects.MSkExamJointBonesDetail.
	  */
	private java.util.Set details;
	/** SystemInformation */
	private ims.domain.SystemInformation systemInformation = new ims.domain.SystemInformation();
    public HandRangeOfMovement (Integer id, int ver)
    {
    	super(id, ver);
    }
    public HandRangeOfMovement ()
    {
    	super();
    }
    public HandRangeOfMovement (Integer id, int ver, Boolean includeRecord)
    {
    	super(id, ver, includeRecord);
    }
	public Class getRealDomainClass()
	{
		return ims.therapies.hand.domain.objects.HandRangeOfMovement.class;
	}
	...
	public String toAuditString()
	{
		...
		if (details != null)
		{
			java.util.Iterator it5 = details.iterator();
			int i5=0;
			while (it5.hasNext())
			{
				if (i5 > 0)
					auditStr.append(",");
				ims.medical.domain.objects.MSkExamJointBonesDetail obj = (ims.medical.domain.objects.MSkExamJointBonesDetail)it5.next();
		if (obj != null)
		{
		   if (i5 == 0)
		   {
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "HandRangeOfMovement";
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			HandRangeOfMovement domainObject = getHandRangeOfMovementfromXML(itemEl, factory, domMap);
	...
	public static HandRangeOfMovement getHandRangeOfMovementfromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getHandRangeOfMovementfromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static HandRangeOfMovement getHandRangeOfMovementfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!HandRangeOfMovement.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!HandRangeOfMovement.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the HandRangeOfMovement class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (HandRangeOfMovement)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(HandRangeOfMovement.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		HandRangeOfMovement ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (HandRangeOfMovement)factory.getImportedDomainObject(HandRangeOfMovement.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new HandRangeOfMovement();
		}
		String keyClassName = "HandRangeOfMovement";
		...
		if (impObj != null)
		{
			return (HandRangeOfMovement)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, HandRangeOfMovement obj, java.util.HashMap domMap) throws Exception
	{
		...
		if(fldEl != null)
		{
			...
			obj.setDetails(ims.medical.domain.objects.MSkExamJointBonesDetail.fromSetXMLString(fldEl, factory, obj.getDetails(), domMap));
		}
	}
