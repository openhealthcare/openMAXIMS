...
public class TTAStatus extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1099100017;
	private static final long serialVersionUID = 1099100017L;
    ...
    public TTAStatus (Integer id, int ver)
    {
    	super(id, ver);
    }
    public TTAStatus ()
    ...
    public TTAStatus (Integer id, int ver, Boolean includeRecord)
    {
    	super(id, ver, includeRecord);
    }
	public Class getRealDomainClass()
	{
		return ims.edischarge.domain.objects.TTAStatus.class;
	}
	...
	public void setReasonForRejection(String reasonForRejection) {
		if ( null != reasonForRejection && reasonForRejection.length() > 1500 ) {
	...
	public void setReasonForSuspension(String reasonForSuspension) {
		if ( null != reasonForSuspension && reasonForSuspension.length() > 1500 ) {
			throw new ims.domain.exceptions.DomainRuntimeException("MaxLength ($MaxLength) exceeded for reasonForSuspension. Tried to set value: "+
				reasonForSuspension);
		}
	...
	public String toAuditString()
	{
	    ...
	    auditStr.append("; ");
		auditStr.append("\r\n*reasonForSuspension* :");
		auditStr.append(reasonForSuspension);
	    auditStr.append("; ");
	...
	public String fieldsToXMLString(java.util.HashMap domMap)
	{
		...
		if (this.getReasonForSuspension() != null)
		{
			sb.append("<reasonForSuspension>");
			sb.append(ims.framework.utils.StringUtils.encodeXML(this.getReasonForSuspension().toString()));
			sb.append("</reasonForSuspension>");		
		}
		return sb.toString();
	}
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			TTAStatus domainObject = getTTAStatusfromXML(itemEl, factory, domMap);
	...
	public static TTAStatus getTTAStatusfromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getTTAStatusfromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static TTAStatus getTTAStatusfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!TTAStatus.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!TTAStatus.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the TTAStatus class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (TTAStatus)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(TTAStatus.CLASSVERSION))
		{
		...
		ret = (TTAStatus)factory.getImportedDomainObject(TTAStatus.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new TTAStatus();
		}
		...
		if (impObj != null)
		{
			return (TTAStatus)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, TTAStatus obj, java.util.HashMap domMap) throws Exception
	{
		...
		fldEl = el.element("reasonForSuspension");
		if(fldEl != null)
		{	
    		obj.setReasonForSuspension(new String(fldEl.getTextTrim()));	
		}
	}
	...
	public static final String ID = "id";
		...
		public static final String ReasonForSuspension = "reasonForSuspension";
	}
}
