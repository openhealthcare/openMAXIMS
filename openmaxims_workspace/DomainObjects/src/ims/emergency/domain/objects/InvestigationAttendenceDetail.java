...
public class InvestigationAttendenceDetail extends ims.domain.DomainObject implements ims.domain.SystemInformationRetainer, java.io.Serializable {
	public static final int CLASSID = 1086100020;
	private static final long serialVersionUID = 1086100020L;
    ...
    public InvestigationAttendenceDetail (Integer id, int ver)
    {
    	super(id, ver);
    }
    public InvestigationAttendenceDetail ()
    {
    	super();
    }
    public InvestigationAttendenceDetail (Integer id, int ver, Boolean includeRecord)
    {
    	super(id, ver, includeRecord);
    }
	public Class getRealDomainClass()
	{
		return ims.emergency.domain.objects.InvestigationAttendenceDetail.class;
	}
	...
	public ims.domain.lookups.LookupInstance getAttendenceInvestigation() {
		return attendenceInvestigation;
	}
	public void setAttendenceInvestigation(ims.domain.lookups.LookupInstance attendenceInvestigation) {
		this.attendenceInvestigation = attendenceInvestigation;
	}
	...
	public String toAuditString()
	{
		...
		if (attendenceInvestigation != null)
			auditStr.append(attendenceInvestigation.getText());
	    auditStr.append("; ");
		auditStr.append("\r\n*active* :");
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "InvestigationAttendenceDetail";
	...
	public String fieldsToXMLString(java.util.HashMap domMap)
	{
		...
		{
			sb.append("<attendenceInvestigation>");
			sb.append(this.getAttendenceInvestigation().toXMLString()); 
			sb.append("</attendenceInvestigation>");		
		}
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			InvestigationAttendenceDetail domainObject = getInvestigationAttendenceDetailfromXML(itemEl, factory, domMap);
	...
	public static InvestigationAttendenceDetail getInvestigationAttendenceDetailfromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getInvestigationAttendenceDetailfromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static InvestigationAttendenceDetail getInvestigationAttendenceDetailfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!InvestigationAttendenceDetail.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!InvestigationAttendenceDetail.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the InvestigationAttendenceDetail class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (InvestigationAttendenceDetail)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(InvestigationAttendenceDetail.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		InvestigationAttendenceDetail ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (InvestigationAttendenceDetail)factory.getImportedDomainObject(InvestigationAttendenceDetail.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new InvestigationAttendenceDetail();
		}
		String keyClassName = "InvestigationAttendenceDetail";
		...
		if (impObj != null)
		{
			return (InvestigationAttendenceDetail)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, InvestigationAttendenceDetail obj, java.util.HashMap domMap) throws Exception
	{
		...
		if(fldEl != null)
		{
			...
			obj.setAttendenceInvestigation(ims.domain.lookups.LookupInstance.fromXMLString(fldEl, factory)); 	
		}
