...
public class PainMedication extends ims.domain.DomainObject implements java.io.Serializable {
	public static final int CLASSID = 1012100033;
	private static final long serialVersionUID = 1012100033L;
    ...
    public PainMedication (Integer id, int ver)
    {
    	super(id, ver);
    }
    ...
    public PainMedication (Integer id, int ver, Boolean includeRecord)
    {
	...
	public String getTakenWithAnything() {
		return takenWithAnything;
	}
	public void setTakenWithAnything(String takenWithAnything) {
		this.takenWithAnything = takenWithAnything;
	}
	...
	public String toAuditString()
	{
	    ...
	    auditStr.append("; ");
		auditStr.append("\r\n*takenWithAnything* :");
		auditStr.append(takenWithAnything);
	    auditStr.append("; ");
		auditStr.append("\r\n*effectiveFor* :");
	...
	public String toXMLString(java.util.HashMap domMap)
	{
		...
		String keyClassName = "PainMedication";
	...
	public String fieldsToXMLString(java.util.HashMap domMap)
	{
		...
		if (this.getTakenWithAnything() != null)
		{
			sb.append("<takenWithAnything>");
			sb.append(ims.framework.utils.StringUtils.encodeXML(this.getTakenWithAnything().toString()));
			sb.append("</takenWithAnything>");		
		}
	...
	private static void fillSetFromXMLString(java.util.Set set, org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		...
		for(int i=0; i<size; i++) 
		{
			...
			PainMedication domainObject = getPainMedicationfromXML(itemEl, factory, domMap);
	...
	public static PainMedication getPainMedicationfromXML(String xml, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		org.dom4j.Document doc = new org.dom4j.io.SAXReader().read(new org.xml.sax.InputSource(xml));
		return getPainMedicationfromXML(doc.getRootElement(), factory, domMap);
	}
	
	public static PainMedication getPainMedicationfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, java.util.HashMap domMap) throws Exception
	{
		if (el == null)
			return null;
		
		String className = el.attributeValue("type");
		if (!PainMedication.class.getName().equals(className))
		{
			Class clz = Class.forName(className);
			if (!PainMedication.class.isAssignableFrom(clz))
				throw new Exception("Element of type = " + className + " cannot be imported using the PainMedication class");
			String shortClassName = className.substring(className.lastIndexOf(".")+1);
			String methodName = "get" + shortClassName + "fromXML";
			java.lang.reflect.Method m = clz.getMethod(methodName, new Class[]{org.dom4j.Element.class, ims.domain.DomainFactory.class, java.util.HashMap.class});
			return (PainMedication)m.invoke(null, new Object[]{el, factory, domMap});
		}

		String impVersion = el.attributeValue("classVersion");
		if(!impVersion.equals(PainMedication.CLASSVERSION))
		{
			throw new Exception("Incompatible class structure found. Cannot import instance.");
		}		
		
		PainMedication ret = null;
		int extId = Integer.parseInt(el.attributeValue("id"));
		String externalSource = el.attributeValue("source");
		ret = (PainMedication)factory.getImportedDomainObject(PainMedication.class, externalSource, extId);	
		if (ret == null)
		{
			ret = new PainMedication();
		}
		String keyClassName = "PainMedication";
		...
		if (impObj != null)
		{
			return (PainMedication)impObj.getDomainObject();
		}
		else
		{
    		impObj = new ims.configuration.ImportedObject();
	...
	public static void fillFieldsfromXML(org.dom4j.Element el, ims.domain.DomainFactory factory, PainMedication obj, java.util.HashMap domMap) throws Exception
	{
		...
		fldEl = el.element("takenWithAnything");
		if(fldEl != null)
		{	
    		obj.setTakenWithAnything(new String(fldEl.getTextTrim()));	
		}
	...
	public static final String ID = "id";
		...
		public static final String TakenWithAnything = "takenWithAnything";
