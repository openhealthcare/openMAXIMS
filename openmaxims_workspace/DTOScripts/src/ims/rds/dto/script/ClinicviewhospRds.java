...
//ClinicviewhospRds.java : Generated by vpurdila on 06 Jul 2004 11:27.
//Java DTO script
...
import ims.dto.client.Sd_apptdts_hosp;

public final class ClinicviewhospRds extends IMSReportDataSourceDTO
{
    public ClinicviewhospRds(ims.dto.DTODomain domain, String seed1, String seed2, String seed3, String seed4, String seed5)
    {
        super(domain);
        SEED_VALUE[0] = seed1;
        SEED_VALUE[1] = seed2;
    ...
    private void InitDefaultValues()
    {
        ...
        sd_apptdts_hospRds = (Sd_apptdts_hosp)domain.getDTOInstance(Sd_apptdts_hosp.class);
        ...
        SD_APPTDTS_HOSP_VALUE.clear();
        for(i = 0; i < 63; i++)
            SD_APPTDTS_HOSP_VALUE.add(new ArrayList());
    ...
    private boolean _internalGetData()
    {
        ...
        //LIST SD_APPTDTS_HOSP
        SD_APPTDTS_HOSP_FILTERS.clear();
        SD_APPTDTS_HOSP_FILTERS.add("PRFILE_SESS_ID");
        SD_APPTDTS_HOSP_FILTERS.add("APPT_STAT");
        SD_APPTDTS_HOSP_FILTERS.add("PRFILED_SESS_ID");
        CopyValue(SD_APPTDTS_HOSP_VALUE, GetIndexByName("PRFILE_SESS_ID", SD_APPTDTS_HOSP), (ArrayList)(IMS_USERVAR_VALUE.get(GetIndexByName("PRFILE_SESS_ID", IMS_USERVAR))));
        CopyValue(SD_APPTDTS_HOSP_VALUE, GetIndexByName("APPT_STAT", SD_APPTDTS_HOSP), (ArrayList)(IMS_USERVAR_VALUE.get(GetIndexByName("APPT_STAT", IMS_USERVAR))));
        CopyValue(SD_APPTDTS_HOSP_VALUE, GetIndexByName("PRFILED_SESS_ID", SD_APPTDTS_HOSP), (ArrayList)(IMS_USERVAR_VALUE.get(GetIndexByName("PRFILED_SESS_ID", IMS_USERVAR))));
        bRet = CallService(sd_apptdts_hospRds, "SD_APPTDTS_HOSP", "LIST", SD_APPTDTS_HOSP, SD_APPTDTS_HOSP_ATTR_DESC, SD_APPTDTS_HOSP_VALUE, SD_APPTDTS_HOSP_FILTERS, true);
        //GET SD_SESSION
    ...
    public String GetData()
    {
        ...
        BuildResult(SD_APPTDTS_HOSP_ALIAS, SD_APPTDTS_HOSP_ATTR_DESC, SD_APPTDTS_HOSP_VALUE);
    ...
    public String GetStructuredData(String sName)
    {
        ...
        BuildStructuredResult("SD_APPTDTS_HOSP", SD_APPTDTS_HOSP_ALIAS, SD_APPTDTS_HOSP_ATTR_DESC, SD_APPTDTS_HOSP_VALUE);
