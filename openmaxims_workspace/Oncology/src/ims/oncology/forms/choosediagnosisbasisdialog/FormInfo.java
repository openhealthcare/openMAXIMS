...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "ChooseDiagnosisBasisDialog";
	}
	public int getWidth()
	{
		return 320;
	...
	{
		return new String[] { "_cv_Oncology.SelectedDiagnosisForPrimaryTumourDetails", "_cv_Oncology.SelectedBasisOfDiagnosis" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Oncology.ChooseDiagnosisBasisDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/diagnostic_48.png";
	}
}
