...
public class GenForm extends FormBridge
{
	...
	public static class chklistBasisCheckedListBox extends CheckedListBoxBridge
	{
		private static final long serialVersionUID = 1L;
		...
		public void newRow(ims.core.vo.lookups.DiagnosisBasisofDiagnosis value, String text, String tooltip)
		{
			super.control.newItem(new ListItem(value, text, tooltip));
		}
		public void newRow(ims.core.vo.lookups.DiagnosisBasisofDiagnosis value, String text, boolean checked)
		{
			super.control.newItem(new ListItem(value, text, checked));
		}
		public void newRow(ims.core.vo.lookups.DiagnosisBasisofDiagnosis value, String text, boolean checked, boolean enabled)
		{
		...
		public void newRow(ims.core.vo.lookups.DiagnosisBasisofDiagnosis value, String text, ims.framework.utils.Image image, boolean checked)
		{
			super.control.newItem(new ListItem(value, text, image, checked));
		}
		public void newRow(ims.core.vo.lookups.DiagnosisBasisofDiagnosis value, String text, ims.framework.utils.Image image, boolean checked, boolean enabled)
		{
			super.control.newItem(new ListItem(value, text, image, checked, enabled));
		}
		public void newRow(ims.core.vo.lookups.DiagnosisBasisofDiagnosis value, String text, ims.framework.utils.Color color)
		{
			super.control.newItem(new ListItem(value, text, color));
		}
		public void newRow(ims.core.vo.lookups.DiagnosisBasisofDiagnosis value, String text, ims.framework.utils.Color color, boolean checked)
		{
			super.control.newItem(new ListItem(value, text, color, checked));
		}
		public void newRow(ims.core.vo.lookups.DiagnosisBasisofDiagnosis value, String text, ims.framework.utils.Color color, boolean checked, boolean enabled)
		{
			super.control.newItem(new ListItem(value, text, color, checked, enabled));
		}
		public void newRow(ims.core.vo.lookups.DiagnosisBasisofDiagnosis value, String text, ims.framework.utils.Image image, ims.framework.utils.Color color, boolean checked)
		{
			super.control.newItem(new ListItem(value, text, image, color, checked));
		}
		public void newRow(ims.core.vo.lookups.DiagnosisBasisofDiagnosis value, String text, ims.framework.utils.Image image, ims.framework.utils.Color color, boolean checked, boolean enabled)
		{
			super.control.newItem(new ListItem(value, text, image, color, checked, enabled));
		}
		public void newRow(ims.core.vo.lookups.DiagnosisBasisofDiagnosis value, String text, ims.framework.utils.Image image, ims.framework.utils.Color color, boolean checked, boolean enabled, String tooltip)
		{
			super.control.newItem(new ListItem(value, text, image, color, checked, enabled, tooltip));
		}
		public ims.core.vo.lookups.DiagnosisBasisofDiagnosis[] getValues()
		{
			ListItemCollection checkedItems = super.control.getCheckedItems();
			if(checkedItems.size() == 0)
				return null;
			ims.core.vo.lookups.DiagnosisBasisofDiagnosis[] items = new ims.core.vo.lookups.DiagnosisBasisofDiagnosis[checkedItems.size()];
			for(int x = 0; x < checkedItems.size(); x++)
			{
				items[x] = (ims.core.vo.lookups.DiagnosisBasisofDiagnosis)checkedItems.get(x).getValue();
			}
			return items;
		}
		public void setValues(ims.core.vo.lookups.DiagnosisBasisofDiagnosis[] values)
		{
			if(values == null)
	...
	{
		if(new ims.framework.ContextVariable("Oncology.SelectedDiagnosisForPrimaryTumourDetails", "_cv_Oncology.SelectedDiagnosisForPrimaryTumourDetails").getValueIsNull(context))
			throw new ims.framework.exceptions.FormMandatoryContextMissingException("The required context data 'Oncology.SelectedDiagnosisForPrimaryTumourDetails' is not available.");
	}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		ims.framework.utils.SizeInfo designSize = new ims.framework.utils.SizeInfo(320, 208);
		if(runtimeSize == null)
		...
		// Label Controls
		RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 32, 24, 243, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Choose one basis of diagnosis value only :", new Integer(1), null, new Integer(0)}));

		// Button Controls
		RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 152, 176, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 232, 176, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 8, 56, 296, 109, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		CheckedListBox m_chklistBasisTemp = (CheckedListBox)factory.getControl(CheckedListBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), ControlState.ENABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT, null, Boolean.TRUE, null, new Integer(startTabIndex.intValue() + 1), Boolean.FALSE, new Integer(1)});
		addControl(m_chklistBasisTemp);
		chklistBasisCheckedListBox chklistBasis = (chklistBasisCheckedListBox)CheckedListBoxFlyweightFactory.getInstance().createCheckedListBoxBridge(chklistBasisCheckedListBox.class, m_chklistBasisTemp);
		super.addCheckedListBox(chklistBasis);
	}
	...
	public chklistBasisCheckedListBox chklistBasis()
	{
		return (chklistBasisCheckedListBox)super.getCheckedListBox(0);
	}
