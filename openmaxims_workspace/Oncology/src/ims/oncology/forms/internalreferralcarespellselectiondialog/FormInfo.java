...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "InternalReferralCareSpellSelectionDialog";
	}
	public int getWidth()
	{
		return 536;
	...
	{
		return new String[] { "_cv_Oncology.EpisodeOfCareDate", "_cv_Clinical.PatientSummary.EpisodeOfCare" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Oncology.InternalReferralCareSpellSelectionDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
