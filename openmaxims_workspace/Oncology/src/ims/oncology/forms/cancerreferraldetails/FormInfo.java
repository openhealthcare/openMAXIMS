...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Clinical.PreceedingReferralDialogMode", "_cv_Clinical.SelectedPreceedingReferralVo" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Oncology.CancerreferralDetails.__internal_x_context__" + String.valueOf(getFormId());
	}
