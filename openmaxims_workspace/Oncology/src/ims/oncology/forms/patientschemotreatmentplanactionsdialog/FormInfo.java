...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "PatientsChemoTreatmentPlanActionsDialog";
	}
	public int getWidth()
	{
		return 816;
	...
	{
		return new String[] { "_cv_Oncology.DecisionTreatFromDialog", "_cv_Oncology.RadiotherapyPatTreatmentPlanAction" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Oncology.PatientsChemoTreatmentPlanActionsDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
