...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.getContextMenus().Oncology.getInternalReferralListMenuVIEWItem().setClickEvent(new ims.framework.delegates.MenuItemClick()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.Control sender) throws ims.framework.exceptions.PresentationLogicException
			{
				onContextMenuItemClick(GenForm.ContextMenus.OncologyNamespace.InternalReferralListMenu.VIEW, sender);
			}
		});
		this.form.getContextMenus().Oncology.getInternalReferralListMenuUPDATEItem().setClickEvent(new ims.framework.delegates.MenuItemClick()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.Control sender) throws ims.framework.exceptions.PresentationLogicException
			{
				onContextMenuItemClick(GenForm.ContextMenus.OncologyNamespace.InternalReferralListMenu.UPDATE, sender);
			}
		});
	}
