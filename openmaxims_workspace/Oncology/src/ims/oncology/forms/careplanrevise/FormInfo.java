...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Oncology.voCancerCarePlan" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Oncology.CarePlanRevise.__internal_x_context__" + String.valueOf(getFormId());
	}
