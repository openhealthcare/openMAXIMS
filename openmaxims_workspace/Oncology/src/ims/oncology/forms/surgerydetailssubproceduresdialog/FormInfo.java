...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "SurgeryDetailsSubProceduresDialog";
	}
	public int getWidth()
	{
		return 536;
	...
	{
		return new String[] { "_cv_Clinical.SelectedSubProcedure" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Oncology.SurgeryDetailsSubProceduresDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
