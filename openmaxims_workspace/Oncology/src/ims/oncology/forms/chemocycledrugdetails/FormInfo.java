...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Oncology.ChemoTherapyDetailRecord", "_cv_Oncology.ChemotherapyCycleDetailsVo", "_cv_Oncology.ChemoTherapyDayDetailsVo", "_cv_Oncology.CycleDrugDetailMode" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Oncology.ChemoCycleDrugDetails.__internal_x_context__" + String.valueOf(getFormId());
	}
