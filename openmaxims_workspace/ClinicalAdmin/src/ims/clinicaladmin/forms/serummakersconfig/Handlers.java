...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void onGrdSerumMarkersSelectionCleared() throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.grdSerumMarkers().setSelectionChangedEvent(new GridSelectionChanged()
		{
			private static final long serialVersionUID = 1L;
		...
		this.form.grdSerumMarkers().setSelectionClearedEvent(new SelectionCleared()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onGrdSerumMarkersSelectionCleared();
			}
		});
