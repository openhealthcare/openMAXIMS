...
import ims.clinicaladmin.forms.serummakersconfig.GenForm.grdSerumMarkersRow;
...
public class Logic extends BaseLogic
{
	...
	public void updateControlsState()
	{
		...
		if (FormMode.VIEW.equals(form.getMode()))
		{
			...
			form.btnEdit().setEnabled(form.getLocalContext().getSelectedRecordIsNotNull() && form.grdSerumMarkers().getValue() != null);
		}
	...
	private void populateSerumMakers(TumourSerumMarkersLiteVoCollection serumMarkers)
	{
		...
		for (TumourSerumMarkersLiteVo record : serumMarkers)
		{
			...
			serumRow.setColActive(Boolean.TRUE.equals(record.getIsActive()));
			
			serumRow.setTextColor(Boolean.TRUE.equals(record.getIsActive()) ? Color.Black : Color.Gray);
	...
	private void populateInstanceControlsFromData(TumourSerumMarkersVo serumMarker)
	{
		...
		form.ctnDetails().chkActive().setValue(Boolean.TRUE.equals(serumMarker.getIsActive()));
	...
	private TumourSerumMarkersVo populateDataFromInstanceControls(TumourSerumMarkersVo serumMarker)
	{
		...
		serumMarker.setIsActive(form.ctnDetails().chkActive().getValue());
