...
public class GenForm extends FormBridge
{
	...
	public static class grdDetailsRow extends GridRowBridge
	{
		...
		public void setColAMTSTermsReadOnly(boolean value)
		{
			super.row.setReadOnly(0, value);
		}
		public boolean isColAMTSTermsReadOnly()
		{
			return super.row.isReadOnly(0);
		}
		public void showColAMTSTermsOpened()
		{
			super.row.showOpened(0);
		}
		public void setTooltipForColAMTSTerms(String value)
		{
			super.row.setTooltip(0, value);
		}
		public String getColAMTSTerms()
		{
			return (String)super.row.get(0);
		}
		public void setColAMTSTerms(String value)
		{
			super.row.set(0, value);
		}
		public void setCellColAMTSTermsTooltip(String value)
		{
			super.row.setTooltip(0, value);
		}
		public void setColLookupValueReadOnly(boolean value)
		{
			super.row.setReadOnly(1, value);
		}
		public boolean isColLookupValueReadOnly()
		{
			return super.row.isReadOnly(1);
		}
		public void showColLookupValueOpened()
		{
			super.row.showOpened(1);
		}
		public void setTooltipForColLookupValue(String value)
		{
			super.row.setTooltip(1, value);
		}
		public ims.clinicaladmin.vo.lookups.DementiaTermConfig getColLookupValue()
		{
			return (ims.clinicaladmin.vo.lookups.DementiaTermConfig)super.row.get(1);
		}
		public void setColLookupValue(ims.clinicaladmin.vo.lookups.DementiaTermConfig value)
		{
			super.row.set(1, value);
		}
		public void setCellColLookupValueTooltip(String value)
		{
			super.row.setTooltip(1, value);
		}
		public void setColTermTextReadOnly(boolean value)
		{
			super.row.setReadOnly(2, value);
		}
		public boolean isColTermTextReadOnly()
		{
			return super.row.isReadOnly(2);
		}
		public void showColTermTextOpened()
		{
			super.row.showOpened(2);
		}
		public void setTooltipForColTermText(String value)
		{
			super.row.setTooltip(2, value);
		}
		public String getColTermText()
		{
			return (String)super.row.get(2);
		}
		public void setColTermText(String value)
		{
			super.row.set(2, value);
		}
		public void setCellColTermTextTooltip(String value)
		{
			super.row.setTooltip(2, value);
		}
		public ims.clinicaladmin.vo.DementiaTermConfigVo getValue()
		{
			return (ims.clinicaladmin.vo.DementiaTermConfigVo)super.row.getValue();
		}
		public void setValue(ims.clinicaladmin.vo.DementiaTermConfigVo value)
		{
	...
	public static class grdDetailsGrid extends GridBridge
	{
		...
		public ims.clinicaladmin.vo.DementiaTermConfigVoCollection getValues()
		{
			ims.clinicaladmin.vo.DementiaTermConfigVoCollection listOfValues = new ims.clinicaladmin.vo.DementiaTermConfigVoCollection();
		...
		public ims.clinicaladmin.vo.DementiaTermConfigVo getValue()
		{
			return (ims.clinicaladmin.vo.DementiaTermConfigVo)super.grid.getValue();
		}
		public void setValue(ims.clinicaladmin.vo.DementiaTermConfigVo value)
		{
		...
		public grdDetailsRow getRowByValue(ims.clinicaladmin.vo.DementiaTermConfigVo value)
		{
			GridRow row = super.grid.getRowByValue(value);
			return row == null?null:new grdDetailsRow(row);
		}
		public void setColAMTSTermsHeaderTooltip(String value)
		{
			super.grid.setColumnHeaderTooltip(0, value);
		}
		public String getColAMTSTermsHeaderTooltip()
		{
			return super.grid.getColumnHeaderTooltip(0);
		}
		public void setColLookupValueHeaderTooltip(String value)
		{
			super.grid.setColumnHeaderTooltip(1, value);
		}
		public String getColLookupValueHeaderTooltip()
		{
			return super.grid.getColumnHeaderTooltip(1);
		}
		public void setColTermTextHeaderTooltip(String value)
		{
			super.grid.setColumnHeaderTooltip(2, value);
		}
		public String getColTermTextHeaderTooltip()
		{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		// Panel Controls
		RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 16, 392, 816, 192, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
		super.addControl(factory.getControl(Panel.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT,"Term Text", new Integer(2), ""}));
		...
		// TextBox Controls
		RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 32, 424, 784, 144, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), new Integer(startTabIndex.intValue() + 2), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT,Boolean.TRUE, new Integer(3500), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.TRUE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));

		// Grid Controls
		RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 16, 8, 816, 368, ims.framework.enumerations.ControlAnchoring.ALL);
		...
		grdDetails.addStringColumn("AMTS Terms ", 0, 0, 200, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdDetails.addStringColumn(" ", 0, 0, 0, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdDetails.addStringColumn("Term Text", 0, 0, -1, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_SelectedRecord = new ims.framework.ContextVariable("SelectedRecord", prefix + "_lv_ClinicalAdmin.DementiaAMTSFieldAndHelpConfig.__internal_x_context__SelectedRecord_" + componentIdentifier + "");
		}
		...
		public ims.clinicaladmin.vo.DementiaTermConfigVo getSelectedRecord()
		{
			return (ims.clinicaladmin.vo.DementiaTermConfigVo)cxl_SelectedRecord.getValue(context);
		}
		public void setSelectedRecord(ims.clinicaladmin.vo.DementiaTermConfigVo value)
		{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[71] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.DementiaAMTSFieldAndHelpConfig.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100059-ID", "ID_DementiaTermConfig");
			fields[72] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.DementiaAMTSFieldAndHelpConfig.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100059-FIELD", "Field");
			fields[73] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.DementiaAMTSFieldAndHelpConfig.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1004100059-HELPTEXT", "HelpText");
			return fields;
		}
