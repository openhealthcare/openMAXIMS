...
public class GenForm extends FormBridge
{
	...
	public static class grdRecordsGrid extends GridBridge
	{
		...
		public grdRecordsRow getRowByValue(ims.clinicaladmin.vo.PSAConfigVo value)
		{
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_SelectedRecord = new ims.framework.ContextVariable("SelectedRecord", prefix + "_lv_ClinicalAdmin.SelecPrognosticPSA.__internal_x_context__SelectedRecord_" + componentIdentifier + "");
		}
		...
		public ims.clinicaladmin.vo.PSAConfigVo getSelectedRecord()
		{
			return (ims.clinicaladmin.vo.PSAConfigVo)cxl_SelectedRecord.getValue(context);
		}
		public void setSelectedRecord(ims.clinicaladmin.vo.PSAConfigVo value)
		{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[71] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticPSA", "BO-1075100015-ID", "ID_PSAConfig");
			fields[72] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticPSA", "BO-1075100015-PSANAME", "PSAName");
			fields[73] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticPSA", "BO-1075100015-PSADESCRIPTION", "PSADescription");
			fields[74] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticPSA", "BO-1075100015-ISACTIVE", "IsActive");
			fields[75] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelecPrognosticPSA.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100015-ID", "ID_PSAConfig");
			fields[76] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelecPrognosticPSA.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100015-PSANAME", "PSAName");
			fields[77] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelecPrognosticPSA.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100015-PSADESCRIPTION", "PSADescription");
			fields[78] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelecPrognosticPSA.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100015-ISACTIVE", "IsActive");
			return fields;
		}
