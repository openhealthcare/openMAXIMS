...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_ClinicalAdmin.SelectedPrognosticPSA" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_ClinicalAdmin.SelecPrognosticPSA.__internal_x_context__" + String.valueOf(getFormId());
	}
