...
public class GenForm extends FormBridge
{
	...
	public static class ctnDetailsContainer extends ContainerBridge
	{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 16, 48, 800, 112, ims.framework.enumerations.ControlAnchoring.ALL);
			ims.framework.FormUiLogic m_ccTaxonomyMappingsForm = loader.loadComponent(104124, appForm, startControlID * 10 + 1000, anchoringHelper1.getSize(), instance1, startTabIndex.intValue() + 10, skipContextValidation);
			//ims.framework.Control m_ccTaxonomyMappingsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(16), new Integer(48), new Integer(800), new Integer(112), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 10), m_ccTaxonomyMappingsForm, instance1 } );
			ims.framework.Control m_ccTaxonomyMappingsControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001),  new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL, new Integer(startTabIndex.intValue() + 10), m_ccTaxonomyMappingsForm, instance1, Boolean.FALSE } );
			...
			// Label Controls
			RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 744, 40, 43, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
			...
			RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 16, 40, 126, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Taxonomy Mappings:", new Integer(1), null, new Integer(0)}));
			RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 16, 10, 73, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Description:", new Integer(1), null, new Integer(0)}));
	
			// TextBox Controls
			RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 88, 8, 728, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
			super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1005), new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.FALSE, new Integer(100), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.TRUE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
	
			// CheckBox Controls
			RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 800, 40, 16, 16, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
	...
	public static class grdHistologiesRow extends GridRowBridge
	{
		private static final long serialVersionUID = 1L;
		
		protected grdHistologiesRow(GridRow row)
		{
			super(row);
		}
	...
	public static class grdHistologiesRowCollection extends GridRowCollectionBridge
	{
		private static final long serialVersionUID = 1L;
		
		private grdHistologiesRowCollection(GridRowCollection collection)
		{
			super(collection);
		}
		public grdHistologiesRow get(int index)
		{
			return new grdHistologiesRow(super.collection.get(index));
		}
		public grdHistologiesRow newRow()
		{
			return new grdHistologiesRow(super.collection.newRow());
		}
		public grdHistologiesRow newRow(boolean autoSelect)
		{
			return new grdHistologiesRow(super.collection.newRow(autoSelect));
		}
		public grdHistologiesRow newRowAt(int index)
		{
			return new grdHistologiesRow(super.collection.newRowAt(index));
		}
		public grdHistologiesRow newRowAt(int index, boolean autoSelect)
		{
			return new grdHistologiesRow(super.collection.newRowAt(index, autoSelect));
		}
	}
	public static class grdHistologiesGrid extends GridBridge
	{
		private static final long serialVersionUID = 1L;
		...
		public grdHistologiesRow getSelectedRow()
		{
			return super.grid.getSelectedRow() == null ? null : new grdHistologiesRow(super.grid.getSelectedRow());
		}
		public int getSelectedRowIndex()
		{
			return super.grid.getSelectedRowIndex();
		}
		public grdHistologiesRowCollection getRows()
		{
			return new grdHistologiesRowCollection(super.grid.getRows());
		}
		public grdHistologiesRow getRowByValue(ims.clinicaladmin.vo.TumourHistologyLiteVo value)
		{
			GridRow row = super.grid.getRowByValue(value);
			return row == null?null:new grdHistologiesRow(row);
		}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		// Container Clasess
		RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 8, 408, 832, 184, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
		...
		ims.framework.utils.SizeInfo m_ctnDetailsDesignSize = new ims.framework.utils.SizeInfo(832, 184);
		...
		// Label Controls
		RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 8, 18, 62, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), new Integer(startTabIndex.intValue() + 1016), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		RuntimeAnchoring anchoringHelper11 = new RuntimeAnchoring(designSize, runtimeSize, 88, 600, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 1013), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 1011), ControlState.ENABLED, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));

		// TextBox Controls
		RuntimeAnchoring anchoringHelper13 = new RuntimeAnchoring(designSize, runtimeSize, 80, 16, 568, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		...
		// CheckBox Controls
		RuntimeAnchoring anchoringHelper14 = new RuntimeAnchoring(designSize, runtimeSize, 656, 18, 88, 16, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		// Grid Controls
		RuntimeAnchoring anchoringHelper15 = new RuntimeAnchoring(designSize, runtimeSize, 8, 64, 832, 336, ims.framework.enumerations.ControlAnchoring.ALL);
		Grid m_grdHistologiesTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.READONLY, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuGenericGrid, Boolean.TRUE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
		addControl(m_grdHistologiesTemp);
		grdHistologiesGrid grdHistologies = (grdHistologiesGrid)GridFlyweightFactory.getInstance().createGridBridge(grdHistologiesGrid.class, m_grdHistologiesTemp);
		grdHistologies.addStringColumn("Histology Description", 0, 0, 700, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdHistologies.addBoolColumn("Active", 0, 0, -1, true, false, 0, true);
		super.addGrid(grdHistologies);

		// Image Buttons Controls
		RuntimeAnchoring anchoringHelper16 = new RuntimeAnchoring(designSize, runtimeSize, 760, 10, 32, 32, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
	...
	public grdHistologiesGrid grdHistologies()
	{
		return (grdHistologiesGrid)super.getGrid(0);
	}
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_SelectedHistology = new ims.framework.ContextVariable("SelectedHistology", prefix + "_lv_ClinicalAdmin.TumourHistologyConfig.__internal_x_context__SelectedHistology_" + componentIdentifier + "");
			cxl_PerformSearch = new ims.framework.ContextVariable("PerformSearch", prefix + "_lv_ClinicalAdmin.TumourHistologyConfig.__internal_x_context__PerformSearch_" + componentIdentifier + "");
		}
		...
		public boolean getPerformSearchIsNotNull()
		{
			return !cxl_PerformSearch.getValueIsNull(context);
		}
		public Boolean getPerformSearch()
		{
			return (Boolean)cxl_PerformSearch.getValue(context);
		}
		public void setPerformSearch(Boolean value)
		{
			cxl_PerformSearch.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_PerformSearch = null;
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[71] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TumourHistologyConfig.__internal_x_context__SelectedHistology_" + componentIdentifier, "BO-1074100012-ID", "ID_TumourHistology");
			fields[72] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TumourHistologyConfig.__internal_x_context__SelectedHistology_" + componentIdentifier, "BO-1074100012-HISTOLOGYDESCRIPTION", "HistologyDescription");
			fields[73] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.TumourHistologyConfig.__internal_x_context__SelectedHistology_" + componentIdentifier, "BO-1074100012-ISACTIVE", "IsActive");
			return fields;
		}
