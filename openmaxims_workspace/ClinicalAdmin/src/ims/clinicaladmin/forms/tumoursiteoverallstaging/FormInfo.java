...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "TumourSiteOverallStaging";
	}
	public int getWidth()
	{
		return 800;
	...
	{
		return new String[] { "_cv_ClinicalAdmin.TumourSite", "_cv_Oncology.SelectedRecordForOverallDialog", "_cv_ClinicalAdmin.TumourGroup", "_cv_Oncology.OverallStagingDynamicGridCollection" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_ClinicalAdmin.TumourSiteOverallStaging.__internal_x_context__" + String.valueOf(getFormId());
	}
