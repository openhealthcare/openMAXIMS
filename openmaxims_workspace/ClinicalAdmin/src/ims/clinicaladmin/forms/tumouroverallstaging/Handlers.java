...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void bindcmbOverall45Lookup();
	abstract protected void defaultcmbOverall45LookupValue();
	abstract protected void onFormOpen(Object[] args) throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void oncmbOverallValueSet(Object value);
	abstract protected void oncmbOverall45ValueSet(Object value);
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.cmbOverall45().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				oncmbOverall45ValueSet(value);
			}
		});
	...
	protected void defaultAllLookupValues()
	{
		...
		defaultcmbOverall45LookupValue();
	}
