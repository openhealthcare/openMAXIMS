...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "TumourGroupOverallPrognostic";
	}
	public int getWidth()
	{
		return 1000;
	...
	{
		return new String[] { "_cv_ClinicalAdmin.TumourGroup", "_cv_Oncology.OverallPrognosticDynamicGridCollection", "_cv_Oncology.SelectedRecordForOverallPrognosticDialog" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_ClinicalAdmin.TumourGroupOverallPrognostic.__internal_x_context__" + String.valueOf(getFormId());
	}
