...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		// Button Controls
		RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 720, 568, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 640, 568, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		// CheckBox Controls
		RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 656, 8, 128, 16, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(CheckBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), new Integer(startTabIndex.intValue() + 1), ControlState.UNKNOWN, ControlState.UNKNOWN,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,"Generate Default List", Boolean.TRUE, null}));

		// Dynamic Grid Controls
		RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 8, 32, 784, 528, ims.framework.enumerations.ControlAnchoring.ALL);
		super.addControl(factory.getControl(DynamicGrid.class, new Object[] { control, new Integer(startControlID.intValue() + 1005), new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), new Integer(startTabIndex.intValue() + 3), ControlState.DISABLED, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.ALL, contextMenus.contextMenuGenericGrid, Boolean.FALSE, Boolean.TRUE, Boolean.TRUE}));
	}
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_SortOrder_T = new ims.framework.ContextVariable("SortOrder_T", prefix + "_lv_ClinicalAdmin.TumourGroupOverallStaging.__internal_x_context__SortOrder_T_" + componentIdentifier + "");
			cxl_SortOrder_N = new ims.framework.ContextVariable("SortOrder_N", prefix + "_lv_ClinicalAdmin.TumourGroupOverallStaging.__internal_x_context__SortOrder_N_" + componentIdentifier + "");
			cxl_SortOrder_M = new ims.framework.ContextVariable("SortOrder_M", prefix + "_lv_ClinicalAdmin.TumourGroupOverallStaging.__internal_x_context__SortOrder_M_" + componentIdentifier + "");
			cxl_SortOrder_HisType = new ims.framework.ContextVariable("SortOrder_HisType", prefix + "_lv_ClinicalAdmin.TumourGroupOverallStaging.__internal_x_context__SortOrder_HisType_" + componentIdentifier + "");
			cxl_SortOrder_HisGrade = new ims.framework.ContextVariable("SortOrder_HisGrade", prefix + "_lv_ClinicalAdmin.TumourGroupOverallStaging.__internal_x_context__SortOrder_HisGrade_" + componentIdentifier + "");
			cxl_SortOrder_Serum = new ims.framework.ContextVariable("SortOrder_Serum", prefix + "_lv_ClinicalAdmin.TumourGroupOverallStaging.__internal_x_context__SortOrder_Serum_" + componentIdentifier + "");
			cxl_SortOrder_O45 = new ims.framework.ContextVariable("SortOrder_O45", prefix + "_lv_ClinicalAdmin.TumourGroupOverallStaging.__internal_x_context__SortOrder_O45_" + componentIdentifier + "");
			cxl_SortOrder_Overall = new ims.framework.ContextVariable("SortOrder_Overall", prefix + "_lv_ClinicalAdmin.TumourGroupOverallStaging.__internal_x_context__SortOrder_Overall_" + componentIdentifier + "");
		}
		...
		public boolean getSortOrder_SerumIsNotNull()
		{
			return !cxl_SortOrder_Serum.getValueIsNull(context);
		}
		public ims.framework.enumerations.SortOrder getSortOrder_Serum()
		{
			return (ims.framework.enumerations.SortOrder)cxl_SortOrder_Serum.getValue(context);
		}
		public void setSortOrder_Serum(ims.framework.enumerations.SortOrder value)
		{
			cxl_SortOrder_Serum.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_SortOrder_Serum = null;
		public boolean getSortOrder_O45IsNotNull()
		{
			return !cxl_SortOrder_O45.getValueIsNull(context);
		}
		public ims.framework.enumerations.SortOrder getSortOrder_O45()
		{
			return (ims.framework.enumerations.SortOrder)cxl_SortOrder_O45.getValue(context);
		}
		public void setSortOrder_O45(ims.framework.enumerations.SortOrder value)
		{
			cxl_SortOrder_O45.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_SortOrder_O45 = null;
