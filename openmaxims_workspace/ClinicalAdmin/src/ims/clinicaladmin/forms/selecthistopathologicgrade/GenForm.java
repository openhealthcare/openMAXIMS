...
public class GenForm extends FormBridge
{
	...
	public static class ctnDetailsContainer extends ContainerBridge
	{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			// Label Controls
			RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 16, 18, 42, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Grade:", new Integer(1), null, new Integer(0)}));
			RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 16, 42, 73, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Description:", new Integer(1), null, new Integer(0)}));
	
			// TextBox Controls
			RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 96, 40, 552, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
			super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), new Integer(startTabIndex.intValue() + 3), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.FALSE, new Integer(70), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.TRUE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
			RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 96, 16, 552, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
	...
	public static class grdHistologyGradeRow extends GridRowBridge
	{
		private static final long serialVersionUID = 1L;
		
		protected grdHistologyGradeRow(GridRow row)
		{
			super(row);
		}
		...
		public void setColGrade(String value)
		{
		...
		public void setColDefaultValueReadOnly(boolean value)
		{
			super.row.setReadOnly(2, value);
		}
		public boolean isColDefaultValueReadOnly()
		{
			return super.row.isReadOnly(2);
		}
		public void showColDefaultValueOpened()
		{
			super.row.showOpened(2);
		}
		public boolean getColDefaultValue()
		{
			return ((Boolean)super.row.get(2)).booleanValue();
		}
		public void setColDefaultValue(boolean value)
		{
			super.row.set(2, new Boolean(value));
		}
		public void setCellColDefaultValueTooltip(String value)
		{
			super.row.setTooltip(2, value);
		}
		public ims.clinicaladmin.vo.HistopathologicGradeVo getValue()
		{
			return (ims.clinicaladmin.vo.HistopathologicGradeVo)super.row.getValue();
		}
	...
	public static class grdHistologyGradeRowCollection extends GridRowCollectionBridge
	{
		private static final long serialVersionUID = 1L;
		
		private grdHistologyGradeRowCollection(GridRowCollection collection)
		{
			super(collection);
		}
		public grdHistologyGradeRow get(int index)
		{
			return new grdHistologyGradeRow(super.collection.get(index));
		}
		public grdHistologyGradeRow newRow()
		{
			return new grdHistologyGradeRow(super.collection.newRow());
		}
		public grdHistologyGradeRow newRow(boolean autoSelect)
		{
			return new grdHistologyGradeRow(super.collection.newRow(autoSelect));
		}
		public grdHistologyGradeRow newRowAt(int index)
		{
			return new grdHistologyGradeRow(super.collection.newRowAt(index));
		}
		public grdHistologyGradeRow newRowAt(int index, boolean autoSelect)
		{
			return new grdHistologyGradeRow(super.collection.newRowAt(index, autoSelect));
		}
	}
	public static class grdHistologyGradeGrid extends GridBridge
	{
		private static final long serialVersionUID = 1L;
		...
		public ims.clinicaladmin.vo.HistopathologicGradeVoCollection getValues()
		{
			ims.clinicaladmin.vo.HistopathologicGradeVoCollection listOfValues = new ims.clinicaladmin.vo.HistopathologicGradeVoCollection();
		...
		public ims.clinicaladmin.vo.HistopathologicGradeVo getValue()
		{
			return (ims.clinicaladmin.vo.HistopathologicGradeVo)super.grid.getValue();
		}
		public void setValue(ims.clinicaladmin.vo.HistopathologicGradeVo value)
		{
			super.grid.setValue(value);
		}
		public grdHistologyGradeRow getSelectedRow()
		{
			return super.grid.getSelectedRow() == null ? null : new grdHistologyGradeRow(super.grid.getSelectedRow());
		}
		public int getSelectedRowIndex()
		{
			return super.grid.getSelectedRowIndex();
		}
		public grdHistologyGradeRowCollection getRows()
		{
			return new grdHistologyGradeRowCollection(super.grid.getRows());
		}
		public grdHistologyGradeRow getRowByValue(ims.clinicaladmin.vo.HistopathologicGradeVo value)
		{
			GridRow row = super.grid.getRowByValue(value);
			return row == null?null:new grdHistologyGradeRow(row);
		}
		...
		public void setColDefaultValueHeaderTooltip(String value)
		{
			super.grid.setColumnHeaderTooltip(2, value);
		}
		public String getColDefaultValueHeaderTooltip()
		{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		// Container Clasess
		RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 8, 360, 672, 88, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		ims.framework.utils.SizeInfo m_ctnDetailsDesignSize = new ims.framework.utils.SizeInfo(672, 88);
		ims.framework.utils.SizeInfo m_ctnDetailsRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper5.getWidth(), anchoringHelper5.getHeight());
		...
		// Button Controls
		RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 605, 456, 75, 23, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 520, 456, 75, 23, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 8, 456, 75, 23, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Select", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		Grid m_grdHistologyGradeTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), new Integer(startTabIndex.intValue() + 1), ControlState.READONLY, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.TRUE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuGenericGrid, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
		addControl(m_grdHistologyGradeTemp);
		grdHistologyGradeGrid grdHistologyGrade = (grdHistologyGradeGrid)GridFlyweightFactory.getInstance().createGridBridge(grdHistologyGradeGrid.class, m_grdHistologyGradeTemp);
		grdHistologyGrade.addStringColumn("Grade", 0, 0, 200, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdHistologyGrade.addStringColumn("Description", 0, 0, 400, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdHistologyGrade.addBoolColumn("Default", 1, 1, -1, true, false, 0, true);
		super.addGrid(grdHistologyGrade);
	}
	...
	public grdHistologyGradeGrid grdHistologyGrade()
	{
		return (grdHistologyGradeGrid)super.getGrid(0);
	}
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_SelectedRecord = new ims.framework.ContextVariable("SelectedRecord", prefix + "_lv_ClinicalAdmin.SelectHistopathologicGrade.__internal_x_context__SelectedRecord_" + componentIdentifier + "");
		}
		...
		public ims.clinicaladmin.vo.HistopathologicGradeVo getSelectedRecord()
		{
			return (ims.clinicaladmin.vo.HistopathologicGradeVo)cxl_SelectedRecord.getValue(context);
		}
		public void setSelectedRecord(ims.clinicaladmin.vo.HistopathologicGradeVo value)
		{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[71] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourDifferentiaion", "BO-1075100006-ID", "ID_HistopathologicGrade");
			fields[72] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourDifferentiaion", "BO-1075100006-TUMOURDIFFERENTATION", "TumourDifferentation");
			fields[73] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourDifferentiaion", "BO-1075100006-ISDEFAULT", "IsDefault");
			fields[74] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourDifferentiaion", "BO-1075100006-ISACTIVE", "IsActive");
			fields[75] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.TumourDifferentiaion", "BO-1075100006-GRADE", "Grade");
			fields[76] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelectHistopathologicGrade.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100006-ID", "ID_HistopathologicGrade");
			fields[77] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelectHistopathologicGrade.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100006-TUMOURDIFFERENTATION", "TumourDifferentation");
			fields[78] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelectHistopathologicGrade.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100006-ISDEFAULT", "IsDefault");
			fields[79] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelectHistopathologicGrade.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100006-ISACTIVE", "IsActive");
			fields[80] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelectHistopathologicGrade.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100006-GRADE", "Grade");
			return fields;
		}
