...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "SelectHistopathologicGrade";
	}
	public int getWidth()
	{
		return 688;
	...
	{
		return new String[] { "_cv_ClinicalAdmin.TumourDifferentiaion" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_ClinicalAdmin.SelectHistopathologicGrade.__internal_x_context__" + String.valueOf(getFormId());
	}
