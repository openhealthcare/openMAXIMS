...
public final class ConfigFlags extends ims.framework.FormConfigFlags implements Serializable
{
	...
	public final PMH_CONFIG_USE_SPECIALTYClass PMH_CONFIG_USE_SPECIALTY;
	...
	public ConfigFlags(ims.framework.ConfigFlag configFlags)
	{
		...
		PMH_CONFIG_USE_SPECIALTY = new PMH_CONFIG_USE_SPECIALTYClass(configFlags);
	}
	...
	public final class PMH_CONFIG_USE_SPECIALTYClass implements Serializable
	{
		private static final long serialVersionUID = 1L;
		private final ims.framework.ConfigFlag configFlags;

		public PMH_CONFIG_USE_SPECIALTYClass(ims.framework.ConfigFlag configFlags)
		{
			this.configFlags = configFlags;
		}
		...
		{
			return (Boolean)configFlags.get("PMH_CONFIG_USE_SPECIALTY");
		}
	}
}
