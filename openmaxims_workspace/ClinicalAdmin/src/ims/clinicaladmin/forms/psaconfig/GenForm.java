...
public class GenForm extends FormBridge
{
	...
	public static class ctnDetailsContainer extends ContainerBridge
	{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			// Label Controls
			RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 728, 10, 43, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
			...
			RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 16, 32, 73, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Description:", new Integer(1), null, new Integer(0)}));
			RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 16, 10, 41, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Name:", new Integer(1), null, new Integer(0)}));
	
			// TextBox Controls
			RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 104, 32, 696, 72, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
			super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, new Integer(100), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.TRUE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
			RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 104, 8, 600, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
			...
			// CheckBox Controls
			RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 784, 10, 16, 16, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
	...
	public static class grdPSAConfigRow extends GridRowBridge
	{
		private static final long serialVersionUID = 1L;
		
		protected grdPSAConfigRow(GridRow row)
		{
			super(row);
		}
		...
		public void setColumnActive(boolean value)
		{
	...
	public static class grdPSAConfigRowCollection extends GridRowCollectionBridge
	{
		private static final long serialVersionUID = 1L;
		
		private grdPSAConfigRowCollection(GridRowCollection collection)
		{
			super(collection);
		}
		public grdPSAConfigRow get(int index)
		{
			return new grdPSAConfigRow(super.collection.get(index));
		}
		public grdPSAConfigRow newRow()
		{
			return new grdPSAConfigRow(super.collection.newRow());
		}
		public grdPSAConfigRow newRow(boolean autoSelect)
		{
			return new grdPSAConfigRow(super.collection.newRow(autoSelect));
		}
		public grdPSAConfigRow newRowAt(int index)
		{
			return new grdPSAConfigRow(super.collection.newRowAt(index));
		}
		public grdPSAConfigRow newRowAt(int index, boolean autoSelect)
		{
			return new grdPSAConfigRow(super.collection.newRowAt(index, autoSelect));
		}
	}
	public static class grdPSAConfigGrid extends GridBridge
	{
		private static final long serialVersionUID = 1L;
		...
		public grdPSAConfigRow getSelectedRow()
		{
			return super.grid.getSelectedRow() == null ? null : new grdPSAConfigRow(super.grid.getSelectedRow());
		}
		public int getSelectedRowIndex()
		{
			return super.grid.getSelectedRowIndex();
		}
		public grdPSAConfigRowCollection getRows()
		{
			return new grdPSAConfigRowCollection(super.grid.getRows());
		}
		public grdPSAConfigRow getRowByValue(ims.clinicaladmin.vo.PSAConfigVo value)
		{
			GridRow row = super.grid.getRowByValue(value);
			return row == null?null:new grdPSAConfigRow(row);
		}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		// Container Clasess
		RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 8, 448, 832, 136, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
		...
		ims.framework.utils.SizeInfo m_ctnDetailsDesignSize = new ims.framework.utils.SizeInfo(832, 136);
		...
		// Button Controls
		RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 687, 592, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 765, 592, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		RuntimeAnchoring anchoringHelper10 = new RuntimeAnchoring(designSize, runtimeSize, 86, 592, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(anchoringHelper10.getX()), new Integer(anchoringHelper10.getY()), new Integer(anchoringHelper10.getWidth()), new Integer(anchoringHelper10.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper11 = new RuntimeAnchoring(designSize, runtimeSize, 8, 592, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		...
		// Grid Controls
		RuntimeAnchoring anchoringHelper12 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 832, 432, ims.framework.enumerations.ControlAnchoring.ALL);
		Grid m_grdPSAConfigTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 1), ControlState.READONLY, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuGenericGrid, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.TRUE, Boolean.TRUE});
		addControl(m_grdPSAConfigTemp);
		grdPSAConfigGrid grdPSAConfig = (grdPSAConfigGrid)GridFlyweightFactory.getInstance().createGridBridge(grdPSAConfigGrid.class, m_grdPSAConfigTemp);
		grdPSAConfig.addStringColumn("Name", 0, 0, 300, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdPSAConfig.addStringColumn("Description", 0, 0, 400, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdPSAConfig.addBoolColumn("Active", 0, 0, -1, true, false, 0, true);
		super.addGrid(grdPSAConfig);
	}
	...
	public grdPSAConfigGrid grdPSAConfig()
	{
		return (grdPSAConfigGrid)super.getGrid(0);
	}
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_SelectedPASConfig = new ims.framework.ContextVariable("SelectedPASConfig", prefix + "_lv_ClinicalAdmin.PSAConfig.__internal_x_context__SelectedPASConfig_" + componentIdentifier + "");
		}
		
		public boolean getSelectedPASConfigIsNotNull()
		{
			return !cxl_SelectedPASConfig.getValueIsNull(context);
		}
		public ims.clinicaladmin.vo.PSAConfigVo getSelectedPASConfig()
		{
			return (ims.clinicaladmin.vo.PSAConfigVo)cxl_SelectedPASConfig.getValue(context);
		}
		public void setSelectedPASConfig(ims.clinicaladmin.vo.PSAConfigVo value)
		{
			cxl_SelectedPASConfig.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_SelectedPASConfig = null;
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[71] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.PSAConfig.__internal_x_context__SelectedPASConfig_" + componentIdentifier, "BO-1075100015-ID", "ID_PSAConfig");
			fields[72] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.PSAConfig.__internal_x_context__SelectedPASConfig_" + componentIdentifier, "BO-1075100015-PSANAME", "PSAName");
			fields[73] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.PSAConfig.__internal_x_context__SelectedPASConfig_" + componentIdentifier, "BO-1075100015-PSADESCRIPTION", "PSADescription");
			fields[74] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.PSAConfig.__internal_x_context__SelectedPASConfig_" + componentIdentifier, "BO-1075100015-ISACTIVE", "IsActive");
			return fields;
		}
