...
public class GenForm extends FormBridge
{
	...
	public static class ctnDetailsContainer extends ContainerBridge
	{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			// Label Controls
			RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 16, 42, 73, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Description:", new Integer(1), null, new Integer(0)}));
			RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 16, 18, 42, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Grade:", new Integer(1), null, new Integer(0)}));
	
			// TextBox Controls
			RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 96, 40, 720, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
			...
			RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 96, 16, 720, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
	...
	public static class grdHistopathologicalGradeRow extends GridRowBridge
	{
		private static final long serialVersionUID = 1L;
		
		protected grdHistopathologicalGradeRow(GridRow row)
		{
			super(row);
		}
	...
	public static class grdHistopathologicalGradeRowCollection extends GridRowCollectionBridge
	{
		private static final long serialVersionUID = 1L;
		
		private grdHistopathologicalGradeRowCollection(GridRowCollection collection)
		{
			super(collection);
		}
		public grdHistopathologicalGradeRow get(int index)
		{
			return new grdHistopathologicalGradeRow(super.collection.get(index));
		}
		public grdHistopathologicalGradeRow newRow()
		{
			return new grdHistopathologicalGradeRow(super.collection.newRow());
		}
		public grdHistopathologicalGradeRow newRow(boolean autoSelect)
		{
			return new grdHistopathologicalGradeRow(super.collection.newRow(autoSelect));
		}
		public grdHistopathologicalGradeRow newRowAt(int index)
		{
			return new grdHistopathologicalGradeRow(super.collection.newRowAt(index));
		}
		public grdHistopathologicalGradeRow newRowAt(int index, boolean autoSelect)
		{
			return new grdHistopathologicalGradeRow(super.collection.newRowAt(index, autoSelect));
		}
	}
	public static class grdHistopathologicalGradeGrid extends GridBridge
	{
		private static final long serialVersionUID = 1L;
		...
		public grdHistopathologicalGradeRow getSelectedRow()
		{
			return super.grid.getSelectedRow() == null ? null : new grdHistopathologicalGradeRow(super.grid.getSelectedRow());
		}
		public int getSelectedRowIndex()
		{
			return super.grid.getSelectedRowIndex();
		}
		public grdHistopathologicalGradeRowCollection getRows()
		{
			return new grdHistopathologicalGradeRowCollection(super.grid.getRows());
		}
		public grdHistopathologicalGradeRow getRowByValue(ims.clinicaladmin.vo.HistopathologicGradeVo value)
		{
			GridRow row = super.grid.getRowByValue(value);
			return row == null?null:new grdHistopathologicalGradeRow(row);
		}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		// Container Clasess
		RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 8, 504, 832, 88, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
		...
		ims.framework.utils.SizeInfo m_ctnDetailsDesignSize = new ims.framework.utils.SizeInfo(832, 88);
		...
		RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 88, 600, 72, 24, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		...
		RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 760, 600, 80, 24, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 672, 600, 80, 24, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		// Grid Controls
		RuntimeAnchoring anchoringHelper10 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 832, 488, ims.framework.enumerations.ControlAnchoring.ALL);
		Grid m_grdHistopathologicalGradeTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(anchoringHelper10.getX()), new Integer(anchoringHelper10.getY()), new Integer(anchoringHelper10.getWidth()), new Integer(anchoringHelper10.getHeight()), new Integer(startTabIndex.intValue() + 1), ControlState.READONLY, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuGenericGrid, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.TRUE, Boolean.TRUE});
		addControl(m_grdHistopathologicalGradeTemp);
		grdHistopathologicalGradeGrid grdHistopathologicalGrade = (grdHistopathologicalGradeGrid)GridFlyweightFactory.getInstance().createGridBridge(grdHistopathologicalGradeGrid.class, m_grdHistopathologicalGradeTemp);
		grdHistopathologicalGrade.addStringColumn("Grade", 0, 0, 200, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdHistopathologicalGrade.addStringColumn("Description", 0, 0, -1, false, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		super.addGrid(grdHistopathologicalGrade);
	}
	...
	public grdHistopathologicalGradeGrid grdHistopathologicalGrade()
	{
		return (grdHistopathologicalGradeGrid)super.getGrid(0);
	}
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_SelectedRecord = new ims.framework.ContextVariable("SelectedRecord", prefix + "_lv_ClinicalAdmin.HistopathologicGradeConfig.__internal_x_context__SelectedRecord_" + componentIdentifier + "");
		}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[71] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.HistopathologicGradeConfig.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100006-ID", "ID_HistopathologicGrade");
			fields[72] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.HistopathologicGradeConfig.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100006-TUMOURDIFFERENTATION", "TumourDifferentation");
			fields[73] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.HistopathologicGradeConfig.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100006-ISDEFAULT", "IsDefault");
			fields[74] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.HistopathologicGradeConfig.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100006-ISACTIVE", "IsActive");
			fields[75] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.HistopathologicGradeConfig.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100006-GRADE", "Grade");
			return fields;
		}
