...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_ClinicalAdmin.TumourHistology" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_ClinicalAdmin.SelectTumourHistology.__internal_x_context__" + String.valueOf(getFormId());
	}
