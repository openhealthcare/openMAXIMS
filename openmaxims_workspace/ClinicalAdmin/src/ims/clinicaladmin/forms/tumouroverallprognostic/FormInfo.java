...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "TumourOverallPrognostic";
	}
	public int getWidth()
	{
		return 400;
	...
	{
		return new String[] { "_cv_Oncology.SelectedRecordForOverallPrognosticDialog", "_cv_Oncology.OverallPrognosticDynamicGridCollection", "_cv_ClinicalAdmin.TumourGroup" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_ClinicalAdmin.TumourOverallPrognostic.__internal_x_context__" + String.valueOf(getFormId());
	}
