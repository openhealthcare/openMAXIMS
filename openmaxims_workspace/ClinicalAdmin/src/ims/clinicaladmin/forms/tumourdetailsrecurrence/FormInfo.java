...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "TumourDetailsRecurrence";
	}
	public int getWidth()
	{
		return 496;
	...
	{
		return new String[] { "_cv_ClinicalAdmin.TumourDetailsRecurrence", "_cv_Core.ParentFormMode" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_ClinicalAdmin.TumourDetailsRecurrence.__internal_x_context__" + String.valueOf(getFormId());
	}
