...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_ClinicalAdmin.TumourSerumMarker" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_ClinicalAdmin.SelectSerumMarker.__internal_x_context__" + String.valueOf(getFormId());
	}
