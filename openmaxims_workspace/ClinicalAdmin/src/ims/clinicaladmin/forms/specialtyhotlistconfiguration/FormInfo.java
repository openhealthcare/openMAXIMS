...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "SpecialtyHotlistConfiguration";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Clinical.SpecialtyHotlistConfigurationVo", "_cv_Clinical.SelectedProcedures", "_cv_Clinical.PMHConfigSearchType" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_ClinicalAdmin.SpecialtyHotlistConfiguration.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/ClinicalAdmin/hotlist_admin_48.png";
	}
}
