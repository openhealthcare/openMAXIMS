...
public class GenForm extends FormBridge
{
	...
	public static class ctnDetailsContainer extends ContainerBridge
	{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 16, 18, 40, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Value:", new Integer(1), null, new Integer(0)}));
	
			// TextBox Controls
			RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 96, 40, 560, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
			...
			RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 96, 16, 560, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
	...
	public static class grdRecordsGrid extends GridBridge
	{
		...
		public grdRecordsRow getRowByValue(ims.oncology.vo.PrognosticLocationConfigVo value)
		{
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_SelctedRecord = new ims.framework.ContextVariable("SelctedRecord", prefix + "_lv_ClinicalAdmin.SelectPrognosticLocation.__internal_x_context__SelctedRecord_" + componentIdentifier + "");
		}
		
		public boolean getSelctedRecordIsNotNull()
		{
			return !cxl_SelctedRecord.getValueIsNull(context);
		}
		public ims.oncology.vo.PrognosticLocationConfigVo getSelctedRecord()
		{
			return (ims.oncology.vo.PrognosticLocationConfigVo)cxl_SelctedRecord.getValue(context);
		}
		public void setSelctedRecord(ims.oncology.vo.PrognosticLocationConfigVo value)
		{
			cxl_SelctedRecord.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_SelctedRecord = null;
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[71] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticLocation", "BO-1075100017-ID", "ID_PrognosticLocationConfig");
			fields[72] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticLocation", "BO-1075100017-LOCATIONNAME", "LocationName");
			fields[73] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticLocation", "BO-1075100017-LOCATIONDESCRIPTION", "LocationDescription");
			fields[74] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticLocation", "BO-1075100017-ISACTIVE", "IsActive");
			fields[75] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelectPrognosticLocation.__internal_x_context__SelctedRecord_" + componentIdentifier, "BO-1075100017-ID", "ID_PrognosticLocationConfig");
			fields[76] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelectPrognosticLocation.__internal_x_context__SelctedRecord_" + componentIdentifier, "BO-1075100017-LOCATIONNAME", "LocationName");
			fields[77] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelectPrognosticLocation.__internal_x_context__SelctedRecord_" + componentIdentifier, "BO-1075100017-LOCATIONDESCRIPTION", "LocationDescription");
			fields[78] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelectPrognosticLocation.__internal_x_context__SelctedRecord_" + componentIdentifier, "BO-1075100017-ISACTIVE", "IsActive");
			return fields;
		}
