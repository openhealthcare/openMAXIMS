...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "SelectPrognosticLocation";
	}
	public int getWidth()
	{
		return 688;
	...
	{
		return new String[] { "_cv_ClinicalAdmin.SelectedPrognosticLocation" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_ClinicalAdmin.SelectPrognosticLocation.__internal_x_context__" + String.valueOf(getFormId());
	}
