...
public class GenForm extends FormBridge
{
	...
	public static class grdRecordsGrid extends GridBridge
	{
		...
		public grdRecordsRow getRowByValue(ims.clinicaladmin.vo.GleasonConfigLiteVo value)
		{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		// Button Controls
		RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 607, 456, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 527, 456, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 7, 456, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_SelectedRecord = new ims.framework.ContextVariable("SelectedRecord", prefix + "_lv_ClinicalAdmin.SelectPrognosticGleason.__internal_x_context__SelectedRecord_" + componentIdentifier + "");
		}
		...
		public ims.clinicaladmin.vo.GleasonConfigLiteVo getSelectedRecord()
		{
			return (ims.clinicaladmin.vo.GleasonConfigLiteVo)cxl_SelectedRecord.getValue(context);
		}
		public void setSelectedRecord(ims.clinicaladmin.vo.GleasonConfigLiteVo value)
		{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[71] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticGleason", "BO-1075100016-ID", "ID_GleasonConfig");
			fields[72] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticGleason", "BO-1075100016-GLEASONNAME", "GleasonName");
			fields[73] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticGleason", "BO-1075100016-GLEASONDESCRIPTION", "GleasonDescription");
			fields[74] = new ims.framework.ReportField(this.context, "_cv_ClinicalAdmin.SelectedPrognosticGleason", "BO-1075100016-ISACTIVE", "IsActive");
			fields[75] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelectPrognosticGleason.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100016-ID", "ID_GleasonConfig");
			fields[76] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelectPrognosticGleason.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100016-GLEASONNAME", "GleasonName");
			fields[77] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelectPrognosticGleason.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100016-GLEASONDESCRIPTION", "GleasonDescription");
			fields[78] = new ims.framework.ReportField(this.context, prefix + "_lv_ClinicalAdmin.SelectPrognosticGleason.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1075100016-ISACTIVE", "IsActive");
			return fields;
		}
