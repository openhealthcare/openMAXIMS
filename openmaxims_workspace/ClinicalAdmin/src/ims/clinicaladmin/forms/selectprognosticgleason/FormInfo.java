...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "SelectPrognosticGleason";
	}
	public int getWidth()
	{
		return 688;
	...
	{
		return new String[] { "_cv_ClinicalAdmin.SelectedPrognosticGleason" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_ClinicalAdmin.SelectPrognosticGleason.__internal_x_context__" + String.valueOf(getFormId());
	}
