...
public class GenForm extends FormBridge
{
	...
	public static class grdLevelRow extends GridRowBridge
	{
		private static final long serialVersionUID = 1L;
		
		protected grdLevelRow(GridRow row)
		{
			super(row);
		}
	...
	public static class grdLevelRowCollection extends GridRowCollectionBridge
	{
		private static final long serialVersionUID = 1L;
		
		private grdLevelRowCollection(GridRowCollection collection)
		{
			super(collection);
		}
		public grdLevelRow get(int index)
		{
			return new grdLevelRow(super.collection.get(index));
		}
		public grdLevelRow newRow()
		{
			return new grdLevelRow(super.collection.newRow());
		}
		public grdLevelRow newRow(boolean autoSelect)
		{
			return new grdLevelRow(super.collection.newRow(autoSelect));
		}
		public grdLevelRow newRowAt(int index)
		{
			return new grdLevelRow(super.collection.newRowAt(index));
		}
		public grdLevelRow newRowAt(int index, boolean autoSelect)
		{
			return new grdLevelRow(super.collection.newRowAt(index, autoSelect));
		}
	}
	public static class grdLevelGrid extends GridBridge
	{
		private static final long serialVersionUID = 1L;
		...
		public grdLevelRow getSelectedRow()
		{
			return super.grid.getSelectedRow() == null ? null : new grdLevelRow(super.grid.getSelectedRow());
		}
		public int getSelectedRowIndex()
		{
			return super.grid.getSelectedRowIndex();
		}
		public grdLevelRowCollection getRows()
		{
			return new grdLevelRowCollection(super.grid.getRows());
		}
		public grdLevelRow getRowByValue(ims.core.vo.VertebrallevelVo value)
		{
			GridRow row = super.grid.getRowByValue(value);
			return row == null?null:new grdLevelRow(row);
		}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), new Integer(-1), ControlState.ENABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		// CheckBox Controls
		RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 16, 16, 112, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// Grid Controls
		RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 16, 40, 816, 544, ims.framework.enumerations.ControlAnchoring.ALL);
		Grid m_grdLevelTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), new Integer(-1), ControlState.DISABLED, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuAddUpDown, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.TRUE, Boolean.TRUE});
		addControl(m_grdLevelTemp);
		grdLevelGrid grdLevel = (grdLevelGrid)GridFlyweightFactory.getInstance().createGridBridge(grdLevelGrid.class, m_grdLevelTemp);
		grdLevel.addStringColumn("Level", 0, 0, 130, false, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdLevel.addStringColumn("Description", 0, 0, 420, false, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdLevel.addBoolColumn("Active", 1, 1, -1, false, false, 0, true);
		super.addGrid(grdLevel);
	}
	...
	public grdLevelGrid grdLevel()
	{
		return (grdLevelGrid)super.getGrid(0);
	}
