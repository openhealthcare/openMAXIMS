...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "TumourOtherClassification";
	}
	public int getWidth()
	{
		return 536;
	...
	{
		return new String[] { "_cv_ClinicalAdmin.TumourGroupOtherClassification" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_ClinicalAdmin.TumourOtherClassification.__internal_x_context__" + String.valueOf(getFormId());
	}
