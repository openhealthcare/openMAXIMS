...
{
	abstract protected void bindgrdTypecolDurationUnitLookup();
	abstract protected void bindcmbDurationUnitLookup();
	abstract protected void defaultcmbDurationUnitLookupValue();
	abstract protected void bindgrdListcolDurationUnitLookup();
	abstract protected void onFormModeChanged();
	abstract protected void onFormOpen() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onChkHasTypeValueChanged() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onGrdSizeSelectionChanged() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onGrdTypeSelectionChanged() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void oncmbDurationUnitValueSet(Object value);
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.ctnDetails().chkHasType().setValueChangedEvent(new ValueChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onChkHasTypeValueChanged();
			}
		});
		this.form.ctnDetails().grdSize().setSelectionChangedEvent(new GridSelectionChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.enumerations.MouseButton mouseButton) throws ims.framework.exceptions.PresentationLogicException
			{
				onGrdSizeSelectionChanged();
			}
		});
		this.form.ctnDetails().grdType().setSelectionChangedEvent(new GridSelectionChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.enumerations.MouseButton mouseButton) throws ims.framework.exceptions.PresentationLogicException
			{
		...
		this.form.ctnDetails().cmbDurationUnit().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				oncmbDurationUnitValueSet(value);
			}
		});
		...
		this.form.getContextMenus().getInvasiveDeviceConfigTypeAddItem().setClickEvent(new ims.framework.delegates.MenuItemClick()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.Control sender) throws ims.framework.exceptions.PresentationLogicException
			{
				onContextMenuItemClick(GenForm.ContextMenus.InvasiveDeviceConfigType.Add, sender);
			}
		});
		this.form.getContextMenus().getInvasiveDeviceConfigTypeRemoveItem().setClickEvent(new ims.framework.delegates.MenuItemClick()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.Control sender) throws ims.framework.exceptions.PresentationLogicException
			{
				onContextMenuItemClick(GenForm.ContextMenus.InvasiveDeviceConfigType.Remove, sender);
			}
		});
		this.form.getContextMenus().getInvasiveDeviceConfigTypeUpdateItem().setClickEvent(new ims.framework.delegates.MenuItemClick()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.Control sender) throws ims.framework.exceptions.PresentationLogicException
			{
				onContextMenuItemClick(GenForm.ContextMenus.InvasiveDeviceConfigType.Update, sender);
			}
		});
		this.form.getContextMenus().getInvasiveDeviceConfigTypeInactivateItem().setClickEvent(new ims.framework.delegates.MenuItemClick()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.Control sender) throws ims.framework.exceptions.PresentationLogicException
			{
				onContextMenuItemClick(GenForm.ContextMenus.InvasiveDeviceConfigType.Inactivate, sender);
			}
		});
	...
	{
		bindgrdTypecolDurationUnitLookup();
		bindcmbDurationUnitLookup();
		bindgrdListcolDurationUnitLookup();
	}
	...
	{
		defaultcmbDurationUnitLookupValue();
	}
