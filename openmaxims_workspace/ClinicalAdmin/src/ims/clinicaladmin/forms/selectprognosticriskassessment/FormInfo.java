...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "SelectPrognosticRiskAssessment";
	}
	public int getWidth()
	{
		return 688;
	...
	{
		return new String[] { "_cv_ClinicalAdmin.SelectedPrognosticRiskAssessment" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_ClinicalAdmin.SelectPrognosticRiskAssessment.__internal_x_context__" + String.valueOf(getFormId());
	}
