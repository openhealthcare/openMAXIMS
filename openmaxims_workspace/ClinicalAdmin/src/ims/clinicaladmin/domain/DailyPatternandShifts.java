...
public interface DailyPatternandShifts extends ims.domain.DomainInterface
{
	...
	* save 
	*/
	public ims.clinicaladmin.vo.DailyPatternConfigVo save(ims.clinicaladmin.vo.DailyPatternConfigVo record) throws ims.domain.exceptions.StaleObjectException, ims.domain.exceptions.UniqueKeyViolationException;
