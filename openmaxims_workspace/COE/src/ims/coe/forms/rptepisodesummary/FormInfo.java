...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_COE.TransferNote" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_COE.RptEpisodeSummary.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Clinical/documents_48.png";
	}
}
