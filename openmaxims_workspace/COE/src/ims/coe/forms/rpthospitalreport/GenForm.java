...
public class GenForm extends FormBridge
{
	...
	{
		if(new ims.framework.ContextVariable("Core.Reports.EndTime", "_cv_Core.Reports.EndTime").getValueIsNull(context))
			throw new ims.framework.exceptions.FormMandatoryContextMissingException("The required context data 'Core.Reports.EndTime' is not available.");
		if(new ims.framework.ContextVariable("Core.Reports.StartTime", "_cv_Core.Reports.StartTime").getValueIsNull(context))
			throw new ims.framework.exceptions.FormMandatoryContextMissingException("The required context data 'Core.Reports.StartTime' is not available.");
	}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 832, 616, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
