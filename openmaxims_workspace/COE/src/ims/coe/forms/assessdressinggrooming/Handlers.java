...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void bindcomboBoxShavingLookup();
	abstract protected void defaultcomboBoxShavingLookupValue();
	abstract protected void bindgridPreferenceColStatusLookup();
	abstract protected void bindgridGroomingcolAbilityLookup();
	abstract protected void onFormOpen() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onanswerBoxRequireAssistanceValueSet(Object value);
	abstract protected void oncomboBoxShavingValueSet(Object value);
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.answerBoxRequireAssistance().setValueSetEvent(new AnswerBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
		...
		this.form.comboBoxShaving().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				oncomboBoxShavingValueSet(value);
			}
		});
	...
	protected void bindLookups()
	{
		...
		bindgridPreferenceColStatusLookup();
		bindgridGroomingcolAbilityLookup();
	}
	...
	protected void defaultAllLookupValues()
	{
		...
		defaultcomboBoxShavingLookupValue();
	}
