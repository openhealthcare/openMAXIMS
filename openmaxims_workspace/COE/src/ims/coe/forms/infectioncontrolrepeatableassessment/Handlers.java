...
{
	abstract protected void bindgrdRecordscolStatusLookup();
	abstract protected void bindgrdRecordsColResultLookup();
	...
	{
		bindgrdRecordscolStatusLookup();
		bindgrdRecordsColResultLookup();
	}
