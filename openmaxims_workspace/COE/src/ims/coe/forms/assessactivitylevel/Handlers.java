...
{
	abstract protected void bindgridActivitycolAbilityLookup();
	abstract protected void bindgridActivityColAidsLookup();
	...
	{
		bindgridActivitycolAbilityLookup();
		bindgridActivityColAidsLookup();
	}
