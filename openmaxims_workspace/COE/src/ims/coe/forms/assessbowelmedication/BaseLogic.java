...
public abstract class BaseLogic extends Handlers
{
	...
	{
		return ims.coe.domain.AssessBowelMedication.class;
	}
	public final void setContext(ims.framework.UIEngine engine, GenForm form, ims.coe.domain.AssessBowelMedication domain)
	{
	...
	protected final void oncomboBoxMedValueSet(Object value)
	{
		...
		if(value == null)
		{
			if(listOfValues != null && listOfValues.size() > 0)
			{
				for(int x = 0; x < listOfValues.size(); x++)
				{
					ims.coe.vo.lookups.BowelMedication existingInstance = (ims.coe.vo.lookups.BowelMedication)listOfValues.get(x);
					if(!existingInstance.isActive())
					{
		...
		else if(value instanceof ims.coe.vo.lookups.BowelMedication)
		{
			ims.coe.vo.lookups.BowelMedication instance = (ims.coe.vo.lookups.BowelMedication)value;
	...
	protected final void bindcomboBoxMedLookup()
	{
		...
		ims.coe.vo.lookups.BowelMedicationCollection lookupCollection = ims.coe.vo.lookups.LookupHelper.getBowelMedication(this.domain.getLookupService());
		for(int x = 0; x < lookupCollection.size(); x++)
		{
	...
	{
		ims.coe.vo.lookups.BowelMedication instance = ims.coe.vo.lookups.LookupHelper.getBowelMedicationInstance(this.domain.getLookupService(), id);
		if(instance != null)
			this.form.comboBoxMed().setValue(instance);
	}
	protected final void defaultcomboBoxMedLookupValue()
	{
		this.form.comboBoxMed().setValue((ims.coe.vo.lookups.BowelMedication)domain.getLookupService().getDefaultInstance(ims.coe.vo.lookups.BowelMedication.class, engine.getFormName().getID(), ims.coe.vo.lookups.BowelMedication.TYPE_ID));
	}
	...
	protected ims.coe.domain.AssessBowelMedication domain;
}
