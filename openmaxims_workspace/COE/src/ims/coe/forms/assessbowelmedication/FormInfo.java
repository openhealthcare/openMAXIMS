...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_COE.BowelMedication" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_COE.AssessBowelMedication.__internal_x_context__" + String.valueOf(getFormId());
	}
