...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_COE.PainMedication" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_COE.AssessPainMedication.__internal_x_context__" + String.valueOf(getFormId());
	}
