...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void bindcomboBoxMethodLookup();
	abstract protected void defaultcomboBoxMethodLookupValue();
	...
	abstract protected void oncomboBoxMethodValueSet(Object value);
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.comboBoxType().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
		...
		this.form.comboBoxMethod().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				oncomboBoxMethodValueSet(value);
			}
		});
	}
	...
	protected void defaultAllLookupValues()
	{
		...
		defaultcomboBoxMethodLookupValue();
	}
