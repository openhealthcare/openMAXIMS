...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_COE.CarePlan.TemplateList", "_cv_COE.BowelMedication", "_cv_Nursing.AssessmentInfo", "_cv_Nursing.AssessmentHeaderInfo" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_COE.AssessBowels.__internal_x_context__" + String.valueOf(getFormId());
	}
