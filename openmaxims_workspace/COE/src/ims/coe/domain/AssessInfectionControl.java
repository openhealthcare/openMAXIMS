...
public interface AssessInfectionControl extends ims.domain.DomainInterface
{
	...
	*/
	public ims.nursing.vo.AssessmentHeaderInfo saveComponent(ims.nursing.vo.AssessmentHeaderInfo assessmentVo, ims.nursing.vo.AssessmentComponent componentVo) throws ims.domain.exceptions.DomainInterfaceException, ims.domain.exceptions.StaleObjectException;

	// Generated from form domain interface definition
	/**
	* Gets the last Assessment Component of type mobility for the given patient
	*/
