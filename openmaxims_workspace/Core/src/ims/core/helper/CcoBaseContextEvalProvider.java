...
import ims.admin.helper.CcoContextReader;
...
public abstract class CcoBaseContextEvalProvider extends DomainImpl implements IContextEvalProvider
{
	...
	public boolean isPatientRip()
	{
		...
		PatientShort pat = CcoContextReader.getPatientShort(ctx);
		if (pat == null)
			return false;
		else
	...
	{
		Context ctx = getContext();
		EpisodeofCareShortVo epis = CcoContextReader.getCurrentEpisodeOfCare(ctx);
		if (epis == null)
			return false;
		else
