...
public abstract class BasePendingElectiveAdmissionsListELComponentImpl extends DomainImpl implements ims.core.domain.PendingElectiveAdmissionsListELComponent, ims.domain.impl.Transactional
{
	...
	@SuppressWarnings("unused")
	public void validategetElectiveLists(ims.core.vo.PendingElectiveAdmissionListFilterVo searchFilter)
	{
	}
