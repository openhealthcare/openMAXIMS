...
public class GenForm extends FormBridge
{
	...
	public static class grdDetailsRow extends GridRowBridge
	{
		...
		{
			return (ims.core.vo.FloorBedSpaceLayoutLiteVo)super.row.getValue();
		}
	...
	public static class grdDetailsGrid extends GridBridge
	{
		...
		public ims.core.vo.FloorBedSpaceLayoutLiteVoCollection getValues()
		{
			ims.core.vo.FloorBedSpaceLayoutLiteVoCollection listOfValues = new ims.core.vo.FloorBedSpaceLayoutLiteVoCollection();
		...
		public ims.core.vo.FloorBedSpaceLayoutLiteVo getValue()
		{
			return (ims.core.vo.FloorBedSpaceLayoutLiteVo)super.grid.getValue();
		}
		public void setValue(ims.core.vo.FloorBedSpaceLayoutLiteVo value)
		{
		...
		public grdDetailsRow getRowByValue(ims.core.vo.FloorBedSpaceLayoutLiteVo value)
		{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		// Label Controls
		RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 24, 24, 48, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));

		// ComboBox Controls
		RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 72, 22, 200, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		grdDetails.addStringColumn("Name", 0, 0, 500, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdDetails.addComboBoxColumn("Status", 0, 0, 200, true, true, false, false, true, -1);
		grdDetails.addBoolColumn("Template", 0, 1, -1, true, false, 1, true);
		super.addGrid(grdDetails);

		// Image Buttons Controls
		RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 800, 17, 30, 30, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 768, 17, 30, 30, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), new Integer(startTabIndex.intValue() + 3), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, this.getImages().Core.FindEnabled24, this.getImages().Core.FindDisabled24, "Search for Bed space layouts matching 'Search Criteria'", Boolean.FALSE, Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null}));
	}
	...
	public CheckBox chkTemplatesOnly()
	{
	...
	public static class Forms implements java.io.Serializable
	{
		...
		public final class CoreForms implements java.io.Serializable
		{
			...
			private CoreForms()
			{
				BayBedSpaceLayoutDesigner = new LocalFormName(102260);
			}
			public final FormName BayBedSpaceLayoutDesigner;
		}
