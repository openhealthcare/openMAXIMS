...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.BedFloorLayout.ReadOnly", "_cv_Core.BedFloorLayout.Selection", "_cv_Core.BedLayoutAction" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.BedSpaceLayoutList.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/bed_layout_list_48.png";
	}
}
