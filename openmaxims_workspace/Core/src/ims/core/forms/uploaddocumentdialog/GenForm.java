...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[99] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-ID", "ID_CatsReferral");
			fields[100] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-CARECONTEXT", "CareContext");
			fields[101] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-ADDITIONALINVAPPTSSTATUS", "AdditionalInvApptsStatus");
			fields[102] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-HASINVESTIGATIONS", "HasInvestigations");
			fields[103] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-HASAPPOINTMENTS", "HasAppointments");
			fields[104] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-HASDOCUMENTS", "HasDocuments");
			fields[105] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-HASREFERRALLETTER", "HasReferralLetter");
			fields[106] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-ISCAB", "IsCAB");
			fields[107] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-HASREJECTEDINV", "HasRejectedInv");
			fields[108] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-ONWARDREFERRALSTATUS", "OnwardReferralStatus");
			fields[109] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-PROVIDERCANCELLATION", "ProviderCancellation");
			fields[110] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-HASCONSULTATIONDETAILS", "HasConsultationDetails");
			fields[111] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-DISCHARGEDATE", "DischargeDate");
			fields[112] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-ISFINALREPORTREQUIRED", "IsFinalReportRequired");
			fields[113] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-TRIAGEDATETIME", "TriageDateTime");
			fields[114] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-LASTAPPTARRIVEDDATE", "LastApptArrivedDate");
			fields[115] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-ISACCEPTEDONCAB", "IsAcceptedOnCAB");
			fields[116] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-ISREFERRALREJECTEDONCAB", "IsReferralRejectedOnCAB");
			fields[117] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-WASPATIENTREJECTIONLETTERSENT", "WasPatientRejectionLetterSent");
			fields[118] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-WASPATIENTPROVIDERCANCELLATIONLETTERSENT", "WasPatientProviderCancellationLetterSent");
			fields[119] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-REQUIRESDISCHARGEREP", "RequiresDischargeRep");
			fields[120] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-HASDNAAPPTSFORREVIEW", "HasDNAApptsForReview");
			fields[121] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-HASCANCELLEDAPPTSFORREVIEW", "HasCancelledApptsForReview");
			fields[122] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-ISSECONDARYREPORTREQUIRED", "IsSecondaryReportRequired");
			fields[123] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-WASFURTHERMANAGEMENTDETAILSREVIEWED", "WasFurtherManagementDetailsReviewed");
			fields[124] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-ONWARDREFERRALREASON", "OnwardReferralReason");
			fields[125] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-DISCHARGETOGPDETAILSREVIEWSTATUS", "DischargeToGPDetailsReviewStatus");
			fields[126] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-ISSUITABLEFORSURGERY", "IsSuitableForSurgery");
			fields[127] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-ISFITFORSURGERY", "IsFitForSurgery");
			fields[128] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-ISAWAITINGCLINICALINFO", "IsAwaitingClinicalInfo");
			fields[129] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-ISACTIVEMONITORAPPTREQUIRED", "IsActiveMonitorApptRequired");
			fields[130] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-CATSREPORTSENTDATE", "CATSReportSentDate");
			fields[131] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-ENDOFCAREDATE", "EndOfCareDate");
			fields[132] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-PROCEDUREFORPOSTOPREVIEW", "ProcedureForPostOpReview");
			fields[133] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-REFERRALCATEGORY", "ReferralCategory");
			fields[134] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-ISONWARDREFERRALTRIAGE", "IsOnwardReferralTriage");
			fields[135] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-URGENCY", "Urgency");
			fields[136] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-PATHWAYID", "PathwayID");
			fields[137] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-RTTCLOCKIMPACT", "RTTClockImpact");
			fields[138] = new ims.framework.ReportField(this.context, "_cv_CareUk.CatsReferralWizard", "BO-1004100035-CONSUPGRADEDATE", "ConsUpgradeDate");
