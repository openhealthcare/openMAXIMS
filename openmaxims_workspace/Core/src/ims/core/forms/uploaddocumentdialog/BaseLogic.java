...
public abstract class BaseLogic extends Handlers
{
	...
	{
		return ims.core.domain.UploadDocumentDialog.class;
	}
	public final void setContext(ims.framework.UIEngine engine, GenForm form, ims.core.domain.UploadDocumentDialog domain)
	{
	...
	{
		this.form.cmbSource().setValue((ims.core.vo.lookups.DocumentCategory)domain.getLookupService().getDefaultInstance(ims.core.vo.lookups.DocumentCategory.class, engine.getFormName().getID(), ims.core.vo.lookups.DocumentCategory.TYPE_ID));
	}
	protected final void oncmbTypeValueSet(Object value)
	{
		...
		if(value == null)
		{
			if(listOfValues != null && listOfValues.size() > 0)
			{
				for(int x = 0; x < listOfValues.size(); x++)
				{
					ims.core.vo.lookups.DocumentCreationType existingInstance = (ims.core.vo.lookups.DocumentCreationType)listOfValues.get(x);
					if(!existingInstance.isActive())
					{
						bindcmbTypeLookup();
						return;
		...
		else if(value instanceof ims.core.vo.lookups.DocumentCreationType)
		{
			ims.core.vo.lookups.DocumentCreationType instance = (ims.core.vo.lookups.DocumentCreationType)value;
	...
	protected final void bindcmbTypeLookup()
	{
		...
		ims.core.vo.lookups.DocumentCreationTypeCollection lookupCollection = ims.core.vo.lookups.LookupHelper.getDocumentCreationType(this.domain.getLookupService());
		for(int x = 0; x < lookupCollection.size(); x++)
		{
	...
	{
		ims.core.vo.lookups.DocumentCreationType instance = ims.core.vo.lookups.LookupHelper.getDocumentCreationTypeInstance(this.domain.getLookupService(), id);
		if(instance != null)
			this.form.cmbType().setValue(instance);
	}
	protected final void defaultcmbTypeLookupValue()
	{
		this.form.cmbType().setValue((ims.core.vo.lookups.DocumentCreationType)domain.getLookupService().getDefaultInstance(ims.core.vo.lookups.DocumentCreationType.class, engine.getFormName().getID(), ims.core.vo.lookups.DocumentCreationType.TYPE_ID));
	}
	...
	protected ims.core.domain.UploadDocumentDialog domain;
}
