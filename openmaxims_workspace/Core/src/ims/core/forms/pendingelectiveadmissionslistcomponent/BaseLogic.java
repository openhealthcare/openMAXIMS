...
public abstract class BaseLogic extends Handlers implements IComponent
{
	...
	{
		return ims.core.domain.PendingElectiveAdmissionsListComponent.class;
	}
	public final void setContext(ims.framework.UIComponentEngine engine, GenForm form, ims.core.domain.PendingElectiveAdmissionsListComponent domain)
	{
	...
	protected ims.core.domain.PendingElectiveAdmissionsListComponent domain;
}
