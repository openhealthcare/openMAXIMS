...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.PatientToBeDisplayed", "_cv_Core.CustomListName" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.CustomPatientList.__internal_x_context__" + String.valueOf(getFormId());
	}
