...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.OtherNames", "_cv_Core.ParentFormMode" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.AliasNames.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/alias_names_48.png";
	}
}
