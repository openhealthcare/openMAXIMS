...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.PatientImage", "_cv_Core.PatientPhotoTempFiles" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.PatientImageDisplay.__internal_x_context__" + String.valueOf(getFormId());
	}
	public ims.framework.FormInfo[] getComponentsFormInfo()
	{
		ims.framework.FormInfo[] componentsInfo = new ims.framework.FormInfo[1];
		componentsInfo[0] = new ims.core.forms.dbimagedisplay.FormInfo(102336);
