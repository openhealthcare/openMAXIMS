...
public abstract class BaseLogic extends Handlers
{
	...
	{
		this.form.cmbStatus().setValue((ims.core.vo.lookups.DocumentStatus)domain.getLookupService().getDefaultInstance(ims.core.vo.lookups.DocumentStatus.class, engine.getFormName().getID(), ims.core.vo.lookups.DocumentStatus.TYPE_ID));
	}
