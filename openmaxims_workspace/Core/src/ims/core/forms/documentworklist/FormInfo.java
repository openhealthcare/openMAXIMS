...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.PatientCorrespondence", "_cv_Core.PatientDocumentsErrors" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.DocumentWorklist.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/documents_zoom_48.png";
	}
}
