...
public abstract class BaseLogic extends Handlers implements IComponent
{
	...
	{
		return ims.core.domain.MOSQuery.class;
	}
	public final void setContext(ims.framework.UIComponentEngine engine, GenForm form, ims.core.domain.MOSQuery domain)
	{
	...
	protected ims.core.domain.MOSQuery domain;
}
