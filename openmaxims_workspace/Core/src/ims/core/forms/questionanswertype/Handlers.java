...
{
	abstract protected void bindgrdAnswerOptioncolExtCodeTypeLookup();
	abstract protected void bindcmbAnswerTypeLookup();
	abstract protected void defaultcmbAnswerTypeLookupValue();
	abstract protected void onFormModeChanged();
	abstract protected void onFormOpen() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onFormDialogClosed(ims.framework.FormName formName, ims.framework.enumerations.DialogResult result) throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onChkMaxMultiselectValueChanged() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onChkCustomWidthValueChanged() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onGrdAnswerOptionGridButtonClicked(int column, GenForm.grdAnswerOptionRow row) throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onGrdAnswerOptionSelectionChanged() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onChkIsMandatoryValueChanged() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void oncmbAnswerTypeValueSet(Object value);
	abstract protected void onCmbAnswerTypeValueChanged() throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.chkMaxMultiselect().setValueChangedEvent(new ValueChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onChkMaxMultiselectValueChanged();
			}
		});
		...
		this.form.grdAnswerOption().setGridButtonClickedEvent(new GridButtonClicked()
		{
			private static final long serialVersionUID = 1L;
			...
			{
				onGrdAnswerOptionGridButtonClicked(column, new GenForm.grdAnswerOptionRow(row));
			}
		});
		this.form.grdAnswerOption().setSelectionChangedEvent(new GridSelectionChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.enumerations.MouseButton mouseButton) throws ims.framework.exceptions.PresentationLogicException
			{
				onGrdAnswerOptionSelectionChanged();
			}
		});
		this.form.chkIsMandatory().setValueChangedEvent(new ValueChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onChkIsMandatoryValueChanged();
			}
		});
		this.form.cmbAnswerType().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				oncmbAnswerTypeValueSet(value);
			}
		});
		this.form.cmbAnswerType().setValueChangedEvent(new ValueChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onCmbAnswerTypeValueChanged();
			}
		});
	...
	{
		bindgrdAnswerOptioncolExtCodeTypeLookup();
	...
	{
		defaultcmbAnswerTypeLookupValue();
	}
