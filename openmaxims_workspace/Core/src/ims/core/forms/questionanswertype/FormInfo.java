...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.QuestionAnswerType", "_cv_Core.QuestionEditViewMode", "_cv_Core.UserDefinedAssessmentType", "_cv_Core.QuestionType", "_cv_Core.TaxonomyMap", "_cv_Admin.SelectedQuestion" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.QuestionAnswerType.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/question_answer_48.png";
	}
}
