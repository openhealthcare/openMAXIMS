...
public abstract class BaseLogic extends Handlers implements IComponent
{
	...
	{
		return ims.core.domain.AuthoringInfo.class;
	}
	public final void setContext(ims.framework.UIComponentEngine engine, GenForm form, ims.core.domain.AuthoringInfo domain)
	{
	...
	protected ims.core.domain.AuthoringInfo domain;
}
