...
public abstract class BaseLogic extends Handlers
{
	...
	{
		return ims.core.domain.PatientDocumentSearch.class;
	}
	public final void setContext(ims.framework.UIEngine engine, GenForm form, ims.core.domain.PatientDocumentSearch domain)
	{
		...
		if(domain.getLookupService().countLookupInstances(ims.core.vo.lookups.DocumentCreationTypeCollection.class, ims.core.vo.lookups.DocumentCreationType.class, 1021219, true) == 0)
		{
			if(lookupUsageErrors == null)
				lookupUsageErrors = new java.util.ArrayList();
			lookupUsageErrors.add("The lookup type 'DocumentCreationType' (ID: 1021219) must have at least one active instance configured.");
		}
		if(domain.getLookupService().countLookupInstances(ims.core.vo.lookups.PreActiveActiveInactiveStatusCollection.class, ims.core.vo.lookups.PreActiveActiveInactiveStatus.class, 1021124, true) == 0)
		{
			if(lookupUsageErrors == null)
				lookupUsageErrors = new java.util.ArrayList();
			lookupUsageErrors.add("The lookup type 'PreActiveActiveInactiveStatus' (ID: 1021124) must have at least one active instance configured.");
		}
	}
	...
	protected ims.core.domain.PatientDocumentSearch domain;
}
