...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.PatientDocument", "_cv_Core.PatientCorrespondence" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.PatientDocumentSearch.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/patient_documents_search_48.png";
	}
}
