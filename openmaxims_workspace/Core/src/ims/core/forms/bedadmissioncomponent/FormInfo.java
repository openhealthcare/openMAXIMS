...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.HasWaitingArea", "_cv_Core.ADTWard", "_cv_Core.SelectedBedSpaceState" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.BedAdmissionComponent.__internal_x_context__" + String.valueOf(getFormId());
	}
