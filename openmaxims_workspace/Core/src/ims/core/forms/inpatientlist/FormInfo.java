...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Correspondence.DocDetailIdReportSeed", "_cv_Correspondence.GenerateFormMode", "_cv_Core.RCHTInpatientDischarge", "_cv_Core.PatientToBeDisplayed" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.InpatientList.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/inpatient_48.png";
	}
}
