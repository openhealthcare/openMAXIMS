...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "VitalSignsVentilationChartDialog";
	}
	public int getWidth()
	{
		return 648;
	...
	{
		return new String[] { "_cv_Core.VentilationChartDateTime", "_cv_Core.VSVentilationChartRecord", "_cv_Core.YesNoDialogMessage", "_cv_Core.VitalSign" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.VitalSignsVentilationChartDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/vital_signs_respiration_48.png";
	}
}
