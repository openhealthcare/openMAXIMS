...
public class GenForm extends FormBridge
{
	...
	public static class grdDetailsRow extends GridRowBridge
	{
		...
		{
			return (ims.core.vo.FloorLayoutLiteVo)super.row.getValue();
		}
	...
	public static class grdDetailsGrid extends GridBridge
	{
		...
		public ims.core.vo.FloorLayoutLiteVoCollection getValues()
		{
			ims.core.vo.FloorLayoutLiteVoCollection listOfValues = new ims.core.vo.FloorLayoutLiteVoCollection();
		...
		public ims.core.vo.FloorLayoutLiteVo getValue()
		{
			return (ims.core.vo.FloorLayoutLiteVo)super.grid.getValue();
		}
		public void setValue(ims.core.vo.FloorLayoutLiteVo value)
		{
		...
		public grdDetailsRow getRowByValue(ims.core.vo.FloorLayoutLiteVo value)
		{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Panel.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,"Floor Layouts", new Integer(1), ""}));
		...
		// Grid Controls
		RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 16, 48, 816, 528, ims.framework.enumerations.ControlAnchoring.ALL);
		...
		grdDetails.addStringColumn("Name", 0, 0, 500, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdDetails.addComboBoxColumn("Status", 0, 0, -1, true, true, false, false, true, -1);
	...
	public static class Forms implements java.io.Serializable
	{
		...
		public final class CoreForms implements java.io.Serializable
		{
			...
			private CoreForms()
			{
				BayFloorPlanDesigner = new LocalFormName(102258);
			}
			public final FormName BayFloorPlanDesigner;
		}
