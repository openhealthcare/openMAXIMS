...
public abstract class BaseLogic extends Handlers implements IComponent
{
	...
	{
		return ims.core.domain.UploadDocument.class;
	}
	public final void setContext(ims.framework.UIComponentEngine engine, GenForm form, ims.core.domain.UploadDocument domain)
	{
	...
	protected ims.core.domain.UploadDocument domain;
}
