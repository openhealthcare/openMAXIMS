...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.GPSurgery", "_cv_Core.GPPractice", "_cv_OCRR.GPSearchString", "_cv_Core.GPDetails" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.GPSelection.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Admin/doctor_48.png";
	}
}
