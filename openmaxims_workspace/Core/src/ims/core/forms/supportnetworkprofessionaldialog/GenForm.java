...
public class GenForm extends FormBridge
{
	...
	public static class grdProfessionalRow extends GridRowBridge
	{
		...
		public void setProfessionReadOnly(boolean value)
		{
			super.row.setReadOnly(2, value);
		}
		public boolean isProfessionReadOnly()
		{
			return super.row.isReadOnly(2);
		}
		public void showProfessionOpened()
		{
		...
		public void setCellProfessionTooltip(String value)
		{
	...
	public static class grdProfessionalGrid extends GridBridge
	{
		...
		public void setProfessionHeaderTooltip(String value)
		{
			super.grid.setColumnHeaderTooltip(2, value);
		}
		public String getProfessionHeaderTooltip()
		{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Cancel", Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));

		// ComboBox Controls
		RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 192, 14, 328, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// Grid Controls
		RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 48, 48, 576, 312, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		grdProfessional.addBoolColumn("Select", 1, 1, 80, false, false, 0, true);
		grdProfessional.addStringColumn("Name", 0, 0, 150, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdProfessional.addStringColumn("Profession", 0, 0, 225, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdProfessional.addStringColumn("Work Phone", 0, 0, -1, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		super.addGrid(grdProfessional);

		// Link Controls
		RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 48, 368, 104, 17, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Link.class, new Object[] { control, new Integer(startControlID.intValue() + 1005), new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), new Integer(startTabIndex.intValue() + 3), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT,"GP Details", Boolean.FALSE, null}));
	}
