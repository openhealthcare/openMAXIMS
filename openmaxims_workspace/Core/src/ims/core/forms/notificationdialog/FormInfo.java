...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.Notification" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.NotificationDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/notification_details_48.png";
	}
}
