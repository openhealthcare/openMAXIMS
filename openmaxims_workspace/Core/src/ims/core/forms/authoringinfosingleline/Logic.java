...
public class Logic extends BaseLogic
{
	...
	private static final String	AUTHORED_DATE_TIME	= "Authored Date/Time:";
	private static final String	AUTHORED_HCP		= "Authored by:";
	...
	public void setLabels(AuthoringLabelType labelType)
	{
		if(labelType != null)
		{
			...
			//WDEV-16791
			if(labelType.equals(AuthoringLabelType.AUTHORED))
			{
				setLabelsText(AUTHORED_HCP, AUTHORED_DATE_TIME);
			}
