...
public abstract class BaseLogic extends Handlers implements IComponent
{
	...
	{
		return ims.core.domain.AddressSearch.class;
	}
	public final void setContext(ims.framework.UIComponentEngine engine, GenForm form, ims.core.domain.AddressSearch domain)
	{
	...
	protected ims.core.domain.AddressSearch domain;
}
