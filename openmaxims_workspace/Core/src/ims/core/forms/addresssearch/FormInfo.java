...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.AddressSearchType", "_cv_Core.AddressSearchText", "_cv_Core.PersonAddress", "_cv_Core.OtherAddresses" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.AddressSearch.__internal_x_context__" + String.valueOf(getFormId());
	}
