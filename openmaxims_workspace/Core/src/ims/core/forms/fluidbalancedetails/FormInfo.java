...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.CurrentDailyFluidBalanceVo", "_cv_Core.CurrentDailyFluidBalanceInstanceVo", "_cv_Core.CurrentDailyPatternConfigVo", "_cv_Core.YesNoDialogMessage" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.FluidBalanceDetails.__internal_x_context__" + String.valueOf(getFormId());
	}
