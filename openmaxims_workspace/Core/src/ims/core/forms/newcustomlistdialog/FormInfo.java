...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.CustomListName" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.RCHTNewCustomListDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
