...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.AutoOpenViewReport", "_cv_Core.ReportID", "_cv_Core.TemplateID", "_cv_Core.CurrentFormName" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.Reports.__internal_x_context__" + String.valueOf(getFormId());
	}
