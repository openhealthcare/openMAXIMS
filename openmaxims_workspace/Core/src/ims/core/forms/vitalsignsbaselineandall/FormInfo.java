...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "VitalSignsBaselineAndAll";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Core.VitalSign", "_cv_Assessment.IsDynamicAssessmentOpenedForPreview", "_cv_Core.VitalSignsEscalationScore", "_cv_Core.VitalSignsEscalationText", "_cv_Core.PatientAssessmentFull", "_cv_Core.IdForm" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.VitalSignsBaselineAndAll.__internal_x_context__" + String.valueOf(getFormId());
	}
