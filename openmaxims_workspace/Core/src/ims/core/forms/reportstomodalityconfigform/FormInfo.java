...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "ReportsToModalityConfigForm";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Core.ModalityReport" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.ReportsToModalityConfigForm.__internal_x_context__" + String.valueOf(getFormId());
	}
