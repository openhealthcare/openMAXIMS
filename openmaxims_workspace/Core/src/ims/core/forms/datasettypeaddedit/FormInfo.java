...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.DataSetRecord" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.DataSetTypeAddEdit.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/data_set_add_48.png";
	}
}
