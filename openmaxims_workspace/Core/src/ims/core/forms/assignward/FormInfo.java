...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.PendingElectiveAdmission", "_cv_Core.PatientElectiveListForWardViewVo" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.AssignWard.__internal_x_context__" + String.valueOf(getFormId());
	}
