...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Admin.IsNewQuestion", "_cv_Core.QuestionEditViewMode", "_cv_Admin.SelectedQuestions", "_cv_Admin.SelectedQuestion" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.QuestionList.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/question_list_48.png";
	}
}
