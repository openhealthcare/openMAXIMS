...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "PatientClericalTaskDialog";
	}
	public int getWidth()
	{
		return 800;
	...
	{
		return new String[] { "_cv_Core.PatientClericalTask", "_cv_OCRR.CurrentPathRadResult" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.PatientClericalTaskDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
