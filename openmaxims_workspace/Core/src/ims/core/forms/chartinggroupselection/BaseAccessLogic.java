...
public class BaseAccessLogic extends FormAccessLogic implements Serializable
{
	...
	{
		if(!form.getGlobalContext().Core.getChartMaxGroupSelectionIsNotNull())
			return false;
		if(!form.getGlobalContext().Core.getChartDatasetSelectionIsNotNull())
			return false;
		if(!form.getGlobalContext().Core.getChartAvailableDatasetsIsNotNull())
			return false;
