...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.ChartMaxGroupSelection", "_cv_Core.ChartDatasetSelection", "_cv_Core.ChartAvailableDatasets" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.ChartingGroupSelection.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/chart_select_48.png";
	}
}
