...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.NOKDetails", "_cv_Core.ParentFormMode", "_cv_Core.NOKPersonAddress", "_cv_Core.CommChannels" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.NOKDetails.__internal_x_context__" + String.valueOf(getFormId());
	}
