...
public abstract class BaseLogic extends Handlers
{
	...
	{
		java.util.ArrayList listOfValues = this.form.cmbRelationship().getValues();
		...
		else if(value instanceof ims.core.vo.lookups.PersonRelationship)
		{
			...
			this.form.cmbRelationship().newRow(instance, instance.getText(), instance.getImage(), instance.getTextColor());
		}
	}
	protected final void bindcmbRelationshipLookup()
	{
		this.form.cmbRelationship().clear();
		...
		for(int x = 0; x < lookupCollection.size(); x++)
		{
			this.form.cmbRelationship().newRow(lookupCollection.get(x), lookupCollection.get(x).getText(), lookupCollection.get(x).getImage(), lookupCollection.get(x).getTextColor());
		}
	}
	protected final void setcmbRelationshipLookupValue(int id)
	{
		...
		if(instance != null)
			this.form.cmbRelationship().setValue(instance);
	}
	protected final void defaultcmbRelationshipLookupValue()
	{
		this.form.cmbRelationship().setValue((ims.core.vo.lookups.PersonRelationship)domain.getLookupService().getDefaultInstance(ims.core.vo.lookups.PersonRelationship.class, engine.getFormName().getID(), ims.core.vo.lookups.PersonRelationship.TYPE_ID));
	}
