...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.AddressSearchType", "_cv_Core.AddressSearchText", "_cv_Core.PersonAddress" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.AddressSelection.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/adress_book_48.png";
	}
}
