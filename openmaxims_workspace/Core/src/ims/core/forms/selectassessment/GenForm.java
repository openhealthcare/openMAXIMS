...
public class GenForm extends FormBridge
{
	...
	public static class grdAssessmentsGrid extends GridBridge
	{
		...
		public grdAssessmentsRow getRowByValue(ims.assessment.vo.UserAssessmentShortVo value)
		{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		// Label Controls
		RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 32, 32, 41, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// TextBox Controls
		RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 72, 30, 376, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		...
		grdAssessments.addStringColumn("Name", 0, 0, 420, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdAssessments.addBoolColumn("Select", 0, 0, -1, false, true, 0, true);
		super.addGrid(grdAssessments);

		// Image Buttons Controls
		RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 496, 25, 30, 30, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 464, 25, 30, 30, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
