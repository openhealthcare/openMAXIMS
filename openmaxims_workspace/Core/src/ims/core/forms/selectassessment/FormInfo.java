...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_ICP.LinkedItem", "_cv_Core.SelectedUserAssessment" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.SelectAssessment.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Assessment/select_assessment_48.png";
	}
}
