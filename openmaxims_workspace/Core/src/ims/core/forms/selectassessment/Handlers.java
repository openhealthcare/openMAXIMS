...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void onGrdAssessmentsGridCheckBoxClicked(int column, GenForm.grdAssessmentsRow row, boolean isChecked) throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.grdAssessments().setGridCheckBoxClickedEvent(new GridCheckBoxClicked()
		{
			private static final long serialVersionUID = 1L;
			...
			{
				onGrdAssessmentsGridCheckBoxClicked(column, new GenForm.grdAssessmentsRow(row), isChecked);
			}
		});
