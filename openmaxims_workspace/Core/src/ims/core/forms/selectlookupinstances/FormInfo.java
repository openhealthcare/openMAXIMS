...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.SelectedLookupInstances", "_cv_Core.SelectLookupType" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.SelectLookupInstances.__internal_x_context__" + String.valueOf(getFormId());
	}
