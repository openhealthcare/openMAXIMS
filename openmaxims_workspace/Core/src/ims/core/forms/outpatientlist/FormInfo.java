...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.PatientToBeDisplayed", "_cv_Core.OutpatientAttendanceForOrder" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.OutpatientList.__internal_x_context__" + String.valueOf(getFormId());
	}
