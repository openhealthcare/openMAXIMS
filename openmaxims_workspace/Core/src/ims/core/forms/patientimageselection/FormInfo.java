...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.PatientPhotoTempFiles", "_cv_Core.PatientImage" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.PatientImageSelection.__internal_x_context__" + String.valueOf(getFormId());
	}
