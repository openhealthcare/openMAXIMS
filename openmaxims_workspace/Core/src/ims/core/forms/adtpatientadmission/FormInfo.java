...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "_lv_Core.ADTPatientAdmission.__internal_x_context__" + String.valueOf(getFormId());
	}
	public ims.framework.FormInfo[] getComponentsFormInfo()
	{
		ims.framework.FormInfo[] componentsInfo = new ims.framework.FormInfo[2];
		componentsInfo[0] = new ims.core.forms.adtadmissiondetailscomponent.FormInfo(102408);
		componentsInfo[1] = new ims.core.forms.adtdischargedetailscomponent.FormInfo(102409);
