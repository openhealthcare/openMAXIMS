...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.CareContextSelectDialog.ChosenCareContext" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.CareContextSelectDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
