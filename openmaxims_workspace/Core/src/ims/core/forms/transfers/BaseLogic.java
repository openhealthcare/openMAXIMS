...
public abstract class BaseLogic extends Handlers implements IComponent
{
	...
	{
		return ims.core.domain.Transfers.class;
	}
	public final void setContext(ims.framework.UIComponentEngine engine, GenForm form, ims.core.domain.Transfers domain)
	{
	...
	protected ims.core.domain.Transfers domain;
}
