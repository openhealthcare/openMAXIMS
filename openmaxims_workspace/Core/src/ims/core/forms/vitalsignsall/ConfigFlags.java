...
public final class ConfigFlags extends ims.framework.FormConfigFlags implements Serializable
{
	...
	public final USE_EARLY_WARNING_SYSTEMClass USE_EARLY_WARNING_SYSTEM;
	...
	public ConfigFlags(ims.framework.ConfigFlag configFlags)
	{
		...
		USE_EARLY_WARNING_SYSTEM = new USE_EARLY_WARNING_SYSTEMClass(configFlags);
	}
	...
	public final class USE_EARLY_WARNING_SYSTEMClass implements Serializable
	{
		private static final long serialVersionUID = 1L;
		private final ims.framework.ConfigFlag configFlags;

		public USE_EARLY_WARNING_SYSTEMClass(ims.framework.ConfigFlag configFlags)
		{
			this.configFlags = configFlags;
		}
		...
		{
			return (Boolean)configFlags.get("USE_EARLY_WARNING_SYSTEM");
		}
	}
}
