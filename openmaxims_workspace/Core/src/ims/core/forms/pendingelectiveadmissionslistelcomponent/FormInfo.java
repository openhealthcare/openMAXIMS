...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "PendingElectiveAdmissionsListELComponent";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Core.CommentDialogString" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.PendingElectiveAdmissionsListELComponent.__internal_x_context__" + String.valueOf(getFormId());
	}
