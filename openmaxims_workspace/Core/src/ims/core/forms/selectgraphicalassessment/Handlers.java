...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void onGrdGraphicAssessmentsGridCheckBoxClicked(int column, GenForm.grdGraphicAssessmentsRow row, boolean isChecked) throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.grdGraphicAssessments().setGridCheckBoxClickedEvent(new GridCheckBoxClicked()
		{
			private static final long serialVersionUID = 1L;
			...
			{
				onGrdGraphicAssessmentsGridCheckBoxClicked(column, new GenForm.grdGraphicAssessmentsRow(row), isChecked);
			}
		});
