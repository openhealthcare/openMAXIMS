...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "SelectGraphicalAssessment";
	}
	public int getWidth()
	{
		return 576;
	...
	{
		return new String[] { "_cv_ICP.LinkedGraphicAssessment", "_cv_ICP.LinkedItem", "_cv_EAS.TreatmentSiteConfig" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.SelectGraphicalAssessment.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Assessment/select_graphic_assessment_48.png";
	}
}
