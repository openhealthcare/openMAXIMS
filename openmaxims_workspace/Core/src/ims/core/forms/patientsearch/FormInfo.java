...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Clinical.PatientSummary.CareSpell", "_cv_Core.PatientToBeDisplayed" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.PatientSearch.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/patient_search_simple.png";
	}
}
