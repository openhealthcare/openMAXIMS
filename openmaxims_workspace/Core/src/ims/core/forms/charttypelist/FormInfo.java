...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.LastNameSelected", "_cv_Core.ChartTypeRecord", "_cv_Core.DataSetRecord" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.ChartTypeList.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/chart_type_list_48.png";
	}
}
