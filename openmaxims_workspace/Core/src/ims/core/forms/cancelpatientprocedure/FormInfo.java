...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.SelectedPatientProcedure" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.CancelPatientProcedure.__internal_x_context__" + String.valueOf(getFormId());
	}
