...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "ReferralDetailsNoteDialog";
	}
	public int getWidth()
	{
		return 536;
	...
	{
		return new String[] { "_cv_CareUk.ReferralNote" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.ReferralDetailsNoteDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Admin/notes_48.png";
	}
}
