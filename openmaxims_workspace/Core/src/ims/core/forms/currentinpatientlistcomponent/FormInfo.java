...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "CurrentInpatientListComponent";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Core.CurrentInPatientListWard", "_cv_Core.PatientToBeDisplayed", "_cv_Core.CommentDialogString", "_cv_Core.SelectedBedSpaceState" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.CurrentInpatientListComponent.__internal_x_context__" + String.valueOf(getFormId());
	}
