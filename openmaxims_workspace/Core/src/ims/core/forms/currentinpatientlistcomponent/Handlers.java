...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void bindcmbSideWardLookup();
	abstract protected void defaultcmbSideWardLookupValue();
	abstract protected void onFormOpen(Object[] args) throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onFormDialogClosed(ims.framework.FormName formName, ims.framework.enumerations.DialogResult result) throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void oncmbIDTypeValueSet(Object value);
	abstract protected void onDyngrdCurrIPCellButtonClicked(ims.framework.controls.DynamicGridCell cell);
	abstract protected void onDyngrdCurrIPRowSelectionChanged(ims.framework.controls.DynamicGridRow row) throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onDyngrdCurrIPColumnHeaderClicked(ims.framework.controls.DynamicGridColumn column);
	...
	abstract protected void oncmbSideWardValueSet(Object value);
	...
	public final void setContext(ims.framework.UIComponentEngine engine, GenForm form)
	{
		...
		this.form.dyngrdCurrIP().setDynamicGridCellButtonClickedEvent(new DynamicGridCellButtonClicked()
		{
			private static final long serialVersionUID = 1L;
			...
			{
				onDyngrdCurrIPCellButtonClicked(cell);
			}
		});
		this.form.dyngrdCurrIP().setDynamicGridRowSelectionChangedEvent(new DynamicGridRowSelectionChanged()
		{
			private static final long serialVersionUID = 1L;
			...
			{
				onDyngrdCurrIPRowSelectionChanged(row);
			}
		});
		this.form.dyngrdCurrIP().setDynamicGridColumnHeaderClickedEvent(new DynamicGridColumnHeaderClicked()
		{
			private static final long serialVersionUID = 1L;
			...
			{
				onDyngrdCurrIPColumnHeaderClicked(column);
			}
		});
		...
		this.form.cmbSideWard().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				oncmbSideWardValueSet(value);
			}
		});
