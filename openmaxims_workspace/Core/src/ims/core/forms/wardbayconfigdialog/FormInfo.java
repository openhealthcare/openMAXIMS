...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_STHK.WardBayConfigVo" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.WardBayConfigDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/ward_config_48.png";
	}
}
