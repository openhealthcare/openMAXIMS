...
public abstract class BaseLogic extends Handlers implements IComponent
{
	...
	{
		return ims.core.domain.DBImageDisplay.class;
	}
	public final void setContext(ims.framework.UIComponentEngine engine, GenForm form, ims.core.domain.DBImageDisplay domain)
	{
	...
	protected ims.core.domain.DBImageDisplay domain;
}
