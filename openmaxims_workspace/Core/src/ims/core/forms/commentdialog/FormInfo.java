...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.CommentDialogReadOnly", "_cv_Core.CommentDialogTitle", "_cv_Core.CommentDialogString" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.CommentDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/comment_48.png";
	}
}
