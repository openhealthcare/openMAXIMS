...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.DataSetTypeItems", "_cv_Core.LastNameSelected", "_cv_Core.ChartTypeRecord", "_cv_Core.DataSetRecord" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.ChartTypeDetails.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/chart_type_list_details_48.png";
	}
}
