...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "EpisodeOfCareHistoryDialog";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Clinical.EpisodeOfCareWithHistory" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.EpisodeOfCareHistoryDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
