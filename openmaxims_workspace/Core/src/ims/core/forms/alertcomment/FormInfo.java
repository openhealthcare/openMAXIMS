...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.AlertInactiveComment" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.AlertComment.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/Alert_48.png";
	}
}
