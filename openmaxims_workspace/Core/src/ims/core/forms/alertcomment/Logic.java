...
//#############################################################################
//#EOH
// This code was generated by Sean Nesbitt using IMS Development Environment (version 1.45 build 2316.22516)
...
public class Logic extends BaseLogic
{
	...
	{
		form.getGlobalContext().Core.setAlertInactiveComment(form.txtComment().getValue());
		engine.close(DialogResult.YES);
	}
	protected void onBtnNoClick() throws ims.framework.exceptions.PresentationLogicException
	{
		form.getGlobalContext().Core.setAlertInactiveComment(null);
