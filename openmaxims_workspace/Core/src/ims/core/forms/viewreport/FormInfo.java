...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Correspondence.DocDetailIdReportSeed", "_cv_Core.ReportID", "_cv_Core.TemplateID", "_cv_Core.CurrentFormName", "_cv_Core.DocumentID" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.ViewReport.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Admin/reports_48.png";
	}
}
