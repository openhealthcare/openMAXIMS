...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.InactivationComment" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.InactivationComment.__internal_x_context__" + String.valueOf(getFormId());
	}
