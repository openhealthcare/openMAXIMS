...
public abstract class BaseLogic extends Handlers
{
	...
	{
		return ims.core.domain.VitalSignsPainLadder.class;
	}
	public final void setContext(ims.framework.UIEngine engine, GenForm form, ims.core.domain.VitalSignsPainLadder domain)
	{
	...
	{
		this.form.cmbPain().setValue((ims.nursing.vo.lookups.PainSeverity)domain.getLookupService().getDefaultInstance(ims.nursing.vo.lookups.PainSeverity.class, engine.getFormName().getID(), ims.nursing.vo.lookups.PainSeverity.TYPE_ID));
	}
	...
	protected ims.core.domain.VitalSignsPainLadder domain;
}
