...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.TaxonomySearchForName", "_cv_Clinical.ReturnToFormName", "_cv_Core.TaxonomyMap", "_cv_Core.TaxonomyTextReturned" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.TaxonomySearch.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Admin/taxonomy_search_48.png";
	}
}
