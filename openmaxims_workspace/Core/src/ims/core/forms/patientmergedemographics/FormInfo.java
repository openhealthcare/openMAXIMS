...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "PatientMergeDemographics";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Core.PatientSource", "_cv_Core.PatientDestination" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.PatientMergeDemographics.__internal_x_context__" + String.valueOf(getFormId());
	}
