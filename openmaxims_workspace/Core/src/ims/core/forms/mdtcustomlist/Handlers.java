...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.getContextMenus().Core.getMDTCustomListsVIEW_MDT_DETAILSItem().setClickEvent(new ims.framework.delegates.MenuItemClick()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.Control sender) throws ims.framework.exceptions.PresentationLogicException
			{
				onContextMenuItemClick(GenForm.ContextMenus.CoreNamespace.MDTCustomLists.VIEW_MDT_DETAILS, sender);
			}
		});
		this.form.getContextMenus().Core.getMDTCustomListsVIEW_CARE_PLAN_DETAILSItem().setClickEvent(new ims.framework.delegates.MenuItemClick()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.Control sender) throws ims.framework.exceptions.PresentationLogicException
			{
				onContextMenuItemClick(GenForm.ContextMenus.CoreNamespace.MDTCustomLists.VIEW_CARE_PLAN_DETAILS, sender);
			}
		});
	}
