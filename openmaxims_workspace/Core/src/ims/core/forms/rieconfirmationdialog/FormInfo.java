...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.RieMessage" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.RieConfirmationDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Admin/erasure_48.png";
	}
}
