...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void onRadioButtonBloodGlucoseGroupValueChanged() throws ims.framework.exceptions.PresentationLogicException;
	...
	abstract protected void onGrhBloodSugarPointClicked(ims.framework.utils.graphing.GraphingPoint point);
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.BloodGlucoseGroup().setValueChangedEvent(new ValueChanged()
		{
			private static final long serialVersionUID = 1L;
		...
		this.form.grhBloodSugar().setGraphingControlClickEvent(new GraphingControlClick()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.utils.graphing.GraphingPoint point)
			{
				onGrhBloodSugarPointClicked(point);
			}
		});
