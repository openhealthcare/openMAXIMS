...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.YesNoDialogMessage", "_cv_Core.HideCancelButton" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.SupportNetworkFamily.__internal_x_context__" + String.valueOf(getFormId());
	}
