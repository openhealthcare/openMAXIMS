...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void onGrhPeakFlowPointClicked(ims.framework.utils.graphing.GraphingPoint point);
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.grhPeakFlow().setGraphingControlClickEvent(new GraphingControlClick()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.utils.graphing.GraphingPoint point)
			{
				onGrhPeakFlowPointClicked(point);
			}
		});
