...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.FloorLayout.Selection", "_cv_Core.FloorLayout.ReadOnly" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.BayFloorPlanDesigner.__internal_x_context__" + String.valueOf(getFormId());
	}
