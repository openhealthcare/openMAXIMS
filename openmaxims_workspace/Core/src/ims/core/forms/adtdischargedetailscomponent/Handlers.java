...
{
	abstract protected void bindcmbDischargeReasonLookup();
	abstract protected void defaultcmbDischargeReasonLookupValue();
	...
	abstract protected void oncmbDischargeReasonValueSet(Object value);
	...
	public final void setContext(ims.framework.UIComponentEngine engine, GenForm form)
	{
		...
		this.form.cmbDischargeReason().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				oncmbDischargeReasonValueSet(value);
			}
		});
	}
	...
	{
		defaultcmbDischargeReasonLookupValue();
	}
