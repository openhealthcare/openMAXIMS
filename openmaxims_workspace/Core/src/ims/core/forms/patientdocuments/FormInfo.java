...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.PatientDocumentsErrors", "_cv_Core.PatientDocument" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.PatientDocuments.__internal_x_context__" + String.valueOf(getFormId());
	}
