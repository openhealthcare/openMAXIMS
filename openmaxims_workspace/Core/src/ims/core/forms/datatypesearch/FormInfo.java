...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.DataSetTypeItems" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.DataTypeSearch.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/data_set_search_48.png";
	}
}
