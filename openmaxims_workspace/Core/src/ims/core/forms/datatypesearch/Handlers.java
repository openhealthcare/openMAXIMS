...
{
	abstract protected void bindcmbSearchCategoryLookup();
	abstract protected void defaultcmbSearchCategoryLookupValue();
	...
	abstract protected void oncmbSearchCategoryValueSet(Object value);
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.btnAddList().setClickEvent(new Click()
		{
			private static final long serialVersionUID = 1L;
		...
		this.form.cmbSearchCategory().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				oncmbSearchCategoryValueSet(value);
			}
		});
	}
	...
	{
		defaultcmbSearchCategoryLookupValue();
	}
