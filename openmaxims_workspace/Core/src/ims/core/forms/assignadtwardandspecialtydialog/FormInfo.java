...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "AssignADTWardAndSpecialtyDialog";
	}
	public int getWidth()
	{
		return 392;
	...
	{
		return new String[] { "_cv_Core.ADTPendingEmergencyAdmission" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.AssignADTWardAndSpecialtyDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/assign_ward_48.png";
	}
}
