...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "VitalSignsVentilationChart";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Core.VentilationChartDateTime", "_cv_Core.VSVentilationChartRecord", "_cv_Core.VitalSign" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.VitalSignsVentilationChart.__internal_x_context__" + String.valueOf(getFormId());
	}
