...
public abstract class BaseLogic extends Handlers implements IComponent
{
	...
	{
		return ims.core.domain.PatientDetails.class;
	}
	public final void setContext(ims.framework.UIComponentEngine engine, GenForm form, ims.core.domain.PatientDetails domain)
	{
	...
	protected ims.core.domain.PatientDetails domain;
}
