...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.ExternalResourceSelected" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.ExternalResourceSearch.__internal_x_context__" + String.valueOf(getFormId());
	}
	public ims.framework.FormInfo[] getComponentsFormInfo()
	{
		ims.framework.FormInfo[] componentsInfo = new ims.framework.FormInfo[1];
		componentsInfo[0] = new ims.core.forms.externalresourcesearchcomponent.FormInfo(102410);
