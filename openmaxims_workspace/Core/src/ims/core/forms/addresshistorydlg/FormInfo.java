...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.PersonAddress", "_cv_Core.OtherAddresses" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.AddressHistoryDlg.__internal_x_context__" + String.valueOf(getFormId());
	}
