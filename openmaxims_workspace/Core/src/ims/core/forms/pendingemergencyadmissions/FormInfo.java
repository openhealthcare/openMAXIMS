...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "PendingEmergencyAdmissions";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Core.ADTPendingEmergencyAdmission", "_cv_Core.PatientToBeDisplayed" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.PendingEmergencyAdmissions.__internal_x_context__" + String.valueOf(getFormId());
	}
