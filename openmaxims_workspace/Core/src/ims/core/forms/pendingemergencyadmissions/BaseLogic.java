...
public abstract class BaseLogic extends Handlers implements IComponent
{
	...
	{
		return ims.core.domain.PendingEmergencyAdmissions.class;
	}
	public final void setContext(ims.framework.UIComponentEngine engine, GenForm form, ims.core.domain.PendingEmergencyAdmissions domain)
	{
	...
	protected final void oncmbStatusValueSet(Object value)
	{
		...
		if(value == null)
		{
			if(listOfValues != null && listOfValues.size() > 0)
			{
				for(int x = 0; x < listOfValues.size(); x++)
				{
					ims.core.vo.lookups.EmergencyAdmissionStatus existingInstance = (ims.core.vo.lookups.EmergencyAdmissionStatus)listOfValues.get(x);
					if(!existingInstance.isActive())
					{
						bindcmbStatusLookup();
						return;
		...
		else if(value instanceof ims.core.vo.lookups.EmergencyAdmissionStatus)
		{
			ims.core.vo.lookups.EmergencyAdmissionStatus instance = (ims.core.vo.lookups.EmergencyAdmissionStatus)value;
	...
	protected final void bindcmbStatusLookup()
	{
		...
		ims.core.vo.lookups.EmergencyAdmissionStatusCollection lookupCollection = ims.core.vo.lookups.LookupHelper.getEmergencyAdmissionStatus(this.domain.getLookupService());
		for(int x = 0; x < lookupCollection.size(); x++)
		{
	...
	{
		ims.core.vo.lookups.EmergencyAdmissionStatus instance = ims.core.vo.lookups.LookupHelper.getEmergencyAdmissionStatusInstance(this.domain.getLookupService(), id);
		if(instance != null)
			this.form.cmbStatus().setValue(instance);
	}
	protected final void defaultcmbStatusLookupValue()
	{
		this.form.cmbStatus().setValue((ims.core.vo.lookups.EmergencyAdmissionStatus)domain.getLookupService().getDefaultInstance(ims.core.vo.lookups.EmergencyAdmissionStatus.class, engine.getFormName().getID(), ims.core.vo.lookups.EmergencyAdmissionStatus.TYPE_ID));
	}
	...
	protected ims.core.domain.PendingEmergencyAdmissions domain;
}
