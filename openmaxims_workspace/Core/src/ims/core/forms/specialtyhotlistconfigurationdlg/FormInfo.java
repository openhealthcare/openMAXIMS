...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "SpecialtyHotlistConfigurationDlg";
	}
	public int getWidth()
	{
		return 584;
	...
	{
		return new String[] { "_cv_Clinical.SpecialtyHotlistConfigurationVo", "_cv_Clinical.PMHConfigSearchType" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.SpecialtyHotlistConfigurationDlg.__internal_x_context__" + String.valueOf(getFormId());
	}
