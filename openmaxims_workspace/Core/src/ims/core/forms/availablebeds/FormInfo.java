...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.SelectedBedSpaceState", "_cv_Core.CommentDialogString", "_cv_Core.PatientToBeDisplayed" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.AvailableBeds.__internal_x_context__" + String.valueOf(getFormId());
	}
