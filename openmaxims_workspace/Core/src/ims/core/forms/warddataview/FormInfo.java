...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.HasWaitingArea" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.WardDataView.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/ward_info_48.png";
	}
}
