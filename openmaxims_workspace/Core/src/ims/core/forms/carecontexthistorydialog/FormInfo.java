...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "CareContextHistoryDialog";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Clinical.CareContextWithHistory" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.CareContextHistoryDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
