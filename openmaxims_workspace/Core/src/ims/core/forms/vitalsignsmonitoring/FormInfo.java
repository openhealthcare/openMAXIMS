...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.ClinicalContact" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Core.VitalSignsMonitoring.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/vital_signs_monitoring_48.png";
	}
}
