...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void onGrhTempPointClicked(ims.framework.utils.graphing.GraphingPoint point);
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.grhTemp().setGraphingControlClickEvent(new GraphingControlClick()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.utils.graphing.GraphingPoint point)
			{
				onGrhTempPointClicked(point);
			}
		});
		this.form.btnCanel().setClickEvent(new Click()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
