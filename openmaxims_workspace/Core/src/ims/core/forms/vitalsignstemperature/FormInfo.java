...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "_lv_Core.VitalSignsTemperature.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/vital_signs_temperature_48.png";
	}
}
