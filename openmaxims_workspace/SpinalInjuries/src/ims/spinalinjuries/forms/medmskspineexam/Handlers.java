...
{
	abstract protected void bindgrdSiteFindingcolFindingLookup();
	abstract protected void onFormModeChanged();
	abstract protected void onFormOpen() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onFormDialogClosed(ims.framework.FormName formName, ims.framework.enumerations.DialogResult result) throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onDrawingEdited(int index) throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onDrawingRemoved(int index) throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onDrawingNote(ims.framework.controls.DrawingControlShape shape) throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onRecbrExamValueChanged() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onGrdSiteFindingSelectionChanged() throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.drawingBack().setDrawingControlShapeEditedEvent(new DrawingControlShapeEdited()
		{
			private static final long serialVersionUID = 1L;
			public void handle(int index) throws ims.framework.exceptions.PresentationLogicException
			{
				onDrawingEdited(index);
			}
		});
		this.form.drawingBack().setDrawingControlShapeRemovedEvent(new DrawingControlShapeRemoved()
		{
			private static final long serialVersionUID = 1L;
			public void handle(int index) throws ims.framework.exceptions.PresentationLogicException
			{
				onDrawingRemoved(index);
			}
		});
		this.form.drawingBack().setDrawingControlNoteEvent(new DrawingControlNote()
		{
			private static final long serialVersionUID = 1L;
		...
		this.form.recbrExam().setValueChangedEvent(new ValueChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onRecbrExamValueChanged();
			}
		});
		this.form.grdSiteFinding().setSelectionChangedEvent(new GridSelectionChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.enumerations.MouseButton mouseButton) throws ims.framework.exceptions.PresentationLogicException
			{
				onGrdSiteFindingSelectionChanged();
			}
		});
	...
	{
		bindgrdSiteFindingcolFindingLookup();
	}
