...
{
	abstract protected void bindansDiffInSwallowingLookup();
	abstract protected void defaultansDiffInSwallowingLookupValue();
	abstract protected void bindansRequireAssistanceLookup();
	abstract protected void defaultansRequireAssistanceLookupValue();
	abstract protected void bindgrdOralColStatusLookup();
	abstract protected void bindgrdNutritionColNutritionalLookup();
	abstract protected void bindgrdNutritionColSiteLookup();
	abstract protected void bindgrdNutritionColTypeLookup();
	abstract protected void onFormModeChanged();
	abstract protected void onFormOpen() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onFormDialogClosed(ims.framework.FormName formName, ims.framework.enumerations.DialogResult result) throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onImbDeleteClick() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onImbNewClick() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onansDiffInSwallowingValueSet(Object value);
	abstract protected void onansRequireAssistanceValueSet(Object value);
	abstract protected void onBtnCancelClick() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onBtnSaveClick() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onGrdNutritionSelectionChanged() throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.imbDelete().setClickEvent(new Click()
		{
			private static final long serialVersionUID = 1L;
		...
		this.form.ansDiffInSwallowing().setValueSetEvent(new AnswerBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				onansDiffInSwallowingValueSet(value);
			}
		});
		this.form.ansRequireAssistance().setValueSetEvent(new AnswerBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				onansRequireAssistanceValueSet(value);
			}
		});
		...
		this.form.grdNutrition().setSelectionChangedEvent(new GridSelectionChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.enumerations.MouseButton mouseButton) throws ims.framework.exceptions.PresentationLogicException
			{
				onGrdNutritionSelectionChanged();
			}
		});
	...
	protected void bindLookups()
	{
		...
		bindgrdOralColStatusLookup();
		bindgrdNutritionColNutritionalLookup();
		bindgrdNutritionColSiteLookup();
		bindgrdNutritionColTypeLookup();
	}
	...
	{
		defaultansDiffInSwallowingLookupValue();
		defaultansRequireAssistanceLookupValue();
	}
