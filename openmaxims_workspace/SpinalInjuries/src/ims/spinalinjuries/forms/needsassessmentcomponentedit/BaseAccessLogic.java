...
public class BaseAccessLogic extends FormAccessLogic implements Serializable
{
	...
	{
		if(!form.getGlobalContext().SpinalInjuries.NeedsAssessment.getEditComponentIsNotNull())
			return false;
		if(!form.getGlobalContext().SpinalInjuries.NeedsAssessment.getEditedComponentIsNewIsNotNull())
			return false;
		if(!form.getGlobalContext().SpinalInjuries.NeedsAssessment.getEditedAssessmentIsNotNull())
			return false;
