...
{
	abstract protected void bindansBladderControlLookup();
	abstract protected void defaultansBladderControlLookupValue();
	abstract protected void bindcmbBladderTypeLookup();
	abstract protected void defaultcmbBladderTypeLookupValue();
	abstract protected void bindgrdManagementColBladderManagementLookup();
	abstract protected void bindgrdManagementColTypeLookup();
	...
	abstract protected void onansBladderControlValueSet(Object value);
	abstract protected void oncmbBladderTypeValueSet(Object value);
	abstract protected void onGrdManagementSelectionChanged() throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.ansBladderControl().setValueSetEvent(new AnswerBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				onansBladderControlValueSet(value);
			}
		});
		this.form.cmbBladderType().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				oncmbBladderTypeValueSet(value);
			}
		});
		this.form.grdManagement().setSelectionChangedEvent(new GridSelectionChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.enumerations.MouseButton mouseButton) throws ims.framework.exceptions.PresentationLogicException
			{
				onGrdManagementSelectionChanged();
			}
		});
	...
	protected void bindLookups()
	{
		...
		bindgrdManagementColBladderManagementLookup();
		bindgrdManagementColTypeLookup();
	}
	...
	{
		defaultansBladderControlLookupValue();
		defaultcmbBladderTypeLookupValue();
	}
