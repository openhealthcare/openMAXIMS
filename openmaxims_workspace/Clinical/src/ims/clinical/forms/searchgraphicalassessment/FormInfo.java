...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "SearchGraphicalAssessment";
	}
	public int getWidth()
	{
		return 624;
	...
	{
		return new String[] { "_cv_Core.GraphicAssessmentShortVo" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.SearchGraphicalAssessment.__internal_x_context__" + String.valueOf(getFormId());
	}
