...
public abstract class BaseLogic extends Handlers
{
	...
	{
		return ims.clinical.domain.PatientAssessmentListAndSearch.class;
	}
	public final void setContext(ims.framework.UIEngine engine, GenForm form, ims.clinical.domain.PatientAssessmentListAndSearch domain)
	{
		setContext(engine, form);
		this.domain = domain;
	}
	protected final void oncmbAssessmentStatusValueSet(Object value)
	{
		java.util.ArrayList listOfValues = this.form.cmbAssessmentStatus().getValues();
		...
		else if(value instanceof ims.core.vo.lookups.PatientAssessmentStatusReason)
		{
			...
			this.form.cmbAssessmentStatus().newRow(instance, instance.getText(), instance.getImage(), instance.getTextColor());
		}
	}
	protected final void bindcmbAssessmentStatusLookup()
	{
		this.form.cmbAssessmentStatus().clear();
		...
		{
			this.form.cmbAssessmentStatus().newRow(lookupCollection.get(x), lookupCollection.get(x).getText(), lookupCollection.get(x).getImage(), lookupCollection.get(x).getTextColor());
		}
	}
	protected final void setcmbAssessmentStatusLookupValue(int id)
	{
		...
		if(instance != null)
			this.form.cmbAssessmentStatus().setValue(instance);
	}
	protected final void defaultcmbAssessmentStatusLookupValue()
	{
		this.form.cmbAssessmentStatus().setValue((ims.core.vo.lookups.PatientAssessmentStatusReason)domain.getLookupService().getDefaultInstance(ims.core.vo.lookups.PatientAssessmentStatusReason.class, engine.getFormName().getID(), ims.core.vo.lookups.PatientAssessmentStatusReason.TYPE_ID));
	}
	...
	protected ims.clinical.domain.PatientAssessmentListAndSearch domain;
}
