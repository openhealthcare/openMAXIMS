...
public abstract class BaseLogic extends Handlers
{
	...
	{
		return ims.clinical.domain.EDischargeList.class;
	}
	public final void setContext(ims.framework.UIEngine engine, GenForm form, ims.clinical.domain.EDischargeList domain)
	{
		setContext(engine, form);
		this.domain = domain;
	}
	protected final void oncmbCompleteValueSet(Object value)
	{
		java.util.ArrayList listOfValues = this.form.cmbComplete().getValues();
		...
		else if(value instanceof ims.core.vo.lookups.YesNo)
		{
			...
			this.form.cmbComplete().newRow(instance, instance.getText(), instance.getImage(), instance.getTextColor());
		}
	}
	protected final void bindcmbCompleteLookup()
	{
		this.form.cmbComplete().clear();
		...
		{
			this.form.cmbComplete().newRow(lookupCollection.get(x), lookupCollection.get(x).getText(), lookupCollection.get(x).getImage(), lookupCollection.get(x).getTextColor());
		}
	}
	protected final void setcmbCompleteLookupValue(int id)
	{
		ims.core.vo.lookups.YesNo instance = ims.core.vo.lookups.LookupHelper.getYesNoInstance(this.domain.getLookupService(), id);
		if(instance != null)
			this.form.cmbComplete().setValue(instance);
	}
	protected final void defaultcmbCompleteLookupValue()
	{
		this.form.cmbComplete().setValue((ims.core.vo.lookups.YesNo)domain.getLookupService().getDefaultInstance(ims.core.vo.lookups.YesNo.class, engine.getFormName().getID(), ims.core.vo.lookups.YesNo.TYPE_ID));
	}
	protected final void oncmbTTAValueSet(Object value)
	{
		...
		if(value == null)
		{
			if(listOfValues != null && listOfValues.size() > 0)
			{
				for(int x = 0; x < listOfValues.size(); x++)
				{
					ims.clinical.vo.lookups.TTORequired existingInstance = (ims.clinical.vo.lookups.TTORequired)listOfValues.get(x);
					if(!existingInstance.isActive())
					{
						bindcmbTTALookup();
						return;
		...
		else if(value instanceof ims.clinical.vo.lookups.TTORequired)
		{
			ims.clinical.vo.lookups.TTORequired instance = (ims.clinical.vo.lookups.TTORequired)value;
	...
	protected final void bindcmbTTALookup()
	{
		...
		ims.clinical.vo.lookups.TTORequiredCollection lookupCollection = ims.clinical.vo.lookups.LookupHelper.getTTORequired(this.domain.getLookupService());
		for(int x = 0; x < lookupCollection.size(); x++)
		{
	...
	{
		ims.clinical.vo.lookups.TTORequired instance = ims.clinical.vo.lookups.LookupHelper.getTTORequiredInstance(this.domain.getLookupService(), id);
		if(instance != null)
			this.form.cmbTTA().setValue(instance);
	}
	protected final void defaultcmbTTALookupValue()
	{
		this.form.cmbTTA().setValue((ims.clinical.vo.lookups.TTORequired)domain.getLookupService().getDefaultInstance(ims.clinical.vo.lookups.TTORequired.class, engine.getFormName().getID(), ims.clinical.vo.lookups.TTORequired.TYPE_ID));
	}
	...
	protected ims.clinical.domain.EDischargeList domain;
}
