...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "FitForSurgeryAssessment";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Clinical.SelectedFitForSurgeryComment", "_cv_Clinical.AppointmentForFitForSurgery" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.FitForSurgeryAssessment.__internal_x_context__" + String.valueOf(getFormId());
	}
