...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "PatientAssessmentSearch";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Clinical.PatientAssessment.SelectedAssessment", "_cv_Clinical.ReturnToFormName", "_cv_Core.UserDefinedFormMode" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.PatientAssessmentSearch.__internal_x_context__" + String.valueOf(getFormId());
	}
