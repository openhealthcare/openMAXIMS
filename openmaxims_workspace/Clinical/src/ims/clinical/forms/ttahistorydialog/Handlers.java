...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void onDyngrdTTACellValueChanged(ims.framework.controls.DynamicGridCell cell);
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.dyngrdTTA().setDynamicGridCellValueChangedEvent(new DynamicGridCellValueChanged()
		{
			private static final long serialVersionUID = 1L;
			...
			{
				onDyngrdTTACellValueChanged(cell);
			}
		});
	}
