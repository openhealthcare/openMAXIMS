...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		// Label Controls
		RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 24, 152, 98, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper10 = new RuntimeAnchoring(designSize, runtimeSize, 168, 152, 184, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RadioButton tmpgrpFilter = (RadioButton)factory.getControl(RadioButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(0), ControlState.ENABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE});
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_voPatientDiagnosis = new ims.framework.ContextVariable("voPatientDiagnosis", prefix + "_lv_Clinical.ProceduresDialog.__internal_x_context__voPatientDiagnosis_" + componentIdentifier + "");
			cxl_voContact = new ims.framework.ContextVariable("voContact", prefix + "_lv_Clinical.ProceduresDialog.__internal_x_context__voContact_" + componentIdentifier + "");
			cxl_voTaxonomyMap = new ims.framework.ContextVariable("voTaxonomyMap", prefix + "_lv_Clinical.ProceduresDialog.__internal_x_context__voTaxonomyMap_" + componentIdentifier + "");
			cxl_voDiagnosis = new ims.framework.ContextVariable("voDiagnosis", prefix + "_lv_Clinical.ProceduresDialog.__internal_x_context__voDiagnosis_" + componentIdentifier + "");
		}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[71] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ProceduresDialog.__internal_x_context__voContact_" + componentIdentifier, "BO-1004100003-ID", "ID_ClinicalContact");
			fields[72] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ProceduresDialog.__internal_x_context__voContact_" + componentIdentifier, "BO-1004100003-SPECIALTY", "Specialty");
			fields[73] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ProceduresDialog.__internal_x_context__voContact_" + componentIdentifier, "BO-1004100003-SEENBY", "SeenBy");
			fields[74] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ProceduresDialog.__internal_x_context__voContact_" + componentIdentifier, "BO-1004100003-CONTACTTYPE", "ContactType");
			fields[75] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ProceduresDialog.__internal_x_context__voContact_" + componentIdentifier, "BO-1004100003-STARTDATETIME", "StartDateTime");
			fields[76] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ProceduresDialog.__internal_x_context__voContact_" + componentIdentifier, "BO-1004100003-ENDDATETIME", "EndDateTime");
			fields[77] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ProceduresDialog.__internal_x_context__voContact_" + componentIdentifier, "BO-1004100003-CARECONTEXT", "CareContext");
			fields[78] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ProceduresDialog.__internal_x_context__voContact_" + componentIdentifier, "BO-1004100003-ISCLINICALNOTECREATED", "IsClinicalNoteCreated");
			fields[79] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ProceduresDialog.__internal_x_context__voTaxonomyMap_" + componentIdentifier, "BO-1003100010-ID", "ID_TaxonomyMap");
			fields[80] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ProceduresDialog.__internal_x_context__voTaxonomyMap_" + componentIdentifier, "BO-1003100010-TAXONOMYNAME", "TaxonomyName");
			fields[81] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ProceduresDialog.__internal_x_context__voTaxonomyMap_" + componentIdentifier, "BO-1003100010-TAXONOMYCODE", "TaxonomyCode");
			fields[82] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ProceduresDialog.__internal_x_context__voDiagnosis_" + componentIdentifier, "BO-1003100025-ID", "ID_Diagnosis");
			fields[83] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ProceduresDialog.__internal_x_context__voDiagnosis_" + componentIdentifier, "BO-1003100025-DIAGNOSISNAME", "DiagnosisName");
			fields[84] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.ProceduresDialog.__internal_x_context__voDiagnosis_" + componentIdentifier, "BO-1003100025-ISACTIVE", "IsActive");
			return fields;
		}
