...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.ProceduresAtConsultation" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.ProceduresDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
