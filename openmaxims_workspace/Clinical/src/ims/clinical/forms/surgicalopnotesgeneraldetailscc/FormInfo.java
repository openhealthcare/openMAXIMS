...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "SurgicalOPNotesGeneralDetailsCC";
	}
	public int getWidth()
	{
		return 800;
	...
	{
		return new String[] { "_cv_Clinical.SelectedProcedure", "_cv_Clinical.SelectedPatientDiagnosisOPNotes", "_cv_Core.RieMessage" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.SurgicalOPNotesGeneralDetailsCC.__internal_x_context__" + String.valueOf(getFormId());
	}
