...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "PatientDiagnosisChecklist";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Clinical.PMHConfigSearchType", "_cv_Clinical.SelectedDiagnosis", "_cv_Core.TaxonomyTextReturned", "_cv_Core.TaxonomyMap", "_cv_Clinical.CDIUnlinkedRecord" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.PatientDiagnosisChecklist.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Clinical/patient_diagnosis_checklist_48.png";
	}
}
