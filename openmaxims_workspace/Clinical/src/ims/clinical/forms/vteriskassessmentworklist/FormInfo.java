...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "VTERiskAssessmentWorklist";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Core.InpatientEpisodeForVTERiskAssessmentWorklistVo" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.VTERiskAssessmentWorklist.__internal_x_context__" + String.valueOf(getFormId());
	}
