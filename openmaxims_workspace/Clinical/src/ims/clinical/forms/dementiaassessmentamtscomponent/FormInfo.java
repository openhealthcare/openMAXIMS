...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "DementiaAssessmentAMTSComponent";
	}
	public int getWidth()
	{
		return 730;
	...
	{
		return new String[] { "_cv_Admin.DementiaConfiguration", "_cv_Core.RieMessage", "_cv_Clinical.AMTSRecordToView" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.DementiaAssessmentAMTSComponent.__internal_x_context__" + String.valueOf(getFormId());
	}
