...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "DementiaConfirmPatientWillBePutOnDementiaPathwayDialog";
	}
	public int getWidth()
	{
		return 584;
	...
	{
		return "_lv_Clinical.DementiaConfirmPatientWillBePutOnDementiaPathwayDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
