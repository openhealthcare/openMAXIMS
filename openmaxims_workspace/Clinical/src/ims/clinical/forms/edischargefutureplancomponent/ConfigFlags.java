...
public final class ConfigFlags extends ims.framework.FormConfigFlags implements Serializable
{
	...
	public ConfigFlags(ims.framework.ConfigFlag configFlags)
	{
		...
		EDISCHARGE_RESULTS_NUM_DAYS = new EDISCHARGE_RESULTS_NUM_DAYSClass(configFlags);
	}
	...
	public final class EDISCHARGE_RESULTS_NUM_DAYSClass implements Serializable
	{
		private static final long serialVersionUID = 1L;
		private final ims.framework.ConfigFlag configFlags;

		public EDISCHARGE_RESULTS_NUM_DAYSClass(ims.framework.ConfigFlag configFlags)
		{
			this.configFlags = configFlags;
		}
		...
		{
			return (Integer)configFlags.get("EDISCHARGE_RESULTS_NUM_DAYS");
		}
	}
}
