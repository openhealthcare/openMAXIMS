...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Admin.DementiaConfiguration", "_cv_Core.PatientToBeDisplayed" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.DementiaWorklist.__internal_x_context__" + String.valueOf(getFormId());
	}
