...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Clinical.SurgicalAuditSurgicalPack", "_cv_Clinical.SurgicalAuditAddEditSurgicalPack" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.SurgicalPacksDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
