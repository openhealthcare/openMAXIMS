...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.YesNoDialogMessage", "_cv_Core.TaxonomyMap" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.PastMedicalHistory.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Clinical/pmh_checklist_48.png";
	}
}
