...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "EDischargeMedicationComponent";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Clinical.eDischargeClinicalComplete", "_cv_Clinical.eDischargeDisableTabs", "_cv_Clinical.eDischargeCompleted" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.EDischargeMedicationComponent.__internal_x_context__" + String.valueOf(getFormId());
	}
