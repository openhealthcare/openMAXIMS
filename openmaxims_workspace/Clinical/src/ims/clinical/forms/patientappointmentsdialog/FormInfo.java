...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "PatientAppointmentsDialog";
	}
	public int getWidth()
	{
		return 696;
	...
	{
		return new String[] { "_cv_Clinical.AppointmentForFitForSurgery" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.PatientAppointmentsDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
