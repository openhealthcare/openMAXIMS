...
public class GenForm extends FormBridge
{
	...
	public static class grdApptsRow extends GridRowBridge
	{
		...
		public ims.scheduling.vo.BookingAppointmentForFitForSurgeryAssessmentVo getValue()
		{
			return (ims.scheduling.vo.BookingAppointmentForFitForSurgeryAssessmentVo)super.row.getValue();
		}
		public void setValue(ims.scheduling.vo.BookingAppointmentForFitForSurgeryAssessmentVo value)
		{
	...
	public static class grdApptsGrid extends GridBridge
	{
		...
		public ims.scheduling.vo.BookingAppointmentForFitForSurgeryAssessmentVoCollection getValues()
		{
			ims.scheduling.vo.BookingAppointmentForFitForSurgeryAssessmentVoCollection listOfValues = new ims.scheduling.vo.BookingAppointmentForFitForSurgeryAssessmentVoCollection();
		...
		public ims.scheduling.vo.BookingAppointmentForFitForSurgeryAssessmentVo getValue()
		{
			return (ims.scheduling.vo.BookingAppointmentForFitForSurgeryAssessmentVo)super.grid.getValue();
		}
		public void setValue(ims.scheduling.vo.BookingAppointmentForFitForSurgeryAssessmentVo value)
		{
		...
		public grdApptsRow getRowByValue(ims.scheduling.vo.BookingAppointmentForFitForSurgeryAssessmentVo value)
		{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		ims.framework.utils.SizeInfo designSize = new ims.framework.utils.SizeInfo(696, 464);
		if(runtimeSize == null)
		...
		// Panel Controls
		RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 8, 16, 680, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		super.addControl(factory.getControl(Panel.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,"Patient Appointments", new Integer(1), ""}));

		// Button Controls
		RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 613, 432, 75, 23, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 536, 432, 75, 23, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// Grid Controls
		RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 16, 48, 664, 376, ims.framework.enumerations.ControlAnchoring.ALL);
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[71] = new ims.framework.ReportField(this.context, "_cv_Clinical.AppointmentForFitForSurgery", "BO-1055100007-ID", "ID_Booking_Appointment");
			fields[72] = new ims.framework.ReportField(this.context, "_cv_Clinical.AppointmentForFitForSurgery", "BO-1055100007-APPOINTMENTDATE", "AppointmentDate");
			fields[73] = new ims.framework.ReportField(this.context, "_cv_Clinical.AppointmentForFitForSurgery", "BO-1055100007-APPTSTARTTIME", "ApptStartTime");
			fields[74] = new ims.framework.ReportField(this.context, "_cv_Clinical.AppointmentForFitForSurgery", "BO-1055100007-APPTSTATUS", "ApptStatus");
			return fields;
		}
