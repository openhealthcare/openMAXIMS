...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "HCPsWithRecordsForProcedure";
	}
	public int getWidth()
	{
		return 856;
	...
	{
		return new String[] { "_cv_ClinicalAdmin.SurgicalOpDetailsConfig" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.HCPsWithRecordsForProcedure.__internal_x_context__" + String.valueOf(getFormId());
	}
