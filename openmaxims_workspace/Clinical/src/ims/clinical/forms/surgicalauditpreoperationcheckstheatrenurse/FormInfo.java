...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "SurgicalAuditPreOperationChecksTheatreNurse";
	}
	public int getWidth()
	{
		return 824;
	...
	{
		return new String[] { "_cv_Clinical.PrimaryPatientProcedureExist", "_cv_Clinical.PatientProcedureMarkedAsPrimary", "_cv_Clinical.SelectedPatientProcedureFromSurgicalAudit" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.SurgicalAuditPreOperationChecksTheatreNurse.__internal_x_context__" + String.valueOf(getFormId());
	}
