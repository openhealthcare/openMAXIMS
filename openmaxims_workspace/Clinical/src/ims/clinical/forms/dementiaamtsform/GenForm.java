...
public class GenForm extends FormBridge
{
	...
	public static class recbrDementiaAMTSRecordBrowser extends RecordBrowserBridge
	{
		private static final long serialVersionUID = 1L;
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 8, 48, 832, 576, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		ims.framework.FormUiLogic m_cc1Form = loader.loadComponent(123261, appForm, startControlID * 10 + 1000, anchoringHelper1.getSize(), instance1, -1, skipContextValidation);
		//ims.framework.Control m_cc1Control = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(8), new Integer(48), new Integer(832), new Integer(576), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(-1), m_cc1Form, instance1 } );
		...
		RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 8, 16, 832, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		RecordBrowser m_recbrDementiaAMTSTemp = (RecordBrowser)factory.getControl(RecordBrowser.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), new Integer(-1), ControlState.ENABLED, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, null});
		addControl(m_recbrDementiaAMTSTemp);
		recbrDementiaAMTSRecordBrowser recbrDementiaAMTS = (recbrDementiaAMTSRecordBrowser)RecordBrowserFlyweightFactory.getInstance().createRecordBrowserBridge(recbrDementiaAMTSRecordBrowser.class, m_recbrDementiaAMTSTemp);
		super.addRecordBrowser(recbrDementiaAMTS);
	}


	public ims.clinical.forms.dementiaassessmentamtscomponent.IComponent cc1()
	{
	...
	public recbrDementiaAMTSRecordBrowser recbrDementiaAMTS()
	{
		return (recbrDementiaAMTSRecordBrowser)super.getRecordBrowser(0);
	}
