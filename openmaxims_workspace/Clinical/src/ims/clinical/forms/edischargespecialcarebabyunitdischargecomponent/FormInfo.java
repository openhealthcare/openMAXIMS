...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "EDischargeSpecialCareBabyUnitDischargeComponent";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return "_lv_Clinical.EDischargeSpecialCareBabyUnitDischargeComponent.__internal_x_context__" + String.valueOf(getFormId());
	}
