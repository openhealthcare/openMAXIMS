...
public abstract class BaseLogic extends Handlers implements IComponent
{
	...
	{
		return ims.clinical.domain.EDischargePatientReadyToLeaveComponent.class;
	}
	public final void setContext(ims.framework.UIComponentEngine engine, GenForm form, ims.clinical.domain.EDischargePatientReadyToLeaveComponent domain)
	{
	...
	protected ims.clinical.domain.EDischargePatientReadyToLeaveComponent domain;
}
