...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "EDischargePatientReadyToLeaveComponent";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Core.YesNoDialogMessage", "_cv_Clinical.eDischargeCompleted", "_cv_Core.HideCancelButton", "_cv_Clinical.eDischargeDisableTabs" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.EDischargePatientReadyToLeaveComponent.__internal_x_context__" + String.valueOf(getFormId());
	}
