...
public abstract class BaseLogic extends Handlers
{
	...
	{
		return ims.clinical.domain.ExtendedPatientClinicalNotes.class;
	}
	public final void setContext(ims.framework.UIEngine engine, GenForm form, ims.clinical.domain.ExtendedPatientClinicalNotes domain)
	{
	...
	{
		this.form.cmbStatus().setValue((ims.core.vo.lookups.ClinicalNotesStatus)domain.getLookupService().getDefaultInstance(ims.core.vo.lookups.ClinicalNotesStatus.class, engine.getFormName().getID(), ims.core.vo.lookups.ClinicalNotesStatus.TYPE_ID));
	}
	...
	protected ims.clinical.domain.ExtendedPatientClinicalNotes domain;
}
