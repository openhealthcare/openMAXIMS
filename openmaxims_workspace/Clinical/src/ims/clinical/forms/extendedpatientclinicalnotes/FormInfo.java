...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "ExtendedPatientClinicalNotes";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Core.ClinicalNotingMode", "_cv_Core.ClinicalNotesShort", "_cv_Clinical.ReturnToFormMode" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.ExtendedPatientClinicalNotes.__internal_x_context__" + String.valueOf(getFormId());
	}
