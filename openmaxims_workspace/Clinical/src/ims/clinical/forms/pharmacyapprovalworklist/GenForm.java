...
public class GenForm extends FormBridge
{
	...
	public static class cmbPharmacyStatusComboBox extends ComboBoxBridge
	{
		private static final long serialVersionUID = 1L;
	...
	public static class qmbResponsibleClinicianComboBox extends ComboBoxBridge
	{
		private static final long serialVersionUID = 1L;
	...
	public static class grdWorklistRow extends GridRowBridge
	{
		...
		public void setColLocWardReadOnly(boolean value)
		{
			super.row.setReadOnly(4, value);
		}
		public boolean isColLocWardReadOnly()
		{
			return super.row.isReadOnly(4);
		}
		public void showColLocWardOpened()
		{
			super.row.showOpened(4);
		}
		public String getColLocWard()
		{
			return (String)super.row.get(4);
		}
		public void setColLocWard(String value)
		{
			super.row.set(4, value);
		}
		public void setCellColLocWardTooltip(String value)
		{
			super.row.setTooltip(4, value);
		}
		public void setColExpDateOfDischReadOnly(boolean value)
		{
			super.row.setReadOnly(5, value);
		}
		public boolean isColExpDateOfDischReadOnly()
		{
			return super.row.isReadOnly(5);
		}
		public void showColExpDateOfDischOpened()
		{
			super.row.showOpened(5);
		}
		public ims.framework.utils.Date getColExpDateOfDisch()
		{
			return (ims.framework.utils.Date)super.row.get(5);
		}
		public void setColExpDateOfDisch(ims.framework.utils.Date value)
		{
			super.row.set(5, value);
		}
		public void setCellColExpDateOfDischTooltip(String value)
		{
			super.row.setTooltip(5, value);
		}
		public void setColDateSubmittReadOnly(boolean value)
		{
			super.row.setReadOnly(6, value);
		}
		public boolean isColDateSubmittReadOnly()
		{
			return super.row.isReadOnly(6);
		}
		public void showColDateSubmittOpened()
		{
			super.row.showOpened(6);
		}
		public ims.framework.utils.Date getColDateSubmitt()
		{
			return (ims.framework.utils.Date)super.row.get(6);
		}
		public void setColDateSubmitt(ims.framework.utils.Date value)
		{
			super.row.set(6, value);
		}
		public void setCellColDateSubmittTooltip(String value)
		{
			super.row.setTooltip(6, value);
		}
		public void setColPharmacyStatusReadOnly(boolean value)
		{
			super.row.setReadOnly(7, value);
		}
		public boolean isColPharmacyStatusReadOnly()
		{
			return super.row.isReadOnly(7);
		}
		public void showColPharmacyStatusOpened()
		{
			super.row.showOpened(7);
		}
		public String getColPharmacyStatus()
		{
			return (String)super.row.get(7);
		}
		public void setColPharmacyStatus(String value)
		{
			super.row.set(7, value);
		}
		public void setCellColPharmacyStatusTooltip(String value)
		{
			super.row.setTooltip(7, value);
		}
		public ims.clinical.vo.TTAMedicationAndPharmacyShortVo getValue()
		{
			return (ims.clinical.vo.TTAMedicationAndPharmacyShortVo)super.row.getValue();
		}
		public void setValue(ims.clinical.vo.TTAMedicationAndPharmacyShortVo value)
		{
	...
	public static class grdWorklistGrid extends GridBridge
	{
		...
		public ims.clinical.vo.TTAMedicationAndPharmacyShortVoCollection getValues()
		{
			ims.clinical.vo.TTAMedicationAndPharmacyShortVoCollection listOfValues = new ims.clinical.vo.TTAMedicationAndPharmacyShortVoCollection();
		...
		public ims.clinical.vo.TTAMedicationAndPharmacyShortVo getValue()
		{
			return (ims.clinical.vo.TTAMedicationAndPharmacyShortVo)super.grid.getValue();
		}
		public void setValue(ims.clinical.vo.TTAMedicationAndPharmacyShortVo value)
		{
		...
		public grdWorklistRow getRowByValue(ims.clinical.vo.TTAMedicationAndPharmacyShortVo value)
		{
		...
		public void setColLocWardHeaderTooltip(String value)
		{
			super.grid.setColumnHeaderTooltip(4, value);
		}
		public String getColLocWardHeaderTooltip()
		{
			return super.grid.getColumnHeaderTooltip(4);
		}
		public void setColExpDateOfDischHeaderTooltip(String value)
		{
			super.grid.setColumnHeaderTooltip(5, value);
		}
		public String getColExpDateOfDischHeaderTooltip()
		{
			return super.grid.getColumnHeaderTooltip(5);
		}
		public void setColDateSubmittHeaderTooltip(String value)
		{
			super.grid.setColumnHeaderTooltip(6, value);
		}
		public String getColDateSubmittHeaderTooltip()
		{
			return super.grid.getColumnHeaderTooltip(6);
		}
		public void setColPharmacyStatusHeaderTooltip(String value)
		{
			super.grid.setColumnHeaderTooltip(7, value);
		}
		public String getColPharmacyStatusHeaderTooltip()
		{
	...
	private void validateContext(ims.framework.Context context)
	{
		if(context == null)
			return;
		if(!context.isValidContextType(ims.clinical.vo.PharmacyApprovalSearchCriteriaVo.class))
			throw new ims.framework.exceptions.CodingRuntimeException("The type 'ims.clinical.vo.PharmacyApprovalSearchCriteriaVo' of the global context variable 'Clinical.PharmacyApprovalSearchCriteria' is not supported.");
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		// Timers
		timers = new Timers();
		timers.SearchTimer = factory.createTimer(0, 0, false);
		form.addTimer(timers.SearchTimer);
		...
		// Label Controls
		RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 496, 18, 104, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, "Hospital Number:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 496, 50, 105, 17, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, "Pharmacy Status:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 208, 50, 129, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Responsible Clinician:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 208, 18, 57, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Location:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 9, 50, 52, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "To Date:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 9, 18, 68, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1005), new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "From Date:", new Integer(1), null, new Integer(0)}));

		// TextBox Controls
		RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 600, 16, 136, 21, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		// Date Controls
		RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 80, 48, 120, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 80, 16, 120, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// ComboBox Controls
		RuntimeAnchoring anchoringHelper10 = new RuntimeAnchoring(designSize, runtimeSize, 600, 48, 136, 21, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		ComboBox m_cmbPharmacyStatusTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(anchoringHelper10.getX()), new Integer(anchoringHelper10.getY()), new Integer(anchoringHelper10.getWidth()), new Integer(anchoringHelper10.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.ENABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.TOPRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		addControl(m_cmbPharmacyStatusTemp);
		cmbPharmacyStatusComboBox cmbPharmacyStatus = (cmbPharmacyStatusComboBox)ComboBoxFlyweightFactory.getInstance().createComboBoxBridge(cmbPharmacyStatusComboBox.class, m_cmbPharmacyStatusTemp);
		super.addComboBox(cmbPharmacyStatus);

		// Query ComboBox Controls
		RuntimeAnchoring anchoringHelper11 = new RuntimeAnchoring(designSize, runtimeSize, 336, 48, 152, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		ComboBox m_qmbResponsibleClinicianTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.ENABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.TRUE, new Integer(3), null, Boolean.FALSE, new Integer(-1), Boolean.FALSE});
		addControl(m_qmbResponsibleClinicianTemp);
		qmbResponsibleClinicianComboBox qmbResponsibleClinician = (qmbResponsibleClinicianComboBox)ComboBoxFlyweightFactory.getInstance().createComboBoxBridge(qmbResponsibleClinicianComboBox.class, m_qmbResponsibleClinicianTemp);
		super.addComboBox(qmbResponsibleClinician);
		RuntimeAnchoring anchoringHelper12 = new RuntimeAnchoring(designSize, runtimeSize, 336, 16, 152, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		...
		grdWorklist.addStringColumn("Hospital Number", 0, 0, 100, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdWorklist.addStringColumn("Patient Name", 0, 0, 150, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdWorklist.addPartialDateColumn("DOB", 0, 0, 70, true, true, null, false, 2, true);
		grdWorklist.addStringColumn("Sex", 0, 0, 70, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdWorklist.addStringColumn("Location/Ward", 0, 0, 127, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdWorklist.addDateColumn("EDD", 0, 0, 100, true, true, null, false, 1, true);
		grdWorklist.addDateColumn("Date Submitted", 0, 0, 100, true, true, null, false, 1, true);
		grdWorklist.addStringColumn("Pharmacy Status", 0, 0, -1, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		super.addGrid(grdWorklist);

		// Image Buttons Controls
		RuntimeAnchoring anchoringHelper14 = new RuntimeAnchoring(designSize, runtimeSize, 808, 11, 30, 30, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1013), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, this.getImages().Core.TimerStartEnabled24, this.getImages().Core.TimerStartDisabled24, "Search for results matching 'Search Criteria'", Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
		...
		RuntimeAnchoring anchoringHelper16 = new RuntimeAnchoring(designSize, runtimeSize, 744, 11, 30, 30, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.ENABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, this.getImages().Core.FindEnabled24, this.getImages().Core.FindDisabled24, "Search for results matching 'Search Criteria'", Boolean.FALSE, Boolean.TRUE, Boolean.TRUE, Boolean.FALSE, null}));
	}
	...
	public TextBox txtHospitalNumber()
	{
	...
	public cmbPharmacyStatusComboBox cmbPharmacyStatus()
	{
		return (cmbPharmacyStatusComboBox)super.getComboBox(0);
	}
	public qmbResponsibleClinicianComboBox qmbResponsibleClinician()
	{
		return (qmbResponsibleClinicianComboBox)super.getComboBox(1);
	}
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_AutoRefresh = new ims.framework.ContextVariable("AutoRefresh", prefix + "_lv_Clinical.PharmacyApprovalWorklist.__internal_x_context__AutoRefresh_" + componentIdentifier + "");
			cxl_ColumnDOBSortOrder = new ims.framework.ContextVariable("ColumnDOBSortOrder", prefix + "_lv_Clinical.PharmacyApprovalWorklist.__internal_x_context__ColumnDOBSortOrder_" + componentIdentifier + "");
		}
		
		public boolean getAutoRefreshIsNotNull()
		{
			return !cxl_AutoRefresh.getValueIsNull(context);
		}
		public Boolean getAutoRefresh()
		{
			return (Boolean)cxl_AutoRefresh.getValue(context);
		}
		public void setAutoRefresh(Boolean value)
		{
			cxl_AutoRefresh.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_AutoRefresh = null;
		public boolean getColumnDOBSortOrderIsNotNull()
		{
			return !cxl_ColumnDOBSortOrder.getValueIsNull(context);
		}
		public ims.framework.enumerations.SortOrder getColumnDOBSortOrder()
		{
			return (ims.framework.enumerations.SortOrder)cxl_ColumnDOBSortOrder.getValue(context);
		}
		public void setColumnDOBSortOrder(ims.framework.enumerations.SortOrder value)
		{
			cxl_ColumnDOBSortOrder.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_ColumnDOBSortOrder = null;
	}
