...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "ExtendedCarePlanClinicalNotes";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Core.ClinicalNotingMode", "_cv_COE.CarePlan", "_cv_Clinical.ReturnToFormMode" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.ExtendedCarePlanClinicalNotes.__internal_x_context__" + String.valueOf(getFormId());
	}
