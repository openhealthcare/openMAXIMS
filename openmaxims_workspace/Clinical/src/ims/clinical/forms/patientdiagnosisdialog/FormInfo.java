...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Clinical.SelectedPatientDiagnosisOPNotes" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.PatientDiagnosisDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
