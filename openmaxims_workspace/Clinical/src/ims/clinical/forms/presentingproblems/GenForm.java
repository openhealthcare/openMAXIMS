...
public class GenForm extends FormBridge
{
	...
	public static class grdProblemsRow extends GridRowBridge
	{
		...
		public ims.clinical.vo.ClinicalProblemShortVo getcolProblems()
		{
			return (ims.clinical.vo.ClinicalProblemShortVo)super.row.get(0);
		}
		public void setcolProblems(ims.clinical.vo.ClinicalProblemShortVo value)
		{
		...
		public boolean getcolIsPrimary()
		{
			return ((Boolean)super.row.get(3)).booleanValue();
		}
		public void setcolIsPrimary(boolean value)
		{
	...
	public static class grdProblemsGrid extends GridBridge
	{
		...
		public grdProblemsRow getRowByValue(ims.vo.ValueObject value)
		{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 8, 24, 424, 56, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// Label Controls
		RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 16, 364, 185, 17, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "History of Presenting Problems:", new Integer(1), null, new Integer(0)}));

		// Button Controls
		RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 8, 600, 72, 24, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 8, 600, 72, 24, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		...
		RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 688, 600, 72, 24, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 768, 600, 72, 24, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		// TextBox Controls
		RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 16, 384, 808, 192, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), new Integer(startTabIndex.intValue() + 3), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT,Boolean.TRUE, new Integer(4000), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.TRUE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));

		// Grid Controls
		RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 16, 96, 808, 256, ims.framework.enumerations.ControlAnchoring.ALL);
		...
		grdProblems.addStringColumn("Problems", 0, 0, 215, false, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdProblems.addAnswerBoxColumn("Select", 0, 0, 50, false, true, 10, true, true);
		grdProblems.addPartialDateColumn("Onset", 0, 0, 70, false, true, null, false, 0, true);
		grdProblems.addBoolColumn("Primary Problem", 0, 0, 100, false, false, 0, true);
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_SelectedInstance = new ims.framework.ContextVariable("SelectedInstance", prefix + "_lv_Clinical.PresentingProblems.__internal_x_context__SelectedInstance_" + componentIdentifier + "");
			cxl_PatientProblemVoCollection = new ims.framework.ContextVariable("PatientProblemVoCollection", prefix + "_lv_Clinical.PresentingProblems.__internal_x_context__PatientProblemVoCollection_" + componentIdentifier + "");
		}
		...
		public ims.clinical.vo.PresentAbsentHistoryProblemsVo getSelectedInstance()
		{
			return (ims.clinical.vo.PresentAbsentHistoryProblemsVo)cxl_SelectedInstance.getValue(context);
		}
		public void setSelectedInstance(ims.clinical.vo.PresentAbsentHistoryProblemsVo value)
		{
			cxl_SelectedInstance.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_SelectedInstance = null;
		public boolean getPatientProblemVoCollectionIsNotNull()
		{
			return !cxl_PatientProblemVoCollection.getValueIsNull(context);
		}
		public ims.core.vo.PatientProblemVoCollection getPatientProblemVoCollection()
		{
			return (ims.core.vo.PatientProblemVoCollection)cxl_PatientProblemVoCollection.getValue(context);
		}
		public void setPatientProblemVoCollection(ims.core.vo.PatientProblemVoCollection value)
		{
			cxl_PatientProblemVoCollection.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_PatientProblemVoCollection = null;
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[74] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PresentingProblems.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100044-ID", "ID_PresentAbsentHistoryProblems");
			fields[75] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PresentingProblems.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100044-HISTORYPRESENTINGPROBLEM", "HistoryPresentingProblem");
			fields[76] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PresentingProblems.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100044-CLINICALCONTACT", "ClinicalContact");
			fields[77] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PresentingProblems.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100044-CARECONTEXT", "CareContext");
			return fields;
		}
