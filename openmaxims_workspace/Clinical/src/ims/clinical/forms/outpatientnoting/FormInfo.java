...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "_lv_Clinical.OutpatientNoting.__internal_x_context__" + String.valueOf(getFormId());
	}
	public ims.framework.FormInfo[] getComponentsFormInfo()
	{
		...
		componentsInfo[1] = new ims.clinical.forms.outpatientassessment.FormInfo(123182);
		componentsInfo[2] = new ims.core.forms.mosquery.FormInfo(102256);
