...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.PatientDiagnosisAtConsultationList", "_cv_Core.PatientDiagnosisAtConsultation", "_cv_Clinical.DisableMainCheckbox" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.DiagnosisDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
