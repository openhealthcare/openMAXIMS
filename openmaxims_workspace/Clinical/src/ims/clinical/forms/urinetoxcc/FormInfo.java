...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.RieMessage", "_cv_Clinical.SelectedDrugToxicologyItem" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.UrineToxCc.__internal_x_context__" + String.valueOf(getFormId());
	}
