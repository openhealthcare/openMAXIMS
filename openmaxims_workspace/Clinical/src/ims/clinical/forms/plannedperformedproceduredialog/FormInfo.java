...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "PlannedPerformedProcedureDialog";
	}
	public int getWidth()
	{
		return 552;
	...
	{
		return new String[] { "_cv_Clinical.CurrentSurgicalAuditProcedureDetail", "_cv_Clinical.SurgicalAuditActualPlannedProcedure", "_cv_Clinical.SurgicalAuditAddEditActualPlannedProcedure" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.PlannedPerformedProcedureDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
