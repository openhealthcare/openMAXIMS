...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "ClinicListActionSummary";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_ICP.PatientICPRecord", "_cv_CareUk.PatientElectiveListRef", "_cv_Scheduling.BookingAppointmentRef" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.ClinicListActionSummary.__internal_x_context__" + String.valueOf(getFormId());
	}
