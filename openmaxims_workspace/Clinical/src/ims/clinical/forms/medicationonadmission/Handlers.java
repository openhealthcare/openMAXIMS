...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.ctnDetails().cmbRoute().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
		...
		this.form.getContextMenus().Clinical.getMedicationOnAdmissionNEWItem().setClickEvent(new ims.framework.delegates.MenuItemClick()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.Control sender) throws ims.framework.exceptions.PresentationLogicException
			{
				onContextMenuItemClick(GenForm.ContextMenus.ClinicalNamespace.MedicationOnAdmission.NEW, sender);
			}
		});
		this.form.getContextMenus().Clinical.getMedicationOnAdmissionEDITItem().setClickEvent(new ims.framework.delegates.MenuItemClick()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.Control sender) throws ims.framework.exceptions.PresentationLogicException
			{
				onContextMenuItemClick(GenForm.ContextMenus.ClinicalNamespace.MedicationOnAdmission.EDIT, sender);
			}
		});
		this.form.getContextMenus().Clinical.getMedicationOnAdmissionINACTIVATEItem().setClickEvent(new ims.framework.delegates.MenuItemClick()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.Control sender) throws ims.framework.exceptions.PresentationLogicException
			{
				onContextMenuItemClick(GenForm.ContextMenus.ClinicalNamespace.MedicationOnAdmission.INACTIVATE, sender);
			}
		});
		this.form.getContextMenus().Clinical.getMedicationOnAdmissionCOPY_LASTItem().setClickEvent(new ims.framework.delegates.MenuItemClick()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.Control sender) throws ims.framework.exceptions.PresentationLogicException
			{
				onContextMenuItemClick(GenForm.ContextMenus.ClinicalNamespace.MedicationOnAdmission.COPY_LAST, sender);
			}
		});
	}
