...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "EDischargeMedicationOnAdmissionComponent";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return "_lv_Clinical.EDischargeMedicationOnAdmissionComponent.__internal_x_context__" + String.valueOf(getFormId());
	}
