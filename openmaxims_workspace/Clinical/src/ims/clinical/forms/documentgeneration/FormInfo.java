...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Clinical.CurrentCorrespondanceSearchCriteria", "_cv_Core.GPDetails", "_cv_Core.ClinicalNotingMode", "_cv_Admin.MemberOfStaffShortVoCollection", "_cv_Clinical.CurrentClinicalCorrespondanceLiteVo" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.DocumentGeneration.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Clinical/documents_add_48.png";
	}
}
