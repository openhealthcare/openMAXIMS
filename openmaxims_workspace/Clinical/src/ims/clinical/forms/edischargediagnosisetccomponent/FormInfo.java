...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "EDischargeDiagnosisEtcComponent";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Clinical.eDischargeCompleted", "_cv_Clinical.eDischargeClinicalComplete", "_cv_Core.RieMessage", "_cv_Clinical.eDischargeDisableTabs" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.EDischargeDiagnosisEtcComponent.__internal_x_context__" + String.valueOf(getFormId());
	}
