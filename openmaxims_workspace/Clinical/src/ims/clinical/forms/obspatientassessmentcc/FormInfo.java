...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.SelectedUserAssessmentLite", "_cv_Assessment.AssessmentsForSpecialtyCollection" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.ObsPatientAssessmentCc.__internal_x_context__" + String.valueOf(getFormId());
	}
