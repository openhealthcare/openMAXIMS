...
public abstract class BaseLogic extends Handlers
{
	...
	{
		java.util.ArrayList listOfValues = this.form.cmb2().getValues();
		...
		else if(value instanceof ims.core.vo.lookups.LateralityLRB)
		{
			...
			this.form.cmb2().newRow(instance, instance.getText(), instance.getImage(), instance.getTextColor());
		}
	}
	protected final void bindcmb2Lookup()
	{
		this.form.cmb2().clear();
		...
		{
			this.form.cmb2().newRow(lookupCollection.get(x), lookupCollection.get(x).getText(), lookupCollection.get(x).getImage(), lookupCollection.get(x).getTextColor());
		}
	}
	protected final void setcmb2LookupValue(int id)
	{
		...
		if(instance != null)
			this.form.cmb2().setValue(instance);
	}
	protected final void defaultcmb2LookupValue()
	{
		this.form.cmb2().setValue((ims.core.vo.lookups.LateralityLRB)domain.getLookupService().getDefaultInstance(ims.core.vo.lookups.LateralityLRB.class, engine.getFormName().getID(), ims.core.vo.lookups.LateralityLRB.TYPE_ID));
	}
