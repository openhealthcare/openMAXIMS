...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "SelectPatientOrLocallyConfiguredDiagnosis";
	}
	public int getWidth()
	{
		return 536;
	...
	{
		return new String[] { "_cv_Clinical.SelectedPatientDiagnosisListVo", "_cv_Clinical.LocallyConfiguredDiagnosis" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.SelectPatientOrLocallyConfiguredDiagnosis.__internal_x_context__" + String.valueOf(getFormId());
	}
