...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Clinical.SelectedFitForSurgeryComment" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.FitForSurgeryComment.__internal_x_context__" + String.valueOf(getFormId());
	}
