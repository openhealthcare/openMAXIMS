...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.CurrentMDTListShown", "_cv_Clinical.CurrentMDTListAndDates" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.MDTNotes.__internal_x_context__" + String.valueOf(getFormId());
	}
