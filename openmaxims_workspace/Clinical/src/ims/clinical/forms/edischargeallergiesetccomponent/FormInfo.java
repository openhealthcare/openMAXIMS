...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "EDischargeAllergiesEtcComponent";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Clinical.eDischargeDisableTabs", "_cv_Clinical.eDischargeCompleted", "_cv_Clinical.eDischargeClinicalComplete", "_cv_Core.YesNoDialogMessage" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.EDischargeAllergiesEtcComponent.__internal_x_context__" + String.valueOf(getFormId());
	}
