...
public abstract class BaseLogic extends Handlers implements IComponent
{
	...
	{
		return ims.clinical.domain.EDischargeOpsProcsComponent.class;
	}
	public final void setContext(ims.framework.UIComponentEngine engine, GenForm form, ims.clinical.domain.EDischargeOpsProcsComponent domain)
	{
	...
	protected ims.clinical.domain.EDischargeOpsProcsComponent domain;
}
