...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "DementiaAssessmentFINDComponent";
	}
	public int getWidth()
	{
		return 730;
	...
	{
		return new String[] { "_cv_Admin.DementiaConfiguration", "_cv_Core.RieMessage" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.DementiaAssessmentFINDComponent.__internal_x_context__" + String.valueOf(getFormId());
	}
