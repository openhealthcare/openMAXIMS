...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.ClinicalNotesShort", "_cv_Clinical.ReturnToFormMode", "_cv_Core.ClinicalNotingMode" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.PatientClinicalNotes.__internal_x_context__" + String.valueOf(getFormId());
	}
