...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.CurrentMDTListShown", "_cv_Clinical.CurrentMDTListAndDates", "_cv_Core.PatientToBeDisplayed" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.MDTList.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Clinical/mdt_48.png";
	}
}
