...
public abstract class BaseLogic extends Handlers implements IComponent
{
	...
	{
		return ims.clinical.domain.HCGCc.class;
	}
	public final void setContext(ims.framework.UIComponentEngine engine, GenForm form, ims.clinical.domain.HCGCc domain)
	{
	...
	protected ims.clinical.domain.HCGCc domain;
}
