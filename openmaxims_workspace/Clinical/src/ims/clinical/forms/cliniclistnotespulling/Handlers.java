...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void onDyngrdListColumnHeaderClicked(ims.framework.controls.DynamicGridColumn column);
	...
	abstract protected void onBtnPullNotesClick() throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.dyngrdList().setDynamicGridColumnHeaderClickedEvent(new DynamicGridColumnHeaderClicked()
		{
			private static final long serialVersionUID = 1L;
			...
			{
				onDyngrdListColumnHeaderClicked(column);
			}
		});
		...
		this.form.btnPullNotes().setClickEvent(new Click()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
