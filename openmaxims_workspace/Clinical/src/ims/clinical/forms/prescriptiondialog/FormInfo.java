...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_CareUk.PrescriptionMedication", "_cv_CareUk.DrugsAlreadyAddedToPrescription" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.PrescriptionDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
