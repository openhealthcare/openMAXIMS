...
public abstract class BaseLogic extends Handlers
{
	...
	{
		return ims.clinical.domain.PrescriptionDialog.class;
	}
	public final void setContext(ims.framework.UIEngine engine, GenForm form, ims.clinical.domain.PrescriptionDialog domain)
	{
		setContext(engine, form);
		this.domain = domain;
		if(domain.getLookupService().countLookupInstances(ims.core.vo.lookups.MedicationFrequencyCollection.class, ims.core.vo.lookups.MedicationFrequency.class, 1021038, true) == 0)
		{
			if(lookupUsageErrors == null)
				lookupUsageErrors = new java.util.ArrayList();
			lookupUsageErrors.add("The lookup type 'MedicationFrequency' (ID: 1021038) must have at least one active instance configured.");
		}
	}
	...
	protected ims.clinical.domain.PrescriptionDialog domain;
}
