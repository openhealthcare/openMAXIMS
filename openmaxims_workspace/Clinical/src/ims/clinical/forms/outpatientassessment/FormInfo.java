...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Assessment.AssessmentsForSpecialtyCollection", "_cv_Clinical.eDischargeClinicalComplete", "_cv_Clinical.eDischargeCompleted", "_cv_Clinical.eDischargeDisableTabs", "_cv_Core.SelectedUserAssessmentLite" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.OutpatientAssessment.__internal_x_context__" + String.valueOf(getFormId());
	}
