...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "HospitalAtNightPatientDetail";
	}
	public int getWidth()
	{
		return 800;
	...
	{
		return new String[] { "_cv_Clinical.HospitalAtNightNotes", "_cv_Clinical.HospitalAtNightPatientDetails", "_cv_Clinical.ClinicalTasks", "_cv_Clinical.RemoveFromHospitalAtNight" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.HospitalAtNightPatientDetail.__internal_x_context__" + String.valueOf(getFormId());
	}
