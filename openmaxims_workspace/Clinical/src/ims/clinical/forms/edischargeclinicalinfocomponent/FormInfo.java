...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "EDischargeClinicalInfoComponent";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Clinical.eDischargeDisableTabs", "_cv_Clinical.eDischargeCompleted", "_cv_Clinical.eDischargeClinicalComplete" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.EDischargeClinicalInfoComponent.__internal_x_context__" + String.valueOf(getFormId());
	}
