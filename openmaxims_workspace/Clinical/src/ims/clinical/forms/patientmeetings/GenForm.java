...
public class GenForm extends FormBridge
{
	...
	public static class ctnDetailsContainer extends ContainerBridge
	{
		...
		public static class cmbStatusComboBox extends ComboBoxBridge
		{
			...
			public void newRow(ims.clinical.vo.lookups.MeetingStatus value, String text)
			{
				super.control.newRow(value, text);
			}
			public void newRow(ims.clinical.vo.lookups.MeetingStatus value, String text, ims.framework.utils.Image image)
			{
				super.control.newRow(value, text, image);
			}
			public void newRow(ims.clinical.vo.lookups.MeetingStatus value, String text, ims.framework.utils.Color textColor)
			{
				super.control.newRow(value, text, textColor);
			}
			public void newRow(ims.clinical.vo.lookups.MeetingStatus value, String text, ims.framework.utils.Image image, ims.framework.utils.Color textColor)
			{
				super.control.newRow(value, text, image, textColor);
			}
			public boolean removeRow(ims.clinical.vo.lookups.MeetingStatus value)
			{
				return super.control.removeRow(value);
			}
			public ims.clinical.vo.lookups.MeetingStatus getValue()
			{
				return (ims.clinical.vo.lookups.MeetingStatus)super.control.getValue();
			}
			public void setValue(ims.clinical.vo.lookups.MeetingStatus value)
			{
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 344, 56, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			ims.framework.FormUiLogic m_customControlAuthoringHcpForm = loader.loadComponent(102228, appForm, startControlID * 10 + 1000, anchoringHelper1.getSize(), instance1, startTabIndex.intValue() + 1, skipContextValidation);
			//ims.framework.Control m_customControlAuthoringHcpControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(8), new Integer(8), new Integer(344), new Integer(56), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 1), m_customControlAuthoringHcpForm, instance1 } );
			ims.framework.Control m_customControlAuthoringHcpControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001),  new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(startTabIndex.intValue() + 1), m_customControlAuthoringHcpForm, instance1, Boolean.FALSE } );
			...
			// Label Controls
			RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 16, 69, 119, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Meeting Date/Time:", new Integer(1), null, new Integer(0)}));
			RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 16, 121, 45, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Status:", new Integer(1), null, new Integer(0)}));
			RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 16, 145, 41, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Notes:", new Integer(1), null, new Integer(0)}));
			RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 16, 95, 115, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1005), new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Next Meeting Date:", new Integer(1), null, new Integer(0)}));
	
			// TextBox Controls
			RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 168, 144, 624, 80, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
			super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1006), new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), new Integer(startTabIndex.intValue() + 1005), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, new Integer(1500), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
	
			// Date Controls
			RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 168, 94, 168, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			...
			// Date Time Controls
			RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 168, 68, 168, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			...
			// ComboBox Controls
			RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 168, 120, 168, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
			...
			RuntimeAnchoring anchoringHelper10 = new RuntimeAnchoring(designSize, runtimeSize, 360, 15, 432, 113, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
		...
		public DateControl dteNextMeeting()
		{
			return (DateControl)super.getControl(6);
		}
		public DateTimeControl dtimMeeting()
		{
	...
	public static class grdListRow extends GridRowBridge
	{
		...
		public void setColNotesButtonReadOnly(boolean value)
		{
			super.row.setReadOnly(2, value);
		}
		public boolean isColNotesButtonReadOnly()
		{
			return super.row.isReadOnly(2);
		}
		public void showColNotesButtonOpened()
		{
			super.row.showOpened(2);
		}
		public void setTooltipForColNotesButton(String value)
		{
			super.row.setTooltip(2, value);
		}
		public String getColNotesButton()
		{
			return (String)super.row.get(2);
		}
		public void setColNotesButton(String value)
		{
			super.row.set(2, value);
		}
		public void setCellColNotesButtonTooltip(String value)
		{
			super.row.setTooltip(2, value);
		}
		...
		public void setTooltipForColNotes(String value)
		{
		...
		public ims.clinical.vo.PatientMeetingLiteVo getValue()
		{
			return (ims.clinical.vo.PatientMeetingLiteVo)super.row.getValue();
		}
		public void setValue(ims.clinical.vo.PatientMeetingLiteVo value)
		{
	...
	public static class grdListGrid extends GridBridge
	{
		...
		public ims.clinical.vo.PatientMeetingLiteVoCollection getValues()
		{
			ims.clinical.vo.PatientMeetingLiteVoCollection listOfValues = new ims.clinical.vo.PatientMeetingLiteVoCollection();
		...
		public ims.clinical.vo.PatientMeetingLiteVo getValue()
		{
			return (ims.clinical.vo.PatientMeetingLiteVo)super.grid.getValue();
		}
		public void setValue(ims.clinical.vo.PatientMeetingLiteVo value)
		{
		...
		public grdListRow getRowByValue(ims.clinical.vo.PatientMeetingLiteVo value)
		{
		...
		public void setColNotesButtonHeaderTooltip(String value)
		{
			super.grid.setColumnHeaderTooltip(2, value);
		}
		public String getColNotesButtonHeaderTooltip()
		{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		// Container Clasess
		RuntimeAnchoring anchoringHelper11 = new RuntimeAnchoring(designSize, runtimeSize, 16, 344, 816, 248, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
		...
		// Button Controls
		RuntimeAnchoring anchoringHelper12 = new RuntimeAnchoring(designSize, runtimeSize, 96, 600, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		...
		RuntimeAnchoring anchoringHelper14 = new RuntimeAnchoring(designSize, runtimeSize, 676, 600, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		// Grid Controls
		RuntimeAnchoring anchoringHelper16 = new RuntimeAnchoring(designSize, runtimeSize, 16, 16, 816, 320, ims.framework.enumerations.ControlAnchoring.ALL);
		...
		grdList.addStringColumn("Meeting Date/Time", 0, 0, 120, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdList.addStringColumn("Status", 0, 0, 100, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdList.addCommentColumn(" ", 0, 0, 20, false, true,0, true);
		grdList.addStringColumn("Notes", 0, 0, -1, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_SelectedInstance = new ims.framework.ContextVariable("SelectedInstance", prefix + "_lv_Clinical.PatientMeetings.__internal_x_context__SelectedInstance_" + componentIdentifier + "");
		}
		...
		public ims.clinical.vo.PatientMeetingVo getSelectedInstance()
		{
			return (ims.clinical.vo.PatientMeetingVo)cxl_SelectedInstance.getValue(context);
		}
		public void setSelectedInstance(ims.clinical.vo.PatientMeetingVo value)
		{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[71] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMeetings.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100058-ID", "ID_PatientMeeting");
			fields[72] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMeetings.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100058-CARECONTEXT", "CareContext");
			fields[73] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMeetings.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100058-CLINICALCONTACT", "ClinicalContact");
			fields[74] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMeetings.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100058-MEETINGDATETIME", "MeetingDateTime");
			fields[75] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMeetings.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100058-NEXTMEETINGDATE", "NextMeetingDate");
			fields[76] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMeetings.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100058-STATUS", "Status");
			fields[77] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientMeetings.__internal_x_context__SelectedInstance_" + componentIdentifier, "BO-1072100058-MEETINGNOTES", "MeetingNotes");
			return fields;
		}
