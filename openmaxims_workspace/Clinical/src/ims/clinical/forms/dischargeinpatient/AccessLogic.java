...
public final class AccessLogic extends BaseAccessLogic implements Serializable
{
	...
	{
		boolean bAccessible = form.getGlobalContext().Core.getCurrentCareContextIsNotNull() && 
		!form.getGlobalContext().Core.getCurrentCareContext().getContext().equals(ContextType.DAYHOSPITAL);
