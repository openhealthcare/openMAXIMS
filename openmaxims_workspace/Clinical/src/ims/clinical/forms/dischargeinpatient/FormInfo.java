...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_COE.DischargeImpatient.DischargeDateTime", "_cv_COE.DischargeInpatient", "_cv_Core.ReportID", "_cv_Core.TemplateID" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.DischargeInpatient.__internal_x_context__" + String.valueOf(getFormId());
	}
