...
public final class GlobalContext extends ims.framework.FormContext implements Serializable
{
	...
	public final class COEContext implements Serializable
	{
		...
		private COEContext(ims.framework.Context context)
		{
			...
			DischargeImpatient = new DischargeImpatientContext(context);
		}
		public final class DischargeImpatientContext implements Serializable
		{
			private static final long serialVersionUID = 1L;

			private DischargeImpatientContext(ims.framework.Context context)
			{
				this.context = context;
			}
			public boolean getDischargeDateTimeIsNotNull()
			{
				return !cx_COEDischargeImpatientDischargeDateTime.getValueIsNull(context);
			}
			public ims.framework.utils.DateTime getDischargeDateTime()
			{
				return (ims.framework.utils.DateTime)cx_COEDischargeImpatientDischargeDateTime.getValue(context);
			}

			private ims.framework.ContextVariable cx_COEDischargeImpatientDischargeDateTime = new ims.framework.ContextVariable("COE.DischargeImpatient.DischargeDateTime", "_cv_COE.DischargeImpatient.DischargeDateTime");
			private ims.framework.Context context;
		}

		public boolean getDischargeInpatientIsNotNull()
		{
			return !cx_COEDischargeInpatient.getValueIsNull(context);
		}
		public ims.coe.vo.Discharge getDischargeInpatient()
		{
			return (ims.coe.vo.Discharge)cx_COEDischargeInpatient.getValue(context);
		}
		public void setDischargeInpatient(ims.coe.vo.Discharge value)
		{
			cx_COEDischargeInpatient.setValue(context, value);
		}

		private ims.framework.ContextVariable cx_COEDischargeInpatient = new ims.framework.ContextVariable("COE.DischargeInpatient", "_cv_COE.DischargeInpatient");

		public DischargeImpatientContext DischargeImpatient;
		private ims.framework.Context context;
	}
