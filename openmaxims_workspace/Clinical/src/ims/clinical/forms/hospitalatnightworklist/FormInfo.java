...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "HospitalAtNightWorklist";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Clinical.HospitalAtNightPatientDetails" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.HospitalAtNightWorklist.__internal_x_context__" + String.valueOf(getFormId());
	}
