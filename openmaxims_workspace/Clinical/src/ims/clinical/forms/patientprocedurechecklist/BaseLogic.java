...
public abstract class BaseLogic extends Handlers
{
	...
	{
		return ims.clinical.domain.PatientProcedureChecklist.class;
	}
	public final void setContext(ims.framework.UIEngine engine, GenForm form, ims.clinical.domain.PatientProcedureChecklist domain)
	{
		setContext(engine, form);
		this.domain = domain;
	}
	protected final void bindgrdChecklistColPresentAbsentLookup()
	{
	...
	protected ims.clinical.domain.PatientProcedureChecklist domain;
}
