...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "PatientProcedureChecklist";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Clinical.PMHConfigSearchType", "_cv_Core.TaxonomyTextReturned", "_cv_Clinical.CDIUnlinkedRecord", "_cv_Clinical.SelectedProcedures", "_cv_Core.TaxonomyMap" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.PatientProcedureChecklist.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Clinical/patient_procedures_checklist_48.png";
	}
}
