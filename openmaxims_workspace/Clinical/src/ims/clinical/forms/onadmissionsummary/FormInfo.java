...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.ClinicalNotingMode" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.OnAdmissionSummary.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Clinical/summary_48.png";
	}
}
