...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "EDischargePreViewComponent";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Clinical.eDischargeCompleted", "_cv_Clinical.eDischargeClinicalComplete", "_cv_Core.GPDetails", "_cv_Clinical.eDischargeDisableTabs", "_cv_Core.YesNoDialogMessage", "_cv_Core.HideCancelButton" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.EDischargePreViewComponent.__internal_x_context__" + String.valueOf(getFormId());
	}
