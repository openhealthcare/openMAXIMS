...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "OutPatientsTreatmentPlan";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Clinical.ReturnToFormMode", "_cv_Clinical.ReturnToFormCDIDescription", "_cv_ProtoTemp.ClinicalNoteDrawingReturnFormName", "_cv_Clinical.ReturnToFormName" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.OutPatientsTreatmentPlan.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/CcoSched/treatment_48.png";
	}
}
