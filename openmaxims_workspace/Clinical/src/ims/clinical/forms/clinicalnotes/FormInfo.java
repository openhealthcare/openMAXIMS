...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.ClinicalNotingMode", "_cv_Clinical.ReturnToFormMode" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Clinical.ClinicalNotes.__internal_x_context__" + String.valueOf(getFormId());
	}
