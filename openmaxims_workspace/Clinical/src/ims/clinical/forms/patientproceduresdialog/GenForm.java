...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		ims.framework.utils.SizeInfo designSize = new ims.framework.utils.SizeInfo(808, 192);
		if(runtimeSize == null)
		...
		RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 16, 64, 776, 64, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		ims.framework.FormUiLogic m_ccProcedureForm = loader.loadComponent(123133, appForm, startControlID * 10 + 1000, anchoringHelper4.getSize(), instance1, startTabIndex.intValue() + 3, skipContextValidation);
		...
		// Label Controls
		RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 24, 136, 53, 17, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		...
		RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 24, 40, 41, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Filter: ", new Integer(1), null, new Integer(0)}));

		// Button Controls
		RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 632, 160, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 712, 160, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		// CheckBox Controls
		RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 128, 136, 16, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RadioButton tmpgrpFilter = (RadioButton)factory.getControl(RadioButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(0), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE});
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_voPatientDiagnosis = new ims.framework.ContextVariable("voPatientDiagnosis", prefix + "_lv_Clinical.PatientProceduresDialog.__internal_x_context__voPatientDiagnosis_" + componentIdentifier + "");
			cxl_voContact = new ims.framework.ContextVariable("voContact", prefix + "_lv_Clinical.PatientProceduresDialog.__internal_x_context__voContact_" + componentIdentifier + "");
			cxl_voTaxonomyMap = new ims.framework.ContextVariable("voTaxonomyMap", prefix + "_lv_Clinical.PatientProceduresDialog.__internal_x_context__voTaxonomyMap_" + componentIdentifier + "");
			cxl_voDiagnosis = new ims.framework.ContextVariable("voDiagnosis", prefix + "_lv_Clinical.PatientProceduresDialog.__internal_x_context__voDiagnosis_" + componentIdentifier + "");
		}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[89] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProceduresDialog.__internal_x_context__voContact_" + componentIdentifier, "BO-1004100003-ID", "ID_ClinicalContact");
			fields[90] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProceduresDialog.__internal_x_context__voContact_" + componentIdentifier, "BO-1004100003-SPECIALTY", "Specialty");
			fields[91] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProceduresDialog.__internal_x_context__voContact_" + componentIdentifier, "BO-1004100003-SEENBY", "SeenBy");
			fields[92] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProceduresDialog.__internal_x_context__voContact_" + componentIdentifier, "BO-1004100003-CONTACTTYPE", "ContactType");
			fields[93] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProceduresDialog.__internal_x_context__voContact_" + componentIdentifier, "BO-1004100003-STARTDATETIME", "StartDateTime");
			fields[94] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProceduresDialog.__internal_x_context__voContact_" + componentIdentifier, "BO-1004100003-ENDDATETIME", "EndDateTime");
			fields[95] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProceduresDialog.__internal_x_context__voContact_" + componentIdentifier, "BO-1004100003-CARECONTEXT", "CareContext");
			fields[96] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProceduresDialog.__internal_x_context__voContact_" + componentIdentifier, "BO-1004100003-ISCLINICALNOTECREATED", "IsClinicalNoteCreated");
			fields[97] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProceduresDialog.__internal_x_context__voTaxonomyMap_" + componentIdentifier, "BO-1003100010-ID", "ID_TaxonomyMap");
			fields[98] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProceduresDialog.__internal_x_context__voTaxonomyMap_" + componentIdentifier, "BO-1003100010-TAXONOMYNAME", "TaxonomyName");
			fields[99] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProceduresDialog.__internal_x_context__voTaxonomyMap_" + componentIdentifier, "BO-1003100010-TAXONOMYCODE", "TaxonomyCode");
			...
			fields[101] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProceduresDialog.__internal_x_context__voDiagnosis_" + componentIdentifier, "BO-1003100025-DIAGNOSISNAME", "DiagnosisName");
			fields[102] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientProceduresDialog.__internal_x_context__voDiagnosis_" + componentIdentifier, "BO-1003100025-ISACTIVE", "IsActive");
			return fields;
		}
