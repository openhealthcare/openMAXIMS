...
public class GenForm extends FormBridge
{
	...
	public static class ctnSummaryContainer extends ContainerBridge
	{
		...
		public static class GroupDiagnosisRadioButton extends RadioButtonBridge
		{
			...
			protected void setContext(Integer startTabIndex, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize)
			{
				if(startTabIndex == null)
					throw new RuntimeException("Invalid startTabIndex ");
				RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 336, 24, 32, 16, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				...
				control.addButton(1, anchoringHelper5.getX(), anchoringHelper5.getY(), anchoringHelper5.getWidth(), "Diagnosis", startTabIndex.intValue() + 12);
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, Images form_images_local, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1006), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 10), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT, form_images_local.COE.Blue, form_images_local.COE.Blue, null, Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
	...
	public static class grdListRow extends GridRowBridge
	{
		...
		public void setColumnHistoryReadOnly(boolean value)
		{
			super.row.setReadOnly(4, value);
		}
		public boolean isColumnHistoryReadOnly()
		{
			return super.row.isReadOnly(4);
		}
		public void setColumnHistoryEmpty(boolean value)
		{
			super.row.setIsEmpty(4, value);
		}
		public boolean isColumnHistoryEmpty()
		{
			return super.row.isEmpty(4);
		}
		public void showColumnHistoryOpened()
		{
			super.row.showOpened(4);
		}
		public void setTooltipForColumnHistory(String value)
		{
			super.row.setTooltip(4, value);
		}
		public ims.framework.utils.Image getColumnHistory()
		{
			return (ims.framework.utils.Image)super.row.get(4);
		}
		public void setColumnHistory(ims.framework.utils.Image value)
		{
			super.row.set(4, value);
		}
		public void setCellColumnHistoryTooltip(String value)
		{
			super.row.setTooltip(4, value);
		}
		public ims.vo.ValueObject getValue()
	...
	public static class grdListGrid extends GridBridge
	{
		...
		public void setColumnHistoryHeaderTooltip(String value)
		{
			super.grid.setColumnHeaderTooltip(4, value);
		}
		public String getColumnHistoryHeaderTooltip()
		{
			return super.grid.getColumnHeaderTooltip(4);
		}
	}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		contextMenus.contextMenuPatSummaryDiagComp = factory.createMenu(startControlID.intValue() + 1);
		contextMenus.contextMenuPatSummaryDiagCompVIEWItem = factory.createMenuItem(startControlID.intValue() + 1, "View", true, false, new Integer(102223), true, false);
		...
		contextMenus.contextMenuPatSummaryDiagCompVIEWLINKSDIALOGItem = factory.createMenuItem(startControlID.intValue() + 2, "View Associations on Dialog", true, false, new Integer(101128), true, true);
		...
		contextMenus.contextMenuPatSummaryDiagCompDISPLAYLINKSSUMMARYItem = factory.createMenuItem(startControlID.intValue() + 3, "Display Associations on Summary", true, false, new Integer(103138), true, false);
		...
		contextMenus.contextMenuPatSummaryDiagCompNEWDIAGNOSISItem = factory.createMenuItem(startControlID.intValue() + 4, "New Diagnosis", true, false, new Integer(102179), true, true);
		...
		contextMenus.contextMenuPatSummaryDiagCompNEWPROBLEMItem = factory.createMenuItem(startControlID.intValue() + 5, "New Problem", true, false, new Integer(102179), true, true);
		...
		contextMenus.contextMenuPatSummaryProc = factory.createMenu(startControlID.intValue() + 2);
		contextMenus.contextMenuPatSummaryProcVIEWItem = factory.createMenuItem(startControlID.intValue() + 6, "View", true, false, new Integer(102223), true, false);
		...
		contextMenus.contextMenuPatSummaryProcVIEWLINKSDIALOGItem = factory.createMenuItem(startControlID.intValue() + 7, "View Associations on Dialog", true, false, new Integer(101128), true, true);
		...
		contextMenus.contextMenuPatSummaryProcDISPLAYLINKSUMMARYItem = factory.createMenuItem(startControlID.intValue() + 8, "Display Associations on Summary", true, false, new Integer(103138), true, false);
		...
		contextMenus.contextMenuPatSummaryProcNEWPROCEDUREItem = factory.createMenuItem(startControlID.intValue() + 9, "New Procedure", true, false, new Integer(102179), true, true);
		...
		contextMenus.contextMenuClinicalContactsList = factory.createMenu(startControlID.intValue() + 3);
		contextMenus.contextMenuClinicalContactsListNewCareGroupingItem = factory.createMenuItem(startControlID.intValue() + 10, "New Problem Group", true, false, new Integer(102149), true, false);
		...
		contextMenus.contextMenuClinicalContactsListEditCareGroupingItem = factory.createMenuItem(startControlID.intValue() + 11, "Edit Problem Group", true, false, new Integer(102150), true, false);
		...
		contextMenus.contextMenuClinicalContactsListNewEpisodeOfCareItem = factory.createMenuItem(startControlID.intValue() + 12, "New Episode of Care", true, false, new Integer(102149), true, true);
		...
		contextMenus.contextMenuClinicalContactsListEditEpisodeofCareItem = factory.createMenuItem(startControlID.intValue() + 13, "Edit Episode of Care", true, false, new Integer(102150), true, false);
		...
		contextMenus.contextMenuClinicalContactsListAddContactContextDetailsItem = factory.createMenuItem(startControlID.intValue() + 14, "New Care Context Details", true, false, new Integer(102149), true, true);
		...
		contextMenus.contextMenuClinicalContactsListEditContactContextDetailsItem = factory.createMenuItem(startControlID.intValue() + 15, "Edit Care Context Details", true, false, new Integer(102150), true, false);
		...
		contextMenus.contextMenuClinicalContactsListAddContactItem = factory.createMenuItem(startControlID.intValue() + 16, "New Clinical Contact", true, false, new Integer(102179), true, true);
		...
		contextMenus.contextMenuClinicalContactsListEditContactItem = factory.createMenuItem(startControlID.intValue() + 17, "Edit Clinical Contact", true, false, new Integer(102150), true, false);
		...
		contextMenus.contextMenuClinicalContactsListViewClinicalNotesItem = factory.createMenuItem(startControlID.intValue() + 18, "View Clinical Notes", true, false, new Integer(102282), true, false);
		...
		contextMenus.contextMenuClinicalContactsListCancelCareContextItem = factory.createMenuItem(startControlID.intValue() + 19, "Cancel Care Context ", true, false, new Integer(116126), true, false);
		...
		contextMenus.contextMenuClinicalContactsListUndoCancelCareContextItem = factory.createMenuItem(startControlID.intValue() + 20, "Undo Cancel Care Context", true, false, new Integer(102187), true, false);
		...
		contextMenus.contextMenuClinicalContactsListCancelClinicalContactItem = factory.createMenuItem(startControlID.intValue() + 21, "Cancel Clinical Contact", true, false, new Integer(116126), true, false);
		...
		contextMenus.contextMenuClinicalContactsListUndoCancelClinicalContactItem = factory.createMenuItem(startControlID.intValue() + 22, "Undo Cancel Clinical Contact", true, false, new Integer(102187), true, false);
		...
		contextMenus.contextMenuClinicalContactsListCancelProblemGroupItem = factory.createMenuItem(startControlID.intValue() + 23, "Cancel Problem Group", true, false, new Integer(116126), true, false);
		...
		contextMenus.contextMenuClinicalContactsListUndoCancelProblemGroupItem = factory.createMenuItem(startControlID.intValue() + 24, "Undo Cancel Problem Group", true, false, new Integer(102187), true, false);
		...
		contextMenus.contextMenuClinicalContactsListCancelEpisodeOfCareItem = factory.createMenuItem(startControlID.intValue() + 25, "Cancel Episode Of Care", true, false, new Integer(116126), true, false);
		...
		contextMenus.contextMenuClinicalContactsListUndoCancelEpisodeOfCareItem = factory.createMenuItem(startControlID.intValue() + 26, "Undo Cancel Episode Of Care", true, false, new Integer(102187), true, false);
		...
		contextMenus.contextMenuClinicalContactsListViewCancelledContextsItem = factory.createMenuItem(startControlID.intValue() + 27, "View Cancelled Contexts", true, false, new Integer(102282), true, false);
		...
		contextMenus.contextMenuClinicalContactsListHideCancelledContextsItem = factory.createMenuItem(startControlID.intValue() + 28, "Hide Cancelled Contexts", true, false, new Integer(102282), true, false);
		...
		Grid m_grdListTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1020), new Integer(anchoringHelper26.getX()), new Integer(anchoringHelper26.getY()), new Integer(anchoringHelper26.getWidth()), new Integer(anchoringHelper26.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.TRUE, new Integer(24), Boolean.FALSE, contextMenus.contextMenuClinicalContactsList, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.TRUE, Boolean.TRUE});
		...
		grdList.addTreeColumn("Start Date / End Date", 0, 375, false, true);
		grdList.addStringColumn("Specialty / Context", 0, 0, 150, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdList.addStringColumn("Contact Type", 0, 0, 120, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdList.addStringColumn("Responsible HCP / Seen By", 0, 0, 155, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdList.addButtonColumn(" ", 0, 1, -1, false, true);
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_ParentEnded = new ims.framework.ContextVariable("ParentEnded", prefix + "_lv_Clinical.PatientSummary.__internal_x_context__ParentEnded_" + componentIdentifier + "");
			cxl_IsDisplayAssociationsOnSummary = new ims.framework.ContextVariable("IsDisplayAssociationsOnSummary", prefix + "_lv_Clinical.PatientSummary.__internal_x_context__IsDisplayAssociationsOnSummary_" + componentIdentifier + "");
			cxl_PreviousDiagnosisEpisodeOfCare = new ims.framework.ContextVariable("PreviousDiagnosisEpisodeOfCare", prefix + "_lv_Clinical.PatientSummary.__internal_x_context__PreviousDiagnosisEpisodeOfCare_" + componentIdentifier + "");
			cxl_PreviousProcedureEpisodeOfCare = new ims.framework.ContextVariable("PreviousProcedureEpisodeOfCare", prefix + "_lv_Clinical.PatientSummary.__internal_x_context__PreviousProcedureEpisodeOfCare_" + componentIdentifier + "");
			cxl_CareContextCollection = new ims.framework.ContextVariable("CareContextCollection", prefix + "_lv_Clinical.PatientSummary.__internal_x_context__CareContextCollection_" + componentIdentifier + "");
			cxl_EpisodeOfCareCollection = new ims.framework.ContextVariable("EpisodeOfCareCollection", prefix + "_lv_Clinical.PatientSummary.__internal_x_context__EpisodeOfCareCollection_" + componentIdentifier + "");
			cxl_ShowCancelledContexts = new ims.framework.ContextVariable("ShowCancelledContexts", prefix + "_lv_Clinical.PatientSummary.__internal_x_context__ShowCancelledContexts_" + componentIdentifier + "");
		}
	...
	public final class ContextMenus implements java.io.Serializable
	{
		...
		public final class PatSummaryDiagComp implements java.io.Serializable
		{
			...
			public static final int VIEWLINKSDIALOG = 2;
			public static final int DISPLAYLINKSSUMMARY = 3;
			public static final int NEWDIAGNOSIS = 4;
		...
		public final class PatSummaryProc implements java.io.Serializable
		{
			...
			public static final int VIEWLINKSDIALOG = 7;
			public static final int DISPLAYLINKSUMMARY = 8;
			public static final int NEWPROCEDURE = 9;
		}
		...
		{
			private static final long serialVersionUID = 1L;
			public static final int NewCareGrouping = 10;
			public static final int EditCareGrouping = 11;
			public static final int NewEpisodeOfCare = 12;
			public static final int EditEpisodeofCare = 13;
			public static final int AddContactContextDetails = 14;
			public static final int EditContactContextDetails = 15;
			public static final int AddContact = 16;
			public static final int EditContact = 17;
			public static final int ViewClinicalNotes = 18;
			public static final int CancelCareContext = 19;
			public static final int UndoCancelCareContext = 20;
			public static final int CancelClinicalContact = 21;
			public static final int UndoCancelClinicalContact = 22;
			public static final int CancelProblemGroup = 23;
			public static final int UndoCancelProblemGroup = 24;
			public static final int CancelEpisodeOfCare = 25;
			public static final int UndoCancelEpisodeOfCare = 26;
			public static final int ViewCancelledContexts = 27;
			public static final int HideCancelledContexts = 28;
		}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[75] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-ID", "ID_SoapNote");
			fields[76] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-SUBJECTIVENOTE", "SubjectiveNote");
			fields[77] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-OBJECTIVENOTE", "ObjectiveNote");
			fields[78] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-ANALYSISNOTE", "AnalysisNote");
			fields[79] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-PLANNOTE", "PlanNote");
			fields[80] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-CLINICALNOTE", "ClinicalNote");
			fields[81] = new ims.framework.ReportField(this.context, "_cv_Clinical.UnsavedSOAPINformation", "BO-1072100036-CARECONTEXT", "CareContext");
			fields[82] = new ims.framework.ReportField(this.context, "_cv_Core.ParentClinContact", "BO-1004100003-ID", "ID_ClinicalContact");
			fields[83] = new ims.framework.ReportField(this.context, "_cv_Core.ParentClinContact", "BO-1004100003-SPECIALTY", "Specialty");
			fields[84] = new ims.framework.ReportField(this.context, "_cv_Core.ParentClinContact", "BO-1004100003-CONTACTTYPE", "ContactType");
			fields[85] = new ims.framework.ReportField(this.context, "_cv_Core.ParentClinContact", "BO-1004100003-STARTDATETIME", "StartDateTime");
			fields[86] = new ims.framework.ReportField(this.context, "_cv_Core.ParentClinContact", "BO-1004100003-ENDDATETIME", "EndDateTime");
			fields[87] = new ims.framework.ReportField(this.context, "_cv_Core.ParentClinContact", "BO-1004100003-CARECONTEXT", "CareContext");
			fields[88] = new ims.framework.ReportField(this.context, "_cv_Core.ParentClinContact", "BO-1004100003-ISCLINICALNOTECREATED", "IsClinicalNoteCreated");
			fields[89] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-ID", "ID_ClinicalContact");
			fields[90] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-SPECIALTY", "Specialty");
			fields[91] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-SEENBY", "SeenBy");
			fields[92] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-CONTACTTYPE", "ContactType");
			fields[93] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-STARTDATETIME", "StartDateTime");
			fields[94] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-ENDDATETIME", "EndDateTime");
			fields[95] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-CARECONTEXT", "CareContext");
			fields[96] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalContact", "BO-1004100003-ISCLINICALNOTECREATED", "IsClinicalNoteCreated");
			fields[97] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-ID", "ID_ClinicalNotes");
			fields[98] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-CLINICALNOTE", "ClinicalNote");
			fields[99] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-NOTETYPE", "NoteType");
			fields[100] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-DISCIPLINE", "Discipline");
			fields[101] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-CLINICALCONTACT", "ClinicalContact");
			fields[102] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-ISDERIVEDNOTE", "IsDerivedNote");
			fields[103] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-FORREVIEW", "ForReview");
			fields[104] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-FORREVIEWDISCIPLINE", "ForReviewDiscipline");
			fields[105] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-REVIEWINGDATETIME", "ReviewingDateTime");
			fields[106] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-ISCORRECTED", "IsCorrected");
			fields[107] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-ISTRANSCRIBED", "IsTranscribed");
			fields[108] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-SOURCEOFNOTE", "SourceOfNote");
			fields[109] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-RECORDINGDATETIME", "RecordingDateTime");
			fields[110] = new ims.framework.ReportField(this.context, "_cv_Core.ClinicalNotesShort", "BO-1011100000-NOTECLASSIFICATION", "NoteClassification");
			fields[111] = new ims.framework.ReportField(this.context, "_cv_Clinical.CareContextWithHistory", "BO-1004100019-ID", "ID_CareContext");
			fields[112] = new ims.framework.ReportField(this.context, "_cv_Clinical.CareContextWithHistory", "BO-1004100019-CONTEXT", "Context");
			fields[113] = new ims.framework.ReportField(this.context, "_cv_Clinical.CareContextWithHistory", "BO-1004100019-STARTDATETIME", "StartDateTime");
			fields[114] = new ims.framework.ReportField(this.context, "_cv_Clinical.CareContextWithHistory", "BO-1004100019-ENDDATETIME", "EndDateTime");
			fields[115] = new ims.framework.ReportField(this.context, "_cv_Clinical.EpisodeOfCareWithHistory", "BO-1004100018-ID", "ID_EpisodeOfCare");
			fields[116] = new ims.framework.ReportField(this.context, "_cv_Clinical.EpisodeOfCareWithHistory", "BO-1004100018-SPECIALTY", "Specialty");
			fields[117] = new ims.framework.ReportField(this.context, "_cv_Clinical.EpisodeOfCareWithHistory", "BO-1004100018-STARTDATE", "StartDate");
			fields[118] = new ims.framework.ReportField(this.context, "_cv_Clinical.EpisodeOfCareWithHistory", "BO-1004100018-ENDDATE", "EndDate");
			fields[119] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientSummary.EpisodeOfCare", "BO-1004100018-ID", "ID_EpisodeOfCare");
			fields[120] = new ims.framework.ReportField(this.context, "_cv_Clinical.PatientSummary.ClinicalContact", "BO-1004100003-ID", "ID_ClinicalContact");
			...
			fields[122] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPatientProblemFromPatientSummary", "BO-1023100001-ID", "ID_PatientProblem");
			fields[123] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPatientDiagnosisFromPatientSummary", "BO-1003100016-ID", "ID_PatientDiagnosis");
			fields[124] = new ims.framework.ReportField(this.context, "_cv_Clinical.SelectedPatientProcedureFromPatientSummary", "BO-1003100017-ID", "ID_PatientProcedure");
			fields[125] = new ims.framework.ReportField(this.context, "_cv_ICP.Service", "BO-1003100032-ID", "ID_Service");
			fields[126] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientSummary.__internal_x_context__PreviousDiagnosisEpisodeOfCare_" + componentIdentifier, "BO-1004100018-ID", "ID_EpisodeOfCare");
			fields[127] = new ims.framework.ReportField(this.context, prefix + "_lv_Clinical.PatientSummary.__internal_x_context__PreviousProcedureEpisodeOfCare_" + componentIdentifier, "BO-1004100018-ID", "ID_EpisodeOfCare");
			return fields;
		}
