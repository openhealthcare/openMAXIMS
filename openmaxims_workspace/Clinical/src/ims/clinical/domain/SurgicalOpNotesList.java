...
public interface SurgicalOpNotesList extends ims.domain.DomainInterface
{
	// Generated from form domain interface definition
	public ims.core.vo.HcpLiteVoCollection listHcpLite(String nameFilter, ims.core.vo.lookups.HcpDisType hcpType);
