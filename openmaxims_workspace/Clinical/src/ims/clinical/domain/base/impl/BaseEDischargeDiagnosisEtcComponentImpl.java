...
public abstract class BaseEDischargeDiagnosisEtcComponentImpl extends DomainImpl implements ims.clinical.domain.EDischargeDiagnosisEtcComponent, ims.domain.impl.Transactional
{
	...
	@SuppressWarnings("unused")
	public void validatesaveDiagnosisVo(ims.core.vo.PatientDiagnosisEDischargeVo voDiagnosis, ims.edischarge.vo.SummaryRefVo summaryVo)
	{
	}
	...
	@SuppressWarnings("unused")
	public void validatesaveDischargeDetails(ims.clinical.vo.DischargeDetailsVo voDischargeDetails, ims.edischarge.vo.SummaryRefVo summaryVo)
	{
	}
	...
	@SuppressWarnings("unused")
	public void validatesave(ims.clinical.vo.DischargeDetailsVo dd, ims.core.vo.PatientDiagnosisEDischargeVoCollection diags, ims.edischarge.vo.SummaryRefVo summary)
	{
		if(dd == null)
	...
	@SuppressWarnings("unused")
	public void validaterieDiagnosis(ims.core.vo.PatientDiagnosisEDischargeListVo diag, ims.framework.FormName formName, Integer patientId, Integer contactId, Integer careContextId, String rieMessage, ims.edischarge.vo.SummaryRefVo summary)
	{
		if(diag == null)
