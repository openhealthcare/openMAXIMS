...
public abstract class BaseHospitalAtNightWorklistImpl extends DomainImpl implements ims.clinical.domain.HospitalAtNightWorklist, ims.domain.impl.Transactional
{
	...
	@SuppressWarnings("unused")
	public void validategetCurrentHospitalAtNightConfig(ims.framework.interfaces.ILocation currentHospital)
	{
	}

	@SuppressWarnings("unused")
	public void validateisSameStatus(ims.clinical.vo.HospitalAtNightPatientDetailRefVo hospitalAtNightPatientDetailsId, ims.clinical.vo.lookups.HospitalAtNightPatientStatus status)
	{
	}
}
