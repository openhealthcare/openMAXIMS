...
public abstract class BaseCataractIntraOperativeCareRecordImpl extends DomainImpl implements ims.clinical.domain.CataractIntraOperativeCareRecord, ims.domain.impl.Transactional
{
	...
	@SuppressWarnings("unused")
	public void validatesave(ims.clinical.vo.IntraOperativeCareRecordVo record)
	{
	}
	...
	@SuppressWarnings("unused")
	public void validatelistMedicationsForSpeciality(ims.core.vo.lookups.Specialty speciality)
	{
		if(speciality == null)
			throw new ims.domain.exceptions.DomainRuntimeException("The parameter 'speciality' of type 'ims.core.vo.lookups.Specialty' cannot be null.");
	}
