...
public interface FamilyHistory extends ims.domain.DomainInterface
{
	// Generated from form domain interface definition
	/**
	* get patients family history
	*/
	public ims.clinical.vo.FamilyHistoryVoCollection list(ims.core.vo.ClinicalContactShortVo voClinicalContact, ims.core.vo.PatientShort voPatientShort);
