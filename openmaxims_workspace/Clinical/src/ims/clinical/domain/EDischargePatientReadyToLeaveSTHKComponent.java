...
public interface EDischargePatientReadyToLeaveSTHKComponent extends ims.domain.DomainInterface
{
	...
	* saveFuturePlan
	*/
	public ims.clinical.vo.DischargeReadyToLeaveVo saveReadyToLeave(ims.clinical.vo.DischargeReadyToLeaveVo voReady, ims.edischarge.vo.SummaryRefVo voSummary) throws ims.domain.exceptions.DomainInterfaceException, ims.domain.exceptions.StaleObjectException;
	...
	*/
	...
	// Generated from form domain interface definition
	public ims.framework.utils.DateTime getAdmissionDateTimeFromAdmissionDetail(ims.core.admin.vo.CareContextRefVo ccRefVo, ims.core.patient.vo.PatientRefVo voPatRefVo);

	// Generated from form domain interface definition
	public ims.core.vo.DischargedEpisodeVo getDischargedEpisodeDetails(ims.core.admin.vo.CareContextRefVo ccRefVo, ims.core.patient.vo.PatientRefVo voPatRefVo);

	// Generated from form domain interface definition
	public ims.core.vo.GP getPatientsGP(ims.core.patient.vo.PatientRefVo patRefVo);

	// Generated from form domain interface definition
	public ims.clinical.vo.EDischargeSTHKSummaryVo getCurrentSummary(ims.core.admin.vo.CareContextRefVo ccRefVo);

	// Generated from form domain interface definition
	public String getDisplayStringAfterSave(ims.edischarge.vo.SummaryRefVo summaryId);
}
