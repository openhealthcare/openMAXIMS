...
public interface SurgicalAuditPreOperationChecks extends ims.domain.DomainInterface
{
	...
	// Generated from form domain interface definition
	public ims.clinical.vo.SurgicalAuditOperationDetailVo getSurgicalAuditOperationDetail(ims.clinical.vo.SurgicalAuditOperationDetailRefVo surgicalAuditOpDetRef);

	// Generated from form domain interface definition
	public Boolean areNoSurgicalAuditOperationDetail(ims.core.admin.vo.CareContextRefVo careContextRef);
	...
	// Generated from form domain interface definition
	public ims.core.vo.MedicVo getMedic(ims.core.resource.people.vo.HcpRefVo hcpRef);

	// Generated from form domain interface definition
	public ims.core.vo.LocationLiteVo getLocationLiteVo(ims.core.resource.place.vo.LocSiteRefVo locSiteRef);

	// Generated from form domain interface definition
	public ims.clinical.vo.SurgicalAuditPreOpChecksVo saveSurgicalAuditPreOpChecks(ims.clinical.vo.SurgicalAuditPreOpChecksVo surgAuditPreOpChecksToSave) throws ims.domain.exceptions.StaleObjectException;
