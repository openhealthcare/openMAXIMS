...
public interface PharmacyApprovalWorklist extends ims.domain.DomainInterface
{
	// Generated from form domain interface definition
	/**
	* Function used to search TTAMedicationAndPharmacy records matching search criteria
	*/
