...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_ICP.PatientICPRecord", "_cv_ICP.EvaluationNote" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_ICP.ICPEvaluationNotes.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/ICP/icp_evaluation_48.png";
	}
}
