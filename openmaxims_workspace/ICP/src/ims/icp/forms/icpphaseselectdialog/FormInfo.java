...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_ICP.PhaseForCloning" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_ICP.ICPPhaseSelectDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
