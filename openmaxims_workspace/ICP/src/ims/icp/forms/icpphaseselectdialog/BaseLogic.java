...
public abstract class BaseLogic extends Handlers
{
	...
	{
		return ims.icp.domain.ICPPhaseSelectDialog.class;
	}
	public final void setContext(ims.framework.UIEngine engine, GenForm form, ims.icp.domain.ICPPhaseSelectDialog domain)
	{
		setContext(engine, form);
		this.domain = domain;
	}
	protected final void bindgrdPhasesColStatusLookup()
	{
		this.form.grdPhases().ColStatusComboBox().clear();
		...
		{
			this.form.grdPhases().ColStatusComboBox().newRow(lookupCollection.get(x), lookupCollection.get(x).getText(), lookupCollection.get(x).getImage(), lookupCollection.get(x).getTextColor());
		}
	}
	...
	protected ims.icp.domain.ICPPhaseSelectDialog domain;
}
