...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_ICP.ProcedureID", "_cv_ICP.Service" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_ICP.ICPPatientSelect.__internal_x_context__" + String.valueOf(getFormId());
	}
