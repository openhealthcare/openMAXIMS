...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "PatientICPActionDetails";
	}
	public int getWidth()
	{
		return 1024;
	...
	{
		return "_lv_ICP.PatientICPActionDetails.__internal_x_context__" + String.valueOf(getFormId());
	}
	public ims.framework.FormInfo[] getComponentsFormInfo()
	{
		ims.framework.FormInfo[] componentsInfo = new ims.framework.FormInfo[1];
		componentsInfo[0] = new ims.icp.forms.patienticpactionlinkeddetailscomponent.FormInfo(118121);
