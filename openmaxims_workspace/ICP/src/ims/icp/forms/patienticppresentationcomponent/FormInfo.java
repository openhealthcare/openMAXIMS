...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "PatientICPPresentationComponent";
	}
	public int getWidth()
	{
		return 480;
	...
	{
		return new String[] { "_cv_ICP.PatientCriticalEvent", "_cv_ICP.EvaluationNote", "_cv_ICP.PatientICPRecord", "_cv_ICP.ActionStatus" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_ICP.PatientICPPresentationComponent.__internal_x_context__" + String.valueOf(getFormId());
	}
