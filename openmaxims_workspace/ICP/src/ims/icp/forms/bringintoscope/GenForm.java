...
public class GenForm extends FormBridge
{
	...
	public static class grdActionsRow extends GridRowBridge
	{
		...
		public grdActionsRow getParentRow()
		{
			return super.row.getParent() == null ? null : new grdActionsRow(super.row.getParent());
		}
		public grdActionsRowCollection getRows()
		{
			if(this.collection == null)
				this.collection = new grdActionsRowCollection(super.row.getRows());
			return this.collection;
		}
		private grdActionsRowCollection collection;
	}
	...
	public static class grdActionsGrid extends GridBridge
	{
		...
		public GenForm.grdActionsRow[] getAllRows()
		{
			java.util.ArrayList rows = new java.util.ArrayList();
			for(int x = 0; x < getRows().size(); x++)
			{
				GenForm.grdActionsRow row = getRows().get(x);
				rows.add(row);
				GenForm.grdActionsRow[] childRows = getAllRows(row);
				for(int i = 0; i < childRows.length; i++)
				{
					rows.add(childRows[i]);
				}
			}
			GenForm.grdActionsRow[] result = new GenForm.grdActionsRow[rows.size()];
			for(int x = 0; x < rows.size(); x++)
			{
				result[x] = (GenForm.grdActionsRow)rows.get(x);
			}
			return result;
		}
		public GenForm.grdActionsRow[] getAllRows(GenForm.grdActionsRow parentRow)
		{
			java.util.ArrayList rows = new java.util.ArrayList();
			for(int x = 0; x < parentRow.getRows().size(); x++)
			{
				GenForm.grdActionsRow row = parentRow.getRows().get(x);
				rows.add(row);
				GenForm.grdActionsRow[] childRows = getAllRows(row);
				for(int i = 0; i < childRows.length; i++)
				{
		...
		private void expandCollapseRow(GenForm.grdActionsRow parentRow, boolean expand)
		{
			for(int x = 0; x < parentRow.getRows().size(); x++)
			{
				GenForm.grdActionsRow row = parentRow.getRows().get(x);
		...
		public grdActionsRow getRowByValue(ims.vo.ValueObject value)
		{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		ims.framework.utils.SizeInfo designSize = new ims.framework.utils.SizeInfo(480, 472);
		if(runtimeSize == null)
		...
		// Button Controls
		RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 275, 440, 112, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), new Integer(-1), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Bring into scope", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 397, 440, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		// Grid Controls
		RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 464, 424, ims.framework.enumerations.ControlAnchoring.ALL);
		...
		grdActions.addTreeColumn("Stage / Phase / Action", 0, -1, false, true);
