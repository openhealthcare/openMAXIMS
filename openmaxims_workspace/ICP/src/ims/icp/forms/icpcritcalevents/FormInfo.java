...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_ICP.PatientICPRecord", "_cv_ICP.PatientCriticalEvent" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_ICP.ICPCritcalEvents.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/critical_events_48.png";
	}
}
