...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void bindgrdStagesColPhasesLookup();
	abstract protected void bindgrdStagesColStatusLookup();
	...
	abstract protected void onGrdStagesSelectionCleared() throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.grdStages().setSelectionChangedEvent(new GridSelectionChanged()
		{
			private static final long serialVersionUID = 1L;
		...
		this.form.grdStages().setSelectionClearedEvent(new SelectionCleared()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onGrdStagesSelectionCleared();
			}
		});
	}
	...
	{
		bindcmbStatusLookup();
		bindgrdStagesColPhasesLookup();
		bindgrdStagesColStatusLookup();
	}
