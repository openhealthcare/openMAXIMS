...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "PatientICPActionLinkedDetailsComponent";
	}
	public int getWidth()
	{
		return 808;
	...
	{
		return "_lv_ICP.PatientICPActionLinkedDetailsComponent.__internal_x_context__" + String.valueOf(getFormId());
	}
	public ims.framework.FormInfo[] getComponentsFormInfo()
	{
		...
		componentsInfo[2] = new ims.assessment.forms.graphicalassessment.FormInfo(127114);
		componentsInfo[3] = new ims.core.forms.assessmentasreport.FormInfo(102275);
