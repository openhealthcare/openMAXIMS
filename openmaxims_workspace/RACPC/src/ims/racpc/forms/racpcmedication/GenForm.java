...
public class GenForm extends FormBridge
{
	...
	public static class grdMedsRow extends GridRowBridge
	{
		...
		public void setcolMedReadOnly(boolean value)
		{
			super.row.setReadOnly(0, value);
		}
		public boolean iscolMedReadOnly()
		{
			return super.row.isReadOnly(0);
		}
		public void showcolMedOpened()
		{
			super.row.showOpened(0);
		}
		public ims.clinical.vo.lookups.RACPMedication getcolMed()
		{
			return (ims.clinical.vo.lookups.RACPMedication)super.row.get(0);
		}
		public void setcolMed(ims.clinical.vo.lookups.RACPMedication value)
		{
			super.row.set(0, value, true);
		}
		public void setCellcolMedTooltip(String value)
		{
		...
		public ims.clinical.vo.lookups.RACPMedicationStatus getcolStatus()
		{
			return (ims.clinical.vo.lookups.RACPMedicationStatus)super.row.get(1);
		}
		public void setcolStatus(ims.clinical.vo.lookups.RACPMedicationStatus value)
		{
	...
	public static class grdMedsGrid extends GridBridge
	{
		...
		public grdMedsRow getRowByValue(String value)
		{
			GridRow row = super.grid.getRowByValue(value);
			return row == null?null:new grdMedsRow(row);
		}
		public void setcolMedHeaderTooltip(String value)
		{
			super.grid.setColumnHeaderTooltip(0, value);
		}
		public String getcolMedHeaderTooltip()
		{
			return super.grid.getColumnHeaderTooltip(0);
		}
		public GridComboBox colMedComboBox()
		{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		// Label Controls
		RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 16, 392, 78, 17, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Other Drugs:", new Integer(1), null, new Integer(0)}));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		// TextBox Controls
		RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 16, 416, 816, 160, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
		...
		// Grid Controls
		RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 16, 16, 816, 368, ims.framework.enumerations.ControlAnchoring.ALL);
		...
		grdMeds.addComboBoxColumn("Drug", 0, 0, 700, false, true, false, false, true, -1);
		grdMeds.addComboBoxColumn("Status", 0, 0, -1, false, true, false, false, true, -1);
	...
	{
		return (grdMedsGrid)super.getGrid(0);
	}
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_RACPMedicationVo = new ims.framework.ContextVariable("RACPMedicationVo", prefix + "_lv_RACPC.RACPCMedication.__internal_x_context__RACPMedicationVo_" + componentIdentifier + "");
		}
		
		public boolean getRACPMedicationVoIsNotNull()
		{
			return !cxl_RACPMedicationVo.getValueIsNull(context);
		}
		public ims.clinical.vo.RACPMedicationVo getRACPMedicationVo()
		{
			return (ims.clinical.vo.RACPMedicationVo)cxl_RACPMedicationVo.getValue(context);
		}
		public void setRACPMedicationVo(ims.clinical.vo.RACPMedicationVo value)
		{
			cxl_RACPMedicationVo.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_RACPMedicationVo = null;
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[71] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCMedication.__internal_x_context__RACPMedicationVo_" + componentIdentifier, "BO-1072100079-ID", "ID_RACPMedication");
			fields[72] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCMedication.__internal_x_context__RACPMedicationVo_" + componentIdentifier, "BO-1072100079-MEDICATIONNOTES", "MedicationNotes");
			fields[73] = new ims.framework.ReportField(this.context, prefix + "_lv_RACPC.RACPCMedication.__internal_x_context__RACPMedicationVo_" + componentIdentifier, "BO-1072100079-CARECONTEXT", "CareContext");
			return fields;
		}
