...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "RACPCPrintSummaryDialog";
	}
	public int getWidth()
	{
		return 400;
	...
	{
		return new String[] { "_cv_RACPC.RACPCSummary" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RACPC.RACPCPrintSummaryDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
