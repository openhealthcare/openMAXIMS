...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "RACPCSummaryCompleteDate";
	}
	public int getWidth()
	{
		return 392;
	...
	{
		return new String[] { "_cv_RACPC.DateOfCompletion" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_RACPC.RACPCSummaryCompleteDate.__internal_x_context__" + String.valueOf(getFormId());
	}
