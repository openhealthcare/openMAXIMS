...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Emergency.SpecialInterestDetails", "_cv_Emergency.ADDEDITMode" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.SpecialInterestDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
