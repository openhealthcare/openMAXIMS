...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "EDPartialAdmissionDialog";
	}
	public int getWidth()
	{
		return 464;
	...
	{
		return new String[] { "_cv_Emergency.Tracking" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.EDPartialAdmissionDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
