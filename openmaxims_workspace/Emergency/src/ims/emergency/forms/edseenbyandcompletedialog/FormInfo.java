...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "EDSeenByAndCompleteDialog";
	}
	public int getWidth()
	{
		return 704;
	...
	{
		return new String[] { "_cv_Emergency.AttendanceClinicalNotes", "_cv_Emergency.Tracking", "_cv_Emergency.TrackingAttendanceStatus" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.EDSeenByAndCompleteDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
