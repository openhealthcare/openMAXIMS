...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "_lv_Emergency.DischargeDetails.__internal_x_context__" + String.valueOf(getFormId());
	}
	public ims.framework.FormInfo[] getComponentsFormInfo()
	{
		ims.framework.FormInfo[] componentsInfo = new ims.framework.FormInfo[2];
		componentsInfo[0] = new ims.emergency.forms.dischargedetails_advicetransport.FormInfo(129156);
		componentsInfo[1] = new ims.emergency.forms.dischargedetails_outcome.FormInfo(129157);
