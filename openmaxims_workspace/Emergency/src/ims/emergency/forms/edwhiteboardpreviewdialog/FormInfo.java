...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "EDWhiteBoardPreviewDialog";
	}
	public int getWidth()
	{
		return 970;
	...
	{
		return new String[] { "_cv_Emergency.WhiteBoardConfig" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.EDWhiteBoardPreviewDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
