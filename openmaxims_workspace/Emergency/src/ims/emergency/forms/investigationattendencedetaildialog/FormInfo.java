...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "InvestigationAttendenceDetailDialog";
	}
	public int getWidth()
	{
		return 496;
	...
	{
		return new String[] { "_cv_Emergency.InvestigationAttendenceDetail" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.InvestigationAttendenceDetailDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
