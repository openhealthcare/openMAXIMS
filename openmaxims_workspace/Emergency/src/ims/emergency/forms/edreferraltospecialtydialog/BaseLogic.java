...
public abstract class BaseLogic extends Handlers
{
	...
	{
		return ims.emergency.domain.EDReferralToSpecialtyDialog.class;
	}
	public final void setContext(ims.framework.UIEngine engine, GenForm form, ims.emergency.domain.EDReferralToSpecialtyDialog domain)
	{
	...
	protected final void oncmbConsultantTeamValueSet(Object value)
	{
		java.util.ArrayList listOfValues = this.form.cmbConsultantTeam().getValues();
		...
		else if(value instanceof ims.emergency.vo.lookups.ReferralSpecialtyConsultantOrTeam)
		{
			...
			this.form.cmbConsultantTeam().newRow(instance, instance.getText(), instance.getImage(), instance.getTextColor());
		}
	}
	protected final void bindcmbConsultantTeamLookup()
	{
		this.form.cmbConsultantTeam().clear();
		...
		for(int x = 0; x < lookupCollection.size(); x++)
		{
			this.form.cmbConsultantTeam().newRow(lookupCollection.get(x), lookupCollection.get(x).getText(), lookupCollection.get(x).getImage(), lookupCollection.get(x).getTextColor());
		}
	}
	protected final void setcmbConsultantTeamLookupValue(int id)
	{
		...
		if(instance != null)
			this.form.cmbConsultantTeam().setValue(instance);
	}
	protected final void defaultcmbConsultantTeamLookupValue()
	{
		this.form.cmbConsultantTeam().setValue((ims.emergency.vo.lookups.ReferralSpecialtyConsultantOrTeam)domain.getLookupService().getDefaultInstance(ims.emergency.vo.lookups.ReferralSpecialtyConsultantOrTeam.class, engine.getFormName().getID(), ims.emergency.vo.lookups.ReferralSpecialtyConsultantOrTeam.TYPE_ID));
	}
	...
	protected ims.emergency.domain.EDReferralToSpecialtyDialog domain;
}
