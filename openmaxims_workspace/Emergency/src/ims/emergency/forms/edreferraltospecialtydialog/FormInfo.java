...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "EDReferralToSpecialtyDialog";
	}
	public int getWidth()
	{
		return 704;
	...
	{
		return new String[] { "_cv_Emergency.Tracking", "_cv_Emergency.AttendanceClinicalNotes" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.EDReferralToSpecialtyDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
