...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "ManchesterTriageProtocolConfig";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Emergency.ManchesterTriageProtocol" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.ManchesterTriageProtocolConfig.__internal_x_context__" + String.valueOf(getFormId());
	}
