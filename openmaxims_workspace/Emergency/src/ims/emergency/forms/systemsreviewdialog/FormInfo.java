...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Emergency.SystemReview", "_cv_Emergency.AddEditForSystemsReviewDlg" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.SystemsReviewDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
