...
public abstract class BaseLogic extends Handlers implements IComponent
{
	...
	{
		return ims.emergency.domain.AttendanceNotesCc.class;
	}
	public final void setContext(ims.framework.UIComponentEngine engine, GenForm form, ims.emergency.domain.AttendanceNotesCc domain)
	{
	...
	{
		this.form.cmbNoteType().setValue((ims.emergency.vo.lookups.AttendanceClinicalNoteType)domain.getLookupService().getDefaultInstance(ims.emergency.vo.lookups.AttendanceClinicalNoteType.class, engine.getFormName().getID(), ims.emergency.vo.lookups.AttendanceClinicalNoteType.TYPE_ID));
	}
	...
	protected ims.emergency.domain.AttendanceNotesCc domain;
}
