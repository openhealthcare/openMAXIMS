...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.PatientPhotoTempFiles", "_cv_Core.PatientWoundAppDBImAndComment", "_cv_Core.PatientImage", "_cv_Core.ClinicalContact" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.WoundImagesCC.__internal_x_context__" + String.valueOf(getFormId());
	}
