...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.HideCancelButton", "_cv_Core.YesNoDialogMessage", "_cv_COE.SupportNetworkServiceCollection", "_cv_COE.SupportNetworkProfessionalCollection", "_cv_COE.SupportNetworkSelectedLocation", "_cv_Core.SupportNetworkPreviousCareContexts" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.SupportServices.__internal_x_context__" + String.valueOf(getFormId());
	}
