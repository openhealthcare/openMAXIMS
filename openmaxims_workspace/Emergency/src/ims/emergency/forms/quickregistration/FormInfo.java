...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Emergency.TrackingAreaForSendToAreaVo", "_cv_Emergency.SelectedPatient" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.QuickRegistration.__internal_x_context__" + String.valueOf(getFormId());
	}
