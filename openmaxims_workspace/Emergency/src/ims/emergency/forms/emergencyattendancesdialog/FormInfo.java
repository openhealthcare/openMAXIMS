...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "EmergencyAttendancesDialog";
	}
	public int getWidth()
	{
		return 896;
	...
	{
		return new String[] { "_cv_Core.ImsReportId", "_cv_Emergency.EmergencyEpisodeDetails" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.EmergencyAttendancesDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
