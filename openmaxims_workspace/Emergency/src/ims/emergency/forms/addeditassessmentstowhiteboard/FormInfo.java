...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "AddEditAssessmentsToWhiteboard";
	}
	public int getWidth()
	{
		return 392;
	...
	{
		return new String[] { "_cv_Emergency.WhiteBoardAssessmentConfig" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.AddEditAssessmentsToWhiteboard.__internal_x_context__" + String.valueOf(getFormId());
	}
