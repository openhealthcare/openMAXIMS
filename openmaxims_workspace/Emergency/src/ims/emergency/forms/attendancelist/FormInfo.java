...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Emergency.CurrentEmergencyAttendance" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.AttendanceList.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Emergency/clock_48.png";
	}
}
