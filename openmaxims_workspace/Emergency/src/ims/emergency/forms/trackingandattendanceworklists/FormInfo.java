...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "TrackingAndAttendanceWorklists";
	}
	public int getWidth()
	{
		return 896;
	...
	{
		return new String[] { "_cv_Emergency.Tracking", "_cv_Core.ImsReportId" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.TrackingAndAttendanceWorklists.__internal_x_context__" + String.valueOf(getFormId());
	}
