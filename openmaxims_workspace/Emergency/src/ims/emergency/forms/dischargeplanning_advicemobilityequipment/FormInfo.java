...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "DischargePlanning_AdviceMobilityEquipment";
	}
	public int getWidth()
	{
		return 672;
	...
	{
		return new String[] { "_cv_Admin.SelectedPrinter" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.DischargePlanning_AdviceMobilityEquipment.__internal_x_context__" + String.valueOf(getFormId());
	}
