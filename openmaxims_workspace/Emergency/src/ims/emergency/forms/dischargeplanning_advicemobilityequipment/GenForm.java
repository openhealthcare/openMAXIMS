...
public class GenForm extends FormBridge
{
	...
	public static class lyrAdviceMobilityLayer extends Layer
	{
		...
		public static class tabAdviceContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Label Controls
				RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 11, 319, 219, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				...
				// Button Controls
				RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 464, 304, 176, 23, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
				super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), new Integer(startTabIndex.intValue() + 3), ControlState.UNKNOWN, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, "Print Selected Advice Leaflets", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		
				// TextBox Controls
				RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 8, 336, 632, 120, ims.framework.enumerations.ControlAnchoring.ALL);
				...
				// Grid Controls
				RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 8, 16, 632, 280, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
				Grid m_grdAdviceLefletTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), new Integer(startTabIndex.intValue() + 1), ControlState.UNKNOWN, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.Emergency.contextMenuDischargeAdviceLeaflet, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
				...
				grdAdviceLeflet.addBoolColumn("Select", 1, 1, 150, false, true, 0, true);
				grdAdviceLeflet.addBoolColumn("Given", 1, 1, -1, true, false, 0, true);
		...
		public static class tabMobilityAndEquipmentContainer extends LayerBridge
		{
			...
			protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
			{
				...
				// Panel Controls
				RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 8, 292, 632, 172, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
				...
				RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 632, 160, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
				...
				RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 8, 176, 632, 112, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
				...
				// Label Controls
				RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 16, 245, 74, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Booking No:", new Integer(1), null, new Integer(0)}));
				RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 16, 221, 128, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Transport Date/Time:", new Integer(1), null, new Integer(0)}));
				RuntimeAnchoring anchoringHelper10 = new RuntimeAnchoring(designSize, runtimeSize, 16, 197, 36, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(anchoringHelper10.getX()), new Integer(anchoringHelper10.getY()), new Integer(anchoringHelper10.getWidth()), new Integer(anchoringHelper10.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Type:", new Integer(1), null, new Integer(0)}));
		
				// TextBox Controls
				RuntimeAnchoring anchoringHelper11 = new RuntimeAnchoring(designSize, runtimeSize, 152, 244, 472, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
				...
				// Date Time Controls
				RuntimeAnchoring anchoringHelper12 = new RuntimeAnchoring(designSize, runtimeSize, 152, 219, 176, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
				...
				// ComboBox Controls
				RuntimeAnchoring anchoringHelper13 = new RuntimeAnchoring(designSize, runtimeSize, 152, 196, 472, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
				...
				// Grid Controls
				RuntimeAnchoring anchoringHelper14 = new RuntimeAnchoring(designSize, runtimeSize, 16, 317, 616, 135, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
				...
				RuntimeAnchoring anchoringHelper15 = new RuntimeAnchoring(designSize, runtimeSize, 16, 33, 616, 119, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
				Grid m_grdMobilityTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.READONLY, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.FALSE, Boolean.FALSE, new Integer(24), Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
		...
		protected void setContext(Form form, ims.framework.interfaces.IAppForm appForm, Control control, FormLoader loader, ContextMenus contextMenus, Integer startControlID, ims.framework.utils.SizeInfo designSize, ims.framework.utils.SizeInfo runtimeSize, Integer startTabIndex, boolean skipContextValidation) throws Exception
		{
			...
			if(startTabIndex == null)
				throw new RuntimeException("Invalid startTabIndex");
			RuntimeAnchoring anchoringHelper16 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 656, 496, ims.framework.enumerations.ControlAnchoring.ALL);
			...
			ims.framework.utils.SizeInfo m_tabAdviceRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper16.getWidth(), anchoringHelper16.getHeight());
			...
			RuntimeAnchoring anchoringHelper17 = new RuntimeAnchoring(designSize, runtimeSize, 8, 8, 656, 496, ims.framework.enumerations.ControlAnchoring.ALL);
			...
			ims.framework.utils.SizeInfo m_tabMobilityAndEquipmentRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper17.getWidth(), anchoringHelper17.getHeight());
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		// Button Controls
		RuntimeAnchoring anchoringHelper18 = new RuntimeAnchoring(designSize, runtimeSize, 589, 512, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		RuntimeAnchoring anchoringHelper19 = new RuntimeAnchoring(designSize, runtimeSize, 512, 512, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		RuntimeAnchoring anchoringHelper20 = new RuntimeAnchoring(designSize, runtimeSize, 86, 512, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		RuntimeAnchoring anchoringHelper21 = new RuntimeAnchoring(designSize, runtimeSize, 8, 512, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1020), new Integer(anchoringHelper21.getX()), new Integer(anchoringHelper21.getY()), new Integer(anchoringHelper21.getWidth()), new Integer(anchoringHelper21.getHeight()), new Integer(startTabIndex.intValue() + 11), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "New", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[71] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.DischargePlanning_AdviceMobilityEquipment.__internal_x_context__CareContext_" + componentIdentifier, "BO-1004100019-ID", "ID_CareContext");
			fields[72] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.DischargePlanning_AdviceMobilityEquipment.__internal_x_context__MainProblem_" + componentIdentifier, "BO-1073100005-ID", "ID_ClinicalProblem");
			fields[73] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.DischargePlanning_AdviceMobilityEquipment.__internal_x_context__Record_" + componentIdentifier, "BO-1086100026-ID", "ID_DischargeServicesAndAdvice");
			fields[74] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.DischargePlanning_AdviceMobilityEquipment.__internal_x_context__Record_" + componentIdentifier, "BO-1086100026-PATIENT", "Patient");
			fields[75] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.DischargePlanning_AdviceMobilityEquipment.__internal_x_context__Record_" + componentIdentifier, "BO-1086100026-EPISODE", "Episode");
			fields[76] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.DischargePlanning_AdviceMobilityEquipment.__internal_x_context__Record_" + componentIdentifier, "BO-1086100026-ATTENDANCE", "Attendance");
			fields[77] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.DischargePlanning_AdviceMobilityEquipment.__internal_x_context__Record_" + componentIdentifier, "BO-1086100026-TRANSPORTARRANGEDTYPE", "TransportArrangedType");
			fields[78] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.DischargePlanning_AdviceMobilityEquipment.__internal_x_context__Record_" + componentIdentifier, "BO-1086100026-TRANSPORTDATETIME", "TransportDateTime");
			fields[79] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.DischargePlanning_AdviceMobilityEquipment.__internal_x_context__Record_" + componentIdentifier, "BO-1086100026-COMMENTS", "Comments");
			fields[80] = new ims.framework.ReportField(this.context, prefix + "_lv_Emergency.DischargePlanning_AdviceMobilityEquipment.__internal_x_context__Record_" + componentIdentifier, "BO-1086100026-BOOKINGNO", "BookingNo");
			return fields;
		}
