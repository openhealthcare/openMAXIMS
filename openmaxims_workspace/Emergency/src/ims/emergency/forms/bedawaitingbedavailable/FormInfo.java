...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "BedAwaitingBedAvailable";
	}
	public int getWidth()
	{
		return 494;
	...
	{
		return new String[] { "_cv_Emergency.Tracking", "_cv_Emergency.TrackingAttendanceStatus" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.BedAwaitingBedAvailable.__internal_x_context__" + String.valueOf(getFormId());
	}
