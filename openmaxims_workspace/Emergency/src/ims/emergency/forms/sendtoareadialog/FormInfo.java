...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Emergency.TrackingAreaForSendToAreaVo", "_cv_Emergency.Tracking" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.SendToAreaDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
