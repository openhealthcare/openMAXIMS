...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "DischargeDetails_Outcome";
	}
	public int getWidth()
	{
		return 520;
	...
	{
		return new String[] { "_cv_Emergency.ReasonForBreach", "_cv_Core.ImsReportId", "_cv_Emergency.TrackingAttendanceStatus" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.DischargeDetails_Outcome.__internal_x_context__" + String.valueOf(getFormId());
	}
