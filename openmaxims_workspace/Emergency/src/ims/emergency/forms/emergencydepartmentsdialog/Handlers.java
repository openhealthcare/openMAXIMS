...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void onGrdStatusGridCheckBoxClicked(int column, GenForm.grdDepartmentsRow row, boolean isChecked) throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.grdDepartments().setGridCheckBoxClickedEvent(new GridCheckBoxClicked()
		{
			private static final long serialVersionUID = 1L;
			...
			{
				onGrdStatusGridCheckBoxClicked(column, new GenForm.grdDepartmentsRow(row), isChecked);
			}
		});
	}
