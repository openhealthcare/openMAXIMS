...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "EmergencyDepartmentsDialog";
	}
	public int getWidth()
	{
		return 584;
	...
	{
		return new String[] { "_cv_Emergency.TrackingAreaCollection" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.EmergencyDepartmentsDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
