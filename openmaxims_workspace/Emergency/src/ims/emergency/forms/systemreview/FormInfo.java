...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Emergency.SystemReview", "_cv_Core.RieMessage", "_cv_Emergency.SystemReviewCollection", "_cv_Emergency.AddEditForSystemsReviewDlg" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.SystemReview.__internal_x_context__" + String.valueOf(getFormId());
	}
