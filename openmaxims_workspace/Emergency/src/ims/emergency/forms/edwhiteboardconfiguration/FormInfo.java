...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "EDWhiteboardConfiguration";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Emergency.WhiteBoardAssessmentConfig", "_cv_Emergency.WhiteBoardQuestionConfig", "_cv_Emergency.WhiteBoardConfig" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.EDWhiteboardConfiguration.__internal_x_context__" + String.valueOf(getFormId());
	}
