...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "TrackingAreaColumnConfigurationDialog";
	}
	public int getWidth()
	{
		return 520;
	...
	{
		return new String[] { "_cv_Emergency.TrackingAreaColumns", "_cv_Emergency.AreaColumn", "_cv_Emergency.TrackingAreaWorkspace" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.TrackingAreaColumnConfigurationDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
