...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "AttendanceRequiringContractingTaskSettings";
	}
	public int getWidth()
	{
		return 512;
	...
	{
		return new String[] { "_cv_Admin.CurrentJobConfiguration" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.AttendanceRequiringContractingTaskSettings.__internal_x_context__" + String.valueOf(getFormId());
	}
