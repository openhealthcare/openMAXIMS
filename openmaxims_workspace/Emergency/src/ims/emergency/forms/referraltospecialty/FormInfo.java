...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Emergency.ReferralToSpecialtyComments", "_cv_Emergency.Tracking" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.ReferralToSpecialty.__internal_x_context__" + String.valueOf(getFormId());
	}
