...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "AttendanceClinicalNoteDialog";
	}
	public int getWidth()
	{
		return 672;
	...
	{
		return new String[] { "_cv_Emergency.AttendanceClinicalNotes" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.AttendanceClinicalNoteDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
	public ims.framework.FormInfo[] getComponentsFormInfo()
	{
		ims.framework.FormInfo[] componentsInfo = new ims.framework.FormInfo[1];
		componentsInfo[0] = new ims.core.forms.authoringinfosingleline.FormInfo(102413);
