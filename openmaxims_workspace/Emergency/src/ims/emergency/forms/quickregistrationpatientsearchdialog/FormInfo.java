...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "QuickRegistrationPatientSearchDialog";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Emergency.SelectedPatient" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.QuickRegistrationPatientSearchDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
