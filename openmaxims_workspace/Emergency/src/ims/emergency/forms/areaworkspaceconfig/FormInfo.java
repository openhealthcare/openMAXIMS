...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Emergency.TrackingAreaColumns", "_cv_Emergency.TrackingAreaWorkspace" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.AreaWorkspaceConfig.__internal_x_context__" + String.valueOf(getFormId());
	}
