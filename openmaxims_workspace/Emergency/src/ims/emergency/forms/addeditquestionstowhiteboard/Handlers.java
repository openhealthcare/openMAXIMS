...
{
	abstract protected void bindcmbGenderLookup();
	abstract protected void defaultcmbGenderLookupValue();
	...
	abstract protected void oncmbGenderValueSet(Object value);
	abstract protected void onGrdAnswerOptionsSelectionChanged() throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.cmbGender().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				oncmbGenderValueSet(value);
			}
		});
		this.form.grdAnswerOptions().setSelectionChangedEvent(new GridSelectionChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.enumerations.MouseButton mouseButton) throws ims.framework.exceptions.PresentationLogicException
			{
				onGrdAnswerOptionsSelectionChanged();
			}
		});
