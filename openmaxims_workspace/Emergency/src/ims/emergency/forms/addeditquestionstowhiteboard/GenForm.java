...
public class GenForm extends FormBridge
{
	...
	public static class grdAnswerOptionsRow extends GridRowBridge
	{
		private static final long serialVersionUID = 1L;
		
		protected grdAnswerOptionsRow(GridRow row)
		{
			super(row);
		}
		...
		public ims.core.vo.AnswerOptionForEDWhiteboardConfigVo getValue()
		{
			return (ims.core.vo.AnswerOptionForEDWhiteboardConfigVo)super.row.getValue();
		}
		public void setValue(ims.core.vo.AnswerOptionForEDWhiteboardConfigVo value)
		{
			super.row.setValue(value);
		}
	}
	public static class grdAnswerOptionsRowCollection extends GridRowCollectionBridge
	{
		private static final long serialVersionUID = 1L;
		
		private grdAnswerOptionsRowCollection(GridRowCollection collection)
		{
			super(collection);
		}
		public grdAnswerOptionsRow get(int index)
		{
			return new grdAnswerOptionsRow(super.collection.get(index));
		}
		public grdAnswerOptionsRow newRow()
		{
			return new grdAnswerOptionsRow(super.collection.newRow());
		}
		public grdAnswerOptionsRow newRow(boolean autoSelect)
		{
			return new grdAnswerOptionsRow(super.collection.newRow(autoSelect));
		}
		public grdAnswerOptionsRow newRowAt(int index)
		{
			return new grdAnswerOptionsRow(super.collection.newRowAt(index));
		}
		public grdAnswerOptionsRow newRowAt(int index, boolean autoSelect)
		{
			return new grdAnswerOptionsRow(super.collection.newRowAt(index, autoSelect));
		}
	}
	public static class grdAnswerOptionsGrid extends GridBridge
	{
		private static final long serialVersionUID = 1L;
		...
		public ims.core.vo.AnswerOptionForEDWhiteboardConfigVoCollection getValues()
		{
			ims.core.vo.AnswerOptionForEDWhiteboardConfigVoCollection listOfValues = new ims.core.vo.AnswerOptionForEDWhiteboardConfigVoCollection();
		...
		public ims.core.vo.AnswerOptionForEDWhiteboardConfigVo getValue()
		{
			return (ims.core.vo.AnswerOptionForEDWhiteboardConfigVo)super.grid.getValue();
		}
		public void setValue(ims.core.vo.AnswerOptionForEDWhiteboardConfigVo value)
		{
			super.grid.setValue(value);
		}
		public grdAnswerOptionsRow getSelectedRow()
		{
			return super.grid.getSelectedRow() == null ? null : new grdAnswerOptionsRow(super.grid.getSelectedRow());
		}
		public int getSelectedRowIndex()
		{
			return super.grid.getSelectedRowIndex();
		}
		public grdAnswerOptionsRowCollection getRows()
		{
			return new grdAnswerOptionsRowCollection(super.grid.getRows());
		}
		public grdAnswerOptionsRow getRowByValue(ims.core.vo.AnswerOptionForEDWhiteboardConfigVo value)
		{
			GridRow row = super.grid.getRowByValue(value);
			return row == null?null:new grdAnswerOptionsRow(row);
		}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		ims.framework.utils.SizeInfo designSize = new ims.framework.utils.SizeInfo(808, 440);
		if(runtimeSize == null)
		...
		// Label Controls
		RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 8, 360, 97, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Gender Specific:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 208, 392, 36, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Years", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 8, 392, 69, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Age Range:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 616, 66, 89, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Column Width:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 8, 128, 98, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Answer Options:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 8, 98, 81, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1005), new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Answer Type:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 8, 66, 96, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1006), new Integer(anchoringHelper7.getX()), new Integer(anchoringHelper7.getY()), new Integer(anchoringHelper7.getWidth()), new Integer(anchoringHelper7.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Column Header:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 8, 16, 88, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Question Text:", new Integer(1), null, new Integer(0)}));

		// Button Controls
		RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 720, 408, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		RuntimeAnchoring anchoringHelper10 = new RuntimeAnchoring(designSize, runtimeSize, 640, 408, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		// TextBox Controls
		RuntimeAnchoring anchoringHelper11 = new RuntimeAnchoring(designSize, runtimeSize, 104, 64, 496, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper12 = new RuntimeAnchoring(designSize, runtimeSize, 104, 16, 696, 40, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// ComboBox Controls
		RuntimeAnchoring anchoringHelper13 = new RuntimeAnchoring(designSize, runtimeSize, 104, 360, 96, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper14 = new RuntimeAnchoring(designSize, runtimeSize, 104, 96, 280, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// Grid Controls
		RuntimeAnchoring anchoringHelper15 = new RuntimeAnchoring(designSize, runtimeSize, 8, 152, 792, 200, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		Grid m_grdAnswerOptionsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuGenericGrid, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
		addControl(m_grdAnswerOptionsTemp);
		grdAnswerOptionsGrid grdAnswerOptions = (grdAnswerOptionsGrid)GridFlyweightFactory.getInstance().createGridBridge(grdAnswerOptionsGrid.class, m_grdAnswerOptionsTemp);
		grdAnswerOptions.addStringColumn("Option Text", 0, 0, 400, false, false, 0, 200, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdAnswerOptions.addStringColumn("Option Description", 0, 0, -1, false, false, 0, 250, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		super.addGrid(grdAnswerOptions);

		// IntBox Controls
		RuntimeAnchoring anchoringHelper16 = new RuntimeAnchoring(designSize, runtimeSize, 704, 64, 96, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper17 = new RuntimeAnchoring(designSize, runtimeSize, 104, 392, 96, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
	...
	public TextBox txtColumnText()
	{
		return (TextBox)super.getControl(10);
	}
	public TextBox txtQuestionText()
	{
		return (TextBox)super.getControl(11);
	}
	public cmbGenderComboBox cmbGender()
	{
		return (cmbGenderComboBox)super.getComboBox(0);
	}
	public cmbAnswerTypeComboBox cmbAnswerType()
	{
		return (cmbAnswerTypeComboBox)super.getComboBox(1);
	}
	public grdAnswerOptionsGrid grdAnswerOptions()
	{
		return (grdAnswerOptionsGrid)super.getGrid(0);
	}
	public IntBox intColumnWidth()
	{
		return (IntBox)super.getControl(15);
	}
	public IntRangeBox irbAgeRange()
	{
		return (IntRangeBox)super.getControl(16);
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[71] = new ims.framework.ReportField(this.context, "_cv_Emergency.WhiteBoardQuestionConfig", "BO-1087100020-ID", "ID_WhiteBoardQuestionConfig");
			fields[72] = new ims.framework.ReportField(this.context, "_cv_Emergency.WhiteBoardQuestionConfig", "BO-1087100020-QUESTIONTEXT", "QuestionText");
			fields[73] = new ims.framework.ReportField(this.context, "_cv_Emergency.WhiteBoardQuestionConfig", "BO-1087100020-COLUMNHEADERTEXT", "ColumnHeaderText");
			fields[74] = new ims.framework.ReportField(this.context, "_cv_Emergency.WhiteBoardQuestionConfig", "BO-1087100020-ANSWERTYPE", "AnswerType");
			fields[75] = new ims.framework.ReportField(this.context, "_cv_Emergency.WhiteBoardQuestionConfig", "BO-1087100020-COLUMNWIDTH", "ColumnWidth");
			fields[76] = new ims.framework.ReportField(this.context, "_cv_Emergency.WhiteBoardQuestionConfig", "BO-1087100020-GENDERSPECIFIC", "GenderSpecific");
			fields[77] = new ims.framework.ReportField(this.context, "_cv_Emergency.WhiteBoardQuestionConfig", "BO-1087100020-AGERANGEMIN", "AgeRangeMin");
			fields[78] = new ims.framework.ReportField(this.context, "_cv_Emergency.WhiteBoardQuestionConfig", "BO-1087100020-AGERANGEMAX", "AgeRangeMax");
			return fields;
		}
