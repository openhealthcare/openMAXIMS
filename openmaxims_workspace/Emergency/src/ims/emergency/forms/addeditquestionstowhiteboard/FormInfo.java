...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "AddEditQuestionsToWhiteboard";
	}
	public int getWidth()
	{
		return 808;
	...
	{
		return new String[] { "_cv_Emergency.WhiteBoardQuestionConfig" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.AddEditQuestionsToWhiteboard.__internal_x_context__" + String.valueOf(getFormId());
	}
