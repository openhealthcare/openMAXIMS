...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "TrackingAreaColumnPreview";
	}
	public int getWidth()
	{
		return 1008;
	...
	{
		return new String[] { "_cv_Emergency.TrackingAreaColumns" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.TrackingAreaColumnPreview.__internal_x_context__" + String.valueOf(getFormId());
	}
