...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "CopyAreaWorkspaceConfig";
	}
	public int getWidth()
	{
		return 488;
	...
	{
		return new String[] { "_cv_Emergency.EDLocation", "_cv_Emergency.TrackingAreaColumns" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.CopyAreaWorkspaceConfig.__internal_x_context__" + String.valueOf(getFormId());
	}
