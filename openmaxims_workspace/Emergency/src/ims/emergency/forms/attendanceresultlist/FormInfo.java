...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_OCRR.ResultDisplayDate", "_cv_OCRR.SelectedPathRadResults", "_cv_OCRR.CurrentPathRadResult", "_cv_OCRR.OrderAwaitingAuthorisation", "_cv_OCRR.PathologyResults.Order", "_cv_OCRR.LastUpdatedPathRadResult" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.AttendanceResultList.__internal_x_context__" + String.valueOf(getFormId());
	}
