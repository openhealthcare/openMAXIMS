...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "InterventionsTreatments";
	}
	public int getWidth()
	{
		return 672;
	...
	{
		return new String[] { "_cv_Emergency.InterventionsTreatmentsForAttendence" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.InterventionsTreatments.__internal_x_context__" + String.valueOf(getFormId());
	}
