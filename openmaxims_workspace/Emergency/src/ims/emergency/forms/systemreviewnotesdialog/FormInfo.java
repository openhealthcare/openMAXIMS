...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "SystemReviewNotesDialog";
	}
	public int getWidth()
	{
		return 1032;
	...
	{
		return new String[] { "_cv_Emergency.SystemReviewCollection" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.SystemReviewNotesDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
	public ims.framework.FormInfo[] getComponentsFormInfo()
	{
		ims.framework.FormInfo[] componentsInfo = new ims.framework.FormInfo[1];
		componentsInfo[0] = new ims.emergency.forms.systemsreviewcc.FormInfo(129198);
