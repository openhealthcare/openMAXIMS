...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "TriageProtocolAssessment";
	}
	public int getWidth()
	{
		return 688;
	...
	{
		return new String[] { "_cv_Emergency.TriageProtocolAssessment", "_cv_Emergency.MainPresentingProblem", "_cv_Emergency.Triage" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.TriageProtocolAssessment.__internal_x_context__" + String.valueOf(getFormId());
	}
