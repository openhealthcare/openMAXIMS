...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Emergency.TriageNote", "_cv_Core.RieMessage" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.TriageNotesCc.__internal_x_context__" + String.valueOf(getFormId());
	}
