...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "EDDecisionToAdmitDialog";
	}
	public int getWidth()
	{
		return 600;
	...
	{
		return new String[] { "_cv_Emergency.TrackingAttendanceStatus", "_cv_Emergency.Tracking" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.EDDecisionToAdmitDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
