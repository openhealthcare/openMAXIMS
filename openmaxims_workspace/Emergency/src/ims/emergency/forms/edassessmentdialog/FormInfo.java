...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Emergency.NewTriageComponentOpenForm" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.EDAssessmentDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
