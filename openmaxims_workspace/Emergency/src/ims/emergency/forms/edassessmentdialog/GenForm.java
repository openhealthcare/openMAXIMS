...
public class GenForm extends FormBridge
{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		ims.framework.utils.SizeInfo designSize = new ims.framework.utils.SizeInfo(1180, 800);
		if(runtimeSize == null)
		...
		RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 0, 4, 1176, 792, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		ims.framework.FormUiLogic m_ccNewTriageccForm = loader.loadComponent(129183, appForm, startControlID * 10 + 1000, anchoringHelper1.getSize(), instance1, -1, skipContextValidation);
		//ims.framework.Control m_ccNewTriageccControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(0), new Integer(4), new Integer(1176), new Integer(792), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(-1), m_ccNewTriageccForm, instance1 } );
		ims.framework.Control m_ccNewTriageccControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001),  new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, new Integer(-1), m_ccNewTriageccForm, instance1, Boolean.FALSE } );
		super.addControl(m_ccNewTriageccControl);
		Menu[] menus1 = m_ccNewTriageccForm.getForm().getRegisteredMenus();
		...
		// Button Controls
		RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 232, 768, 128, 23, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
	...
	public ims.emergency.forms.edassessmentcomponent.IComponent ccNewTriagecc()
	{
	...
	public void setccNewTriageccValueChangedEvent(ims.framework.delegates.ValueChanged delegate)
	{
		((CustomComponent)super.getControl(0)).setValueChangedEvent(delegate);
	}
	public void setccNewTriageccVisible(boolean value)
	{
		((ims.framework.Control)super.getControl(0)).setVisible(value);
	}
	public boolean isccNewTriageccVisible()
	{
		return ((ims.framework.Control)super.getControl(0)).isVisible();
	}
	public void setccNewTriageccEnabled(boolean value)
	{
		((ims.framework.Control)super.getControl(0)).setEnabled(value);
	}
	public boolean isccNewTriageccEnabled()
	{
