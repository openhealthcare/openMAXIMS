...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void onDyngrdDepartmentsCellValueChanged(ims.framework.controls.DynamicGridCell cell);
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.dyngrdDepartments().setDynamicGridCellValueChangedEvent(new DynamicGridCellValueChanged()
		{
			private static final long serialVersionUID = 1L;
			...
			{
				onDyngrdDepartmentsCellValueChanged(cell);
			}
		});
