...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "ReferralToSpecialtyCommentsDialog";
	}
	public int getWidth()
	{
		return 496;
	...
	{
		return new String[] { "_cv_Emergency.ReferralToSpecialtyComments" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.ReferralToSpecialtyCommentsDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
