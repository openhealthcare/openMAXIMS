...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "AttendanceKPIConfiguration";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Emergency.TriageKPI" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Emergency.AttendanceKPIConfiguration.__internal_x_context__" + String.valueOf(getFormId());
	}
