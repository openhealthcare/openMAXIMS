...
import ims.emergency.domain.base.impl.BaseReferralToSpecialtyImpl;
...
public class ReferralToSpecialtyImpl extends BaseReferralToSpecialtyImpl
{
	...
	public ReferralToSpecialtyTeamVo save(ReferralToSpecialtyTeamVo referralToSpecialty, TrackingForReferalToSpecialtyVo trackingToSave) throws StaleObjectException
	{
		...
		{
			if (!referralToSpecialty.isValidated())
				throw new DomainRuntimeException("AllocatedMedicVo Not Validated.");
