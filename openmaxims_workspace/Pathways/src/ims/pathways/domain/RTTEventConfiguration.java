...
public interface RTTEventConfiguration extends ims.domain.DomainInterface
{
	// Generated from form domain interface definition
	/**
	* saveSurgeryDetails
	*/
	public ims.pathways.vo.RTTEventVo saveRTTEvent(ims.pathways.vo.RTTEventVo rtteventVo) throws ims.domain.exceptions.StaleObjectException, ims.domain.exceptions.UniqueKeyViolationException;
