...
public class GenForm extends FormBridge
{
	...
	public static class ctnSearchContainer extends ContainerBridge
	{
		private static final long serialVersionUID = 1L;
	...
	public static class cmbProviderSysSearchComboBox extends ComboBoxBridge
	{
		private static final long serialVersionUID = 1L;
	...
	public static class cmbSpecSearchComboBox extends ComboBoxBridge
	{
		private static final long serialVersionUID = 1L;
	...
	public static class cmbDetailSearchComboBox extends ComboBoxBridge
	{
		private static final long serialVersionUID = 1L;
	...
	public static class cmbGroupSearchComboBox extends ComboBoxBridge
	{
		private static final long serialVersionUID = 1L;
	...
	public static class qmbConsultantSearchComboBox extends ComboBoxBridge
	{
		private static final long serialVersionUID = 1L;
	...
	public static class grdGroupsRow extends GridRowBridge
	{
		...
		public void setColConsReadOnly(boolean value)
		{
			super.row.setReadOnly(5, value);
		}
		public boolean isColConsReadOnly()
		{
			return super.row.isReadOnly(5);
		}
		public void showColConsOpened()
		{
			super.row.showOpened(5);
		}
		public String getColCons()
		{
			return (String)super.row.get(5);
		}
		public void setColCons(String value)
		{
			super.row.set(5, value);
		}
		public void setCellColConsTooltip(String value)
		{
	...
	public static class grdGroupsGrid extends GridBridge
	{
		...
		public grdGroupsRow getRowByValue(ims.pathways.vo.ExternalEventMappingVo value)
		{
		...
		public void setColConsHeaderTooltip(String value)
		{
			super.grid.setColumnHeaderTooltip(5, value);
		}
		public String getColConsHeaderTooltip()
		{
			return super.grid.getColumnHeaderTooltip(5);
		}
	}
	public static class grdGroupSearchRow extends GridRowBridge
	{
		private static final long serialVersionUID = 1L;
		
		protected grdGroupSearchRow(GridRow row)
		{
			super(row);
		}
		public void showOpened(int column)
	...
	public static class grdGroupSearchRowCollection extends GridRowCollectionBridge
	{
		private static final long serialVersionUID = 1L;
		
		private grdGroupSearchRowCollection(GridRowCollection collection)
		{
			super(collection);
		}
		public grdGroupSearchRow get(int index)
		{
			return new grdGroupSearchRow(super.collection.get(index));
		}
		public grdGroupSearchRow newRow()
		{
			return new grdGroupSearchRow(super.collection.newRow());
		}
		public grdGroupSearchRow newRow(boolean autoSelect)
		{
			return new grdGroupSearchRow(super.collection.newRow(autoSelect));
		}
		public grdGroupSearchRow newRowAt(int index)
		{
			return new grdGroupSearchRow(super.collection.newRowAt(index));
		}
		public grdGroupSearchRow newRowAt(int index, boolean autoSelect)
		{
			return new grdGroupSearchRow(super.collection.newRowAt(index, autoSelect));
		}
	}
	public static class grdGroupSearchGrid extends GridBridge
	{
		private static final long serialVersionUID = 1L;
		...
		public grdGroupSearchRow getSelectedRow()
		{
			return super.grid.getSelectedRow() == null ? null : new grdGroupSearchRow(super.grid.getSelectedRow());
		}
		public int getSelectedRowIndex()
		{
			return super.grid.getSelectedRowIndex();
		}
		public grdGroupSearchRowCollection getRows()
		{
			return new grdGroupSearchRowCollection(super.grid.getRows());
		}
		public grdGroupSearchRow getRowByValue(ims.pathways.vo.ExternalEventMappingVo value)
		{
			GridRow row = super.grid.getRowByValue(value);
			return row == null?null:new grdGroupSearchRow(row);
		}
		public void setColGroupHeaderTooltip(String value)
		{
			super.grid.setColumnHeaderTooltip(0, value);
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		// Container Clasess
		RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 8, 0, 832, 344, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		Container m_ctnSearch = (Container)factory.getControl(Container.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, null, new Boolean(false)});
		addControl(m_ctnSearch);
		ctnSearchContainer ctnSearch = (ctnSearchContainer)ContainerBridgeFlyweightFactory.getInstance().createContainerBridge(ctnSearchContainer.class, m_ctnSearch, factory);
		ims.framework.utils.SizeInfo m_ctnSearchDesignSize = new ims.framework.utils.SizeInfo(832, 344);
		ims.framework.utils.SizeInfo m_ctnSearchRuntimeSize = new ims.framework.utils.SizeInfo(anchoringHelper1.getWidth(), anchoringHelper1.getHeight());
		ctnSearch.setContext(form, appForm, m_ctnSearch, loader, this.getImages(), contextMenus, startControlID, m_ctnSearchDesignSize, m_ctnSearchRuntimeSize, startTabIndex, skipContextValidation);
		super.addContainer(ctnSearch);

		// Label Controls
		RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 392, 66, 101, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Provider System:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 24, 42, 42, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Detail:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 392, 42, 70, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Consultant:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 392, 18, 71, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Clinic Code:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 24, 18, 43, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1005), new Integer(anchoringHelper6.getX()), new Integer(anchoringHelper6.getY()), new Integer(anchoringHelper6.getWidth()), new Integer(anchoringHelper6.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Group:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 24, 66, 60, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1006), new Integer(anchoringHelper7.getX()), new Integer(anchoringHelper7.getY()), new Integer(anchoringHelper7.getWidth()), new Integer(anchoringHelper7.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Specialty:", new Integer(1), null, new Integer(0)}));

		// Button Controls
		RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 760, 312, 75, 23, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 96, 312, 75, 23, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper10 = new RuntimeAnchoring(designSize, runtimeSize, 16, 312, 75, 23, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 15), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "OK", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		// TextBox Controls
		RuntimeAnchoring anchoringHelper13 = new RuntimeAnchoring(designSize, runtimeSize, 504, 16, 248, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// ComboBox Controls
		RuntimeAnchoring anchoringHelper14 = new RuntimeAnchoring(designSize, runtimeSize, 504, 64, 248, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		ComboBox m_cmbProviderSysSearchTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1013), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.ENABLED, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		addControl(m_cmbProviderSysSearchTemp);
		cmbProviderSysSearchComboBox cmbProviderSysSearch = (cmbProviderSysSearchComboBox)ComboBoxFlyweightFactory.getInstance().createComboBoxBridge(cmbProviderSysSearchComboBox.class, m_cmbProviderSysSearchTemp);
		super.addComboBox(cmbProviderSysSearch);
		RuntimeAnchoring anchoringHelper15 = new RuntimeAnchoring(designSize, runtimeSize, 96, 64, 280, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		ComboBox m_cmbSpecSearchTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1014), new Integer(anchoringHelper15.getX()), new Integer(anchoringHelper15.getY()), new Integer(anchoringHelper15.getWidth()), new Integer(anchoringHelper15.getHeight()), new Integer(startTabIndex.intValue() + 3), ControlState.ENABLED, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		addControl(m_cmbSpecSearchTemp);
		cmbSpecSearchComboBox cmbSpecSearch = (cmbSpecSearchComboBox)ComboBoxFlyweightFactory.getInstance().createComboBoxBridge(cmbSpecSearchComboBox.class, m_cmbSpecSearchTemp);
		super.addComboBox(cmbSpecSearch);
		RuntimeAnchoring anchoringHelper16 = new RuntimeAnchoring(designSize, runtimeSize, 96, 40, 280, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		ComboBox m_cmbDetailSearchTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1015), new Integer(anchoringHelper16.getX()), new Integer(anchoringHelper16.getY()), new Integer(anchoringHelper16.getWidth()), new Integer(anchoringHelper16.getHeight()), new Integer(startTabIndex.intValue() + 2), ControlState.ENABLED, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		addControl(m_cmbDetailSearchTemp);
		cmbDetailSearchComboBox cmbDetailSearch = (cmbDetailSearchComboBox)ComboBoxFlyweightFactory.getInstance().createComboBoxBridge(cmbDetailSearchComboBox.class, m_cmbDetailSearchTemp);
		super.addComboBox(cmbDetailSearch);
		RuntimeAnchoring anchoringHelper17 = new RuntimeAnchoring(designSize, runtimeSize, 96, 16, 280, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		ComboBox m_cmbGroupSearchTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1016), new Integer(anchoringHelper17.getX()), new Integer(anchoringHelper17.getY()), new Integer(anchoringHelper17.getWidth()), new Integer(anchoringHelper17.getHeight()), new Integer(startTabIndex.intValue() + 1), ControlState.ENABLED, ControlState.DISABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		addControl(m_cmbGroupSearchTemp);
		cmbGroupSearchComboBox cmbGroupSearch = (cmbGroupSearchComboBox)ComboBoxFlyweightFactory.getInstance().createComboBoxBridge(cmbGroupSearchComboBox.class, m_cmbGroupSearchTemp);
		super.addComboBox(cmbGroupSearch);

		// Query ComboBox Controls
		RuntimeAnchoring anchoringHelper18 = new RuntimeAnchoring(designSize, runtimeSize, 504, 40, 248, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		ComboBox m_qmbConsultantSearchTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1017), new Integer(anchoringHelper18.getX()), new Integer(anchoringHelper18.getY()), new Integer(anchoringHelper18.getWidth()), new Integer(anchoringHelper18.getHeight()), new Integer(startTabIndex.intValue() + 5), ControlState.ENABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFT,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.TRUE, new Integer(1), null, Boolean.FALSE, new Integer(-1), Boolean.FALSE});
		addControl(m_qmbConsultantSearchTemp);
		qmbConsultantSearchComboBox qmbConsultantSearch = (qmbConsultantSearchComboBox)ComboBoxFlyweightFactory.getInstance().createComboBoxBridge(qmbConsultantSearchComboBox.class, m_qmbConsultantSearchTemp);
		super.addComboBox(qmbConsultantSearch);

		// Grid Controls
		RuntimeAnchoring anchoringHelper19 = new RuntimeAnchoring(designSize, runtimeSize, 16, 352, 816, 232, ims.framework.enumerations.ControlAnchoring.ALL);
		Grid m_grdGroupsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1018), new Integer(anchoringHelper19.getX()), new Integer(anchoringHelper19.getY()), new Integer(anchoringHelper19.getWidth()), new Integer(anchoringHelper19.getHeight()), new Integer(startTabIndex.intValue() + 13), ControlState.READONLY, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuGenericGrid, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.TRUE, Boolean.TRUE});
		...
		grdGroups.addStringColumn("Group", 0, 0, 150, true, false, 2, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdGroups.addStringColumn("Detail", 0, 0, 120, true, false, 2, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdGroups.addStringColumn("Specialty", 0, 0, 120, true, false, 2, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdGroups.addStringColumn("Provider System", 0, 0, 120, true, false, 2, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdGroups.addStringColumn("Clinic Code", 0, 0, 120, true, false, 2, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdGroups.addStringColumn("Consultant", 0, 0, 120, true, false, 2, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		super.addGrid(grdGroups);
		RuntimeAnchoring anchoringHelper20 = new RuntimeAnchoring(designSize, runtimeSize, 16, 104, 816, 200, ims.framework.enumerations.ControlAnchoring.ALL);
		Grid m_grdGroupSearchTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), new Integer(startTabIndex.intValue() + 9), ControlState.EDITABLE, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.FALSE, Boolean.FALSE, new Integer(24), Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.TRUE, Boolean.TRUE});
		addControl(m_grdGroupSearchTemp);
		grdGroupSearchGrid grdGroupSearch = (grdGroupSearchGrid)GridFlyweightFactory.getInstance().createGridBridge(grdGroupSearchGrid.class, m_grdGroupSearchTemp);
		grdGroupSearch.addStringColumn("Group", 0, 0, 150, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdGroupSearch.addStringColumn("Detail", 0, 0, 120, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdGroupSearch.addStringColumn("Specialty", 0, 0, 120, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdGroupSearch.addStringColumn("Provider System", 0, 0, 120, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdGroupSearch.addStringColumn("Clinic Code", 0, 0, 120, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdGroupSearch.addStringColumn("Consultant", 0, 0, 120, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdGroupSearch.addBoolColumn("Select", 0, 0, -1, false, false, 0, true);
		super.addGrid(grdGroupSearch);

		// Image Buttons Controls
		RuntimeAnchoring anchoringHelper21 = new RuntimeAnchoring(designSize, runtimeSize, 806, 12, 30, 30, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		RuntimeAnchoring anchoringHelper22 = new RuntimeAnchoring(designSize, runtimeSize, 772, 12, 30, 30, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
	...
	public ctnSearchContainer ctnSearch()
	{
		return (ctnSearchContainer)super.getContainer(0);
	}
	...
	public TextBox txtClinicCodeSearch()
	{
		return (TextBox)super.getControl(12);
	}
	public cmbProviderSysSearchComboBox cmbProviderSysSearch()
	{
		return (cmbProviderSysSearchComboBox)super.getComboBox(0);
	}
	public cmbSpecSearchComboBox cmbSpecSearch()
	{
		return (cmbSpecSearchComboBox)super.getComboBox(1);
	}
	public cmbDetailSearchComboBox cmbDetailSearch()
	{
		return (cmbDetailSearchComboBox)super.getComboBox(2);
	}
	public cmbGroupSearchComboBox cmbGroupSearch()
	{
		return (cmbGroupSearchComboBox)super.getComboBox(3);
	}
	public qmbConsultantSearchComboBox qmbConsultantSearch()
	{
		return (qmbConsultantSearchComboBox)super.getComboBox(4);
	}
	public grdGroupsGrid grdGroups()
	{
		return (grdGroupsGrid)super.getGrid(0);
	}
	public grdGroupSearchGrid grdGroupSearch()
	{
		return (grdGroupSearchGrid)super.getGrid(1);
	}
