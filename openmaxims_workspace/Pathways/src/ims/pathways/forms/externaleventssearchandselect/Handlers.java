...
{
	abstract protected void bindcmbSpecSearchLookup();
	abstract protected void defaultcmbSpecSearchLookupValue();
	abstract protected void bindcmbDetailSearchLookup();
	abstract protected void defaultcmbDetailSearchLookupValue();
	abstract protected void bindcmbGroupSearchLookup();
	abstract protected void defaultcmbGroupSearchLookupValue();
	...
	abstract protected void onQmbConsultantSearchTextSubmited(String value) throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onImbClearClick() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onImbSearchClick() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void oncmbSpecSearchValueSet(Object value);
	abstract protected void oncmbDetailSearchValueSet(Object value);
	abstract protected void oncmbGroupSearchValueSet(Object value);
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.grdGroups().setSelectionChangedEvent(new GridSelectionChanged()
		{
			private static final long serialVersionUID = 1L;
		...
		this.form.qmbConsultantSearch().setSearchEvent(new ComboBoxSearch()
		{
			private static final long serialVersionUID = 1L;
			public void handle(String value) throws ims.framework.exceptions.PresentationLogicException
			{
				onQmbConsultantSearchTextSubmited(value);
			}
		});
		...
		this.form.cmbSpecSearch().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				oncmbSpecSearchValueSet(value);
			}
		});
		this.form.cmbDetailSearch().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				oncmbDetailSearchValueSet(value);
			}
		});
		this.form.cmbGroupSearch().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				oncmbGroupSearchValueSet(value);
			}
		});
	...
	{
		defaultcmbSpecSearchLookupValue();
		defaultcmbDetailSearchLookupValue();
		defaultcmbGroupSearchLookupValue();
	}
