...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Pathways.PatientJourneyComments" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Pathways.PatientJourneyComments.__internal_x_context__" + String.valueOf(getFormId());
	}
