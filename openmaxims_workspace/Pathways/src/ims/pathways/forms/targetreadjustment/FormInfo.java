...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Pathways.TargetReadjustments", "_cv_Pathways.TargetReadjustmentsAction" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Pathways.TargetReadjustment.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Pathways/target_48.png";
	}
}
