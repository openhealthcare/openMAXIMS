...
public class GenForm extends FormBridge
{
	...
	public static class grdEventsRow extends GridRowBridge
	{
		...
		public void setColEventTypeReadOnly(boolean value)
		{
			super.row.setReadOnly(2, value);
		}
		public boolean isColEventTypeReadOnly()
		{
			return super.row.isReadOnly(2);
		}
		public void showColEventTypeOpened()
		{
			super.row.showOpened(2);
		}
		public ims.pathways.vo.lookups.EventCreationType getColEventType()
		{
			return (ims.pathways.vo.lookups.EventCreationType)super.row.get(2);
		}
		public void setColEventType(ims.pathways.vo.lookups.EventCreationType value)
		{
			super.row.set(2, value, true);
		}
		public void setCellColEventTypeTooltip(String value)
		{
		...
		{
			return (ims.pathways.vo.EventLiteVo)super.row.getValue();
		}
	...
	public static class grdEventsGrid extends GridBridge
	{
		...
		public ims.pathways.vo.EventLiteVoCollection getValues()
		{
			ims.pathways.vo.EventLiteVoCollection listOfValues = new ims.pathways.vo.EventLiteVoCollection();
		...
		public ims.pathways.vo.EventLiteVo getValue()
		{
			return (ims.pathways.vo.EventLiteVo)super.grid.getValue();
		}
		public void setValue(ims.pathways.vo.EventLiteVo value)
		{
		...
		public grdEventsRow getRowByValue(ims.pathways.vo.EventLiteVo value)
		{
		...
		public void setColEventTypeHeaderTooltip(String value)
		{
			super.grid.setColumnHeaderTooltip(2, value);
		}
		public String getColEventTypeHeaderTooltip()
		{
			return super.grid.getColumnHeaderTooltip(2);
		}
		public GridComboBox ColEventTypeComboBox()
		{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1003), new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));

		// TextBox Controls
		RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 88, 16, 344, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(anchoringHelper5.getX()), new Integer(anchoringHelper5.getY()), new Integer(anchoringHelper5.getWidth()), new Integer(anchoringHelper5.getHeight()), new Integer(startTabIndex.intValue() + 1), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.FALSE, new Integer(255), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));

		// ComboBox Controls
		RuntimeAnchoring anchoringHelper6 = new RuntimeAnchoring(designSize, runtimeSize, 512, 16, 240, 21, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		...
		// Grid Controls
		RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 16, 64, 816, 520, ims.framework.enumerations.ControlAnchoring.ALL);
		...
		grdEvents.addStringColumn("Event Name", 0, 0, 200, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdEvents.addStringColumn("Event Description", 0, 0, 380, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdEvents.addComboBoxColumn("Event Type", 0, 0, 100, true, true, false, false, true, -1);
		grdEvents.addImageColumn("Icon", 0, 1, 70, true, 0);
		grdEvents.addComboBoxColumn("Status", 0, 0, -1, true, true, false, false, true, -1);
		super.addGrid(grdEvents);

		// Image Buttons Controls
		RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 802, 12, 30, 30, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, this.getImages().Core.ClearEnabled24, this.getImages().Core.ClearDisabled24, "Clear", Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
	...
	public TextBox txtEventNameSearch()
	{
		return (TextBox)super.getControl(4);
	}
	public cmbStatusSearchComboBox cmbStatusSearch()
	{
		return (cmbStatusSearchComboBox)super.getComboBox(0);
	}
	...
	public static class Forms implements java.io.Serializable
	{
		...
		public final class PathwaysForms implements java.io.Serializable
		{
			...
			{
				EventConfiguration = new LocalFormName(132104);
			}
			public final FormName EventConfiguration;
		}
