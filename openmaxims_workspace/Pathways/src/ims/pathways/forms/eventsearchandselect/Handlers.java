...
{
	abstract protected void bindgrdEventsColEventTypeLookup();
	abstract protected void bindgrdEventsColStatusLookup();
	...
	abstract protected void onBtnNewEventClick() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onBtnEditEventClick() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onGrdEventsSelectionChanged() throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.btnNewEvent().setClickEvent(new Click()
		{
			private static final long serialVersionUID = 1L;
		...
		this.form.btnEditEvent().setClickEvent(new Click()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
		...
		this.form.grdEvents().setSelectionChangedEvent(new GridSelectionChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.enumerations.MouseButton mouseButton) throws ims.framework.exceptions.PresentationLogicException
			{
				onGrdEventsSelectionChanged();
			}
		});
	...
	{
		bindgrdEventsColEventTypeLookup();
		bindgrdEventsColStatusLookup();
