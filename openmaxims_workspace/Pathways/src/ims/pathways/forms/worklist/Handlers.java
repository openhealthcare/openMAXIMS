...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode, ims.framework.interfaces.IClearInfo
{
	...
	abstract protected void bindgrdTargetsColBreachStatusLookup();
	...
	abstract protected void onGrdPathwaysGridCheckBoxClicked(int column, GenForm.grdPathwaysRow row, boolean isChecked) throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.grdPathways().setGridCheckBoxClickedEvent(new GridCheckBoxClicked()
		{
			private static final long serialVersionUID = 1L;
			...
			{
				onGrdPathwaysGridCheckBoxClicked(column, new GenForm.grdPathwaysRow(row), isChecked);
			}
		});
		...
		this.form.getContextMenus().Pathways.getWorkListJourneyTargetNEW_EVENTItem().setClickEvent(new ims.framework.delegates.MenuItemClick()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.Control sender) throws ims.framework.exceptions.PresentationLogicException
			{
				onContextMenuItemClick(GenForm.ContextMenus.PathwaysNamespace.WorkListJourneyTarget.NEW_EVENT, sender);
			}
		});
		this.form.getContextMenus().Pathways.getWorkListJourneyTargetVIEW_PAT_JOURNEYItem().setClickEvent(new ims.framework.delegates.MenuItemClick()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.Control sender) throws ims.framework.exceptions.PresentationLogicException
			{
				onContextMenuItemClick(GenForm.ContextMenus.PathwaysNamespace.WorkListJourneyTarget.VIEW_PAT_JOURNEY, sender);
			}
		});
		this.form.getContextMenus().Pathways.getWokListPathwayTargetADDTARGETItem().setClickEvent(new ims.framework.delegates.MenuItemClick()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.Control sender) throws ims.framework.exceptions.PresentationLogicException
			{
				onContextMenuItemClick(GenForm.ContextMenus.PathwaysNamespace.WokListPathwayTarget.ADDTARGET, sender);
			}
		});
		this.form.getContextMenus().Pathways.getWokListPathwayTargetREMOVETARGETItem().setClickEvent(new ims.framework.delegates.MenuItemClick()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.Control sender) throws ims.framework.exceptions.PresentationLogicException
			{
				onContextMenuItemClick(GenForm.ContextMenus.PathwaysNamespace.WokListPathwayTarget.REMOVETARGET, sender);
			}
		});
	}
	protected void bindLookups()
	{
		bindgrdTargetsColBreachStatusLookup();
	}
