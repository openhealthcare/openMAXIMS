...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Pathways.SelectedPatientPathwayJourney" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Pathways.PatientJourneyClock.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Pathways/patient_journey_clock_48.png";
	}
}
