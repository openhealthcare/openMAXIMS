...
public class GenForm extends FormBridge
{
	...
	public static class grdDetailsRow extends GridRowBridge
	{
		...
		public ims.core.vo.lookups.Specialty getColSpecialty()
		{
			return (ims.core.vo.lookups.Specialty)super.row.get(2);
		}
		public void setColSpecialty(ims.core.vo.lookups.Specialty value)
		{
		...
		public String getColWeeks()
		{
			return (String)super.row.get(6);
		}
		public void setColWeeks(String value)
		{
		...
		public ims.pathways.vo.PathwayShortVo getValue()
		{
			return (ims.pathways.vo.PathwayShortVo)super.row.getValue();
		}
		public void setValue(ims.pathways.vo.PathwayShortVo value)
		{
	...
	public static class grdDetailsGrid extends GridBridge
	{
		...
		public ims.pathways.vo.PathwayShortVoCollection getValues()
		{
			ims.pathways.vo.PathwayShortVoCollection listOfValues = new ims.pathways.vo.PathwayShortVoCollection();
		...
		public ims.pathways.vo.PathwayShortVo getValue()
		{
			return (ims.pathways.vo.PathwayShortVo)super.grid.getValue();
		}
		public void setValue(ims.pathways.vo.PathwayShortVo value)
		{
		...
		public grdDetailsRow getRowByValue(ims.pathways.vo.PathwayShortVo value)
		{
		...
		public GridComboBox ColSpecialtyComboBox()
		{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		contextMenus.Pathways.contextMenuPathwaySearchAndSelect = factory.createMenu(startControlID.intValue() + 1);
		contextMenus.Pathways.contextMenuPathwaySearchAndSelectNEWItem = factory.createMenuItem(startControlID.intValue() + 1, "New", true, false, new Integer(102179), true, false);
		contextMenus.Pathways.contextMenuPathwaySearchAndSelect.add(contextMenus.Pathways.contextMenuPathwaySearchAndSelectNEWItem);
		contextMenus.Pathways.contextMenuPathwaySearchAndSelectEDITItem = factory.createMenuItem(startControlID.intValue() + 2, "Edit", true, false, new Integer(102150), true, false);
		contextMenus.Pathways.contextMenuPathwaySearchAndSelect.add(contextMenus.Pathways.contextMenuPathwaySearchAndSelectEDITItem);
		contextMenus.Pathways.contextMenuPathwaySearchAndSelectVIEWItem = factory.createMenuItem(startControlID.intValue() + 3, "View", true, false, new Integer(102223), false, false);
		contextMenus.Pathways.contextMenuPathwaySearchAndSelect.add(contextMenus.Pathways.contextMenuPathwaySearchAndSelectVIEWItem);
		contextMenus.Pathways.contextMenuPathwaySearchAndSelectCOPYItem = factory.createMenuItem(startControlID.intValue() + 4, "Create a New Pathway based on <pname>", true, false, new Integer(102179), true, false);
		contextMenus.Pathways.contextMenuPathwaySearchAndSelect.add(contextMenus.Pathways.contextMenuPathwaySearchAndSelectCOPYItem);
		form.registerMenu(contextMenus.Pathways.contextMenuPathwaySearchAndSelect);


		// Custom Controls
		ims.framework.CustomComponent instance1 = factory.getEmptyCustomComponent();
		RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 512, 16, 256, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		ims.framework.FormUiLogic m_customControlMosForm = loader.loadComponent(102256, appForm, startControlID * 10 + 1000, anchoringHelper1.getSize(), instance1, startTabIndex.intValue() + 5, skipContextValidation);
		//ims.framework.Control m_customControlMosControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(512), new Integer(16), new Integer(256), new Integer(20), ControlState.ENABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 5), m_customControlMosForm, instance1 } );
		ims.framework.Control m_customControlMosControl = factory.getControl(CustomComponent.class, new Object[] { control, new Integer(startControlID.intValue() + 1001),  new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.ENABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT, new Integer(startTabIndex.intValue() + 5), m_customControlMosForm, instance1, Boolean.FALSE } );
		...
		// Label Controls
		RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 432, 16, 70, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 432, 40, 45, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1004), new Integer(anchoringHelper4.getX()), new Integer(anchoringHelper4.getY()), new Integer(anchoringHelper4.getWidth()), new Integer(anchoringHelper4.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Status:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 16, 16, 41, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 96, 592, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		...
		// TextBox Controls
		RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 88, 16, 320, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// ComboBox Controls
		RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 512, 40, 240, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		ComboBox m_cmbSearchStatusTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1009), new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), new Integer(startTabIndex.intValue() + 1007), ControlState.ENABLED, ControlState.ENABLED,ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT ,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.FALSE, new Integer(1), null, Boolean.FALSE, new Integer(-1)});
		...
		RuntimeAnchoring anchoringHelper10 = new RuntimeAnchoring(designSize, runtimeSize, 88, 40, 320, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		Grid m_grdDetailsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 1013), ControlState.READONLY, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.Pathways.contextMenuPathwaySearchAndSelect, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.TRUE, Boolean.TRUE});
		...
		grdDetails.addStringColumn("Pathway Name", 0, 0, 150, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdDetails.addWrapTextColumn("Pathway Description", 0, 0, 200, true, false, 0, true);
		grdDetails.addComboBoxColumn("Specialty", 0, 0, 100, true, true, false, false, true, -1);
		grdDetails.addStringColumn("Consultant", 0, 0, 100, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdDetails.addComboBoxColumn("Status", 0, 0, 100, true, true, false, false, true, -1);
		grdDetails.addBoolColumn("Default", 0, 0, 50, true, false, 1, true);
		grdDetails.addStringColumn("No. of Weeks\\Days", 0, 0, -1, true, false, 1, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		super.addGrid(grdDetails);

		// Image Buttons Controls
		RuntimeAnchoring anchoringHelper12 = new RuntimeAnchoring(designSize, runtimeSize, 802, 12, 30, 30, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
		super.addControl(factory.getControl(ImageButton.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 1011), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPRIGHT, this.getImages().Core.ClearEnabled24, this.getImages().Core.ClearDisabled24, "Clear", Boolean.FALSE, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null}));
		RuntimeAnchoring anchoringHelper13 = new RuntimeAnchoring(designSize, runtimeSize, 768, 12, 30, 30, ims.framework.enumerations.ControlAnchoring.TOPRIGHT);
	...
	public static class Forms implements java.io.Serializable
	{
		...
		public final class PathwaysForms implements java.io.Serializable
		{
			...
			{
				PathwayConfiguration = new LocalFormName(132101);
			}
			public final FormName PathwayConfiguration;
		}
	...
	public final class ContextMenus implements java.io.Serializable
	{
		...
		{
			private static final long serialVersionUID = 1L;
			public final class PathwaySearchAndSelect implements java.io.Serializable
			{
				private static final long serialVersionUID = 1L;
			...
			public void disableAllPathwaySearchAndSelectMenuItems()
			{
				this.contextMenuPathwaySearchAndSelectNEWItem.setEnabled(false);
				this.contextMenuPathwaySearchAndSelectEDITItem.setEnabled(false);
				this.contextMenuPathwaySearchAndSelectVIEWItem.setEnabled(false);
				this.contextMenuPathwaySearchAndSelectCOPYItem.setEnabled(false);
			}
			public void hideAllPathwaySearchAndSelectMenuItems()
			{
				this.contextMenuPathwaySearchAndSelectNEWItem.setVisible(false);
				this.contextMenuPathwaySearchAndSelectEDITItem.setVisible(false);
				this.contextMenuPathwaySearchAndSelectVIEWItem.setVisible(false);
				this.contextMenuPathwaySearchAndSelectCOPYItem.setVisible(false);
			}
			private Menu contextMenuPathwaySearchAndSelect;
			public ReadOnlyMenuItem getPathwaySearchAndSelectNEWItem()
			{
				return this.contextMenuPathwaySearchAndSelectNEWItem;
			}
			private MenuItem contextMenuPathwaySearchAndSelectNEWItem;
			public ReadOnlyMenuItem getPathwaySearchAndSelectEDITItem()
			{
				return this.contextMenuPathwaySearchAndSelectEDITItem;
			}
			private MenuItem contextMenuPathwaySearchAndSelectEDITItem;
			public ReadOnlyMenuItem getPathwaySearchAndSelectVIEWItem()
			{
				return this.contextMenuPathwaySearchAndSelectVIEWItem;
			}
			private MenuItem contextMenuPathwaySearchAndSelectVIEWItem;
			public MenuItem getPathwaySearchAndSelectCOPYItem()
			{
				return this.contextMenuPathwaySearchAndSelectCOPYItem;
			}
			private MenuItem contextMenuPathwaySearchAndSelectCOPYItem;
		}
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[71] = new ims.framework.ReportField(this.context, "_cv_Pathways.SelectedPathway", "BO-1089100002-ID", "ID_Pathway");
			fields[72] = new ims.framework.ReportField(this.context, "_cv_Pathways.PathwayToCopy", "BO-1089100002-ID", "ID_Pathway");
			return fields;
		}
