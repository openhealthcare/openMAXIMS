...
{
	abstract protected void bindcmbActionSearchLookup();
	abstract protected void defaultcmbActionSearchLookupValue();
	abstract protected void bindcmbActionLookup();
	abstract protected void defaultcmbActionLookupValue();
	abstract protected void onFormOpen(Object[] args) throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void oncmbActionSearchValueSet(Object value);
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.cmbActionSearch().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				oncmbActionSearchValueSet(value);
			}
		});
		...
		this.form.ctnDetails().cmbAction().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
	...
	{
		defaultcmbActionSearchLookupValue();
