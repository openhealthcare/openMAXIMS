...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "RTTStatusPointSelectDialog";
	}
	public int getWidth()
	{
		return 648;
	...
	{
		return new String[] { "_cv_Pathways.FollowingRTTStatusPoints" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Pathways.RTTStatusPointSelectDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
