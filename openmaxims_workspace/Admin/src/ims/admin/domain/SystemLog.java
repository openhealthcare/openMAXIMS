...
public interface SystemLog extends ims.domain.DomainInterface
{
	...
	// Generated from form domain interface definition
	/**
	* Gets the entries based on session Id
	*/
	public ims.admin.vo.SystemLogVoCollection getEntries(String sessionId);

	// Generated from form domain interface definition
	public ims.admin.vo.SystemLogVo getEntry(Integer eventId);
}
