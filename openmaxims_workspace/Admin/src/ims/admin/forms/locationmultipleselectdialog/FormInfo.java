...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "LocationMultipleSelectDialog";
	}
	public int getWidth()
	{
		return 560;
	...
	{
		return new String[] { "_cv_CareUk.ContractServiceLocationsConfig", "_cv_CareUk.LocationContract" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Admin.LocationMultipleSelectDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
