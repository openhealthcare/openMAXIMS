...
public abstract class BaseLogic extends Handlers implements IComponent
{
	...
	{
		return ims.admin.domain.TaxonomyMappings.class;
	}
	public final void setContext(ims.framework.UIComponentEngine engine, GenForm form, ims.admin.domain.TaxonomyMappings domain)
	{
	...
	protected ims.admin.domain.TaxonomyMappings domain;
}
