...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void onGrdMappingsGridButtonClicked(int column, GenForm.grdMappingsRow row) throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIComponentEngine engine, GenForm form)
	{
		...
		this.form.grdMappings().setGridButtonClickedEvent(new GridButtonClicked()
		{
			private static final long serialVersionUID = 1L;
			...
			{
				onGrdMappingsGridButtonClicked(column, new GenForm.grdMappingsRow(row));
			}
		});
