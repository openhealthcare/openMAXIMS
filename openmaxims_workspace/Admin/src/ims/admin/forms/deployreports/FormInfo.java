...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_PasswordEntered", "_cv_Core.YesNoDialogMessage", "_cv_Admin.ReportsModifiedSinceLastDeployment" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Admin.DeployReports.__internal_x_context__" + String.valueOf(getFormId());
	}
	public ims.framework.FormInfo[] getComponentsFormInfo()
	{
		ims.framework.FormInfo[] componentsInfo = new ims.framework.FormInfo[1];
		componentsInfo[0] = new ims.admin.forms.searchreport.FormInfo(102405);
		return componentsInfo;
	}
	public String getImagePath()
	{
		return "Images/Admin/reports_clock_48.png";
	}
}
