...
public final class ConfigFlags extends ims.framework.FormConfigFlags implements Serializable
{
	...
	public final ALLOW_CLINIC_EDITClass ALLOW_CLINIC_EDIT;
	...
	public ConfigFlags(ims.framework.ConfigFlag configFlags)
	{
		...
		ALLOW_CLINIC_EDIT = new ALLOW_CLINIC_EDITClass(configFlags);
	}
	...
	public final class ALLOW_CLINIC_EDITClass implements Serializable
	{
		private static final long serialVersionUID = 1L;
		private final ims.framework.ConfigFlag configFlags;

		public ALLOW_CLINIC_EDITClass(ims.framework.ConfigFlag configFlags)
		{
			this.configFlags = configFlags;
		}
		...
		{
			return (Boolean)configFlags.get("ALLOW_CLINIC_EDIT");
		}
	}
}
