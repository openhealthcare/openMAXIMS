...
public abstract class BaseLogic extends Handlers implements IComponent
{
	...
	{
		return ims.admin.domain.SearchReport.class;
	}
	public final void setContext(ims.framework.UIComponentEngine engine, GenForm form, ims.admin.domain.SearchReport domain)
	{
	...
	protected ims.admin.domain.SearchReport domain;
}
