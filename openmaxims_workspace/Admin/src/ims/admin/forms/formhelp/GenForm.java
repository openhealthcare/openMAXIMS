...
public class GenForm extends FormBridge
{
	...
	public static class grdDetailsRow extends GridRowBridge
	{
		...
		public void setCellurlTooltip(String value)
		{
	...
	public static class grdDetailsGrid extends GridBridge
	{
		...
		public grdDetailsRow getRowByValue(ims.admin.vo.AppFormVo value)
		{
		...
		public void seturlHeaderTooltip(String value)
		{
			super.grid.setColumnHeaderTooltip(1, value);
		}
		public String geturlHeaderTooltip()
		{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		// Panel Controls
		RuntimeAnchoring anchoringHelper1 = new RuntimeAnchoring(designSize, runtimeSize, 16, 488, 816, 96, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
		super.addControl(factory.getControl(Panel.class, new Object[] { control, new Integer(startControlID.intValue() + 1000), new Integer(anchoringHelper1.getX()), new Integer(anchoringHelper1.getY()), new Integer(anchoringHelper1.getWidth()), new Integer(anchoringHelper1.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT,"Details", new Integer(2), ""}));

		// Label Controls
		RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 32, 552, 61, 17, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.ENABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Help URL:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 32, 520, 74, 17, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), ControlState.ENABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Form Name:", new Integer(1), null, new Integer(0)}));
		...
		RuntimeAnchoring anchoringHelper5 = new RuntimeAnchoring(designSize, runtimeSize, 104, 592, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT);
		...
		// TextBox Controls
		RuntimeAnchoring anchoringHelper8 = new RuntimeAnchoring(designSize, runtimeSize, 120, 552, 696, 21, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), new Integer(startTabIndex.intValue() + 4), ControlState.DISABLED, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT,Boolean.FALSE, new Integer(200), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.TRUE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));

		// Query ComboBox Controls
		RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 120, 520, 696, 21, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT);
		ComboBox m_qmbFormTemp = (ComboBox)factory.getControl(ComboBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1008), new Integer(anchoringHelper9.getX()), new Integer(anchoringHelper9.getY()), new Integer(anchoringHelper9.getWidth()), new Integer(anchoringHelper9.getHeight()), new Integer(startTabIndex.intValue() + 3), ControlState.DISABLED, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFTRIGHT,Boolean.TRUE, Boolean.FALSE, SortOrder.NONE, Boolean.TRUE, new Integer(3), null, Boolean.TRUE, new Integer(-1), Boolean.FALSE});
		...
		// Grid Controls
		RuntimeAnchoring anchoringHelper10 = new RuntimeAnchoring(designSize, runtimeSize, 16, 16, 816, 456, ims.framework.enumerations.ControlAnchoring.ALL);
		...
		grdDetails.addStringColumn("Form Name", 0, 0, 250, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdDetails.addStringColumn("Help URL", 0, 0, -1, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_CurrentForm = new ims.framework.ContextVariable("CurrentForm", prefix + "_lv_Admin.FormHelp.__internal_x_context__CurrentForm_" + componentIdentifier + "");
		}
		
		public boolean getCurrentFormIsNotNull()
		{
			return !cxl_CurrentForm.getValueIsNull(context);
		}
		public ims.admin.vo.AppFormVo getCurrentForm()
		{
			return (ims.admin.vo.AppFormVo)cxl_CurrentForm.getValue(context);
		}
		public void setCurrentForm(ims.admin.vo.AppFormVo value)
		{
			cxl_CurrentForm.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_CurrentForm = null;
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[71] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.FormHelp.__internal_x_context__CurrentForm_" + componentIdentifier, "BO-1021100001-ID", "ID_AppForm");
			fields[72] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.FormHelp.__internal_x_context__CurrentForm_" + componentIdentifier, "BO-1021100001-NAME", "Name");
			fields[73] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.FormHelp.__internal_x_context__CurrentForm_" + componentIdentifier, "BO-1021100001-ALIASNAME", "AliasName");
			fields[74] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.FormHelp.__internal_x_context__CurrentForm_" + componentIdentifier, "BO-1021100001-CAPTION", "Caption");
			fields[75] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.FormHelp.__internal_x_context__CurrentForm_" + componentIdentifier, "BO-1021100001-ISDIALOG", "IsDialog");
			fields[76] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.FormHelp.__internal_x_context__CurrentForm_" + componentIdentifier, "BO-1021100001-ISALIAS", "IsAlias");
			fields[77] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.FormHelp.__internal_x_context__CurrentForm_" + componentIdentifier, "BO-1021100001-ISCOMPONENT", "IsComponent");
			fields[78] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.FormHelp.__internal_x_context__CurrentForm_" + componentIdentifier, "BO-1021100001-DESCRIPTION", "Description");
			fields[79] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.FormHelp.__internal_x_context__CurrentForm_" + componentIdentifier, "BO-1021100001-CANBEINNAVIGATION", "CanBeInNavigation");
			fields[80] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.FormHelp.__internal_x_context__CurrentForm_" + componentIdentifier, "BO-1021100001-CANBEINTOPBUTTONS", "CanBeInTopButtons");
			fields[81] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.FormHelp.__internal_x_context__CurrentForm_" + componentIdentifier, "BO-1021100001-LOGICCLASS", "LogicClass");
			fields[82] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.FormHelp.__internal_x_context__CurrentForm_" + componentIdentifier, "BO-1021100001-ACCESSCLASS", "AccessClass");
			fields[83] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.FormHelp.__internal_x_context__CurrentForm_" + componentIdentifier, "BO-1021100001-DOMAINCLASS", "DomainImpl");
			fields[84] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.FormHelp.__internal_x_context__CurrentForm_" + componentIdentifier, "BO-1021100001-HELPLINK", "HelpLink");
			fields[85] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.FormHelp.__internal_x_context__CurrentForm_" + componentIdentifier, "BO-1021100001-RIEBOCLASSNAME", "RieBoClassName");
			fields[86] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.FormHelp.__internal_x_context__CurrentForm_" + componentIdentifier, "BO-1021100001-ISSYSTEM", "IsSystem");
			fields[87] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.FormHelp.__internal_x_context__CurrentForm_" + componentIdentifier, "BO-1021100001-INFORMATIONBARVISIBLE", "InformationBarVisible");
			return fields;
		}
