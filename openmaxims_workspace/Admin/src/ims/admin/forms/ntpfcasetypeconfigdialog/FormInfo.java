...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "NTPFCaseTypeConfigDialog";
	}
	public int getWidth()
	{
		return 456;
	...
	{
		return new String[] { "_cv_NTPF.CaseTypes" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Admin.NTPFCaseTypeConfigDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
