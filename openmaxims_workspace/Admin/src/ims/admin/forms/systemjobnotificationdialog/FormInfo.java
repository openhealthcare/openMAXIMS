...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "SystemJobNotificationDialog";
	}
	public int getWidth()
	{
		return 632;
	...
	{
		return new String[] { "_cv_Admin.SystemJobNotification" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Admin.SystemJobNotificationDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
