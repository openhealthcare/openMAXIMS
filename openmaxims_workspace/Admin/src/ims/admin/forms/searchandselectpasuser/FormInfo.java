...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Admin.HeartsUser" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Admin.SearchAndSelectPASUser.__internal_x_context__" + String.valueOf(getFormId());
	}
