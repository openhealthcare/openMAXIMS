...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "DeployReportsConfirmation";
	}
	public int getWidth()
	{
		return 928;
	...
	{
		return new String[] { "_cv_Admin.ReportsModifiedSinceLastDeployment" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Admin.DeployReportsConfirmation.__internal_x_context__" + String.valueOf(getFormId());
	}
