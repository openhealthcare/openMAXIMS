...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "ServiceMultipleSelectDialog";
	}
	public int getWidth()
	{
		return 560;
	...
	{
		return new String[] { "_cv_CareUk.ContractServiceLocationsConfig", "_cv_CareUk.ServiceContrat" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Admin.ServiceMultipleSelectDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
