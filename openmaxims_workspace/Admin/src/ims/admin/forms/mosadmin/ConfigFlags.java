...
public final class ConfigFlags extends ims.framework.FormConfigFlags implements Serializable
{
	...
	public final ALLOW_CONS_PAS_ID_UPDATEClass ALLOW_CONS_PAS_ID_UPDATE;
	...
	public ConfigFlags(ims.framework.ConfigFlag configFlags)
	{
		...
		ALLOW_CONS_PAS_ID_UPDATE = new ALLOW_CONS_PAS_ID_UPDATEClass(configFlags);
	}
	...
	public final class ALLOW_CONS_PAS_ID_UPDATEClass implements Serializable
	{
		private static final long serialVersionUID = 1L;
		private final ims.framework.ConfigFlag configFlags;

		public ALLOW_CONS_PAS_ID_UPDATEClass(ims.framework.ConfigFlag configFlags)
		{
			this.configFlags = configFlags;
		}
		...
		public Boolean getValue()
		{
			return (Boolean)configFlags.get("ALLOW_CONS_PAS_ID_UPDATE");
		}
	}
}
