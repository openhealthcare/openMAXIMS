...
public class GenForm extends FormBridge
{
	...
	public static class grdMappingsRow extends GridRowBridge
	{
		...
		public ims.core.vo.NonUniqueTaxonomyMapVo getValue()
		{
			return (ims.core.vo.NonUniqueTaxonomyMapVo)super.row.getValue();
		}
		public void setValue(ims.core.vo.NonUniqueTaxonomyMapVo value)
		{
	...
	public static class grdMappingsGrid extends GridBridge
	{
		...
		public ims.core.vo.NonUniqueTaxonomyMapVoCollection getValues()
		{
			ims.core.vo.NonUniqueTaxonomyMapVoCollection listOfValues = new ims.core.vo.NonUniqueTaxonomyMapVoCollection();
		...
		public ims.core.vo.NonUniqueTaxonomyMapVo getValue()
		{
			return (ims.core.vo.NonUniqueTaxonomyMapVo)super.grid.getValue();
		}
		public void setValue(ims.core.vo.NonUniqueTaxonomyMapVo value)
		{
		...
		public grdMappingsRow getRowByValue(ims.core.vo.NonUniqueTaxonomyMapVo value)
		{
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		grdMappings.addStringColumn("Code", 0, 0, 210, false, false, 0, 30, true, ims.framework.enumerations.CharacterCasing.NORMAL);
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_ContextMenuSelected = new ims.framework.ContextVariable("ContextMenuSelected", prefix + "_lv_Admin.NonUniqueTaxonomyMappings.__internal_x_context__ContextMenuSelected_" + componentIdentifier + "");
			cxl_SetComponentValue = new ims.framework.ContextVariable("SetComponentValue", prefix + "_lv_Admin.NonUniqueTaxonomyMappings.__internal_x_context__SetComponentValue_" + componentIdentifier + "");
			cxl_Locked = new ims.framework.ContextVariable("Locked", prefix + "_lv_Admin.NonUniqueTaxonomyMappings.__internal_x_context__Locked_" + componentIdentifier + "");
			cxl_ComponentMode = new ims.framework.ContextVariable("ComponentMode", prefix + "_lv_Admin.NonUniqueTaxonomyMappings.__internal_x_context__ComponentMode_" + componentIdentifier + "");
			cxl_SelectedRecord = new ims.framework.ContextVariable("SelectedRecord", prefix + "_lv_Admin.NonUniqueTaxonomyMappings.__internal_x_context__SelectedRecord_" + componentIdentifier + "");
		}
		...
		public ims.core.vo.NonUniqueTaxonomyMapVoCollection getSetComponentValue()
		{
			return (ims.core.vo.NonUniqueTaxonomyMapVoCollection)cxl_SetComponentValue.getValue(context);
		}
		public void setSetComponentValue(ims.core.vo.NonUniqueTaxonomyMapVoCollection value)
		{
		...
		public ims.core.vo.NonUniqueTaxonomyMapVo getSelectedRecord()
		{
			return (ims.core.vo.NonUniqueTaxonomyMapVo)cxl_SelectedRecord.getValue(context);
		}
		public void setSelectedRecord(ims.core.vo.NonUniqueTaxonomyMapVo value)
		{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[74] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NonUniqueTaxonomyMappings.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100071-ID", "ID_NonUniqueTaxonomyMap");
			fields[75] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NonUniqueTaxonomyMappings.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100071-TAXONOMYNAME", "TaxonomyName");
			fields[76] = new ims.framework.ReportField(this.context, prefix + "_lv_Admin.NonUniqueTaxonomyMappings.__internal_x_context__SelectedRecord_" + componentIdentifier, "BO-1003100071-TAXONOMYCODE", "TaxonomyCode");
			return fields;
		}
