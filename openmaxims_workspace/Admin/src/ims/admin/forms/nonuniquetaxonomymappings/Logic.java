...
import ims.admin.forms.nonuniquetaxonomymappings.GenForm.grdMappingsRow;
...
public class Logic extends BaseLogic
{
	...
	{
		ims.admin.forms.nonuniquetaxonomymappings.GenForm.grdMappingsRow selectedRow = form.grdMappings().getSelectedRow();
		if (selectedRow != null)
