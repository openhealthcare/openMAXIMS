...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "NonUniqueTaxonomyMappings";
	}
	public int getWidth()
	{
		return 376;
	...
	{
		return new String[] { "_cv_Core.TaxonomyMap" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Admin.NonUniqueTaxonomyMappings.__internal_x_context__" + String.valueOf(getFormId());
	}
