...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Admin.ManagedLocations", "_cv_Admin.SelectedLocations" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Admin.SelectLocations.__internal_x_context__" + String.valueOf(getFormId());
	}
