...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void onDyngrdFlagsColumnHeaderClicked(ims.framework.controls.DynamicGridColumn column);
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.dyngrdFlags().setDynamicGridColumnHeaderClickedEvent(new DynamicGridColumnHeaderClicked()
		{
			private static final long serialVersionUID = 1L;
			...
			{
				onDyngrdFlagsColumnHeaderClicked(column);
			}
		});
