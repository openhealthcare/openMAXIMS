...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void bindgrdDetailsMappingscolExtCodeTypeLookup();
	abstract protected void onFormModeChanged();
	abstract protected void onFormOpen(Object[] args) throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onCustomControlPracticeAdminValueChanged() throws ims.framework.exceptions.PresentationLogicException;
	...
	abstract protected void onGrdDetailsMappingsSelectionChanged() throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.setcustomControlPracticeAdminValueChangedEvent(new ValueChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onCustomControlPracticeAdminValueChanged();
			}
		});
		...
		this.form.ctnDetails().grdCommChannels().setSelectionChangedEvent(new GridSelectionChanged()
		{
			private static final long serialVersionUID = 1L;
		...
		this.form.ctnDetails().cmbCounty().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
		...
		this.form.ctnDetails().grdDetailsMappings().setSelectionChangedEvent(new GridSelectionChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.enumerations.MouseButton mouseButton) throws ims.framework.exceptions.PresentationLogicException
			{
				onGrdDetailsMappingsSelectionChanged();
			}
		});
		this.form.getContextMenus().Admin.getPracticeCommChannelsADDItem().setClickEvent(new ims.framework.delegates.MenuItemClick()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.Control sender) throws ims.framework.exceptions.PresentationLogicException
			{
				onContextMenuItemClick(GenForm.ContextMenus.AdminNamespace.PracticeCommChannels.ADD, sender);
			}
		});
		this.form.getContextMenus().Admin.getPracticeCommChannelsREMOVEItem().setClickEvent(new ims.framework.delegates.MenuItemClick()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.Control sender) throws ims.framework.exceptions.PresentationLogicException
			{
				onContextMenuItemClick(GenForm.ContextMenus.AdminNamespace.PracticeCommChannels.REMOVE, sender);
			}
		});
	...
	protected void bindLookups()
	{
		...
		bindcmbCountyLookup();
		bindgrdDetailsMappingscolExtCodeTypeLookup();
	}
