...
{
	abstract protected void bindcmbDestinationLookup();
	abstract protected void defaultcmbDestinationLookupValue();
	abstract protected void bindcmbMethodLookup();
	abstract protected void defaultcmbMethodLookupValue();
	abstract protected void onFormOpen(Object[] args) throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void oncmbDestinationValueSet(Object value);
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.cmbDestination().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				oncmbDestinationValueSet(value);
			}
		});
	...
	{
		defaultcmbDestinationLookupValue();
