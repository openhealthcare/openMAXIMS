...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "RCHTManualDischargeDialog";
	}
	public int getWidth()
	{
		return 424;
	...
	{
		return new String[] { "_cv_Core.RCHTInpatientDischarge" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Admin.RCHTManualDischargeDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
