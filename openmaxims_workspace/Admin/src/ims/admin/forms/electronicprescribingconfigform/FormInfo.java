...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "ElectronicPrescribingConfigForm";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Admin.ElectronicPrescribingConfigVo", "_cv_Admin.SelectedRoles" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Admin.ElectronicPrescribingConfigForm.__internal_x_context__" + String.valueOf(getFormId());
	}
