...
public abstract class BaseLogic extends Handlers
{
	...
	{
		return ims.admin.domain.ExternalResourcesConfig.class;
	}
	public final void setContext(ims.framework.UIEngine engine, GenForm form, ims.admin.domain.ExternalResourcesConfig domain)
	{
		setContext(engine, form);
		this.domain = domain;
	}
	protected final void oncmbStatusDetailsValueSet(Object value)
	{
		java.util.ArrayList listOfValues = this.form.cmbStatusDetails().getValues();
		...
		else if(value instanceof ims.core.vo.lookups.PreActiveActiveInactiveStatus)
		{
			...
			this.form.cmbStatusDetails().newRow(instance, instance.getText(), instance.getImage(), instance.getTextColor());
		}
	}
	protected final void bindcmbStatusDetailsLookup()
	{
		this.form.cmbStatusDetails().clear();
		...
		{
			this.form.cmbStatusDetails().newRow(lookupCollection.get(x), lookupCollection.get(x).getText(), lookupCollection.get(x).getImage(), lookupCollection.get(x).getTextColor());
		}
	}
	protected final void setcmbStatusDetailsLookupValue(int id)
	{
		...
		if(instance != null)
			this.form.cmbStatusDetails().setValue(instance);
	}
	protected final void defaultcmbStatusDetailsLookupValue()
	{
		this.form.cmbStatusDetails().setValue((ims.core.vo.lookups.PreActiveActiveInactiveStatus)domain.getLookupService().getDefaultInstance(ims.core.vo.lookups.PreActiveActiveInactiveStatus.class, engine.getFormName().getID(), ims.core.vo.lookups.PreActiveActiveInactiveStatus.TYPE_ID));
	}
	protected final void oncmbHcpTypeDetailsValueSet(Object value)
	{
		java.util.ArrayList listOfValues = this.form.cmbHcpTypeDetails().getValues();
		...
		else if(value instanceof ims.core.vo.lookups.HcpDisType)
		{
			...
			this.form.cmbHcpTypeDetails().newRow(instance, instance.getText(), instance.getImage(), instance.getTextColor());
		}
	}
	protected final void bindcmbHcpTypeDetailsLookup()
	{
		this.form.cmbHcpTypeDetails().clear();
		...
		for(int x = 0; x < lookupCollection.size(); x++)
		{
			this.form.cmbHcpTypeDetails().newRow(lookupCollection.get(x), lookupCollection.get(x).getText(), lookupCollection.get(x).getImage(), lookupCollection.get(x).getTextColor());
		}
	}
	protected final void setcmbHcpTypeDetailsLookupValue(int id)
	{
		...
		if(instance != null)
			this.form.cmbHcpTypeDetails().setValue(instance);
	}
	protected final void defaultcmbHcpTypeDetailsLookupValue()
	{
		this.form.cmbHcpTypeDetails().setValue((ims.core.vo.lookups.HcpDisType)domain.getLookupService().getDefaultInstance(ims.core.vo.lookups.HcpDisType.class, engine.getFormName().getID(), ims.core.vo.lookups.HcpDisType.TYPE_ID));
	}
	...
	protected final void oncmbExternalResourceTypeDetailsValueSet(Object value)
	{
		java.util.ArrayList listOfValues = this.form.cmbExternalResourceTypeDetails().getValues();
		...
		else if(value instanceof ims.core.vo.lookups.ExternalResourceType)
		{
			...
			this.form.cmbExternalResourceTypeDetails().newRow(instance, instance.getText(), instance.getImage(), instance.getTextColor());
		}
	}
	protected final void bindcmbExternalResourceTypeDetailsLookup()
	{
		this.form.cmbExternalResourceTypeDetails().clear();
		...
		for(int x = 0; x < lookupCollection.size(); x++)
		{
			this.form.cmbExternalResourceTypeDetails().newRow(lookupCollection.get(x), lookupCollection.get(x).getText(), lookupCollection.get(x).getImage(), lookupCollection.get(x).getTextColor());
		}
	}
	protected final void setcmbExternalResourceTypeDetailsLookupValue(int id)
	{
		...
		if(instance != null)
			this.form.cmbExternalResourceTypeDetails().setValue(instance);
	}
	protected final void defaultcmbExternalResourceTypeDetailsLookupValue()
	{
		this.form.cmbExternalResourceTypeDetails().setValue((ims.core.vo.lookups.ExternalResourceType)domain.getLookupService().getDefaultInstance(ims.core.vo.lookups.ExternalResourceType.class, engine.getFormName().getID(), ims.core.vo.lookups.ExternalResourceType.TYPE_ID));
	}
	...
	protected ims.admin.domain.ExternalResourcesConfig domain;
}
