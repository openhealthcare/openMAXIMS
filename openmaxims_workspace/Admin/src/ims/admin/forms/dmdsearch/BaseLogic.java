...
public abstract class BaseLogic extends Handlers implements IComponent
{
	...
	{
		return ims.admin.domain.DMDSearch.class;
	}
	public final void setContext(ims.framework.UIComponentEngine engine, GenForm form, ims.admin.domain.DMDSearch domain)
	{
	...
	protected ims.admin.domain.DMDSearch domain;
}
