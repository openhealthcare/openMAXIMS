...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "ConsultantProcedureCategoryConfiguration";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Clinical.SelectedProcedures", "_cv_Clinical.SelectedProcedure" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Admin.ConsultantProcedureCategoryConfiguration.__internal_x_context__" + String.valueOf(getFormId());
	}
