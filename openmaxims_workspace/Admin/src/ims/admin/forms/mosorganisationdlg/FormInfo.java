...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Admin.SelectedMos", "_cv_Hcp", "_cv_NTPF.CaseTypes" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Admin.MosOrganisationDlg.__internal_x_context__" + String.valueOf(getFormId());
	}
