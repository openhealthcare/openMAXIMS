...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "ElectronicPrescribingConfigDialog";
	}
	public int getWidth()
	{
		return 536;
	...
	{
		return new String[] { "_cv_Admin.ElectronicPrescribingConfigVo" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Admin.ElectronicPrescribingConfigDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
