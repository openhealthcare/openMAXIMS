...
public abstract class BaseLogic extends Handlers implements IComponent
{
	...
	{
		return ims.admin.domain.DMD.class;
	}
	public final void setContext(ims.framework.UIComponentEngine engine, GenForm form, ims.admin.domain.DMD domain)
	{
	...
	protected ims.admin.domain.DMD domain;
}
