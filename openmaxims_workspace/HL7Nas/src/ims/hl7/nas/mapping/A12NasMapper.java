...
public class A12NasMapper extends NasMapper 
{
	public ImsNasMsg translate(Message msg) throws Exception 
	{
		...
		//get by visit id and update location
		Integer pkey = null;
		if ((pkey = getPatientPkey(msg)) != null)
		{
			...
			/* field 1 */
			if (!evn.getEventTypeCode().getValue().equalsIgnoreCase("A12"))
			{
			...
			else
			{
				...
				nm.addPair("EPSD",getVisitNumberFromPV1(pv1));
			}
			/*else if (tmpVal.equalsIgnoreCase("O"))
			{}*/
