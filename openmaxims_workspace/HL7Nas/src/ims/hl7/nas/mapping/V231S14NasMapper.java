...
public class V231S14NasMapper extends V231NasMapper
{
	public ImsNasMsg translate(Message msg) throws Exception
	{
		...
		if (mapper == null)
		{
			throw new Exception("S14 mapper requires S12 mapper. S12 mapper not found in list of registerd mappers.");
		}
