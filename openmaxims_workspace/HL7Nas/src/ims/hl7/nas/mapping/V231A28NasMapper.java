...
public class V231A28NasMapper extends V231NasMapper
{
	...
	public ImsNasMsg translate(Message msg) throws Exception
	{
		...
		//String idVal = pid.getAlternatePatientIDPID(0).getID().getValue();
		String idVal = pid.getPatientID().getID().getValue();
		//if (idVal != null && idVal.length() > 0)		
		//	hospNum = getPatientPkey(msg); 
