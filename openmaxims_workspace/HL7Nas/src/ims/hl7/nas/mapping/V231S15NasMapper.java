...
public class V231S15NasMapper extends V231NasMapper
{
	public ImsNasMsg translate(Message msg) throws Exception
	{
		...
		if (mapper == null)
		{
			throw new Exception("S15 mapper requires S12 mapper. S15 mapper not found in list of registerd mappers.");
		}
