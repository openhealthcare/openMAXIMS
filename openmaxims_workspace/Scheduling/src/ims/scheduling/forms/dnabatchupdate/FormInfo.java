...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Scheduling.NumHours" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Scheduling.DnaBatchUpdate.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Scheduling/dna_batch_update_48.png";
	}
}
