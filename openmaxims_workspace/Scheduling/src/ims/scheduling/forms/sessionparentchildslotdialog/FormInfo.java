...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "SessionParentChildSlotDialog";
	}
	public int getWidth()
	{
		return 488;
	...
	{
		return new String[] { "_cv_Scheduling.SessionParentChildSlot" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Scheduling.SessionParentChildSlotDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
