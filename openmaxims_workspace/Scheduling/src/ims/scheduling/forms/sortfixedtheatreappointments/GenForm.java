...
public class GenForm extends FormBridge
{
	...
	public static class grdApptsRow extends GridRowBridge
	{
		...
		public void setColCustomTCILagReadOnly(boolean value)
		{
			super.row.setReadOnly(0, value);
		}
		public boolean isColCustomTCILagReadOnly()
		{
			return super.row.isReadOnly(0);
		}
		public void showColCustomTCILagOpened()
		{
			super.row.showOpened(0);
		}
		public void setTooltipForColCustomTCILag(String value)
		{
			super.row.setTooltip(0, value);
		}
		public Integer getColCustomTCILag()
		{
			return (Integer)super.row.get(0);
		}
		public void setColCustomTCILag(Integer value)
		{
			super.row.set(0, value);
		}
		public void setCellColCustomTCILagTooltip(String value)
		{
			super.row.setTooltip(0, value);
		}
		...
		public ims.framework.utils.Time getColComeInTime()
		{
			return (ims.framework.utils.Time)super.row.get(7);
		}
		public void setColComeInTime(ims.framework.utils.Time value)
		{
	...
	public static class grdApptsGrid extends GridBridge
	{
		...
		public void setColCustomTCILagHeaderTooltip(String value)
		{
			super.grid.setColumnHeaderTooltip(0, value);
		}
		public String getColCustomTCILagHeaderTooltip()
		{
			return super.grid.getColumnHeaderTooltip(0);
		}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		contextMenus.Scheduling.contextMenuSortFixedTheatreAppointments = factory.createMenu(startControlID.intValue() + 1);
		contextMenus.Scheduling.contextMenuSortFixedTheatreAppointmentsMOVEUPItem = factory.createMenuItem(startControlID.intValue() + 1, "Move Up", true, false, new Integer(102197), true, false);
		if(factory.getUIEngine().getLoggedInRole().hasMenuActionRight(appForm, new ims.framework.MenuAction(4220001)))
			contextMenus.Scheduling.contextMenuSortFixedTheatreAppointments.add(contextMenus.Scheduling.contextMenuSortFixedTheatreAppointmentsMOVEUPItem);
		contextMenus.Scheduling.contextMenuSortFixedTheatreAppointmentsMOVEDOWNItem = factory.createMenuItem(startControlID.intValue() + 2, "Move Down", true, false, new Integer(102198), true, false);
		if(factory.getUIEngine().getLoggedInRole().hasMenuActionRight(appForm, new ims.framework.MenuAction(4220002)))
			contextMenus.Scheduling.contextMenuSortFixedTheatreAppointments.add(contextMenus.Scheduling.contextMenuSortFixedTheatreAppointmentsMOVEDOWNItem);
		contextMenus.Scheduling.contextMenuSortFixedTheatreAppointmentsEDITTIMESItem = factory.createMenuItem(startControlID.intValue() + 3, "Edit Start/Come In Time", true, false, new Integer(102150), true, false);
		if(factory.getUIEngine().getLoggedInRole().hasMenuActionRight(appForm, new ims.framework.MenuAction(4220003)))
			contextMenus.Scheduling.contextMenuSortFixedTheatreAppointments.add(contextMenus.Scheduling.contextMenuSortFixedTheatreAppointmentsEDITTIMESItem);
		contextMenus.Scheduling.contextMenuSortFixedTheatreAppointmentsSORTBYTCIItem = factory.createMenuItem(startControlID.intValue() + 4, "Sort By - Come In Time", true, false, new Integer(102243), true, false);
		if(factory.getUIEngine().getLoggedInRole().hasMenuActionRight(appForm, new ims.framework.MenuAction(4220004)))
			contextMenus.Scheduling.contextMenuSortFixedTheatreAppointments.add(contextMenus.Scheduling.contextMenuSortFixedTheatreAppointmentsSORTBYTCIItem);
		form.registerMenu(contextMenus.Scheduling.contextMenuSortFixedTheatreAppointments);
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1010), new Integer(anchoringHelper11.getX()), new Integer(anchoringHelper11.getY()), new Integer(anchoringHelper11.getWidth()), new Integer(anchoringHelper11.getHeight()), new Integer(startTabIndex.intValue() + 14), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Re Order", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 16), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Finalise", Boolean.TRUE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1012), new Integer(anchoringHelper13.getX()), new Integer(anchoringHelper13.getY()), new Integer(anchoringHelper13.getWidth()), new Integer(anchoringHelper13.getHeight()), new Integer(startTabIndex.intValue() + 20), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Save", Boolean.FALSE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1013), new Integer(anchoringHelper14.getX()), new Integer(anchoringHelper14.getY()), new Integer(anchoringHelper14.getWidth()), new Integer(anchoringHelper14.getHeight()), new Integer(startTabIndex.intValue() + 22), ControlState.HIDDEN, ControlState.ENABLED, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT, "Cancel", Boolean.FALSE, null, Boolean.FALSE, Boolean.FALSE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));
		...
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1018), new Integer(anchoringHelper19.getX()), new Integer(anchoringHelper19.getY()), new Integer(anchoringHelper19.getWidth()), new Integer(anchoringHelper19.getHeight()), new Integer(startTabIndex.intValue() + 7), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		...
		super.addControl(factory.getControl(TextBox.class, new Object[] { control, new Integer(startControlID.intValue() + 1019), new Integer(anchoringHelper20.getX()), new Integer(anchoringHelper20.getY()), new Integer(anchoringHelper20.getWidth()), new Integer(anchoringHelper20.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.DISABLED, ControlState.DISABLED, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT,Boolean.FALSE, new Integer(0), Boolean.TRUE, Boolean.FALSE, null, null, Boolean.FALSE, ims.framework.enumerations.CharacterCasing.NORMAL, ims.framework.enumerations.TextTrimming.NONE, "", ""}));
		...
		Grid m_grdApptsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1022), new Integer(anchoringHelper23.getX()), new Integer(anchoringHelper23.getY()), new Integer(anchoringHelper23.getWidth()), new Integer(anchoringHelper23.getHeight()), new Integer(startTabIndex.intValue() + 12), ControlState.DISABLED, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.Scheduling.contextMenuSortFixedTheatreAppointments, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.FALSE, Boolean.TRUE});
		...
		grdAppts.addIntColumn(" ", 0, 0, 0, true, true, null, false, 0, false);
		grdAppts.addTimeColumn("Start Time", 0, 0, 80, false, true, false, null, false, 0, true);
		...
		grdAppts.addTimeColumn("Come In Time", 0, 0, 90, false, true, false, null, false, 0, true);
		grdAppts.addStringColumn("Duration", 0, 0, 60, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdAppts.addStringColumn("Procedure", 0, 0, -1, true, false, 0, 0, true, ims.framework.enumerations.CharacterCasing.NORMAL);
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_SessApptOrder = new ims.framework.ContextVariable("SessApptOrder", prefix + "_lv_Scheduling.SortFixedTheatreAppointments.__internal_x_context__SessApptOrder_" + componentIdentifier + "");
			cxl_TCISortOrder = new ims.framework.ContextVariable("TCISortOrder", prefix + "_lv_Scheduling.SortFixedTheatreAppointments.__internal_x_context__TCISortOrder_" + componentIdentifier + "");
			cxl_EditingTimes = new ims.framework.ContextVariable("EditingTimes", prefix + "_lv_Scheduling.SortFixedTheatreAppointments.__internal_x_context__EditingTimes_" + componentIdentifier + "");
			cxl_AppointmentsBeforeReorder = new ims.framework.ContextVariable("AppointmentsBeforeReorder", prefix + "_lv_Scheduling.SortFixedTheatreAppointments.__internal_x_context__AppointmentsBeforeReorder_" + componentIdentifier + "");
		}
		...
		public boolean getEditingTimesIsNotNull()
		{
			return !cxl_EditingTimes.getValueIsNull(context);
		}
		public Boolean getEditingTimes()
		{
			return (Boolean)cxl_EditingTimes.getValue(context);
		}
		public void setEditingTimes(Boolean value)
		{
			cxl_EditingTimes.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_EditingTimes = null;
		public boolean getAppointmentsBeforeReorderIsNotNull()
		{
			return !cxl_AppointmentsBeforeReorder.getValueIsNull(context);
		}
		public ims.scheduling.vo.BookingAppointmentTheatreVoCollection getAppointmentsBeforeReorder()
		{
			return (ims.scheduling.vo.BookingAppointmentTheatreVoCollection)cxl_AppointmentsBeforeReorder.getValue(context);
		}
		public void setAppointmentsBeforeReorder(ims.scheduling.vo.BookingAppointmentTheatreVoCollection value)
		{
			cxl_AppointmentsBeforeReorder.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_AppointmentsBeforeReorder = null;
	}
	...
	public final class ContextMenus implements java.io.Serializable
	{
		...
		{
			private static final long serialVersionUID = 1L;
			public final class SortFixedTheatreAppointments implements java.io.Serializable
			{
				private static final long serialVersionUID = 1L;
				public static final int MOVEUP = 1;
				public static final int MOVEDOWN = 2;
				public static final int EDITTIMES = 3;
				public static final int SORTBYTCI = 4;
			}
			public void disableAllSortFixedTheatreAppointmentsMenuItems()
			{
				this.contextMenuSortFixedTheatreAppointmentsMOVEUPItem.setEnabled(false);
				this.contextMenuSortFixedTheatreAppointmentsMOVEDOWNItem.setEnabled(false);
				this.contextMenuSortFixedTheatreAppointmentsEDITTIMESItem.setEnabled(false);
				this.contextMenuSortFixedTheatreAppointmentsSORTBYTCIItem.setEnabled(false);
			}
			public void hideAllSortFixedTheatreAppointmentsMenuItems()
			{
				this.contextMenuSortFixedTheatreAppointmentsMOVEUPItem.setVisible(false);
				this.contextMenuSortFixedTheatreAppointmentsMOVEDOWNItem.setVisible(false);
				this.contextMenuSortFixedTheatreAppointmentsEDITTIMESItem.setVisible(false);
				this.contextMenuSortFixedTheatreAppointmentsSORTBYTCIItem.setVisible(false);
			}
			private Menu contextMenuSortFixedTheatreAppointments;
			public ReadOnlyMenuItem getSortFixedTheatreAppointmentsMOVEUPItem()
			{
				return this.contextMenuSortFixedTheatreAppointmentsMOVEUPItem;
			}
			private MenuItem contextMenuSortFixedTheatreAppointmentsMOVEUPItem;
			public ReadOnlyMenuItem getSortFixedTheatreAppointmentsMOVEDOWNItem()
			{
				return this.contextMenuSortFixedTheatreAppointmentsMOVEDOWNItem;
			}
			private MenuItem contextMenuSortFixedTheatreAppointmentsMOVEDOWNItem;
			public ReadOnlyMenuItem getSortFixedTheatreAppointmentsEDITTIMESItem()
			{
				return this.contextMenuSortFixedTheatreAppointmentsEDITTIMESItem;
			}
			private MenuItem contextMenuSortFixedTheatreAppointmentsEDITTIMESItem;
			public ReadOnlyMenuItem getSortFixedTheatreAppointmentsSORTBYTCIItem()
			{
				return this.contextMenuSortFixedTheatreAppointmentsSORTBYTCIItem;
			}
			private MenuItem contextMenuSortFixedTheatreAppointmentsSORTBYTCIItem;
		}
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[74] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.SortFixedTheatreAppointments.__internal_x_context__SessApptOrder_" + componentIdentifier, "BO-1090100012-FINALISEDBY", "FinalisedBy");
			fields[75] = new ims.framework.ReportField(this.context, prefix + "_lv_Scheduling.SortFixedTheatreAppointments.__internal_x_context__SessApptOrder_" + componentIdentifier, "BO-1090100012-FINALISEDDATETIME", "FinalisedDateTime");
			return fields;
		}
