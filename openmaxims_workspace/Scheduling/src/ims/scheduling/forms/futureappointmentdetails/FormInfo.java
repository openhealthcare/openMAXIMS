...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Scheduling.FutureAppointmentDetails" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Scheduling.FutureAppointmentDetails.__internal_x_context__" + String.valueOf(getFormId());
	}
