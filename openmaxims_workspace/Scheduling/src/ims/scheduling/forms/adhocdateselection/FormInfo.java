...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Scheduling.ProfileShort" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Scheduling.AdHocDateSelection.__internal_x_context__" + String.valueOf(getFormId());
	}
