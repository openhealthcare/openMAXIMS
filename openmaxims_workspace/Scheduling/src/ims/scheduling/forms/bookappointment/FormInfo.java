...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Scheduling.BookingService", "_cv_Scheduling.BookingActivity", "_cv_Scheduling.AppointmentIds", "_cv_Scheduling.BookingSession", "_cv_Scheduling.BookingAppointment" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Scheduling.BookAppointment.__internal_x_context__" + String.valueOf(getFormId());
	}
