...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "HcpMultipleSelectDialog";
	}
	public int getWidth()
	{
		return 392;
	...
	{
		return new String[] { "_cv_Scheduling.SelectedHCPs" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Scheduling.HcpMultipleSelectDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
