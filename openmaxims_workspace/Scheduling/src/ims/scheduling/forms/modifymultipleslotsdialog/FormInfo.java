...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "ModifyMultipleSlotsDialog";
	}
	public int getWidth()
	{
		return 360;
	...
	{
		return new String[] { "_cv_Scheduling.BookTheatreSlotDialogData" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Scheduling.ModifyMultipleSlotsDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
