...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "ProfileTheatreSlotDialog";
	}
	public int getWidth()
	{
		return 488;
	...
	{
		return new String[] { "_cv_Scheduling.ProfileStartTime", "_cv_Scheduling.ProfileParentChildSlot", "_cv_Scheduling.ProfileEndTime" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Scheduling.ProfileTheatreSlotDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
