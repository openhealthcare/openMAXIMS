...
public class GenForm extends FormBridge
{
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[81] = new ims.framework.ReportField(this.context, "_cv_CareUk.SelectedSession", "BO-1055100010-ID", "ID_Sch_Session");
			fields[82] = new ims.framework.ReportField(this.context, "_cv_CareUk.SelectedSession", "BO-1055100010-NAME", "Name");
			fields[83] = new ims.framework.ReportField(this.context, "_cv_CareUk.SelectedSession", "BO-1055100010-REMAININGSLOTS", "RemainingSlots");
			fields[84] = new ims.framework.ReportField(this.context, "_cv_CareUk.SelectedSession", "BO-1055100010-TOTALSLOTS", "TotalSlots");
			fields[85] = new ims.framework.ReportField(this.context, "_cv_CareUk.SelectedSession", "BO-1055100010-THEATRETYPE", "TheatreType");
			fields[86] = new ims.framework.ReportField(this.context, "_cv_CareUk.SelectedSession", "BO-1055100010-ISFIXED", "IsFixed");
			fields[87] = new ims.framework.ReportField(this.context, "_cv_CareUk.SelectedSession", "BO-1055100010-STARTTM", "StartTm");
			fields[88] = new ims.framework.ReportField(this.context, "_cv_CareUk.SelectedSession", "BO-1055100010-ENDTM", "EndTm");
			fields[89] = new ims.framework.ReportField(this.context, "_cv_CareUk.SelectedSession", "BO-1055100010-REMAININGTIME", "RemainingTime");
			fields[90] = new ims.framework.ReportField(this.context, "_cv_CareUk.SelectedSession", "BO-1055100010-SESSIONDATE", "SessionDate");
			fields[91] = new ims.framework.ReportField(this.context, "_cv_CareUk.SelectedSession", "BO-1055100010-MAXCONTINUOUSAVAILABLEMINS", "MaxContinuousAvailableMins");
			fields[92] = new ims.framework.ReportField(this.context, "_cv_CareUk.SelectedSession", "BO-1055100010-CONSMEDIATYPE", "ConsMediaType");
			fields[93] = new ims.framework.ReportField(this.context, "_cv_CareUk.SelectedSession", "BO-1055100010-DESCRIPTION", "Description");
			fields[94] = new ims.framework.ReportField(this.context, "_cv_CareUk.SelectedSession", "BO-1055100010-SESSIONSTATUS", "SessionStatus");
			fields[95] = new ims.framework.ReportField(this.context, "_cv_CareUk.SelectedSession", "BO-1055100010-ISACTIVE", "IsActive");
			fields[96] = new ims.framework.ReportField(this.context, "_cv_CareUk.SelectedSession", "BO-1055100010-PASCLINIC", "PASClinic");
			fields[97] = new ims.framework.ReportField(this.context, "_cv_CareUk.SelectedSession", "BO-1055100010-ISTHEATRESESSION", "IsTheatreSession");
			fields[98] = new ims.framework.ReportField(this.context, "_cv_CareUk.SelectedSession", "BO-1055100010-CANCELLATIONREASON", "CancellationReason");
			fields[99] = new ims.framework.ReportField(this.context, "_cv_CareUk.SelectedSession", "BO-1055100010-COMMENT", "Comment");
			fields[100] = new ims.framework.ReportField(this.context, "_cv_CareUk.SelectedSession", "BO-1055100010-WASSESSIONMOVED", "WasSessionMoved");
