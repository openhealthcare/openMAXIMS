...
public final class Vsbp implements ims.vo.ImsCloneable
{
	private VsbpFilter lastGetFilter = null;
	private final String serviceName = "VSBP";
	 ...
	 */ 
	public VsbpFilter Filter = new VsbpFilter();			
	/**
	 * Represents the filter used by the current Data Transfer Object to Insert/Update data.
	 */ 
	public VsbpEditFilter EditFilter = new VsbpEditFilter();
	/**
	 * Contains the data records for the current Data Transfer Object
	 */ 
	public VsbpCollection DataCollection = new VsbpCollection();

	/**
	 * Creates a new Vsbp Data Transfer Object.
	 */ 
	public Vsbp(ims.dto.Connection connection)
	{	
	 ...
	 */
	public Vsbp cloneObject()
	{
		Vsbp cloneObject = new Vsbp(Connection);
		...
		for(int x = 0; x < DataCollection.count(); x++)
		{
			...
			cloneObject.DataCollection.get(index).Bprsys = DataCollection.get(x).Bprsys;
			cloneObject.DataCollection.get(index).Bprdia = DataCollection.get(x).Bprdia;
			cloneObject.DataCollection.get(index).Bppos = DataCollection.get(x).Bppos;
			cloneObject.DataCollection.get(index).Bpsite = DataCollection.get(x).Bpsite;
			cloneObject.DataCollection.get(index).Absinterval = DataCollection.get(x).Absinterval;
			cloneObject.DataCollection.get(index).Bprsys2 = DataCollection.get(x).Bprsys2;
			cloneObject.DataCollection.get(index).Bprdia2 = DataCollection.get(x).Bprdia2;
			cloneObject.DataCollection.get(index).Bppos2 = DataCollection.get(x).Bppos2;
			cloneObject.DataCollection.get(index).Bpsite2 = DataCollection.get(x).Bpsite2;
	...
	public ims.dto.Result count()
	{
		...
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Vsbp.Count");
			
		int result = Connection.count(serviceName, encodeNASFilter());
		if(result >= 0)
			return new ims.dto.Result(result, "No error detected. The count result is held in the ID field", "DTO.Client.Vsbp.Count");
	...
	*/
	...
	{	
		...
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Vsbp.Get");
	...
	*/
	...
	{						
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Vsbp.GetForUpdate");
							
		if(lastGetFilter == null)	
			return new ims.dto.Result("Last get method failed or not called", "DTO.Client.Vsbp.GetForUpdate");
		...
		return new ims.dto.Result("The data was changed by another user", "DTO.Client.Vsbp.GetForUpdate");
	}		
	/**
	...
	*/
	public ims.dto.Result insert()
	{
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Vsbp.Insert");
					
		if(DataCollection.count() == 0)
			return new ims.dto.Result("No data to insert", "DTO.Client.Vsbp.Insert");
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple object insert not allowed", "DTO.Client.Vsbp.Insert");
		...
		{
			return new ims.dto.Result("Invalid record ID returned", "DTO.Client.Vsbp.Insert");
		}
		
		return new ims.dto.Result(recordID, "No error. The ID of the new record is in the ID field", "DTO.Client.Vsbp.Insert");
	}
	/**
	...
	{
		if(action.length() == 0)
			return new ims.dto.Result("Invalid action name", "DTO.Client.Vsbp.ExecuteAction");
			
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Vsbp.ExecuteAction");
		
		if(DataCollection.count() == 0)
			return new ims.dto.Result("Data container is empty", "DTO.Client.Vsbp.ExecuteAction");
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple objects are not allowed", "DTO.Client.Vsbp.ExecuteAction");
		...
		try
		{
			return new ims.dto.Result(new Integer(Connection.getValueAt(2)).intValue(), "No error", "DTO.Client.Vsbp.ExecuteAction");	
		}
		catch(NumberFormatException ex)
		{
			return new ims.dto.Result("Invalid server response", "DTO.Client.Vsbp.ExecuteAction");
		}
	}
	/**
	...
	{
		if(action.length() == 0)
			return new ims.dto.Result("Invalid action name", "DTO.Client.Vsbp.TransferData");
			
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Vsbp.TransferData");
		
		if(DataCollection.count() == 0)
			return new ims.dto.Result("No data to transfer", "DTO.Client.Vsbp.TransferData");
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple objects not allowed", "DTO.Client.Vsbp.TransferData");
	...
	{			
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Vsbp.Update");
				
		if(DataCollection.count() == 0)
			return new ims.dto.Result("No data to update", "DTO.Client.Vsbp.Update");	
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple object update not allowed", "DTO.Client.Vsbp.Update");
	...
	{
		if(!listInProgress)
			return new ims.dto.Result("No active list running", "DTO.Client.Vsbp.StopList");
	...
	{	
		...
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Vsbp.List");
	...
	private String encodeNASFilter(VsbpFilter filter)
	{
		if(filter == null)
			return "";
		...
		if(Filter.Bprsys != null && filter.Bprsys.length()> 0)
		{
			if(filterString.length() > 0)
				filterString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			filterString += "BPRSYS" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + filter.Bprsys;
		}
		
		if(Filter.Bprdia != null && filter.Bprdia.length()> 0)
		{
			if(filterString.length() > 0)
				filterString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			filterString += "BPRDIA" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + filter.Bprdia;
		}
		
		if(Filter.Bppos != null && filter.Bppos.length()> 0)
		{
			if(filterString.length() > 0)
				filterString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			filterString += "BPPOS" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + filter.Bppos;
		}
		
		if(Filter.Bpsite != null && filter.Bpsite.length()> 0)
		{
			if(filterString.length() > 0)
				filterString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			filterString += "BPSITE" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + filter.Bpsite;
		}
		
		if(Filter.Absinterval != null && filter.Absinterval.length()> 0)
		{
			if(filterString.length() > 0)
				filterString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			filterString += "ABSINTERVAL" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + filter.Absinterval;
		}
		
		if(Filter.Bprsys2 != null && filter.Bprsys2.length()> 0)
		{
			if(filterString.length() > 0)
				filterString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			filterString += "BPRSYS2" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + filter.Bprsys2;
		}
		
		if(Filter.Bprdia2 != null && filter.Bprdia2.length()> 0)
		{
			if(filterString.length() > 0)
				filterString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			filterString += "BPRDIA2" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + filter.Bprdia2;
		}
		
		if(Filter.Bppos2 != null && filter.Bppos2.length()> 0)
		{
			if(filterString.length() > 0)
				filterString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			filterString += "BPPOS2" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + filter.Bppos2;
		}
		
		if(Filter.Bpsite2 != null && filter.Bpsite2.length()> 0)
		{
			if(filterString.length() > 0)
				filterString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			filterString += "BPSITE2" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + filter.Bpsite2;
		}
	...
	private String encodeNASMessage()
	{
		...
		VsbpRecord data = (VsbpRecord)DataCollection.get(0);
		...
		if(EditFilter.IncludeBprsys)
		{
			if(dataString.length() > 0)
				dataString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			dataString += "BPRSYS" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + Connection.encodeFieldValue(data.Bprsys);
		}
		
		if(EditFilter.IncludeBprdia)
		{
			if(dataString.length() > 0)
				dataString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			dataString += "BPRDIA" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + Connection.encodeFieldValue(data.Bprdia);
		}
		
		if(EditFilter.IncludeBppos)
		{
			if(dataString.length() > 0)
				dataString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			dataString += "BPPOS" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + Connection.encodeFieldValue(data.Bppos);
		}
		
		if(EditFilter.IncludeBpsite)
		{
			if(dataString.length() > 0)
				dataString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			dataString += "BPSITE" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + Connection.encodeFieldValue(data.Bpsite);
		}
		
		if(EditFilter.IncludeAbsinterval)
		{
			if(dataString.length() > 0)
				dataString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			dataString += "ABSINTERVAL" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + Connection.encodeFieldValue(data.Absinterval);
		}
		
		if(EditFilter.IncludeBprsys2)
		{
			if(dataString.length() > 0)
				dataString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			dataString += "BPRSYS2" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + Connection.encodeFieldValue(data.Bprsys2);
		}
		
		if(EditFilter.IncludeBprdia2)
		{
			if(dataString.length() > 0)
				dataString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			dataString += "BPRDIA2" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + Connection.encodeFieldValue(data.Bprdia2);
		}
		
		if(EditFilter.IncludeBppos2)
		{
			if(dataString.length() > 0)
				dataString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			dataString += "BPPOS2" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + Connection.encodeFieldValue(data.Bppos2);
		}
		
		if(EditFilter.IncludeBpsite2)
		{
			if(dataString.length() > 0)
				dataString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			dataString += "BPSITE2" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + Connection.encodeFieldValue(data.Bpsite2);
		}
	...
	private int decodeNASMessage()
	{
		...
		{
			VsbpRecord record = new VsbpRecord();
			...
			record.Bprsys = Connection.decodeFieldValue(Connection.getValueFor(valueItems, "BPRSYS"));
			record.Bprdia = Connection.decodeFieldValue(Connection.getValueFor(valueItems, "BPRDIA"));
			record.Bppos = Connection.decodeFieldValue(Connection.getValueFor(valueItems, "BPPOS"));
			record.Bpsite = Connection.decodeFieldValue(Connection.getValueFor(valueItems, "BPSITE"));
			record.Absinterval = Connection.decodeFieldValue(Connection.getValueFor(valueItems, "ABSINTERVAL"));
			record.Bprsys2 = Connection.decodeFieldValue(Connection.getValueFor(valueItems, "BPRSYS2"));
			record.Bprdia2 = Connection.decodeFieldValue(Connection.getValueFor(valueItems, "BPRDIA2"));
			record.Bppos2 = Connection.decodeFieldValue(Connection.getValueFor(valueItems, "BPPOS2"));
			record.Bpsite2 = Connection.decodeFieldValue(Connection.getValueFor(valueItems, "BPSITE2"));
	...
	public final class VsbpCollection
	{
		private java.util.ArrayList recordCollection = new java.util.ArrayList();
		
		public int add()
		{
			VsbpRecord newRecord = new VsbpRecord();
			recordCollection.add(newRecord);
			return count() - 1;
		}
		public int add(VsbpRecord record)
		{
		...
		public VsbpRecord get(int index)
		{
			return (VsbpRecord)recordCollection.get(index);
		}
	...
	public final class VsbpRecord
	{
		...
		public String Tstp = "";
		public String Bprsys = "";
		public String Bprdia = "";
		public String Bppos = "";
		public String Bpsite = "";
		public String Absinterval = "";
		public String Bprsys2 = "";
		public String Bprdia2 = "";
		public String Bppos2 = "";
		public String Bpsite2 = "";
	...
	{			
		...
		public VsbpFilter cloneObject()
		{
			VsbpFilter newFilter = new VsbpFilter();
			...
			newFilter.Bprsys = this.Bprsys;
			newFilter.Bprdia = this.Bprdia;
			newFilter.Bppos = this.Bppos;
			newFilter.Bpsite = this.Bpsite;
			newFilter.Absinterval = this.Absinterval;
			newFilter.Bprsys2 = this.Bprsys2;
			newFilter.Bprdia2 = this.Bprdia2;
			newFilter.Bppos2 = this.Bppos2;
			newFilter.Bpsite2 = this.Bpsite2;
			newFilter.Active_flag = this.Active_flag;
			
			return newFilter;
		}
	}
	public final class VsbpEditFilter
	{			
		...
		public boolean IncludeBprsys = true;
		public boolean IncludeBprdia = true;
		public boolean IncludeBppos = true;
		public boolean IncludeBpsite = true;
		public boolean IncludeAbsinterval = true;
		public boolean IncludeBprsys2 = true;
		public boolean IncludeBprdia2 = true;
		public boolean IncludeBppos2 = true;
		public boolean IncludeBpsite2 = true;
		...
		{				
			...
			IncludeBppos = false;
			IncludeBpsite = false;
			IncludeAbsinterval = false;
			IncludeBprsys2 = false;
			IncludeBprdia2 = false;
			IncludeBppos2 = false;
			IncludeBpsite2 = false;
			IncludeActive_flag = false;
		}
		public VsbpEditFilter cloneObject()
		{
			VsbpEditFilter newEditFilter = new VsbpEditFilter();
			...
			newEditFilter.IncludeBprsys = this.IncludeBprsys;
			newEditFilter.IncludeBprdia = this.IncludeBprdia;
			newEditFilter.IncludeBppos = this.IncludeBppos;
			newEditFilter.IncludeBpsite = this.IncludeBpsite;
			newEditFilter.IncludeAbsinterval = this.IncludeAbsinterval;
			newEditFilter.IncludeBprsys2 = this.IncludeBprsys2;
			newEditFilter.IncludeBprdia2 = this.IncludeBprdia2;
			newEditFilter.IncludeBppos2 = this.IncludeBppos2;
			newEditFilter.IncludeBpsite2 = this.IncludeBpsite2;
