...
public final class Sd_appt_apdts implements ims.vo.ImsCloneable
{
	private static final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(Sd_appt_apdts.class);
	
	private Sd_appt_apdtsFilter lastGetFilter = null;
	private final String serviceName = "SD_APPT_APDTS";
	 ...
	 */ 
	public Sd_appt_apdtsFilter Filter = new Sd_appt_apdtsFilter();			
	/**
	 * Represents the filter used by the current Data Transfer Object to Insert/Update data.
	 */ 
	public Sd_appt_apdtsEditFilter EditFilter = new Sd_appt_apdtsEditFilter();
	/**
	 * Contains the data records for the current Data Transfer Object
	 */ 
	public Sd_appt_apdtsCollection DataCollection = new Sd_appt_apdtsCollection();

	/**
	 * Creates a new Sd_appt_apdts Data Transfer Object.
	 */ 
	public Sd_appt_apdts(ims.dto.Connection connection)
	{	
	 ...
	 */
	public Sd_appt_apdts cloneObject()
	{
		Sd_appt_apdts cloneObject = new Sd_appt_apdts(Connection);
	...
	{
		return "Sd_appt_apdts.imx".toLowerCase();
	}
	/**
	...
	public ims.dto.Result count()
	{
		...
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_appt_apdts.Count");
			
		int result = Connection.count(serviceName, encodeNASFilter());
		if(result >= 0)
			return new ims.dto.Result(result, "No error detected. The count result is held in the ID field", "DTO.Client.Sd_appt_apdts.Count");
	...
	*/
	...
	{	
		...
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_appt_apdts.Get");
	...
	*/
	...
	{						
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_appt_apdts.GetForUpdate");
							
		if(lastGetFilter == null)	
			return new ims.dto.Result("Last get method failed or not called", "DTO.Client.Sd_appt_apdts.GetForUpdate");
		...
		return new ims.dto.Result("The data was changed by another user", "DTO.Client.Sd_appt_apdts.GetForUpdate");
	}		
	/**
	...
	*/
	public ims.dto.Result insert()
	{
		...
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_appt_apdts.Insert");
					
		if(DataCollection.count() == 0)
			return new ims.dto.Result("No data to insert", "DTO.Client.Sd_appt_apdts.Insert");
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple object insert not allowed", "DTO.Client.Sd_appt_apdts.Insert");
		...
		{
			return new ims.dto.Result("Invalid record ID returned", "DTO.Client.Sd_appt_apdts.Insert");
		}
		
		decodeResultData();
		
		return new ims.dto.Result(recordID, "No error. The ID of the new record is in the ID field", "DTO.Client.Sd_appt_apdts.Insert");
	}
	/**
	...
	public ims.dto.Result executeAction(String action)
	{
		this.lastResultData = null;
		if(action.length() == 0)
			return new ims.dto.Result("Invalid action name", "DTO.Client.Sd_appt_apdts.ExecuteAction");
			
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_appt_apdts.ExecuteAction");
		
		if(DataCollection.count() == 0)
			return new ims.dto.Result("Data container is empty", "DTO.Client.Sd_appt_apdts.ExecuteAction");
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple objects are not allowed", "DTO.Client.Sd_appt_apdts.ExecuteAction");
		...
		try
		{
			return new ims.dto.Result(new Integer(Connection.getValueAt(2)).intValue(), "No error", "DTO.Client.Sd_appt_apdts.ExecuteAction");	
		}
		catch(NumberFormatException ex)
		{
			return new ims.dto.Result("Invalid server response", "DTO.Client.Sd_appt_apdts.ExecuteAction");
		}
	}
	/**
	...
	{
		if(action.length() == 0)
			return new ims.dto.Result("Invalid action name", "DTO.Client.Sd_appt_apdts.TransferData");
			
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_appt_apdts.TransferData");
		
		if(DataCollection.count() == 0)
			return new ims.dto.Result("No data to transfer", "DTO.Client.Sd_appt_apdts.TransferData");
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple objects not allowed", "DTO.Client.Sd_appt_apdts.TransferData");
	...
	{			
		...
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_appt_apdts.Update");
				
		if(DataCollection.count() == 0)
			return new ims.dto.Result("No data to update", "DTO.Client.Sd_appt_apdts.Update");	
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple object update not allowed", "DTO.Client.Sd_appt_apdts.Update");
	...
	{
		if(!listInProgress)
			return new ims.dto.Result("No active list running", "DTO.Client.Sd_appt_apdts.StopList");
	...
	{				
		logger.debug("Sd_appt_apdts nextList Entry");
		ims.dto.Result result = Connection.nextList(serviceName);
		if(result != null)
			return result;
		logger.debug("Sd_appt_apdts After NextList ");
				
		decodeNASMessage();		
		logger.debug("Sd_appt_apdts After decode NasMsg NextList");
		return null;
	}
	...
	{	
		...
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_appt_apdts.List");
							
		listInProgress = true;	
		logger.debug("Sd_appt_apdts Before List");
		...
		logger.debug("Sd_appt_apdts After List");
		...
		logger.debug("Sd_appt_apdts After Parse Message");
	...
	private String encodeNASFilter(Sd_appt_apdtsFilter filter)
	{
		if(filter == null)
			return "";
	...
	private String encodeNASMessage()
	{
		...
		Sd_appt_apdtsRecord data = (Sd_appt_apdtsRecord)DataCollection.get(0);
	...
	private int decodeNASMessage()
	{
		...
		{
			Sd_appt_apdtsRecord record = new Sd_appt_apdtsRecord();
	...
	public final class Sd_appt_apdtsCollection
	{
		private java.util.ArrayList recordCollection = new java.util.ArrayList();
		
		public int add()
		{
			Sd_appt_apdtsRecord newRecord = new Sd_appt_apdtsRecord();
			recordCollection.add(newRecord);
			return count() - 1;
		}
		public int add(Sd_appt_apdtsRecord record)
		{
		...
		public Sd_appt_apdtsRecord get(int index)
		{
			return (Sd_appt_apdtsRecord)recordCollection.get(index);
		}
	...
	public final class Sd_appt_apdtsRecord
	{
	...
	public final class Sd_appt_apdtsFilter
	{			
		public String Appt_id = "";
		public String Appt_head_id = "";
		public String Prfile_sess_id = "";
		...
		public Sd_appt_apdtsFilter cloneObject()
		{
			Sd_appt_apdtsFilter newFilter = new Sd_appt_apdtsFilter();
	...
	public final class Sd_appt_apdtsEditFilter
	{			
		...
		public Sd_appt_apdtsEditFilter cloneObject()
		{
			Sd_appt_apdtsEditFilter newEditFilter = new Sd_appt_apdtsEditFilter();
