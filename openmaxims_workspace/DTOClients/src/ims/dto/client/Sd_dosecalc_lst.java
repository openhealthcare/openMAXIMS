...
public final class Sd_dosecalc_lst implements ims.vo.ImsCloneable
{
	private static final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(Sd_dosecalc_lst.class);
	
	private Sd_dosecalc_lstFilter lastGetFilter = null;
	private final String serviceName = "SD_DOSECALC_LST";
	 ...
	 */ 
	public Sd_dosecalc_lstFilter Filter = new Sd_dosecalc_lstFilter();			
	/**
	 * Represents the filter used by the current Data Transfer Object to Insert/Update data.
	 */ 
	public Sd_dosecalc_lstEditFilter EditFilter = new Sd_dosecalc_lstEditFilter();
	/**
	 * Contains the data records for the current Data Transfer Object
	 */ 
	public Sd_dosecalc_lstCollection DataCollection = new Sd_dosecalc_lstCollection();

	/**
	 * Creates a new Sd_dosecalc_lst Data Transfer Object.
	 */ 
	public Sd_dosecalc_lst(ims.dto.Connection connection)
	{	
	 ...
	 */
	public Sd_dosecalc_lst cloneObject()
	{
		Sd_dosecalc_lst cloneObject = new Sd_dosecalc_lst(Connection);
	...
	{
		return "Sd_dosecalc_lst.imx".toLowerCase();
	}
	/**
	...
	public ims.dto.Result count()
	{
		...
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_dosecalc_lst.Count");
			
		int result = Connection.count(serviceName, encodeNASFilter());
		if(result >= 0)
			return new ims.dto.Result(result, "No error detected. The count result is held in the ID field", "DTO.Client.Sd_dosecalc_lst.Count");
	...
	*/
	...
	{	
		...
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_dosecalc_lst.Get");
	...
	*/
	...
	{						
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_dosecalc_lst.GetForUpdate");
							
		if(lastGetFilter == null)	
			return new ims.dto.Result("Last get method failed or not called", "DTO.Client.Sd_dosecalc_lst.GetForUpdate");
		...
		return new ims.dto.Result("The data was changed by another user", "DTO.Client.Sd_dosecalc_lst.GetForUpdate");
	}		
	/**
	...
	*/
	public ims.dto.Result insert()
	{
		...
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_dosecalc_lst.Insert");
					
		if(DataCollection.count() == 0)
			return new ims.dto.Result("No data to insert", "DTO.Client.Sd_dosecalc_lst.Insert");
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple object insert not allowed", "DTO.Client.Sd_dosecalc_lst.Insert");
		...
		{
			return new ims.dto.Result("Invalid record ID returned", "DTO.Client.Sd_dosecalc_lst.Insert");
		}
		
		decodeResultData();
		
		return new ims.dto.Result(recordID, "No error. The ID of the new record is in the ID field", "DTO.Client.Sd_dosecalc_lst.Insert");
	}
	/**
	...
	public ims.dto.Result executeAction(String action)
	{
		this.lastResultData = null;
		if(action.length() == 0)
			return new ims.dto.Result("Invalid action name", "DTO.Client.Sd_dosecalc_lst.ExecuteAction");
			
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_dosecalc_lst.ExecuteAction");
		
		if(DataCollection.count() == 0)
			return new ims.dto.Result("Data container is empty", "DTO.Client.Sd_dosecalc_lst.ExecuteAction");
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple objects are not allowed", "DTO.Client.Sd_dosecalc_lst.ExecuteAction");
		...
		try
		{
			return new ims.dto.Result(new Integer(Connection.getValueAt(2)).intValue(), "No error", "DTO.Client.Sd_dosecalc_lst.ExecuteAction");	
		}
		catch(NumberFormatException ex)
		{
			return new ims.dto.Result("Invalid server response", "DTO.Client.Sd_dosecalc_lst.ExecuteAction");
		}
	}
	/**
	...
	{
		if(action.length() == 0)
			return new ims.dto.Result("Invalid action name", "DTO.Client.Sd_dosecalc_lst.TransferData");
			
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_dosecalc_lst.TransferData");
		
		if(DataCollection.count() == 0)
			return new ims.dto.Result("No data to transfer", "DTO.Client.Sd_dosecalc_lst.TransferData");
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple objects not allowed", "DTO.Client.Sd_dosecalc_lst.TransferData");
	...
	{			
		...
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_dosecalc_lst.Update");
				
		if(DataCollection.count() == 0)
			return new ims.dto.Result("No data to update", "DTO.Client.Sd_dosecalc_lst.Update");	
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple object update not allowed", "DTO.Client.Sd_dosecalc_lst.Update");
	...
	{
		if(!listInProgress)
			return new ims.dto.Result("No active list running", "DTO.Client.Sd_dosecalc_lst.StopList");
	...
	{				
		logger.debug("Sd_dosecalc_lst nextList Entry");
		ims.dto.Result result = Connection.nextList(serviceName);
		if(result != null)
			return result;
		logger.debug("Sd_dosecalc_lst After NextList ");
				
		decodeNASMessage();		
		logger.debug("Sd_dosecalc_lst After decode NasMsg NextList");
		return null;
	}
	...
	{	
		...
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_dosecalc_lst.List");
							
		listInProgress = true;	
		logger.debug("Sd_dosecalc_lst Before List");
		...
		logger.debug("Sd_dosecalc_lst After List");
		...
		logger.debug("Sd_dosecalc_lst After Parse Message");
	...
	private String encodeNASFilter(Sd_dosecalc_lstFilter filter)
	{
		if(filter == null)
			return "";
	...
	private String encodeNASMessage()
	{
		...
		Sd_dosecalc_lstRecord data = (Sd_dosecalc_lstRecord)DataCollection.get(0);
	...
	private int decodeNASMessage()
	{
		...
		{
			Sd_dosecalc_lstRecord record = new Sd_dosecalc_lstRecord();
	...
	public final class Sd_dosecalc_lstCollection
	{
		private java.util.ArrayList recordCollection = new java.util.ArrayList();
		
		public int add()
		{
			Sd_dosecalc_lstRecord newRecord = new Sd_dosecalc_lstRecord();
			recordCollection.add(newRecord);
			return count() - 1;
		}
		public int add(Sd_dosecalc_lstRecord record)
		{
		...
		public Sd_dosecalc_lstRecord get(int index)
		{
			return (Sd_dosecalc_lstRecord)recordCollection.get(index);
		}
	...
	public final class Sd_dosecalc_lstRecord
	{
	...
	public final class Sd_dosecalc_lstFilter
	{			
		public String Sd_comp_plan_id = "";
		public String Activdone = "";
		public String Targetdate = "";
		...
		public Sd_dosecalc_lstFilter cloneObject()
		{
			Sd_dosecalc_lstFilter newFilter = new Sd_dosecalc_lstFilter();
	...
	public final class Sd_dosecalc_lstEditFilter
	{			
		...
		public Sd_dosecalc_lstEditFilter cloneObject()
		{
			Sd_dosecalc_lstEditFilter newEditFilter = new Sd_dosecalc_lstEditFilter();
