...
public final class Sd_aalst_pb implements ims.vo.ImsCloneable
{
	private static final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(Sd_aalst_pb.class);
	
	private Sd_aalst_pbFilter lastGetFilter = null;
	private final String serviceName = "SD_AALST_PB";
	 ...
	 */ 
	public Sd_aalst_pbFilter Filter = new Sd_aalst_pbFilter();			
	/**
	 * Represents the filter used by the current Data Transfer Object to Insert/Update data.
	 */ 
	public Sd_aalst_pbEditFilter EditFilter = new Sd_aalst_pbEditFilter();
	/**
	 * Contains the data records for the current Data Transfer Object
	 */ 
	public Sd_aalst_pbCollection DataCollection = new Sd_aalst_pbCollection();

	/**
	 * Creates a new Sd_aalst_pb Data Transfer Object.
	 */ 
	public Sd_aalst_pb(ims.dto.Connection connection)
	{	
	 ...
	 */
	public Sd_aalst_pb cloneObject()
	{
		Sd_aalst_pb cloneObject = new Sd_aalst_pb(Connection);
		...
		for(int x = 0; x < DataCollection.count(); x++)
		{
			...
			cloneObject.DataCollection.get(index).Eb_dose = DataCollection.get(x).Eb_dose;
			cloneObject.DataCollection.get(index).Eb_fractions = DataCollection.get(x).Eb_fractions;
			cloneObject.DataCollection.get(index).Eb_dur = DataCollection.get(x).Eb_dur;
			cloneObject.DataCollection.get(index).Eb_isbooked = DataCollection.get(x).Eb_isbooked;
			cloneObject.DataCollection.get(index).Eb_dose_astat = DataCollection.get(x).Eb_dose_astat;
	...
	{
		return "Sd_aalst_pb.imx".toLowerCase();
	}
	/**
	...
	public ims.dto.Result count()
	{
		...
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_aalst_pb.Count");
			
		int result = Connection.count(serviceName, encodeNASFilter());
		if(result >= 0)
			return new ims.dto.Result(result, "No error detected. The count result is held in the ID field", "DTO.Client.Sd_aalst_pb.Count");
	...
	*/
	...
	{	
		...
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_aalst_pb.Get");
	...
	*/
	...
	{						
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_aalst_pb.GetForUpdate");
							
		if(lastGetFilter == null)	
			return new ims.dto.Result("Last get method failed or not called", "DTO.Client.Sd_aalst_pb.GetForUpdate");
		...
		return new ims.dto.Result("The data was changed by another user", "DTO.Client.Sd_aalst_pb.GetForUpdate");
	}		
	/**
	...
	*/
	public ims.dto.Result insert()
	{
		...
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_aalst_pb.Insert");
					
		if(DataCollection.count() == 0)
			return new ims.dto.Result("No data to insert", "DTO.Client.Sd_aalst_pb.Insert");
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple object insert not allowed", "DTO.Client.Sd_aalst_pb.Insert");
		...
		{
			return new ims.dto.Result("Invalid record ID returned", "DTO.Client.Sd_aalst_pb.Insert");
		}
		
		decodeResultData();
		
		return new ims.dto.Result(recordID, "No error. The ID of the new record is in the ID field", "DTO.Client.Sd_aalst_pb.Insert");
	}
	/**
	...
	public ims.dto.Result executeAction(String action)
	{
		this.lastResultData = null;
		if(action.length() == 0)
			return new ims.dto.Result("Invalid action name", "DTO.Client.Sd_aalst_pb.ExecuteAction");
			
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_aalst_pb.ExecuteAction");
		
		if(DataCollection.count() == 0)
			return new ims.dto.Result("Data container is empty", "DTO.Client.Sd_aalst_pb.ExecuteAction");
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple objects are not allowed", "DTO.Client.Sd_aalst_pb.ExecuteAction");
		...
		try
		{
			return new ims.dto.Result(new Integer(Connection.getValueAt(2)).intValue(), "No error", "DTO.Client.Sd_aalst_pb.ExecuteAction");	
		}
		catch(NumberFormatException ex)
		{
			return new ims.dto.Result("Invalid server response", "DTO.Client.Sd_aalst_pb.ExecuteAction");
		}
	}
	/**
	...
	{
		if(action.length() == 0)
			return new ims.dto.Result("Invalid action name", "DTO.Client.Sd_aalst_pb.TransferData");
			
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_aalst_pb.TransferData");
		
		if(DataCollection.count() == 0)
			return new ims.dto.Result("No data to transfer", "DTO.Client.Sd_aalst_pb.TransferData");
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple objects not allowed", "DTO.Client.Sd_aalst_pb.TransferData");
	...
	{			
		...
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_aalst_pb.Update");
				
		if(DataCollection.count() == 0)
			return new ims.dto.Result("No data to update", "DTO.Client.Sd_aalst_pb.Update");	
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple object update not allowed", "DTO.Client.Sd_aalst_pb.Update");
	...
	{
		if(!listInProgress)
			return new ims.dto.Result("No active list running", "DTO.Client.Sd_aalst_pb.StopList");
	...
	{				
		logger.debug("Sd_aalst_pb nextList Entry");
		ims.dto.Result result = Connection.nextList(serviceName);
		if(result != null)
			return result;
		logger.debug("Sd_aalst_pb After NextList ");
				
		decodeNASMessage();		
		logger.debug("Sd_aalst_pb After decode NasMsg NextList");
		return null;
	}
	...
	{	
		...
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_aalst_pb.List");
							
		listInProgress = true;	
		logger.debug("Sd_aalst_pb Before List");
		...
		logger.debug("Sd_aalst_pb After List");
		...
		logger.debug("Sd_aalst_pb After Parse Message");
	...
	private String encodeNASFilter(Sd_aalst_pbFilter filter)
	{
		if(filter == null)
			return "";
		...
		if(Filter.Eb_dose != null && filter.Eb_dose.length()> 0)
		{
			if(filterString.length() > 0)
				filterString.append(ims.dto.NASMessageCodes.PAIRSEPARATOR);
			filterString.append("EB_DOSE" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + filter.Eb_dose);
		}
		
		if(Filter.Eb_fractions != null && filter.Eb_fractions.length()> 0)
		{
			if(filterString.length() > 0)
				filterString.append(ims.dto.NASMessageCodes.PAIRSEPARATOR);
			filterString.append("EB_FRACTIONS" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + filter.Eb_fractions);
		}
		
		if(Filter.Eb_dur != null && filter.Eb_dur.length()> 0)
		{
			if(filterString.length() > 0)
				filterString.append(ims.dto.NASMessageCodes.PAIRSEPARATOR);
			filterString.append("EB_DUR" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + filter.Eb_dur);
		}
		
		if(Filter.Eb_isbooked != null && filter.Eb_isbooked.length()> 0)
		{
			if(filterString.length() > 0)
				filterString.append(ims.dto.NASMessageCodes.PAIRSEPARATOR);
			filterString.append("EB_ISBOOKED" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + filter.Eb_isbooked);
		}
		
		if(Filter.Eb_dose_astat != null && filter.Eb_dose_astat.length()> 0)
		{
			if(filterString.length() > 0)
				filterString.append(ims.dto.NASMessageCodes.PAIRSEPARATOR);
			filterString.append("EB_DOSE_ASTAT" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + filter.Eb_dose_astat);
		}
	...
	private String encodeNASMessage()
	{
		...
		Sd_aalst_pbRecord data = (Sd_aalst_pbRecord)DataCollection.get(0);
		...
		if(EditFilter.IncludeEb_dose)
		{
			if(dataString.length() > 0)
				dataString.append(ims.dto.NASMessageCodes.PAIRSEPARATOR);
			dataString.append("EB_DOSE" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + Connection.encodeFieldValue(data.Eb_dose));
		}
		
		if(EditFilter.IncludeEb_fractions)
		{
			if(dataString.length() > 0)
				dataString.append(ims.dto.NASMessageCodes.PAIRSEPARATOR);
			dataString.append("EB_FRACTIONS" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + Connection.encodeFieldValue(data.Eb_fractions));
		}
		
		if(EditFilter.IncludeEb_dur)
		{
			if(dataString.length() > 0)
				dataString.append(ims.dto.NASMessageCodes.PAIRSEPARATOR);
			dataString.append("EB_DUR" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + Connection.encodeFieldValue(data.Eb_dur));
		}
		
		if(EditFilter.IncludeEb_isbooked)
		{
			if(dataString.length() > 0)
				dataString.append(ims.dto.NASMessageCodes.PAIRSEPARATOR);
			dataString.append("EB_ISBOOKED" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + Connection.encodeFieldValue(data.Eb_isbooked));
		}
		
		if(EditFilter.IncludeEb_dose_astat)
		{
			if(dataString.length() > 0)
				dataString.append(ims.dto.NASMessageCodes.PAIRSEPARATOR);
			dataString.append("EB_DOSE_ASTAT" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + Connection.encodeFieldValue(data.Eb_dose_astat));
		}
	...
	private int decodeNASMessage()
	{
		...
		{
			Sd_aalst_pbRecord record = new Sd_aalst_pbRecord();
			...
			record.Eb_dose = Connection.decodeFieldValue(Connection.getValueFor(valueItems, "EB_DOSE"));
			record.Eb_fractions = Connection.decodeFieldValue(Connection.getValueFor(valueItems, "EB_FRACTIONS"));
			record.Eb_dur = Connection.decodeFieldValue(Connection.getValueFor(valueItems, "EB_DUR"));
			record.Eb_isbooked = Connection.decodeFieldValue(Connection.getValueFor(valueItems, "EB_ISBOOKED"));
			record.Eb_dose_astat = Connection.decodeFieldValue(Connection.getValueFor(valueItems, "EB_DOSE_ASTAT"));
	...
	public final class Sd_aalst_pbCollection
	{
		private java.util.ArrayList recordCollection = new java.util.ArrayList();
		
		public int add()
		{
			Sd_aalst_pbRecord newRecord = new Sd_aalst_pbRecord();
			recordCollection.add(newRecord);
			return count() - 1;
		}
		public int add(Sd_aalst_pbRecord record)
		{
		...
		public Sd_aalst_pbRecord get(int index)
		{
			return (Sd_aalst_pbRecord)recordCollection.get(index);
		}
	...
	public final class Sd_aalst_pbRecord
	{
		public String Unid = "";
		public String Eb_dose = "";
		public String Eb_fractions = "";
		public String Eb_dur = "";
		public String Eb_isbooked = "";
		public String Eb_dose_astat = "";
	...
	public final class Sd_aalst_pbFilter
	{			
		public String Unid = "";
		public String Eb_dose = "";
		public String Eb_fractions = "";
		...
		public Sd_aalst_pbFilter cloneObject()
		{
			Sd_aalst_pbFilter newFilter = new Sd_aalst_pbFilter();
			
			newFilter.Unid = this.Unid;
			newFilter.Eb_dose = this.Eb_dose;
			newFilter.Eb_fractions = this.Eb_fractions;
			newFilter.Eb_dur = this.Eb_dur;
			newFilter.Eb_isbooked = this.Eb_isbooked;
			newFilter.Eb_dose_astat = this.Eb_dose_astat;
	...
	public final class Sd_aalst_pbEditFilter
	{			
		public boolean IncludeUnid = true;
		public boolean IncludeEb_dose = true;
		public boolean IncludeEb_fractions = true;
		public boolean IncludeEb_dur = true;
		public boolean IncludeEb_isbooked = true;
		public boolean IncludeEb_dose_astat = true;
		...
		{				
			IncludeUnid = true;
			IncludeEb_dose = true;
			IncludeEb_fractions = true;
			IncludeEb_dur = true;
			IncludeEb_isbooked = true;
			IncludeEb_dose_astat = true;
		...
		{				
			IncludeUnid = false;
			IncludeEb_dose = false;
			IncludeEb_fractions = false;
			IncludeEb_dur = false;
			IncludeEb_isbooked = false;
			IncludeEb_dose_astat = false;
		...
		public Sd_aalst_pbEditFilter cloneObject()
		{
			Sd_aalst_pbEditFilter newEditFilter = new Sd_aalst_pbEditFilter();
			
			newEditFilter.IncludeUnid = this.IncludeUnid;
			newEditFilter.IncludeEb_dose = this.IncludeEb_dose;
			newEditFilter.IncludeEb_fractions = this.IncludeEb_fractions;
			newEditFilter.IncludeEb_dur = this.IncludeEb_dur;
			newEditFilter.IncludeEb_isbooked = this.IncludeEb_isbooked;
			newEditFilter.IncludeEb_dose_astat = this.IncludeEb_dose_astat;
