...
public final class Wardlist
{
	...
	*/
	...
	private String encodeNASMessage()
	{
		...
		WardlistRecord data = (WardlistRecord)DataCollection.get(0);
	...
	private int decodeNASMessage()
	{
		...
		{
			WardlistRecord record = new WardlistRecord();
	...
	public final class WardlistCollection
	{
		private java.util.ArrayList recordCollection = new java.util.ArrayList();
		
		public int add()
		{
			WardlistRecord newRecord = new WardlistRecord();
			recordCollection.add(newRecord);
			return count() - 1;
		}
		public int add(WardlistRecord record)
		{
		...
		public WardlistRecord get(int index)
		{
			return (WardlistRecord)recordCollection.get(index);
		}
	...
	public final class WardlistRecord
	{
		public String Rsno = "";
		public String Hpcd = "";
		public String Site = "";
	...
	public final class WardlistFilter
	{			
		public String Rsno = "";
		public String Hpcd = "";
		public String Site = "";
		...
		public WardlistFilter cloneObject()
		{
			WardlistFilter newFilter = new WardlistFilter();
