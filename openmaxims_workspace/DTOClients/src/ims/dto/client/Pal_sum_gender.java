...
public final class Pal_sum_gender
{
	private Pal_sum_genderFilter lastGetFilter = null;
	private final String serviceName = "PAL_SUM_GENDER";
	 ...
	 */ 
	public Pal_sum_genderFilter Filter = new Pal_sum_genderFilter();			
	/**
	 * Represents the filter used by the current Data Transfer Object to Insert/Update data.
	 */ 
	public Pal_sum_genderEditFilter EditFilter = new Pal_sum_genderEditFilter();
	/**
	 * Contains the data records for the current Data Transfer Object
	 */ 
	public Pal_sum_genderCollection DataCollection = new Pal_sum_genderCollection();

	/**
	 * Creates a new Pal_sum_gender Data Transfer Object.
	 */ 
	public Pal_sum_gender(ims.dto.Connection connection) throws ims.dto.Exception
	{	
		if(connection == null)
	 ...
	 */
	public Pal_sum_gender cloneObject() throws ims.dto.Exception
	{
		Pal_sum_gender cloneObject = new Pal_sum_gender(Connection);
		...
		for(int x = 0; x < DataCollection.count(); x++)
		{
			...
			cloneObject.DataCollection.get(index).Pal_sum_gender_id = DataCollection.get(x).Pal_sum_gender_id;
	...
	{
		return "Pal_sum_gender.imx".toLowerCase();
	}
	/**
	...
	public ims.dto.Result count()
	{
		...
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Pal_sum_gender.Count");
			
		int result = Connection.count(serviceName, encodeNASFilter());
		if(result >= 0)
			return new ims.dto.Result(result, "No error detected. The count result is held in the ID field", "DTO.Client.Pal_sum_gender.Count");
	...
	*/
	...
	{	
		...
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Pal_sum_gender.Get");
	...
	*/
	...
	{						
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Pal_sum_gender.GetForUpdate");
							
		if(lastGetFilter == null)	
			return new ims.dto.Result("Last get method failed or not called", "DTO.Client.Pal_sum_gender.GetForUpdate");
		...
		return new ims.dto.Result("The data was changed by another user", "DTO.Client.Pal_sum_gender.GetForUpdate");
	}		
	/**
	...
	*/
	public ims.dto.Result insert()
	{
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Pal_sum_gender.Insert");
					
		if(DataCollection.count() == 0)
			return new ims.dto.Result("No data to insert", "DTO.Client.Pal_sum_gender.Insert");
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple object insert not allowed", "DTO.Client.Pal_sum_gender.Insert");
		...
		{
			return new ims.dto.Result("Invalid record ID returned", "DTO.Client.Pal_sum_gender.Insert");
		}
		
		return new ims.dto.Result(recordID, "No error. The ID of the new record is in the ID field", "DTO.Client.Pal_sum_gender.Insert");
	}
	/**
	...
	{
		if(action.length() == 0)
			return new ims.dto.Result("Invalid action name", "DTO.Client.Pal_sum_gender.ExecuteAction");
			
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Pal_sum_gender.ExecuteAction");
		
		if(DataCollection.count() == 0)
			return new ims.dto.Result("Data container is empty", "DTO.Client.Pal_sum_gender.ExecuteAction");
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple objects are not allowed", "DTO.Client.Pal_sum_gender.ExecuteAction");
		...
		try
		{
			return new ims.dto.Result(new Integer(Connection.getValueAt(2)).intValue(), "No error", "DTO.Client.Pal_sum_gender.ExecuteAction");	
		}
		catch(NumberFormatException ex)
		{
			return new ims.dto.Result("Invalid server response", "DTO.Client.Pal_sum_gender.ExecuteAction");
		}
	}
	/**
	...
	{
		if(action.length() == 0)
			return new ims.dto.Result("Invalid action name", "DTO.Client.Pal_sum_gender.TransferData");
			
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Pal_sum_gender.TransferData");
		
		if(DataCollection.count() == 0)
			return new ims.dto.Result("No data to transfer", "DTO.Client.Pal_sum_gender.TransferData");
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple objects not allowed", "DTO.Client.Pal_sum_gender.TransferData");
	...
	{			
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Pal_sum_gender.Update");
				
		if(DataCollection.count() == 0)
			return new ims.dto.Result("No data to update", "DTO.Client.Pal_sum_gender.Update");	
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple object update not allowed", "DTO.Client.Pal_sum_gender.Update");
	...
	{
		if(!listInProgress)
			return new ims.dto.Result("No active list running", "DTO.Client.Pal_sum_gender.StopList");
	...
	{	
		...
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Pal_sum_gender.List");
	...
	private String encodeNASFilter(Pal_sum_genderFilter filter)
	{
		if(filter == null)
			return "";
		...
		if(Filter.Pal_sum_gender_id != null && filter.Pal_sum_gender_id.length()> 0)
		{
			if(filterString.length() > 0)
				filterString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			filterString += "PAL_SUM_GENDER_ID" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + filter.Pal_sum_gender_id;
		}
	...
	private String encodeNASMessage()
	{
		...
		Pal_sum_genderRecord data = (Pal_sum_genderRecord)DataCollection.get(0);
		
		if(EditFilter.IncludePal_sum_gender_id)
		{
			if(dataString.length() > 0)
				dataString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			dataString += "PAL_SUM_GENDER_ID" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + Connection.encodeFieldValue(data.Pal_sum_gender_id);
		}
	...
	private int decodeNASMessage()
	{
		...
		{
			Pal_sum_genderRecord record = new Pal_sum_genderRecord();
			String[] valueItems = Connection.splitResponseItem(items[x]);
			
			record.Pal_sum_gender_id = Connection.decodeFieldValue(Connection.getValueFor(valueItems, "PAL_SUM_GENDER_ID"));
	...
	public final class Pal_sum_genderCollection
	{
		private java.util.ArrayList recordCollection = new java.util.ArrayList();
		
		public int add()
		{
			Pal_sum_genderRecord newRecord = new Pal_sum_genderRecord();
			recordCollection.add(newRecord);
			return count() - 1;
		}
		public int add(Pal_sum_genderRecord record)
		{
		...
		public Pal_sum_genderRecord get(int index)
		{
			return (Pal_sum_genderRecord)recordCollection.get(index);
		}
	...
	public final class Pal_sum_genderRecord
	{
		public String Pal_sum_gender_id = "";
		public String Pkey = "";
		public String Rdat = "";
		public String Rtim = "";
		public String Rhcp = "";
	...
	public final class Pal_sum_genderFilter
	{			
		public String Pal_sum_gender_id = "";
		public String Pkey = "";
		public String Rdat = "";
		...
		public Pal_sum_genderFilter cloneObject()
		{
			Pal_sum_genderFilter newFilter = new Pal_sum_genderFilter();
			
			newFilter.Pal_sum_gender_id = this.Pal_sum_gender_id;
	...
	public final class Pal_sum_genderEditFilter
	{			
		public boolean IncludePal_sum_gender_id = true;
		...
		{				
			IncludePal_sum_gender_id = false;
			IncludePkey = false;
			IncludeRdat = false;
			IncludeRtim = false;
			IncludeRhcp = false;
		...
		public Pal_sum_genderEditFilter cloneObject()
		{
			Pal_sum_genderEditFilter newEditFilter = new Pal_sum_genderEditFilter();
			
			newEditFilter.IncludePal_sum_gender_id = this.IncludePal_sum_gender_id;
