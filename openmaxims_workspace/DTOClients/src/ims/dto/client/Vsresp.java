...
public final class Vsresp implements ims.vo.ImsCloneable
{
	private VsrespFilter lastGetFilter = null;
	private final String serviceName = "VSRESP";
	 ...
	 */ 
	public VsrespFilter Filter = new VsrespFilter();			
	/**
	 * Represents the filter used by the current Data Transfer Object to Insert/Update data.
	 */ 
	public VsrespEditFilter EditFilter = new VsrespEditFilter();
	/**
	 * Contains the data records for the current Data Transfer Object
	 */ 
	public VsrespCollection DataCollection = new VsrespCollection();

	/**
	 * Creates a new Vsresp Data Transfer Object.
	 */ 
	public Vsresp(ims.dto.Connection connection)
	{	
	 ...
	 */
	public Vsresp cloneObject()
	{
		Vsresp cloneObject = new Vsresp(Connection);
		...
		for(int x = 0; x < DataCollection.count(); x++)
		{
			...
			cloneObject.DataCollection.get(index).Resp = DataCollection.get(x).Resp;
	...
	public ims.dto.Result count()
	{
		...
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Vsresp.Count");
			
		int result = Connection.count(serviceName, encodeNASFilter());
		if(result >= 0)
			return new ims.dto.Result(result, "No error detected. The count result is held in the ID field", "DTO.Client.Vsresp.Count");
	...
	*/
	...
	{	
		...
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Vsresp.Get");
	...
	*/
	...
	{						
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Vsresp.GetForUpdate");
							
		if(lastGetFilter == null)	
			return new ims.dto.Result("Last get method failed or not called", "DTO.Client.Vsresp.GetForUpdate");
		...
		return new ims.dto.Result("The data was changed by another user", "DTO.Client.Vsresp.GetForUpdate");
	}		
	/**
	...
	*/
	public ims.dto.Result insert()
	{
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Vsresp.Insert");
					
		if(DataCollection.count() == 0)
			return new ims.dto.Result("No data to insert", "DTO.Client.Vsresp.Insert");
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple object insert not allowed", "DTO.Client.Vsresp.Insert");
		...
		{
			return new ims.dto.Result("Invalid record ID returned", "DTO.Client.Vsresp.Insert");
		}
		
		return new ims.dto.Result(recordID, "No error. The ID of the new record is in the ID field", "DTO.Client.Vsresp.Insert");
	}
	/**
	...
	{
		if(action.length() == 0)
			return new ims.dto.Result("Invalid action name", "DTO.Client.Vsresp.ExecuteAction");
			
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Vsresp.ExecuteAction");
		
		if(DataCollection.count() == 0)
			return new ims.dto.Result("Data container is empty", "DTO.Client.Vsresp.ExecuteAction");
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple objects are not allowed", "DTO.Client.Vsresp.ExecuteAction");
		...
		try
		{
			return new ims.dto.Result(new Integer(Connection.getValueAt(2)).intValue(), "No error", "DTO.Client.Vsresp.ExecuteAction");	
		}
		catch(NumberFormatException ex)
		{
			return new ims.dto.Result("Invalid server response", "DTO.Client.Vsresp.ExecuteAction");
		}
	}
	/**
	...
	{
		if(action.length() == 0)
			return new ims.dto.Result("Invalid action name", "DTO.Client.Vsresp.TransferData");
			
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Vsresp.TransferData");
		
		if(DataCollection.count() == 0)
			return new ims.dto.Result("No data to transfer", "DTO.Client.Vsresp.TransferData");
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple objects not allowed", "DTO.Client.Vsresp.TransferData");
	...
	{			
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Vsresp.Update");
				
		if(DataCollection.count() == 0)
			return new ims.dto.Result("No data to update", "DTO.Client.Vsresp.Update");	
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple object update not allowed", "DTO.Client.Vsresp.Update");
	...
	{
		if(!listInProgress)
			return new ims.dto.Result("No active list running", "DTO.Client.Vsresp.StopList");
	...
	{	
		...
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Vsresp.List");
	...
	private String encodeNASFilter(VsrespFilter filter)
	{
		if(filter == null)
			return "";
		...
		if(Filter.Resp != null && filter.Resp.length()> 0)
		{
			if(filterString.length() > 0)
				filterString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			filterString += "RESP" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + filter.Resp;
		}
	...
	private String encodeNASMessage()
	{
		...
		VsrespRecord data = (VsrespRecord)DataCollection.get(0);
		...
		if(EditFilter.IncludeResp)
		{
			if(dataString.length() > 0)
				dataString += ims.dto.NASMessageCodes.PAIRSEPARATOR;
			dataString += "RESP" + ims.dto.NASMessageCodes.ATTRIBUTEVALUESEPARATOR + Connection.encodeFieldValue(data.Resp);
		}
	...
	private int decodeNASMessage()
	{
		...
		{
			VsrespRecord record = new VsrespRecord();
			...
			record.Resp = Connection.decodeFieldValue(Connection.getValueFor(valueItems, "RESP"));
	...
	public final class VsrespCollection
	{
		private java.util.ArrayList recordCollection = new java.util.ArrayList();
		
		public int add()
		{
			VsrespRecord newRecord = new VsrespRecord();
			recordCollection.add(newRecord);
			return count() - 1;
		}
		public int add(VsrespRecord record)
		{
		...
		public VsrespRecord get(int index)
		{
			return (VsrespRecord)recordCollection.get(index);
		}
	...
	public final class VsrespRecord
	{
		public String Unid = "";
		public String Pkey = "";
		public String Type = "";
	...
	public final class VsrespFilter
	{			
		public String Unid = "";
		public String Pkey = "";
		public String Type = "";
		...
		public VsrespFilter cloneObject()
		{
			VsrespFilter newFilter = new VsrespFilter();
			...
			newFilter.Resp = this.Resp;
			newFilter.Active_flag = this.Active_flag;
			
			return newFilter;
		}
	}
	public final class VsrespEditFilter
	{			
		...
		public boolean IncludeResp = true;
		...
		public VsrespEditFilter cloneObject()
		{
			VsrespEditFilter newEditFilter = new VsrespEditFilter();
			...
			newEditFilter.IncludeResp = this.IncludeResp;
