...
public final class Sd_apptdts_sur implements ims.vo.ImsCloneable
{
	private static final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(Sd_apptdts_sur.class);
	
	private Sd_apptdts_surFilter lastGetFilter = null;
	private final String serviceName = "SD_APPTDTS_SUR";
	 ...
	 */ 
	public Sd_apptdts_surFilter Filter = new Sd_apptdts_surFilter();			
	/**
	 * Represents the filter used by the current Data Transfer Object to Insert/Update data.
	 */ 
	public Sd_apptdts_surEditFilter EditFilter = new Sd_apptdts_surEditFilter();
	/**
	 * Contains the data records for the current Data Transfer Object
	 */ 
	public Sd_apptdts_surCollection DataCollection = new Sd_apptdts_surCollection();

	/**
	 * Creates a new Sd_apptdts_sur Data Transfer Object.
	 */ 
	public Sd_apptdts_sur(ims.dto.Connection connection)
	{	
	 ...
	 */
	public Sd_apptdts_sur cloneObject()
	{
		Sd_apptdts_sur cloneObject = new Sd_apptdts_sur(Connection);
	...
	{
		return "Sd_apptdts_sur.imx".toLowerCase();
	}
	/**
	...
	public ims.dto.Result count()
	{
		...
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_apptdts_sur.Count");
			
		int result = Connection.count(serviceName, encodeNASFilter());
		if(result >= 0)
			return new ims.dto.Result(result, "No error detected. The count result is held in the ID field", "DTO.Client.Sd_apptdts_sur.Count");
	...
	*/
	...
	{	
		...
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_apptdts_sur.Get");
	...
	*/
	...
	{						
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_apptdts_sur.GetForUpdate");
							
		if(lastGetFilter == null)	
			return new ims.dto.Result("Last get method failed or not called", "DTO.Client.Sd_apptdts_sur.GetForUpdate");
		...
		return new ims.dto.Result("The data was changed by another user", "DTO.Client.Sd_apptdts_sur.GetForUpdate");
	}		
	/**
	...
	*/
	public ims.dto.Result insert()
	{
		...
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_apptdts_sur.Insert");
					
		if(DataCollection.count() == 0)
			return new ims.dto.Result("No data to insert", "DTO.Client.Sd_apptdts_sur.Insert");
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple object insert not allowed", "DTO.Client.Sd_apptdts_sur.Insert");
		...
		{
			return new ims.dto.Result("Invalid record ID returned", "DTO.Client.Sd_apptdts_sur.Insert");
		}
		
		decodeResultData();
		
		return new ims.dto.Result(recordID, "No error. The ID of the new record is in the ID field", "DTO.Client.Sd_apptdts_sur.Insert");
	}
	/**
	...
	public ims.dto.Result executeAction(String action)
	{
		this.lastResultData = null;
		if(action.length() == 0)
			return new ims.dto.Result("Invalid action name", "DTO.Client.Sd_apptdts_sur.ExecuteAction");
			
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_apptdts_sur.ExecuteAction");
		
		if(DataCollection.count() == 0)
			return new ims.dto.Result("Data container is empty", "DTO.Client.Sd_apptdts_sur.ExecuteAction");
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple objects are not allowed", "DTO.Client.Sd_apptdts_sur.ExecuteAction");
		...
		try
		{
			return new ims.dto.Result(new Integer(Connection.getValueAt(2)).intValue(), "No error", "DTO.Client.Sd_apptdts_sur.ExecuteAction");	
		}
		catch(NumberFormatException ex)
		{
			return new ims.dto.Result("Invalid server response", "DTO.Client.Sd_apptdts_sur.ExecuteAction");
		}
	}
	/**
	...
	{
		if(action.length() == 0)
			return new ims.dto.Result("Invalid action name", "DTO.Client.Sd_apptdts_sur.TransferData");
			
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_apptdts_sur.TransferData");
		
		if(DataCollection.count() == 0)
			return new ims.dto.Result("No data to transfer", "DTO.Client.Sd_apptdts_sur.TransferData");
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple objects not allowed", "DTO.Client.Sd_apptdts_sur.TransferData");
	...
	{			
		...
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_apptdts_sur.Update");
				
		if(DataCollection.count() == 0)
			return new ims.dto.Result("No data to update", "DTO.Client.Sd_apptdts_sur.Update");	
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple object update not allowed", "DTO.Client.Sd_apptdts_sur.Update");
	...
	{
		if(!listInProgress)
			return new ims.dto.Result("No active list running", "DTO.Client.Sd_apptdts_sur.StopList");
	...
	{				
		logger.debug("Sd_apptdts_sur nextList Entry");
		ims.dto.Result result = Connection.nextList(serviceName);
		if(result != null)
			return result;
		logger.debug("Sd_apptdts_sur After NextList ");
				
		decodeNASMessage();		
		logger.debug("Sd_apptdts_sur After decode NasMsg NextList");
		return null;
	}
	...
	{	
		...
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_apptdts_sur.List");
							
		listInProgress = true;	
		logger.debug("Sd_apptdts_sur Before List");
		...
		logger.debug("Sd_apptdts_sur After List");
		...
		logger.debug("Sd_apptdts_sur After Parse Message");
	...
	private String encodeNASFilter(Sd_apptdts_surFilter filter)
	{
		if(filter == null)
			return "";
	...
	private String encodeNASMessage()
	{
		...
		Sd_apptdts_surRecord data = (Sd_apptdts_surRecord)DataCollection.get(0);
	...
	private int decodeNASMessage()
	{
		...
		{
			Sd_apptdts_surRecord record = new Sd_apptdts_surRecord();
	...
	public final class Sd_apptdts_surCollection
	{
		private java.util.ArrayList recordCollection = new java.util.ArrayList();
		
		public int add()
		{
			Sd_apptdts_surRecord newRecord = new Sd_apptdts_surRecord();
			recordCollection.add(newRecord);
			return count() - 1;
		}
		public int add(Sd_apptdts_surRecord record)
		{
		...
		public Sd_apptdts_surRecord get(int index)
		{
			return (Sd_apptdts_surRecord)recordCollection.get(index);
		}
	...
	public final class Sd_apptdts_surRecord
	{
	...
	public final class Sd_apptdts_surFilter
	{			
		public String Appt_id = "";
		public String Appt_head_id = "";
		public String Prfile_sess_id = "";
		...
		public Sd_apptdts_surFilter cloneObject()
		{
			Sd_apptdts_surFilter newFilter = new Sd_apptdts_surFilter();
	...
	public final class Sd_apptdts_surEditFilter
	{			
		...
		public Sd_apptdts_surEditFilter cloneObject()
		{
			Sd_apptdts_surEditFilter newEditFilter = new Sd_apptdts_surEditFilter();
