...
public final class Dojallergy
{
	private DojallergyFilter lastGetFilter = null;
	private final String serviceName = "DOJALLERGY";
	 ...
	 */ 
	public DojallergyFilter Filter = new DojallergyFilter();			
	/**
	 * Represents the filter used by the current Data Transfer Object to Insert/Update data.
	 */ 
	public DojallergyEditFilter EditFilter = new DojallergyEditFilter();
	/**
	 * Contains the data records for the current Data Transfer Object
	 */ 
	public DojallergyCollection DataCollection = new DojallergyCollection();

	/**
	 * Creates a new Dojallergy Data Transfer Object.
	 */ 
	public Dojallergy(ims.dto.Connection connection) throws ims.dto.Exception
	{	
		if(connection == null)
	 ...
	 */
	public Dojallergy cloneObject() throws ims.dto.Exception
	{
		Dojallergy cloneObject = new Dojallergy(Connection);
	...
	{
		return "Dojallergy.imx".toLowerCase();
	}
	/**
	...
	public ims.dto.Result count()
	{
		...
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Dojallergy.Count");
			
		int result = Connection.count(serviceName, encodeNASFilter());
		if(result >= 0)
			return new ims.dto.Result(result, "No error detected. The count result is held in the ID field", "DTO.Client.Dojallergy.Count");
	...
	*/
	...
	{	
		...
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Dojallergy.Get");
	...
	*/
	...
	{						
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Dojallergy.GetForUpdate");
							
		if(lastGetFilter == null)	
			return new ims.dto.Result("Last get method failed or not called", "DTO.Client.Dojallergy.GetForUpdate");
		...
		return new ims.dto.Result("The data was changed by another user", "DTO.Client.Dojallergy.GetForUpdate");
	}		
	/**
	...
	*/
	public ims.dto.Result insert()
	{
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Dojallergy.Insert");
					
		if(DataCollection.count() == 0)
			return new ims.dto.Result("No data to insert", "DTO.Client.Dojallergy.Insert");
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple object insert not allowed", "DTO.Client.Dojallergy.Insert");
		...
		{
			return new ims.dto.Result("Invalid record ID returned", "DTO.Client.Dojallergy.Insert");
		}
		
		return new ims.dto.Result(recordID, "No error. The ID of the new record is in the ID field", "DTO.Client.Dojallergy.Insert");
	}
	/**
	...
	{
		if(action.length() == 0)
			return new ims.dto.Result("Invalid action name", "DTO.Client.Dojallergy.ExecuteAction");
			
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Dojallergy.ExecuteAction");
		
		if(DataCollection.count() == 0)
			return new ims.dto.Result("Data container is empty", "DTO.Client.Dojallergy.ExecuteAction");
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple objects are not allowed", "DTO.Client.Dojallergy.ExecuteAction");
		...
		try
		{
			return new ims.dto.Result(new Integer(Connection.getValueAt(2)).intValue(), "No error", "DTO.Client.Dojallergy.ExecuteAction");	
		}
		catch(NumberFormatException ex)
		{
			return new ims.dto.Result("Invalid server response", "DTO.Client.Dojallergy.ExecuteAction");
		}
	}
	/**
	...
	{
		if(action.length() == 0)
			return new ims.dto.Result("Invalid action name", "DTO.Client.Dojallergy.TransferData");
			
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Dojallergy.TransferData");
		
		if(DataCollection.count() == 0)
			return new ims.dto.Result("No data to transfer", "DTO.Client.Dojallergy.TransferData");
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple objects not allowed", "DTO.Client.Dojallergy.TransferData");
	...
	{			
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Dojallergy.Update");
				
		if(DataCollection.count() == 0)
			return new ims.dto.Result("No data to update", "DTO.Client.Dojallergy.Update");	
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple object update not allowed", "DTO.Client.Dojallergy.Update");
	...
	{
		if(!listInProgress)
			return new ims.dto.Result("No active list running", "DTO.Client.Dojallergy.StopList");
	...
	{	
		...
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Dojallergy.List");
	...
	private String encodeNASFilter(DojallergyFilter filter)
	{
		if(filter == null)
			return "";
	...
	private String encodeNASMessage()
	{
		...
		DojallergyRecord data = (DojallergyRecord)DataCollection.get(0);
	...
	private int decodeNASMessage()
	{
		...
		{
			DojallergyRecord record = new DojallergyRecord();
	...
	public final class DojallergyCollection
	{
		private java.util.ArrayList recordCollection = new java.util.ArrayList();
		
		public int add()
		{
			DojallergyRecord newRecord = new DojallergyRecord();
			recordCollection.add(newRecord);
			return count() - 1;
		}
		public int add(DojallergyRecord record)
		{
		...
		public DojallergyRecord get(int index)
		{
			return (DojallergyRecord)recordCollection.get(index);
		}
	...
	public final class DojallergyRecord
	{
		public String Unid = "";
		public String Pkey = "";
		public String Ahid = "";
	...
	public final class DojallergyFilter
	{			
		public String Unid = "";
		public String Pkey = "";
		public String Ahid = "";
		...
		public DojallergyFilter cloneObject()
		{
			DojallergyFilter newFilter = new DojallergyFilter();
	...
	public final class DojallergyEditFilter
	{			
		...
		public DojallergyEditFilter cloneObject()
		{
			DojallergyEditFilter newEditFilter = new DojallergyEditFilter();
