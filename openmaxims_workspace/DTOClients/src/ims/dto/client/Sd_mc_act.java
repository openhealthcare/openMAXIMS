...
public final class Sd_mc_act implements ims.vo.ImsCloneable
{
	private static final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger(Sd_mc_act.class);
	
	private Sd_mc_actFilter lastGetFilter = null;
	private final String serviceName = "SD_MC_ACT";
	 ...
	 */ 
	public Sd_mc_actFilter Filter = new Sd_mc_actFilter();			
	/**
	 * Represents the filter used by the current Data Transfer Object to Insert/Update data.
	 */ 
	public Sd_mc_actEditFilter EditFilter = new Sd_mc_actEditFilter();
	/**
	 * Contains the data records for the current Data Transfer Object
	 */ 
	public Sd_mc_actCollection DataCollection = new Sd_mc_actCollection();

	/**
	 * Creates a new Sd_mc_act Data Transfer Object.
	 */ 
	public Sd_mc_act(ims.dto.Connection connection)
	{	
	 ...
	 */
	public Sd_mc_act cloneObject()
	{
		Sd_mc_act cloneObject = new Sd_mc_act(Connection);
	...
	{
		return "Sd_mc_act.imx".toLowerCase();
	}
	/**
	...
	public ims.dto.Result count()
	{
		...
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_mc_act.Count");
			
		int result = Connection.count(serviceName, encodeNASFilter());
		if(result >= 0)
			return new ims.dto.Result(result, "No error detected. The count result is held in the ID field", "DTO.Client.Sd_mc_act.Count");
	...
	*/
	...
	{	
		...
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_mc_act.Get");
	...
	*/
	...
	{						
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_mc_act.GetForUpdate");
							
		if(lastGetFilter == null)	
			return new ims.dto.Result("Last get method failed or not called", "DTO.Client.Sd_mc_act.GetForUpdate");
		...
		return new ims.dto.Result("The data was changed by another user", "DTO.Client.Sd_mc_act.GetForUpdate");
	}		
	/**
	...
	*/
	public ims.dto.Result insert()
	{
		...
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_mc_act.Insert");
					
		if(DataCollection.count() == 0)
			return new ims.dto.Result("No data to insert", "DTO.Client.Sd_mc_act.Insert");
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple object insert not allowed", "DTO.Client.Sd_mc_act.Insert");
		...
		{
			return new ims.dto.Result("Invalid record ID returned", "DTO.Client.Sd_mc_act.Insert");
		}
		
		decodeResultData();
		
		return new ims.dto.Result(recordID, "No error. The ID of the new record is in the ID field", "DTO.Client.Sd_mc_act.Insert");
	}
	/**
	...
	public ims.dto.Result executeAction(String action)
	{
		this.lastResultData = null;
		if(action.length() == 0)
			return new ims.dto.Result("Invalid action name", "DTO.Client.Sd_mc_act.ExecuteAction");
			
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_mc_act.ExecuteAction");
		
		if(DataCollection.count() == 0)
			return new ims.dto.Result("Data container is empty", "DTO.Client.Sd_mc_act.ExecuteAction");
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple objects are not allowed", "DTO.Client.Sd_mc_act.ExecuteAction");
		...
		try
		{
			return new ims.dto.Result(new Integer(Connection.getValueAt(2)).intValue(), "No error", "DTO.Client.Sd_mc_act.ExecuteAction");	
		}
		catch(NumberFormatException ex)
		{
			return new ims.dto.Result("Invalid server response", "DTO.Client.Sd_mc_act.ExecuteAction");
		}
	}
	/**
	...
	{
		if(action.length() == 0)
			return new ims.dto.Result("Invalid action name", "DTO.Client.Sd_mc_act.TransferData");
			
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_mc_act.TransferData");
		
		if(DataCollection.count() == 0)
			return new ims.dto.Result("No data to transfer", "DTO.Client.Sd_mc_act.TransferData");
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple objects not allowed", "DTO.Client.Sd_mc_act.TransferData");
	...
	{			
		...
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_mc_act.Update");
				
		if(DataCollection.count() == 0)
			return new ims.dto.Result("No data to update", "DTO.Client.Sd_mc_act.Update");	
			
		if(DataCollection.count() > 1)
			return new ims.dto.Result("Multiple object update not allowed", "DTO.Client.Sd_mc_act.Update");
	...
	{
		if(!listInProgress)
			return new ims.dto.Result("No active list running", "DTO.Client.Sd_mc_act.StopList");
	...
	{				
		logger.debug("Sd_mc_act nextList Entry");
		ims.dto.Result result = Connection.nextList(serviceName);
		if(result != null)
			return result;
		logger.debug("Sd_mc_act After NextList ");
				
		decodeNASMessage();		
		logger.debug("Sd_mc_act After decode NasMsg NextList");
		return null;
	}
	...
	{	
		...
		ims.dto.Result reLoginResult = Connection.reLogin();
		if(reLoginResult != null)
			return new ims.dto.Result(reLoginResult.getMessage(), "DTO.Client.Sd_mc_act.List");
							
		listInProgress = true;	
		logger.debug("Sd_mc_act Before List");
		...
		logger.debug("Sd_mc_act After List");
		...
		logger.debug("Sd_mc_act After Parse Message");
	...
	private String encodeNASFilter(Sd_mc_actFilter filter)
	{
		if(filter == null)
			return "";
	...
	private String encodeNASMessage()
	{
		...
		Sd_mc_actRecord data = (Sd_mc_actRecord)DataCollection.get(0);
	...
	private int decodeNASMessage()
	{
		...
		{
			Sd_mc_actRecord record = new Sd_mc_actRecord();
	...
	public final class Sd_mc_actCollection
	{
		private java.util.ArrayList recordCollection = new java.util.ArrayList();
		
		public int add()
		{
			Sd_mc_actRecord newRecord = new Sd_mc_actRecord();
			recordCollection.add(newRecord);
			return count() - 1;
		}
		public int add(Sd_mc_actRecord record)
		{
		...
		public Sd_mc_actRecord get(int index)
		{
			return (Sd_mc_actRecord)recordCollection.get(index);
		}
	...
	public final class Sd_mc_actRecord
	{
		public String Mc_id = "";
	...
	public final class Sd_mc_actFilter
	{			
		public String Mc_id = "";
		public String Action_id = "";
		public String Activity_id = "";
		...
		public Sd_mc_actFilter cloneObject()
		{
			Sd_mc_actFilter newFilter = new Sd_mc_actFilter();
	...
	public final class Sd_mc_actEditFilter
	{			
		...
		public Sd_mc_actEditFilter cloneObject()
		{
			Sd_mc_actEditFilter newEditFilter = new Sd_mc_actEditFilter();
