 ...
 */
public class NeuroInterpretShortVo extends ims.medical.vo.NeuInterpretRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public NeuroInterpretShortVo()
	{
	}
	public NeuroInterpretShortVo(Integer id, int version)
	{
		super(id, version);
	}
	public NeuroInterpretShortVo(ims.generalmedical.vo.beans.NeuroInterpretShortVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.generalmedical.vo.beans.NeuroInterpretShortVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.generalmedical.vo.beans.NeuroInterpretShortVoBean bean = null;
		if(map != null)
			bean = (ims.generalmedical.vo.beans.NeuroInterpretShortVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.generalmedical.vo.beans.NeuroInterpretShortVoBean();
	...
	public Object clone()
	{
		...
		NeuroInterpretShortVo clone = new NeuroInterpretShortVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(NeuroInterpretShortVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A NeuroInterpretShortVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((NeuroInterpretShortVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((NeuroInterpretShortVo)obj).getBoId());
	}
