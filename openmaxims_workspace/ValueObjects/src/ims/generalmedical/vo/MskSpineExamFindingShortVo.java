 ...
 */
public class MskSpineExamFindingShortVo extends ims.medical.vo.MskSpineExamRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public MskSpineExamFindingShortVo()
	{
	}
	public MskSpineExamFindingShortVo(Integer id, int version)
	{
		super(id, version);
	}
	public MskSpineExamFindingShortVo(ims.generalmedical.vo.beans.MskSpineExamFindingShortVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.generalmedical.vo.beans.MskSpineExamFindingShortVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.generalmedical.vo.beans.MskSpineExamFindingShortVoBean bean = null;
		if(map != null)
			bean = (ims.generalmedical.vo.beans.MskSpineExamFindingShortVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.generalmedical.vo.beans.MskSpineExamFindingShortVoBean();
	...
	public Object clone()
	{
		...
		MskSpineExamFindingShortVo clone = new MskSpineExamFindingShortVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(MskSpineExamFindingShortVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A MskSpineExamFindingShortVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		MskSpineExamFindingShortVo compareObj = (MskSpineExamFindingShortVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
