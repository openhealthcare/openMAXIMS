 ...
 */
public class NeuroReflexesShortVo extends ims.medical.vo.NeuExamReflxsRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public NeuroReflexesShortVo()
	{
	}
	public NeuroReflexesShortVo(Integer id, int version)
	{
		super(id, version);
	}
	public NeuroReflexesShortVo(ims.generalmedical.vo.beans.NeuroReflexesShortVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.generalmedical.vo.beans.NeuroReflexesShortVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.generalmedical.vo.beans.NeuroReflexesShortVoBean bean = null;
		if(map != null)
			bean = (ims.generalmedical.vo.beans.NeuroReflexesShortVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.generalmedical.vo.beans.NeuroReflexesShortVoBean();
	...
	public Object clone()
	{
		...
		NeuroReflexesShortVo clone = new NeuroReflexesShortVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(NeuroReflexesShortVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A NeuroReflexesShortVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		NeuroReflexesShortVo compareObj = (NeuroReflexesShortVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
