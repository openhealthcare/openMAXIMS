 ...
 */
public class NeuroMotorFindingsShortVo extends ims.medical.vo.NeuExamMotorRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public NeuroMotorFindingsShortVo()
	{
	}
	public NeuroMotorFindingsShortVo(Integer id, int version)
	{
		super(id, version);
	}
	public NeuroMotorFindingsShortVo(ims.generalmedical.vo.beans.NeuroMotorFindingsShortVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.generalmedical.vo.beans.NeuroMotorFindingsShortVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.generalmedical.vo.beans.NeuroMotorFindingsShortVoBean bean = null;
		if(map != null)
			bean = (ims.generalmedical.vo.beans.NeuroMotorFindingsShortVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.generalmedical.vo.beans.NeuroMotorFindingsShortVoBean();
	...
	public Object clone()
	{
		...
		NeuroMotorFindingsShortVo clone = new NeuroMotorFindingsShortVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(NeuroMotorFindingsShortVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A NeuroMotorFindingsShortVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		NeuroMotorFindingsShortVo compareObj = (NeuroMotorFindingsShortVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
