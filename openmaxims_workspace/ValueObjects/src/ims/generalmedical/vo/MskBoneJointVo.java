 ...
 */
public class MskBoneJointVo extends ims.medical.vo.MskExamJointBonesRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public MskBoneJointVo()
	{
	}
	public MskBoneJointVo(Integer id, int version)
	{
		super(id, version);
	}
	public MskBoneJointVo(ims.generalmedical.vo.beans.MskBoneJointVoBean bean)
	{
		this.id = bean.getId();
		...
		this.jointbonedetail = ims.generalmedical.vo.MskExamJointBonesDetailVoCollection.buildFromBeanCollection(bean.getJointBoneDetail());
		this.carecontext = bean.getCareContext() == null ? null : bean.getCareContext().buildVo();
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.generalmedical.vo.beans.MskBoneJointVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.generalmedical.vo.beans.MskBoneJointVoBean bean = null;
		if(map != null)
			bean = (ims.generalmedical.vo.beans.MskBoneJointVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.generalmedical.vo.beans.MskBoneJointVoBean();
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("JOINTBONEDETAIL"))
			return getJointBoneDetail();
	...
	public boolean getJointBoneDetailIsNotNull()
	{
		return this.jointbonedetail != null;
	}
	public ims.generalmedical.vo.MskExamJointBonesDetailVoCollection getJointBoneDetail()
	{
		return this.jointbonedetail;
	}
	public void setJointBoneDetail(ims.generalmedical.vo.MskExamJointBonesDetailVoCollection value)
	{
		this.isValidated = false;
		this.jointbonedetail = value;
	}
	...
	public boolean isValidated()
	{
		...
		if(this.jointbonedetail != null)
		{
			if(!this.jointbonedetail.isValidated())
			{
				this.isBusy = false;
				return false;
			}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.authoringcp == null)
			listOfErrors.add("Recording HCP is a mandatory Field");
		if(this.authoringcp != null)
		{
		...
		if(this.authoringdatetime == null)
			listOfErrors.add("Recording Date and Time is a mandatory Field");
		if(this.jointbonedetail != null)
		{
			String[] listOfOtherErrors = this.jointbonedetail.validate();
			if(listOfOtherErrors != null)
			{
				for(int x = 0; x < listOfOtherErrors.length; x++)
				{
	...
	public Object clone()
	{
		...
		MskBoneJointVo clone = new MskBoneJointVo(this.id, this.version);
		...
		if(this.jointbonedetail == null)
			clone.jointbonedetail = null;
		else
			clone.jointbonedetail = (ims.generalmedical.vo.MskExamJointBonesDetailVoCollection)this.jointbonedetail.clone();
		if(this.carecontext == null)
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(MskBoneJointVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A MskBoneJointVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		MskBoneJointVo compareObj = (MskBoneJointVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
			if(this.getID_MskExamJointBones() == null && compareObj.getID_MskExamJointBones() != null)
				return -1;
			if(this.getID_MskExamJointBones() != null && compareObj.getID_MskExamJointBones() == null)
				return 1;
			if(this.getID_MskExamJointBones() != null && compareObj.getID_MskExamJointBones() != null)
				retVal = this.getID_MskExamJointBones().compareTo(compareObj.getID_MskExamJointBones());
		}
		return retVal;
	}
	...
	protected ims.generalmedical.vo.MskExamJointBonesDetailVoCollection jointbonedetail;
