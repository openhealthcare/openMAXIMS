...
public class MskBoneJointVoBean extends ims.vo.ValueObjectBean
{
	public MskBoneJointVoBean()
	{
	}
	public MskBoneJointVoBean(ims.generalmedical.vo.MskBoneJointVo vo)
	{
		this.id = vo.getBoId();
		...
		this.jointbonedetail = vo.getJointBoneDetail() == null ? null : vo.getJointBoneDetail().getBeanCollection();
		this.carecontext = vo.getCareContext() == null ? null : (ims.core.vo.beans.CareContextLiteVoBean)vo.getCareContext().getBean();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.generalmedical.vo.MskBoneJointVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.generalmedical.vo.MskBoneJointVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.generalmedical.vo.MskBoneJointVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.generalmedical.vo.MskBoneJointVo vo = null;
		if(map != null)
			vo = (ims.generalmedical.vo.MskBoneJointVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.generalmedical.vo.MskBoneJointVo();
	...
	public ims.generalmedical.vo.beans.MskExamJointBonesDetailVoBean[] getJointBoneDetail()
	{
		return this.jointbonedetail;
	}
	public void setJointBoneDetail(ims.generalmedical.vo.beans.MskExamJointBonesDetailVoBean[] value)
	{
	...
	private ims.generalmedical.vo.beans.MskExamJointBonesDetailVoBean[] jointbonedetail;
