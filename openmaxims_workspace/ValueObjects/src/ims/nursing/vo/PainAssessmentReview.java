 ...
 */
public class PainAssessmentReview extends ims.nursing.assessmenttools.vo.PainAssessmentReviewRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public PainAssessmentReview(Integer id, int version)
	{
		super(id, version);
	}
	public PainAssessmentReview(ims.nursing.vo.beans.PainAssessmentReviewBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.nursing.vo.beans.PainAssessmentReviewBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.assessmentdatetime = bean.getAssessmentDateTime() == null ? null : bean.getAssessmentDateTime().buildDateTime();
	...
	{
		ims.nursing.vo.beans.PainAssessmentReviewBean bean = null;
		if(map != null)
			bean = (ims.nursing.vo.beans.PainAssessmentReviewBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.nursing.vo.beans.PainAssessmentReviewBean();
	...
	public Object clone()
	{
		...
		PainAssessmentReview clone = new PainAssessmentReview(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(PainAssessmentReview.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A PainAssessmentReview object cannot be compared an Object of type " + obj.getClass().getName());
		}
		PainAssessmentReview compareObj = (PainAssessmentReview)obj;
		int retVal = 0;
		if (retVal == 0)
		{
