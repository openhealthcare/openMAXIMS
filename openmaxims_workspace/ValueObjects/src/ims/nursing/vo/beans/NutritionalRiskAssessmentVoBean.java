...
public class NutritionalRiskAssessmentVoBean extends ims.vo.ValueObjectBean
{
	public NutritionalRiskAssessmentVoBean()
	{
	}
	public NutritionalRiskAssessmentVoBean(ims.nursing.vo.NutritionalRiskAssessmentVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.nursing.vo.NutritionalRiskAssessmentVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.nursing.vo.NutritionalRiskAssessmentVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.nursing.vo.NutritionalRiskAssessmentVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.nursing.vo.NutritionalRiskAssessmentVo vo = null;
		if(map != null)
			vo = (ims.nursing.vo.NutritionalRiskAssessmentVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.nursing.vo.NutritionalRiskAssessmentVo();
	...
	public ims.nursing.vo.beans.NutritionalRiskAssessmentDetailsVoBean[] getAssessmentDetails()
	{
		return this.assessmentdetails;
	}
	public void setAssessmentDetails(ims.nursing.vo.beans.NutritionalRiskAssessmentDetailsVoBean[] value)
	{
	...
	private ims.nursing.vo.beans.NutritionalRiskAssessmentDetailsVoBean[] assessmentdetails;
}
