...
public class AssessmentInfoBean extends ims.vo.ValueObjectBean
{
	public AssessmentInfoBean()
	{
	}
	public AssessmentInfoBean(ims.nursing.vo.AssessmentInfo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.nursing.vo.AssessmentInfo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.datetime = vo.getDateTime() == null ? null : (ims.framework.utils.beans.DateTimeBean)vo.getDateTime().getBean();
	...
	public ims.nursing.vo.AssessmentInfo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.nursing.vo.AssessmentInfo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.nursing.vo.AssessmentInfo vo = null;
		if(map != null)
			vo = (ims.nursing.vo.AssessmentInfo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.nursing.vo.AssessmentInfo();
