...
public class PropertyChecklistShortVoBean extends ims.vo.ValueObjectBean
{
	public PropertyChecklistShortVoBean()
	{
	}
	public PropertyChecklistShortVoBean(ims.nursing.vo.PropertyChecklistShortVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.nursing.vo.PropertyChecklistShortVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.movementtype = vo.getMovementType() == null ? null : (ims.vo.LookupInstanceBean)vo.getMovementType().getBean();
	...
	public ims.nursing.vo.PropertyChecklistShortVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.nursing.vo.PropertyChecklistShortVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.nursing.vo.PropertyChecklistShortVo vo = null;
		if(map != null)
			vo = (ims.nursing.vo.PropertyChecklistShortVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.nursing.vo.PropertyChecklistShortVo();
