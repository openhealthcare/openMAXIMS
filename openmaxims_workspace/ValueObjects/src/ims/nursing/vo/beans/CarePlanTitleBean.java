...
public class CarePlanTitleBean extends ims.vo.ValueObjectBean
{
	public CarePlanTitleBean()
	{
	}
	...
	public ims.nursing.vo.CarePlanTitle buildVo()
	{
	...
	public ims.nursing.vo.CarePlanTitle buildVo(ims.vo.ValueObjectBeanMap map)
	{
		...
		if(map != null)
			vo = (ims.nursing.vo.CarePlanTitle)map.getValueObject(this);
		if(vo == null)
		{
