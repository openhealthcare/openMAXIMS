...
public class SkinAssessmentBean extends ims.vo.ValueObjectBean
{
	public SkinAssessmentBean()
	{
	}
	public SkinAssessmentBean(ims.nursing.vo.SkinAssessment vo)
	{
		this.id = vo.getBoId();
		...
		this.skinassessmentfindings = vo.getSkinAssessmentFindings() == null ? null : vo.getSkinAssessmentFindings().getBeanCollection();
		this.isskinintact = vo.getIsSkinIntact();
		this.imageversion = vo.getImageVersion() == null ? null : (ims.core.vo.beans.DrawingImageVersionVoBean)vo.getImageVersion().getBean();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.nursing.vo.SkinAssessment vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.nursing.vo.SkinAssessment buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.nursing.vo.SkinAssessment buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.nursing.vo.SkinAssessment vo = null;
		if(map != null)
			vo = (ims.nursing.vo.SkinAssessment)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.nursing.vo.SkinAssessment();
	...
	public ims.nursing.vo.beans.SkinAssessmentFindingsBean[] getSkinAssessmentFindings()
	{
		return this.skinassessmentfindings;
	}
	public void setSkinAssessmentFindings(ims.nursing.vo.beans.SkinAssessmentFindingsBean[] value)
	{
	...
	private ims.nursing.vo.beans.SkinAssessmentFindingsBean[] skinassessmentfindings;
