...
public class WaterlowAssessmentVoBean extends ims.vo.ValueObjectBean
{
	public WaterlowAssessmentVoBean()
	{
	}
	public WaterlowAssessmentVoBean(ims.nursing.vo.WaterlowAssessmentVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.nursing.vo.WaterlowAssessmentVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.nursing.vo.WaterlowAssessmentVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.nursing.vo.WaterlowAssessmentVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.nursing.vo.WaterlowAssessmentVo vo = null;
		if(map != null)
			vo = (ims.nursing.vo.WaterlowAssessmentVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.nursing.vo.WaterlowAssessmentVo();
	...
	public ims.nursing.vo.beans.WaterlowAssessmentDetailsVoBean[] getAssessmentDetails()
	{
		return this.assessmentdetails;
	}
	public void setAssessmentDetails(ims.nursing.vo.beans.WaterlowAssessmentDetailsVoBean[] value)
	{
	...
	private ims.nursing.vo.beans.WaterlowAssessmentDetailsVoBean[] assessmentdetails;
