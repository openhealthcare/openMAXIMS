...
public class CarePlanStatusBean extends ims.vo.ValueObjectBean
{
	public CarePlanStatusBean()
	{
	}
	public CarePlanStatusBean(ims.nursing.vo.CarePlanStatus vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.nursing.vo.CarePlanStatus vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.status = vo.getStatus() == null ? null : (ims.vo.LookupInstanceBean)vo.getStatus().getBean();
	...
	public ims.nursing.vo.CarePlanStatus buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.nursing.vo.CarePlanStatus buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.nursing.vo.CarePlanStatus vo = null;
		if(map != null)
			vo = (ims.nursing.vo.CarePlanStatus)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.nursing.vo.CarePlanStatus();
