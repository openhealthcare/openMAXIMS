...
public class CarePlanEvaluationFilterVoBean extends ims.vo.ValueObjectBean
{
	public CarePlanEvaluationFilterVoBean()
	{
	}
	public CarePlanEvaluationFilterVoBean(ims.nursing.vo.CarePlanEvaluationFilterVo vo)
	{
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.nursing.vo.CarePlanEvaluationFilterVo vo)
	{
		this.fromdate = vo.getFromDate() == null ? null : (ims.framework.utils.beans.DateBean)vo.getFromDate().getBean();
		this.todate = vo.getToDate() == null ? null : (ims.framework.utils.beans.DateBean)vo.getToDate().getBean();
		this.activeonly = vo.getActiveOnly();
	...
	public ims.nursing.vo.CarePlanEvaluationFilterVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.nursing.vo.CarePlanEvaluationFilterVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.nursing.vo.CarePlanEvaluationFilterVo vo = null;
		if(map != null)
			vo = (ims.nursing.vo.CarePlanEvaluationFilterVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.nursing.vo.CarePlanEvaluationFilterVo();
