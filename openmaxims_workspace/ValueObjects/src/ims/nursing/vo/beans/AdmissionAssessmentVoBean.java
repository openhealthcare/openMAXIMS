...
public class AdmissionAssessmentVoBean extends ims.vo.ValueObjectBean
{
	public AdmissionAssessmentVoBean()
	{
	}
	public AdmissionAssessmentVoBean(ims.nursing.vo.AdmissionAssessmentVo vo)
	{
		this.id = vo.getBoId();
		...
		this.componentcareplans = vo.getComponentCarePlans() == null ? null : vo.getComponentCarePlans().getBeanCollection();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.nursing.vo.AdmissionAssessmentVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.nursing.vo.AdmissionAssessmentVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.nursing.vo.AdmissionAssessmentVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.nursing.vo.AdmissionAssessmentVo vo = null;
		if(map != null)
			vo = (ims.nursing.vo.AdmissionAssessmentVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.nursing.vo.AdmissionAssessmentVo();
	...
	public ims.nursing.vo.beans.AssessmentComponentCarePlansBean[] getComponentCarePlans()
	{
		return this.componentcareplans;
	}
	public void setComponentCarePlans(ims.nursing.vo.beans.AssessmentComponentCarePlansBean[] value)
	{
	...
	private ims.nursing.vo.beans.AssessmentComponentCarePlansBean[] componentcareplans;
}
