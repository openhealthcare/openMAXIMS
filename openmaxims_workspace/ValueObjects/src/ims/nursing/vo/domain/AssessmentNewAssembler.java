 ...
 */
public class AssessmentNewAssembler
{
  	/**
	 ...
	 */
	 public static ims.nursing.vo.AssessmentNew copy(ims.nursing.vo.AssessmentNew valueObjectDest, ims.nursing.vo.AssessmentNew valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createAssessmentNewCollectionFromAdmissionAssessment(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.nursing.assessment.domain.objects.AdmissionAssessment objects.
	 */
	public static ims.nursing.vo.AssessmentNewCollection createAssessmentNewCollectionFromAdmissionAssessment(java.util.Set domainObjectSet)	
	{
		return createAssessmentNewCollectionFromAdmissionAssessment(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.nursing.assessment.domain.objects.AdmissionAssessment objects.
	 */
	public static ims.nursing.vo.AssessmentNewCollection createAssessmentNewCollectionFromAdmissionAssessment(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.nursing.vo.AssessmentNewCollection voList = new ims.nursing.vo.AssessmentNewCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.nursing.vo.AssessmentNew vo = create(map, domainObject);
	 ...
	 */
	public static ims.nursing.vo.AssessmentNewCollection createAssessmentNewCollectionFromAdmissionAssessment(java.util.List domainObjectList) 
	{
		return createAssessmentNewCollectionFromAdmissionAssessment(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.nursing.assessment.domain.objects.AdmissionAssessment objects.
	 */
	public static ims.nursing.vo.AssessmentNewCollection createAssessmentNewCollectionFromAdmissionAssessment(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.nursing.vo.AssessmentNewCollection voList = new ims.nursing.vo.AssessmentNewCollection();
	 ...
	 */
	 public static java.util.Set extractAdmissionAssessmentSet(ims.domain.ILightweightDomainFactory domainFactory, ims.nursing.vo.AssessmentNewCollection voCollection) 
	 {
	 	return extractAdmissionAssessmentSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractAdmissionAssessmentSet(ims.domain.ILightweightDomainFactory domainFactory, ims.nursing.vo.AssessmentNewCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.nursing.vo.AssessmentNew vo = voCollection.get(i);
			ims.nursing.assessment.domain.objects.AdmissionAssessment domainObject = AssessmentNewAssembler.extractAdmissionAssessment(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractAdmissionAssessmentList(ims.domain.ILightweightDomainFactory domainFactory, ims.nursing.vo.AssessmentNewCollection voCollection) 
	 {
	 	return extractAdmissionAssessmentList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractAdmissionAssessmentList(ims.domain.ILightweightDomainFactory domainFactory, ims.nursing.vo.AssessmentNewCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.nursing.vo.AssessmentNew create(ims.nursing.assessment.domain.objects.AdmissionAssessment domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.nursing.vo.AssessmentNew create(DomainObjectMap map, ims.nursing.assessment.domain.objects.AdmissionAssessment domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.nursing.vo.AssessmentNew valueObject = (ims.nursing.vo.AssessmentNew) map.getValueObject(domainObject, ims.nursing.vo.AssessmentNew.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.nursing.vo.AssessmentNew(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.nursing.assessment.domain.objects.AdmissionAssessment
	 */
	 public static ims.nursing.vo.AssessmentNew insert(ims.nursing.vo.AssessmentNew valueObject, ims.nursing.assessment.domain.objects.AdmissionAssessment domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.nursing.assessment.domain.objects.AdmissionAssessment
	 */
	 public static ims.nursing.vo.AssessmentNew insert(DomainObjectMap map, ims.nursing.vo.AssessmentNew valueObject, ims.nursing.assessment.domain.objects.AdmissionAssessment domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		if ( null != instance1 ) {
			...
			valueObject.setAssessmentType(voLookup1);
				...
				// HcpInitiated
		if (domainObject.getHcpInitiated() != null)
		{
			if(domainObject.getHcpInitiated() instanceof HibernateProxy) // If the proxy is set, there is no need to lazy load, the proxy knows the id already. 
			{
				HibernateProxy p = (HibernateProxy) domainObject.getHcpInitiated();
				int id = Integer.parseInt(p.getHibernateLazyInitializer().getIdentifier().toString());				
				valueObject.setHcpInitiated(new ims.core.resource.people.vo.HcpRefVo(id, -1));				
			}
			else
			{
				valueObject.setHcpInitiated(new ims.core.resource.people.vo.HcpRefVo(domainObject.getHcpInitiated().getId(), domainObject.getHcpInitiated().getVersion()));
			}
		}
		// DateTimeInitiated
	 ...
	 */
	public static ims.nursing.assessment.domain.objects.AdmissionAssessment extractAdmissionAssessment(ims.domain.ILightweightDomainFactory domainFactory, ims.nursing.vo.AssessmentNew valueObject) 
	{
		return 	extractAdmissionAssessment(domainFactory, valueObject, new HashMap());
	}

	public static ims.nursing.assessment.domain.objects.AdmissionAssessment extractAdmissionAssessment(ims.domain.ILightweightDomainFactory domainFactory, ims.nursing.vo.AssessmentNew valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.nursing.vo.AssessmentNew ID_AdmissionAssessment field is unknown
		...
		if ( null != valueObject.getHcpInitiated() ) 
		{
			...
			{
				value2 = domainObject.getHcpInitiated();	
			}
			else
			{
