 ...
 */
public class PatientForCarePlanWorklistVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.nursing.vo.PatientForCarePlanWorklistVo copy(ims.nursing.vo.PatientForCarePlanWorklistVo valueObjectDest, ims.nursing.vo.PatientForCarePlanWorklistVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createPatientForCarePlanWorklistVoCollectionFromPatient(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.patient.domain.objects.Patient objects.
	 */
	public static ims.nursing.vo.PatientForCarePlanWorklistVoCollection createPatientForCarePlanWorklistVoCollectionFromPatient(java.util.Set domainObjectSet)	
	{
		return createPatientForCarePlanWorklistVoCollectionFromPatient(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.patient.domain.objects.Patient objects.
	 */
	public static ims.nursing.vo.PatientForCarePlanWorklistVoCollection createPatientForCarePlanWorklistVoCollectionFromPatient(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.nursing.vo.PatientForCarePlanWorklistVoCollection voList = new ims.nursing.vo.PatientForCarePlanWorklistVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.nursing.vo.PatientForCarePlanWorklistVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.nursing.vo.PatientForCarePlanWorklistVoCollection createPatientForCarePlanWorklistVoCollectionFromPatient(java.util.List domainObjectList) 
	{
		return createPatientForCarePlanWorklistVoCollectionFromPatient(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.patient.domain.objects.Patient objects.
	 */
	public static ims.nursing.vo.PatientForCarePlanWorklistVoCollection createPatientForCarePlanWorklistVoCollectionFromPatient(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.nursing.vo.PatientForCarePlanWorklistVoCollection voList = new ims.nursing.vo.PatientForCarePlanWorklistVoCollection();
	 ...
	 */
	 public static java.util.Set extractPatientSet(ims.domain.ILightweightDomainFactory domainFactory, ims.nursing.vo.PatientForCarePlanWorklistVoCollection voCollection) 
	 {
	 	return extractPatientSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientSet(ims.domain.ILightweightDomainFactory domainFactory, ims.nursing.vo.PatientForCarePlanWorklistVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.nursing.vo.PatientForCarePlanWorklistVo vo = voCollection.get(i);
			ims.core.patient.domain.objects.Patient domainObject = PatientForCarePlanWorklistVoAssembler.extractPatient(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPatientList(ims.domain.ILightweightDomainFactory domainFactory, ims.nursing.vo.PatientForCarePlanWorklistVoCollection voCollection) 
	 {
	 	return extractPatientList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPatientList(ims.domain.ILightweightDomainFactory domainFactory, ims.nursing.vo.PatientForCarePlanWorklistVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.nursing.vo.PatientForCarePlanWorklistVo create(ims.core.patient.domain.objects.Patient domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.nursing.vo.PatientForCarePlanWorklistVo create(DomainObjectMap map, ims.core.patient.domain.objects.Patient domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.nursing.vo.PatientForCarePlanWorklistVo valueObject = (ims.nursing.vo.PatientForCarePlanWorklistVo) map.getValueObject(domainObject, ims.nursing.vo.PatientForCarePlanWorklistVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.nursing.vo.PatientForCarePlanWorklistVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.patient.domain.objects.Patient
	 */
	 public static ims.nursing.vo.PatientForCarePlanWorklistVo insert(ims.nursing.vo.PatientForCarePlanWorklistVo valueObject, ims.core.patient.domain.objects.Patient domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.patient.domain.objects.Patient
	 */
	 public static ims.nursing.vo.PatientForCarePlanWorklistVo insert(DomainObjectMap map, ims.nursing.vo.PatientForCarePlanWorklistVo valueObject, ims.core.patient.domain.objects.Patient domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.patient.domain.objects.Patient extractPatient(ims.domain.ILightweightDomainFactory domainFactory, ims.nursing.vo.PatientForCarePlanWorklistVo valueObject) 
	{
		return 	extractPatient(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.patient.domain.objects.Patient extractPatient(ims.domain.ILightweightDomainFactory domainFactory, ims.nursing.vo.PatientForCarePlanWorklistVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.nursing.vo.PatientForCarePlanWorklistVo ID_Patient field is unknown
