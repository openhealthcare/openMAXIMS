 ...
 */
public class AssessmentCarePlansAssembler
{
  	/**
	 ...
	 */
	 public static ims.nursing.vo.AssessmentCarePlans copy(ims.nursing.vo.AssessmentCarePlans valueObjectDest, ims.nursing.vo.AssessmentCarePlans valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createAssessmentCarePlansCollectionFromAdmissionAssessment(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.nursing.assessment.domain.objects.AdmissionAssessment objects.
	 */
	public static ims.nursing.vo.AssessmentCarePlansCollection createAssessmentCarePlansCollectionFromAdmissionAssessment(java.util.Set domainObjectSet)	
	{
		return createAssessmentCarePlansCollectionFromAdmissionAssessment(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.nursing.assessment.domain.objects.AdmissionAssessment objects.
	 */
	public static ims.nursing.vo.AssessmentCarePlansCollection createAssessmentCarePlansCollectionFromAdmissionAssessment(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.nursing.vo.AssessmentCarePlansCollection voList = new ims.nursing.vo.AssessmentCarePlansCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.nursing.vo.AssessmentCarePlans vo = create(map, domainObject);
	 ...
	 */
	public static ims.nursing.vo.AssessmentCarePlansCollection createAssessmentCarePlansCollectionFromAdmissionAssessment(java.util.List domainObjectList) 
	{
		return createAssessmentCarePlansCollectionFromAdmissionAssessment(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.nursing.assessment.domain.objects.AdmissionAssessment objects.
	 */
	public static ims.nursing.vo.AssessmentCarePlansCollection createAssessmentCarePlansCollectionFromAdmissionAssessment(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.nursing.vo.AssessmentCarePlansCollection voList = new ims.nursing.vo.AssessmentCarePlansCollection();
	 ...
	 */
	 public static java.util.Set extractAdmissionAssessmentSet(ims.domain.ILightweightDomainFactory domainFactory, ims.nursing.vo.AssessmentCarePlansCollection voCollection) 
	 {
	 	return extractAdmissionAssessmentSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractAdmissionAssessmentSet(ims.domain.ILightweightDomainFactory domainFactory, ims.nursing.vo.AssessmentCarePlansCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.nursing.vo.AssessmentCarePlans vo = voCollection.get(i);
			ims.nursing.assessment.domain.objects.AdmissionAssessment domainObject = AssessmentCarePlansAssembler.extractAdmissionAssessment(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractAdmissionAssessmentList(ims.domain.ILightweightDomainFactory domainFactory, ims.nursing.vo.AssessmentCarePlansCollection voCollection) 
	 {
	 	return extractAdmissionAssessmentList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractAdmissionAssessmentList(ims.domain.ILightweightDomainFactory domainFactory, ims.nursing.vo.AssessmentCarePlansCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.nursing.vo.AssessmentCarePlans create(ims.nursing.assessment.domain.objects.AdmissionAssessment domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.nursing.vo.AssessmentCarePlans create(DomainObjectMap map, ims.nursing.assessment.domain.objects.AdmissionAssessment domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.nursing.vo.AssessmentCarePlans valueObject = (ims.nursing.vo.AssessmentCarePlans) map.getValueObject(domainObject, ims.nursing.vo.AssessmentCarePlans.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.nursing.vo.AssessmentCarePlans(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.nursing.assessment.domain.objects.AdmissionAssessment
	 */
	 public static ims.nursing.vo.AssessmentCarePlans insert(ims.nursing.vo.AssessmentCarePlans valueObject, ims.nursing.assessment.domain.objects.AdmissionAssessment domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.nursing.assessment.domain.objects.AdmissionAssessment
	 */
	 public static ims.nursing.vo.AssessmentCarePlans insert(DomainObjectMap map, ims.nursing.vo.AssessmentCarePlans valueObject, ims.nursing.assessment.domain.objects.AdmissionAssessment domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.nursing.assessment.domain.objects.AdmissionAssessment extractAdmissionAssessment(ims.domain.ILightweightDomainFactory domainFactory, ims.nursing.vo.AssessmentCarePlans valueObject) 
	{
		return 	extractAdmissionAssessment(domainFactory, valueObject, new HashMap());
	}

	public static ims.nursing.assessment.domain.objects.AdmissionAssessment extractAdmissionAssessment(ims.domain.ILightweightDomainFactory domainFactory, ims.nursing.vo.AssessmentCarePlans valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.nursing.vo.AssessmentCarePlans ID_AdmissionAssessment field is unknown
