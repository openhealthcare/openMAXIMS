 ...
 */
public class AssessmentComponent extends ims.nursing.assessment.vo.AssessmentComponentRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public AssessmentComponent(Integer id, int version)
	{
		super(id, version);
	}
	public AssessmentComponent(ims.nursing.vo.beans.AssessmentComponentBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.nursing.vo.beans.AssessmentComponentBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.iscomplete = bean.getIsComplete();
	...
	{
		ims.nursing.vo.beans.AssessmentComponentBean bean = null;
		if(map != null)
			bean = (ims.nursing.vo.beans.AssessmentComponentBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.nursing.vo.beans.AssessmentComponentBean();
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("LASTASSESSMENTINFO"))
			return getLastAssessmentInfo();
		if(fieldName.equals("CAREPLANTEMPLATE"))
			return getCarePlanTemplate();
	...
	public boolean getLastAssessmentInfoIsNotNull()
	{
		return this.lastassessmentinfo != null;
	}
	public ims.nursing.vo.AssessmentInfo getLastAssessmentInfo()
	{
		return this.lastassessmentinfo;
	}
	public void setLastAssessmentInfo(ims.nursing.vo.AssessmentInfo value)
	{
		this.isValidated = false;
	...
	{
		return this.careplantemplate != null;
	}
	public ims.nursing.vo.CarePlanTemplateCollection getCarePlanTemplate()
	{
		return this.careplantemplate;
	}
	public void setCarePlanTemplate(ims.nursing.vo.CarePlanTemplateCollection value)
	{
		this.isValidated = false;
	...
	public ims.nursing.vo.CarePlanCollection getCarePlans()
	{
		return this.careplans;
	}
	public void setCarePlans(ims.nursing.vo.CarePlanCollection value)
	{
		this.isValidated = false;
	...
	public Object clone()
	{
		...
		AssessmentComponent clone = new AssessmentComponent(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(AssessmentComponent.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A AssessmentComponent object cannot be compared an Object of type " + obj.getClass().getName());
		}
		AssessmentComponent compareObj = (AssessmentComponent)obj;
		int retVal = 0;
		if (retVal == 0)
		{
	...
	protected ims.nursing.vo.AssessmentInfo lastassessmentinfo;
	protected ims.nursing.vo.CarePlanTemplateCollection careplantemplate;
	protected ims.nursing.vo.CarePlanCollection careplans;
