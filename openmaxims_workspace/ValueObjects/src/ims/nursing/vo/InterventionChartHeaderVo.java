 ...
 */
public class InterventionChartHeaderVo extends ims.nursing.vo.InterventionChartRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public InterventionChartHeaderVo()
	{
	}
	public InterventionChartHeaderVo(Integer id, int version)
	{
		super(id, version);
	}
	public InterventionChartHeaderVo(ims.nursing.vo.beans.InterventionChartHeaderVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.nursing.vo.beans.InterventionChartHeaderVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.nursing.vo.beans.InterventionChartHeaderVoBean bean = null;
		if(map != null)
			bean = (ims.nursing.vo.beans.InterventionChartHeaderVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.nursing.vo.beans.InterventionChartHeaderVoBean();
	...
	public Object clone()
	{
		...
		InterventionChartHeaderVo clone = new InterventionChartHeaderVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(InterventionChartHeaderVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A InterventionChartHeaderVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		InterventionChartHeaderVo compareObj = (InterventionChartHeaderVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
