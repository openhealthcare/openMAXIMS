 ...
 */
public class HL7OutboundVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.hl7.vo.HL7OutboundVo copy(ims.hl7.vo.HL7OutboundVo valueObjectDest, ims.hl7.vo.HL7OutboundVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createHL7OutboundVoCollectionFromHL7Outbound(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.hl7.domain.objects.HL7Outbound objects.
	 */
	public static ims.hl7.vo.HL7OutboundVoCollection createHL7OutboundVoCollectionFromHL7Outbound(java.util.Set domainObjectSet)	
	{
		return createHL7OutboundVoCollectionFromHL7Outbound(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.hl7.domain.objects.HL7Outbound objects.
	 */
	public static ims.hl7.vo.HL7OutboundVoCollection createHL7OutboundVoCollectionFromHL7Outbound(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.hl7.vo.HL7OutboundVoCollection voList = new ims.hl7.vo.HL7OutboundVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.hl7.vo.HL7OutboundVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.hl7.vo.HL7OutboundVoCollection createHL7OutboundVoCollectionFromHL7Outbound(java.util.List domainObjectList) 
	{
		return createHL7OutboundVoCollectionFromHL7Outbound(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.hl7.domain.objects.HL7Outbound objects.
	 */
	public static ims.hl7.vo.HL7OutboundVoCollection createHL7OutboundVoCollectionFromHL7Outbound(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.hl7.vo.HL7OutboundVoCollection voList = new ims.hl7.vo.HL7OutboundVoCollection();
	 ...
	 */
	 public static java.util.Set extractHL7OutboundSet(ims.domain.ILightweightDomainFactory domainFactory, ims.hl7.vo.HL7OutboundVoCollection voCollection) 
	 {
	 	return extractHL7OutboundSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractHL7OutboundSet(ims.domain.ILightweightDomainFactory domainFactory, ims.hl7.vo.HL7OutboundVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.hl7.vo.HL7OutboundVo vo = voCollection.get(i);
			ims.hl7.domain.objects.HL7Outbound domainObject = HL7OutboundVoAssembler.extractHL7Outbound(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractHL7OutboundList(ims.domain.ILightweightDomainFactory domainFactory, ims.hl7.vo.HL7OutboundVoCollection voCollection) 
	 {
	 	return extractHL7OutboundList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractHL7OutboundList(ims.domain.ILightweightDomainFactory domainFactory, ims.hl7.vo.HL7OutboundVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.hl7.vo.HL7OutboundVo create(ims.hl7.domain.objects.HL7Outbound domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.hl7.vo.HL7OutboundVo create(DomainObjectMap map, ims.hl7.domain.objects.HL7Outbound domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.hl7.vo.HL7OutboundVo valueObject = (ims.hl7.vo.HL7OutboundVo) map.getValueObject(domainObject, ims.hl7.vo.HL7OutboundVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.hl7.vo.HL7OutboundVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.hl7.domain.objects.HL7Outbound
	 */
	 public static ims.hl7.vo.HL7OutboundVo insert(ims.hl7.vo.HL7OutboundVo valueObject, ims.hl7.domain.objects.HL7Outbound domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.hl7.domain.objects.HL7Outbound
	 */
	 public static ims.hl7.vo.HL7OutboundVo insert(DomainObjectMap map, ims.hl7.vo.HL7OutboundVo valueObject, ims.hl7.domain.objects.HL7Outbound domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.hl7.domain.objects.HL7Outbound extractHL7Outbound(ims.domain.ILightweightDomainFactory domainFactory, ims.hl7.vo.HL7OutboundVo valueObject) 
	{
		return 	extractHL7Outbound(domainFactory, valueObject, new HashMap());
	}

	public static ims.hl7.domain.objects.HL7Outbound extractHL7Outbound(ims.domain.ILightweightDomainFactory domainFactory, ims.hl7.vo.HL7OutboundVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.hl7.vo.HL7OutboundVo ID_HL7Outbound field is unknown
