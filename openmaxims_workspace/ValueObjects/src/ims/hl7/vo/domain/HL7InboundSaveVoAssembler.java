 ...
 */
public class HL7InboundSaveVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.hl7.vo.HL7InboundSaveVo copy(ims.hl7.vo.HL7InboundSaveVo valueObjectDest, ims.hl7.vo.HL7InboundSaveVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createHL7InboundSaveVoCollectionFromHL7Inbound(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.hl7.domain.objects.HL7Inbound objects.
	 */
	public static ims.hl7.vo.HL7InboundSaveVoCollection createHL7InboundSaveVoCollectionFromHL7Inbound(java.util.Set domainObjectSet)	
	{
		return createHL7InboundSaveVoCollectionFromHL7Inbound(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.hl7.domain.objects.HL7Inbound objects.
	 */
	public static ims.hl7.vo.HL7InboundSaveVoCollection createHL7InboundSaveVoCollectionFromHL7Inbound(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.hl7.vo.HL7InboundSaveVoCollection voList = new ims.hl7.vo.HL7InboundSaveVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.hl7.vo.HL7InboundSaveVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.hl7.vo.HL7InboundSaveVoCollection createHL7InboundSaveVoCollectionFromHL7Inbound(java.util.List domainObjectList) 
	{
		return createHL7InboundSaveVoCollectionFromHL7Inbound(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.hl7.domain.objects.HL7Inbound objects.
	 */
	public static ims.hl7.vo.HL7InboundSaveVoCollection createHL7InboundSaveVoCollectionFromHL7Inbound(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.hl7.vo.HL7InboundSaveVoCollection voList = new ims.hl7.vo.HL7InboundSaveVoCollection();
	 ...
	 */
	 public static java.util.Set extractHL7InboundSet(ims.domain.ILightweightDomainFactory domainFactory, ims.hl7.vo.HL7InboundSaveVoCollection voCollection) 
	 {
	 	return extractHL7InboundSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractHL7InboundSet(ims.domain.ILightweightDomainFactory domainFactory, ims.hl7.vo.HL7InboundSaveVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.hl7.vo.HL7InboundSaveVo vo = voCollection.get(i);
			ims.hl7.domain.objects.HL7Inbound domainObject = HL7InboundSaveVoAssembler.extractHL7Inbound(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractHL7InboundList(ims.domain.ILightweightDomainFactory domainFactory, ims.hl7.vo.HL7InboundSaveVoCollection voCollection) 
	 {
	 	return extractHL7InboundList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractHL7InboundList(ims.domain.ILightweightDomainFactory domainFactory, ims.hl7.vo.HL7InboundSaveVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.hl7.vo.HL7InboundSaveVo create(ims.hl7.domain.objects.HL7Inbound domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.hl7.vo.HL7InboundSaveVo create(DomainObjectMap map, ims.hl7.domain.objects.HL7Inbound domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.hl7.vo.HL7InboundSaveVo valueObject = (ims.hl7.vo.HL7InboundSaveVo) map.getValueObject(domainObject, ims.hl7.vo.HL7InboundSaveVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.hl7.vo.HL7InboundSaveVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.hl7.domain.objects.HL7Inbound
	 */
	 public static ims.hl7.vo.HL7InboundSaveVo insert(ims.hl7.vo.HL7InboundSaveVo valueObject, ims.hl7.domain.objects.HL7Inbound domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.hl7.domain.objects.HL7Inbound
	 */
	 public static ims.hl7.vo.HL7InboundSaveVo insert(DomainObjectMap map, ims.hl7.vo.HL7InboundSaveVo valueObject, ims.hl7.domain.objects.HL7Inbound domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.hl7.domain.objects.HL7Inbound extractHL7Inbound(ims.domain.ILightweightDomainFactory domainFactory, ims.hl7.vo.HL7InboundSaveVo valueObject) 
	{
		return 	extractHL7Inbound(domainFactory, valueObject, new HashMap());
	}

	public static ims.hl7.domain.objects.HL7Inbound extractHL7Inbound(ims.domain.ILightweightDomainFactory domainFactory, ims.hl7.vo.HL7InboundSaveVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.hl7.vo.HL7InboundSaveVo ID_HL7Inbound field is unknown
		...
		if ( null != valueObject.getProviderSystem() ) 
		{
			...
			{
				value4 = domainObject.getProviderSystem();	
			}
			else
			{
