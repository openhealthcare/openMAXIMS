 ...
 */
public class HL7OutboundVo extends ims.hl7.vo.HL7OutboundRefVo implements ims.vo.ImsCloneable, Comparable, ims.vo.interfaces.IHL7Query
{
	private static final long serialVersionUID = 1L;

	public HL7OutboundVo()
	{
	}
	public HL7OutboundVo(Integer id, int version)
	{
		super(id, version);
	}
	public HL7OutboundVo(ims.hl7.vo.beans.HL7OutboundVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.hl7.vo.beans.HL7OutboundVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.hl7.vo.beans.HL7OutboundVoBean bean = null;
		if(map != null)
			bean = (ims.hl7.vo.beans.HL7OutboundVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.hl7.vo.beans.HL7OutboundVoBean();
	...
	*/
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.failuremessage != null)
			if(this.failuremessage.length() > 1000)
				listOfErrors.add("The length of the field [failuremessage] in the value object [ims.hl7.vo.HL7OutboundVo] is too big. It should be less or equal to 1000");
	...
	public Object clone()
	{
		...
		HL7OutboundVo clone = new HL7OutboundVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(HL7OutboundVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A HL7OutboundVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((HL7OutboundVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((HL7OutboundVo)obj).getBoId());
	}
