 ...
 */
public class PathwayTargetRTTEventVo extends ims.pathways.configuration.vo.PathwayTargetRTTEventRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public PathwayTargetRTTEventVo()
	{
	}
	public PathwayTargetRTTEventVo(Integer id, int version)
	{
		super(id, version);
	}
	public PathwayTargetRTTEventVo(ims.pathways.vo.beans.PathwayTargetRTTEventVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.pathwaytarget = bean.getPathwayTarget() == null ? null : bean.getPathwayTarget().buildVo();
		this.rttevent = bean.getRTTEvent() == null ? null : new ims.pathways.configuration.vo.RTTEventRefVo(new Integer(bean.getRTTEvent().getId()), bean.getRTTEvent().getVersion());
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.pathways.vo.beans.PathwayTargetRTTEventVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.pathways.vo.beans.PathwayTargetRTTEventVoBean bean = null;
		if(map != null)
			bean = (ims.pathways.vo.beans.PathwayTargetRTTEventVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.pathways.vo.beans.PathwayTargetRTTEventVoBean();
	...
	public boolean getRTTEventIsNotNull()
	{
		return this.rttevent != null;
	}
	public ims.pathways.configuration.vo.RTTEventRefVo getRTTEvent()
	{
		return this.rttevent;
	}
	public void setRTTEvent(ims.pathways.configuration.vo.RTTEventRefVo value)
	{
		this.isValidated = false;
		this.rttevent = value;
	}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.rttevent == null)
			listOfErrors.add("RTTEvent is mandatory");
		if(this.status == null)
	...
	public Object clone()
	{
		...
		PathwayTargetRTTEventVo clone = new PathwayTargetRTTEventVo(this.id, this.version);
		
		if(this.pathwaytarget == null)
			clone.pathwaytarget = null;
		else
			clone.pathwaytarget = (ims.pathways.vo.PathwayTargetShortVo)this.pathwaytarget.clone();
		clone.rttevent = this.rttevent;
		if(this.status == null)
			clone.status = null;
		else
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(PathwayTargetRTTEventVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A PathwayTargetRTTEventVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((PathwayTargetRTTEventVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((PathwayTargetRTTEventVo)obj).getBoId());
	}
	...
	protected ims.pathways.configuration.vo.RTTEventRefVo rttevent;
