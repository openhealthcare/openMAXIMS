 ...
 */
public class PathwayShortVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.pathways.vo.PathwayShortVo copy(ims.pathways.vo.PathwayShortVo valueObjectDest, ims.pathways.vo.PathwayShortVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createPathwayShortVoCollectionFromPathway(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.pathways.configuration.domain.objects.Pathway objects.
	 */
	public static ims.pathways.vo.PathwayShortVoCollection createPathwayShortVoCollectionFromPathway(java.util.Set domainObjectSet)	
	{
		return createPathwayShortVoCollectionFromPathway(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.pathways.configuration.domain.objects.Pathway objects.
	 */
	public static ims.pathways.vo.PathwayShortVoCollection createPathwayShortVoCollectionFromPathway(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.pathways.vo.PathwayShortVoCollection voList = new ims.pathways.vo.PathwayShortVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.pathways.vo.PathwayShortVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.pathways.vo.PathwayShortVoCollection createPathwayShortVoCollectionFromPathway(java.util.List domainObjectList) 
	{
		return createPathwayShortVoCollectionFromPathway(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.pathways.configuration.domain.objects.Pathway objects.
	 */
	public static ims.pathways.vo.PathwayShortVoCollection createPathwayShortVoCollectionFromPathway(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.pathways.vo.PathwayShortVoCollection voList = new ims.pathways.vo.PathwayShortVoCollection();
	 ...
	 */
	 public static java.util.Set extractPathwaySet(ims.domain.ILightweightDomainFactory domainFactory, ims.pathways.vo.PathwayShortVoCollection voCollection) 
	 {
	 	return extractPathwaySet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPathwaySet(ims.domain.ILightweightDomainFactory domainFactory, ims.pathways.vo.PathwayShortVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.pathways.vo.PathwayShortVo vo = voCollection.get(i);
			ims.pathways.configuration.domain.objects.Pathway domainObject = PathwayShortVoAssembler.extractPathway(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPathwayList(ims.domain.ILightweightDomainFactory domainFactory, ims.pathways.vo.PathwayShortVoCollection voCollection) 
	 {
	 	return extractPathwayList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPathwayList(ims.domain.ILightweightDomainFactory domainFactory, ims.pathways.vo.PathwayShortVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.pathways.vo.PathwayShortVo create(ims.pathways.configuration.domain.objects.Pathway domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.pathways.vo.PathwayShortVo create(DomainObjectMap map, ims.pathways.configuration.domain.objects.Pathway domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.pathways.vo.PathwayShortVo valueObject = (ims.pathways.vo.PathwayShortVo) map.getValueObject(domainObject, ims.pathways.vo.PathwayShortVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.pathways.vo.PathwayShortVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.pathways.configuration.domain.objects.Pathway
	 */
	 public static ims.pathways.vo.PathwayShortVo insert(ims.pathways.vo.PathwayShortVo valueObject, ims.pathways.configuration.domain.objects.Pathway domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.pathways.configuration.domain.objects.Pathway
	 */
	 public static ims.pathways.vo.PathwayShortVo insert(DomainObjectMap map, ims.pathways.vo.PathwayShortVo valueObject, ims.pathways.configuration.domain.objects.Pathway domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// JourneyCountType
		ims.domain.lookups.LookupInstance instance7 = domainObject.getJourneyCountType();
		if ( null != instance7 ) {
			ims.framework.utils.ImagePath img = null;
			ims.framework.utils.Color color = null;		
			img = null;
			...
			ims.pathways.vo.lookups.JourneyCountType voLookup7 = new ims.pathways.vo.lookups.JourneyCountType(instance7.getId(),instance7.getText(), instance7.isActive(), null, img, color);
			ims.pathways.vo.lookups.JourneyCountType parentVoLookup7 = voLookup7;
			...
			while (parent7 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup7.setParent(new ims.pathways.vo.lookups.JourneyCountType(parent7.getId(),parent7.getText(), parent7.isActive(), null, img, color));
				parentVoLookup7 = parentVoLookup7.getParent();
								parent7 = parent7.getParent();
			}			
			valueObject.setJourneyCountType(voLookup7);
		}
				// sysInfo
	...
	public static ims.pathways.configuration.domain.objects.Pathway extractPathway(ims.domain.ILightweightDomainFactory domainFactory, ims.pathways.vo.PathwayShortVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.pathways.vo.PathwayShortVo ID_Pathway field is unknown
		...
		domainObject.setJourneyCountType(value7);
