 ...
 */
public class EventRTTEventVo extends ims.pathways.configuration.vo.EventRTTEventRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public EventRTTEventVo()
	{
	}
	public EventRTTEventVo(Integer id, int version)
	{
		super(id, version);
	}
	public EventRTTEventVo(ims.pathways.vo.beans.EventRTTEventVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.event = bean.getEvent() == null ? null : bean.getEvent().buildVo();
		this.rttevent = bean.getRTTEvent() == null ? null : bean.getRTTEvent().buildVo();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.pathways.vo.beans.EventRTTEventVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.event = bean.getEvent() == null ? null : bean.getEvent().buildVo(map);
		this.rttevent = bean.getRTTEvent() == null ? null : bean.getRTTEvent().buildVo(map);
		this.status = bean.getStatus() == null ? null : ims.core.vo.lookups.PreActiveActiveInactiveStatus.buildLookup(bean.getStatus());
	...
	{
		ims.pathways.vo.beans.EventRTTEventVoBean bean = null;
		if(map != null)
			bean = (ims.pathways.vo.beans.EventRTTEventVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.pathways.vo.beans.EventRTTEventVoBean();
	...
	public ims.pathways.vo.RTTEventVo getRTTEvent()
	{
		return this.rttevent;
	}
	public void setRTTEvent(ims.pathways.vo.RTTEventVo value)
	{
		this.isValidated = false;
		this.rttevent = value;
	}
	...
	public Object clone()
	{
		...
		EventRTTEventVo clone = new EventRTTEventVo(this.id, this.version);
		...
		if(this.rttevent == null)
			...
			clone.rttevent = (ims.pathways.vo.RTTEventVo)this.rttevent.clone();
		if(this.status == null)
			clone.status = null;
		else
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(EventRTTEventVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A EventRTTEventVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((EventRTTEventVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((EventRTTEventVo)obj).getBoId());
	}
	...
	protected ims.pathways.vo.RTTEventVo rttevent;
