 ...
 */
public class TargetShortVo extends ims.pathways.configuration.vo.TargetRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public TargetShortVo()
	{
	}
	public TargetShortVo(Integer id, int version)
	{
		super(id, version);
	}
	public TargetShortVo(ims.pathways.vo.beans.TargetShortVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.pathways.vo.beans.TargetShortVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.name = bean.getName();
	...
	{
		ims.pathways.vo.beans.TargetShortVoBean bean = null;
		if(map != null)
			bean = (ims.pathways.vo.beans.TargetShortVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.pathways.vo.beans.TargetShortVoBean();
	...
	*/
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.name == null || this.name.length() == 0)
			...
			listOfErrors.add("The length of the field [name] in the value object [ims.pathways.vo.TargetShortVo] is too big. It should be less or equal to 255");
		if(this.description != null)
			if(this.description.length() > 255)
				listOfErrors.add("The length of the field [description] in the value object [ims.pathways.vo.TargetShortVo] is too big. It should be less or equal to 255");
		if(this.status == null)
	...
	public Object clone()
	{
		...
		TargetShortVo clone = new TargetShortVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(TargetShortVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A TargetShortVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((TargetShortVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((TargetShortVo)obj).getBoId());
	}
