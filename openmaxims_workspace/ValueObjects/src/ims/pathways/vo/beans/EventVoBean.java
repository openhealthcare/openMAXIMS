...
public class EventVoBean extends ims.vo.ValueObjectBean
{
	public EventVoBean()
	{
	}
	public EventVoBean(ims.pathways.vo.EventVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.pathways.vo.EventVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.name = vo.getName();
	...
	public ims.pathways.vo.EventVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.pathways.vo.EventVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.pathways.vo.EventVo vo = null;
		if(map != null)
			vo = (ims.pathways.vo.EventVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.pathways.vo.EventVo();
