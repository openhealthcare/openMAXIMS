...
public class PathwayTargetExternalEventMappingVoBean extends ims.vo.ValueObjectBean
{
	public PathwayTargetExternalEventMappingVoBean()
	{
	}
	public PathwayTargetExternalEventMappingVoBean(ims.pathways.vo.PathwayTargetExternalEventMappingVo vo)
	{
		this.id = vo.getBoId();
		...
		this.externaleventmapping = vo.getExternalEventMapping() == null ? null : new ims.vo.RefVoBean(vo.getExternalEventMapping().getBoId(), vo.getExternalEventMapping().getBoVersion());
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.pathways.vo.PathwayTargetExternalEventMappingVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.pathways.vo.PathwayTargetExternalEventMappingVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.pathways.vo.PathwayTargetExternalEventMappingVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.pathways.vo.PathwayTargetExternalEventMappingVo vo = null;
		if(map != null)
			vo = (ims.pathways.vo.PathwayTargetExternalEventMappingVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.pathways.vo.PathwayTargetExternalEventMappingVo();
	...
	public ims.vo.RefVoBean getExternalEventMapping()
	{
		return this.externaleventmapping;
	}
	public void setExternalEventMapping(ims.vo.RefVoBean value)
	{
	...
	private ims.vo.RefVoBean externaleventmapping;
