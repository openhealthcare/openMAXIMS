...
public class EventExternalEventMappingVoBean extends ims.vo.ValueObjectBean
{
	public EventExternalEventMappingVoBean()
	{
	}
	public EventExternalEventMappingVoBean(ims.pathways.vo.EventExternalEventMappingVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.event = vo.getEvent() == null ? null : (ims.pathways.vo.beans.EventVoBean)vo.getEvent().getBean();
		this.externaleventmapping = vo.getExternalEventMapping() == null ? null : (ims.pathways.vo.beans.ExternalEventMappingVoBean)vo.getExternalEventMapping().getBean();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.pathways.vo.EventExternalEventMappingVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.event = vo.getEvent() == null ? null : (ims.pathways.vo.beans.EventVoBean)vo.getEvent().getBean(map);
		this.externaleventmapping = vo.getExternalEventMapping() == null ? null : (ims.pathways.vo.beans.ExternalEventMappingVoBean)vo.getExternalEventMapping().getBean(map);
		this.status = vo.getStatus() == null ? null : (ims.vo.LookupInstanceBean)vo.getStatus().getBean();
	...
	public ims.pathways.vo.EventExternalEventMappingVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.pathways.vo.EventExternalEventMappingVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.pathways.vo.EventExternalEventMappingVo vo = null;
		if(map != null)
			vo = (ims.pathways.vo.EventExternalEventMappingVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.pathways.vo.EventExternalEventMappingVo();
	...
	public ims.pathways.vo.beans.ExternalEventMappingVoBean getExternalEventMapping()
	{
		return this.externaleventmapping;
	}
	public void setExternalEventMapping(ims.pathways.vo.beans.ExternalEventMappingVoBean value)
	{
	...
	private ims.pathways.vo.beans.ExternalEventMappingVoBean externaleventmapping;
