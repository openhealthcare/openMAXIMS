 ...
 */
public class PatientDiagnosisForPrimaryTumourVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.oncology.vo.PatientDiagnosisForPrimaryTumourVo copy(ims.oncology.vo.PatientDiagnosisForPrimaryTumourVo valueObjectDest, ims.oncology.vo.PatientDiagnosisForPrimaryTumourVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createPatientDiagnosisForPrimaryTumourVoCollectionFromPatientDiagnosis(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.clinical.domain.objects.PatientDiagnosis objects.
	 */
	public static ims.oncology.vo.PatientDiagnosisForPrimaryTumourVoCollection createPatientDiagnosisForPrimaryTumourVoCollectionFromPatientDiagnosis(java.util.Set domainObjectSet)	
	{
		return createPatientDiagnosisForPrimaryTumourVoCollectionFromPatientDiagnosis(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.clinical.domain.objects.PatientDiagnosis objects.
	 */
	public static ims.oncology.vo.PatientDiagnosisForPrimaryTumourVoCollection createPatientDiagnosisForPrimaryTumourVoCollectionFromPatientDiagnosis(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.oncology.vo.PatientDiagnosisForPrimaryTumourVoCollection voList = new ims.oncology.vo.PatientDiagnosisForPrimaryTumourVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.oncology.vo.PatientDiagnosisForPrimaryTumourVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.oncology.vo.PatientDiagnosisForPrimaryTumourVoCollection createPatientDiagnosisForPrimaryTumourVoCollectionFromPatientDiagnosis(java.util.List domainObjectList) 
	{
		return createPatientDiagnosisForPrimaryTumourVoCollectionFromPatientDiagnosis(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.clinical.domain.objects.PatientDiagnosis objects.
	 */
	public static ims.oncology.vo.PatientDiagnosisForPrimaryTumourVoCollection createPatientDiagnosisForPrimaryTumourVoCollectionFromPatientDiagnosis(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.oncology.vo.PatientDiagnosisForPrimaryTumourVoCollection voList = new ims.oncology.vo.PatientDiagnosisForPrimaryTumourVoCollection();
	 ...
	 */
	 public static java.util.Set extractPatientDiagnosisSet(ims.domain.ILightweightDomainFactory domainFactory, ims.oncology.vo.PatientDiagnosisForPrimaryTumourVoCollection voCollection) 
	 {
	 	return extractPatientDiagnosisSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientDiagnosisSet(ims.domain.ILightweightDomainFactory domainFactory, ims.oncology.vo.PatientDiagnosisForPrimaryTumourVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.oncology.vo.PatientDiagnosisForPrimaryTumourVo vo = voCollection.get(i);
			ims.core.clinical.domain.objects.PatientDiagnosis domainObject = PatientDiagnosisForPrimaryTumourVoAssembler.extractPatientDiagnosis(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPatientDiagnosisList(ims.domain.ILightweightDomainFactory domainFactory, ims.oncology.vo.PatientDiagnosisForPrimaryTumourVoCollection voCollection) 
	 {
	 	return extractPatientDiagnosisList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPatientDiagnosisList(ims.domain.ILightweightDomainFactory domainFactory, ims.oncology.vo.PatientDiagnosisForPrimaryTumourVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.oncology.vo.PatientDiagnosisForPrimaryTumourVo create(ims.core.clinical.domain.objects.PatientDiagnosis domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.oncology.vo.PatientDiagnosisForPrimaryTumourVo create(DomainObjectMap map, ims.core.clinical.domain.objects.PatientDiagnosis domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.oncology.vo.PatientDiagnosisForPrimaryTumourVo valueObject = (ims.oncology.vo.PatientDiagnosisForPrimaryTumourVo) map.getValueObject(domainObject, ims.oncology.vo.PatientDiagnosisForPrimaryTumourVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.oncology.vo.PatientDiagnosisForPrimaryTumourVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.PatientDiagnosis
	 */
	 public static ims.oncology.vo.PatientDiagnosisForPrimaryTumourVo insert(ims.oncology.vo.PatientDiagnosisForPrimaryTumourVo valueObject, ims.core.clinical.domain.objects.PatientDiagnosis domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.PatientDiagnosis
	 */
	 public static ims.oncology.vo.PatientDiagnosisForPrimaryTumourVo insert(DomainObjectMap map, ims.oncology.vo.PatientDiagnosisForPrimaryTumourVo valueObject, ims.core.clinical.domain.objects.PatientDiagnosis domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.clinical.domain.objects.PatientDiagnosis extractPatientDiagnosis(ims.domain.ILightweightDomainFactory domainFactory, ims.oncology.vo.PatientDiagnosisForPrimaryTumourVo valueObject) 
	{
		return 	extractPatientDiagnosis(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.clinical.domain.objects.PatientDiagnosis extractPatientDiagnosis(ims.domain.ILightweightDomainFactory domainFactory, ims.oncology.vo.PatientDiagnosisForPrimaryTumourVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.oncology.vo.PatientDiagnosisForPrimaryTumourVo ID_PatientDiagnosis field is unknown
		...
		ims.core.vo.lookups.DiagnosisBasisofDiagnosisCollection collection5 =
	valueObject.getBasisofDiagnosis();
		...
		//Remove all ones in domList where index > voCollection.size() as these should
		//now represent the ones removed from the VO collection. No longer referenced.
		int j5 = domainBasisofDiagnosis.size();
		while (j5 > collection5Size)
		{
			domainBasisofDiagnosis.remove(j5-1);
			j5 = domainBasisofDiagnosis.size();
		}
