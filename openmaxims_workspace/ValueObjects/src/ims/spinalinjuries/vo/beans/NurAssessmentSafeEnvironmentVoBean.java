...
public class NurAssessmentSafeEnvironmentVoBean extends ims.vo.ValueObjectBean
{
	public NurAssessmentSafeEnvironmentVoBean()
	{
	}
	public NurAssessmentSafeEnvironmentVoBean(ims.spinalinjuries.vo.NurAssessmentSafeEnvironmentVo vo)
	{
		this.id = vo.getBoId();
		...
		this.maintainownsafety = vo.getMaintainOwnSafety() == null ? null : (ims.vo.LookupInstanceBean)vo.getMaintainOwnSafety().getBean();
		this.haveaheadinjury = vo.getHaveAHeadInjury() == null ? null : (ims.vo.LookupInstanceBean)vo.getHaveAHeadInjury().getBean();
		this.riskofautonomicdysreflexia = vo.getRiskOfAutonomicDysreflexia() == null ? null : (ims.vo.LookupInstanceBean)vo.getRiskOfAutonomicDysreflexia().getBean();
		this.notes = vo.getNotes();
		this.safetylevel = vo.getSafetyLevel() == null ? null : vo.getSafetyLevel().getBeanCollection();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.spinalinjuries.vo.NurAssessmentSafeEnvironmentVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.iscomplete = vo.getIsComplete();
	...
	public ims.spinalinjuries.vo.NurAssessmentSafeEnvironmentVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.spinalinjuries.vo.NurAssessmentSafeEnvironmentVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.spinalinjuries.vo.NurAssessmentSafeEnvironmentVo vo = null;
		if(map != null)
			vo = (ims.spinalinjuries.vo.NurAssessmentSafeEnvironmentVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.spinalinjuries.vo.NurAssessmentSafeEnvironmentVo();
	...
	public ims.vo.LookupInstanceBean getMaintainOwnSafety()
	{
		return this.maintainownsafety;
	}
	public void setMaintainOwnSafety(ims.vo.LookupInstanceBean value)
	{
		this.maintainownsafety = value;
	}
	public ims.vo.LookupInstanceBean getHaveAHeadInjury()
	{
		return this.haveaheadinjury;
	}
	public void setHaveAHeadInjury(ims.vo.LookupInstanceBean value)
	{
		this.haveaheadinjury = value;
	}
	public ims.vo.LookupInstanceBean getRiskOfAutonomicDysreflexia()
	{
		return this.riskofautonomicdysreflexia;
	}
	public void setRiskOfAutonomicDysreflexia(ims.vo.LookupInstanceBean value)
	{
	...
	public ims.nursing.vo.beans.SafetyLevelVoBean[] getSafetyLevel()
	{
		return this.safetylevel;
	}
	public void setSafetyLevel(ims.nursing.vo.beans.SafetyLevelVoBean[] value)
	{
	...
	private ims.vo.LookupInstanceBean maintainownsafety;
	private ims.vo.LookupInstanceBean haveaheadinjury;
	private ims.vo.LookupInstanceBean riskofautonomicdysreflexia;
	private String notes;
	private ims.nursing.vo.beans.SafetyLevelVoBean[] safetylevel;
}
