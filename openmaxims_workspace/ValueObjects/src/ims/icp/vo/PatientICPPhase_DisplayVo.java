 ...
 */
public class PatientICPPhase_DisplayVo extends ims.icps.instantiation.vo.PatientICPPhaseRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public PatientICPPhase_DisplayVo()
	{
	}
	public PatientICPPhase_DisplayVo(Integer id, int version)
	{
		super(id, version);
	}
	public PatientICPPhase_DisplayVo(ims.icp.vo.beans.PatientICPPhase_DisplayVoBean bean)
	{
		this.id = bean.getId();
		...
		this.hasactions = bean.getHasActions();
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.icp.vo.beans.PatientICPPhase_DisplayVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.icp = bean.getICP() == null ? null : new ims.icps.instantiation.vo.PatientICPRefVo(new Integer(bean.getICP().getId()), bean.getICP().getVersion());
	...
	{
		ims.icp.vo.beans.PatientICPPhase_DisplayVoBean bean = null;
		if(map != null)
			bean = (ims.icp.vo.beans.PatientICPPhase_DisplayVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.icp.vo.beans.PatientICPPhase_DisplayVoBean();
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("HASACTIONS"))
			return getHasActions();
	...
	public boolean getHasActionsIsNotNull()
	{
		return this.hasactions != null;
	}
	...
	public Object clone()
	{
		...
		PatientICPPhase_DisplayVo clone = new PatientICPPhase_DisplayVo(this.id, this.version);
		...
		clone.hasactions = this.hasactions;
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(PatientICPPhase_DisplayVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A PatientICPPhase_DisplayVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((PatientICPPhase_DisplayVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((PatientICPPhase_DisplayVo)obj).getBoId());
	}
