...
public class ICPStageLiteVoBean extends ims.vo.ValueObjectBean
{
	public ICPStageLiteVoBean()
	{
	}
	public ICPStageLiteVoBean(ims.icp.vo.ICPStageLiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public ims.icp.vo.ICPStageLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.icp.vo.ICPStageLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.icp.vo.ICPStageLiteVo vo = null;
		if(map != null)
			vo = (ims.icp.vo.ICPStageLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.icp.vo.ICPStageLiteVo();
