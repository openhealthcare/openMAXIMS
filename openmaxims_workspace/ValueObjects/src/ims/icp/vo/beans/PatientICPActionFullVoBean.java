...
public class PatientICPActionFullVoBean extends ims.vo.ValueObjectBean
{
	public PatientICPActionFullVoBean()
	{
	}
	public PatientICPActionFullVoBean(ims.icp.vo.PatientICPActionFullVo vo)
	{
		this.id = vo.getBoId();
		...
		this.action = vo.getAction() == null ? null : (ims.icp.vo.beans.ICPActionShortVoBean)vo.getAction().getBean();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.icp.vo.PatientICPActionFullVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.patient = vo.getPatient() == null ? null : new ims.vo.RefVoBean(vo.getPatient().getBoId(), vo.getPatient().getBoVersion());
		this.carecontext = vo.getCareContext() == null ? null : new ims.vo.RefVoBean(vo.getCareContext().getBoId(), vo.getCareContext().getBoVersion());
		this.icp = vo.getICP() == null ? null : new ims.vo.RefVoBean(vo.getICP().getBoId(), vo.getICP().getBoVersion());
		this.action = vo.getAction() == null ? null : (ims.icp.vo.beans.ICPActionShortVoBean)vo.getAction().getBean(map);
	...
	public ims.icp.vo.PatientICPActionFullVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.icp.vo.PatientICPActionFullVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.icp.vo.PatientICPActionFullVo vo = null;
		if(map != null)
			vo = (ims.icp.vo.PatientICPActionFullVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.icp.vo.PatientICPActionFullVo();
	...
	public ims.icp.vo.beans.ICPActionShortVoBean getAction()
	{
		return this.action;
	}
	public void setAction(ims.icp.vo.beans.ICPActionShortVoBean value)
	{
		this.action = value;
	}
	...
	public ims.icp.vo.beans.PatientICPActionStatusVoBean[] getStatusHistory()
	{
		return this.statushistory;
	}
	public void setStatusHistory(ims.icp.vo.beans.PatientICPActionStatusVoBean[] value)
	{
	...
	private ims.icp.vo.beans.ICPActionShortVoBean action;
	private ims.icp.vo.beans.PatientICPActionStatusVoBean currentstatus;
	private ims.icp.vo.beans.PatientICPActionStatusVoBean[] statushistory;
