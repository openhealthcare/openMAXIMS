...
public class PatientICPStage_CreationVoBean extends ims.vo.ValueObjectBean
{
	public PatientICPStage_CreationVoBean()
	{
	}
	public PatientICPStage_CreationVoBean(ims.icp.vo.PatientICPStage_CreationVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.icp.vo.PatientICPStage_CreationVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.patient = vo.getPatient() == null ? null : new ims.vo.RefVoBean(vo.getPatient().getBoId(), vo.getPatient().getBoVersion());
	...
	public ims.icp.vo.PatientICPStage_CreationVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.icp.vo.PatientICPStage_CreationVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.icp.vo.PatientICPStage_CreationVo vo = null;
		if(map != null)
			vo = (ims.icp.vo.PatientICPStage_CreationVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.icp.vo.PatientICPStage_CreationVo();
	...
	public ims.icp.vo.beans.PatientICPPhase_CreationVoBean[] getStagePhases()
	{
		return this.stagephases;
	}
	public void setStagePhases(ims.icp.vo.beans.PatientICPPhase_CreationVoBean[] value)
	{
	...
	private ims.icp.vo.beans.PatientICPPhase_CreationVoBean[] stagephases;
