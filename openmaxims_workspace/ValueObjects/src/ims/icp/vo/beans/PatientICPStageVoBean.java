...
public class PatientICPStageVoBean extends ims.vo.ValueObjectBean
{
	public PatientICPStageVoBean()
	{
	}
	public PatientICPStageVoBean(ims.icp.vo.PatientICPStageVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.icp.vo.PatientICPStageVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.patient = vo.getPatient() == null ? null : new ims.vo.RefVoBean(vo.getPatient().getBoId(), vo.getPatient().getBoVersion());
	...
	public ims.icp.vo.PatientICPStageVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.icp.vo.PatientICPStageVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.icp.vo.PatientICPStageVo vo = null;
		if(map != null)
			vo = (ims.icp.vo.PatientICPStageVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.icp.vo.PatientICPStageVo();
	...
	public ims.icp.vo.beans.PatientICPPhaseVoBean[] getStagePhases()
	{
		return this.stagephases;
	}
	public void setStagePhases(ims.icp.vo.beans.PatientICPPhaseVoBean[] value)
	{
	...
	private ims.icp.vo.beans.PatientICPPhaseVoBean[] stagephases;
}
