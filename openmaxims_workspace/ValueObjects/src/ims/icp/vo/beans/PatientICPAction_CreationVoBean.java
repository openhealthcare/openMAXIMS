...
public class PatientICPAction_CreationVoBean extends ims.vo.ValueObjectBean
{
	public PatientICPAction_CreationVoBean()
	{
	}
	public PatientICPAction_CreationVoBean(ims.icp.vo.PatientICPAction_CreationVo vo)
	{
		this.id = vo.getBoId();
		...
		this.action = vo.getAction() == null ? null : new ims.vo.RefVoBean(vo.getAction().getBoId(), vo.getAction().getBoVersion());
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.icp.vo.PatientICPAction_CreationVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.patient = vo.getPatient() == null ? null : new ims.vo.RefVoBean(vo.getPatient().getBoId(), vo.getPatient().getBoVersion());
	...
	public ims.icp.vo.PatientICPAction_CreationVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.icp.vo.PatientICPAction_CreationVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.icp.vo.PatientICPAction_CreationVo vo = null;
		if(map != null)
			vo = (ims.icp.vo.PatientICPAction_CreationVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.icp.vo.PatientICPAction_CreationVo();
	...
	public ims.vo.RefVoBean getAction()
	{
		return this.action;
	}
	public void setAction(ims.vo.RefVoBean value)
	{
		this.action = value;
	}
	...
	private ims.vo.RefVoBean action;
