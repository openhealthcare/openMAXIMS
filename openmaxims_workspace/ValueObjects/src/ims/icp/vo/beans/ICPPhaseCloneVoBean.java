...
public class ICPPhaseCloneVoBean extends ims.vo.ValueObjectBean
{
	public ICPPhaseCloneVoBean()
	{
	}
	public ICPPhaseCloneVoBean(ims.icp.vo.ICPPhaseCloneVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.icp.vo.ICPPhaseCloneVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.name = vo.getName();
	...
	public ims.icp.vo.ICPPhaseCloneVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.icp.vo.ICPPhaseCloneVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.icp.vo.ICPPhaseCloneVo vo = null;
		if(map != null)
			vo = (ims.icp.vo.ICPPhaseCloneVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.icp.vo.ICPPhaseCloneVo();
	...
	public ims.icp.vo.beans.ICPActionCloneVoBean[] getActions()
	{
		return this.actions;
	}
	public void setActions(ims.icp.vo.beans.ICPActionCloneVoBean[] value)
	{
		this.actions = value;
	}
	...
	private ims.icp.vo.beans.ICPActionCloneVoBean[] actions;
}
