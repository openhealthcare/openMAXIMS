...
public class PatientICPPhasesLiteVoBean extends ims.vo.ValueObjectBean
{
	public PatientICPPhasesLiteVoBean()
	{
	}
	public PatientICPPhasesLiteVoBean(ims.icp.vo.PatientICPPhasesLiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.icp.vo.PatientICPPhasesLiteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.icp.vo.PatientICPPhasesLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.icp.vo.PatientICPPhasesLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.icp.vo.PatientICPPhasesLiteVo vo = null;
		if(map != null)
			vo = (ims.icp.vo.PatientICPPhasesLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.icp.vo.PatientICPPhasesLiteVo();
	...
	public ims.icp.vo.beans.PatientICPActionLiteVoBean[] getPhaseActions()
	{
		return this.phaseactions;
	}
	public void setPhaseActions(ims.icp.vo.beans.PatientICPActionLiteVoBean[] value)
	{
	...
	private ims.icp.vo.beans.PatientICPActionLiteVoBean[] phaseactions;
