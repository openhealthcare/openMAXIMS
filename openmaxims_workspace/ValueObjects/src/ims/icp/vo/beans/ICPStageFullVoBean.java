...
public class ICPStageFullVoBean extends ims.vo.ValueObjectBean
{
	public ICPStageFullVoBean()
	{
	}
	public ICPStageFullVoBean(ims.icp.vo.ICPStageFullVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.icp.vo.ICPStageFullVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.name = vo.getName();
	...
	public ims.icp.vo.ICPStageFullVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.icp.vo.ICPStageFullVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.icp.vo.ICPStageFullVo vo = null;
		if(map != null)
			vo = (ims.icp.vo.ICPStageFullVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.icp.vo.ICPStageFullVo();
	...
	public ims.icp.vo.beans.ICPPhaseFullVoBean[] getPhases()
	{
		return this.phases;
	}
	public void setPhases(ims.icp.vo.beans.ICPPhaseFullVoBean[] value)
	{
		this.phases = value;
	}
	...
	private ims.icp.vo.beans.ICPPhaseFullVoBean[] phases;
