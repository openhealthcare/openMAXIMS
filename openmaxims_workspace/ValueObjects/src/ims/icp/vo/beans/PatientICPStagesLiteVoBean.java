...
public class PatientICPStagesLiteVoBean extends ims.vo.ValueObjectBean
{
	public PatientICPStagesLiteVoBean()
	{
	}
	public PatientICPStagesLiteVoBean(ims.icp.vo.PatientICPStagesLiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.icp.vo.PatientICPStagesLiteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.icp.vo.PatientICPStagesLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.icp.vo.PatientICPStagesLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.icp.vo.PatientICPStagesLiteVo vo = null;
		if(map != null)
			vo = (ims.icp.vo.PatientICPStagesLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.icp.vo.PatientICPStagesLiteVo();
	...
	public ims.icp.vo.beans.PatientICPPhasesLiteVoBean[] getStagePhases()
	{
		return this.stagephases;
	}
	public void setStagePhases(ims.icp.vo.beans.PatientICPPhasesLiteVoBean[] value)
	{
	...
	private ims.icp.vo.beans.PatientICPPhasesLiteVoBean[] stagephases;
