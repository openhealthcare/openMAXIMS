 ...
 */
public class ICPPhaseFullVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.icp.vo.ICPPhaseFullVo copy(ims.icp.vo.ICPPhaseFullVo valueObjectDest, ims.icp.vo.ICPPhaseFullVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createICPPhaseFullVoCollectionFromICPPhase(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.icps.configuration.domain.objects.ICPPhase objects.
	 */
	public static ims.icp.vo.ICPPhaseFullVoCollection createICPPhaseFullVoCollectionFromICPPhase(java.util.Set domainObjectSet)	
	{
		return createICPPhaseFullVoCollectionFromICPPhase(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.icps.configuration.domain.objects.ICPPhase objects.
	 */
	public static ims.icp.vo.ICPPhaseFullVoCollection createICPPhaseFullVoCollectionFromICPPhase(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.icp.vo.ICPPhaseFullVoCollection voList = new ims.icp.vo.ICPPhaseFullVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.icp.vo.ICPPhaseFullVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.icp.vo.ICPPhaseFullVoCollection createICPPhaseFullVoCollectionFromICPPhase(java.util.List domainObjectList) 
	{
		return createICPPhaseFullVoCollectionFromICPPhase(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.icps.configuration.domain.objects.ICPPhase objects.
	 */
	public static ims.icp.vo.ICPPhaseFullVoCollection createICPPhaseFullVoCollectionFromICPPhase(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.icp.vo.ICPPhaseFullVoCollection voList = new ims.icp.vo.ICPPhaseFullVoCollection();
	 ...
	 */
	 public static java.util.Set extractICPPhaseSet(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.ICPPhaseFullVoCollection voCollection) 
	 {
	 	return extractICPPhaseSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractICPPhaseSet(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.ICPPhaseFullVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.icp.vo.ICPPhaseFullVo vo = voCollection.get(i);
			ims.icps.configuration.domain.objects.ICPPhase domainObject = ICPPhaseFullVoAssembler.extractICPPhase(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractICPPhaseList(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.ICPPhaseFullVoCollection voCollection) 
	 {
	 	return extractICPPhaseList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractICPPhaseList(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.ICPPhaseFullVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.icp.vo.ICPPhaseFullVo create(ims.icps.configuration.domain.objects.ICPPhase domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.icp.vo.ICPPhaseFullVo create(DomainObjectMap map, ims.icps.configuration.domain.objects.ICPPhase domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.icp.vo.ICPPhaseFullVo valueObject = (ims.icp.vo.ICPPhaseFullVo) map.getValueObject(domainObject, ims.icp.vo.ICPPhaseFullVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.icp.vo.ICPPhaseFullVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.icps.configuration.domain.objects.ICPPhase
	 */
	 public static ims.icp.vo.ICPPhaseFullVo insert(ims.icp.vo.ICPPhaseFullVo valueObject, ims.icps.configuration.domain.objects.ICPPhase domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.icps.configuration.domain.objects.ICPPhase
	 */
	 public static ims.icp.vo.ICPPhaseFullVo insert(DomainObjectMap map, ims.icp.vo.ICPPhaseFullVo valueObject, ims.icps.configuration.domain.objects.ICPPhase domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// Actions
		valueObject.setActions(ims.icp.vo.domain.ICPActionShortVoAssembler.createICPActionShortVoCollectionFromICPAction(map, domainObject.getActions()) );
		// Rules
	 ...
	 */
	public static ims.icps.configuration.domain.objects.ICPPhase extractICPPhase(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.ICPPhaseFullVo valueObject) 
	{
		return 	extractICPPhase(domainFactory, valueObject, new HashMap());
	}

	public static ims.icps.configuration.domain.objects.ICPPhase extractICPPhase(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.ICPPhaseFullVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.icp.vo.ICPPhaseFullVo ID_ICPPhase field is unknown
		...
		domainObject.setActions(ims.icp.vo.domain.ICPActionShortVoAssembler.extractICPActionSet(domainFactory, valueObject.getActions(), domainObject.getActions(), domMap));		
