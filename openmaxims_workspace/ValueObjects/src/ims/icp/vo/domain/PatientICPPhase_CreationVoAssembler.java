 ...
 */
public class PatientICPPhase_CreationVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.icp.vo.PatientICPPhase_CreationVo copy(ims.icp.vo.PatientICPPhase_CreationVo valueObjectDest, ims.icp.vo.PatientICPPhase_CreationVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createPatientICPPhase_CreationVoCollectionFromPatientICPPhase(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.icps.instantiation.domain.objects.PatientICPPhase objects.
	 */
	public static ims.icp.vo.PatientICPPhase_CreationVoCollection createPatientICPPhase_CreationVoCollectionFromPatientICPPhase(java.util.Set domainObjectSet)	
	{
		return createPatientICPPhase_CreationVoCollectionFromPatientICPPhase(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.icps.instantiation.domain.objects.PatientICPPhase objects.
	 */
	public static ims.icp.vo.PatientICPPhase_CreationVoCollection createPatientICPPhase_CreationVoCollectionFromPatientICPPhase(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.icp.vo.PatientICPPhase_CreationVoCollection voList = new ims.icp.vo.PatientICPPhase_CreationVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.icp.vo.PatientICPPhase_CreationVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.icp.vo.PatientICPPhase_CreationVoCollection createPatientICPPhase_CreationVoCollectionFromPatientICPPhase(java.util.List domainObjectList) 
	{
		return createPatientICPPhase_CreationVoCollectionFromPatientICPPhase(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.icps.instantiation.domain.objects.PatientICPPhase objects.
	 */
	public static ims.icp.vo.PatientICPPhase_CreationVoCollection createPatientICPPhase_CreationVoCollectionFromPatientICPPhase(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.icp.vo.PatientICPPhase_CreationVoCollection voList = new ims.icp.vo.PatientICPPhase_CreationVoCollection();
	 ...
	 */
	 public static java.util.Set extractPatientICPPhaseSet(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICPPhase_CreationVoCollection voCollection) 
	 {
	 	return extractPatientICPPhaseSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientICPPhaseSet(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICPPhase_CreationVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.icp.vo.PatientICPPhase_CreationVo vo = voCollection.get(i);
			ims.icps.instantiation.domain.objects.PatientICPPhase domainObject = PatientICPPhase_CreationVoAssembler.extractPatientICPPhase(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPatientICPPhaseList(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICPPhase_CreationVoCollection voCollection) 
	 {
	 	return extractPatientICPPhaseList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPatientICPPhaseList(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICPPhase_CreationVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.icp.vo.PatientICPPhase_CreationVo create(ims.icps.instantiation.domain.objects.PatientICPPhase domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.icp.vo.PatientICPPhase_CreationVo create(DomainObjectMap map, ims.icps.instantiation.domain.objects.PatientICPPhase domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.icp.vo.PatientICPPhase_CreationVo valueObject = (ims.icp.vo.PatientICPPhase_CreationVo) map.getValueObject(domainObject, ims.icp.vo.PatientICPPhase_CreationVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.icp.vo.PatientICPPhase_CreationVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.icps.instantiation.domain.objects.PatientICPPhase
	 */
	 public static ims.icp.vo.PatientICPPhase_CreationVo insert(ims.icp.vo.PatientICPPhase_CreationVo valueObject, ims.icps.instantiation.domain.objects.PatientICPPhase domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.icps.instantiation.domain.objects.PatientICPPhase
	 */
	 public static ims.icp.vo.PatientICPPhase_CreationVo insert(DomainObjectMap map, ims.icp.vo.PatientICPPhase_CreationVo valueObject, ims.icps.instantiation.domain.objects.PatientICPPhase domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// PhaseActions
		valueObject.setPhaseActions(ims.icp.vo.domain.PatientICPAction_CreationVoAssembler.createPatientICPAction_CreationVoCollectionFromPatientICPAction(map, domainObject.getPhaseActions()) );
		// CurrentStatus
	 ...
	 */
	public static ims.icps.instantiation.domain.objects.PatientICPPhase extractPatientICPPhase(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICPPhase_CreationVo valueObject) 
	{
		return 	extractPatientICPPhase(domainFactory, valueObject, new HashMap());
	}

	public static ims.icps.instantiation.domain.objects.PatientICPPhase extractPatientICPPhase(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICPPhase_CreationVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.icp.vo.PatientICPPhase_CreationVo ID_PatientICPPhase field is unknown
		...
		domainObject.setPhaseActions(ims.icp.vo.domain.PatientICPAction_CreationVoAssembler.extractPatientICPActionSet(domainFactory, valueObject.getPhaseActions(), domainObject.getPhaseActions(), domMap));		
		...
		ims.icps.instantiation.vo.PatientICPPhaseStatusRefVoCollection refCollection8 = new ims.icps.instantiation.vo.PatientICPPhaseStatusRefVoCollection();
		if (valueObject.getStatusHistory() != null)
		{
			for (int i8=0; i8<valueObject.getStatusHistory().size(); i8++)
			{
				ims.icps.instantiation.vo.PatientICPPhaseStatusRefVo ref8 = (ims.icps.instantiation.vo.PatientICPPhaseStatusRefVo)valueObject.getStatusHistory().get(i8);
				refCollection8.add(ref8);
			}
		}
		int size8 = (null == refCollection8) ? 0 : refCollection8.size();		
		java.util.Set domainStatusHistory8 = domainObject.getStatusHistory();
		if (domainStatusHistory8 == null)
		{
			domainStatusHistory8 = new java.util.HashSet();
		}
		java.util.Set newSet8  = new java.util.HashSet();
		for(int i=0; i<size8; i++) 
		{
			ims.icps.instantiation.vo.PatientICPPhaseStatusRefVo vo = refCollection8.get(i);					
			...
			//Trying to avoid the hibernate collection being marked as dirty via its public interface methods. (like add)
			if (!domainStatusHistory8.contains(dom))
			{
				domainStatusHistory8.add(dom);
			}
			newSet8.add(dom);			
		}
		java.util.Set removedSet8 = new java.util.HashSet();
		java.util.Iterator iter8 = domainStatusHistory8.iterator();
		//Find out which objects need to be removed
		while (iter8.hasNext())
		{
		...
		while (iter8.hasNext())
		{
			domainStatusHistory8.remove(iter8.next());
		}		
