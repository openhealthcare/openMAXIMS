 ...
 */
public class ICPActionShortVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.icp.vo.ICPActionShortVo copy(ims.icp.vo.ICPActionShortVo valueObjectDest, ims.icp.vo.ICPActionShortVo valueObjectSrc) 
	 {
		...
		valueObjectDest.setClinicalDetailActions(valueObjectSrc.getClinicalDetailActions());
		// Name
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createICPActionShortVoCollectionFromICPAction(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.icps.configuration.domain.objects.ICPAction objects.
	 */
	public static ims.icp.vo.ICPActionShortVoCollection createICPActionShortVoCollectionFromICPAction(java.util.Set domainObjectSet)	
	{
		return createICPActionShortVoCollectionFromICPAction(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.icps.configuration.domain.objects.ICPAction objects.
	 */
	public static ims.icp.vo.ICPActionShortVoCollection createICPActionShortVoCollectionFromICPAction(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.icp.vo.ICPActionShortVoCollection voList = new ims.icp.vo.ICPActionShortVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.icp.vo.ICPActionShortVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.icp.vo.ICPActionShortVoCollection createICPActionShortVoCollectionFromICPAction(java.util.List domainObjectList) 
	{
		return createICPActionShortVoCollectionFromICPAction(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.icps.configuration.domain.objects.ICPAction objects.
	 */
	public static ims.icp.vo.ICPActionShortVoCollection createICPActionShortVoCollectionFromICPAction(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.icp.vo.ICPActionShortVoCollection voList = new ims.icp.vo.ICPActionShortVoCollection();
	 ...
	 */
	 public static java.util.Set extractICPActionSet(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.ICPActionShortVoCollection voCollection) 
	 {
	 	return extractICPActionSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractICPActionSet(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.ICPActionShortVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.icp.vo.ICPActionShortVo vo = voCollection.get(i);
			ims.icps.configuration.domain.objects.ICPAction domainObject = ICPActionShortVoAssembler.extractICPAction(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractICPActionList(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.ICPActionShortVoCollection voCollection) 
	 {
	 	return extractICPActionList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractICPActionList(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.ICPActionShortVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.icp.vo.ICPActionShortVo create(ims.icps.configuration.domain.objects.ICPAction domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.icp.vo.ICPActionShortVo create(DomainObjectMap map, ims.icps.configuration.domain.objects.ICPAction domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.icp.vo.ICPActionShortVo valueObject = (ims.icp.vo.ICPActionShortVo) map.getValueObject(domainObject, ims.icp.vo.ICPActionShortVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.icp.vo.ICPActionShortVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.icps.configuration.domain.objects.ICPAction
	 */
	 public static ims.icp.vo.ICPActionShortVo insert(ims.icp.vo.ICPActionShortVo valueObject, ims.icps.configuration.domain.objects.ICPAction domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.icps.configuration.domain.objects.ICPAction
	 */
	 public static ims.icp.vo.ICPActionShortVo insert(DomainObjectMap map, ims.icp.vo.ICPActionShortVo valueObject, ims.icps.configuration.domain.objects.ICPAction domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// ClinicalDetailActions
		ims.icps.configuration.vo.ICPActionRefVoCollection ClinicalDetailActions = new ims.icps.configuration.vo.ICPActionRefVoCollection();
		for(java.util.Iterator iterator = domainObject.getClinicalDetailActions().iterator(); iterator.hasNext(); ) 
		{
			ims.icps.configuration.domain.objects.ICPAction tmp = (ims.icps.configuration.domain.objects.ICPAction)iterator.next();
			if (tmp != null)
				ClinicalDetailActions.add(new ims.icps.configuration.vo.ICPActionRefVo(tmp.getId(),tmp.getVersion()));
		}
		valueObject.setClinicalDetailActions(ClinicalDetailActions);
		// Name
		...
		// LinkedType
		ims.domain.lookups.LookupInstance instance15 = domainObject.getLinkedType();
		if ( null != instance15 ) {
			ims.framework.utils.ImagePath img = null;
			ims.framework.utils.Color color = null;		
			img = null;
			...
			ims.core.vo.lookups.ICPCompLinkedType voLookup15 = new ims.core.vo.lookups.ICPCompLinkedType(instance15.getId(),instance15.getText(), instance15.isActive(), null, img, color);
			ims.core.vo.lookups.ICPCompLinkedType parentVoLookup15 = voLookup15;
			...
			while (parent15 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup15.setParent(new ims.core.vo.lookups.ICPCompLinkedType(parent15.getId(),parent15.getText(), parent15.isActive(), null, img, color));
				parentVoLookup15 = parentVoLookup15.getParent();
								parent15 = parent15.getParent();
			}			
			valueObject.setLinkedType(voLookup15);
		}
		 		return valueObject;
	 }
	 ...
	 */
	public static ims.icps.configuration.domain.objects.ICPAction extractICPAction(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.ICPActionShortVo valueObject) 
	{
		return 	extractICPAction(domainFactory, valueObject, new HashMap());
	}

	public static ims.icps.configuration.domain.objects.ICPAction extractICPAction(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.ICPActionShortVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.icp.vo.ICPActionShortVo ID_ICPAction field is unknown
		...
		ims.icps.configuration.vo.ICPActionRefVoCollection refCollection6 = valueObject.getClinicalDetailActions();
		int size6 = (null == refCollection6) ? 0 : refCollection6.size();		
		java.util.Set domainClinicalDetailActions6 = domainObject.getClinicalDetailActions();
		if (domainClinicalDetailActions6 == null)
		{
			domainClinicalDetailActions6 = new java.util.HashSet();
		}
		java.util.Set newSet6  = new java.util.HashSet();
		for(int i=0; i<size6; i++) 
		{
			ims.icps.configuration.vo.ICPActionRefVo vo = refCollection6.get(i);					
			...
			//Trying to avoid the hibernate collection being marked as dirty via its public interface methods. (like add)
			if (!domainClinicalDetailActions6.contains(dom))
			{
				domainClinicalDetailActions6.add(dom);
			}
			newSet6.add(dom);			
		}
		java.util.Set removedSet6 = new java.util.HashSet();
		java.util.Iterator iter6 = domainClinicalDetailActions6.iterator();
		//Find out which objects need to be removed
		while (iter6.hasNext())
		{
		...
		while (iter6.hasNext())
		{
			domainClinicalDetailActions6.remove(iter6.next());
		}		
		
		domainObject.setClinicalDetailActions(domainClinicalDetailActions6);		
		...
		ims.core.vo.lookups.HcpDisTypeCollection collection10 =
	valueObject.getDiscipline();
		...
		//Remove all ones in domList where index > voCollection.size() as these should
		//now represent the ones removed from the VO collection. No longer referenced.
		int j10 = domainDiscipline.size();
		while (j10 > collection10Size)
		{
			domainDiscipline.remove(j10-1);
			j10 = domainDiscipline.size();
		}
		...
		domainObject.setLinkedType(value15);
