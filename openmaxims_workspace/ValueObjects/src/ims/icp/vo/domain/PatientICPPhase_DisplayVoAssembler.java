 ...
 */
public class PatientICPPhase_DisplayVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.icp.vo.PatientICPPhase_DisplayVo copy(ims.icp.vo.PatientICPPhase_DisplayVo valueObjectDest, ims.icp.vo.PatientICPPhase_DisplayVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createPatientICPPhase_DisplayVoCollectionFromPatientICPPhase(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.icps.instantiation.domain.objects.PatientICPPhase objects.
	 */
	public static ims.icp.vo.PatientICPPhase_DisplayVoCollection createPatientICPPhase_DisplayVoCollectionFromPatientICPPhase(java.util.Set domainObjectSet)	
	{
		return createPatientICPPhase_DisplayVoCollectionFromPatientICPPhase(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.icps.instantiation.domain.objects.PatientICPPhase objects.
	 */
	public static ims.icp.vo.PatientICPPhase_DisplayVoCollection createPatientICPPhase_DisplayVoCollectionFromPatientICPPhase(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.icp.vo.PatientICPPhase_DisplayVoCollection voList = new ims.icp.vo.PatientICPPhase_DisplayVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.icp.vo.PatientICPPhase_DisplayVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.icp.vo.PatientICPPhase_DisplayVoCollection createPatientICPPhase_DisplayVoCollectionFromPatientICPPhase(java.util.List domainObjectList) 
	{
		return createPatientICPPhase_DisplayVoCollectionFromPatientICPPhase(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.icps.instantiation.domain.objects.PatientICPPhase objects.
	 */
	public static ims.icp.vo.PatientICPPhase_DisplayVoCollection createPatientICPPhase_DisplayVoCollectionFromPatientICPPhase(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.icp.vo.PatientICPPhase_DisplayVoCollection voList = new ims.icp.vo.PatientICPPhase_DisplayVoCollection();
	 ...
	 */
	 public static java.util.Set extractPatientICPPhaseSet(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICPPhase_DisplayVoCollection voCollection) 
	 {
	 	return extractPatientICPPhaseSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientICPPhaseSet(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICPPhase_DisplayVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.icp.vo.PatientICPPhase_DisplayVo vo = voCollection.get(i);
			ims.icps.instantiation.domain.objects.PatientICPPhase domainObject = PatientICPPhase_DisplayVoAssembler.extractPatientICPPhase(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPatientICPPhaseList(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICPPhase_DisplayVoCollection voCollection) 
	 {
	 	return extractPatientICPPhaseList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPatientICPPhaseList(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICPPhase_DisplayVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.icp.vo.PatientICPPhase_DisplayVo create(ims.icps.instantiation.domain.objects.PatientICPPhase domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.icp.vo.PatientICPPhase_DisplayVo create(DomainObjectMap map, ims.icps.instantiation.domain.objects.PatientICPPhase domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.icp.vo.PatientICPPhase_DisplayVo valueObject = (ims.icp.vo.PatientICPPhase_DisplayVo) map.getValueObject(domainObject, ims.icp.vo.PatientICPPhase_DisplayVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.icp.vo.PatientICPPhase_DisplayVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.icps.instantiation.domain.objects.PatientICPPhase
	 */
	 public static ims.icp.vo.PatientICPPhase_DisplayVo insert(ims.icp.vo.PatientICPPhase_DisplayVo valueObject, ims.icps.instantiation.domain.objects.PatientICPPhase domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.icps.instantiation.domain.objects.PatientICPPhase
	 */
	 public static ims.icp.vo.PatientICPPhase_DisplayVo insert(DomainObjectMap map, ims.icp.vo.PatientICPPhase_DisplayVo valueObject, ims.icps.instantiation.domain.objects.PatientICPPhase domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.icps.instantiation.domain.objects.PatientICPPhase extractPatientICPPhase(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICPPhase_DisplayVo valueObject) 
	{
		return 	extractPatientICPPhase(domainFactory, valueObject, new HashMap());
	}

	public static ims.icps.instantiation.domain.objects.PatientICPPhase extractPatientICPPhase(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICPPhase_DisplayVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.icp.vo.PatientICPPhase_DisplayVo ID_PatientICPPhase field is unknown
	...
	ims.icps.configuration.domain.objects.ICPPhase value2 = null;
		...
		ims.icps.instantiation.vo.PatientICPPhaseStatusRefVoCollection refCollection4 = valueObject.getStatusHistory();
		...
		{
			ims.icps.instantiation.vo.PatientICPPhaseStatusRefVo vo = refCollection4.get(i);					
