 ...
 */
public class PatientICPAction_CreationVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.icp.vo.PatientICPAction_CreationVo copy(ims.icp.vo.PatientICPAction_CreationVo valueObjectDest, ims.icp.vo.PatientICPAction_CreationVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createPatientICPAction_CreationVoCollectionFromPatientICPAction(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.icps.instantiation.domain.objects.PatientICPAction objects.
	 */
	public static ims.icp.vo.PatientICPAction_CreationVoCollection createPatientICPAction_CreationVoCollectionFromPatientICPAction(java.util.Set domainObjectSet)	
	{
		return createPatientICPAction_CreationVoCollectionFromPatientICPAction(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.icps.instantiation.domain.objects.PatientICPAction objects.
	 */
	public static ims.icp.vo.PatientICPAction_CreationVoCollection createPatientICPAction_CreationVoCollectionFromPatientICPAction(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.icp.vo.PatientICPAction_CreationVoCollection voList = new ims.icp.vo.PatientICPAction_CreationVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.icp.vo.PatientICPAction_CreationVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.icp.vo.PatientICPAction_CreationVoCollection createPatientICPAction_CreationVoCollectionFromPatientICPAction(java.util.List domainObjectList) 
	{
		return createPatientICPAction_CreationVoCollectionFromPatientICPAction(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.icps.instantiation.domain.objects.PatientICPAction objects.
	 */
	public static ims.icp.vo.PatientICPAction_CreationVoCollection createPatientICPAction_CreationVoCollectionFromPatientICPAction(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.icp.vo.PatientICPAction_CreationVoCollection voList = new ims.icp.vo.PatientICPAction_CreationVoCollection();
	 ...
	 */
	 public static java.util.Set extractPatientICPActionSet(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICPAction_CreationVoCollection voCollection) 
	 {
	 	return extractPatientICPActionSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientICPActionSet(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICPAction_CreationVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.icp.vo.PatientICPAction_CreationVo vo = voCollection.get(i);
			ims.icps.instantiation.domain.objects.PatientICPAction domainObject = PatientICPAction_CreationVoAssembler.extractPatientICPAction(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPatientICPActionList(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICPAction_CreationVoCollection voCollection) 
	 {
	 	return extractPatientICPActionList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPatientICPActionList(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICPAction_CreationVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.icp.vo.PatientICPAction_CreationVo create(ims.icps.instantiation.domain.objects.PatientICPAction domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.icp.vo.PatientICPAction_CreationVo create(DomainObjectMap map, ims.icps.instantiation.domain.objects.PatientICPAction domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.icp.vo.PatientICPAction_CreationVo valueObject = (ims.icp.vo.PatientICPAction_CreationVo) map.getValueObject(domainObject, ims.icp.vo.PatientICPAction_CreationVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.icp.vo.PatientICPAction_CreationVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.icps.instantiation.domain.objects.PatientICPAction
	 */
	 public static ims.icp.vo.PatientICPAction_CreationVo insert(ims.icp.vo.PatientICPAction_CreationVo valueObject, ims.icps.instantiation.domain.objects.PatientICPAction domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.icps.instantiation.domain.objects.PatientICPAction
	 */
	 public static ims.icp.vo.PatientICPAction_CreationVo insert(DomainObjectMap map, ims.icp.vo.PatientICPAction_CreationVo valueObject, ims.icps.instantiation.domain.objects.PatientICPAction domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// Action
		if (domainObject.getAction() != null)
		{
			if(domainObject.getAction() instanceof HibernateProxy) // If the proxy is set, there is no need to lazy load, the proxy knows the id already. 
			{
				HibernateProxy p = (HibernateProxy) domainObject.getAction();
				int id = Integer.parseInt(p.getHibernateLazyInitializer().getIdentifier().toString());				
				valueObject.setAction(new ims.icps.configuration.vo.ICPActionRefVo(id, -1));				
			}
			else
			{
				valueObject.setAction(new ims.icps.configuration.vo.ICPActionRefVo(domainObject.getAction().getId(), domainObject.getAction().getVersion()));
			}
		}
		// CurrentStatus
	 ...
	 */
	public static ims.icps.instantiation.domain.objects.PatientICPAction extractPatientICPAction(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICPAction_CreationVo valueObject) 
	{
		return 	extractPatientICPAction(domainFactory, valueObject, new HashMap());
	}

	public static ims.icps.instantiation.domain.objects.PatientICPAction extractPatientICPAction(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICPAction_CreationVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.icp.vo.PatientICPAction_CreationVo ID_PatientICPAction field is unknown
		...
		ims.icps.instantiation.vo.PatientICPActionStatusRefVoCollection refCollection7 = new ims.icps.instantiation.vo.PatientICPActionStatusRefVoCollection();
		if (valueObject.getStatusHistory() != null)
		{
			for (int i7=0; i7<valueObject.getStatusHistory().size(); i7++)
			{
				ims.icps.instantiation.vo.PatientICPActionStatusRefVo ref7 = (ims.icps.instantiation.vo.PatientICPActionStatusRefVo)valueObject.getStatusHistory().get(i7);
		...
		{
			ims.icps.instantiation.vo.PatientICPActionStatusRefVo vo = refCollection7.get(i);					
