 ...
 */
public class PatientICPMediumVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.icp.vo.PatientICPMediumVo copy(ims.icp.vo.PatientICPMediumVo valueObjectDest, ims.icp.vo.PatientICPMediumVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createPatientICPMediumVoCollectionFromPatientICP(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.icps.instantiation.domain.objects.PatientICP objects.
	 */
	public static ims.icp.vo.PatientICPMediumVoCollection createPatientICPMediumVoCollectionFromPatientICP(java.util.Set domainObjectSet)	
	{
		return createPatientICPMediumVoCollectionFromPatientICP(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.icps.instantiation.domain.objects.PatientICP objects.
	 */
	public static ims.icp.vo.PatientICPMediumVoCollection createPatientICPMediumVoCollectionFromPatientICP(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.icp.vo.PatientICPMediumVoCollection voList = new ims.icp.vo.PatientICPMediumVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.icp.vo.PatientICPMediumVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.icp.vo.PatientICPMediumVoCollection createPatientICPMediumVoCollectionFromPatientICP(java.util.List domainObjectList) 
	{
		return createPatientICPMediumVoCollectionFromPatientICP(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.icps.instantiation.domain.objects.PatientICP objects.
	 */
	public static ims.icp.vo.PatientICPMediumVoCollection createPatientICPMediumVoCollectionFromPatientICP(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.icp.vo.PatientICPMediumVoCollection voList = new ims.icp.vo.PatientICPMediumVoCollection();
	 ...
	 */
	 public static java.util.Set extractPatientICPSet(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICPMediumVoCollection voCollection) 
	 {
	 	return extractPatientICPSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientICPSet(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICPMediumVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.icp.vo.PatientICPMediumVo vo = voCollection.get(i);
			ims.icps.instantiation.domain.objects.PatientICP domainObject = PatientICPMediumVoAssembler.extractPatientICP(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPatientICPList(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICPMediumVoCollection voCollection) 
	 {
	 	return extractPatientICPList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPatientICPList(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICPMediumVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.icp.vo.PatientICPMediumVo create(ims.icps.instantiation.domain.objects.PatientICP domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.icp.vo.PatientICPMediumVo create(DomainObjectMap map, ims.icps.instantiation.domain.objects.PatientICP domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.icp.vo.PatientICPMediumVo valueObject = (ims.icp.vo.PatientICPMediumVo) map.getValueObject(domainObject, ims.icp.vo.PatientICPMediumVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.icp.vo.PatientICPMediumVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.icps.instantiation.domain.objects.PatientICP
	 */
	 public static ims.icp.vo.PatientICPMediumVo insert(ims.icp.vo.PatientICPMediumVo valueObject, ims.icps.instantiation.domain.objects.PatientICP domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.icps.instantiation.domain.objects.PatientICP
	 */
	 public static ims.icp.vo.PatientICPMediumVo insert(DomainObjectMap map, ims.icp.vo.PatientICPMediumVo valueObject, ims.icps.instantiation.domain.objects.PatientICP domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.icps.instantiation.domain.objects.PatientICP extractPatientICP(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICPMediumVo valueObject) 
	{
		return 	extractPatientICP(domainFactory, valueObject, new HashMap());
	}

	public static ims.icps.instantiation.domain.objects.PatientICP extractPatientICP(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICPMediumVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.icp.vo.PatientICPMediumVo ID_PatientICP field is unknown
		...
		ims.framework.utils.DateTime dateTime2 = valueObject.getStartedDateTime();
		java.util.Date value2 = null;
		if ( dateTime2 != null ) 
		{
			value2 = dateTime2.getJavaDate();
		}
		domainObject.setStartedDateTime(value2);
	...
	ims.icps.configuration.domain.objects.ICP value8 = null;
		if ( null != valueObject.getICP() ) 
		{
			if (valueObject.getICP().getBoId() == null)
			{
				...
				{
					value8 = (ims.icps.configuration.domain.objects.ICP)domMap.get(valueObject.getICP());
				}
			}
			else
			{
				value8 = (ims.icps.configuration.domain.objects.ICP)domainFactory.getDomainObject(ims.icps.configuration.domain.objects.ICP.class, valueObject.getICP().getBoId());
			}
		}
		domainObject.setICP(value8);
