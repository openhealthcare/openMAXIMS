 ...
 */
public class PatientICP_CreationVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.icp.vo.PatientICP_CreationVo copy(ims.icp.vo.PatientICP_CreationVo valueObjectDest, ims.icp.vo.PatientICP_CreationVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createPatientICP_CreationVoCollectionFromPatientICP(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.icps.instantiation.domain.objects.PatientICP objects.
	 */
	public static ims.icp.vo.PatientICP_CreationVoCollection createPatientICP_CreationVoCollectionFromPatientICP(java.util.Set domainObjectSet)	
	{
		return createPatientICP_CreationVoCollectionFromPatientICP(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.icps.instantiation.domain.objects.PatientICP objects.
	 */
	public static ims.icp.vo.PatientICP_CreationVoCollection createPatientICP_CreationVoCollectionFromPatientICP(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.icp.vo.PatientICP_CreationVoCollection voList = new ims.icp.vo.PatientICP_CreationVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.icp.vo.PatientICP_CreationVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.icp.vo.PatientICP_CreationVoCollection createPatientICP_CreationVoCollectionFromPatientICP(java.util.List domainObjectList) 
	{
		return createPatientICP_CreationVoCollectionFromPatientICP(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.icps.instantiation.domain.objects.PatientICP objects.
	 */
	public static ims.icp.vo.PatientICP_CreationVoCollection createPatientICP_CreationVoCollectionFromPatientICP(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.icp.vo.PatientICP_CreationVoCollection voList = new ims.icp.vo.PatientICP_CreationVoCollection();
	 ...
	 */
	 public static java.util.Set extractPatientICPSet(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICP_CreationVoCollection voCollection) 
	 {
	 	return extractPatientICPSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientICPSet(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICP_CreationVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.icp.vo.PatientICP_CreationVo vo = voCollection.get(i);
			ims.icps.instantiation.domain.objects.PatientICP domainObject = PatientICP_CreationVoAssembler.extractPatientICP(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPatientICPList(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICP_CreationVoCollection voCollection) 
	 {
	 	return extractPatientICPList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPatientICPList(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICP_CreationVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.icp.vo.PatientICP_CreationVo create(ims.icps.instantiation.domain.objects.PatientICP domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.icp.vo.PatientICP_CreationVo create(DomainObjectMap map, ims.icps.instantiation.domain.objects.PatientICP domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.icp.vo.PatientICP_CreationVo valueObject = (ims.icp.vo.PatientICP_CreationVo) map.getValueObject(domainObject, ims.icp.vo.PatientICP_CreationVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.icp.vo.PatientICP_CreationVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.icps.instantiation.domain.objects.PatientICP
	 */
	 public static ims.icp.vo.PatientICP_CreationVo insert(ims.icp.vo.PatientICP_CreationVo valueObject, ims.icps.instantiation.domain.objects.PatientICP domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.icps.instantiation.domain.objects.PatientICP
	 */
	 public static ims.icp.vo.PatientICP_CreationVo insert(DomainObjectMap map, ims.icp.vo.PatientICP_CreationVo valueObject, ims.icps.instantiation.domain.objects.PatientICP domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// Stages
		valueObject.setStages(ims.icp.vo.domain.PatientICPStage_CreationVoAssembler.createPatientICPStage_CreationVoCollectionFromPatientICPStage(map, domainObject.getStages()) );
		// hasOutstandingAdminActions
	 ...
	 */
	public static ims.icps.instantiation.domain.objects.PatientICP extractPatientICP(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICP_CreationVo valueObject) 
	{
		return 	extractPatientICP(domainFactory, valueObject, new HashMap());
	}

	public static ims.icps.instantiation.domain.objects.PatientICP extractPatientICP(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICP_CreationVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.icp.vo.PatientICP_CreationVo ID_PatientICP field is unknown
		...
		ims.framework.utils.DateTime dateTime7 = valueObject.getStartedDateTime();
		java.util.Date value7 = null;
		if ( dateTime7 != null ) 
		{
			value7 = dateTime7.getJavaDate();
		}
		domainObject.setStartedDateTime(value7);
		domainObject.setStages(ims.icp.vo.domain.PatientICPStage_CreationVoAssembler.extractPatientICPStageSet(domainFactory, valueObject.getStages(), domainObject.getStages(), domMap));		
