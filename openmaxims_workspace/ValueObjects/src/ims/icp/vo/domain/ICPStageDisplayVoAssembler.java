 ...
 */
public class ICPStageDisplayVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.icp.vo.ICPStageDisplayVo copy(ims.icp.vo.ICPStageDisplayVo valueObjectDest, ims.icp.vo.ICPStageDisplayVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createICPStageDisplayVoCollectionFromICPStage(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.icps.configuration.domain.objects.ICPStage objects.
	 */
	public static ims.icp.vo.ICPStageDisplayVoCollection createICPStageDisplayVoCollectionFromICPStage(java.util.Set domainObjectSet)	
	{
		return createICPStageDisplayVoCollectionFromICPStage(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.icps.configuration.domain.objects.ICPStage objects.
	 */
	public static ims.icp.vo.ICPStageDisplayVoCollection createICPStageDisplayVoCollectionFromICPStage(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.icp.vo.ICPStageDisplayVoCollection voList = new ims.icp.vo.ICPStageDisplayVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.icp.vo.ICPStageDisplayVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.icp.vo.ICPStageDisplayVoCollection createICPStageDisplayVoCollectionFromICPStage(java.util.List domainObjectList) 
	{
		return createICPStageDisplayVoCollectionFromICPStage(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.icps.configuration.domain.objects.ICPStage objects.
	 */
	public static ims.icp.vo.ICPStageDisplayVoCollection createICPStageDisplayVoCollectionFromICPStage(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.icp.vo.ICPStageDisplayVoCollection voList = new ims.icp.vo.ICPStageDisplayVoCollection();
	 ...
	 */
	 public static java.util.Set extractICPStageSet(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.ICPStageDisplayVoCollection voCollection) 
	 {
	 	return extractICPStageSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractICPStageSet(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.ICPStageDisplayVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.icp.vo.ICPStageDisplayVo vo = voCollection.get(i);
			ims.icps.configuration.domain.objects.ICPStage domainObject = ICPStageDisplayVoAssembler.extractICPStage(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractICPStageList(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.ICPStageDisplayVoCollection voCollection) 
	 {
	 	return extractICPStageList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractICPStageList(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.ICPStageDisplayVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.icp.vo.ICPStageDisplayVo create(ims.icps.configuration.domain.objects.ICPStage domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.icp.vo.ICPStageDisplayVo create(DomainObjectMap map, ims.icps.configuration.domain.objects.ICPStage domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.icp.vo.ICPStageDisplayVo valueObject = (ims.icp.vo.ICPStageDisplayVo) map.getValueObject(domainObject, ims.icp.vo.ICPStageDisplayVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.icp.vo.ICPStageDisplayVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.icps.configuration.domain.objects.ICPStage
	 */
	 public static ims.icp.vo.ICPStageDisplayVo insert(ims.icp.vo.ICPStageDisplayVo valueObject, ims.icps.configuration.domain.objects.ICPStage domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.icps.configuration.domain.objects.ICPStage
	 */
	 public static ims.icp.vo.ICPStageDisplayVo insert(DomainObjectMap map, ims.icp.vo.ICPStageDisplayVo valueObject, ims.icps.configuration.domain.objects.ICPStage domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// Phases
		valueObject.setPhases(ims.icp.vo.domain.ICPPhaseDisplayVoAssembler.createICPPhaseDisplayVoCollectionFromICPPhase(map, domainObject.getPhases()) );
		// Name
	 ...
	 */
	public static ims.icps.configuration.domain.objects.ICPStage extractICPStage(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.ICPStageDisplayVo valueObject) 
	{
		return 	extractICPStage(domainFactory, valueObject, new HashMap());
	}

	public static ims.icps.configuration.domain.objects.ICPStage extractICPStage(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.ICPStageDisplayVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.icp.vo.ICPStageDisplayVo ID_ICPStage field is unknown
