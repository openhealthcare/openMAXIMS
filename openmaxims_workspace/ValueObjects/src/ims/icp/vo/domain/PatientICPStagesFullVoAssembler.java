 ...
 */
public class PatientICPStagesFullVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.icp.vo.PatientICPStagesFullVo copy(ims.icp.vo.PatientICPStagesFullVo valueObjectDest, ims.icp.vo.PatientICPStagesFullVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createPatientICPStagesFullVoCollectionFromPatientICPStage(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.icps.instantiation.domain.objects.PatientICPStage objects.
	 */
	public static ims.icp.vo.PatientICPStagesFullVoCollection createPatientICPStagesFullVoCollectionFromPatientICPStage(java.util.Set domainObjectSet)	
	{
		return createPatientICPStagesFullVoCollectionFromPatientICPStage(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.icps.instantiation.domain.objects.PatientICPStage objects.
	 */
	public static ims.icp.vo.PatientICPStagesFullVoCollection createPatientICPStagesFullVoCollectionFromPatientICPStage(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.icp.vo.PatientICPStagesFullVoCollection voList = new ims.icp.vo.PatientICPStagesFullVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.icp.vo.PatientICPStagesFullVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.icp.vo.PatientICPStagesFullVoCollection createPatientICPStagesFullVoCollectionFromPatientICPStage(java.util.List domainObjectList) 
	{
		return createPatientICPStagesFullVoCollectionFromPatientICPStage(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.icps.instantiation.domain.objects.PatientICPStage objects.
	 */
	public static ims.icp.vo.PatientICPStagesFullVoCollection createPatientICPStagesFullVoCollectionFromPatientICPStage(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.icp.vo.PatientICPStagesFullVoCollection voList = new ims.icp.vo.PatientICPStagesFullVoCollection();
	 ...
	 */
	 public static java.util.Set extractPatientICPStageSet(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICPStagesFullVoCollection voCollection) 
	 {
	 	return extractPatientICPStageSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientICPStageSet(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICPStagesFullVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.icp.vo.PatientICPStagesFullVo vo = voCollection.get(i);
			ims.icps.instantiation.domain.objects.PatientICPStage domainObject = PatientICPStagesFullVoAssembler.extractPatientICPStage(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPatientICPStageList(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICPStagesFullVoCollection voCollection) 
	 {
	 	return extractPatientICPStageList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPatientICPStageList(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICPStagesFullVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.icp.vo.PatientICPStagesFullVo create(ims.icps.instantiation.domain.objects.PatientICPStage domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.icp.vo.PatientICPStagesFullVo create(DomainObjectMap map, ims.icps.instantiation.domain.objects.PatientICPStage domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.icp.vo.PatientICPStagesFullVo valueObject = (ims.icp.vo.PatientICPStagesFullVo) map.getValueObject(domainObject, ims.icp.vo.PatientICPStagesFullVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.icp.vo.PatientICPStagesFullVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.icps.instantiation.domain.objects.PatientICPStage
	 */
	 public static ims.icp.vo.PatientICPStagesFullVo insert(ims.icp.vo.PatientICPStagesFullVo valueObject, ims.icps.instantiation.domain.objects.PatientICPStage domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.icps.instantiation.domain.objects.PatientICPStage
	 */
	 public static ims.icp.vo.PatientICPStagesFullVo insert(DomainObjectMap map, ims.icp.vo.PatientICPStagesFullVo valueObject, ims.icps.instantiation.domain.objects.PatientICPStage domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// StagePhases
		valueObject.setStagePhases(ims.icp.vo.domain.PatientICPPhasesFullVoAssembler.createPatientICPPhasesFullVoCollectionFromPatientICPPhase(map, domainObject.getStagePhases()) );
 		return valueObject;
	 }
	 ...
	 */
	public static ims.icps.instantiation.domain.objects.PatientICPStage extractPatientICPStage(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICPStagesFullVo valueObject) 
	{
		return 	extractPatientICPStage(domainFactory, valueObject, new HashMap());
	}

	public static ims.icps.instantiation.domain.objects.PatientICPStage extractPatientICPStage(ims.domain.ILightweightDomainFactory domainFactory, ims.icp.vo.PatientICPStagesFullVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.icp.vo.PatientICPStagesFullVo ID_PatientICPStage field is unknown
		...
		domainObject.setStatusHistory(ims.icp.vo.domain.PatientICPStageStatusVoAssembler.extractPatientICPStageStatusSet(domainFactory, valueObject.getStatusHistory(), domainObject.getStatusHistory(), domMap));		
		...
		domainObject.setStagePhases(ims.icp.vo.domain.PatientICPPhasesFullVoAssembler.extractPatientICPPhaseSet(domainFactory, valueObject.getStagePhases(), domainObject.getStagePhases(), domMap));		
