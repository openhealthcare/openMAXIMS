 ...
 */
public class PatientICPAction_PresentationVo extends ims.icps.instantiation.vo.PatientICPActionRefVo implements ims.vo.ImsCloneable, Comparable, ims.vo.interfaces.IInstantiationICPStagePhaseAction
{
	private static final long serialVersionUID = 1L;

	public PatientICPAction_PresentationVo()
	{
	}
	public PatientICPAction_PresentationVo(Integer id, int version)
	{
		super(id, version);
	}
	public PatientICPAction_PresentationVo(ims.icp.vo.beans.PatientICPAction_PresentationVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.icp.vo.beans.PatientICPAction_PresentationVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.icp = bean.getICP() == null ? null : new ims.icps.instantiation.vo.PatientICPRefVo(new Integer(bean.getICP().getId()), bean.getICP().getVersion());
	...
	{
		ims.icp.vo.beans.PatientICPAction_PresentationVoBean bean = null;
		if(map != null)
			bean = (ims.icp.vo.beans.PatientICPAction_PresentationVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.icp.vo.beans.PatientICPAction_PresentationVoBean();
	...
	*/
	...
	public Object clone()
	{
		...
		PatientICPAction_PresentationVo clone = new PatientICPAction_PresentationVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(PatientICPAction_PresentationVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A PatientICPAction_PresentationVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((PatientICPAction_PresentationVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((PatientICPAction_PresentationVo)obj).getBoId());
	}
