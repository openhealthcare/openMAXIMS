 ...
 */
public class Patient_ICP_LiteVo extends ims.icps.instantiation.vo.PatientICPRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public Patient_ICP_LiteVo()
	{
	}
	public Patient_ICP_LiteVo(Integer id, int version)
	{
		super(id, version);
	}
	public Patient_ICP_LiteVo(ims.icp.vo.beans.Patient_ICP_LiteVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.icp.vo.beans.Patient_ICP_LiteVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.icp.vo.beans.Patient_ICP_LiteVoBean bean = null;
		if(map != null)
			bean = (ims.icp.vo.beans.Patient_ICP_LiteVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.icp.vo.beans.Patient_ICP_LiteVoBean();
	...
	public Object clone()
	{
		...
		Patient_ICP_LiteVo clone = new Patient_ICP_LiteVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(Patient_ICP_LiteVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A Patient_ICP_LiteVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((Patient_ICP_LiteVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((Patient_ICP_LiteVo)obj).getBoId());
	}
