 ...
 */
public class PatientICPStage_CreationVo extends ims.icps.instantiation.vo.PatientICPStageRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public PatientICPStage_CreationVo()
	{
	}
	public PatientICPStage_CreationVo(Integer id, int version)
	{
		super(id, version);
	}
	public PatientICPStage_CreationVo(ims.icp.vo.beans.PatientICPStage_CreationVoBean bean)
	{
		this.id = bean.getId();
		...
		this.stagephases = ims.icp.vo.PatientICPPhase_CreationVoCollection.buildFromBeanCollection(bean.getStagePhases());
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.icp.vo.beans.PatientICPStage_CreationVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.patient = bean.getPatient() == null ? null : new ims.core.patient.vo.PatientRefVo(new Integer(bean.getPatient().getId()), bean.getPatient().getVersion());
	...
	{
		ims.icp.vo.beans.PatientICPStage_CreationVoBean bean = null;
		if(map != null)
			bean = (ims.icp.vo.beans.PatientICPStage_CreationVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.icp.vo.beans.PatientICPStage_CreationVoBean();
	...
	public ims.icp.vo.PatientICPPhase_CreationVoCollection getStagePhases()
	{
		return this.stagephases;
	}
	public void setStagePhases(ims.icp.vo.PatientICPPhase_CreationVoCollection value)
	{
		this.isValidated = false;
	...
	public Object clone()
	{
		...
		PatientICPStage_CreationVo clone = new PatientICPStage_CreationVo(this.id, this.version);
		...
		if(this.stagephases == null)
			...
			clone.stagephases = (ims.icp.vo.PatientICPPhase_CreationVoCollection)this.stagephases.clone();
		if(this.currentstatus == null)
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(PatientICPStage_CreationVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A PatientICPStage_CreationVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((PatientICPStage_CreationVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((PatientICPStage_CreationVo)obj).getBoId());
	}
	...
	protected ims.icp.vo.PatientICPPhase_CreationVoCollection stagephases;
