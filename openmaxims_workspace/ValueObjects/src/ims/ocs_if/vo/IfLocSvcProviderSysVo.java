 ...
 */
public class IfLocSvcProviderSysVo extends ims.ocrr.configuration.vo.LocSvcProviderSysRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public IfLocSvcProviderSysVo()
	{
	}
	public IfLocSvcProviderSysVo(Integer id, int version)
	{
		super(id, version);
	}
	public IfLocSvcProviderSysVo(ims.ocs_if.vo.beans.IfLocSvcProviderSysVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocs_if.vo.beans.IfLocSvcProviderSysVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.ocs_if.vo.beans.IfLocSvcProviderSysVoBean bean = null;
		if(map != null)
			bean = (ims.ocs_if.vo.beans.IfLocSvcProviderSysVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.ocs_if.vo.beans.IfLocSvcProviderSysVoBean();
	...
	public Object clone()
	{
		...
		IfLocSvcProviderSysVo clone = new IfLocSvcProviderSysVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(IfLocSvcProviderSysVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A IfLocSvcProviderSysVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((IfLocSvcProviderSysVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((IfLocSvcProviderSysVo)obj).getBoId());
	}
