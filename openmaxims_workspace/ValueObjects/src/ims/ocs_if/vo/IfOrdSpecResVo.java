 ...
 */
public class IfOrdSpecResVo extends ims.ocs_if.vo.IfOrdSpecLiteVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public IfOrdSpecResVo()
	{
	}
	public IfOrdSpecResVo(Integer id, int version)
	{
		super(id, version);
	}
	public IfOrdSpecResVo(ims.ocs_if.vo.beans.IfOrdSpecResVoBean bean)
	{
		this.id = bean.getId();
		...
		this.investigations = ims.ocs_if.vo.IfOrdInvResultVoCollection.buildFromBeanCollection(bean.getInvestigations());
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocs_if.vo.beans.IfOrdSpecResVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.colldatetimeplacer = bean.getCollDateTimePlacer() == null ? null : bean.getCollDateTimePlacer().buildDateTime();
	...
	{
		ims.ocs_if.vo.beans.IfOrdSpecResVoBean bean = null;
		if(map != null)
			bean = (ims.ocs_if.vo.beans.IfOrdSpecResVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.ocs_if.vo.beans.IfOrdSpecResVoBean();
	...
	public ims.ocs_if.vo.IfOrdInvResultVoCollection getInvestigations()
	{
		return this.investigations;
	}
	public void setInvestigations(ims.ocs_if.vo.IfOrdInvResultVoCollection value)
	{
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.sitetext != null)
			if(this.sitetext.length() > 255)
				listOfErrors.add("The length of the field [sitetext] in the value object [ims.ocs_if.vo.IfOrdSpecResVo] is too big. It should be less or equal to 255");
		...
		if(this.fillerordnum != null)
			if(this.fillerordnum.length() > 20)
				listOfErrors.add("The length of the field [fillerordnum] in the value object [ims.ocs_if.vo.IfOrdSpecResVo] is too big. It should be less or equal to 20");
		if(this.collectorcomment != null)
			if(this.collectorcomment.length() > 500)
				listOfErrors.add("The length of the field [collectorcomment] in the value object [ims.ocs_if.vo.IfOrdSpecResVo] is too big. It should be less or equal to 500");
		if(this.placerordnum == null || this.placerordnum.length() == 0)
			...
			listOfErrors.add("The length of the field [placerordnum] in the value object [ims.ocs_if.vo.IfOrdSpecResVo] is too big. It should be less or equal to 20");
		if(this.investigations != null)
		{
	...
	public Object clone()
	{
		...
		IfOrdSpecResVo clone = new IfOrdSpecResVo(this.id, this.version);
		...
		if(this.investigations == null)
			...
			clone.investigations = (ims.ocs_if.vo.IfOrdInvResultVoCollection)this.investigations.clone();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(IfOrdSpecResVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A IfOrdSpecResVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((IfOrdSpecResVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((IfOrdSpecResVo)obj).getBoId());
	}
	...
	protected ims.ocs_if.vo.IfOrdInvResultVoCollection investigations;
