...
public class IfOrderInvCurrentStatusVoBean extends ims.vo.ValueObjectBean
{
	public IfOrderInvCurrentStatusVoBean()
	{
	}
	public IfOrderInvCurrentStatusVoBean(ims.ocs_if.vo.IfOrderInvCurrentStatusVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocs_if.vo.IfOrderInvCurrentStatusVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.ordinvstatus = vo.getOrdInvStatus() == null ? null : (ims.vo.LookupInstanceBean)vo.getOrdInvStatus().getBean();
	...
	public ims.ocs_if.vo.IfOrderInvCurrentStatusVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.ocs_if.vo.IfOrderInvCurrentStatusVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.ocs_if.vo.IfOrderInvCurrentStatusVo vo = null;
		if(map != null)
			vo = (ims.ocs_if.vo.IfOrderInvCurrentStatusVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.ocs_if.vo.IfOrderInvCurrentStatusVo();
