...
public class IfInvIdxLiteVoBean extends ims.vo.ValueObjectBean
{
	public IfInvIdxLiteVoBean()
	{
	}
	public IfInvIdxLiteVoBean(ims.ocs_if.vo.IfInvIdxLiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocs_if.vo.IfInvIdxLiteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.category = vo.getCategory() == null ? null : (ims.vo.LookupInstanceBean)vo.getCategory().getBean();
	...
	public ims.ocs_if.vo.IfInvIdxLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.ocs_if.vo.IfInvIdxLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.ocs_if.vo.IfInvIdxLiteVo vo = null;
		if(map != null)
			vo = (ims.ocs_if.vo.IfInvIdxLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.ocs_if.vo.IfInvIdxLiteVo();
