...
public class IfOrdSpecLiteVoBean extends ims.vo.ValueObjectBean
{
	public IfOrdSpecLiteVoBean()
	{
	}
	public IfOrdSpecLiteVoBean(ims.ocs_if.vo.IfOrdSpecLiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocs_if.vo.IfOrdSpecLiteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.colldatetimeplacer = vo.getCollDateTimePlacer() == null ? null : (ims.framework.utils.beans.DateTimeBean)vo.getCollDateTimePlacer().getBean();
	...
	public ims.ocs_if.vo.IfOrdSpecLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.ocs_if.vo.IfOrdSpecLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.ocs_if.vo.IfOrdSpecLiteVo vo = null;
		if(map != null)
			vo = (ims.ocs_if.vo.IfOrdSpecLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.ocs_if.vo.IfOrdSpecLiteVo();
