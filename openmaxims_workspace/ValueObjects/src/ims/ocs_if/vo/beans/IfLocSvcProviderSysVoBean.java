...
public class IfLocSvcProviderSysVoBean extends ims.vo.ValueObjectBean
{
	public IfLocSvcProviderSysVoBean()
	{
	}
	public IfLocSvcProviderSysVoBean(ims.ocs_if.vo.IfLocSvcProviderSysVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocs_if.vo.IfLocSvcProviderSysVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.ocs_if.vo.IfLocSvcProviderSysVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.ocs_if.vo.IfLocSvcProviderSysVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.ocs_if.vo.IfLocSvcProviderSysVo vo = null;
		if(map != null)
			vo = (ims.ocs_if.vo.IfLocSvcProviderSysVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.ocs_if.vo.IfLocSvcProviderSysVo();
