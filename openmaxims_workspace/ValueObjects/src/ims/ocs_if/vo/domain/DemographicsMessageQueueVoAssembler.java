 ...
 */
public class DemographicsMessageQueueVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.ocs_if.vo.DemographicsMessageQueueVo copy(ims.ocs_if.vo.DemographicsMessageQueueVo valueObjectDest, ims.ocs_if.vo.DemographicsMessageQueueVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createDemographicsMessageQueueVoCollectionFromDemographicsMessageQueue(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.hl7adtout.domain.objects.DemographicsMessageQueue objects.
	 */
	public static ims.ocs_if.vo.DemographicsMessageQueueVoCollection createDemographicsMessageQueueVoCollectionFromDemographicsMessageQueue(java.util.Set domainObjectSet)	
	{
		return createDemographicsMessageQueueVoCollectionFromDemographicsMessageQueue(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.hl7adtout.domain.objects.DemographicsMessageQueue objects.
	 */
	public static ims.ocs_if.vo.DemographicsMessageQueueVoCollection createDemographicsMessageQueueVoCollectionFromDemographicsMessageQueue(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.ocs_if.vo.DemographicsMessageQueueVoCollection voList = new ims.ocs_if.vo.DemographicsMessageQueueVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.ocs_if.vo.DemographicsMessageQueueVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.ocs_if.vo.DemographicsMessageQueueVoCollection createDemographicsMessageQueueVoCollectionFromDemographicsMessageQueue(java.util.List domainObjectList) 
	{
		return createDemographicsMessageQueueVoCollectionFromDemographicsMessageQueue(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.hl7adtout.domain.objects.DemographicsMessageQueue objects.
	 */
	public static ims.ocs_if.vo.DemographicsMessageQueueVoCollection createDemographicsMessageQueueVoCollectionFromDemographicsMessageQueue(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.ocs_if.vo.DemographicsMessageQueueVoCollection voList = new ims.ocs_if.vo.DemographicsMessageQueueVoCollection();
	 ...
	 */
	 public static java.util.Set extractDemographicsMessageQueueSet(ims.domain.ILightweightDomainFactory domainFactory, ims.ocs_if.vo.DemographicsMessageQueueVoCollection voCollection) 
	 {
	 	return extractDemographicsMessageQueueSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractDemographicsMessageQueueSet(ims.domain.ILightweightDomainFactory domainFactory, ims.ocs_if.vo.DemographicsMessageQueueVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.ocs_if.vo.DemographicsMessageQueueVo vo = voCollection.get(i);
			ims.hl7adtout.domain.objects.DemographicsMessageQueue domainObject = DemographicsMessageQueueVoAssembler.extractDemographicsMessageQueue(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractDemographicsMessageQueueList(ims.domain.ILightweightDomainFactory domainFactory, ims.ocs_if.vo.DemographicsMessageQueueVoCollection voCollection) 
	 {
	 	return extractDemographicsMessageQueueList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractDemographicsMessageQueueList(ims.domain.ILightweightDomainFactory domainFactory, ims.ocs_if.vo.DemographicsMessageQueueVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.ocs_if.vo.DemographicsMessageQueueVo create(ims.hl7adtout.domain.objects.DemographicsMessageQueue domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.ocs_if.vo.DemographicsMessageQueueVo create(DomainObjectMap map, ims.hl7adtout.domain.objects.DemographicsMessageQueue domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.ocs_if.vo.DemographicsMessageQueueVo valueObject = (ims.ocs_if.vo.DemographicsMessageQueueVo) map.getValueObject(domainObject, ims.ocs_if.vo.DemographicsMessageQueueVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.ocs_if.vo.DemographicsMessageQueueVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.hl7adtout.domain.objects.DemographicsMessageQueue
	 */
	 public static ims.ocs_if.vo.DemographicsMessageQueueVo insert(ims.ocs_if.vo.DemographicsMessageQueueVo valueObject, ims.hl7adtout.domain.objects.DemographicsMessageQueue domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.hl7adtout.domain.objects.DemographicsMessageQueue
	 */
	 public static ims.ocs_if.vo.DemographicsMessageQueueVo insert(DomainObjectMap map, ims.ocs_if.vo.DemographicsMessageQueueVo valueObject, ims.hl7adtout.domain.objects.DemographicsMessageQueue domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// MergeHistory
		if (domainObject.getMergeHistory() != null)
		{
			if(domainObject.getMergeHistory() instanceof HibernateProxy) // If the proxy is set, there is no need to lazy load, the proxy knows the id already. 
			{
				HibernateProxy p = (HibernateProxy) domainObject.getMergeHistory();
				int id = Integer.parseInt(p.getHibernateLazyInitializer().getIdentifier().toString());				
				valueObject.setMergeHistory(new ims.core.patient.vo.PatientMergeHistoryRefVo(id, -1));				
			}
			else
			{
				valueObject.setMergeHistory(new ims.core.patient.vo.PatientMergeHistoryRefVo(domainObject.getMergeHistory().getId(), domainObject.getMergeHistory().getVersion()));
			}
		}
 		return valueObject;
	 }
	 ...
	 */
	public static ims.hl7adtout.domain.objects.DemographicsMessageQueue extractDemographicsMessageQueue(ims.domain.ILightweightDomainFactory domainFactory, ims.ocs_if.vo.DemographicsMessageQueueVo valueObject) 
	{
		return 	extractDemographicsMessageQueue(domainFactory, valueObject, new HashMap());
	}

	public static ims.hl7adtout.domain.objects.DemographicsMessageQueue extractDemographicsMessageQueue(ims.domain.ILightweightDomainFactory domainFactory, ims.ocs_if.vo.DemographicsMessageQueueVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.ocs_if.vo.DemographicsMessageQueueVo ID_DemographicsMessageQueue field is unknown
		...
		ims.core.patient.domain.objects.PatientMergeHistory value12 = null;
		if ( null != valueObject.getMergeHistory() ) 
		{
			if (valueObject.getMergeHistory().getBoId() == null)
			{
				...
				{
					value12 = (ims.core.patient.domain.objects.PatientMergeHistory)domMap.get(valueObject.getMergeHistory());
				}
			}
			else if (valueObject.getBoVersion() == -1) // RefVo was not modified since obtained from the Assembler, no need to update the BO field
			{
				value12 = domainObject.getMergeHistory();	
			}
			else
			{
				value12 = (ims.core.patient.domain.objects.PatientMergeHistory)domainFactory.getDomainObject(ims.core.patient.domain.objects.PatientMergeHistory.class, valueObject.getMergeHistory().getBoId());
			}
		}
		domainObject.setMergeHistory(value12);
