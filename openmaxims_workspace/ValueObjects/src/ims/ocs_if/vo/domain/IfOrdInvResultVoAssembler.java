 ...
 * @author John MacEnri
 */
public class IfOrdInvResultVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.ocs_if.vo.IfOrdInvResultVo copy(ims.ocs_if.vo.IfOrdInvResultVo valueObjectDest, ims.ocs_if.vo.IfOrdInvResultVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createIfOrdInvResultVoCollectionFromOrderInvestigation(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.ocrr.orderingresults.domain.objects.OrderInvestigation objects.
	 */
	public static ims.ocs_if.vo.IfOrdInvResultVoCollection createIfOrdInvResultVoCollectionFromOrderInvestigation(java.util.Set domainObjectSet)	
	{
		return createIfOrdInvResultVoCollectionFromOrderInvestigation(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.ocrr.orderingresults.domain.objects.OrderInvestigation objects.
	 */
	public static ims.ocs_if.vo.IfOrdInvResultVoCollection createIfOrdInvResultVoCollectionFromOrderInvestigation(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.ocs_if.vo.IfOrdInvResultVoCollection voList = new ims.ocs_if.vo.IfOrdInvResultVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.ocs_if.vo.IfOrdInvResultVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.ocs_if.vo.IfOrdInvResultVoCollection createIfOrdInvResultVoCollectionFromOrderInvestigation(java.util.List domainObjectList) 
	{
		return createIfOrdInvResultVoCollectionFromOrderInvestigation(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.ocrr.orderingresults.domain.objects.OrderInvestigation objects.
	 */
	public static ims.ocs_if.vo.IfOrdInvResultVoCollection createIfOrdInvResultVoCollectionFromOrderInvestigation(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.ocs_if.vo.IfOrdInvResultVoCollection voList = new ims.ocs_if.vo.IfOrdInvResultVoCollection();
	 ...
	 */
	 public static java.util.Set extractOrderInvestigationSet(ims.domain.ILightweightDomainFactory domainFactory, ims.ocs_if.vo.IfOrdInvResultVoCollection voCollection) 
	 {
	 	return extractOrderInvestigationSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractOrderInvestigationSet(ims.domain.ILightweightDomainFactory domainFactory, ims.ocs_if.vo.IfOrdInvResultVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.ocs_if.vo.IfOrdInvResultVo vo = voCollection.get(i);
			ims.ocrr.orderingresults.domain.objects.OrderInvestigation domainObject = IfOrdInvResultVoAssembler.extractOrderInvestigation(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractOrderInvestigationList(ims.domain.ILightweightDomainFactory domainFactory, ims.ocs_if.vo.IfOrdInvResultVoCollection voCollection) 
	 {
	 	return extractOrderInvestigationList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractOrderInvestigationList(ims.domain.ILightweightDomainFactory domainFactory, ims.ocs_if.vo.IfOrdInvResultVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.ocs_if.vo.IfOrdInvResultVo create(ims.ocrr.orderingresults.domain.objects.OrderInvestigation domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.ocs_if.vo.IfOrdInvResultVo create(DomainObjectMap map, ims.ocrr.orderingresults.domain.objects.OrderInvestigation domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.ocs_if.vo.IfOrdInvResultVo valueObject = (ims.ocs_if.vo.IfOrdInvResultVo) map.getValueObject(domainObject, ims.ocs_if.vo.IfOrdInvResultVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.ocs_if.vo.IfOrdInvResultVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.ocrr.orderingresults.domain.objects.OrderInvestigation
	 */
	 public static ims.ocs_if.vo.IfOrdInvResultVo insert(ims.ocs_if.vo.IfOrdInvResultVo valueObject, ims.ocrr.orderingresults.domain.objects.OrderInvestigation domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.ocrr.orderingresults.domain.objects.OrderInvestigation
	 */
	 public static ims.ocs_if.vo.IfOrdInvResultVo insert(DomainObjectMap map, ims.ocs_if.vo.IfOrdInvResultVo valueObject, ims.ocrr.orderingresults.domain.objects.OrderInvestigation domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.ocrr.orderingresults.domain.objects.OrderInvestigation extractOrderInvestigation(ims.domain.ILightweightDomainFactory domainFactory, ims.ocs_if.vo.IfOrdInvResultVo valueObject) 
	{
		return 	extractOrderInvestigation(domainFactory, valueObject, new HashMap());
	}

	public static ims.ocrr.orderingresults.domain.objects.OrderInvestigation extractOrderInvestigation(ims.domain.ILightweightDomainFactory domainFactory, ims.ocs_if.vo.IfOrdInvResultVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.ocs_if.vo.IfOrdInvResultVo ID_OrderInvestigation field is unknown
		...
		ims.framework.utils.DateTime dateTime27 = valueObject.getResultSortDate();
		java.util.Date value27 = null;
		if ( dateTime27 != null ) 
		{
			value27 = dateTime27.getJavaDate();
		}
		domainObject.setResultSortDate(value27);
