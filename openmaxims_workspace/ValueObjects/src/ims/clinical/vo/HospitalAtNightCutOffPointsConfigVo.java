 ...
 */
public class HospitalAtNightCutOffPointsConfigVo extends ims.clinical.configuration.vo.HospitalAtNightCutOverPointsConfigRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public HospitalAtNightCutOffPointsConfigVo()
	{
	}
	public HospitalAtNightCutOffPointsConfigVo(Integer id, int version)
	{
		super(id, version);
	}
	public HospitalAtNightCutOffPointsConfigVo(ims.clinical.vo.beans.HospitalAtNightCutOffPointsConfigVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinical.vo.beans.HospitalAtNightCutOffPointsConfigVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.starttime = bean.getStartTime() == null ? null : bean.getStartTime().buildTime();
	...
	{
		ims.clinical.vo.beans.HospitalAtNightCutOffPointsConfigVoBean bean = null;
		if(map != null)
			bean = (ims.clinical.vo.beans.HospitalAtNightCutOffPointsConfigVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.clinical.vo.beans.HospitalAtNightCutOffPointsConfigVoBean();
	...
	public Object clone()
	{
		...
		HospitalAtNightCutOffPointsConfigVo clone = new HospitalAtNightCutOffPointsConfigVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(HospitalAtNightCutOffPointsConfigVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A HospitalAtNightCutOffPointsConfigVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((HospitalAtNightCutOffPointsConfigVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((HospitalAtNightCutOffPointsConfigVo)obj).getBoId());
	}
