 ...
 */
public class IntraOperativeCareRecordShortVo extends ims.clinical.vo.IntraOperativeCareRecordLiteVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public IntraOperativeCareRecordShortVo()
	{
	}
	public IntraOperativeCareRecordShortVo(Integer id, int version)
	{
		super(id, version);
	}
	public IntraOperativeCareRecordShortVo(ims.clinical.vo.beans.IntraOperativeCareRecordShortVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinical.vo.beans.IntraOperativeCareRecordShortVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.carecontext = bean.getCareContext() == null ? null : new ims.core.admin.vo.CareContextRefVo(new Integer(bean.getCareContext().getId()), bean.getCareContext().getVersion());
	...
	{
		ims.clinical.vo.beans.IntraOperativeCareRecordShortVoBean bean = null;
		if(map != null)
			bean = (ims.clinical.vo.beans.IntraOperativeCareRecordShortVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.clinical.vo.beans.IntraOperativeCareRecordShortVoBean();
	...
	public ims.clinical.vo.IntraOperativeDetailsLiteVo getIntraOperativeDetails()
	{
		return this.intraoperativedetails;
	}
	public void setIntraOperativeDetails(ims.clinical.vo.IntraOperativeDetailsLiteVo value)
	{
	...
	public Object clone()
	{
		...
		IntraOperativeCareRecordShortVo clone = new IntraOperativeCareRecordShortVo(this.id, this.version);
		...
		if(this.intraoperativedetails == null)
			...
			clone.intraoperativedetails = (ims.clinical.vo.IntraOperativeDetailsLiteVo)this.intraoperativedetails.clone();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(IntraOperativeCareRecordShortVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A IntraOperativeCareRecordShortVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((IntraOperativeCareRecordShortVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((IntraOperativeCareRecordShortVo)obj).getBoId());
	}
	...
	protected ims.clinical.vo.IntraOperativeDetailsLiteVo intraoperativedetails;
