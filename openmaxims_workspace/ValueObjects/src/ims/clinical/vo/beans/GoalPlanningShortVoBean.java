...
public class GoalPlanningShortVoBean extends ims.vo.ValueObjectBean
{
	public GoalPlanningShortVoBean()
	{
	}
	public GoalPlanningShortVoBean(ims.clinical.vo.GoalPlanningShortVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinical.vo.GoalPlanningShortVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.goalplanningdate = vo.getGoalPlanningDate() == null ? null : (ims.framework.utils.beans.DateBean)vo.getGoalPlanningDate().getBean();
	...
	public ims.clinical.vo.GoalPlanningShortVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.clinical.vo.GoalPlanningShortVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.clinical.vo.GoalPlanningShortVo vo = null;
		if(map != null)
			vo = (ims.clinical.vo.GoalPlanningShortVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.clinical.vo.GoalPlanningShortVo();
