...
public class PatientForHospitalAtNightVoBean extends ims.vo.ValueObjectBean
{
	public PatientForHospitalAtNightVoBean()
	{
	}
	public PatientForHospitalAtNightVoBean(ims.clinical.vo.PatientForHospitalAtNightVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinical.vo.PatientForHospitalAtNightVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.clinical.vo.PatientForHospitalAtNightVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.clinical.vo.PatientForHospitalAtNightVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.clinical.vo.PatientForHospitalAtNightVo vo = null;
		if(map != null)
			vo = (ims.clinical.vo.PatientForHospitalAtNightVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.clinical.vo.PatientForHospitalAtNightVo();
