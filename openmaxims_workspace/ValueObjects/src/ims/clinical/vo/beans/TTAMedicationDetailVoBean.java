...
public class TTAMedicationDetailVoBean extends ims.vo.ValueObjectBean
{
	public TTAMedicationDetailVoBean()
	{
	}
	public TTAMedicationDetailVoBean(ims.clinical.vo.TTAMedicationDetailVo vo)
	{
		this.id = vo.getBoId();
		...
		this.clinicalcommentsforpharmacy = vo.getClinicalCommentsForPharmacy();
		this.medicationinstructionsforpatient = vo.getMedicationInstructionsForPatient();
		this.prescribercontacted = vo.getPrescriberContacted();
		this.unittext = vo.getUnitText();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinical.vo.TTAMedicationDetailVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.othermedicationtext = vo.getOtherMedicationText();
	...
	public ims.clinical.vo.TTAMedicationDetailVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.clinical.vo.TTAMedicationDetailVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.clinical.vo.TTAMedicationDetailVo vo = null;
		if(map != null)
			vo = (ims.clinical.vo.TTAMedicationDetailVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.clinical.vo.TTAMedicationDetailVo();
