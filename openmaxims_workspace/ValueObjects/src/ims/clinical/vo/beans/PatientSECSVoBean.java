...
public class PatientSECSVoBean extends ims.vo.ValueObjectBean
{
	public PatientSECSVoBean()
	{
	}
	public PatientSECSVoBean(ims.clinical.vo.PatientSECSVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinical.vo.PatientSECSVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.clinical.vo.PatientSECSVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.clinical.vo.PatientSECSVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.clinical.vo.PatientSECSVo vo = null;
		if(map != null)
			vo = (ims.clinical.vo.PatientSECSVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.clinical.vo.PatientSECSVo();
