...
public class PatientAbsentProcedureVoBean extends ims.vo.ValueObjectBean
{
	public PatientAbsentProcedureVoBean()
	{
	}
	public PatientAbsentProcedureVoBean(ims.clinical.vo.PatientAbsentProcedureVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinical.vo.PatientAbsentProcedureVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.clinical.vo.PatientAbsentProcedureVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.clinical.vo.PatientAbsentProcedureVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.clinical.vo.PatientAbsentProcedureVo vo = null;
		if(map != null)
			vo = (ims.clinical.vo.PatientAbsentProcedureVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.clinical.vo.PatientAbsentProcedureVo();
