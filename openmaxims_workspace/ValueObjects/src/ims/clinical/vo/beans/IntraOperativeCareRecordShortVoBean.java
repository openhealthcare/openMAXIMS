...
public class IntraOperativeCareRecordShortVoBean extends ims.vo.ValueObjectBean
{
	public IntraOperativeCareRecordShortVoBean()
	{
	}
	public IntraOperativeCareRecordShortVoBean(ims.clinical.vo.IntraOperativeCareRecordShortVo vo)
	{
		this.id = vo.getBoId();
		...
		this.intraoperativedetails = vo.getIntraOperativeDetails() == null ? null : (ims.clinical.vo.beans.IntraOperativeDetailsLiteVoBean)vo.getIntraOperativeDetails().getBean();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinical.vo.IntraOperativeCareRecordShortVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.carecontext = vo.getCareContext() == null ? null : new ims.vo.RefVoBean(vo.getCareContext().getBoId(), vo.getCareContext().getBoVersion());
		...
		this.intraoperativedetails = vo.getIntraOperativeDetails() == null ? null : (ims.clinical.vo.beans.IntraOperativeDetailsLiteVoBean)vo.getIntraOperativeDetails().getBean(map);
	}

	public ims.clinical.vo.IntraOperativeCareRecordShortVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.clinical.vo.IntraOperativeCareRecordShortVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.clinical.vo.IntraOperativeCareRecordShortVo vo = null;
		if(map != null)
			vo = (ims.clinical.vo.IntraOperativeCareRecordShortVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.clinical.vo.IntraOperativeCareRecordShortVo();
	...
	public ims.clinical.vo.beans.IntraOperativeDetailsLiteVoBean getIntraOperativeDetails()
	{
		return this.intraoperativedetails;
	}
	public void setIntraOperativeDetails(ims.clinical.vo.beans.IntraOperativeDetailsLiteVoBean value)
	{
	...
	private ims.clinical.vo.beans.IntraOperativeDetailsLiteVoBean intraoperativedetails;
}
