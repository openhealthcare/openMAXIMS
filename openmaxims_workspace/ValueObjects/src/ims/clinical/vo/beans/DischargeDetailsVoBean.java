...
public class DischargeDetailsVoBean extends ims.vo.ValueObjectBean
{
	public DischargeDetailsVoBean()
	{
	}
	public DischargeDetailsVoBean(ims.clinical.vo.DischargeDetailsVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinical.vo.DischargeDetailsVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.carecontext = vo.getCareContext() == null ? null : new ims.vo.RefVoBean(vo.getCareContext().getBoId(), vo.getCareContext().getBoVersion());
	...
	public ims.clinical.vo.DischargeDetailsVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.clinical.vo.DischargeDetailsVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.clinical.vo.DischargeDetailsVo vo = null;
		if(map != null)
			vo = (ims.clinical.vo.DischargeDetailsVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.clinical.vo.DischargeDetailsVo();
