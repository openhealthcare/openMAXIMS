...
public class AdmissionDetailForDementiaWorklistVoBean extends ims.vo.ValueObjectBean
{
	public AdmissionDetailForDementiaWorklistVoBean()
	{
	}
	public AdmissionDetailForDementiaWorklistVoBean(ims.clinical.vo.AdmissionDetailForDementiaWorklistVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinical.vo.AdmissionDetailForDementiaWorklistVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.clinical.vo.AdmissionDetailForDementiaWorklistVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.clinical.vo.AdmissionDetailForDementiaWorklistVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.clinical.vo.AdmissionDetailForDementiaWorklistVo vo = null;
		if(map != null)
			vo = (ims.clinical.vo.AdmissionDetailForDementiaWorklistVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.clinical.vo.AdmissionDetailForDementiaWorklistVo();
