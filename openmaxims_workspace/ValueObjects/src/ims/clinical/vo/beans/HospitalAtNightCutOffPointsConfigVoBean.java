...
public class HospitalAtNightCutOffPointsConfigVoBean extends ims.vo.ValueObjectBean
{
	public HospitalAtNightCutOffPointsConfigVoBean()
	{
	}
	public HospitalAtNightCutOffPointsConfigVoBean(ims.clinical.vo.HospitalAtNightCutOffPointsConfigVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinical.vo.HospitalAtNightCutOffPointsConfigVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.starttime = vo.getStartTime() == null ? null : (ims.framework.utils.beans.TimeBean)vo.getStartTime().getBean();
	...
	public ims.clinical.vo.HospitalAtNightCutOffPointsConfigVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.clinical.vo.HospitalAtNightCutOffPointsConfigVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.clinical.vo.HospitalAtNightCutOffPointsConfigVo vo = null;
		if(map != null)
			vo = (ims.clinical.vo.HospitalAtNightCutOffPointsConfigVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.clinical.vo.HospitalAtNightCutOffPointsConfigVo();
