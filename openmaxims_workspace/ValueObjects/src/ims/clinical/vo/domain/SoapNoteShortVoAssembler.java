 ...
 */
public class SoapNoteShortVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.clinical.vo.SoapNoteShortVo copy(ims.clinical.vo.SoapNoteShortVo valueObjectDest, ims.clinical.vo.SoapNoteShortVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createSoapNoteShortVoCollectionFromSoapNote(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.clinical.domain.objects.SoapNote objects.
	 */
	public static ims.clinical.vo.SoapNoteShortVoCollection createSoapNoteShortVoCollectionFromSoapNote(java.util.Set domainObjectSet)	
	{
		return createSoapNoteShortVoCollectionFromSoapNote(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.clinical.domain.objects.SoapNote objects.
	 */
	public static ims.clinical.vo.SoapNoteShortVoCollection createSoapNoteShortVoCollectionFromSoapNote(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.clinical.vo.SoapNoteShortVoCollection voList = new ims.clinical.vo.SoapNoteShortVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.clinical.vo.SoapNoteShortVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.clinical.vo.SoapNoteShortVoCollection createSoapNoteShortVoCollectionFromSoapNote(java.util.List domainObjectList) 
	{
		return createSoapNoteShortVoCollectionFromSoapNote(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.clinical.domain.objects.SoapNote objects.
	 */
	public static ims.clinical.vo.SoapNoteShortVoCollection createSoapNoteShortVoCollectionFromSoapNote(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.clinical.vo.SoapNoteShortVoCollection voList = new ims.clinical.vo.SoapNoteShortVoCollection();
	 ...
	 */
	 public static java.util.Set extractSoapNoteSet(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.SoapNoteShortVoCollection voCollection) 
	 {
	 	return extractSoapNoteSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractSoapNoteSet(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.SoapNoteShortVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.clinical.vo.SoapNoteShortVo vo = voCollection.get(i);
			ims.clinical.domain.objects.SoapNote domainObject = SoapNoteShortVoAssembler.extractSoapNote(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractSoapNoteList(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.SoapNoteShortVoCollection voCollection) 
	 {
	 	return extractSoapNoteList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractSoapNoteList(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.SoapNoteShortVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.clinical.vo.SoapNoteShortVo create(ims.clinical.domain.objects.SoapNote domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.clinical.vo.SoapNoteShortVo create(DomainObjectMap map, ims.clinical.domain.objects.SoapNote domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.clinical.vo.SoapNoteShortVo valueObject = (ims.clinical.vo.SoapNoteShortVo) map.getValueObject(domainObject, ims.clinical.vo.SoapNoteShortVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.clinical.vo.SoapNoteShortVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.clinical.domain.objects.SoapNote
	 */
	 public static ims.clinical.vo.SoapNoteShortVo insert(ims.clinical.vo.SoapNoteShortVo valueObject, ims.clinical.domain.objects.SoapNote domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.clinical.domain.objects.SoapNote
	 */
	 public static ims.clinical.vo.SoapNoteShortVo insert(DomainObjectMap map, ims.clinical.vo.SoapNoteShortVo valueObject, ims.clinical.domain.objects.SoapNote domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.clinical.domain.objects.SoapNote extractSoapNote(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.SoapNoteShortVo valueObject) 
	{
		return 	extractSoapNote(domainFactory, valueObject, new HashMap());
	}

	public static ims.clinical.domain.objects.SoapNote extractSoapNote(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.SoapNoteShortVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.clinical.vo.SoapNoteShortVo ID_SoapNote field is unknown
		...
		ims.core.vo.lookups.AreaOfNeedCollection collection1 =
	valueObject.getAreaofNeed();
		...
		//Remove all ones in domList where index > voCollection.size() as these should
		//now represent the ones removed from the VO collection. No longer referenced.
		int j1 = domainAreaofNeed.size();
		while (j1 > collection1Size)
		{
			domainAreaofNeed.remove(j1-1);
			j1 = domainAreaofNeed.size();
		}
