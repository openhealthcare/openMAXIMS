 ...
 */
public class PatientForDementiaVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.clinical.vo.PatientForDementiaVo copy(ims.clinical.vo.PatientForDementiaVo valueObjectDest, ims.clinical.vo.PatientForDementiaVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createPatientForDementiaVoCollectionFromPatient(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.patient.domain.objects.Patient objects.
	 */
	public static ims.clinical.vo.PatientForDementiaVoCollection createPatientForDementiaVoCollectionFromPatient(java.util.Set domainObjectSet)	
	{
		return createPatientForDementiaVoCollectionFromPatient(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.patient.domain.objects.Patient objects.
	 */
	public static ims.clinical.vo.PatientForDementiaVoCollection createPatientForDementiaVoCollectionFromPatient(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.clinical.vo.PatientForDementiaVoCollection voList = new ims.clinical.vo.PatientForDementiaVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.clinical.vo.PatientForDementiaVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.clinical.vo.PatientForDementiaVoCollection createPatientForDementiaVoCollectionFromPatient(java.util.List domainObjectList) 
	{
		return createPatientForDementiaVoCollectionFromPatient(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.patient.domain.objects.Patient objects.
	 */
	public static ims.clinical.vo.PatientForDementiaVoCollection createPatientForDementiaVoCollectionFromPatient(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.clinical.vo.PatientForDementiaVoCollection voList = new ims.clinical.vo.PatientForDementiaVoCollection();
	 ...
	 */
	 public static java.util.Set extractPatientSet(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.PatientForDementiaVoCollection voCollection) 
	 {
	 	return extractPatientSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientSet(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.PatientForDementiaVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.clinical.vo.PatientForDementiaVo vo = voCollection.get(i);
			ims.core.patient.domain.objects.Patient domainObject = PatientForDementiaVoAssembler.extractPatient(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPatientList(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.PatientForDementiaVoCollection voCollection) 
	 {
	 	return extractPatientList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPatientList(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.PatientForDementiaVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.clinical.vo.PatientForDementiaVo create(ims.core.patient.domain.objects.Patient domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.clinical.vo.PatientForDementiaVo create(DomainObjectMap map, ims.core.patient.domain.objects.Patient domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.clinical.vo.PatientForDementiaVo valueObject = (ims.clinical.vo.PatientForDementiaVo) map.getValueObject(domainObject, ims.clinical.vo.PatientForDementiaVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.clinical.vo.PatientForDementiaVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.patient.domain.objects.Patient
	 */
	 public static ims.clinical.vo.PatientForDementiaVo insert(ims.clinical.vo.PatientForDementiaVo valueObject, ims.core.patient.domain.objects.Patient domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.patient.domain.objects.Patient
	 */
	 public static ims.clinical.vo.PatientForDementiaVo insert(DomainObjectMap map, ims.clinical.vo.PatientForDementiaVo valueObject, ims.core.patient.domain.objects.Patient domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.patient.domain.objects.Patient extractPatient(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.PatientForDementiaVo valueObject) 
	{
		return 	extractPatient(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.patient.domain.objects.Patient extractPatient(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.PatientForDementiaVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.clinical.vo.PatientForDementiaVo ID_Patient field is unknown
