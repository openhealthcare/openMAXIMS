 ...
 */
public class TTAMedicationVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.clinical.vo.TTAMedicationVo copy(ims.clinical.vo.TTAMedicationVo valueObjectDest, ims.clinical.vo.TTAMedicationVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createTTAMedicationVoCollectionFromTTAMedication(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.edischarge.domain.objects.TTAMedication objects.
	 */
	public static ims.clinical.vo.TTAMedicationVoCollection createTTAMedicationVoCollectionFromTTAMedication(java.util.Set domainObjectSet)	
	{
		return createTTAMedicationVoCollectionFromTTAMedication(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.edischarge.domain.objects.TTAMedication objects.
	 */
	public static ims.clinical.vo.TTAMedicationVoCollection createTTAMedicationVoCollectionFromTTAMedication(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.clinical.vo.TTAMedicationVoCollection voList = new ims.clinical.vo.TTAMedicationVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.clinical.vo.TTAMedicationVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.clinical.vo.TTAMedicationVoCollection createTTAMedicationVoCollectionFromTTAMedication(java.util.List domainObjectList) 
	{
		return createTTAMedicationVoCollectionFromTTAMedication(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.edischarge.domain.objects.TTAMedication objects.
	 */
	public static ims.clinical.vo.TTAMedicationVoCollection createTTAMedicationVoCollectionFromTTAMedication(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.clinical.vo.TTAMedicationVoCollection voList = new ims.clinical.vo.TTAMedicationVoCollection();
	 ...
	 */
	 public static java.util.Set extractTTAMedicationSet(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.TTAMedicationVoCollection voCollection) 
	 {
	 	return extractTTAMedicationSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractTTAMedicationSet(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.TTAMedicationVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.clinical.vo.TTAMedicationVo vo = voCollection.get(i);
			ims.edischarge.domain.objects.TTAMedication domainObject = TTAMedicationVoAssembler.extractTTAMedication(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractTTAMedicationList(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.TTAMedicationVoCollection voCollection) 
	 {
	 	return extractTTAMedicationList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractTTAMedicationList(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.TTAMedicationVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.clinical.vo.TTAMedicationVo create(ims.edischarge.domain.objects.TTAMedication domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.clinical.vo.TTAMedicationVo create(DomainObjectMap map, ims.edischarge.domain.objects.TTAMedication domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.clinical.vo.TTAMedicationVo valueObject = (ims.clinical.vo.TTAMedicationVo) map.getValueObject(domainObject, ims.clinical.vo.TTAMedicationVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.clinical.vo.TTAMedicationVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.edischarge.domain.objects.TTAMedication
	 */
	 public static ims.clinical.vo.TTAMedicationVo insert(ims.clinical.vo.TTAMedicationVo valueObject, ims.edischarge.domain.objects.TTAMedication domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.edischarge.domain.objects.TTAMedication
	 */
	 public static ims.clinical.vo.TTAMedicationVo insert(DomainObjectMap map, ims.clinical.vo.TTAMedicationVo valueObject, ims.edischarge.domain.objects.TTAMedication domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.edischarge.domain.objects.TTAMedication extractTTAMedication(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.TTAMedicationVo valueObject) 
	{
		return 	extractTTAMedication(domainFactory, valueObject, new HashMap());
	}

	public static ims.edischarge.domain.objects.TTAMedication extractTTAMedication(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.TTAMedicationVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.clinical.vo.TTAMedicationVo ID_TTAMedication field is unknown
