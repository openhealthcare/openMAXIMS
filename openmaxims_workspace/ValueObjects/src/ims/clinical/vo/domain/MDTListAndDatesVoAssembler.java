 ...
 */
public class MDTListAndDatesVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.clinical.vo.MDTListAndDatesVo copy(ims.clinical.vo.MDTListAndDatesVo valueObjectDest, ims.clinical.vo.MDTListAndDatesVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createMDTListAndDatesVoCollectionFromMDTListandDates(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.clinical.domain.objects.MDTListandDates objects.
	 */
	public static ims.clinical.vo.MDTListAndDatesVoCollection createMDTListAndDatesVoCollectionFromMDTListandDates(java.util.Set domainObjectSet)	
	{
		return createMDTListAndDatesVoCollectionFromMDTListandDates(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.clinical.domain.objects.MDTListandDates objects.
	 */
	public static ims.clinical.vo.MDTListAndDatesVoCollection createMDTListAndDatesVoCollectionFromMDTListandDates(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.clinical.vo.MDTListAndDatesVoCollection voList = new ims.clinical.vo.MDTListAndDatesVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.clinical.vo.MDTListAndDatesVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.clinical.vo.MDTListAndDatesVoCollection createMDTListAndDatesVoCollectionFromMDTListandDates(java.util.List domainObjectList) 
	{
		return createMDTListAndDatesVoCollectionFromMDTListandDates(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.clinical.domain.objects.MDTListandDates objects.
	 */
	public static ims.clinical.vo.MDTListAndDatesVoCollection createMDTListAndDatesVoCollectionFromMDTListandDates(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.clinical.vo.MDTListAndDatesVoCollection voList = new ims.clinical.vo.MDTListAndDatesVoCollection();
	 ...
	 */
	 public static java.util.Set extractMDTListandDatesSet(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.MDTListAndDatesVoCollection voCollection) 
	 {
	 	return extractMDTListandDatesSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractMDTListandDatesSet(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.MDTListAndDatesVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.clinical.vo.MDTListAndDatesVo vo = voCollection.get(i);
			ims.clinical.domain.objects.MDTListandDates domainObject = MDTListAndDatesVoAssembler.extractMDTListandDates(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractMDTListandDatesList(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.MDTListAndDatesVoCollection voCollection) 
	 {
	 	return extractMDTListandDatesList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractMDTListandDatesList(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.MDTListAndDatesVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.clinical.vo.MDTListAndDatesVo create(ims.clinical.domain.objects.MDTListandDates domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.clinical.vo.MDTListAndDatesVo create(DomainObjectMap map, ims.clinical.domain.objects.MDTListandDates domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.clinical.vo.MDTListAndDatesVo valueObject = (ims.clinical.vo.MDTListAndDatesVo) map.getValueObject(domainObject, ims.clinical.vo.MDTListAndDatesVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.clinical.vo.MDTListAndDatesVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.clinical.domain.objects.MDTListandDates
	 */
	 public static ims.clinical.vo.MDTListAndDatesVo insert(ims.clinical.vo.MDTListAndDatesVo valueObject, ims.clinical.domain.objects.MDTListandDates domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.clinical.domain.objects.MDTListandDates
	 */
	 public static ims.clinical.vo.MDTListAndDatesVo insert(DomainObjectMap map, ims.clinical.vo.MDTListAndDatesVo valueObject, ims.clinical.domain.objects.MDTListandDates domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.clinical.domain.objects.MDTListandDates extractMDTListandDates(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.MDTListAndDatesVo valueObject) 
	{
		return 	extractMDTListandDates(domainFactory, valueObject, new HashMap());
	}

	public static ims.clinical.domain.objects.MDTListandDates extractMDTListandDates(ims.domain.ILightweightDomainFactory domainFactory, ims.clinical.vo.MDTListAndDatesVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.clinical.vo.MDTListAndDatesVo ID_MDTListandDates field is unknown
