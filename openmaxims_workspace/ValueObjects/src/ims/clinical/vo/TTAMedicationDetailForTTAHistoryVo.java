 ...
 */
public class TTAMedicationDetailForTTAHistoryVo extends ims.edischarge.vo.TTAMedicationDetailRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public TTAMedicationDetailForTTAHistoryVo()
	{
	}
	public TTAMedicationDetailForTTAHistoryVo(Integer id, int version)
	{
		super(id, version);
	}
	public TTAMedicationDetailForTTAHistoryVo(ims.clinical.vo.beans.TTAMedicationDetailForTTAHistoryVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinical.vo.beans.TTAMedicationDetailForTTAHistoryVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.clinical.vo.beans.TTAMedicationDetailForTTAHistoryVoBean bean = null;
		if(map != null)
			bean = (ims.clinical.vo.beans.TTAMedicationDetailForTTAHistoryVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.clinical.vo.beans.TTAMedicationDetailForTTAHistoryVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.othermedicationtext == null || this.othermedicationtext.length() == 0)
			...
			listOfErrors.add("The length of the field [othermedicationtext] in the value object [ims.clinical.vo.TTAMedicationDetailForTTAHistoryVo] is too big. It should be less or equal to 700");
		if(this.unittext != null)
			if(this.unittext.length() > 40)
				listOfErrors.add("The length of the field [unittext] in the value object [ims.clinical.vo.TTAMedicationDetailForTTAHistoryVo] is too big. It should be less or equal to 40");
	...
	public Object clone()
	{
		...
		TTAMedicationDetailForTTAHistoryVo clone = new TTAMedicationDetailForTTAHistoryVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(TTAMedicationDetailForTTAHistoryVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A TTAMedicationDetailForTTAHistoryVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((TTAMedicationDetailForTTAHistoryVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((TTAMedicationDetailForTTAHistoryVo)obj).getBoId());
	}
