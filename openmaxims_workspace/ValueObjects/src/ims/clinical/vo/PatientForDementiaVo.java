 ...
 */
public class PatientForDementiaVo extends ims.core.patient.vo.PatientRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public PatientForDementiaVo()
	{
	}
	public PatientForDementiaVo(Integer id, int version)
	{
		super(id, version);
	}
	public PatientForDementiaVo(ims.clinical.vo.beans.PatientForDementiaVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinical.vo.beans.PatientForDementiaVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.clinical.vo.beans.PatientForDementiaVoBean bean = null;
		if(map != null)
			bean = (ims.clinical.vo.beans.PatientForDementiaVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.clinical.vo.beans.PatientForDementiaVoBean();
	...
	public Object clone()
	{
		...
		PatientForDementiaVo clone = new PatientForDementiaVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(PatientForDementiaVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A PatientForDementiaVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((PatientForDementiaVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((PatientForDementiaVo)obj).getBoId());
	}
