 ...
 */
public class PatientMeetingInviteeVo extends ims.clinical.vo.PatientMeetingInviteeRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public PatientMeetingInviteeVo()
	{
	}
	public PatientMeetingInviteeVo(Integer id, int version)
	{
		super(id, version);
	}
	public PatientMeetingInviteeVo(ims.clinical.vo.beans.PatientMeetingInviteeVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinical.vo.beans.PatientMeetingInviteeVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.clinical.vo.beans.PatientMeetingInviteeVoBean bean = null;
		if(map != null)
			bean = (ims.clinical.vo.beans.PatientMeetingInviteeVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.clinical.vo.beans.PatientMeetingInviteeVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.familymember != null)
			if(this.familymember.length() > 55)
				listOfErrors.add("The length of the field [familymember] in the value object [ims.clinical.vo.PatientMeetingInviteeVo] is too big. It should be less or equal to 55");
		if(this.note != null)
			if(this.note.length() > 255)
				listOfErrors.add("The length of the field [note] in the value object [ims.clinical.vo.PatientMeetingInviteeVo] is too big. It should be less or equal to 255");
	...
	public Object clone()
	{
		...
		PatientMeetingInviteeVo clone = new PatientMeetingInviteeVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(PatientMeetingInviteeVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A PatientMeetingInviteeVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((PatientMeetingInviteeVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((PatientMeetingInviteeVo)obj).getBoId());
	}
