 ...
 */
public class PresentingComplaintVo extends ims.clinical.vo.PresentingComplaintLiteVo implements ims.vo.ImsCloneable, Comparable, ims.vo.interfaces.ICciFull
{
	private static final long serialVersionUID = 1L;

	public PresentingComplaintVo()
	{
	}
	public PresentingComplaintVo(Integer id, int version)
	{
		super(id, version);
	}
	public PresentingComplaintVo(ims.clinical.vo.beans.PresentingComplaintVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinical.vo.beans.PresentingComplaintVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.pcname = bean.getPCName();
	...
	{
		ims.clinical.vo.beans.PresentingComplaintVoBean bean = null;
		if(map != null)
			bean = (ims.clinical.vo.beans.PresentingComplaintVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.clinical.vo.beans.PresentingComplaintVoBean();
	...
	*/
		...
		*/
			...
			{
				//specifically used by AllergenVo
				return null;
			}
			...
			public void setCciAllergenType(ims.core.vo.lookups.AllergenType cciAllergenType)
			{
				//specifically used by AllergenVo
			}
	...
	public void setCciTCILagTime(Integer tciLagTime)
	{
		// this function is only for the procedure vo. 		
			...
			{
				return this.getID_PresentingComplaint();
			}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.pcname != null)
			if(this.pcname.length() > 100)
				listOfErrors.add("The length of the field [pcname] in the value object [ims.clinical.vo.PresentingComplaintVo] is too big. It should be less or equal to 100");
		if(this.taxonomymap != null)
		{
	...
	public Object clone()
	{
		...
		PresentingComplaintVo clone = new PresentingComplaintVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(PresentingComplaintVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A PresentingComplaintVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((PresentingComplaintVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((PresentingComplaintVo)obj).getBoId());
	}
