...
public class LoCallWaitingListDetailsMediumVoBean extends ims.vo.ValueObjectBean
{
	public LoCallWaitingListDetailsMediumVoBean()
	{
	}
	public LoCallWaitingListDetailsMediumVoBean(ims.ntpf.vo.LoCallWaitingListDetailsMediumVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ntpf.vo.LoCallWaitingListDetailsMediumVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.statushistory = vo.getStatusHistory() == null ? null : vo.getStatusHistory().getBeanCollection();
	...
	public ims.ntpf.vo.LoCallWaitingListDetailsMediumVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.ntpf.vo.LoCallWaitingListDetailsMediumVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.ntpf.vo.LoCallWaitingListDetailsMediumVo vo = null;
		if(map != null)
			vo = (ims.ntpf.vo.LoCallWaitingListDetailsMediumVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.ntpf.vo.LoCallWaitingListDetailsMediumVo();
