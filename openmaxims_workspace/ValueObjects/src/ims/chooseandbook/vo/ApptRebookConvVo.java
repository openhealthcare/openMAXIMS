 ...
 */
public class ApptRebookConvVo extends ims.chooseandbook.vo.ConversationVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public ApptRebookConvVo()
	{
	}
	public ApptRebookConvVo(Integer id, int version)
	{
		super(id, version);
	}
	public ApptRebookConvVo(ims.chooseandbook.vo.beans.ApptRebookConvVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.chooseandbook.vo.beans.ApptRebookConvVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.chooseandbook.vo.beans.ApptRebookConvVoBean bean = null;
		if(map != null)
			bean = (ims.chooseandbook.vo.beans.ApptRebookConvVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.chooseandbook.vo.beans.ApptRebookConvVoBean();
	...
	public Object clone()
	{
		...
		ApptRebookConvVo clone = new ApptRebookConvVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(ApptRebookConvVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A ApptRebookConvVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		ApptRebookConvVo compareObj = (ApptRebookConvVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
