...
public class ApptConfirmConvVoBean extends ims.vo.ValueObjectBean
{
	public ApptConfirmConvVoBean()
	{
	}
	public ApptConfirmConvVoBean(ims.chooseandbook.vo.ApptConfirmConvVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.chooseandbook.vo.ApptConfirmConvVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.chooseandbook.vo.ApptConfirmConvVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.chooseandbook.vo.ApptConfirmConvVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.chooseandbook.vo.ApptConfirmConvVo vo = null;
		if(map != null)
			vo = (ims.chooseandbook.vo.ApptConfirmConvVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.chooseandbook.vo.ApptConfirmConvVo();
