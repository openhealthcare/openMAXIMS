 ...
 */
public class NtfyDnaConvVo extends ims.chooseandbook.vo.ConversationVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public NtfyDnaConvVo()
	{
	}
	public NtfyDnaConvVo(Integer id, int version)
	{
		super(id, version);
	}
	public NtfyDnaConvVo(ims.chooseandbook.vo.beans.NtfyDnaConvVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.chooseandbook.vo.beans.NtfyDnaConvVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.chooseandbook.vo.beans.NtfyDnaConvVoBean bean = null;
		if(map != null)
			bean = (ims.chooseandbook.vo.beans.NtfyDnaConvVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.chooseandbook.vo.beans.NtfyDnaConvVoBean();
	...
	public Object clone()
	{
		...
		NtfyDnaConvVo clone = new NtfyDnaConvVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(NtfyDnaConvVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A NtfyDnaConvVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		NtfyDnaConvVo compareObj = (NtfyDnaConvVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
