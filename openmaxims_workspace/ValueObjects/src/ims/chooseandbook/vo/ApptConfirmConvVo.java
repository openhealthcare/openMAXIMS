 ...
 */
public class ApptConfirmConvVo extends ims.chooseandbook.vo.ConversationVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public ApptConfirmConvVo()
	{
	}
	public ApptConfirmConvVo(Integer id, int version)
	{
		super(id, version);
	}
	public ApptConfirmConvVo(ims.chooseandbook.vo.beans.ApptConfirmConvVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.chooseandbook.vo.beans.ApptConfirmConvVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.chooseandbook.vo.beans.ApptConfirmConvVoBean bean = null;
		if(map != null)
			bean = (ims.chooseandbook.vo.beans.ApptConfirmConvVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.chooseandbook.vo.beans.ApptConfirmConvVoBean();
	...
	public Object clone()
	{
		...
		ApptConfirmConvVo clone = new ApptConfirmConvVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(ApptConfirmConvVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A ApptConfirmConvVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		ApptConfirmConvVo compareObj = (ApptConfirmConvVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
