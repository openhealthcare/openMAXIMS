 ...
 */
public class NtfySlotCancConvVo extends ims.chooseandbook.vo.ConversationVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public NtfySlotCancConvVo()
	{
	}
	public NtfySlotCancConvVo(Integer id, int version)
	{
		super(id, version);
	}
	public NtfySlotCancConvVo(ims.chooseandbook.vo.beans.NtfySlotCancConvVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.chooseandbook.vo.beans.NtfySlotCancConvVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.chooseandbook.vo.beans.NtfySlotCancConvVoBean bean = null;
		if(map != null)
			bean = (ims.chooseandbook.vo.beans.NtfySlotCancConvVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.chooseandbook.vo.beans.NtfySlotCancConvVoBean();
	...
	public Object clone()
	{
		...
		NtfySlotCancConvVo clone = new NtfySlotCancConvVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(NtfySlotCancConvVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A NtfySlotCancConvVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		NtfySlotCancConvVo compareObj = (NtfySlotCancConvVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
