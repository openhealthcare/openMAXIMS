 ...
 */
public class SlotHarvestConvVo extends ims.chooseandbook.vo.ConversationVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public SlotHarvestConvVo()
	{
	}
	public SlotHarvestConvVo(Integer id, int version)
	{
		super(id, version);
	}
	public SlotHarvestConvVo(ims.chooseandbook.vo.beans.SlotHarvestConvVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.chooseandbook.vo.beans.SlotHarvestConvVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.chooseandbook.vo.beans.SlotHarvestConvVoBean bean = null;
		if(map != null)
			bean = (ims.chooseandbook.vo.beans.SlotHarvestConvVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.chooseandbook.vo.beans.SlotHarvestConvVoBean();
	...
	public Object clone()
	{
		...
		SlotHarvestConvVo clone = new SlotHarvestConvVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(SlotHarvestConvVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A SlotHarvestConvVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		SlotHarvestConvVo compareObj = (SlotHarvestConvVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
