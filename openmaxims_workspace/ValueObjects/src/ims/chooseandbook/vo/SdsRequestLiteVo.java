 ...
 */
public class SdsRequestLiteVo extends ims.choose_book.vo.SdsRequestRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public SdsRequestLiteVo()
	{
	}
	public SdsRequestLiteVo(Integer id, int version)
	{
		super(id, version);
	}
	public SdsRequestLiteVo(ims.chooseandbook.vo.beans.SdsRequestLiteVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.chooseandbook.vo.beans.SdsRequestLiteVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.datetimerequested = bean.getDateTimeRequested() == null ? null : bean.getDateTimeRequested().buildDateTime();
	...
	{
		ims.chooseandbook.vo.beans.SdsRequestLiteVoBean bean = null;
		if(map != null)
			bean = (ims.chooseandbook.vo.beans.SdsRequestLiteVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.chooseandbook.vo.beans.SdsRequestLiteVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.comments != null)
			if(this.comments.length() > 255)
				listOfErrors.add("The length of the field [comments] in the value object [ims.chooseandbook.vo.SdsRequestLiteVo] is too big. It should be less or equal to 255");
		if(this.active == null)
	...
	public Object clone()
	{
		...
		SdsRequestLiteVo clone = new SdsRequestLiteVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(SdsRequestLiteVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A SdsRequestLiteVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((SdsRequestLiteVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((SdsRequestLiteVo)obj).getBoId());
	}
