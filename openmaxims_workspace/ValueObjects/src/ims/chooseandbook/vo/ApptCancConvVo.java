 ...
 */
public class ApptCancConvVo extends ims.chooseandbook.vo.ConversationVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public ApptCancConvVo()
	{
	}
	public ApptCancConvVo(Integer id, int version)
	{
		super(id, version);
	}
	public ApptCancConvVo(ims.chooseandbook.vo.beans.ApptCancConvVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.chooseandbook.vo.beans.ApptCancConvVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.chooseandbook.vo.beans.ApptCancConvVoBean bean = null;
		if(map != null)
			bean = (ims.chooseandbook.vo.beans.ApptCancConvVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.chooseandbook.vo.beans.ApptCancConvVoBean();
	...
	public Object clone()
	{
		...
		ApptCancConvVo clone = new ApptCancConvVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(ApptCancConvVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A ApptCancConvVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		ApptCancConvVo compareObj = (ApptCancConvVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
