 ...
 */
public class CatsReferralForClinicListVo extends ims.careuk.vo.CatsReferralRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public CatsReferralForClinicListVo(ims.careuk.vo.beans.CatsReferralForClinicListVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.hasdnaapptsforreview = bean.getHasDNAApptsForReview();
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.CatsReferralForClinicListVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.hasdnaapptsforreview = bean.getHasDNAApptsForReview();
	...
	{
		ims.careuk.vo.beans.CatsReferralForClinicListVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.CatsReferralForClinicListVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.CatsReferralForClinicListVoBean();
