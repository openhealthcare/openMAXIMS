...
public class CatsReportNoteVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<CatsReportNoteVo>
{
	...
	{
		return "ims.careuk.domain.objects.CatsReportNote";
	}
	...
	public ims.careuk.vo.CatsReportNoteRefVoCollection toRefVoCollection()
	{
		ims.careuk.vo.CatsReportNoteRefVoCollection result = new ims.careuk.vo.CatsReportNoteRefVoCollection();
		for(int x = 0; x < this.col.size(); x++)
		{
	...
	public ims.careuk.vo.beans.CatsReportNoteVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.CatsReportNoteVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.CatsReportNoteVoBean[] result = new ims.careuk.vo.beans.CatsReportNoteVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			CatsReportNoteVo vo = ((CatsReportNoteVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.CatsReportNoteVoBean)vo.getBean();
		}
		return result;
	}
	public static CatsReportNoteVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.CatsReportNoteVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static CatsReportNoteVoCollection buildFromBeanCollection(ims.careuk.vo.beans.CatsReportNoteVoBean[] beans)
	{
		CatsReportNoteVoCollection coll = new CatsReportNoteVoCollection();
		if(beans == null)
			return coll;
