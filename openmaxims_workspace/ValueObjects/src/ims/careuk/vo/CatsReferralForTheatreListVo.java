 ...
 */
public class CatsReferralForTheatreListVo extends ims.careuk.vo.CatsReferralRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public CatsReferralForTheatreListVo()
	{
	}
	public CatsReferralForTheatreListVo(Integer id, int version)
	{
		super(id, version);
	}
	public CatsReferralForTheatreListVo(ims.careuk.vo.beans.CatsReferralForTheatreListVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.CatsReferralForTheatreListVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.CatsReferralForTheatreListVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.CatsReferralForTheatreListVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.CatsReferralForTheatreListVoBean();
	...
	public Object clone()
	{
		...
		CatsReferralForTheatreListVo clone = new CatsReferralForTheatreListVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(CatsReferralForTheatreListVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A CatsReferralForTheatreListVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((CatsReferralForTheatreListVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((CatsReferralForTheatreListVo)obj).getBoId());
	}
