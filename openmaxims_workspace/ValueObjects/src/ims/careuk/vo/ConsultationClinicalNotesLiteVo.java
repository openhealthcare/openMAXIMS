 ...
 */
public class ConsultationClinicalNotesLiteVo extends ims.careuk.vo.ConsultationClinicalNotesRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ConsultationClinicalNotesLiteVo(ims.careuk.vo.beans.ConsultationClinicalNotesLiteVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.ConsultationClinicalNotesLiteVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.catsreferral = bean.getCatsReferral() == null ? null : new ims.careuk.vo.CatsReferralRefVo(new Integer(bean.getCatsReferral().getId()), bean.getCatsReferral().getVersion());
	...
	{
		ims.careuk.vo.beans.ConsultationClinicalNotesLiteVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.ConsultationClinicalNotesLiteVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.ConsultationClinicalNotesLiteVoBean();
