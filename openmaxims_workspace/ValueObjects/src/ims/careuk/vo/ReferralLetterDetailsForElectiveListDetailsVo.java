...
public class ReferralLetterDetailsForElectiveListDetailsVo extends ims.core.clinical.vo.ReferralLetterDetailsRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ReferralLetterDetailsForElectiveListDetailsVo(ims.careuk.vo.beans.ReferralLetterDetailsForElectiveListDetailsVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.ReferralLetterDetailsForElectiveListDetailsVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.ReferralLetterDetailsForElectiveListDetailsVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.ReferralLetterDetailsForElectiveListDetailsVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.ReferralLetterDetailsForElectiveListDetailsVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.specialrequirements != null)
			if(this.specialrequirements.length() > 255)
				listOfErrors.add("The length of the field [specialrequirements] in the value object [ims.careuk.vo.ReferralLetterDetailsForElectiveListDetailsVo] is too big. It should be less or equal to 255");
