...
public class ReferralLetterDetailsForNewPatientElectiveListVo extends ims.core.clinical.vo.ReferralLetterDetailsRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ReferralLetterDetailsForNewPatientElectiveListVo(ims.careuk.vo.beans.ReferralLetterDetailsForNewPatientElectiveListVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.ReferralLetterDetailsForNewPatientElectiveListVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.ReferralLetterDetailsForNewPatientElectiveListVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.ReferralLetterDetailsForNewPatientElectiveListVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.ReferralLetterDetailsForNewPatientElectiveListVoBean();
