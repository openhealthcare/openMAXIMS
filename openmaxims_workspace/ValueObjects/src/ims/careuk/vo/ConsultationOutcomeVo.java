 ...
 */
public class ConsultationOutcomeVo extends ims.careuk.vo.ConsultationOutcomeRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ConsultationOutcomeVo(ims.careuk.vo.beans.ConsultationOutcomeVoBean bean)
	{
		this.id = bean.getId();
		...
		this.dischargetype = bean.getDischargeType() == null ? null : ims.careuk.vo.lookups.ConsultationOutcomeType.buildLookup(bean.getDischargeType());
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.ConsultationOutcomeVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.ConsultationOutcomeVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.ConsultationOutcomeVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.ConsultationOutcomeVoBean();
	...
	public ims.careuk.vo.lookups.ConsultationOutcomeType getDischargeType()
	{
		return this.dischargetype;
	}
	public void setDischargeType(ims.careuk.vo.lookups.ConsultationOutcomeType value)
	{
		this.isValidated = false;
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.furthermanagement != null)
			if(this.furthermanagement.length() > 3000)
				listOfErrors.add("The length of the field [furthermanagement] in the value object [ims.careuk.vo.ConsultationOutcomeVo] is too big. It should be less or equal to 3000");
	...
	public Object clone()
	{
		...
		if(this.dischargetype == null)
			...
			clone.dischargetype = (ims.careuk.vo.lookups.ConsultationOutcomeType)this.dischargetype.clone();
	...
	protected ims.careuk.vo.lookups.ConsultationOutcomeType dischargetype;
