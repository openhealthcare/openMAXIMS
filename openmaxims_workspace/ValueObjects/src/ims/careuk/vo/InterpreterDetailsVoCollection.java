...
public class InterpreterDetailsVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<InterpreterDetailsVo>
{
	...
	{
		return "ims.careuk.domain.objects.InterpreterDetails";
	}
	...
	public ims.careuk.vo.InterpreterDetailsRefVoCollection toRefVoCollection()
	{
		ims.careuk.vo.InterpreterDetailsRefVoCollection result = new ims.careuk.vo.InterpreterDetailsRefVoCollection();
		for(int x = 0; x < this.col.size(); x++)
		{
	...
	public ims.careuk.vo.beans.InterpreterDetailsVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.InterpreterDetailsVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.InterpreterDetailsVoBean[] result = new ims.careuk.vo.beans.InterpreterDetailsVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			InterpreterDetailsVo vo = ((InterpreterDetailsVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.InterpreterDetailsVoBean)vo.getBean();
		}
		return result;
	}
	public static InterpreterDetailsVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.InterpreterDetailsVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static InterpreterDetailsVoCollection buildFromBeanCollection(ims.careuk.vo.beans.InterpreterDetailsVoBean[] beans)
	{
		InterpreterDetailsVoCollection coll = new InterpreterDetailsVoCollection();
		if(beans == null)
			return coll;
