...
public class ActivityUniqueLineRefVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<ActivityUniqueLineRefVo>
{
	...
	public ims.careuk.vo.ActivityUniqueLineRefRefVoCollection toRefVoCollection()
	{
		ims.careuk.vo.ActivityUniqueLineRefRefVoCollection result = new ims.careuk.vo.ActivityUniqueLineRefRefVoCollection();
		for(int x = 0; x < this.col.size(); x++)
		{
	...
	public ims.careuk.vo.beans.ActivityUniqueLineRefVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.ActivityUniqueLineRefVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.ActivityUniqueLineRefVoBean[] result = new ims.careuk.vo.beans.ActivityUniqueLineRefVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			ActivityUniqueLineRefVo vo = ((ActivityUniqueLineRefVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.ActivityUniqueLineRefVoBean)vo.getBean();
		}
		return result;
	}
	public static ActivityUniqueLineRefVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.ActivityUniqueLineRefVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static ActivityUniqueLineRefVoCollection buildFromBeanCollection(ims.careuk.vo.beans.ActivityUniqueLineRefVoBean[] beans)
	{
		ActivityUniqueLineRefVoCollection coll = new ActivityUniqueLineRefVoCollection();
		if(beans == null)
			return coll;
