...
public class CatsReferralFlaggedForReviewVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<CatsReferralFlaggedForReviewVo>
{
	...
	public ims.careuk.vo.beans.CatsReferralFlaggedForReviewVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.CatsReferralFlaggedForReviewVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.CatsReferralFlaggedForReviewVoBean[] result = new ims.careuk.vo.beans.CatsReferralFlaggedForReviewVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			CatsReferralFlaggedForReviewVo vo = ((CatsReferralFlaggedForReviewVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.CatsReferralFlaggedForReviewVoBean)vo.getBean();
		}
		return result;
	}
	public static CatsReferralFlaggedForReviewVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.CatsReferralFlaggedForReviewVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static CatsReferralFlaggedForReviewVoCollection buildFromBeanCollection(ims.careuk.vo.beans.CatsReferralFlaggedForReviewVoBean[] beans)
	{
		CatsReferralFlaggedForReviewVoCollection coll = new CatsReferralFlaggedForReviewVoCollection();
		if(beans == null)
			return coll;
