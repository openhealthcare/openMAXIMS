...
public class DiagnosisManagementLiteVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<DiagnosisManagementLiteVo>
{
	...
	public ims.careuk.vo.beans.DiagnosisManagementLiteVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.DiagnosisManagementLiteVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.DiagnosisManagementLiteVoBean[] result = new ims.careuk.vo.beans.DiagnosisManagementLiteVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			DiagnosisManagementLiteVo vo = ((DiagnosisManagementLiteVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.DiagnosisManagementLiteVoBean)vo.getBean();
		}
		return result;
	}
	public static DiagnosisManagementLiteVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.DiagnosisManagementLiteVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static DiagnosisManagementLiteVoCollection buildFromBeanCollection(ims.careuk.vo.beans.DiagnosisManagementLiteVoBean[] beans)
	{
		DiagnosisManagementLiteVoCollection coll = new DiagnosisManagementLiteVoCollection();
		if(beans == null)
			return coll;
