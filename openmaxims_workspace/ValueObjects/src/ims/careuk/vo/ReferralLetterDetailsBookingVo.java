...
public class ReferralLetterDetailsBookingVo extends ims.core.clinical.vo.ReferralLetterDetailsRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ReferralLetterDetailsBookingVo(ims.careuk.vo.beans.ReferralLetterDetailsBookingVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.ReferralLetterDetailsBookingVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.ReferralLetterDetailsBookingVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.ReferralLetterDetailsBookingVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.ReferralLetterDetailsBookingVoBean();
