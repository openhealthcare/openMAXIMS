...
public class ReferralStatusConfigVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<ReferralStatusConfigVo>
{
	...
	public ims.careuk.vo.beans.ReferralStatusConfigVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.ReferralStatusConfigVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.ReferralStatusConfigVoBean[] result = new ims.careuk.vo.beans.ReferralStatusConfigVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			ReferralStatusConfigVo vo = ((ReferralStatusConfigVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.ReferralStatusConfigVoBean)vo.getBean();
		}
		return result;
	}
	public static ReferralStatusConfigVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.ReferralStatusConfigVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static ReferralStatusConfigVoCollection buildFromBeanCollection(ims.careuk.vo.beans.ReferralStatusConfigVoBean[] beans)
	{
		ReferralStatusConfigVoCollection coll = new ReferralStatusConfigVoCollection();
		if(beans == null)
			return coll;
