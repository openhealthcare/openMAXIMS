...
public class CatsReferralListManualAssemblyVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<CatsReferralListManualAssemblyVo>
{
	...
	public ims.careuk.vo.beans.CatsReferralListManualAssemblyVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.CatsReferralListManualAssemblyVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.CatsReferralListManualAssemblyVoBean[] result = new ims.careuk.vo.beans.CatsReferralListManualAssemblyVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			CatsReferralListManualAssemblyVo vo = ((CatsReferralListManualAssemblyVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.CatsReferralListManualAssemblyVoBean)vo.getBean();
		}
		return result;
	}
	public static CatsReferralListManualAssemblyVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.CatsReferralListManualAssemblyVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static CatsReferralListManualAssemblyVoCollection buildFromBeanCollection(ims.careuk.vo.beans.CatsReferralListManualAssemblyVoBean[] beans)
	{
		CatsReferralListManualAssemblyVoCollection coll = new CatsReferralListManualAssemblyVoCollection();
		if(beans == null)
			return coll;
