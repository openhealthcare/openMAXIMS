 ...
 */
public class PatientElectiveListElectiveTCIVo extends ims.careuk.vo.TCIForPatientElectiveListRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public PatientElectiveListElectiveTCIVo(ims.careuk.vo.beans.PatientElectiveListElectiveTCIVoBean bean)
	{
		this.id = bean.getId();
		...
		this.tciward = bean.getTCIWard() == null ? null : new ims.core.resource.place.vo.LocationRefVo(new Integer(bean.getTCIWard().getId()), bean.getTCIWard().getVersion());
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.PatientElectiveListElectiveTCIVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.tcidate = bean.getTCIDate() == null ? null : bean.getTCIDate().buildDate();
	...
	{
		ims.careuk.vo.beans.PatientElectiveListElectiveTCIVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.PatientElectiveListElectiveTCIVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.PatientElectiveListElectiveTCIVoBean();
	...
	public ims.core.resource.place.vo.LocationRefVo getTCIWard()
	{
		return this.tciward;
	}
	public void setTCIWard(ims.core.resource.place.vo.LocationRefVo value)
	{
		this.isValidated = false;
		this.tciward = value;
	}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.datetcioffered == null)
			listOfErrors.add("'Date TCI Offered' is mandatory!");
		if(this.comments != null)
			if(this.comments.length() > 1000)
				listOfErrors.add("The length of the field [comments] in the value object [ims.careuk.vo.PatientElectiveListElectiveTCIVo] is too big. It should be less or equal to 1000");
		if(this.tcibed != null)
			if(this.tcibed.length() > 255)
				listOfErrors.add("The length of the field [tcibed] in the value object [ims.careuk.vo.PatientElectiveListElectiveTCIVo] is too big. It should be less or equal to 255");
		if(this.currentoutcome != null)
		{
	...
	protected ims.core.resource.place.vo.LocationRefVo tciward;
