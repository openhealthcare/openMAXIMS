...
public class CatsReferralForTheatreListVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<CatsReferralForTheatreListVo>
{
	...
	public ims.careuk.vo.beans.CatsReferralForTheatreListVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.CatsReferralForTheatreListVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.CatsReferralForTheatreListVoBean[] result = new ims.careuk.vo.beans.CatsReferralForTheatreListVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			CatsReferralForTheatreListVo vo = ((CatsReferralForTheatreListVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.CatsReferralForTheatreListVoBean)vo.getBean();
		}
		return result;
	}
	public static CatsReferralForTheatreListVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.CatsReferralForTheatreListVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static CatsReferralForTheatreListVoCollection buildFromBeanCollection(ims.careuk.vo.beans.CatsReferralForTheatreListVoBean[] beans)
	{
		CatsReferralForTheatreListVoCollection coll = new CatsReferralForTheatreListVoCollection();
		if(beans == null)
			return coll;
