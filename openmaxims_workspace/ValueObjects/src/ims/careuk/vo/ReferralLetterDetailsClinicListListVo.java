...
public class ReferralLetterDetailsClinicListListVo extends ims.core.clinical.vo.ReferralLetterDetailsRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ReferralLetterDetailsClinicListListVo(ims.careuk.vo.beans.ReferralLetterDetailsClinicListListVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.ReferralLetterDetailsClinicListListVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.isdadreferral = bean.getIsDADReferral();
	...
	{
		ims.careuk.vo.beans.ReferralLetterDetailsClinicListListVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.ReferralLetterDetailsClinicListListVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.ReferralLetterDetailsClinicListListVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.dadubrn != null)
			if(this.dadubrn.length() > 50)
				listOfErrors.add("The length of the field [dadubrn] in the value object [ims.careuk.vo.ReferralLetterDetailsClinicListListVo] is too big. It should be less or equal to 50");
