 ...
 */
public class ReferralERODVo extends ims.careuk.vo.ReferralERODRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ReferralERODVo(ims.careuk.vo.beans.ReferralERODVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.ReferralERODVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.eroddate1 = bean.getERODDate1() == null ? null : bean.getERODDate1().buildDate();
	...
	{
		ims.careuk.vo.beans.ReferralERODVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.ReferralERODVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.ReferralERODVoBean();
	...
	public ims.careuk.vo.Booking_AppointmentERODVo getAppointment()
	{
		return this.appointment;
	}
	public void setAppointment(ims.careuk.vo.Booking_AppointmentERODVo value)
	{
		this.isValidated = false;
	...
	public Object clone()
	{
		...
		if(this.appointment == null)
			...
			clone.appointment = (ims.careuk.vo.Booking_AppointmentERODVo)this.appointment.clone();
	...
	protected ims.careuk.vo.Booking_AppointmentERODVo appointment;
