 ...
 */
public class NursingNotesVo extends ims.careuk.vo.NursingNotesRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public NursingNotesVo(ims.careuk.vo.beans.NursingNotesVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.NursingNotesVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.catsreferral = bean.getCatsReferral() == null ? null : new ims.careuk.vo.CatsReferralRefVo(new Integer(bean.getCatsReferral().getId()), bean.getCatsReferral().getVersion());
	...
	{
		ims.careuk.vo.beans.NursingNotesVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.NursingNotesVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.NursingNotesVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.observationnotes != null)
			if(this.observationnotes.length() > 1000)
				listOfErrors.add("The length of the field [observationnotes] in the value object [ims.careuk.vo.NursingNotesVo] is too big. It should be less or equal to 1000");
		if(this.comorbidities != null)
		{
