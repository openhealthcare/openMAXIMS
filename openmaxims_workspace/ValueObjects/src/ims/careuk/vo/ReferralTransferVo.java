 ...
 */
public class ReferralTransferVo extends ims.careuk.vo.ReferralTransferRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ReferralTransferVo(ims.careuk.vo.beans.ReferralTransferVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.ReferralTransferVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.rttstatusdate = bean.getRTTStatusDate() == null ? null : bean.getRTTStatusDate().buildDate();
	...
	{
		ims.careuk.vo.beans.ReferralTransferVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.ReferralTransferVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.ReferralTransferVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.otherpatientnumber == null || this.otherpatientnumber.length() == 0)
			...
			listOfErrors.add("The length of the field [otherpatientnumber] in the value object [ims.careuk.vo.ReferralTransferVo] is too big. It should be less or equal to 50");
		if(this.otherorganisationcode == null || this.otherorganisationcode.length() == 0)
			...
			listOfErrors.add("The length of the field [otherorganisationcode] in the value object [ims.careuk.vo.ReferralTransferVo] is too big. It should be less or equal to 5");
		if(this.currentrttstatus != null)
		{
