...
public class OutpatientPreAssessmentVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<OutpatientPreAssessmentVo>
{
	...
	public ims.careuk.vo.OutpatientPreAssessmentRefVoCollection toRefVoCollection()
	{
		ims.careuk.vo.OutpatientPreAssessmentRefVoCollection result = new ims.careuk.vo.OutpatientPreAssessmentRefVoCollection();
		for(int x = 0; x < this.col.size(); x++)
		{
	...
	public ims.careuk.vo.beans.OutpatientPreAssessmentVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.OutpatientPreAssessmentVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.OutpatientPreAssessmentVoBean[] result = new ims.careuk.vo.beans.OutpatientPreAssessmentVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			OutpatientPreAssessmentVo vo = ((OutpatientPreAssessmentVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.OutpatientPreAssessmentVoBean)vo.getBean();
		}
		return result;
	}
	public static OutpatientPreAssessmentVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.OutpatientPreAssessmentVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static OutpatientPreAssessmentVoCollection buildFromBeanCollection(ims.careuk.vo.beans.OutpatientPreAssessmentVoBean[] beans)
	{
		OutpatientPreAssessmentVoCollection coll = new OutpatientPreAssessmentVoCollection();
		if(beans == null)
			return coll;
