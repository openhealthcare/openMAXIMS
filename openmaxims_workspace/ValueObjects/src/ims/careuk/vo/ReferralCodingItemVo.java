 ...
 */
public class ReferralCodingItemVo extends ims.careuk.vo.ReferralCodingItemRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ReferralCodingItemVo(ims.careuk.vo.beans.ReferralCodingItemVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.ReferralCodingItemVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.ReferralCodingItemVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.ReferralCodingItemVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.ReferralCodingItemVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.opcs4 != null)
			if(this.opcs4.length() > 25)
				listOfErrors.add("The length of the field [opcs4] in the value object [ims.careuk.vo.ReferralCodingItemVo] is too big. It should be less or equal to 25");
		if(this.icd10 != null)
			if(this.icd10.length() > 25)
				listOfErrors.add("The length of the field [icd10] in the value object [ims.careuk.vo.ReferralCodingItemVo] is too big. It should be less or equal to 25");
