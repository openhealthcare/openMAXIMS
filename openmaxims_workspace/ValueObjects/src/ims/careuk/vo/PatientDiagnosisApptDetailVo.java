 ...
 */
public class PatientDiagnosisApptDetailVo extends ims.careuk.vo.PatientDiagnosisForClinicalNotesVo implements ims.vo.ImsCloneable, Comparable, ims.vo.interfaces.IClinicalCodingValue
{
	...
	public PatientDiagnosisApptDetailVo(ims.careuk.vo.beans.PatientDiagnosisApptDetailVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.PatientDiagnosisApptDetailVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.PatientDiagnosisApptDetailVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.PatientDiagnosisApptDetailVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.PatientDiagnosisApptDetailVoBean();
	...
	*/
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.diagnosisdescription == null || this.diagnosisdescription.length() == 0)
			...
			listOfErrors.add("The length of the field [diagnosisdescription] in the value object [ims.careuk.vo.PatientDiagnosisApptDetailVo] is too big. It should be less or equal to 255");
