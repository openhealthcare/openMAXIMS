 ...
 */
public class PrescriptionsLiteVo extends ims.careuk.vo.PrescriptionRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public PrescriptionsLiteVo(ims.careuk.vo.beans.PrescriptionsLiteVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.PrescriptionsLiteVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.catsreferral = bean.getCatsReferral() == null ? null : new ims.careuk.vo.CatsReferralRefVo(new Integer(bean.getCatsReferral().getId()), bean.getCatsReferral().getVersion());
	...
	{
		ims.careuk.vo.beans.PrescriptionsLiteVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.PrescriptionsLiteVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.PrescriptionsLiteVoBean();
