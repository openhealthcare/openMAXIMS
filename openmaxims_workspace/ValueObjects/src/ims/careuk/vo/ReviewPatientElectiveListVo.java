...
/**
 * Linked to CAREUK.ReviewPatientElectiveList business object (ID: 1096100069).
 */
public class ReviewPatientElectiveListVo extends ims.careuk.vo.ReviewPatientElectiveListRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ReviewPatientElectiveListVo(ims.careuk.vo.beans.ReviewPatientElectiveListVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.reviewtype = bean.getReviewType() == null ? null : ims.careuk.vo.lookups.ElectiveListReviewType.buildLookup(bean.getReviewType());
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.ReviewPatientElectiveListVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.reviewtype = bean.getReviewType() == null ? null : ims.careuk.vo.lookups.ElectiveListReviewType.buildLookup(bean.getReviewType());
	...
	{
		ims.careuk.vo.beans.ReviewPatientElectiveListVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.ReviewPatientElectiveListVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.ReviewPatientElectiveListVoBean();
	...
	public ims.careuk.vo.lookups.ElectiveListReviewType getReviewType()
	{
		return this.reviewtype;
	}
	public void setReviewType(ims.careuk.vo.lookups.ElectiveListReviewType value)
	{
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.reviewnotes != null)
			if(this.reviewnotes.length() > 1000)
				listOfErrors.add("The length of the field [reviewnotes] in the value object [ims.careuk.vo.ReviewPatientElectiveListVo] is too big. It should be less or equal to 1000");
	...
	public Object clone()
	{
		...
		if(this.reviewtype == null)
			...
			clone.reviewtype = (ims.careuk.vo.lookups.ElectiveListReviewType)this.reviewtype.clone();
	...
	protected ims.careuk.vo.lookups.ElectiveListReviewType reviewtype;
