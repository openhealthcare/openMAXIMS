...
public class IFCATSExternalEventVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<IFCATSExternalEventVo>
{
	...
	public ims.careuk.vo.beans.IFCATSExternalEventVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.IFCATSExternalEventVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.IFCATSExternalEventVoBean[] result = new ims.careuk.vo.beans.IFCATSExternalEventVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			IFCATSExternalEventVo vo = ((IFCATSExternalEventVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.IFCATSExternalEventVoBean)vo.getBean();
		}
		return result;
	}
	public static IFCATSExternalEventVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.IFCATSExternalEventVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static IFCATSExternalEventVoCollection buildFromBeanCollection(ims.careuk.vo.beans.IFCATSExternalEventVoBean[] beans)
	{
		IFCATSExternalEventVoCollection coll = new IFCATSExternalEventVoCollection();
		if(beans == null)
			return coll;
