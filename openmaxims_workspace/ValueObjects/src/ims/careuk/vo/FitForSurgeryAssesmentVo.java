 ...
 */
public class FitForSurgeryAssesmentVo extends ims.careuk.vo.FitForSurgeryAssessmentLiteVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public FitForSurgeryAssesmentVo(ims.careuk.vo.beans.FitForSurgeryAssesmentVoBean bean)
	{
		this.id = bean.getId();
		...
		this.fitcomments = ims.careuk.vo.FitForSurgeryCommentVoCollection.buildFromBeanCollection(bean.getFitComments());
		this.opdappt = bean.getOPDAppt() == null ? null : bean.getOPDAppt().buildVo();
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.FitForSurgeryAssesmentVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.carecontext = bean.getCareContext() == null ? null : new ims.core.admin.vo.CareContextRefVo(new Integer(bean.getCareContext().getId()), bean.getCareContext().getVersion());
	...
	{
		ims.careuk.vo.beans.FitForSurgeryAssesmentVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.FitForSurgeryAssesmentVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.FitForSurgeryAssesmentVoBean();
	...
	public ims.careuk.vo.FitForSurgeryCommentVoCollection getFitComments()
	{
		return this.fitcomments;
	}
	public void setFitComments(ims.careuk.vo.FitForSurgeryCommentVoCollection value)
	{
		this.isValidated = false;
	...
	public Object clone()
	{
		...
		if(this.fitcomments == null)
			...
			clone.fitcomments = (ims.careuk.vo.FitForSurgeryCommentVoCollection)this.fitcomments.clone();
	...
	protected ims.careuk.vo.FitForSurgeryCommentVoCollection fitcomments;
