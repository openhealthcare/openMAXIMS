...
public class InpatientClinicalCodingWorklistSearchCriteriaVo extends ims.vo.ValueObject implements ims.vo.ImsCloneable, Comparable
{
	...
	public InpatientClinicalCodingWorklistSearchCriteriaVo(ims.careuk.vo.beans.InpatientClinicalCodingWorklistSearchCriteriaVoBean bean)
	{
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.InpatientClinicalCodingWorklistSearchCriteriaVoBean bean)
	{
		this.specialty = bean.getSpecialty() == null ? null : ims.core.vo.lookups.Specialty.buildLookup(bean.getSpecialty());
	...
	{
		ims.careuk.vo.beans.InpatientClinicalCodingWorklistSearchCriteriaVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.InpatientClinicalCodingWorklistSearchCriteriaVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.InpatientClinicalCodingWorklistSearchCriteriaVoBean();
