 ...
 */
public class ReportNotePrintTemplateVo extends ims.careuk.vo.ReportNotePrintTemplateRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ReportNotePrintTemplateVo(ims.careuk.vo.beans.ReportNotePrintTemplateVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.ReportNotePrintTemplateVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.notetype = bean.getNoteType() == null ? null : ims.careuk.vo.lookups.ReportNoteType.buildLookup(bean.getNoteType());
	...
	{
		ims.careuk.vo.beans.ReportNotePrintTemplateVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.ReportNotePrintTemplateVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.ReportNotePrintTemplateVoBean();
