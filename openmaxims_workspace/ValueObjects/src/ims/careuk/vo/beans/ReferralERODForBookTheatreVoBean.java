...
public class ReferralERODForBookTheatreVoBean extends ims.vo.ValueObjectBean
{
	public ReferralERODForBookTheatreVoBean()
	{
	}
	public ReferralERODForBookTheatreVoBean(ims.careuk.vo.ReferralERODForBookTheatreVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.ReferralERODForBookTheatreVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.eroddate1 = vo.getERODDate1() == null ? null : (ims.framework.utils.beans.DateBean)vo.getERODDate1().getBean();
	...
	public ims.careuk.vo.ReferralERODForBookTheatreVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.ReferralERODForBookTheatreVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.ReferralERODForBookTheatreVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.ReferralERODForBookTheatreVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.ReferralERODForBookTheatreVo();
