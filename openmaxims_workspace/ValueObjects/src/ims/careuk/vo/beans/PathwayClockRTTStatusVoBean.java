...
public class PathwayClockRTTStatusVoBean extends ims.vo.ValueObjectBean
{
	...
	public PathwayClockRTTStatusVoBean(ims.careuk.vo.PathwayClockRTTStatusVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.PathwayClockRTTStatusVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.currentrttstatus = vo.getCurrentRTTStatus() == null ? null : new ims.vo.RefVoBean(vo.getCurrentRTTStatus().getBoId(), vo.getCurrentRTTStatus().getBoVersion());
	...
	public ims.careuk.vo.PathwayClockRTTStatusVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.PathwayClockRTTStatusVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.PathwayClockRTTStatusVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.PathwayClockRTTStatusVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.PathwayClockRTTStatusVo();
