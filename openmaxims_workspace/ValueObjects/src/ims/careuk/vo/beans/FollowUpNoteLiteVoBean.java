...
public class FollowUpNoteLiteVoBean extends ims.vo.ValueObjectBean
{
	public FollowUpNoteLiteVoBean()
	{
	}
	public FollowUpNoteLiteVoBean(ims.careuk.vo.FollowUpNoteLiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.FollowUpNoteLiteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.catsreferral = vo.getCatsReferral() == null ? null : new ims.vo.RefVoBean(vo.getCatsReferral().getBoId(), vo.getCatsReferral().getBoVersion());
	...
	public ims.careuk.vo.FollowUpNoteLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.FollowUpNoteLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.FollowUpNoteLiteVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.FollowUpNoteLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.FollowUpNoteLiteVo();
