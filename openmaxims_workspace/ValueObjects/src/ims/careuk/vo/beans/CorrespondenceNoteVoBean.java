...
public class CorrespondenceNoteVoBean extends ims.vo.ValueObjectBean
{
	...
	public CorrespondenceNoteVoBean(ims.careuk.vo.CorrespondenceNoteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.CorrespondenceNoteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.catsreferral = vo.getCatsReferral() == null ? null : new ims.vo.RefVoBean(vo.getCatsReferral().getBoId(), vo.getCatsReferral().getBoVersion());
	...
	public ims.careuk.vo.CorrespondenceNoteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.CorrespondenceNoteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.CorrespondenceNoteVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.CorrespondenceNoteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.CorrespondenceNoteVo();
