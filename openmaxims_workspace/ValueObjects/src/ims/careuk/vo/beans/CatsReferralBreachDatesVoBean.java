...
public class CatsReferralBreachDatesVoBean extends ims.vo.ValueObjectBean
{
	...
	public CatsReferralBreachDatesVoBean(ims.careuk.vo.CatsReferralBreachDatesVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.CatsReferralBreachDatesVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.careuk.vo.CatsReferralBreachDatesVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.CatsReferralBreachDatesVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.CatsReferralBreachDatesVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.CatsReferralBreachDatesVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.CatsReferralBreachDatesVo();
