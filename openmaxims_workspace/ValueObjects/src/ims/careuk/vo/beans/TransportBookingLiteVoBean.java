...
public class TransportBookingLiteVoBean extends ims.vo.ValueObjectBean
{
	...
	public TransportBookingLiteVoBean(ims.careuk.vo.TransportBookingLiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.TransportBookingLiteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.datebooked = vo.getDateBooked() == null ? null : (ims.framework.utils.beans.DateBean)vo.getDateBooked().getBean();
	...
	public ims.careuk.vo.TransportBookingLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.TransportBookingLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.TransportBookingLiteVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.TransportBookingLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.TransportBookingLiteVo();
