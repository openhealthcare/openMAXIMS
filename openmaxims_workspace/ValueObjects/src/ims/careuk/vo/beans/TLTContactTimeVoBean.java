...
public class TLTContactTimeVoBean extends ims.vo.ValueObjectBean
{
	...
	public TLTContactTimeVoBean(ims.careuk.vo.TLTContactTimeVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.TLTContactTimeVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.careuk.vo.TLTContactTimeVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.TLTContactTimeVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.TLTContactTimeVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.TLTContactTimeVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.TLTContactTimeVo();
