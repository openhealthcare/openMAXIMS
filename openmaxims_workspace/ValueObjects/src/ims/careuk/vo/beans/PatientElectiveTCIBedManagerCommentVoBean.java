...
public class PatientElectiveTCIBedManagerCommentVoBean extends ims.vo.ValueObjectBean
{
	...
	public PatientElectiveTCIBedManagerCommentVoBean(ims.careuk.vo.PatientElectiveTCIBedManagerCommentVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.PatientElectiveTCIBedManagerCommentVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.bedmanagercomment = vo.getBedManagerComment();
	...
	public ims.careuk.vo.PatientElectiveTCIBedManagerCommentVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.PatientElectiveTCIBedManagerCommentVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.PatientElectiveTCIBedManagerCommentVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.PatientElectiveTCIBedManagerCommentVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.PatientElectiveTCIBedManagerCommentVo();
