...
public class DiagnosisManagementLiteVoBean extends ims.vo.ValueObjectBean
{
	...
	public DiagnosisManagementLiteVoBean(ims.careuk.vo.DiagnosisManagementLiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.DiagnosisManagementLiteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.catsreferral = vo.getCatsReferral() == null ? null : new ims.vo.RefVoBean(vo.getCatsReferral().getBoId(), vo.getCatsReferral().getBoVersion());
	...
	public ims.careuk.vo.DiagnosisManagementLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.DiagnosisManagementLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.DiagnosisManagementLiteVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.DiagnosisManagementLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.DiagnosisManagementLiteVo();
