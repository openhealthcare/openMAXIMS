...
public class PatientElectiveListVoBean extends ims.vo.ValueObjectBean
{
	...
	public PatientElectiveListVoBean(ims.careuk.vo.PatientElectiveListVo vo)
	{
		this.id = vo.getBoId();
		...
		this.tcidetails = vo.getTCIDetails() == null ? null : (ims.careuk.vo.beans.PatientElectiveListElectiveTCIVoBean)vo.getTCIDetails().getBean();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.PatientElectiveListVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		...
		this.electiveadmissiontype = vo.getElectiveAdmissionType() == null ? null : (ims.vo.LookupInstanceBean)vo.getElectiveAdmissionType().getBean();
		this.erod = vo.getEROD() == null ? null : new ims.vo.RefVoBean(vo.getEROD().getBoId(), vo.getEROD().getBoVersion());
		this.tcidetails = vo.getTCIDetails() == null ? null : (ims.careuk.vo.beans.PatientElectiveListElectiveTCIVoBean)vo.getTCIDetails().getBean(map);
		this.electiveliststatushistory = vo.getElectiveListStatusHistory() == null ? null : vo.getElectiveListStatusHistory().getBeanCollection();
		this.electivelistreason = vo.getElectiveListReason() == null ? null : (ims.vo.LookupInstanceBean)vo.getElectiveListReason().getBean();
		this.pathwayclock = vo.getPathwayClock() == null ? null : new ims.vo.RefVoBean(vo.getPathwayClock().getBoId(), vo.getPathwayClock().getBoVersion());
		if(vo.getERODHistory() != null)
	...
	public ims.careuk.vo.PatientElectiveListVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.PatientElectiveListVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.PatientElectiveListVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.PatientElectiveListVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.PatientElectiveListVo();
	...
	public ims.careuk.vo.beans.PatientElectiveListElectiveTCIVoBean[] getTCIHistory()
	{
		return this.tcihistory;
	}
	public void setTCIHistory(ims.careuk.vo.beans.PatientElectiveListElectiveTCIVoBean[] value)
	{
	...
	public ims.careuk.vo.beans.PatientElectiveListNotesVoBean[] getNotes()
	{
		return this.notes;
	}
	public void setNotes(ims.careuk.vo.beans.PatientElectiveListNotesVoBean[] value)
	{
		this.notes = value;
	}
	...
	public ims.careuk.vo.beans.PatientElectiveListElectiveTCIVoBean getTCIDetails()
	{
		return this.tcidetails;
	}
	public void setTCIDetails(ims.careuk.vo.beans.PatientElectiveListElectiveTCIVoBean value)
	{
	...
	private ims.careuk.vo.beans.PatientElectiveListElectiveTCIVoBean[] tcihistory;
	private Boolean interpretatorrequired;
	private ims.vo.LookupInstanceBean transport;
	private ims.careuk.vo.beans.PatientElectiveListNotesVoBean[] notes;
	private ims.vo.LookupInstanceBean electiveadmissiontype;
	private ims.vo.RefVoBean erod;
	private ims.careuk.vo.beans.PatientElectiveListElectiveTCIVoBean tcidetails;
