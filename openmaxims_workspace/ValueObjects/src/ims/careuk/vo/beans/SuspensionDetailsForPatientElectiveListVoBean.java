...
public class SuspensionDetailsForPatientElectiveListVoBean extends ims.vo.ValueObjectBean
{
	...
	public SuspensionDetailsForPatientElectiveListVoBean(ims.careuk.vo.SuspensionDetailsForPatientElectiveListVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.SuspensionDetailsForPatientElectiveListVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.startdate = vo.getStartDate() == null ? null : (ims.framework.utils.beans.DateBean)vo.getStartDate().getBean();
	...
	public ims.careuk.vo.SuspensionDetailsForPatientElectiveListVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.SuspensionDetailsForPatientElectiveListVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.SuspensionDetailsForPatientElectiveListVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.SuspensionDetailsForPatientElectiveListVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.SuspensionDetailsForPatientElectiveListVo();
