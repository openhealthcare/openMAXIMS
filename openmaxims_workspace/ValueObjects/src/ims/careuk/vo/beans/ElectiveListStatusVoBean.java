...
public class ElectiveListStatusVoBean extends ims.vo.ValueObjectBean
{
	...
	public ElectiveListStatusVoBean(ims.careuk.vo.ElectiveListStatusVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.ElectiveListStatusVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.careuk.vo.ElectiveListStatusVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.ElectiveListStatusVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.ElectiveListStatusVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.ElectiveListStatusVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.ElectiveListStatusVo();
