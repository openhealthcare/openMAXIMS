...
public class PrescriptionsLiteVoBean extends ims.vo.ValueObjectBean
{
	public PrescriptionsLiteVoBean()
	{
	}
	public PrescriptionsLiteVoBean(ims.careuk.vo.PrescriptionsLiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.PrescriptionsLiteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.catsreferral = vo.getCatsReferral() == null ? null : new ims.vo.RefVoBean(vo.getCatsReferral().getBoId(), vo.getCatsReferral().getBoVersion());
	...
	public ims.careuk.vo.PrescriptionsLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.PrescriptionsLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.PrescriptionsLiteVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.PrescriptionsLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.PrescriptionsLiteVo();
