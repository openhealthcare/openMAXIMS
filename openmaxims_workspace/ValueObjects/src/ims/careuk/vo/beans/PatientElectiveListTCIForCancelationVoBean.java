...
public class PatientElectiveListTCIForCancelationVoBean extends ims.vo.ValueObjectBean
{
	...
	public PatientElectiveListTCIForCancelationVoBean(ims.careuk.vo.PatientElectiveListTCIForCancelationVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.PatientElectiveListTCIForCancelationVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.careuk.vo.PatientElectiveListTCIForCancelationVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.PatientElectiveListTCIForCancelationVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.PatientElectiveListTCIForCancelationVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.PatientElectiveListTCIForCancelationVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.PatientElectiveListTCIForCancelationVo();
