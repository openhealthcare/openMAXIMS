...
public class DischargeSummaryPacuAndWardLiteVoBean extends ims.vo.ValueObjectBean
{
	...
	public DischargeSummaryPacuAndWardLiteVoBean(ims.careuk.vo.DischargeSummaryPacuAndWardLiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.DischargeSummaryPacuAndWardLiteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.catsreferral = vo.getCatsReferral() == null ? null : new ims.vo.RefVoBean(vo.getCatsReferral().getBoId(), vo.getCatsReferral().getBoVersion());
	...
	public ims.careuk.vo.DischargeSummaryPacuAndWardLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.DischargeSummaryPacuAndWardLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.DischargeSummaryPacuAndWardLiteVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.DischargeSummaryPacuAndWardLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.DischargeSummaryPacuAndWardLiteVo();
