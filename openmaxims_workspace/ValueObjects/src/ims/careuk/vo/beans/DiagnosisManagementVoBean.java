...
public class DiagnosisManagementVoBean extends ims.vo.ValueObjectBean
{
	...
	public DiagnosisManagementVoBean(ims.careuk.vo.DiagnosisManagementVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.DiagnosisManagementVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.catsreferral = vo.getCatsReferral() == null ? null : new ims.vo.RefVoBean(vo.getCatsReferral().getBoId(), vo.getCatsReferral().getBoVersion());
	...
	public ims.careuk.vo.DiagnosisManagementVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.DiagnosisManagementVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.DiagnosisManagementVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.DiagnosisManagementVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.DiagnosisManagementVo();
