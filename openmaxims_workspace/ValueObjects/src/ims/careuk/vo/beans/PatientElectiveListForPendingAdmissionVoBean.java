...
public class PatientElectiveListForPendingAdmissionVoBean extends ims.vo.ValueObjectBean
{
	...
	public PatientElectiveListForPendingAdmissionVoBean(ims.careuk.vo.PatientElectiveListForPendingAdmissionVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.electivelist = vo.getElectiveList() == null ? null : (ims.careuk.vo.beans.ElectiveListConfigurationLiteVoBean)vo.getElectiveList().getBean();
		...
		this.tcidetails = vo.getTCIDetails() == null ? null : (ims.careuk.vo.beans.PatientElectiveTCIBedManagerCommentVoBean)vo.getTCIDetails().getBean();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.PatientElectiveListForPendingAdmissionVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.electivelist = vo.getElectiveList() == null ? null : (ims.careuk.vo.beans.ElectiveListConfigurationLiteVoBean)vo.getElectiveList().getBean(map);
		...
		this.electiveadmissiontype = vo.getElectiveAdmissionType() == null ? null : (ims.vo.LookupInstanceBean)vo.getElectiveAdmissionType().getBean();
		this.intendedmanagement = vo.getIntendedManagement() == null ? null : (ims.vo.LookupInstanceBean)vo.getIntendedManagement().getBean();
		this.tcidetails = vo.getTCIDetails() == null ? null : (ims.careuk.vo.beans.PatientElectiveTCIBedManagerCommentVoBean)vo.getTCIDetails().getBean(map);
	...
	public ims.careuk.vo.PatientElectiveListForPendingAdmissionVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.PatientElectiveListForPendingAdmissionVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.PatientElectiveListForPendingAdmissionVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.PatientElectiveListForPendingAdmissionVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.PatientElectiveListForPendingAdmissionVo();
	...
	public ims.careuk.vo.beans.ElectiveListConfigurationLiteVoBean getElectiveList()
	{
		return this.electivelist;
	}
	public void setElectiveList(ims.careuk.vo.beans.ElectiveListConfigurationLiteVoBean value)
	{
	...
	public ims.careuk.vo.beans.PatientElectiveTCIBedManagerCommentVoBean getTCIDetails()
	{
		return this.tcidetails;
	}
	public void setTCIDetails(ims.careuk.vo.beans.PatientElectiveTCIBedManagerCommentVoBean value)
	{
	...
	private Integer id;
	private int version;
	private ims.careuk.vo.beans.ElectiveListConfigurationLiteVoBean electivelist;
	...
	private ims.careuk.vo.beans.PatientElectiveTCIBedManagerCommentVoBean tcidetails;
