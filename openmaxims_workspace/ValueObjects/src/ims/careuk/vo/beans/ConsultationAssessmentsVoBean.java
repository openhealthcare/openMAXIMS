...
public class ConsultationAssessmentsVoBean extends ims.vo.ValueObjectBean
{
	...
	public ConsultationAssessmentsVoBean(ims.careuk.vo.ConsultationAssessmentsVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.ConsultationAssessmentsVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.catsreferral = vo.getCatsReferral() == null ? null : new ims.vo.RefVoBean(vo.getCatsReferral().getBoId(), vo.getCatsReferral().getBoVersion());
	...
	public ims.careuk.vo.ConsultationAssessmentsVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.ConsultationAssessmentsVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.ConsultationAssessmentsVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.ConsultationAssessmentsVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.ConsultationAssessmentsVo();
