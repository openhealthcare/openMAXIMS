...
public class ReferralERODForBookAppointmentVoBean extends ims.vo.ValueObjectBean
{
	...
	public ReferralERODForBookAppointmentVoBean(ims.careuk.vo.ReferralERODForBookAppointmentVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.ReferralERODForBookAppointmentVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.eroddate1 = vo.getERODDate1() == null ? null : (ims.framework.utils.beans.DateBean)vo.getERODDate1().getBean();
	...
	public ims.careuk.vo.ReferralERODForBookAppointmentVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.ReferralERODForBookAppointmentVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.ReferralERODForBookAppointmentVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.ReferralERODForBookAppointmentVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.ReferralERODForBookAppointmentVo();
