...
public class PrescriptionsVoBean extends ims.vo.ValueObjectBean
{
	...
	public PrescriptionsVoBean(ims.careuk.vo.PrescriptionsVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.PrescriptionsVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.catsreferral = vo.getCatsReferral() == null ? null : new ims.vo.RefVoBean(vo.getCatsReferral().getBoId(), vo.getCatsReferral().getBoVersion());
	...
	public ims.careuk.vo.PrescriptionsVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.PrescriptionsVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.PrescriptionsVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.PrescriptionsVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.PrescriptionsVo();
