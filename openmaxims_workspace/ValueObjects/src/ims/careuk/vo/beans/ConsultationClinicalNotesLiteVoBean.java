...
public class ConsultationClinicalNotesLiteVoBean extends ims.vo.ValueObjectBean
{
	...
	public ConsultationClinicalNotesLiteVoBean(ims.careuk.vo.ConsultationClinicalNotesLiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.ConsultationClinicalNotesLiteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.catsreferral = vo.getCatsReferral() == null ? null : new ims.vo.RefVoBean(vo.getCatsReferral().getBoId(), vo.getCatsReferral().getBoVersion());
	...
	public ims.careuk.vo.ConsultationClinicalNotesLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.ConsultationClinicalNotesLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.ConsultationClinicalNotesLiteVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.ConsultationClinicalNotesLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.ConsultationClinicalNotesLiteVo();
