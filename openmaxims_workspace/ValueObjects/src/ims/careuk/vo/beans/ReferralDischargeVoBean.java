...
public class ReferralDischargeVoBean extends ims.vo.ValueObjectBean
{
	...
	public ReferralDischargeVoBean(ims.careuk.vo.ReferralDischargeVo vo)
	{
		this.id = vo.getBoId();
		...
		this.currentonwardreferral = vo.getCurrentOnwardReferral() == null ? null : (ims.careuk.vo.beans.OnwardReferralVoBean)vo.getCurrentOnwardReferral().getBean();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.ReferralDischargeVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.dischargetype = vo.getDischargeType() == null ? null : (ims.vo.LookupInstanceBean)vo.getDischargeType().getBean();
		...
		this.dischargeothertype = vo.getDischargeOtherType() == null ? null : (ims.vo.LookupInstanceBean)vo.getDischargeOtherType().getBean();
		this.otherdetails = vo.getOtherDetails();
		this.currentonwardreferral = vo.getCurrentOnwardReferral() == null ? null : (ims.careuk.vo.beans.OnwardReferralVoBean)vo.getCurrentOnwardReferral().getBean(map);
		this.onwardreferrals = vo.getOnwardReferrals() == null ? null : vo.getOnwardReferrals().getBeanCollection();
		this.dischargedate = vo.getDischargeDate() == null ? null : (ims.framework.utils.beans.DateBean)vo.getDischargeDate().getBean();
	...
	public ims.careuk.vo.ReferralDischargeVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.ReferralDischargeVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.ReferralDischargeVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.ReferralDischargeVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.ReferralDischargeVo();
	...
	public ims.careuk.vo.beans.OnwardReferralVoBean getCurrentOnwardReferral()
	{
		return this.currentonwardreferral;
	}
	public void setCurrentOnwardReferral(ims.careuk.vo.beans.OnwardReferralVoBean value)
	{
		this.currentonwardreferral = value;
	}
	public ims.careuk.vo.beans.OnwardReferralVoBean[] getOnwardReferrals()
	{
		return this.onwardreferrals;
	}
	public void setOnwardReferrals(ims.careuk.vo.beans.OnwardReferralVoBean[] value)
	{
	...
	private ims.careuk.vo.beans.OnwardReferralVoBean currentonwardreferral;
	private ims.careuk.vo.beans.OnwardReferralVoBean[] onwardreferrals;
