...
public class TltSummaryNoteLiteVoBean extends ims.vo.ValueObjectBean
{
	public TltSummaryNoteLiteVoBean()
	{
	}
	public TltSummaryNoteLiteVoBean(ims.careuk.vo.TltSummaryNoteLiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.TltSummaryNoteLiteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.catsreferral = vo.getCatsReferral() == null ? null : new ims.vo.RefVoBean(vo.getCatsReferral().getBoId(), vo.getCatsReferral().getBoVersion());
	...
	public ims.careuk.vo.TltSummaryNoteLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.TltSummaryNoteLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.TltSummaryNoteLiteVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.TltSummaryNoteLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.TltSummaryNoteLiteVo();
