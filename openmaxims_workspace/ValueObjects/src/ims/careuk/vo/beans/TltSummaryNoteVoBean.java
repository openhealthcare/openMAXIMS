...
public class TltSummaryNoteVoBean extends ims.vo.ValueObjectBean
{
	...
	public TltSummaryNoteVoBean(ims.careuk.vo.TltSummaryNoteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.TltSummaryNoteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.catsreferral = vo.getCatsReferral() == null ? null : new ims.vo.RefVoBean(vo.getCatsReferral().getBoId(), vo.getCatsReferral().getBoVersion());
	...
	public ims.careuk.vo.TltSummaryNoteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.TltSummaryNoteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.TltSummaryNoteVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.TltSummaryNoteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.TltSummaryNoteVo();
