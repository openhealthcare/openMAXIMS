...
public class ElectiveTCIForReferralDetailsVoBean extends ims.vo.ValueObjectBean
{
	...
	public ElectiveTCIForReferralDetailsVoBean(ims.careuk.vo.ElectiveTCIForReferralDetailsVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.ElectiveTCIForReferralDetailsVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.tcidate = vo.getTCIDate() == null ? null : (ims.framework.utils.beans.DateBean)vo.getTCIDate().getBean();
	...
	public ims.careuk.vo.ElectiveTCIForReferralDetailsVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.ElectiveTCIForReferralDetailsVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.ElectiveTCIForReferralDetailsVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.ElectiveTCIForReferralDetailsVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.ElectiveTCIForReferralDetailsVo();
