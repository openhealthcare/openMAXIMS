...
public class ContractConfigKPIHistoryVoBean extends ims.vo.ValueObjectBean
{
	...
	public ContractConfigKPIHistoryVoBean(ims.careuk.vo.ContractConfigKPIHistoryVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.ContractConfigKPIHistoryVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.dateinstantiated = vo.getDateInstantiated() == null ? null : (ims.framework.utils.beans.DateBean)vo.getDateInstantiated().getBean();
	...
	public ims.careuk.vo.ContractConfigKPIHistoryVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.ContractConfigKPIHistoryVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.ContractConfigKPIHistoryVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.ContractConfigKPIHistoryVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.ContractConfigKPIHistoryVo();
