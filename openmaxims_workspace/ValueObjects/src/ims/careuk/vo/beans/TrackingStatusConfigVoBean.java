...
public class TrackingStatusConfigVoBean extends ims.vo.ValueObjectBean
{
	...
	public TrackingStatusConfigVoBean(ims.careuk.vo.TrackingStatusConfigVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.TrackingStatusConfigVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.timeintopacu = vo.getTimeintoPACU() == null ? null : (ims.framework.utils.beans.ColorBean)vo.getTimeintoPACU().getBean();
	...
	public ims.careuk.vo.TrackingStatusConfigVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.TrackingStatusConfigVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.TrackingStatusConfigVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.TrackingStatusConfigVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.TrackingStatusConfigVo();
