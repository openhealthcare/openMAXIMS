...
public class SessionForClinicalNotesVoBean extends ims.vo.ValueObjectBean
{
	...
	public SessionForClinicalNotesVoBean(ims.careuk.vo.SessionForClinicalNotesVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.SessionForClinicalNotesVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.name = vo.getName();
	...
	public ims.careuk.vo.SessionForClinicalNotesVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.SessionForClinicalNotesVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.SessionForClinicalNotesVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.SessionForClinicalNotesVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.SessionForClinicalNotesVo();
