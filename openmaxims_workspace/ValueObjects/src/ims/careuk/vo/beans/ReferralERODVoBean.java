...
public class ReferralERODVoBean extends ims.vo.ValueObjectBean
{
	...
	public ReferralERODVoBean(ims.careuk.vo.ReferralERODVo vo)
	{
		this.id = vo.getBoId();
		...
		this.appointment = vo.getAppointment() == null ? null : (ims.careuk.vo.beans.Booking_AppointmentERODVoBean)vo.getAppointment().getBean();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.ReferralERODVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.eroddate1 = vo.getERODDate1() == null ? null : (ims.framework.utils.beans.DateBean)vo.getERODDate1().getBean();
		...
		this.reasonableoffer = vo.getReasonableOffer();
		this.erodtype = vo.getERODType() == null ? null : (ims.vo.LookupInstanceBean)vo.getERODType().getBean();
		this.appointment = vo.getAppointment() == null ? null : (ims.careuk.vo.beans.Booking_AppointmentERODVoBean)vo.getAppointment().getBean(map);
		this.sequence = vo.getSequence();
		this.isactive = vo.getIsActive();
		this.pathwayclock = vo.getPathWayClock() == null ? null : new ims.vo.RefVoBean(vo.getPathWayClock().getBoId(), vo.getPathWayClock().getBoVersion());
	}

	public ims.careuk.vo.ReferralERODVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.ReferralERODVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.ReferralERODVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.ReferralERODVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.ReferralERODVo();
	...
	public ims.careuk.vo.beans.Booking_AppointmentERODVoBean getAppointment()
	{
		return this.appointment;
	}
	public void setAppointment(ims.careuk.vo.beans.Booking_AppointmentERODVoBean value)
	{
	...
	private ims.careuk.vo.beans.Booking_AppointmentERODVoBean appointment;
