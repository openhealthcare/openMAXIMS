...
public class ReportNotePrintTemplateVoBean extends ims.vo.ValueObjectBean
{
	...
	public ReportNotePrintTemplateVoBean(ims.careuk.vo.ReportNotePrintTemplateVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.ReportNotePrintTemplateVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.notetype = vo.getNoteType() == null ? null : (ims.vo.LookupInstanceBean)vo.getNoteType().getBean();
	...
	public ims.careuk.vo.ReportNotePrintTemplateVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.ReportNotePrintTemplateVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.ReportNotePrintTemplateVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.ReportNotePrintTemplateVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.ReportNotePrintTemplateVo();
