...
public class TransportBookingDisplayVoBean extends ims.vo.ValueObjectBean
{
	...
	public TransportBookingDisplayVoBean(ims.careuk.vo.TransportBookingDisplayVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.TransportBookingDisplayVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.datebooked = vo.getDateBooked() == null ? null : (ims.framework.utils.beans.DateBean)vo.getDateBooked().getBean();
	...
	public ims.careuk.vo.TransportBookingDisplayVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.TransportBookingDisplayVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.TransportBookingDisplayVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.TransportBookingDisplayVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.TransportBookingDisplayVo();
