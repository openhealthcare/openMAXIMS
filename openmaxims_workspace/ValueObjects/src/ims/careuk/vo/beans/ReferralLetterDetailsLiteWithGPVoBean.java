...
public class ReferralLetterDetailsLiteWithGPVoBean extends ims.vo.ValueObjectBean
{
	public ReferralLetterDetailsLiteWithGPVoBean()
	{
	}
	public ReferralLetterDetailsLiteWithGPVoBean(ims.careuk.vo.ReferralLetterDetailsLiteWithGPVo vo)
	{
		this.id = vo.getBoId();
		...
		this.gpname = vo.getGPName() == null ? null : (ims.core.vo.beans.GpLiteWithNameVoBean)vo.getGPName().getBean();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.ReferralLetterDetailsLiteWithGPVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		...
		this.end18ww = vo.getEnd18WW() == null ? null : (ims.framework.utils.beans.DateBean)vo.getEnd18WW().getBean();
		this.consultant = vo.getConsultant() == null ? null : new ims.vo.RefVoBean(vo.getConsultant().getBoId(), vo.getConsultant().getBoVersion());
		this.gpname = vo.getGPName() == null ? null : (ims.core.vo.beans.GpLiteWithNameVoBean)vo.getGPName().getBean(map);
	}

	public ims.careuk.vo.ReferralLetterDetailsLiteWithGPVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.ReferralLetterDetailsLiteWithGPVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.ReferralLetterDetailsLiteWithGPVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.ReferralLetterDetailsLiteWithGPVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.ReferralLetterDetailsLiteWithGPVo();
	...
	public ims.core.vo.beans.GpLiteWithNameVoBean getGPName()
	{
		return this.gpname;
	}
	public void setGPName(ims.core.vo.beans.GpLiteWithNameVoBean value)
	{
		this.gpname = value;
	}
	...
	private ims.core.vo.beans.GpLiteWithNameVoBean gpname;
}
