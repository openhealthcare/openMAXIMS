...
public class CorrespondenceNoteLiteVoBean extends ims.vo.ValueObjectBean
{
	...
	public CorrespondenceNoteLiteVoBean(ims.careuk.vo.CorrespondenceNoteLiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.CorrespondenceNoteLiteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.catsreferral = vo.getCatsReferral() == null ? null : new ims.vo.RefVoBean(vo.getCatsReferral().getBoId(), vo.getCatsReferral().getBoVersion());
	...
	public ims.careuk.vo.CorrespondenceNoteLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.CorrespondenceNoteLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.CorrespondenceNoteLiteVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.CorrespondenceNoteLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.CorrespondenceNoteLiteVo();
