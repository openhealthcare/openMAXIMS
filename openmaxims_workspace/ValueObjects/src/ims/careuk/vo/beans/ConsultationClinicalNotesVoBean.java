...
public class ConsultationClinicalNotesVoBean extends ims.vo.ValueObjectBean
{
	...
	public ConsultationClinicalNotesVoBean(ims.careuk.vo.ConsultationClinicalNotesVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.ConsultationClinicalNotesVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.catsreferral = vo.getCatsReferral() == null ? null : new ims.vo.RefVoBean(vo.getCatsReferral().getBoId(), vo.getCatsReferral().getBoVersion());
	...
	public ims.careuk.vo.ConsultationClinicalNotesVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.ConsultationClinicalNotesVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.ConsultationClinicalNotesVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.ConsultationClinicalNotesVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.ConsultationClinicalNotesVo();
