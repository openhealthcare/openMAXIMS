...
public class OrderInvApptVoBean extends ims.vo.ValueObjectBean
{
	...
	public OrderInvApptVoBean(ims.careuk.vo.OrderInvApptVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.OrderInvApptVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.careuk.vo.OrderInvApptVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.OrderInvApptVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.OrderInvApptVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.OrderInvApptVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.OrderInvApptVo();
