...
public class AtConsultationVoBean extends ims.vo.ValueObjectBean
{
	...
	public AtConsultationVoBean(ims.careuk.vo.AtConsultationVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.AtConsultationVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.catsreferral = vo.getCatsReferral() == null ? null : new ims.vo.RefVoBean(vo.getCatsReferral().getBoId(), vo.getCatsReferral().getBoVersion());
	...
	public ims.careuk.vo.AtConsultationVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.careuk.vo.AtConsultationVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.careuk.vo.AtConsultationVo vo = null;
		if(map != null)
			vo = (ims.careuk.vo.AtConsultationVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.careuk.vo.AtConsultationVo();
