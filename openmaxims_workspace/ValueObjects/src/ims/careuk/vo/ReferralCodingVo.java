...
/**
 * Linked to CAREUK.ReferralCoding business object (ID: 1096100037).
 */
public class ReferralCodingVo extends ims.careuk.vo.ReferralCodingRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ReferralCodingVo(ims.careuk.vo.beans.ReferralCodingVoBean bean)
	{
		this.id = bean.getId();
		...
		this.codingitems = ims.careuk.vo.ReferralCodingItemVoCollection.buildFromBeanCollection(bean.getCodingItems());
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.ReferralCodingVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.catsreferral = bean.getCatsReferral() == null ? null : new ims.careuk.vo.CatsReferralRefVo(new Integer(bean.getCatsReferral().getId()), bean.getCatsReferral().getVersion());
	...
	{
		ims.careuk.vo.beans.ReferralCodingVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.ReferralCodingVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.ReferralCodingVoBean();
	...
	public ims.careuk.vo.ReferralCodingItemVoCollection getCodingItems()
	{
		return this.codingitems;
	}
	public void setCodingItems(ims.careuk.vo.ReferralCodingItemVoCollection value)
	{
		this.isValidated = false;
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.comments != null)
			if(this.comments.length() > 1000)
				listOfErrors.add("The length of the field [comments] in the value object [ims.careuk.vo.ReferralCodingVo] is too big. It should be less or equal to 1000");
	...
	public Object clone()
	{
		...
		if(this.codingitems == null)
			...
			clone.codingitems = (ims.careuk.vo.ReferralCodingItemVoCollection)this.codingitems.clone();
		if(this.authoringmos == null)
	...
	protected ims.careuk.vo.ReferralCodingItemVoCollection codingitems;
