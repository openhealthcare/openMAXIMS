...
public class PatientDiagnosisApptDetailVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<PatientDiagnosisApptDetailVo>
{
	...
	public ims.careuk.vo.beans.PatientDiagnosisApptDetailVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.PatientDiagnosisApptDetailVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.PatientDiagnosisApptDetailVoBean[] result = new ims.careuk.vo.beans.PatientDiagnosisApptDetailVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			PatientDiagnosisApptDetailVo vo = ((PatientDiagnosisApptDetailVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.PatientDiagnosisApptDetailVoBean)vo.getBean();
		}
		return result;
	}
	public static PatientDiagnosisApptDetailVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.PatientDiagnosisApptDetailVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static PatientDiagnosisApptDetailVoCollection buildFromBeanCollection(ims.careuk.vo.beans.PatientDiagnosisApptDetailVoBean[] beans)
	{
		PatientDiagnosisApptDetailVoCollection coll = new PatientDiagnosisApptDetailVoCollection();
		if(beans == null)
			return coll;
