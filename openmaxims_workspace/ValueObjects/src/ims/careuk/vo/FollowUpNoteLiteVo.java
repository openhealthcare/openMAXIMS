 ...
 */
public class FollowUpNoteLiteVo extends ims.careuk.vo.FollowUpNoteRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public FollowUpNoteLiteVo()
	{
	}
	public FollowUpNoteLiteVo(Integer id, int version)
	{
		super(id, version);
	}
	public FollowUpNoteLiteVo(ims.careuk.vo.beans.FollowUpNoteLiteVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.FollowUpNoteLiteVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.catsreferral = bean.getCatsReferral() == null ? null : new ims.careuk.vo.CatsReferralRefVo(new Integer(bean.getCatsReferral().getId()), bean.getCatsReferral().getVersion());
	...
	{
		ims.careuk.vo.beans.FollowUpNoteLiteVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.FollowUpNoteLiteVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.FollowUpNoteLiteVoBean();
	...
	public Object clone()
	{
		...
		FollowUpNoteLiteVo clone = new FollowUpNoteLiteVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(FollowUpNoteLiteVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A FollowUpNoteLiteVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((FollowUpNoteLiteVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((FollowUpNoteLiteVo)obj).getBoId());
	}
