 ...
 */
public class ContractConfigForReferralDetailsComponentVo extends ims.careuk.vo.ContractConfigShortVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ContractConfigForReferralDetailsComponentVo(ims.careuk.vo.beans.ContractConfigForReferralDetailsComponentVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.ContractConfigForReferralDetailsComponentVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.contractid = bean.getContractId();
	...
	{
		ims.careuk.vo.beans.ContractConfigForReferralDetailsComponentVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.ContractConfigForReferralDetailsComponentVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.ContractConfigForReferralDetailsComponentVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.contractid == null || this.contractid.length() == 0)
			...
			listOfErrors.add("The length of the field [contractid] in the value object [ims.careuk.vo.ContractConfigForReferralDetailsComponentVo] is too big. It should be less or equal to 25");
		if(this.contractname == null || this.contractname.length() == 0)
			...
			listOfErrors.add("The length of the field [contractname] in the value object [ims.careuk.vo.ContractConfigForReferralDetailsComponentVo] is too big. It should be less or equal to 255");
		if(this.status == null)
