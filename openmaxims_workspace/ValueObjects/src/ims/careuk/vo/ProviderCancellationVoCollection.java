...
public class ProviderCancellationVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<ProviderCancellationVo>
{
	...
	{
		return "ims.careuk.domain.objects.ProviderCancellation";
	}
	...
	public ims.careuk.vo.ProviderCancellationRefVoCollection toRefVoCollection()
	{
		ims.careuk.vo.ProviderCancellationRefVoCollection result = new ims.careuk.vo.ProviderCancellationRefVoCollection();
		for(int x = 0; x < this.col.size(); x++)
		{
	...
	public ims.careuk.vo.beans.ProviderCancellationVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.ProviderCancellationVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.ProviderCancellationVoBean[] result = new ims.careuk.vo.beans.ProviderCancellationVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			ProviderCancellationVo vo = ((ProviderCancellationVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.ProviderCancellationVoBean)vo.getBean();
		}
		return result;
	}
	public static ProviderCancellationVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.ProviderCancellationVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static ProviderCancellationVoCollection buildFromBeanCollection(ims.careuk.vo.beans.ProviderCancellationVoBean[] beans)
	{
		ProviderCancellationVoCollection coll = new ProviderCancellationVoCollection();
		if(beans == null)
			return coll;
