...
public class CatsReferralERODVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<CatsReferralERODVo>
{
	...
	public ims.careuk.vo.beans.CatsReferralERODVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.CatsReferralERODVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.CatsReferralERODVoBean[] result = new ims.careuk.vo.beans.CatsReferralERODVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			CatsReferralERODVo vo = ((CatsReferralERODVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.CatsReferralERODVoBean)vo.getBean();
		}
		return result;
	}
	public static CatsReferralERODVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.CatsReferralERODVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static CatsReferralERODVoCollection buildFromBeanCollection(ims.careuk.vo.beans.CatsReferralERODVoBean[] beans)
	{
		CatsReferralERODVoCollection coll = new CatsReferralERODVoCollection();
		if(beans == null)
			return coll;
