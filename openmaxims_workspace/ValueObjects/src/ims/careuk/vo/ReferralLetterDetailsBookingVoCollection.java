...
public class ReferralLetterDetailsBookingVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<ReferralLetterDetailsBookingVo>
{
	...
	public ims.careuk.vo.beans.ReferralLetterDetailsBookingVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.ReferralLetterDetailsBookingVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.ReferralLetterDetailsBookingVoBean[] result = new ims.careuk.vo.beans.ReferralLetterDetailsBookingVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			ReferralLetterDetailsBookingVo vo = ((ReferralLetterDetailsBookingVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.ReferralLetterDetailsBookingVoBean)vo.getBean();
		}
		return result;
	}
	public static ReferralLetterDetailsBookingVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.ReferralLetterDetailsBookingVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static ReferralLetterDetailsBookingVoCollection buildFromBeanCollection(ims.careuk.vo.beans.ReferralLetterDetailsBookingVoBean[] beans)
	{
		ReferralLetterDetailsBookingVoCollection coll = new ReferralLetterDetailsBookingVoCollection();
		if(beans == null)
			return coll;
