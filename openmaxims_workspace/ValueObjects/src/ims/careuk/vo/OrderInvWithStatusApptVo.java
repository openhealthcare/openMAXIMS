 ...
 */
public class OrderInvWithStatusApptVo extends ims.careuk.vo.OrderInvApptRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public OrderInvWithStatusApptVo()
	{
	}
	public OrderInvWithStatusApptVo(Integer id, int version)
	{
		super(id, version);
	}
	public OrderInvWithStatusApptVo(ims.careuk.vo.beans.OrderInvWithStatusApptVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.OrderInvWithStatusApptVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.OrderInvWithStatusApptVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.OrderInvWithStatusApptVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.OrderInvWithStatusApptVoBean();
	...
	public ims.ocrr.vo.OrderInvestigationBookingWithStatusVo getOrderInvestigation()
	{
		return this.orderinvestigation;
	}
	public void setOrderInvestigation(ims.ocrr.vo.OrderInvestigationBookingWithStatusVo value)
	{
	...
	public Object clone()
	{
		...
		OrderInvWithStatusApptVo clone = new OrderInvWithStatusApptVo(this.id, this.version);
		
		if(this.orderinvestigation == null)
			clone.orderinvestigation = null;
		else
			clone.orderinvestigation = (ims.ocrr.vo.OrderInvestigationBookingWithStatusVo)this.orderinvestigation.clone();
		if(this.appointment == null)
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(OrderInvWithStatusApptVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A OrderInvWithStatusApptVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((OrderInvWithStatusApptVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((OrderInvWithStatusApptVo)obj).getBoId());
	}
	...
	protected ims.ocrr.vo.OrderInvestigationBookingWithStatusVo orderinvestigation;
