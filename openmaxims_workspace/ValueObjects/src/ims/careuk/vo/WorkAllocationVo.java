...
public class WorkAllocationVo extends ims.core.vo.WorkAllocationListVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public WorkAllocationVo(ims.careuk.vo.beans.WorkAllocationVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.WorkAllocationVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.catsreferral = bean.getCatsReferral() == null ? null : new ims.careuk.vo.CatsReferralRefVo(new Integer(bean.getCatsReferral().getId()), bean.getCatsReferral().getVersion());
	...
	{
		ims.careuk.vo.beans.WorkAllocationVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.WorkAllocationVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.WorkAllocationVoBean();
