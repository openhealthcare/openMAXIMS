...
public class CSPrimaryDiagnosisForClinicalNotesVo extends ims.core.clinical.vo.CsPrimaryDiagnosisRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public CSPrimaryDiagnosisForClinicalNotesVo(ims.careuk.vo.beans.CSPrimaryDiagnosisForClinicalNotesVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.CSPrimaryDiagnosisForClinicalNotesVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.CSPrimaryDiagnosisForClinicalNotesVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.CSPrimaryDiagnosisForClinicalNotesVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.CSPrimaryDiagnosisForClinicalNotesVoBean();
