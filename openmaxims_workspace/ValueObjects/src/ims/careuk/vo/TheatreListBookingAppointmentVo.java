...
public class TheatreListBookingAppointmentVo extends ims.scheduling.vo.Booking_AppointmentRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public TheatreListBookingAppointmentVo(ims.careuk.vo.beans.TheatreListBookingAppointmentVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.TheatreListBookingAppointmentVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.apptstarttime = bean.getApptStartTime() == null ? null : bean.getApptStartTime().buildTime();
	...
	{
		ims.careuk.vo.beans.TheatreListBookingAppointmentVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.TheatreListBookingAppointmentVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.TheatreListBookingAppointmentVoBean();
