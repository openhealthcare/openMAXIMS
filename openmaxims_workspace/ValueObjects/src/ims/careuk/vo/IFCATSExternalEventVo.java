...
public class IFCATSExternalEventVo extends ims.vo.ValueObject implements ims.vo.ImsCloneable, Comparable
{
	...
	public IFCATSExternalEventVo(ims.careuk.vo.beans.IFCATSExternalEventVoBean bean)
	{
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.IFCATSExternalEventVoBean bean)
	{
		this.appointmentid = bean.getAppointmentID();
		this.referralid = bean.getReferralID();
		this.transportarranged = bean.getTransportArranged();
	...
	{
		ims.careuk.vo.beans.IFCATSExternalEventVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.IFCATSExternalEventVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.IFCATSExternalEventVoBean();
