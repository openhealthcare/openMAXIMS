 ...
 */
public class PatientElectiveListLiteVo extends ims.careuk.vo.PatientElectiveListRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public PatientElectiveListLiteVo(ims.careuk.vo.beans.PatientElectiveListLiteVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.PatientElectiveListLiteVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.PatientElectiveListLiteVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.PatientElectiveListLiteVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.PatientElectiveListLiteVoBean();
	...
	public ims.careuk.vo.ElectiveListStatusForBookTheatreVo getElectiveListStatus()
	{
		return this.electiveliststatus;
	}
	public void setElectiveListStatus(ims.careuk.vo.ElectiveListStatusForBookTheatreVo value)
	{
		this.isValidated = false;
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.proceduredescription != null)
			if(this.proceduredescription.length() > 255)
				listOfErrors.add("The length of the field [proceduredescription] in the value object [ims.careuk.vo.PatientElectiveListLiteVo] is too big. It should be less or equal to 255");
	...
	public Object clone()
	{
		...
		if(this.electiveliststatus == null)
			...
			clone.electiveliststatus = (ims.careuk.vo.ElectiveListStatusForBookTheatreVo)this.electiveliststatus.clone();
	...
	protected ims.careuk.vo.ElectiveListStatusForBookTheatreVo electiveliststatus;
