...
public class CSPrimaryDiagnosisForClinicalNotesVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<CSPrimaryDiagnosisForClinicalNotesVo>
{
	...
	public ims.careuk.vo.beans.CSPrimaryDiagnosisForClinicalNotesVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.CSPrimaryDiagnosisForClinicalNotesVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.CSPrimaryDiagnosisForClinicalNotesVoBean[] result = new ims.careuk.vo.beans.CSPrimaryDiagnosisForClinicalNotesVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			CSPrimaryDiagnosisForClinicalNotesVo vo = ((CSPrimaryDiagnosisForClinicalNotesVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.CSPrimaryDiagnosisForClinicalNotesVoBean)vo.getBean();
		}
		return result;
	}
	public static CSPrimaryDiagnosisForClinicalNotesVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.CSPrimaryDiagnosisForClinicalNotesVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static CSPrimaryDiagnosisForClinicalNotesVoCollection buildFromBeanCollection(ims.careuk.vo.beans.CSPrimaryDiagnosisForClinicalNotesVoBean[] beans)
	{
		CSPrimaryDiagnosisForClinicalNotesVoCollection coll = new CSPrimaryDiagnosisForClinicalNotesVoCollection();
		if(beans == null)
			return coll;
