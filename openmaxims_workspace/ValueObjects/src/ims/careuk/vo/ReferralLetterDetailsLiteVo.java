...
public class ReferralLetterDetailsLiteVo extends ims.core.clinical.vo.ReferralLetterDetailsRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ReferralLetterDetailsLiteVo(ims.careuk.vo.beans.ReferralLetterDetailsLiteVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.ReferralLetterDetailsLiteVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.ReferralLetterDetailsLiteVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.ReferralLetterDetailsLiteVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.ReferralLetterDetailsLiteVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.alliedhealthprofname != null)
			if(this.alliedhealthprofname.length() > 150)
				listOfErrors.add("The length of the field [alliedhealthprofname] in the value object [ims.careuk.vo.ReferralLetterDetailsLiteVo] is too big. It should be less or equal to 150");
		...
		if(this.specialrequirements != null)
			if(this.specialrequirements.length() > 255)
				listOfErrors.add("The length of the field [specialrequirements] in the value object [ims.careuk.vo.ReferralLetterDetailsLiteVo] is too big. It should be less or equal to 255");
