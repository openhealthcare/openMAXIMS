...
public class ReferralLetterDetailsLiteWithGPVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.ReferralLetterDetailsLiteWithGPVo copy(ims.careuk.vo.ReferralLetterDetailsLiteWithGPVo valueObjectDest, ims.careuk.vo.ReferralLetterDetailsLiteWithGPVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.ReferralLetterDetailsLiteWithGPVoCollection createReferralLetterDetailsLiteWithGPVoCollectionFromReferralLetterDetails(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.core.clinical.domain.objects.ReferralLetterDetails objects.
	 */
	public static ims.careuk.vo.ReferralLetterDetailsLiteWithGPVoCollection createReferralLetterDetailsLiteWithGPVoCollectionFromReferralLetterDetails(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.ReferralLetterDetailsLiteWithGPVoCollection voList = new ims.careuk.vo.ReferralLetterDetailsLiteWithGPVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.ReferralLetterDetailsLiteWithGPVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.ReferralLetterDetailsLiteWithGPVoCollection createReferralLetterDetailsLiteWithGPVoCollectionFromReferralLetterDetails(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.core.clinical.domain.objects.ReferralLetterDetails objects.
	 */
	public static ims.careuk.vo.ReferralLetterDetailsLiteWithGPVoCollection createReferralLetterDetailsLiteWithGPVoCollectionFromReferralLetterDetails(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.ReferralLetterDetailsLiteWithGPVoCollection voList = new ims.careuk.vo.ReferralLetterDetailsLiteWithGPVoCollection();
	 ...
	 */
	 public static java.util.Set extractReferralLetterDetailsSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralLetterDetailsLiteWithGPVoCollection voCollection) 
	 {
	 	return extractReferralLetterDetailsSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractReferralLetterDetailsSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralLetterDetailsLiteWithGPVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.ReferralLetterDetailsLiteWithGPVo vo = voCollection.get(i);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractReferralLetterDetailsList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralLetterDetailsLiteWithGPVoCollection voCollection) 
	 {
	 	return extractReferralLetterDetailsList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractReferralLetterDetailsList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralLetterDetailsLiteWithGPVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.ReferralLetterDetailsLiteWithGPVo create(ims.core.clinical.domain.objects.ReferralLetterDetails domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.ReferralLetterDetailsLiteWithGPVo create(DomainObjectMap map, ims.core.clinical.domain.objects.ReferralLetterDetails domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.ReferralLetterDetailsLiteWithGPVo valueObject = (ims.careuk.vo.ReferralLetterDetailsLiteWithGPVo) map.getValueObject(domainObject, ims.careuk.vo.ReferralLetterDetailsLiteWithGPVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.ReferralLetterDetailsLiteWithGPVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.ReferralLetterDetails
	 */
	 public static ims.careuk.vo.ReferralLetterDetailsLiteWithGPVo insert(ims.careuk.vo.ReferralLetterDetailsLiteWithGPVo valueObject, ims.core.clinical.domain.objects.ReferralLetterDetails domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.ReferralLetterDetails
	 */
	 public static ims.careuk.vo.ReferralLetterDetailsLiteWithGPVo insert(DomainObjectMap map, ims.careuk.vo.ReferralLetterDetailsLiteWithGPVo valueObject, ims.core.clinical.domain.objects.ReferralLetterDetails domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.clinical.domain.objects.ReferralLetterDetails extractReferralLetterDetails(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralLetterDetailsLiteWithGPVo valueObject) 
	{
		return 	extractReferralLetterDetails(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.clinical.domain.objects.ReferralLetterDetails extractReferralLetterDetails(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralLetterDetailsLiteWithGPVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.ReferralLetterDetailsLiteWithGPVo ID_ReferralLetterDetails field is unknown
