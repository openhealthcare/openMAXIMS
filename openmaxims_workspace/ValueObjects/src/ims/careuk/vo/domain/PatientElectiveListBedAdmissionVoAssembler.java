...
public class PatientElectiveListBedAdmissionVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.PatientElectiveListBedAdmissionVo copy(ims.careuk.vo.PatientElectiveListBedAdmissionVo valueObjectDest, ims.careuk.vo.PatientElectiveListBedAdmissionVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.PatientElectiveListBedAdmissionVoCollection createPatientElectiveListBedAdmissionVoCollectionFromPatientElectiveList(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.PatientElectiveList objects.
	 */
	public static ims.careuk.vo.PatientElectiveListBedAdmissionVoCollection createPatientElectiveListBedAdmissionVoCollectionFromPatientElectiveList(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.PatientElectiveListBedAdmissionVoCollection voList = new ims.careuk.vo.PatientElectiveListBedAdmissionVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.PatientElectiveListBedAdmissionVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.PatientElectiveListBedAdmissionVoCollection createPatientElectiveListBedAdmissionVoCollectionFromPatientElectiveList(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.PatientElectiveList objects.
	 */
	public static ims.careuk.vo.PatientElectiveListBedAdmissionVoCollection createPatientElectiveListBedAdmissionVoCollectionFromPatientElectiveList(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.PatientElectiveListBedAdmissionVoCollection voList = new ims.careuk.vo.PatientElectiveListBedAdmissionVoCollection();
	 ...
	 */
	 public static java.util.Set extractPatientElectiveListSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListBedAdmissionVoCollection voCollection) 
	 {
	 	return extractPatientElectiveListSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientElectiveListSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListBedAdmissionVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.PatientElectiveListBedAdmissionVo vo = voCollection.get(i);
			ims.careuk.domain.objects.PatientElectiveList domainObject = PatientElectiveListBedAdmissionVoAssembler.extractPatientElectiveList(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPatientElectiveListList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListBedAdmissionVoCollection voCollection) 
	 {
	 	return extractPatientElectiveListList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPatientElectiveListList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListBedAdmissionVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.PatientElectiveListBedAdmissionVo create(ims.careuk.domain.objects.PatientElectiveList domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.PatientElectiveListBedAdmissionVo create(DomainObjectMap map, ims.careuk.domain.objects.PatientElectiveList domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.PatientElectiveListBedAdmissionVo valueObject = (ims.careuk.vo.PatientElectiveListBedAdmissionVo) map.getValueObject(domainObject, ims.careuk.vo.PatientElectiveListBedAdmissionVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.PatientElectiveListBedAdmissionVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.careuk.domain.objects.PatientElectiveList
	 */
	 public static ims.careuk.vo.PatientElectiveListBedAdmissionVo insert(ims.careuk.vo.PatientElectiveListBedAdmissionVo valueObject, ims.careuk.domain.objects.PatientElectiveList domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.careuk.domain.objects.PatientElectiveList
	 */
	 public static ims.careuk.vo.PatientElectiveListBedAdmissionVo insert(DomainObjectMap map, ims.careuk.vo.PatientElectiveListBedAdmissionVo valueObject, ims.careuk.domain.objects.PatientElectiveList domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// ElectiveList
		valueObject.setElectiveList(ims.careuk.vo.domain.ElectiveListConfigurationLiteVoAssembler.create(map, domainObject.getElectiveList()) );
		// Ward
		...
		if ( null != instance10 ) {
			...
			valueObject.setElectiveListReason(voLookup10);
				...
				// Referral
		valueObject.setReferral(ims.careuk.vo.domain.CATSReferralWithContextPasVoAssembler.create(map, domainObject.getReferral()) );
		// EROD
	 ...
	 */
	public static ims.careuk.domain.objects.PatientElectiveList extractPatientElectiveList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListBedAdmissionVo valueObject) 
	{
		return 	extractPatientElectiveList(domainFactory, valueObject, new HashMap());
	}

	public static ims.careuk.domain.objects.PatientElectiveList extractPatientElectiveList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListBedAdmissionVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.PatientElectiveListBedAdmissionVo ID_PatientElectiveList field is unknown
	...
	ims.core.patient.domain.objects.Patient value7 = null;
		...
		ims.careuk.vo.ElectiveListStatusRefVoCollection refCollection9 = valueObject.getElectiveListStatusHistory();
		...
		{
			ims.careuk.vo.ElectiveListStatusRefVo vo = refCollection9.get(i);			
		...
		domainObject.setReferral(ims.careuk.vo.domain.CATSReferralWithContextPasVoAssembler.extractCatsReferral(domainFactory, valueObject.getReferral(), domMap));
	// SaveAsRefVO - treated as a refVo in extract methods
	ims.careuk.domain.objects.ReferralEROD value12 = null;
		if ( null != valueObject.getEROD() ) 
		{
			if (valueObject.getEROD().getBoId() == null)
			{
				...
				{
					value12 = (ims.careuk.domain.objects.ReferralEROD)domMap.get(valueObject.getEROD());
				}
			}
			else
			{
				value12 = (ims.careuk.domain.objects.ReferralEROD)domainFactory.getDomainObject(ims.careuk.domain.objects.ReferralEROD.class, valueObject.getEROD().getBoId());
			}
		}
		domainObject.setEROD(value12);

		ims.careuk.vo.ReferralERODRefVoCollection refCollection13 = valueObject.getERODHistory();
		...
		{
			ims.careuk.vo.ReferralERODRefVo vo = refCollection13.get(i);			
