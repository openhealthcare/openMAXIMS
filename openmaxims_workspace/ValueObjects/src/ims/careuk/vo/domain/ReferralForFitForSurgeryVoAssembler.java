...
public class ReferralForFitForSurgeryVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.ReferralForFitForSurgeryVo copy(ims.careuk.vo.ReferralForFitForSurgeryVo valueObjectDest, ims.careuk.vo.ReferralForFitForSurgeryVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.ReferralForFitForSurgeryVoCollection createReferralForFitForSurgeryVoCollectionFromCatsReferral(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.CatsReferral objects.
	 */
	public static ims.careuk.vo.ReferralForFitForSurgeryVoCollection createReferralForFitForSurgeryVoCollectionFromCatsReferral(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.ReferralForFitForSurgeryVoCollection voList = new ims.careuk.vo.ReferralForFitForSurgeryVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.ReferralForFitForSurgeryVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.ReferralForFitForSurgeryVoCollection createReferralForFitForSurgeryVoCollectionFromCatsReferral(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.CatsReferral objects.
	 */
	public static ims.careuk.vo.ReferralForFitForSurgeryVoCollection createReferralForFitForSurgeryVoCollectionFromCatsReferral(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.ReferralForFitForSurgeryVoCollection voList = new ims.careuk.vo.ReferralForFitForSurgeryVoCollection();
	 ...
	 */
	 public static java.util.Set extractCatsReferralSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralForFitForSurgeryVoCollection voCollection) 
	 {
	 	return extractCatsReferralSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractCatsReferralSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralForFitForSurgeryVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.ReferralForFitForSurgeryVo vo = voCollection.get(i);
			ims.careuk.domain.objects.CatsReferral domainObject = ReferralForFitForSurgeryVoAssembler.extractCatsReferral(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractCatsReferralList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralForFitForSurgeryVoCollection voCollection) 
	 {
	 	return extractCatsReferralList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractCatsReferralList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralForFitForSurgeryVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.ReferralForFitForSurgeryVo create(ims.careuk.domain.objects.CatsReferral domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.ReferralForFitForSurgeryVo create(DomainObjectMap map, ims.careuk.domain.objects.CatsReferral domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.ReferralForFitForSurgeryVo valueObject = (ims.careuk.vo.ReferralForFitForSurgeryVo) map.getValueObject(domainObject, ims.careuk.vo.ReferralForFitForSurgeryVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.ReferralForFitForSurgeryVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.careuk.domain.objects.CatsReferral
	 */
	 public static ims.careuk.vo.ReferralForFitForSurgeryVo insert(ims.careuk.vo.ReferralForFitForSurgeryVo valueObject, ims.careuk.domain.objects.CatsReferral domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.careuk.domain.objects.CatsReferral
	 */
	 public static ims.careuk.vo.ReferralForFitForSurgeryVo insert(DomainObjectMap map, ims.careuk.vo.ReferralForFitForSurgeryVo valueObject, ims.careuk.domain.objects.CatsReferral domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.careuk.domain.objects.CatsReferral extractCatsReferral(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralForFitForSurgeryVo valueObject) 
	{
		return 	extractCatsReferral(domainFactory, valueObject, new HashMap());
	}

	public static ims.careuk.domain.objects.CatsReferral extractCatsReferral(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralForFitForSurgeryVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.ReferralForFitForSurgeryVo ID_CatsReferral field is unknown
		...
		// SaveAsRefVO treated as RefValueObject
		ims.careuk.vo.OrderInvApptRefVoCollection refCollection2 = new ims.careuk.vo.OrderInvApptRefVoCollection();
		if (valueObject.getOrderInvAppts() != null)
		{
			for (int i2=0; i2<valueObject.getOrderInvAppts().size(); i2++)
			{
				ims.careuk.vo.OrderInvApptRefVo ref2 = (ims.careuk.vo.OrderInvApptRefVo)valueObject.getOrderInvAppts().get(i2);
		...
		{
			ims.careuk.vo.OrderInvApptRefVo vo = refCollection2.get(i);					
			ims.careuk.domain.objects.OrderInvAppt dom = null;
			if ( null != vo ) 
			{
				if (vo.getBoId() == null)
				{
					if (domMap.get(vo) != null)
					{
						dom = (ims.careuk.domain.objects.OrderInvAppt)domMap.get(vo);
					}
				}
				else
				{
					dom = (ims.careuk.domain.objects.OrderInvAppt)domainFactory.getDomainObject( ims.careuk.domain.objects.OrderInvAppt.class, vo.getBoId());
				}
			}
