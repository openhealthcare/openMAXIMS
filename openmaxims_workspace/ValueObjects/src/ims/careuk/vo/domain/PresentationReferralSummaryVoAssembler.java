...
public class PresentationReferralSummaryVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.PresentationReferralSummaryVo copy(ims.careuk.vo.PresentationReferralSummaryVo valueObjectDest, ims.careuk.vo.PresentationReferralSummaryVo valueObjectSrc) 
	 {
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.PresentationReferralSummary objects.
	 */
	public static ims.careuk.vo.PresentationReferralSummaryVoCollection createPresentationReferralSummaryVoCollectionFromPresentationReferralSummary(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.PresentationReferralSummary objects.
	 */
	public static ims.careuk.vo.PresentationReferralSummaryVoCollection createPresentationReferralSummaryVoCollectionFromPresentationReferralSummary(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.PresentationReferralSummaryVoCollection voList = new ims.careuk.vo.PresentationReferralSummaryVoCollection();
		...
		{
			ims.careuk.domain.objects.PresentationReferralSummary domainObject = (ims.careuk.domain.objects.PresentationReferralSummary) iterator.next();
			ims.careuk.vo.PresentationReferralSummaryVo vo = create(map, domainObject);
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.PresentationReferralSummary objects.
	 */
	public static ims.careuk.vo.PresentationReferralSummaryVoCollection createPresentationReferralSummaryVoCollectionFromPresentationReferralSummary(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.PresentationReferralSummary objects.
	 */
	public static ims.careuk.vo.PresentationReferralSummaryVoCollection createPresentationReferralSummaryVoCollectionFromPresentationReferralSummary(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.PresentationReferralSummaryVoCollection voList = new ims.careuk.vo.PresentationReferralSummaryVoCollection();
		...
		{
			ims.careuk.domain.objects.PresentationReferralSummary domainObject = (ims.careuk.domain.objects.PresentationReferralSummary) domainObjectList.get(i);
			ims.careuk.vo.PresentationReferralSummaryVo vo = create(map, domainObject);
	...
	/**
	 * Create the ims.careuk.domain.objects.PresentationReferralSummary set from the value object collection.
	 * @param domainFactory - used to create existing (persistent) domain objects.
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.Set extractPresentationReferralSummarySet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PresentationReferralSummaryVoCollection voCollection) 
	 {
	 	return extractPresentationReferralSummarySet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPresentationReferralSummarySet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PresentationReferralSummaryVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.PresentationReferralSummaryVo vo = voCollection.get(i);
			ims.careuk.domain.objects.PresentationReferralSummary domainObject = PresentationReferralSummaryVoAssembler.extractPresentationReferralSummary(domainFactory, vo, domMap);
	...
	/**
	 * Create the ims.careuk.domain.objects.PresentationReferralSummary list from the value object collection.
	 * @param domainFactory - used to create existing (persistent) domain objects.
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPresentationReferralSummaryList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PresentationReferralSummaryVoCollection voCollection) 
	 {
	 	return extractPresentationReferralSummaryList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPresentationReferralSummaryList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PresentationReferralSummaryVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	...
	/**
	 * Create the ValueObject from the ims.careuk.domain.objects.PresentationReferralSummary object.
	 * @param domainObject ims.careuk.domain.objects.PresentationReferralSummary
	 */
	 public static ims.careuk.vo.PresentationReferralSummaryVo create(ims.careuk.domain.objects.PresentationReferralSummary domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.PresentationReferralSummaryVo create(DomainObjectMap map, ims.careuk.domain.objects.PresentationReferralSummary domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.PresentationReferralSummaryVo valueObject = (ims.careuk.vo.PresentationReferralSummaryVo) map.getValueObject(domainObject, ims.careuk.vo.PresentationReferralSummaryVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.PresentationReferralSummaryVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.careuk.domain.objects.PresentationReferralSummary
	 */
	 public static ims.careuk.vo.PresentationReferralSummaryVo insert(ims.careuk.vo.PresentationReferralSummaryVo valueObject, ims.careuk.domain.objects.PresentationReferralSummary domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.careuk.domain.objects.PresentationReferralSummary
	 */
	 public static ims.careuk.vo.PresentationReferralSummaryVo insert(DomainObjectMap map, ims.careuk.vo.PresentationReferralSummaryVo valueObject, ims.careuk.domain.objects.PresentationReferralSummary domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.careuk.domain.objects.PresentationReferralSummary extractPresentationReferralSummary(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PresentationReferralSummaryVo valueObject) 
	{
		return 	extractPresentationReferralSummary(domainFactory, valueObject, new HashMap());
	}

	public static ims.careuk.domain.objects.PresentationReferralSummary extractPresentationReferralSummary(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PresentationReferralSummaryVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		ims.careuk.domain.objects.PresentationReferralSummary domainObject = null;
		if ( null == id) 
		{
			if (domMap.get(valueObject) != null)
			{
				return (ims.careuk.domain.objects.PresentationReferralSummary)domMap.get(valueObject);
			}
			// ims.careuk.vo.PresentationReferralSummaryVo ID_PresentationReferralSummary field is unknown
			domainObject = new ims.careuk.domain.objects.PresentationReferralSummary();
		...
		else 
		{
			...
			{
				return (ims.careuk.domain.objects.PresentationReferralSummary)domMap.get(key);
			}
			domainObject = (ims.careuk.domain.objects.PresentationReferralSummary) domainFactory.getDomainObject(ims.careuk.domain.objects.PresentationReferralSummary.class, id );
