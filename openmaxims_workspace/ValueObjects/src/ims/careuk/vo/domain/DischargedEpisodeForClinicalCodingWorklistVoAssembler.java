...
public class DischargedEpisodeForClinicalCodingWorklistVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.DischargedEpisodeForClinicalCodingWorklistVo copy(ims.careuk.vo.DischargedEpisodeForClinicalCodingWorklistVo valueObjectDest, ims.careuk.vo.DischargedEpisodeForClinicalCodingWorklistVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.DischargedEpisodeForClinicalCodingWorklistVoCollection createDischargedEpisodeForClinicalCodingWorklistVoCollectionFromDischargedEpisode(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.core.admin.pas.domain.objects.DischargedEpisode objects.
	 */
	public static ims.careuk.vo.DischargedEpisodeForClinicalCodingWorklistVoCollection createDischargedEpisodeForClinicalCodingWorklistVoCollectionFromDischargedEpisode(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.DischargedEpisodeForClinicalCodingWorklistVoCollection voList = new ims.careuk.vo.DischargedEpisodeForClinicalCodingWorklistVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.DischargedEpisodeForClinicalCodingWorklistVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.DischargedEpisodeForClinicalCodingWorklistVoCollection createDischargedEpisodeForClinicalCodingWorklistVoCollectionFromDischargedEpisode(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.core.admin.pas.domain.objects.DischargedEpisode objects.
	 */
	public static ims.careuk.vo.DischargedEpisodeForClinicalCodingWorklistVoCollection createDischargedEpisodeForClinicalCodingWorklistVoCollectionFromDischargedEpisode(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.DischargedEpisodeForClinicalCodingWorklistVoCollection voList = new ims.careuk.vo.DischargedEpisodeForClinicalCodingWorklistVoCollection();
	 ...
	 */
	 public static java.util.Set extractDischargedEpisodeSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.DischargedEpisodeForClinicalCodingWorklistVoCollection voCollection) 
	 {
	 	return extractDischargedEpisodeSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractDischargedEpisodeSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.DischargedEpisodeForClinicalCodingWorklistVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.DischargedEpisodeForClinicalCodingWorklistVo vo = voCollection.get(i);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractDischargedEpisodeList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.DischargedEpisodeForClinicalCodingWorklistVoCollection voCollection) 
	 {
	 	return extractDischargedEpisodeList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractDischargedEpisodeList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.DischargedEpisodeForClinicalCodingWorklistVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.DischargedEpisodeForClinicalCodingWorklistVo create(ims.core.admin.pas.domain.objects.DischargedEpisode domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.DischargedEpisodeForClinicalCodingWorklistVo create(DomainObjectMap map, ims.core.admin.pas.domain.objects.DischargedEpisode domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.DischargedEpisodeForClinicalCodingWorklistVo valueObject = (ims.careuk.vo.DischargedEpisodeForClinicalCodingWorklistVo) map.getValueObject(domainObject, ims.careuk.vo.DischargedEpisodeForClinicalCodingWorklistVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.DischargedEpisodeForClinicalCodingWorklistVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.admin.pas.domain.objects.DischargedEpisode
	 */
	 public static ims.careuk.vo.DischargedEpisodeForClinicalCodingWorklistVo insert(ims.careuk.vo.DischargedEpisodeForClinicalCodingWorklistVo valueObject, ims.core.admin.pas.domain.objects.DischargedEpisode domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.admin.pas.domain.objects.DischargedEpisode
	 */
	 public static ims.careuk.vo.DischargedEpisodeForClinicalCodingWorklistVo insert(DomainObjectMap map, ims.careuk.vo.DischargedEpisodeForClinicalCodingWorklistVo valueObject, ims.core.admin.pas.domain.objects.DischargedEpisode domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// pasEvent
		valueObject.setPasEvent(ims.careuk.vo.domain.PasEventForClinicalCodingWorklistVoAssembler.create(map, domainObject.getPasEvent()) );
		// dischargeDateTime
	 ...
	 */
	public static ims.core.admin.pas.domain.objects.DischargedEpisode extractDischargedEpisode(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.DischargedEpisodeForClinicalCodingWorklistVo valueObject) 
	{
		return 	extractDischargedEpisode(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.admin.pas.domain.objects.DischargedEpisode extractDischargedEpisode(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.DischargedEpisodeForClinicalCodingWorklistVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.DischargedEpisodeForClinicalCodingWorklistVo ID_DischargedEpisode field is unknown
