...
public class ContractConfigVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.ContractConfigVo copy(ims.careuk.vo.ContractConfigVo valueObjectDest, ims.careuk.vo.ContractConfigVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.ContractConfigVoCollection createContractConfigVoCollectionFromContractConfig(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.core.configuration.domain.objects.ContractConfig objects.
	 */
	public static ims.careuk.vo.ContractConfigVoCollection createContractConfigVoCollectionFromContractConfig(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.ContractConfigVoCollection voList = new ims.careuk.vo.ContractConfigVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.ContractConfigVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.ContractConfigVoCollection createContractConfigVoCollectionFromContractConfig(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.core.configuration.domain.objects.ContractConfig objects.
	 */
	public static ims.careuk.vo.ContractConfigVoCollection createContractConfigVoCollectionFromContractConfig(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.ContractConfigVoCollection voList = new ims.careuk.vo.ContractConfigVoCollection();
	 ...
	 */
	 public static java.util.Set extractContractConfigSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ContractConfigVoCollection voCollection) 
	 {
	 	return extractContractConfigSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractContractConfigSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ContractConfigVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.ContractConfigVo vo = voCollection.get(i);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractContractConfigList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ContractConfigVoCollection voCollection) 
	 {
	 	return extractContractConfigList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractContractConfigList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ContractConfigVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.ContractConfigVo create(ims.core.configuration.domain.objects.ContractConfig domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.ContractConfigVo create(DomainObjectMap map, ims.core.configuration.domain.objects.ContractConfig domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.ContractConfigVo valueObject = (ims.careuk.vo.ContractConfigVo) map.getValueObject(domainObject, ims.careuk.vo.ContractConfigVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.ContractConfigVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.configuration.domain.objects.ContractConfig
	 */
	 public static ims.careuk.vo.ContractConfigVo insert(ims.careuk.vo.ContractConfigVo valueObject, ims.core.configuration.domain.objects.ContractConfig domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.configuration.domain.objects.ContractConfig
	 */
	 public static ims.careuk.vo.ContractConfigVo insert(DomainObjectMap map, ims.careuk.vo.ContractConfigVo valueObject, ims.core.configuration.domain.objects.ContractConfig domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// ContractKPIHistory
		valueObject.setContractKPIHistory(ims.careuk.vo.domain.ContractConfigKPIHistoryVoAssembler.createContractConfigKPIHistoryVoCollectionFromContractConfigKPIHistory(map, domainObject.getContractKPIHistory()) );
		// ServiceLocations
		valueObject.setServiceLocations(ims.careuk.vo.domain.ContractServiceLocationsConfigVoAssembler.createContractServiceLocationsConfigVoCollectionFromContractServiceLocationsConfig(map, domainObject.getServiceLocations()) );
		// CCGsForContract
		valueObject.setCCGsForContract(ims.careuk.vo.domain.CCGToContractConfigVoAssembler.createCCGToContractConfigVoCollectionFromCCGToContractConfig(map, domainObject.getCCGsForContract()) );
		// ContractOrganisation
	 ...
	 */
	public static ims.core.configuration.domain.objects.ContractConfig extractContractConfig(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ContractConfigVo valueObject) 
	{
		return 	extractContractConfig(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.configuration.domain.objects.ContractConfig extractContractConfig(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ContractConfigVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.ContractConfigVo ID_ContractConfig field is unknown
		...
		domainObject.setContractKPIHistory(ims.careuk.vo.domain.ContractConfigKPIHistoryVoAssembler.extractContractConfigKPIHistoryList(domainFactory, valueObject.getContractKPIHistory(), domainObject.getContractKPIHistory(), domMap));		
		domainObject.setServiceLocations(ims.careuk.vo.domain.ContractServiceLocationsConfigVoAssembler.extractContractServiceLocationsConfigList(domainFactory, valueObject.getServiceLocations(), domainObject.getServiceLocations(), domMap));		
		domainObject.setCCGsForContract(ims.careuk.vo.domain.CCGToContractConfigVoAssembler.extractCCGToContractConfigList(domainFactory, valueObject.getCCGsForContract(), domainObject.getCCGsForContract(), domMap));		
