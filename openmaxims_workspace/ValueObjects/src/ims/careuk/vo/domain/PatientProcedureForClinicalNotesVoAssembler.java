...
public class PatientProcedureForClinicalNotesVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.PatientProcedureForClinicalNotesVo copy(ims.careuk.vo.PatientProcedureForClinicalNotesVo valueObjectDest, ims.careuk.vo.PatientProcedureForClinicalNotesVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.PatientProcedureForClinicalNotesVoCollection createPatientProcedureForClinicalNotesVoCollectionFromPatientProcedure(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.core.clinical.domain.objects.PatientProcedure objects.
	 */
	public static ims.careuk.vo.PatientProcedureForClinicalNotesVoCollection createPatientProcedureForClinicalNotesVoCollectionFromPatientProcedure(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.PatientProcedureForClinicalNotesVoCollection voList = new ims.careuk.vo.PatientProcedureForClinicalNotesVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.PatientProcedureForClinicalNotesVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.PatientProcedureForClinicalNotesVoCollection createPatientProcedureForClinicalNotesVoCollectionFromPatientProcedure(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.core.clinical.domain.objects.PatientProcedure objects.
	 */
	public static ims.careuk.vo.PatientProcedureForClinicalNotesVoCollection createPatientProcedureForClinicalNotesVoCollectionFromPatientProcedure(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.PatientProcedureForClinicalNotesVoCollection voList = new ims.careuk.vo.PatientProcedureForClinicalNotesVoCollection();
	 ...
	 */
	 public static java.util.Set extractPatientProcedureSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientProcedureForClinicalNotesVoCollection voCollection) 
	 {
	 	return extractPatientProcedureSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientProcedureSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientProcedureForClinicalNotesVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.PatientProcedureForClinicalNotesVo vo = voCollection.get(i);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPatientProcedureList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientProcedureForClinicalNotesVoCollection voCollection) 
	 {
	 	return extractPatientProcedureList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPatientProcedureList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientProcedureForClinicalNotesVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.PatientProcedureForClinicalNotesVo create(ims.core.clinical.domain.objects.PatientProcedure domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.PatientProcedureForClinicalNotesVo create(DomainObjectMap map, ims.core.clinical.domain.objects.PatientProcedure domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.PatientProcedureForClinicalNotesVo valueObject = (ims.careuk.vo.PatientProcedureForClinicalNotesVo) map.getValueObject(domainObject, ims.careuk.vo.PatientProcedureForClinicalNotesVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.PatientProcedureForClinicalNotesVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.PatientProcedure
	 */
	 public static ims.careuk.vo.PatientProcedureForClinicalNotesVo insert(ims.careuk.vo.PatientProcedureForClinicalNotesVo valueObject, ims.core.clinical.domain.objects.PatientProcedure domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.PatientProcedure
	 */
	 public static ims.careuk.vo.PatientProcedureForClinicalNotesVo insert(DomainObjectMap map, ims.careuk.vo.PatientProcedureForClinicalNotesVo valueObject, ims.core.clinical.domain.objects.PatientProcedure domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.clinical.domain.objects.PatientProcedure extractPatientProcedure(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientProcedureForClinicalNotesVo valueObject) 
	{
		return 	extractPatientProcedure(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.clinical.domain.objects.PatientProcedure extractPatientProcedure(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientProcedureForClinicalNotesVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.PatientProcedureForClinicalNotesVo ID_PatientProcedure field is unknown
