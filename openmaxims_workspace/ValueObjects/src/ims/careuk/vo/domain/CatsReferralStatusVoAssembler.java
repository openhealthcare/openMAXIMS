...
public class CatsReferralStatusVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.CatsReferralStatusVo copy(ims.careuk.vo.CatsReferralStatusVo valueObjectDest, ims.careuk.vo.CatsReferralStatusVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.CatsReferralStatusVoCollection createCatsReferralStatusVoCollectionFromCATSReferralStatus(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.CATSReferralStatus objects.
	 */
	public static ims.careuk.vo.CatsReferralStatusVoCollection createCatsReferralStatusVoCollectionFromCATSReferralStatus(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.CatsReferralStatusVoCollection voList = new ims.careuk.vo.CatsReferralStatusVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.CatsReferralStatusVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.CatsReferralStatusVoCollection createCatsReferralStatusVoCollectionFromCATSReferralStatus(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.CATSReferralStatus objects.
	 */
	public static ims.careuk.vo.CatsReferralStatusVoCollection createCatsReferralStatusVoCollectionFromCATSReferralStatus(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.CatsReferralStatusVoCollection voList = new ims.careuk.vo.CatsReferralStatusVoCollection();
	 ...
	 */
	 public static java.util.Set extractCATSReferralStatusSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.CatsReferralStatusVoCollection voCollection) 
	 {
	 	return extractCATSReferralStatusSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractCATSReferralStatusSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.CatsReferralStatusVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.CatsReferralStatusVo vo = voCollection.get(i);
			ims.careuk.domain.objects.CATSReferralStatus domainObject = CatsReferralStatusVoAssembler.extractCATSReferralStatus(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractCATSReferralStatusList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.CatsReferralStatusVoCollection voCollection) 
	 {
	 	return extractCATSReferralStatusList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractCATSReferralStatusList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.CatsReferralStatusVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.CatsReferralStatusVo create(ims.careuk.domain.objects.CATSReferralStatus domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.CatsReferralStatusVo create(DomainObjectMap map, ims.careuk.domain.objects.CATSReferralStatus domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.CatsReferralStatusVo valueObject = (ims.careuk.vo.CatsReferralStatusVo) map.getValueObject(domainObject, ims.careuk.vo.CatsReferralStatusVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.CatsReferralStatusVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.careuk.domain.objects.CATSReferralStatus
	 */
	 public static ims.careuk.vo.CatsReferralStatusVo insert(ims.careuk.vo.CatsReferralStatusVo valueObject, ims.careuk.domain.objects.CATSReferralStatus domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.careuk.domain.objects.CATSReferralStatus
	 */
	 public static ims.careuk.vo.CatsReferralStatusVo insert(DomainObjectMap map, ims.careuk.vo.CatsReferralStatusVo valueObject, ims.careuk.domain.objects.CATSReferralStatus domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		if ( null != instance4 ) {
			...
			ims.careuk.vo.lookups.SecondOpinionCategory voLookup4 = new ims.careuk.vo.lookups.SecondOpinionCategory(instance4.getId(),instance4.getText(), instance4.isActive(), null, img, color);
			ims.careuk.vo.lookups.SecondOpinionCategory parentVoLookup4 = voLookup4;
			...
			while (parent4 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup4.setParent(new ims.careuk.vo.lookups.SecondOpinionCategory(parent4.getId(),parent4.getText(), parent4.isActive(), null, img, color));
		...
		if ( null != instance5 ) {
			...
			ims.careuk.vo.lookups.ReferralApptStatus voLookup5 = new ims.careuk.vo.lookups.ReferralApptStatus(instance5.getId(),instance5.getText(), instance5.isActive(), null, img, color);
			ims.careuk.vo.lookups.ReferralApptStatus parentVoLookup5 = voLookup5;
			...
			while (parent5 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup5.setParent(new ims.careuk.vo.lookups.ReferralApptStatus(parent5.getId(),parent5.getText(), parent5.isActive(), null, img, color));
	 ...
	 */
	public static ims.careuk.domain.objects.CATSReferralStatus extractCATSReferralStatus(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.CatsReferralStatusVo valueObject) 
	{
		return 	extractCATSReferralStatus(domainFactory, valueObject, new HashMap());
	}

	public static ims.careuk.domain.objects.CATSReferralStatus extractCATSReferralStatus(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.CatsReferralStatusVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.CatsReferralStatusVo ID_CATSReferralStatus field is unknown
