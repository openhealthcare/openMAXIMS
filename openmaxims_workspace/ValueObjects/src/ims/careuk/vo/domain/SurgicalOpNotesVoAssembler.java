...
public class SurgicalOpNotesVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.SurgicalOpNotesVo copy(ims.careuk.vo.SurgicalOpNotesVo valueObjectDest, ims.careuk.vo.SurgicalOpNotesVo valueObjectSrc) 
	 {
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.SurgicalOpNotes objects.
	 */
	public static ims.careuk.vo.SurgicalOpNotesVoCollection createSurgicalOpNotesVoCollectionFromSurgicalOpNotes(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.SurgicalOpNotes objects.
	 */
	public static ims.careuk.vo.SurgicalOpNotesVoCollection createSurgicalOpNotesVoCollectionFromSurgicalOpNotes(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.SurgicalOpNotesVoCollection voList = new ims.careuk.vo.SurgicalOpNotesVoCollection();
		...
		{
			ims.careuk.domain.objects.SurgicalOpNotes domainObject = (ims.careuk.domain.objects.SurgicalOpNotes) iterator.next();
			ims.careuk.vo.SurgicalOpNotesVo vo = create(map, domainObject);
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.SurgicalOpNotes objects.
	 */
	public static ims.careuk.vo.SurgicalOpNotesVoCollection createSurgicalOpNotesVoCollectionFromSurgicalOpNotes(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.SurgicalOpNotes objects.
	 */
	public static ims.careuk.vo.SurgicalOpNotesVoCollection createSurgicalOpNotesVoCollectionFromSurgicalOpNotes(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.SurgicalOpNotesVoCollection voList = new ims.careuk.vo.SurgicalOpNotesVoCollection();
		...
		{
			ims.careuk.domain.objects.SurgicalOpNotes domainObject = (ims.careuk.domain.objects.SurgicalOpNotes) domainObjectList.get(i);
			ims.careuk.vo.SurgicalOpNotesVo vo = create(map, domainObject);
	...
	/**
	 * Create the ims.careuk.domain.objects.SurgicalOpNotes set from the value object collection.
	 * @param domainFactory - used to create existing (persistent) domain objects.
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.Set extractSurgicalOpNotesSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.SurgicalOpNotesVoCollection voCollection) 
	 {
	 	return extractSurgicalOpNotesSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractSurgicalOpNotesSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.SurgicalOpNotesVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.SurgicalOpNotesVo vo = voCollection.get(i);
			ims.careuk.domain.objects.SurgicalOpNotes domainObject = SurgicalOpNotesVoAssembler.extractSurgicalOpNotes(domainFactory, vo, domMap);
	...
	/**
	 * Create the ims.careuk.domain.objects.SurgicalOpNotes list from the value object collection.
	 * @param domainFactory - used to create existing (persistent) domain objects.
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractSurgicalOpNotesList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.SurgicalOpNotesVoCollection voCollection) 
	 {
	 	return extractSurgicalOpNotesList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractSurgicalOpNotesList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.SurgicalOpNotesVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	...
	/**
	 * Create the ValueObject from the ims.careuk.domain.objects.SurgicalOpNotes object.
	 * @param domainObject ims.careuk.domain.objects.SurgicalOpNotes
	 */
	 public static ims.careuk.vo.SurgicalOpNotesVo create(ims.careuk.domain.objects.SurgicalOpNotes domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.SurgicalOpNotesVo create(DomainObjectMap map, ims.careuk.domain.objects.SurgicalOpNotes domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.SurgicalOpNotesVo valueObject = (ims.careuk.vo.SurgicalOpNotesVo) map.getValueObject(domainObject, ims.careuk.vo.SurgicalOpNotesVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.SurgicalOpNotesVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.careuk.domain.objects.SurgicalOpNotes
	 */
	 public static ims.careuk.vo.SurgicalOpNotesVo insert(ims.careuk.vo.SurgicalOpNotesVo valueObject, ims.careuk.domain.objects.SurgicalOpNotes domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.careuk.domain.objects.SurgicalOpNotes
	 */
	 public static ims.careuk.vo.SurgicalOpNotesVo insert(DomainObjectMap map, ims.careuk.vo.SurgicalOpNotesVo valueObject, ims.careuk.domain.objects.SurgicalOpNotes domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		if ( null != instance15 ) {
			...
			ims.careuk.vo.lookups.SurgicalOpFollowUpType voLookup15 = new ims.careuk.vo.lookups.SurgicalOpFollowUpType(instance15.getId(),instance15.getText(), instance15.isActive(), null, img, color);
			ims.careuk.vo.lookups.SurgicalOpFollowUpType parentVoLookup15 = voLookup15;
			...
			while (parent15 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup15.setParent(new ims.careuk.vo.lookups.SurgicalOpFollowUpType(parent15.getId(),parent15.getText(), parent15.isActive(), null, img, color));
		...
		if ( null != instance16 ) {
			...
			ims.careuk.vo.lookups.SurgicalOpFollowUpIn voLookup16 = new ims.careuk.vo.lookups.SurgicalOpFollowUpIn(instance16.getId(),instance16.getText(), instance16.isActive(), null, img, color);
			ims.careuk.vo.lookups.SurgicalOpFollowUpIn parentVoLookup16 = voLookup16;
			...
			while (parent16 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup16.setParent(new ims.careuk.vo.lookups.SurgicalOpFollowUpIn(parent16.getId(),parent16.getText(), parent16.isActive(), null, img, color));
	 ...
	 */
	public static ims.careuk.domain.objects.SurgicalOpNotes extractSurgicalOpNotes(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.SurgicalOpNotesVo valueObject) 
	{
		return 	extractSurgicalOpNotes(domainFactory, valueObject, new HashMap());
	}

	public static ims.careuk.domain.objects.SurgicalOpNotes extractSurgicalOpNotes(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.SurgicalOpNotesVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		ims.careuk.domain.objects.SurgicalOpNotes domainObject = null;
		if ( null == id) 
		{
			if (domMap.get(valueObject) != null)
			{
				return (ims.careuk.domain.objects.SurgicalOpNotes)domMap.get(valueObject);
			}
			// ims.careuk.vo.SurgicalOpNotesVo ID_SurgicalOpNotes field is unknown
			domainObject = new ims.careuk.domain.objects.SurgicalOpNotes();
		...
		else 
		{
			...
			{
				return (ims.careuk.domain.objects.SurgicalOpNotes)domMap.get(key);
			}
			domainObject = (ims.careuk.domain.objects.SurgicalOpNotes) domainFactory.getDomainObject(ims.careuk.domain.objects.SurgicalOpNotes.class, id );
