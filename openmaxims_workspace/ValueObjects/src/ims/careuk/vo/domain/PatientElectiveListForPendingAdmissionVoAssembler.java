...
public class PatientElectiveListForPendingAdmissionVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.PatientElectiveListForPendingAdmissionVo copy(ims.careuk.vo.PatientElectiveListForPendingAdmissionVo valueObjectDest, ims.careuk.vo.PatientElectiveListForPendingAdmissionVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.PatientElectiveListForPendingAdmissionVoCollection createPatientElectiveListForPendingAdmissionVoCollectionFromPatientElectiveList(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.PatientElectiveList objects.
	 */
	public static ims.careuk.vo.PatientElectiveListForPendingAdmissionVoCollection createPatientElectiveListForPendingAdmissionVoCollectionFromPatientElectiveList(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.PatientElectiveListForPendingAdmissionVoCollection voList = new ims.careuk.vo.PatientElectiveListForPendingAdmissionVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.PatientElectiveListForPendingAdmissionVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.PatientElectiveListForPendingAdmissionVoCollection createPatientElectiveListForPendingAdmissionVoCollectionFromPatientElectiveList(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.PatientElectiveList objects.
	 */
	public static ims.careuk.vo.PatientElectiveListForPendingAdmissionVoCollection createPatientElectiveListForPendingAdmissionVoCollectionFromPatientElectiveList(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.PatientElectiveListForPendingAdmissionVoCollection voList = new ims.careuk.vo.PatientElectiveListForPendingAdmissionVoCollection();
	 ...
	 */
	 public static java.util.Set extractPatientElectiveListSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListForPendingAdmissionVoCollection voCollection) 
	 {
	 	return extractPatientElectiveListSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientElectiveListSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListForPendingAdmissionVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.PatientElectiveListForPendingAdmissionVo vo = voCollection.get(i);
			ims.careuk.domain.objects.PatientElectiveList domainObject = PatientElectiveListForPendingAdmissionVoAssembler.extractPatientElectiveList(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPatientElectiveListList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListForPendingAdmissionVoCollection voCollection) 
	 {
	 	return extractPatientElectiveListList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPatientElectiveListList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListForPendingAdmissionVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.PatientElectiveListForPendingAdmissionVo create(ims.careuk.domain.objects.PatientElectiveList domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.PatientElectiveListForPendingAdmissionVo create(DomainObjectMap map, ims.careuk.domain.objects.PatientElectiveList domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.PatientElectiveListForPendingAdmissionVo valueObject = (ims.careuk.vo.PatientElectiveListForPendingAdmissionVo) map.getValueObject(domainObject, ims.careuk.vo.PatientElectiveListForPendingAdmissionVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.PatientElectiveListForPendingAdmissionVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.careuk.domain.objects.PatientElectiveList
	 */
	 public static ims.careuk.vo.PatientElectiveListForPendingAdmissionVo insert(ims.careuk.vo.PatientElectiveListForPendingAdmissionVo valueObject, ims.careuk.domain.objects.PatientElectiveList domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.careuk.domain.objects.PatientElectiveList
	 */
	 public static ims.careuk.vo.PatientElectiveListForPendingAdmissionVo insert(DomainObjectMap map, ims.careuk.vo.PatientElectiveListForPendingAdmissionVo valueObject, ims.careuk.domain.objects.PatientElectiveList domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		if ( null != instance6 ) {
			...
			valueObject.setIntendedManagement(voLookup6);
				...
				// TCIDetails
		valueObject.setTCIDetails(ims.careuk.vo.domain.PatientElectiveTCIBedManagerCommentVoAssembler.create(map, domainObject.getTCIDetails()) );
		// PrimaryProcedure
	 ...
	 */
	public static ims.careuk.domain.objects.PatientElectiveList extractPatientElectiveList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListForPendingAdmissionVo valueObject) 
	{
		return 	extractPatientElectiveList(domainFactory, valueObject, new HashMap());
	}

	public static ims.careuk.domain.objects.PatientElectiveList extractPatientElectiveList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListForPendingAdmissionVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.PatientElectiveListForPendingAdmissionVo ID_PatientElectiveList field is unknown
	...
	// SaveAsRefVO - treated as a refVo in extract methods
	ims.careuk.domain.objects.TCIForPatientElectiveList value7 = null;
		if ( null != valueObject.getTCIDetails() ) 
		{
			if (valueObject.getTCIDetails().getBoId() == null)
			{
				...
				{
					value7 = (ims.careuk.domain.objects.TCIForPatientElectiveList)domMap.get(valueObject.getTCIDetails());
				}
			}
			else
			{
				value7 = (ims.careuk.domain.objects.TCIForPatientElectiveList)domainFactory.getDomainObject(ims.careuk.domain.objects.TCIForPatientElectiveList.class, valueObject.getTCIDetails().getBoId());
			}
		}
