...
public class CSPrimaryDiagnosisForClinicalNotesVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.CSPrimaryDiagnosisForClinicalNotesVo copy(ims.careuk.vo.CSPrimaryDiagnosisForClinicalNotesVo valueObjectDest, ims.careuk.vo.CSPrimaryDiagnosisForClinicalNotesVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.CSPrimaryDiagnosisForClinicalNotesVoCollection createCSPrimaryDiagnosisForClinicalNotesVoCollectionFromCsPrimaryDiagnosis(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.core.clinical.domain.objects.CsPrimaryDiagnosis objects.
	 */
	public static ims.careuk.vo.CSPrimaryDiagnosisForClinicalNotesVoCollection createCSPrimaryDiagnosisForClinicalNotesVoCollectionFromCsPrimaryDiagnosis(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.CSPrimaryDiagnosisForClinicalNotesVoCollection voList = new ims.careuk.vo.CSPrimaryDiagnosisForClinicalNotesVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.CSPrimaryDiagnosisForClinicalNotesVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.CSPrimaryDiagnosisForClinicalNotesVoCollection createCSPrimaryDiagnosisForClinicalNotesVoCollectionFromCsPrimaryDiagnosis(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.core.clinical.domain.objects.CsPrimaryDiagnosis objects.
	 */
	public static ims.careuk.vo.CSPrimaryDiagnosisForClinicalNotesVoCollection createCSPrimaryDiagnosisForClinicalNotesVoCollectionFromCsPrimaryDiagnosis(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.CSPrimaryDiagnosisForClinicalNotesVoCollection voList = new ims.careuk.vo.CSPrimaryDiagnosisForClinicalNotesVoCollection();
	 ...
	 */
	 public static java.util.Set extractCsPrimaryDiagnosisSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.CSPrimaryDiagnosisForClinicalNotesVoCollection voCollection) 
	 {
	 	return extractCsPrimaryDiagnosisSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractCsPrimaryDiagnosisSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.CSPrimaryDiagnosisForClinicalNotesVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.CSPrimaryDiagnosisForClinicalNotesVo vo = voCollection.get(i);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractCsPrimaryDiagnosisList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.CSPrimaryDiagnosisForClinicalNotesVoCollection voCollection) 
	 {
	 	return extractCsPrimaryDiagnosisList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractCsPrimaryDiagnosisList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.CSPrimaryDiagnosisForClinicalNotesVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.CSPrimaryDiagnosisForClinicalNotesVo create(ims.core.clinical.domain.objects.CsPrimaryDiagnosis domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.CSPrimaryDiagnosisForClinicalNotesVo create(DomainObjectMap map, ims.core.clinical.domain.objects.CsPrimaryDiagnosis domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.CSPrimaryDiagnosisForClinicalNotesVo valueObject = (ims.careuk.vo.CSPrimaryDiagnosisForClinicalNotesVo) map.getValueObject(domainObject, ims.careuk.vo.CSPrimaryDiagnosisForClinicalNotesVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.CSPrimaryDiagnosisForClinicalNotesVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.CsPrimaryDiagnosis
	 */
	 public static ims.careuk.vo.CSPrimaryDiagnosisForClinicalNotesVo insert(ims.careuk.vo.CSPrimaryDiagnosisForClinicalNotesVo valueObject, ims.core.clinical.domain.objects.CsPrimaryDiagnosis domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.CsPrimaryDiagnosis
	 */
	 public static ims.careuk.vo.CSPrimaryDiagnosisForClinicalNotesVo insert(DomainObjectMap map, ims.careuk.vo.CSPrimaryDiagnosisForClinicalNotesVo valueObject, ims.core.clinical.domain.objects.CsPrimaryDiagnosis domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.clinical.domain.objects.CsPrimaryDiagnosis extractCsPrimaryDiagnosis(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.CSPrimaryDiagnosisForClinicalNotesVo valueObject) 
	{
		return 	extractCsPrimaryDiagnosis(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.clinical.domain.objects.CsPrimaryDiagnosis extractCsPrimaryDiagnosis(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.CSPrimaryDiagnosisForClinicalNotesVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.CSPrimaryDiagnosisForClinicalNotesVo ID_CsPrimaryDiagnosis field is unknown
