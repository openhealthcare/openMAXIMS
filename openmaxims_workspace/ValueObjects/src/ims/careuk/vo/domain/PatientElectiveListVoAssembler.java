...
public class PatientElectiveListVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.PatientElectiveListVo copy(ims.careuk.vo.PatientElectiveListVo valueObjectDest, ims.careuk.vo.PatientElectiveListVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.PatientElectiveListVoCollection createPatientElectiveListVoCollectionFromPatientElectiveList(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.PatientElectiveList objects.
	 */
	public static ims.careuk.vo.PatientElectiveListVoCollection createPatientElectiveListVoCollectionFromPatientElectiveList(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.PatientElectiveListVoCollection voList = new ims.careuk.vo.PatientElectiveListVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.PatientElectiveListVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.PatientElectiveListVoCollection createPatientElectiveListVoCollectionFromPatientElectiveList(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.PatientElectiveList objects.
	 */
	public static ims.careuk.vo.PatientElectiveListVoCollection createPatientElectiveListVoCollectionFromPatientElectiveList(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.PatientElectiveListVoCollection voList = new ims.careuk.vo.PatientElectiveListVoCollection();
	 ...
	 */
	 public static java.util.Set extractPatientElectiveListSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListVoCollection voCollection) 
	 {
	 	return extractPatientElectiveListSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientElectiveListSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.PatientElectiveListVo vo = voCollection.get(i);
			ims.careuk.domain.objects.PatientElectiveList domainObject = PatientElectiveListVoAssembler.extractPatientElectiveList(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPatientElectiveListList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListVoCollection voCollection) 
	 {
	 	return extractPatientElectiveListList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPatientElectiveListList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.PatientElectiveListVo create(ims.careuk.domain.objects.PatientElectiveList domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.PatientElectiveListVo create(DomainObjectMap map, ims.careuk.domain.objects.PatientElectiveList domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.PatientElectiveListVo valueObject = (ims.careuk.vo.PatientElectiveListVo) map.getValueObject(domainObject, ims.careuk.vo.PatientElectiveListVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.PatientElectiveListVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.careuk.domain.objects.PatientElectiveList
	 */
	 public static ims.careuk.vo.PatientElectiveListVo insert(ims.careuk.vo.PatientElectiveListVo valueObject, ims.careuk.domain.objects.PatientElectiveList domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.careuk.domain.objects.PatientElectiveList
	 */
	 public static ims.careuk.vo.PatientElectiveListVo insert(DomainObjectMap map, ims.careuk.vo.PatientElectiveListVo valueObject, ims.careuk.domain.objects.PatientElectiveList domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		if ( null != instance12 ) {
			...
			ims.careuk.vo.lookups.ReferralUrgency voLookup12 = new ims.careuk.vo.lookups.ReferralUrgency(instance12.getId(),instance12.getText(), instance12.isActive(), null, img, color);
			ims.careuk.vo.lookups.ReferralUrgency parentVoLookup12 = voLookup12;
			...
			while (parent12 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup12.setParent(new ims.careuk.vo.lookups.ReferralUrgency(parent12.getId(),parent12.getText(), parent12.isActive(), null, img, color));
			...
			valueObject.setPriority(voLookup12);
				...
				// Suspensions
		valueObject.setSuspensions(ims.careuk.vo.domain.SuspensionDetailsForPatientElectiveListVoAssembler.createSuspensionDetailsForPatientElectiveListVoCollectionFromSuspensionDetailsForPatientElectiveList(map, domainObject.getSuspensions()) );
		// OperativeProcedureStatus
		...
		// TCIHistory
		valueObject.setTCIHistory(ims.careuk.vo.domain.PatientElectiveListElectiveTCIVoAssembler.createPatientElectiveListElectiveTCIVoCollectionFromTCIForPatientElectiveList(map, domainObject.getTCIHistory()) );
		// InterpretatorRequired
		...
		if ( null != instance21 ) {
			...
			ims.careuk.vo.lookups.ElectiveAdmissionType voLookup21 = new ims.careuk.vo.lookups.ElectiveAdmissionType(instance21.getId(),instance21.getText(), instance21.isActive(), null, img, color);
			ims.careuk.vo.lookups.ElectiveAdmissionType parentVoLookup21 = voLookup21;
			...
			while (parent21 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup21.setParent(new ims.careuk.vo.lookups.ElectiveAdmissionType(parent21.getId(),parent21.getText(), parent21.isActive(), null, img, color));
		...
		// TCIDetails
		valueObject.setTCIDetails(ims.careuk.vo.domain.PatientElectiveListElectiveTCIVoAssembler.create(map, domainObject.getTCIDetails()) );
		// ElectiveListStatusHistory
		...
		if ( null != instance33 ) {
			...
			ims.careuk.vo.lookups.CatsReferralCategory voLookup33 = new ims.careuk.vo.lookups.CatsReferralCategory(instance33.getId(),instance33.getText(), instance33.isActive(), null, img, color);
			ims.careuk.vo.lookups.CatsReferralCategory parentVoLookup33 = voLookup33;
			...
			while (parent33 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup33.setParent(new ims.careuk.vo.lookups.CatsReferralCategory(parent33.getId(),parent33.getText(), parent33.isActive(), null, img, color));
	 ...
	 */
	public static ims.careuk.domain.objects.PatientElectiveList extractPatientElectiveList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListVo valueObject) 
	{
		return 	extractPatientElectiveList(domainFactory, valueObject, new HashMap());
	}

	public static ims.careuk.domain.objects.PatientElectiveList extractPatientElectiveList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.PatientElectiveListVo ID_PatientElectiveList field is unknown
	...
	ims.core.configuration.domain.objects.ElectiveListConfiguration value1 = null;
		...
		ims.careuk.domain.objects.CatsReferral value4 = null;
		if ( null != valueObject.getReferral() ) 
		{
			if (valueObject.getReferral().getBoId() == null)
			{
				...
				{
					value4 = (ims.careuk.domain.objects.CatsReferral)domMap.get(valueObject.getReferral());
				}
			}
			else if (valueObject.getBoVersion() == -1) // RefVo was not modified since obtained from the Assembler, no need to update the BO field
			{
			...
			{
				value4 = (ims.careuk.domain.objects.CatsReferral)domainFactory.getDomainObject(ims.careuk.domain.objects.CatsReferral.class, valueObject.getReferral().getBoId());
			}
		}
	...
	ims.core.resource.people.domain.objects.Hcp value7 = null;
		...
		domainObject.setSuspensions(ims.careuk.vo.domain.SuspensionDetailsForPatientElectiveListVoAssembler.extractSuspensionDetailsForPatientElectiveListList(domainFactory, valueObject.getSuspensions(), domainObject.getSuspensions(), domMap));		
	...
	ims.core.clinical.domain.objects.Procedure value15 = null;
		...
		domainObject.setTCIHistory(ims.careuk.vo.domain.PatientElectiveListElectiveTCIVoAssembler.extractTCIForPatientElectiveListList(domainFactory, valueObject.getTCIHistory(), domainObject.getTCIHistory(), domMap));		
		...
		ims.careuk.domain.objects.ReferralEROD value22 = null;
		if ( null != valueObject.getEROD() ) 
		{
			if (valueObject.getEROD().getBoId() == null)
			{
				...
				{
					value22 = (ims.careuk.domain.objects.ReferralEROD)domMap.get(valueObject.getEROD());
				}
			}
			else if (valueObject.getBoVersion() == -1) // RefVo was not modified since obtained from the Assembler, no need to update the BO field
			{
			...
			{
				value22 = (ims.careuk.domain.objects.ReferralEROD)domainFactory.getDomainObject(ims.careuk.domain.objects.ReferralEROD.class, valueObject.getEROD().getBoId());
			}
		}
		domainObject.setEROD(value22);
		domainObject.setTCIDetails(ims.careuk.vo.domain.PatientElectiveListElectiveTCIVoAssembler.extractTCIForPatientElectiveList(domainFactory, valueObject.getTCIDetails(), domMap));
		...
		ims.careuk.vo.ReferralERODRefVoCollection refCollection27 = valueObject.getERODHistory();
		...
		{
			ims.careuk.vo.ReferralERODRefVo vo = refCollection27.get(i);			
