...
public class BaselineObservationsVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.BaselineObservationsVo copy(ims.careuk.vo.BaselineObservationsVo valueObjectDest, ims.careuk.vo.BaselineObservationsVo valueObjectSrc) 
	 {
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.NursingNotes objects.
	 */
	public static ims.careuk.vo.BaselineObservationsVoCollection createBaselineObservationsVoCollectionFromNursingNotes(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.NursingNotes objects.
	 */
	public static ims.careuk.vo.BaselineObservationsVoCollection createBaselineObservationsVoCollectionFromNursingNotes(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.BaselineObservationsVoCollection voList = new ims.careuk.vo.BaselineObservationsVoCollection();
		...
		{
			ims.careuk.domain.objects.NursingNotes domainObject = (ims.careuk.domain.objects.NursingNotes) iterator.next();
			ims.careuk.vo.BaselineObservationsVo vo = create(map, domainObject);
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.NursingNotes objects.
	 */
	public static ims.careuk.vo.BaselineObservationsVoCollection createBaselineObservationsVoCollectionFromNursingNotes(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.NursingNotes objects.
	 */
	public static ims.careuk.vo.BaselineObservationsVoCollection createBaselineObservationsVoCollectionFromNursingNotes(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.BaselineObservationsVoCollection voList = new ims.careuk.vo.BaselineObservationsVoCollection();
		...
		{
			ims.careuk.domain.objects.NursingNotes domainObject = (ims.careuk.domain.objects.NursingNotes) domainObjectList.get(i);
			ims.careuk.vo.BaselineObservationsVo vo = create(map, domainObject);
	...
	/**
	 * Create the ims.careuk.domain.objects.NursingNotes set from the value object collection.
	 * @param domainFactory - used to create existing (persistent) domain objects.
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.Set extractNursingNotesSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.BaselineObservationsVoCollection voCollection) 
	 {
	 	return extractNursingNotesSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractNursingNotesSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.BaselineObservationsVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.BaselineObservationsVo vo = voCollection.get(i);
			ims.careuk.domain.objects.NursingNotes domainObject = BaselineObservationsVoAssembler.extractNursingNotes(domainFactory, vo, domMap);
	...
	/**
	 * Create the ims.careuk.domain.objects.NursingNotes list from the value object collection.
	 * @param domainFactory - used to create existing (persistent) domain objects.
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractNursingNotesList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.BaselineObservationsVoCollection voCollection) 
	 {
	 	return extractNursingNotesList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractNursingNotesList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.BaselineObservationsVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	...
	/**
	 * Create the ValueObject from the ims.careuk.domain.objects.NursingNotes object.
	 * @param domainObject ims.careuk.domain.objects.NursingNotes
	 */
	 public static ims.careuk.vo.BaselineObservationsVo create(ims.careuk.domain.objects.NursingNotes domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.BaselineObservationsVo create(DomainObjectMap map, ims.careuk.domain.objects.NursingNotes domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.BaselineObservationsVo valueObject = (ims.careuk.vo.BaselineObservationsVo) map.getValueObject(domainObject, ims.careuk.vo.BaselineObservationsVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.BaselineObservationsVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.careuk.domain.objects.NursingNotes
	 */
	 public static ims.careuk.vo.BaselineObservationsVo insert(ims.careuk.vo.BaselineObservationsVo valueObject, ims.careuk.domain.objects.NursingNotes domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.careuk.domain.objects.NursingNotes
	 */
	 public static ims.careuk.vo.BaselineObservationsVo insert(DomainObjectMap map, ims.careuk.vo.BaselineObservationsVo valueObject, ims.careuk.domain.objects.NursingNotes domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.careuk.domain.objects.NursingNotes extractNursingNotes(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.BaselineObservationsVo valueObject) 
	{
		return 	extractNursingNotes(domainFactory, valueObject, new HashMap());
	}

	public static ims.careuk.domain.objects.NursingNotes extractNursingNotes(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.BaselineObservationsVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		ims.careuk.domain.objects.NursingNotes domainObject = null;
		if ( null == id) 
		{
			if (domMap.get(valueObject) != null)
			{
				return (ims.careuk.domain.objects.NursingNotes)domMap.get(valueObject);
			}
			// ims.careuk.vo.BaselineObservationsVo ID_NursingNotes field is unknown
			domainObject = new ims.careuk.domain.objects.NursingNotes();
		...
		else 
		{
			...
			{
				return (ims.careuk.domain.objects.NursingNotes)domMap.get(key);
			}
			domainObject = (ims.careuk.domain.objects.NursingNotes) domainFactory.getDomainObject(ims.careuk.domain.objects.NursingNotes.class, id );
