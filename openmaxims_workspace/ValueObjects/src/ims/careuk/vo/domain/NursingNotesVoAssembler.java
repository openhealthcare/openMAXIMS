...
public class NursingNotesVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.NursingNotesVo copy(ims.careuk.vo.NursingNotesVo valueObjectDest, ims.careuk.vo.NursingNotesVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.NursingNotesVoCollection createNursingNotesVoCollectionFromNursingNotes(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.NursingNotes objects.
	 */
	public static ims.careuk.vo.NursingNotesVoCollection createNursingNotesVoCollectionFromNursingNotes(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.NursingNotesVoCollection voList = new ims.careuk.vo.NursingNotesVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.NursingNotesVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.NursingNotesVoCollection createNursingNotesVoCollectionFromNursingNotes(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.NursingNotes objects.
	 */
	public static ims.careuk.vo.NursingNotesVoCollection createNursingNotesVoCollectionFromNursingNotes(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.NursingNotesVoCollection voList = new ims.careuk.vo.NursingNotesVoCollection();
	 ...
	 */
	 public static java.util.Set extractNursingNotesSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.NursingNotesVoCollection voCollection) 
	 {
	 	return extractNursingNotesSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractNursingNotesSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.NursingNotesVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.NursingNotesVo vo = voCollection.get(i);
			ims.careuk.domain.objects.NursingNotes domainObject = NursingNotesVoAssembler.extractNursingNotes(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractNursingNotesList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.NursingNotesVoCollection voCollection) 
	 {
	 	return extractNursingNotesList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractNursingNotesList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.NursingNotesVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.NursingNotesVo create(ims.careuk.domain.objects.NursingNotes domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.NursingNotesVo create(DomainObjectMap map, ims.careuk.domain.objects.NursingNotes domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.NursingNotesVo valueObject = (ims.careuk.vo.NursingNotesVo) map.getValueObject(domainObject, ims.careuk.vo.NursingNotesVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.NursingNotesVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.careuk.domain.objects.NursingNotes
	 */
	 public static ims.careuk.vo.NursingNotesVo insert(ims.careuk.vo.NursingNotesVo valueObject, ims.careuk.domain.objects.NursingNotes domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.careuk.domain.objects.NursingNotes
	 */
	 public static ims.careuk.vo.NursingNotesVo insert(DomainObjectMap map, ims.careuk.vo.NursingNotesVo valueObject, ims.careuk.domain.objects.NursingNotes domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.careuk.domain.objects.NursingNotes extractNursingNotes(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.NursingNotesVo valueObject) 
	{
		return 	extractNursingNotes(domainFactory, valueObject, new HashMap());
	}

	public static ims.careuk.domain.objects.NursingNotes extractNursingNotes(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.NursingNotesVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.NursingNotesVo ID_NursingNotes field is unknown
