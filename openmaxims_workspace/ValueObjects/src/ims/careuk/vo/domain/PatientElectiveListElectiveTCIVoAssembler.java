...
public class PatientElectiveListElectiveTCIVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.PatientElectiveListElectiveTCIVo copy(ims.careuk.vo.PatientElectiveListElectiveTCIVo valueObjectDest, ims.careuk.vo.PatientElectiveListElectiveTCIVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.PatientElectiveListElectiveTCIVoCollection createPatientElectiveListElectiveTCIVoCollectionFromTCIForPatientElectiveList(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.TCIForPatientElectiveList objects.
	 */
	public static ims.careuk.vo.PatientElectiveListElectiveTCIVoCollection createPatientElectiveListElectiveTCIVoCollectionFromTCIForPatientElectiveList(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.PatientElectiveListElectiveTCIVoCollection voList = new ims.careuk.vo.PatientElectiveListElectiveTCIVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.PatientElectiveListElectiveTCIVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.PatientElectiveListElectiveTCIVoCollection createPatientElectiveListElectiveTCIVoCollectionFromTCIForPatientElectiveList(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.TCIForPatientElectiveList objects.
	 */
	public static ims.careuk.vo.PatientElectiveListElectiveTCIVoCollection createPatientElectiveListElectiveTCIVoCollectionFromTCIForPatientElectiveList(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.PatientElectiveListElectiveTCIVoCollection voList = new ims.careuk.vo.PatientElectiveListElectiveTCIVoCollection();
	 ...
	 */
	 public static java.util.Set extractTCIForPatientElectiveListSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListElectiveTCIVoCollection voCollection) 
	 {
	 	return extractTCIForPatientElectiveListSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractTCIForPatientElectiveListSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListElectiveTCIVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.PatientElectiveListElectiveTCIVo vo = voCollection.get(i);
			ims.careuk.domain.objects.TCIForPatientElectiveList domainObject = PatientElectiveListElectiveTCIVoAssembler.extractTCIForPatientElectiveList(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractTCIForPatientElectiveListList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListElectiveTCIVoCollection voCollection) 
	 {
	 	return extractTCIForPatientElectiveListList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractTCIForPatientElectiveListList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListElectiveTCIVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.PatientElectiveListElectiveTCIVo create(ims.careuk.domain.objects.TCIForPatientElectiveList domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.PatientElectiveListElectiveTCIVo create(DomainObjectMap map, ims.careuk.domain.objects.TCIForPatientElectiveList domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.PatientElectiveListElectiveTCIVo valueObject = (ims.careuk.vo.PatientElectiveListElectiveTCIVo) map.getValueObject(domainObject, ims.careuk.vo.PatientElectiveListElectiveTCIVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.PatientElectiveListElectiveTCIVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.careuk.domain.objects.TCIForPatientElectiveList
	 */
	 public static ims.careuk.vo.PatientElectiveListElectiveTCIVo insert(ims.careuk.vo.PatientElectiveListElectiveTCIVo valueObject, ims.careuk.domain.objects.TCIForPatientElectiveList domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.careuk.domain.objects.TCIForPatientElectiveList
	 */
	 public static ims.careuk.vo.PatientElectiveListElectiveTCIVo insert(DomainObjectMap map, ims.careuk.vo.PatientElectiveListElectiveTCIVo valueObject, ims.careuk.domain.objects.TCIForPatientElectiveList domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		if ( null != instance9 ) {
			...
			ims.careuk.vo.lookups.PlanningElective voLookup9 = new ims.careuk.vo.lookups.PlanningElective(instance9.getId(),instance9.getText(), instance9.isActive(), null, img, color);
			ims.careuk.vo.lookups.PlanningElective parentVoLookup9 = voLookup9;
			...
			while (parent9 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup9.setParent(new ims.careuk.vo.lookups.PlanningElective(parent9.getId(),parent9.getText(), parent9.isActive(), null, img, color));
		...
		// OutcomeHistory
		valueObject.setOutcomeHistory(ims.careuk.vo.domain.TCIOutcomeForPatientElectiveListVoAssembler.createTCIOutcomeForPatientElectiveListVoCollectionFromTCIOutcomeForPatientElectiveList(map, domainObject.getOutcomeHistory()) );
		// IsActive
		...
		if ( null != instance16 ) {
			...
			ims.careuk.vo.lookups.KPIExceededReason voLookup16 = new ims.careuk.vo.lookups.KPIExceededReason(instance16.getId(),instance16.getText(), instance16.isActive(), null, img, color);
			ims.careuk.vo.lookups.KPIExceededReason parentVoLookup16 = voLookup16;
			...
			while (parent16 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup16.setParent(new ims.careuk.vo.lookups.KPIExceededReason(parent16.getId(),parent16.getText(), parent16.isActive(), null, img, color));
	 ...
	 */
	public static ims.careuk.domain.objects.TCIForPatientElectiveList extractTCIForPatientElectiveList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListElectiveTCIVo valueObject) 
	{
		return 	extractTCIForPatientElectiveList(domainFactory, valueObject, new HashMap());
	}

	public static ims.careuk.domain.objects.TCIForPatientElectiveList extractTCIForPatientElectiveList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListElectiveTCIVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.PatientElectiveListElectiveTCIVo ID_TCIForPatientElectiveList field is unknown
	...
	ims.scheduling.domain.objects.Booking_Appointment value6 = null;
		...
		domainObject.setOutcomeHistory(ims.careuk.vo.domain.TCIOutcomeForPatientElectiveListVoAssembler.extractTCIOutcomeForPatientElectiveListList(domainFactory, valueObject.getOutcomeHistory(), domainObject.getOutcomeHistory(), domMap));		
