...
public class DiagnosisManagementVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.DiagnosisManagementVo copy(ims.careuk.vo.DiagnosisManagementVo valueObjectDest, ims.careuk.vo.DiagnosisManagementVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.DiagnosisManagementVoCollection createDiagnosisManagementVoCollectionFromDiagnosisManagement(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.DiagnosisManagement objects.
	 */
	public static ims.careuk.vo.DiagnosisManagementVoCollection createDiagnosisManagementVoCollectionFromDiagnosisManagement(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.DiagnosisManagementVoCollection voList = new ims.careuk.vo.DiagnosisManagementVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.DiagnosisManagementVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.DiagnosisManagementVoCollection createDiagnosisManagementVoCollectionFromDiagnosisManagement(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.DiagnosisManagement objects.
	 */
	public static ims.careuk.vo.DiagnosisManagementVoCollection createDiagnosisManagementVoCollectionFromDiagnosisManagement(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.DiagnosisManagementVoCollection voList = new ims.careuk.vo.DiagnosisManagementVoCollection();
	 ...
	 */
	 public static java.util.Set extractDiagnosisManagementSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.DiagnosisManagementVoCollection voCollection) 
	 {
	 	return extractDiagnosisManagementSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractDiagnosisManagementSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.DiagnosisManagementVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.DiagnosisManagementVo vo = voCollection.get(i);
			ims.careuk.domain.objects.DiagnosisManagement domainObject = DiagnosisManagementVoAssembler.extractDiagnosisManagement(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractDiagnosisManagementList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.DiagnosisManagementVoCollection voCollection) 
	 {
	 	return extractDiagnosisManagementList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractDiagnosisManagementList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.DiagnosisManagementVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.DiagnosisManagementVo create(ims.careuk.domain.objects.DiagnosisManagement domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.DiagnosisManagementVo create(DomainObjectMap map, ims.careuk.domain.objects.DiagnosisManagement domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.DiagnosisManagementVo valueObject = (ims.careuk.vo.DiagnosisManagementVo) map.getValueObject(domainObject, ims.careuk.vo.DiagnosisManagementVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.DiagnosisManagementVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.careuk.domain.objects.DiagnosisManagement
	 */
	 public static ims.careuk.vo.DiagnosisManagementVo insert(ims.careuk.vo.DiagnosisManagementVo valueObject, ims.careuk.domain.objects.DiagnosisManagement domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.careuk.domain.objects.DiagnosisManagement
	 */
	 public static ims.careuk.vo.DiagnosisManagementVo insert(DomainObjectMap map, ims.careuk.vo.DiagnosisManagementVo valueObject, ims.careuk.domain.objects.DiagnosisManagement domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.careuk.domain.objects.DiagnosisManagement extractDiagnosisManagement(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.DiagnosisManagementVo valueObject) 
	{
		return 	extractDiagnosisManagement(domainFactory, valueObject, new HashMap());
	}

	public static ims.careuk.domain.objects.DiagnosisManagement extractDiagnosisManagement(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.DiagnosisManagementVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.DiagnosisManagementVo ID_DiagnosisManagement field is unknown
		...
		ims.careuk.domain.objects.CatsReferral value10 = null;
		if ( null != valueObject.getCatsReferral() ) 
		{
			if (valueObject.getCatsReferral().getBoId() == null)
			{
				...
				{
					value10 = (ims.careuk.domain.objects.CatsReferral)domMap.get(valueObject.getCatsReferral());
				}
			}
			...
			{
				value10 = (ims.careuk.domain.objects.CatsReferral)domainFactory.getDomainObject(ims.careuk.domain.objects.CatsReferral.class, valueObject.getCatsReferral().getBoId());
			}
		}
