...
public class PatientProcedureApptDetailVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.PatientProcedureApptDetailVo copy(ims.careuk.vo.PatientProcedureApptDetailVo valueObjectDest, ims.careuk.vo.PatientProcedureApptDetailVo valueObjectSrc) 
	 {
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.PatientProcedureApptDetail objects.
	 */
	public static ims.careuk.vo.PatientProcedureApptDetailVoCollection createPatientProcedureApptDetailVoCollectionFromPatientProcedureApptDetail(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.PatientProcedureApptDetail objects.
	 */
	public static ims.careuk.vo.PatientProcedureApptDetailVoCollection createPatientProcedureApptDetailVoCollectionFromPatientProcedureApptDetail(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.PatientProcedureApptDetailVoCollection voList = new ims.careuk.vo.PatientProcedureApptDetailVoCollection();
		...
		{
			ims.careuk.domain.objects.PatientProcedureApptDetail domainObject = (ims.careuk.domain.objects.PatientProcedureApptDetail) iterator.next();
			ims.careuk.vo.PatientProcedureApptDetailVo vo = create(map, domainObject);
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.PatientProcedureApptDetail objects.
	 */
	public static ims.careuk.vo.PatientProcedureApptDetailVoCollection createPatientProcedureApptDetailVoCollectionFromPatientProcedureApptDetail(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.PatientProcedureApptDetail objects.
	 */
	public static ims.careuk.vo.PatientProcedureApptDetailVoCollection createPatientProcedureApptDetailVoCollectionFromPatientProcedureApptDetail(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.PatientProcedureApptDetailVoCollection voList = new ims.careuk.vo.PatientProcedureApptDetailVoCollection();
		...
		{
			ims.careuk.domain.objects.PatientProcedureApptDetail domainObject = (ims.careuk.domain.objects.PatientProcedureApptDetail) domainObjectList.get(i);
			ims.careuk.vo.PatientProcedureApptDetailVo vo = create(map, domainObject);
	...
	/**
	 * Create the ims.careuk.domain.objects.PatientProcedureApptDetail set from the value object collection.
	 * @param domainFactory - used to create existing (persistent) domain objects.
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.Set extractPatientProcedureApptDetailSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientProcedureApptDetailVoCollection voCollection) 
	 {
	 	return extractPatientProcedureApptDetailSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientProcedureApptDetailSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientProcedureApptDetailVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.PatientProcedureApptDetailVo vo = voCollection.get(i);
			ims.careuk.domain.objects.PatientProcedureApptDetail domainObject = PatientProcedureApptDetailVoAssembler.extractPatientProcedureApptDetail(domainFactory, vo, domMap);
	...
	/**
	 * Create the ims.careuk.domain.objects.PatientProcedureApptDetail list from the value object collection.
	 * @param domainFactory - used to create existing (persistent) domain objects.
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPatientProcedureApptDetailList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientProcedureApptDetailVoCollection voCollection) 
	 {
	 	return extractPatientProcedureApptDetailList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPatientProcedureApptDetailList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientProcedureApptDetailVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	...
	/**
	 * Create the ValueObject from the ims.careuk.domain.objects.PatientProcedureApptDetail object.
	 * @param domainObject ims.careuk.domain.objects.PatientProcedureApptDetail
	 */
	 public static ims.careuk.vo.PatientProcedureApptDetailVo create(ims.careuk.domain.objects.PatientProcedureApptDetail domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.PatientProcedureApptDetailVo create(DomainObjectMap map, ims.careuk.domain.objects.PatientProcedureApptDetail domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.PatientProcedureApptDetailVo valueObject = (ims.careuk.vo.PatientProcedureApptDetailVo) map.getValueObject(domainObject, ims.careuk.vo.PatientProcedureApptDetailVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.PatientProcedureApptDetailVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.careuk.domain.objects.PatientProcedureApptDetail
	 */
	 public static ims.careuk.vo.PatientProcedureApptDetailVo insert(ims.careuk.vo.PatientProcedureApptDetailVo valueObject, ims.careuk.domain.objects.PatientProcedureApptDetail domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.careuk.domain.objects.PatientProcedureApptDetail
	 */
	 public static ims.careuk.vo.PatientProcedureApptDetailVo insert(DomainObjectMap map, ims.careuk.vo.PatientProcedureApptDetailVo valueObject, ims.careuk.domain.objects.PatientProcedureApptDetail domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.careuk.domain.objects.PatientProcedureApptDetail extractPatientProcedureApptDetail(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientProcedureApptDetailVo valueObject) 
	{
		return 	extractPatientProcedureApptDetail(domainFactory, valueObject, new HashMap());
	}

	public static ims.careuk.domain.objects.PatientProcedureApptDetail extractPatientProcedureApptDetail(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientProcedureApptDetailVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		ims.careuk.domain.objects.PatientProcedureApptDetail domainObject = null;
		if ( null == id) 
		{
			if (domMap.get(valueObject) != null)
			{
				return (ims.careuk.domain.objects.PatientProcedureApptDetail)domMap.get(valueObject);
			}
			// ims.careuk.vo.PatientProcedureApptDetailVo ID_PatientProcedureApptDetail field is unknown
			domainObject = new ims.careuk.domain.objects.PatientProcedureApptDetail();
		...
		else 
		{
			...
			{
				return (ims.careuk.domain.objects.PatientProcedureApptDetail)domMap.get(key);
			}
			domainObject = (ims.careuk.domain.objects.PatientProcedureApptDetail) domainFactory.getDomainObject(ims.careuk.domain.objects.PatientProcedureApptDetail.class, id );
