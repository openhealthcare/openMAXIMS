...
public class ReferralDischargeVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.ReferralDischargeVo copy(ims.careuk.vo.ReferralDischargeVo valueObjectDest, ims.careuk.vo.ReferralDischargeVo valueObjectSrc) 
	 {
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.DischargeOutcome objects.
	 */
	public static ims.careuk.vo.ReferralDischargeVoCollection createReferralDischargeVoCollectionFromDischargeOutcome(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.DischargeOutcome objects.
	 */
	public static ims.careuk.vo.ReferralDischargeVoCollection createReferralDischargeVoCollectionFromDischargeOutcome(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.ReferralDischargeVoCollection voList = new ims.careuk.vo.ReferralDischargeVoCollection();
		...
		{
			ims.careuk.domain.objects.DischargeOutcome domainObject = (ims.careuk.domain.objects.DischargeOutcome) iterator.next();
			ims.careuk.vo.ReferralDischargeVo vo = create(map, domainObject);
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.DischargeOutcome objects.
	 */
	public static ims.careuk.vo.ReferralDischargeVoCollection createReferralDischargeVoCollectionFromDischargeOutcome(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.DischargeOutcome objects.
	 */
	public static ims.careuk.vo.ReferralDischargeVoCollection createReferralDischargeVoCollectionFromDischargeOutcome(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.ReferralDischargeVoCollection voList = new ims.careuk.vo.ReferralDischargeVoCollection();
		...
		{
			ims.careuk.domain.objects.DischargeOutcome domainObject = (ims.careuk.domain.objects.DischargeOutcome) domainObjectList.get(i);
			ims.careuk.vo.ReferralDischargeVo vo = create(map, domainObject);
	...
	/**
	 * Create the ims.careuk.domain.objects.DischargeOutcome set from the value object collection.
	 * @param domainFactory - used to create existing (persistent) domain objects.
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.Set extractDischargeOutcomeSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralDischargeVoCollection voCollection) 
	 {
	 	return extractDischargeOutcomeSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractDischargeOutcomeSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralDischargeVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.ReferralDischargeVo vo = voCollection.get(i);
			ims.careuk.domain.objects.DischargeOutcome domainObject = ReferralDischargeVoAssembler.extractDischargeOutcome(domainFactory, vo, domMap);
	...
	/**
	 * Create the ims.careuk.domain.objects.DischargeOutcome list from the value object collection.
	 * @param domainFactory - used to create existing (persistent) domain objects.
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractDischargeOutcomeList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralDischargeVoCollection voCollection) 
	 {
	 	return extractDischargeOutcomeList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractDischargeOutcomeList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralDischargeVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	...
	/**
	 * Create the ValueObject from the ims.careuk.domain.objects.DischargeOutcome object.
	 * @param domainObject ims.careuk.domain.objects.DischargeOutcome
	 */
	 public static ims.careuk.vo.ReferralDischargeVo create(ims.careuk.domain.objects.DischargeOutcome domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.ReferralDischargeVo create(DomainObjectMap map, ims.careuk.domain.objects.DischargeOutcome domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.ReferralDischargeVo valueObject = (ims.careuk.vo.ReferralDischargeVo) map.getValueObject(domainObject, ims.careuk.vo.ReferralDischargeVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.ReferralDischargeVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.careuk.domain.objects.DischargeOutcome
	 */
	 public static ims.careuk.vo.ReferralDischargeVo insert(ims.careuk.vo.ReferralDischargeVo valueObject, ims.careuk.domain.objects.DischargeOutcome domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.careuk.domain.objects.DischargeOutcome
	 */
	 public static ims.careuk.vo.ReferralDischargeVo insert(DomainObjectMap map, ims.careuk.vo.ReferralDischargeVo valueObject, ims.careuk.domain.objects.DischargeOutcome domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		if ( null != instance1 ) {
			...
			ims.careuk.vo.lookups.DischargeType voLookup1 = new ims.careuk.vo.lookups.DischargeType(instance1.getId(),instance1.getText(), instance1.isActive(), null, img, color);
			ims.careuk.vo.lookups.DischargeType parentVoLookup1 = voLookup1;
			...
			while (parent1 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup1.setParent(new ims.careuk.vo.lookups.DischargeType(parent1.getId(),parent1.getText(), parent1.isActive(), null, img, color));
		...
		if ( null != instance3 ) {
			...
			ims.careuk.vo.lookups.DischargeOtherType voLookup3 = new ims.careuk.vo.lookups.DischargeOtherType(instance3.getId(),instance3.getText(), instance3.isActive(), null, img, color);
			ims.careuk.vo.lookups.DischargeOtherType parentVoLookup3 = voLookup3;
			...
			while (parent3 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup3.setParent(new ims.careuk.vo.lookups.DischargeOtherType(parent3.getId(),parent3.getText(), parent3.isActive(), null, img, color));
		...
		// CurrentOnwardReferral
		valueObject.setCurrentOnwardReferral(ims.careuk.vo.domain.OnwardReferralVoAssembler.create(map, domainObject.getCurrentOnwardReferral()) );
		// OnwardReferrals
		valueObject.setOnwardReferrals(ims.careuk.vo.domain.OnwardReferralVoAssembler.createOnwardReferralVoCollectionFromOnwardReferral(map, domainObject.getOnwardReferrals()) );
		// DischargeDate
	 ...
	 */
	public static ims.careuk.domain.objects.DischargeOutcome extractDischargeOutcome(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralDischargeVo valueObject) 
	{
		return 	extractDischargeOutcome(domainFactory, valueObject, new HashMap());
	}

	public static ims.careuk.domain.objects.DischargeOutcome extractDischargeOutcome(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralDischargeVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		ims.careuk.domain.objects.DischargeOutcome domainObject = null;
		if ( null == id) 
		{
			if (domMap.get(valueObject) != null)
			{
				return (ims.careuk.domain.objects.DischargeOutcome)domMap.get(valueObject);
			}
			// ims.careuk.vo.ReferralDischargeVo ID_DischargeOutcome field is unknown
			domainObject = new ims.careuk.domain.objects.DischargeOutcome();
		...
		else 
		{
			...
			{
				return (ims.careuk.domain.objects.DischargeOutcome)domMap.get(key);
			}
			domainObject = (ims.careuk.domain.objects.DischargeOutcome) domainFactory.getDomainObject(ims.careuk.domain.objects.DischargeOutcome.class, id );
		...
		domainObject.setCurrentOnwardReferral(ims.careuk.vo.domain.OnwardReferralVoAssembler.extractOnwardReferral(domainFactory, valueObject.getCurrentOnwardReferral(), domMap));
		domainObject.setOnwardReferrals(ims.careuk.vo.domain.OnwardReferralVoAssembler.extractOnwardReferralSet(domainFactory, valueObject.getOnwardReferrals(), domainObject.getOnwardReferrals(), domMap));		
