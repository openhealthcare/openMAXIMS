...
public class TheatreListBookingAppointmentVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.TheatreListBookingAppointmentVo copy(ims.careuk.vo.TheatreListBookingAppointmentVo valueObjectDest, ims.careuk.vo.TheatreListBookingAppointmentVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.TheatreListBookingAppointmentVoCollection createTheatreListBookingAppointmentVoCollectionFromBooking_Appointment(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.scheduling.domain.objects.Booking_Appointment objects.
	 */
	public static ims.careuk.vo.TheatreListBookingAppointmentVoCollection createTheatreListBookingAppointmentVoCollectionFromBooking_Appointment(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.TheatreListBookingAppointmentVoCollection voList = new ims.careuk.vo.TheatreListBookingAppointmentVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.TheatreListBookingAppointmentVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.TheatreListBookingAppointmentVoCollection createTheatreListBookingAppointmentVoCollectionFromBooking_Appointment(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.scheduling.domain.objects.Booking_Appointment objects.
	 */
	public static ims.careuk.vo.TheatreListBookingAppointmentVoCollection createTheatreListBookingAppointmentVoCollectionFromBooking_Appointment(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.TheatreListBookingAppointmentVoCollection voList = new ims.careuk.vo.TheatreListBookingAppointmentVoCollection();
	 ...
	 */
	 public static java.util.Set extractBooking_AppointmentSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.TheatreListBookingAppointmentVoCollection voCollection) 
	 {
	 	return extractBooking_AppointmentSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractBooking_AppointmentSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.TheatreListBookingAppointmentVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.TheatreListBookingAppointmentVo vo = voCollection.get(i);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractBooking_AppointmentList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.TheatreListBookingAppointmentVoCollection voCollection) 
	 {
	 	return extractBooking_AppointmentList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractBooking_AppointmentList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.TheatreListBookingAppointmentVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.TheatreListBookingAppointmentVo create(ims.scheduling.domain.objects.Booking_Appointment domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.TheatreListBookingAppointmentVo create(DomainObjectMap map, ims.scheduling.domain.objects.Booking_Appointment domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.TheatreListBookingAppointmentVo valueObject = (ims.careuk.vo.TheatreListBookingAppointmentVo) map.getValueObject(domainObject, ims.careuk.vo.TheatreListBookingAppointmentVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.TheatreListBookingAppointmentVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.scheduling.domain.objects.Booking_Appointment
	 */
	 public static ims.careuk.vo.TheatreListBookingAppointmentVo insert(ims.careuk.vo.TheatreListBookingAppointmentVo valueObject, ims.scheduling.domain.objects.Booking_Appointment domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.scheduling.domain.objects.Booking_Appointment
	 */
	 public static ims.careuk.vo.TheatreListBookingAppointmentVo insert(DomainObjectMap map, ims.careuk.vo.TheatreListBookingAppointmentVo valueObject, ims.scheduling.domain.objects.Booking_Appointment domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.scheduling.domain.objects.Booking_Appointment extractBooking_Appointment(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.TheatreListBookingAppointmentVo valueObject) 
	{
		return 	extractBooking_Appointment(domainFactory, valueObject, new HashMap());
	}

	public static ims.scheduling.domain.objects.Booking_Appointment extractBooking_Appointment(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.TheatreListBookingAppointmentVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.TheatreListBookingAppointmentVo ID_Booking_Appointment field is unknown
