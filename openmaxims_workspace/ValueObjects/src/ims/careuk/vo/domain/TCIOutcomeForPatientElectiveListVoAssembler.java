 ...
 */
public class TCIOutcomeForPatientElectiveListVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.careuk.vo.TCIOutcomeForPatientElectiveListVo copy(ims.careuk.vo.TCIOutcomeForPatientElectiveListVo valueObjectDest, ims.careuk.vo.TCIOutcomeForPatientElectiveListVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createTCIOutcomeForPatientElectiveListVoCollectionFromTCIOutcomeForPatientElectiveList(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.TCIOutcomeForPatientElectiveList objects.
	 */
	public static ims.careuk.vo.TCIOutcomeForPatientElectiveListVoCollection createTCIOutcomeForPatientElectiveListVoCollectionFromTCIOutcomeForPatientElectiveList(java.util.Set domainObjectSet)	
	{
		return createTCIOutcomeForPatientElectiveListVoCollectionFromTCIOutcomeForPatientElectiveList(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.TCIOutcomeForPatientElectiveList objects.
	 */
	public static ims.careuk.vo.TCIOutcomeForPatientElectiveListVoCollection createTCIOutcomeForPatientElectiveListVoCollectionFromTCIOutcomeForPatientElectiveList(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.TCIOutcomeForPatientElectiveListVoCollection voList = new ims.careuk.vo.TCIOutcomeForPatientElectiveListVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.TCIOutcomeForPatientElectiveListVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.TCIOutcomeForPatientElectiveListVoCollection createTCIOutcomeForPatientElectiveListVoCollectionFromTCIOutcomeForPatientElectiveList(java.util.List domainObjectList) 
	{
		return createTCIOutcomeForPatientElectiveListVoCollectionFromTCIOutcomeForPatientElectiveList(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.TCIOutcomeForPatientElectiveList objects.
	 */
	public static ims.careuk.vo.TCIOutcomeForPatientElectiveListVoCollection createTCIOutcomeForPatientElectiveListVoCollectionFromTCIOutcomeForPatientElectiveList(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.TCIOutcomeForPatientElectiveListVoCollection voList = new ims.careuk.vo.TCIOutcomeForPatientElectiveListVoCollection();
	 ...
	 */
	 public static java.util.Set extractTCIOutcomeForPatientElectiveListSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.TCIOutcomeForPatientElectiveListVoCollection voCollection) 
	 {
	 	return extractTCIOutcomeForPatientElectiveListSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractTCIOutcomeForPatientElectiveListSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.TCIOutcomeForPatientElectiveListVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.TCIOutcomeForPatientElectiveListVo vo = voCollection.get(i);
			ims.careuk.domain.objects.TCIOutcomeForPatientElectiveList domainObject = TCIOutcomeForPatientElectiveListVoAssembler.extractTCIOutcomeForPatientElectiveList(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractTCIOutcomeForPatientElectiveListList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.TCIOutcomeForPatientElectiveListVoCollection voCollection) 
	 {
	 	return extractTCIOutcomeForPatientElectiveListList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractTCIOutcomeForPatientElectiveListList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.TCIOutcomeForPatientElectiveListVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.TCIOutcomeForPatientElectiveListVo create(ims.careuk.domain.objects.TCIOutcomeForPatientElectiveList domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.TCIOutcomeForPatientElectiveListVo create(DomainObjectMap map, ims.careuk.domain.objects.TCIOutcomeForPatientElectiveList domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.TCIOutcomeForPatientElectiveListVo valueObject = (ims.careuk.vo.TCIOutcomeForPatientElectiveListVo) map.getValueObject(domainObject, ims.careuk.vo.TCIOutcomeForPatientElectiveListVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.TCIOutcomeForPatientElectiveListVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.careuk.domain.objects.TCIOutcomeForPatientElectiveList
	 */
	 public static ims.careuk.vo.TCIOutcomeForPatientElectiveListVo insert(ims.careuk.vo.TCIOutcomeForPatientElectiveListVo valueObject, ims.careuk.domain.objects.TCIOutcomeForPatientElectiveList domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.careuk.domain.objects.TCIOutcomeForPatientElectiveList
	 */
	 public static ims.careuk.vo.TCIOutcomeForPatientElectiveListVo insert(DomainObjectMap map, ims.careuk.vo.TCIOutcomeForPatientElectiveListVo valueObject, ims.careuk.domain.objects.TCIOutcomeForPatientElectiveList domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.careuk.domain.objects.TCIOutcomeForPatientElectiveList extractTCIOutcomeForPatientElectiveList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.TCIOutcomeForPatientElectiveListVo valueObject) 
	{
		return 	extractTCIOutcomeForPatientElectiveList(domainFactory, valueObject, new HashMap());
	}

	public static ims.careuk.domain.objects.TCIOutcomeForPatientElectiveList extractTCIOutcomeForPatientElectiveList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.TCIOutcomeForPatientElectiveListVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.TCIOutcomeForPatientElectiveListVo ID_TCIOutcomeForPatientElectiveList field is unknown
