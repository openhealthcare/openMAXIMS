...
public class CatsReferralVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.CatsReferralVo copy(ims.careuk.vo.CatsReferralVo valueObjectDest, ims.careuk.vo.CatsReferralVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.CatsReferralVoCollection createCatsReferralVoCollectionFromCatsReferral(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.CatsReferral objects.
	 */
	public static ims.careuk.vo.CatsReferralVoCollection createCatsReferralVoCollectionFromCatsReferral(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.CatsReferralVoCollection voList = new ims.careuk.vo.CatsReferralVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.CatsReferralVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.CatsReferralVoCollection createCatsReferralVoCollectionFromCatsReferral(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.CatsReferral objects.
	 */
	public static ims.careuk.vo.CatsReferralVoCollection createCatsReferralVoCollectionFromCatsReferral(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.CatsReferralVoCollection voList = new ims.careuk.vo.CatsReferralVoCollection();
	 ...
	 */
	 public static java.util.Set extractCatsReferralSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.CatsReferralVoCollection voCollection) 
	 {
	 	return extractCatsReferralSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractCatsReferralSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.CatsReferralVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.CatsReferralVo vo = voCollection.get(i);
			ims.careuk.domain.objects.CatsReferral domainObject = CatsReferralVoAssembler.extractCatsReferral(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractCatsReferralList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.CatsReferralVoCollection voCollection) 
	 {
	 	return extractCatsReferralList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractCatsReferralList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.CatsReferralVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.CatsReferralVo create(ims.careuk.domain.objects.CatsReferral domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.CatsReferralVo create(DomainObjectMap map, ims.careuk.domain.objects.CatsReferral domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.CatsReferralVo valueObject = (ims.careuk.vo.CatsReferralVo) map.getValueObject(domainObject, ims.careuk.vo.CatsReferralVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.CatsReferralVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.careuk.domain.objects.CatsReferral
	 */
	 public static ims.careuk.vo.CatsReferralVo insert(ims.careuk.vo.CatsReferralVo valueObject, ims.careuk.domain.objects.CatsReferral domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.careuk.domain.objects.CatsReferral
	 */
	 public static ims.careuk.vo.CatsReferralVo insert(DomainObjectMap map, ims.careuk.vo.CatsReferralVo valueObject, ims.careuk.domain.objects.CatsReferral domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.careuk.domain.objects.CatsReferral extractCatsReferral(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.CatsReferralVo valueObject) 
	{
		return 	extractCatsReferral(domainFactory, valueObject, new HashMap());
	}

	public static ims.careuk.domain.objects.CatsReferral extractCatsReferral(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.CatsReferralVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.CatsReferralVo ID_CatsReferral field is unknown
