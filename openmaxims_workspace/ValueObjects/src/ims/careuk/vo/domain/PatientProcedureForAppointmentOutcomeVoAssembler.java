...
public class PatientProcedureForAppointmentOutcomeVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.PatientProcedureForAppointmentOutcomeVo copy(ims.careuk.vo.PatientProcedureForAppointmentOutcomeVo valueObjectDest, ims.careuk.vo.PatientProcedureForAppointmentOutcomeVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.PatientProcedureForAppointmentOutcomeVoCollection createPatientProcedureForAppointmentOutcomeVoCollectionFromPatientProcedure(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.core.clinical.domain.objects.PatientProcedure objects.
	 */
	public static ims.careuk.vo.PatientProcedureForAppointmentOutcomeVoCollection createPatientProcedureForAppointmentOutcomeVoCollectionFromPatientProcedure(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.PatientProcedureForAppointmentOutcomeVoCollection voList = new ims.careuk.vo.PatientProcedureForAppointmentOutcomeVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.PatientProcedureForAppointmentOutcomeVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.PatientProcedureForAppointmentOutcomeVoCollection createPatientProcedureForAppointmentOutcomeVoCollectionFromPatientProcedure(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.core.clinical.domain.objects.PatientProcedure objects.
	 */
	public static ims.careuk.vo.PatientProcedureForAppointmentOutcomeVoCollection createPatientProcedureForAppointmentOutcomeVoCollectionFromPatientProcedure(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.PatientProcedureForAppointmentOutcomeVoCollection voList = new ims.careuk.vo.PatientProcedureForAppointmentOutcomeVoCollection();
	 ...
	 */
	 public static java.util.Set extractPatientProcedureSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientProcedureForAppointmentOutcomeVoCollection voCollection) 
	 {
	 	return extractPatientProcedureSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientProcedureSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientProcedureForAppointmentOutcomeVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.PatientProcedureForAppointmentOutcomeVo vo = voCollection.get(i);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPatientProcedureList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientProcedureForAppointmentOutcomeVoCollection voCollection) 
	 {
	 	return extractPatientProcedureList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPatientProcedureList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientProcedureForAppointmentOutcomeVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.PatientProcedureForAppointmentOutcomeVo create(ims.core.clinical.domain.objects.PatientProcedure domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.PatientProcedureForAppointmentOutcomeVo create(DomainObjectMap map, ims.core.clinical.domain.objects.PatientProcedure domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.PatientProcedureForAppointmentOutcomeVo valueObject = (ims.careuk.vo.PatientProcedureForAppointmentOutcomeVo) map.getValueObject(domainObject, ims.careuk.vo.PatientProcedureForAppointmentOutcomeVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.PatientProcedureForAppointmentOutcomeVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.PatientProcedure
	 */
	 public static ims.careuk.vo.PatientProcedureForAppointmentOutcomeVo insert(ims.careuk.vo.PatientProcedureForAppointmentOutcomeVo valueObject, ims.core.clinical.domain.objects.PatientProcedure domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.PatientProcedure
	 */
	 public static ims.careuk.vo.PatientProcedureForAppointmentOutcomeVo insert(DomainObjectMap map, ims.careuk.vo.PatientProcedureForAppointmentOutcomeVo valueObject, ims.core.clinical.domain.objects.PatientProcedure domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.clinical.domain.objects.PatientProcedure extractPatientProcedure(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientProcedureForAppointmentOutcomeVo valueObject) 
	{
		return 	extractPatientProcedure(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.clinical.domain.objects.PatientProcedure extractPatientProcedure(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientProcedureForAppointmentOutcomeVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.PatientProcedureForAppointmentOutcomeVo ID_PatientProcedure field is unknown
