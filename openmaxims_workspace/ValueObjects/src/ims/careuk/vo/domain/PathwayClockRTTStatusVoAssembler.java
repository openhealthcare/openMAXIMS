...
public class PathwayClockRTTStatusVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.PathwayClockRTTStatusVo copy(ims.careuk.vo.PathwayClockRTTStatusVo valueObjectDest, ims.careuk.vo.PathwayClockRTTStatusVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.PathwayClockRTTStatusVoCollection createPathwayClockRTTStatusVoCollectionFromPathwayClock(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.pathways.domain.objects.PathwayClock objects.
	 */
	public static ims.careuk.vo.PathwayClockRTTStatusVoCollection createPathwayClockRTTStatusVoCollectionFromPathwayClock(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.PathwayClockRTTStatusVoCollection voList = new ims.careuk.vo.PathwayClockRTTStatusVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.PathwayClockRTTStatusVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.PathwayClockRTTStatusVoCollection createPathwayClockRTTStatusVoCollectionFromPathwayClock(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.pathways.domain.objects.PathwayClock objects.
	 */
	public static ims.careuk.vo.PathwayClockRTTStatusVoCollection createPathwayClockRTTStatusVoCollectionFromPathwayClock(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.PathwayClockRTTStatusVoCollection voList = new ims.careuk.vo.PathwayClockRTTStatusVoCollection();
	 ...
	 */
	 public static java.util.Set extractPathwayClockSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PathwayClockRTTStatusVoCollection voCollection) 
	 {
	 	return extractPathwayClockSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPathwayClockSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PathwayClockRTTStatusVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.PathwayClockRTTStatusVo vo = voCollection.get(i);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPathwayClockList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PathwayClockRTTStatusVoCollection voCollection) 
	 {
	 	return extractPathwayClockList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPathwayClockList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PathwayClockRTTStatusVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.PathwayClockRTTStatusVo create(ims.pathways.domain.objects.PathwayClock domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.PathwayClockRTTStatusVo create(DomainObjectMap map, ims.pathways.domain.objects.PathwayClock domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.PathwayClockRTTStatusVo valueObject = (ims.careuk.vo.PathwayClockRTTStatusVo) map.getValueObject(domainObject, ims.careuk.vo.PathwayClockRTTStatusVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.PathwayClockRTTStatusVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.pathways.domain.objects.PathwayClock
	 */
	 public static ims.careuk.vo.PathwayClockRTTStatusVo insert(ims.careuk.vo.PathwayClockRTTStatusVo valueObject, ims.pathways.domain.objects.PathwayClock domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.pathways.domain.objects.PathwayClock
	 */
	 public static ims.careuk.vo.PathwayClockRTTStatusVo insert(DomainObjectMap map, ims.careuk.vo.PathwayClockRTTStatusVo valueObject, ims.pathways.domain.objects.PathwayClock domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.pathways.domain.objects.PathwayClock extractPathwayClock(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PathwayClockRTTStatusVo valueObject) 
	{
		return 	extractPathwayClock(domainFactory, valueObject, new HashMap());
	}

	public static ims.pathways.domain.objects.PathwayClock extractPathwayClock(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PathwayClockRTTStatusVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.PathwayClockRTTStatusVo ID_PathwayClock field is unknown
