...
public class DischargeSummaryPacuAndWardVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.DischargeSummaryPacuAndWardVo copy(ims.careuk.vo.DischargeSummaryPacuAndWardVo valueObjectDest, ims.careuk.vo.DischargeSummaryPacuAndWardVo valueObjectSrc) 
	 {
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.DischargeSummaryPacuAndWard objects.
	 */
	public static ims.careuk.vo.DischargeSummaryPacuAndWardVoCollection createDischargeSummaryPacuAndWardVoCollectionFromDischargeSummaryPacuAndWard(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.DischargeSummaryPacuAndWard objects.
	 */
	public static ims.careuk.vo.DischargeSummaryPacuAndWardVoCollection createDischargeSummaryPacuAndWardVoCollectionFromDischargeSummaryPacuAndWard(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.DischargeSummaryPacuAndWardVoCollection voList = new ims.careuk.vo.DischargeSummaryPacuAndWardVoCollection();
		...
		{
			ims.careuk.domain.objects.DischargeSummaryPacuAndWard domainObject = (ims.careuk.domain.objects.DischargeSummaryPacuAndWard) iterator.next();
			ims.careuk.vo.DischargeSummaryPacuAndWardVo vo = create(map, domainObject);
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.DischargeSummaryPacuAndWard objects.
	 */
	public static ims.careuk.vo.DischargeSummaryPacuAndWardVoCollection createDischargeSummaryPacuAndWardVoCollectionFromDischargeSummaryPacuAndWard(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.DischargeSummaryPacuAndWard objects.
	 */
	public static ims.careuk.vo.DischargeSummaryPacuAndWardVoCollection createDischargeSummaryPacuAndWardVoCollectionFromDischargeSummaryPacuAndWard(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.DischargeSummaryPacuAndWardVoCollection voList = new ims.careuk.vo.DischargeSummaryPacuAndWardVoCollection();
		...
		{
			ims.careuk.domain.objects.DischargeSummaryPacuAndWard domainObject = (ims.careuk.domain.objects.DischargeSummaryPacuAndWard) domainObjectList.get(i);
			ims.careuk.vo.DischargeSummaryPacuAndWardVo vo = create(map, domainObject);
	...
	/**
	 * Create the ims.careuk.domain.objects.DischargeSummaryPacuAndWard set from the value object collection.
	 * @param domainFactory - used to create existing (persistent) domain objects.
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.Set extractDischargeSummaryPacuAndWardSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.DischargeSummaryPacuAndWardVoCollection voCollection) 
	 {
	 	return extractDischargeSummaryPacuAndWardSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractDischargeSummaryPacuAndWardSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.DischargeSummaryPacuAndWardVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.DischargeSummaryPacuAndWardVo vo = voCollection.get(i);
			ims.careuk.domain.objects.DischargeSummaryPacuAndWard domainObject = DischargeSummaryPacuAndWardVoAssembler.extractDischargeSummaryPacuAndWard(domainFactory, vo, domMap);
	...
	/**
	 * Create the ims.careuk.domain.objects.DischargeSummaryPacuAndWard list from the value object collection.
	 * @param domainFactory - used to create existing (persistent) domain objects.
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractDischargeSummaryPacuAndWardList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.DischargeSummaryPacuAndWardVoCollection voCollection) 
	 {
	 	return extractDischargeSummaryPacuAndWardList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractDischargeSummaryPacuAndWardList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.DischargeSummaryPacuAndWardVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	...
	/**
	 * Create the ValueObject from the ims.careuk.domain.objects.DischargeSummaryPacuAndWard object.
	 * @param domainObject ims.careuk.domain.objects.DischargeSummaryPacuAndWard
	 */
	 public static ims.careuk.vo.DischargeSummaryPacuAndWardVo create(ims.careuk.domain.objects.DischargeSummaryPacuAndWard domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.DischargeSummaryPacuAndWardVo create(DomainObjectMap map, ims.careuk.domain.objects.DischargeSummaryPacuAndWard domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.DischargeSummaryPacuAndWardVo valueObject = (ims.careuk.vo.DischargeSummaryPacuAndWardVo) map.getValueObject(domainObject, ims.careuk.vo.DischargeSummaryPacuAndWardVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.DischargeSummaryPacuAndWardVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.careuk.domain.objects.DischargeSummaryPacuAndWard
	 */
	 public static ims.careuk.vo.DischargeSummaryPacuAndWardVo insert(ims.careuk.vo.DischargeSummaryPacuAndWardVo valueObject, ims.careuk.domain.objects.DischargeSummaryPacuAndWard domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.careuk.domain.objects.DischargeSummaryPacuAndWard
	 */
	 public static ims.careuk.vo.DischargeSummaryPacuAndWardVo insert(DomainObjectMap map, ims.careuk.vo.DischargeSummaryPacuAndWardVo valueObject, ims.careuk.domain.objects.DischargeSummaryPacuAndWard domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		if ( null != instance7 ) {
			...
			ims.careuk.vo.lookups.FollowupManagementType voLookup7 = new ims.careuk.vo.lookups.FollowupManagementType(instance7.getId(),instance7.getText(), instance7.isActive(), null, img, color);
			ims.careuk.vo.lookups.FollowupManagementType parentVoLookup7 = voLookup7;
			...
			while (parent7 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup7.setParent(new ims.careuk.vo.lookups.FollowupManagementType(parent7.getId(),parent7.getText(), parent7.isActive(), null, img, color));
		...
		if ( null != instance9 ) {
			...
			ims.careuk.vo.lookups.MedicallyIncomplete voLookup9 = new ims.careuk.vo.lookups.MedicallyIncomplete(instance9.getId(),instance9.getText(), instance9.isActive(), null, img, color);
			ims.careuk.vo.lookups.MedicallyIncomplete parentVoLookup9 = voLookup9;
			...
			while (parent9 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup9.setParent(new ims.careuk.vo.lookups.MedicallyIncomplete(parent9.getId(),parent9.getText(), parent9.isActive(), null, img, color));
		...
		if (domainObject.getCurrentOnwardReferral() != null)
		{
			if(domainObject.getCurrentOnwardReferral() instanceof HibernateProxy) // If the proxy is set, there is no need to lazy load, the proxy knows the id already. 
			{
				...
				valueObject.setCurrentOnwardReferral(new ims.careuk.vo.OnwardReferralRefVo(id, -1));				
			}
			else
			{
				valueObject.setCurrentOnwardReferral(new ims.careuk.vo.OnwardReferralRefVo(domainObject.getCurrentOnwardReferral().getId(), domainObject.getCurrentOnwardReferral().getVersion()));
			}
		}
		// OnwardReferrals
		ims.careuk.vo.OnwardReferralRefVoCollection OnwardReferrals = new ims.careuk.vo.OnwardReferralRefVoCollection();
		for(java.util.Iterator iterator = domainObject.getOnwardReferrals().iterator(); iterator.hasNext(); ) 
		{
			ims.careuk.domain.objects.OnwardReferral tmp = (ims.careuk.domain.objects.OnwardReferral)iterator.next();
			if (tmp != null)
				OnwardReferrals.add(new ims.careuk.vo.OnwardReferralRefVo(tmp.getId(),tmp.getVersion()));
		}
		...
		if ( null != instance17 ) {
			...
			ims.careuk.vo.lookups.DischargeType voLookup17 = new ims.careuk.vo.lookups.DischargeType(instance17.getId(),instance17.getText(), instance17.isActive(), null, img, color);
			ims.careuk.vo.lookups.DischargeType parentVoLookup17 = voLookup17;
			...
			while (parent17 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup17.setParent(new ims.careuk.vo.lookups.DischargeType(parent17.getId(),parent17.getText(), parent17.isActive(), null, img, color));
	 ...
	 */
	public static ims.careuk.domain.objects.DischargeSummaryPacuAndWard extractDischargeSummaryPacuAndWard(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.DischargeSummaryPacuAndWardVo valueObject) 
	{
		return 	extractDischargeSummaryPacuAndWard(domainFactory, valueObject, new HashMap());
	}

	public static ims.careuk.domain.objects.DischargeSummaryPacuAndWard extractDischargeSummaryPacuAndWard(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.DischargeSummaryPacuAndWardVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		ims.careuk.domain.objects.DischargeSummaryPacuAndWard domainObject = null;
		if ( null == id) 
		{
			if (domMap.get(valueObject) != null)
			{
				return (ims.careuk.domain.objects.DischargeSummaryPacuAndWard)domMap.get(valueObject);
			}
			// ims.careuk.vo.DischargeSummaryPacuAndWardVo ID_DischargeSummaryPacuAndWard field is unknown
			domainObject = new ims.careuk.domain.objects.DischargeSummaryPacuAndWard();
		...
		else 
		{
			...
			{
				return (ims.careuk.domain.objects.DischargeSummaryPacuAndWard)domMap.get(key);
			}
			domainObject = (ims.careuk.domain.objects.DischargeSummaryPacuAndWard) domainFactory.getDomainObject(ims.careuk.domain.objects.DischargeSummaryPacuAndWard.class, id );
		...
		ims.careuk.domain.objects.OnwardReferral value11 = null;
		if ( null != valueObject.getCurrentOnwardReferral() ) 
		{
			if (valueObject.getCurrentOnwardReferral().getBoId() == null)
			{
				...
				{
					value11 = (ims.careuk.domain.objects.OnwardReferral)domMap.get(valueObject.getCurrentOnwardReferral());
				}
			}
			...
			{
				value11 = (ims.careuk.domain.objects.OnwardReferral)domainFactory.getDomainObject(ims.careuk.domain.objects.OnwardReferral.class, valueObject.getCurrentOnwardReferral().getBoId());
			}
		}
		domainObject.setCurrentOnwardReferral(value11);

		ims.careuk.vo.OnwardReferralRefVoCollection refCollection12 = valueObject.getOnwardReferrals();
		...
		{
			ims.careuk.vo.OnwardReferralRefVo vo = refCollection12.get(i);					
			ims.careuk.domain.objects.OnwardReferral dom = null;
			if ( null != vo ) 
			{
				if (vo.getBoId() == null)
				{
					if (domMap.get(vo) != null)
					{
						dom = (ims.careuk.domain.objects.OnwardReferral)domMap.get(vo);
					}
				}
				else
				{
					dom = (ims.careuk.domain.objects.OnwardReferral)domainFactory.getDomainObject( ims.careuk.domain.objects.OnwardReferral.class, vo.getBoId());
				}
			}
		...
		ims.careuk.domain.objects.CatsReferral value14 = null;
		if ( null != valueObject.getCatsReferral() ) 
		{
			if (valueObject.getCatsReferral().getBoId() == null)
			{
				...
				{
					value14 = (ims.careuk.domain.objects.CatsReferral)domMap.get(valueObject.getCatsReferral());
				}
			}
			else if (valueObject.getBoVersion() == -1) // RefVo was not modified since obtained from the Assembler, no need to update the BO field
			{
			...
			{
				value14 = (ims.careuk.domain.objects.CatsReferral)domainFactory.getDomainObject(ims.careuk.domain.objects.CatsReferral.class, valueObject.getCatsReferral().getBoId());
			}
		}
