...
public class ContractConfigurationVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.ContractConfigurationVo copy(ims.careuk.vo.ContractConfigurationVo valueObjectDest, ims.careuk.vo.ContractConfigurationVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.ContractConfigurationVoCollection createContractConfigurationVoCollectionFromContractConfig(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.core.configuration.domain.objects.ContractConfig objects.
	 */
	public static ims.careuk.vo.ContractConfigurationVoCollection createContractConfigurationVoCollectionFromContractConfig(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.ContractConfigurationVoCollection voList = new ims.careuk.vo.ContractConfigurationVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.ContractConfigurationVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.ContractConfigurationVoCollection createContractConfigurationVoCollectionFromContractConfig(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.core.configuration.domain.objects.ContractConfig objects.
	 */
	public static ims.careuk.vo.ContractConfigurationVoCollection createContractConfigurationVoCollectionFromContractConfig(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.ContractConfigurationVoCollection voList = new ims.careuk.vo.ContractConfigurationVoCollection();
	 ...
	 */
	 public static java.util.Set extractContractConfigSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ContractConfigurationVoCollection voCollection) 
	 {
	 	return extractContractConfigSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractContractConfigSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ContractConfigurationVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.ContractConfigurationVo vo = voCollection.get(i);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractContractConfigList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ContractConfigurationVoCollection voCollection) 
	 {
	 	return extractContractConfigList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractContractConfigList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ContractConfigurationVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.ContractConfigurationVo create(ims.core.configuration.domain.objects.ContractConfig domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.ContractConfigurationVo create(DomainObjectMap map, ims.core.configuration.domain.objects.ContractConfig domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.ContractConfigurationVo valueObject = (ims.careuk.vo.ContractConfigurationVo) map.getValueObject(domainObject, ims.careuk.vo.ContractConfigurationVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.ContractConfigurationVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.configuration.domain.objects.ContractConfig
	 */
	 public static ims.careuk.vo.ContractConfigurationVo insert(ims.careuk.vo.ContractConfigurationVo valueObject, ims.core.configuration.domain.objects.ContractConfig domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.configuration.domain.objects.ContractConfig
	 */
	 public static ims.careuk.vo.ContractConfigurationVo insert(DomainObjectMap map, ims.careuk.vo.ContractConfigurationVo valueObject, ims.core.configuration.domain.objects.ContractConfig domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.configuration.domain.objects.ContractConfig extractContractConfig(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ContractConfigurationVo valueObject) 
	{
		return 	extractContractConfig(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.configuration.domain.objects.ContractConfig extractContractConfig(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ContractConfigurationVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.ContractConfigurationVo ID_ContractConfig field is unknown
