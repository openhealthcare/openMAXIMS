...
public class CatsReferralListVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.CatsReferralListVo copy(ims.careuk.vo.CatsReferralListVo valueObjectDest, ims.careuk.vo.CatsReferralListVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.CatsReferralListVoCollection createCatsReferralListVoCollectionFromCatsReferral(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.CatsReferral objects.
	 */
	public static ims.careuk.vo.CatsReferralListVoCollection createCatsReferralListVoCollectionFromCatsReferral(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.CatsReferralListVoCollection voList = new ims.careuk.vo.CatsReferralListVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.CatsReferralListVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.CatsReferralListVoCollection createCatsReferralListVoCollectionFromCatsReferral(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.CatsReferral objects.
	 */
	public static ims.careuk.vo.CatsReferralListVoCollection createCatsReferralListVoCollectionFromCatsReferral(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.CatsReferralListVoCollection voList = new ims.careuk.vo.CatsReferralListVoCollection();
	 ...
	 */
	 public static java.util.Set extractCatsReferralSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.CatsReferralListVoCollection voCollection) 
	 {
	 	return extractCatsReferralSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractCatsReferralSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.CatsReferralListVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.CatsReferralListVo vo = voCollection.get(i);
			ims.careuk.domain.objects.CatsReferral domainObject = CatsReferralListVoAssembler.extractCatsReferral(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractCatsReferralList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.CatsReferralListVoCollection voCollection) 
	 {
	 	return extractCatsReferralList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractCatsReferralList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.CatsReferralListVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.CatsReferralListVo create(ims.careuk.domain.objects.CatsReferral domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.CatsReferralListVo create(DomainObjectMap map, ims.careuk.domain.objects.CatsReferral domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.CatsReferralListVo valueObject = (ims.careuk.vo.CatsReferralListVo) map.getValueObject(domainObject, ims.careuk.vo.CatsReferralListVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.CatsReferralListVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.careuk.domain.objects.CatsReferral
	 */
	 public static ims.careuk.vo.CatsReferralListVo insert(ims.careuk.vo.CatsReferralListVo valueObject, ims.careuk.domain.objects.CatsReferral domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.careuk.domain.objects.CatsReferral
	 */
	 public static ims.careuk.vo.CatsReferralListVo insert(DomainObjectMap map, ims.careuk.vo.CatsReferralListVo valueObject, ims.careuk.domain.objects.CatsReferral domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// ReferralDetails
		valueObject.setReferralDetails(ims.careuk.vo.domain.ReferralLetterDetailsLiteVoAssembler.create(map, domainObject.getReferralDetails()) );
		// hasDocuments
		...
		if ( null != instance11 ) {
			...
			ims.careuk.vo.lookups.AdditionalInvestigationAppointmentsStatus voLookup11 = new ims.careuk.vo.lookups.AdditionalInvestigationAppointmentsStatus(instance11.getId(),instance11.getText(), instance11.isActive(), null, img, color);
			ims.careuk.vo.lookups.AdditionalInvestigationAppointmentsStatus parentVoLookup11 = voLookup11;
			...
			while (parent11 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup11.setParent(new ims.careuk.vo.lookups.AdditionalInvestigationAppointmentsStatus(parent11.getId(),parent11.getText(), parent11.isActive(), null, img, color));
		...
		if ( null != instance15 ) {
			...
			ims.careuk.vo.lookups.OnwardReferralStatus voLookup15 = new ims.careuk.vo.lookups.OnwardReferralStatus(instance15.getId(),instance15.getText(), instance15.isActive(), null, img, color);
			ims.careuk.vo.lookups.OnwardReferralStatus parentVoLookup15 = voLookup15;
			...
			while (parent15 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup15.setParent(new ims.careuk.vo.lookups.OnwardReferralStatus(parent15.getId(),parent15.getText(), parent15.isActive(), null, img, color));
	 ...
	 */
	public static ims.careuk.domain.objects.CatsReferral extractCatsReferral(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.CatsReferralListVo valueObject) 
	{
		return 	extractCatsReferral(domainFactory, valueObject, new HashMap());
	}

	public static ims.careuk.domain.objects.CatsReferral extractCatsReferral(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.CatsReferralListVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.CatsReferralListVo ID_CatsReferral field is unknown
	...
	ims.scheduling.domain.objects.Booking_Appointment value10 = null;
		...
		ims.careuk.domain.objects.ProviderCancellation value13 = null;
		if ( null != valueObject.getProviderCancellation() ) 
		{
			if (valueObject.getProviderCancellation().getBoId() == null)
			{
				...
				{
					value13 = (ims.careuk.domain.objects.ProviderCancellation)domMap.get(valueObject.getProviderCancellation());
				}
			}
			else if (valueObject.getBoVersion() == -1) // RefVo was not modified since obtained from the Assembler, no need to update the BO field
			{
			...
			{
				value13 = (ims.careuk.domain.objects.ProviderCancellation)domainFactory.getDomainObject(ims.careuk.domain.objects.ProviderCancellation.class, valueObject.getProviderCancellation().getBoId());
			}
		}
	...
	// SaveAsRefVO - treated as a refVo in extract methods
	ims.careuk.domain.objects.AwaitingClinicalInfo value27 = null;
		if ( null != valueObject.getAwaitingClinicalInfo() ) 
		{
			if (valueObject.getAwaitingClinicalInfo().getBoId() == null)
			{
				...
				{
					value27 = (ims.careuk.domain.objects.AwaitingClinicalInfo)domMap.get(valueObject.getAwaitingClinicalInfo());
				}
			}
			else
			{
				value27 = (ims.careuk.domain.objects.AwaitingClinicalInfo)domainFactory.getDomainObject(ims.careuk.domain.objects.AwaitingClinicalInfo.class, valueObject.getAwaitingClinicalInfo().getBoId());
			}
		}
		...
		domainObject.setContract(ims.careuk.vo.domain.ContractConfigShortVoAssembler.extractContractConfig(domainFactory, valueObject.getContract(), domMap));
