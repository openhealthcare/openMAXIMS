...
public class Booking_AppointmentElectiveListVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.Booking_AppointmentElectiveListVo copy(ims.careuk.vo.Booking_AppointmentElectiveListVo valueObjectDest, ims.careuk.vo.Booking_AppointmentElectiveListVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.Booking_AppointmentElectiveListVoCollection createBooking_AppointmentElectiveListVoCollectionFromBooking_Appointment(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.scheduling.domain.objects.Booking_Appointment objects.
	 */
	public static ims.careuk.vo.Booking_AppointmentElectiveListVoCollection createBooking_AppointmentElectiveListVoCollectionFromBooking_Appointment(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.Booking_AppointmentElectiveListVoCollection voList = new ims.careuk.vo.Booking_AppointmentElectiveListVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.Booking_AppointmentElectiveListVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.Booking_AppointmentElectiveListVoCollection createBooking_AppointmentElectiveListVoCollectionFromBooking_Appointment(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.scheduling.domain.objects.Booking_Appointment objects.
	 */
	public static ims.careuk.vo.Booking_AppointmentElectiveListVoCollection createBooking_AppointmentElectiveListVoCollectionFromBooking_Appointment(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.Booking_AppointmentElectiveListVoCollection voList = new ims.careuk.vo.Booking_AppointmentElectiveListVoCollection();
	 ...
	 */
	 public static java.util.Set extractBooking_AppointmentSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.Booking_AppointmentElectiveListVoCollection voCollection) 
	 {
	 	return extractBooking_AppointmentSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractBooking_AppointmentSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.Booking_AppointmentElectiveListVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.Booking_AppointmentElectiveListVo vo = voCollection.get(i);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractBooking_AppointmentList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.Booking_AppointmentElectiveListVoCollection voCollection) 
	 {
	 	return extractBooking_AppointmentList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractBooking_AppointmentList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.Booking_AppointmentElectiveListVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.Booking_AppointmentElectiveListVo create(ims.scheduling.domain.objects.Booking_Appointment domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.Booking_AppointmentElectiveListVo create(DomainObjectMap map, ims.scheduling.domain.objects.Booking_Appointment domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.Booking_AppointmentElectiveListVo valueObject = (ims.careuk.vo.Booking_AppointmentElectiveListVo) map.getValueObject(domainObject, ims.careuk.vo.Booking_AppointmentElectiveListVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.Booking_AppointmentElectiveListVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.scheduling.domain.objects.Booking_Appointment
	 */
	 public static ims.careuk.vo.Booking_AppointmentElectiveListVo insert(ims.careuk.vo.Booking_AppointmentElectiveListVo valueObject, ims.scheduling.domain.objects.Booking_Appointment domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.scheduling.domain.objects.Booking_Appointment
	 */
	 public static ims.careuk.vo.Booking_AppointmentElectiveListVo insert(DomainObjectMap map, ims.careuk.vo.Booking_AppointmentElectiveListVo valueObject, ims.scheduling.domain.objects.Booking_Appointment domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.scheduling.domain.objects.Booking_Appointment extractBooking_Appointment(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.Booking_AppointmentElectiveListVo valueObject) 
	{
		return 	extractBooking_Appointment(domainFactory, valueObject, new HashMap());
	}

	public static ims.scheduling.domain.objects.Booking_Appointment extractBooking_Appointment(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.Booking_AppointmentElectiveListVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.Booking_AppointmentElectiveListVo ID_Booking_Appointment field is unknown
