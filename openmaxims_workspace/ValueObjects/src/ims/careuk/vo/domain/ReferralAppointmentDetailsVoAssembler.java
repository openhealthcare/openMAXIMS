...
public class ReferralAppointmentDetailsVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.ReferralAppointmentDetailsVo copy(ims.careuk.vo.ReferralAppointmentDetailsVo valueObjectDest, ims.careuk.vo.ReferralAppointmentDetailsVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.ReferralAppointmentDetailsVoCollection createReferralAppointmentDetailsVoCollectionFromCatsReferral(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.CatsReferral objects.
	 */
	public static ims.careuk.vo.ReferralAppointmentDetailsVoCollection createReferralAppointmentDetailsVoCollectionFromCatsReferral(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.ReferralAppointmentDetailsVoCollection voList = new ims.careuk.vo.ReferralAppointmentDetailsVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.ReferralAppointmentDetailsVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.ReferralAppointmentDetailsVoCollection createReferralAppointmentDetailsVoCollectionFromCatsReferral(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.CatsReferral objects.
	 */
	public static ims.careuk.vo.ReferralAppointmentDetailsVoCollection createReferralAppointmentDetailsVoCollectionFromCatsReferral(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.ReferralAppointmentDetailsVoCollection voList = new ims.careuk.vo.ReferralAppointmentDetailsVoCollection();
	 ...
	 */
	 public static java.util.Set extractCatsReferralSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralAppointmentDetailsVoCollection voCollection) 
	 {
	 	return extractCatsReferralSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractCatsReferralSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralAppointmentDetailsVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.ReferralAppointmentDetailsVo vo = voCollection.get(i);
			ims.careuk.domain.objects.CatsReferral domainObject = ReferralAppointmentDetailsVoAssembler.extractCatsReferral(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractCatsReferralList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralAppointmentDetailsVoCollection voCollection) 
	 {
	 	return extractCatsReferralList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractCatsReferralList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralAppointmentDetailsVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.ReferralAppointmentDetailsVo create(ims.careuk.domain.objects.CatsReferral domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.ReferralAppointmentDetailsVo create(DomainObjectMap map, ims.careuk.domain.objects.CatsReferral domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.ReferralAppointmentDetailsVo valueObject = (ims.careuk.vo.ReferralAppointmentDetailsVo) map.getValueObject(domainObject, ims.careuk.vo.ReferralAppointmentDetailsVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.ReferralAppointmentDetailsVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.careuk.domain.objects.CatsReferral
	 */
	 public static ims.careuk.vo.ReferralAppointmentDetailsVo insert(ims.careuk.vo.ReferralAppointmentDetailsVo valueObject, ims.careuk.domain.objects.CatsReferral domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.careuk.domain.objects.CatsReferral
	 */
	 public static ims.careuk.vo.ReferralAppointmentDetailsVo insert(DomainObjectMap map, ims.careuk.vo.ReferralAppointmentDetailsVo valueObject, ims.careuk.domain.objects.CatsReferral domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// ReferralDetails
		valueObject.setReferralDetails(ims.careuk.vo.domain.ReferralLetterDetailsLiteWithGPVoAssembler.create(map, domainObject.getReferralDetails()) );
		// InvestigationOrders
		...
		// OrderInvAppts
		valueObject.setOrderInvAppts(ims.careuk.vo.domain.OrderInvApptListVoAssembler.createOrderInvApptListVoCollectionFromOrderInvAppt(map, domainObject.getOrderInvAppts()) );
		// ICABReferral
		valueObject.setICABReferral(ims.admin.vo.domain.ICABReferralListVoAssembler.create(map, domainObject.getICABReferral()) );
		// OutpatientEROD
		valueObject.setOutpatientEROD(ims.careuk.vo.domain.ReferralERODVoAssembler.createReferralERODVoCollectionFromReferralEROD(map, domainObject.getOutpatientEROD()) );
		// ElectiveEROD
		valueObject.setElectiveEROD(ims.careuk.vo.domain.ReferralERODVoAssembler.createReferralERODVoCollectionFromReferralEROD(map, domainObject.getElectiveEROD()) );
		// CurrentRTTStatus
	 ...
	 */
	public static ims.careuk.domain.objects.CatsReferral extractCatsReferral(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralAppointmentDetailsVo valueObject) 
	{
		return 	extractCatsReferral(domainFactory, valueObject, new HashMap());
	}

	public static ims.careuk.domain.objects.CatsReferral extractCatsReferral(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralAppointmentDetailsVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.ReferralAppointmentDetailsVo ID_CatsReferral field is unknown
		...
		domainObject.setReferralDetails(ims.careuk.vo.domain.ReferralLetterDetailsLiteWithGPVoAssembler.extractReferralLetterDetails(domainFactory, valueObject.getReferralDetails(), domMap));
		...
		domainObject.setOrderInvAppts(ims.careuk.vo.domain.OrderInvApptListVoAssembler.extractOrderInvApptSet(domainFactory, valueObject.getOrderInvAppts(), domainObject.getOrderInvAppts(), domMap));		
		...
		ims.careuk.vo.ReferralERODRefVoCollection refCollection8 = new ims.careuk.vo.ReferralERODRefVoCollection();
		if (valueObject.getOutpatientEROD() != null)
		{
			for (int i8=0; i8<valueObject.getOutpatientEROD().size(); i8++)
			{
				ims.careuk.vo.ReferralERODRefVo ref8 = (ims.careuk.vo.ReferralERODRefVo)valueObject.getOutpatientEROD().get(i8);
		...
		{
			ims.careuk.vo.ReferralERODRefVo vo = refCollection8.get(i);			
		...
		// SaveAsRefVO treated as RefValueObject
		ims.careuk.vo.ReferralERODRefVoCollection refCollection9 = new ims.careuk.vo.ReferralERODRefVoCollection();
		if (valueObject.getElectiveEROD() != null)
		{
			for (int i9=0; i9<valueObject.getElectiveEROD().size(); i9++)
			{
				ims.careuk.vo.ReferralERODRefVo ref9 = (ims.careuk.vo.ReferralERODRefVo)valueObject.getElectiveEROD().get(i9);
		...
		{
			ims.careuk.vo.ReferralERODRefVo vo = refCollection9.get(i);			
			ims.careuk.domain.objects.ReferralEROD dom = null;
			if ( null != vo ) 
			{
				if (vo.getBoId() == null)
