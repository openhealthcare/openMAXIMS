...
public class ReferralLetterDetailsForNewPatientElectiveListVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.ReferralLetterDetailsForNewPatientElectiveListVo copy(ims.careuk.vo.ReferralLetterDetailsForNewPatientElectiveListVo valueObjectDest, ims.careuk.vo.ReferralLetterDetailsForNewPatientElectiveListVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.ReferralLetterDetailsForNewPatientElectiveListVoCollection createReferralLetterDetailsForNewPatientElectiveListVoCollectionFromReferralLetterDetails(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.core.clinical.domain.objects.ReferralLetterDetails objects.
	 */
	public static ims.careuk.vo.ReferralLetterDetailsForNewPatientElectiveListVoCollection createReferralLetterDetailsForNewPatientElectiveListVoCollectionFromReferralLetterDetails(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.ReferralLetterDetailsForNewPatientElectiveListVoCollection voList = new ims.careuk.vo.ReferralLetterDetailsForNewPatientElectiveListVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.ReferralLetterDetailsForNewPatientElectiveListVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.ReferralLetterDetailsForNewPatientElectiveListVoCollection createReferralLetterDetailsForNewPatientElectiveListVoCollectionFromReferralLetterDetails(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.core.clinical.domain.objects.ReferralLetterDetails objects.
	 */
	public static ims.careuk.vo.ReferralLetterDetailsForNewPatientElectiveListVoCollection createReferralLetterDetailsForNewPatientElectiveListVoCollectionFromReferralLetterDetails(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.ReferralLetterDetailsForNewPatientElectiveListVoCollection voList = new ims.careuk.vo.ReferralLetterDetailsForNewPatientElectiveListVoCollection();
	 ...
	 */
	 public static java.util.Set extractReferralLetterDetailsSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralLetterDetailsForNewPatientElectiveListVoCollection voCollection) 
	 {
	 	return extractReferralLetterDetailsSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractReferralLetterDetailsSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralLetterDetailsForNewPatientElectiveListVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.ReferralLetterDetailsForNewPatientElectiveListVo vo = voCollection.get(i);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractReferralLetterDetailsList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralLetterDetailsForNewPatientElectiveListVoCollection voCollection) 
	 {
	 	return extractReferralLetterDetailsList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractReferralLetterDetailsList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralLetterDetailsForNewPatientElectiveListVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.ReferralLetterDetailsForNewPatientElectiveListVo create(ims.core.clinical.domain.objects.ReferralLetterDetails domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.ReferralLetterDetailsForNewPatientElectiveListVo create(DomainObjectMap map, ims.core.clinical.domain.objects.ReferralLetterDetails domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.ReferralLetterDetailsForNewPatientElectiveListVo valueObject = (ims.careuk.vo.ReferralLetterDetailsForNewPatientElectiveListVo) map.getValueObject(domainObject, ims.careuk.vo.ReferralLetterDetailsForNewPatientElectiveListVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.ReferralLetterDetailsForNewPatientElectiveListVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.ReferralLetterDetails
	 */
	 public static ims.careuk.vo.ReferralLetterDetailsForNewPatientElectiveListVo insert(ims.careuk.vo.ReferralLetterDetailsForNewPatientElectiveListVo valueObject, ims.core.clinical.domain.objects.ReferralLetterDetails domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.ReferralLetterDetails
	 */
	 public static ims.careuk.vo.ReferralLetterDetailsForNewPatientElectiveListVo insert(DomainObjectMap map, ims.careuk.vo.ReferralLetterDetailsForNewPatientElectiveListVo valueObject, ims.core.clinical.domain.objects.ReferralLetterDetails domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.clinical.domain.objects.ReferralLetterDetails extractReferralLetterDetails(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralLetterDetailsForNewPatientElectiveListVo valueObject) 
	{
		return 	extractReferralLetterDetails(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.clinical.domain.objects.ReferralLetterDetails extractReferralLetterDetails(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralLetterDetailsForNewPatientElectiveListVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.ReferralLetterDetailsForNewPatientElectiveListVo ID_ReferralLetterDetails field is unknown
