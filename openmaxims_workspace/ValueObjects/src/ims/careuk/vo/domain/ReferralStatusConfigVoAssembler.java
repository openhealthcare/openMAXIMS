...
public class ReferralStatusConfigVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.ReferralStatusConfigVo copy(ims.careuk.vo.ReferralStatusConfigVo valueObjectDest, ims.careuk.vo.ReferralStatusConfigVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.ReferralStatusConfigVoCollection createReferralStatusConfigVoCollectionFromReferralStatusConfig(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.core.admin.domain.objects.ReferralStatusConfig objects.
	 */
	public static ims.careuk.vo.ReferralStatusConfigVoCollection createReferralStatusConfigVoCollectionFromReferralStatusConfig(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.ReferralStatusConfigVoCollection voList = new ims.careuk.vo.ReferralStatusConfigVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.ReferralStatusConfigVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.ReferralStatusConfigVoCollection createReferralStatusConfigVoCollectionFromReferralStatusConfig(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.core.admin.domain.objects.ReferralStatusConfig objects.
	 */
	public static ims.careuk.vo.ReferralStatusConfigVoCollection createReferralStatusConfigVoCollectionFromReferralStatusConfig(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.ReferralStatusConfigVoCollection voList = new ims.careuk.vo.ReferralStatusConfigVoCollection();
	 ...
	 */
	 public static java.util.Set extractReferralStatusConfigSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralStatusConfigVoCollection voCollection) 
	 {
	 	return extractReferralStatusConfigSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractReferralStatusConfigSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralStatusConfigVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.ReferralStatusConfigVo vo = voCollection.get(i);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractReferralStatusConfigList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralStatusConfigVoCollection voCollection) 
	 {
	 	return extractReferralStatusConfigList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractReferralStatusConfigList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralStatusConfigVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.ReferralStatusConfigVo create(ims.core.admin.domain.objects.ReferralStatusConfig domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.ReferralStatusConfigVo create(DomainObjectMap map, ims.core.admin.domain.objects.ReferralStatusConfig domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.ReferralStatusConfigVo valueObject = (ims.careuk.vo.ReferralStatusConfigVo) map.getValueObject(domainObject, ims.careuk.vo.ReferralStatusConfigVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.ReferralStatusConfigVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.admin.domain.objects.ReferralStatusConfig
	 */
	 public static ims.careuk.vo.ReferralStatusConfigVo insert(ims.careuk.vo.ReferralStatusConfigVo valueObject, ims.core.admin.domain.objects.ReferralStatusConfig domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.admin.domain.objects.ReferralStatusConfig
	 */
	 public static ims.careuk.vo.ReferralStatusConfigVo insert(DomainObjectMap map, ims.careuk.vo.ReferralStatusConfigVo valueObject, ims.core.admin.domain.objects.ReferralStatusConfig domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		ims.careuk.vo.lookups.ReferralApptStatusCollection LinkedReferralStatus = new ims.careuk.vo.lookups.ReferralApptStatusCollection();
		for(java.util.Iterator iterator = listLinkedReferralStatus.iterator(); iterator.hasNext(); ) 
		{
			...
			if (color != null) 
				color.getValue();
			ims.careuk.vo.lookups.ReferralApptStatus voInstance = new ims.careuk.vo.lookups.ReferralApptStatus(instance.getId(),instance.getText(), instance.isActive(), null, img, color);
			ims.careuk.vo.lookups.ReferralApptStatus parentVoInstance = voInstance;
			...
			while (parent != null)
			{
				...
				if (color != null) 
					color.getValue();
								parentVoInstance.setParent(new ims.careuk.vo.lookups.ReferralApptStatus(parent.getId(),parent.getText(), parent.isActive(), null, img, color));
	 ...
	 */
	public static ims.core.admin.domain.objects.ReferralStatusConfig extractReferralStatusConfig(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralStatusConfigVo valueObject) 
	{
		return 	extractReferralStatusConfig(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.admin.domain.objects.ReferralStatusConfig extractReferralStatusConfig(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralStatusConfigVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.ReferralStatusConfigVo ID_ReferralStatusConfig field is unknown
		...
		ims.careuk.vo.lookups.ReferralApptStatusCollection collection2 =
