...
public class PathwayClockForReferralERODVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.PathwayClockForReferralERODVo copy(ims.careuk.vo.PathwayClockForReferralERODVo valueObjectDest, ims.careuk.vo.PathwayClockForReferralERODVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.PathwayClockForReferralERODVoCollection createPathwayClockForReferralERODVoCollectionFromPathwayClock(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.pathways.domain.objects.PathwayClock objects.
	 */
	public static ims.careuk.vo.PathwayClockForReferralERODVoCollection createPathwayClockForReferralERODVoCollectionFromPathwayClock(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.PathwayClockForReferralERODVoCollection voList = new ims.careuk.vo.PathwayClockForReferralERODVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.PathwayClockForReferralERODVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.PathwayClockForReferralERODVoCollection createPathwayClockForReferralERODVoCollectionFromPathwayClock(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.pathways.domain.objects.PathwayClock objects.
	 */
	public static ims.careuk.vo.PathwayClockForReferralERODVoCollection createPathwayClockForReferralERODVoCollectionFromPathwayClock(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.PathwayClockForReferralERODVoCollection voList = new ims.careuk.vo.PathwayClockForReferralERODVoCollection();
	 ...
	 */
	 public static java.util.Set extractPathwayClockSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PathwayClockForReferralERODVoCollection voCollection) 
	 {
	 	return extractPathwayClockSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPathwayClockSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PathwayClockForReferralERODVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.PathwayClockForReferralERODVo vo = voCollection.get(i);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPathwayClockList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PathwayClockForReferralERODVoCollection voCollection) 
	 {
	 	return extractPathwayClockList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPathwayClockList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PathwayClockForReferralERODVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.PathwayClockForReferralERODVo create(ims.pathways.domain.objects.PathwayClock domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.PathwayClockForReferralERODVo create(DomainObjectMap map, ims.pathways.domain.objects.PathwayClock domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.PathwayClockForReferralERODVo valueObject = (ims.careuk.vo.PathwayClockForReferralERODVo) map.getValueObject(domainObject, ims.careuk.vo.PathwayClockForReferralERODVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.PathwayClockForReferralERODVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.pathways.domain.objects.PathwayClock
	 */
	 public static ims.careuk.vo.PathwayClockForReferralERODVo insert(ims.careuk.vo.PathwayClockForReferralERODVo valueObject, ims.pathways.domain.objects.PathwayClock domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.pathways.domain.objects.PathwayClock
	 */
	 public static ims.careuk.vo.PathwayClockForReferralERODVo insert(DomainObjectMap map, ims.careuk.vo.PathwayClockForReferralERODVo valueObject, ims.pathways.domain.objects.PathwayClock domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.pathways.domain.objects.PathwayClock extractPathwayClock(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PathwayClockForReferralERODVo valueObject) 
	{
		return 	extractPathwayClock(domainFactory, valueObject, new HashMap());
	}

	public static ims.pathways.domain.objects.PathwayClock extractPathwayClock(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PathwayClockForReferralERODVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.PathwayClockForReferralERODVo ID_PathwayClock field is unknown
