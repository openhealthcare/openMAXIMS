 ...
 */
public class ReferralERODForBookAppointmentVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.careuk.vo.ReferralERODForBookAppointmentVo copy(ims.careuk.vo.ReferralERODForBookAppointmentVo valueObjectDest, ims.careuk.vo.ReferralERODForBookAppointmentVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createReferralERODForBookAppointmentVoCollectionFromReferralEROD(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.ReferralEROD objects.
	 */
	public static ims.careuk.vo.ReferralERODForBookAppointmentVoCollection createReferralERODForBookAppointmentVoCollectionFromReferralEROD(java.util.Set domainObjectSet)	
	{
		return createReferralERODForBookAppointmentVoCollectionFromReferralEROD(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.ReferralEROD objects.
	 */
	public static ims.careuk.vo.ReferralERODForBookAppointmentVoCollection createReferralERODForBookAppointmentVoCollectionFromReferralEROD(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.ReferralERODForBookAppointmentVoCollection voList = new ims.careuk.vo.ReferralERODForBookAppointmentVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.ReferralERODForBookAppointmentVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.ReferralERODForBookAppointmentVoCollection createReferralERODForBookAppointmentVoCollectionFromReferralEROD(java.util.List domainObjectList) 
	{
		return createReferralERODForBookAppointmentVoCollectionFromReferralEROD(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.ReferralEROD objects.
	 */
	public static ims.careuk.vo.ReferralERODForBookAppointmentVoCollection createReferralERODForBookAppointmentVoCollectionFromReferralEROD(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.ReferralERODForBookAppointmentVoCollection voList = new ims.careuk.vo.ReferralERODForBookAppointmentVoCollection();
	 ...
	 */
	 ...
	 public static java.util.Set extractReferralERODSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralERODForBookAppointmentVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.ReferralERODForBookAppointmentVo vo = voCollection.get(i);
			ims.careuk.domain.objects.ReferralEROD domainObject = ReferralERODForBookAppointmentVoAssembler.extractReferralEROD(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractReferralERODList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralERODForBookAppointmentVoCollection voCollection) 
	 {
	 	return extractReferralERODList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractReferralERODList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralERODForBookAppointmentVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.ReferralERODForBookAppointmentVo create(ims.careuk.domain.objects.ReferralEROD domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.ReferralERODForBookAppointmentVo create(DomainObjectMap map, ims.careuk.domain.objects.ReferralEROD domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.ReferralERODForBookAppointmentVo valueObject = (ims.careuk.vo.ReferralERODForBookAppointmentVo) map.getValueObject(domainObject, ims.careuk.vo.ReferralERODForBookAppointmentVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.ReferralERODForBookAppointmentVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.careuk.domain.objects.ReferralEROD
	 */
	 public static ims.careuk.vo.ReferralERODForBookAppointmentVo insert(ims.careuk.vo.ReferralERODForBookAppointmentVo valueObject, ims.careuk.domain.objects.ReferralEROD domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.careuk.domain.objects.ReferralEROD
	 */
	 public static ims.careuk.vo.ReferralERODForBookAppointmentVo insert(DomainObjectMap map, ims.careuk.vo.ReferralERODForBookAppointmentVo valueObject, ims.careuk.domain.objects.ReferralEROD domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.careuk.domain.objects.ReferralEROD extractReferralEROD(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralERODForBookAppointmentVo valueObject) 
	{
		return 	extractReferralEROD(domainFactory, valueObject, new HashMap());
	}

	public static ims.careuk.domain.objects.ReferralEROD extractReferralEROD(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralERODForBookAppointmentVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.ReferralERODForBookAppointmentVo ID_ReferralEROD field is unknown
