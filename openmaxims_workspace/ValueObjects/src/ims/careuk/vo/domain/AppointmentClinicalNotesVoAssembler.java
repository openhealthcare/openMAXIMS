...
public class AppointmentClinicalNotesVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.AppointmentClinicalNotesVo copy(ims.careuk.vo.AppointmentClinicalNotesVo valueObjectDest, ims.careuk.vo.AppointmentClinicalNotesVo valueObjectSrc) 
	 {
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.AppointmentClinicalNotes objects.
	 */
	public static ims.careuk.vo.AppointmentClinicalNotesVoCollection createAppointmentClinicalNotesVoCollectionFromAppointmentClinicalNotes(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.AppointmentClinicalNotes objects.
	 */
	public static ims.careuk.vo.AppointmentClinicalNotesVoCollection createAppointmentClinicalNotesVoCollectionFromAppointmentClinicalNotes(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.AppointmentClinicalNotesVoCollection voList = new ims.careuk.vo.AppointmentClinicalNotesVoCollection();
		...
		{
			ims.careuk.domain.objects.AppointmentClinicalNotes domainObject = (ims.careuk.domain.objects.AppointmentClinicalNotes) iterator.next();
			ims.careuk.vo.AppointmentClinicalNotesVo vo = create(map, domainObject);
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.AppointmentClinicalNotes objects.
	 */
	public static ims.careuk.vo.AppointmentClinicalNotesVoCollection createAppointmentClinicalNotesVoCollectionFromAppointmentClinicalNotes(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.AppointmentClinicalNotes objects.
	 */
	public static ims.careuk.vo.AppointmentClinicalNotesVoCollection createAppointmentClinicalNotesVoCollectionFromAppointmentClinicalNotes(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.AppointmentClinicalNotesVoCollection voList = new ims.careuk.vo.AppointmentClinicalNotesVoCollection();
		...
		{
			ims.careuk.domain.objects.AppointmentClinicalNotes domainObject = (ims.careuk.domain.objects.AppointmentClinicalNotes) domainObjectList.get(i);
			ims.careuk.vo.AppointmentClinicalNotesVo vo = create(map, domainObject);
	...
	/**
	 * Create the ims.careuk.domain.objects.AppointmentClinicalNotes set from the value object collection.
	 * @param domainFactory - used to create existing (persistent) domain objects.
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.Set extractAppointmentClinicalNotesSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.AppointmentClinicalNotesVoCollection voCollection) 
	 {
	 	return extractAppointmentClinicalNotesSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractAppointmentClinicalNotesSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.AppointmentClinicalNotesVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.AppointmentClinicalNotesVo vo = voCollection.get(i);
			ims.careuk.domain.objects.AppointmentClinicalNotes domainObject = AppointmentClinicalNotesVoAssembler.extractAppointmentClinicalNotes(domainFactory, vo, domMap);
	...
	/**
	 * Create the ims.careuk.domain.objects.AppointmentClinicalNotes list from the value object collection.
	 * @param domainFactory - used to create existing (persistent) domain objects.
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractAppointmentClinicalNotesList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.AppointmentClinicalNotesVoCollection voCollection) 
	 {
	 	return extractAppointmentClinicalNotesList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractAppointmentClinicalNotesList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.AppointmentClinicalNotesVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	...
	/**
	 * Create the ValueObject from the ims.careuk.domain.objects.AppointmentClinicalNotes object.
	 * @param domainObject ims.careuk.domain.objects.AppointmentClinicalNotes
	 */
	 public static ims.careuk.vo.AppointmentClinicalNotesVo create(ims.careuk.domain.objects.AppointmentClinicalNotes domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.AppointmentClinicalNotesVo create(DomainObjectMap map, ims.careuk.domain.objects.AppointmentClinicalNotes domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.AppointmentClinicalNotesVo valueObject = (ims.careuk.vo.AppointmentClinicalNotesVo) map.getValueObject(domainObject, ims.careuk.vo.AppointmentClinicalNotesVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.AppointmentClinicalNotesVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.careuk.domain.objects.AppointmentClinicalNotes
	 */
	 public static ims.careuk.vo.AppointmentClinicalNotesVo insert(ims.careuk.vo.AppointmentClinicalNotesVo valueObject, ims.careuk.domain.objects.AppointmentClinicalNotes domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.careuk.domain.objects.AppointmentClinicalNotes
	 */
	 public static ims.careuk.vo.AppointmentClinicalNotesVo insert(DomainObjectMap map, ims.careuk.vo.AppointmentClinicalNotesVo valueObject, ims.careuk.domain.objects.AppointmentClinicalNotes domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		if ( null != instance4 ) {
			...
			ims.careuk.vo.lookups.ClinicalNoteTypeForAnAppointment voLookup4 = new ims.careuk.vo.lookups.ClinicalNoteTypeForAnAppointment(instance4.getId(),instance4.getText(), instance4.isActive(), null, img, color);
			ims.careuk.vo.lookups.ClinicalNoteTypeForAnAppointment parentVoLookup4 = voLookup4;
			...
			while (parent4 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup4.setParent(new ims.careuk.vo.lookups.ClinicalNoteTypeForAnAppointment(parent4.getId(),parent4.getText(), parent4.isActive(), null, img, color));
		...
		if ( null != instance8 ) {
			...
			ims.careuk.vo.lookups.ReportNoteType voLookup8 = new ims.careuk.vo.lookups.ReportNoteType(instance8.getId(),instance8.getText(), instance8.isActive(), null, img, color);
			ims.careuk.vo.lookups.ReportNoteType parentVoLookup8 = voLookup8;
			...
			while (parent8 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup8.setParent(new ims.careuk.vo.lookups.ReportNoteType(parent8.getId(),parent8.getText(), parent8.isActive(), null, img, color));
		...
		if ( null != instance9 ) {
			...
			ims.careuk.vo.lookups.ReportNoteStatus voLookup9 = new ims.careuk.vo.lookups.ReportNoteStatus(instance9.getId(),instance9.getText(), instance9.isActive(), null, img, color);
			ims.careuk.vo.lookups.ReportNoteStatus parentVoLookup9 = voLookup9;
			...
			while (parent9 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup9.setParent(new ims.careuk.vo.lookups.ReportNoteStatus(parent9.getId(),parent9.getText(), parent9.isActive(), null, img, color));
	 ...
	 */
	public static ims.careuk.domain.objects.AppointmentClinicalNotes extractAppointmentClinicalNotes(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.AppointmentClinicalNotesVo valueObject) 
	{
		return 	extractAppointmentClinicalNotes(domainFactory, valueObject, new HashMap());
	}

	public static ims.careuk.domain.objects.AppointmentClinicalNotes extractAppointmentClinicalNotes(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.AppointmentClinicalNotesVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		ims.careuk.domain.objects.AppointmentClinicalNotes domainObject = null;
		if ( null == id) 
		{
			if (domMap.get(valueObject) != null)
			{
				return (ims.careuk.domain.objects.AppointmentClinicalNotes)domMap.get(valueObject);
			}
			// ims.careuk.vo.AppointmentClinicalNotesVo ID_AppointmentClinicalNotes field is unknown
			domainObject = new ims.careuk.domain.objects.AppointmentClinicalNotes();
		...
		else 
		{
			...
			{
				return (ims.careuk.domain.objects.AppointmentClinicalNotes)domMap.get(key);
			}
			domainObject = (ims.careuk.domain.objects.AppointmentClinicalNotes) domainFactory.getDomainObject(ims.careuk.domain.objects.AppointmentClinicalNotes.class, id );
