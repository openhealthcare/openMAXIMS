 ...
 */
public class PatientElectiveListLiteVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.careuk.vo.PatientElectiveListLiteVo copy(ims.careuk.vo.PatientElectiveListLiteVo valueObjectDest, ims.careuk.vo.PatientElectiveListLiteVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createPatientElectiveListLiteVoCollectionFromPatientElectiveList(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.PatientElectiveList objects.
	 */
	public static ims.careuk.vo.PatientElectiveListLiteVoCollection createPatientElectiveListLiteVoCollectionFromPatientElectiveList(java.util.Set domainObjectSet)	
	{
		return createPatientElectiveListLiteVoCollectionFromPatientElectiveList(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.PatientElectiveList objects.
	 */
	public static ims.careuk.vo.PatientElectiveListLiteVoCollection createPatientElectiveListLiteVoCollectionFromPatientElectiveList(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.PatientElectiveListLiteVoCollection voList = new ims.careuk.vo.PatientElectiveListLiteVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.PatientElectiveListLiteVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.PatientElectiveListLiteVoCollection createPatientElectiveListLiteVoCollectionFromPatientElectiveList(java.util.List domainObjectList) 
	{
		return createPatientElectiveListLiteVoCollectionFromPatientElectiveList(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.PatientElectiveList objects.
	 */
	public static ims.careuk.vo.PatientElectiveListLiteVoCollection createPatientElectiveListLiteVoCollectionFromPatientElectiveList(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.PatientElectiveListLiteVoCollection voList = new ims.careuk.vo.PatientElectiveListLiteVoCollection();
	 ...
	 */
	 public static java.util.Set extractPatientElectiveListSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListLiteVoCollection voCollection) 
	 {
	 	return extractPatientElectiveListSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientElectiveListSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListLiteVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.PatientElectiveListLiteVo vo = voCollection.get(i);
			ims.careuk.domain.objects.PatientElectiveList domainObject = PatientElectiveListLiteVoAssembler.extractPatientElectiveList(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPatientElectiveListList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListLiteVoCollection voCollection) 
	 {
	 	return extractPatientElectiveListList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPatientElectiveListList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListLiteVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.PatientElectiveListLiteVo create(ims.careuk.domain.objects.PatientElectiveList domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.PatientElectiveListLiteVo create(DomainObjectMap map, ims.careuk.domain.objects.PatientElectiveList domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.PatientElectiveListLiteVo valueObject = (ims.careuk.vo.PatientElectiveListLiteVo) map.getValueObject(domainObject, ims.careuk.vo.PatientElectiveListLiteVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.PatientElectiveListLiteVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.careuk.domain.objects.PatientElectiveList
	 */
	 public static ims.careuk.vo.PatientElectiveListLiteVo insert(ims.careuk.vo.PatientElectiveListLiteVo valueObject, ims.careuk.domain.objects.PatientElectiveList domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.careuk.domain.objects.PatientElectiveList
	 */
	 public static ims.careuk.vo.PatientElectiveListLiteVo insert(DomainObjectMap map, ims.careuk.vo.PatientElectiveListLiteVo valueObject, ims.careuk.domain.objects.PatientElectiveList domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// ElectiveListStatus
		valueObject.setElectiveListStatus(ims.careuk.vo.domain.ElectiveListStatusForBookTheatreVoAssembler.create(map, domainObject.getElectiveListStatus()) );
		// PrimaryProcedure
	 ...
	 */
	public static ims.careuk.domain.objects.PatientElectiveList extractPatientElectiveList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListLiteVo valueObject) 
	{
		return 	extractPatientElectiveList(domainFactory, valueObject, new HashMap());
	}

	public static ims.careuk.domain.objects.PatientElectiveList extractPatientElectiveList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListLiteVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.PatientElectiveListLiteVo ID_PatientElectiveList field is unknown
	...
	// SaveAsRefVO - treated as a refVo in extract methods
	ims.careuk.domain.objects.ElectiveListStatus value3 = null;
		if ( null != valueObject.getElectiveListStatus() ) 
		{
			if (valueObject.getElectiveListStatus().getBoId() == null)
			{
				if (domMap.get(valueObject.getElectiveListStatus()) != null)
				{
					value3 = (ims.careuk.domain.objects.ElectiveListStatus)domMap.get(valueObject.getElectiveListStatus());
				}
			}
			else
			{
				value3 = (ims.careuk.domain.objects.ElectiveListStatus)domainFactory.getDomainObject(ims.careuk.domain.objects.ElectiveListStatus.class, valueObject.getElectiveListStatus().getBoId());
			}
		}
		domainObject.setElectiveListStatus(value3);
	// SaveAsRefVO - treated as a refVo in extract methods
