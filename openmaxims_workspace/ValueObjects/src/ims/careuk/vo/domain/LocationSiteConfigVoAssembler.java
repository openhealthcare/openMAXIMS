...
public class LocationSiteConfigVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.LocationSiteConfigVo copy(ims.careuk.vo.LocationSiteConfigVo valueObjectDest, ims.careuk.vo.LocationSiteConfigVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.LocationSiteConfigVoCollection createLocationSiteConfigVoCollectionFromLocSite(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.core.resource.place.domain.objects.LocSite objects.
	 */
	public static ims.careuk.vo.LocationSiteConfigVoCollection createLocationSiteConfigVoCollectionFromLocSite(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.LocationSiteConfigVoCollection voList = new ims.careuk.vo.LocationSiteConfigVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.LocationSiteConfigVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.LocationSiteConfigVoCollection createLocationSiteConfigVoCollectionFromLocSite(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.core.resource.place.domain.objects.LocSite objects.
	 */
	public static ims.careuk.vo.LocationSiteConfigVoCollection createLocationSiteConfigVoCollectionFromLocSite(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.LocationSiteConfigVoCollection voList = new ims.careuk.vo.LocationSiteConfigVoCollection();
	 ...
	 */
	 public static java.util.Set extractLocSiteSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.LocationSiteConfigVoCollection voCollection) 
	 {
	 	return extractLocSiteSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractLocSiteSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.LocationSiteConfigVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.LocationSiteConfigVo vo = voCollection.get(i);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractLocSiteList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.LocationSiteConfigVoCollection voCollection) 
	 {
	 	return extractLocSiteList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractLocSiteList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.LocationSiteConfigVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.LocationSiteConfigVo create(ims.core.resource.place.domain.objects.LocSite domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.LocationSiteConfigVo create(DomainObjectMap map, ims.core.resource.place.domain.objects.LocSite domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.LocationSiteConfigVo valueObject = (ims.careuk.vo.LocationSiteConfigVo) map.getValueObject(domainObject, ims.careuk.vo.LocationSiteConfigVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.LocationSiteConfigVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.resource.place.domain.objects.LocSite
	 */
	 public static ims.careuk.vo.LocationSiteConfigVo insert(ims.careuk.vo.LocationSiteConfigVo valueObject, ims.core.resource.place.domain.objects.LocSite domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.resource.place.domain.objects.LocSite
	 */
	 public static ims.careuk.vo.LocationSiteConfigVo insert(DomainObjectMap map, ims.careuk.vo.LocationSiteConfigVo valueObject, ims.core.resource.place.domain.objects.LocSite domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// Locations
		valueObject.setLocations(ims.careuk.vo.domain.LocationConfigVoAssembler.createLocationConfigVoCollectionFromLocation(map, domainObject.getLocations()) );
		// Name
	 ...
	 */
	public static ims.core.resource.place.domain.objects.LocSite extractLocSite(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.LocationSiteConfigVo valueObject) 
	{
		return 	extractLocSite(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.resource.place.domain.objects.LocSite extractLocSite(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.LocationSiteConfigVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.LocationSiteConfigVo ID_LocSite field is unknown
