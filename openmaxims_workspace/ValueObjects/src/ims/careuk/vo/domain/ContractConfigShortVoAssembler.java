 ...
 */
public class ContractConfigShortVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.careuk.vo.ContractConfigShortVo copy(ims.careuk.vo.ContractConfigShortVo valueObjectDest, ims.careuk.vo.ContractConfigShortVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createContractConfigShortVoCollectionFromContractConfig(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.configuration.domain.objects.ContractConfig objects.
	 */
	public static ims.careuk.vo.ContractConfigShortVoCollection createContractConfigShortVoCollectionFromContractConfig(java.util.Set domainObjectSet)	
	{
		return createContractConfigShortVoCollectionFromContractConfig(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.configuration.domain.objects.ContractConfig objects.
	 */
	public static ims.careuk.vo.ContractConfigShortVoCollection createContractConfigShortVoCollectionFromContractConfig(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.ContractConfigShortVoCollection voList = new ims.careuk.vo.ContractConfigShortVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.ContractConfigShortVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.ContractConfigShortVoCollection createContractConfigShortVoCollectionFromContractConfig(java.util.List domainObjectList) 
	{
		return createContractConfigShortVoCollectionFromContractConfig(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.configuration.domain.objects.ContractConfig objects.
	 */
	public static ims.careuk.vo.ContractConfigShortVoCollection createContractConfigShortVoCollectionFromContractConfig(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.ContractConfigShortVoCollection voList = new ims.careuk.vo.ContractConfigShortVoCollection();
	 ...
	 */
	 public static java.util.Set extractContractConfigSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ContractConfigShortVoCollection voCollection) 
	 {
	 	return extractContractConfigSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractContractConfigSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ContractConfigShortVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.ContractConfigShortVo vo = voCollection.get(i);
			ims.core.configuration.domain.objects.ContractConfig domainObject = ContractConfigShortVoAssembler.extractContractConfig(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractContractConfigList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ContractConfigShortVoCollection voCollection) 
	 {
	 	return extractContractConfigList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractContractConfigList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ContractConfigShortVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.ContractConfigShortVo create(ims.core.configuration.domain.objects.ContractConfig domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.ContractConfigShortVo create(DomainObjectMap map, ims.core.configuration.domain.objects.ContractConfig domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.ContractConfigShortVo valueObject = (ims.careuk.vo.ContractConfigShortVo) map.getValueObject(domainObject, ims.careuk.vo.ContractConfigShortVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.ContractConfigShortVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.configuration.domain.objects.ContractConfig
	 */
	 public static ims.careuk.vo.ContractConfigShortVo insert(ims.careuk.vo.ContractConfigShortVo valueObject, ims.core.configuration.domain.objects.ContractConfig domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.configuration.domain.objects.ContractConfig
	 */
	 public static ims.careuk.vo.ContractConfigShortVo insert(DomainObjectMap map, ims.careuk.vo.ContractConfigShortVo valueObject, ims.core.configuration.domain.objects.ContractConfig domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.configuration.domain.objects.ContractConfig extractContractConfig(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ContractConfigShortVo valueObject) 
	{
		return 	extractContractConfig(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.configuration.domain.objects.ContractConfig extractContractConfig(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ContractConfigShortVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.ContractConfigShortVo ID_ContractConfig field is unknown
