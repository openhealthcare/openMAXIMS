...
public class CatsReferralWizardVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.CatsReferralWizardVo copy(ims.careuk.vo.CatsReferralWizardVo valueObjectDest, ims.careuk.vo.CatsReferralWizardVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.CatsReferralWizardVoCollection createCatsReferralWizardVoCollectionFromCatsReferral(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.CatsReferral objects.
	 */
	public static ims.careuk.vo.CatsReferralWizardVoCollection createCatsReferralWizardVoCollectionFromCatsReferral(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.CatsReferralWizardVoCollection voList = new ims.careuk.vo.CatsReferralWizardVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.CatsReferralWizardVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.CatsReferralWizardVoCollection createCatsReferralWizardVoCollectionFromCatsReferral(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.CatsReferral objects.
	 */
	public static ims.careuk.vo.CatsReferralWizardVoCollection createCatsReferralWizardVoCollectionFromCatsReferral(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.CatsReferralWizardVoCollection voList = new ims.careuk.vo.CatsReferralWizardVoCollection();
	 ...
	 */
	 public static java.util.Set extractCatsReferralSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.CatsReferralWizardVoCollection voCollection) 
	 {
	 	return extractCatsReferralSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractCatsReferralSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.CatsReferralWizardVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.CatsReferralWizardVo vo = voCollection.get(i);
			ims.careuk.domain.objects.CatsReferral domainObject = CatsReferralWizardVoAssembler.extractCatsReferral(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractCatsReferralList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.CatsReferralWizardVoCollection voCollection) 
	 {
	 	return extractCatsReferralList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractCatsReferralList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.CatsReferralWizardVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.CatsReferralWizardVo create(ims.careuk.domain.objects.CatsReferral domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.CatsReferralWizardVo create(DomainObjectMap map, ims.careuk.domain.objects.CatsReferral domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.CatsReferralWizardVo valueObject = (ims.careuk.vo.CatsReferralWizardVo) map.getValueObject(domainObject, ims.careuk.vo.CatsReferralWizardVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.CatsReferralWizardVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.careuk.domain.objects.CatsReferral
	 */
	 public static ims.careuk.vo.CatsReferralWizardVo insert(ims.careuk.vo.CatsReferralWizardVo valueObject, ims.careuk.domain.objects.CatsReferral domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.careuk.domain.objects.CatsReferral
	 */
	 public static ims.careuk.vo.CatsReferralWizardVo insert(DomainObjectMap map, ims.careuk.vo.CatsReferralWizardVo valueObject, ims.careuk.domain.objects.CatsReferral domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		if ( null != instance5 ) {
			...
			ims.careuk.vo.lookups.AdditionalInvestigationAppointmentsStatus voLookup5 = new ims.careuk.vo.lookups.AdditionalInvestigationAppointmentsStatus(instance5.getId(),instance5.getText(), instance5.isActive(), null, img, color);
			ims.careuk.vo.lookups.AdditionalInvestigationAppointmentsStatus parentVoLookup5 = voLookup5;
			...
			while (parent5 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup5.setParent(new ims.careuk.vo.lookups.AdditionalInvestigationAppointmentsStatus(parent5.getId(),parent5.getText(), parent5.isActive(), null, img, color));
		...
		// StatusHistory
		valueObject.setStatusHistory(ims.careuk.vo.domain.CatsReferralStatusVoAssembler.createCatsReferralStatusVoCollectionFromCATSReferralStatus(map, domainObject.getStatusHistory()) );
		// RejectReferralDetail
		valueObject.setRejectReferralDetail(ims.careuk.vo.domain.RejectReferralVoAssembler.create(map, domainObject.getRejectReferralDetail()) );
		// hasRejectedInv
		...
		if ( null != instance14 ) {
			...
			ims.careuk.vo.lookups.OnwardReferralStatus voLookup14 = new ims.careuk.vo.lookups.OnwardReferralStatus(instance14.getId(),instance14.getText(), instance14.isActive(), null, img, color);
			ims.careuk.vo.lookups.OnwardReferralStatus parentVoLookup14 = voLookup14;
			...
			while (parent14 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup14.setParent(new ims.careuk.vo.lookups.OnwardReferralStatus(parent14.getId(),parent14.getText(), parent14.isActive(), null, img, color));
		...
		if ( null != instance18 ) {
			...
			ims.careuk.vo.lookups.ReportStatus voLookup18 = new ims.careuk.vo.lookups.ReportStatus(instance18.getId(),instance18.getText(), instance18.isActive(), null, img, color);
			ims.careuk.vo.lookups.ReportStatus parentVoLookup18 = voLookup18;
			...
			while (parent18 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup18.setParent(new ims.careuk.vo.lookups.ReportStatus(parent18.getId(),parent18.getText(), parent18.isActive(), null, img, color));
		...
		if ( null != instance28 ) {
			...
			ims.careuk.vo.lookups.ReportStatus voLookup28 = new ims.careuk.vo.lookups.ReportStatus(instance28.getId(),instance28.getText(), instance28.isActive(), null, img, color);
			ims.careuk.vo.lookups.ReportStatus parentVoLookup28 = voLookup28;
			...
			while (parent28 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup28.setParent(new ims.careuk.vo.lookups.ReportStatus(parent28.getId(),parent28.getText(), parent28.isActive(), null, img, color));
		...
		if ( null != instance30 ) {
			...
			ims.careuk.vo.lookups.OnwardReferralReason voLookup30 = new ims.careuk.vo.lookups.OnwardReferralReason(instance30.getId(),instance30.getText(), instance30.isActive(), null, img, color);
			ims.careuk.vo.lookups.OnwardReferralReason parentVoLookup30 = voLookup30;
			...
			while (parent30 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup30.setParent(new ims.careuk.vo.lookups.OnwardReferralReason(parent30.getId(),parent30.getText(), parent30.isActive(), null, img, color));
		...
		if ( null != instance31 ) {
			...
			ims.careuk.vo.lookups.DischargeToGPDetailsReviewStatus voLookup31 = new ims.careuk.vo.lookups.DischargeToGPDetailsReviewStatus(instance31.getId(),instance31.getText(), instance31.isActive(), null, img, color);
			ims.careuk.vo.lookups.DischargeToGPDetailsReviewStatus parentVoLookup31 = voLookup31;
			...
			while (parent31 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup31.setParent(new ims.careuk.vo.lookups.DischargeToGPDetailsReviewStatus(parent31.getId(),parent31.getText(), parent31.isActive(), null, img, color));
		...
		// AwaitingClinicalInfo
		valueObject.setAwaitingClinicalInfo(ims.careuk.vo.domain.AwaitingClinicalInfoVoAssembler.create(map, domainObject.getAwaitingClinicalInfo()) );
		// isAwaitingClinicalInfo
		valueObject.setIsAwaitingClinicalInfo( domainObject.isIsAwaitingClinicalInfo() );
		// Contract
		valueObject.setContract(ims.careuk.vo.domain.ContractConfigForReferralDetailsComponentVoAssembler.create(map, domainObject.getContract()) );
		// ReportsRequired
		valueObject.setReportsRequired(ims.careuk.vo.domain.ReportsRequiredForPrintingVoAssembler.createReportsRequiredForPrintingVoCollectionFromReportsRequiredForPrinting(map, domainObject.getReportsRequired()) );
		// isActiveMonitorApptRequired
		...
		if ( null != instance42 ) {
			...
			ims.careuk.vo.lookups.CatsReferralCategory voLookup42 = new ims.careuk.vo.lookups.CatsReferralCategory(instance42.getId(),instance42.getText(), instance42.isActive(), null, img, color);
			ims.careuk.vo.lookups.CatsReferralCategory parentVoLookup42 = voLookup42;
			...
			while (parent42 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup42.setParent(new ims.careuk.vo.lookups.CatsReferralCategory(parent42.getId(),parent42.getText(), parent42.isActive(), null, img, color));
		...
		if ( null != instance45 ) {
			...
			ims.careuk.vo.lookups.ReferralUrgency voLookup45 = new ims.careuk.vo.lookups.ReferralUrgency(instance45.getId(),instance45.getText(), instance45.isActive(), null, img, color);
			ims.careuk.vo.lookups.ReferralUrgency parentVoLookup45 = voLookup45;
			...
			while (parent45 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup45.setParent(new ims.careuk.vo.lookups.ReferralUrgency(parent45.getId(),parent45.getText(), parent45.isActive(), null, img, color));
		...
		// ReferralTransfer
		valueObject.setReferralTransfer(ims.careuk.vo.domain.ReferralTransferVoAssembler.create(map, domainObject.getReferralTransfer()) );
		// ConsUpgradeDate
	 ...
	 */
	public static ims.careuk.domain.objects.CatsReferral extractCatsReferral(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.CatsReferralWizardVo valueObject) 
	{
		return 	extractCatsReferral(domainFactory, valueObject, new HashMap());
	}

	public static ims.careuk.domain.objects.CatsReferral extractCatsReferral(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.CatsReferralWizardVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.CatsReferralWizardVo ID_CatsReferral field is unknown
	...
	ims.core.patient.domain.objects.Patient value1 = null;
		...
		domainObject.setStatusHistory(ims.careuk.vo.domain.CatsReferralStatusVoAssembler.extractCATSReferralStatusSet(domainFactory, valueObject.getStatusHistory(), domainObject.getStatusHistory(), domMap));		
		domainObject.setRejectReferralDetail(ims.careuk.vo.domain.RejectReferralVoAssembler.extractReferralReject(domainFactory, valueObject.getRejectReferralDetail(), domMap));
		...
		ims.careuk.domain.objects.ProviderCancellation value15 = null;
		if ( null != valueObject.getProviderCancellation() ) 
		{
			if (valueObject.getProviderCancellation().getBoId() == null)
			{
				...
				{
					value15 = (ims.careuk.domain.objects.ProviderCancellation)domMap.get(valueObject.getProviderCancellation());
				}
			}
			else if (valueObject.getBoVersion() == -1) // RefVo was not modified since obtained from the Assembler, no need to update the BO field
			{
			...
			{
				value15 = (ims.careuk.domain.objects.ProviderCancellation)domainFactory.getDomainObject(ims.careuk.domain.objects.ProviderCancellation.class, valueObject.getProviderCancellation().getBoId());
			}
		}
		...
		domainObject.setAwaitingClinicalInfo(ims.careuk.vo.domain.AwaitingClinicalInfoVoAssembler.extractAwaitingClinicalInfo(domainFactory, valueObject.getAwaitingClinicalInfo(), domMap));
	...
	ims.core.configuration.domain.objects.ContractConfig value36 = null;
		...
		domainObject.setReportsRequired(ims.careuk.vo.domain.ReportsRequiredForPrintingVoAssembler.extractReportsRequiredForPrintingSet(domainFactory, valueObject.getReportsRequired(), domainObject.getReportsRequired(), domMap));		
	...
	ims.core.resource.place.domain.objects.Location value44 = null;
		...
		domainObject.setReferralTransfer(ims.careuk.vo.domain.ReferralTransferVoAssembler.extractReferralTransfer(domainFactory, valueObject.getReferralTransfer(), domMap));
