...
public class PasEventForClinicalCodingWorklistVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.PasEventForClinicalCodingWorklistVo copy(ims.careuk.vo.PasEventForClinicalCodingWorklistVo valueObjectDest, ims.careuk.vo.PasEventForClinicalCodingWorklistVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.PasEventForClinicalCodingWorklistVoCollection createPasEventForClinicalCodingWorklistVoCollectionFromPASEvent(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.core.admin.pas.domain.objects.PASEvent objects.
	 */
	public static ims.careuk.vo.PasEventForClinicalCodingWorklistVoCollection createPasEventForClinicalCodingWorklistVoCollectionFromPASEvent(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.PasEventForClinicalCodingWorklistVoCollection voList = new ims.careuk.vo.PasEventForClinicalCodingWorklistVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.PasEventForClinicalCodingWorklistVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.PasEventForClinicalCodingWorklistVoCollection createPasEventForClinicalCodingWorklistVoCollectionFromPASEvent(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.core.admin.pas.domain.objects.PASEvent objects.
	 */
	public static ims.careuk.vo.PasEventForClinicalCodingWorklistVoCollection createPasEventForClinicalCodingWorklistVoCollectionFromPASEvent(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.PasEventForClinicalCodingWorklistVoCollection voList = new ims.careuk.vo.PasEventForClinicalCodingWorklistVoCollection();
	 ...
	 */
	 public static java.util.Set extractPASEventSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PasEventForClinicalCodingWorklistVoCollection voCollection) 
	 {
	 	return extractPASEventSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPASEventSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PasEventForClinicalCodingWorklistVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.PasEventForClinicalCodingWorklistVo vo = voCollection.get(i);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPASEventList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PasEventForClinicalCodingWorklistVoCollection voCollection) 
	 {
	 	return extractPASEventList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPASEventList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PasEventForClinicalCodingWorklistVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.PasEventForClinicalCodingWorklistVo create(ims.core.admin.pas.domain.objects.PASEvent domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.PasEventForClinicalCodingWorklistVo create(DomainObjectMap map, ims.core.admin.pas.domain.objects.PASEvent domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.PasEventForClinicalCodingWorklistVo valueObject = (ims.careuk.vo.PasEventForClinicalCodingWorklistVo) map.getValueObject(domainObject, ims.careuk.vo.PasEventForClinicalCodingWorklistVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.PasEventForClinicalCodingWorklistVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.admin.pas.domain.objects.PASEvent
	 */
	 public static ims.careuk.vo.PasEventForClinicalCodingWorklistVo insert(ims.careuk.vo.PasEventForClinicalCodingWorklistVo valueObject, ims.core.admin.pas.domain.objects.PASEvent domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.admin.pas.domain.objects.PASEvent
	 */
	 public static ims.careuk.vo.PasEventForClinicalCodingWorklistVo insert(DomainObjectMap map, ims.careuk.vo.PasEventForClinicalCodingWorklistVo valueObject, ims.core.admin.pas.domain.objects.PASEvent domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// patient
		valueObject.setPatient(ims.careuk.vo.domain.PatientForClinicalCodingWorklistVoAssembler.create(map, domainObject.getPatient()) );
		// Consultant
	 ...
	 */
	public static ims.core.admin.pas.domain.objects.PASEvent extractPASEvent(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PasEventForClinicalCodingWorklistVo valueObject) 
	{
		return 	extractPASEvent(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.admin.pas.domain.objects.PASEvent extractPASEvent(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PasEventForClinicalCodingWorklistVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.PasEventForClinicalCodingWorklistVo ID_PASEvent field is unknown
