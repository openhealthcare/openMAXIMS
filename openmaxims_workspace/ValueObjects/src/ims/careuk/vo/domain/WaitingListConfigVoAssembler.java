...
public class WaitingListConfigVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.WaitingListConfigVo copy(ims.careuk.vo.WaitingListConfigVo valueObjectDest, ims.careuk.vo.WaitingListConfigVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.WaitingListConfigVoCollection createWaitingListConfigVoCollectionFromElectiveListConfiguration(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.core.configuration.domain.objects.ElectiveListConfiguration objects.
	 */
	public static ims.careuk.vo.WaitingListConfigVoCollection createWaitingListConfigVoCollectionFromElectiveListConfiguration(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.WaitingListConfigVoCollection voList = new ims.careuk.vo.WaitingListConfigVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.WaitingListConfigVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.WaitingListConfigVoCollection createWaitingListConfigVoCollectionFromElectiveListConfiguration(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.core.configuration.domain.objects.ElectiveListConfiguration objects.
	 */
	public static ims.careuk.vo.WaitingListConfigVoCollection createWaitingListConfigVoCollectionFromElectiveListConfiguration(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.WaitingListConfigVoCollection voList = new ims.careuk.vo.WaitingListConfigVoCollection();
	 ...
	 */
	 public static java.util.Set extractElectiveListConfigurationSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.WaitingListConfigVoCollection voCollection) 
	 {
	 	return extractElectiveListConfigurationSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractElectiveListConfigurationSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.WaitingListConfigVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.WaitingListConfigVo vo = voCollection.get(i);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractElectiveListConfigurationList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.WaitingListConfigVoCollection voCollection) 
	 {
	 	return extractElectiveListConfigurationList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractElectiveListConfigurationList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.WaitingListConfigVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.WaitingListConfigVo create(ims.core.configuration.domain.objects.ElectiveListConfiguration domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.WaitingListConfigVo create(DomainObjectMap map, ims.core.configuration.domain.objects.ElectiveListConfiguration domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.WaitingListConfigVo valueObject = (ims.careuk.vo.WaitingListConfigVo) map.getValueObject(domainObject, ims.careuk.vo.WaitingListConfigVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.WaitingListConfigVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.configuration.domain.objects.ElectiveListConfiguration
	 */
	 public static ims.careuk.vo.WaitingListConfigVo insert(ims.careuk.vo.WaitingListConfigVo valueObject, ims.core.configuration.domain.objects.ElectiveListConfiguration domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.configuration.domain.objects.ElectiveListConfiguration
	 */
	 public static ims.careuk.vo.WaitingListConfigVo insert(DomainObjectMap map, ims.careuk.vo.WaitingListConfigVo valueObject, ims.core.configuration.domain.objects.ElectiveListConfiguration domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.configuration.domain.objects.ElectiveListConfiguration extractElectiveListConfiguration(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.WaitingListConfigVo valueObject) 
	{
		return 	extractElectiveListConfiguration(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.configuration.domain.objects.ElectiveListConfiguration extractElectiveListConfiguration(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.WaitingListConfigVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.WaitingListConfigVo ID_ElectiveListConfiguration field is unknown
