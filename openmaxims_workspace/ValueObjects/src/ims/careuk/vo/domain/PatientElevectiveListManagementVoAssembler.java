...
public class PatientElevectiveListManagementVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.PatientElevectiveListManagementVo copy(ims.careuk.vo.PatientElevectiveListManagementVo valueObjectDest, ims.careuk.vo.PatientElevectiveListManagementVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.PatientElevectiveListManagementVoCollection createPatientElevectiveListManagementVoCollectionFromPatientElectiveList(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.PatientElectiveList objects.
	 */
	public static ims.careuk.vo.PatientElevectiveListManagementVoCollection createPatientElevectiveListManagementVoCollectionFromPatientElectiveList(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.PatientElevectiveListManagementVoCollection voList = new ims.careuk.vo.PatientElevectiveListManagementVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.PatientElevectiveListManagementVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.PatientElevectiveListManagementVoCollection createPatientElevectiveListManagementVoCollectionFromPatientElectiveList(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.PatientElectiveList objects.
	 */
	public static ims.careuk.vo.PatientElevectiveListManagementVoCollection createPatientElevectiveListManagementVoCollectionFromPatientElectiveList(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.PatientElevectiveListManagementVoCollection voList = new ims.careuk.vo.PatientElevectiveListManagementVoCollection();
	 ...
	 */
	 public static java.util.Set extractPatientElectiveListSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElevectiveListManagementVoCollection voCollection) 
	 {
	 	return extractPatientElectiveListSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientElectiveListSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElevectiveListManagementVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.PatientElevectiveListManagementVo vo = voCollection.get(i);
			ims.careuk.domain.objects.PatientElectiveList domainObject = PatientElevectiveListManagementVoAssembler.extractPatientElectiveList(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPatientElectiveListList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElevectiveListManagementVoCollection voCollection) 
	 {
	 	return extractPatientElectiveListList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPatientElectiveListList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElevectiveListManagementVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.PatientElevectiveListManagementVo create(ims.careuk.domain.objects.PatientElectiveList domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.PatientElevectiveListManagementVo create(DomainObjectMap map, ims.careuk.domain.objects.PatientElectiveList domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.PatientElevectiveListManagementVo valueObject = (ims.careuk.vo.PatientElevectiveListManagementVo) map.getValueObject(domainObject, ims.careuk.vo.PatientElevectiveListManagementVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.PatientElevectiveListManagementVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.careuk.domain.objects.PatientElectiveList
	 */
	 public static ims.careuk.vo.PatientElevectiveListManagementVo insert(ims.careuk.vo.PatientElevectiveListManagementVo valueObject, ims.careuk.domain.objects.PatientElectiveList domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.careuk.domain.objects.PatientElectiveList
	 */
	 public static ims.careuk.vo.PatientElevectiveListManagementVo insert(DomainObjectMap map, ims.careuk.vo.PatientElevectiveListManagementVo valueObject, ims.careuk.domain.objects.PatientElectiveList domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		if ( null != instance5 ) {
			...
			ims.careuk.vo.lookups.ElectiveAdmissionType voLookup5 = new ims.careuk.vo.lookups.ElectiveAdmissionType(instance5.getId(),instance5.getText(), instance5.isActive(), null, img, color);
			ims.careuk.vo.lookups.ElectiveAdmissionType parentVoLookup5 = voLookup5;
			...
			while (parent5 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup5.setParent(new ims.careuk.vo.lookups.ElectiveAdmissionType(parent5.getId(),parent5.getText(), parent5.isActive(), null, img, color));
		...
		if (domainObject.getEROD() != null)
		{
			if(domainObject.getEROD() instanceof HibernateProxy) // If the proxy is set, there is no need to lazy load, the proxy knows the id already. 
			{
				...
				int id = Integer.parseInt(p.getHibernateLazyInitializer().getIdentifier().toString());				
				valueObject.setEROD(new ims.careuk.vo.ReferralERODRefVo(id, -1));				
			}
			else
			{
				valueObject.setEROD(new ims.careuk.vo.ReferralERODRefVo(domainObject.getEROD().getId(), domainObject.getEROD().getVersion()));
			}
		}
		// ERODHistory
		...
		if ( null != instance20 ) {
			...
			ims.careuk.vo.lookups.CatsReferralCategory voLookup20 = new ims.careuk.vo.lookups.CatsReferralCategory(instance20.getId(),instance20.getText(), instance20.isActive(), null, img, color);
			ims.careuk.vo.lookups.CatsReferralCategory parentVoLookup20 = voLookup20;
			...
			while (parent20 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup20.setParent(new ims.careuk.vo.lookups.CatsReferralCategory(parent20.getId(),parent20.getText(), parent20.isActive(), null, img, color));
	 ...
	 */
	public static ims.careuk.domain.objects.PatientElectiveList extractPatientElectiveList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElevectiveListManagementVo valueObject) 
	{
		return 	extractPatientElectiveList(domainFactory, valueObject, new HashMap());
	}

	public static ims.careuk.domain.objects.PatientElectiveList extractPatientElectiveList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElevectiveListManagementVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.PatientElevectiveListManagementVo ID_PatientElectiveList field is unknown
	...
	ims.core.patient.domain.objects.Patient value1 = null;
		...
		ims.careuk.domain.objects.CatsReferral value2 = null;
		if ( null != valueObject.getReferral() ) 
		{
			if (valueObject.getReferral().getBoId() == null)
			{
				...
				{
					value2 = (ims.careuk.domain.objects.CatsReferral)domMap.get(valueObject.getReferral());
				}
			}
			...
			{
				value2 = (ims.careuk.domain.objects.CatsReferral)domainFactory.getDomainObject(ims.careuk.domain.objects.CatsReferral.class, valueObject.getReferral().getBoId());
			}
		}
	...
	ims.core.resource.people.domain.objects.Hcp value3 = null;
		...
		ims.careuk.vo.SuspensionDetailsForPatientElectiveListRefVoCollection refCollection8 = valueObject.getSuspensions();
		...
		{
			ims.careuk.vo.SuspensionDetailsForPatientElectiveListRefVo vo = refCollection8.get(i);			
		...
		ims.careuk.vo.TCIForPatientElectiveListRefVoCollection refCollection12 = valueObject.getTCIHistory();
		...
		{
			ims.careuk.vo.TCIForPatientElectiveListRefVo vo = refCollection12.get(i);			
		...
		ims.careuk.vo.NotesForPatientElectiveListRefVoCollection refCollection14 = valueObject.getNotes();
		...
		{
			ims.careuk.vo.NotesForPatientElectiveListRefVo vo = refCollection14.get(i);					
		...
		ims.careuk.domain.objects.ReferralEROD value15 = null;
		if ( null != valueObject.getEROD() ) 
		{
			if (valueObject.getEROD().getBoId() == null)
			{
				...
				{
					value15 = (ims.careuk.domain.objects.ReferralEROD)domMap.get(valueObject.getEROD());
				}
			}
			else if (valueObject.getBoVersion() == -1) // RefVo was not modified since obtained from the Assembler, no need to update the BO field
			{
			...
			{
				value15 = (ims.careuk.domain.objects.ReferralEROD)domainFactory.getDomainObject(ims.careuk.domain.objects.ReferralEROD.class, valueObject.getEROD().getBoId());
			}
		}
		domainObject.setEROD(value15);

		ims.careuk.vo.ReferralERODRefVoCollection refCollection16 = valueObject.getERODHistory();
		...
		{
			ims.careuk.vo.ReferralERODRefVo vo = refCollection16.get(i);			
