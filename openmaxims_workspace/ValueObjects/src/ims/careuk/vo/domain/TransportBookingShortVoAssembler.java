...
public class TransportBookingShortVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.TransportBookingShortVo copy(ims.careuk.vo.TransportBookingShortVo valueObjectDest, ims.careuk.vo.TransportBookingShortVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.TransportBookingShortVoCollection createTransportBookingShortVoCollectionFromTransportBooking(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.core.domain.objects.TransportBooking objects.
	 */
	public static ims.careuk.vo.TransportBookingShortVoCollection createTransportBookingShortVoCollectionFromTransportBooking(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.TransportBookingShortVoCollection voList = new ims.careuk.vo.TransportBookingShortVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.TransportBookingShortVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.TransportBookingShortVoCollection createTransportBookingShortVoCollectionFromTransportBooking(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.core.domain.objects.TransportBooking objects.
	 */
	public static ims.careuk.vo.TransportBookingShortVoCollection createTransportBookingShortVoCollectionFromTransportBooking(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.TransportBookingShortVoCollection voList = new ims.careuk.vo.TransportBookingShortVoCollection();
	 ...
	 */
	 public static java.util.Set extractTransportBookingSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.TransportBookingShortVoCollection voCollection) 
	 {
	 	return extractTransportBookingSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractTransportBookingSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.TransportBookingShortVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.TransportBookingShortVo vo = voCollection.get(i);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractTransportBookingList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.TransportBookingShortVoCollection voCollection) 
	 {
	 	return extractTransportBookingList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractTransportBookingList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.TransportBookingShortVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.TransportBookingShortVo create(ims.core.domain.objects.TransportBooking domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.TransportBookingShortVo create(DomainObjectMap map, ims.core.domain.objects.TransportBooking domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.TransportBookingShortVo valueObject = (ims.careuk.vo.TransportBookingShortVo) map.getValueObject(domainObject, ims.careuk.vo.TransportBookingShortVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.TransportBookingShortVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.domain.objects.TransportBooking
	 */
	 public static ims.careuk.vo.TransportBookingShortVo insert(ims.careuk.vo.TransportBookingShortVo valueObject, ims.core.domain.objects.TransportBooking domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.domain.objects.TransportBooking
	 */
	 public static ims.careuk.vo.TransportBookingShortVo insert(DomainObjectMap map, ims.careuk.vo.TransportBookingShortVo valueObject, ims.core.domain.objects.TransportBooking domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.domain.objects.TransportBooking extractTransportBooking(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.TransportBookingShortVo valueObject) 
	{
		return 	extractTransportBooking(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.domain.objects.TransportBooking extractTransportBooking(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.TransportBookingShortVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.TransportBookingShortVo ID_TransportBooking field is unknown
