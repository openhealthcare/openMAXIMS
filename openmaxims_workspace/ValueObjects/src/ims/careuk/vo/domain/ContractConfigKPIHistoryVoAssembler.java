...
public class ContractConfigKPIHistoryVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.ContractConfigKPIHistoryVo copy(ims.careuk.vo.ContractConfigKPIHistoryVo valueObjectDest, ims.careuk.vo.ContractConfigKPIHistoryVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.ContractConfigKPIHistoryVoCollection createContractConfigKPIHistoryVoCollectionFromContractConfigKPIHistory(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.core.configuration.domain.objects.ContractConfigKPIHistory objects.
	 */
	public static ims.careuk.vo.ContractConfigKPIHistoryVoCollection createContractConfigKPIHistoryVoCollectionFromContractConfigKPIHistory(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.ContractConfigKPIHistoryVoCollection voList = new ims.careuk.vo.ContractConfigKPIHistoryVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.ContractConfigKPIHistoryVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.ContractConfigKPIHistoryVoCollection createContractConfigKPIHistoryVoCollectionFromContractConfigKPIHistory(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.core.configuration.domain.objects.ContractConfigKPIHistory objects.
	 */
	public static ims.careuk.vo.ContractConfigKPIHistoryVoCollection createContractConfigKPIHistoryVoCollectionFromContractConfigKPIHistory(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.ContractConfigKPIHistoryVoCollection voList = new ims.careuk.vo.ContractConfigKPIHistoryVoCollection();
	 ...
	 */
	 public static java.util.Set extractContractConfigKPIHistorySet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ContractConfigKPIHistoryVoCollection voCollection) 
	 {
	 	return extractContractConfigKPIHistorySet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractContractConfigKPIHistorySet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ContractConfigKPIHistoryVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.ContractConfigKPIHistoryVo vo = voCollection.get(i);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractContractConfigKPIHistoryList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ContractConfigKPIHistoryVoCollection voCollection) 
	 {
	 	return extractContractConfigKPIHistoryList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractContractConfigKPIHistoryList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ContractConfigKPIHistoryVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.ContractConfigKPIHistoryVo create(ims.core.configuration.domain.objects.ContractConfigKPIHistory domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.ContractConfigKPIHistoryVo create(DomainObjectMap map, ims.core.configuration.domain.objects.ContractConfigKPIHistory domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.ContractConfigKPIHistoryVo valueObject = (ims.careuk.vo.ContractConfigKPIHistoryVo) map.getValueObject(domainObject, ims.careuk.vo.ContractConfigKPIHistoryVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.ContractConfigKPIHistoryVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.configuration.domain.objects.ContractConfigKPIHistory
	 */
	 public static ims.careuk.vo.ContractConfigKPIHistoryVo insert(ims.careuk.vo.ContractConfigKPIHistoryVo valueObject, ims.core.configuration.domain.objects.ContractConfigKPIHistory domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.configuration.domain.objects.ContractConfigKPIHistory
	 */
	 public static ims.careuk.vo.ContractConfigKPIHistoryVo insert(DomainObjectMap map, ims.careuk.vo.ContractConfigKPIHistoryVo valueObject, ims.core.configuration.domain.objects.ContractConfigKPIHistory domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.configuration.domain.objects.ContractConfigKPIHistory extractContractConfigKPIHistory(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ContractConfigKPIHistoryVo valueObject) 
	{
		return 	extractContractConfigKPIHistory(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.configuration.domain.objects.ContractConfigKPIHistory extractContractConfigKPIHistory(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ContractConfigKPIHistoryVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.ContractConfigKPIHistoryVo ID_ContractConfigKPIHistory field is unknown
