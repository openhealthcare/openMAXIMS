...
public class PatientElectiveListForTCIDetailsDialogVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.PatientElectiveListForTCIDetailsDialogVo copy(ims.careuk.vo.PatientElectiveListForTCIDetailsDialogVo valueObjectDest, ims.careuk.vo.PatientElectiveListForTCIDetailsDialogVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.PatientElectiveListForTCIDetailsDialogVoCollection createPatientElectiveListForTCIDetailsDialogVoCollectionFromPatientElectiveList(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.PatientElectiveList objects.
	 */
	public static ims.careuk.vo.PatientElectiveListForTCIDetailsDialogVoCollection createPatientElectiveListForTCIDetailsDialogVoCollectionFromPatientElectiveList(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.PatientElectiveListForTCIDetailsDialogVoCollection voList = new ims.careuk.vo.PatientElectiveListForTCIDetailsDialogVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.PatientElectiveListForTCIDetailsDialogVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.PatientElectiveListForTCIDetailsDialogVoCollection createPatientElectiveListForTCIDetailsDialogVoCollectionFromPatientElectiveList(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.PatientElectiveList objects.
	 */
	public static ims.careuk.vo.PatientElectiveListForTCIDetailsDialogVoCollection createPatientElectiveListForTCIDetailsDialogVoCollectionFromPatientElectiveList(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.PatientElectiveListForTCIDetailsDialogVoCollection voList = new ims.careuk.vo.PatientElectiveListForTCIDetailsDialogVoCollection();
	 ...
	 */
	 public static java.util.Set extractPatientElectiveListSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListForTCIDetailsDialogVoCollection voCollection) 
	 {
	 	return extractPatientElectiveListSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientElectiveListSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListForTCIDetailsDialogVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.PatientElectiveListForTCIDetailsDialogVo vo = voCollection.get(i);
			ims.careuk.domain.objects.PatientElectiveList domainObject = PatientElectiveListForTCIDetailsDialogVoAssembler.extractPatientElectiveList(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPatientElectiveListList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListForTCIDetailsDialogVoCollection voCollection) 
	 {
	 	return extractPatientElectiveListList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPatientElectiveListList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListForTCIDetailsDialogVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.PatientElectiveListForTCIDetailsDialogVo create(ims.careuk.domain.objects.PatientElectiveList domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.PatientElectiveListForTCIDetailsDialogVo create(DomainObjectMap map, ims.careuk.domain.objects.PatientElectiveList domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.PatientElectiveListForTCIDetailsDialogVo valueObject = (ims.careuk.vo.PatientElectiveListForTCIDetailsDialogVo) map.getValueObject(domainObject, ims.careuk.vo.PatientElectiveListForTCIDetailsDialogVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.PatientElectiveListForTCIDetailsDialogVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.careuk.domain.objects.PatientElectiveList
	 */
	 public static ims.careuk.vo.PatientElectiveListForTCIDetailsDialogVo insert(ims.careuk.vo.PatientElectiveListForTCIDetailsDialogVo valueObject, ims.careuk.domain.objects.PatientElectiveList domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.careuk.domain.objects.PatientElectiveList
	 */
	 public static ims.careuk.vo.PatientElectiveListForTCIDetailsDialogVo insert(DomainObjectMap map, ims.careuk.vo.PatientElectiveListForTCIDetailsDialogVo valueObject, ims.careuk.domain.objects.PatientElectiveList domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		if ( null != instance12 ) {
			...
			ims.careuk.vo.lookups.ElectiveAdmissionType voLookup12 = new ims.careuk.vo.lookups.ElectiveAdmissionType(instance12.getId(),instance12.getText(), instance12.isActive(), null, img, color);
			ims.careuk.vo.lookups.ElectiveAdmissionType parentVoLookup12 = voLookup12;
			...
			while (parent12 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup12.setParent(new ims.careuk.vo.lookups.ElectiveAdmissionType(parent12.getId(),parent12.getText(), parent12.isActive(), null, img, color));
		...
		if ( null != instance15 ) {
			...
			ims.careuk.vo.lookups.ReferralUrgency voLookup15 = new ims.careuk.vo.lookups.ReferralUrgency(instance15.getId(),instance15.getText(), instance15.isActive(), null, img, color);
			ims.careuk.vo.lookups.ReferralUrgency parentVoLookup15 = voLookup15;
			...
			while (parent15 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup15.setParent(new ims.careuk.vo.lookups.ReferralUrgency(parent15.getId(),parent15.getText(), parent15.isActive(), null, img, color));
		...
		if ( null != instance23 ) {
			...
			valueObject.setTransport(voLookup23);
				...
				// Notes
		ims.careuk.vo.NotesForPatientElectiveListRefVoCollection Notes = new ims.careuk.vo.NotesForPatientElectiveListRefVoCollection();
		for(java.util.Iterator iterator = domainObject.getNotes().iterator(); iterator.hasNext(); ) 
		{
			ims.careuk.domain.objects.NotesForPatientElectiveList tmp = (ims.careuk.domain.objects.NotesForPatientElectiveList)iterator.next();
			if (tmp != null)
				Notes.add(new ims.careuk.vo.NotesForPatientElectiveListRefVo(tmp.getId(),tmp.getVersion()));
		}
		...
		// ERODHistory
		valueObject.setERODHistory(ims.careuk.vo.domain.ReferralERODVoAssembler.createReferralERODVoCollectionFromReferralEROD(map, domainObject.getERODHistory()) );
		// PathwayClock
		...
		if ( null != instance28 ) {
			...
			ims.careuk.vo.lookups.CatsReferralCategory voLookup28 = new ims.careuk.vo.lookups.CatsReferralCategory(instance28.getId(),instance28.getText(), instance28.isActive(), null, img, color);
			ims.careuk.vo.lookups.CatsReferralCategory parentVoLookup28 = voLookup28;
			...
			while (parent28 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup28.setParent(new ims.careuk.vo.lookups.CatsReferralCategory(parent28.getId(),parent28.getText(), parent28.isActive(), null, img, color));
	 ...
	 */
	public static ims.careuk.domain.objects.PatientElectiveList extractPatientElectiveList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListForTCIDetailsDialogVo valueObject) 
	{
		return 	extractPatientElectiveList(domainFactory, valueObject, new HashMap());
	}

	public static ims.careuk.domain.objects.PatientElectiveList extractPatientElectiveList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListForTCIDetailsDialogVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.PatientElectiveListForTCIDetailsDialogVo ID_PatientElectiveList field is unknown
		...
		ims.careuk.vo.SuspensionDetailsForPatientElectiveListRefVoCollection refCollection16 = valueObject.getSuspensions();
		...
		{
			ims.careuk.vo.SuspensionDetailsForPatientElectiveListRefVo vo = refCollection16.get(i);			
		...
		ims.careuk.vo.NotesForPatientElectiveListRefVoCollection refCollection24 = valueObject.getNotes();
		...
		{
			ims.careuk.vo.NotesForPatientElectiveListRefVo vo = refCollection24.get(i);					
			ims.careuk.domain.objects.NotesForPatientElectiveList dom = null;
			if ( null != vo ) 
			{
				if (vo.getBoId() == null)
				{
					if (domMap.get(vo) != null)
					{
						dom = (ims.careuk.domain.objects.NotesForPatientElectiveList)domMap.get(vo);
					}
				}
				else
				{
					dom = (ims.careuk.domain.objects.NotesForPatientElectiveList)domainFactory.getDomainObject( ims.careuk.domain.objects.NotesForPatientElectiveList.class, vo.getBoId());
				}
			}
		...
		domainObject.setERODHistory(ims.careuk.vo.domain.ReferralERODVoAssembler.extractReferralERODList(domainFactory, valueObject.getERODHistory(), domainObject.getERODHistory(), domMap));		
