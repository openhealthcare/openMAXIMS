...
public class ContractConfigLiteVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.ContractConfigLiteVo copy(ims.careuk.vo.ContractConfigLiteVo valueObjectDest, ims.careuk.vo.ContractConfigLiteVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.ContractConfigLiteVoCollection createContractConfigLiteVoCollectionFromContractConfig(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.core.configuration.domain.objects.ContractConfig objects.
	 */
	public static ims.careuk.vo.ContractConfigLiteVoCollection createContractConfigLiteVoCollectionFromContractConfig(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.ContractConfigLiteVoCollection voList = new ims.careuk.vo.ContractConfigLiteVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.ContractConfigLiteVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.ContractConfigLiteVoCollection createContractConfigLiteVoCollectionFromContractConfig(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.core.configuration.domain.objects.ContractConfig objects.
	 */
	public static ims.careuk.vo.ContractConfigLiteVoCollection createContractConfigLiteVoCollectionFromContractConfig(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.ContractConfigLiteVoCollection voList = new ims.careuk.vo.ContractConfigLiteVoCollection();
	 ...
	 */
	 public static java.util.Set extractContractConfigSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ContractConfigLiteVoCollection voCollection) 
	 {
	 	return extractContractConfigSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractContractConfigSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ContractConfigLiteVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.ContractConfigLiteVo vo = voCollection.get(i);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractContractConfigList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ContractConfigLiteVoCollection voCollection) 
	 {
	 	return extractContractConfigList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractContractConfigList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ContractConfigLiteVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.ContractConfigLiteVo create(ims.core.configuration.domain.objects.ContractConfig domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.ContractConfigLiteVo create(DomainObjectMap map, ims.core.configuration.domain.objects.ContractConfig domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.ContractConfigLiteVo valueObject = (ims.careuk.vo.ContractConfigLiteVo) map.getValueObject(domainObject, ims.careuk.vo.ContractConfigLiteVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.ContractConfigLiteVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.configuration.domain.objects.ContractConfig
	 */
	 public static ims.careuk.vo.ContractConfigLiteVo insert(ims.careuk.vo.ContractConfigLiteVo valueObject, ims.core.configuration.domain.objects.ContractConfig domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.configuration.domain.objects.ContractConfig
	 */
	 public static ims.careuk.vo.ContractConfigLiteVo insert(DomainObjectMap map, ims.careuk.vo.ContractConfigLiteVo valueObject, ims.core.configuration.domain.objects.ContractConfig domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.configuration.domain.objects.ContractConfig extractContractConfig(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ContractConfigLiteVo valueObject) 
	{
		return 	extractContractConfig(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.configuration.domain.objects.ContractConfig extractContractConfig(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ContractConfigLiteVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.ContractConfigLiteVo ID_ContractConfig field is unknown
