...
public class PatientElectiveListTCIVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.PatientElectiveListTCIVo copy(ims.careuk.vo.PatientElectiveListTCIVo valueObjectDest, ims.careuk.vo.PatientElectiveListTCIVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.PatientElectiveListTCIVoCollection createPatientElectiveListTCIVoCollectionFromTCIForPatientElectiveList(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.TCIForPatientElectiveList objects.
	 */
	public static ims.careuk.vo.PatientElectiveListTCIVoCollection createPatientElectiveListTCIVoCollectionFromTCIForPatientElectiveList(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.PatientElectiveListTCIVoCollection voList = new ims.careuk.vo.PatientElectiveListTCIVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.PatientElectiveListTCIVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.PatientElectiveListTCIVoCollection createPatientElectiveListTCIVoCollectionFromTCIForPatientElectiveList(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.TCIForPatientElectiveList objects.
	 */
	public static ims.careuk.vo.PatientElectiveListTCIVoCollection createPatientElectiveListTCIVoCollectionFromTCIForPatientElectiveList(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.PatientElectiveListTCIVoCollection voList = new ims.careuk.vo.PatientElectiveListTCIVoCollection();
	 ...
	 */
	 public static java.util.Set extractTCIForPatientElectiveListSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListTCIVoCollection voCollection) 
	 {
	 	return extractTCIForPatientElectiveListSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractTCIForPatientElectiveListSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListTCIVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.PatientElectiveListTCIVo vo = voCollection.get(i);
			ims.careuk.domain.objects.TCIForPatientElectiveList domainObject = PatientElectiveListTCIVoAssembler.extractTCIForPatientElectiveList(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractTCIForPatientElectiveListList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListTCIVoCollection voCollection) 
	 {
	 	return extractTCIForPatientElectiveListList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractTCIForPatientElectiveListList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListTCIVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.PatientElectiveListTCIVo create(ims.careuk.domain.objects.TCIForPatientElectiveList domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.PatientElectiveListTCIVo create(DomainObjectMap map, ims.careuk.domain.objects.TCIForPatientElectiveList domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.PatientElectiveListTCIVo valueObject = (ims.careuk.vo.PatientElectiveListTCIVo) map.getValueObject(domainObject, ims.careuk.vo.PatientElectiveListTCIVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.PatientElectiveListTCIVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.careuk.domain.objects.TCIForPatientElectiveList
	 */
	 public static ims.careuk.vo.PatientElectiveListTCIVo insert(ims.careuk.vo.PatientElectiveListTCIVo valueObject, ims.careuk.domain.objects.TCIForPatientElectiveList domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.careuk.domain.objects.TCIForPatientElectiveList
	 */
	 public static ims.careuk.vo.PatientElectiveListTCIVo insert(DomainObjectMap map, ims.careuk.vo.PatientElectiveListTCIVo valueObject, ims.careuk.domain.objects.TCIForPatientElectiveList domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// Appointment
		valueObject.setAppointment(ims.careuk.vo.domain.Booking_AppointmentElectiveListVoAssembler.create(map, domainObject.getAppointment()) );
		// Session
		...
		if ( null != instance8 ) {
			...
			ims.careuk.vo.lookups.PlanningElective voLookup8 = new ims.careuk.vo.lookups.PlanningElective(instance8.getId(),instance8.getText(), instance8.isActive(), null, img, color);
			ims.careuk.vo.lookups.PlanningElective parentVoLookup8 = voLookup8;
			...
			while (parent8 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup8.setParent(new ims.careuk.vo.lookups.PlanningElective(parent8.getId(),parent8.getText(), parent8.isActive(), null, img, color));
	 ...
	 */
	public static ims.careuk.domain.objects.TCIForPatientElectiveList extractTCIForPatientElectiveList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListTCIVo valueObject) 
	{
		return 	extractTCIForPatientElectiveList(domainFactory, valueObject, new HashMap());
	}

	public static ims.careuk.domain.objects.TCIForPatientElectiveList extractTCIForPatientElectiveList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListTCIVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.PatientElectiveListTCIVo ID_TCIForPatientElectiveList field is unknown
