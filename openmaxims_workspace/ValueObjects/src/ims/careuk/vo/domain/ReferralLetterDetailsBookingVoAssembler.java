...
public class ReferralLetterDetailsBookingVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.ReferralLetterDetailsBookingVo copy(ims.careuk.vo.ReferralLetterDetailsBookingVo valueObjectDest, ims.careuk.vo.ReferralLetterDetailsBookingVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.ReferralLetterDetailsBookingVoCollection createReferralLetterDetailsBookingVoCollectionFromReferralLetterDetails(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.core.clinical.domain.objects.ReferralLetterDetails objects.
	 */
	public static ims.careuk.vo.ReferralLetterDetailsBookingVoCollection createReferralLetterDetailsBookingVoCollectionFromReferralLetterDetails(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.ReferralLetterDetailsBookingVoCollection voList = new ims.careuk.vo.ReferralLetterDetailsBookingVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.ReferralLetterDetailsBookingVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.ReferralLetterDetailsBookingVoCollection createReferralLetterDetailsBookingVoCollectionFromReferralLetterDetails(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.core.clinical.domain.objects.ReferralLetterDetails objects.
	 */
	public static ims.careuk.vo.ReferralLetterDetailsBookingVoCollection createReferralLetterDetailsBookingVoCollectionFromReferralLetterDetails(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.ReferralLetterDetailsBookingVoCollection voList = new ims.careuk.vo.ReferralLetterDetailsBookingVoCollection();
	 ...
	 */
	 public static java.util.Set extractReferralLetterDetailsSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralLetterDetailsBookingVoCollection voCollection) 
	 {
	 	return extractReferralLetterDetailsSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractReferralLetterDetailsSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralLetterDetailsBookingVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.ReferralLetterDetailsBookingVo vo = voCollection.get(i);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractReferralLetterDetailsList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralLetterDetailsBookingVoCollection voCollection) 
	 {
	 	return extractReferralLetterDetailsList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractReferralLetterDetailsList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralLetterDetailsBookingVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.ReferralLetterDetailsBookingVo create(ims.core.clinical.domain.objects.ReferralLetterDetails domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.ReferralLetterDetailsBookingVo create(DomainObjectMap map, ims.core.clinical.domain.objects.ReferralLetterDetails domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.ReferralLetterDetailsBookingVo valueObject = (ims.careuk.vo.ReferralLetterDetailsBookingVo) map.getValueObject(domainObject, ims.careuk.vo.ReferralLetterDetailsBookingVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.ReferralLetterDetailsBookingVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.ReferralLetterDetails
	 */
	 public static ims.careuk.vo.ReferralLetterDetailsBookingVo insert(ims.careuk.vo.ReferralLetterDetailsBookingVo valueObject, ims.core.clinical.domain.objects.ReferralLetterDetails domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.ReferralLetterDetails
	 */
	 public static ims.careuk.vo.ReferralLetterDetailsBookingVo insert(DomainObjectMap map, ims.careuk.vo.ReferralLetterDetailsBookingVo valueObject, ims.core.clinical.domain.objects.ReferralLetterDetails domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.clinical.domain.objects.ReferralLetterDetails extractReferralLetterDetails(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralLetterDetailsBookingVo valueObject) 
	{
		return 	extractReferralLetterDetails(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.clinical.domain.objects.ReferralLetterDetails extractReferralLetterDetails(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralLetterDetailsBookingVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.ReferralLetterDetailsBookingVo ID_ReferralLetterDetails field is unknown
