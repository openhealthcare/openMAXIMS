...
public class ReferralLetterDetailsLiteVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.ReferralLetterDetailsLiteVo copy(ims.careuk.vo.ReferralLetterDetailsLiteVo valueObjectDest, ims.careuk.vo.ReferralLetterDetailsLiteVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.ReferralLetterDetailsLiteVoCollection createReferralLetterDetailsLiteVoCollectionFromReferralLetterDetails(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.core.clinical.domain.objects.ReferralLetterDetails objects.
	 */
	public static ims.careuk.vo.ReferralLetterDetailsLiteVoCollection createReferralLetterDetailsLiteVoCollectionFromReferralLetterDetails(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.ReferralLetterDetailsLiteVoCollection voList = new ims.careuk.vo.ReferralLetterDetailsLiteVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.ReferralLetterDetailsLiteVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.ReferralLetterDetailsLiteVoCollection createReferralLetterDetailsLiteVoCollectionFromReferralLetterDetails(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.core.clinical.domain.objects.ReferralLetterDetails objects.
	 */
	public static ims.careuk.vo.ReferralLetterDetailsLiteVoCollection createReferralLetterDetailsLiteVoCollectionFromReferralLetterDetails(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.ReferralLetterDetailsLiteVoCollection voList = new ims.careuk.vo.ReferralLetterDetailsLiteVoCollection();
	 ...
	 */
	 public static java.util.Set extractReferralLetterDetailsSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralLetterDetailsLiteVoCollection voCollection) 
	 {
	 	return extractReferralLetterDetailsSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractReferralLetterDetailsSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralLetterDetailsLiteVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.ReferralLetterDetailsLiteVo vo = voCollection.get(i);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractReferralLetterDetailsList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralLetterDetailsLiteVoCollection voCollection) 
	 {
	 	return extractReferralLetterDetailsList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractReferralLetterDetailsList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralLetterDetailsLiteVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.ReferralLetterDetailsLiteVo create(ims.core.clinical.domain.objects.ReferralLetterDetails domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.ReferralLetterDetailsLiteVo create(DomainObjectMap map, ims.core.clinical.domain.objects.ReferralLetterDetails domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.ReferralLetterDetailsLiteVo valueObject = (ims.careuk.vo.ReferralLetterDetailsLiteVo) map.getValueObject(domainObject, ims.careuk.vo.ReferralLetterDetailsLiteVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.ReferralLetterDetailsLiteVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.ReferralLetterDetails
	 */
	 public static ims.careuk.vo.ReferralLetterDetailsLiteVo insert(ims.careuk.vo.ReferralLetterDetailsLiteVo valueObject, ims.core.clinical.domain.objects.ReferralLetterDetails domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.ReferralLetterDetails
	 */
	 public static ims.careuk.vo.ReferralLetterDetailsLiteVo insert(DomainObjectMap map, ims.careuk.vo.ReferralLetterDetailsLiteVo valueObject, ims.core.clinical.domain.objects.ReferralLetterDetails domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.clinical.domain.objects.ReferralLetterDetails extractReferralLetterDetails(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralLetterDetailsLiteVo valueObject) 
	{
		return 	extractReferralLetterDetails(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.clinical.domain.objects.ReferralLetterDetails extractReferralLetterDetails(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralLetterDetailsLiteVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.ReferralLetterDetailsLiteVo ID_ReferralLetterDetails field is unknown
