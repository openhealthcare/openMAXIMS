...
public class ReferralLetterDetailsForElectiveListDetailsVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.ReferralLetterDetailsForElectiveListDetailsVo copy(ims.careuk.vo.ReferralLetterDetailsForElectiveListDetailsVo valueObjectDest, ims.careuk.vo.ReferralLetterDetailsForElectiveListDetailsVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.ReferralLetterDetailsForElectiveListDetailsVoCollection createReferralLetterDetailsForElectiveListDetailsVoCollectionFromReferralLetterDetails(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.core.clinical.domain.objects.ReferralLetterDetails objects.
	 */
	public static ims.careuk.vo.ReferralLetterDetailsForElectiveListDetailsVoCollection createReferralLetterDetailsForElectiveListDetailsVoCollectionFromReferralLetterDetails(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.ReferralLetterDetailsForElectiveListDetailsVoCollection voList = new ims.careuk.vo.ReferralLetterDetailsForElectiveListDetailsVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.ReferralLetterDetailsForElectiveListDetailsVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.ReferralLetterDetailsForElectiveListDetailsVoCollection createReferralLetterDetailsForElectiveListDetailsVoCollectionFromReferralLetterDetails(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.core.clinical.domain.objects.ReferralLetterDetails objects.
	 */
	public static ims.careuk.vo.ReferralLetterDetailsForElectiveListDetailsVoCollection createReferralLetterDetailsForElectiveListDetailsVoCollectionFromReferralLetterDetails(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.ReferralLetterDetailsForElectiveListDetailsVoCollection voList = new ims.careuk.vo.ReferralLetterDetailsForElectiveListDetailsVoCollection();
	 ...
	 */
	 public static java.util.Set extractReferralLetterDetailsSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralLetterDetailsForElectiveListDetailsVoCollection voCollection) 
	 {
	 	return extractReferralLetterDetailsSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractReferralLetterDetailsSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralLetterDetailsForElectiveListDetailsVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.ReferralLetterDetailsForElectiveListDetailsVo vo = voCollection.get(i);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractReferralLetterDetailsList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralLetterDetailsForElectiveListDetailsVoCollection voCollection) 
	 {
	 	return extractReferralLetterDetailsList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractReferralLetterDetailsList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralLetterDetailsForElectiveListDetailsVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.ReferralLetterDetailsForElectiveListDetailsVo create(ims.core.clinical.domain.objects.ReferralLetterDetails domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.ReferralLetterDetailsForElectiveListDetailsVo create(DomainObjectMap map, ims.core.clinical.domain.objects.ReferralLetterDetails domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.ReferralLetterDetailsForElectiveListDetailsVo valueObject = (ims.careuk.vo.ReferralLetterDetailsForElectiveListDetailsVo) map.getValueObject(domainObject, ims.careuk.vo.ReferralLetterDetailsForElectiveListDetailsVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.ReferralLetterDetailsForElectiveListDetailsVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.ReferralLetterDetails
	 */
	 public static ims.careuk.vo.ReferralLetterDetailsForElectiveListDetailsVo insert(ims.careuk.vo.ReferralLetterDetailsForElectiveListDetailsVo valueObject, ims.core.clinical.domain.objects.ReferralLetterDetails domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.ReferralLetterDetails
	 */
	 public static ims.careuk.vo.ReferralLetterDetailsForElectiveListDetailsVo insert(DomainObjectMap map, ims.careuk.vo.ReferralLetterDetailsForElectiveListDetailsVo valueObject, ims.core.clinical.domain.objects.ReferralLetterDetails domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.clinical.domain.objects.ReferralLetterDetails extractReferralLetterDetails(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralLetterDetailsForElectiveListDetailsVo valueObject) 
	{
		return 	extractReferralLetterDetails(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.clinical.domain.objects.ReferralLetterDetails extractReferralLetterDetails(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralLetterDetailsForElectiveListDetailsVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.ReferralLetterDetailsForElectiveListDetailsVo ID_ReferralLetterDetails field is unknown
