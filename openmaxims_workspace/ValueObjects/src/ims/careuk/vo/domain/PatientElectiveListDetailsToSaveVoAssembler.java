...
public class PatientElectiveListDetailsToSaveVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.PatientElectiveListDetailsToSaveVo copy(ims.careuk.vo.PatientElectiveListDetailsToSaveVo valueObjectDest, ims.careuk.vo.PatientElectiveListDetailsToSaveVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.PatientElectiveListDetailsToSaveVoCollection createPatientElectiveListDetailsToSaveVoCollectionFromPatientElectiveList(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.PatientElectiveList objects.
	 */
	public static ims.careuk.vo.PatientElectiveListDetailsToSaveVoCollection createPatientElectiveListDetailsToSaveVoCollectionFromPatientElectiveList(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.PatientElectiveListDetailsToSaveVoCollection voList = new ims.careuk.vo.PatientElectiveListDetailsToSaveVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.PatientElectiveListDetailsToSaveVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.PatientElectiveListDetailsToSaveVoCollection createPatientElectiveListDetailsToSaveVoCollectionFromPatientElectiveList(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.PatientElectiveList objects.
	 */
	public static ims.careuk.vo.PatientElectiveListDetailsToSaveVoCollection createPatientElectiveListDetailsToSaveVoCollectionFromPatientElectiveList(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.PatientElectiveListDetailsToSaveVoCollection voList = new ims.careuk.vo.PatientElectiveListDetailsToSaveVoCollection();
	 ...
	 */
	 public static java.util.Set extractPatientElectiveListSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListDetailsToSaveVoCollection voCollection) 
	 {
	 	return extractPatientElectiveListSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientElectiveListSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListDetailsToSaveVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.PatientElectiveListDetailsToSaveVo vo = voCollection.get(i);
			ims.careuk.domain.objects.PatientElectiveList domainObject = PatientElectiveListDetailsToSaveVoAssembler.extractPatientElectiveList(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPatientElectiveListList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListDetailsToSaveVoCollection voCollection) 
	 {
	 	return extractPatientElectiveListList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPatientElectiveListList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListDetailsToSaveVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.PatientElectiveListDetailsToSaveVo create(ims.careuk.domain.objects.PatientElectiveList domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.PatientElectiveListDetailsToSaveVo create(DomainObjectMap map, ims.careuk.domain.objects.PatientElectiveList domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.PatientElectiveListDetailsToSaveVo valueObject = (ims.careuk.vo.PatientElectiveListDetailsToSaveVo) map.getValueObject(domainObject, ims.careuk.vo.PatientElectiveListDetailsToSaveVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.PatientElectiveListDetailsToSaveVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.careuk.domain.objects.PatientElectiveList
	 */
	 public static ims.careuk.vo.PatientElectiveListDetailsToSaveVo insert(ims.careuk.vo.PatientElectiveListDetailsToSaveVo valueObject, ims.careuk.domain.objects.PatientElectiveList domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.careuk.domain.objects.PatientElectiveList
	 */
	 public static ims.careuk.vo.PatientElectiveListDetailsToSaveVo insert(DomainObjectMap map, ims.careuk.vo.PatientElectiveListDetailsToSaveVo valueObject, ims.careuk.domain.objects.PatientElectiveList domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// ElectiveListStatusHistory
		valueObject.setElectiveListStatusHistory(ims.careuk.vo.domain.ElectiveListStatusVoAssembler.createElectiveListStatusVoCollectionFromElectiveListStatus(map, domainObject.getElectiveListStatusHistory()) );
		// Patient
		...
		if (domainObject.getReferral() != null)
		{
			if(domainObject.getReferral() instanceof HibernateProxy) // If the proxy is set, there is no need to lazy load, the proxy knows the id already. 
			{
				...
				int id = Integer.parseInt(p.getHibernateLazyInitializer().getIdentifier().toString());				
				valueObject.setReferral(new ims.careuk.vo.CatsReferralRefVo(id, -1));				
			}
			else
			{
				valueObject.setReferral(new ims.careuk.vo.CatsReferralRefVo(domainObject.getReferral().getId(), domainObject.getReferral().getVersion()));
			}
		}
		// EpisodeOfCare
		...
		if ( null != instance13 ) {
			...
			ims.careuk.vo.lookups.ElectiveAdmissionType voLookup13 = new ims.careuk.vo.lookups.ElectiveAdmissionType(instance13.getId(),instance13.getText(), instance13.isActive(), null, img, color);
			ims.careuk.vo.lookups.ElectiveAdmissionType parentVoLookup13 = voLookup13;
			...
			while (parent13 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup13.setParent(new ims.careuk.vo.lookups.ElectiveAdmissionType(parent13.getId(),parent13.getText(), parent13.isActive(), null, img, color));
		...
		if ( null != instance18 ) {
			...
			ims.careuk.vo.lookups.ReferralUrgency voLookup18 = new ims.careuk.vo.lookups.ReferralUrgency(instance18.getId(),instance18.getText(), instance18.isActive(), null, img, color);
			ims.careuk.vo.lookups.ReferralUrgency parentVoLookup18 = voLookup18;
			...
			while (parent18 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup18.setParent(new ims.careuk.vo.lookups.ReferralUrgency(parent18.getId(),parent18.getText(), parent18.isActive(), null, img, color));
			...
			valueObject.setPriority(voLookup18);
				...
				// Suspensions
		ims.careuk.vo.SuspensionDetailsForPatientElectiveListRefVoCollection Suspensions = new ims.careuk.vo.SuspensionDetailsForPatientElectiveListRefVoCollection();
		for(java.util.Iterator iterator = domainObject.getSuspensions().iterator(); iterator.hasNext(); ) 
		{
			ims.careuk.domain.objects.SuspensionDetailsForPatientElectiveList tmp = (ims.careuk.domain.objects.SuspensionDetailsForPatientElectiveList)iterator.next();
			if (tmp != null)
				Suspensions.add(new ims.careuk.vo.SuspensionDetailsForPatientElectiveListRefVo(tmp.getId(),tmp.getVersion()));
		}
		...
		// TCIDetails
		valueObject.setTCIDetails(ims.careuk.vo.domain.PatientElectiveListTCIVoAssembler.create(map, domainObject.getTCIDetails()) );
		// TCIHistory
		valueObject.setTCIHistory(ims.careuk.vo.domain.PatientElectiveListTCIVoAssembler.createPatientElectiveListTCIVoCollectionFromTCIForPatientElectiveList(map, domainObject.getTCIHistory()) );
		// InterpretatorRequired
		...
		// Notes
		valueObject.setNotes(ims.careuk.vo.domain.PatientElectiveListNotesVoAssembler.createPatientElectiveListNotesVoCollectionFromNotesForPatientElectiveList(map, domainObject.getNotes()) );
		// EROD
		valueObject.setEROD(ims.careuk.vo.domain.ReferralERODVoAssembler.create(map, domainObject.getEROD()) );
		// ERODHistory
		ims.careuk.vo.ReferralERODRefVoCollection ERODHistory = new ims.careuk.vo.ReferralERODRefVoCollection();
		for(java.util.Iterator iterator = domainObject.getERODHistory().iterator(); iterator.hasNext(); ) 
		{
			ims.careuk.domain.objects.ReferralEROD tmp = (ims.careuk.domain.objects.ReferralEROD)iterator.next();
			if (tmp != null)
				ERODHistory.add(new ims.careuk.vo.ReferralERODRefVo(tmp.getId(),tmp.getVersion()));
		}
		...
		// Reviews
		valueObject.setReviews(ims.careuk.vo.domain.ReviewPatientElectiveListVoAssembler.createReviewPatientElectiveListVoCollectionFromReviewPatientElectiveList(map, domainObject.getReviews()) );
		// CurrentSuspensionEndDate
		...
		if ( null != instance40 ) {
			...
			ims.careuk.vo.lookups.CatsReferralCategory voLookup40 = new ims.careuk.vo.lookups.CatsReferralCategory(instance40.getId(),instance40.getText(), instance40.isActive(), null, img, color);
			ims.careuk.vo.lookups.CatsReferralCategory parentVoLookup40 = voLookup40;
			...
			while (parent40 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup40.setParent(new ims.careuk.vo.lookups.CatsReferralCategory(parent40.getId(),parent40.getText(), parent40.isActive(), null, img, color));
	 ...
	 */
	public static ims.careuk.domain.objects.PatientElectiveList extractPatientElectiveList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListDetailsToSaveVo valueObject) 
	{
		return 	extractPatientElectiveList(domainFactory, valueObject, new HashMap());
	}

	public static ims.careuk.domain.objects.PatientElectiveList extractPatientElectiveList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientElectiveListDetailsToSaveVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.PatientElectiveListDetailsToSaveVo ID_PatientElectiveList field is unknown
	...
	ims.core.configuration.domain.objects.ElectiveListConfiguration value1 = null;
		...
		domainObject.setElectiveListStatusHistory(ims.careuk.vo.domain.ElectiveListStatusVoAssembler.extractElectiveListStatusList(domainFactory, valueObject.getElectiveListStatusHistory(), domainObject.getElectiveListStatusHistory(), domMap));		
		...
		ims.careuk.domain.objects.CatsReferral value5 = null;
		if ( null != valueObject.getReferral() ) 
		{
			if (valueObject.getReferral().getBoId() == null)
			{
				...
				{
					value5 = (ims.careuk.domain.objects.CatsReferral)domMap.get(valueObject.getReferral());
				}
			}
			else if (valueObject.getBoVersion() == -1) // RefVo was not modified since obtained from the Assembler, no need to update the BO field
			{
			...
			{
				value5 = (ims.careuk.domain.objects.CatsReferral)domainFactory.getDomainObject(ims.careuk.domain.objects.CatsReferral.class, valueObject.getReferral().getBoId());
			}
		}
	...
	ims.core.resource.people.domain.objects.Hcp value9 = null;
		...
		ims.careuk.vo.SuspensionDetailsForPatientElectiveListRefVoCollection refCollection19 = valueObject.getSuspensions();
		...
		{
			ims.careuk.vo.SuspensionDetailsForPatientElectiveListRefVo vo = refCollection19.get(i);			
			ims.careuk.domain.objects.SuspensionDetailsForPatientElectiveList dom = null;
			if ( null != vo ) 
			{
				if (vo.getBoId() == null)
				{
					...
					{
						dom = (ims.careuk.domain.objects.SuspensionDetailsForPatientElectiveList)domMap.get(vo);
					}
				}
				else
				{
					dom = (ims.careuk.domain.objects.SuspensionDetailsForPatientElectiveList)domainFactory.getDomainObject( ims.careuk.domain.objects.SuspensionDetailsForPatientElectiveList.class, vo.getBoId());
				}
			}
	...
	ims.core.clinical.domain.objects.Procedure value21 = null;
		...
		domainObject.setTCIDetails(ims.careuk.vo.domain.PatientElectiveListTCIVoAssembler.extractTCIForPatientElectiveList(domainFactory, valueObject.getTCIDetails(), domMap));
		domainObject.setTCIHistory(ims.careuk.vo.domain.PatientElectiveListTCIVoAssembler.extractTCIForPatientElectiveListList(domainFactory, valueObject.getTCIHistory(), domainObject.getTCIHistory(), domMap));		
		...
		domainObject.setNotes(ims.careuk.vo.domain.PatientElectiveListNotesVoAssembler.extractNotesForPatientElectiveListSet(domainFactory, valueObject.getNotes(), domainObject.getNotes(), domMap));		
		domainObject.setEROD(ims.careuk.vo.domain.ReferralERODVoAssembler.extractReferralEROD(domainFactory, valueObject.getEROD(), domMap));

		ims.careuk.vo.ReferralERODRefVoCollection refCollection34 = valueObject.getERODHistory();
		...
		{
			ims.careuk.vo.ReferralERODRefVo vo = refCollection34.get(i);			
			ims.careuk.domain.objects.ReferralEROD dom = null;
			if ( null != vo ) 
			{
				if (vo.getBoId() == null)
				{
					if (domMap.get(vo) != null)
					{
						dom = (ims.careuk.domain.objects.ReferralEROD)domMap.get(vo);
					}
				}
				else
				{
					dom = (ims.careuk.domain.objects.ReferralEROD)domainFactory.getDomainObject( ims.careuk.domain.objects.ReferralEROD.class, vo.getBoId());
				}
			}
		...
		domainObject.setReviews(ims.careuk.vo.domain.ReviewPatientElectiveListVoAssembler.extractReviewPatientElectiveListSet(domainFactory, valueObject.getReviews(), domainObject.getReviews(), domMap));		
