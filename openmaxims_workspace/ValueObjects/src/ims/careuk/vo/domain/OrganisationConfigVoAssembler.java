...
public class OrganisationConfigVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.OrganisationConfigVo copy(ims.careuk.vo.OrganisationConfigVo valueObjectDest, ims.careuk.vo.OrganisationConfigVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.OrganisationConfigVoCollection createOrganisationConfigVoCollectionFromOrganisation(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.core.resource.place.domain.objects.Organisation objects.
	 */
	public static ims.careuk.vo.OrganisationConfigVoCollection createOrganisationConfigVoCollectionFromOrganisation(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.OrganisationConfigVoCollection voList = new ims.careuk.vo.OrganisationConfigVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.OrganisationConfigVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.OrganisationConfigVoCollection createOrganisationConfigVoCollectionFromOrganisation(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.core.resource.place.domain.objects.Organisation objects.
	 */
	public static ims.careuk.vo.OrganisationConfigVoCollection createOrganisationConfigVoCollectionFromOrganisation(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.OrganisationConfigVoCollection voList = new ims.careuk.vo.OrganisationConfigVoCollection();
	 ...
	 */
	 public static java.util.Set extractOrganisationSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.OrganisationConfigVoCollection voCollection) 
	 {
	 	return extractOrganisationSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractOrganisationSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.OrganisationConfigVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.OrganisationConfigVo vo = voCollection.get(i);
	 ...
	 */
	 ...
	 public static java.util.List extractOrganisationList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.OrganisationConfigVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.OrganisationConfigVo create(ims.core.resource.place.domain.objects.Organisation domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.OrganisationConfigVo create(DomainObjectMap map, ims.core.resource.place.domain.objects.Organisation domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.OrganisationConfigVo valueObject = (ims.careuk.vo.OrganisationConfigVo) map.getValueObject(domainObject, ims.careuk.vo.OrganisationConfigVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.OrganisationConfigVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.resource.place.domain.objects.Organisation
	 */
	 public static ims.careuk.vo.OrganisationConfigVo insert(ims.careuk.vo.OrganisationConfigVo valueObject, ims.core.resource.place.domain.objects.Organisation domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.resource.place.domain.objects.Organisation
	 */
	 public static ims.careuk.vo.OrganisationConfigVo insert(DomainObjectMap map, ims.careuk.vo.OrganisationConfigVo valueObject, ims.core.resource.place.domain.objects.Organisation domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// LocationSites
		valueObject.setLocationSites(ims.careuk.vo.domain.LocationSiteConfigVoAssembler.createLocationSiteConfigVoCollectionFromLocSite(map, domainObject.getLocationSites()) );
		// UpperName
		valueObject.setUpperName(domainObject.getUpperName());
		// Comment
		valueObject.setComment(domainObject.getComment());
		// relatedOrganisations
		valueObject.setRelatedOrganisations(ims.careuk.vo.domain.OrganisationConfigVoAssembler.createOrganisationConfigVoCollectionFromOrganisation(map, domainObject.getRelatedOrganisations()) );
 		return valueObject;
	 }
	...
	public static ims.core.resource.place.domain.objects.Organisation extractOrganisation(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.OrganisationConfigVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.OrganisationConfigVo ID_Organisation field is unknown
		...
		domainObject.setLocationSites(ims.careuk.vo.domain.LocationSiteConfigVoAssembler.extractLocSiteSet(domainFactory, valueObject.getLocationSites(), domainObject.getLocationSites(), domMap));		
		//This is to overcome a bug in both Sybase and Oracle which prevents them from storing an empty string correctly
		//Sybase stores it as a single space, Oracle stores it as NULL. This fix will make them consistent at least.
