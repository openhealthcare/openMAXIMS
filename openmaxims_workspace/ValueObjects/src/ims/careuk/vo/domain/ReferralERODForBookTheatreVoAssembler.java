...
public class ReferralERODForBookTheatreVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.ReferralERODForBookTheatreVo copy(ims.careuk.vo.ReferralERODForBookTheatreVo valueObjectDest, ims.careuk.vo.ReferralERODForBookTheatreVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.ReferralERODForBookTheatreVoCollection createReferralERODForBookTheatreVoCollectionFromReferralEROD(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.ReferralEROD objects.
	 */
	public static ims.careuk.vo.ReferralERODForBookTheatreVoCollection createReferralERODForBookTheatreVoCollectionFromReferralEROD(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.ReferralERODForBookTheatreVoCollection voList = new ims.careuk.vo.ReferralERODForBookTheatreVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.ReferralERODForBookTheatreVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.ReferralERODForBookTheatreVoCollection createReferralERODForBookTheatreVoCollectionFromReferralEROD(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.ReferralEROD objects.
	 */
	public static ims.careuk.vo.ReferralERODForBookTheatreVoCollection createReferralERODForBookTheatreVoCollectionFromReferralEROD(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.ReferralERODForBookTheatreVoCollection voList = new ims.careuk.vo.ReferralERODForBookTheatreVoCollection();
	 ...
	 */
	 public static java.util.Set extractReferralERODSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralERODForBookTheatreVoCollection voCollection) 
	 {
	 	return extractReferralERODSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractReferralERODSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralERODForBookTheatreVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.ReferralERODForBookTheatreVo vo = voCollection.get(i);
			ims.careuk.domain.objects.ReferralEROD domainObject = ReferralERODForBookTheatreVoAssembler.extractReferralEROD(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractReferralERODList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralERODForBookTheatreVoCollection voCollection) 
	 {
	 	return extractReferralERODList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractReferralERODList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralERODForBookTheatreVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.ReferralERODForBookTheatreVo create(ims.careuk.domain.objects.ReferralEROD domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.ReferralERODForBookTheatreVo create(DomainObjectMap map, ims.careuk.domain.objects.ReferralEROD domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.ReferralERODForBookTheatreVo valueObject = (ims.careuk.vo.ReferralERODForBookTheatreVo) map.getValueObject(domainObject, ims.careuk.vo.ReferralERODForBookTheatreVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.ReferralERODForBookTheatreVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.careuk.domain.objects.ReferralEROD
	 */
	 public static ims.careuk.vo.ReferralERODForBookTheatreVo insert(ims.careuk.vo.ReferralERODForBookTheatreVo valueObject, ims.careuk.domain.objects.ReferralEROD domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.careuk.domain.objects.ReferralEROD
	 */
	 public static ims.careuk.vo.ReferralERODForBookTheatreVo insert(DomainObjectMap map, ims.careuk.vo.ReferralERODForBookTheatreVo valueObject, ims.careuk.domain.objects.ReferralEROD domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.careuk.domain.objects.ReferralEROD extractReferralEROD(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralERODForBookTheatreVo valueObject) 
	{
		return 	extractReferralEROD(domainFactory, valueObject, new HashMap());
	}

	public static ims.careuk.domain.objects.ReferralEROD extractReferralEROD(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.ReferralERODForBookTheatreVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.ReferralERODForBookTheatreVo ID_ReferralEROD field is unknown
