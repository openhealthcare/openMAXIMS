...
public class SuitableForSurgeryAssessmentLiteVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.SuitableForSurgeryAssessmentLiteVo copy(ims.careuk.vo.SuitableForSurgeryAssessmentLiteVo valueObjectDest, ims.careuk.vo.SuitableForSurgeryAssessmentLiteVo valueObjectSrc) 
	 {
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.SuitableForSurgeryAssessment objects.
	 */
	public static ims.careuk.vo.SuitableForSurgeryAssessmentLiteVoCollection createSuitableForSurgeryAssessmentLiteVoCollectionFromSuitableForSurgeryAssessment(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.SuitableForSurgeryAssessment objects.
	 */
	public static ims.careuk.vo.SuitableForSurgeryAssessmentLiteVoCollection createSuitableForSurgeryAssessmentLiteVoCollectionFromSuitableForSurgeryAssessment(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.SuitableForSurgeryAssessmentLiteVoCollection voList = new ims.careuk.vo.SuitableForSurgeryAssessmentLiteVoCollection();
		...
		{
			ims.careuk.domain.objects.SuitableForSurgeryAssessment domainObject = (ims.careuk.domain.objects.SuitableForSurgeryAssessment) iterator.next();
			ims.careuk.vo.SuitableForSurgeryAssessmentLiteVo vo = create(map, domainObject);
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.SuitableForSurgeryAssessment objects.
	 */
	public static ims.careuk.vo.SuitableForSurgeryAssessmentLiteVoCollection createSuitableForSurgeryAssessmentLiteVoCollectionFromSuitableForSurgeryAssessment(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.SuitableForSurgeryAssessment objects.
	 */
	public static ims.careuk.vo.SuitableForSurgeryAssessmentLiteVoCollection createSuitableForSurgeryAssessmentLiteVoCollectionFromSuitableForSurgeryAssessment(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.SuitableForSurgeryAssessmentLiteVoCollection voList = new ims.careuk.vo.SuitableForSurgeryAssessmentLiteVoCollection();
		...
		{
			ims.careuk.domain.objects.SuitableForSurgeryAssessment domainObject = (ims.careuk.domain.objects.SuitableForSurgeryAssessment) domainObjectList.get(i);
			ims.careuk.vo.SuitableForSurgeryAssessmentLiteVo vo = create(map, domainObject);
	...
	/**
	 * Create the ims.careuk.domain.objects.SuitableForSurgeryAssessment set from the value object collection.
	 * @param domainFactory - used to create existing (persistent) domain objects.
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.Set extractSuitableForSurgeryAssessmentSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.SuitableForSurgeryAssessmentLiteVoCollection voCollection) 
	 {
	 	return extractSuitableForSurgeryAssessmentSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractSuitableForSurgeryAssessmentSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.SuitableForSurgeryAssessmentLiteVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.SuitableForSurgeryAssessmentLiteVo vo = voCollection.get(i);
			ims.careuk.domain.objects.SuitableForSurgeryAssessment domainObject = SuitableForSurgeryAssessmentLiteVoAssembler.extractSuitableForSurgeryAssessment(domainFactory, vo, domMap);
	...
	/**
	 * Create the ims.careuk.domain.objects.SuitableForSurgeryAssessment list from the value object collection.
	 * @param domainFactory - used to create existing (persistent) domain objects.
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractSuitableForSurgeryAssessmentList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.SuitableForSurgeryAssessmentLiteVoCollection voCollection) 
	 {
	 	return extractSuitableForSurgeryAssessmentList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractSuitableForSurgeryAssessmentList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.SuitableForSurgeryAssessmentLiteVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	...
	/**
	 * Create the ValueObject from the ims.careuk.domain.objects.SuitableForSurgeryAssessment object.
	 * @param domainObject ims.careuk.domain.objects.SuitableForSurgeryAssessment
	 */
	 public static ims.careuk.vo.SuitableForSurgeryAssessmentLiteVo create(ims.careuk.domain.objects.SuitableForSurgeryAssessment domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.SuitableForSurgeryAssessmentLiteVo create(DomainObjectMap map, ims.careuk.domain.objects.SuitableForSurgeryAssessment domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.SuitableForSurgeryAssessmentLiteVo valueObject = (ims.careuk.vo.SuitableForSurgeryAssessmentLiteVo) map.getValueObject(domainObject, ims.careuk.vo.SuitableForSurgeryAssessmentLiteVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.SuitableForSurgeryAssessmentLiteVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.careuk.domain.objects.SuitableForSurgeryAssessment
	 */
	 public static ims.careuk.vo.SuitableForSurgeryAssessmentLiteVo insert(ims.careuk.vo.SuitableForSurgeryAssessmentLiteVo valueObject, ims.careuk.domain.objects.SuitableForSurgeryAssessment domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.careuk.domain.objects.SuitableForSurgeryAssessment
	 */
	 public static ims.careuk.vo.SuitableForSurgeryAssessmentLiteVo insert(DomainObjectMap map, ims.careuk.vo.SuitableForSurgeryAssessmentLiteVo valueObject, ims.careuk.domain.objects.SuitableForSurgeryAssessment domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		if ( null != instance10 ) {
			...
			ims.careuk.vo.lookups.ReasonNotSuitableForSurgery voLookup10 = new ims.careuk.vo.lookups.ReasonNotSuitableForSurgery(instance10.getId(),instance10.getText(), instance10.isActive(), null, img, color);
			ims.careuk.vo.lookups.ReasonNotSuitableForSurgery parentVoLookup10 = voLookup10;
			...
			while (parent10 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup10.setParent(new ims.careuk.vo.lookups.ReasonNotSuitableForSurgery(parent10.getId(),parent10.getText(), parent10.isActive(), null, img, color));
			...
			valueObject.setReasonNotSuitable(voLookup10);
				...
				// Comments
		valueObject.setComments(ims.careuk.vo.domain.SuitableForSurgeryCommentVoAssembler.createSuitableForSurgeryCommentVoCollectionFromSuitableForSurgeryComment(map, domainObject.getComments()) );
		// ProcedurePerformed
	 ...
	 */
	public static ims.careuk.domain.objects.SuitableForSurgeryAssessment extractSuitableForSurgeryAssessment(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.SuitableForSurgeryAssessmentLiteVo valueObject) 
	{
		return 	extractSuitableForSurgeryAssessment(domainFactory, valueObject, new HashMap());
	}

	public static ims.careuk.domain.objects.SuitableForSurgeryAssessment extractSuitableForSurgeryAssessment(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.SuitableForSurgeryAssessmentLiteVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		ims.careuk.domain.objects.SuitableForSurgeryAssessment domainObject = null;
		if ( null == id) 
		{
			if (domMap.get(valueObject) != null)
			{
				return (ims.careuk.domain.objects.SuitableForSurgeryAssessment)domMap.get(valueObject);
			}
			// ims.careuk.vo.SuitableForSurgeryAssessmentLiteVo ID_SuitableForSurgeryAssessment field is unknown
			domainObject = new ims.careuk.domain.objects.SuitableForSurgeryAssessment();
		...
		else 
		{
			...
			{
				return (ims.careuk.domain.objects.SuitableForSurgeryAssessment)domMap.get(key);
			}
			domainObject = (ims.careuk.domain.objects.SuitableForSurgeryAssessment) domainFactory.getDomainObject(ims.careuk.domain.objects.SuitableForSurgeryAssessment.class, id );
		...
		domainObject.setComments(ims.careuk.vo.domain.SuitableForSurgeryCommentVoAssembler.extractSuitableForSurgeryCommentSet(domainFactory, valueObject.getComments(), domainObject.getComments(), domMap));		
