...
public class PatientDiagnosisForClinicalNotesVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.PatientDiagnosisForClinicalNotesVo copy(ims.careuk.vo.PatientDiagnosisForClinicalNotesVo valueObjectDest, ims.careuk.vo.PatientDiagnosisForClinicalNotesVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.PatientDiagnosisForClinicalNotesVoCollection createPatientDiagnosisForClinicalNotesVoCollectionFromPatientDiagnosis(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.core.clinical.domain.objects.PatientDiagnosis objects.
	 */
	public static ims.careuk.vo.PatientDiagnosisForClinicalNotesVoCollection createPatientDiagnosisForClinicalNotesVoCollectionFromPatientDiagnosis(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.PatientDiagnosisForClinicalNotesVoCollection voList = new ims.careuk.vo.PatientDiagnosisForClinicalNotesVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.PatientDiagnosisForClinicalNotesVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.PatientDiagnosisForClinicalNotesVoCollection createPatientDiagnosisForClinicalNotesVoCollectionFromPatientDiagnosis(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.core.clinical.domain.objects.PatientDiagnosis objects.
	 */
	public static ims.careuk.vo.PatientDiagnosisForClinicalNotesVoCollection createPatientDiagnosisForClinicalNotesVoCollectionFromPatientDiagnosis(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.PatientDiagnosisForClinicalNotesVoCollection voList = new ims.careuk.vo.PatientDiagnosisForClinicalNotesVoCollection();
	 ...
	 */
	 public static java.util.Set extractPatientDiagnosisSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientDiagnosisForClinicalNotesVoCollection voCollection) 
	 {
	 	return extractPatientDiagnosisSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientDiagnosisSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientDiagnosisForClinicalNotesVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.PatientDiagnosisForClinicalNotesVo vo = voCollection.get(i);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPatientDiagnosisList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientDiagnosisForClinicalNotesVoCollection voCollection) 
	 {
	 	return extractPatientDiagnosisList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPatientDiagnosisList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientDiagnosisForClinicalNotesVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.PatientDiagnosisForClinicalNotesVo create(ims.core.clinical.domain.objects.PatientDiagnosis domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.PatientDiagnosisForClinicalNotesVo create(DomainObjectMap map, ims.core.clinical.domain.objects.PatientDiagnosis domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.PatientDiagnosisForClinicalNotesVo valueObject = (ims.careuk.vo.PatientDiagnosisForClinicalNotesVo) map.getValueObject(domainObject, ims.careuk.vo.PatientDiagnosisForClinicalNotesVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.PatientDiagnosisForClinicalNotesVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.PatientDiagnosis
	 */
	 public static ims.careuk.vo.PatientDiagnosisForClinicalNotesVo insert(ims.careuk.vo.PatientDiagnosisForClinicalNotesVo valueObject, ims.core.clinical.domain.objects.PatientDiagnosis domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.PatientDiagnosis
	 */
	 public static ims.careuk.vo.PatientDiagnosisForClinicalNotesVo insert(DomainObjectMap map, ims.careuk.vo.PatientDiagnosisForClinicalNotesVo valueObject, ims.core.clinical.domain.objects.PatientDiagnosis domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.clinical.domain.objects.PatientDiagnosis extractPatientDiagnosis(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientDiagnosisForClinicalNotesVo valueObject) 
	{
		return 	extractPatientDiagnosis(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.clinical.domain.objects.PatientDiagnosis extractPatientDiagnosis(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.PatientDiagnosisForClinicalNotesVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.PatientDiagnosisForClinicalNotesVo ID_PatientDiagnosis field is unknown
