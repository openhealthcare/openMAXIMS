...
public class OnwardReferralFromTriageVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.OnwardReferralFromTriageVo copy(ims.careuk.vo.OnwardReferralFromTriageVo valueObjectDest, ims.careuk.vo.OnwardReferralFromTriageVo valueObjectSrc) 
	 {
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.OnwardReferralFromTriage objects.
	 */
	public static ims.careuk.vo.OnwardReferralFromTriageVoCollection createOnwardReferralFromTriageVoCollectionFromOnwardReferralFromTriage(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.careuk.domain.objects.OnwardReferralFromTriage objects.
	 */
	public static ims.careuk.vo.OnwardReferralFromTriageVoCollection createOnwardReferralFromTriageVoCollectionFromOnwardReferralFromTriage(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.OnwardReferralFromTriageVoCollection voList = new ims.careuk.vo.OnwardReferralFromTriageVoCollection();
		...
		{
			ims.careuk.domain.objects.OnwardReferralFromTriage domainObject = (ims.careuk.domain.objects.OnwardReferralFromTriage) iterator.next();
			ims.careuk.vo.OnwardReferralFromTriageVo vo = create(map, domainObject);
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.OnwardReferralFromTriage objects.
	 */
	public static ims.careuk.vo.OnwardReferralFromTriageVoCollection createOnwardReferralFromTriageVoCollectionFromOnwardReferralFromTriage(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.careuk.domain.objects.OnwardReferralFromTriage objects.
	 */
	public static ims.careuk.vo.OnwardReferralFromTriageVoCollection createOnwardReferralFromTriageVoCollectionFromOnwardReferralFromTriage(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.OnwardReferralFromTriageVoCollection voList = new ims.careuk.vo.OnwardReferralFromTriageVoCollection();
		...
		{
			ims.careuk.domain.objects.OnwardReferralFromTriage domainObject = (ims.careuk.domain.objects.OnwardReferralFromTriage) domainObjectList.get(i);
			ims.careuk.vo.OnwardReferralFromTriageVo vo = create(map, domainObject);
	...
	/**
	 * Create the ims.careuk.domain.objects.OnwardReferralFromTriage set from the value object collection.
	 * @param domainFactory - used to create existing (persistent) domain objects.
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.Set extractOnwardReferralFromTriageSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.OnwardReferralFromTriageVoCollection voCollection) 
	 {
	 	return extractOnwardReferralFromTriageSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractOnwardReferralFromTriageSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.OnwardReferralFromTriageVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.OnwardReferralFromTriageVo vo = voCollection.get(i);
			ims.careuk.domain.objects.OnwardReferralFromTriage domainObject = OnwardReferralFromTriageVoAssembler.extractOnwardReferralFromTriage(domainFactory, vo, domMap);
	...
	/**
	 * Create the ims.careuk.domain.objects.OnwardReferralFromTriage list from the value object collection.
	 * @param domainFactory - used to create existing (persistent) domain objects.
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractOnwardReferralFromTriageList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.OnwardReferralFromTriageVoCollection voCollection) 
	 {
	 	return extractOnwardReferralFromTriageList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractOnwardReferralFromTriageList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.OnwardReferralFromTriageVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	...
	/**
	 * Create the ValueObject from the ims.careuk.domain.objects.OnwardReferralFromTriage object.
	 * @param domainObject ims.careuk.domain.objects.OnwardReferralFromTriage
	 */
	 public static ims.careuk.vo.OnwardReferralFromTriageVo create(ims.careuk.domain.objects.OnwardReferralFromTriage domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.OnwardReferralFromTriageVo create(DomainObjectMap map, ims.careuk.domain.objects.OnwardReferralFromTriage domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.OnwardReferralFromTriageVo valueObject = (ims.careuk.vo.OnwardReferralFromTriageVo) map.getValueObject(domainObject, ims.careuk.vo.OnwardReferralFromTriageVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.OnwardReferralFromTriageVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.careuk.domain.objects.OnwardReferralFromTriage
	 */
	 public static ims.careuk.vo.OnwardReferralFromTriageVo insert(ims.careuk.vo.OnwardReferralFromTriageVo valueObject, ims.careuk.domain.objects.OnwardReferralFromTriage domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.careuk.domain.objects.OnwardReferralFromTriage
	 */
	 public static ims.careuk.vo.OnwardReferralFromTriageVo insert(DomainObjectMap map, ims.careuk.vo.OnwardReferralFromTriageVo valueObject, ims.careuk.domain.objects.OnwardReferralFromTriage domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		if ( null != instance7 ) {
			...
			ims.careuk.vo.lookups.ServiceReferredInto voLookup7 = new ims.careuk.vo.lookups.ServiceReferredInto(instance7.getId(),instance7.getText(), instance7.isActive(), null, img, color);
			ims.careuk.vo.lookups.ServiceReferredInto parentVoLookup7 = voLookup7;
			...
			while (parent7 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup7.setParent(new ims.careuk.vo.lookups.ServiceReferredInto(parent7.getId(),parent7.getText(), parent7.isActive(), null, img, color));
	 ...
	 */
	public static ims.careuk.domain.objects.OnwardReferralFromTriage extractOnwardReferralFromTriage(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.OnwardReferralFromTriageVo valueObject) 
	{
		return 	extractOnwardReferralFromTriage(domainFactory, valueObject, new HashMap());
	}

	public static ims.careuk.domain.objects.OnwardReferralFromTriage extractOnwardReferralFromTriage(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.OnwardReferralFromTriageVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		ims.careuk.domain.objects.OnwardReferralFromTriage domainObject = null;
		if ( null == id) 
		{
			if (domMap.get(valueObject) != null)
			{
				return (ims.careuk.domain.objects.OnwardReferralFromTriage)domMap.get(valueObject);
			}
			// ims.careuk.vo.OnwardReferralFromTriageVo ID_OnwardReferralFromTriage field is unknown
			domainObject = new ims.careuk.domain.objects.OnwardReferralFromTriage();
		...
		else 
		{
			...
			{
				return (ims.careuk.domain.objects.OnwardReferralFromTriage)domMap.get(key);
			}
			domainObject = (ims.careuk.domain.objects.OnwardReferralFromTriage) domainFactory.getDomainObject(ims.careuk.domain.objects.OnwardReferralFromTriage.class, id );
