...
public class LocationConfigVoAssembler
{
	 ...
	 */
	 public static ims.careuk.vo.LocationConfigVo copy(ims.careuk.vo.LocationConfigVo valueObjectDest, ims.careuk.vo.LocationConfigVo valueObjectSrc) 
	 {
	 ...
	 */
	public static ims.careuk.vo.LocationConfigVoCollection createLocationConfigVoCollectionFromLocation(java.util.Set domainObjectSet)	
	{
	 ...
	 * @param domainObjectSet - Set of ims.core.resource.place.domain.objects.Location objects.
	 */
	public static ims.careuk.vo.LocationConfigVoCollection createLocationConfigVoCollectionFromLocation(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.careuk.vo.LocationConfigVoCollection voList = new ims.careuk.vo.LocationConfigVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.careuk.vo.LocationConfigVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.careuk.vo.LocationConfigVoCollection createLocationConfigVoCollectionFromLocation(java.util.List domainObjectList) 
	{
	 ...
	 * @param domainObjectList - List of ims.core.resource.place.domain.objects.Location objects.
	 */
	public static ims.careuk.vo.LocationConfigVoCollection createLocationConfigVoCollectionFromLocation(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.careuk.vo.LocationConfigVoCollection voList = new ims.careuk.vo.LocationConfigVoCollection();
	 ...
	 */
	 public static java.util.Set extractLocationSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.LocationConfigVoCollection voCollection) 
	 {
	 	return extractLocationSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractLocationSet(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.LocationConfigVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.careuk.vo.LocationConfigVo vo = voCollection.get(i);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractLocationList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.LocationConfigVoCollection voCollection) 
	 {
	 	return extractLocationList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractLocationList(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.LocationConfigVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.careuk.vo.LocationConfigVo create(ims.core.resource.place.domain.objects.Location domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.careuk.vo.LocationConfigVo create(DomainObjectMap map, ims.core.resource.place.domain.objects.Location domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.careuk.vo.LocationConfigVo valueObject = (ims.careuk.vo.LocationConfigVo) map.getValueObject(domainObject, ims.careuk.vo.LocationConfigVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.careuk.vo.LocationConfigVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.resource.place.domain.objects.Location
	 */
	 public static ims.careuk.vo.LocationConfigVo insert(ims.careuk.vo.LocationConfigVo valueObject, ims.core.resource.place.domain.objects.Location domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.resource.place.domain.objects.Location
	 */
	 public static ims.careuk.vo.LocationConfigVo insert(DomainObjectMap map, ims.careuk.vo.LocationConfigVo valueObject, ims.core.resource.place.domain.objects.Location domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.resource.place.domain.objects.Location extractLocation(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.LocationConfigVo valueObject) 
	{
		return 	extractLocation(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.resource.place.domain.objects.Location extractLocation(ims.domain.ILightweightDomainFactory domainFactory, ims.careuk.vo.LocationConfigVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.careuk.vo.LocationConfigVo ID_Location field is unknown
