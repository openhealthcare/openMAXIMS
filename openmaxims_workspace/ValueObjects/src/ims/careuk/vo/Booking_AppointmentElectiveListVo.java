...
public class Booking_AppointmentElectiveListVo extends ims.scheduling.vo.Booking_AppointmentRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public Booking_AppointmentElectiveListVo(ims.careuk.vo.beans.Booking_AppointmentElectiveListVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.Booking_AppointmentElectiveListVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.Booking_AppointmentElectiveListVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.Booking_AppointmentElectiveListVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.Booking_AppointmentElectiveListVoBean();
