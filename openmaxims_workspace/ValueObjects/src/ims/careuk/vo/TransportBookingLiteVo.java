...
public class TransportBookingLiteVo extends ims.core.vo.TransportBookingRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public TransportBookingLiteVo(ims.careuk.vo.beans.TransportBookingLiteVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.TransportBookingLiteVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.datebooked = bean.getDateBooked() == null ? null : bean.getDateBooked().buildDate();
	...
	{
		ims.careuk.vo.beans.TransportBookingLiteVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.TransportBookingLiteVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.TransportBookingLiteVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.bookingreference == null || this.bookingreference.length() == 0)
			...
			listOfErrors.add("The length of the field [bookingreference] in the value object [ims.careuk.vo.TransportBookingLiteVo] is too big. It should be less or equal to 25");
