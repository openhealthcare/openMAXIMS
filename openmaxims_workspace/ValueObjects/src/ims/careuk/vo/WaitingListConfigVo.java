...
public class WaitingListConfigVo extends ims.core.configuration.vo.ElectiveListConfigurationRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public WaitingListConfigVo(ims.careuk.vo.beans.WaitingListConfigVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.WaitingListConfigVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.waitinglistname = bean.getWaitingListName();
	...
	{
		ims.careuk.vo.beans.WaitingListConfigVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.WaitingListConfigVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.WaitingListConfigVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.waitinglistname == null || this.waitinglistname.length() == 0)
			...
			listOfErrors.add("The length of the field [waitinglistname] in the value object [ims.careuk.vo.WaitingListConfigVo] is too big. It should be less or equal to 150");
		...
		if(this.waitinglistcode != null)
			if(this.waitinglistcode.length() > 20)
				listOfErrors.add("The length of the field [waitinglistcode] in the value object [ims.careuk.vo.WaitingListConfigVo] is too big. It should be less or equal to 20");
