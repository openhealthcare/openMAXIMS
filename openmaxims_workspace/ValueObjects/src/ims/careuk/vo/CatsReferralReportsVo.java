 ...
 */
public class CatsReferralReportsVo extends ims.careuk.vo.CatsReferralRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public CatsReferralReportsVo(ims.careuk.vo.beans.CatsReferralReportsVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.CatsReferralReportsVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.isfinalreportrequired = bean.getIsFinalReportRequired() == null ? null : ims.careuk.vo.lookups.ReportStatus.buildLookup(bean.getIsFinalReportRequired());
	...
	{
		ims.careuk.vo.beans.CatsReferralReportsVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.CatsReferralReportsVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.CatsReferralReportsVoBean();
