 ...
 */
public class ConsultationTimeVo extends ims.careuk.vo.ConsultationTimeRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ConsultationTimeVo(ims.careuk.vo.beans.ConsultationTimeVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.ConsultationTimeVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.ConsultationTimeVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.ConsultationTimeVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.ConsultationTimeVoBean();
