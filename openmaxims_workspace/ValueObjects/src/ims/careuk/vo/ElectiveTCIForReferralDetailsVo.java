 ...
 */
public class ElectiveTCIForReferralDetailsVo extends ims.careuk.vo.TCIForPatientElectiveListRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ElectiveTCIForReferralDetailsVo(ims.careuk.vo.beans.ElectiveTCIForReferralDetailsVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.ElectiveTCIForReferralDetailsVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.tcidate = bean.getTCIDate() == null ? null : bean.getTCIDate().buildDate();
	...
	{
		ims.careuk.vo.beans.ElectiveTCIForReferralDetailsVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.ElectiveTCIForReferralDetailsVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.ElectiveTCIForReferralDetailsVoBean();
