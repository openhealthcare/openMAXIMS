...
public class PasEventForClinicalCodingWorklistVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<PasEventForClinicalCodingWorklistVo>
{
	...
	public ims.careuk.vo.beans.PasEventForClinicalCodingWorklistVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.PasEventForClinicalCodingWorklistVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.PasEventForClinicalCodingWorklistVoBean[] result = new ims.careuk.vo.beans.PasEventForClinicalCodingWorklistVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			PasEventForClinicalCodingWorklistVo vo = ((PasEventForClinicalCodingWorklistVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.PasEventForClinicalCodingWorklistVoBean)vo.getBean();
		}
		return result;
	}
	public static PasEventForClinicalCodingWorklistVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.PasEventForClinicalCodingWorklistVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static PasEventForClinicalCodingWorklistVoCollection buildFromBeanCollection(ims.careuk.vo.beans.PasEventForClinicalCodingWorklistVoBean[] beans)
	{
		PasEventForClinicalCodingWorklistVoCollection coll = new PasEventForClinicalCodingWorklistVoCollection();
		if(beans == null)
			return coll;
