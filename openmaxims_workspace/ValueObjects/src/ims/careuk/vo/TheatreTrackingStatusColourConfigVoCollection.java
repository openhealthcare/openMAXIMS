...
public class TheatreTrackingStatusColourConfigVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<TheatreTrackingStatusColourConfigVo>
{
	...
	public ims.careuk.vo.TheatreTrackingStatusColourConfigRefVoCollection toRefVoCollection()
	{
		ims.careuk.vo.TheatreTrackingStatusColourConfigRefVoCollection result = new ims.careuk.vo.TheatreTrackingStatusColourConfigRefVoCollection();
		for(int x = 0; x < this.col.size(); x++)
		{
	...
	public ims.careuk.vo.beans.TheatreTrackingStatusColourConfigVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.TheatreTrackingStatusColourConfigVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.TheatreTrackingStatusColourConfigVoBean[] result = new ims.careuk.vo.beans.TheatreTrackingStatusColourConfigVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			TheatreTrackingStatusColourConfigVo vo = ((TheatreTrackingStatusColourConfigVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.TheatreTrackingStatusColourConfigVoBean)vo.getBean();
		}
		return result;
	}
	public static TheatreTrackingStatusColourConfigVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.TheatreTrackingStatusColourConfigVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static TheatreTrackingStatusColourConfigVoCollection buildFromBeanCollection(ims.careuk.vo.beans.TheatreTrackingStatusColourConfigVoBean[] beans)
	{
		TheatreTrackingStatusColourConfigVoCollection coll = new TheatreTrackingStatusColourConfigVoCollection();
		if(beans == null)
			return coll;
