...
public class ConsultationAssessmentsLiteVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<ConsultationAssessmentsLiteVo>
{
	...
	public ims.careuk.vo.beans.ConsultationAssessmentsLiteVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.ConsultationAssessmentsLiteVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.ConsultationAssessmentsLiteVoBean[] result = new ims.careuk.vo.beans.ConsultationAssessmentsLiteVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			ConsultationAssessmentsLiteVo vo = ((ConsultationAssessmentsLiteVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.ConsultationAssessmentsLiteVoBean)vo.getBean();
		}
		return result;
	}
	public static ConsultationAssessmentsLiteVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.ConsultationAssessmentsLiteVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static ConsultationAssessmentsLiteVoCollection buildFromBeanCollection(ims.careuk.vo.beans.ConsultationAssessmentsLiteVoBean[] beans)
	{
		ConsultationAssessmentsLiteVoCollection coll = new ConsultationAssessmentsLiteVoCollection();
		if(beans == null)
			return coll;
