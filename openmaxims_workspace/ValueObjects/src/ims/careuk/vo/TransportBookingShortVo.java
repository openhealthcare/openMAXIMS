 ...
 */
public class TransportBookingShortVo extends ims.careuk.vo.TransportBookingLiteVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public TransportBookingShortVo(ims.careuk.vo.beans.TransportBookingShortVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.TransportBookingShortVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.datebooked = bean.getDateBooked() == null ? null : bean.getDateBooked().buildDate();
	...
	{
		ims.careuk.vo.beans.TransportBookingShortVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.TransportBookingShortVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.TransportBookingShortVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.bookingreference == null || this.bookingreference.length() == 0)
			...
			listOfErrors.add("The length of the field [bookingreference] in the value object [ims.careuk.vo.TransportBookingShortVo] is too big. It should be less or equal to 25");
