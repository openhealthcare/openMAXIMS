 ...
 */
public class ReferralAppointmentDetailsVo extends ims.careuk.vo.CatsReferralRefVo implements ims.vo.ImsCloneable, Comparable, ims.vo.interfaces.IReferralApptDetail
{
	...
	public ReferralAppointmentDetailsVo(ims.careuk.vo.beans.ReferralAppointmentDetailsVoBean bean)
	{
		this.id = bean.getId();
		...
		this.outpatienterod = ims.careuk.vo.ReferralERODVoCollection.buildFromBeanCollection(bean.getOutpatientEROD());
		this.electiveerod = ims.careuk.vo.ReferralERODVoCollection.buildFromBeanCollection(bean.getElectiveEROD());
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.ReferralAppointmentDetailsVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.ReferralAppointmentDetailsVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.ReferralAppointmentDetailsVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.ReferralAppointmentDetailsVoBean();
	...
	public ims.careuk.vo.ReferralLetterDetailsLiteWithGPVo getReferralDetails()
	{
		return this.referraldetails;
	}
	public void setReferralDetails(ims.careuk.vo.ReferralLetterDetailsLiteWithGPVo value)
	{
	...
	public ims.careuk.vo.ReferralERODVoCollection getOutpatientEROD()
	{
		return this.outpatienterod;
	}
	public void setOutpatientEROD(ims.careuk.vo.ReferralERODVoCollection value)
	{
		this.isValidated = false;
	...
	public ims.careuk.vo.ReferralERODVoCollection getElectiveEROD()
	{
		return this.electiveerod;
	}
	public void setElectiveEROD(ims.careuk.vo.ReferralERODVoCollection value)
	{
		this.isValidated = false;
	...
	*/
		...
		{
			ims.careuk.vo.ReferralLetterDetailsLiteVo voReferralLetterDetail = this.getReferralDetails();
		...
		{
			ims.careuk.vo.ReferralLetterDetailsLiteWithGPVo voReferralLetterDetail = this.getReferralDetails();
		...
		public ims.careuk.vo.CatsReferralStatusVoCollection getIReferralApptDetailStatusHistory()
		{
		...
		public ims.careuk.vo.OrderInvApptListVoCollection getIReferralApptDetailOrdInvAppts()
		{
			return this.getOrderInvAppts();
		}
	
		public ims.careuk.vo.ReferralERODVoCollection getIReferralOutpatientEROD()
		{
			return this.outpatienterod;
		}
	
		public ims.careuk.vo.ReferralERODVoCollection getIReferralTheatreEROD()
		{
			return this.electiveerod;
		}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.pathwayid != null)
			if(this.pathwayid.length() > 20)
				listOfErrors.add("The length of the field [pathwayid] in the value object [ims.careuk.vo.ReferralAppointmentDetailsVo] is too big. It should be less or equal to 20");
	...
	public Object clone()
	{
		...
		if(this.referraldetails == null)
			...
			clone.referraldetails = (ims.careuk.vo.ReferralLetterDetailsLiteWithGPVo)this.referraldetails.clone();
		if(this.investigationorders == null)
		...
		if(this.outpatienterod == null)
			...
			clone.outpatienterod = (ims.careuk.vo.ReferralERODVoCollection)this.outpatienterod.clone();
		if(this.electiveerod == null)
			clone.electiveerod = null;
		else
			clone.electiveerod = (ims.careuk.vo.ReferralERODVoCollection)this.electiveerod.clone();
	...
	protected ims.careuk.vo.ReferralLetterDetailsLiteWithGPVo referraldetails;
	...
	protected ims.careuk.vo.ReferralERODVoCollection outpatienterod;
	protected ims.careuk.vo.ReferralERODVoCollection electiveerod;
