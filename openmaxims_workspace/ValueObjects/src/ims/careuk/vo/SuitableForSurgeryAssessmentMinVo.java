 ...
 */
public class SuitableForSurgeryAssessmentMinVo extends ims.careuk.vo.SuitableForSurgeryAssessmentRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public SuitableForSurgeryAssessmentMinVo(ims.careuk.vo.beans.SuitableForSurgeryAssessmentMinVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.SuitableForSurgeryAssessmentMinVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.SuitableForSurgeryAssessmentMinVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.SuitableForSurgeryAssessmentMinVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.SuitableForSurgeryAssessmentMinVoBean();
