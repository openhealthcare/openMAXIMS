 ...
 */
public class CatsReferralListVo extends ims.careuk.vo.CatsReferralRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public CatsReferralListVo(ims.careuk.vo.beans.CatsReferralListVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.CatsReferralListVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.CatsReferralListVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.CatsReferralListVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.CatsReferralListVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.pathwayid != null)
			if(this.pathwayid.length() > 20)
				listOfErrors.add("The length of the field [pathwayid] in the value object [ims.careuk.vo.CatsReferralListVo] is too big. It should be less or equal to 20");
