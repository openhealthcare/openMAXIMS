...
public class CCGToContractConfigVo extends ims.core.configuration.vo.CCGToContractConfigRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public CCGToContractConfigVo(ims.careuk.vo.beans.CCGToContractConfigVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.CCGToContractConfigVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.ccgcode = bean.getCCGCode();
	...
	{
		ims.careuk.vo.beans.CCGToContractConfigVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.CCGToContractConfigVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.CCGToContractConfigVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.ccgcode == null || this.ccgcode.length() == 0)
			...
			listOfErrors.add("The length of the field [ccgcode] in the value object [ims.careuk.vo.CCGToContractConfigVo] is too big. It should be less or equal to 5");
