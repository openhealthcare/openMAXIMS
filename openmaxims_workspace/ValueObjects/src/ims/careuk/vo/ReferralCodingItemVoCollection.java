...
public class ReferralCodingItemVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<ReferralCodingItemVo>
{
	...
	public ims.careuk.vo.ReferralCodingItemRefVoCollection toRefVoCollection()
	{
		ims.careuk.vo.ReferralCodingItemRefVoCollection result = new ims.careuk.vo.ReferralCodingItemRefVoCollection();
		for(int x = 0; x < this.col.size(); x++)
		{
	...
	public ims.careuk.vo.beans.ReferralCodingItemVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.ReferralCodingItemVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.ReferralCodingItemVoBean[] result = new ims.careuk.vo.beans.ReferralCodingItemVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			ReferralCodingItemVo vo = ((ReferralCodingItemVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.ReferralCodingItemVoBean)vo.getBean();
		}
		return result;
	}
	public static ReferralCodingItemVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.ReferralCodingItemVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static ReferralCodingItemVoCollection buildFromBeanCollection(ims.careuk.vo.beans.ReferralCodingItemVoBean[] beans)
	{
		ReferralCodingItemVoCollection coll = new ReferralCodingItemVoCollection();
		if(beans == null)
			return coll;
