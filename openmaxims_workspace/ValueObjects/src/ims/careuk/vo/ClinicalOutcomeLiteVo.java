 ...
 */
public class ClinicalOutcomeLiteVo extends ims.careuk.vo.ClinicalOutcomeRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ClinicalOutcomeLiteVo(ims.careuk.vo.beans.ClinicalOutcomeLiteVoBean bean)
	{
		this.id = bean.getId();
		...
		this.clinicaloutcomecontext = bean.getClinicalOutcomeContext() == null ? null : ims.careuk.vo.lookups.ClinicalOutcomeContext.buildLookup(bean.getClinicalOutcomeContext());
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.ClinicalOutcomeLiteVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.ClinicalOutcomeLiteVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.ClinicalOutcomeLiteVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.ClinicalOutcomeLiteVoBean();
	...
	public ims.careuk.vo.ClinicalOutcomeProcedureVo getProcedure()
	{
		return this.procedure;
	}
	public void setProcedure(ims.careuk.vo.ClinicalOutcomeProcedureVo value)
	{
		this.isValidated = false;
	...
	public ims.careuk.vo.lookups.ClinicalOutcomeContext getClinicalOutcomeContext()
	{
		return this.clinicaloutcomecontext;
	}
	public void setClinicalOutcomeContext(ims.careuk.vo.lookups.ClinicalOutcomeContext value)
	{
		this.isValidated = false;
	...
	public Object clone()
	{
		...
		if(this.procedure == null)
			...
			clone.procedure = (ims.careuk.vo.ClinicalOutcomeProcedureVo)this.procedure.clone();
		if(this.clinicaloutcomecontext == null)
			clone.clinicaloutcomecontext = null;
		else
			clone.clinicaloutcomecontext = (ims.careuk.vo.lookups.ClinicalOutcomeContext)this.clinicaloutcomecontext.clone();
	...
	protected ims.careuk.vo.ClinicalOutcomeProcedureVo procedure;
	protected ims.careuk.vo.lookups.ClinicalOutcomeContext clinicaloutcomecontext;
