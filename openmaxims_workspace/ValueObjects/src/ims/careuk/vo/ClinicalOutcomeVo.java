 ...
 */
public class ClinicalOutcomeVo extends ims.careuk.vo.ClinicalOutcomeLiteVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ClinicalOutcomeVo(ims.careuk.vo.beans.ClinicalOutcomeVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.ClinicalOutcomeVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.ClinicalOutcomeVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.ClinicalOutcomeVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.ClinicalOutcomeVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.actioncomments != null)
			if(this.actioncomments.length() > 1000)
				listOfErrors.add("The length of the field [actioncomments] in the value object [ims.careuk.vo.ClinicalOutcomeVo] is too big. It should be less or equal to 1000");
