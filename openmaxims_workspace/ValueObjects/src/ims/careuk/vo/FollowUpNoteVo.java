 ...
 */
public class FollowUpNoteVo extends ims.careuk.vo.FollowUpNoteLiteVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public FollowUpNoteVo(ims.careuk.vo.beans.FollowUpNoteVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.FollowUpNoteVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.catsreferral = bean.getCatsReferral() == null ? null : new ims.careuk.vo.CatsReferralRefVo(new Integer(bean.getCatsReferral().getId()), bean.getCatsReferral().getVersion());
	...
	{
		ims.careuk.vo.beans.FollowUpNoteVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.FollowUpNoteVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.FollowUpNoteVoBean();
