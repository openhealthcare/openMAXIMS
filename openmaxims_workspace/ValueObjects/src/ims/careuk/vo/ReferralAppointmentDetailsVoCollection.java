...
public class ReferralAppointmentDetailsVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<ReferralAppointmentDetailsVo>
{
	...
	public ims.careuk.vo.beans.ReferralAppointmentDetailsVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.ReferralAppointmentDetailsVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.ReferralAppointmentDetailsVoBean[] result = new ims.careuk.vo.beans.ReferralAppointmentDetailsVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			ReferralAppointmentDetailsVo vo = ((ReferralAppointmentDetailsVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.ReferralAppointmentDetailsVoBean)vo.getBean();
		}
		return result;
	}
	public static ReferralAppointmentDetailsVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.ReferralAppointmentDetailsVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static ReferralAppointmentDetailsVoCollection buildFromBeanCollection(ims.careuk.vo.beans.ReferralAppointmentDetailsVoBean[] beans)
	{
		ReferralAppointmentDetailsVoCollection coll = new ReferralAppointmentDetailsVoCollection();
		if(beans == null)
			return coll;
