 ...
 */
public class CorrespondenceNoteLiteVo extends ims.careuk.vo.ReportNoteRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public CorrespondenceNoteLiteVo()
	{
	}
	public CorrespondenceNoteLiteVo(Integer id, int version)
	{
		super(id, version);
	}
	public CorrespondenceNoteLiteVo(ims.careuk.vo.beans.CorrespondenceNoteLiteVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.CorrespondenceNoteLiteVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.catsreferral = bean.getCatsReferral() == null ? null : new ims.careuk.vo.CatsReferralRefVo(new Integer(bean.getCatsReferral().getId()), bean.getCatsReferral().getVersion());
	...
	{
		ims.careuk.vo.beans.CorrespondenceNoteLiteVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.CorrespondenceNoteLiteVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.CorrespondenceNoteLiteVoBean();
	...
	public Object clone()
	{
		...
		CorrespondenceNoteLiteVo clone = new CorrespondenceNoteLiteVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(CorrespondenceNoteLiteVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A CorrespondenceNoteLiteVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((CorrespondenceNoteLiteVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((CorrespondenceNoteLiteVo)obj).getBoId());
	}
