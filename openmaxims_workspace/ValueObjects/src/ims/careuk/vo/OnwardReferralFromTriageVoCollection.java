...
public class OnwardReferralFromTriageVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<OnwardReferralFromTriageVo>
{
	...
	{
		return "ims.careuk.domain.objects.OnwardReferralFromTriage";
	}
	...
	public ims.careuk.vo.OnwardReferralFromTriageRefVoCollection toRefVoCollection()
	{
		ims.careuk.vo.OnwardReferralFromTriageRefVoCollection result = new ims.careuk.vo.OnwardReferralFromTriageRefVoCollection();
		for(int x = 0; x < this.col.size(); x++)
		{
	...
	public ims.careuk.vo.beans.OnwardReferralFromTriageVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.OnwardReferralFromTriageVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.OnwardReferralFromTriageVoBean[] result = new ims.careuk.vo.beans.OnwardReferralFromTriageVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			OnwardReferralFromTriageVo vo = ((OnwardReferralFromTriageVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.OnwardReferralFromTriageVoBean)vo.getBean();
		}
		return result;
	}
	public static OnwardReferralFromTriageVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.OnwardReferralFromTriageVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static OnwardReferralFromTriageVoCollection buildFromBeanCollection(ims.careuk.vo.beans.OnwardReferralFromTriageVoBean[] beans)
	{
		OnwardReferralFromTriageVoCollection coll = new OnwardReferralFromTriageVoCollection();
		if(beans == null)
			return coll;
