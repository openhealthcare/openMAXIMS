...
public class PatientProcedureForAppointmentOutcomeVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<PatientProcedureForAppointmentOutcomeVo>
{
	...
	public ims.careuk.vo.beans.PatientProcedureForAppointmentOutcomeVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.PatientProcedureForAppointmentOutcomeVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.PatientProcedureForAppointmentOutcomeVoBean[] result = new ims.careuk.vo.beans.PatientProcedureForAppointmentOutcomeVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			PatientProcedureForAppointmentOutcomeVo vo = ((PatientProcedureForAppointmentOutcomeVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.PatientProcedureForAppointmentOutcomeVoBean)vo.getBean();
		}
		return result;
	}
	public static PatientProcedureForAppointmentOutcomeVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.PatientProcedureForAppointmentOutcomeVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static PatientProcedureForAppointmentOutcomeVoCollection buildFromBeanCollection(ims.careuk.vo.beans.PatientProcedureForAppointmentOutcomeVoBean[] beans)
	{
		PatientProcedureForAppointmentOutcomeVoCollection coll = new PatientProcedureForAppointmentOutcomeVoCollection();
		if(beans == null)
			return coll;
