 ...
 */
public class FurtherManagementDetailsVo extends ims.careuk.vo.FurtherManagementRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public FurtherManagementDetailsVo(ims.careuk.vo.beans.FurtherManagementDetailsVoBean bean)
	{
		this.id = bean.getId();
		...
		this.anotherconsultationappt = bean.getAnotherConsultationAppt() == null ? null : ims.careuk.vo.lookups.AnotherConsultationAppt.buildLookup(bean.getAnotherConsultationAppt());
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.FurtherManagementDetailsVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.followuptype = bean.getFollowupType() == null ? null : ims.careuk.vo.lookups.FollowupManagementType.buildLookup(bean.getFollowupType());
	...
	{
		ims.careuk.vo.beans.FurtherManagementDetailsVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.FurtherManagementDetailsVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.FurtherManagementDetailsVoBean();
	...
	public ims.careuk.vo.lookups.AnotherConsultationAppt getAnotherConsultationAppt()
	{
		return this.anotherconsultationappt;
	}
	public void setAnotherConsultationAppt(ims.careuk.vo.lookups.AnotherConsultationAppt value)
	{
		this.isValidated = false;
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.furthermanagementbycats != null)
			if(this.furthermanagementbycats.length() > 3000)
				listOfErrors.add("The length of the field [furthermanagementbycats] in the value object [ims.careuk.vo.FurtherManagementDetailsVo] is too big. It should be less or equal to 3000");
		if(this.tltnotes != null)
			if(this.tltnotes.length() > 3000)
				listOfErrors.add("The length of the field [tltnotes] in the value object [ims.careuk.vo.FurtherManagementDetailsVo] is too big. It should be less or equal to 3000");
		if(this.procedure != null)
		{
	...
	public Object clone()
	{
		...
		if(this.anotherconsultationappt == null)
			...
			clone.anotherconsultationappt = (ims.careuk.vo.lookups.AnotherConsultationAppt)this.anotherconsultationappt.clone();
		if(this.procedure == null)
	...
	protected ims.careuk.vo.lookups.AnotherConsultationAppt anotherconsultationappt;
