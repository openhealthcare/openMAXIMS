...
public class PatientProcedureForAppointmentOutcomeVo extends ims.core.clinical.vo.PatientProcedureRefVo implements ims.vo.ImsCloneable, Comparable, ims.vo.interfaces.IClinicalCodingValue
{
	...
	public PatientProcedureForAppointmentOutcomeVo(ims.careuk.vo.beans.PatientProcedureForAppointmentOutcomeVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.PatientProcedureForAppointmentOutcomeVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.PatientProcedureForAppointmentOutcomeVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.PatientProcedureForAppointmentOutcomeVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.PatientProcedureForAppointmentOutcomeVoBean();
	...
	*/
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.proceduredescription == null || this.proceduredescription.length() == 0)
			...
			listOfErrors.add("The length of the field [proceduredescription] in the value object [ims.careuk.vo.PatientProcedureForAppointmentOutcomeVo] is too big. It should be less or equal to 255");
		if(this.sitetext != null)
			if(this.sitetext.length() > 255)
				listOfErrors.add("The length of the field [sitetext] in the value object [ims.careuk.vo.PatientProcedureForAppointmentOutcomeVo] is too big. It should be less or equal to 255");
