...
public class CATSReferralFilterVo extends ims.vo.ValueObject implements ims.vo.ImsCloneable, Comparable
{
	...
	public CATSReferralFilterVo(ims.careuk.vo.beans.CATSReferralFilterVoBean bean)
	{
		...
		this.status = bean.getStatus() == null ? null : ims.careuk.vo.lookups.ReferralWorklistStatus.buildLookup(bean.getStatus());
		...
		this.reviewtype = bean.getReviewType() == null ? null : ims.careuk.vo.lookups.ReviewType.buildLookup(bean.getReviewType());
		...
		this.reportsubcategory = bean.getReportSubCategory() == null ? null : ims.careuk.vo.lookups.ReportsRequiredSubCategory.buildLookup(bean.getReportSubCategory());
		this.tlttype = bean.getTLTType() == null ? null : ims.careuk.vo.lookups.TLTType.buildLookup(bean.getTLTType());
		...
		this.secondopinionreason = bean.getSecondOpinionReason() == null ? null : ims.careuk.vo.lookups.SecondOpinionCategory.buildLookup(bean.getSecondOpinionReason());
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.CATSReferralFilterVoBean bean)
	{
		this.fromdate = bean.getFromDate() == null ? null : bean.getFromDate().buildDate();
		this.todate = bean.getToDate() == null ? null : bean.getToDate().buildDate();
		this.status = bean.getStatus() == null ? null : ims.careuk.vo.lookups.ReferralWorklistStatus.buildLookup(bean.getStatus());
	...
	{
		ims.careuk.vo.beans.CATSReferralFilterVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.CATSReferralFilterVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.CATSReferralFilterVoBean();
	...
	public ims.careuk.vo.lookups.ReferralWorklistStatus getStatus()
	{
		return this.status;
	}
	public void setStatus(ims.careuk.vo.lookups.ReferralWorklistStatus value)
	{
		this.isValidated = false;
		this.status = value;
	}
	...
	public ims.careuk.vo.lookups.ReviewType getReviewType()
	{
		return this.reviewtype;
	}
	public void setReviewType(ims.careuk.vo.lookups.ReviewType value)
	{
		this.isValidated = false;
	...
	public ims.careuk.vo.lookups.ReportsRequiredSubCategory getReportSubCategory()
	{
		return this.reportsubcategory;
	}
	public void setReportSubCategory(ims.careuk.vo.lookups.ReportsRequiredSubCategory value)
	{
		this.isValidated = false;
	...
	public ims.careuk.vo.lookups.TLTType getTLTType()
	{
		return this.tlttype;
	}
	public void setTLTType(ims.careuk.vo.lookups.TLTType value)
	{
		this.isValidated = false;
		this.tlttype = value;
	}
	...
	public ims.careuk.vo.lookups.SecondOpinionCategory getSecondOpinionReason()
	{
		return this.secondopinionreason;
	}
	public void setSecondOpinionReason(ims.careuk.vo.lookups.SecondOpinionCategory value)
	{
		this.isValidated = false;
	...
	public ims.careuk.vo.ContractServiceLocationsConfigVo getTreatmentCenter()
	{
		return this.treatmentcenter;
	}
	public void setTreatmentCenter(ims.careuk.vo.ContractServiceLocationsConfigVo value)
	{
		this.isValidated = false;
	...
	public Object clone()
	{
		...
		if(this.status == null)
			...
			clone.status = (ims.careuk.vo.lookups.ReferralWorklistStatus)this.status.clone();
		...
		if(this.reviewtype == null)
			...
			clone.reviewtype = (ims.careuk.vo.lookups.ReviewType)this.reviewtype.clone();
		...
		if(this.reportsubcategory == null)
			...
			clone.reportsubcategory = (ims.careuk.vo.lookups.ReportsRequiredSubCategory)this.reportsubcategory.clone();
		if(this.tlttype == null)
			clone.tlttype = null;
		else
			clone.tlttype = (ims.careuk.vo.lookups.TLTType)this.tlttype.clone();
		...
		if(this.secondopinionreason == null)
			...
			clone.secondopinionreason = (ims.careuk.vo.lookups.SecondOpinionCategory)this.secondopinionreason.clone();
		...
		if(this.treatmentcenter == null)
			...
			clone.treatmentcenter = (ims.careuk.vo.ContractServiceLocationsConfigVo)this.treatmentcenter.clone();
	...
	protected ims.careuk.vo.lookups.ReferralWorklistStatus status;
	...
	protected ims.careuk.vo.lookups.ReviewType reviewtype;
	...
	protected ims.careuk.vo.lookups.ReportsRequiredSubCategory reportsubcategory;
	protected ims.careuk.vo.lookups.TLTType tlttype;
	...
	protected ims.careuk.vo.lookups.SecondOpinionCategory secondopinionreason;
	...
	protected ims.careuk.vo.ContractServiceLocationsConfigVo treatmentcenter;
