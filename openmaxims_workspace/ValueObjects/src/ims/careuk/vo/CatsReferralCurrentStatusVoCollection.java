...
public class CatsReferralCurrentStatusVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<CatsReferralCurrentStatusVo>
{
	...
	public ims.careuk.vo.beans.CatsReferralCurrentStatusVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.CatsReferralCurrentStatusVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.CatsReferralCurrentStatusVoBean[] result = new ims.careuk.vo.beans.CatsReferralCurrentStatusVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			CatsReferralCurrentStatusVo vo = ((CatsReferralCurrentStatusVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.CatsReferralCurrentStatusVoBean)vo.getBean();
		}
		return result;
	}
	public static CatsReferralCurrentStatusVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.CatsReferralCurrentStatusVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static CatsReferralCurrentStatusVoCollection buildFromBeanCollection(ims.careuk.vo.beans.CatsReferralCurrentStatusVoBean[] beans)
	{
		CatsReferralCurrentStatusVoCollection coll = new CatsReferralCurrentStatusVoCollection();
		if(beans == null)
			return coll;
