...
public class SearchCriteriaForElectiveListManagementVo extends ims.vo.ValueObject implements ims.vo.ImsCloneable, Comparable
{
	...
	public SearchCriteriaForElectiveListManagementVo(ims.careuk.vo.beans.SearchCriteriaForElectiveListManagementVoBean bean)
	{
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.SearchCriteriaForElectiveListManagementVoBean bean)
	{
	...
	{
		ims.careuk.vo.beans.SearchCriteriaForElectiveListManagementVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.SearchCriteriaForElectiveListManagementVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.SearchCriteriaForElectiveListManagementVoBean();
