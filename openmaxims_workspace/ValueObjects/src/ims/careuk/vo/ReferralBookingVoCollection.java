...
public class ReferralBookingVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<ReferralBookingVo>
{
	...
	public ims.careuk.vo.beans.ReferralBookingVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.ReferralBookingVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.ReferralBookingVoBean[] result = new ims.careuk.vo.beans.ReferralBookingVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			ReferralBookingVo vo = ((ReferralBookingVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.ReferralBookingVoBean)vo.getBean();
		}
		return result;
	}
	public static ReferralBookingVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.ReferralBookingVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static ReferralBookingVoCollection buildFromBeanCollection(ims.careuk.vo.beans.ReferralBookingVoBean[] beans)
	{
		ReferralBookingVoCollection coll = new ReferralBookingVoCollection();
		if(beans == null)
			return coll;
