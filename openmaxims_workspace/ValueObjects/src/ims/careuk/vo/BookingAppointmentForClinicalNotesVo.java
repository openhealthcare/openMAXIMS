...
public class BookingAppointmentForClinicalNotesVo extends ims.scheduling.vo.Booking_AppointmentRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public BookingAppointmentForClinicalNotesVo(ims.careuk.vo.beans.BookingAppointmentForClinicalNotesVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.BookingAppointmentForClinicalNotesVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.appointmentdate = bean.getAppointmentDate() == null ? null : bean.getAppointmentDate().buildDate();
	...
	{
		ims.careuk.vo.beans.BookingAppointmentForClinicalNotesVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.BookingAppointmentForClinicalNotesVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.BookingAppointmentForClinicalNotesVoBean();
	...
	public ims.careuk.vo.SessionForClinicalNotesVo getSession()
	{
		return this.session;
	}
	public void setSession(ims.careuk.vo.SessionForClinicalNotesVo value)
	{
		this.isValidated = false;
		this.session = value;
	}
	...
	public Object clone()
	{
		...
		if(this.session == null)
			...
			clone.session = (ims.careuk.vo.SessionForClinicalNotesVo)this.session.clone();
	...
	protected ims.careuk.vo.SessionForClinicalNotesVo session;
