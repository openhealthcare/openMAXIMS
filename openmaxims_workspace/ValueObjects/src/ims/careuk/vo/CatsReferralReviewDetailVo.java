 ...
 */
public class CatsReferralReviewDetailVo extends ims.careuk.vo.CatsReferralRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public CatsReferralReviewDetailVo(ims.careuk.vo.beans.CatsReferralReviewDetailVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.currentreviewdetail = ims.careuk.vo.ReviewReferralDetailVoCollection.buildFromBeanCollection(bean.getCurrentReviewDetail());
		this.reviewhistory = ims.careuk.vo.ReviewReferralDetailVoCollection.buildFromBeanCollection(bean.getReviewHistory());
		this.isflaggedforreview = bean.getIsFlaggedForReview();
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.CatsReferralReviewDetailVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.currentreviewdetail = ims.careuk.vo.ReviewReferralDetailVoCollection.buildFromBeanCollection(bean.getCurrentReviewDetail());
	...
	{
		ims.careuk.vo.beans.CatsReferralReviewDetailVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.CatsReferralReviewDetailVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.CatsReferralReviewDetailVoBean();
	...
	public ims.careuk.vo.ReviewReferralDetailVoCollection getCurrentReviewDetail()
	{
		return this.currentreviewdetail;
	}
	public void setCurrentReviewDetail(ims.careuk.vo.ReviewReferralDetailVoCollection value)
	{
	...
	public ims.careuk.vo.ReviewReferralDetailVoCollection getReviewHistory()
	{
		return this.reviewhistory;
	}
	public void setReviewHistory(ims.careuk.vo.ReviewReferralDetailVoCollection value)
	{
		this.isValidated = false;
	...
	public Object clone()
	{
		...
		if(this.currentreviewdetail == null)
			...
			clone.currentreviewdetail = (ims.careuk.vo.ReviewReferralDetailVoCollection)this.currentreviewdetail.clone();
		if(this.reviewhistory == null)
			clone.reviewhistory = null;
		else
			clone.reviewhistory = (ims.careuk.vo.ReviewReferralDetailVoCollection)this.reviewhistory.clone();
	...
	protected ims.careuk.vo.ReviewReferralDetailVoCollection currentreviewdetail;
	protected ims.careuk.vo.ReviewReferralDetailVoCollection reviewhistory;
