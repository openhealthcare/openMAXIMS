 ...
 */
public class ReferralERODForBookAppointmentVo extends ims.careuk.vo.ReferralERODRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public ReferralERODForBookAppointmentVo()
	{
	}
	public ReferralERODForBookAppointmentVo(Integer id, int version)
	{
		super(id, version);
	}
	public ReferralERODForBookAppointmentVo(ims.careuk.vo.beans.ReferralERODForBookAppointmentVoBean bean)
	{
		this.id = bean.getId();
		...
		this.erodtype = bean.getERODType() == null ? null : ims.careuk.vo.lookups.ERODType.buildLookup(bean.getERODType());
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.ReferralERODForBookAppointmentVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.eroddate1 = bean.getERODDate1() == null ? null : bean.getERODDate1().buildDate();
	...
	{
		ims.careuk.vo.beans.ReferralERODForBookAppointmentVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.ReferralERODForBookAppointmentVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.ReferralERODForBookAppointmentVoBean();
	...
	public ims.careuk.vo.lookups.ERODType getERODType()
	{
		return this.erodtype;
	}
	public void setERODType(ims.careuk.vo.lookups.ERODType value)
	{
		this.isValidated = false;
		this.erodtype = value;
	}
	...
	public Object clone()
	{
		...
		ReferralERODForBookAppointmentVo clone = new ReferralERODForBookAppointmentVo(this.id, this.version);
		...
		if(this.erodtype == null)
			...
			clone.erodtype = (ims.careuk.vo.lookups.ERODType)this.erodtype.clone();
		if(this.appointment == null)
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(ReferralERODForBookAppointmentVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A ReferralERODForBookAppointmentVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((ReferralERODForBookAppointmentVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((ReferralERODForBookAppointmentVo)obj).getBoId());
	}
	...
	protected ims.careuk.vo.lookups.ERODType erodtype;
