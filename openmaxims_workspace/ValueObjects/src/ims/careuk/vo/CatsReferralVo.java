 ...
 */
public class CatsReferralVo extends ims.careuk.vo.CatsReferralRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public CatsReferralVo(ims.careuk.vo.beans.CatsReferralVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.CatsReferralVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.patient = bean.getPatient() == null ? null : new ims.core.patient.vo.PatientRefVo(new Integer(bean.getPatient().getId()), bean.getPatient().getVersion());
	...
	{
		ims.careuk.vo.beans.CatsReferralVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.CatsReferralVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.CatsReferralVoBean();
