 ...
 */
public class CatsReferralStatusVo extends ims.careuk.vo.CatsReferralStatusLiteVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public CatsReferralStatusVo(ims.careuk.vo.beans.CatsReferralStatusVoBean bean)
	{
		this.id = bean.getId();
		...
		this.secondopinioncategory = bean.getSecondOpinionCategory() == null ? null : ims.careuk.vo.lookups.SecondOpinionCategory.buildLookup(bean.getSecondOpinionCategory());
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.CatsReferralStatusVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.referralstatus = bean.getReferralStatus() == null ? null : ims.careuk.vo.lookups.ReferralApptStatus.buildLookup(bean.getReferralStatus());
	...
	{
		ims.careuk.vo.beans.CatsReferralStatusVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.CatsReferralStatusVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.CatsReferralStatusVoBean();
	...
	public ims.careuk.vo.lookups.SecondOpinionCategory getSecondOpinionCategory()
	{
		return this.secondopinioncategory;
	}
	public void setSecondOpinionCategory(ims.careuk.vo.lookups.SecondOpinionCategory value)
	{
		this.isValidated = false;
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.comment != null)
			if(this.comment.length() > 1500)
				listOfErrors.add("The length of the field [comment] in the value object [ims.careuk.vo.CatsReferralStatusVo] is too big. It should be less or equal to 1500");
	...
	public Object clone()
	{
		...
		if(this.secondopinioncategory == null)
			...
			clone.secondopinioncategory = (ims.careuk.vo.lookups.SecondOpinionCategory)this.secondopinioncategory.clone();
	...
	protected ims.careuk.vo.lookups.SecondOpinionCategory secondopinioncategory;
