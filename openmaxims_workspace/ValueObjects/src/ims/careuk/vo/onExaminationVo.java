 ...
 */
public class onExaminationVo extends ims.careuk.vo.OnExaminationRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public onExaminationVo(ims.careuk.vo.beans.onExaminationVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.onExaminationVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.catsreferral = bean.getCatsReferral() == null ? null : new ims.careuk.vo.CatsReferralRefVo(new Integer(bean.getCatsReferral().getId()), bean.getCatsReferral().getVersion());
	...
	{
		ims.careuk.vo.beans.onExaminationVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.onExaminationVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.onExaminationVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.relevantpmh != null)
			if(this.relevantpmh.length() > 2500)
				listOfErrors.add("The length of the field [relevantpmh] in the value object [ims.careuk.vo.onExaminationVo] is too big. It should be less or equal to 2500");
		if(this.clinicalnote != null)
		{
