 ...
 */
public class PatientElectiveListTCIForCancelationVo extends ims.careuk.vo.TCIForPatientElectiveListRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public PatientElectiveListTCIForCancelationVo(ims.careuk.vo.beans.PatientElectiveListTCIForCancelationVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.PatientElectiveListTCIForCancelationVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.PatientElectiveListTCIForCancelationVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.PatientElectiveListTCIForCancelationVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.PatientElectiveListTCIForCancelationVoBean();
