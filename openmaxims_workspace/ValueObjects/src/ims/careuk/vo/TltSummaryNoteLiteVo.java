 ...
 */
public class TltSummaryNoteLiteVo extends ims.careuk.vo.TltSummaryNoteRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public TltSummaryNoteLiteVo(ims.careuk.vo.beans.TltSummaryNoteLiteVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.TltSummaryNoteLiteVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.catsreferral = bean.getCatsReferral() == null ? null : new ims.careuk.vo.CatsReferralRefVo(new Integer(bean.getCatsReferral().getId()), bean.getCatsReferral().getVersion());
	...
	{
		ims.careuk.vo.beans.TltSummaryNoteLiteVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.TltSummaryNoteLiteVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.TltSummaryNoteLiteVoBean();
