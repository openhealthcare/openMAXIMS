...
public class ReferralLetterDetailsClinicListListVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<ReferralLetterDetailsClinicListListVo>
{
	...
	public ims.careuk.vo.beans.ReferralLetterDetailsClinicListListVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.ReferralLetterDetailsClinicListListVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.ReferralLetterDetailsClinicListListVoBean[] result = new ims.careuk.vo.beans.ReferralLetterDetailsClinicListListVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			ReferralLetterDetailsClinicListListVo vo = ((ReferralLetterDetailsClinicListListVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.ReferralLetterDetailsClinicListListVoBean)vo.getBean();
		}
		return result;
	}
	public static ReferralLetterDetailsClinicListListVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.ReferralLetterDetailsClinicListListVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static ReferralLetterDetailsClinicListListVoCollection buildFromBeanCollection(ims.careuk.vo.beans.ReferralLetterDetailsClinicListListVoBean[] beans)
	{
		ReferralLetterDetailsClinicListListVoCollection coll = new ReferralLetterDetailsClinicListListVoCollection();
		if(beans == null)
			return coll;
