...
public class CATSReferralFilterVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<CATSReferralFilterVo>
{
	...
	public ims.careuk.vo.beans.CATSReferralFilterVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.CATSReferralFilterVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.CATSReferralFilterVoBean[] result = new ims.careuk.vo.beans.CATSReferralFilterVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			CATSReferralFilterVo vo = ((CATSReferralFilterVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.CATSReferralFilterVoBean)vo.getBean();
		}
		return result;
	}
	public static CATSReferralFilterVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.CATSReferralFilterVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static CATSReferralFilterVoCollection buildFromBeanCollection(ims.careuk.vo.beans.CATSReferralFilterVoBean[] beans)
	{
		CATSReferralFilterVoCollection coll = new CATSReferralFilterVoCollection();
		if(beans == null)
			return coll;
