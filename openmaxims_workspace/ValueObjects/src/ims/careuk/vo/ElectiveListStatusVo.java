 ...
 */
public class ElectiveListStatusVo extends ims.careuk.vo.ElectiveListStatusRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ElectiveListStatusVo(ims.careuk.vo.beans.ElectiveListStatusVoBean bean)
	{
		this.id = bean.getId();
		...
		this.removalreason = bean.getRemovalReason() == null ? null : ims.careuk.vo.lookups.ElectiveListStatusReason.buildLookup(bean.getRemovalReason());
		this.removalotherreason = bean.getRemovalOtherReason() == null ? null : ims.careuk.vo.lookups.RemovalOtherReason.buildLookup(bean.getRemovalOtherReason());
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.ElectiveListStatusVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.ElectiveListStatusVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.ElectiveListStatusVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.ElectiveListStatusVoBean();
	...
	public ims.careuk.vo.lookups.ElectiveListStatusReason getRemovalReason()
	{
		return this.removalreason;
	}
	public void setRemovalReason(ims.careuk.vo.lookups.ElectiveListStatusReason value)
	{
		this.isValidated = false;
	...
	public ims.careuk.vo.lookups.RemovalOtherReason getRemovalOtherReason()
	{
		return this.removalotherreason;
	}
	public void setRemovalOtherReason(ims.careuk.vo.lookups.RemovalOtherReason value)
	{
		this.isValidated = false;
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.statuscomment != null)
			if(this.statuscomment.length() > 1500)
				listOfErrors.add("The length of the field [statuscomment] in the value object [ims.careuk.vo.ElectiveListStatusVo] is too big. It should be less or equal to 1500");
	...
	public Object clone()
	{
		...
		if(this.removalreason == null)
			...
			clone.removalreason = (ims.careuk.vo.lookups.ElectiveListStatusReason)this.removalreason.clone();
		if(this.removalotherreason == null)
			clone.removalotherreason = null;
		else
			clone.removalotherreason = (ims.careuk.vo.lookups.RemovalOtherReason)this.removalotherreason.clone();
	...
	protected ims.careuk.vo.lookups.ElectiveListStatusReason removalreason;
	protected ims.careuk.vo.lookups.RemovalOtherReason removalotherreason;
