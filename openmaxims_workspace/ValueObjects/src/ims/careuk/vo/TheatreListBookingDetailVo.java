...
public class TheatreListBookingDetailVo extends ims.vo.ValueObject implements ims.vo.ImsCloneable, Comparable
{
	...
	public TheatreListBookingDetailVo(ims.careuk.vo.beans.TheatreListBookingDetailVoBean bean)
	{
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.TheatreListBookingDetailVoBean bean)
	{
		this.tcitime = bean.getTCITime();
		this.proceduretext = bean.getProcedureText();
		this.theatretext = bean.getTheatreText();
	...
	{
		ims.careuk.vo.beans.TheatreListBookingDetailVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.TheatreListBookingDetailVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.TheatreListBookingDetailVoBean();
