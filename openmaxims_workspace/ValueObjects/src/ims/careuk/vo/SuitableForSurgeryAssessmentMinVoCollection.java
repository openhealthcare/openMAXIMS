...
public class SuitableForSurgeryAssessmentMinVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<SuitableForSurgeryAssessmentMinVo>
{
	...
	public ims.careuk.vo.beans.SuitableForSurgeryAssessmentMinVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.SuitableForSurgeryAssessmentMinVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.SuitableForSurgeryAssessmentMinVoBean[] result = new ims.careuk.vo.beans.SuitableForSurgeryAssessmentMinVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			SuitableForSurgeryAssessmentMinVo vo = ((SuitableForSurgeryAssessmentMinVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.SuitableForSurgeryAssessmentMinVoBean)vo.getBean();
		}
		return result;
	}
	public static SuitableForSurgeryAssessmentMinVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.SuitableForSurgeryAssessmentMinVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static SuitableForSurgeryAssessmentMinVoCollection buildFromBeanCollection(ims.careuk.vo.beans.SuitableForSurgeryAssessmentMinVoBean[] beans)
	{
		SuitableForSurgeryAssessmentMinVoCollection coll = new SuitableForSurgeryAssessmentMinVoCollection();
		if(beans == null)
			return coll;
