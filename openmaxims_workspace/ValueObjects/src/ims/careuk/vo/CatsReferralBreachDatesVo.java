 ...
 */
public class CatsReferralBreachDatesVo extends ims.careuk.vo.CatsReferralRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public CatsReferralBreachDatesVo(ims.careuk.vo.beans.CatsReferralBreachDatesVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.CatsReferralBreachDatesVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.CatsReferralBreachDatesVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.CatsReferralBreachDatesVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.CatsReferralBreachDatesVoBean();
