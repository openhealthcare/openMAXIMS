...
/**
 * Linked to CAREUK.ReviewReferralDetail business object (ID: 1096100019).
 */
public class ReviewReferralDetailVo extends ims.careuk.vo.ReviewReferralDetailRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ReviewReferralDetailVo(ims.careuk.vo.beans.ReviewReferralDetailVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.ReviewReferralDetailVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.reviewtype = bean.getReviewType() == null ? null : ims.careuk.vo.lookups.ReviewType.buildLookup(bean.getReviewType());
	...
	{
		ims.careuk.vo.beans.ReviewReferralDetailVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.ReviewReferralDetailVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.ReviewReferralDetailVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.reasonnotes != null)
			if(this.reasonnotes.length() > 255)
				listOfErrors.add("The length of the field [reasonnotes] in the value object [ims.careuk.vo.ReviewReferralDetailVo] is too big. It should be less or equal to 255");
		if(this.reviewnotes != null)
			if(this.reviewnotes.length() > 255)
				listOfErrors.add("The length of the field [reviewnotes] in the value object [ims.careuk.vo.ReviewReferralDetailVo] is too big. It should be less or equal to 255");
