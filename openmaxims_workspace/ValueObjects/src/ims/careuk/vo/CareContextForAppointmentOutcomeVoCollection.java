...
public class CareContextForAppointmentOutcomeVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<CareContextForAppointmentOutcomeVo>
{
	...
	public ims.careuk.vo.beans.CareContextForAppointmentOutcomeVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.CareContextForAppointmentOutcomeVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.CareContextForAppointmentOutcomeVoBean[] result = new ims.careuk.vo.beans.CareContextForAppointmentOutcomeVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			CareContextForAppointmentOutcomeVo vo = ((CareContextForAppointmentOutcomeVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.CareContextForAppointmentOutcomeVoBean)vo.getBean();
		}
		return result;
	}
	public static CareContextForAppointmentOutcomeVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.CareContextForAppointmentOutcomeVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static CareContextForAppointmentOutcomeVoCollection buildFromBeanCollection(ims.careuk.vo.beans.CareContextForAppointmentOutcomeVoBean[] beans)
	{
		CareContextForAppointmentOutcomeVoCollection coll = new CareContextForAppointmentOutcomeVoCollection();
		if(beans == null)
			return coll;
