...
public class TransportBookingShortVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<TransportBookingShortVo>
{
	...
	public ims.careuk.vo.beans.TransportBookingShortVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.TransportBookingShortVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.TransportBookingShortVoBean[] result = new ims.careuk.vo.beans.TransportBookingShortVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			TransportBookingShortVo vo = ((TransportBookingShortVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.TransportBookingShortVoBean)vo.getBean();
		}
		return result;
	}
	public static TransportBookingShortVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.TransportBookingShortVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static TransportBookingShortVoCollection buildFromBeanCollection(ims.careuk.vo.beans.TransportBookingShortVoBean[] beans)
	{
		TransportBookingShortVoCollection coll = new TransportBookingShortVoCollection();
		if(beans == null)
			return coll;
