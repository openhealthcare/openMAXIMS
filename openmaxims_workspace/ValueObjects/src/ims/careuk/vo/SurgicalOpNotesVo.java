...
/**
 * Linked to CAREUK.SurgicalOpNotes business object (ID: 1096100053).
 */
public class SurgicalOpNotesVo extends ims.careuk.vo.SurgicalOpNotesRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public SurgicalOpNotesVo(ims.careuk.vo.beans.SurgicalOpNotesVoBean bean)
	{
		this.id = bean.getId();
		...
		this.followuptype = bean.getFollowUpType() == null ? null : ims.careuk.vo.lookups.SurgicalOpFollowUpType.buildLookup(bean.getFollowUpType());
		this.followuptypein = bean.getFollowUpTypeIn() == null ? null : ims.careuk.vo.lookups.SurgicalOpFollowUpIn.buildLookup(bean.getFollowUpTypeIn());
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.SurgicalOpNotesVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.carecontext = bean.getCareContext() == null ? null : new ims.core.admin.vo.CareContextRefVo(new Integer(bean.getCareContext().getId()), bean.getCareContext().getVersion());
	...
	{
		ims.careuk.vo.beans.SurgicalOpNotesVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.SurgicalOpNotesVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.SurgicalOpNotesVoBean();
	...
	public ims.careuk.vo.lookups.SurgicalOpFollowUpType getFollowUpType()
	{
		return this.followuptype;
	}
	public void setFollowUpType(ims.careuk.vo.lookups.SurgicalOpFollowUpType value)
	{
		this.isValidated = false;
	...
	public ims.careuk.vo.lookups.SurgicalOpFollowUpIn getFollowUpTypeIn()
	{
		return this.followuptypein;
	}
	public void setFollowUpTypeIn(ims.careuk.vo.lookups.SurgicalOpFollowUpIn value)
	{
		this.isValidated = false;
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.lainfiltration != null)
			if(this.lainfiltration.length() > 2000)
				listOfErrors.add("The length of the field [lainfiltration] in the value object [ims.careuk.vo.SurgicalOpNotesVo] is too big. It should be less or equal to 2000");
		if(this.preoperativediagnosis != null)
			if(this.preoperativediagnosis.length() > 255)
				listOfErrors.add("The length of the field [preoperativediagnosis] in the value object [ims.careuk.vo.SurgicalOpNotesVo] is too big. It should be less or equal to 255");
		if(this.antibiotics != null)
			if(this.antibiotics.length() > 255)
				listOfErrors.add("The length of the field [antibiotics] in the value object [ims.careuk.vo.SurgicalOpNotesVo] is too big. It should be less or equal to 255");
		if(this.vte != null)
			if(this.vte.length() > 255)
				listOfErrors.add("The length of the field [vte] in the value object [ims.careuk.vo.SurgicalOpNotesVo] is too big. It should be less or equal to 255");
		if(this.ebi != null)
			if(this.ebi.length() > 10)
				listOfErrors.add("The length of the field [ebi] in the value object [ims.careuk.vo.SurgicalOpNotesVo] is too big. It should be less or equal to 10");
	...
	public Object clone()
	{
		...
		if(this.followuptype == null)
			...
			clone.followuptype = (ims.careuk.vo.lookups.SurgicalOpFollowUpType)this.followuptype.clone();
		if(this.followuptypein == null)
			clone.followuptypein = null;
		else
			clone.followuptypein = (ims.careuk.vo.lookups.SurgicalOpFollowUpIn)this.followuptypein.clone();
	...
	protected ims.careuk.vo.lookups.SurgicalOpFollowUpType followuptype;
	protected ims.careuk.vo.lookups.SurgicalOpFollowUpIn followuptypein;
