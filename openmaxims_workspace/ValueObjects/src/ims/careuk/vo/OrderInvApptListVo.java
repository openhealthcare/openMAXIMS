 ...
 */
public class OrderInvApptListVo extends ims.careuk.vo.OrderInvApptRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public OrderInvApptListVo(ims.careuk.vo.beans.OrderInvApptListVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.OrderInvApptListVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.orderinvestigation = bean.getOrderInvestigation() == null ? null : new ims.ocrr.orderingresults.vo.OrderInvestigationRefVo(new Integer(bean.getOrderInvestigation().getId()), bean.getOrderInvestigation().getVersion());
	...
	{
		ims.careuk.vo.beans.OrderInvApptListVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.OrderInvApptListVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.OrderInvApptListVoBean();
