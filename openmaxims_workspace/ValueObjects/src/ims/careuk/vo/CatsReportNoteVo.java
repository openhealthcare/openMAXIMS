...
/**
 * Linked to CAREUK.CatsReportNote business object (ID: 1096100039).
 */
public class CatsReportNoteVo extends ims.careuk.vo.CatsReportNoteRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public CatsReportNoteVo()
	{
	}
	public CatsReportNoteVo(Integer id, int version)
	{
		super(id, version);
	}
	public CatsReportNoteVo(ims.careuk.vo.beans.CatsReportNoteVoBean bean)
	{
		this.id = bean.getId();
		...
		this.finalnote = bean.getFinalNote();
		this.recordinginformation = bean.getRecordingInformation() == null ? null : bean.getRecordingInformation().buildVo();
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.CatsReportNoteVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.catsreferral = bean.getCatsReferral() == null ? null : new ims.careuk.vo.CatsReferralRefVo(new Integer(bean.getCatsReferral().getId()), bean.getCatsReferral().getVersion());
	...
	{
		ims.careuk.vo.beans.CatsReportNoteVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.CatsReportNoteVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.CatsReportNoteVoBean();
	...
	public boolean getFinalNoteIsNotNull()
	{
		return this.finalnote != null;
	}
	public String getFinalNote()
	{
		return this.finalnote;
	}
	public static int getFinalNoteMaxLength()
	{
		return 10000;
	}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.finalnote == null || this.finalnote.length() == 0)
			listOfErrors.add("FinalNote is mandatory");
		if(this.recordinginformation == null)
	...
	public Object clone()
	{
		...
		CatsReportNoteVo clone = new CatsReportNoteVo(this.id, this.version);
		...
		clone.finalnote = this.finalnote;
		if(this.recordinginformation == null)
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(CatsReportNoteVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A CatsReportNoteVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((CatsReportNoteVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((CatsReportNoteVo)obj).getBoId());
	}
