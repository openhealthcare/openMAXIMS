 ...
 */
public class TltSummaryNoteVo extends ims.careuk.vo.TltSummaryNoteLiteVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public TltSummaryNoteVo(ims.careuk.vo.beans.TltSummaryNoteVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.TltSummaryNoteVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.catsreferral = bean.getCatsReferral() == null ? null : new ims.careuk.vo.CatsReferralRefVo(new Integer(bean.getCatsReferral().getId()), bean.getCatsReferral().getVersion());
	...
	{
		ims.careuk.vo.beans.TltSummaryNoteVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.TltSummaryNoteVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.TltSummaryNoteVoBean();
