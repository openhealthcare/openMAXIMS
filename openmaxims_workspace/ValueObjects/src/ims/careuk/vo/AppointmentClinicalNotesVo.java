 ...
 */
public class AppointmentClinicalNotesVo extends ims.careuk.vo.AppointmentClinicalNotesRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public AppointmentClinicalNotesVo(ims.careuk.vo.beans.AppointmentClinicalNotesVoBean bean)
	{
		this.id = bean.getId();
		...
		this.clinicalnotetype = bean.getClinicalNoteType() == null ? null : ims.careuk.vo.lookups.ClinicalNoteTypeForAnAppointment.buildLookup(bean.getClinicalNoteType());
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.AppointmentClinicalNotesVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.catsreferral = bean.getCatsReferral() == null ? null : new ims.careuk.vo.CatsReferralRefVo(new Integer(bean.getCatsReferral().getId()), bean.getCatsReferral().getVersion());
	...
	{
		ims.careuk.vo.beans.AppointmentClinicalNotesVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.AppointmentClinicalNotesVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.AppointmentClinicalNotesVoBean();
	...
	public ims.careuk.vo.lookups.ClinicalNoteTypeForAnAppointment getClinicalNoteType()
	{
		return this.clinicalnotetype;
	}
	public void setClinicalNoteType(ims.careuk.vo.lookups.ClinicalNoteTypeForAnAppointment value)
	{
		this.isValidated = false;
	...
	public Object clone()
	{
		...
		if(this.clinicalnotetype == null)
			...
			clone.clinicalnotetype = (ims.careuk.vo.lookups.ClinicalNoteTypeForAnAppointment)this.clinicalnotetype.clone();
	...
	protected ims.careuk.vo.lookups.ClinicalNoteTypeForAnAppointment clinicalnotetype;
