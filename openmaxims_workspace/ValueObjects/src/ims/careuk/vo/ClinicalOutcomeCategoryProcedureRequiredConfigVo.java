 ...
 */
public class ClinicalOutcomeCategoryProcedureRequiredConfigVo extends ims.careuk.vo.ClinicalOutcomeCategoryProcedureRequiredConfigRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ClinicalOutcomeCategoryProcedureRequiredConfigVo(ims.careuk.vo.beans.ClinicalOutcomeCategoryProcedureRequiredConfigVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.ClinicalOutcomeCategoryProcedureRequiredConfigVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.category = bean.getCategory() == null ? null : ims.clinical.vo.lookups.ClinicalOutcomeCategory.buildLookup(bean.getCategory());
	...
	{
		ims.careuk.vo.beans.ClinicalOutcomeCategoryProcedureRequiredConfigVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.ClinicalOutcomeCategoryProcedureRequiredConfigVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.ClinicalOutcomeCategoryProcedureRequiredConfigVoBean();
