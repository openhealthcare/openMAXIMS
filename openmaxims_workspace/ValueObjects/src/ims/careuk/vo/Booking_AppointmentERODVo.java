...
public class Booking_AppointmentERODVo extends ims.scheduling.vo.Booking_AppointmentRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public Booking_AppointmentERODVo(ims.careuk.vo.beans.Booking_AppointmentERODVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.Booking_AppointmentERODVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.appointmentdate = bean.getAppointmentDate() == null ? null : bean.getAppointmentDate().buildDate();
	...
	{
		ims.careuk.vo.beans.Booking_AppointmentERODVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.Booking_AppointmentERODVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.Booking_AppointmentERODVoBean();
