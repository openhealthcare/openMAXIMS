 ...
 */
public class PatientElectiveListNotesVo extends ims.careuk.vo.NotesForPatientElectiveListRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public PatientElectiveListNotesVo(ims.careuk.vo.beans.PatientElectiveListNotesVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.PatientElectiveListNotesVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.PatientElectiveListNotesVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.PatientElectiveListNotesVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.PatientElectiveListNotesVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.notes == null || this.notes.length() == 0)
			...
			listOfErrors.add("The length of the field [notes] in the value object [ims.careuk.vo.PatientElectiveListNotesVo] is too big. It should be less or equal to 1000");
