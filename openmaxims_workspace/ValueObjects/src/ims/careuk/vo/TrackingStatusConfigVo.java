 ...
 */
public class TrackingStatusConfigVo extends ims.careuk.vo.TrackStatusConfigRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public TrackingStatusConfigVo(ims.careuk.vo.beans.TrackingStatusConfigVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.TrackingStatusConfigVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.timeintopacu = bean.getTimeintoPACU() == null ? null : bean.getTimeintoPACU().buildColor();
	...
	{
		ims.careuk.vo.beans.TrackingStatusConfigVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.TrackingStatusConfigVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.TrackingStatusConfigVoBean();
