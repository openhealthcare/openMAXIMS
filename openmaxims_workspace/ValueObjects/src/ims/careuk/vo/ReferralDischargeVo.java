...
/**
 * Linked to CAREUK.DischargeOutcome business object (ID: 1096100017).
 */
public class ReferralDischargeVo extends ims.careuk.vo.DischargeOutcomeRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ReferralDischargeVo(ims.careuk.vo.beans.ReferralDischargeVoBean bean)
	{
		this.id = bean.getId();
		...
		this.dischargeothertype = bean.getDischargeOtherType() == null ? null : ims.careuk.vo.lookups.DischargeOtherType.buildLookup(bean.getDischargeOtherType());
		...
		this.onwardreferrals = ims.careuk.vo.OnwardReferralVoCollection.buildFromBeanCollection(bean.getOnwardReferrals());
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.ReferralDischargeVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.dischargetype = bean.getDischargeType() == null ? null : ims.careuk.vo.lookups.DischargeType.buildLookup(bean.getDischargeType());
	...
	{
		ims.careuk.vo.beans.ReferralDischargeVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.ReferralDischargeVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.ReferralDischargeVoBean();
	...
	public ims.careuk.vo.lookups.DischargeType getDischargeType()
	{
		return this.dischargetype;
	}
	public void setDischargeType(ims.careuk.vo.lookups.DischargeType value)
	{
	...
	public ims.careuk.vo.lookups.DischargeOtherType getDischargeOtherType()
	{
		return this.dischargeothertype;
	}
	public void setDischargeOtherType(ims.careuk.vo.lookups.DischargeOtherType value)
	{
		this.isValidated = false;
	...
	public ims.careuk.vo.OnwardReferralVo getCurrentOnwardReferral()
	{
		return this.currentonwardreferral;
	}
	public void setCurrentOnwardReferral(ims.careuk.vo.OnwardReferralVo value)
	{
		this.isValidated = false;
	...
	public ims.careuk.vo.OnwardReferralVoCollection getOnwardReferrals()
	{
		return this.onwardreferrals;
	}
	public void setOnwardReferrals(ims.careuk.vo.OnwardReferralVoCollection value)
	{
		this.isValidated = false;
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.furthermanagement != null)
			if(this.furthermanagement.length() > 3000)
				listOfErrors.add("The length of the field [furthermanagement] in the value object [ims.careuk.vo.ReferralDischargeVo] is too big. It should be less or equal to 3000");
		if(this.otherdetails != null)
			if(this.otherdetails.length() > 3000)
				listOfErrors.add("The length of the field [otherdetails] in the value object [ims.careuk.vo.ReferralDischargeVo] is too big. It should be less or equal to 3000");
		if(this.currentonwardreferral != null)
		{
	...
	public Object clone()
	{
		...
		if(this.dischargeothertype == null)
			...
			clone.dischargeothertype = (ims.careuk.vo.lookups.DischargeOtherType)this.dischargeothertype.clone();
		clone.otherdetails = this.otherdetails;
		if(this.currentonwardreferral == null)
			clone.currentonwardreferral = null;
		else
			clone.currentonwardreferral = (ims.careuk.vo.OnwardReferralVo)this.currentonwardreferral.clone();
		if(this.onwardreferrals == null)
			clone.onwardreferrals = null;
		else
			clone.onwardreferrals = (ims.careuk.vo.OnwardReferralVoCollection)this.onwardreferrals.clone();
		if(this.dischargedate == null)
	...
	protected ims.careuk.vo.lookups.DischargeType dischargetype;
	protected String furthermanagement;
	protected ims.careuk.vo.lookups.DischargeOtherType dischargeothertype;
	protected String otherdetails;
	protected ims.careuk.vo.OnwardReferralVo currentonwardreferral;
	protected ims.careuk.vo.OnwardReferralVoCollection onwardreferrals;
