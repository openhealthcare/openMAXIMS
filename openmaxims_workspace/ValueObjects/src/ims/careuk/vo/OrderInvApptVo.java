 ...
 */
public class OrderInvApptVo extends ims.careuk.vo.OrderInvApptRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public OrderInvApptVo(ims.careuk.vo.beans.OrderInvApptVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.OrderInvApptVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.OrderInvApptVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.OrderInvApptVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.OrderInvApptVoBean();
