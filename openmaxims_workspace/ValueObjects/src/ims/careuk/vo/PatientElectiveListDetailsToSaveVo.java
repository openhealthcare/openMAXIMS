 ...
 */
public class PatientElectiveListDetailsToSaveVo extends ims.careuk.vo.PatientElectiveListRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public PatientElectiveListDetailsToSaveVo(ims.careuk.vo.beans.PatientElectiveListDetailsToSaveVoBean bean)
	{
		this.id = bean.getId();
		...
		this.tcihistory = ims.careuk.vo.PatientElectiveListTCIVoCollection.buildFromBeanCollection(bean.getTCIHistory());
		...
		this.reviews = ims.careuk.vo.ReviewPatientElectiveListVoCollection.buildFromBeanCollection(bean.getReviews());
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.PatientElectiveListDetailsToSaveVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.PatientElectiveListDetailsToSaveVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.PatientElectiveListDetailsToSaveVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.PatientElectiveListDetailsToSaveVoBean();
	...
	public ims.careuk.vo.PatientElectiveListTCIVoCollection getTCIHistory()
	{
		return this.tcihistory;
	}
	public void setTCIHistory(ims.careuk.vo.PatientElectiveListTCIVoCollection value)
	{
		this.isValidated = false;
	...
	public ims.careuk.vo.ReferralERODVo getEROD()
	{
		return this.erod;
	}
	public void setEROD(ims.careuk.vo.ReferralERODVo value)
	{
		this.isValidated = false;
		this.erod = value;
	}
	...
	public ims.careuk.vo.ReviewPatientElectiveListVoCollection getReviews()
	{
		return this.reviews;
	}
	public void setReviews(ims.careuk.vo.ReviewPatientElectiveListVoCollection value)
	{
		this.isValidated = false;
		this.reviews = value;
	}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.bed != null)
			if(this.bed.length() > 50)
				listOfErrors.add("The length of the field [bed] in the value object [ims.careuk.vo.PatientElectiveListDetailsToSaveVo] is too big. It should be less or equal to 50");
		...
		if(this.proceduredescription != null)
			if(this.proceduredescription.length() > 255)
				listOfErrors.add("The length of the field [proceduredescription] in the value object [ims.careuk.vo.PatientElectiveListDetailsToSaveVo] is too big. It should be less or equal to 255");
		if(this.tcidetails != null)
		{
		...
		if(this.specialrequirementsdetails != null)
			if(this.specialrequirementsdetails.length() > 1000)
				listOfErrors.add("The length of the field [specialrequirementsdetails] in the value object [ims.careuk.vo.PatientElectiveListDetailsToSaveVo] is too big. It should be less or equal to 1000");
		if(this.notes != null)
		{
	...
	public Object clone()
	{
		...
		if(this.tcihistory == null)
			...
			clone.tcihistory = (ims.careuk.vo.PatientElectiveListTCIVoCollection)this.tcihistory.clone();
		...
		if(this.erod == null)
			...
			clone.erod = (ims.careuk.vo.ReferralERODVo)this.erod.clone();
		...
		if(this.reviews == null)
			...
			clone.reviews = (ims.careuk.vo.ReviewPatientElectiveListVoCollection)this.reviews.clone();
	...
	protected ims.careuk.vo.PatientElectiveListTCIVoCollection tcihistory;
	...
	protected ims.careuk.vo.ReferralERODVo erod;
	...
	protected ims.careuk.vo.ReviewPatientElectiveListVoCollection reviews;
