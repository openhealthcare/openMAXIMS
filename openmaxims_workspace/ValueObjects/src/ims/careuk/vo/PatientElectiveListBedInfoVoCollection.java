...
public class PatientElectiveListBedInfoVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<PatientElectiveListBedInfoVo>
{
	...
	public ims.careuk.vo.beans.PatientElectiveListBedInfoVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.PatientElectiveListBedInfoVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.PatientElectiveListBedInfoVoBean[] result = new ims.careuk.vo.beans.PatientElectiveListBedInfoVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			PatientElectiveListBedInfoVo vo = ((PatientElectiveListBedInfoVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.PatientElectiveListBedInfoVoBean)vo.getBean();
		}
		return result;
	}
	public static PatientElectiveListBedInfoVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.PatientElectiveListBedInfoVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static PatientElectiveListBedInfoVoCollection buildFromBeanCollection(ims.careuk.vo.beans.PatientElectiveListBedInfoVoBean[] beans)
	{
		PatientElectiveListBedInfoVoCollection coll = new PatientElectiveListBedInfoVoCollection();
		if(beans == null)
			return coll;
