 ...
 */
public class CatsReferralWizardVo extends ims.careuk.vo.CatsReferralRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public CatsReferralWizardVo(ims.careuk.vo.beans.CatsReferralWizardVoBean bean)
	{
		this.id = bean.getId();
		...
		this.additionalinvapptsstatus = bean.getAdditionalInvApptsStatus() == null ? null : ims.careuk.vo.lookups.AdditionalInvestigationAppointmentsStatus.buildLookup(bean.getAdditionalInvApptsStatus());
		...
		this.onwardreferralstatus = bean.getOnwardReferralStatus() == null ? null : ims.careuk.vo.lookups.OnwardReferralStatus.buildLookup(bean.getOnwardReferralStatus());
		this.providercancellation = bean.getProviderCancellation() == null ? null : new ims.careuk.vo.ProviderCancellationRefVo(new Integer(bean.getProviderCancellation().getId()), bean.getProviderCancellation().getVersion());
		...
		this.isfinalreportrequired = bean.getIsFinalReportRequired() == null ? null : ims.careuk.vo.lookups.ReportStatus.buildLookup(bean.getIsFinalReportRequired());
		...
		this.issecondaryreportrequired = bean.getIsSecondaryReportRequired() == null ? null : ims.careuk.vo.lookups.ReportStatus.buildLookup(bean.getIsSecondaryReportRequired());
		...
		this.dischargetogpdetailsreviewstatus = bean.getDischargeToGPDetailsReviewStatus() == null ? null : ims.careuk.vo.lookups.DischargeToGPDetailsReviewStatus.buildLookup(bean.getDischargeToGPDetailsReviewStatus());
		...
		this.reportsrequired = ims.careuk.vo.ReportsRequiredForPrintingVoCollection.buildFromBeanCollection(bean.getReportsRequired());
		...
		this.urgency = bean.getUrgency() == null ? null : ims.careuk.vo.lookups.ReferralUrgency.buildLookup(bean.getUrgency());
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.CatsReferralWizardVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.CatsReferralWizardVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.CatsReferralWizardVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.CatsReferralWizardVoBean();
	...
	public ims.careuk.vo.lookups.AdditionalInvestigationAppointmentsStatus getAdditionalInvApptsStatus()
	{
		return this.additionalinvapptsstatus;
	}
	public void setAdditionalInvApptsStatus(ims.careuk.vo.lookups.AdditionalInvestigationAppointmentsStatus value)
	{
		this.isValidated = false;
	...
	public ims.careuk.vo.RejectReferralVo getRejectReferralDetail()
	{
		return this.rejectreferraldetail;
	}
	public void setRejectReferralDetail(ims.careuk.vo.RejectReferralVo value)
	{
		this.isValidated = false;
	...
	public ims.careuk.vo.lookups.OnwardReferralStatus getOnwardReferralStatus()
	{
		return this.onwardreferralstatus;
	}
	public void setOnwardReferralStatus(ims.careuk.vo.lookups.OnwardReferralStatus value)
	{
		this.isValidated = false;
	...
	public ims.careuk.vo.ProviderCancellationRefVo getProviderCancellation()
	{
		return this.providercancellation;
	}
	public void setProviderCancellation(ims.careuk.vo.ProviderCancellationRefVo value)
	{
		this.isValidated = false;
	...
	public ims.careuk.vo.lookups.ReportStatus getIsFinalReportRequired()
	{
		return this.isfinalreportrequired;
	}
	public void setIsFinalReportRequired(ims.careuk.vo.lookups.ReportStatus value)
	{
		this.isValidated = false;
	...
	public ims.careuk.vo.lookups.ReportStatus getIsSecondaryReportRequired()
	{
		return this.issecondaryreportrequired;
	}
	public void setIsSecondaryReportRequired(ims.careuk.vo.lookups.ReportStatus value)
	{
		this.isValidated = false;
	...
	public ims.careuk.vo.lookups.DischargeToGPDetailsReviewStatus getDischargeToGPDetailsReviewStatus()
	{
		return this.dischargetogpdetailsreviewstatus;
	}
	public void setDischargeToGPDetailsReviewStatus(ims.careuk.vo.lookups.DischargeToGPDetailsReviewStatus value)
	{
		this.isValidated = false;
	...
	public ims.careuk.vo.AwaitingClinicalInfoVo getAwaitingClinicalInfo()
	{
		return this.awaitingclinicalinfo;
	}
	public void setAwaitingClinicalInfo(ims.careuk.vo.AwaitingClinicalInfoVo value)
	{
		this.isValidated = false;
	...
	public ims.careuk.vo.ContractConfigForReferralDetailsComponentVo getContract()
	{
		return this.contract;
	}
	public void setContract(ims.careuk.vo.ContractConfigForReferralDetailsComponentVo value)
	{
		this.isValidated = false;
		this.contract = value;
	}
	...
	public ims.careuk.vo.ReportsRequiredForPrintingVoCollection getReportsRequired()
	{
		return this.reportsrequired;
	}
	public void setReportsRequired(ims.careuk.vo.ReportsRequiredForPrintingVoCollection value)
	{
		this.isValidated = false;
	...
	public ims.careuk.vo.lookups.ReferralUrgency getUrgency()
	{
		return this.urgency;
	}
	public void setUrgency(ims.careuk.vo.lookups.ReferralUrgency value)
	{
		this.isValidated = false;
		this.urgency = value;
	}
	...
	public ims.careuk.vo.ReferralTransferVo getReferralTransfer()
	{
		return this.referraltransfer;
	}
	public void setReferralTransfer(ims.careuk.vo.ReferralTransferVo value)
	{
		this.isValidated = false;
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.pathwayid != null)
			if(this.pathwayid.length() > 20)
				listOfErrors.add("The length of the field [pathwayid] in the value object [ims.careuk.vo.CatsReferralWizardVo] is too big. It should be less or equal to 20");
		if(this.referraltransfer != null)
		{
	...
	public Object clone()
	{
		...
		if(this.additionalinvapptsstatus == null)
			...
			clone.additionalinvapptsstatus = (ims.careuk.vo.lookups.AdditionalInvestigationAppointmentsStatus)this.additionalinvapptsstatus.clone();
		...
		if(this.rejectreferraldetail == null)
			...
			clone.rejectreferraldetail = (ims.careuk.vo.RejectReferralVo)this.rejectreferraldetail.clone();
		clone.hasrejectedinv = this.hasrejectedinv;
		if(this.onwardreferralstatus == null)
			clone.onwardreferralstatus = null;
		else
			clone.onwardreferralstatus = (ims.careuk.vo.lookups.OnwardReferralStatus)this.onwardreferralstatus.clone();
		...
		if(this.isfinalreportrequired == null)
			...
			clone.isfinalreportrequired = (ims.careuk.vo.lookups.ReportStatus)this.isfinalreportrequired.clone();
		...
		if(this.issecondaryreportrequired == null)
			...
			clone.issecondaryreportrequired = (ims.careuk.vo.lookups.ReportStatus)this.issecondaryreportrequired.clone();
		...
		if(this.dischargetogpdetailsreviewstatus == null)
			...
			clone.dischargetogpdetailsreviewstatus = (ims.careuk.vo.lookups.DischargeToGPDetailsReviewStatus)this.dischargetogpdetailsreviewstatus.clone();
		...
		if(this.awaitingclinicalinfo == null)
			...
			clone.awaitingclinicalinfo = (ims.careuk.vo.AwaitingClinicalInfoVo)this.awaitingclinicalinfo.clone();
		clone.isawaitingclinicalinfo = this.isawaitingclinicalinfo;
		if(this.contract == null)
			clone.contract = null;
		else
			clone.contract = (ims.careuk.vo.ContractConfigForReferralDetailsComponentVo)this.contract.clone();
		if(this.reportsrequired == null)
			clone.reportsrequired = null;
		else
			clone.reportsrequired = (ims.careuk.vo.ReportsRequiredForPrintingVoCollection)this.reportsrequired.clone();
		...
		if(this.urgency == null)
			...
			clone.urgency = (ims.careuk.vo.lookups.ReferralUrgency)this.urgency.clone();
		clone.pathwayid = this.pathwayid;
		clone.rttclockimpact = this.rttclockimpact;
		if(this.referraltransfer == null)
			clone.referraltransfer = null;
		else
			clone.referraltransfer = (ims.careuk.vo.ReferralTransferVo)this.referraltransfer.clone();
	...
	protected ims.careuk.vo.lookups.AdditionalInvestigationAppointmentsStatus additionalinvapptsstatus;
	...
	protected ims.careuk.vo.RejectReferralVo rejectreferraldetail;
	protected Boolean hasrejectedinv;
	protected ims.careuk.vo.lookups.OnwardReferralStatus onwardreferralstatus;
	protected ims.careuk.vo.ProviderCancellationRefVo providercancellation;
	protected Boolean hasconsultationdetails;
	protected ims.framework.utils.Date dischargedate;
	protected ims.careuk.vo.lookups.ReportStatus isfinalreportrequired;
	...
	protected ims.careuk.vo.lookups.ReportStatus issecondaryreportrequired;
	...
	protected ims.careuk.vo.lookups.DischargeToGPDetailsReviewStatus dischargetogpdetailsreviewstatus;
	protected Boolean issuitableforsurgery;
	protected Boolean isfitforsurgery;
	protected ims.careuk.vo.AwaitingClinicalInfoVo awaitingclinicalinfo;
	protected Boolean isawaitingclinicalinfo;
	protected ims.careuk.vo.ContractConfigForReferralDetailsComponentVo contract;
	protected ims.careuk.vo.ReportsRequiredForPrintingVoCollection reportsrequired;
	...
	protected ims.careuk.vo.lookups.ReferralUrgency urgency;
	protected String pathwayid;
	protected Boolean rttclockimpact;
	protected ims.careuk.vo.ReferralTransferVo referraltransfer;
