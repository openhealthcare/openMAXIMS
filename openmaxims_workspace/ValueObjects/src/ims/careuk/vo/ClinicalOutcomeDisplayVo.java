 ...
 */
public class ClinicalOutcomeDisplayVo extends ims.careuk.vo.ClinicalOutcomeLiteVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ClinicalOutcomeDisplayVo(ims.careuk.vo.beans.ClinicalOutcomeDisplayVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.ClinicalOutcomeDisplayVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.ClinicalOutcomeDisplayVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.ClinicalOutcomeDisplayVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.ClinicalOutcomeDisplayVoBean();
	...
	*/
		public ClinicalOutcomeDisplayVo(ims.careuk.vo.ClinicalOutcomeLiteVo value)
		{
