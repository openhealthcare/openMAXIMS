 ...
 */
public class TLTContactTimeVo extends ims.careuk.vo.TltContactTimeRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public TLTContactTimeVo(ims.careuk.vo.beans.TLTContactTimeVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.TLTContactTimeVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.TLTContactTimeVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.TLTContactTimeVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.TLTContactTimeVoBean();
