...
public class CATSReferralTransportBookingVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<CATSReferralTransportBookingVo>
{
	...
	public ims.careuk.vo.beans.CATSReferralTransportBookingVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.CATSReferralTransportBookingVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.CATSReferralTransportBookingVoBean[] result = new ims.careuk.vo.beans.CATSReferralTransportBookingVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			CATSReferralTransportBookingVo vo = ((CATSReferralTransportBookingVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.CATSReferralTransportBookingVoBean)vo.getBean();
		}
		return result;
	}
	public static CATSReferralTransportBookingVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.CATSReferralTransportBookingVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static CATSReferralTransportBookingVoCollection buildFromBeanCollection(ims.careuk.vo.beans.CATSReferralTransportBookingVoBean[] beans)
	{
		CATSReferralTransportBookingVoCollection coll = new CATSReferralTransportBookingVoCollection();
		if(beans == null)
			return coll;
