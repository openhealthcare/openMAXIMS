 ...
 */
public class ReferralERODForBookTheatreVo extends ims.careuk.vo.ReferralERODRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ReferralERODForBookTheatreVo(ims.careuk.vo.beans.ReferralERODForBookTheatreVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.ReferralERODForBookTheatreVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.eroddate1 = bean.getERODDate1() == null ? null : bean.getERODDate1().buildDate();
	...
	{
		ims.careuk.vo.beans.ReferralERODForBookTheatreVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.ReferralERODForBookTheatreVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.ReferralERODForBookTheatreVoBean();
