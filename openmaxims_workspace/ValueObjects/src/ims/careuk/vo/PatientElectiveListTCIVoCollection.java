...
public class PatientElectiveListTCIVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<PatientElectiveListTCIVo>
{
	...
	public ims.careuk.vo.beans.PatientElectiveListTCIVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.PatientElectiveListTCIVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.PatientElectiveListTCIVoBean[] result = new ims.careuk.vo.beans.PatientElectiveListTCIVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			PatientElectiveListTCIVo vo = ((PatientElectiveListTCIVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.PatientElectiveListTCIVoBean)vo.getBean();
		}
		return result;
	}
	public static PatientElectiveListTCIVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.PatientElectiveListTCIVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static PatientElectiveListTCIVoCollection buildFromBeanCollection(ims.careuk.vo.beans.PatientElectiveListTCIVoBean[] beans)
	{
		PatientElectiveListTCIVoCollection coll = new PatientElectiveListTCIVoCollection();
		if(beans == null)
			return coll;
