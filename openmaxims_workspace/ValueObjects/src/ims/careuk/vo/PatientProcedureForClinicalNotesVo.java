...
public class PatientProcedureForClinicalNotesVo extends ims.core.clinical.vo.PatientProcedureRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public PatientProcedureForClinicalNotesVo(ims.careuk.vo.beans.PatientProcedureForClinicalNotesVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.PatientProcedureForClinicalNotesVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.PatientProcedureForClinicalNotesVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.PatientProcedureForClinicalNotesVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.PatientProcedureForClinicalNotesVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.proceduredescription == null || this.proceduredescription.length() == 0)
			...
			listOfErrors.add("The length of the field [proceduredescription] in the value object [ims.careuk.vo.PatientProcedureForClinicalNotesVo] is too big. It should be less or equal to 255");
