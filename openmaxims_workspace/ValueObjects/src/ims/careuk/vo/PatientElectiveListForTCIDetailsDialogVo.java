 ...
 */
public class PatientElectiveListForTCIDetailsDialogVo extends ims.careuk.vo.PatientElectiveListRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public PatientElectiveListForTCIDetailsDialogVo(ims.careuk.vo.beans.PatientElectiveListForTCIDetailsDialogVoBean bean)
	{
		this.id = bean.getId();
		...
		this.erodhistory = ims.careuk.vo.ReferralERODVoCollection.buildFromBeanCollection(bean.getERODHistory());
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.PatientElectiveListForTCIDetailsDialogVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.PatientElectiveListForTCIDetailsDialogVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.PatientElectiveListForTCIDetailsDialogVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.PatientElectiveListForTCIDetailsDialogVoBean();
	...
	public ims.careuk.vo.ReferralERODVoCollection getERODHistory()
	{
		return this.erodhistory;
	}
	public void setERODHistory(ims.careuk.vo.ReferralERODVoCollection value)
	{
		this.isValidated = false;
	...
	public Object clone()
	{
		...
		if(this.erodhistory == null)
			...
			clone.erodhistory = (ims.careuk.vo.ReferralERODVoCollection)this.erodhistory.clone();
	...
	protected ims.careuk.vo.ReferralERODVoCollection erodhistory;
