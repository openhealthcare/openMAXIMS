...
public class ConsultationOutcomeVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<ConsultationOutcomeVo>
{
	...
	public ims.careuk.vo.ConsultationOutcomeRefVoCollection toRefVoCollection()
	{
		ims.careuk.vo.ConsultationOutcomeRefVoCollection result = new ims.careuk.vo.ConsultationOutcomeRefVoCollection();
		for(int x = 0; x < this.col.size(); x++)
		{
	...
	public ims.careuk.vo.beans.ConsultationOutcomeVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.ConsultationOutcomeVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.ConsultationOutcomeVoBean[] result = new ims.careuk.vo.beans.ConsultationOutcomeVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			ConsultationOutcomeVo vo = ((ConsultationOutcomeVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.ConsultationOutcomeVoBean)vo.getBean();
		}
		return result;
	}
	public static ConsultationOutcomeVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.ConsultationOutcomeVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static ConsultationOutcomeVoCollection buildFromBeanCollection(ims.careuk.vo.beans.ConsultationOutcomeVoBean[] beans)
	{
		ConsultationOutcomeVoCollection coll = new ConsultationOutcomeVoCollection();
		if(beans == null)
			return coll;
