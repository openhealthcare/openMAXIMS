 ...
 */
public class CatsReferralRttDateForTheatreListVo extends ims.careuk.vo.CatsReferralRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public CatsReferralRttDateForTheatreListVo(ims.careuk.vo.beans.CatsReferralRttDateForTheatreListVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.referraldetails = bean.getReferralDetails() == null ? null : bean.getReferralDetails().buildVo();
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.CatsReferralRttDateForTheatreListVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.CatsReferralRttDateForTheatreListVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.CatsReferralRttDateForTheatreListVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.CatsReferralRttDateForTheatreListVoBean();
