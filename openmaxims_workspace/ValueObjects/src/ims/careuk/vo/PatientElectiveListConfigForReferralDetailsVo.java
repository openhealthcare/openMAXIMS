...
public class PatientElectiveListConfigForReferralDetailsVo extends ims.core.configuration.vo.ElectiveListConfigurationRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public PatientElectiveListConfigForReferralDetailsVo(ims.careuk.vo.beans.PatientElectiveListConfigForReferralDetailsVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.PatientElectiveListConfigForReferralDetailsVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.waitinglistname = bean.getWaitingListName();
	...
	{
		ims.careuk.vo.beans.PatientElectiveListConfigForReferralDetailsVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.PatientElectiveListConfigForReferralDetailsVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.PatientElectiveListConfigForReferralDetailsVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.waitinglistname == null || this.waitinglistname.length() == 0)
			...
			listOfErrors.add("The length of the field [waitinglistname] in the value object [ims.careuk.vo.PatientElectiveListConfigForReferralDetailsVo] is too big. It should be less or equal to 150");
