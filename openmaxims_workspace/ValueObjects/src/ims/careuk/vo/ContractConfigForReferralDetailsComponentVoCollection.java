...
public class ContractConfigForReferralDetailsComponentVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<ContractConfigForReferralDetailsComponentVo>
{
	...
	public ims.careuk.vo.beans.ContractConfigForReferralDetailsComponentVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.ContractConfigForReferralDetailsComponentVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.ContractConfigForReferralDetailsComponentVoBean[] result = new ims.careuk.vo.beans.ContractConfigForReferralDetailsComponentVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			ContractConfigForReferralDetailsComponentVo vo = ((ContractConfigForReferralDetailsComponentVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.ContractConfigForReferralDetailsComponentVoBean)vo.getBean();
		}
		return result;
	}
	public static ContractConfigForReferralDetailsComponentVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.ContractConfigForReferralDetailsComponentVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static ContractConfigForReferralDetailsComponentVoCollection buildFromBeanCollection(ims.careuk.vo.beans.ContractConfigForReferralDetailsComponentVoBean[] beans)
	{
		ContractConfigForReferralDetailsComponentVoCollection coll = new ContractConfigForReferralDetailsComponentVoCollection();
		if(beans == null)
			return coll;
