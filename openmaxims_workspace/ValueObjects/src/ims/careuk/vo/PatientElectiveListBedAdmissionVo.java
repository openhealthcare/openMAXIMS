 ...
 */
public class PatientElectiveListBedAdmissionVo extends ims.careuk.vo.PatientElectiveListRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public PatientElectiveListBedAdmissionVo(ims.careuk.vo.beans.PatientElectiveListBedAdmissionVoBean bean)
	{
		this.id = bean.getId();
		...
		{
			this.electiveliststatushistory = new ims.careuk.vo.ElectiveListStatusRefVoCollection();
			...
			{
				this.electiveliststatushistory.add(new ims.careuk.vo.ElectiveListStatusRefVo(new Integer(bean.getElectiveListStatusHistory()[electiveliststatushistory_i].getId()), bean.getElectiveListStatusHistory()[electiveliststatushistory_i].getVersion()));
			}
		}
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.PatientElectiveListBedAdmissionVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.PatientElectiveListBedAdmissionVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.PatientElectiveListBedAdmissionVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.PatientElectiveListBedAdmissionVoBean();
	...
	public ims.careuk.vo.ElectiveListStatusRefVoCollection getElectiveListStatusHistory()
	{
		return this.electiveliststatushistory;
	}
	public void setElectiveListStatusHistory(ims.careuk.vo.ElectiveListStatusRefVoCollection value)
	{
		this.isValidated = false;
	...
	public ims.careuk.vo.CATSReferralWithContextPasVo getReferral()
	{
		return this.referral;
	}
	public void setReferral(ims.careuk.vo.CATSReferralWithContextPasVo value)
	{
		this.isValidated = false;
		this.referral = value;
	}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.bed != null)
			if(this.bed.length() > 50)
				listOfErrors.add("The length of the field [bed] in the value object [ims.careuk.vo.PatientElectiveListBedAdmissionVo] is too big. It should be less or equal to 50");
		if(this.tcidetails != null)
		{
	...
	public Object clone()
	{
		...
		if(this.referral == null)
			...
			clone.referral = (ims.careuk.vo.CATSReferralWithContextPasVo)this.referral.clone();
		if(this.erod == null)
			clone.erod = null;
		else
	...
	protected ims.careuk.vo.ElectiveListStatusRefVoCollection electiveliststatushistory;
	protected ims.emergency.vo.lookups.ElectiveListReason electivelistreason;
	protected ims.careuk.vo.CATSReferralWithContextPasVo referral;
