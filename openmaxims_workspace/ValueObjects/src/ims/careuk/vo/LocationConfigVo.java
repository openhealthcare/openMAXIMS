...
public class LocationConfigVo extends ims.admin.vo.ConfigLocationLiteVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public LocationConfigVo(ims.careuk.vo.beans.LocationConfigVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.LocationConfigVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.name = bean.getName();
	...
	{
		ims.careuk.vo.beans.LocationConfigVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.LocationConfigVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.LocationConfigVoBean();
	...
	public ims.careuk.vo.LocationConfigVoCollection getLocations()
	{
		return this.locations;
	}
	public void setLocations(ims.careuk.vo.LocationConfigVoCollection value)
	{
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.name == null || this.name.length() == 0)
			...
			listOfErrors.add("The length of the field [name] in the value object [ims.careuk.vo.LocationConfigVo] is too big. It should be less or equal to 120");
		if(this.type == null)
	...
	protected ims.careuk.vo.LocationConfigVoCollection locations;
