...
public class ClinicalOutcomeProcedureVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<ClinicalOutcomeProcedureVo>
{
	...
	public ims.careuk.vo.beans.ClinicalOutcomeProcedureVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.ClinicalOutcomeProcedureVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.ClinicalOutcomeProcedureVoBean[] result = new ims.careuk.vo.beans.ClinicalOutcomeProcedureVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			ClinicalOutcomeProcedureVo vo = ((ClinicalOutcomeProcedureVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.ClinicalOutcomeProcedureVoBean)vo.getBean();
		}
		return result;
	}
	public static ClinicalOutcomeProcedureVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.ClinicalOutcomeProcedureVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static ClinicalOutcomeProcedureVoCollection buildFromBeanCollection(ims.careuk.vo.beans.ClinicalOutcomeProcedureVoBean[] beans)
	{
		ClinicalOutcomeProcedureVoCollection coll = new ClinicalOutcomeProcedureVoCollection();
		if(beans == null)
			return coll;
