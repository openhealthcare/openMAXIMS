 ...
 */
public class PatientElectiveListForDNAAppointmentsVo extends ims.careuk.vo.PatientElectiveListRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public PatientElectiveListForDNAAppointmentsVo(ims.careuk.vo.beans.PatientElectiveListForDNAAppointmentsVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.PatientElectiveListForDNAAppointmentsVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.PatientElectiveListForDNAAppointmentsVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.PatientElectiveListForDNAAppointmentsVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.PatientElectiveListForDNAAppointmentsVoBean();
	...
	public ims.careuk.vo.TCIForPatientElectiveListAppointmentDNAVo getTCIDetails()
	{
		return this.tcidetails;
	}
	public void setTCIDetails(ims.careuk.vo.TCIForPatientElectiveListAppointmentDNAVo value)
	{
		this.isValidated = false;
	...
	public Object clone()
	{
		...
		if(this.tcidetails == null)
			...
			clone.tcidetails = (ims.careuk.vo.TCIForPatientElectiveListAppointmentDNAVo)this.tcidetails.clone();
	...
	protected ims.careuk.vo.TCIForPatientElectiveListAppointmentDNAVo tcidetails;
