 ...
 */
public class PresentationReferralSummaryVo extends ims.careuk.vo.PresentationReferralSummaryRefVo implements ims.vo.ImsCloneable, Comparable, ims.vo.interfaces.IPresentationReferralSummary
{
	...
	public PresentationReferralSummaryVo(ims.careuk.vo.beans.PresentationReferralSummaryVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.PresentationReferralSummaryVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.catsreferral = bean.getCatsReferral() == null ? null : new ims.careuk.vo.CatsReferralRefVo(new Integer(bean.getCatsReferral().getId()), bean.getCatsReferral().getVersion());
	...
	{
		ims.careuk.vo.beans.PresentationReferralSummaryVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.PresentationReferralSummaryVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.PresentationReferralSummaryVoBean();
