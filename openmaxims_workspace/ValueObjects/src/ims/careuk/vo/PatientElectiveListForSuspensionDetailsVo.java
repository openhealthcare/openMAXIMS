 ...
 */
public class PatientElectiveListForSuspensionDetailsVo extends ims.careuk.vo.PatientElectiveListRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public PatientElectiveListForSuspensionDetailsVo(ims.careuk.vo.beans.PatientElectiveListForSuspensionDetailsVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.PatientElectiveListForSuspensionDetailsVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.PatientElectiveListForSuspensionDetailsVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.PatientElectiveListForSuspensionDetailsVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.PatientElectiveListForSuspensionDetailsVoBean();
