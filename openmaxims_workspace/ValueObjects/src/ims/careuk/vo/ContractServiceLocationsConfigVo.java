...
public class ContractServiceLocationsConfigVo extends ims.core.configuration.vo.ContractServiceLocationsConfigRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ContractServiceLocationsConfigVo(ims.careuk.vo.beans.ContractServiceLocationsConfigVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.ContractServiceLocationsConfigVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.careuk.vo.beans.ContractServiceLocationsConfigVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.ContractServiceLocationsConfigVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.ContractServiceLocationsConfigVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.contractid == null || this.contractid.length() == 0)
			...
			listOfErrors.add("The length of the field [contractid] in the value object [ims.careuk.vo.ContractServiceLocationsConfigVo] is too big. It should be less or equal to 25");
