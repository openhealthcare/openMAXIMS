...
public class ClinicalOutcomeDisplayVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<ClinicalOutcomeDisplayVo>
{
	...
	public ims.careuk.vo.ClinicalOutcomeRefVoCollection toRefVoCollection()
	{
		ims.careuk.vo.ClinicalOutcomeRefVoCollection result = new ims.careuk.vo.ClinicalOutcomeRefVoCollection();
		for(int x = 0; x < this.col.size(); x++)
		{
	...
	public ims.careuk.vo.beans.ClinicalOutcomeDisplayVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.ClinicalOutcomeDisplayVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.ClinicalOutcomeDisplayVoBean[] result = new ims.careuk.vo.beans.ClinicalOutcomeDisplayVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			ClinicalOutcomeDisplayVo vo = ((ClinicalOutcomeDisplayVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.ClinicalOutcomeDisplayVoBean)vo.getBean();
		}
		return result;
	}
	public static ClinicalOutcomeDisplayVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.ClinicalOutcomeDisplayVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static ClinicalOutcomeDisplayVoCollection buildFromBeanCollection(ims.careuk.vo.beans.ClinicalOutcomeDisplayVoBean[] beans)
	{
		ClinicalOutcomeDisplayVoCollection coll = new ClinicalOutcomeDisplayVoCollection();
		if(beans == null)
			return coll;
