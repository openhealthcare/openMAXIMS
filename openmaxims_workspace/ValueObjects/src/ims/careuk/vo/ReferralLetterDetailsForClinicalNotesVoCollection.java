...
public class ReferralLetterDetailsForClinicalNotesVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<ReferralLetterDetailsForClinicalNotesVo>
{
	...
	public ims.careuk.vo.beans.ReferralLetterDetailsForClinicalNotesVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.careuk.vo.beans.ReferralLetterDetailsForClinicalNotesVoBean[] getBeanCollectionArray()
	{
		ims.careuk.vo.beans.ReferralLetterDetailsForClinicalNotesVoBean[] result = new ims.careuk.vo.beans.ReferralLetterDetailsForClinicalNotesVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			ReferralLetterDetailsForClinicalNotesVo vo = ((ReferralLetterDetailsForClinicalNotesVo)col.get(i));
			result[i] = (ims.careuk.vo.beans.ReferralLetterDetailsForClinicalNotesVoBean)vo.getBean();
		}
		return result;
	}
	public static ReferralLetterDetailsForClinicalNotesVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.careuk.vo.beans.ReferralLetterDetailsForClinicalNotesVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static ReferralLetterDetailsForClinicalNotesVoCollection buildFromBeanCollection(ims.careuk.vo.beans.ReferralLetterDetailsForClinicalNotesVoBean[] beans)
	{
		ReferralLetterDetailsForClinicalNotesVoCollection coll = new ReferralLetterDetailsForClinicalNotesVoCollection();
		if(beans == null)
			return coll;
