 ...
 */
public class TCIOutcomeForPatientElectiveListVo extends ims.careuk.vo.TCIOutcomeForPatientElectiveListRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public TCIOutcomeForPatientElectiveListVo(ims.careuk.vo.beans.TCIOutcomeForPatientElectiveListVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.outcome = bean.getOutcome() == null ? null : ims.careuk.vo.lookups.AdmissionOfferOutcome.buildLookup(bean.getOutcome());
		...
		this.outcomereason = bean.getOutcomeReason() == null ? null : ims.careuk.vo.lookups.TCIStatusChangeReason.buildLookup(bean.getOutcomeReason());
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.careuk.vo.beans.TCIOutcomeForPatientElectiveListVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.outcome = bean.getOutcome() == null ? null : ims.careuk.vo.lookups.AdmissionOfferOutcome.buildLookup(bean.getOutcome());
	...
	{
		ims.careuk.vo.beans.TCIOutcomeForPatientElectiveListVoBean bean = null;
		if(map != null)
			bean = (ims.careuk.vo.beans.TCIOutcomeForPatientElectiveListVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.careuk.vo.beans.TCIOutcomeForPatientElectiveListVoBean();
	...
	public ims.careuk.vo.lookups.AdmissionOfferOutcome getOutcome()
	{
		return this.outcome;
	}
	public void setOutcome(ims.careuk.vo.lookups.AdmissionOfferOutcome value)
	{
	...
	public ims.careuk.vo.lookups.TCIStatusChangeReason getOutcomeReason()
	{
		return this.outcomereason;
	}
	public void setOutcomeReason(ims.careuk.vo.lookups.TCIStatusChangeReason value)
	{
		this.isValidated = false;
	...
	public Object clone()
	{
		...
		if(this.outcome == null)
			...
			clone.outcome = (ims.careuk.vo.lookups.AdmissionOfferOutcome)this.outcome.clone();
		...
		if(this.outcomereason == null)
			...
			clone.outcomereason = (ims.careuk.vo.lookups.TCIStatusChangeReason)this.outcomereason.clone();
	...
	protected ims.careuk.vo.lookups.AdmissionOfferOutcome outcome;
	protected ims.core.resource.people.vo.MemberOfStaffRefVo changeby;
	protected ims.framework.utils.DateTime statusdatetime;
	protected ims.careuk.vo.lookups.TCIStatusChangeReason outcomereason;
