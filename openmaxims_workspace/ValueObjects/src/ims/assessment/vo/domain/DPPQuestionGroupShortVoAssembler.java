 ...
 */
public class DPPQuestionGroupShortVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.assessment.vo.DPPQuestionGroupShortVo copy(ims.assessment.vo.DPPQuestionGroupShortVo valueObjectDest, ims.assessment.vo.DPPQuestionGroupShortVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createDPPQuestionGroupShortVoCollectionFromDPPQuestionGroup(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.assessment.configuration.domain.objects.DPPQuestionGroup objects.
	 */
	public static ims.assessment.vo.DPPQuestionGroupShortVoCollection createDPPQuestionGroupShortVoCollectionFromDPPQuestionGroup(java.util.Set domainObjectSet)	
	{
		return createDPPQuestionGroupShortVoCollectionFromDPPQuestionGroup(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.assessment.configuration.domain.objects.DPPQuestionGroup objects.
	 */
	public static ims.assessment.vo.DPPQuestionGroupShortVoCollection createDPPQuestionGroupShortVoCollectionFromDPPQuestionGroup(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.assessment.vo.DPPQuestionGroupShortVoCollection voList = new ims.assessment.vo.DPPQuestionGroupShortVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.assessment.vo.DPPQuestionGroupShortVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.assessment.vo.DPPQuestionGroupShortVoCollection createDPPQuestionGroupShortVoCollectionFromDPPQuestionGroup(java.util.List domainObjectList) 
	{
		return createDPPQuestionGroupShortVoCollectionFromDPPQuestionGroup(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.assessment.configuration.domain.objects.DPPQuestionGroup objects.
	 */
	public static ims.assessment.vo.DPPQuestionGroupShortVoCollection createDPPQuestionGroupShortVoCollectionFromDPPQuestionGroup(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.assessment.vo.DPPQuestionGroupShortVoCollection voList = new ims.assessment.vo.DPPQuestionGroupShortVoCollection();
	 ...
	 */
	 public static java.util.Set extractDPPQuestionGroupSet(ims.domain.ILightweightDomainFactory domainFactory, ims.assessment.vo.DPPQuestionGroupShortVoCollection voCollection) 
	 {
	 	return extractDPPQuestionGroupSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractDPPQuestionGroupSet(ims.domain.ILightweightDomainFactory domainFactory, ims.assessment.vo.DPPQuestionGroupShortVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.assessment.vo.DPPQuestionGroupShortVo vo = voCollection.get(i);
			ims.assessment.configuration.domain.objects.DPPQuestionGroup domainObject = DPPQuestionGroupShortVoAssembler.extractDPPQuestionGroup(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractDPPQuestionGroupList(ims.domain.ILightweightDomainFactory domainFactory, ims.assessment.vo.DPPQuestionGroupShortVoCollection voCollection) 
	 {
	 	return extractDPPQuestionGroupList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractDPPQuestionGroupList(ims.domain.ILightweightDomainFactory domainFactory, ims.assessment.vo.DPPQuestionGroupShortVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.assessment.vo.DPPQuestionGroupShortVo create(ims.assessment.configuration.domain.objects.DPPQuestionGroup domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.assessment.vo.DPPQuestionGroupShortVo create(DomainObjectMap map, ims.assessment.configuration.domain.objects.DPPQuestionGroup domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.assessment.vo.DPPQuestionGroupShortVo valueObject = (ims.assessment.vo.DPPQuestionGroupShortVo) map.getValueObject(domainObject, ims.assessment.vo.DPPQuestionGroupShortVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.assessment.vo.DPPQuestionGroupShortVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.assessment.configuration.domain.objects.DPPQuestionGroup
	 */
	 public static ims.assessment.vo.DPPQuestionGroupShortVo insert(ims.assessment.vo.DPPQuestionGroupShortVo valueObject, ims.assessment.configuration.domain.objects.DPPQuestionGroup domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.assessment.configuration.domain.objects.DPPQuestionGroup
	 */
	 public static ims.assessment.vo.DPPQuestionGroupShortVo insert(DomainObjectMap map, ims.assessment.vo.DPPQuestionGroupShortVo valueObject, ims.assessment.configuration.domain.objects.DPPQuestionGroup domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.assessment.configuration.domain.objects.DPPQuestionGroup extractDPPQuestionGroup(ims.domain.ILightweightDomainFactory domainFactory, ims.assessment.vo.DPPQuestionGroupShortVo valueObject) 
	{
		return 	extractDPPQuestionGroup(domainFactory, valueObject, new HashMap());
	}

	public static ims.assessment.configuration.domain.objects.DPPQuestionGroup extractDPPQuestionGroup(ims.domain.ILightweightDomainFactory domainFactory, ims.assessment.vo.DPPQuestionGroupShortVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.assessment.vo.DPPQuestionGroupShortVo ID_DPPQuestionGroup field is unknown
		...
		ims.assessment.configuration.vo.AssessmentQuestionRefVoCollection refCollection3 = valueObject.getAssessmentQuestions();
		int size3 = (null == refCollection3) ? 0 : refCollection3.size();		
		java.util.Set domainAssessmentQuestions3 = domainObject.getAssessmentQuestions();
		if (domainAssessmentQuestions3 == null)
		{
			domainAssessmentQuestions3 = new java.util.HashSet();
		}
		java.util.Set newSet3  = new java.util.HashSet();
		for(int i=0; i<size3; i++) 
		{
			ims.assessment.configuration.vo.AssessmentQuestionRefVo vo = refCollection3.get(i);					
			...
			//Trying to avoid the hibernate collection being marked as dirty via its public interface methods. (like add)
			if (!domainAssessmentQuestions3.contains(dom))
			{
				domainAssessmentQuestions3.add(dom);
			}
			newSet3.add(dom);			
		}
		java.util.Set removedSet3 = new java.util.HashSet();
		java.util.Iterator iter3 = domainAssessmentQuestions3.iterator();
		//Find out which objects need to be removed
		while (iter3.hasNext())
		{
		...
		while (iter3.hasNext())
		{
			domainAssessmentQuestions3.remove(iter3.next());
		}		
		
		domainObject.setAssessmentQuestions(domainAssessmentQuestions3);		
