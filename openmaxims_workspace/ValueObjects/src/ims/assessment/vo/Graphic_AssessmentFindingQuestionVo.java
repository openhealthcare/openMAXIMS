 ...
 */
public class Graphic_AssessmentFindingQuestionVo extends ims.assessment.configuration.vo.GraphicAssessmentFindingQuestionRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public Graphic_AssessmentFindingQuestionVo()
	{
	}
	public Graphic_AssessmentFindingQuestionVo(Integer id, int version)
	{
		super(id, version);
	}
	public Graphic_AssessmentFindingQuestionVo(ims.assessment.vo.beans.Graphic_AssessmentFindingQuestionVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.assessment.vo.beans.Graphic_AssessmentFindingQuestionVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.assessment.vo.beans.Graphic_AssessmentFindingQuestionVoBean bean = null;
		if(map != null)
			bean = (ims.assessment.vo.beans.Graphic_AssessmentFindingQuestionVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.assessment.vo.beans.Graphic_AssessmentFindingQuestionVoBean();
	...
	public Object clone()
	{
		...
		Graphic_AssessmentFindingQuestionVo clone = new Graphic_AssessmentFindingQuestionVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(Graphic_AssessmentFindingQuestionVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A Graphic_AssessmentFindingQuestionVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		Graphic_AssessmentFindingQuestionVo compareObj = (Graphic_AssessmentFindingQuestionVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
