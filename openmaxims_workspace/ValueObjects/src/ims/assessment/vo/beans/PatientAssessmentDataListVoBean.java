...
public class PatientAssessmentDataListVoBean extends ims.vo.ValueObjectBean
{
	public PatientAssessmentDataListVoBean()
	{
	}
	public PatientAssessmentDataListVoBean(ims.assessment.vo.PatientAssessmentDataListVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.assessment.vo.PatientAssessmentDataListVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.assessment.vo.PatientAssessmentDataListVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.assessment.vo.PatientAssessmentDataListVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.assessment.vo.PatientAssessmentDataListVo vo = null;
		if(map != null)
			vo = (ims.assessment.vo.PatientAssessmentDataListVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.assessment.vo.PatientAssessmentDataListVo();
