...
public class Graphic_AssessmentVoBean extends ims.vo.ValueObjectBean
{
	public Graphic_AssessmentVoBean()
	{
	}
	public Graphic_AssessmentVoBean(ims.assessment.vo.Graphic_AssessmentVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.assessment.vo.Graphic_AssessmentVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.name = vo.getName();
	...
	public ims.assessment.vo.Graphic_AssessmentVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.assessment.vo.Graphic_AssessmentVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.assessment.vo.Graphic_AssessmentVo vo = null;
		if(map != null)
			vo = (ims.assessment.vo.Graphic_AssessmentVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.assessment.vo.Graphic_AssessmentVo();
	...
	public ims.assessment.vo.beans.Graphic_AssessmentQuestionVoBean[] getAssociatedQuestions()
	{
		return this.associatedquestions;
	}
	public void setAssociatedQuestions(ims.assessment.vo.beans.Graphic_AssessmentQuestionVoBean[] value)
	{
		this.associatedquestions = value;
	}
	public ims.assessment.vo.beans.Graphic_AssessmentFindingVoBean[] getFindingsAndQuestions()
	{
		return this.findingsandquestions;
	}
	public void setFindingsAndQuestions(ims.assessment.vo.beans.Graphic_AssessmentFindingVoBean[] value)
	{
	...
	private ims.assessment.vo.beans.Graphic_AssessmentQuestionVoBean[] associatedquestions;
	private ims.assessment.vo.beans.Graphic_AssessmentFindingVoBean[] findingsandquestions;
}
