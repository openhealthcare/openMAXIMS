 ...
 */
public class Answer_DetailsVo extends ims.assessment.instantiation.vo.PatientAnswerDetailsRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public Answer_DetailsVo()
	{
	}
	public Answer_DetailsVo(Integer id, int version)
	{
		super(id, version);
	}
	public Answer_DetailsVo(ims.assessment.vo.beans.Answer_DetailsVoBean bean)
	{
		this.id = bean.getId();
		...
		this.multiselectanswers = ims.assessment.vo.Answer_OptionVoCollection.buildFromBeanCollection(bean.getMultiSelectAnswers());
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.assessment.vo.beans.Answer_DetailsVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.assessment.vo.beans.Answer_DetailsVoBean bean = null;
		if(map != null)
			bean = (ims.assessment.vo.beans.Answer_DetailsVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.assessment.vo.beans.Answer_DetailsVoBean();
	...
	public ims.assessment.vo.Question_AnswerTypeVo getAnswerType()
	{
		return this.answertype;
	}
	public void setAnswerType(ims.assessment.vo.Question_AnswerTypeVo value)
	{
	...
	public ims.assessment.vo.Answer_OptionVoCollection getMultiSelectAnswers()
	{
		return this.multiselectanswers;
	}
	public void setMultiSelectAnswers(ims.assessment.vo.Answer_OptionVoCollection value)
	{
		this.isValidated = false;
	...
	public ims.assessment.vo.Answer_OptionVo getPicklist()
	{
		return this.picklist;
	}
	public void setPicklist(ims.assessment.vo.Answer_OptionVo value)
	{
		this.isValidated = false;
		this.picklist = value;
	}
	...
	public Object clone()
	{
		...
		Answer_DetailsVo clone = new Answer_DetailsVo(this.id, this.version);
		
		if(this.answertype == null)
			clone.answertype = null;
		else
			clone.answertype = (ims.assessment.vo.Question_AnswerTypeVo)this.answertype.clone();
		...
		if(this.multiselectanswers == null)
			...
			clone.multiselectanswers = (ims.assessment.vo.Answer_OptionVoCollection)this.multiselectanswers.clone();
		clone.boolvalueanswer = this.boolvalueanswer;
		if(this.picklist == null)
			clone.picklist = null;
		else
			clone.picklist = (ims.assessment.vo.Answer_OptionVo)this.picklist.clone();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(Answer_DetailsVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A Answer_DetailsVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((Answer_DetailsVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((Answer_DetailsVo)obj).getBoId());
	}
	...
	protected ims.assessment.vo.Question_AnswerTypeVo answertype;
	protected Integer answerwidth;
	protected Integer maxmultiselectallowed;
	protected ims.assessment.vo.Answer_OptionVoCollection multiselectanswers;
	protected Boolean boolvalueanswer;
	protected ims.assessment.vo.Answer_OptionVo picklist;
