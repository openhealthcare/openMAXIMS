 ...
 */
public class Question_InformationVo extends ims.core.clinical.vo.QuestionInformationRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public Question_InformationVo()
	{
	}
	public Question_InformationVo(Integer id, int version)
	{
		super(id, version);
	}
	public Question_InformationVo(ims.assessment.vo.beans.Question_InformationVoBean bean)
	{
		this.id = bean.getId();
		...
		this.answertypes = ims.assessment.vo.Question_AnswerTypeVoCollection.buildFromBeanCollection(bean.getAnswerTypes());
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.assessment.vo.beans.Question_InformationVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.text = bean.getText();
	...
	{
		ims.assessment.vo.beans.Question_InformationVoBean bean = null;
		if(map != null)
			bean = (ims.assessment.vo.beans.Question_InformationVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.assessment.vo.beans.Question_InformationVoBean();
	...
	public ims.assessment.vo.Question_AnswerTypeVoCollection getAnswerTypes()
	{
		return this.answertypes;
	}
	public void setAnswerTypes(ims.assessment.vo.Question_AnswerTypeVoCollection value)
	{
		this.isValidated = false;
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.text == null || this.text.length() == 0)
			listOfErrors.add("Text is mandatory");
		else if(this.text.length() > 500)
			listOfErrors.add("The length of the field [text] in the value object [ims.assessment.vo.Question_InformationVo] is too big. It should be less or equal to 500");
		if(this.shorttext == null || this.shorttext.length() == 0)
			listOfErrors.add("ShortText is mandatory");
		else if(this.shorttext.length() > 500)
			listOfErrors.add("The length of the field [shorttext] in the value object [ims.assessment.vo.Question_InformationVo] is too big. It should be less or equal to 500");
	...
	public Object clone()
	{
		...
		Question_InformationVo clone = new Question_InformationVo(this.id, this.version);
		...
		if(this.answertypes == null)
			...
			clone.answertypes = (ims.assessment.vo.Question_AnswerTypeVoCollection)this.answertypes.clone();
		if(this.genderspecific == null)
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(Question_InformationVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A Question_InformationVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((Question_InformationVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((Question_InformationVo)obj).getBoId());
	}
	...
	protected ims.assessment.vo.Question_AnswerTypeVoCollection answertypes;
