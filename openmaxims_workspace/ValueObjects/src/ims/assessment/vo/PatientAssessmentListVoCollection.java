...
public class PatientAssessmentListVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<PatientAssessmentListVo>
{
	...
	public ims.assessment.vo.beans.PatientAssessmentListVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.assessment.vo.beans.PatientAssessmentListVoBean[] getBeanCollectionArray()
	{
		ims.assessment.vo.beans.PatientAssessmentListVoBean[] result = new ims.assessment.vo.beans.PatientAssessmentListVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			PatientAssessmentListVo vo = ((PatientAssessmentListVo)col.get(i));
			result[i] = (ims.assessment.vo.beans.PatientAssessmentListVoBean)vo.getBean();
		}
		return result;
	}
	public static PatientAssessmentListVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.assessment.vo.beans.PatientAssessmentListVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static PatientAssessmentListVoCollection buildFromBeanCollection(ims.assessment.vo.beans.PatientAssessmentListVoBean[] beans)
	{
		PatientAssessmentListVoCollection coll = new PatientAssessmentListVoCollection();
		if(beans == null)
			return coll;
