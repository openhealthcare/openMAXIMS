 ...
 */
public class Graphic_AssessmentQuestionVo extends ims.assessment.configuration.vo.GraphicAssessmentQuestionRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public Graphic_AssessmentQuestionVo()
	{
	}
	public Graphic_AssessmentQuestionVo(Integer id, int version)
	{
		super(id, version);
	}
	public Graphic_AssessmentQuestionVo(ims.assessment.vo.beans.Graphic_AssessmentQuestionVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.assessment.vo.beans.Graphic_AssessmentQuestionVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.ismandatory = bean.getIsMandatory();
	...
	{
		ims.assessment.vo.beans.Graphic_AssessmentQuestionVoBean bean = null;
		if(map != null)
			bean = (ims.assessment.vo.beans.Graphic_AssessmentQuestionVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.assessment.vo.beans.Graphic_AssessmentQuestionVoBean();
	...
	public Object clone()
	{
		...
		Graphic_AssessmentQuestionVo clone = new Graphic_AssessmentQuestionVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(Graphic_AssessmentQuestionVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A Graphic_AssessmentQuestionVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		Graphic_AssessmentQuestionVo compareObj = (Graphic_AssessmentQuestionVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
