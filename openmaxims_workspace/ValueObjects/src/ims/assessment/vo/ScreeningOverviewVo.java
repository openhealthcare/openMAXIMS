...
public class ScreeningOverviewVo extends ims.vo.ValueObject implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public ScreeningOverviewVo()
	{
	}
	public ScreeningOverviewVo(ims.assessment.vo.beans.ScreeningOverviewVoBean bean)
	{
		this.screenprofilecomponentid = bean.getScreenProfileComponentID();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.assessment.vo.beans.ScreeningOverviewVoBean bean)
	{
		this.screenprofilecomponentid = bean.getScreenProfileComponentID();
		this.userassessmentid = bean.getUserAssessmentID();
		this.userassessmentname = bean.getUserAssessmentName();
	...
	{
		ims.assessment.vo.beans.ScreeningOverviewVoBean bean = null;
		if(map != null)
			bean = (ims.assessment.vo.beans.ScreeningOverviewVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.assessment.vo.beans.ScreeningOverviewVoBean();
			map.addValueObjectBean(this, bean);
			bean.populate(map, this);
		}
		return bean;
	}
	public boolean getScreenProfileComponentIDIsNotNull()
	{
		return this.screenprofilecomponentid != null;
	}
	public Integer getScreenProfileComponentID()
	{
		return this.screenprofilecomponentid;
	}
	public void setScreenProfileComponentID(Integer value)
	{
		this.isValidated = false;
		this.screenprofilecomponentid = value;
	}
	...
	public boolean equals(Object obj)
	{
		if(obj == null)
			return false;
		if(!(obj instanceof ScreeningOverviewVo))
			return false;
		ScreeningOverviewVo compareObj = (ScreeningOverviewVo)obj;
		if(this.getScreenProfileComponentID() == null && compareObj.getScreenProfileComponentID() != null)
			return false;
		if(this.getScreenProfileComponentID() != null && compareObj.getScreenProfileComponentID() == null)
			return false;
		if(this.getScreenProfileComponentID() != null && compareObj.getScreenProfileComponentID() != null)
			return this.getScreenProfileComponentID().equals(compareObj.getScreenProfileComponentID());
	...
	public Object clone()
	{
		...
		ScreeningOverviewVo clone = new ScreeningOverviewVo();
		
		clone.screenprofilecomponentid = this.screenprofilecomponentid;
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(ScreeningOverviewVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A ScreeningOverviewVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		ScreeningOverviewVo compareObj = (ScreeningOverviewVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
			...
			if(this.getScreenProfileComponentID() != null && compareObj.getScreenProfileComponentID() == null)
				return 1;
			if(this.getScreenProfileComponentID() != null && compareObj.getScreenProfileComponentID() != null)
				retVal = this.getScreenProfileComponentID().compareTo(compareObj.getScreenProfileComponentID());
		}
		return retVal;
	}
	...
	{
		int count = 0;
		if(this.screenprofilecomponentid != null)
			count++;
	...
	protected Integer screenprofilecomponentid;
