 ...
 */
public class Patient_AssessmentQuestionVo extends ims.assessment.instantiation.vo.PatientAssessmentQuestionRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public Patient_AssessmentQuestionVo()
	{
	}
	public Patient_AssessmentQuestionVo(Integer id, int version)
	{
		super(id, version);
	}
	public Patient_AssessmentQuestionVo(ims.assessment.vo.beans.Patient_AssessmentQuestionVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.assessment.vo.beans.Patient_AssessmentQuestionVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.isanswered = bean.getIsAnswered() == null ? null : ims.assessment.vo.lookups.AnswerStatus.buildLookup(bean.getIsAnswered());
	...
	{
		ims.assessment.vo.beans.Patient_AssessmentQuestionVoBean bean = null;
		if(map != null)
			bean = (ims.assessment.vo.beans.Patient_AssessmentQuestionVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.assessment.vo.beans.Patient_AssessmentQuestionVoBean();
	...
	public ims.assessment.vo.Assessment_QuestionVo getAssessmentQuestion()
	{
		return this.assessmentquestion;
	}
	public void setAssessmentQuestion(ims.assessment.vo.Assessment_QuestionVo value)
	{
		this.isValidated = false;
	...
	public Object clone()
	{
		...
		Patient_AssessmentQuestionVo clone = new Patient_AssessmentQuestionVo(this.id, this.version);
		...
		if(this.assessmentquestion == null)
			...
			clone.assessmentquestion = (ims.assessment.vo.Assessment_QuestionVo)this.assessmentquestion.clone();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(Patient_AssessmentQuestionVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A Patient_AssessmentQuestionVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		Patient_AssessmentQuestionVo compareObj = (Patient_AssessmentQuestionVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
	...
	protected ims.assessment.vo.Assessment_QuestionVo assessmentquestion;
