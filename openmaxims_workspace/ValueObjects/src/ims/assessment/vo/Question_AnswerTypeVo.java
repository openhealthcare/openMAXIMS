 ...
 */
public class Question_AnswerTypeVo extends ims.core.clinical.vo.QuestionAnswerTypeRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public Question_AnswerTypeVo()
	{
	}
	public Question_AnswerTypeVo(Integer id, int version)
	{
		super(id, version);
	}
	public Question_AnswerTypeVo(ims.assessment.vo.beans.Question_AnswerTypeVoBean bean)
	{
		this.id = bean.getId();
		...
		this.options = ims.assessment.vo.Answer_OptionVoCollection.buildFromBeanCollection(bean.getOptions());
		this.ismandatory = bean.getIsMandatory();
		this.mandatoryvalmessage = bean.getMandatoryValMessage();
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.assessment.vo.beans.Question_AnswerTypeVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.answertype = bean.getAnswerType() == null ? null : ims.core.vo.lookups.QuestionAnswerType.buildLookup(bean.getAnswerType());
	...
	{
		ims.assessment.vo.beans.Question_AnswerTypeVoBean bean = null;
		if(map != null)
			bean = (ims.assessment.vo.beans.Question_AnswerTypeVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.assessment.vo.beans.Question_AnswerTypeVoBean();
	...
	public ims.assessment.vo.Answer_OptionVoCollection getOptions()
	{
		return this.options;
	}
	public void setOptions(ims.assessment.vo.Answer_OptionVoCollection value)
	{
		this.isValidated = false;
		this.options = value;
	}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.separatortext != null)
			if(this.separatortext.length() > 70)
				listOfErrors.add("The length of the field [separatortext] in the value object [ims.assessment.vo.Question_AnswerTypeVo] is too big. It should be less or equal to 70");
		if(this.options != null)
		{
		...
		if(this.mandatoryvalmessage != null)
			if(this.mandatoryvalmessage.length() > 150)
				listOfErrors.add("The length of the field [mandatoryvalmessage] in the value object [ims.assessment.vo.Question_AnswerTypeVo] is too big. It should be less or equal to 150");
	...
	public Object clone()
	{
		...
		Question_AnswerTypeVo clone = new Question_AnswerTypeVo(this.id, this.version);
		...
		if(this.options == null)
			...
			clone.options = (ims.assessment.vo.Answer_OptionVoCollection)this.options.clone();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(Question_AnswerTypeVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A Question_AnswerTypeVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((Question_AnswerTypeVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((Question_AnswerTypeVo)obj).getBoId());
	}
	...
	protected ims.assessment.vo.Answer_OptionVoCollection options;
