 ...
 */
public class NewResultInvestigationVo extends ims.ocrr.configuration.vo.InvestigationRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public NewResultInvestigationVo()
	{
	}
	public NewResultInvestigationVo(Integer id, int version)
	{
		super(id, version);
	}
	public NewResultInvestigationVo(ims.ocrr.vo.beans.NewResultInvestigationVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.beans.NewResultInvestigationVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.ocrr.vo.beans.NewResultInvestigationVoBean bean = null;
		if(map != null)
			bean = (ims.ocrr.vo.beans.NewResultInvestigationVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.ocrr.vo.beans.NewResultInvestigationVoBean();
	...
	public ims.ocrr.vo.NewResultProvidorServiceVo getProviderService()
	{
		return this.providerservice;
	}
	public void setProviderService(ims.ocrr.vo.NewResultProvidorServiceVo value)
	{
	...
	public Object clone()
	{
		...
		NewResultInvestigationVo clone = new NewResultInvestigationVo(this.id, this.version);
		
		if(this.providerservice == null)
			clone.providerservice = null;
		else
			clone.providerservice = (ims.ocrr.vo.NewResultProvidorServiceVo)this.providerservice.clone();
		if(this.investigationindex == null)
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(NewResultInvestigationVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A NewResultInvestigationVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((NewResultInvestigationVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((NewResultInvestigationVo)obj).getBoId());
	}
	...
	protected ims.ocrr.vo.NewResultProvidorServiceVo providerservice;
