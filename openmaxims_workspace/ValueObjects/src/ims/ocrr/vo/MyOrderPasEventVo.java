 ...
 */
public class MyOrderPasEventVo extends ims.core.admin.pas.vo.PASEventRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public MyOrderPasEventVo()
	{
	}
	public MyOrderPasEventVo(Integer id, int version)
	{
		super(id, version);
	}
	public MyOrderPasEventVo(ims.ocrr.vo.beans.MyOrderPasEventVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.beans.MyOrderPasEventVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.eventdatetime = bean.getEventDateTime() == null ? null : bean.getEventDateTime().buildDateTime();
	...
	{
		ims.ocrr.vo.beans.MyOrderPasEventVoBean bean = null;
		if(map != null)
			bean = (ims.ocrr.vo.beans.MyOrderPasEventVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.ocrr.vo.beans.MyOrderPasEventVoBean();
	...
	public Object clone()
	{
		...
		MyOrderPasEventVo clone = new MyOrderPasEventVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(MyOrderPasEventVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A MyOrderPasEventVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((MyOrderPasEventVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((MyOrderPasEventVo)obj).getBoId());
	}
