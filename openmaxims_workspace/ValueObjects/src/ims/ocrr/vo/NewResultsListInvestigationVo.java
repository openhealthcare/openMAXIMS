 ...
 */
public class NewResultsListInvestigationVo extends ims.ocrr.configuration.vo.InvestigationRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public NewResultsListInvestigationVo()
	{
	}
	public NewResultsListInvestigationVo(Integer id, int version)
	{
		super(id, version);
	}
	public NewResultsListInvestigationVo(ims.ocrr.vo.beans.NewResultsListInvestigationVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.beans.NewResultsListInvestigationVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.ocrr.vo.beans.NewResultsListInvestigationVoBean bean = null;
		if(map != null)
			bean = (ims.ocrr.vo.beans.NewResultsListInvestigationVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.ocrr.vo.beans.NewResultsListInvestigationVoBean();
	...
	public ims.ocrr.vo.NewResultsListInvestigationIndexVo getInvestigationIndex()
	{
		return this.investigationindex;
	}
	public void setInvestigationIndex(ims.ocrr.vo.NewResultsListInvestigationIndexVo value)
	{
		this.isValidated = false;
	...
	public Object clone()
	{
		...
		NewResultsListInvestigationVo clone = new NewResultsListInvestigationVo(this.id, this.version);
		...
		if(this.investigationindex == null)
			...
			clone.investigationindex = (ims.ocrr.vo.NewResultsListInvestigationIndexVo)this.investigationindex.clone();
		if(this.type == null)
			clone.type = null;
		else
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(NewResultsListInvestigationVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A NewResultsListInvestigationVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((NewResultsListInvestigationVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((NewResultsListInvestigationVo)obj).getBoId());
	}
	...
	protected ims.ocrr.vo.NewResultsListInvestigationIndexVo investigationindex;
