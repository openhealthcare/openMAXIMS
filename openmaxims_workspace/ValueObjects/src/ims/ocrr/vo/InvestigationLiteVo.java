 ...
 */
public class InvestigationLiteVo extends ims.ocrr.configuration.vo.InvestigationRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public InvestigationLiteVo()
	{
	}
	public InvestigationLiteVo(Integer id, int version)
	{
		super(id, version);
	}
	public InvestigationLiteVo(ims.ocrr.vo.beans.InvestigationLiteVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.beans.InvestigationLiteVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.ocrr.vo.beans.InvestigationLiteVoBean bean = null;
		if(map != null)
			bean = (ims.ocrr.vo.beans.InvestigationLiteVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.ocrr.vo.beans.InvestigationLiteVoBean();
	...
	public ims.ocrr.vo.ProviderServiceOcsVo getProviderService()
	{
		return this.providerservice;
	}
	public void setProviderService(ims.ocrr.vo.ProviderServiceOcsVo value)
	{
		this.isValidated = false;
	...
	public Object clone()
	{
		...
		InvestigationLiteVo clone = new InvestigationLiteVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(InvestigationLiteVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A InvestigationLiteVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((InvestigationLiteVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((InvestigationLiteVo)obj).getBoId());
	}
	...
	protected ims.ocrr.vo.ProviderServiceOcsVo providerservice;
