 ...
 */
public class InvestigationShortVo extends ims.ocrr.configuration.vo.InvestigationRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public InvestigationShortVo()
	{
	}
	public InvestigationShortVo(Integer id, int version)
	{
		super(id, version);
	}
	public InvestigationShortVo(ims.ocrr.vo.beans.InvestigationShortVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.beans.InvestigationShortVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.activestatus = bean.getActiveStatus() == null ? null : ims.core.vo.lookups.PreActiveActiveInactiveStatus.buildLookup(bean.getActiveStatus());
	...
	{
		ims.ocrr.vo.beans.InvestigationShortVoBean bean = null;
		if(map != null)
			bean = (ims.ocrr.vo.beans.InvestigationShortVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.ocrr.vo.beans.InvestigationShortVoBean();
	...
	public ims.ocrr.vo.InvestigationIndexVo getInvestigationIndex()
	{
		return this.investigationindex;
	}
	public void setInvestigationIndex(ims.ocrr.vo.InvestigationIndexVo value)
	{
		this.isValidated = false;
	...
	public Object clone()
	{
		...
		InvestigationShortVo clone = new InvestigationShortVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(InvestigationShortVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A InvestigationShortVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		InvestigationShortVo compareObj = (InvestigationShortVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
	...
	protected ims.ocrr.vo.InvestigationIndexVo investigationindex;
