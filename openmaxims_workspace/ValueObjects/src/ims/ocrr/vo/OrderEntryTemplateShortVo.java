 ...
 */
public class OrderEntryTemplateShortVo extends ims.ocrr.vo.OrderEntryTemplateBaseVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public OrderEntryTemplateShortVo()
	{
	}
	public OrderEntryTemplateShortVo(Integer id, int version)
	{
		super(id, version);
	}
	public OrderEntryTemplateShortVo(ims.ocrr.vo.beans.OrderEntryTemplateShortVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.beans.OrderEntryTemplateShortVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.formname = bean.getFormName();
	...
	{
		ims.ocrr.vo.beans.OrderEntryTemplateShortVoBean bean = null;
		if(map != null)
			bean = (ims.ocrr.vo.beans.OrderEntryTemplateShortVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.ocrr.vo.beans.OrderEntryTemplateShortVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.formname == null || this.formname.length() == 0)
			...
			listOfErrors.add("The length of the field [formname] in the value object [ims.ocrr.vo.OrderEntryTemplateShortVo] is too big. It should be less or equal to 255");
		if(this.description == null || this.description.length() == 0)
			listOfErrors.add("Description is mandatory");
		else if(this.description.length() > 255)
			listOfErrors.add("The length of the field [description] in the value object [ims.ocrr.vo.OrderEntryTemplateShortVo] is too big. It should be less or equal to 255");
		if(this.templatecategory == null)
			listOfErrors.add("TemplateCategory is mandatory");
		if(this.activestatus == null)
			listOfErrors.add("ActiveStatus is mandatory");
		if(this.menuname == null || this.menuname.length() == 0)
			listOfErrors.add("MenuName is mandatory");
		else if(this.menuname.length() > 255)
			listOfErrors.add("The length of the field [menuname] in the value object [ims.ocrr.vo.OrderEntryTemplateShortVo] is too big. It should be less or equal to 255");
	...
	public Object clone()
	{
		...
		OrderEntryTemplateShortVo clone = new OrderEntryTemplateShortVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(OrderEntryTemplateShortVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A OrderEntryTemplateShortVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		OrderEntryTemplateShortVo compareObj = (OrderEntryTemplateShortVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
