 ...
 */
public class OrderedInvestigationStatusVo extends ims.ocrr.orderingresults.vo.OrderedInvestigationStatusRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public OrderedInvestigationStatusVo()
	{
	}
	public OrderedInvestigationStatusVo(Integer id, int version)
	{
		super(id, version);
	}
	public OrderedInvestigationStatusVo(ims.ocrr.vo.beans.OrderedInvestigationStatusVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.beans.OrderedInvestigationStatusVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.ordinvstatus = bean.getOrdInvStatus() == null ? null : ims.ocrr.vo.lookups.OrderInvStatus.buildLookup(bean.getOrdInvStatus());
	...
	{
		ims.ocrr.vo.beans.OrderedInvestigationStatusVoBean bean = null;
		if(map != null)
			bean = (ims.ocrr.vo.beans.OrderedInvestigationStatusVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.ocrr.vo.beans.OrderedInvestigationStatusVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.changeuser != null)
			if(this.changeuser.length() > 255)
				listOfErrors.add("The length of the field [changeuser] in the value object [ims.ocrr.vo.OrderedInvestigationStatusVo] is too big. It should be less or equal to 255");
		if(this.statusreason != null)
			if(this.statusreason.length() > 500)
				listOfErrors.add("The length of the field [statusreason] in the value object [ims.ocrr.vo.OrderedInvestigationStatusVo] is too big. It should be less or equal to 500");
	...
	public Object clone()
	{
		...
		OrderedInvestigationStatusVo clone = new OrderedInvestigationStatusVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(OrderedInvestigationStatusVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A OrderedInvestigationStatusVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		OrderedInvestigationStatusVo compareObj = (OrderedInvestigationStatusVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
