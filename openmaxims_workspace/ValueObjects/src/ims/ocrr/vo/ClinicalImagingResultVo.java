 ...
 */
public class ClinicalImagingResultVo extends ims.ocrr.orderingresults.vo.OrderInvestigationRefVo implements ims.vo.ImsCloneable, Comparable, ims.vo.interfaces.IOrderResultDisplay
{
	private static final long serialVersionUID = 1L;

	public ClinicalImagingResultVo()
	{
	}
	public ClinicalImagingResultVo(Integer id, int version)
	{
		super(id, version);
	}
	public ClinicalImagingResultVo(ims.ocrr.vo.beans.ClinicalImagingResultVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.beans.ClinicalImagingResultVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.ocrr.vo.beans.ClinicalImagingResultVoBean bean = null;
		if(map != null)
			bean = (ims.ocrr.vo.beans.ClinicalImagingResultVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.ocrr.vo.beans.ClinicalImagingResultVoBean();
	...
	public ims.ocrr.vo.ResultDetailsForClinicalImagingResultVo getResultDetails()
	{
		return this.resultdetails;
	}
	public void setResultDetails(ims.ocrr.vo.ResultDetailsForClinicalImagingResultVo value)
	{
		this.isValidated = false;
	...
	*/
	...
	public ims.ocrr.vo.RadResultDetailsVo getIOrderResultDisplayRadResultDetails()
	{
		if (resultdetails != null)
			return resultdetails.getClinicalResultDetails();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.fillerordnum != null)
			if(this.fillerordnum.length() > 20)
				listOfErrors.add("The length of the field [fillerordnum] in the value object [ims.ocrr.vo.ClinicalImagingResultVo] is too big. It should be less or equal to 20");
		if(this.requestedlocation != null)
		{
	...
	public Object clone()
	{
		...
		ClinicalImagingResultVo clone = new ClinicalImagingResultVo(this.id, this.version);
		...
		if(this.resultdetails == null)
			...
			clone.resultdetails = (ims.ocrr.vo.ResultDetailsForClinicalImagingResultVo)this.resultdetails.clone();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(ClinicalImagingResultVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A ClinicalImagingResultVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((ClinicalImagingResultVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((ClinicalImagingResultVo)obj).getBoId());
	}
	...
	protected ims.ocrr.vo.ResultDetailsForClinicalImagingResultVo resultdetails;
