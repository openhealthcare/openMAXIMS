...
public class HelpTextVoCollection extends ims.vo.ValueObjectCollection implements ims.vo.ImsCloneable, Iterable<HelpTextVo>
{
	...
	public ims.ocrr.vo.beans.HelpTextVoBean[] getBeanCollection()
	{
		return getBeanCollectionArray();
	}
	public ims.ocrr.vo.beans.HelpTextVoBean[] getBeanCollectionArray()
	{
		ims.ocrr.vo.beans.HelpTextVoBean[] result = new ims.ocrr.vo.beans.HelpTextVoBean[col.size()];
		for(int i = 0; i < col.size(); i++)
		{
			HelpTextVo vo = ((HelpTextVo)col.get(i));
			result[i] = (ims.ocrr.vo.beans.HelpTextVoBean)vo.getBean();
		}
		return result;
	}
	public static HelpTextVoCollection buildFromBeanCollection(java.util.Collection beans)
	{
		...
		while (iter.hasNext())
		{
			coll.add(((ims.ocrr.vo.beans.HelpTextVoBean)iter.next()).buildVo());
		}
		return coll;
	}
	public static HelpTextVoCollection buildFromBeanCollection(ims.ocrr.vo.beans.HelpTextVoBean[] beans)
	{
		HelpTextVoCollection coll = new HelpTextVoCollection();
		if(beans == null)
			return coll;
