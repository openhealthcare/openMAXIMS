 ...
 */
public class RadiologyOrderVo extends ims.ocrr.orderingresults.vo.OrderInvestigationRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public RadiologyOrderVo()
	{
	}
	public RadiologyOrderVo(Integer id, int version)
	{
		super(id, version);
	}
	public RadiologyOrderVo(ims.ocrr.vo.beans.RadiologyOrderVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.beans.RadiologyOrderVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.ocrr.vo.beans.RadiologyOrderVoBean bean = null;
		if(map != null)
			bean = (ims.ocrr.vo.beans.RadiologyOrderVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.ocrr.vo.beans.RadiologyOrderVoBean();
	...
	public Object clone()
	{
		...
		RadiologyOrderVo clone = new RadiologyOrderVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(RadiologyOrderVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A RadiologyOrderVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		RadiologyOrderVo compareObj = (RadiologyOrderVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
