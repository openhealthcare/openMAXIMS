 ...
 */
public class InvestigationIndexLiteVo extends ims.ocrr.configuration.vo.InvestigationIndexRefVo implements ims.vo.ImsCloneable, Comparable, ims.vo.interfaces.IGenericItemType
{
	private static final long serialVersionUID = 1L;

	public InvestigationIndexLiteVo()
	{
	}
	public InvestigationIndexLiteVo(Integer id, int version)
	{
		super(id, version);
	}
	public InvestigationIndexLiteVo(ims.ocrr.vo.beans.InvestigationIndexLiteVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.beans.InvestigationIndexLiteVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.name = bean.getName();
	...
	{
		ims.ocrr.vo.beans.InvestigationIndexLiteVoBean bean = null;
		if(map != null)
			bean = (ims.ocrr.vo.beans.InvestigationIndexLiteVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.ocrr.vo.beans.InvestigationIndexLiteVoBean();
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("TIMESERIESINSTRUCTIONSURL"))
			return getTimeSeriesInstructionsURL();
	...
	public boolean getTimeSeriesInstructionsURLIsNotNull()
	{
		return this.timeseriesinstructionsurl != null;
	}
	public String getTimeSeriesInstructionsURL()
	{
		return this.timeseriesinstructionsurl;
	}
	public static int getTimeSeriesInstructionsURLMaxLength()
	{
		return 200;
	}
	...
	*/
		...
		{
			return ims.core.vo.enums.SelectItemType.INVINDEX;
		}
		...
		{
			return this.name != null ? this.name : "<name is null>";
		}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.name == null || this.name.length() == 0)
			...
			listOfErrors.add("The length of the field [name] in the value object [ims.ocrr.vo.InvestigationIndexLiteVo] is too big. It should be less or equal to 200");
		...
		if(this.timeseriesinstructionsurl != null)
			if(this.timeseriesinstructionsurl.length() > 200)
				listOfErrors.add("The length of the field [timeseriesinstructionsurl] in the value object [ims.ocrr.vo.InvestigationIndexLiteVo] is too big. It should be less or equal to 200");
	...
	public Object clone()
	{
		...
		InvestigationIndexLiteVo clone = new InvestigationIndexLiteVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(InvestigationIndexLiteVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A InvestigationIndexLiteVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((InvestigationIndexLiteVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((InvestigationIndexLiteVo)obj).getBoId());
	}
	...
	protected String timeseriesinstructionsurl;
