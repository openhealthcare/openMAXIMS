 ...
 */
public class SpecimenWorkListItemVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.ocrr.vo.SpecimenWorkListItemVo copy(ims.ocrr.vo.SpecimenWorkListItemVo valueObjectDest, ims.ocrr.vo.SpecimenWorkListItemVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createSpecimenWorkListItemVoCollectionFromSpecimenWorkListItem(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.ocrr.orderingresults.domain.objects.SpecimenWorkListItem objects.
	 */
	public static ims.ocrr.vo.SpecimenWorkListItemVoCollection createSpecimenWorkListItemVoCollectionFromSpecimenWorkListItem(java.util.Set domainObjectSet)	
	{
		return createSpecimenWorkListItemVoCollectionFromSpecimenWorkListItem(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.ocrr.orderingresults.domain.objects.SpecimenWorkListItem objects.
	 */
	public static ims.ocrr.vo.SpecimenWorkListItemVoCollection createSpecimenWorkListItemVoCollectionFromSpecimenWorkListItem(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.ocrr.vo.SpecimenWorkListItemVoCollection voList = new ims.ocrr.vo.SpecimenWorkListItemVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.ocrr.vo.SpecimenWorkListItemVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.ocrr.vo.SpecimenWorkListItemVoCollection createSpecimenWorkListItemVoCollectionFromSpecimenWorkListItem(java.util.List domainObjectList) 
	{
		return createSpecimenWorkListItemVoCollectionFromSpecimenWorkListItem(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.ocrr.orderingresults.domain.objects.SpecimenWorkListItem objects.
	 */
	public static ims.ocrr.vo.SpecimenWorkListItemVoCollection createSpecimenWorkListItemVoCollectionFromSpecimenWorkListItem(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.ocrr.vo.SpecimenWorkListItemVoCollection voList = new ims.ocrr.vo.SpecimenWorkListItemVoCollection();
	 ...
	 */
	 public static java.util.Set extractSpecimenWorkListItemSet(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.SpecimenWorkListItemVoCollection voCollection) 
	 {
	 	return extractSpecimenWorkListItemSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractSpecimenWorkListItemSet(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.SpecimenWorkListItemVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.ocrr.vo.SpecimenWorkListItemVo vo = voCollection.get(i);
			ims.ocrr.orderingresults.domain.objects.SpecimenWorkListItem domainObject = SpecimenWorkListItemVoAssembler.extractSpecimenWorkListItem(domainFactory, vo, domMap);
	 ...
	 */
	 ...
	 public static java.util.List extractSpecimenWorkListItemList(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.SpecimenWorkListItemVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.ocrr.vo.SpecimenWorkListItemVo create(ims.ocrr.orderingresults.domain.objects.SpecimenWorkListItem domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.ocrr.vo.SpecimenWorkListItemVo create(DomainObjectMap map, ims.ocrr.orderingresults.domain.objects.SpecimenWorkListItem domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.ocrr.vo.SpecimenWorkListItemVo valueObject = (ims.ocrr.vo.SpecimenWorkListItemVo) map.getValueObject(domainObject, ims.ocrr.vo.SpecimenWorkListItemVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.ocrr.vo.SpecimenWorkListItemVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.ocrr.orderingresults.domain.objects.SpecimenWorkListItem
	 */
	 public static ims.ocrr.vo.SpecimenWorkListItemVo insert(ims.ocrr.vo.SpecimenWorkListItemVo valueObject, ims.ocrr.orderingresults.domain.objects.SpecimenWorkListItem domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.ocrr.orderingresults.domain.objects.SpecimenWorkListItem
	 */
	 public static ims.ocrr.vo.SpecimenWorkListItemVo insert(DomainObjectMap map, ims.ocrr.vo.SpecimenWorkListItemVo valueObject, ims.ocrr.orderingresults.domain.objects.SpecimenWorkListItem domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		if ( null != instance6 ) {
			...
			valueObject.setCollectionStatus(voLookup6);
				...
				// DFTOrderInvestigation
		if (domainObject.getDFTOrderInvestigation() != null)
		{
			if(domainObject.getDFTOrderInvestigation() instanceof HibernateProxy) // If the proxy is set, there is no need to lazy load, the proxy knows the id already. 
			{
				HibernateProxy p = (HibernateProxy) domainObject.getDFTOrderInvestigation();
				int id = Integer.parseInt(p.getHibernateLazyInitializer().getIdentifier().toString());				
				valueObject.setDFTOrderInvestigation(new ims.ocrr.orderingresults.vo.OrderInvestigationRefVo(id, -1));				
			}
			else
			{
				valueObject.setDFTOrderInvestigation(new ims.ocrr.orderingresults.vo.OrderInvestigationRefVo(domainObject.getDFTOrderInvestigation().getId(), domainObject.getDFTOrderInvestigation().getVersion()));
			}
		}
 		return valueObject;
	 }
	 ...
	 */
	public static ims.ocrr.orderingresults.domain.objects.SpecimenWorkListItem extractSpecimenWorkListItem(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.SpecimenWorkListItemVo valueObject) 
	{
		return 	extractSpecimenWorkListItem(domainFactory, valueObject, new HashMap());
	}

	public static ims.ocrr.orderingresults.domain.objects.SpecimenWorkListItem extractSpecimenWorkListItem(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.SpecimenWorkListItemVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.ocrr.vo.SpecimenWorkListItemVo ID_SpecimenWorkListItem field is unknown
		...
		ims.ocrr.orderingresults.domain.objects.OrderSpecimen value1 = null;
		if ( null != valueObject.getSpecimen() ) 
		{
			if (valueObject.getSpecimen().getBoId() == null)
			{
				...
				{
					value1 = (ims.ocrr.orderingresults.domain.objects.OrderSpecimen)domMap.get(valueObject.getSpecimen());
				}
			}
			else if (valueObject.getBoVersion() == -1) // RefVo was not modified since obtained from the Assembler, no need to update the BO field
			{
				value1 = domainObject.getSpecimen();	
			}
			else
			{
				value1 = (ims.ocrr.orderingresults.domain.objects.OrderSpecimen)domainFactory.getDomainObject(ims.ocrr.orderingresults.domain.objects.OrderSpecimen.class, valueObject.getSpecimen().getBoId());
			}
		}
		domainObject.setSpecimen(value1);
		...
		ims.ocrr.orderingresults.domain.objects.OrderInvestigation value7 = null;
		if ( null != valueObject.getDFTOrderInvestigation() ) 
		{
			if (valueObject.getDFTOrderInvestigation().getBoId() == null)
			{
				...
				{
					value7 = (ims.ocrr.orderingresults.domain.objects.OrderInvestigation)domMap.get(valueObject.getDFTOrderInvestigation());
				}
			}
			else if (valueObject.getBoVersion() == -1) // RefVo was not modified since obtained from the Assembler, no need to update the BO field
			{
				value7 = domainObject.getDFTOrderInvestigation();	
			}
			else
			{
				value7 = (ims.ocrr.orderingresults.domain.objects.OrderInvestigation)domainFactory.getDomainObject(ims.ocrr.orderingresults.domain.objects.OrderInvestigation.class, valueObject.getDFTOrderInvestigation().getBoId());
			}
		}
		domainObject.setDFTOrderInvestigation(value7);
