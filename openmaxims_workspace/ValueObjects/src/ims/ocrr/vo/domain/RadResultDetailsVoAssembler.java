 ...
 */
public class RadResultDetailsVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.ocrr.vo.RadResultDetailsVo copy(ims.ocrr.vo.RadResultDetailsVo valueObjectDest, ims.ocrr.vo.RadResultDetailsVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createRadResultDetailsVoCollectionFromClinicalResultDetail(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.ocrr.orderingresults.domain.objects.ClinicalResultDetail objects.
	 */
	public static ims.ocrr.vo.RadResultDetailsVoCollection createRadResultDetailsVoCollectionFromClinicalResultDetail(java.util.Set domainObjectSet)	
	{
		return createRadResultDetailsVoCollectionFromClinicalResultDetail(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.ocrr.orderingresults.domain.objects.ClinicalResultDetail objects.
	 */
	public static ims.ocrr.vo.RadResultDetailsVoCollection createRadResultDetailsVoCollectionFromClinicalResultDetail(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.ocrr.vo.RadResultDetailsVoCollection voList = new ims.ocrr.vo.RadResultDetailsVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.ocrr.vo.RadResultDetailsVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.ocrr.vo.RadResultDetailsVoCollection createRadResultDetailsVoCollectionFromClinicalResultDetail(java.util.List domainObjectList) 
	{
		return createRadResultDetailsVoCollectionFromClinicalResultDetail(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.ocrr.orderingresults.domain.objects.ClinicalResultDetail objects.
	 */
	public static ims.ocrr.vo.RadResultDetailsVoCollection createRadResultDetailsVoCollectionFromClinicalResultDetail(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.ocrr.vo.RadResultDetailsVoCollection voList = new ims.ocrr.vo.RadResultDetailsVoCollection();
	 ...
	 */
	 public static java.util.Set extractClinicalResultDetailSet(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.RadResultDetailsVoCollection voCollection) 
	 {
	 	return extractClinicalResultDetailSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractClinicalResultDetailSet(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.RadResultDetailsVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.ocrr.vo.RadResultDetailsVo vo = voCollection.get(i);
			ims.ocrr.orderingresults.domain.objects.ClinicalResultDetail domainObject = RadResultDetailsVoAssembler.extractClinicalResultDetail(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractClinicalResultDetailList(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.RadResultDetailsVoCollection voCollection) 
	 {
	 	return extractClinicalResultDetailList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractClinicalResultDetailList(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.RadResultDetailsVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.ocrr.vo.RadResultDetailsVo create(ims.ocrr.orderingresults.domain.objects.ClinicalResultDetail domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.ocrr.vo.RadResultDetailsVo create(DomainObjectMap map, ims.ocrr.orderingresults.domain.objects.ClinicalResultDetail domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.ocrr.vo.RadResultDetailsVo valueObject = (ims.ocrr.vo.RadResultDetailsVo) map.getValueObject(domainObject, ims.ocrr.vo.RadResultDetailsVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.ocrr.vo.RadResultDetailsVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.ocrr.orderingresults.domain.objects.ClinicalResultDetail
	 */
	 public static ims.ocrr.vo.RadResultDetailsVo insert(ims.ocrr.vo.RadResultDetailsVo valueObject, ims.ocrr.orderingresults.domain.objects.ClinicalResultDetail domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.ocrr.orderingresults.domain.objects.ClinicalResultDetail
	 */
	 public static ims.ocrr.vo.RadResultDetailsVo insert(DomainObjectMap map, ims.ocrr.vo.RadResultDetailsVo valueObject, ims.ocrr.orderingresults.domain.objects.ClinicalResultDetail domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.ocrr.orderingresults.domain.objects.ClinicalResultDetail extractClinicalResultDetail(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.RadResultDetailsVo valueObject) 
	{
		return 	extractClinicalResultDetail(domainFactory, valueObject, new HashMap());
	}

	public static ims.ocrr.orderingresults.domain.objects.ClinicalResultDetail extractClinicalResultDetail(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.RadResultDetailsVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.ocrr.vo.RadResultDetailsVo ID_ClinicalResultDetail field is unknown
		...
		ims.framework.utils.DateTime dateTime6 = valueObject.getExamDateTime();
		java.util.Date value6 = null;
		if ( dateTime6 != null ) 
		{
			value6 = dateTime6.getJavaDate();
		}
		domainObject.setExamDateTime(value6);
