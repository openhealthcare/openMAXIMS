 ...
 */
public class NewResultsListOrderDetailsVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.ocrr.vo.NewResultsListOrderDetailsVo copy(ims.ocrr.vo.NewResultsListOrderDetailsVo valueObjectDest, ims.ocrr.vo.NewResultsListOrderDetailsVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createNewResultsListOrderDetailsVoCollectionFromOcsOrderSession(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.ocrr.orderingresults.domain.objects.OcsOrderSession objects.
	 */
	public static ims.ocrr.vo.NewResultsListOrderDetailsVoCollection createNewResultsListOrderDetailsVoCollectionFromOcsOrderSession(java.util.Set domainObjectSet)	
	{
		return createNewResultsListOrderDetailsVoCollectionFromOcsOrderSession(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.ocrr.orderingresults.domain.objects.OcsOrderSession objects.
	 */
	public static ims.ocrr.vo.NewResultsListOrderDetailsVoCollection createNewResultsListOrderDetailsVoCollectionFromOcsOrderSession(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.ocrr.vo.NewResultsListOrderDetailsVoCollection voList = new ims.ocrr.vo.NewResultsListOrderDetailsVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.ocrr.vo.NewResultsListOrderDetailsVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.ocrr.vo.NewResultsListOrderDetailsVoCollection createNewResultsListOrderDetailsVoCollectionFromOcsOrderSession(java.util.List domainObjectList) 
	{
		return createNewResultsListOrderDetailsVoCollectionFromOcsOrderSession(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.ocrr.orderingresults.domain.objects.OcsOrderSession objects.
	 */
	public static ims.ocrr.vo.NewResultsListOrderDetailsVoCollection createNewResultsListOrderDetailsVoCollectionFromOcsOrderSession(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.ocrr.vo.NewResultsListOrderDetailsVoCollection voList = new ims.ocrr.vo.NewResultsListOrderDetailsVoCollection();
	 ...
	 */
	 public static java.util.Set extractOcsOrderSessionSet(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.NewResultsListOrderDetailsVoCollection voCollection) 
	 {
	 	return extractOcsOrderSessionSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractOcsOrderSessionSet(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.NewResultsListOrderDetailsVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.ocrr.vo.NewResultsListOrderDetailsVo vo = voCollection.get(i);
			ims.ocrr.orderingresults.domain.objects.OcsOrderSession domainObject = NewResultsListOrderDetailsVoAssembler.extractOcsOrderSession(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractOcsOrderSessionList(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.NewResultsListOrderDetailsVoCollection voCollection) 
	 {
	 	return extractOcsOrderSessionList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractOcsOrderSessionList(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.NewResultsListOrderDetailsVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.ocrr.vo.NewResultsListOrderDetailsVo create(ims.ocrr.orderingresults.domain.objects.OcsOrderSession domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.ocrr.vo.NewResultsListOrderDetailsVo create(DomainObjectMap map, ims.ocrr.orderingresults.domain.objects.OcsOrderSession domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.ocrr.vo.NewResultsListOrderDetailsVo valueObject = (ims.ocrr.vo.NewResultsListOrderDetailsVo) map.getValueObject(domainObject, ims.ocrr.vo.NewResultsListOrderDetailsVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.ocrr.vo.NewResultsListOrderDetailsVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.ocrr.orderingresults.domain.objects.OcsOrderSession
	 */
	 public static ims.ocrr.vo.NewResultsListOrderDetailsVo insert(ims.ocrr.vo.NewResultsListOrderDetailsVo valueObject, ims.ocrr.orderingresults.domain.objects.OcsOrderSession domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.ocrr.orderingresults.domain.objects.OcsOrderSession
	 */
	 public static ims.ocrr.vo.NewResultsListOrderDetailsVo insert(DomainObjectMap map, ims.ocrr.vo.NewResultsListOrderDetailsVo valueObject, ims.ocrr.orderingresults.domain.objects.OcsOrderSession domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.ocrr.orderingresults.domain.objects.OcsOrderSession extractOcsOrderSession(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.NewResultsListOrderDetailsVo valueObject) 
	{
		return 	extractOcsOrderSession(domainFactory, valueObject, new HashMap());
	}

	public static ims.ocrr.orderingresults.domain.objects.OcsOrderSession extractOcsOrderSession(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.NewResultsListOrderDetailsVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.ocrr.vo.NewResultsListOrderDetailsVo ID_OcsOrderSession field is unknown
	...
	ims.core.resource.place.domain.objects.Location value2 = null;
		if ( null != valueObject.getPatientLocation() ) 
		{
			if (valueObject.getPatientLocation().getBoId() == null)
			{
				...
				{
					value2 = (ims.core.resource.place.domain.objects.Location)domMap.get(valueObject.getPatientLocation());
				}
			}
			else
			{
				value2 = (ims.core.resource.place.domain.objects.Location)domainFactory.getDomainObject(ims.core.resource.place.domain.objects.Location.class, valueObject.getPatientLocation().getBoId());
			}
		}
		domainObject.setPatientLocation(value2);
	// SaveAsRefVO - treated as a refVo in extract methods
	ims.core.resource.place.domain.objects.Clinic value3 = null;
		if ( null != valueObject.getPatientClinic() ) 
		{
			if (valueObject.getPatientClinic().getBoId() == null)
			{
				...
				{
					value3 = (ims.core.resource.place.domain.objects.Clinic)domMap.get(valueObject.getPatientClinic());
				}
			}
			else
			{
				value3 = (ims.core.resource.place.domain.objects.Clinic)domainFactory.getDomainObject(ims.core.resource.place.domain.objects.Clinic.class, valueObject.getPatientClinic().getBoId());
			}
		}
		domainObject.setPatientClinic(value3);
	// SaveAsRefVO - treated as a refVo in extract methods
