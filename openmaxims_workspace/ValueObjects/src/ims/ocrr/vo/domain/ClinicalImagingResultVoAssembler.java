 ...
 */
public class ClinicalImagingResultVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.ocrr.vo.ClinicalImagingResultVo copy(ims.ocrr.vo.ClinicalImagingResultVo valueObjectDest, ims.ocrr.vo.ClinicalImagingResultVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createClinicalImagingResultVoCollectionFromOrderInvestigation(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.ocrr.orderingresults.domain.objects.OrderInvestigation objects.
	 */
	public static ims.ocrr.vo.ClinicalImagingResultVoCollection createClinicalImagingResultVoCollectionFromOrderInvestigation(java.util.Set domainObjectSet)	
	{
		return createClinicalImagingResultVoCollectionFromOrderInvestigation(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.ocrr.orderingresults.domain.objects.OrderInvestigation objects.
	 */
	public static ims.ocrr.vo.ClinicalImagingResultVoCollection createClinicalImagingResultVoCollectionFromOrderInvestigation(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.ocrr.vo.ClinicalImagingResultVoCollection voList = new ims.ocrr.vo.ClinicalImagingResultVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.ocrr.vo.ClinicalImagingResultVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.ocrr.vo.ClinicalImagingResultVoCollection createClinicalImagingResultVoCollectionFromOrderInvestigation(java.util.List domainObjectList) 
	{
		return createClinicalImagingResultVoCollectionFromOrderInvestigation(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.ocrr.orderingresults.domain.objects.OrderInvestigation objects.
	 */
	public static ims.ocrr.vo.ClinicalImagingResultVoCollection createClinicalImagingResultVoCollectionFromOrderInvestigation(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.ocrr.vo.ClinicalImagingResultVoCollection voList = new ims.ocrr.vo.ClinicalImagingResultVoCollection();
	 ...
	 */
	 public static java.util.Set extractOrderInvestigationSet(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.ClinicalImagingResultVoCollection voCollection) 
	 {
	 	return extractOrderInvestigationSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractOrderInvestigationSet(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.ClinicalImagingResultVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.ocrr.vo.ClinicalImagingResultVo vo = voCollection.get(i);
			ims.ocrr.orderingresults.domain.objects.OrderInvestigation domainObject = ClinicalImagingResultVoAssembler.extractOrderInvestigation(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractOrderInvestigationList(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.ClinicalImagingResultVoCollection voCollection) 
	 {
	 	return extractOrderInvestigationList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractOrderInvestigationList(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.ClinicalImagingResultVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.ocrr.vo.ClinicalImagingResultVo create(ims.ocrr.orderingresults.domain.objects.OrderInvestigation domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.ocrr.vo.ClinicalImagingResultVo create(DomainObjectMap map, ims.ocrr.orderingresults.domain.objects.OrderInvestigation domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.ocrr.vo.ClinicalImagingResultVo valueObject = (ims.ocrr.vo.ClinicalImagingResultVo) map.getValueObject(domainObject, ims.ocrr.vo.ClinicalImagingResultVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.ocrr.vo.ClinicalImagingResultVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.ocrr.orderingresults.domain.objects.OrderInvestigation
	 */
	 public static ims.ocrr.vo.ClinicalImagingResultVo insert(ims.ocrr.vo.ClinicalImagingResultVo valueObject, ims.ocrr.orderingresults.domain.objects.OrderInvestigation domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.ocrr.orderingresults.domain.objects.OrderInvestigation
	 */
	 public static ims.ocrr.vo.ClinicalImagingResultVo insert(DomainObjectMap map, ims.ocrr.vo.ClinicalImagingResultVo valueObject, ims.ocrr.orderingresults.domain.objects.OrderInvestigation domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// OrderDetails
		valueObject.setOrderDetails(ims.ocrr.vo.domain.NewResultOcsOrderVoAssembler.create(map, domainObject.getOrderDetails()) );
		// ResultDemographics
		...
		if ( null != instance6 ) {
			...
			valueObject.setResultStatus(voLookup6);
				...
				// DisplayFlag
		ims.domain.lookups.LookupInstance instance7 = domainObject.getDisplayFlag();
		if ( null != instance7 ) {
			ims.framework.utils.ImagePath img = null;
			ims.framework.utils.Color color = null;		
			img = null;
			...
			ims.ocrr.vo.lookups.OcsDisplayFlag voLookup7 = new ims.ocrr.vo.lookups.OcsDisplayFlag(instance7.getId(),instance7.getText(), instance7.isActive(), null, img, color);
			ims.ocrr.vo.lookups.OcsDisplayFlag parentVoLookup7 = voLookup7;
			...
			while (parent7 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup7.setParent(new ims.ocrr.vo.lookups.OcsDisplayFlag(parent7.getId(),parent7.getText(), parent7.isActive(), null, img, color));
				parentVoLookup7 = parentVoLookup7.getParent();
								parent7 = parent7.getParent();
			}			
			valueObject.setDisplayFlag(voLookup7);
		}
				// OrdInvCurrentStatus
		...
		// ResultDetails
		valueObject.setResultDetails(ims.ocrr.vo.domain.ResultDetailsForClinicalImagingResultVoAssembler.create(map, domainObject.getResultDetails()) );
 		return valueObject;
	 }
	 ...
	 */
	public static ims.ocrr.orderingresults.domain.objects.OrderInvestigation extractOrderInvestigation(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.ClinicalImagingResultVo valueObject) 
	{
		return 	extractOrderInvestigation(domainFactory, valueObject, new HashMap());
	}

	public static ims.ocrr.orderingresults.domain.objects.OrderInvestigation extractOrderInvestigation(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.ClinicalImagingResultVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.ocrr.vo.ClinicalImagingResultVo ID_OrderInvestigation field is unknown
		...
		domainObject.setOrderDetails(ims.ocrr.vo.domain.NewResultOcsOrderVoAssembler.extractOcsOrderSession(domainFactory, valueObject.getOrderDetails(), domMap));
		...
		domainObject.setDisplayFlag(value7);
		...
		domainObject.setResultDetails(ims.ocrr.vo.domain.ResultDetailsForClinicalImagingResultVoAssembler.extractResultDetails(domainFactory, valueObject.getResultDetails(), domMap));
