 ...
 */
public class PathologySpecimenLiteVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.ocrr.vo.PathologySpecimenLiteVo copy(ims.ocrr.vo.PathologySpecimenLiteVo valueObjectDest, ims.ocrr.vo.PathologySpecimenLiteVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createPathologySpecimenLiteVoCollectionFromOrderSpecimen(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.ocrr.orderingresults.domain.objects.OrderSpecimen objects.
	 */
	public static ims.ocrr.vo.PathologySpecimenLiteVoCollection createPathologySpecimenLiteVoCollectionFromOrderSpecimen(java.util.Set domainObjectSet)	
	{
		return createPathologySpecimenLiteVoCollectionFromOrderSpecimen(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.ocrr.orderingresults.domain.objects.OrderSpecimen objects.
	 */
	public static ims.ocrr.vo.PathologySpecimenLiteVoCollection createPathologySpecimenLiteVoCollectionFromOrderSpecimen(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.ocrr.vo.PathologySpecimenLiteVoCollection voList = new ims.ocrr.vo.PathologySpecimenLiteVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.ocrr.vo.PathologySpecimenLiteVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.ocrr.vo.PathologySpecimenLiteVoCollection createPathologySpecimenLiteVoCollectionFromOrderSpecimen(java.util.List domainObjectList) 
	{
		return createPathologySpecimenLiteVoCollectionFromOrderSpecimen(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.ocrr.orderingresults.domain.objects.OrderSpecimen objects.
	 */
	public static ims.ocrr.vo.PathologySpecimenLiteVoCollection createPathologySpecimenLiteVoCollectionFromOrderSpecimen(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.ocrr.vo.PathologySpecimenLiteVoCollection voList = new ims.ocrr.vo.PathologySpecimenLiteVoCollection();
	 ...
	 */
	 ...
	 public static java.util.Set extractOrderSpecimenSet(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.PathologySpecimenLiteVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.ocrr.vo.PathologySpecimenLiteVo vo = voCollection.get(i);
			ims.ocrr.orderingresults.domain.objects.OrderSpecimen domainObject = PathologySpecimenLiteVoAssembler.extractOrderSpecimen(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractOrderSpecimenList(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.PathologySpecimenLiteVoCollection voCollection) 
	 {
	 	return extractOrderSpecimenList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractOrderSpecimenList(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.PathologySpecimenLiteVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.ocrr.vo.PathologySpecimenLiteVo create(ims.ocrr.orderingresults.domain.objects.OrderSpecimen domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.ocrr.vo.PathologySpecimenLiteVo create(DomainObjectMap map, ims.ocrr.orderingresults.domain.objects.OrderSpecimen domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.ocrr.vo.PathologySpecimenLiteVo valueObject = (ims.ocrr.vo.PathologySpecimenLiteVo) map.getValueObject(domainObject, ims.ocrr.vo.PathologySpecimenLiteVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.ocrr.vo.PathologySpecimenLiteVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.ocrr.orderingresults.domain.objects.OrderSpecimen
	 */
	 public static ims.ocrr.vo.PathologySpecimenLiteVo insert(ims.ocrr.vo.PathologySpecimenLiteVo valueObject, ims.ocrr.orderingresults.domain.objects.OrderSpecimen domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.ocrr.orderingresults.domain.objects.OrderSpecimen
	 */
	 public static ims.ocrr.vo.PathologySpecimenLiteVo insert(DomainObjectMap map, ims.ocrr.vo.PathologySpecimenLiteVo valueObject, ims.ocrr.orderingresults.domain.objects.OrderSpecimen domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.ocrr.orderingresults.domain.objects.OrderSpecimen extractOrderSpecimen(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.PathologySpecimenLiteVo valueObject) 
	{
		return 	extractOrderSpecimen(domainFactory, valueObject, new HashMap());
	}

	public static ims.ocrr.orderingresults.domain.objects.OrderSpecimen extractOrderSpecimen(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.PathologySpecimenLiteVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.ocrr.vo.PathologySpecimenLiteVo ID_OrderSpecimen field is unknown
		...
		ims.ocrr.orderingresults.vo.ResultConclusionAndActionCommentRefVoCollection refCollection3 = new ims.ocrr.orderingresults.vo.ResultConclusionAndActionCommentRefVoCollection();
		if (valueObject.getResultConclusionComments() != null)
		{
			for (int i3=0; i3<valueObject.getResultConclusionComments().size(); i3++)
			{
				ims.ocrr.orderingresults.vo.ResultConclusionAndActionCommentRefVo ref3 = (ims.ocrr.orderingresults.vo.ResultConclusionAndActionCommentRefVo)valueObject.getResultConclusionComments().get(i3);
				refCollection3.add(ref3);
			}
		}
		int size3 = (null == refCollection3) ? 0 : refCollection3.size();		
		java.util.Set domainResultConclusionComments3 = domainObject.getResultConclusionComments();
		if (domainResultConclusionComments3 == null)
		{
			domainResultConclusionComments3 = new java.util.HashSet();
		}
		java.util.Set newSet3  = new java.util.HashSet();
		for(int i=0; i<size3; i++) 
		{
			ims.ocrr.orderingresults.vo.ResultConclusionAndActionCommentRefVo vo = refCollection3.get(i);					
			...
			//Trying to avoid the hibernate collection being marked as dirty via its public interface methods. (like add)
			if (!domainResultConclusionComments3.contains(dom))
			{
				domainResultConclusionComments3.add(dom);
			}
			newSet3.add(dom);			
		}
		java.util.Set removedSet3 = new java.util.HashSet();
		java.util.Iterator iter3 = domainResultConclusionComments3.iterator();
		//Find out which objects need to be removed
		while (iter3.hasNext())
		{
		...
		while (iter3.hasNext())
		{
			domainResultConclusionComments3.remove(iter3.next());
		}		
		
		domainObject.setResultConclusionComments(domainResultConclusionComments3);		
