 ...
 */
public class PathologyResultShortVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.ocrr.vo.PathologyResultShortVo copy(ims.ocrr.vo.PathologyResultShortVo valueObjectDest, ims.ocrr.vo.PathologyResultShortVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createPathologyResultShortVoCollectionFromOrderInvestigation(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.ocrr.orderingresults.domain.objects.OrderInvestigation objects.
	 */
	public static ims.ocrr.vo.PathologyResultShortVoCollection createPathologyResultShortVoCollectionFromOrderInvestigation(java.util.Set domainObjectSet)	
	{
		return createPathologyResultShortVoCollectionFromOrderInvestigation(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.ocrr.orderingresults.domain.objects.OrderInvestigation objects.
	 */
	public static ims.ocrr.vo.PathologyResultShortVoCollection createPathologyResultShortVoCollectionFromOrderInvestigation(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.ocrr.vo.PathologyResultShortVoCollection voList = new ims.ocrr.vo.PathologyResultShortVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.ocrr.vo.PathologyResultShortVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.ocrr.vo.PathologyResultShortVoCollection createPathologyResultShortVoCollectionFromOrderInvestigation(java.util.List domainObjectList) 
	{
		return createPathologyResultShortVoCollectionFromOrderInvestigation(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.ocrr.orderingresults.domain.objects.OrderInvestigation objects.
	 */
	public static ims.ocrr.vo.PathologyResultShortVoCollection createPathologyResultShortVoCollectionFromOrderInvestigation(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.ocrr.vo.PathologyResultShortVoCollection voList = new ims.ocrr.vo.PathologyResultShortVoCollection();
	 ...
	 */
	 public static java.util.Set extractOrderInvestigationSet(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.PathologyResultShortVoCollection voCollection) 
	 {
	 	return extractOrderInvestigationSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractOrderInvestigationSet(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.PathologyResultShortVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.ocrr.vo.PathologyResultShortVo vo = voCollection.get(i);
			ims.ocrr.orderingresults.domain.objects.OrderInvestigation domainObject = PathologyResultShortVoAssembler.extractOrderInvestigation(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractOrderInvestigationList(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.PathologyResultShortVoCollection voCollection) 
	 {
	 	return extractOrderInvestigationList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractOrderInvestigationList(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.PathologyResultShortVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.ocrr.vo.PathologyResultShortVo create(ims.ocrr.orderingresults.domain.objects.OrderInvestigation domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.ocrr.vo.PathologyResultShortVo create(DomainObjectMap map, ims.ocrr.orderingresults.domain.objects.OrderInvestigation domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.ocrr.vo.PathologyResultShortVo valueObject = (ims.ocrr.vo.PathologyResultShortVo) map.getValueObject(domainObject, ims.ocrr.vo.PathologyResultShortVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.ocrr.vo.PathologyResultShortVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.ocrr.orderingresults.domain.objects.OrderInvestigation
	 */
	 public static ims.ocrr.vo.PathologyResultShortVo insert(ims.ocrr.vo.PathologyResultShortVo valueObject, ims.ocrr.orderingresults.domain.objects.OrderInvestigation domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.ocrr.orderingresults.domain.objects.OrderInvestigation
	 */
	 public static ims.ocrr.vo.PathologyResultShortVo insert(DomainObjectMap map, ims.ocrr.vo.PathologyResultShortVo valueObject, ims.ocrr.orderingresults.domain.objects.OrderInvestigation domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.ocrr.orderingresults.domain.objects.OrderInvestigation extractOrderInvestigation(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.PathologyResultShortVo valueObject) 
	{
		return 	extractOrderInvestigation(domainFactory, valueObject, new HashMap());
	}

	public static ims.ocrr.orderingresults.domain.objects.OrderInvestigation extractOrderInvestigation(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.PathologyResultShortVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.ocrr.vo.PathologyResultShortVo ID_OrderInvestigation field is unknown
