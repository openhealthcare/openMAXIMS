 ...
 */
public class RoleDisciplineSecurityLevelLiteVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.ocrr.vo.RoleDisciplineSecurityLevelLiteVo copy(ims.ocrr.vo.RoleDisciplineSecurityLevelLiteVo valueObjectDest, ims.ocrr.vo.RoleDisciplineSecurityLevelLiteVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createRoleDisciplineSecurityLevelLiteVoCollectionFromRoleDisciplineSecurityLevel(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.ocrr.configuration.domain.objects.RoleDisciplineSecurityLevel objects.
	 */
	public static ims.ocrr.vo.RoleDisciplineSecurityLevelLiteVoCollection createRoleDisciplineSecurityLevelLiteVoCollectionFromRoleDisciplineSecurityLevel(java.util.Set domainObjectSet)	
	{
		return createRoleDisciplineSecurityLevelLiteVoCollectionFromRoleDisciplineSecurityLevel(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.ocrr.configuration.domain.objects.RoleDisciplineSecurityLevel objects.
	 */
	public static ims.ocrr.vo.RoleDisciplineSecurityLevelLiteVoCollection createRoleDisciplineSecurityLevelLiteVoCollectionFromRoleDisciplineSecurityLevel(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.ocrr.vo.RoleDisciplineSecurityLevelLiteVoCollection voList = new ims.ocrr.vo.RoleDisciplineSecurityLevelLiteVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.ocrr.vo.RoleDisciplineSecurityLevelLiteVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.ocrr.vo.RoleDisciplineSecurityLevelLiteVoCollection createRoleDisciplineSecurityLevelLiteVoCollectionFromRoleDisciplineSecurityLevel(java.util.List domainObjectList) 
	{
		return createRoleDisciplineSecurityLevelLiteVoCollectionFromRoleDisciplineSecurityLevel(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.ocrr.configuration.domain.objects.RoleDisciplineSecurityLevel objects.
	 */
	public static ims.ocrr.vo.RoleDisciplineSecurityLevelLiteVoCollection createRoleDisciplineSecurityLevelLiteVoCollectionFromRoleDisciplineSecurityLevel(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.ocrr.vo.RoleDisciplineSecurityLevelLiteVoCollection voList = new ims.ocrr.vo.RoleDisciplineSecurityLevelLiteVoCollection();
	 ...
	 */
	 public static java.util.Set extractRoleDisciplineSecurityLevelSet(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.RoleDisciplineSecurityLevelLiteVoCollection voCollection) 
	 {
	 	return extractRoleDisciplineSecurityLevelSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractRoleDisciplineSecurityLevelSet(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.RoleDisciplineSecurityLevelLiteVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.ocrr.vo.RoleDisciplineSecurityLevelLiteVo vo = voCollection.get(i);
			ims.ocrr.configuration.domain.objects.RoleDisciplineSecurityLevel domainObject = RoleDisciplineSecurityLevelLiteVoAssembler.extractRoleDisciplineSecurityLevel(domainFactory, vo, domMap);
	 ...
	 */
	 ...
	 public static java.util.List extractRoleDisciplineSecurityLevelList(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.RoleDisciplineSecurityLevelLiteVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.ocrr.vo.RoleDisciplineSecurityLevelLiteVo create(ims.ocrr.configuration.domain.objects.RoleDisciplineSecurityLevel domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.ocrr.vo.RoleDisciplineSecurityLevelLiteVo create(DomainObjectMap map, ims.ocrr.configuration.domain.objects.RoleDisciplineSecurityLevel domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.ocrr.vo.RoleDisciplineSecurityLevelLiteVo valueObject = (ims.ocrr.vo.RoleDisciplineSecurityLevelLiteVo) map.getValueObject(domainObject, ims.ocrr.vo.RoleDisciplineSecurityLevelLiteVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.ocrr.vo.RoleDisciplineSecurityLevelLiteVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.ocrr.configuration.domain.objects.RoleDisciplineSecurityLevel
	 */
	 public static ims.ocrr.vo.RoleDisciplineSecurityLevelLiteVo insert(ims.ocrr.vo.RoleDisciplineSecurityLevelLiteVo valueObject, ims.ocrr.configuration.domain.objects.RoleDisciplineSecurityLevel domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.ocrr.configuration.domain.objects.RoleDisciplineSecurityLevel
	 */
	 public static ims.ocrr.vo.RoleDisciplineSecurityLevelLiteVo insert(DomainObjectMap map, ims.ocrr.vo.RoleDisciplineSecurityLevelLiteVo valueObject, ims.ocrr.configuration.domain.objects.RoleDisciplineSecurityLevel domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// OrderingSecurityLevel
		valueObject.setOrderingSecurityLevel(ims.ocrr.vo.domain.SecurityLevelConfigVoAssembler.create(map, domainObject.getOrderingSecurityLevel()) );
		// ViewingSecurityLevel
		valueObject.setViewingSecurityLevel(ims.ocrr.vo.domain.SecurityLevelConfigVoAssembler.create(map, domainObject.getViewingSecurityLevel()) );
 		return valueObject;
	 }
	 ...
	 */
	public static ims.ocrr.configuration.domain.objects.RoleDisciplineSecurityLevel extractRoleDisciplineSecurityLevel(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.RoleDisciplineSecurityLevelLiteVo valueObject) 
	{
		return 	extractRoleDisciplineSecurityLevel(domainFactory, valueObject, new HashMap());
	}

	public static ims.ocrr.configuration.domain.objects.RoleDisciplineSecurityLevel extractRoleDisciplineSecurityLevel(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.RoleDisciplineSecurityLevelLiteVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.ocrr.vo.RoleDisciplineSecurityLevelLiteVo ID_RoleDisciplineSecurityLevel field is unknown
