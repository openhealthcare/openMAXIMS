 ...
 */
public class ClinicalResultVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.ocrr.vo.ClinicalResultVo copy(ims.ocrr.vo.ClinicalResultVo valueObjectDest, ims.ocrr.vo.ClinicalResultVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createClinicalResultVoCollectionFromOrderInvestigation(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.ocrr.orderingresults.domain.objects.OrderInvestigation objects.
	 */
	public static ims.ocrr.vo.ClinicalResultVoCollection createClinicalResultVoCollectionFromOrderInvestigation(java.util.Set domainObjectSet)	
	{
		return createClinicalResultVoCollectionFromOrderInvestigation(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.ocrr.orderingresults.domain.objects.OrderInvestigation objects.
	 */
	public static ims.ocrr.vo.ClinicalResultVoCollection createClinicalResultVoCollectionFromOrderInvestigation(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.ocrr.vo.ClinicalResultVoCollection voList = new ims.ocrr.vo.ClinicalResultVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.ocrr.vo.ClinicalResultVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.ocrr.vo.ClinicalResultVoCollection createClinicalResultVoCollectionFromOrderInvestigation(java.util.List domainObjectList) 
	{
		return createClinicalResultVoCollectionFromOrderInvestigation(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.ocrr.orderingresults.domain.objects.OrderInvestigation objects.
	 */
	public static ims.ocrr.vo.ClinicalResultVoCollection createClinicalResultVoCollectionFromOrderInvestigation(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.ocrr.vo.ClinicalResultVoCollection voList = new ims.ocrr.vo.ClinicalResultVoCollection();
	 ...
	 */
	 public static java.util.Set extractOrderInvestigationSet(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.ClinicalResultVoCollection voCollection) 
	 {
	 	return extractOrderInvestigationSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractOrderInvestigationSet(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.ClinicalResultVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.ocrr.vo.ClinicalResultVo vo = voCollection.get(i);
			ims.ocrr.orderingresults.domain.objects.OrderInvestigation domainObject = ClinicalResultVoAssembler.extractOrderInvestigation(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractOrderInvestigationList(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.ClinicalResultVoCollection voCollection) 
	 {
	 	return extractOrderInvestigationList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractOrderInvestigationList(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.ClinicalResultVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.ocrr.vo.ClinicalResultVo create(ims.ocrr.orderingresults.domain.objects.OrderInvestigation domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.ocrr.vo.ClinicalResultVo create(DomainObjectMap map, ims.ocrr.orderingresults.domain.objects.OrderInvestigation domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.ocrr.vo.ClinicalResultVo valueObject = (ims.ocrr.vo.ClinicalResultVo) map.getValueObject(domainObject, ims.ocrr.vo.ClinicalResultVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.ocrr.vo.ClinicalResultVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.ocrr.orderingresults.domain.objects.OrderInvestigation
	 */
	 public static ims.ocrr.vo.ClinicalResultVo insert(ims.ocrr.vo.ClinicalResultVo valueObject, ims.ocrr.orderingresults.domain.objects.OrderInvestigation domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.ocrr.orderingresults.domain.objects.OrderInvestigation
	 */
	 public static ims.ocrr.vo.ClinicalResultVo insert(DomainObjectMap map, ims.ocrr.vo.ClinicalResultVo valueObject, ims.ocrr.orderingresults.domain.objects.OrderInvestigation domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// ResultDetails
		valueObject.setResultDetails(ims.ocrr.vo.domain.ResultDetailsForClinicalResultVoAssembler.create(map, domainObject.getResultDetails()) );
		// PlacerOrdNum
	 ...
	 */
	public static ims.ocrr.orderingresults.domain.objects.OrderInvestigation extractOrderInvestigation(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.ClinicalResultVo valueObject) 
	{
		return 	extractOrderInvestigation(domainFactory, valueObject, new HashMap());
	}

	public static ims.ocrr.orderingresults.domain.objects.OrderInvestigation extractOrderInvestigation(ims.domain.ILightweightDomainFactory domainFactory, ims.ocrr.vo.ClinicalResultVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.ocrr.vo.ClinicalResultVo ID_OrderInvestigation field is unknown
		...
		domainObject.setResultDetails(ims.ocrr.vo.domain.ResultDetailsForClinicalResultVoAssembler.extractResultDetails(domainFactory, valueObject.getResultDetails(), domMap));
		//This is to overcome a bug in both Sybase and Oracle which prevents them from storing an empty string correctly
		//Sybase stores it as a single space, Oracle stores it as NULL. This fix will make them consistent at least.
