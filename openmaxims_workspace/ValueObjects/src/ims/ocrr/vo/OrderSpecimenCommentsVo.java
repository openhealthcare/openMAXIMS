 ...
 */
public class OrderSpecimenCommentsVo extends ims.ocrr.orderingresults.vo.OrderSpecimenRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public OrderSpecimenCommentsVo()
	{
	}
	public OrderSpecimenCommentsVo(Integer id, int version)
	{
		super(id, version);
	}
	public OrderSpecimenCommentsVo(ims.ocrr.vo.beans.OrderSpecimenCommentsVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.beans.OrderSpecimenCommentsVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.resultconclusioncomments = ims.ocrr.vo.ResultCommentsLiteVoCollection.buildFromBeanCollection(bean.getResultConclusionComments());
	...
	{
		ims.ocrr.vo.beans.OrderSpecimenCommentsVoBean bean = null;
		if(map != null)
			bean = (ims.ocrr.vo.beans.OrderSpecimenCommentsVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.ocrr.vo.beans.OrderSpecimenCommentsVoBean();
	...
	public Object clone()
	{
		...
		OrderSpecimenCommentsVo clone = new OrderSpecimenCommentsVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(OrderSpecimenCommentsVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A OrderSpecimenCommentsVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((OrderSpecimenCommentsVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((OrderSpecimenCommentsVo)obj).getBoId());
	}
