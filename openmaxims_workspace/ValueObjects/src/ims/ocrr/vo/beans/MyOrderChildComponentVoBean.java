...
public class MyOrderChildComponentVoBean extends ims.vo.ValueObjectBean
{
	public MyOrderChildComponentVoBean()
	{
	}
	public MyOrderChildComponentVoBean(ims.ocrr.vo.MyOrderChildComponentVo vo)
	{
		this.id = vo.getID();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.MyOrderChildComponentVo vo)
	{
		this.id = vo.getID();
		this.componenttype = vo.getComponentType() == null ? null : (ims.vo.LookupInstanceBean)vo.getComponentType().getBean();
		this.text = vo.getText();
	...
	public ims.ocrr.vo.MyOrderChildComponentVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.ocrr.vo.MyOrderChildComponentVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.ocrr.vo.MyOrderChildComponentVo vo = null;
		if(map != null)
			vo = (ims.ocrr.vo.MyOrderChildComponentVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.ocrr.vo.MyOrderChildComponentVo();
