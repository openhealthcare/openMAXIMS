...
public class SelectedComponentFromSelectOrderVoBean extends ims.vo.ValueObjectBean
{
	public SelectedComponentFromSelectOrderVoBean()
	{
	}
	public SelectedComponentFromSelectOrderVoBean(ims.ocrr.vo.SelectedComponentFromSelectOrderVo vo)
	{
		this.id = vo.getID();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.SelectedComponentFromSelectOrderVo vo)
	{
		this.id = vo.getID();
		this.componenttype = vo.getComponentType() == null ? null : (ims.vo.LookupInstanceBean)vo.getComponentType().getBean();
		this.text = vo.getText();
	...
	public ims.ocrr.vo.SelectedComponentFromSelectOrderVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.ocrr.vo.SelectedComponentFromSelectOrderVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.ocrr.vo.SelectedComponentFromSelectOrderVo vo = null;
		if(map != null)
			vo = (ims.ocrr.vo.SelectedComponentFromSelectOrderVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.ocrr.vo.SelectedComponentFromSelectOrderVo();
