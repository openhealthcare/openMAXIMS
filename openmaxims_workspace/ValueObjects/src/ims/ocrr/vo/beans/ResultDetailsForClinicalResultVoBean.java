...
public class ResultDetailsForClinicalResultVoBean extends ims.vo.ValueObjectBean
{
	public ResultDetailsForClinicalResultVoBean()
	{
	}
	public ResultDetailsForClinicalResultVoBean(ims.ocrr.vo.ResultDetailsForClinicalResultVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.ResultDetailsForClinicalResultVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.type = vo.getType() == null ? null : (ims.vo.LookupInstanceBean)vo.getType().getBean();
	...
	public ims.ocrr.vo.ResultDetailsForClinicalResultVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.ocrr.vo.ResultDetailsForClinicalResultVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.ocrr.vo.ResultDetailsForClinicalResultVo vo = null;
		if(map != null)
			vo = (ims.ocrr.vo.ResultDetailsForClinicalResultVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.ocrr.vo.ResultDetailsForClinicalResultVo();
