...
public class OcsOrderForDFTOrderInvestigationVoBean extends ims.vo.ValueObjectBean
{
	public OcsOrderForDFTOrderInvestigationVoBean()
	{
	}
	public OcsOrderForDFTOrderInvestigationVoBean(ims.ocrr.vo.OcsOrderForDFTOrderInvestigationVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.OcsOrderForDFTOrderInvestigationVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.ocrr.vo.OcsOrderForDFTOrderInvestigationVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.ocrr.vo.OcsOrderForDFTOrderInvestigationVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.ocrr.vo.OcsOrderForDFTOrderInvestigationVo vo = null;
		if(map != null)
			vo = (ims.ocrr.vo.OcsOrderForDFTOrderInvestigationVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.ocrr.vo.OcsOrderForDFTOrderInvestigationVo();
