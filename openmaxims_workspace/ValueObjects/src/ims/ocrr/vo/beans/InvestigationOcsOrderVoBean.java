...
public class InvestigationOcsOrderVoBean extends ims.vo.ValueObjectBean
{
	public InvestigationOcsOrderVoBean()
	{
	}
	public InvestigationOcsOrderVoBean(ims.ocrr.vo.InvestigationOcsOrderVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.InvestigationOcsOrderVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.ocrr.vo.InvestigationOcsOrderVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.ocrr.vo.InvestigationOcsOrderVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.ocrr.vo.InvestigationOcsOrderVo vo = null;
		if(map != null)
			vo = (ims.ocrr.vo.InvestigationOcsOrderVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.ocrr.vo.InvestigationOcsOrderVo();
