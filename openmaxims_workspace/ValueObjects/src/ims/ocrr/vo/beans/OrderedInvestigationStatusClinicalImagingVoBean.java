...
public class OrderedInvestigationStatusClinicalImagingVoBean extends ims.vo.ValueObjectBean
{
	public OrderedInvestigationStatusClinicalImagingVoBean()
	{
	}
	public OrderedInvestigationStatusClinicalImagingVoBean(ims.ocrr.vo.OrderedInvestigationStatusClinicalImagingVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.OrderedInvestigationStatusClinicalImagingVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.ordinvstatus = vo.getOrdInvStatus() == null ? null : (ims.vo.LookupInstanceBean)vo.getOrdInvStatus().getBean();
	...
	public ims.ocrr.vo.OrderedInvestigationStatusClinicalImagingVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.ocrr.vo.OrderedInvestigationStatusClinicalImagingVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.ocrr.vo.OrderedInvestigationStatusClinicalImagingVo vo = null;
		if(map != null)
			vo = (ims.ocrr.vo.OrderedInvestigationStatusClinicalImagingVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.ocrr.vo.OrderedInvestigationStatusClinicalImagingVo();
