...
public class OrderedInvestigationStatusClinicalVoBean extends ims.vo.ValueObjectBean
{
	public OrderedInvestigationStatusClinicalVoBean()
	{
	}
	public OrderedInvestigationStatusClinicalVoBean(ims.ocrr.vo.OrderedInvestigationStatusClinicalVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.OrderedInvestigationStatusClinicalVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.ordinvstatus = vo.getOrdInvStatus() == null ? null : (ims.vo.LookupInstanceBean)vo.getOrdInvStatus().getBean();
	...
	public ims.ocrr.vo.OrderedInvestigationStatusClinicalVo buildVo()
	{
