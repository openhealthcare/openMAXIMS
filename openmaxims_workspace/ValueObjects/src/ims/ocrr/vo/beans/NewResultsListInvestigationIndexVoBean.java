...
public class NewResultsListInvestigationIndexVoBean extends ims.vo.ValueObjectBean
{
	public NewResultsListInvestigationIndexVoBean()
	{
	}
	public NewResultsListInvestigationIndexVoBean(ims.ocrr.vo.NewResultsListInvestigationIndexVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.NewResultsListInvestigationIndexVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.name = vo.getName();
	...
	public ims.ocrr.vo.NewResultsListInvestigationIndexVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.ocrr.vo.NewResultsListInvestigationIndexVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.ocrr.vo.NewResultsListInvestigationIndexVo vo = null;
		if(map != null)
			vo = (ims.ocrr.vo.NewResultsListInvestigationIndexVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.ocrr.vo.NewResultsListInvestigationIndexVo();
