...
public class NewResultOcsOrderVoBean extends ims.vo.ValueObjectBean
{
	public NewResultOcsOrderVoBean()
	{
	}
	public NewResultOcsOrderVoBean(ims.ocrr.vo.NewResultOcsOrderVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.NewResultOcsOrderVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.clinicalcontact = vo.getClinicalContact() == null ? null : new ims.vo.RefVoBean(vo.getClinicalContact().getBoId(), vo.getClinicalContact().getBoVersion());
	...
	public ims.ocrr.vo.NewResultOcsOrderVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.ocrr.vo.NewResultOcsOrderVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.ocrr.vo.NewResultOcsOrderVo vo = null;
		if(map != null)
			vo = (ims.ocrr.vo.NewResultOcsOrderVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.ocrr.vo.NewResultOcsOrderVo();
	...
	public ims.ocrr.vo.beans.OrderInvestigationForNewResultOcsOrderVoBean[] getInvestigations()
	{
		return this.investigations;
	}
	public void setInvestigations(ims.ocrr.vo.beans.OrderInvestigationForNewResultOcsOrderVoBean[] value)
	{
	...
	private ims.ocrr.vo.beans.OrderInvestigationForNewResultOcsOrderVoBean[] investigations;
}
