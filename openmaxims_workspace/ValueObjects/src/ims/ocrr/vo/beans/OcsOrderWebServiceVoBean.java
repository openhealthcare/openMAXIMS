...
public class OcsOrderWebServiceVoBean extends ims.vo.ValueObjectBean
{
	public OcsOrderWebServiceVoBean()
	{
	}
	public OcsOrderWebServiceVoBean(ims.ocrr.vo.OcsOrderWebServiceVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.hasneworupdatedresults = vo.getHasNewOrUpdatedResults();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.OcsOrderWebServiceVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.hasneworupdatedresults = vo.getHasNewOrUpdatedResults();
	...
	public ims.ocrr.vo.OcsOrderWebServiceVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.ocrr.vo.OcsOrderWebServiceVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.ocrr.vo.OcsOrderWebServiceVo vo = null;
		if(map != null)
			vo = (ims.ocrr.vo.OcsOrderWebServiceVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.ocrr.vo.OcsOrderWebServiceVo();
	...
	public ims.ocrr.vo.beans.OrderInvestigationWebServiceVoBean[] getInvestigations()
	{
		return this.investigations;
	}
	public void setInvestigations(ims.ocrr.vo.beans.OrderInvestigationWebServiceVoBean[] value)
	{
	...
	private ims.ocrr.vo.beans.OrderInvestigationWebServiceVoBean[] investigations;
}
