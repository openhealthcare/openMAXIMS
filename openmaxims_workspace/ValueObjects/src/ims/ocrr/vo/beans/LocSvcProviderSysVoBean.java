...
public class LocSvcProviderSysVoBean extends ims.vo.ValueObjectBean
{
	public LocSvcProviderSysVoBean()
	{
	}
	public LocSvcProviderSysVoBean(ims.ocrr.vo.LocSvcProviderSysVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.LocSvcProviderSysVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.ocrr.vo.LocSvcProviderSysVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.ocrr.vo.LocSvcProviderSysVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.ocrr.vo.LocSvcProviderSysVo vo = null;
		if(map != null)
			vo = (ims.ocrr.vo.LocSvcProviderSysVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.ocrr.vo.LocSvcProviderSysVo();
