 ...
 */
public class NewResultsListOrderDetailsVo extends ims.ocrr.orderingresults.vo.OcsOrderSessionRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public NewResultsListOrderDetailsVo()
	{
	}
	public NewResultsListOrderDetailsVo(Integer id, int version)
	{
		super(id, version);
	}
	public NewResultsListOrderDetailsVo(ims.ocrr.vo.beans.NewResultsListOrderDetailsVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.beans.NewResultsListOrderDetailsVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.ocrr.vo.beans.NewResultsListOrderDetailsVoBean bean = null;
		if(map != null)
			bean = (ims.ocrr.vo.beans.NewResultsListOrderDetailsVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.ocrr.vo.beans.NewResultsListOrderDetailsVoBean();
	...
	*/
	...
	public Object clone()
	{
		...
		NewResultsListOrderDetailsVo clone = new NewResultsListOrderDetailsVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(NewResultsListOrderDetailsVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A NewResultsListOrderDetailsVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((NewResultsListOrderDetailsVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((NewResultsListOrderDetailsVo)obj).getBoId());
	}
