 ...
 */
public class NewResultsListOrderInvestigationStatusVo extends ims.ocrr.orderingresults.vo.OrderedInvestigationStatusRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public NewResultsListOrderInvestigationStatusVo()
	{
	}
	public NewResultsListOrderInvestigationStatusVo(Integer id, int version)
	{
		super(id, version);
	}
	public NewResultsListOrderInvestigationStatusVo(ims.ocrr.vo.beans.NewResultsListOrderInvestigationStatusVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.beans.NewResultsListOrderInvestigationStatusVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.ordinvstatus = bean.getOrdInvStatus() == null ? null : ims.ocrr.vo.lookups.OrderInvStatus.buildLookup(bean.getOrdInvStatus());
	...
	{
		ims.ocrr.vo.beans.NewResultsListOrderInvestigationStatusVoBean bean = null;
		if(map != null)
			bean = (ims.ocrr.vo.beans.NewResultsListOrderInvestigationStatusVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.ocrr.vo.beans.NewResultsListOrderInvestigationStatusVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.changeuser != null)
			if(this.changeuser.length() > 255)
				listOfErrors.add("The length of the field [changeuser] in the value object [ims.ocrr.vo.NewResultsListOrderInvestigationStatusVo] is too big. It should be less or equal to 255");
		if(this.statusreason != null)
			if(this.statusreason.length() > 500)
				listOfErrors.add("The length of the field [statusreason] in the value object [ims.ocrr.vo.NewResultsListOrderInvestigationStatusVo] is too big. It should be less or equal to 500");
	...
	public Object clone()
	{
		...
		NewResultsListOrderInvestigationStatusVo clone = new NewResultsListOrderInvestigationStatusVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(NewResultsListOrderInvestigationStatusVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A NewResultsListOrderInvestigationStatusVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((NewResultsListOrderInvestigationStatusVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((NewResultsListOrderInvestigationStatusVo)obj).getBoId());
	}
