...
public class MyOrderChildComponentVo extends ims.ocrr.vo.SelectedComponentFromSelectOrderVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public MyOrderChildComponentVo()
	{
	}
	public MyOrderChildComponentVo(ims.ocrr.vo.beans.MyOrderChildComponentVoBean bean)
	{
		this.id = bean.getID();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.beans.MyOrderChildComponentVoBean bean)
	{
		this.id = bean.getID();
		this.componenttype = bean.getComponentType() == null ? null : ims.ocrr.vo.lookups.SelectAndOrderComponentType.buildLookup(bean.getComponentType());
		this.text = bean.getText();
	...
	{
		ims.ocrr.vo.beans.MyOrderChildComponentVoBean bean = null;
		if(map != null)
			bean = (ims.ocrr.vo.beans.MyOrderChildComponentVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.ocrr.vo.beans.MyOrderChildComponentVoBean();
	...
	public boolean equals(Object obj)
	{
		if(obj == null)
			return false;
		if(!(obj instanceof MyOrderChildComponentVo))
			return false;
		MyOrderChildComponentVo compareObj = (MyOrderChildComponentVo)obj;
	...
	public Object clone()
	{
		...
		MyOrderChildComponentVo clone = new MyOrderChildComponentVo();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(MyOrderChildComponentVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A MyOrderChildComponentVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		MyOrderChildComponentVo compareObj = (MyOrderChildComponentVo)obj;
		int retVal = 0;
		if (retVal == 0)
