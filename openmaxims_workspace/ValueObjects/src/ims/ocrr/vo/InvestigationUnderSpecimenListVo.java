 ...
 */
public class InvestigationUnderSpecimenListVo extends ims.ocrr.configuration.vo.InvestigationRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public InvestigationUnderSpecimenListVo()
	{
	}
	public InvestigationUnderSpecimenListVo(Integer id, int version)
	{
		super(id, version);
	}
	public InvestigationUnderSpecimenListVo(ims.ocrr.vo.beans.InvestigationUnderSpecimenListVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.beans.InvestigationUnderSpecimenListVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.ocrr.vo.beans.InvestigationUnderSpecimenListVoBean bean = null;
		if(map != null)
			bean = (ims.ocrr.vo.beans.InvestigationUnderSpecimenListVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.ocrr.vo.beans.InvestigationUnderSpecimenListVoBean();
	...
	public Object clone()
	{
		...
		InvestigationUnderSpecimenListVo clone = new InvestigationUnderSpecimenListVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(InvestigationUnderSpecimenListVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A InvestigationUnderSpecimenListVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((InvestigationUnderSpecimenListVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((InvestigationUnderSpecimenListVo)obj).getBoId());
	}
