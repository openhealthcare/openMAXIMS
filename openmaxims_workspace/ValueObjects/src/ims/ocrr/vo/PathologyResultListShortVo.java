 ...
 */
public class PathologyResultListShortVo extends ims.ocrr.orderingresults.vo.OrderInvestigationRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public PathologyResultListShortVo(Integer id, int version)
	{
		super(id, version);
	}
	public PathologyResultListShortVo(ims.ocrr.vo.beans.PathologyResultListShortVoBean bean)
	{
		...
		this.specimen = ims.ocrr.vo.PathologySpecimenLiteVoCollection.buildFromBeanCollection(bean.getSpecimen());
		...
		this.daterequested = bean.getDateRequested() == null ? null : bean.getDateRequested().buildDate();
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.beans.PathologyResultListShortVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.ocrr.vo.beans.PathologyResultListShortVoBean bean = null;
		if(map != null)
			bean = (ims.ocrr.vo.beans.PathologyResultListShortVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.ocrr.vo.beans.PathologyResultListShortVoBean();
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("DATEREQUESTED"))
	...
	public ims.ocrr.vo.PathologySpecimenLiteVoCollection getSpecimen()
	{
		return this.specimen;
	}
	public void setSpecimen(ims.ocrr.vo.PathologySpecimenLiteVoCollection value)
	{
		this.isValidated = false;
		this.specimen = value;
	}
	...
	public ims.ocrr.vo.ResultDetailsForPathologyResultListShortVo getResultDetails()
	{
		return this.resultdetails;
	}
	public void setResultDetails(ims.ocrr.vo.ResultDetailsForPathologyResultListShortVo value)
	{
		this.isValidated = false;
	...
	public boolean getDateRequestedIsNotNull()
	{
		return this.daterequested != null;
	}
	public ims.framework.utils.Date getDateRequested()
	{
		return this.daterequested;
	}
	public void setDateRequested(ims.framework.utils.Date value)
	{
		this.isValidated = false;
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.placerordnum != null)
			if(this.placerordnum.length() > 20)
				listOfErrors.add("The length of the field [placerordnum] in the value object [ims.ocrr.vo.PathologyResultListShortVo] is too big. It should be less or equal to 20");
	...
	public Object clone()
	{
		...
		if(this.specimen == null)
			...
			clone.specimen = (ims.ocrr.vo.PathologySpecimenLiteVoCollection)this.specimen.clone();
		...
		if(this.resultdetails == null)
			...
			clone.resultdetails = (ims.ocrr.vo.ResultDetailsForPathologyResultListShortVo)this.resultdetails.clone();
		...
		if(this.daterequested == null)
			clone.daterequested = null;
		else
			clone.daterequested = (ims.framework.utils.Date)this.daterequested.clone();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		{
			throw new ClassCastException("A PathologyResultListShortVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
	...
	protected ims.ocrr.vo.PathologySpecimenLiteVoCollection specimen;
	...
	protected ims.ocrr.vo.ResultDetailsForPathologyResultListShortVo resultdetails;
	protected String placerordnum;
	protected ims.core.vo.HcpLiteVo allocatedhcpforreview;
	protected ims.framework.utils.Date daterequested;
