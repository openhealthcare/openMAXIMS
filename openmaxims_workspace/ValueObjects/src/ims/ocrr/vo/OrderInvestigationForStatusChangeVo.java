...
public class OrderInvestigationForStatusChangeVo extends ims.ocrr.orderingresults.vo.OrderInvestigationRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		{
			throw new ClassCastException("A OrderInvestigationForStatusChangeVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((OrderInvestigationForStatusChangeVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((OrderInvestigationForStatusChangeVo)obj).getBoId());
	}
