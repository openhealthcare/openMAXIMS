 ...
 */
public class PathologyResultShortVo extends ims.ocrr.orderingresults.vo.OrderInvestigationRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public PathologyResultShortVo()
	{
	}
	public PathologyResultShortVo(Integer id, int version)
	{
		super(id, version);
	}
	public PathologyResultShortVo(ims.ocrr.vo.beans.PathologyResultShortVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.beans.PathologyResultShortVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.ocrr.vo.beans.PathologyResultShortVoBean bean = null;
		if(map != null)
			bean = (ims.ocrr.vo.beans.PathologyResultShortVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.ocrr.vo.beans.PathologyResultShortVoBean();
	...
	public Object clone()
	{
		...
		PathologyResultShortVo clone = new PathologyResultShortVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(PathologyResultShortVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A PathologyResultShortVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		PathologyResultShortVo compareObj = (PathologyResultShortVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
