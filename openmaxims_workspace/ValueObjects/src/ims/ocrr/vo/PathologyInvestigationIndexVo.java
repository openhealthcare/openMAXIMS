 ...
 */
public class PathologyInvestigationIndexVo extends ims.ocrr.configuration.vo.InvestigationIndexRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public PathologyInvestigationIndexVo()
	{
	}
	public PathologyInvestigationIndexVo(Integer id, int version)
	{
		super(id, version);
	}
	public PathologyInvestigationIndexVo(ims.ocrr.vo.beans.PathologyInvestigationIndexVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.beans.PathologyInvestigationIndexVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.name = bean.getName();
	...
	{
		ims.ocrr.vo.beans.PathologyInvestigationIndexVoBean bean = null;
		if(map != null)
			bean = (ims.ocrr.vo.beans.PathologyInvestigationIndexVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.ocrr.vo.beans.PathologyInvestigationIndexVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.name == null || this.name.length() == 0)
			...
			listOfErrors.add("The length of the field [name] in the value object [ims.ocrr.vo.PathologyInvestigationIndexVo] is too big. It should be less or equal to 200");
	...
	public Object clone()
	{
		...
		PathologyInvestigationIndexVo clone = new PathologyInvestigationIndexVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(PathologyInvestigationIndexVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A PathologyInvestigationIndexVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((PathologyInvestigationIndexVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((PathologyInvestigationIndexVo)obj).getBoId());
	}
