 ...
 */
public class InvestigationOcsOrderVo extends ims.ocrr.configuration.vo.InvestigationRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public InvestigationOcsOrderVo()
	{
	}
	public InvestigationOcsOrderVo(Integer id, int version)
	{
		super(id, version);
	}
	public InvestigationOcsOrderVo(ims.ocrr.vo.beans.InvestigationOcsOrderVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.investigationindex = bean.getInvestigationIndex() == null ? null : bean.getInvestigationIndex().buildVo();
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.beans.InvestigationOcsOrderVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.ocrr.vo.beans.InvestigationOcsOrderVoBean bean = null;
		if(map != null)
			bean = (ims.ocrr.vo.beans.InvestigationOcsOrderVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.ocrr.vo.beans.InvestigationOcsOrderVoBean();
	...
	public Object clone()
	{
		...
		InvestigationOcsOrderVo clone = new InvestigationOcsOrderVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(InvestigationOcsOrderVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A InvestigationOcsOrderVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((InvestigationOcsOrderVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((InvestigationOcsOrderVo)obj).getBoId());
	}
