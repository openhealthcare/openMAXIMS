 ...
 */
public class OrderSpecimenPathologyVo extends ims.ocrr.orderingresults.vo.OrderSpecimenRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public OrderSpecimenPathologyVo()
	{
	}
	public OrderSpecimenPathologyVo(Integer id, int version)
	{
		super(id, version);
	}
	public OrderSpecimenPathologyVo(ims.ocrr.vo.beans.OrderSpecimenPathologyVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.beans.OrderSpecimenPathologyVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.specimensource = bean.getSpecimenSource() == null ? null : ims.ocrr.vo.lookups.SpecimenType.buildLookup(bean.getSpecimenSource());
	...
	{
		ims.ocrr.vo.beans.OrderSpecimenPathologyVoBean bean = null;
		if(map != null)
			bean = (ims.ocrr.vo.beans.OrderSpecimenPathologyVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.ocrr.vo.beans.OrderSpecimenPathologyVoBean();
	...
	public Object clone()
	{
		...
		OrderSpecimenPathologyVo clone = new OrderSpecimenPathologyVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(OrderSpecimenPathologyVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A OrderSpecimenPathologyVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((OrderSpecimenPathologyVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((OrderSpecimenPathologyVo)obj).getBoId());
	}
