 ...
 */
public class TemplateRoleShortVo extends ims.ocrr.configuration.vo.TemplateRoleRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public TemplateRoleShortVo()
	{
	}
	public TemplateRoleShortVo(Integer id, int version)
	{
		super(id, version);
	}
	public TemplateRoleShortVo(ims.ocrr.vo.beans.TemplateRoleShortVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.beans.TemplateRoleShortVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.ocrr.vo.beans.TemplateRoleShortVoBean bean = null;
		if(map != null)
			bean = (ims.ocrr.vo.beans.TemplateRoleShortVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.ocrr.vo.beans.TemplateRoleShortVoBean();
	...
	public Object clone()
	{
		...
		TemplateRoleShortVo clone = new TemplateRoleShortVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(TemplateRoleShortVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A TemplateRoleShortVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		TemplateRoleShortVo compareObj = (TemplateRoleShortVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
			if(this.getID_TemplateRole() == null && compareObj.getID_TemplateRole() != null)
				return -1;
			if(this.getID_TemplateRole() != null && compareObj.getID_TemplateRole() == null)
				return 1;
			if(this.getID_TemplateRole() != null && compareObj.getID_TemplateRole() != null)
				retVal = this.getID_TemplateRole().compareTo(compareObj.getID_TemplateRole());
		}
		return retVal;
	}
