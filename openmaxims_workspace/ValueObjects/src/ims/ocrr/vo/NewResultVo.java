 ...
 */
public class NewResultVo extends ims.ocrr.orderingresults.vo.OrderInvestigationRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public NewResultVo(Integer id, int version)
	{
		super(id, version);
	}
	public NewResultVo(ims.ocrr.vo.beans.NewResultVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.ocrr.vo.beans.NewResultVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.ocrr.vo.beans.NewResultVoBean bean = null;
		if(map != null)
			bean = (ims.ocrr.vo.beans.NewResultVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.ocrr.vo.beans.NewResultVoBean();
	...
	public Object clone()
	{
		...
		NewResultVo clone = new NewResultVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(NewResultVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A NewResultVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		NewResultVo compareObj = (NewResultVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
