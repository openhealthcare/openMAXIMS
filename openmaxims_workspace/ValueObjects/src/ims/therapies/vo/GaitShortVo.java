 ...
 */
public class GaitShortVo extends ims.therapies.treatment.vo.GaitRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public GaitShortVo(Integer id, int version)
	{
		super(id, version);
	}
	public GaitShortVo(ims.therapies.vo.beans.GaitShortVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.beans.GaitShortVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.authoringdatetime = bean.getAuthoringDateTime() == null ? null : bean.getAuthoringDateTime().buildDateTime();
	...
	{
		ims.therapies.vo.beans.GaitShortVoBean bean = null;
		if(map != null)
			bean = (ims.therapies.vo.beans.GaitShortVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.therapies.vo.beans.GaitShortVoBean();
	...
	public Object clone()
	{
		...
		GaitShortVo clone = new GaitShortVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(GaitShortVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A GaitShortVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((GaitShortVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((GaitShortVo)obj).getBoId());
	}
