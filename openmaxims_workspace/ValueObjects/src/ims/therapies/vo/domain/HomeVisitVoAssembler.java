 ...
 * @author Peter Martin
 */
public class HomeVisitVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.therapies.vo.HomeVisitVo copy(ims.therapies.vo.HomeVisitVo valueObjectDest, ims.therapies.vo.HomeVisitVo valueObjectSrc) 
	 {
		...
		valueObjectDest.setHomeAssessmentComponent(valueObjectSrc.getHomeAssessmentComponent());
		// Rooms
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createHomeVisitVoCollectionFromHomeVisit(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.therapies.homeandenvironmentalvisit.domain.objects.HomeVisit objects.
	 */
	public static ims.therapies.vo.HomeVisitVoCollection createHomeVisitVoCollectionFromHomeVisit(java.util.Set domainObjectSet)	
	{
		return createHomeVisitVoCollectionFromHomeVisit(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.therapies.homeandenvironmentalvisit.domain.objects.HomeVisit objects.
	 */
	public static ims.therapies.vo.HomeVisitVoCollection createHomeVisitVoCollectionFromHomeVisit(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.therapies.vo.HomeVisitVoCollection voList = new ims.therapies.vo.HomeVisitVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.therapies.vo.HomeVisitVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.therapies.vo.HomeVisitVoCollection createHomeVisitVoCollectionFromHomeVisit(java.util.List domainObjectList) 
	{
		return createHomeVisitVoCollectionFromHomeVisit(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.therapies.homeandenvironmentalvisit.domain.objects.HomeVisit objects.
	 */
	public static ims.therapies.vo.HomeVisitVoCollection createHomeVisitVoCollectionFromHomeVisit(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.therapies.vo.HomeVisitVoCollection voList = new ims.therapies.vo.HomeVisitVoCollection();
	 ...
	 */
	 public static java.util.Set extractHomeVisitSet(ims.domain.ILightweightDomainFactory domainFactory, ims.therapies.vo.HomeVisitVoCollection voCollection) 
	 {
	 	return extractHomeVisitSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractHomeVisitSet(ims.domain.ILightweightDomainFactory domainFactory, ims.therapies.vo.HomeVisitVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.therapies.vo.HomeVisitVo vo = voCollection.get(i);
			ims.therapies.homeandenvironmentalvisit.domain.objects.HomeVisit domainObject = HomeVisitVoAssembler.extractHomeVisit(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractHomeVisitList(ims.domain.ILightweightDomainFactory domainFactory, ims.therapies.vo.HomeVisitVoCollection voCollection) 
	 {
	 	return extractHomeVisitList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractHomeVisitList(ims.domain.ILightweightDomainFactory domainFactory, ims.therapies.vo.HomeVisitVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.therapies.vo.HomeVisitVo create(ims.therapies.homeandenvironmentalvisit.domain.objects.HomeVisit domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.therapies.vo.HomeVisitVo create(DomainObjectMap map, ims.therapies.homeandenvironmentalvisit.domain.objects.HomeVisit domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.therapies.vo.HomeVisitVo valueObject = (ims.therapies.vo.HomeVisitVo) map.getValueObject(domainObject, ims.therapies.vo.HomeVisitVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.therapies.vo.HomeVisitVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.therapies.homeandenvironmentalvisit.domain.objects.HomeVisit
	 */
	 public static ims.therapies.vo.HomeVisitVo insert(ims.therapies.vo.HomeVisitVo valueObject, ims.therapies.homeandenvironmentalvisit.domain.objects.HomeVisit domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.therapies.homeandenvironmentalvisit.domain.objects.HomeVisit
	 */
	 public static ims.therapies.vo.HomeVisitVo insert(DomainObjectMap map, ims.therapies.vo.HomeVisitVo valueObject, ims.therapies.homeandenvironmentalvisit.domain.objects.HomeVisit domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// TherapistPresent
		valueObject.setTherapistPresent(ims.core.vo.domain.HcpLiteVoAssembler.create(map, domainObject.getTherapistPresent()) );
		// OthersPresent
		valueObject.setOthersPresent(domainObject.getOthersPresent());
		// HomeAssessmentComponent
		valueObject.setHomeAssessmentComponent(ims.therapies.vo.domain.BathingFacilityVoAssembler.createBathingFacilityVoCollectionFromBathingFacility(map, domainObject.getHomeAssessmentComponent()) );
		// Rooms
	 ...
	 */
	public static ims.therapies.homeandenvironmentalvisit.domain.objects.HomeVisit extractHomeVisit(ims.domain.ILightweightDomainFactory domainFactory, ims.therapies.vo.HomeVisitVo valueObject) 
	{
		return 	extractHomeVisit(domainFactory, valueObject, new HashMap());
	}

	public static ims.therapies.homeandenvironmentalvisit.domain.objects.HomeVisit extractHomeVisit(ims.domain.ILightweightDomainFactory domainFactory, ims.therapies.vo.HomeVisitVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.therapies.vo.HomeVisitVo ID_HomeVisit field is unknown
		...
		domainObject.setTherapistPresent(ims.core.vo.domain.HcpLiteVoAssembler.extractHcp(domainFactory, valueObject.getTherapistPresent(), domMap));
		...
		domainObject.setHomeAssessmentComponent(ims.therapies.vo.domain.BathingFacilityVoAssembler.extractBathingFacilitySet(domainFactory, valueObject.getHomeAssessmentComponent(), domainObject.getHomeAssessmentComponent(), domMap));		
