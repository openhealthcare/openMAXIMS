 ...
 */
public class EducationToCarersVo extends ims.therapies.vo.EducationToCarersRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public EducationToCarersVo()
	{
	}
	public EducationToCarersVo(Integer id, int version)
	{
		super(id, version);
	}
	public EducationToCarersVo(ims.therapies.vo.beans.EducationToCarersVoBean bean)
	{
		this.id = bean.getId();
		...
		this.carer = bean.getCarer() == null ? null : ims.therapies.vo.lookups.CarerEducation.buildLookup(bean.getCarer());
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.beans.EducationToCarersVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.authoringdatetime = bean.getAuthoringDateTime() == null ? null : bean.getAuthoringDateTime().buildDateTime();
	...
	{
		ims.therapies.vo.beans.EducationToCarersVoBean bean = null;
		if(map != null)
			bean = (ims.therapies.vo.beans.EducationToCarersVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.therapies.vo.beans.EducationToCarersVoBean();
	...
	public boolean getCarerIsNotNull()
	{
		return this.carer != null;
	}
	public ims.therapies.vo.lookups.CarerEducation getCarer()
	{
		return this.carer;
	}
	public void setCarer(ims.therapies.vo.lookups.CarerEducation value)
	{
		this.isValidated = false;
		this.carer = value;
	}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.details != null)
			if(this.details.length() > 1000)
				listOfErrors.add("The length of the field [details] in the value object [ims.therapies.vo.EducationToCarersVo] is too big. It should be less or equal to 1000");
	...
	public Object clone()
	{
		...
		EducationToCarersVo clone = new EducationToCarersVo(this.id, this.version);
		...
		if(this.carer == null)
			...
			clone.carer = (ims.therapies.vo.lookups.CarerEducation)this.carer.clone();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(EducationToCarersVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A EducationToCarersVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		EducationToCarersVo compareObj = (EducationToCarersVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
		...
		if (retVal == 0)
		{
			if(this.getAuthoringCP() == null && compareObj.getAuthoringCP() != null)
				return -1;
			if(this.getAuthoringCP() != null && compareObj.getAuthoringCP() == null)
				return 1;
			if(this.getAuthoringCP() != null && compareObj.getAuthoringCP() != null)
				retVal = this.getAuthoringCP().compareTo(compareObj.getAuthoringCP());
		}
		return retVal;
	}
	...
	protected ims.therapies.vo.lookups.CarerEducation carer;
