 ...
 */
public class HydrotherapyShortVo extends ims.therapies.treatment.vo.HydrotherapyRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public HydrotherapyShortVo()
	{
	}
	public HydrotherapyShortVo(Integer id, int version)
	{
		super(id, version);
	}
	public HydrotherapyShortVo(ims.therapies.vo.beans.HydrotherapyShortVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.beans.HydrotherapyShortVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.therapies.vo.beans.HydrotherapyShortVoBean bean = null;
		if(map != null)
			bean = (ims.therapies.vo.beans.HydrotherapyShortVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.therapies.vo.beans.HydrotherapyShortVoBean();
	...
	public Object clone()
	{
		...
		HydrotherapyShortVo clone = new HydrotherapyShortVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(HydrotherapyShortVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A HydrotherapyShortVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((HydrotherapyShortVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((HydrotherapyShortVo)obj).getBoId());
	}
