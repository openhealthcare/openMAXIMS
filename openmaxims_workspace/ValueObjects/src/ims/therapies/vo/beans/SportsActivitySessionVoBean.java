...
public class SportsActivitySessionVoBean extends ims.vo.ValueObjectBean
{
	public SportsActivitySessionVoBean()
	{
	}
	public SportsActivitySessionVoBean(ims.therapies.vo.SportsActivitySessionVo vo)
	{
		this.id = vo.getBoId();
		...
		this.sportsactivity = vo.getSportsActivity() == null ? null : vo.getSportsActivity().getBeanCollection();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.SportsActivitySessionVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.authoringdatetime = vo.getAuthoringDateTime() == null ? null : (ims.framework.utils.beans.DateTimeBean)vo.getAuthoringDateTime().getBean();
	...
	public ims.therapies.vo.SportsActivitySessionVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.therapies.vo.SportsActivitySessionVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.therapies.vo.SportsActivitySessionVo vo = null;
		if(map != null)
			vo = (ims.therapies.vo.SportsActivitySessionVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.therapies.vo.SportsActivitySessionVo();
	...
	public ims.therapies.vo.beans.SportsActivityVoBean[] getSportsActivity()
	{
		return this.sportsactivity;
	}
	public void setSportsActivity(ims.therapies.vo.beans.SportsActivityVoBean[] value)
	{
	...
	private ims.therapies.vo.beans.SportsActivityVoBean[] sportsactivity;
