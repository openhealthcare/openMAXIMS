...
public class ThermalVoBean extends ims.vo.ValueObjectBean
{
	public ThermalVoBean()
	{
	}
	public ThermalVoBean(ims.therapies.vo.ThermalVo vo)
	{
		this.id = vo.getBoId();
		...
		this.thermalactivity = vo.getThermalActivity() == null ? null : vo.getThermalActivity().getBeanCollection();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.ThermalVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.therapies.vo.ThermalVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.therapies.vo.ThermalVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.therapies.vo.ThermalVo vo = null;
		if(map != null)
			vo = (ims.therapies.vo.ThermalVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.therapies.vo.ThermalVo();
	...
	public ims.therapies.vo.beans.ThermalActivityVoBean[] getThermalActivity()
	{
		return this.thermalactivity;
	}
	public void setThermalActivity(ims.therapies.vo.beans.ThermalActivityVoBean[] value)
	{
	...
	private ims.therapies.vo.beans.ThermalActivityVoBean[] thermalactivity;
}
