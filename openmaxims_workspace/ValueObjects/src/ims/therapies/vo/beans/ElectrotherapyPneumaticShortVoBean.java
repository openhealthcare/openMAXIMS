...
public class ElectrotherapyPneumaticShortVoBean extends ims.vo.ValueObjectBean
{
	public ElectrotherapyPneumaticShortVoBean()
	{
	}
	public ElectrotherapyPneumaticShortVoBean(ims.therapies.vo.ElectrotherapyPneumaticShortVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.ElectrotherapyPneumaticShortVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.therapies.vo.ElectrotherapyPneumaticShortVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.therapies.vo.ElectrotherapyPneumaticShortVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.therapies.vo.ElectrotherapyPneumaticShortVo vo = null;
		if(map != null)
			vo = (ims.therapies.vo.ElectrotherapyPneumaticShortVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.therapies.vo.ElectrotherapyPneumaticShortVo();
