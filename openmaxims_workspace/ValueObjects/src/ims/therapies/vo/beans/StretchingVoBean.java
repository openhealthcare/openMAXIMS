...
public class StretchingVoBean extends ims.vo.ValueObjectBean
{
	public StretchingVoBean()
	{
	}
	public StretchingVoBean(ims.therapies.vo.StretchingVo vo)
	{
		this.id = vo.getBoId();
		...
		this.stretchingdetails = vo.getStretchingDetails() == null ? null : vo.getStretchingDetails().getBeanCollection();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.StretchingVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.therapies.vo.StretchingVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.therapies.vo.StretchingVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.therapies.vo.StretchingVo vo = null;
		if(map != null)
			vo = (ims.therapies.vo.StretchingVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.therapies.vo.StretchingVo();
	...
	public ims.therapies.vo.beans.StretchingDetailsVoBean[] getStretchingDetails()
	{
		return this.stretchingdetails;
	}
	public void setStretchingDetails(ims.therapies.vo.beans.StretchingDetailsVoBean[] value)
	{
	...
	private ims.therapies.vo.beans.StretchingDetailsVoBean[] stretchingdetails;
}
