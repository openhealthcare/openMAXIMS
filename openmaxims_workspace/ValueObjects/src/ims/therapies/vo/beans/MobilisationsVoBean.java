...
public class MobilisationsVoBean extends ims.vo.ValueObjectBean
{
	public MobilisationsVoBean()
	{
	}
	public MobilisationsVoBean(ims.therapies.vo.MobilisationsVo vo)
	{
		this.id = vo.getBoId();
		...
		this.mobilisationstreatment = vo.getMobilisationsTreatment() == null ? null : vo.getMobilisationsTreatment().getBeanCollection();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.MobilisationsVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.therapies.vo.MobilisationsVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.therapies.vo.MobilisationsVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.therapies.vo.MobilisationsVo vo = null;
		if(map != null)
			vo = (ims.therapies.vo.MobilisationsVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.therapies.vo.MobilisationsVo();
	...
	public ims.therapies.vo.beans.MobilisationsTreatmentVoBean[] getMobilisationsTreatment()
	{
		return this.mobilisationstreatment;
	}
	public void setMobilisationsTreatment(ims.therapies.vo.beans.MobilisationsTreatmentVoBean[] value)
	{
	...
	private ims.therapies.vo.beans.MobilisationsTreatmentVoBean[] mobilisationstreatment;
}
