...
public class ElectrotherapyUltrasoundShortVoBean extends ims.vo.ValueObjectBean
{
	public ElectrotherapyUltrasoundShortVoBean()
	{
	}
	public ElectrotherapyUltrasoundShortVoBean(ims.therapies.vo.ElectrotherapyUltrasoundShortVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.ElectrotherapyUltrasoundShortVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.therapies.vo.ElectrotherapyUltrasoundShortVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.therapies.vo.ElectrotherapyUltrasoundShortVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.therapies.vo.ElectrotherapyUltrasoundShortVo vo = null;
		if(map != null)
			vo = (ims.therapies.vo.ElectrotherapyUltrasoundShortVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.therapies.vo.ElectrotherapyUltrasoundShortVo();
