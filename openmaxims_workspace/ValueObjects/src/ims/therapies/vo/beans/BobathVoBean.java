...
public class BobathVoBean extends ims.vo.ValueObjectBean
{
	public BobathVoBean()
	{
	}
	public BobathVoBean(ims.therapies.vo.BobathVo vo)
	{
		this.id = vo.getBoId();
		...
		this.bobathtreatment = vo.getBobathTreatment() == null ? null : vo.getBobathTreatment().getBeanCollection();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.BobathVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.therapies.vo.BobathVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.therapies.vo.BobathVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.therapies.vo.BobathVo vo = null;
		if(map != null)
			vo = (ims.therapies.vo.BobathVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.therapies.vo.BobathVo();
	...
	public ims.therapies.vo.beans.BobathTreatmentVoBean[] getBobathTreatment()
	{
		return this.bobathtreatment;
	}
	public void setBobathTreatment(ims.therapies.vo.beans.BobathTreatmentVoBean[] value)
	{
	...
	private ims.therapies.vo.beans.BobathTreatmentVoBean[] bobathtreatment;
}
