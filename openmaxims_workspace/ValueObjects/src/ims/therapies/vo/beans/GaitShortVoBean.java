...
public class GaitShortVoBean extends ims.vo.ValueObjectBean
{
	public GaitShortVoBean()
	{
	}
	public GaitShortVoBean(ims.therapies.vo.GaitShortVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.GaitShortVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.authoringdatetime = vo.getAuthoringDateTime() == null ? null : (ims.framework.utils.beans.DateTimeBean)vo.getAuthoringDateTime().getBean();
	...
	public ims.therapies.vo.GaitShortVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.therapies.vo.GaitShortVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.therapies.vo.GaitShortVo vo = null;
		if(map != null)
			vo = (ims.therapies.vo.GaitShortVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.therapies.vo.GaitShortVo();
