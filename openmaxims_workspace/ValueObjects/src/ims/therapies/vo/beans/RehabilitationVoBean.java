...
public class RehabilitationVoBean extends ims.vo.ValueObjectBean
{
	public RehabilitationVoBean()
	{
	}
	public RehabilitationVoBean(ims.therapies.vo.RehabilitationVo vo)
	{
		this.id = vo.getBoId();
		...
		this.rehabactivity = vo.getRehabActivity() == null ? null : vo.getRehabActivity().getBeanCollection();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.RehabilitationVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.therapies.vo.RehabilitationVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.therapies.vo.RehabilitationVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.therapies.vo.RehabilitationVo vo = null;
		if(map != null)
			vo = (ims.therapies.vo.RehabilitationVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.therapies.vo.RehabilitationVo();
	...
	public ims.therapies.vo.beans.RehabilitationActivityVoBean[] getRehabActivity()
	{
		return this.rehabactivity;
	}
	public void setRehabActivity(ims.therapies.vo.beans.RehabilitationActivityVoBean[] value)
	{
	...
	private ims.therapies.vo.beans.RehabilitationActivityVoBean[] rehabactivity;
}
