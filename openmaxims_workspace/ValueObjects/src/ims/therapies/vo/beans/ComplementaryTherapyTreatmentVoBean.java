...
public class ComplementaryTherapyTreatmentVoBean extends ims.vo.ValueObjectBean
{
	public ComplementaryTherapyTreatmentVoBean()
	{
	}
	public ComplementaryTherapyTreatmentVoBean(ims.therapies.vo.ComplementaryTherapyTreatmentVo vo)
	{
		this.id = vo.getBoId();
		...
		this.complementarytherapy = vo.getComplementaryTherapy() == null ? null : vo.getComplementaryTherapy().getBeanCollection();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.ComplementaryTherapyTreatmentVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.therapies.vo.ComplementaryTherapyTreatmentVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.therapies.vo.ComplementaryTherapyTreatmentVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.therapies.vo.ComplementaryTherapyTreatmentVo vo = null;
		if(map != null)
			vo = (ims.therapies.vo.ComplementaryTherapyTreatmentVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.therapies.vo.ComplementaryTherapyTreatmentVo();
	...
	public ims.therapies.vo.beans.ComplementaryTherapyDetailsVoBean[] getComplementaryTherapy()
	{
		return this.complementarytherapy;
	}
	public void setComplementaryTherapy(ims.therapies.vo.beans.ComplementaryTherapyDetailsVoBean[] value)
	{
	...
	private ims.therapies.vo.beans.ComplementaryTherapyDetailsVoBean[] complementarytherapy;
}
