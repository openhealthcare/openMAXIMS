...
public class FunctionalTransfersShortVoBean extends ims.vo.ValueObjectBean
{
	public FunctionalTransfersShortVoBean()
	{
	}
	public FunctionalTransfersShortVoBean(ims.therapies.vo.FunctionalTransfersShortVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.FunctionalTransfersShortVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.clinicalcontact = vo.getClinicalContact() == null ? null : new ims.vo.RefVoBean(vo.getClinicalContact().getBoId(), vo.getClinicalContact().getBoVersion());
	...
	public ims.therapies.vo.FunctionalTransfersShortVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.therapies.vo.FunctionalTransfersShortVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.therapies.vo.FunctionalTransfersShortVo vo = null;
		if(map != null)
			vo = (ims.therapies.vo.FunctionalTransfersShortVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.therapies.vo.FunctionalTransfersShortVo();
