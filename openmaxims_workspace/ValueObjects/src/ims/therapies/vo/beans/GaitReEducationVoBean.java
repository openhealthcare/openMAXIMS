...
public class GaitReEducationVoBean extends ims.vo.ValueObjectBean
{
	public GaitReEducationVoBean()
	{
	}
	public GaitReEducationVoBean(ims.therapies.vo.GaitReEducationVo vo)
	{
		this.id = vo.getBoId();
		...
		this.gaitaspect = vo.getGaitAspect() == null ? null : vo.getGaitAspect().getBeanCollection();
		this.details = vo.getDetails();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.GaitReEducationVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.therapies.vo.GaitReEducationVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.therapies.vo.GaitReEducationVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.therapies.vo.GaitReEducationVo vo = null;
		if(map != null)
			vo = (ims.therapies.vo.GaitReEducationVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.therapies.vo.GaitReEducationVo();
	...
	public java.util.Collection getGaitAspect()
	{
		return this.gaitaspect;
	}
	public void setGaitAspect(java.util.Collection value)
	{
		this.gaitaspect = value;
	}
	public void addGaitAspect(java.util.Collection value)
	{
		if(this.gaitaspect == null)
			this.gaitaspect = new java.util.ArrayList();
		this.gaitaspect.add(value);
	}
	...
	private java.util.Collection gaitaspect;
