...
public class RemedialShortVoBean extends ims.vo.ValueObjectBean
{
	public RemedialShortVoBean()
	{
	}
	public RemedialShortVoBean(ims.therapies.vo.RemedialShortVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.RemedialShortVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.clinicalcontact = vo.getClinicalContact() == null ? null : new ims.vo.RefVoBean(vo.getClinicalContact().getBoId(), vo.getClinicalContact().getBoVersion());
	...
	public ims.therapies.vo.RemedialShortVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.therapies.vo.RemedialShortVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.therapies.vo.RemedialShortVo vo = null;
		if(map != null)
			vo = (ims.therapies.vo.RemedialShortVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.therapies.vo.RemedialShortVo();
