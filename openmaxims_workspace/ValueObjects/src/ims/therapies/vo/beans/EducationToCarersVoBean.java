...
public class EducationToCarersVoBean extends ims.vo.ValueObjectBean
{
	public EducationToCarersVoBean()
	{
	}
	public EducationToCarersVoBean(ims.therapies.vo.EducationToCarersVo vo)
	{
		this.id = vo.getBoId();
		...
		this.carer = vo.getCarer() == null ? null : (ims.vo.LookupInstanceBean)vo.getCarer().getBean();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.EducationToCarersVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.authoringdatetime = vo.getAuthoringDateTime() == null ? null : (ims.framework.utils.beans.DateTimeBean)vo.getAuthoringDateTime().getBean();
	...
	public ims.therapies.vo.EducationToCarersVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.therapies.vo.EducationToCarersVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.therapies.vo.EducationToCarersVo vo = null;
		if(map != null)
			vo = (ims.therapies.vo.EducationToCarersVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.therapies.vo.EducationToCarersVo();
	...
	public ims.vo.LookupInstanceBean getCarer()
	{
		return this.carer;
	}
	public void setCarer(ims.vo.LookupInstanceBean value)
	{
		this.carer = value;
	}
	...
	private ims.vo.LookupInstanceBean carer;
