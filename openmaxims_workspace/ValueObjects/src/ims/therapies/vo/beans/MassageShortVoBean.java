...
public class MassageShortVoBean extends ims.vo.ValueObjectBean
{
	public MassageShortVoBean()
	{
	}
	public MassageShortVoBean(ims.therapies.vo.MassageShortVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.MassageShortVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.therapies.vo.MassageShortVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.therapies.vo.MassageShortVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.therapies.vo.MassageShortVo vo = null;
		if(map != null)
			vo = (ims.therapies.vo.MassageShortVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.therapies.vo.MassageShortVo();
