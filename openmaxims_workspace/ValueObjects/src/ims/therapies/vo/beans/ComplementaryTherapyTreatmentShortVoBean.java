...
public class ComplementaryTherapyTreatmentShortVoBean extends ims.vo.ValueObjectBean
{
	public ComplementaryTherapyTreatmentShortVoBean()
	{
	}
	public ComplementaryTherapyTreatmentShortVoBean(ims.therapies.vo.ComplementaryTherapyTreatmentShortVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.ComplementaryTherapyTreatmentShortVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.therapies.vo.ComplementaryTherapyTreatmentShortVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.therapies.vo.ComplementaryTherapyTreatmentShortVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.therapies.vo.ComplementaryTherapyTreatmentShortVo vo = null;
		if(map != null)
			vo = (ims.therapies.vo.ComplementaryTherapyTreatmentShortVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.therapies.vo.ComplementaryTherapyTreatmentShortVo();
