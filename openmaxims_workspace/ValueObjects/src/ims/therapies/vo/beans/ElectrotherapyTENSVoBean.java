...
public class ElectrotherapyTENSVoBean extends ims.vo.ValueObjectBean
{
	public ElectrotherapyTENSVoBean()
	{
	}
	public ElectrotherapyTENSVoBean(ims.therapies.vo.ElectrotherapyTENSVo vo)
	{
		this.id = vo.getBoId();
		...
		this.tenstreatments = vo.getTensTreatments() == null ? null : vo.getTensTreatments().getBeanCollection();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.ElectrotherapyTENSVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.therapies.vo.ElectrotherapyTENSVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.therapies.vo.ElectrotherapyTENSVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.therapies.vo.ElectrotherapyTENSVo vo = null;
		if(map != null)
			vo = (ims.therapies.vo.ElectrotherapyTENSVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.therapies.vo.ElectrotherapyTENSVo();
	...
	public ims.therapies.vo.beans.ElectrotherapyTensTreatmentVoBean[] getTensTreatments()
	{
		return this.tenstreatments;
	}
	public void setTensTreatments(ims.therapies.vo.beans.ElectrotherapyTensTreatmentVoBean[] value)
	{
	...
	private ims.therapies.vo.beans.ElectrotherapyTensTreatmentVoBean[] tenstreatments;
}
