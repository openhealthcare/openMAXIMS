...
public class RemedialVoBean extends ims.vo.ValueObjectBean
{
	public RemedialVoBean()
	{
	}
	public RemedialVoBean(ims.therapies.vo.RemedialVo vo)
	{
		this.id = vo.getBoId();
		...
		this.remediallocation = vo.getRemedialLocation() == null ? null : (ims.vo.LookupInstanceBean)vo.getRemedialLocation().getBean();
		this.remedialactivity = vo.getRemedialActivity() == null ? null : vo.getRemedialActivity().getBeanCollection();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.RemedialVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.therapies.vo.RemedialVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.therapies.vo.RemedialVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.therapies.vo.RemedialVo vo = null;
		if(map != null)
			vo = (ims.therapies.vo.RemedialVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.therapies.vo.RemedialVo();
	...
	public ims.vo.LookupInstanceBean getRemedialLocation()
	{
		return this.remediallocation;
	}
	public void setRemedialLocation(ims.vo.LookupInstanceBean value)
	{
		this.remediallocation = value;
	}
	public ims.therapies.vo.beans.RemedialActivityVoBean[] getRemedialActivity()
	{
		return this.remedialactivity;
	}
	public void setRemedialActivity(ims.therapies.vo.beans.RemedialActivityVoBean[] value)
	{
	...
	private ims.vo.LookupInstanceBean remediallocation;
	private ims.therapies.vo.beans.RemedialActivityVoBean[] remedialactivity;
}
