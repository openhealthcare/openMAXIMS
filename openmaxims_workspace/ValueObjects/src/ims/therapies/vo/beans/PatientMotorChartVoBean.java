...
public class PatientMotorChartVoBean extends ims.vo.ValueObjectBean
{
	public PatientMotorChartVoBean()
	{
	}
	public PatientMotorChartVoBean(ims.therapies.vo.PatientMotorChartVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.PatientMotorChartVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.therapies.vo.PatientMotorChartVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.therapies.vo.PatientMotorChartVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.therapies.vo.PatientMotorChartVo vo = null;
		if(map != null)
			vo = (ims.therapies.vo.PatientMotorChartVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.therapies.vo.PatientMotorChartVo();
	...
	public ims.therapies.vo.beans.MotorChartDetailsVoBean[] getDetails()
	{
		return this.details;
	}
	public void setDetails(ims.therapies.vo.beans.MotorChartDetailsVoBean[] value)
	{
		this.details = value;
	}
	...
	private ims.therapies.vo.beans.MotorChartDetailsVoBean[] details;
