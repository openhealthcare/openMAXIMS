 ...
 */
public class ComplementaryTherapyTreatmentShortVo extends ims.therapies.treatment.vo.ComplementaryTherapyTreatmentRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public ComplementaryTherapyTreatmentShortVo()
	{
	}
	public ComplementaryTherapyTreatmentShortVo(Integer id, int version)
	{
		super(id, version);
	}
	public ComplementaryTherapyTreatmentShortVo(ims.therapies.vo.beans.ComplementaryTherapyTreatmentShortVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.beans.ComplementaryTherapyTreatmentShortVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.therapies.vo.beans.ComplementaryTherapyTreatmentShortVoBean bean = null;
		if(map != null)
			bean = (ims.therapies.vo.beans.ComplementaryTherapyTreatmentShortVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.therapies.vo.beans.ComplementaryTherapyTreatmentShortVoBean();
	...
	public Object clone()
	{
		...
		ComplementaryTherapyTreatmentShortVo clone = new ComplementaryTherapyTreatmentShortVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(ComplementaryTherapyTreatmentShortVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A ComplementaryTherapyTreatmentShortVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		ComplementaryTherapyTreatmentShortVo compareObj = (ComplementaryTherapyTreatmentShortVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
