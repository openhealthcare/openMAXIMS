 ...
 */
public class ThermalShortVo extends ims.therapies.treatment.vo.ThermalRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public ThermalShortVo()
	{
	}
	public ThermalShortVo(Integer id, int version)
	{
		super(id, version);
	}
	public ThermalShortVo(ims.therapies.vo.beans.ThermalShortVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.beans.ThermalShortVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.therapies.vo.beans.ThermalShortVoBean bean = null;
		if(map != null)
			bean = (ims.therapies.vo.beans.ThermalShortVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.therapies.vo.beans.ThermalShortVoBean();
	...
	public Object clone()
	{
		...
		ThermalShortVo clone = new ThermalShortVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(ThermalShortVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A ThermalShortVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		ThermalShortVo compareObj = (ThermalShortVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
