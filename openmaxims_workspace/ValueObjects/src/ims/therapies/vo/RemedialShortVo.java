 ...
 */
public class RemedialShortVo extends ims.therapies.treatment.vo.RemedialRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public RemedialShortVo()
	{
	}
	public RemedialShortVo(Integer id, int version)
	{
		super(id, version);
	}
	public RemedialShortVo(ims.therapies.vo.beans.RemedialShortVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.beans.RemedialShortVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.clinicalcontact = bean.getClinicalContact() == null ? null : new ims.core.admin.vo.ClinicalContactRefVo(new Integer(bean.getClinicalContact().getId()), bean.getClinicalContact().getVersion());
	...
	{
		ims.therapies.vo.beans.RemedialShortVoBean bean = null;
		if(map != null)
			bean = (ims.therapies.vo.beans.RemedialShortVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.therapies.vo.beans.RemedialShortVoBean();
	...
	public Object clone()
	{
		...
		RemedialShortVo clone = new RemedialShortVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(RemedialShortVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A RemedialShortVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((RemedialShortVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((RemedialShortVo)obj).getBoId());
	}
