 ...
 */
public class FunctionalTransfersShortVo extends ims.therapies.treatment.vo.FunctionalTransfersRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public FunctionalTransfersShortVo()
	{
	}
	public FunctionalTransfersShortVo(Integer id, int version)
	{
		super(id, version);
	}
	public FunctionalTransfersShortVo(ims.therapies.vo.beans.FunctionalTransfersShortVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.beans.FunctionalTransfersShortVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.clinicalcontact = bean.getClinicalContact() == null ? null : new ims.core.admin.vo.ClinicalContactRefVo(new Integer(bean.getClinicalContact().getId()), bean.getClinicalContact().getVersion());
	...
	{
		ims.therapies.vo.beans.FunctionalTransfersShortVoBean bean = null;
		if(map != null)
			bean = (ims.therapies.vo.beans.FunctionalTransfersShortVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.therapies.vo.beans.FunctionalTransfersShortVoBean();
	...
	public Object clone()
	{
		...
		FunctionalTransfersShortVo clone = new FunctionalTransfersShortVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(FunctionalTransfersShortVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A FunctionalTransfersShortVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((FunctionalTransfersShortVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((FunctionalTransfersShortVo)obj).getBoId());
	}
