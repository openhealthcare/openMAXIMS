 ...
 */
public class MobilisationsShortVo extends ims.therapies.treatment.vo.MobilisationsRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public MobilisationsShortVo()
	{
	}
	public MobilisationsShortVo(Integer id, int version)
	{
		super(id, version);
	}
	public MobilisationsShortVo(ims.therapies.vo.beans.MobilisationsShortVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.beans.MobilisationsShortVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.therapies.vo.beans.MobilisationsShortVoBean bean = null;
		if(map != null)
			bean = (ims.therapies.vo.beans.MobilisationsShortVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.therapies.vo.beans.MobilisationsShortVoBean();
	...
	public Object clone()
	{
		...
		MobilisationsShortVo clone = new MobilisationsShortVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(MobilisationsShortVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A MobilisationsShortVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		MobilisationsShortVo compareObj = (MobilisationsShortVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
