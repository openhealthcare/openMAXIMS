 ...
 */
public class ThermalVo extends ims.therapies.treatment.vo.ThermalRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public ThermalVo(Integer id, int version)
	{
		super(id, version);
	}
	public ThermalVo(ims.therapies.vo.beans.ThermalVoBean bean)
	{
		this.id = bean.getId();
		...
		this.thermalactivity = ims.therapies.vo.ThermalActivityVoCollection.buildFromBeanCollection(bean.getThermalActivity());
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.beans.ThermalVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.therapies.vo.beans.ThermalVoBean bean = null;
		if(map != null)
			bean = (ims.therapies.vo.beans.ThermalVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.therapies.vo.beans.ThermalVoBean();
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("THERMALACTIVITY"))
			return getThermalActivity();
	...
	public boolean getThermalActivityIsNotNull()
	{
		return this.thermalactivity != null;
	}
	public ims.therapies.vo.ThermalActivityVoCollection getThermalActivity()
	{
		return this.thermalactivity;
	}
	public void setThermalActivity(ims.therapies.vo.ThermalActivityVoCollection value)
	{
		this.isValidated = false;
		this.thermalactivity = value;
	}
	public boolean isValidated()
	{
		...
		if(this.thermalactivity != null)
		{
			if(!this.thermalactivity.isValidated())
			{
				this.isBusy = false;
				return false;
			}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.thermalactivity != null)
		{
			String[] listOfOtherErrors = this.thermalactivity.validate();
			if(listOfOtherErrors != null)
			{
				for(int x = 0; x < listOfOtherErrors.length; x++)
				{
	...
	public Object clone()
	{
		...
		ThermalVo clone = new ThermalVo(this.id, this.version);
		...
		if(this.thermalactivity == null)
			clone.thermalactivity = null;
		else
			clone.thermalactivity = (ims.therapies.vo.ThermalActivityVoCollection)this.thermalactivity.clone();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(ThermalVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A ThermalVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		ThermalVo compareObj = (ThermalVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
			if(this.getID_Thermal() == null && compareObj.getID_Thermal() != null)
				return -1;
			if(this.getID_Thermal() != null && compareObj.getID_Thermal() == null)
				return 1;
			if(this.getID_Thermal() != null && compareObj.getID_Thermal() != null)
				retVal = this.getID_Thermal().compareTo(compareObj.getID_Thermal());
		}
		return retVal;
	}
	...
	protected ims.therapies.vo.ThermalActivityVoCollection thermalactivity;
