 ...
 */
public class ElectrotherapyTENSShortVo extends ims.therapies.treatment.vo.ElectrotherapyTENSRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public ElectrotherapyTENSShortVo()
	{
	}
	public ElectrotherapyTENSShortVo(Integer id, int version)
	{
		super(id, version);
	}
	public ElectrotherapyTENSShortVo(ims.therapies.vo.beans.ElectrotherapyTENSShortVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.beans.ElectrotherapyTENSShortVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.therapies.vo.beans.ElectrotherapyTENSShortVoBean bean = null;
		if(map != null)
			bean = (ims.therapies.vo.beans.ElectrotherapyTENSShortVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.therapies.vo.beans.ElectrotherapyTENSShortVoBean();
	...
	public Object clone()
	{
		...
		ElectrotherapyTENSShortVo clone = new ElectrotherapyTENSShortVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(ElectrotherapyTENSShortVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A ElectrotherapyTENSShortVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		ElectrotherapyTENSShortVo compareObj = (ElectrotherapyTENSShortVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
