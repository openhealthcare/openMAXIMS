 ...
 */
public class HandRangeOfMovementLiteVo extends ims.therapies.hand.vo.HandRangeOfMovementRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public HandRangeOfMovementLiteVo()
	{
	}
	public HandRangeOfMovementLiteVo(Integer id, int version)
	{
		super(id, version);
	}
	public HandRangeOfMovementLiteVo(ims.therapies.vo.beans.HandRangeOfMovementLiteVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.beans.HandRangeOfMovementLiteVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.authoringdatetime = bean.getAuthoringDateTime() == null ? null : bean.getAuthoringDateTime().buildDateTime();
	...
	{
		ims.therapies.vo.beans.HandRangeOfMovementLiteVoBean bean = null;
		if(map != null)
			bean = (ims.therapies.vo.beans.HandRangeOfMovementLiteVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.therapies.vo.beans.HandRangeOfMovementLiteVoBean();
	...
	public ims.therapies.vo.lookups.DominantHand getDominantHand()
	{
		return this.dominanthand;
	}
	public void setDominantHand(ims.therapies.vo.lookups.DominantHand value)
	{
		this.isValidated = false;
	...
	public Object clone()
	{
		...
		HandRangeOfMovementLiteVo clone = new HandRangeOfMovementLiteVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(HandRangeOfMovementLiteVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A HandRangeOfMovementLiteVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((HandRangeOfMovementLiteVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((HandRangeOfMovementLiteVo)obj).getBoId());
	}
	...
	protected ims.therapies.vo.lookups.DominantHand dominanthand;
