 ...
 */
public class ElectrotherapyPneumaticVo extends ims.therapies.treatment.vo.ElectrotherapyPneumaticRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public ElectrotherapyPneumaticVo()
	{
	}
	public ElectrotherapyPneumaticVo(Integer id, int version)
	{
		super(id, version);
	}
	public ElectrotherapyPneumaticVo(ims.therapies.vo.beans.ElectrotherapyPneumaticVoBean bean)
	{
		this.id = bean.getId();
		...
		this.pneumatictreatment = ims.therapies.vo.ElectrotherapyPneumaticTreatmentVoCollection.buildFromBeanCollection(bean.getPneumaticTreatment());
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.beans.ElectrotherapyPneumaticVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.authoringdatetime = bean.getAuthoringDateTime() == null ? null : bean.getAuthoringDateTime().buildDateTime();
	...
	{
		ims.therapies.vo.beans.ElectrotherapyPneumaticVoBean bean = null;
		if(map != null)
			bean = (ims.therapies.vo.beans.ElectrotherapyPneumaticVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.therapies.vo.beans.ElectrotherapyPneumaticVoBean();
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("PNEUMATICTREATMENT"))
			return getPneumaticTreatment();
	...
	public boolean getPneumaticTreatmentIsNotNull()
	{
		return this.pneumatictreatment != null;
	}
	public ims.therapies.vo.ElectrotherapyPneumaticTreatmentVoCollection getPneumaticTreatment()
	{
		return this.pneumatictreatment;
	}
	public void setPneumaticTreatment(ims.therapies.vo.ElectrotherapyPneumaticTreatmentVoCollection value)
	{
		this.isValidated = false;
	...
	public boolean isValidated()
	{
		...
		if(this.pneumatictreatment != null)
		{
			if(!this.pneumatictreatment.isValidated())
			{
				this.isBusy = false;
				return false;
			}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.pneumatictreatment != null)
		{
			String[] listOfOtherErrors = this.pneumatictreatment.validate();
			if(listOfOtherErrors != null)
			{
				for(int x = 0; x < listOfOtherErrors.length; x++)
				{
	...
	public Object clone()
	{
		...
		ElectrotherapyPneumaticVo clone = new ElectrotherapyPneumaticVo(this.id, this.version);
		...
		if(this.pneumatictreatment == null)
			clone.pneumatictreatment = null;
		else
			clone.pneumatictreatment = (ims.therapies.vo.ElectrotherapyPneumaticTreatmentVoCollection)this.pneumatictreatment.clone();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(ElectrotherapyPneumaticVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A ElectrotherapyPneumaticVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		ElectrotherapyPneumaticVo compareObj = (ElectrotherapyPneumaticVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
	...
	protected ims.therapies.vo.ElectrotherapyPneumaticTreatmentVoCollection pneumatictreatment;
