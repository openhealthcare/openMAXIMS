 ...
 */
public class BobathVo extends ims.therapies.treatment.vo.BobathRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public BobathVo(Integer id, int version)
	{
		super(id, version);
	}
	public BobathVo(ims.therapies.vo.beans.BobathVoBean bean)
	{
		this.id = bean.getId();
		...
		this.bobathtreatment = ims.therapies.vo.BobathTreatmentVoCollection.buildFromBeanCollection(bean.getBobathTreatment());
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.beans.BobathVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.therapies.vo.beans.BobathVoBean bean = null;
		if(map != null)
			bean = (ims.therapies.vo.beans.BobathVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.therapies.vo.beans.BobathVoBean();
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("BOBATHTREATMENT"))
			return getBobathTreatment();
	...
	public boolean getBobathTreatmentIsNotNull()
	{
		return this.bobathtreatment != null;
	}
	public ims.therapies.vo.BobathTreatmentVoCollection getBobathTreatment()
	{
		return this.bobathtreatment;
	}
	public void setBobathTreatment(ims.therapies.vo.BobathTreatmentVoCollection value)
	{
		this.isValidated = false;
		this.bobathtreatment = value;
	}
	public boolean isValidated()
	{
		...
		if(this.bobathtreatment != null)
		{
			if(!this.bobathtreatment.isValidated())
			{
				this.isBusy = false;
				return false;
			}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.bobathtreatment == null || this.bobathtreatment.size() == 0)
			listOfErrors.add("BobathTreatment are mandatory");
		if(this.bobathtreatment != null)
		{
			String[] listOfOtherErrors = this.bobathtreatment.validate();
			if(listOfOtherErrors != null)
			{
				for(int x = 0; x < listOfOtherErrors.length; x++)
				{
	...
	public Object clone()
	{
		...
		BobathVo clone = new BobathVo(this.id, this.version);
		...
		if(this.bobathtreatment == null)
			clone.bobathtreatment = null;
		else
			clone.bobathtreatment = (ims.therapies.vo.BobathTreatmentVoCollection)this.bobathtreatment.clone();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(BobathVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A BobathVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		BobathVo compareObj = (BobathVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
	...
	protected ims.therapies.vo.BobathTreatmentVoCollection bobathtreatment;
