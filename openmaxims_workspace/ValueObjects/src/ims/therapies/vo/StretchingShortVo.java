 ...
 */
public class StretchingShortVo extends ims.therapies.treatment.vo.StretchingRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public StretchingShortVo()
	{
	}
	public StretchingShortVo(Integer id, int version)
	{
		super(id, version);
	}
	public StretchingShortVo(ims.therapies.vo.beans.StretchingShortVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.therapies.vo.beans.StretchingShortVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.therapies.vo.beans.StretchingShortVoBean bean = null;
		if(map != null)
			bean = (ims.therapies.vo.beans.StretchingShortVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.therapies.vo.beans.StretchingShortVoBean();
	...
	public Object clone()
	{
		...
		StretchingShortVo clone = new StretchingShortVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(StretchingShortVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A StretchingShortVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		StretchingShortVo compareObj = (StretchingShortVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
