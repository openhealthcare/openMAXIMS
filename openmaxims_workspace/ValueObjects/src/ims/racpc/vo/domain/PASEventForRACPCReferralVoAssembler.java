 ...
 */
public class PASEventForRACPCReferralVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.racpc.vo.PASEventForRACPCReferralVo copy(ims.racpc.vo.PASEventForRACPCReferralVo valueObjectDest, ims.racpc.vo.PASEventForRACPCReferralVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createPASEventForRACPCReferralVoCollectionFromPASEvent(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.admin.pas.domain.objects.PASEvent objects.
	 */
	public static ims.racpc.vo.PASEventForRACPCReferralVoCollection createPASEventForRACPCReferralVoCollectionFromPASEvent(java.util.Set domainObjectSet)	
	{
		return createPASEventForRACPCReferralVoCollectionFromPASEvent(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.admin.pas.domain.objects.PASEvent objects.
	 */
	public static ims.racpc.vo.PASEventForRACPCReferralVoCollection createPASEventForRACPCReferralVoCollectionFromPASEvent(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.racpc.vo.PASEventForRACPCReferralVoCollection voList = new ims.racpc.vo.PASEventForRACPCReferralVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.racpc.vo.PASEventForRACPCReferralVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.racpc.vo.PASEventForRACPCReferralVoCollection createPASEventForRACPCReferralVoCollectionFromPASEvent(java.util.List domainObjectList) 
	{
		return createPASEventForRACPCReferralVoCollectionFromPASEvent(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.admin.pas.domain.objects.PASEvent objects.
	 */
	public static ims.racpc.vo.PASEventForRACPCReferralVoCollection createPASEventForRACPCReferralVoCollectionFromPASEvent(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.racpc.vo.PASEventForRACPCReferralVoCollection voList = new ims.racpc.vo.PASEventForRACPCReferralVoCollection();
	 ...
	 */
	 public static java.util.Set extractPASEventSet(ims.domain.ILightweightDomainFactory domainFactory, ims.racpc.vo.PASEventForRACPCReferralVoCollection voCollection) 
	 {
	 	return extractPASEventSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPASEventSet(ims.domain.ILightweightDomainFactory domainFactory, ims.racpc.vo.PASEventForRACPCReferralVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.racpc.vo.PASEventForRACPCReferralVo vo = voCollection.get(i);
			ims.core.admin.pas.domain.objects.PASEvent domainObject = PASEventForRACPCReferralVoAssembler.extractPASEvent(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPASEventList(ims.domain.ILightweightDomainFactory domainFactory, ims.racpc.vo.PASEventForRACPCReferralVoCollection voCollection) 
	 {
	 	return extractPASEventList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPASEventList(ims.domain.ILightweightDomainFactory domainFactory, ims.racpc.vo.PASEventForRACPCReferralVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.racpc.vo.PASEventForRACPCReferralVo create(ims.core.admin.pas.domain.objects.PASEvent domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.racpc.vo.PASEventForRACPCReferralVo create(DomainObjectMap map, ims.core.admin.pas.domain.objects.PASEvent domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.racpc.vo.PASEventForRACPCReferralVo valueObject = (ims.racpc.vo.PASEventForRACPCReferralVo) map.getValueObject(domainObject, ims.racpc.vo.PASEventForRACPCReferralVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.racpc.vo.PASEventForRACPCReferralVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.admin.pas.domain.objects.PASEvent
	 */
	 public static ims.racpc.vo.PASEventForRACPCReferralVo insert(ims.racpc.vo.PASEventForRACPCReferralVo valueObject, ims.core.admin.pas.domain.objects.PASEvent domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.admin.pas.domain.objects.PASEvent
	 */
	 public static ims.racpc.vo.PASEventForRACPCReferralVo insert(DomainObjectMap map, ims.racpc.vo.PASEventForRACPCReferralVo valueObject, ims.core.admin.pas.domain.objects.PASEvent domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		if ( null != instance2 ) {
			...
			valueObject.setSourceOfReferral(voLookup2);
				...
				// referringGP
		valueObject.setReferringGP(ims.racpc.vo.domain.GPForRACPCReferralVoAssembler.create(map, domainObject.getReferringGP()) );
		// EventType
	 ...
	 */
	public static ims.core.admin.pas.domain.objects.PASEvent extractPASEvent(ims.domain.ILightweightDomainFactory domainFactory, ims.racpc.vo.PASEventForRACPCReferralVo valueObject) 
	{
		return 	extractPASEvent(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.admin.pas.domain.objects.PASEvent extractPASEvent(ims.domain.ILightweightDomainFactory domainFactory, ims.racpc.vo.PASEventForRACPCReferralVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.racpc.vo.PASEventForRACPCReferralVo ID_PASEvent field is unknown
