 ...
 */
public class PatientHandlingHeader extends ims.core.vo.AssessmentVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public PatientHandlingHeader()
	{
	}
	public PatientHandlingHeader(Integer id, int version)
	{
		super(id, version);
	}
	public PatientHandlingHeader(ims.coe.vo.beans.PatientHandlingHeaderBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.coe.vo.beans.PatientHandlingHeaderBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.coe.vo.beans.PatientHandlingHeaderBean bean = null;
		if(map != null)
			bean = (ims.coe.vo.beans.PatientHandlingHeaderBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.coe.vo.beans.PatientHandlingHeaderBean();
	...
	public Object clone()
	{
		...
		PatientHandlingHeader clone = new PatientHandlingHeader(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(PatientHandlingHeader.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A PatientHandlingHeader object cannot be compared an Object of type " + obj.getClass().getName());
		}
		PatientHandlingHeader compareObj = (PatientHandlingHeader)obj;
		int retVal = 0;
		if (retVal == 0)
		{
