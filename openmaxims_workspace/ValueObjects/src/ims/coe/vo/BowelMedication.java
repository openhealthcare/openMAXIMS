 ...
 */
public class BowelMedication extends ims.coe.assessment.vo.BowelMedicationRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public BowelMedication(Integer id, int version)
	{
		super(id, version);
	}
	public BowelMedication(ims.coe.vo.beans.BowelMedicationBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.medication = bean.getMedication() == null ? null : ims.coe.vo.lookups.BowelMedication.buildLookup(bean.getMedication());
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.coe.vo.beans.BowelMedicationBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.medication = bean.getMedication() == null ? null : ims.coe.vo.lookups.BowelMedication.buildLookup(bean.getMedication());
	...
	{
		ims.coe.vo.beans.BowelMedicationBean bean = null;
		if(map != null)
			bean = (ims.coe.vo.beans.BowelMedicationBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.coe.vo.beans.BowelMedicationBean();
	...
	public ims.coe.vo.lookups.BowelMedication getMedication()
	{
		return this.medication;
	}
	public void setMedication(ims.coe.vo.lookups.BowelMedication value)
	{
	...
	public Object clone()
	{
		...
		BowelMedication clone = new BowelMedication(this.id, this.version);
		
		if(this.medication == null)
			clone.medication = null;
		else
			clone.medication = (ims.coe.vo.lookups.BowelMedication)this.medication.clone();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(BowelMedication.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A BowelMedication object cannot be compared an Object of type " + obj.getClass().getName());
		}
		BowelMedication compareObj = (BowelMedication)obj;
		int retVal = 0;
		if (retVal == 0)
		{
	...
	protected ims.coe.vo.lookups.BowelMedication medication;
