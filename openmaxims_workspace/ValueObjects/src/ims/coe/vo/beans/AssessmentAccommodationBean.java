...
public class AssessmentAccommodationBean extends ims.vo.ValueObjectBean
{
	public AssessmentAccommodationBean()
	{
	}
	public AssessmentAccommodationBean(ims.coe.vo.AssessmentAccommodation vo)
	{
		this.id = vo.getBoId();
		...
		this.homefacilities = vo.getHomeFacilities() == null ? null : vo.getHomeFacilities().getBeanCollection();
		this.accommodationhousing = vo.getAccommodationHousing() == null ? null : (ims.coe.vo.beans.AccommodationHousingVoBean)vo.getAccommodationHousing().getBean();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.coe.vo.AssessmentAccommodation vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.iscomplete = vo.getIsComplete();
		...
		this.careplans = vo.getCarePlans() == null ? null : vo.getCarePlans().getBeanCollection();
		this.homefacilities = vo.getHomeFacilities() == null ? null : vo.getHomeFacilities().getBeanCollection();
		this.accommodationhousing = vo.getAccommodationHousing() == null ? null : (ims.coe.vo.beans.AccommodationHousingVoBean)vo.getAccommodationHousing().getBean(map);
	}

	public ims.coe.vo.AssessmentAccommodation buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.coe.vo.AssessmentAccommodation buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.coe.vo.AssessmentAccommodation vo = null;
		if(map != null)
			vo = (ims.coe.vo.AssessmentAccommodation)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.coe.vo.AssessmentAccommodation();
	...
	public ims.coe.vo.beans.AccommodationHomeFacilitiesBean[] getHomeFacilities()
	{
		return this.homefacilities;
	}
	public void setHomeFacilities(ims.coe.vo.beans.AccommodationHomeFacilitiesBean[] value)
	{
		this.homefacilities = value;
	}
	public ims.coe.vo.beans.AccommodationHousingVoBean getAccommodationHousing()
	{
		return this.accommodationhousing;
	}
	public void setAccommodationHousing(ims.coe.vo.beans.AccommodationHousingVoBean value)
	{
	...
	private ims.coe.vo.beans.AccommodationHomeFacilitiesBean[] homefacilities;
	private ims.coe.vo.beans.AccommodationHousingVoBean accommodationhousing;
}
