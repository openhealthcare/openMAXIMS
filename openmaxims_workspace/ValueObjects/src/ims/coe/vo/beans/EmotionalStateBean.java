...
public class EmotionalStateBean extends ims.vo.ValueObjectBean
{
	public EmotionalStateBean()
	{
	}
	public EmotionalStateBean(ims.coe.vo.EmotionalState vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.coe.vo.EmotionalState vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.assessment = vo.getAssessment() == null ? null : (ims.vo.LookupInstanceBean)vo.getAssessment().getBean();
	...
	public ims.coe.vo.EmotionalState buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.coe.vo.EmotionalState buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.coe.vo.EmotionalState vo = null;
		if(map != null)
			vo = (ims.coe.vo.EmotionalState)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.coe.vo.EmotionalState();
