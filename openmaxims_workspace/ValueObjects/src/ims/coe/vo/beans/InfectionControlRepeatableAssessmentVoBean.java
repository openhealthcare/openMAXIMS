...
public class InfectionControlRepeatableAssessmentVoBean extends ims.vo.ValueObjectBean
{
	public InfectionControlRepeatableAssessmentVoBean()
	{
	}
	public InfectionControlRepeatableAssessmentVoBean(ims.coe.vo.InfectionControlRepeatableAssessmentVo vo)
	{
		this.id = vo.getBoId();
		...
		this.infectioncontroldetails = vo.getInfectionControlDetails() == null ? null : vo.getInfectionControlDetails().getBeanCollection();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.coe.vo.InfectionControlRepeatableAssessmentVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.coe.vo.InfectionControlRepeatableAssessmentVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.coe.vo.InfectionControlRepeatableAssessmentVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.coe.vo.InfectionControlRepeatableAssessmentVo vo = null;
		if(map != null)
			vo = (ims.coe.vo.InfectionControlRepeatableAssessmentVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.coe.vo.InfectionControlRepeatableAssessmentVo();
	...
	public ims.coe.vo.beans.InfectionControlDetailsVoBean[] getInfectionControlDetails()
	{
		return this.infectioncontroldetails;
	}
	public void setInfectionControlDetails(ims.coe.vo.beans.InfectionControlDetailsVoBean[] value)
	{
	...
	private ims.coe.vo.beans.InfectionControlDetailsVoBean[] infectioncontroldetails;
}
