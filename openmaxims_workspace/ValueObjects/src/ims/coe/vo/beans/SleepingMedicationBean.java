...
public class SleepingMedicationBean extends ims.vo.ValueObjectBean
{
	public SleepingMedicationBean()
	{
	}
	public SleepingMedicationBean(ims.coe.vo.SleepingMedication vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.sleepmedication = vo.getSleepMedication() == null ? null : (ims.vo.LookupInstanceBean)vo.getSleepMedication().getBean();
		...
		this.takenwhen = vo.getTakenWhen();
		this.effectivefor = vo.getEffectiveFor();
		this.iscurrentlyactive = vo.getIsCurrentlyActive();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.coe.vo.SleepingMedication vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.sleepmedication = vo.getSleepMedication() == null ? null : (ims.vo.LookupInstanceBean)vo.getSleepMedication().getBean();
	...
	public ims.coe.vo.SleepingMedication buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.coe.vo.SleepingMedication buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.coe.vo.SleepingMedication vo = null;
		if(map != null)
			vo = (ims.coe.vo.SleepingMedication)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.coe.vo.SleepingMedication();
	...
	public ims.vo.LookupInstanceBean getSleepMedication()
	{
		return this.sleepmedication;
	}
	public void setSleepMedication(ims.vo.LookupInstanceBean value)
	{
	...
	private Integer id;
	private int version;
	private ims.vo.LookupInstanceBean sleepmedication;
