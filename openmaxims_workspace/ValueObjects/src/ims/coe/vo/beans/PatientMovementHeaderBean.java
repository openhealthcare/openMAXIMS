...
public class PatientMovementHeaderBean extends ims.vo.ValueObjectBean
{
	public PatientMovementHeaderBean()
	{
	}
	public PatientMovementHeaderBean(ims.coe.vo.PatientMovementHeader vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.coe.vo.PatientMovementHeader vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.coe.vo.PatientMovementHeader buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.coe.vo.PatientMovementHeader buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.coe.vo.PatientMovementHeader vo = null;
		if(map != null)
			vo = (ims.coe.vo.PatientMovementHeader)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.coe.vo.PatientMovementHeader();
