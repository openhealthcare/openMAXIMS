...
public class AssessmentLeisureBean extends ims.vo.ValueObjectBean
{
	public AssessmentLeisureBean()
	{
	}
	public AssessmentLeisureBean(ims.coe.vo.AssessmentLeisure vo)
	{
		this.id = vo.getBoId();
		...
		this.leisureclubs = vo.getLeisureClubs() == null ? null : vo.getLeisureClubs().getBeanCollection();
		this.hobbies = vo.getHobbies();
		this.enjoydoingmost = vo.getEnjoyDoingMost();
		this.preferencesoftime = vo.getPreferencesOfTime();
		this.alcoholsocially = vo.getAlcoholSocially() == null ? null : (ims.vo.LookupInstanceBean)vo.getAlcoholSocially().getBean();
		this.alcoholdetails = vo.getAlcoholDetails();
		this.alcoholunits = vo.getAlcoholUnits();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.coe.vo.AssessmentLeisure vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.iscomplete = vo.getIsComplete();
	...
	public ims.coe.vo.AssessmentLeisure buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.coe.vo.AssessmentLeisure buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.coe.vo.AssessmentLeisure vo = null;
		if(map != null)
			vo = (ims.coe.vo.AssessmentLeisure)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.coe.vo.AssessmentLeisure();
	...
	public ims.coe.vo.beans.LeisureClubBean[] getLeisureClubs()
	{
		return this.leisureclubs;
	}
	public void setLeisureClubs(ims.coe.vo.beans.LeisureClubBean[] value)
	{
	...
	public ims.vo.LookupInstanceBean getAlcoholSocially()
	{
		return this.alcoholsocially;
	}
	public void setAlcoholSocially(ims.vo.LookupInstanceBean value)
	{
	...
	private ims.coe.vo.beans.LeisureClubBean[] leisureclubs;
	private String hobbies;
	private String enjoydoingmost;
	private String preferencesoftime;
	private ims.vo.LookupInstanceBean alcoholsocially;
