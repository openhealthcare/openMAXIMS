...
public class PatientHandlingHeaderBean extends ims.vo.ValueObjectBean
{
	public PatientHandlingHeaderBean()
	{
	}
	public PatientHandlingHeaderBean(ims.coe.vo.PatientHandlingHeader vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.coe.vo.PatientHandlingHeader vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.coe.vo.PatientHandlingHeader buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.coe.vo.PatientHandlingHeader buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.coe.vo.PatientHandlingHeader vo = null;
		if(map != null)
			vo = (ims.coe.vo.PatientHandlingHeader)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.coe.vo.PatientHandlingHeader();
