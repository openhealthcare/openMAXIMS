...
public class AssessmentActivityLevelBean extends ims.vo.ValueObjectBean
{
	public AssessmentActivityLevelBean()
	{
	}
	public AssessmentActivityLevelBean(ims.coe.vo.AssessmentActivityLevel vo)
	{
		this.id = vo.getBoId();
		...
		this.activitydetails = vo.getActivityDetails() == null ? null : vo.getActivityDetails().getBeanCollection();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.coe.vo.AssessmentActivityLevel vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.iscomplete = vo.getIsComplete();
	...
	public ims.coe.vo.AssessmentActivityLevel buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.coe.vo.AssessmentActivityLevel buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.coe.vo.AssessmentActivityLevel vo = null;
		if(map != null)
			vo = (ims.coe.vo.AssessmentActivityLevel)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.coe.vo.AssessmentActivityLevel();
	...
	public ims.coe.vo.beans.ActivityLevelDetailsBean[] getActivityDetails()
	{
		return this.activitydetails;
	}
	public void setActivityDetails(ims.coe.vo.beans.ActivityLevelDetailsBean[] value)
	{
	...
	private ims.coe.vo.beans.ActivityLevelDetailsBean[] activitydetails;
}
