 ...
 * @author John MacEnri
 */
public class PatientHandlingHeaderAssembler
{
  	/**
	 ...
	 */
	 public static ims.coe.vo.PatientHandlingHeader copy(ims.coe.vo.PatientHandlingHeader valueObjectDest, ims.coe.vo.PatientHandlingHeader valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createPatientHandlingHeaderCollectionFromPatientMovementHandlingScreening(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.coe.assessmenttools.domain.objects.PatientMovementHandlingScreening objects.
	 */
	public static ims.coe.vo.PatientHandlingHeaderCollection createPatientHandlingHeaderCollectionFromPatientMovementHandlingScreening(java.util.Set domainObjectSet)	
	{
		return createPatientHandlingHeaderCollectionFromPatientMovementHandlingScreening(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.coe.assessmenttools.domain.objects.PatientMovementHandlingScreening objects.
	 */
	public static ims.coe.vo.PatientHandlingHeaderCollection createPatientHandlingHeaderCollectionFromPatientMovementHandlingScreening(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.coe.vo.PatientHandlingHeaderCollection voList = new ims.coe.vo.PatientHandlingHeaderCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.coe.vo.PatientHandlingHeader vo = create(map, domainObject);
	 ...
	 */
	public static ims.coe.vo.PatientHandlingHeaderCollection createPatientHandlingHeaderCollectionFromPatientMovementHandlingScreening(java.util.List domainObjectList) 
	{
		return createPatientHandlingHeaderCollectionFromPatientMovementHandlingScreening(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.coe.assessmenttools.domain.objects.PatientMovementHandlingScreening objects.
	 */
	public static ims.coe.vo.PatientHandlingHeaderCollection createPatientHandlingHeaderCollectionFromPatientMovementHandlingScreening(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.coe.vo.PatientHandlingHeaderCollection voList = new ims.coe.vo.PatientHandlingHeaderCollection();
	 ...
	 */
	 public static java.util.Set extractPatientMovementHandlingScreeningSet(ims.domain.ILightweightDomainFactory domainFactory, ims.coe.vo.PatientHandlingHeaderCollection voCollection) 
	 {
	 	return extractPatientMovementHandlingScreeningSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientMovementHandlingScreeningSet(ims.domain.ILightweightDomainFactory domainFactory, ims.coe.vo.PatientHandlingHeaderCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.coe.vo.PatientHandlingHeader vo = voCollection.get(i);
			ims.coe.assessmenttools.domain.objects.PatientMovementHandlingScreening domainObject = PatientHandlingHeaderAssembler.extractPatientMovementHandlingScreening(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPatientMovementHandlingScreeningList(ims.domain.ILightweightDomainFactory domainFactory, ims.coe.vo.PatientHandlingHeaderCollection voCollection) 
	 {
	 	return extractPatientMovementHandlingScreeningList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPatientMovementHandlingScreeningList(ims.domain.ILightweightDomainFactory domainFactory, ims.coe.vo.PatientHandlingHeaderCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.coe.vo.PatientHandlingHeader create(ims.coe.assessmenttools.domain.objects.PatientMovementHandlingScreening domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.coe.vo.PatientHandlingHeader create(DomainObjectMap map, ims.coe.assessmenttools.domain.objects.PatientMovementHandlingScreening domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.coe.vo.PatientHandlingHeader valueObject = (ims.coe.vo.PatientHandlingHeader) map.getValueObject(domainObject, ims.coe.vo.PatientHandlingHeader.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.coe.vo.PatientHandlingHeader(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.coe.assessmenttools.domain.objects.PatientMovementHandlingScreening
	 */
	 public static ims.coe.vo.PatientHandlingHeader insert(ims.coe.vo.PatientHandlingHeader valueObject, ims.coe.assessmenttools.domain.objects.PatientMovementHandlingScreening domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.coe.assessmenttools.domain.objects.PatientMovementHandlingScreening
	 */
	 public static ims.coe.vo.PatientHandlingHeader insert(DomainObjectMap map, ims.coe.vo.PatientHandlingHeader valueObject, ims.coe.assessmenttools.domain.objects.PatientMovementHandlingScreening domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.coe.assessmenttools.domain.objects.PatientMovementHandlingScreening extractPatientMovementHandlingScreening(ims.domain.ILightweightDomainFactory domainFactory, ims.coe.vo.PatientHandlingHeader valueObject) 
	{
		return 	extractPatientMovementHandlingScreening(domainFactory, valueObject, new HashMap());
	}

	public static ims.coe.assessmenttools.domain.objects.PatientMovementHandlingScreening extractPatientMovementHandlingScreening(ims.domain.ILightweightDomainFactory domainFactory, ims.coe.vo.PatientHandlingHeader valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.coe.vo.PatientHandlingHeader ID_PatientMovementHandlingScreening field is unknown
