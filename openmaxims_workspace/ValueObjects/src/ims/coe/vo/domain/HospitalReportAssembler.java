 ...
 */
public class HospitalReportAssembler
{
  	/**
	 ...
	 */
	 public static ims.coe.vo.HospitalReport copy(ims.coe.vo.HospitalReport valueObjectDest, ims.coe.vo.HospitalReport valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createHospitalReportCollectionFromClinicalNotes(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.clinical.domain.objects.ClinicalNotes objects.
	 */
	public static ims.coe.vo.HospitalReportCollection createHospitalReportCollectionFromClinicalNotes(java.util.Set domainObjectSet)	
	{
		return createHospitalReportCollectionFromClinicalNotes(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.clinical.domain.objects.ClinicalNotes objects.
	 */
	public static ims.coe.vo.HospitalReportCollection createHospitalReportCollectionFromClinicalNotes(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.coe.vo.HospitalReportCollection voList = new ims.coe.vo.HospitalReportCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.coe.vo.HospitalReport vo = create(map, domainObject);
	 ...
	 */
	public static ims.coe.vo.HospitalReportCollection createHospitalReportCollectionFromClinicalNotes(java.util.List domainObjectList) 
	{
		return createHospitalReportCollectionFromClinicalNotes(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.clinical.domain.objects.ClinicalNotes objects.
	 */
	public static ims.coe.vo.HospitalReportCollection createHospitalReportCollectionFromClinicalNotes(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.coe.vo.HospitalReportCollection voList = new ims.coe.vo.HospitalReportCollection();
	 ...
	 */
	 public static java.util.Set extractClinicalNotesSet(ims.domain.ILightweightDomainFactory domainFactory, ims.coe.vo.HospitalReportCollection voCollection) 
	 {
	 	return extractClinicalNotesSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractClinicalNotesSet(ims.domain.ILightweightDomainFactory domainFactory, ims.coe.vo.HospitalReportCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.coe.vo.HospitalReport vo = voCollection.get(i);
			ims.core.clinical.domain.objects.ClinicalNotes domainObject = HospitalReportAssembler.extractClinicalNotes(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractClinicalNotesList(ims.domain.ILightweightDomainFactory domainFactory, ims.coe.vo.HospitalReportCollection voCollection) 
	 {
	 	return extractClinicalNotesList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractClinicalNotesList(ims.domain.ILightweightDomainFactory domainFactory, ims.coe.vo.HospitalReportCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.coe.vo.HospitalReport create(ims.core.clinical.domain.objects.ClinicalNotes domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.coe.vo.HospitalReport create(DomainObjectMap map, ims.core.clinical.domain.objects.ClinicalNotes domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.coe.vo.HospitalReport valueObject = (ims.coe.vo.HospitalReport) map.getValueObject(domainObject, ims.coe.vo.HospitalReport.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.coe.vo.HospitalReport(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.ClinicalNotes
	 */
	 public static ims.coe.vo.HospitalReport insert(ims.coe.vo.HospitalReport valueObject, ims.core.clinical.domain.objects.ClinicalNotes domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.ClinicalNotes
	 */
	 public static ims.coe.vo.HospitalReport insert(DomainObjectMap map, ims.coe.vo.HospitalReport valueObject, ims.core.clinical.domain.objects.ClinicalNotes domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.clinical.domain.objects.ClinicalNotes extractClinicalNotes(ims.domain.ILightweightDomainFactory domainFactory, ims.coe.vo.HospitalReport valueObject) 
	{
		return 	extractClinicalNotes(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.clinical.domain.objects.ClinicalNotes extractClinicalNotes(ims.domain.ILightweightDomainFactory domainFactory, ims.coe.vo.HospitalReport valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.coe.vo.HospitalReport ID_ClinicalNotes field is unknown
