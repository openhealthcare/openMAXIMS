 ...
 */
public class AssessmentEmotionalState extends ims.nursing.vo.AssessmentComponent implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public AssessmentEmotionalState()
	{
	}
	public AssessmentEmotionalState(Integer id, int version)
	{
		super(id, version);
	}
	public AssessmentEmotionalState(ims.coe.vo.beans.AssessmentEmotionalStateBean bean)
	{
		this.id = bean.getId();
		...
		this.stateassessment = ims.coe.vo.EmotionalStateCollection.buildFromBeanCollection(bean.getStateAssessment());
		this.sexuality = bean.getSexuality();
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.coe.vo.beans.AssessmentEmotionalStateBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.iscomplete = bean.getIsComplete();
	...
	{
		ims.coe.vo.beans.AssessmentEmotionalStateBean bean = null;
		if(map != null)
			bean = (ims.coe.vo.beans.AssessmentEmotionalStateBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.coe.vo.beans.AssessmentEmotionalStateBean();
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("STATEASSESSMENT"))
			return getStateAssessment();
		if(fieldName.equals("SEXUALITY"))
			return getSexuality();
		return super.getFieldValueByFieldName(fieldName);
	}
	public boolean getStateAssessmentIsNotNull()
	{
		return this.stateassessment != null;
	}
	public ims.coe.vo.EmotionalStateCollection getStateAssessment()
	{
		return this.stateassessment;
	}
	public void setStateAssessment(ims.coe.vo.EmotionalStateCollection value)
	{
	...
	public boolean isValidated()
	{
		...
		if(this.stateassessment != null)
		{
			if(!this.stateassessment.isValidated())
			{
				this.isBusy = false;
				return false;
			}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.stateassessment != null)
		{
			String[] listOfOtherErrors = this.stateassessment.validate();
			if(listOfOtherErrors != null)
			{
				for(int x = 0; x < listOfOtherErrors.length; x++)
				{
		...
		if(this.sexuality != null)
			if(this.sexuality.length() > 500)
				listOfErrors.add("The length of the field [sexuality] in the value object [ims.coe.vo.AssessmentEmotionalState] is too big. It should be less or equal to 500");
	...
	public Object clone()
	{
		...
		AssessmentEmotionalState clone = new AssessmentEmotionalState(this.id, this.version);
		...
		if(this.stateassessment == null)
			clone.stateassessment = null;
		else
			clone.stateassessment = (ims.coe.vo.EmotionalStateCollection)this.stateassessment.clone();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(AssessmentEmotionalState.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A AssessmentEmotionalState object cannot be compared an Object of type " + obj.getClass().getName());
		}
		AssessmentEmotionalState compareObj = (AssessmentEmotionalState)obj;
		int retVal = 0;
		if (retVal == 0)
		{
	...
	protected ims.coe.vo.EmotionalStateCollection stateassessment;
