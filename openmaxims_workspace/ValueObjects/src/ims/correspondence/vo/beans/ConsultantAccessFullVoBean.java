...
public class ConsultantAccessFullVoBean extends ims.vo.ValueObjectBean
{
	public ConsultantAccessFullVoBean()
	{
	}
	public ConsultantAccessFullVoBean(ims.correspondence.vo.ConsultantAccessFullVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.correspondence.vo.ConsultantAccessFullVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.accessright = vo.getAccessRight() == null ? null : (ims.vo.LookupInstanceBean)vo.getAccessRight().getBean();
	...
	public ims.correspondence.vo.ConsultantAccessFullVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.correspondence.vo.ConsultantAccessFullVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.correspondence.vo.ConsultantAccessFullVo vo = null;
		if(map != null)
			vo = (ims.correspondence.vo.ConsultantAccessFullVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.correspondence.vo.ConsultantAccessFullVo();
