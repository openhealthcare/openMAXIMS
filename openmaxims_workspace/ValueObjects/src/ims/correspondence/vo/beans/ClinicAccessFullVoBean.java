...
public class ClinicAccessFullVoBean extends ims.vo.ValueObjectBean
{
	public ClinicAccessFullVoBean()
	{
	}
	public ClinicAccessFullVoBean(ims.correspondence.vo.ClinicAccessFullVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.correspondence.vo.ClinicAccessFullVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.accessright = vo.getAccessRight() == null ? null : (ims.vo.LookupInstanceBean)vo.getAccessRight().getBean();
	...
	public ims.correspondence.vo.ClinicAccessFullVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.correspondence.vo.ClinicAccessFullVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.correspondence.vo.ClinicAccessFullVo vo = null;
		if(map != null)
			vo = (ims.correspondence.vo.ClinicAccessFullVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.correspondence.vo.ClinicAccessFullVo();
