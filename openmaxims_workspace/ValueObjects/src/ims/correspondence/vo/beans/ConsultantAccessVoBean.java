...
public class ConsultantAccessVoBean extends ims.vo.ValueObjectBean
{
	public ConsultantAccessVoBean()
	{
	}
	public ConsultantAccessVoBean(ims.correspondence.vo.ConsultantAccessVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.correspondence.vo.ConsultantAccessVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.accessright = vo.getAccessRight() == null ? null : (ims.vo.LookupInstanceBean)vo.getAccessRight().getBean();
	...
	public ims.correspondence.vo.ConsultantAccessVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.correspondence.vo.ConsultantAccessVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.correspondence.vo.ConsultantAccessVo vo = null;
		if(map != null)
			vo = (ims.correspondence.vo.ConsultantAccessVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.correspondence.vo.ConsultantAccessVo();
