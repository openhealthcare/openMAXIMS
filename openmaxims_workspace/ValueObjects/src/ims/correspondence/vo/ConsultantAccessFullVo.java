 ...
 */
public class ConsultantAccessFullVo extends ims.correspondence.configuration.vo.ConsultantAccessRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public ConsultantAccessFullVo()
	{
	}
	public ConsultantAccessFullVo(Integer id, int version)
	{
		super(id, version);
	}
	public ConsultantAccessFullVo(ims.correspondence.vo.beans.ConsultantAccessFullVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.correspondence.vo.beans.ConsultantAccessFullVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.accessright = bean.getAccessRight() == null ? null : ims.correspondence.vo.lookups.Access.buildLookup(bean.getAccessRight());
	...
	{
		ims.correspondence.vo.beans.ConsultantAccessFullVoBean bean = null;
		if(map != null)
			bean = (ims.correspondence.vo.beans.ConsultantAccessFullVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.correspondence.vo.beans.ConsultantAccessFullVoBean();
	...
	public Object clone()
	{
		...
		ConsultantAccessFullVo clone = new ConsultantAccessFullVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(ConsultantAccessFullVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A ConsultantAccessFullVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		ConsultantAccessFullVo compareObj = (ConsultantAccessFullVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
