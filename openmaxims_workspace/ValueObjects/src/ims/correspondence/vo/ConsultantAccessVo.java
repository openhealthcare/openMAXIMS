 ...
 */
public class ConsultantAccessVo extends ims.correspondence.configuration.vo.ConsultantAccessRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public ConsultantAccessVo()
	{
	}
	public ConsultantAccessVo(Integer id, int version)
	{
		super(id, version);
	}
	public ConsultantAccessVo(ims.correspondence.vo.beans.ConsultantAccessVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.correspondence.vo.beans.ConsultantAccessVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.accessright = bean.getAccessRight() == null ? null : ims.correspondence.vo.lookups.Access.buildLookup(bean.getAccessRight());
	...
	{
		ims.correspondence.vo.beans.ConsultantAccessVoBean bean = null;
		if(map != null)
			bean = (ims.correspondence.vo.beans.ConsultantAccessVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.correspondence.vo.beans.ConsultantAccessVoBean();
	...
	public Object clone()
	{
		...
		ConsultantAccessVo clone = new ConsultantAccessVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(ConsultantAccessVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A ConsultantAccessVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((ConsultantAccessVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((ConsultantAccessVo)obj).getBoId());
	}
