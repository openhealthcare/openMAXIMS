...
public class DocPatCareContextVo extends ims.vo.ValueObject implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public DocPatCareContextVo()
	{
	}
	public DocPatCareContextVo(ims.correspondence.vo.beans.DocPatCareContextVoBean bean)
	{
		this.patient = bean.getPatient() == null ? null : bean.getPatient().buildVo();
		this.carecontext = bean.getCareContext() == null ? null : bean.getCareContext().buildVo();
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.correspondence.vo.beans.DocPatCareContextVoBean bean)
	{
	...
	{
		ims.correspondence.vo.beans.DocPatCareContextVoBean bean = null;
		if(map != null)
			bean = (ims.correspondence.vo.beans.DocPatCareContextVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.correspondence.vo.beans.DocPatCareContextVoBean();
	...
	public boolean equals(Object obj)
	{
		if(obj == null)
			return false;
		if(!(obj instanceof DocPatCareContextVo))
			return false;
		DocPatCareContextVo compareObj = (DocPatCareContextVo)obj;
	...
	public Object clone()
	{
		...
		DocPatCareContextVo clone = new DocPatCareContextVo();
		...
		if(this.carecontext == null)
			...
			clone.carecontext = (ims.core.vo.CareContextVo)this.carecontext.clone();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(DocPatCareContextVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A DocPatCareContextVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		DocPatCareContextVo compareObj = (DocPatCareContextVo)obj;
		int retVal = 0;
		if (retVal == 0)
	...
	protected ims.core.vo.CareContextVo carecontext;
