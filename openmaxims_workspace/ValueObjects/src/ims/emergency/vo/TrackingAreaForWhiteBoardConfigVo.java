 ...
 */
public class TrackingAreaForWhiteBoardConfigVo extends ims.emergency.configuration.vo.TrackingAreaRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public TrackingAreaForWhiteBoardConfigVo()
	{
	}
	public TrackingAreaForWhiteBoardConfigVo(Integer id, int version)
	{
		super(id, version);
	}
	public TrackingAreaForWhiteBoardConfigVo(ims.emergency.vo.beans.TrackingAreaForWhiteBoardConfigVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.beans.TrackingAreaForWhiteBoardConfigVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.emergency.vo.beans.TrackingAreaForWhiteBoardConfigVoBean bean = null;
		if(map != null)
			bean = (ims.emergency.vo.beans.TrackingAreaForWhiteBoardConfigVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.emergency.vo.beans.TrackingAreaForWhiteBoardConfigVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.areanamedescription == null || this.areanamedescription.length() == 0)
			...
			listOfErrors.add("The length of the field [areanamedescription] in the value object [ims.emergency.vo.TrackingAreaForWhiteBoardConfigVo] is too big. It should be less or equal to 150");
		if(this.areadisplayname == null || this.areadisplayname.length() == 0)
			...
			listOfErrors.add("The length of the field [areadisplayname] in the value object [ims.emergency.vo.TrackingAreaForWhiteBoardConfigVo] is too big. It should be less or equal to 15");
		if(this.status == null)
	...
	public Object clone()
	{
		...
		TrackingAreaForWhiteBoardConfigVo clone = new TrackingAreaForWhiteBoardConfigVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(TrackingAreaForWhiteBoardConfigVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A TrackingAreaForWhiteBoardConfigVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((TrackingAreaForWhiteBoardConfigVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((TrackingAreaForWhiteBoardConfigVo)obj).getBoId());
	}
