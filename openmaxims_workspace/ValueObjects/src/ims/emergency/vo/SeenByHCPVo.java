 ...
 */
public class SeenByHCPVo extends ims.emergency.vo.SeenByHCPRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public SeenByHCPVo(Integer id, int version)
	{
		super(id, version);
	}
	public SeenByHCPVo(ims.emergency.vo.beans.SeenByHCPVoBean bean)
	{
		this.id = bean.getId();
		...
		this.seenbyhcpnotes = ims.emergency.vo.AttendanceClinicalNotesVoCollection.buildFromBeanCollection(bean.getSeenByHCPNotes());
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.beans.SeenByHCPVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.patient = bean.getPatient() == null ? null : new ims.core.patient.vo.PatientRefVo(new Integer(bean.getPatient().getId()), bean.getPatient().getVersion());
	...
	{
		ims.emergency.vo.beans.SeenByHCPVoBean bean = null;
		if(map != null)
			bean = (ims.emergency.vo.beans.SeenByHCPVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.emergency.vo.beans.SeenByHCPVoBean();
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("SEENBYHCPNOTES"))
			return getSeenByHCPNotes();
	...
	public boolean getSeenByHCPNotesIsNotNull()
	{
		return this.seenbyhcpnotes != null;
	}
	public ims.emergency.vo.AttendanceClinicalNotesVoCollection getSeenByHCPNotes()
	{
		return this.seenbyhcpnotes;
	}
	public void setSeenByHCPNotes(ims.emergency.vo.AttendanceClinicalNotesVoCollection value)
	{
		this.isValidated = false;
	...
	public boolean isValidated()
	{
		...
		if(this.seenbyhcpnotes != null)
		{
			if(!this.seenbyhcpnotes.isValidated())
			{
				this.isBusy = false;
				return false;
			}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.allocateddatetime == null)
			listOfErrors.add("Allocated Date Time is mandatory!");
		if(this.seendatetime == null)
			listOfErrors.add("Date and time Patient Seen is mandatory!");
		if(this.seenbyhcpnotes != null)
		{
			String[] listOfOtherErrors = this.seenbyhcpnotes.validate();
	...
	public Object clone()
	{
		...
		SeenByHCPVo clone = new SeenByHCPVo(this.id, this.version);
		...
		if(this.seenbyhcpnotes == null)
			clone.seenbyhcpnotes = null;
		else
			clone.seenbyhcpnotes = (ims.emergency.vo.AttendanceClinicalNotesVoCollection)this.seenbyhcpnotes.clone();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(SeenByHCPVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A SeenByHCPVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((SeenByHCPVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((SeenByHCPVo)obj).getBoId());
	}
	...
	protected ims.emergency.vo.AttendanceClinicalNotesVoCollection seenbyhcpnotes;
