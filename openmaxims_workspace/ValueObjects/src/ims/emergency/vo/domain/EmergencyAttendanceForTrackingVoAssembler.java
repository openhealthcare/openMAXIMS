 ...
 */
public class EmergencyAttendanceForTrackingVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.emergency.vo.EmergencyAttendanceForTrackingVo copy(ims.emergency.vo.EmergencyAttendanceForTrackingVo valueObjectDest, ims.emergency.vo.EmergencyAttendanceForTrackingVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createEmergencyAttendanceForTrackingVoCollectionFromEmergencyAttendance(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.admin.domain.objects.EmergencyAttendance objects.
	 */
	public static ims.emergency.vo.EmergencyAttendanceForTrackingVoCollection createEmergencyAttendanceForTrackingVoCollectionFromEmergencyAttendance(java.util.Set domainObjectSet)	
	{
		return createEmergencyAttendanceForTrackingVoCollectionFromEmergencyAttendance(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.admin.domain.objects.EmergencyAttendance objects.
	 */
	public static ims.emergency.vo.EmergencyAttendanceForTrackingVoCollection createEmergencyAttendanceForTrackingVoCollectionFromEmergencyAttendance(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.emergency.vo.EmergencyAttendanceForTrackingVoCollection voList = new ims.emergency.vo.EmergencyAttendanceForTrackingVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.emergency.vo.EmergencyAttendanceForTrackingVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.emergency.vo.EmergencyAttendanceForTrackingVoCollection createEmergencyAttendanceForTrackingVoCollectionFromEmergencyAttendance(java.util.List domainObjectList) 
	{
		return createEmergencyAttendanceForTrackingVoCollectionFromEmergencyAttendance(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.admin.domain.objects.EmergencyAttendance objects.
	 */
	public static ims.emergency.vo.EmergencyAttendanceForTrackingVoCollection createEmergencyAttendanceForTrackingVoCollectionFromEmergencyAttendance(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.emergency.vo.EmergencyAttendanceForTrackingVoCollection voList = new ims.emergency.vo.EmergencyAttendanceForTrackingVoCollection();
	 ...
	 */
	 public static java.util.Set extractEmergencyAttendanceSet(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.EmergencyAttendanceForTrackingVoCollection voCollection) 
	 {
	 	return extractEmergencyAttendanceSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractEmergencyAttendanceSet(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.EmergencyAttendanceForTrackingVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.emergency.vo.EmergencyAttendanceForTrackingVo vo = voCollection.get(i);
			ims.core.admin.domain.objects.EmergencyAttendance domainObject = EmergencyAttendanceForTrackingVoAssembler.extractEmergencyAttendance(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractEmergencyAttendanceList(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.EmergencyAttendanceForTrackingVoCollection voCollection) 
	 {
	 	return extractEmergencyAttendanceList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractEmergencyAttendanceList(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.EmergencyAttendanceForTrackingVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.emergency.vo.EmergencyAttendanceForTrackingVo create(ims.core.admin.domain.objects.EmergencyAttendance domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.emergency.vo.EmergencyAttendanceForTrackingVo create(DomainObjectMap map, ims.core.admin.domain.objects.EmergencyAttendance domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.emergency.vo.EmergencyAttendanceForTrackingVo valueObject = (ims.emergency.vo.EmergencyAttendanceForTrackingVo) map.getValueObject(domainObject, ims.emergency.vo.EmergencyAttendanceForTrackingVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.emergency.vo.EmergencyAttendanceForTrackingVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.admin.domain.objects.EmergencyAttendance
	 */
	 public static ims.emergency.vo.EmergencyAttendanceForTrackingVo insert(ims.emergency.vo.EmergencyAttendanceForTrackingVo valueObject, ims.core.admin.domain.objects.EmergencyAttendance domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.admin.domain.objects.EmergencyAttendance
	 */
	 public static ims.emergency.vo.EmergencyAttendanceForTrackingVo insert(DomainObjectMap map, ims.emergency.vo.EmergencyAttendanceForTrackingVo valueObject, ims.core.admin.domain.objects.EmergencyAttendance domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.admin.domain.objects.EmergencyAttendance extractEmergencyAttendance(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.EmergencyAttendanceForTrackingVo valueObject) 
	{
		return 	extractEmergencyAttendance(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.admin.domain.objects.EmergencyAttendance extractEmergencyAttendance(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.EmergencyAttendanceForTrackingVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.emergency.vo.EmergencyAttendanceForTrackingVo ID_EmergencyAttendance field is unknown
		...
		ims.framework.utils.DateTime dateTime7 = valueObject.getArrivalDateTime();
		java.util.Date value7 = null;
		if ( dateTime7 != null ) 
		{
			value7 = dateTime7.getJavaDate();
		}
		domainObject.setArrivalDateTime(value7);
