 ...
 */
public class TrackingAreaShortVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.emergency.vo.TrackingAreaShortVo copy(ims.emergency.vo.TrackingAreaShortVo valueObjectDest, ims.emergency.vo.TrackingAreaShortVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createTrackingAreaShortVoCollectionFromTrackingArea(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.emergency.configuration.domain.objects.TrackingArea objects.
	 */
	public static ims.emergency.vo.TrackingAreaShortVoCollection createTrackingAreaShortVoCollectionFromTrackingArea(java.util.Set domainObjectSet)	
	{
		return createTrackingAreaShortVoCollectionFromTrackingArea(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.emergency.configuration.domain.objects.TrackingArea objects.
	 */
	public static ims.emergency.vo.TrackingAreaShortVoCollection createTrackingAreaShortVoCollectionFromTrackingArea(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.emergency.vo.TrackingAreaShortVoCollection voList = new ims.emergency.vo.TrackingAreaShortVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.emergency.vo.TrackingAreaShortVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.emergency.vo.TrackingAreaShortVoCollection createTrackingAreaShortVoCollectionFromTrackingArea(java.util.List domainObjectList) 
	{
		return createTrackingAreaShortVoCollectionFromTrackingArea(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.emergency.configuration.domain.objects.TrackingArea objects.
	 */
	public static ims.emergency.vo.TrackingAreaShortVoCollection createTrackingAreaShortVoCollectionFromTrackingArea(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.emergency.vo.TrackingAreaShortVoCollection voList = new ims.emergency.vo.TrackingAreaShortVoCollection();
	 ...
	 */
	 public static java.util.Set extractTrackingAreaSet(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingAreaShortVoCollection voCollection) 
	 {
	 	return extractTrackingAreaSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractTrackingAreaSet(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingAreaShortVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.emergency.vo.TrackingAreaShortVo vo = voCollection.get(i);
			ims.emergency.configuration.domain.objects.TrackingArea domainObject = TrackingAreaShortVoAssembler.extractTrackingArea(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractTrackingAreaList(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingAreaShortVoCollection voCollection) 
	 {
	 	return extractTrackingAreaList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractTrackingAreaList(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingAreaShortVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.emergency.vo.TrackingAreaShortVo create(ims.emergency.configuration.domain.objects.TrackingArea domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.emergency.vo.TrackingAreaShortVo create(DomainObjectMap map, ims.emergency.configuration.domain.objects.TrackingArea domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.emergency.vo.TrackingAreaShortVo valueObject = (ims.emergency.vo.TrackingAreaShortVo) map.getValueObject(domainObject, ims.emergency.vo.TrackingAreaShortVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.emergency.vo.TrackingAreaShortVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.emergency.configuration.domain.objects.TrackingArea
	 */
	 public static ims.emergency.vo.TrackingAreaShortVo insert(ims.emergency.vo.TrackingAreaShortVo valueObject, ims.emergency.configuration.domain.objects.TrackingArea domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.emergency.configuration.domain.objects.TrackingArea
	 */
	 public static ims.emergency.vo.TrackingAreaShortVo insert(DomainObjectMap map, ims.emergency.vo.TrackingAreaShortVo valueObject, ims.emergency.configuration.domain.objects.TrackingArea domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.emergency.configuration.domain.objects.TrackingArea extractTrackingArea(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingAreaShortVo valueObject) 
	{
		return 	extractTrackingArea(domainFactory, valueObject, new HashMap());
	}

	public static ims.emergency.configuration.domain.objects.TrackingArea extractTrackingArea(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingAreaShortVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.emergency.vo.TrackingAreaShortVo ID_TrackingArea field is unknown
