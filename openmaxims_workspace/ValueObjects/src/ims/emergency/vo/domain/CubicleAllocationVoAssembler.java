 ...
 */
public class CubicleAllocationVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.emergency.vo.CubicleAllocationVo copy(ims.emergency.vo.CubicleAllocationVo valueObjectDest, ims.emergency.vo.CubicleAllocationVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createCubicleAllocationVoCollectionFromCubicleAllocation(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.emergency.domain.objects.CubicleAllocation objects.
	 */
	public static ims.emergency.vo.CubicleAllocationVoCollection createCubicleAllocationVoCollectionFromCubicleAllocation(java.util.Set domainObjectSet)	
	{
		return createCubicleAllocationVoCollectionFromCubicleAllocation(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.emergency.domain.objects.CubicleAllocation objects.
	 */
	public static ims.emergency.vo.CubicleAllocationVoCollection createCubicleAllocationVoCollectionFromCubicleAllocation(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.emergency.vo.CubicleAllocationVoCollection voList = new ims.emergency.vo.CubicleAllocationVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.emergency.vo.CubicleAllocationVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.emergency.vo.CubicleAllocationVoCollection createCubicleAllocationVoCollectionFromCubicleAllocation(java.util.List domainObjectList) 
	{
		return createCubicleAllocationVoCollectionFromCubicleAllocation(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.emergency.domain.objects.CubicleAllocation objects.
	 */
	public static ims.emergency.vo.CubicleAllocationVoCollection createCubicleAllocationVoCollectionFromCubicleAllocation(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.emergency.vo.CubicleAllocationVoCollection voList = new ims.emergency.vo.CubicleAllocationVoCollection();
	 ...
	 */
	 public static java.util.Set extractCubicleAllocationSet(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.CubicleAllocationVoCollection voCollection) 
	 {
	 	return extractCubicleAllocationSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractCubicleAllocationSet(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.CubicleAllocationVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.emergency.vo.CubicleAllocationVo vo = voCollection.get(i);
			ims.emergency.domain.objects.CubicleAllocation domainObject = CubicleAllocationVoAssembler.extractCubicleAllocation(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractCubicleAllocationList(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.CubicleAllocationVoCollection voCollection) 
	 {
	 	return extractCubicleAllocationList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractCubicleAllocationList(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.CubicleAllocationVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.emergency.vo.CubicleAllocationVo create(ims.emergency.domain.objects.CubicleAllocation domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.emergency.vo.CubicleAllocationVo create(DomainObjectMap map, ims.emergency.domain.objects.CubicleAllocation domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.emergency.vo.CubicleAllocationVo valueObject = (ims.emergency.vo.CubicleAllocationVo) map.getValueObject(domainObject, ims.emergency.vo.CubicleAllocationVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.emergency.vo.CubicleAllocationVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.emergency.domain.objects.CubicleAllocation
	 */
	 public static ims.emergency.vo.CubicleAllocationVo insert(ims.emergency.vo.CubicleAllocationVo valueObject, ims.emergency.domain.objects.CubicleAllocation domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.emergency.domain.objects.CubicleAllocation
	 */
	 public static ims.emergency.vo.CubicleAllocationVo insert(DomainObjectMap map, ims.emergency.vo.CubicleAllocationVo valueObject, ims.emergency.domain.objects.CubicleAllocation domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.emergency.domain.objects.CubicleAllocation extractCubicleAllocation(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.CubicleAllocationVo valueObject) 
	{
		return 	extractCubicleAllocation(domainFactory, valueObject, new HashMap());
	}

	public static ims.emergency.domain.objects.CubicleAllocation extractCubicleAllocation(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.CubicleAllocationVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.emergency.vo.CubicleAllocationVo ID_CubicleAllocation field is unknown
	...
	ims.emergency.configuration.domain.objects.TrackingArea value4 = null;
		...
		ims.framework.utils.DateTime dateTime5 = valueObject.getAllocatedCubicleDateTime();
		java.util.Date value5 = null;
		if ( dateTime5 != null ) 
		{
			value5 = dateTime5.getJavaDate();
		}
		domainObject.setAllocatedCubicleDateTime(value5);
	// SaveAsRefVO - treated as a refVo in extract methods
	ims.core.resource.people.domain.objects.MemberOfStaff value6 = null;
		if ( null != valueObject.getAllocatedBy() ) 
		{
			if (valueObject.getAllocatedBy().getBoId() == null)
			{
				...
				{
					value6 = (ims.core.resource.people.domain.objects.MemberOfStaff)domMap.get(valueObject.getAllocatedBy());
				}
			}
			else
			{
				value6 = (ims.core.resource.people.domain.objects.MemberOfStaff)domainFactory.getDomainObject(ims.core.resource.people.domain.objects.MemberOfStaff.class, valueObject.getAllocatedBy().getBoId());
			}
		}
		domainObject.setAllocatedBy(value6);
		domainObject.setCubicleRoomBed(ims.emergency.vo.domain.TrackingCubicleRoomBedVoAssembler.extractTrackingCubicleRoomBed(domainFactory, valueObject.getCubicleRoomBed(), domMap));
