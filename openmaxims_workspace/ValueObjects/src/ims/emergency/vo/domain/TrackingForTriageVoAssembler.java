 ...
 */
public class TrackingForTriageVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.emergency.vo.TrackingForTriageVo copy(ims.emergency.vo.TrackingForTriageVo valueObjectDest, ims.emergency.vo.TrackingForTriageVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createTrackingForTriageVoCollectionFromTracking(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.emergency.domain.objects.Tracking objects.
	 */
	public static ims.emergency.vo.TrackingForTriageVoCollection createTrackingForTriageVoCollectionFromTracking(java.util.Set domainObjectSet)	
	{
		return createTrackingForTriageVoCollectionFromTracking(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.emergency.domain.objects.Tracking objects.
	 */
	public static ims.emergency.vo.TrackingForTriageVoCollection createTrackingForTriageVoCollectionFromTracking(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.emergency.vo.TrackingForTriageVoCollection voList = new ims.emergency.vo.TrackingForTriageVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.emergency.vo.TrackingForTriageVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.emergency.vo.TrackingForTriageVoCollection createTrackingForTriageVoCollectionFromTracking(java.util.List domainObjectList) 
	{
		return createTrackingForTriageVoCollectionFromTracking(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.emergency.domain.objects.Tracking objects.
	 */
	public static ims.emergency.vo.TrackingForTriageVoCollection createTrackingForTriageVoCollectionFromTracking(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.emergency.vo.TrackingForTriageVoCollection voList = new ims.emergency.vo.TrackingForTriageVoCollection();
	 ...
	 */
	 public static java.util.Set extractTrackingSet(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingForTriageVoCollection voCollection) 
	 {
	 	return extractTrackingSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractTrackingSet(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingForTriageVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.emergency.vo.TrackingForTriageVo vo = voCollection.get(i);
			ims.emergency.domain.objects.Tracking domainObject = TrackingForTriageVoAssembler.extractTracking(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractTrackingList(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingForTriageVoCollection voCollection) 
	 {
	 	return extractTrackingList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractTrackingList(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingForTriageVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.emergency.vo.TrackingForTriageVo create(ims.emergency.domain.objects.Tracking domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.emergency.vo.TrackingForTriageVo create(DomainObjectMap map, ims.emergency.domain.objects.Tracking domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.emergency.vo.TrackingForTriageVo valueObject = (ims.emergency.vo.TrackingForTriageVo) map.getValueObject(domainObject, ims.emergency.vo.TrackingForTriageVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.emergency.vo.TrackingForTriageVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.emergency.domain.objects.Tracking
	 */
	 public static ims.emergency.vo.TrackingForTriageVo insert(ims.emergency.vo.TrackingForTriageVo valueObject, ims.emergency.domain.objects.Tracking domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.emergency.domain.objects.Tracking
	 */
	 public static ims.emergency.vo.TrackingForTriageVo insert(DomainObjectMap map, ims.emergency.vo.TrackingForTriageVo valueObject, ims.emergency.domain.objects.Tracking domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// TriageDetails
		valueObject.setTriageDetails(ims.emergency.vo.domain.TriageForTriageVoAssembler.create(map, domainObject.getTriageDetails()) );
		// CurrentArea
	 ...
	 */
	public static ims.emergency.domain.objects.Tracking extractTracking(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingForTriageVo valueObject) 
	{
		return 	extractTracking(domainFactory, valueObject, new HashMap());
	}

	public static ims.emergency.domain.objects.Tracking extractTracking(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingForTriageVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.emergency.vo.TrackingForTriageVo ID_Tracking field is unknown
	...
	ims.core.admin.domain.objects.EmergencyEpisode value1 = null;
		if ( null != valueObject.getEpisode() ) 
		{
			if (valueObject.getEpisode().getBoId() == null)
			{
				...
				{
					value1 = (ims.core.admin.domain.objects.EmergencyEpisode)domMap.get(valueObject.getEpisode());
				}
			}
			else
			{
				value1 = (ims.core.admin.domain.objects.EmergencyEpisode)domainFactory.getDomainObject(ims.core.admin.domain.objects.EmergencyEpisode.class, valueObject.getEpisode().getBoId());
			}
		}
		domainObject.setEpisode(value1);
		domainObject.setTriageDetails(ims.emergency.vo.domain.TriageForTriageVoAssembler.extractTriage(domainFactory, valueObject.getTriageDetails(), domMap));
		...
		if ( null != valueObject.getCurrentArea() ) 
		{
			...
			{
				value3 = domainObject.getCurrentArea();	
			}
			else
			{
	...
	// SaveAsRefVO - treated as a refVo in extract methods
	ims.emergency.domain.objects.SeenByHCP value6 = null;
		if ( null != valueObject.getSeenBy() ) 
		{
			if (valueObject.getSeenBy().getBoId() == null)
			{
				...
				{
					value6 = (ims.emergency.domain.objects.SeenByHCP)domMap.get(valueObject.getSeenBy());
				}
			}
			else
			{
				value6 = (ims.emergency.domain.objects.SeenByHCP)domainFactory.getDomainObject(ims.emergency.domain.objects.SeenByHCP.class, valueObject.getSeenBy().getBoId());
			}
		}
