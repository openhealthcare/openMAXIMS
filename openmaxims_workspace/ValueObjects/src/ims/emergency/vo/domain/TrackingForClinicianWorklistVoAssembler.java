 ...
 */
public class TrackingForClinicianWorklistVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.emergency.vo.TrackingForClinicianWorklistVo copy(ims.emergency.vo.TrackingForClinicianWorklistVo valueObjectDest, ims.emergency.vo.TrackingForClinicianWorklistVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createTrackingForClinicianWorklistVoCollectionFromTracking(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.emergency.domain.objects.Tracking objects.
	 */
	public static ims.emergency.vo.TrackingForClinicianWorklistVoCollection createTrackingForClinicianWorklistVoCollectionFromTracking(java.util.Set domainObjectSet)	
	{
		return createTrackingForClinicianWorklistVoCollectionFromTracking(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.emergency.domain.objects.Tracking objects.
	 */
	public static ims.emergency.vo.TrackingForClinicianWorklistVoCollection createTrackingForClinicianWorklistVoCollectionFromTracking(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.emergency.vo.TrackingForClinicianWorklistVoCollection voList = new ims.emergency.vo.TrackingForClinicianWorklistVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.emergency.vo.TrackingForClinicianWorklistVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.emergency.vo.TrackingForClinicianWorklistVoCollection createTrackingForClinicianWorklistVoCollectionFromTracking(java.util.List domainObjectList) 
	{
		return createTrackingForClinicianWorklistVoCollectionFromTracking(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.emergency.domain.objects.Tracking objects.
	 */
	public static ims.emergency.vo.TrackingForClinicianWorklistVoCollection createTrackingForClinicianWorklistVoCollectionFromTracking(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.emergency.vo.TrackingForClinicianWorklistVoCollection voList = new ims.emergency.vo.TrackingForClinicianWorklistVoCollection();
	 ...
	 */
	 public static java.util.Set extractTrackingSet(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingForClinicianWorklistVoCollection voCollection) 
	 {
	 	return extractTrackingSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractTrackingSet(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingForClinicianWorklistVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.emergency.vo.TrackingForClinicianWorklistVo vo = voCollection.get(i);
			ims.emergency.domain.objects.Tracking domainObject = TrackingForClinicianWorklistVoAssembler.extractTracking(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractTrackingList(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingForClinicianWorklistVoCollection voCollection) 
	 {
	 	return extractTrackingList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractTrackingList(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingForClinicianWorklistVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.emergency.vo.TrackingForClinicianWorklistVo create(ims.emergency.domain.objects.Tracking domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.emergency.vo.TrackingForClinicianWorklistVo create(DomainObjectMap map, ims.emergency.domain.objects.Tracking domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.emergency.vo.TrackingForClinicianWorklistVo valueObject = (ims.emergency.vo.TrackingForClinicianWorklistVo) map.getValueObject(domainObject, ims.emergency.vo.TrackingForClinicianWorklistVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.emergency.vo.TrackingForClinicianWorklistVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.emergency.domain.objects.Tracking
	 */
	 public static ims.emergency.vo.TrackingForClinicianWorklistVo insert(ims.emergency.vo.TrackingForClinicianWorklistVo valueObject, ims.emergency.domain.objects.Tracking domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.emergency.domain.objects.Tracking
	 */
	 public static ims.emergency.vo.TrackingForClinicianWorklistVo insert(DomainObjectMap map, ims.emergency.vo.TrackingForClinicianWorklistVo valueObject, ims.emergency.domain.objects.Tracking domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		if (domainObject.getSeenBy() != null)
		{
			if(domainObject.getSeenBy() instanceof HibernateProxy) // If the proxy is set, there is no need to lazy load, the proxy knows the id already. 
			{
				...
				int id = Integer.parseInt(p.getHibernateLazyInitializer().getIdentifier().toString());				
				valueObject.setSeenBy(new ims.emergency.vo.SeenByHCPRefVo(id, -1));				
			}
			else
			{
				valueObject.setSeenBy(new ims.emergency.vo.SeenByHCPRefVo(domainObject.getSeenBy().getId(), domainObject.getSeenBy().getVersion()));
			}
		}
 		return valueObject;
	 }
	 ...
	 */
	public static ims.emergency.domain.objects.Tracking extractTracking(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingForClinicianWorklistVo valueObject) 
	{
		return 	extractTracking(domainFactory, valueObject, new HashMap());
	}

	public static ims.emergency.domain.objects.Tracking extractTracking(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingForClinicianWorklistVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.emergency.vo.TrackingForClinicianWorklistVo ID_Tracking field is unknown
	...
	ims.core.admin.domain.objects.EmergencyEpisode value2 = null;
		...
		domainObject.setTriageDetails(ims.emergency.vo.domain.TriageForClinicianWorklistVoAssembler.extractTriage(domainFactory, valueObject.getTriageDetails(), domMap));
		...
		if ( null != valueObject.getCurrentArea() ) 
		{
			if (valueObject.getCurrentArea().getBoId() == null)
			{
				...
				{
					value4 = (ims.emergency.configuration.domain.objects.TrackingArea)domMap.get(valueObject.getCurrentArea());
				}
			}
			else if (valueObject.getBoVersion() == -1) // RefVo was not modified since obtained from the Assembler, no need to update the BO field
			{
				value4 = domainObject.getCurrentArea();	
			}
			else
			{
				value4 = (ims.emergency.configuration.domain.objects.TrackingArea)domainFactory.getDomainObject(ims.emergency.configuration.domain.objects.TrackingArea.class, valueObject.getCurrentArea().getBoId());
			}
		}
		domainObject.setCurrentArea(value4);
	// SaveAsRefVO - treated as a refVo in extract methods
