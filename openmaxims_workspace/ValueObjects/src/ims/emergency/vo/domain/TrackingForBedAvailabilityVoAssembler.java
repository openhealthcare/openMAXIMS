 ...
 */
public class TrackingForBedAvailabilityVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.emergency.vo.TrackingForBedAvailabilityVo copy(ims.emergency.vo.TrackingForBedAvailabilityVo valueObjectDest, ims.emergency.vo.TrackingForBedAvailabilityVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createTrackingForBedAvailabilityVoCollectionFromTracking(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.emergency.domain.objects.Tracking objects.
	 */
	public static ims.emergency.vo.TrackingForBedAvailabilityVoCollection createTrackingForBedAvailabilityVoCollectionFromTracking(java.util.Set domainObjectSet)	
	{
		return createTrackingForBedAvailabilityVoCollectionFromTracking(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.emergency.domain.objects.Tracking objects.
	 */
	public static ims.emergency.vo.TrackingForBedAvailabilityVoCollection createTrackingForBedAvailabilityVoCollectionFromTracking(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.emergency.vo.TrackingForBedAvailabilityVoCollection voList = new ims.emergency.vo.TrackingForBedAvailabilityVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.emergency.vo.TrackingForBedAvailabilityVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.emergency.vo.TrackingForBedAvailabilityVoCollection createTrackingForBedAvailabilityVoCollectionFromTracking(java.util.List domainObjectList) 
	{
		return createTrackingForBedAvailabilityVoCollectionFromTracking(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.emergency.domain.objects.Tracking objects.
	 */
	public static ims.emergency.vo.TrackingForBedAvailabilityVoCollection createTrackingForBedAvailabilityVoCollectionFromTracking(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.emergency.vo.TrackingForBedAvailabilityVoCollection voList = new ims.emergency.vo.TrackingForBedAvailabilityVoCollection();
	 ...
	 */
	 public static java.util.Set extractTrackingSet(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingForBedAvailabilityVoCollection voCollection) 
	 {
	 	return extractTrackingSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractTrackingSet(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingForBedAvailabilityVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.emergency.vo.TrackingForBedAvailabilityVo vo = voCollection.get(i);
			ims.emergency.domain.objects.Tracking domainObject = TrackingForBedAvailabilityVoAssembler.extractTracking(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractTrackingList(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingForBedAvailabilityVoCollection voCollection) 
	 {
	 	return extractTrackingList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractTrackingList(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingForBedAvailabilityVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.emergency.vo.TrackingForBedAvailabilityVo create(ims.emergency.domain.objects.Tracking domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.emergency.vo.TrackingForBedAvailabilityVo create(DomainObjectMap map, ims.emergency.domain.objects.Tracking domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.emergency.vo.TrackingForBedAvailabilityVo valueObject = (ims.emergency.vo.TrackingForBedAvailabilityVo) map.getValueObject(domainObject, ims.emergency.vo.TrackingForBedAvailabilityVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.emergency.vo.TrackingForBedAvailabilityVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.emergency.domain.objects.Tracking
	 */
	 public static ims.emergency.vo.TrackingForBedAvailabilityVo insert(ims.emergency.vo.TrackingForBedAvailabilityVo valueObject, ims.emergency.domain.objects.Tracking domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.emergency.domain.objects.Tracking
	 */
	 public static ims.emergency.vo.TrackingForBedAvailabilityVo insert(DomainObjectMap map, ims.emergency.vo.TrackingForBedAvailabilityVo valueObject, ims.emergency.domain.objects.Tracking domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.emergency.domain.objects.Tracking extractTracking(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingForBedAvailabilityVo valueObject) 
	{
		return 	extractTracking(domainFactory, valueObject, new HashMap());
	}

	public static ims.emergency.domain.objects.Tracking extractTracking(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingForBedAvailabilityVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.emergency.vo.TrackingForBedAvailabilityVo ID_Tracking field is unknown
