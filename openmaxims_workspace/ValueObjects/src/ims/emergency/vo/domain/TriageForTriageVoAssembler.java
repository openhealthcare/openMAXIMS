 ...
 */
public class TriageForTriageVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.emergency.vo.TriageForTriageVo copy(ims.emergency.vo.TriageForTriageVo valueObjectDest, ims.emergency.vo.TriageForTriageVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createTriageForTriageVoCollectionFromTriage(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.emergency.domain.objects.Triage objects.
	 */
	public static ims.emergency.vo.TriageForTriageVoCollection createTriageForTriageVoCollectionFromTriage(java.util.Set domainObjectSet)	
	{
		return createTriageForTriageVoCollectionFromTriage(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.emergency.domain.objects.Triage objects.
	 */
	public static ims.emergency.vo.TriageForTriageVoCollection createTriageForTriageVoCollectionFromTriage(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.emergency.vo.TriageForTriageVoCollection voList = new ims.emergency.vo.TriageForTriageVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.emergency.vo.TriageForTriageVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.emergency.vo.TriageForTriageVoCollection createTriageForTriageVoCollectionFromTriage(java.util.List domainObjectList) 
	{
		return createTriageForTriageVoCollectionFromTriage(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.emergency.domain.objects.Triage objects.
	 */
	public static ims.emergency.vo.TriageForTriageVoCollection createTriageForTriageVoCollectionFromTriage(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.emergency.vo.TriageForTriageVoCollection voList = new ims.emergency.vo.TriageForTriageVoCollection();
	 ...
	 */
	 public static java.util.Set extractTriageSet(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TriageForTriageVoCollection voCollection) 
	 {
	 	return extractTriageSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractTriageSet(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TriageForTriageVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.emergency.vo.TriageForTriageVo vo = voCollection.get(i);
			ims.emergency.domain.objects.Triage domainObject = TriageForTriageVoAssembler.extractTriage(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractTriageList(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TriageForTriageVoCollection voCollection) 
	 {
	 	return extractTriageList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractTriageList(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TriageForTriageVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.emergency.vo.TriageForTriageVo create(ims.emergency.domain.objects.Triage domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.emergency.vo.TriageForTriageVo create(DomainObjectMap map, ims.emergency.domain.objects.Triage domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.emergency.vo.TriageForTriageVo valueObject = (ims.emergency.vo.TriageForTriageVo) map.getValueObject(domainObject, ims.emergency.vo.TriageForTriageVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.emergency.vo.TriageForTriageVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.emergency.domain.objects.Triage
	 */
	 public static ims.emergency.vo.TriageForTriageVo insert(ims.emergency.vo.TriageForTriageVo valueObject, ims.emergency.domain.objects.Triage domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.emergency.domain.objects.Triage
	 */
	 public static ims.emergency.vo.TriageForTriageVo insert(DomainObjectMap map, ims.emergency.vo.TriageForTriageVo valueObject, ims.emergency.domain.objects.Triage domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// CurrentTriagePriority
		ims.domain.lookups.LookupInstance instance7 = domainObject.getCurrentTriagePriority();
		if ( null != instance7 ) {
			...
			valueObject.setCurrentTriagePriority(voLookup7);
		}
				// MainPresentingProblem
		valueObject.setMainPresentingProblem(ims.emergency.vo.domain.PatientProblemForTriageVoAssembler.create(map, domainObject.getMainPresentingProblem()) );
		// CurrentTriagePathway
	 ...
	 */
	public static ims.emergency.domain.objects.Triage extractTriage(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TriageForTriageVo valueObject) 
	{
		return 	extractTriage(domainFactory, valueObject, new HashMap());
	}

	public static ims.emergency.domain.objects.Triage extractTriage(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TriageForTriageVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.emergency.vo.TriageForTriageVo ID_Triage field is unknown
		...
		if ( null != valueObject.getEpisode() ) 
		{
			if (valueObject.getEpisode().getBoId() == null)
			{
				...
				{
					value4 = (ims.core.admin.domain.objects.EpisodeOfCare)domMap.get(valueObject.getEpisode());
				}
			}
			else if (valueObject.getBoVersion() == -1) // RefVo was not modified since obtained from the Assembler, no need to update the BO field
			{
				value4 = domainObject.getEpisode();	
			}
			else
			{
				value4 = (ims.core.admin.domain.objects.EpisodeOfCare)domainFactory.getDomainObject(ims.core.admin.domain.objects.EpisodeOfCare.class, valueObject.getEpisode().getBoId());
			}
		}
		domainObject.setEpisode(value4);
		...
		if ( null != valueObject.getTrackingArea() ) 
		{
			if (valueObject.getTrackingArea().getBoId() == null)
			{
				...
				{
					value5 = (ims.emergency.configuration.domain.objects.TrackingArea)domMap.get(valueObject.getTrackingArea());
				}
			}
			else if (valueObject.getBoVersion() == -1) // RefVo was not modified since obtained from the Assembler, no need to update the BO field
			{
				value5 = domainObject.getTrackingArea();	
			}
			else
			{
				value5 = (ims.emergency.configuration.domain.objects.TrackingArea)domainFactory.getDomainObject(ims.emergency.configuration.domain.objects.TrackingArea.class, valueObject.getTrackingArea().getBoId());
			}
		}
		domainObject.setTrackingArea(value5);
		ims.framework.utils.DateTime dateTime6 = valueObject.getTriageCompletionTime();
		java.util.Date value6 = null;
		if ( dateTime6 != null ) 
		{
			value6 = dateTime6.getJavaDate();
		}
		domainObject.setTriageCompletionTime(value6);
		...
		domainObject.setCurrentTriagePriority(value7);
	// SaveAsRefVO - treated as a refVo in extract methods
	ims.core.clinical.domain.objects.PatientProblem value8 = null;
		if ( null != valueObject.getMainPresentingProblem() ) 
		{
			if (valueObject.getMainPresentingProblem().getBoId() == null)
			{
				...
				{
					value8 = (ims.core.clinical.domain.objects.PatientProblem)domMap.get(valueObject.getMainPresentingProblem());
				}
			}
			else
			{
				value8 = (ims.core.clinical.domain.objects.PatientProblem)domainFactory.getDomainObject(ims.core.clinical.domain.objects.PatientProblem.class, valueObject.getMainPresentingProblem().getBoId());
			}
		}
		domainObject.setMainPresentingProblem(value8);
		ims.icps.instantiation.domain.objects.PatientICP value9 = null;
		if ( null != valueObject.getCurrentTriagePathway() ) 
		{
			if (valueObject.getCurrentTriagePathway().getBoId() == null)
			{
				...
				{
					value9 = (ims.icps.instantiation.domain.objects.PatientICP)domMap.get(valueObject.getCurrentTriagePathway());
				}
			}
			else if (valueObject.getBoVersion() == -1) // RefVo was not modified since obtained from the Assembler, no need to update the BO field
			{
				value9 = domainObject.getCurrentTriagePathway();	
			}
			else
			{
				value9 = (ims.icps.instantiation.domain.objects.PatientICP)domainFactory.getDomainObject(ims.icps.instantiation.domain.objects.PatientICP.class, valueObject.getCurrentTriagePathway().getBoId());
			}
		}
		domainObject.setCurrentTriagePathway(value9);
	// SaveAsRefVO - treated as a refVo in extract methods
	ims.emergency.domain.objects.TriageProtocolAssessment value10 = null;
		if ( null != valueObject.getCurrentTriageAssessment() ) 
		{
			if (valueObject.getCurrentTriageAssessment().getBoId() == null)
			{
				...
				{
					value10 = (ims.emergency.domain.objects.TriageProtocolAssessment)domMap.get(valueObject.getCurrentTriageAssessment());
				}
			}
			else
			{
				value10 = (ims.emergency.domain.objects.TriageProtocolAssessment)domainFactory.getDomainObject(ims.emergency.domain.objects.TriageProtocolAssessment.class, valueObject.getCurrentTriageAssessment().getBoId());
			}
		}
		domainObject.setCurrentTriageAssessment(value10);
