 ...
 */
public class BedAvailabilityVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.emergency.vo.BedAvailabilityVo copy(ims.emergency.vo.BedAvailabilityVo valueObjectDest, ims.emergency.vo.BedAvailabilityVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createBedAvailabilityVoCollectionFromBedAvailability(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.emergency.domain.objects.BedAvailability objects.
	 */
	public static ims.emergency.vo.BedAvailabilityVoCollection createBedAvailabilityVoCollectionFromBedAvailability(java.util.Set domainObjectSet)	
	{
		return createBedAvailabilityVoCollectionFromBedAvailability(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.emergency.domain.objects.BedAvailability objects.
	 */
	public static ims.emergency.vo.BedAvailabilityVoCollection createBedAvailabilityVoCollectionFromBedAvailability(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.emergency.vo.BedAvailabilityVoCollection voList = new ims.emergency.vo.BedAvailabilityVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.emergency.vo.BedAvailabilityVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.emergency.vo.BedAvailabilityVoCollection createBedAvailabilityVoCollectionFromBedAvailability(java.util.List domainObjectList) 
	{
		return createBedAvailabilityVoCollectionFromBedAvailability(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.emergency.domain.objects.BedAvailability objects.
	 */
	public static ims.emergency.vo.BedAvailabilityVoCollection createBedAvailabilityVoCollectionFromBedAvailability(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.emergency.vo.BedAvailabilityVoCollection voList = new ims.emergency.vo.BedAvailabilityVoCollection();
	 ...
	 */
	 public static java.util.Set extractBedAvailabilitySet(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.BedAvailabilityVoCollection voCollection) 
	 {
	 	return extractBedAvailabilitySet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractBedAvailabilitySet(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.BedAvailabilityVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.emergency.vo.BedAvailabilityVo vo = voCollection.get(i);
			ims.emergency.domain.objects.BedAvailability domainObject = BedAvailabilityVoAssembler.extractBedAvailability(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractBedAvailabilityList(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.BedAvailabilityVoCollection voCollection) 
	 {
	 	return extractBedAvailabilityList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractBedAvailabilityList(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.BedAvailabilityVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.emergency.vo.BedAvailabilityVo create(ims.emergency.domain.objects.BedAvailability domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.emergency.vo.BedAvailabilityVo create(DomainObjectMap map, ims.emergency.domain.objects.BedAvailability domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.emergency.vo.BedAvailabilityVo valueObject = (ims.emergency.vo.BedAvailabilityVo) map.getValueObject(domainObject, ims.emergency.vo.BedAvailabilityVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.emergency.vo.BedAvailabilityVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.emergency.domain.objects.BedAvailability
	 */
	 public static ims.emergency.vo.BedAvailabilityVo insert(ims.emergency.vo.BedAvailabilityVo valueObject, ims.emergency.domain.objects.BedAvailability domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.emergency.domain.objects.BedAvailability
	 */
	 public static ims.emergency.vo.BedAvailabilityVo insert(DomainObjectMap map, ims.emergency.vo.BedAvailabilityVo valueObject, ims.emergency.domain.objects.BedAvailability domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.emergency.domain.objects.BedAvailability extractBedAvailability(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.BedAvailabilityVo valueObject) 
	{
		return 	extractBedAvailability(domainFactory, valueObject, new HashMap());
	}

	public static ims.emergency.domain.objects.BedAvailability extractBedAvailability(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.BedAvailabilityVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.emergency.vo.BedAvailabilityVo ID_BedAvailability field is unknown
