 ...
 */
public class BedAvailabilityForTrackVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.emergency.vo.BedAvailabilityForTrackVo copy(ims.emergency.vo.BedAvailabilityForTrackVo valueObjectDest, ims.emergency.vo.BedAvailabilityForTrackVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createBedAvailabilityForTrackVoCollectionFromBedAvailability(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.emergency.domain.objects.BedAvailability objects.
	 */
	public static ims.emergency.vo.BedAvailabilityForTrackVoCollection createBedAvailabilityForTrackVoCollectionFromBedAvailability(java.util.Set domainObjectSet)	
	{
		return createBedAvailabilityForTrackVoCollectionFromBedAvailability(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.emergency.domain.objects.BedAvailability objects.
	 */
	public static ims.emergency.vo.BedAvailabilityForTrackVoCollection createBedAvailabilityForTrackVoCollectionFromBedAvailability(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.emergency.vo.BedAvailabilityForTrackVoCollection voList = new ims.emergency.vo.BedAvailabilityForTrackVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.emergency.vo.BedAvailabilityForTrackVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.emergency.vo.BedAvailabilityForTrackVoCollection createBedAvailabilityForTrackVoCollectionFromBedAvailability(java.util.List domainObjectList) 
	{
		return createBedAvailabilityForTrackVoCollectionFromBedAvailability(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.emergency.domain.objects.BedAvailability objects.
	 */
	public static ims.emergency.vo.BedAvailabilityForTrackVoCollection createBedAvailabilityForTrackVoCollectionFromBedAvailability(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.emergency.vo.BedAvailabilityForTrackVoCollection voList = new ims.emergency.vo.BedAvailabilityForTrackVoCollection();
	 ...
	 */
	 public static java.util.Set extractBedAvailabilitySet(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.BedAvailabilityForTrackVoCollection voCollection) 
	 {
	 	return extractBedAvailabilitySet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractBedAvailabilitySet(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.BedAvailabilityForTrackVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.emergency.vo.BedAvailabilityForTrackVo vo = voCollection.get(i);
			ims.emergency.domain.objects.BedAvailability domainObject = BedAvailabilityForTrackVoAssembler.extractBedAvailability(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractBedAvailabilityList(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.BedAvailabilityForTrackVoCollection voCollection) 
	 {
	 	return extractBedAvailabilityList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractBedAvailabilityList(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.BedAvailabilityForTrackVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.emergency.vo.BedAvailabilityForTrackVo create(ims.emergency.domain.objects.BedAvailability domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.emergency.vo.BedAvailabilityForTrackVo create(DomainObjectMap map, ims.emergency.domain.objects.BedAvailability domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.emergency.vo.BedAvailabilityForTrackVo valueObject = (ims.emergency.vo.BedAvailabilityForTrackVo) map.getValueObject(domainObject, ims.emergency.vo.BedAvailabilityForTrackVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.emergency.vo.BedAvailabilityForTrackVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.emergency.domain.objects.BedAvailability
	 */
	 public static ims.emergency.vo.BedAvailabilityForTrackVo insert(ims.emergency.vo.BedAvailabilityForTrackVo valueObject, ims.emergency.domain.objects.BedAvailability domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.emergency.domain.objects.BedAvailability
	 */
	 public static ims.emergency.vo.BedAvailabilityForTrackVo insert(DomainObjectMap map, ims.emergency.vo.BedAvailabilityForTrackVo valueObject, ims.emergency.domain.objects.BedAvailability domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.emergency.domain.objects.BedAvailability extractBedAvailability(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.BedAvailabilityForTrackVo valueObject) 
	{
		return 	extractBedAvailability(domainFactory, valueObject, new HashMap());
	}

	public static ims.emergency.domain.objects.BedAvailability extractBedAvailability(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.BedAvailabilityForTrackVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.emergency.vo.BedAvailabilityForTrackVo ID_BedAvailability field is unknown
		...
		ims.framework.utils.DateTime dateTime5 = valueObject.getAwaitingDateTime();
		java.util.Date value5 = null;
		if ( dateTime5 != null ) 
		{
			value5 = dateTime5.getJavaDate();
		}
		domainObject.setAwaitingDateTime(value5);
		ims.framework.utils.DateTime dateTime6 = valueObject.getAvailableDateTime();
		java.util.Date value6 = null;
		if ( dateTime6 != null ) 
		{
			value6 = dateTime6.getJavaDate();
		}
		domainObject.setAvailableDateTime(value6);
