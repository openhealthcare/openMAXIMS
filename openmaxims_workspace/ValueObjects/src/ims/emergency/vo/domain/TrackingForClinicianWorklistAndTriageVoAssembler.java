 ...
 */
public class TrackingForClinicianWorklistAndTriageVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.emergency.vo.TrackingForClinicianWorklistAndTriageVo copy(ims.emergency.vo.TrackingForClinicianWorklistAndTriageVo valueObjectDest, ims.emergency.vo.TrackingForClinicianWorklistAndTriageVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createTrackingForClinicianWorklistAndTriageVoCollectionFromTracking(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.emergency.domain.objects.Tracking objects.
	 */
	public static ims.emergency.vo.TrackingForClinicianWorklistAndTriageVoCollection createTrackingForClinicianWorklistAndTriageVoCollectionFromTracking(java.util.Set domainObjectSet)	
	{
		return createTrackingForClinicianWorklistAndTriageVoCollectionFromTracking(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.emergency.domain.objects.Tracking objects.
	 */
	public static ims.emergency.vo.TrackingForClinicianWorklistAndTriageVoCollection createTrackingForClinicianWorklistAndTriageVoCollectionFromTracking(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.emergency.vo.TrackingForClinicianWorklistAndTriageVoCollection voList = new ims.emergency.vo.TrackingForClinicianWorklistAndTriageVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.emergency.vo.TrackingForClinicianWorklistAndTriageVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.emergency.vo.TrackingForClinicianWorklistAndTriageVoCollection createTrackingForClinicianWorklistAndTriageVoCollectionFromTracking(java.util.List domainObjectList) 
	{
		return createTrackingForClinicianWorklistAndTriageVoCollectionFromTracking(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.emergency.domain.objects.Tracking objects.
	 */
	public static ims.emergency.vo.TrackingForClinicianWorklistAndTriageVoCollection createTrackingForClinicianWorklistAndTriageVoCollectionFromTracking(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.emergency.vo.TrackingForClinicianWorklistAndTriageVoCollection voList = new ims.emergency.vo.TrackingForClinicianWorklistAndTriageVoCollection();
	 ...
	 */
	 public static java.util.Set extractTrackingSet(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingForClinicianWorklistAndTriageVoCollection voCollection) 
	 {
	 	return extractTrackingSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractTrackingSet(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingForClinicianWorklistAndTriageVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.emergency.vo.TrackingForClinicianWorklistAndTriageVo vo = voCollection.get(i);
			ims.emergency.domain.objects.Tracking domainObject = TrackingForClinicianWorklistAndTriageVoAssembler.extractTracking(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractTrackingList(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingForClinicianWorklistAndTriageVoCollection voCollection) 
	 {
	 	return extractTrackingList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractTrackingList(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingForClinicianWorklistAndTriageVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.emergency.vo.TrackingForClinicianWorklistAndTriageVo create(ims.emergency.domain.objects.Tracking domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.emergency.vo.TrackingForClinicianWorklistAndTriageVo create(DomainObjectMap map, ims.emergency.domain.objects.Tracking domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.emergency.vo.TrackingForClinicianWorklistAndTriageVo valueObject = (ims.emergency.vo.TrackingForClinicianWorklistAndTriageVo) map.getValueObject(domainObject, ims.emergency.vo.TrackingForClinicianWorklistAndTriageVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.emergency.vo.TrackingForClinicianWorklistAndTriageVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.emergency.domain.objects.Tracking
	 */
	 public static ims.emergency.vo.TrackingForClinicianWorklistAndTriageVo insert(ims.emergency.vo.TrackingForClinicianWorklistAndTriageVo valueObject, ims.emergency.domain.objects.Tracking domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.emergency.domain.objects.Tracking
	 */
	 public static ims.emergency.vo.TrackingForClinicianWorklistAndTriageVo insert(DomainObjectMap map, ims.emergency.vo.TrackingForClinicianWorklistAndTriageVo valueObject, ims.emergency.domain.objects.Tracking domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.emergency.domain.objects.Tracking extractTracking(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingForClinicianWorklistAndTriageVo valueObject) 
	{
		return 	extractTracking(domainFactory, valueObject, new HashMap());
	}

	public static ims.emergency.domain.objects.Tracking extractTracking(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.TrackingForClinicianWorklistAndTriageVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.emergency.vo.TrackingForClinicianWorklistAndTriageVo ID_Tracking field is unknown
	...
	// SaveAsRefVO - treated as a refVo in extract methods
	ims.emergency.domain.objects.SeenByHCP value8 = null;
		if ( null != valueObject.getSeenBy() ) 
		{
			if (valueObject.getSeenBy().getBoId() == null)
			{
				...
				{
					value8 = (ims.emergency.domain.objects.SeenByHCP)domMap.get(valueObject.getSeenBy());
				}
			}
			else
			{
				value8 = (ims.emergency.domain.objects.SeenByHCP)domainFactory.getDomainObject(ims.emergency.domain.objects.SeenByHCP.class, valueObject.getSeenBy().getBoId());
			}
		}
