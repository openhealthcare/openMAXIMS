 ...
 */
public class DNWForTrackingSaveVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.emergency.vo.DNWForTrackingSaveVo copy(ims.emergency.vo.DNWForTrackingSaveVo valueObjectDest, ims.emergency.vo.DNWForTrackingSaveVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createDNWForTrackingSaveVoCollectionFromDNW(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.emergency.domain.objects.DNW objects.
	 */
	public static ims.emergency.vo.DNWForTrackingSaveVoCollection createDNWForTrackingSaveVoCollectionFromDNW(java.util.Set domainObjectSet)	
	{
		return createDNWForTrackingSaveVoCollectionFromDNW(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.emergency.domain.objects.DNW objects.
	 */
	public static ims.emergency.vo.DNWForTrackingSaveVoCollection createDNWForTrackingSaveVoCollectionFromDNW(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.emergency.vo.DNWForTrackingSaveVoCollection voList = new ims.emergency.vo.DNWForTrackingSaveVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.emergency.vo.DNWForTrackingSaveVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.emergency.vo.DNWForTrackingSaveVoCollection createDNWForTrackingSaveVoCollectionFromDNW(java.util.List domainObjectList) 
	{
		return createDNWForTrackingSaveVoCollectionFromDNW(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.emergency.domain.objects.DNW objects.
	 */
	public static ims.emergency.vo.DNWForTrackingSaveVoCollection createDNWForTrackingSaveVoCollectionFromDNW(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.emergency.vo.DNWForTrackingSaveVoCollection voList = new ims.emergency.vo.DNWForTrackingSaveVoCollection();
	 ...
	 */
	 public static java.util.Set extractDNWSet(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.DNWForTrackingSaveVoCollection voCollection) 
	 {
	 	return extractDNWSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractDNWSet(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.DNWForTrackingSaveVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.emergency.vo.DNWForTrackingSaveVo vo = voCollection.get(i);
			ims.emergency.domain.objects.DNW domainObject = DNWForTrackingSaveVoAssembler.extractDNW(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractDNWList(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.DNWForTrackingSaveVoCollection voCollection) 
	 {
	 	return extractDNWList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractDNWList(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.DNWForTrackingSaveVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.emergency.vo.DNWForTrackingSaveVo create(ims.emergency.domain.objects.DNW domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.emergency.vo.DNWForTrackingSaveVo create(DomainObjectMap map, ims.emergency.domain.objects.DNW domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.emergency.vo.DNWForTrackingSaveVo valueObject = (ims.emergency.vo.DNWForTrackingSaveVo) map.getValueObject(domainObject, ims.emergency.vo.DNWForTrackingSaveVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.emergency.vo.DNWForTrackingSaveVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.emergency.domain.objects.DNW
	 */
	 public static ims.emergency.vo.DNWForTrackingSaveVo insert(ims.emergency.vo.DNWForTrackingSaveVo valueObject, ims.emergency.domain.objects.DNW domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.emergency.domain.objects.DNW
	 */
	 public static ims.emergency.vo.DNWForTrackingSaveVo insert(DomainObjectMap map, ims.emergency.vo.DNWForTrackingSaveVo valueObject, ims.emergency.domain.objects.DNW domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// CurrentStatus
		valueObject.setCurrentStatus(ims.emergency.vo.domain.DNWStatusForTrackingSaveVoAssembler.create(map, domainObject.getCurrentStatus()) );
		// StatusHistory
		valueObject.setStatusHistory(ims.emergency.vo.domain.DNWStatusForTrackingSaveVoAssembler.createDNWStatusForTrackingSaveVoCollectionFromDNWStatus(map, domainObject.getStatusHistory()) );
 		return valueObject;
	 }
	 ...
	 */
	public static ims.emergency.domain.objects.DNW extractDNW(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.DNWForTrackingSaveVo valueObject) 
	{
		return 	extractDNW(domainFactory, valueObject, new HashMap());
	}

	public static ims.emergency.domain.objects.DNW extractDNW(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.DNWForTrackingSaveVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.emergency.vo.DNWForTrackingSaveVo ID_DNW field is unknown
		...
		domainObject.setCurrentStatus(ims.emergency.vo.domain.DNWStatusForTrackingSaveVoAssembler.extractDNWStatus(domainFactory, valueObject.getCurrentStatus(), domMap));
		domainObject.setStatusHistory(ims.emergency.vo.domain.DNWStatusForTrackingSaveVoAssembler.extractDNWStatusSet(domainFactory, valueObject.getStatusHistory(), domainObject.getStatusHistory(), domMap));		
