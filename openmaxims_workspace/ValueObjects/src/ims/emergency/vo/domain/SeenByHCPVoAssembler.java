 ...
 */
public class SeenByHCPVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.emergency.vo.SeenByHCPVo copy(ims.emergency.vo.SeenByHCPVo valueObjectDest, ims.emergency.vo.SeenByHCPVo valueObjectSrc) 
	 {
		...
		// SeenByHCPNotes
		valueObjectDest.setSeenByHCPNotes(valueObjectSrc.getSeenByHCPNotes());
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createSeenByHCPVoCollectionFromSeenByHCP(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.emergency.domain.objects.SeenByHCP objects.
	 */
	public static ims.emergency.vo.SeenByHCPVoCollection createSeenByHCPVoCollectionFromSeenByHCP(java.util.Set domainObjectSet)	
	{
		return createSeenByHCPVoCollectionFromSeenByHCP(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.emergency.domain.objects.SeenByHCP objects.
	 */
	public static ims.emergency.vo.SeenByHCPVoCollection createSeenByHCPVoCollectionFromSeenByHCP(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.emergency.vo.SeenByHCPVoCollection voList = new ims.emergency.vo.SeenByHCPVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.emergency.vo.SeenByHCPVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.emergency.vo.SeenByHCPVoCollection createSeenByHCPVoCollectionFromSeenByHCP(java.util.List domainObjectList) 
	{
		return createSeenByHCPVoCollectionFromSeenByHCP(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.emergency.domain.objects.SeenByHCP objects.
	 */
	public static ims.emergency.vo.SeenByHCPVoCollection createSeenByHCPVoCollectionFromSeenByHCP(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.emergency.vo.SeenByHCPVoCollection voList = new ims.emergency.vo.SeenByHCPVoCollection();
	 ...
	 */
	 public static java.util.Set extractSeenByHCPSet(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.SeenByHCPVoCollection voCollection) 
	 {
	 	return extractSeenByHCPSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractSeenByHCPSet(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.SeenByHCPVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.emergency.vo.SeenByHCPVo vo = voCollection.get(i);
			ims.emergency.domain.objects.SeenByHCP domainObject = SeenByHCPVoAssembler.extractSeenByHCP(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractSeenByHCPList(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.SeenByHCPVoCollection voCollection) 
	 {
	 	return extractSeenByHCPList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractSeenByHCPList(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.SeenByHCPVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.emergency.vo.SeenByHCPVo create(ims.emergency.domain.objects.SeenByHCP domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.emergency.vo.SeenByHCPVo create(DomainObjectMap map, ims.emergency.domain.objects.SeenByHCP domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.emergency.vo.SeenByHCPVo valueObject = (ims.emergency.vo.SeenByHCPVo) map.getValueObject(domainObject, ims.emergency.vo.SeenByHCPVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.emergency.vo.SeenByHCPVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.emergency.domain.objects.SeenByHCP
	 */
	 public static ims.emergency.vo.SeenByHCPVo insert(ims.emergency.vo.SeenByHCPVo valueObject, ims.emergency.domain.objects.SeenByHCP domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.emergency.domain.objects.SeenByHCP
	 */
	 public static ims.emergency.vo.SeenByHCPVo insert(DomainObjectMap map, ims.emergency.vo.SeenByHCPVo valueObject, ims.emergency.domain.objects.SeenByHCP domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// SeenByHCPNotes
		valueObject.setSeenByHCPNotes(ims.emergency.vo.domain.AttendanceClinicalNotesVoAssembler.createAttendanceClinicalNotesVoCollectionFromAttendanceClinicalNotes(map, domainObject.getSeenByHCPNotes()) );
 		return valueObject;
	 }
	 ...
	 */
	public static ims.emergency.domain.objects.SeenByHCP extractSeenByHCP(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.SeenByHCPVo valueObject) 
	{
		return 	extractSeenByHCP(domainFactory, valueObject, new HashMap());
	}

	public static ims.emergency.domain.objects.SeenByHCP extractSeenByHCP(ims.domain.ILightweightDomainFactory domainFactory, ims.emergency.vo.SeenByHCPVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.emergency.vo.SeenByHCPVo ID_SeenByHCP field is unknown
		...
		ims.framework.utils.DateTime dateTime5 = valueObject.getAllocatedDateTime();
		java.util.Date value5 = null;
		if ( dateTime5 != null ) 
		{
			value5 = dateTime5.getJavaDate();
		}
		domainObject.setAllocatedDateTime(value5);
	...
	ims.core.resource.people.domain.objects.Medic value6 = null;
		if ( null != valueObject.getAllocatedMedic() ) 
		{
			if (valueObject.getAllocatedMedic().getBoId() == null)
			{
				...
				{
					value6 = (ims.core.resource.people.domain.objects.Medic)domMap.get(valueObject.getAllocatedMedic());
				}
			}
			else
			{
				value6 = (ims.core.resource.people.domain.objects.Medic)domainFactory.getDomainObject(ims.core.resource.people.domain.objects.Medic.class, valueObject.getAllocatedMedic().getBoId());
			}
		}
		domainObject.setAllocatedMedic(value6);
	// SaveAsRefVO - treated as a refVo in extract methods
	ims.core.resource.people.domain.objects.Nurse value7 = null;
		if ( null != valueObject.getAllocatedNurse() ) 
		{
			if (valueObject.getAllocatedNurse().getBoId() == null)
			{
				...
				{
					value7 = (ims.core.resource.people.domain.objects.Nurse)domMap.get(valueObject.getAllocatedNurse());
				}
			}
			else
			{
				value7 = (ims.core.resource.people.domain.objects.Nurse)domainFactory.getDomainObject(ims.core.resource.people.domain.objects.Nurse.class, valueObject.getAllocatedNurse().getBoId());
			}
		}
		domainObject.setAllocatedNurse(value7);
		...
		domainObject.setSeenByHCPNotes(ims.emergency.vo.domain.AttendanceClinicalNotesVoAssembler.extractAttendanceClinicalNotesList(domainFactory, valueObject.getSeenByHCPNotes(), domainObject.getSeenByHCPNotes(), domMap));		
