 ...
 */
public class ifEDEpisodeVo extends ims.core.admin.vo.EmergencyEpisodeRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public ifEDEpisodeVo()
	{
	}
	public ifEDEpisodeVo(Integer id, int version)
	{
		super(id, version);
	}
	public ifEDEpisodeVo(ims.emergency.vo.beans.ifEDEpisodeVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.beans.ifEDEpisodeVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.presentingcomplaint = bean.getPresentingComplaint() == null ? null : ims.emergency.vo.lookups.PresentingComplaint.buildLookup(bean.getPresentingComplaint());
	...
	{
		ims.emergency.vo.beans.ifEDEpisodeVoBean bean = null;
		if(map != null)
			bean = (ims.emergency.vo.beans.ifEDEpisodeVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.emergency.vo.beans.ifEDEpisodeVoBean();
	...
	public Object clone()
	{
		...
		ifEDEpisodeVo clone = new ifEDEpisodeVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(ifEDEpisodeVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A ifEDEpisodeVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((ifEDEpisodeVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((ifEDEpisodeVo)obj).getBoId());
	}
