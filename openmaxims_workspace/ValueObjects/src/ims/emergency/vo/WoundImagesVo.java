 ...
 */
public class WoundImagesVo extends ims.core.clinical.vo.WoundImageRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public WoundImagesVo()
	{
	}
	public WoundImagesVo(Integer id, int version)
	{
		super(id, version);
	}
	public WoundImagesVo(ims.emergency.vo.beans.WoundImagesVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.beans.WoundImagesVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.emergency.vo.beans.WoundImagesVoBean bean = null;
		if(map != null)
			bean = (ims.emergency.vo.beans.WoundImagesVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.emergency.vo.beans.WoundImagesVoBean();
	...
	public Object clone()
	{
		...
		WoundImagesVo clone = new WoundImagesVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(WoundImagesVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A WoundImagesVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((WoundImagesVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((WoundImagesVo)obj).getBoId());
	}
