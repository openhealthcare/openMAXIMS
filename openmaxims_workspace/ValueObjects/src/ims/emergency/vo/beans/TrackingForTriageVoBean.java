...
public class TrackingForTriageVoBean extends ims.vo.ValueObjectBean
{
	public TrackingForTriageVoBean()
	{
	}
	public TrackingForTriageVoBean(ims.emergency.vo.TrackingForTriageVo vo)
	{
		this.id = vo.getBoId();
		...
		this.triagedetails = vo.getTriageDetails() == null ? null : (ims.emergency.vo.beans.TriageForTriageVoBean)vo.getTriageDetails().getBean();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.TrackingForTriageVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		...
		this.triagedetails = vo.getTriageDetails() == null ? null : (ims.emergency.vo.beans.TriageForTriageVoBean)vo.getTriageDetails().getBean(map);
		this.currentarea = vo.getCurrentArea() == null ? null : new ims.vo.RefVoBean(vo.getCurrentArea().getBoId(), vo.getCurrentArea().getBoVersion());
		this.isdischarged = vo.getIsDischarged();
	...
	public ims.emergency.vo.TrackingForTriageVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.emergency.vo.TrackingForTriageVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.emergency.vo.TrackingForTriageVo vo = null;
		if(map != null)
			vo = (ims.emergency.vo.TrackingForTriageVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.emergency.vo.TrackingForTriageVo();
	...
	public ims.emergency.vo.beans.TriageForTriageVoBean getTriageDetails()
	{
		return this.triagedetails;
	}
	public void setTriageDetails(ims.emergency.vo.beans.TriageForTriageVoBean value)
	{
	...
	private ims.emergency.vo.beans.TriageForTriageVoBean triagedetails;
