...
public class TrackingForTrackingStatusVoBean extends ims.vo.ValueObjectBean
{
	public TrackingForTrackingStatusVoBean()
	{
	}
	public TrackingForTrackingStatusVoBean(ims.emergency.vo.TrackingForTrackingStatusVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.TrackingForTrackingStatusVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.emergency.vo.TrackingForTrackingStatusVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.emergency.vo.TrackingForTrackingStatusVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.emergency.vo.TrackingForTrackingStatusVo vo = null;
		if(map != null)
			vo = (ims.emergency.vo.TrackingForTrackingStatusVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.emergency.vo.TrackingForTrackingStatusVo();
