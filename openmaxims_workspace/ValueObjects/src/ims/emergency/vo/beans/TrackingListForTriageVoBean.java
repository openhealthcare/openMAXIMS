...
public class TrackingListForTriageVoBean extends ims.vo.ValueObjectBean
{
	public TrackingListForTriageVoBean()
	{
	}
	public TrackingListForTriageVoBean(ims.emergency.vo.TrackingListForTriageVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.TrackingListForTriageVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.emergency.vo.TrackingListForTriageVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.emergency.vo.TrackingListForTriageVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.emergency.vo.TrackingListForTriageVo vo = null;
		if(map != null)
			vo = (ims.emergency.vo.TrackingListForTriageVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.emergency.vo.TrackingListForTriageVo();
