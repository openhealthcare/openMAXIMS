...
public class EmergencyEpisodeForEventHistoryVoBean extends ims.vo.ValueObjectBean
{
	public EmergencyEpisodeForEventHistoryVoBean()
	{
	}
	public EmergencyEpisodeForEventHistoryVoBean(ims.emergency.vo.EmergencyEpisodeForEventHistoryVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.EmergencyEpisodeForEventHistoryVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.injurydatetime = vo.getInjuryDateTime() == null ? null : (ims.framework.utils.beans.DateTimeBean)vo.getInjuryDateTime().getBean();
	...
	public ims.emergency.vo.EmergencyEpisodeForEventHistoryVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.emergency.vo.EmergencyEpisodeForEventHistoryVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.emergency.vo.EmergencyEpisodeForEventHistoryVo vo = null;
		if(map != null)
			vo = (ims.emergency.vo.EmergencyEpisodeForEventHistoryVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.emergency.vo.EmergencyEpisodeForEventHistoryVo();
