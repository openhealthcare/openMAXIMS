...
public class TrackingForBedAvailabilityVoBean extends ims.vo.ValueObjectBean
{
	public TrackingForBedAvailabilityVoBean()
	{
	}
	public TrackingForBedAvailabilityVoBean(ims.emergency.vo.TrackingForBedAvailabilityVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.TrackingForBedAvailabilityVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.currentarea = vo.getCurrentArea() == null ? null : new ims.vo.RefVoBean(vo.getCurrentArea().getBoId(), vo.getCurrentArea().getBoVersion());
	...
	public ims.emergency.vo.TrackingForBedAvailabilityVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.emergency.vo.TrackingForBedAvailabilityVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.emergency.vo.TrackingForBedAvailabilityVo vo = null;
		if(map != null)
			vo = (ims.emergency.vo.TrackingForBedAvailabilityVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.emergency.vo.TrackingForBedAvailabilityVo();
