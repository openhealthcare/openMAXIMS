...
public class EmergencyEpisodeForTriageVoBean extends ims.vo.ValueObjectBean
{
	public EmergencyEpisodeForTriageVoBean()
	{
	}
	public EmergencyEpisodeForTriageVoBean(ims.emergency.vo.EmergencyEpisodeForTriageVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.EmergencyEpisodeForTriageVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.injurydatetime = vo.getInjuryDateTime() == null ? null : (ims.framework.utils.beans.DateTimeBean)vo.getInjuryDateTime().getBean();
	...
	public ims.emergency.vo.EmergencyEpisodeForTriageVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.emergency.vo.EmergencyEpisodeForTriageVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.emergency.vo.EmergencyEpisodeForTriageVo vo = null;
		if(map != null)
			vo = (ims.emergency.vo.EmergencyEpisodeForTriageVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.emergency.vo.EmergencyEpisodeForTriageVo();
	...
	public ims.emergency.vo.beans.EmergencyAttendanceForTriageVoBean[] getEmergencyAttendances()
	{
		return this.emergencyattendances;
	}
	public void setEmergencyAttendances(ims.emergency.vo.beans.EmergencyAttendanceForTriageVoBean[] value)
	{
	...
	private ims.emergency.vo.beans.EmergencyAttendanceForTriageVoBean[] emergencyattendances;
}
