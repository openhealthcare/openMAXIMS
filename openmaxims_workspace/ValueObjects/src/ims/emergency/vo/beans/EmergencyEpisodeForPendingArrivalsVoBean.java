...
public class EmergencyEpisodeForPendingArrivalsVoBean extends ims.vo.ValueObjectBean
{
	public EmergencyEpisodeForPendingArrivalsVoBean()
	{
	}
	public EmergencyEpisodeForPendingArrivalsVoBean(ims.emergency.vo.EmergencyEpisodeForPendingArrivalsVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.EmergencyEpisodeForPendingArrivalsVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.injurydatetime = vo.getInjuryDateTime() == null ? null : (ims.framework.utils.beans.DateTimeBean)vo.getInjuryDateTime().getBean();
	...
	public ims.emergency.vo.EmergencyEpisodeForPendingArrivalsVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.emergency.vo.EmergencyEpisodeForPendingArrivalsVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.emergency.vo.EmergencyEpisodeForPendingArrivalsVo vo = null;
		if(map != null)
			vo = (ims.emergency.vo.EmergencyEpisodeForPendingArrivalsVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.emergency.vo.EmergencyEpisodeForPendingArrivalsVo();
