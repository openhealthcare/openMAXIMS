...
public class EmergencyAttendanceForTriageLiteVoBean extends ims.vo.ValueObjectBean
{
	public EmergencyAttendanceForTriageLiteVoBean()
	{
	}
	public EmergencyAttendanceForTriageLiteVoBean(ims.emergency.vo.EmergencyAttendanceForTriageLiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.EmergencyAttendanceForTriageLiteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.registrationdatetime = vo.getRegistrationDateTime() == null ? null : (ims.framework.utils.beans.DateTimeBean)vo.getRegistrationDateTime().getBean();
	...
	public ims.emergency.vo.EmergencyAttendanceForTriageLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.emergency.vo.EmergencyAttendanceForTriageLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.emergency.vo.EmergencyAttendanceForTriageLiteVo vo = null;
		if(map != null)
			vo = (ims.emergency.vo.EmergencyAttendanceForTriageLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.emergency.vo.EmergencyAttendanceForTriageLiteVo();
