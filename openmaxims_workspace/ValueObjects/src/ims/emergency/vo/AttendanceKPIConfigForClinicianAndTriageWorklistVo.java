 ...
 */
public class AttendanceKPIConfigForClinicianAndTriageWorklistVo extends ims.emergency.configuration.vo.AttendanceKPIConfigRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public AttendanceKPIConfigForClinicianAndTriageWorklistVo()
	{
	}
	public AttendanceKPIConfigForClinicianAndTriageWorklistVo(Integer id, int version)
	{
		super(id, version);
	}
	public AttendanceKPIConfigForClinicianAndTriageWorklistVo(ims.emergency.vo.beans.AttendanceKPIConfigForClinicianAndTriageWorklistVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.beans.AttendanceKPIConfigForClinicianAndTriageWorklistVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.edlocation = bean.getEDLocation() == null ? null : new ims.core.resource.place.vo.LocationRefVo(new Integer(bean.getEDLocation().getId()), bean.getEDLocation().getVersion());
	...
	{
		ims.emergency.vo.beans.AttendanceKPIConfigForClinicianAndTriageWorklistVoBean bean = null;
		if(map != null)
			bean = (ims.emergency.vo.beans.AttendanceKPIConfigForClinicianAndTriageWorklistVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.emergency.vo.beans.AttendanceKPIConfigForClinicianAndTriageWorklistVoBean();
	...
	public Object clone()
	{
		...
		AttendanceKPIConfigForClinicianAndTriageWorklistVo clone = new AttendanceKPIConfigForClinicianAndTriageWorklistVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(AttendanceKPIConfigForClinicianAndTriageWorklistVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A AttendanceKPIConfigForClinicianAndTriageWorklistVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((AttendanceKPIConfigForClinicianAndTriageWorklistVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((AttendanceKPIConfigForClinicianAndTriageWorklistVo)obj).getBoId());
	}
