 ...
 */
public class DNWForTrackingSaveVo extends ims.emergency.vo.DNWRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public DNWForTrackingSaveVo()
	{
	}
	public DNWForTrackingSaveVo(Integer id, int version)
	{
		super(id, version);
	}
	public DNWForTrackingSaveVo(ims.emergency.vo.beans.DNWForTrackingSaveVoBean bean)
	{
		this.id = bean.getId();
		...
		this.statushistory = ims.emergency.vo.DNWStatusForTrackingSaveVoCollection.buildFromBeanCollection(bean.getStatusHistory());
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.beans.DNWForTrackingSaveVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.patient = bean.getPatient() == null ? null : new ims.core.patient.vo.PatientRefVo(new Integer(bean.getPatient().getId()), bean.getPatient().getVersion());
	...
	{
		ims.emergency.vo.beans.DNWForTrackingSaveVoBean bean = null;
		if(map != null)
			bean = (ims.emergency.vo.beans.DNWForTrackingSaveVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.emergency.vo.beans.DNWForTrackingSaveVoBean();
	...
	public ims.emergency.vo.DNWStatusForTrackingSaveVo getCurrentStatus()
	{
		return this.currentstatus;
	}
	public void setCurrentStatus(ims.emergency.vo.DNWStatusForTrackingSaveVo value)
	{
		this.isValidated = false;
	...
	public ims.emergency.vo.DNWStatusForTrackingSaveVoCollection getStatusHistory()
	{
		return this.statushistory;
	}
	public void setStatusHistory(ims.emergency.vo.DNWStatusForTrackingSaveVoCollection value)
	{
		this.isValidated = false;
	...
	public Object clone()
	{
		...
		DNWForTrackingSaveVo clone = new DNWForTrackingSaveVo(this.id, this.version);
		...
		if(this.currentstatus == null)
			...
			clone.currentstatus = (ims.emergency.vo.DNWStatusForTrackingSaveVo)this.currentstatus.clone();
		if(this.statushistory == null)
			clone.statushistory = null;
		else
			clone.statushistory = (ims.emergency.vo.DNWStatusForTrackingSaveVoCollection)this.statushistory.clone();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(DNWForTrackingSaveVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A DNWForTrackingSaveVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((DNWForTrackingSaveVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((DNWForTrackingSaveVo)obj).getBoId());
	}
	...
	protected ims.emergency.vo.DNWStatusForTrackingSaveVo currentstatus;
	protected ims.emergency.vo.DNWStatusForTrackingSaveVoCollection statushistory;
