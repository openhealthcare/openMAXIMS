 ...
 */
public class EpisodeDetailsVo extends ims.core.admin.vo.EmergencyEpisodeRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public EpisodeDetailsVo()
	{
	}
	public EpisodeDetailsVo(Integer id, int version)
	{
		super(id, version);
	}
	public EpisodeDetailsVo(ims.emergency.vo.beans.EpisodeDetailsVoBean bean)
	{
		this.id = bean.getId();
		...
		this.emergencyattendances = ims.emergency.vo.AttendanceDetailsVoCollection.buildFromBeanCollection(bean.getEmergencyAttendances());
		...
		this.otherreferral = bean.getOtherReferral();
		this.medpatientconsent = bean.getMedPatientConsent();
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.beans.EpisodeDetailsVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.injurydatetime = bean.getInjuryDateTime() == null ? null : bean.getInjuryDateTime().buildDateTime();
	...
	{
		ims.emergency.vo.beans.EpisodeDetailsVoBean bean = null;
		if(map != null)
			bean = (ims.emergency.vo.beans.EpisodeDetailsVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.emergency.vo.beans.EpisodeDetailsVoBean();
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("PATIENT"))
			return getPatient();
		if(fieldName.equals("OTHERREFERRAL"))
			return getOtherReferral();
	...
	public ims.emergency.vo.AttendanceDetailsVoCollection getEmergencyAttendances()
	{
		return this.emergencyattendances;
	}
	public void setEmergencyAttendances(ims.emergency.vo.AttendanceDetailsVoCollection value)
	{
		this.isValidated = false;
	...
	public boolean getOtherReferralIsNotNull()
	{
		return this.otherreferral != null;
	}
	public String getOtherReferral()
	{
		return this.otherreferral;
	}
	public static int getOtherReferralMaxLength()
	{
		return 75;
	}
	...
	public boolean isValidated()
	{
		...
		{
			if(!this.specialinterestdetails.isValidated())
			{
				this.isBusy = false;
				return false;
			}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.locationdetails != null)
			if(this.locationdetails.length() > 255)
				listOfErrors.add("The length of the field [locationdetails] in the value object [ims.emergency.vo.EpisodeDetailsVo] is too big. It should be less or equal to 255");
		...
		if(this.placeofemployment != null)
			if(this.placeofemployment.length() > 150)
				listOfErrors.add("The length of the field [placeofemployment] in the value object [ims.emergency.vo.EpisodeDetailsVo] is too big. It should be less or equal to 150");
		if(this.specialinterestdetails != null)
		{
			String[] listOfOtherErrors = this.specialinterestdetails.validate();
			if(listOfOtherErrors != null)
			{
				for(int x = 0; x < listOfOtherErrors.length; x++)
				{
		...
		if(this.tiig != null)
		{
			String[] listOfOtherErrors = this.tiig.validate();
			if(listOfOtherErrors != null)
			{
				for(int x = 0; x < listOfOtherErrors.length; x++)
				{
		...
		if(this.otherreferral != null)
			if(this.otherreferral.length() > 75)
				listOfErrors.add("The length of the field [otherreferral] in the value object [ims.emergency.vo.EpisodeDetailsVo] is too big. It should be less or equal to 75");
	...
	public Object clone()
	{
		...
		EpisodeDetailsVo clone = new EpisodeDetailsVo(this.id, this.version);
		...
		if(this.emergencyattendances == null)
			...
			clone.emergencyattendances = (ims.emergency.vo.AttendanceDetailsVoCollection)this.emergencyattendances.clone();
		if(this.school == null)
			clone.school = null;
		else
		...
		clone.otherreferral = this.otherreferral;
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(EpisodeDetailsVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A EpisodeDetailsVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((EpisodeDetailsVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((EpisodeDetailsVo)obj).getBoId());
	}
	...
	protected ims.emergency.vo.AttendanceDetailsVoCollection emergencyattendances;
	...
	protected String otherreferral;
