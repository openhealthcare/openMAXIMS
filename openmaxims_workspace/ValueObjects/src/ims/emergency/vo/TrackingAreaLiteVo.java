 ...
 */
public class TrackingAreaLiteVo extends ims.emergency.configuration.vo.TrackingAreaRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public TrackingAreaLiteVo(Integer id, int version)
	{
		super(id, version);
	}
	public TrackingAreaLiteVo(ims.emergency.vo.beans.TrackingAreaLiteVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.beans.TrackingAreaLiteVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.areanamedescription = bean.getAreaNameDescription();
	...
	{
		ims.emergency.vo.beans.TrackingAreaLiteVoBean bean = null;
		if(map != null)
			bean = (ims.emergency.vo.beans.TrackingAreaLiteVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.emergency.vo.beans.TrackingAreaLiteVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.areanamedescription == null || this.areanamedescription.length() == 0)
			...
			listOfErrors.add("The length of the field [areanamedescription] in the value object [ims.emergency.vo.TrackingAreaLiteVo] is too big. It should be less or equal to 150");
		if(this.areadisplayname == null || this.areadisplayname.length() == 0)
			...
			listOfErrors.add("The length of the field [areadisplayname] in the value object [ims.emergency.vo.TrackingAreaLiteVo] is too big. It should be less or equal to 15");
		if(this.status == null)
	...
	public Object clone()
	{
		...
		TrackingAreaLiteVo clone = new TrackingAreaLiteVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(TrackingAreaLiteVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A TrackingAreaLiteVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((TrackingAreaLiteVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((TrackingAreaLiteVo)obj).getBoId());
	}
