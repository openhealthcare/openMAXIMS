 ...
 */
public class BedAvailabilityVo extends ims.emergency.vo.BedAvailabilityRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public BedAvailabilityVo(Integer id, int version)
	{
		super(id, version);
	}
	public BedAvailabilityVo(ims.emergency.vo.beans.BedAvailabilityVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.beans.BedAvailabilityVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.patient = bean.getPatient() == null ? null : new ims.core.patient.vo.PatientRefVo(new Integer(bean.getPatient().getId()), bean.getPatient().getVersion());
	...
	{
		ims.emergency.vo.beans.BedAvailabilityVoBean bean = null;
		if(map != null)
			bean = (ims.emergency.vo.beans.BedAvailabilityVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.emergency.vo.beans.BedAvailabilityVoBean();
	...
	public Object clone()
	{
		...
		BedAvailabilityVo clone = new BedAvailabilityVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(BedAvailabilityVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A BedAvailabilityVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((BedAvailabilityVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((BedAvailabilityVo)obj).getBoId());
	}
