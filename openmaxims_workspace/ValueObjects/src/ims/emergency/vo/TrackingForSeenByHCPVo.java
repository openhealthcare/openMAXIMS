 ...
 */
public class TrackingForSeenByHCPVo extends ims.emergency.vo.TrackingRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public TrackingForSeenByHCPVo()
	{
	}
	public TrackingForSeenByHCPVo(Integer id, int version)
	{
		super(id, version);
	}
	public TrackingForSeenByHCPVo(ims.emergency.vo.beans.TrackingForSeenByHCPVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.emergency.vo.beans.TrackingForSeenByHCPVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.patient = bean.getPatient() == null ? null : new ims.core.patient.vo.PatientRefVo(new Integer(bean.getPatient().getId()), bean.getPatient().getVersion());
	...
	{
		ims.emergency.vo.beans.TrackingForSeenByHCPVoBean bean = null;
		if(map != null)
			bean = (ims.emergency.vo.beans.TrackingForSeenByHCPVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.emergency.vo.beans.TrackingForSeenByHCPVoBean();
	...
	public ims.emergency.vo.TriageForSeenByHcpVo getTriageDetails()
	{
		return this.triagedetails;
	}
	public void setTriageDetails(ims.emergency.vo.TriageForSeenByHcpVo value)
	{
		this.isValidated = false;
	...
	public Object clone()
	{
		...
		TrackingForSeenByHCPVo clone = new TrackingForSeenByHCPVo(this.id, this.version);
		...
		if(this.triagedetails == null)
			...
			clone.triagedetails = (ims.emergency.vo.TriageForSeenByHcpVo)this.triagedetails.clone();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(TrackingForSeenByHCPVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A TrackingForSeenByHCPVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((TrackingForSeenByHCPVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((TrackingForSeenByHCPVo)obj).getBoId());
	}
	...
	protected ims.emergency.vo.TriageForSeenByHcpVo triagedetails;
