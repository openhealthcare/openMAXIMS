...
public class SessionSlotForDNAVoBean extends ims.vo.ValueObjectBean
{
	public SessionSlotForDNAVoBean()
	{
	}
	public SessionSlotForDNAVoBean(ims.scheduling.vo.SessionSlotForDNAVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.scheduling.vo.SessionSlotForDNAVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.status = vo.getStatus() == null ? null : (ims.vo.LookupInstanceBean)vo.getStatus().getBean();
	...
	public ims.scheduling.vo.SessionSlotForDNAVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.scheduling.vo.SessionSlotForDNAVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.scheduling.vo.SessionSlotForDNAVo vo = null;
		if(map != null)
			vo = (ims.scheduling.vo.SessionSlotForDNAVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.scheduling.vo.SessionSlotForDNAVo();
