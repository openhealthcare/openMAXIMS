...
public class Session_Exc_TimesVoBean extends ims.vo.ValueObjectBean
{
	public Session_Exc_TimesVoBean()
	{
	}
	public Session_Exc_TimesVoBean(ims.scheduling.vo.Session_Exc_TimesVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.scheduling.vo.Session_Exc_TimesVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.starttime = vo.getStartTime() == null ? null : (ims.framework.utils.beans.TimeBean)vo.getStartTime().getBean();
	...
	public ims.scheduling.vo.Session_Exc_TimesVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.scheduling.vo.Session_Exc_TimesVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.scheduling.vo.Session_Exc_TimesVo vo = null;
		if(map != null)
			vo = (ims.scheduling.vo.Session_Exc_TimesVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.scheduling.vo.Session_Exc_TimesVo();
