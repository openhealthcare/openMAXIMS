...
public class Profile_Exc_TimeVoBean extends ims.vo.ValueObjectBean
{
	public Profile_Exc_TimeVoBean()
	{
	}
	public Profile_Exc_TimeVoBean(ims.scheduling.vo.Profile_Exc_TimeVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.scheduling.vo.Profile_Exc_TimeVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.starttime = vo.getStartTime() == null ? null : (ims.framework.utils.beans.TimeBean)vo.getStartTime().getBean();
	...
	public ims.scheduling.vo.Profile_Exc_TimeVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.scheduling.vo.Profile_Exc_TimeVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.scheduling.vo.Profile_Exc_TimeVo vo = null;
		if(map != null)
			vo = (ims.scheduling.vo.Profile_Exc_TimeVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.scheduling.vo.Profile_Exc_TimeVo();
