...
public class SessionSlotStatusVoBean extends ims.vo.ValueObjectBean
{
	public SessionSlotStatusVoBean()
	{
	}
	public SessionSlotStatusVoBean(ims.scheduling.vo.SessionSlotStatusVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.scheduling.vo.SessionSlotStatusVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.datetime = vo.getDateTime() == null ? null : (ims.framework.utils.beans.DateTimeBean)vo.getDateTime().getBean();
	...
	public ims.scheduling.vo.SessionSlotStatusVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.scheduling.vo.SessionSlotStatusVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.scheduling.vo.SessionSlotStatusVo vo = null;
		if(map != null)
			vo = (ims.scheduling.vo.SessionSlotStatusVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.scheduling.vo.SessionSlotStatusVo();
