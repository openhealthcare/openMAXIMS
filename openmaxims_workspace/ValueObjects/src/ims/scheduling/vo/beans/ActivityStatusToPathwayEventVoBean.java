...
public class ActivityStatusToPathwayEventVoBean extends ims.vo.ValueObjectBean
{
	public ActivityStatusToPathwayEventVoBean()
	{
	}
	public ActivityStatusToPathwayEventVoBean(ims.scheduling.vo.ActivityStatusToPathwayEventVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.scheduling.vo.ActivityStatusToPathwayEventVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.scheduling.vo.ActivityStatusToPathwayEventVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.scheduling.vo.ActivityStatusToPathwayEventVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.scheduling.vo.ActivityStatusToPathwayEventVo vo = null;
		if(map != null)
			vo = (ims.scheduling.vo.ActivityStatusToPathwayEventVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.scheduling.vo.ActivityStatusToPathwayEventVo();
