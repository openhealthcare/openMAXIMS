 ...
 */
public class SessionActivityEventVo extends ims.scheduling.vo.SessionActivityPathwayEventRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public SessionActivityEventVo()
	{
	}
	public SessionActivityEventVo(Integer id, int version)
	{
		super(id, version);
	}
	public SessionActivityEventVo(ims.scheduling.vo.beans.SessionActivityEventVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.scheduling.vo.beans.SessionActivityEventVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.activity = bean.getActivity() == null ? null : new ims.core.resource.place.vo.ActivityRefVo(new Integer(bean.getActivity().getId()), bean.getActivity().getVersion());
	...
	{
		ims.scheduling.vo.beans.SessionActivityEventVoBean bean = null;
		if(map != null)
			bean = (ims.scheduling.vo.beans.SessionActivityEventVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.scheduling.vo.beans.SessionActivityEventVoBean();
	...
	public Object clone()
	{
		...
		SessionActivityEventVo clone = new SessionActivityEventVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(SessionActivityEventVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A SessionActivityEventVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((SessionActivityEventVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((SessionActivityEventVo)obj).getBoId());
	}
