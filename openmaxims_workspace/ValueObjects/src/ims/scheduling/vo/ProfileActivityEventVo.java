 ...
 */
public class ProfileActivityEventVo extends ims.scheduling.vo.ActivityStatusToPathwayEventRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public ProfileActivityEventVo()
	{
	}
	public ProfileActivityEventVo(Integer id, int version)
	{
		super(id, version);
	}
	public ProfileActivityEventVo(ims.scheduling.vo.beans.ProfileActivityEventVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.scheduling.vo.beans.ProfileActivityEventVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.scheduling.vo.beans.ProfileActivityEventVoBean bean = null;
		if(map != null)
			bean = (ims.scheduling.vo.beans.ProfileActivityEventVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.scheduling.vo.beans.ProfileActivityEventVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.activity == null)
			listOfErrors.add("Events tab,  Activity field is mandatory");
		if(this.activity != null)
		{
		...
		if(this.appointmentstatus == null)
			listOfErrors.add("Events tab,  Status field is mandatory");
		if(this.event == null)
			listOfErrors.add("Events tab,  Pathway Event field is mandatory");
		if(this.event != null)
		{
	...
	public Object clone()
	{
		...
		ProfileActivityEventVo clone = new ProfileActivityEventVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(ProfileActivityEventVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A ProfileActivityEventVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((ProfileActivityEventVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((ProfileActivityEventVo)obj).getBoId());
	}
