 ...
 */
public class BookingAppointmentClinicListListVo extends ims.scheduling.vo.Booking_AppointmentRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public BookingAppointmentClinicListListVo()
	{
	}
	public BookingAppointmentClinicListListVo(Integer id, int version)
	{
		super(id, version);
	}
	public BookingAppointmentClinicListListVo(ims.scheduling.vo.beans.BookingAppointmentClinicListListVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.scheduling.vo.beans.BookingAppointmentClinicListListVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.appointmentdate = bean.getAppointmentDate() == null ? null : bean.getAppointmentDate().buildDate();
	...
	{
		ims.scheduling.vo.beans.BookingAppointmentClinicListListVoBean bean = null;
		if(map != null)
			bean = (ims.scheduling.vo.beans.BookingAppointmentClinicListListVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.scheduling.vo.beans.BookingAppointmentClinicListListVoBean();
	...
	public ims.core.vo.PatientClinicListListVo getPatient()
	{
		return this.patient;
	}
	public void setPatient(ims.core.vo.PatientClinicListListVo value)
	{
		this.isValidated = false;
		this.patient = value;
	}
	...
	public Object clone()
	{
		...
		BookingAppointmentClinicListListVo clone = new BookingAppointmentClinicListListVo(this.id, this.version);
		...
		if(this.patient == null)
			...
			clone.patient = (ims.core.vo.PatientClinicListListVo)this.patient.clone();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(BookingAppointmentClinicListListVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A BookingAppointmentClinicListListVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((BookingAppointmentClinicListListVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((BookingAppointmentClinicListListVo)obj).getBoId());
	}
	...
	protected ims.core.vo.PatientClinicListListVo patient;
