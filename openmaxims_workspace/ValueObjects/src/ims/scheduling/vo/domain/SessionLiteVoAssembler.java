 ...
 */
public class SessionLiteVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.scheduling.vo.SessionLiteVo copy(ims.scheduling.vo.SessionLiteVo valueObjectDest, ims.scheduling.vo.SessionLiteVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createSessionLiteVoCollectionFromSch_Session(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.scheduling.domain.objects.Sch_Session objects.
	 */
	public static ims.scheduling.vo.SessionLiteVoCollection createSessionLiteVoCollectionFromSch_Session(java.util.Set domainObjectSet)	
	{
		return createSessionLiteVoCollectionFromSch_Session(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.scheduling.domain.objects.Sch_Session objects.
	 */
	public static ims.scheduling.vo.SessionLiteVoCollection createSessionLiteVoCollectionFromSch_Session(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.scheduling.vo.SessionLiteVoCollection voList = new ims.scheduling.vo.SessionLiteVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.scheduling.vo.SessionLiteVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.scheduling.vo.SessionLiteVoCollection createSessionLiteVoCollectionFromSch_Session(java.util.List domainObjectList) 
	{
		return createSessionLiteVoCollectionFromSch_Session(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.scheduling.domain.objects.Sch_Session objects.
	 */
	public static ims.scheduling.vo.SessionLiteVoCollection createSessionLiteVoCollectionFromSch_Session(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.scheduling.vo.SessionLiteVoCollection voList = new ims.scheduling.vo.SessionLiteVoCollection();
	 ...
	 */
	 public static java.util.Set extractSch_SessionSet(ims.domain.ILightweightDomainFactory domainFactory, ims.scheduling.vo.SessionLiteVoCollection voCollection) 
	 {
	 	return extractSch_SessionSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractSch_SessionSet(ims.domain.ILightweightDomainFactory domainFactory, ims.scheduling.vo.SessionLiteVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.scheduling.vo.SessionLiteVo vo = voCollection.get(i);
			ims.scheduling.domain.objects.Sch_Session domainObject = SessionLiteVoAssembler.extractSch_Session(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractSch_SessionList(ims.domain.ILightweightDomainFactory domainFactory, ims.scheduling.vo.SessionLiteVoCollection voCollection) 
	 {
	 	return extractSch_SessionList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractSch_SessionList(ims.domain.ILightweightDomainFactory domainFactory, ims.scheduling.vo.SessionLiteVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.scheduling.vo.SessionLiteVo create(ims.scheduling.domain.objects.Sch_Session domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.scheduling.vo.SessionLiteVo create(DomainObjectMap map, ims.scheduling.domain.objects.Sch_Session domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.scheduling.vo.SessionLiteVo valueObject = (ims.scheduling.vo.SessionLiteVo) map.getValueObject(domainObject, ims.scheduling.vo.SessionLiteVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.scheduling.vo.SessionLiteVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.scheduling.domain.objects.Sch_Session
	 */
	 public static ims.scheduling.vo.SessionLiteVo insert(ims.scheduling.vo.SessionLiteVo valueObject, ims.scheduling.domain.objects.Sch_Session domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.scheduling.domain.objects.Sch_Session
	 */
	 public static ims.scheduling.vo.SessionLiteVo insert(DomainObjectMap map, ims.scheduling.vo.SessionLiteVo valueObject, ims.scheduling.domain.objects.Sch_Session domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.scheduling.domain.objects.Sch_Session extractSch_Session(ims.domain.ILightweightDomainFactory domainFactory, ims.scheduling.vo.SessionLiteVo valueObject) 
	{
		return 	extractSch_Session(domainFactory, valueObject, new HashMap());
	}

	public static ims.scheduling.domain.objects.Sch_Session extractSch_Session(ims.domain.ILightweightDomainFactory domainFactory, ims.scheduling.vo.SessionLiteVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.scheduling.vo.SessionLiteVo ID_Sch_Session field is unknown
		...
		ims.framework.utils.Time time4 = valueObject.getStartTm();
		String value4 = null;
		if ( time4 != null ) 
		{
			value4 = time4.toString();
		}
		domainObject.setStartTm(value4);
