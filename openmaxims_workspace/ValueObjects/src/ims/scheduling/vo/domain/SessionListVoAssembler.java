 ...
 */
public class SessionListVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.scheduling.vo.SessionListVo copy(ims.scheduling.vo.SessionListVo valueObjectDest, ims.scheduling.vo.SessionListVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createSessionListVoCollectionFromSch_Session(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.scheduling.domain.objects.Sch_Session objects.
	 */
	public static ims.scheduling.vo.SessionListVoCollection createSessionListVoCollectionFromSch_Session(java.util.Set domainObjectSet)	
	{
		return createSessionListVoCollectionFromSch_Session(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.scheduling.domain.objects.Sch_Session objects.
	 */
	public static ims.scheduling.vo.SessionListVoCollection createSessionListVoCollectionFromSch_Session(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.scheduling.vo.SessionListVoCollection voList = new ims.scheduling.vo.SessionListVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.scheduling.vo.SessionListVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.scheduling.vo.SessionListVoCollection createSessionListVoCollectionFromSch_Session(java.util.List domainObjectList) 
	{
		return createSessionListVoCollectionFromSch_Session(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.scheduling.domain.objects.Sch_Session objects.
	 */
	public static ims.scheduling.vo.SessionListVoCollection createSessionListVoCollectionFromSch_Session(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.scheduling.vo.SessionListVoCollection voList = new ims.scheduling.vo.SessionListVoCollection();
	 ...
	 */
	 public static java.util.Set extractSch_SessionSet(ims.domain.ILightweightDomainFactory domainFactory, ims.scheduling.vo.SessionListVoCollection voCollection) 
	 {
	 	return extractSch_SessionSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractSch_SessionSet(ims.domain.ILightweightDomainFactory domainFactory, ims.scheduling.vo.SessionListVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.scheduling.vo.SessionListVo vo = voCollection.get(i);
			ims.scheduling.domain.objects.Sch_Session domainObject = SessionListVoAssembler.extractSch_Session(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractSch_SessionList(ims.domain.ILightweightDomainFactory domainFactory, ims.scheduling.vo.SessionListVoCollection voCollection) 
	 {
	 	return extractSch_SessionList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractSch_SessionList(ims.domain.ILightweightDomainFactory domainFactory, ims.scheduling.vo.SessionListVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.scheduling.vo.SessionListVo create(ims.scheduling.domain.objects.Sch_Session domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.scheduling.vo.SessionListVo create(DomainObjectMap map, ims.scheduling.domain.objects.Sch_Session domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.scheduling.vo.SessionListVo valueObject = (ims.scheduling.vo.SessionListVo) map.getValueObject(domainObject, ims.scheduling.vo.SessionListVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.scheduling.vo.SessionListVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.scheduling.domain.objects.Sch_Session
	 */
	 public static ims.scheduling.vo.SessionListVo insert(ims.scheduling.vo.SessionListVo valueObject, ims.scheduling.domain.objects.Sch_Session domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.scheduling.domain.objects.Sch_Session
	 */
	 public static ims.scheduling.vo.SessionListVo insert(DomainObjectMap map, ims.scheduling.vo.SessionListVo valueObject, ims.scheduling.domain.objects.Sch_Session domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.scheduling.domain.objects.Sch_Session extractSch_Session(ims.domain.ILightweightDomainFactory domainFactory, ims.scheduling.vo.SessionListVo valueObject) 
	{
		return 	extractSch_Session(domainFactory, valueObject, new HashMap());
	}

	public static ims.scheduling.domain.objects.Sch_Session extractSch_Session(ims.domain.ILightweightDomainFactory domainFactory, ims.scheduling.vo.SessionListVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.scheduling.vo.SessionListVo ID_Sch_Session field is unknown
