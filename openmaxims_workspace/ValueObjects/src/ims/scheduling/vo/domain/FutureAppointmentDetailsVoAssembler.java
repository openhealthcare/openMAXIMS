...
public class FutureAppointmentDetailsVoAssembler
{
	 ...
	 */
	 public static ims.scheduling.vo.FutureAppointmentDetailsVo copy(ims.scheduling.vo.FutureAppointmentDetailsVo valueObjectDest, ims.scheduling.vo.FutureAppointmentDetailsVo valueObjectSrc) 
	 {
		...
		// FutureApptByDate
		valueObjectDest.setFutureApptByDate(valueObjectSrc.getFutureApptByDate());
	 ...
	 */
	 public static ims.scheduling.vo.FutureAppointmentDetailsVo insert(DomainObjectMap map, ims.scheduling.vo.FutureAppointmentDetailsVo valueObject, ims.scheduling.domain.objects.FutureAppointmentDetails domainObject) 
	 {
		...
		// PeriodType
		ims.domain.lookups.LookupInstance instance2 = domainObject.getPeriodType();
		if ( null != instance2 ) {
			...
			ims.core.vo.lookups.TimeUnitsSecondsToMonths voLookup2 = new ims.core.vo.lookups.TimeUnitsSecondsToMonths(instance2.getId(),instance2.getText(), instance2.isActive(), null, img, color);
			ims.core.vo.lookups.TimeUnitsSecondsToMonths parentVoLookup2 = voLookup2;
			...
			while (parent2 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup2.setParent(new ims.core.vo.lookups.TimeUnitsSecondsToMonths(parent2.getId(),parent2.getText(), parent2.isActive(), null, img, color));
				parentVoLookup2 = parentVoLookup2.getParent();
								parent2 = parent2.getParent();
			}			
			valueObject.setPeriodType(voLookup2);
		}
				// FutureApptByDate
		java.util.Date FutureApptByDate = domainObject.getFutureApptByDate();
		if ( null != FutureApptByDate ) 
		{
			valueObject.setFutureApptByDate(new ims.framework.utils.Date(FutureApptByDate) );
		}
 		return valueObject;
	 }
	...
	public static ims.scheduling.domain.objects.FutureAppointmentDetails extractFutureAppointmentDetails(ims.domain.ILightweightDomainFactory domainFactory, ims.scheduling.vo.FutureAppointmentDetailsVo valueObject, HashMap domMap) 
	{
		...
		domainObject.setPeriodType(value2);
		java.util.Date value3 = null;
		ims.framework.utils.Date date3 = valueObject.getFutureApptByDate();		
		if ( date3 != null ) 
		{
			value3 = date3.getDate();
		}
		domainObject.setFutureApptByDate(value3);
