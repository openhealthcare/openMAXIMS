 ...
 */
public class BookingAppointmentShortVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.scheduling.vo.BookingAppointmentShortVo copy(ims.scheduling.vo.BookingAppointmentShortVo valueObjectDest, ims.scheduling.vo.BookingAppointmentShortVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createBookingAppointmentShortVoCollectionFromBooking_Appointment(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.scheduling.domain.objects.Booking_Appointment objects.
	 */
	public static ims.scheduling.vo.BookingAppointmentShortVoCollection createBookingAppointmentShortVoCollectionFromBooking_Appointment(java.util.Set domainObjectSet)	
	{
		return createBookingAppointmentShortVoCollectionFromBooking_Appointment(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.scheduling.domain.objects.Booking_Appointment objects.
	 */
	public static ims.scheduling.vo.BookingAppointmentShortVoCollection createBookingAppointmentShortVoCollectionFromBooking_Appointment(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.scheduling.vo.BookingAppointmentShortVoCollection voList = new ims.scheduling.vo.BookingAppointmentShortVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.scheduling.vo.BookingAppointmentShortVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.scheduling.vo.BookingAppointmentShortVoCollection createBookingAppointmentShortVoCollectionFromBooking_Appointment(java.util.List domainObjectList) 
	{
		return createBookingAppointmentShortVoCollectionFromBooking_Appointment(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.scheduling.domain.objects.Booking_Appointment objects.
	 */
	public static ims.scheduling.vo.BookingAppointmentShortVoCollection createBookingAppointmentShortVoCollectionFromBooking_Appointment(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.scheduling.vo.BookingAppointmentShortVoCollection voList = new ims.scheduling.vo.BookingAppointmentShortVoCollection();
	 ...
	 */
	 public static java.util.Set extractBooking_AppointmentSet(ims.domain.ILightweightDomainFactory domainFactory, ims.scheduling.vo.BookingAppointmentShortVoCollection voCollection) 
	 {
	 	return extractBooking_AppointmentSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractBooking_AppointmentSet(ims.domain.ILightweightDomainFactory domainFactory, ims.scheduling.vo.BookingAppointmentShortVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.scheduling.vo.BookingAppointmentShortVo vo = voCollection.get(i);
			ims.scheduling.domain.objects.Booking_Appointment domainObject = BookingAppointmentShortVoAssembler.extractBooking_Appointment(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractBooking_AppointmentList(ims.domain.ILightweightDomainFactory domainFactory, ims.scheduling.vo.BookingAppointmentShortVoCollection voCollection) 
	 {
	 	return extractBooking_AppointmentList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractBooking_AppointmentList(ims.domain.ILightweightDomainFactory domainFactory, ims.scheduling.vo.BookingAppointmentShortVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.scheduling.vo.BookingAppointmentShortVo create(ims.scheduling.domain.objects.Booking_Appointment domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.scheduling.vo.BookingAppointmentShortVo create(DomainObjectMap map, ims.scheduling.domain.objects.Booking_Appointment domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.scheduling.vo.BookingAppointmentShortVo valueObject = (ims.scheduling.vo.BookingAppointmentShortVo) map.getValueObject(domainObject, ims.scheduling.vo.BookingAppointmentShortVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.scheduling.vo.BookingAppointmentShortVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.scheduling.domain.objects.Booking_Appointment
	 */
	 public static ims.scheduling.vo.BookingAppointmentShortVo insert(ims.scheduling.vo.BookingAppointmentShortVo valueObject, ims.scheduling.domain.objects.Booking_Appointment domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.scheduling.domain.objects.Booking_Appointment
	 */
	 public static ims.scheduling.vo.BookingAppointmentShortVo insert(DomainObjectMap map, ims.scheduling.vo.BookingAppointmentShortVo valueObject, ims.scheduling.domain.objects.Booking_Appointment domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		if ( null != instance3 ) {
			...
			ims.scheduling.vo.lookups.ApptOutcome voLookup3 = new ims.scheduling.vo.lookups.ApptOutcome(instance3.getId(),instance3.getText(), instance3.isActive(), null, img, color);
			ims.scheduling.vo.lookups.ApptOutcome parentVoLookup3 = voLookup3;
			...
			while (parent3 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup3.setParent(new ims.scheduling.vo.lookups.ApptOutcome(parent3.getId(),parent3.getText(), parent3.isActive(), null, img, color));
	 ...
	 */
	public static ims.scheduling.domain.objects.Booking_Appointment extractBooking_Appointment(ims.domain.ILightweightDomainFactory domainFactory, ims.scheduling.vo.BookingAppointmentShortVo valueObject) 
	{
		return 	extractBooking_Appointment(domainFactory, valueObject, new HashMap());
	}

	public static ims.scheduling.domain.objects.Booking_Appointment extractBooking_Appointment(ims.domain.ILightweightDomainFactory domainFactory, ims.scheduling.vo.BookingAppointmentShortVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.scheduling.vo.BookingAppointmentShortVo ID_Booking_Appointment field is unknown
		...
		ims.framework.utils.Time time6 = valueObject.getApptStartTime();
		String value6 = null;
		if ( time6 != null ) 
		{
			value6 = time6.toString();
		}
		domainObject.setApptStartTime(value6);
		...
		ims.scheduling.vo.Appointment_StatusRefVoCollection refCollection8 = new ims.scheduling.vo.Appointment_StatusRefVoCollection();
		if (valueObject.getApptStatusHistory() != null)
		{
			for (int i8=0; i8<valueObject.getApptStatusHistory().size(); i8++)
			{
				ims.scheduling.vo.Appointment_StatusRefVo ref8 = (ims.scheduling.vo.Appointment_StatusRefVo)valueObject.getApptStatusHistory().get(i8);
				refCollection8.add(ref8);
			}
		}
		int size8 = (null == refCollection8) ? 0 : refCollection8.size();		
		java.util.Set domainApptStatusHistory8 = domainObject.getApptStatusHistory();
		if (domainApptStatusHistory8 == null)
		{
			domainApptStatusHistory8 = new java.util.HashSet();
		}
		java.util.Set newSet8  = new java.util.HashSet();
		for(int i=0; i<size8; i++) 
		{
			ims.scheduling.vo.Appointment_StatusRefVo vo = refCollection8.get(i);					
			...
			//Trying to avoid the hibernate collection being marked as dirty via its public interface methods. (like add)
			if (!domainApptStatusHistory8.contains(dom))
			{
				domainApptStatusHistory8.add(dom);
			}
			newSet8.add(dom);			
		}
		java.util.Set removedSet8 = new java.util.HashSet();
		java.util.Iterator iter8 = domainApptStatusHistory8.iterator();
		//Find out which objects need to be removed
		while (iter8.hasNext())
		{
		...
		while (iter8.hasNext())
		{
			domainApptStatusHistory8.remove(iter8.next());
		}		
		
		domainObject.setApptStatusHistory(domainApptStatusHistory8);		
