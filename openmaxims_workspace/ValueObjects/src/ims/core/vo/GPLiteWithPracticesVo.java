 ...
 */
public class GPLiteWithPracticesVo extends ims.core.vo.GpLiteVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public GPLiteWithPracticesVo()
	{
	}
	public GPLiteWithPracticesVo(Integer id, int version)
	{
		super(id, version);
	}
	public GPLiteWithPracticesVo(ims.core.vo.beans.GPLiteWithPracticesVoBean bean)
	{
		this.id = bean.getId();
		...
		this.practices = ims.core.vo.GpLiteToPracticeLiteVoCollection.buildFromBeanCollection(bean.getPractices());
		this.status = bean.getStatus() == null ? null : ims.core.vo.lookups.GPStatus.buildLookup(bean.getStatus());
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.GPLiteWithPracticesVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.core.vo.beans.GPLiteWithPracticesVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.GPLiteWithPracticesVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.GPLiteWithPracticesVoBean();
	...
	public ims.core.vo.GpLiteToPracticeLiteVoCollection getPractices()
	{
		return this.practices;
	}
	public void setPractices(ims.core.vo.GpLiteToPracticeLiteVoCollection value)
	{
	...
	public Object clone()
	{
		...
		GPLiteWithPracticesVo clone = new GPLiteWithPracticesVo(this.id, this.version);
		...
		if(this.practices == null)
			...
			clone.practices = (ims.core.vo.GpLiteToPracticeLiteVoCollection)this.practices.clone();
		if(this.status == null)
			clone.status = null;
		else
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(GPLiteWithPracticesVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A GPLiteWithPracticesVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((GPLiteWithPracticesVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((GPLiteWithPracticesVo)obj).getBoId());
	}
	...
	protected ims.core.vo.GpLiteToPracticeLiteVoCollection practices;
