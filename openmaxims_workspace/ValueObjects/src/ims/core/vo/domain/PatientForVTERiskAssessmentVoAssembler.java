 ...
 */
public class PatientForVTERiskAssessmentVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.PatientForVTERiskAssessmentVo copy(ims.core.vo.PatientForVTERiskAssessmentVo valueObjectDest, ims.core.vo.PatientForVTERiskAssessmentVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createPatientForVTERiskAssessmentVoCollectionFromPatient(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.patient.domain.objects.Patient objects.
	 */
	public static ims.core.vo.PatientForVTERiskAssessmentVoCollection createPatientForVTERiskAssessmentVoCollectionFromPatient(java.util.Set domainObjectSet)	
	{
		return createPatientForVTERiskAssessmentVoCollectionFromPatient(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.patient.domain.objects.Patient objects.
	 */
	public static ims.core.vo.PatientForVTERiskAssessmentVoCollection createPatientForVTERiskAssessmentVoCollectionFromPatient(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.PatientForVTERiskAssessmentVoCollection voList = new ims.core.vo.PatientForVTERiskAssessmentVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.PatientForVTERiskAssessmentVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.PatientForVTERiskAssessmentVoCollection createPatientForVTERiskAssessmentVoCollectionFromPatient(java.util.List domainObjectList) 
	{
		return createPatientForVTERiskAssessmentVoCollectionFromPatient(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.patient.domain.objects.Patient objects.
	 */
	public static ims.core.vo.PatientForVTERiskAssessmentVoCollection createPatientForVTERiskAssessmentVoCollectionFromPatient(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.PatientForVTERiskAssessmentVoCollection voList = new ims.core.vo.PatientForVTERiskAssessmentVoCollection();
	 ...
	 */
	 public static java.util.Set extractPatientSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientForVTERiskAssessmentVoCollection voCollection) 
	 {
	 	return extractPatientSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientForVTERiskAssessmentVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.PatientForVTERiskAssessmentVo vo = voCollection.get(i);
			ims.core.patient.domain.objects.Patient domainObject = PatientForVTERiskAssessmentVoAssembler.extractPatient(domainFactory, vo, domMap);
	 ...
	 */
	 ...
	 public static java.util.List extractPatientList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientForVTERiskAssessmentVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.PatientForVTERiskAssessmentVo create(ims.core.patient.domain.objects.Patient domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.PatientForVTERiskAssessmentVo create(DomainObjectMap map, ims.core.patient.domain.objects.Patient domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.PatientForVTERiskAssessmentVo valueObject = (ims.core.vo.PatientForVTERiskAssessmentVo) map.getValueObject(domainObject, ims.core.vo.PatientForVTERiskAssessmentVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.PatientForVTERiskAssessmentVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.patient.domain.objects.Patient
	 */
	 public static ims.core.vo.PatientForVTERiskAssessmentVo insert(ims.core.vo.PatientForVTERiskAssessmentVo valueObject, ims.core.patient.domain.objects.Patient domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.patient.domain.objects.Patient
	 */
	 public static ims.core.vo.PatientForVTERiskAssessmentVo insert(DomainObjectMap map, ims.core.vo.PatientForVTERiskAssessmentVo valueObject, ims.core.patient.domain.objects.Patient domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.patient.domain.objects.Patient extractPatient(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientForVTERiskAssessmentVo valueObject) 
	{
		return 	extractPatient(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.patient.domain.objects.Patient extractPatient(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientForVTERiskAssessmentVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.PatientForVTERiskAssessmentVo ID_Patient field is unknown
