 ...
 */
public class BedSpaceStateStatusVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.BedSpaceStateStatusVo copy(ims.core.vo.BedSpaceStateStatusVo valueObjectDest, ims.core.vo.BedSpaceStateStatusVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createBedSpaceStateStatusVoCollectionFromBedSpaceStateStatus(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.admin.pas.domain.objects.BedSpaceStateStatus objects.
	 */
	public static ims.core.vo.BedSpaceStateStatusVoCollection createBedSpaceStateStatusVoCollectionFromBedSpaceStateStatus(java.util.Set domainObjectSet)	
	{
		return createBedSpaceStateStatusVoCollectionFromBedSpaceStateStatus(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.admin.pas.domain.objects.BedSpaceStateStatus objects.
	 */
	public static ims.core.vo.BedSpaceStateStatusVoCollection createBedSpaceStateStatusVoCollectionFromBedSpaceStateStatus(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.BedSpaceStateStatusVoCollection voList = new ims.core.vo.BedSpaceStateStatusVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.BedSpaceStateStatusVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.BedSpaceStateStatusVoCollection createBedSpaceStateStatusVoCollectionFromBedSpaceStateStatus(java.util.List domainObjectList) 
	{
		return createBedSpaceStateStatusVoCollectionFromBedSpaceStateStatus(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.admin.pas.domain.objects.BedSpaceStateStatus objects.
	 */
	public static ims.core.vo.BedSpaceStateStatusVoCollection createBedSpaceStateStatusVoCollectionFromBedSpaceStateStatus(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.BedSpaceStateStatusVoCollection voList = new ims.core.vo.BedSpaceStateStatusVoCollection();
	 ...
	 */
	 public static java.util.Set extractBedSpaceStateStatusSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.BedSpaceStateStatusVoCollection voCollection) 
	 {
	 	return extractBedSpaceStateStatusSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractBedSpaceStateStatusSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.BedSpaceStateStatusVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.BedSpaceStateStatusVo vo = voCollection.get(i);
			ims.core.admin.pas.domain.objects.BedSpaceStateStatus domainObject = BedSpaceStateStatusVoAssembler.extractBedSpaceStateStatus(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractBedSpaceStateStatusList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.BedSpaceStateStatusVoCollection voCollection) 
	 {
	 	return extractBedSpaceStateStatusList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractBedSpaceStateStatusList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.BedSpaceStateStatusVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.BedSpaceStateStatusVo create(ims.core.admin.pas.domain.objects.BedSpaceStateStatus domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.BedSpaceStateStatusVo create(DomainObjectMap map, ims.core.admin.pas.domain.objects.BedSpaceStateStatus domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.BedSpaceStateStatusVo valueObject = (ims.core.vo.BedSpaceStateStatusVo) map.getValueObject(domainObject, ims.core.vo.BedSpaceStateStatusVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.BedSpaceStateStatusVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.admin.pas.domain.objects.BedSpaceStateStatus
	 */
	 public static ims.core.vo.BedSpaceStateStatusVo insert(ims.core.vo.BedSpaceStateStatusVo valueObject, ims.core.admin.pas.domain.objects.BedSpaceStateStatus domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.admin.pas.domain.objects.BedSpaceStateStatus
	 */
	 public static ims.core.vo.BedSpaceStateStatusVo insert(DomainObjectMap map, ims.core.vo.BedSpaceStateStatusVo valueObject, ims.core.admin.pas.domain.objects.BedSpaceStateStatus domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.admin.pas.domain.objects.BedSpaceStateStatus extractBedSpaceStateStatus(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.BedSpaceStateStatusVo valueObject) 
	{
		return 	extractBedSpaceStateStatus(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.admin.pas.domain.objects.BedSpaceStateStatus extractBedSpaceStateStatus(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.BedSpaceStateStatusVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.BedSpaceStateStatusVo ID_BedSpaceStateStatus field is unknown
