 ...
 */
public class PatientAlertEDischargeVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.PatientAlertEDischargeVo copy(ims.core.vo.PatientAlertEDischargeVo valueObjectDest, ims.core.vo.PatientAlertEDischargeVo valueObjectSrc) 
	 {
		...
		valueObjectDest.setIncludeAlertInDischargeReports(valueObjectSrc.getIncludeAlertInDischargeReports());
		// SysInfo
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createPatientAlertEDischargeVoCollectionFromPatientAlert(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.clinical.domain.objects.PatientAlert objects.
	 */
	public static ims.core.vo.PatientAlertEDischargeVoCollection createPatientAlertEDischargeVoCollectionFromPatientAlert(java.util.Set domainObjectSet)	
	{
		return createPatientAlertEDischargeVoCollectionFromPatientAlert(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.clinical.domain.objects.PatientAlert objects.
	 */
	public static ims.core.vo.PatientAlertEDischargeVoCollection createPatientAlertEDischargeVoCollectionFromPatientAlert(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.PatientAlertEDischargeVoCollection voList = new ims.core.vo.PatientAlertEDischargeVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.PatientAlertEDischargeVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.PatientAlertEDischargeVoCollection createPatientAlertEDischargeVoCollectionFromPatientAlert(java.util.List domainObjectList) 
	{
		return createPatientAlertEDischargeVoCollectionFromPatientAlert(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.clinical.domain.objects.PatientAlert objects.
	 */
	public static ims.core.vo.PatientAlertEDischargeVoCollection createPatientAlertEDischargeVoCollectionFromPatientAlert(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.PatientAlertEDischargeVoCollection voList = new ims.core.vo.PatientAlertEDischargeVoCollection();
	 ...
	 */
	 public static java.util.Set extractPatientAlertSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientAlertEDischargeVoCollection voCollection) 
	 {
	 	return extractPatientAlertSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientAlertSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientAlertEDischargeVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.PatientAlertEDischargeVo vo = voCollection.get(i);
			ims.core.clinical.domain.objects.PatientAlert domainObject = PatientAlertEDischargeVoAssembler.extractPatientAlert(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPatientAlertList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientAlertEDischargeVoCollection voCollection) 
	 {
	 	return extractPatientAlertList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPatientAlertList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientAlertEDischargeVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.PatientAlertEDischargeVo create(ims.core.clinical.domain.objects.PatientAlert domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.PatientAlertEDischargeVo create(DomainObjectMap map, ims.core.clinical.domain.objects.PatientAlert domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.PatientAlertEDischargeVo valueObject = (ims.core.vo.PatientAlertEDischargeVo) map.getValueObject(domainObject, ims.core.vo.PatientAlertEDischargeVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.PatientAlertEDischargeVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.PatientAlert
	 */
	 public static ims.core.vo.PatientAlertEDischargeVo insert(ims.core.vo.PatientAlertEDischargeVo valueObject, ims.core.clinical.domain.objects.PatientAlert domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.PatientAlert
	 */
	 public static ims.core.vo.PatientAlertEDischargeVo insert(DomainObjectMap map, ims.core.vo.PatientAlertEDischargeVo valueObject, ims.core.clinical.domain.objects.PatientAlert domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// IncludeAlertInDischargeReports
		valueObject.setIncludeAlertInDischargeReports(ims.core.vo.domain.IncludeAlertInDischargeReportsVoAssembler.createIncludeAlertInDischargeReportsVoCollectionFromIncludeAlertInDischargeReport(map, domainObject.getIncludeAlertInDischargeReports()) );
		// SysInfo
	 ...
	 */
	public static ims.core.clinical.domain.objects.PatientAlert extractPatientAlert(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientAlertEDischargeVo valueObject) 
	{
		return 	extractPatientAlert(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.clinical.domain.objects.PatientAlert extractPatientAlert(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientAlertEDischargeVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.PatientAlertEDischargeVo ID_PatientAlert field is unknown
		...
		if ( null != DateIdentified ) 
		{
			value5 = DateIdentified.toInteger();
		}
		domainObject.setDateIdentified(value5);
		...
		domainObject.setIncludeAlertInDischargeReports(ims.core.vo.domain.IncludeAlertInDischargeReportsVoAssembler.extractIncludeAlertInDischargeReportSet(domainFactory, valueObject.getIncludeAlertInDischargeReports(), domainObject.getIncludeAlertInDischargeReports(), domMap));		
		//This is to overcome a bug in both Sybase and Oracle which prevents them from storing an empty string correctly
		//Sybase stores it as a single space, Oracle stores it as NULL. This fix will make them consistent at least.
