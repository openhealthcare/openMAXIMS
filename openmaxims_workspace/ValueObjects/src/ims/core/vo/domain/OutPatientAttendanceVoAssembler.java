 ...
 */
public class OutPatientAttendanceVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.OutPatientAttendanceVo copy(ims.core.vo.OutPatientAttendanceVo valueObjectDest, ims.core.vo.OutPatientAttendanceVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createOutPatientAttendanceVoCollectionFromOutpatientAttendance(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.admin.pas.domain.objects.OutpatientAttendance objects.
	 */
	public static ims.core.vo.OutPatientAttendanceVoCollection createOutPatientAttendanceVoCollectionFromOutpatientAttendance(java.util.Set domainObjectSet)	
	{
		return createOutPatientAttendanceVoCollectionFromOutpatientAttendance(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.admin.pas.domain.objects.OutpatientAttendance objects.
	 */
	public static ims.core.vo.OutPatientAttendanceVoCollection createOutPatientAttendanceVoCollectionFromOutpatientAttendance(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.OutPatientAttendanceVoCollection voList = new ims.core.vo.OutPatientAttendanceVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.OutPatientAttendanceVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.OutPatientAttendanceVoCollection createOutPatientAttendanceVoCollectionFromOutpatientAttendance(java.util.List domainObjectList) 
	{
		return createOutPatientAttendanceVoCollectionFromOutpatientAttendance(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.admin.pas.domain.objects.OutpatientAttendance objects.
	 */
	public static ims.core.vo.OutPatientAttendanceVoCollection createOutPatientAttendanceVoCollectionFromOutpatientAttendance(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.OutPatientAttendanceVoCollection voList = new ims.core.vo.OutPatientAttendanceVoCollection();
	 ...
	 */
	 public static java.util.Set extractOutpatientAttendanceSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.OutPatientAttendanceVoCollection voCollection) 
	 {
	 	return extractOutpatientAttendanceSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractOutpatientAttendanceSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.OutPatientAttendanceVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.OutPatientAttendanceVo vo = voCollection.get(i);
			ims.core.admin.pas.domain.objects.OutpatientAttendance domainObject = OutPatientAttendanceVoAssembler.extractOutpatientAttendance(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractOutpatientAttendanceList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.OutPatientAttendanceVoCollection voCollection) 
	 {
	 	return extractOutpatientAttendanceList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractOutpatientAttendanceList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.OutPatientAttendanceVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.OutPatientAttendanceVo create(ims.core.admin.pas.domain.objects.OutpatientAttendance domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.OutPatientAttendanceVo create(DomainObjectMap map, ims.core.admin.pas.domain.objects.OutpatientAttendance domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.OutPatientAttendanceVo valueObject = (ims.core.vo.OutPatientAttendanceVo) map.getValueObject(domainObject, ims.core.vo.OutPatientAttendanceVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.OutPatientAttendanceVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.admin.pas.domain.objects.OutpatientAttendance
	 */
	 public static ims.core.vo.OutPatientAttendanceVo insert(ims.core.vo.OutPatientAttendanceVo valueObject, ims.core.admin.pas.domain.objects.OutpatientAttendance domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.admin.pas.domain.objects.OutpatientAttendance
	 */
	 public static ims.core.vo.OutPatientAttendanceVo insert(DomainObjectMap map, ims.core.vo.OutPatientAttendanceVo valueObject, ims.core.admin.pas.domain.objects.OutpatientAttendance domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.admin.pas.domain.objects.OutpatientAttendance extractOutpatientAttendance(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.OutPatientAttendanceVo valueObject) 
	{
		return 	extractOutpatientAttendance(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.admin.pas.domain.objects.OutpatientAttendance extractOutpatientAttendance(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.OutPatientAttendanceVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.OutPatientAttendanceVo ID_OutpatientAttendance field is unknown
