...
public class GpVoAssembler
{
	 ...
	 */
	 public static ims.core.vo.GpVo copy(ims.core.vo.GpVo valueObjectDest, ims.core.vo.GpVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createGpVoCollectionFromGp(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.resource.people.domain.objects.Gp objects.
	 */
	public static ims.core.vo.GpVoCollection createGpVoCollectionFromGp(java.util.Set domainObjectSet)	
	{
		return createGpVoCollectionFromGp(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.resource.people.domain.objects.Gp objects.
	 */
	public static ims.core.vo.GpVoCollection createGpVoCollectionFromGp(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.GpVoCollection voList = new ims.core.vo.GpVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.GpVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.GpVoCollection createGpVoCollectionFromGp(java.util.List domainObjectList) 
	{
		return createGpVoCollectionFromGp(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.resource.people.domain.objects.Gp objects.
	 */
	public static ims.core.vo.GpVoCollection createGpVoCollectionFromGp(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.GpVoCollection voList = new ims.core.vo.GpVoCollection();
	 ...
	 */
	 public static java.util.Set extractGpSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.GpVoCollection voCollection) 
	 {
	 	return extractGpSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractGpSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.GpVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.GpVo vo = voCollection.get(i);
			ims.core.resource.people.domain.objects.Gp domainObject = GpVoAssembler.extractGp(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractGpList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.GpVoCollection voCollection) 
	 {
	 	return extractGpList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractGpList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.GpVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.GpVo create(ims.core.resource.people.domain.objects.Gp domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.GpVo create(DomainObjectMap map, ims.core.resource.people.domain.objects.Gp domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.GpVo valueObject = (ims.core.vo.GpVo) map.getValueObject(domainObject, ims.core.vo.GpVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.GpVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.resource.people.domain.objects.Gp
	 */
	 public static ims.core.vo.GpVo insert(ims.core.vo.GpVo valueObject, ims.core.resource.people.domain.objects.Gp domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.resource.people.domain.objects.Gp
	 */
	 public static ims.core.vo.GpVo insert(DomainObjectMap map, ims.core.vo.GpVo valueObject, ims.core.resource.people.domain.objects.Gp domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.resource.people.domain.objects.Gp extractGp(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.GpVo valueObject) 
	{
		return 	extractGp(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.resource.people.domain.objects.Gp extractGp(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.GpVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.GpVo ID_Gp field is unknown
		...
		domainObject.setPractices(ims.core.vo.domain.Gp_PracticesVoAssembler.extractGpToPracticeSet(domainFactory, valueObject.getPractices(), domainObject.getPractices(), domMap));		
