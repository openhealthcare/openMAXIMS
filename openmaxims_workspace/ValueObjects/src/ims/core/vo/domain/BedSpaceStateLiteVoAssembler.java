 ...
 */
public class BedSpaceStateLiteVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.BedSpaceStateLiteVo copy(ims.core.vo.BedSpaceStateLiteVo valueObjectDest, ims.core.vo.BedSpaceStateLiteVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createBedSpaceStateLiteVoCollectionFromBedSpaceState(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.admin.pas.domain.objects.BedSpaceState objects.
	 */
	public static ims.core.vo.BedSpaceStateLiteVoCollection createBedSpaceStateLiteVoCollectionFromBedSpaceState(java.util.Set domainObjectSet)	
	{
		return createBedSpaceStateLiteVoCollectionFromBedSpaceState(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.admin.pas.domain.objects.BedSpaceState objects.
	 */
	public static ims.core.vo.BedSpaceStateLiteVoCollection createBedSpaceStateLiteVoCollectionFromBedSpaceState(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.BedSpaceStateLiteVoCollection voList = new ims.core.vo.BedSpaceStateLiteVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.BedSpaceStateLiteVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.BedSpaceStateLiteVoCollection createBedSpaceStateLiteVoCollectionFromBedSpaceState(java.util.List domainObjectList) 
	{
		return createBedSpaceStateLiteVoCollectionFromBedSpaceState(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.admin.pas.domain.objects.BedSpaceState objects.
	 */
	public static ims.core.vo.BedSpaceStateLiteVoCollection createBedSpaceStateLiteVoCollectionFromBedSpaceState(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.BedSpaceStateLiteVoCollection voList = new ims.core.vo.BedSpaceStateLiteVoCollection();
	 ...
	 */
	 public static java.util.Set extractBedSpaceStateSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.BedSpaceStateLiteVoCollection voCollection) 
	 {
	 	return extractBedSpaceStateSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractBedSpaceStateSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.BedSpaceStateLiteVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.BedSpaceStateLiteVo vo = voCollection.get(i);
			ims.core.admin.pas.domain.objects.BedSpaceState domainObject = BedSpaceStateLiteVoAssembler.extractBedSpaceState(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractBedSpaceStateList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.BedSpaceStateLiteVoCollection voCollection) 
	 {
	 	return extractBedSpaceStateList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractBedSpaceStateList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.BedSpaceStateLiteVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.BedSpaceStateLiteVo create(ims.core.admin.pas.domain.objects.BedSpaceState domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.BedSpaceStateLiteVo create(DomainObjectMap map, ims.core.admin.pas.domain.objects.BedSpaceState domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.BedSpaceStateLiteVo valueObject = (ims.core.vo.BedSpaceStateLiteVo) map.getValueObject(domainObject, ims.core.vo.BedSpaceStateLiteVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.BedSpaceStateLiteVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.admin.pas.domain.objects.BedSpaceState
	 */
	 public static ims.core.vo.BedSpaceStateLiteVo insert(ims.core.vo.BedSpaceStateLiteVo valueObject, ims.core.admin.pas.domain.objects.BedSpaceState domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.admin.pas.domain.objects.BedSpaceState
	 */
	 public static ims.core.vo.BedSpaceStateLiteVo insert(DomainObjectMap map, ims.core.vo.BedSpaceStateLiteVo valueObject, ims.core.admin.pas.domain.objects.BedSpaceState domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.admin.pas.domain.objects.BedSpaceState extractBedSpaceState(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.BedSpaceStateLiteVo valueObject) 
	{
		return 	extractBedSpaceState(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.admin.pas.domain.objects.BedSpaceState extractBedSpaceState(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.BedSpaceStateLiteVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.BedSpaceStateLiteVo ID_BedSpaceState field is unknown
