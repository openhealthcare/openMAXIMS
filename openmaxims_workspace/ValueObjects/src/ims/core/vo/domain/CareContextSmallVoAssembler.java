 ...
 */
public class CareContextSmallVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.CareContextSmallVo copy(ims.core.vo.CareContextSmallVo valueObjectDest, ims.core.vo.CareContextSmallVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createCareContextSmallVoCollectionFromCareContext(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.admin.domain.objects.CareContext objects.
	 */
	public static ims.core.vo.CareContextSmallVoCollection createCareContextSmallVoCollectionFromCareContext(java.util.Set domainObjectSet)	
	{
		return createCareContextSmallVoCollectionFromCareContext(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.admin.domain.objects.CareContext objects.
	 */
	public static ims.core.vo.CareContextSmallVoCollection createCareContextSmallVoCollectionFromCareContext(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.CareContextSmallVoCollection voList = new ims.core.vo.CareContextSmallVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.CareContextSmallVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.CareContextSmallVoCollection createCareContextSmallVoCollectionFromCareContext(java.util.List domainObjectList) 
	{
		return createCareContextSmallVoCollectionFromCareContext(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.admin.domain.objects.CareContext objects.
	 */
	public static ims.core.vo.CareContextSmallVoCollection createCareContextSmallVoCollectionFromCareContext(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.CareContextSmallVoCollection voList = new ims.core.vo.CareContextSmallVoCollection();
	 ...
	 */
	 public static java.util.Set extractCareContextSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CareContextSmallVoCollection voCollection) 
	 {
	 	return extractCareContextSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractCareContextSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CareContextSmallVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.CareContextSmallVo vo = voCollection.get(i);
			ims.core.admin.domain.objects.CareContext domainObject = CareContextSmallVoAssembler.extractCareContext(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractCareContextList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CareContextSmallVoCollection voCollection) 
	 {
	 	return extractCareContextList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractCareContextList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CareContextSmallVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.CareContextSmallVo create(ims.core.admin.domain.objects.CareContext domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.CareContextSmallVo create(DomainObjectMap map, ims.core.admin.domain.objects.CareContext domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.CareContextSmallVo valueObject = (ims.core.vo.CareContextSmallVo) map.getValueObject(domainObject, ims.core.vo.CareContextSmallVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.CareContextSmallVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.admin.domain.objects.CareContext
	 */
	 public static ims.core.vo.CareContextSmallVo insert(ims.core.vo.CareContextSmallVo valueObject, ims.core.admin.domain.objects.CareContext domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.admin.domain.objects.CareContext
	 */
	 public static ims.core.vo.CareContextSmallVo insert(DomainObjectMap map, ims.core.vo.CareContextSmallVo valueObject, ims.core.admin.domain.objects.CareContext domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// CareContextHistory
		valueObject.setCareContextHistory(ims.core.vo.domain.CareContextHistVoAssembler.createCareContextHistVoCollectionFromCareContextHistory(map, domainObject.getCareContextHistory()) );
 		return valueObject;
	 }
	 ...
	 */
	public static ims.core.admin.domain.objects.CareContext extractCareContext(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CareContextSmallVo valueObject) 
	{
		return 	extractCareContext(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.admin.domain.objects.CareContext extractCareContext(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CareContextSmallVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		ims.core.admin.vo.CareContextHistoryRefVoCollection refCollection4 = new ims.core.admin.vo.CareContextHistoryRefVoCollection();
		if (valueObject.getCareContextHistory() != null)
		{
			for (int i4=0; i4<valueObject.getCareContextHistory().size(); i4++)
			{
				ims.core.admin.vo.CareContextHistoryRefVo ref4 = (ims.core.admin.vo.CareContextHistoryRefVo)valueObject.getCareContextHistory().get(i4);
		...
		for(int i=0; i<size4; i++) 
		{
			...
			if ( null != vo ) 
			{
				...
				{
					dom = (ims.core.admin.domain.objects.CareContextHistory)domainFactory.getDomainObject( ims.core.admin.domain.objects.CareContextHistory.class, vo.getBoId());
				}
			}
