 ...
 */
public class PatientAllergyForNursingNotesVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.PatientAllergyForNursingNotesVo copy(ims.core.vo.PatientAllergyForNursingNotesVo valueObjectDest, ims.core.vo.PatientAllergyForNursingNotesVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createPatientAllergyForNursingNotesVoCollectionFromPatientAllergy(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.clinical.domain.objects.PatientAllergy objects.
	 */
	public static ims.core.vo.PatientAllergyForNursingNotesVoCollection createPatientAllergyForNursingNotesVoCollectionFromPatientAllergy(java.util.Set domainObjectSet)	
	{
		return createPatientAllergyForNursingNotesVoCollectionFromPatientAllergy(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.clinical.domain.objects.PatientAllergy objects.
	 */
	public static ims.core.vo.PatientAllergyForNursingNotesVoCollection createPatientAllergyForNursingNotesVoCollectionFromPatientAllergy(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.PatientAllergyForNursingNotesVoCollection voList = new ims.core.vo.PatientAllergyForNursingNotesVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.PatientAllergyForNursingNotesVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.PatientAllergyForNursingNotesVoCollection createPatientAllergyForNursingNotesVoCollectionFromPatientAllergy(java.util.List domainObjectList) 
	{
		return createPatientAllergyForNursingNotesVoCollectionFromPatientAllergy(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.clinical.domain.objects.PatientAllergy objects.
	 */
	public static ims.core.vo.PatientAllergyForNursingNotesVoCollection createPatientAllergyForNursingNotesVoCollectionFromPatientAllergy(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.PatientAllergyForNursingNotesVoCollection voList = new ims.core.vo.PatientAllergyForNursingNotesVoCollection();
	 ...
	 */
	 public static java.util.Set extractPatientAllergySet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientAllergyForNursingNotesVoCollection voCollection) 
	 {
	 	return extractPatientAllergySet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientAllergySet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientAllergyForNursingNotesVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.PatientAllergyForNursingNotesVo vo = voCollection.get(i);
			ims.core.clinical.domain.objects.PatientAllergy domainObject = PatientAllergyForNursingNotesVoAssembler.extractPatientAllergy(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPatientAllergyList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientAllergyForNursingNotesVoCollection voCollection) 
	 {
	 	return extractPatientAllergyList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPatientAllergyList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientAllergyForNursingNotesVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.PatientAllergyForNursingNotesVo create(ims.core.clinical.domain.objects.PatientAllergy domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.PatientAllergyForNursingNotesVo create(DomainObjectMap map, ims.core.clinical.domain.objects.PatientAllergy domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.PatientAllergyForNursingNotesVo valueObject = (ims.core.vo.PatientAllergyForNursingNotesVo) map.getValueObject(domainObject, ims.core.vo.PatientAllergyForNursingNotesVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.PatientAllergyForNursingNotesVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.PatientAllergy
	 */
	 public static ims.core.vo.PatientAllergyForNursingNotesVo insert(ims.core.vo.PatientAllergyForNursingNotesVo valueObject, ims.core.clinical.domain.objects.PatientAllergy domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.PatientAllergy
	 */
	 public static ims.core.vo.PatientAllergyForNursingNotesVo insert(DomainObjectMap map, ims.core.vo.PatientAllergyForNursingNotesVo valueObject, ims.core.clinical.domain.objects.PatientAllergy domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.clinical.domain.objects.PatientAllergy extractPatientAllergy(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientAllergyForNursingNotesVo valueObject) 
	{
		return 	extractPatientAllergy(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.clinical.domain.objects.PatientAllergy extractPatientAllergy(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientAllergyForNursingNotesVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.PatientAllergyForNursingNotesVo ID_PatientAllergy field is unknown
