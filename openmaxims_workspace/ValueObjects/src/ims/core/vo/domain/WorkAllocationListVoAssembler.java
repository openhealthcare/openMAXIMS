 ...
 */
public class WorkAllocationListVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.WorkAllocationListVo copy(ims.core.vo.WorkAllocationListVo valueObjectDest, ims.core.vo.WorkAllocationListVo valueObjectSrc) 
	 {
	...
	{
		return createWorkAllocationListVoCollectionFromWorkAllocation(new DomainObjectMap(), domainObjectSet);
	}
	...
	{
		ims.core.vo.WorkAllocationListVoCollection voList = new ims.core.vo.WorkAllocationListVoCollection();
	...
	{
		return createWorkAllocationListVoCollectionFromWorkAllocation(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 */
	 public static java.util.Set extractWorkAllocationSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.WorkAllocationListVoCollection voCollection) 
	 {
	 	return extractWorkAllocationSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractWorkAllocationSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.WorkAllocationListVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractWorkAllocationList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.WorkAllocationListVoCollection voCollection) 
	 {
	 	return extractWorkAllocationList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractWorkAllocationList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.WorkAllocationListVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	  ...
	  */
	  public static ims.core.vo.WorkAllocationListVo create(DomainObjectMap map, ims.careuk.domain.objects.WorkAllocation domainObject) 
	  {
			...
			ims.core.vo.WorkAllocationListVo valueObject = (ims.core.vo.WorkAllocationListVo) map.getValueObject(domainObject, ims.core.vo.WorkAllocationListVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.WorkAllocationListVo(domainObject.getId(), domainObject.getVersion());
