 ...
 * @author John MacEnri
 */
public class LocShortVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.LocShortVo copy(ims.core.vo.LocShortVo valueObjectDest, ims.core.vo.LocShortVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createLocShortVoCollectionFromLocation(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.resource.place.domain.objects.Location objects.
	 */
	public static ims.core.vo.LocShortVoCollection createLocShortVoCollectionFromLocation(java.util.Set domainObjectSet)	
	{
		return createLocShortVoCollectionFromLocation(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.resource.place.domain.objects.Location objects.
	 */
	public static ims.core.vo.LocShortVoCollection createLocShortVoCollectionFromLocation(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.LocShortVoCollection voList = new ims.core.vo.LocShortVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.LocShortVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.LocShortVoCollection createLocShortVoCollectionFromLocation(java.util.List domainObjectList) 
	{
		return createLocShortVoCollectionFromLocation(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.resource.place.domain.objects.Location objects.
	 */
	public static ims.core.vo.LocShortVoCollection createLocShortVoCollectionFromLocation(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.LocShortVoCollection voList = new ims.core.vo.LocShortVoCollection();
	 ...
	 */
	 public static java.util.Set extractLocationSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.LocShortVoCollection voCollection) 
	 {
	 	return extractLocationSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractLocationSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.LocShortVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.LocShortVo vo = voCollection.get(i);
			ims.core.resource.place.domain.objects.Location domainObject = LocShortVoAssembler.extractLocation(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractLocationList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.LocShortVoCollection voCollection) 
	 {
	 	return extractLocationList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractLocationList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.LocShortVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.LocShortVo create(ims.core.resource.place.domain.objects.Location domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.LocShortVo create(DomainObjectMap map, ims.core.resource.place.domain.objects.Location domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.LocShortVo valueObject = (ims.core.vo.LocShortVo) map.getValueObject(domainObject, ims.core.vo.LocShortVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.LocShortVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.resource.place.domain.objects.Location
	 */
	 public static ims.core.vo.LocShortVo insert(ims.core.vo.LocShortVo valueObject, ims.core.resource.place.domain.objects.Location domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.resource.place.domain.objects.Location
	 */
	 public static ims.core.vo.LocShortVo insert(DomainObjectMap map, ims.core.vo.LocShortVo valueObject, ims.core.resource.place.domain.objects.Location domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.resource.place.domain.objects.Location extractLocation(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.LocShortVo valueObject) 
	{
		return 	extractLocation(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.resource.place.domain.objects.Location extractLocation(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.LocShortVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.LocShortVo ID_Location field is unknown
