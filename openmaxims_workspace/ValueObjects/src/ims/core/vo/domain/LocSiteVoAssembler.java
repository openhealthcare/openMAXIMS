 ...
 */
public class LocSiteVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.LocSiteVo copy(ims.core.vo.LocSiteVo valueObjectDest, ims.core.vo.LocSiteVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createLocSiteVoCollectionFromLocSite(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.resource.place.domain.objects.LocSite objects.
	 */
	public static ims.core.vo.LocSiteVoCollection createLocSiteVoCollectionFromLocSite(java.util.Set domainObjectSet)	
	{
		return createLocSiteVoCollectionFromLocSite(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.resource.place.domain.objects.LocSite objects.
	 */
	public static ims.core.vo.LocSiteVoCollection createLocSiteVoCollectionFromLocSite(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.LocSiteVoCollection voList = new ims.core.vo.LocSiteVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.LocSiteVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.LocSiteVoCollection createLocSiteVoCollectionFromLocSite(java.util.List domainObjectList) 
	{
		return createLocSiteVoCollectionFromLocSite(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.resource.place.domain.objects.LocSite objects.
	 */
	public static ims.core.vo.LocSiteVoCollection createLocSiteVoCollectionFromLocSite(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.LocSiteVoCollection voList = new ims.core.vo.LocSiteVoCollection();
	 ...
	 */
	 public static java.util.Set extractLocSiteSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.LocSiteVoCollection voCollection) 
	 {
	 	return extractLocSiteSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractLocSiteSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.LocSiteVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.LocSiteVo vo = voCollection.get(i);
			ims.core.resource.place.domain.objects.LocSite domainObject = LocSiteVoAssembler.extractLocSite(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractLocSiteList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.LocSiteVoCollection voCollection) 
	 {
	 	return extractLocSiteList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractLocSiteList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.LocSiteVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.LocSiteVo create(ims.core.resource.place.domain.objects.LocSite domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.LocSiteVo create(DomainObjectMap map, ims.core.resource.place.domain.objects.LocSite domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.LocSiteVo valueObject = (ims.core.vo.LocSiteVo) map.getValueObject(domainObject, ims.core.vo.LocSiteVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.LocSiteVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.resource.place.domain.objects.LocSite
	 */
	 public static ims.core.vo.LocSiteVo insert(ims.core.vo.LocSiteVo valueObject, ims.core.resource.place.domain.objects.LocSite domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.resource.place.domain.objects.LocSite
	 */
	 public static ims.core.vo.LocSiteVo insert(DomainObjectMap map, ims.core.vo.LocSiteVo valueObject, ims.core.resource.place.domain.objects.LocSite domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.resource.place.domain.objects.LocSite extractLocSite(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.LocSiteVo valueObject) 
	{
		return 	extractLocSite(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.resource.place.domain.objects.LocSite extractLocSite(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.LocSiteVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.LocSiteVo ID_LocSite field is unknown
