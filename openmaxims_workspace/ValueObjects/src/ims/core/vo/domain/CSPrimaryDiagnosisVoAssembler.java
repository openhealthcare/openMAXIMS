 ...
 */
public class CSPrimaryDiagnosisVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.CSPrimaryDiagnosisVo copy(ims.core.vo.CSPrimaryDiagnosisVo valueObjectDest, ims.core.vo.CSPrimaryDiagnosisVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createCSPrimaryDiagnosisVoCollectionFromCsPrimaryDiagnosis(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.clinical.domain.objects.CsPrimaryDiagnosis objects.
	 */
	public static ims.core.vo.CSPrimaryDiagnosisVoCollection createCSPrimaryDiagnosisVoCollectionFromCsPrimaryDiagnosis(java.util.Set domainObjectSet)	
	{
		return createCSPrimaryDiagnosisVoCollectionFromCsPrimaryDiagnosis(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.clinical.domain.objects.CsPrimaryDiagnosis objects.
	 */
	public static ims.core.vo.CSPrimaryDiagnosisVoCollection createCSPrimaryDiagnosisVoCollectionFromCsPrimaryDiagnosis(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.CSPrimaryDiagnosisVoCollection voList = new ims.core.vo.CSPrimaryDiagnosisVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.CSPrimaryDiagnosisVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.CSPrimaryDiagnosisVoCollection createCSPrimaryDiagnosisVoCollectionFromCsPrimaryDiagnosis(java.util.List domainObjectList) 
	{
		return createCSPrimaryDiagnosisVoCollectionFromCsPrimaryDiagnosis(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.clinical.domain.objects.CsPrimaryDiagnosis objects.
	 */
	public static ims.core.vo.CSPrimaryDiagnosisVoCollection createCSPrimaryDiagnosisVoCollectionFromCsPrimaryDiagnosis(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.CSPrimaryDiagnosisVoCollection voList = new ims.core.vo.CSPrimaryDiagnosisVoCollection();
	 ...
	 */
	 public static java.util.Set extractCsPrimaryDiagnosisSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CSPrimaryDiagnosisVoCollection voCollection) 
	 {
	 	return extractCsPrimaryDiagnosisSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractCsPrimaryDiagnosisSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CSPrimaryDiagnosisVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.CSPrimaryDiagnosisVo vo = voCollection.get(i);
			ims.core.clinical.domain.objects.CsPrimaryDiagnosis domainObject = CSPrimaryDiagnosisVoAssembler.extractCsPrimaryDiagnosis(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractCsPrimaryDiagnosisList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CSPrimaryDiagnosisVoCollection voCollection) 
	 {
	 	return extractCsPrimaryDiagnosisList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractCsPrimaryDiagnosisList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CSPrimaryDiagnosisVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.CSPrimaryDiagnosisVo create(ims.core.clinical.domain.objects.CsPrimaryDiagnosis domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.CSPrimaryDiagnosisVo create(DomainObjectMap map, ims.core.clinical.domain.objects.CsPrimaryDiagnosis domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.CSPrimaryDiagnosisVo valueObject = (ims.core.vo.CSPrimaryDiagnosisVo) map.getValueObject(domainObject, ims.core.vo.CSPrimaryDiagnosisVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.CSPrimaryDiagnosisVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.CsPrimaryDiagnosis
	 */
	 public static ims.core.vo.CSPrimaryDiagnosisVo insert(ims.core.vo.CSPrimaryDiagnosisVo valueObject, ims.core.clinical.domain.objects.CsPrimaryDiagnosis domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.CsPrimaryDiagnosis
	 */
	 public static ims.core.vo.CSPrimaryDiagnosisVo insert(DomainObjectMap map, ims.core.vo.CSPrimaryDiagnosisVo valueObject, ims.core.clinical.domain.objects.CsPrimaryDiagnosis domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.clinical.domain.objects.CsPrimaryDiagnosis extractCsPrimaryDiagnosis(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CSPrimaryDiagnosisVo valueObject) 
	{
		return 	extractCsPrimaryDiagnosis(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.clinical.domain.objects.CsPrimaryDiagnosis extractCsPrimaryDiagnosis(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.CSPrimaryDiagnosisVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.CSPrimaryDiagnosisVo ID_CsPrimaryDiagnosis field is unknown
