 ...
 */
public class HcpLiteVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.HcpLiteVo copy(ims.core.vo.HcpLiteVo valueObjectDest, ims.core.vo.HcpLiteVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createHcpLiteVoCollectionFromHcp(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.resource.people.domain.objects.Hcp objects.
	 */
	public static ims.core.vo.HcpLiteVoCollection createHcpLiteVoCollectionFromHcp(java.util.Set domainObjectSet)	
	{
		return createHcpLiteVoCollectionFromHcp(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.resource.people.domain.objects.Hcp objects.
	 */
	public static ims.core.vo.HcpLiteVoCollection createHcpLiteVoCollectionFromHcp(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.HcpLiteVoCollection voList = new ims.core.vo.HcpLiteVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.HcpLiteVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.HcpLiteVoCollection createHcpLiteVoCollectionFromHcp(java.util.List domainObjectList) 
	{
		return createHcpLiteVoCollectionFromHcp(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.resource.people.domain.objects.Hcp objects.
	 */
	public static ims.core.vo.HcpLiteVoCollection createHcpLiteVoCollectionFromHcp(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.HcpLiteVoCollection voList = new ims.core.vo.HcpLiteVoCollection();
	 ...
	 */
	 public static java.util.Set extractHcpSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.HcpLiteVoCollection voCollection) 
	 {
	 	return extractHcpSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractHcpSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.HcpLiteVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.HcpLiteVo vo = voCollection.get(i);
			ims.core.resource.people.domain.objects.Hcp domainObject = HcpLiteVoAssembler.extractHcp(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractHcpList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.HcpLiteVoCollection voCollection) 
	 {
	 	return extractHcpList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractHcpList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.HcpLiteVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.HcpLiteVo create(ims.core.resource.people.domain.objects.Hcp domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.HcpLiteVo create(DomainObjectMap map, ims.core.resource.people.domain.objects.Hcp domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.HcpLiteVo valueObject = (ims.core.vo.HcpLiteVo) map.getValueObject(domainObject, ims.core.vo.HcpLiteVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.HcpLiteVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.resource.people.domain.objects.Hcp
	 */
	 public static ims.core.vo.HcpLiteVo insert(ims.core.vo.HcpLiteVo valueObject, ims.core.resource.people.domain.objects.Hcp domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.resource.people.domain.objects.Hcp
	 */
	 public static ims.core.vo.HcpLiteVo insert(DomainObjectMap map, ims.core.vo.HcpLiteVo valueObject, ims.core.resource.people.domain.objects.Hcp domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.resource.people.domain.objects.Hcp extractHcp(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.HcpLiteVo valueObject) 
	{
		return 	extractHcp(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.resource.people.domain.objects.Hcp extractHcp(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.HcpLiteVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.HcpLiteVo ID_Hcp field is unknown
