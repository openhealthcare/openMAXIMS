 ...
 * @author Dara Hickey
 */
public class PasEventWithReferringGPVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.PasEventWithReferringGPVo copy(ims.core.vo.PasEventWithReferringGPVo valueObjectDest, ims.core.vo.PasEventWithReferringGPVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createPasEventWithReferringGPVoCollectionFromPASEvent(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.admin.pas.domain.objects.PASEvent objects.
	 */
	public static ims.core.vo.PasEventWithReferringGPVoCollection createPasEventWithReferringGPVoCollectionFromPASEvent(java.util.Set domainObjectSet)	
	{
		return createPasEventWithReferringGPVoCollectionFromPASEvent(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.admin.pas.domain.objects.PASEvent objects.
	 */
	public static ims.core.vo.PasEventWithReferringGPVoCollection createPasEventWithReferringGPVoCollectionFromPASEvent(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.PasEventWithReferringGPVoCollection voList = new ims.core.vo.PasEventWithReferringGPVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.PasEventWithReferringGPVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.PasEventWithReferringGPVoCollection createPasEventWithReferringGPVoCollectionFromPASEvent(java.util.List domainObjectList) 
	{
		return createPasEventWithReferringGPVoCollectionFromPASEvent(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.admin.pas.domain.objects.PASEvent objects.
	 */
	public static ims.core.vo.PasEventWithReferringGPVoCollection createPasEventWithReferringGPVoCollectionFromPASEvent(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.PasEventWithReferringGPVoCollection voList = new ims.core.vo.PasEventWithReferringGPVoCollection();
	 ...
	 */
	 public static java.util.Set extractPASEventSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PasEventWithReferringGPVoCollection voCollection) 
	 {
	 	return extractPASEventSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPASEventSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PasEventWithReferringGPVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.PasEventWithReferringGPVo vo = voCollection.get(i);
			ims.core.admin.pas.domain.objects.PASEvent domainObject = PasEventWithReferringGPVoAssembler.extractPASEvent(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPASEventList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PasEventWithReferringGPVoCollection voCollection) 
	 {
	 	return extractPASEventList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPASEventList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PasEventWithReferringGPVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.PasEventWithReferringGPVo create(ims.core.admin.pas.domain.objects.PASEvent domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.PasEventWithReferringGPVo create(DomainObjectMap map, ims.core.admin.pas.domain.objects.PASEvent domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.PasEventWithReferringGPVo valueObject = (ims.core.vo.PasEventWithReferringGPVo) map.getValueObject(domainObject, ims.core.vo.PasEventWithReferringGPVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.PasEventWithReferringGPVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.admin.pas.domain.objects.PASEvent
	 */
	 public static ims.core.vo.PasEventWithReferringGPVo insert(ims.core.vo.PasEventWithReferringGPVo valueObject, ims.core.admin.pas.domain.objects.PASEvent domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.admin.pas.domain.objects.PASEvent
	 */
	 public static ims.core.vo.PasEventWithReferringGPVo insert(DomainObjectMap map, ims.core.vo.PasEventWithReferringGPVo valueObject, ims.core.admin.pas.domain.objects.PASEvent domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.admin.pas.domain.objects.PASEvent extractPASEvent(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PasEventWithReferringGPVo valueObject) 
	{
		return 	extractPASEvent(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.admin.pas.domain.objects.PASEvent extractPASEvent(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PasEventWithReferringGPVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.PasEventWithReferringGPVo ID_PASEvent field is unknown
