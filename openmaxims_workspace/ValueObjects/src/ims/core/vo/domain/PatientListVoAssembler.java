 ...
 */
public class PatientListVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.PatientListVo copy(ims.core.vo.PatientListVo valueObjectDest, ims.core.vo.PatientListVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createPatientListVoCollectionFromPatient(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.patient.domain.objects.Patient objects.
	 */
	public static ims.core.vo.PatientListVoCollection createPatientListVoCollectionFromPatient(java.util.Set domainObjectSet)	
	{
		return createPatientListVoCollectionFromPatient(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.patient.domain.objects.Patient objects.
	 */
	public static ims.core.vo.PatientListVoCollection createPatientListVoCollectionFromPatient(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.PatientListVoCollection voList = new ims.core.vo.PatientListVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.PatientListVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.PatientListVoCollection createPatientListVoCollectionFromPatient(java.util.List domainObjectList) 
	{
		return createPatientListVoCollectionFromPatient(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.patient.domain.objects.Patient objects.
	 */
	public static ims.core.vo.PatientListVoCollection createPatientListVoCollectionFromPatient(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.PatientListVoCollection voList = new ims.core.vo.PatientListVoCollection();
	 ...
	 */
	 public static java.util.Set extractPatientSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientListVoCollection voCollection) 
	 {
	 	return extractPatientSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientListVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.PatientListVo vo = voCollection.get(i);
			ims.core.patient.domain.objects.Patient domainObject = PatientListVoAssembler.extractPatient(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPatientList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientListVoCollection voCollection) 
	 {
	 	return extractPatientList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPatientList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientListVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.PatientListVo create(ims.core.patient.domain.objects.Patient domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.PatientListVo create(DomainObjectMap map, ims.core.patient.domain.objects.Patient domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.PatientListVo valueObject = (ims.core.vo.PatientListVo) map.getValueObject(domainObject, ims.core.vo.PatientListVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.PatientListVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.patient.domain.objects.Patient
	 */
	 public static ims.core.vo.PatientListVo insert(ims.core.vo.PatientListVo valueObject, ims.core.patient.domain.objects.Patient domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.patient.domain.objects.Patient
	 */
	 public static ims.core.vo.PatientListVo insert(DomainObjectMap map, ims.core.vo.PatientListVo valueObject, ims.core.patient.domain.objects.Patient domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// identifiers
		valueObject.setIdentifiers(ims.core.vo.domain.PatientIdListVoAssembler.createPatientIdListVoCollectionFromPatientId(map, domainObject.getIdentifiers()) );
 		return valueObject;
	 }
	 ...
	 */
	public static ims.core.patient.domain.objects.Patient extractPatient(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientListVo valueObject) 
	{
		return 	extractPatient(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.patient.domain.objects.Patient extractPatient(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientListVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.PatientListVo ID_Patient field is unknown
