 ...
 */
public class VSVentilationChartRecordsVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.VSVentilationChartRecordsVo copy(ims.core.vo.VSVentilationChartRecordsVo valueObjectDest, ims.core.vo.VSVentilationChartRecordsVo valueObjectSrc) 
	 {
		...
		valueObjectDest.setSpontaneousRespiratoryRate(valueObjectSrc.getSpontaneousRespiratoryRate());
		// Temperature
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createVSVentilationChartRecordsVoCollectionFromVitalSigns(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.vitals.domain.objects.VitalSigns objects.
	 */
	public static ims.core.vo.VSVentilationChartRecordsVoCollection createVSVentilationChartRecordsVoCollectionFromVitalSigns(java.util.Set domainObjectSet)	
	{
		return createVSVentilationChartRecordsVoCollectionFromVitalSigns(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.vitals.domain.objects.VitalSigns objects.
	 */
	public static ims.core.vo.VSVentilationChartRecordsVoCollection createVSVentilationChartRecordsVoCollectionFromVitalSigns(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.VSVentilationChartRecordsVoCollection voList = new ims.core.vo.VSVentilationChartRecordsVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.VSVentilationChartRecordsVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.VSVentilationChartRecordsVoCollection createVSVentilationChartRecordsVoCollectionFromVitalSigns(java.util.List domainObjectList) 
	{
		return createVSVentilationChartRecordsVoCollectionFromVitalSigns(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.vitals.domain.objects.VitalSigns objects.
	 */
	public static ims.core.vo.VSVentilationChartRecordsVoCollection createVSVentilationChartRecordsVoCollectionFromVitalSigns(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.VSVentilationChartRecordsVoCollection voList = new ims.core.vo.VSVentilationChartRecordsVoCollection();
	 ...
	 */
	 public static java.util.Set extractVitalSignsSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.VSVentilationChartRecordsVoCollection voCollection) 
	 {
	 	return extractVitalSignsSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractVitalSignsSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.VSVentilationChartRecordsVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.VSVentilationChartRecordsVo vo = voCollection.get(i);
			ims.core.vitals.domain.objects.VitalSigns domainObject = VSVentilationChartRecordsVoAssembler.extractVitalSigns(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractVitalSignsList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.VSVentilationChartRecordsVoCollection voCollection) 
	 {
	 	return extractVitalSignsList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractVitalSignsList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.VSVentilationChartRecordsVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.VSVentilationChartRecordsVo create(ims.core.vitals.domain.objects.VitalSigns domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.VSVentilationChartRecordsVo create(DomainObjectMap map, ims.core.vitals.domain.objects.VitalSigns domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.VSVentilationChartRecordsVo valueObject = (ims.core.vo.VSVentilationChartRecordsVo) map.getValueObject(domainObject, ims.core.vo.VSVentilationChartRecordsVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.VSVentilationChartRecordsVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.vitals.domain.objects.VitalSigns
	 */
	 public static ims.core.vo.VSVentilationChartRecordsVo insert(ims.core.vo.VSVentilationChartRecordsVo valueObject, ims.core.vitals.domain.objects.VitalSigns domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.vitals.domain.objects.VitalSigns
	 */
	 public static ims.core.vo.VSVentilationChartRecordsVo insert(DomainObjectMap map, ims.core.vo.VSVentilationChartRecordsVo valueObject, ims.core.vitals.domain.objects.VitalSigns domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// SpontaneousRespiratoryRate
		valueObject.setSpontaneousRespiratoryRate(ims.core.vo.domain.VSRespirationsAssembler.create(map, domainObject.getRespiratory()) );
		// Temperature
	 ...
	 */
	public static ims.core.vitals.domain.objects.VitalSigns extractVitalSigns(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.VSVentilationChartRecordsVo valueObject) 
	{
		return 	extractVitalSigns(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.vitals.domain.objects.VitalSigns extractVitalSigns(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.VSVentilationChartRecordsVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.VSVentilationChartRecordsVo ID_VitalSigns field is unknown
		...
		domainObject.setRespiratory(ims.core.vo.domain.VSRespirationsAssembler.extractRespiratory(domainFactory, valueObject.getSpontaneousRespiratoryRate(), domMap));
