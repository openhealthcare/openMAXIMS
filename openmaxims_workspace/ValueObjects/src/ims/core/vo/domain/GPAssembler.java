...
public class GPAssembler
{
	 ...
	 */
	 public static ims.core.vo.GP copy(ims.core.vo.GP valueObjectDest, ims.core.vo.GP valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createGPCollectionFromGp(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.resource.people.domain.objects.Gp objects.
	 */
	public static ims.core.vo.GPCollection createGPCollectionFromGp(java.util.Set domainObjectSet)	
	{
		return createGPCollectionFromGp(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.resource.people.domain.objects.Gp objects.
	 */
	public static ims.core.vo.GPCollection createGPCollectionFromGp(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.GPCollection voList = new ims.core.vo.GPCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.GP vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.GPCollection createGPCollectionFromGp(java.util.List domainObjectList) 
	{
		return createGPCollectionFromGp(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.resource.people.domain.objects.Gp objects.
	 */
	public static ims.core.vo.GPCollection createGPCollectionFromGp(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.GPCollection voList = new ims.core.vo.GPCollection();
	 ...
	 */
	 public static java.util.Set extractGpSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.GPCollection voCollection) 
	 {
	 	return extractGpSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractGpSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.GPCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.GP vo = voCollection.get(i);
			ims.core.resource.people.domain.objects.Gp domainObject = GPAssembler.extractGp(domainFactory, vo, domMap);
	 ...
	 */
	 ...
	 public static java.util.List extractGpList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.GPCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.GP create(ims.core.resource.people.domain.objects.Gp domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.GP create(DomainObjectMap map, ims.core.resource.people.domain.objects.Gp domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.GP valueObject = (ims.core.vo.GP) map.getValueObject(domainObject, ims.core.vo.GP.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.GP(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.resource.people.domain.objects.Gp
	 */
	 public static ims.core.vo.GP insert(ims.core.vo.GP valueObject, ims.core.resource.people.domain.objects.Gp domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.resource.people.domain.objects.Gp
	 */
	 public static ims.core.vo.GP insert(DomainObjectMap map, ims.core.vo.GP valueObject, ims.core.resource.people.domain.objects.Gp domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.resource.people.domain.objects.Gp extractGp(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.GP valueObject) 
	{
		return 	extractGp(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.resource.people.domain.objects.Gp extractGp(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.GP valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.GP ID_Gp field is unknown
