 ...
 */
public class AdmissionDetailLiteWithInpatientEpisodeVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.AdmissionDetailLiteWithInpatientEpisodeVo copy(ims.core.vo.AdmissionDetailLiteWithInpatientEpisodeVo valueObjectDest, ims.core.vo.AdmissionDetailLiteWithInpatientEpisodeVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createAdmissionDetailLiteWithInpatientEpisodeVoCollectionFromAdmissionDetail(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.admin.pas.domain.objects.AdmissionDetail objects.
	 */
	public static ims.core.vo.AdmissionDetailLiteWithInpatientEpisodeVoCollection createAdmissionDetailLiteWithInpatientEpisodeVoCollectionFromAdmissionDetail(java.util.Set domainObjectSet)	
	{
		return createAdmissionDetailLiteWithInpatientEpisodeVoCollectionFromAdmissionDetail(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.admin.pas.domain.objects.AdmissionDetail objects.
	 */
	public static ims.core.vo.AdmissionDetailLiteWithInpatientEpisodeVoCollection createAdmissionDetailLiteWithInpatientEpisodeVoCollectionFromAdmissionDetail(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.AdmissionDetailLiteWithInpatientEpisodeVoCollection voList = new ims.core.vo.AdmissionDetailLiteWithInpatientEpisodeVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.AdmissionDetailLiteWithInpatientEpisodeVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.AdmissionDetailLiteWithInpatientEpisodeVoCollection createAdmissionDetailLiteWithInpatientEpisodeVoCollectionFromAdmissionDetail(java.util.List domainObjectList) 
	{
		return createAdmissionDetailLiteWithInpatientEpisodeVoCollectionFromAdmissionDetail(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.admin.pas.domain.objects.AdmissionDetail objects.
	 */
	public static ims.core.vo.AdmissionDetailLiteWithInpatientEpisodeVoCollection createAdmissionDetailLiteWithInpatientEpisodeVoCollectionFromAdmissionDetail(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.AdmissionDetailLiteWithInpatientEpisodeVoCollection voList = new ims.core.vo.AdmissionDetailLiteWithInpatientEpisodeVoCollection();
	 ...
	 */
	 public static java.util.Set extractAdmissionDetailSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.AdmissionDetailLiteWithInpatientEpisodeVoCollection voCollection) 
	 {
	 	return extractAdmissionDetailSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractAdmissionDetailSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.AdmissionDetailLiteWithInpatientEpisodeVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.AdmissionDetailLiteWithInpatientEpisodeVo vo = voCollection.get(i);
			ims.core.admin.pas.domain.objects.AdmissionDetail domainObject = AdmissionDetailLiteWithInpatientEpisodeVoAssembler.extractAdmissionDetail(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractAdmissionDetailList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.AdmissionDetailLiteWithInpatientEpisodeVoCollection voCollection) 
	 {
	 	return extractAdmissionDetailList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractAdmissionDetailList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.AdmissionDetailLiteWithInpatientEpisodeVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.AdmissionDetailLiteWithInpatientEpisodeVo create(ims.core.admin.pas.domain.objects.AdmissionDetail domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.AdmissionDetailLiteWithInpatientEpisodeVo create(DomainObjectMap map, ims.core.admin.pas.domain.objects.AdmissionDetail domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.AdmissionDetailLiteWithInpatientEpisodeVo valueObject = (ims.core.vo.AdmissionDetailLiteWithInpatientEpisodeVo) map.getValueObject(domainObject, ims.core.vo.AdmissionDetailLiteWithInpatientEpisodeVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.AdmissionDetailLiteWithInpatientEpisodeVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.admin.pas.domain.objects.AdmissionDetail
	 */
	 public static ims.core.vo.AdmissionDetailLiteWithInpatientEpisodeVo insert(ims.core.vo.AdmissionDetailLiteWithInpatientEpisodeVo valueObject, ims.core.admin.pas.domain.objects.AdmissionDetail domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.admin.pas.domain.objects.AdmissionDetail
	 */
	 public static ims.core.vo.AdmissionDetailLiteWithInpatientEpisodeVo insert(DomainObjectMap map, ims.core.vo.AdmissionDetailLiteWithInpatientEpisodeVo valueObject, ims.core.admin.pas.domain.objects.AdmissionDetail domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 */
	public static ims.core.admin.pas.domain.objects.AdmissionDetail extractAdmissionDetail(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.AdmissionDetailLiteWithInpatientEpisodeVo valueObject) 
	{
		return 	extractAdmissionDetail(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.admin.pas.domain.objects.AdmissionDetail extractAdmissionDetail(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.AdmissionDetailLiteWithInpatientEpisodeVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.AdmissionDetailLiteWithInpatientEpisodeVo ID_AdmissionDetail field is unknown
