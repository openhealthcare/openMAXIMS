 ...
 */
public class MemberOfStaffVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.MemberOfStaffVo copy(ims.core.vo.MemberOfStaffVo valueObjectDest, ims.core.vo.MemberOfStaffVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createMemberOfStaffVoCollectionFromMemberOfStaff(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.resource.people.domain.objects.MemberOfStaff objects.
	 */
	public static ims.core.vo.MemberOfStaffVoCollection createMemberOfStaffVoCollectionFromMemberOfStaff(java.util.Set domainObjectSet)	
	{
		return createMemberOfStaffVoCollectionFromMemberOfStaff(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.resource.people.domain.objects.MemberOfStaff objects.
	 */
	public static ims.core.vo.MemberOfStaffVoCollection createMemberOfStaffVoCollectionFromMemberOfStaff(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.MemberOfStaffVoCollection voList = new ims.core.vo.MemberOfStaffVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.MemberOfStaffVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.MemberOfStaffVoCollection createMemberOfStaffVoCollectionFromMemberOfStaff(java.util.List domainObjectList) 
	{
		return createMemberOfStaffVoCollectionFromMemberOfStaff(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.resource.people.domain.objects.MemberOfStaff objects.
	 */
	public static ims.core.vo.MemberOfStaffVoCollection createMemberOfStaffVoCollectionFromMemberOfStaff(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.MemberOfStaffVoCollection voList = new ims.core.vo.MemberOfStaffVoCollection();
	 ...
	 */
	 public static java.util.Set extractMemberOfStaffSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.MemberOfStaffVoCollection voCollection) 
	 {
	 	return extractMemberOfStaffSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractMemberOfStaffSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.MemberOfStaffVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.MemberOfStaffVo vo = voCollection.get(i);
			ims.core.resource.people.domain.objects.MemberOfStaff domainObject = MemberOfStaffVoAssembler.extractMemberOfStaff(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractMemberOfStaffList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.MemberOfStaffVoCollection voCollection) 
	 {
	 	return extractMemberOfStaffList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractMemberOfStaffList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.MemberOfStaffVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.MemberOfStaffVo create(ims.core.resource.people.domain.objects.MemberOfStaff domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.MemberOfStaffVo create(DomainObjectMap map, ims.core.resource.people.domain.objects.MemberOfStaff domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.MemberOfStaffVo valueObject = (ims.core.vo.MemberOfStaffVo) map.getValueObject(domainObject, ims.core.vo.MemberOfStaffVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.MemberOfStaffVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.resource.people.domain.objects.MemberOfStaff
	 */
	 public static ims.core.vo.MemberOfStaffVo insert(ims.core.vo.MemberOfStaffVo valueObject, ims.core.resource.people.domain.objects.MemberOfStaff domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.resource.people.domain.objects.MemberOfStaff
	 */
	 public static ims.core.vo.MemberOfStaffVo insert(DomainObjectMap map, ims.core.vo.MemberOfStaffVo valueObject, ims.core.resource.people.domain.objects.MemberOfStaff domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// Locations
		valueObject.setLocations(ims.core.vo.domain.HcpLocationVoAssembler.createHcpLocationVoCollectionFromHcpLocation(map, domainObject.getLocations()) );
		// hcp
		valueObject.setHcp(ims.core.vo.domain.HcpAssembler.create(map, domainObject.getHcp()) );
		// StaffType
		ims.domain.lookups.LookupInstance instance3 = domainObject.getStaffType();
		if ( null != instance3 ) {
			...
			ims.core.vo.lookups.StaffType voLookup3 = new ims.core.vo.lookups.StaffType(instance3.getId(),instance3.getText(), instance3.isActive(), null, img, color);
			ims.core.vo.lookups.StaffType parentVoLookup3 = voLookup3;
			...
			while (parent3 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup3.setParent(new ims.core.vo.lookups.StaffType(parent3.getId(),parent3.getText(), parent3.isActive(), null, img, color));
				parentVoLookup3 = parentVoLookup3.getParent();
								parent3 = parent3.getParent();
			}			
			valueObject.setStaffType(voLookup3);
		}
				// isActive
	 ...
	 */
	public static ims.core.resource.people.domain.objects.MemberOfStaff extractMemberOfStaff(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.MemberOfStaffVo valueObject) 
	{
		return 	extractMemberOfStaff(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.resource.people.domain.objects.MemberOfStaff extractMemberOfStaff(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.MemberOfStaffVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.MemberOfStaffVo ID_MemberOfStaff field is unknown
		...
		domainObject.setLocations(ims.core.vo.domain.HcpLocationVoAssembler.extractHcpLocationSet(domainFactory, valueObject.getLocations(), domainObject.getLocations(), domMap));		
		...
		domainObject.setStaffType(value3);
