 ...
 */
public class ClinicalNotesVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.ClinicalNotesVo copy(ims.core.vo.ClinicalNotesVo valueObjectDest, ims.core.vo.ClinicalNotesVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createClinicalNotesVoCollectionFromClinicalNotes(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.clinical.domain.objects.ClinicalNotes objects.
	 */
	public static ims.core.vo.ClinicalNotesVoCollection createClinicalNotesVoCollectionFromClinicalNotes(java.util.Set domainObjectSet)	
	{
		return createClinicalNotesVoCollectionFromClinicalNotes(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.clinical.domain.objects.ClinicalNotes objects.
	 */
	public static ims.core.vo.ClinicalNotesVoCollection createClinicalNotesVoCollectionFromClinicalNotes(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.ClinicalNotesVoCollection voList = new ims.core.vo.ClinicalNotesVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.ClinicalNotesVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.ClinicalNotesVoCollection createClinicalNotesVoCollectionFromClinicalNotes(java.util.List domainObjectList) 
	{
		return createClinicalNotesVoCollectionFromClinicalNotes(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.clinical.domain.objects.ClinicalNotes objects.
	 */
	public static ims.core.vo.ClinicalNotesVoCollection createClinicalNotesVoCollectionFromClinicalNotes(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.ClinicalNotesVoCollection voList = new ims.core.vo.ClinicalNotesVoCollection();
	 ...
	 */
	 public static java.util.Set extractClinicalNotesSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.ClinicalNotesVoCollection voCollection) 
	 {
	 	return extractClinicalNotesSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractClinicalNotesSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.ClinicalNotesVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.ClinicalNotesVo vo = voCollection.get(i);
			ims.core.clinical.domain.objects.ClinicalNotes domainObject = ClinicalNotesVoAssembler.extractClinicalNotes(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractClinicalNotesList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.ClinicalNotesVoCollection voCollection) 
	 {
	 	return extractClinicalNotesList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractClinicalNotesList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.ClinicalNotesVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.ClinicalNotesVo create(ims.core.clinical.domain.objects.ClinicalNotes domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.ClinicalNotesVo create(DomainObjectMap map, ims.core.clinical.domain.objects.ClinicalNotes domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.ClinicalNotesVo valueObject = (ims.core.vo.ClinicalNotesVo) map.getValueObject(domainObject, ims.core.vo.ClinicalNotesVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.ClinicalNotesVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.ClinicalNotes
	 */
	 public static ims.core.vo.ClinicalNotesVo insert(ims.core.vo.ClinicalNotesVo valueObject, ims.core.clinical.domain.objects.ClinicalNotes domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.ClinicalNotes
	 */
	 public static ims.core.vo.ClinicalNotesVo insert(DomainObjectMap map, ims.core.vo.ClinicalNotesVo valueObject, ims.core.clinical.domain.objects.ClinicalNotes domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// NoteClassification
		ims.domain.lookups.LookupInstance instance5 = domainObject.getNoteClassification();
		if ( null != instance5 ) {
			...
			ims.clinical.vo.lookups.ClinicalNoteClassification voLookup5 = new ims.clinical.vo.lookups.ClinicalNoteClassification(instance5.getId(),instance5.getText(), instance5.isActive(), null, img, color);
			ims.clinical.vo.lookups.ClinicalNoteClassification parentVoLookup5 = voLookup5;
			...
			while (parent5 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup5.setParent(new ims.clinical.vo.lookups.ClinicalNoteClassification(parent5.getId(),parent5.getText(), parent5.isActive(), null, img, color));
				parentVoLookup5 = parentVoLookup5.getParent();
								parent5 = parent5.getParent();
			}			
			valueObject.setNoteClassification(voLookup5);
		}
				// NoteType
		...
		if ( null != instance6 ) {
			...
			ims.core.vo.lookups.ClinicalNoteType voLookup6 = new ims.core.vo.lookups.ClinicalNoteType(instance6.getId(),instance6.getText(), instance6.isActive(), null, img, color);
			ims.core.vo.lookups.ClinicalNoteType parentVoLookup6 = voLookup6;
			...
			while (parent6 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup6.setParent(new ims.core.vo.lookups.ClinicalNoteType(parent6.getId(),parent6.getText(), parent6.isActive(), null, img, color));
		...
		// ForReviewDiscipline
		ims.domain.lookups.LookupInstance instance12 = domainObject.getForReviewDiscipline();
		if ( null != instance12 ) {
			ims.framework.utils.ImagePath img = null;
			ims.framework.utils.Color color = null;		
			img = null;
			...
			valueObject.setForReviewDiscipline(voLookup12);
		}
				// ReviewingHCP
		...
		// SourceOfNote
		ims.domain.lookups.LookupInstance instance18 = domainObject.getSourceOfNote();
		if ( null != instance18 ) {
			ims.framework.utils.ImagePath img = null;
			ims.framework.utils.Color color = null;		
			img = null;
			...
			ims.core.vo.lookups.SourceOfNote voLookup18 = new ims.core.vo.lookups.SourceOfNote(instance18.getId(),instance18.getText(), instance18.isActive(), null, img, color);
			ims.core.vo.lookups.SourceOfNote parentVoLookup18 = voLookup18;
			...
			while (parent18 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup18.setParent(new ims.core.vo.lookups.SourceOfNote(parent18.getId(),parent18.getText(), parent18.isActive(), null, img, color));
				parentVoLookup18 = parentVoLookup18.getParent();
								parent18 = parent18.getParent();
			}			
			valueObject.setSourceOfNote(voLookup18);
		}
				// RecordingUser
	 ...
	 */
	public static ims.core.clinical.domain.objects.ClinicalNotes extractClinicalNotes(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.ClinicalNotesVo valueObject) 
	{
		return 	extractClinicalNotes(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.clinical.domain.objects.ClinicalNotes extractClinicalNotes(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.ClinicalNotesVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.ClinicalNotesVo ID_ClinicalNotes field is unknown
		...
		domainObject.setNoteClassification(value5);
		// create LookupInstance from vo LookupType
		...
		domainObject.setForReviewDiscipline(value12);
	...
	ims.core.resource.people.domain.objects.Hcp value13 = null;
		if ( null != valueObject.getReviewingHCP() ) 
		{
			if (valueObject.getReviewingHCP().getBoId() == null)
			{
				...
				{
					value13 = (ims.core.resource.people.domain.objects.Hcp)domMap.get(valueObject.getReviewingHCP());
				}
			}
			else
			{
				value13 = (ims.core.resource.people.domain.objects.Hcp)domainFactory.getDomainObject(ims.core.resource.people.domain.objects.Hcp.class, valueObject.getReviewingHCP().getBoId());
			}
		}
		domainObject.setReviewingHCP(value13);
		ims.framework.utils.DateTime dateTime14 = valueObject.getReviewingDateTime();
		java.util.Date value14 = null;
		if ( dateTime14 != null ) 
		{
			value14 = dateTime14.getJavaDate();
		}
		domainObject.setReviewingDateTime(value14);
		...
		domainObject.setSourceOfNote(value18);
	// SaveAsRefVO - treated as a refVo in extract methods
	ims.core.resource.people.domain.objects.MemberOfStaff value19 = null;
		if ( null != valueObject.getRecordingUser() ) 
		{
			if (valueObject.getRecordingUser().getBoId() == null)
			{
				...
				{
					value19 = (ims.core.resource.people.domain.objects.MemberOfStaff)domMap.get(valueObject.getRecordingUser());
				}
			}
			else
			{
				value19 = (ims.core.resource.people.domain.objects.MemberOfStaff)domainFactory.getDomainObject(ims.core.resource.people.domain.objects.MemberOfStaff.class, valueObject.getRecordingUser().getBoId());
			}
		}
		domainObject.setRecordingUser(value19);
		ims.framework.utils.DateTime dateTime20 = valueObject.getRecordingDateTime();
		java.util.Date value20 = null;
		if ( dateTime20 != null ) 
		{
			value20 = dateTime20.getJavaDate();
		}
		domainObject.setRecordingDateTime(value20);
