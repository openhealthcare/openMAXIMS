 ...
 */
public class PatientElectiveListForWardViewVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.PatientElectiveListForWardViewVo copy(ims.core.vo.PatientElectiveListForWardViewVo valueObjectDest, ims.core.vo.PatientElectiveListForWardViewVo valueObjectSrc) 
	 {
	...
	{
		return createPatientElectiveListForWardViewVoCollectionFromPatientElectiveList(new DomainObjectMap(), domainObjectSet);
	}
	...
	{
		ims.core.vo.PatientElectiveListForWardViewVoCollection voList = new ims.core.vo.PatientElectiveListForWardViewVoCollection();
	...
	{
		return createPatientElectiveListForWardViewVoCollectionFromPatientElectiveList(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 */
	 public static java.util.Set extractPatientElectiveListSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientElectiveListForWardViewVoCollection voCollection) 
	 {
	 	return extractPatientElectiveListSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientElectiveListSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientElectiveListForWardViewVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPatientElectiveListList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientElectiveListForWardViewVoCollection voCollection) 
	 {
	 	return extractPatientElectiveListList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPatientElectiveListList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientElectiveListForWardViewVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	  ...
	  */
	  public static ims.core.vo.PatientElectiveListForWardViewVo create(DomainObjectMap map, ims.careuk.domain.objects.PatientElectiveList domainObject) 
	  {
			...
			ims.core.vo.PatientElectiveListForWardViewVo valueObject = (ims.core.vo.PatientElectiveListForWardViewVo) map.getValueObject(domainObject, ims.core.vo.PatientElectiveListForWardViewVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.PatientElectiveListForWardViewVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 */
	 public static ims.core.vo.PatientElectiveListForWardViewVo insert(DomainObjectMap map, ims.core.vo.PatientElectiveListForWardViewVo valueObject, ims.careuk.domain.objects.PatientElectiveList domainObject) 
	 {
		...
		// Referral
		valueObject.setReferral(ims.core.vo.domain.CatsRefPatElectListWardViewLiteVoAssembler.create(map, domainObject.getReferral()) );
		// Ward
		valueObject.setWard(ims.core.vo.domain.LocationLiteVoAssembler.create(map, domainObject.getWard()) );
		// TCIDetails
		valueObject.setTCIDetails(ims.core.vo.domain.TCIForPatElectListForWardLiteVoAssembler.create(map, domainObject.getTCIDetails()) );
 		return valueObject;
	 }
	...
	ims.careuk.domain.objects.CatsReferral value3 = null;
		...
		domainObject.setTCIDetails(ims.core.vo.domain.TCIForPatElectListForWardLiteVoAssembler.extractTCIForPatientElectiveList(domainFactory, valueObject.getTCIDetails(), domMap));
