 ...
 */
public class PatientProcedureShortListVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.PatientProcedureShortListVo copy(ims.core.vo.PatientProcedureShortListVo valueObjectDest, ims.core.vo.PatientProcedureShortListVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createPatientProcedureShortListVoCollectionFromPatientProcedure(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.clinical.domain.objects.PatientProcedure objects.
	 */
	public static ims.core.vo.PatientProcedureShortListVoCollection createPatientProcedureShortListVoCollectionFromPatientProcedure(java.util.Set domainObjectSet)	
	{
		return createPatientProcedureShortListVoCollectionFromPatientProcedure(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.clinical.domain.objects.PatientProcedure objects.
	 */
	public static ims.core.vo.PatientProcedureShortListVoCollection createPatientProcedureShortListVoCollectionFromPatientProcedure(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.PatientProcedureShortListVoCollection voList = new ims.core.vo.PatientProcedureShortListVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.PatientProcedureShortListVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.PatientProcedureShortListVoCollection createPatientProcedureShortListVoCollectionFromPatientProcedure(java.util.List domainObjectList) 
	{
		return createPatientProcedureShortListVoCollectionFromPatientProcedure(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.clinical.domain.objects.PatientProcedure objects.
	 */
	public static ims.core.vo.PatientProcedureShortListVoCollection createPatientProcedureShortListVoCollectionFromPatientProcedure(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.PatientProcedureShortListVoCollection voList = new ims.core.vo.PatientProcedureShortListVoCollection();
	 ...
	 */
	 public static java.util.Set extractPatientProcedureSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientProcedureShortListVoCollection voCollection) 
	 {
	 	return extractPatientProcedureSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPatientProcedureSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientProcedureShortListVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.PatientProcedureShortListVo vo = voCollection.get(i);
			ims.core.clinical.domain.objects.PatientProcedure domainObject = PatientProcedureShortListVoAssembler.extractPatientProcedure(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPatientProcedureList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientProcedureShortListVoCollection voCollection) 
	 {
	 	return extractPatientProcedureList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPatientProcedureList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientProcedureShortListVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.PatientProcedureShortListVo create(ims.core.clinical.domain.objects.PatientProcedure domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.PatientProcedureShortListVo create(DomainObjectMap map, ims.core.clinical.domain.objects.PatientProcedure domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.PatientProcedureShortListVo valueObject = (ims.core.vo.PatientProcedureShortListVo) map.getValueObject(domainObject, ims.core.vo.PatientProcedureShortListVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.PatientProcedureShortListVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.PatientProcedure
	 */
	 public static ims.core.vo.PatientProcedureShortListVo insert(ims.core.vo.PatientProcedureShortListVo valueObject, ims.core.clinical.domain.objects.PatientProcedure domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.clinical.domain.objects.PatientProcedure
	 */
	 public static ims.core.vo.PatientProcedureShortListVo insert(DomainObjectMap map, ims.core.vo.PatientProcedureShortListVo valueObject, ims.core.clinical.domain.objects.PatientProcedure domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// InfoSource
		ims.domain.lookups.LookupInstance instance11 = domainObject.getInfoSource();
		if ( null != instance11 ) {
			ims.framework.utils.ImagePath img = null;
			ims.framework.utils.Color color = null;		
			img = null;
			...
			ims.core.vo.lookups.SourceofInformation voLookup11 = new ims.core.vo.lookups.SourceofInformation(instance11.getId(),instance11.getText(), instance11.isActive(), null, img, color);
			ims.core.vo.lookups.SourceofInformation parentVoLookup11 = voLookup11;
			...
			while (parent11 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup11.setParent(new ims.core.vo.lookups.SourceofInformation(parent11.getId(),parent11.getText(), parent11.isActive(), null, img, color));
				parentVoLookup11 = parentVoLookup11.getParent();
								parent11 = parent11.getParent();
			}			
			valueObject.setInfoSource(voLookup11);
		}
				// SysInfo
	 ...
	 */
	public static ims.core.clinical.domain.objects.PatientProcedure extractPatientProcedure(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientProcedureShortListVo valueObject) 
	{
		return 	extractPatientProcedure(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.clinical.domain.objects.PatientProcedure extractPatientProcedure(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PatientProcedureShortListVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.PatientProcedureShortListVo ID_PatientProcedure field is unknown
		...
		ims.framework.utils.Time time7 = valueObject.getProcTime();
		String value7 = null;
		if ( time7 != null ) 
		{
			value7 = time7.toString();
		}
		domainObject.setProcTime(value7);
		// create LookupInstance from vo LookupType
		...
		domainObject.setInfoSource(value11);
		ims.core.clinical.domain.objects.PatientProcedure value13 = null;
		if ( null != valueObject.getPlannedProc() ) 
		{
			if (valueObject.getPlannedProc().getBoId() == null)
			{
				...
				{
					value13 = (ims.core.clinical.domain.objects.PatientProcedure)domMap.get(valueObject.getPlannedProc());
				}
			}
			else if (valueObject.getBoVersion() == -1) // RefVo was not modified since obtained from the Assembler, no need to update the BO field
			{
				value13 = domainObject.getPlannedProc();	
			}
			else
			{
				value13 = (ims.core.clinical.domain.objects.PatientProcedure)domainFactory.getDomainObject(ims.core.clinical.domain.objects.PatientProcedure.class, valueObject.getPlannedProc().getBoId());
			}
		}
		domainObject.setPlannedProc(value13);
		...
		ims.core.clinical.domain.objects.IntraOperativeCareRecord value16 = null;
		if ( null != valueObject.getIntraOperativeRecord() ) 
		{
			if (valueObject.getIntraOperativeRecord().getBoId() == null)
			{
				...
				{
					value16 = (ims.core.clinical.domain.objects.IntraOperativeCareRecord)domMap.get(valueObject.getIntraOperativeRecord());
				}
			}
			else if (valueObject.getBoVersion() == -1) // RefVo was not modified since obtained from the Assembler, no need to update the BO field
			{
				value16 = domainObject.getIntraOperativeRecord();	
			}
			else
			{
				value16 = (ims.core.clinical.domain.objects.IntraOperativeCareRecord)domainFactory.getDomainObject(ims.core.clinical.domain.objects.IntraOperativeCareRecord.class, valueObject.getIntraOperativeRecord().getBoId());
			}
		}
		domainObject.setIntraOperativeRecord(value16);
