 ...
 */
public class PendingElectiveAdmissionHl7VoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.PendingElectiveAdmissionHl7Vo copy(ims.core.vo.PendingElectiveAdmissionHl7Vo valueObjectDest, ims.core.vo.PendingElectiveAdmissionHl7Vo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createPendingElectiveAdmissionHl7VoCollectionFromPendingElectiveAdmission(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.admin.pas.domain.objects.PendingElectiveAdmission objects.
	 */
	public static ims.core.vo.PendingElectiveAdmissionHl7VoCollection createPendingElectiveAdmissionHl7VoCollectionFromPendingElectiveAdmission(java.util.Set domainObjectSet)	
	{
		return createPendingElectiveAdmissionHl7VoCollectionFromPendingElectiveAdmission(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.admin.pas.domain.objects.PendingElectiveAdmission objects.
	 */
	public static ims.core.vo.PendingElectiveAdmissionHl7VoCollection createPendingElectiveAdmissionHl7VoCollectionFromPendingElectiveAdmission(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.PendingElectiveAdmissionHl7VoCollection voList = new ims.core.vo.PendingElectiveAdmissionHl7VoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.PendingElectiveAdmissionHl7Vo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.PendingElectiveAdmissionHl7VoCollection createPendingElectiveAdmissionHl7VoCollectionFromPendingElectiveAdmission(java.util.List domainObjectList) 
	{
		return createPendingElectiveAdmissionHl7VoCollectionFromPendingElectiveAdmission(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.admin.pas.domain.objects.PendingElectiveAdmission objects.
	 */
	public static ims.core.vo.PendingElectiveAdmissionHl7VoCollection createPendingElectiveAdmissionHl7VoCollectionFromPendingElectiveAdmission(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.PendingElectiveAdmissionHl7VoCollection voList = new ims.core.vo.PendingElectiveAdmissionHl7VoCollection();
	 ...
	 */
	 public static java.util.Set extractPendingElectiveAdmissionSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PendingElectiveAdmissionHl7VoCollection voCollection) 
	 {
	 	return extractPendingElectiveAdmissionSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractPendingElectiveAdmissionSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PendingElectiveAdmissionHl7VoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.PendingElectiveAdmissionHl7Vo vo = voCollection.get(i);
			ims.core.admin.pas.domain.objects.PendingElectiveAdmission domainObject = PendingElectiveAdmissionHl7VoAssembler.extractPendingElectiveAdmission(domainFactory, vo, domMap);
	 ...
	 * @param voCollection - the collection of value objects	 
	 */
	 public static java.util.List extractPendingElectiveAdmissionList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PendingElectiveAdmissionHl7VoCollection voCollection) 
	 {
	 	return extractPendingElectiveAdmissionList(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.List extractPendingElectiveAdmissionList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PendingElectiveAdmissionHl7VoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.PendingElectiveAdmissionHl7Vo create(ims.core.admin.pas.domain.objects.PendingElectiveAdmission domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.PendingElectiveAdmissionHl7Vo create(DomainObjectMap map, ims.core.admin.pas.domain.objects.PendingElectiveAdmission domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.PendingElectiveAdmissionHl7Vo valueObject = (ims.core.vo.PendingElectiveAdmissionHl7Vo) map.getValueObject(domainObject, ims.core.vo.PendingElectiveAdmissionHl7Vo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.PendingElectiveAdmissionHl7Vo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.admin.pas.domain.objects.PendingElectiveAdmission
	 */
	 public static ims.core.vo.PendingElectiveAdmissionHl7Vo insert(ims.core.vo.PendingElectiveAdmissionHl7Vo valueObject, ims.core.admin.pas.domain.objects.PendingElectiveAdmission domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.admin.pas.domain.objects.PendingElectiveAdmission
	 */
	 public static ims.core.vo.PendingElectiveAdmissionHl7Vo insert(DomainObjectMap map, ims.core.vo.PendingElectiveAdmissionHl7Vo valueObject, ims.core.admin.pas.domain.objects.PendingElectiveAdmission domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// AdmissionSource
		ims.domain.lookups.LookupInstance instance8 = domainObject.getAdmissionSource();
		if ( null != instance8 ) {
			ims.framework.utils.ImagePath img = null;
			ims.framework.utils.Color color = null;		
			img = null;
			...
			ims.core.vo.lookups.SourceOfAdmission voLookup8 = new ims.core.vo.lookups.SourceOfAdmission(instance8.getId(),instance8.getText(), instance8.isActive(), null, img, color);
			ims.core.vo.lookups.SourceOfAdmission parentVoLookup8 = voLookup8;
			...
			while (parent8 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup8.setParent(new ims.core.vo.lookups.SourceOfAdmission(parent8.getId(),parent8.getText(), parent8.isActive(), null, img, color));
				parentVoLookup8 = parentVoLookup8.getParent();
								parent8 = parent8.getParent();
			}			
			valueObject.setAdmissionSource(voLookup8);
		}
				// ReasonForAdmission
		...
		// ManagementIntention
		ims.domain.lookups.LookupInstance instance11 = domainObject.getManagementIntention();
		if ( null != instance11 ) {
			ims.framework.utils.ImagePath img = null;
			ims.framework.utils.Color color = null;		
			img = null;
			...
			ims.core.vo.lookups.ManagementIntention voLookup11 = new ims.core.vo.lookups.ManagementIntention(instance11.getId(),instance11.getText(), instance11.isActive(), null, img, color);
			ims.core.vo.lookups.ManagementIntention parentVoLookup11 = voLookup11;
			...
			while (parent11 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup11.setParent(new ims.core.vo.lookups.ManagementIntention(parent11.getId(),parent11.getText(), parent11.isActive(), null, img, color));
				parentVoLookup11 = parentVoLookup11.getParent();
								parent11 = parent11.getParent();
			}			
			valueObject.setManagementIntention(voLookup11);
		}
				// Comments
		...
		// AdmissionMethod
		ims.domain.lookups.LookupInstance instance14 = domainObject.getAdmissionMethod();
		if ( null != instance14 ) {
			ims.framework.utils.ImagePath img = null;
			ims.framework.utils.Color color = null;		
			img = null;
			...
			ims.core.vo.lookups.MethodOfAdmission voLookup14 = new ims.core.vo.lookups.MethodOfAdmission(instance14.getId(),instance14.getText(), instance14.isActive(), null, img, color);
			ims.core.vo.lookups.MethodOfAdmission parentVoLookup14 = voLookup14;
			...
			while (parent14 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup14.setParent(new ims.core.vo.lookups.MethodOfAdmission(parent14.getId(),parent14.getText(), parent14.isActive(), null, img, color));
				parentVoLookup14 = parentVoLookup14.getParent();
								parent14 = parent14.getParent();
			}			
			valueObject.setAdmissionMethod(voLookup14);
		}
				// ReferringConsultant
		if (domainObject.getReferringConsultant() != null)
		{
			if(domainObject.getReferringConsultant() instanceof HibernateProxy) // If the proxy is set, there is no need to lazy load, the proxy knows the id already. 
			{
				HibernateProxy p = (HibernateProxy) domainObject.getReferringConsultant();
				int id = Integer.parseInt(p.getHibernateLazyInitializer().getIdentifier().toString());				
				valueObject.setReferringConsultant(new ims.core.resource.people.vo.MedicRefVo(id, -1));				
			}
			else
			{
				valueObject.setReferringConsultant(new ims.core.resource.people.vo.MedicRefVo(domainObject.getReferringConsultant().getId(), domainObject.getReferringConsultant().getVersion()));
			}
		}
		// PatientStatus
		ims.domain.lookups.LookupInstance instance16 = domainObject.getPatientStatus();
		if ( null != instance16 ) {
			ims.framework.utils.ImagePath img = null;
			ims.framework.utils.Color color = null;		
			img = null;
			...
			ims.core.vo.lookups.PatientStatus voLookup16 = new ims.core.vo.lookups.PatientStatus(instance16.getId(),instance16.getText(), instance16.isActive(), null, img, color);
			ims.core.vo.lookups.PatientStatus parentVoLookup16 = voLookup16;
			...
			while (parent16 != null)
			{
    			...
    			if (color != null) 
    				color.getValue();
								parentVoLookup16.setParent(new ims.core.vo.lookups.PatientStatus(parent16.getId(),parent16.getText(), parent16.isActive(), null, img, color));
				parentVoLookup16 = parentVoLookup16.getParent();
								parent16 = parent16.getParent();
			}			
			valueObject.setPatientStatus(voLookup16);
		}
		 		return valueObject;
	 }
	 ...
	 */
	public static ims.core.admin.pas.domain.objects.PendingElectiveAdmission extractPendingElectiveAdmission(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PendingElectiveAdmissionHl7Vo valueObject) 
	{
		return 	extractPendingElectiveAdmission(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.admin.pas.domain.objects.PendingElectiveAdmission extractPendingElectiveAdmission(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.PendingElectiveAdmissionHl7Vo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.PendingElectiveAdmissionHl7Vo ID_PendingElectiveAdmission field is unknown
	...
	ims.core.resource.place.domain.objects.Location value2 = null;
		...
		domainObject.setAdmissionSource(value8);
		...
		domainObject.setManagementIntention(value11);
		//This is to overcome a bug in both Sybase and Oracle which prevents them from storing an empty string correctly
		//Sybase stores it as a single space, Oracle stores it as NULL. This fix will make them consistent at least.
		...
		domainObject.setAdmissionMethod(value14);
		...
		if ( null != valueObject.getReferringConsultant() ) 
		{
			if (valueObject.getReferringConsultant().getBoId() == null)
			{
				...
				{
					value15 = (ims.core.resource.people.domain.objects.Medic)domMap.get(valueObject.getReferringConsultant());
				}
			}
			else if (valueObject.getBoVersion() == -1) // RefVo was not modified since obtained from the Assembler, no need to update the BO field
			{
				value15 = domainObject.getReferringConsultant();	
			}
			else
			{
				value15 = (ims.core.resource.people.domain.objects.Medic)domainFactory.getDomainObject(ims.core.resource.people.domain.objects.Medic.class, valueObject.getReferringConsultant().getBoId());
			}
		}
		domainObject.setReferringConsultant(value15);
		// create LookupInstance from vo LookupType
		...
		domainObject.setPatientStatus(value16);
