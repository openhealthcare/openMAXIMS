 ...
 */
public class LocSiteUpprNameVoAssembler
{
  	/**
	 ...
	 */
	 public static ims.core.vo.LocSiteUpprNameVo copy(ims.core.vo.LocSiteUpprNameVo valueObjectDest, ims.core.vo.LocSiteUpprNameVo valueObjectSrc) 
	 {
	 ...
	 * It is intended to be used when one called to an Assembler is made.
 	 * If more than one call to an Assembler is made then #createLocSiteUpprNameVoCollectionFromLocSite(DomainObjectMap, Set) should be used.
	 * @param domainObjectSet - Set of ims.core.resource.place.domain.objects.LocSite objects.
	 */
	public static ims.core.vo.LocSiteUpprNameVoCollection createLocSiteUpprNameVoCollectionFromLocSite(java.util.Set domainObjectSet)	
	{
		return createLocSiteUpprNameVoCollectionFromLocSite(new DomainObjectMap(), domainObjectSet);
	}
	 ...
	 * @param domainObjectSet - Set of ims.core.resource.place.domain.objects.LocSite objects.
	 */
	public static ims.core.vo.LocSiteUpprNameVoCollection createLocSiteUpprNameVoCollectionFromLocSite(DomainObjectMap map, java.util.Set domainObjectSet)	
	{
		ims.core.vo.LocSiteUpprNameVoCollection voList = new ims.core.vo.LocSiteUpprNameVoCollection();
		...
		while( iterator.hasNext() ) 
		{
			...
			ims.core.vo.LocSiteUpprNameVo vo = create(map, domainObject);
	 ...
	 */
	public static ims.core.vo.LocSiteUpprNameVoCollection createLocSiteUpprNameVoCollectionFromLocSite(java.util.List domainObjectList) 
	{
		return createLocSiteUpprNameVoCollectionFromLocSite(new DomainObjectMap(), domainObjectList);
	}
	 ...
	 * @param domainObjectList - List of ims.core.resource.place.domain.objects.LocSite objects.
	 */
	public static ims.core.vo.LocSiteUpprNameVoCollection createLocSiteUpprNameVoCollectionFromLocSite(DomainObjectMap map, java.util.List domainObjectList) 
	{
		ims.core.vo.LocSiteUpprNameVoCollection voList = new ims.core.vo.LocSiteUpprNameVoCollection();
	 ...
	 */
	 public static java.util.Set extractLocSiteSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.LocSiteUpprNameVoCollection voCollection) 
	 {
	 	return extractLocSiteSet(domainFactory, voCollection, null, new HashMap());
	 }
	 
	 public static java.util.Set extractLocSiteSet(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.LocSiteUpprNameVoCollection voCollection, java.util.Set domainObjectSet, HashMap domMap) 
	 {
		...
		{
			ims.core.vo.LocSiteUpprNameVo vo = voCollection.get(i);
			ims.core.resource.place.domain.objects.LocSite domainObject = LocSiteUpprNameVoAssembler.extractLocSite(domainFactory, vo, domMap);
	 ...
	 */
	 ...
	 public static java.util.List extractLocSiteList(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.LocSiteUpprNameVoCollection voCollection, java.util.List domainObjectList, HashMap domMap) 
	 {
	 	int size = (null == voCollection) ? 0 : voCollection.size();
	 ...
	 */
	 public static ims.core.vo.LocSiteUpprNameVo create(ims.core.resource.place.domain.objects.LocSite domainObject) 
	 {
	  ...
	  * @param domainObject
	  */
	  public static ims.core.vo.LocSiteUpprNameVo create(DomainObjectMap map, ims.core.resource.place.domain.objects.LocSite domainObject) 
	  {
	  		if (null == domainObject) 
	  		{
				return null;
			...
			ims.core.vo.LocSiteUpprNameVo valueObject = (ims.core.vo.LocSiteUpprNameVo) map.getValueObject(domainObject, ims.core.vo.LocSiteUpprNameVo.class);
			if ( null == valueObject ) 
			{
				valueObject = new ims.core.vo.LocSiteUpprNameVo(domainObject.getId(), domainObject.getVersion());
	 ...
	 * @param domainObject ims.core.resource.place.domain.objects.LocSite
	 */
	 public static ims.core.vo.LocSiteUpprNameVo insert(ims.core.vo.LocSiteUpprNameVo valueObject, ims.core.resource.place.domain.objects.LocSite domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
	 ...
	 * @param domainObject ims.core.resource.place.domain.objects.LocSite
	 */
	 public static ims.core.vo.LocSiteUpprNameVo insert(DomainObjectMap map, ims.core.vo.LocSiteUpprNameVo valueObject, ims.core.resource.place.domain.objects.LocSite domainObject) 
	 {
	 	if (null == domainObject) 
	 	{
			return valueObject;
		...
		// parentOrganisation
		valueObject.setParentOrganisation(ims.core.vo.domain.OrgVoAssembler.create(map, domainObject.getParentOrganisation()) );
		// CommChannels
	 ...
	 */
	public static ims.core.resource.place.domain.objects.LocSite extractLocSite(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.LocSiteUpprNameVo valueObject) 
	{
		return 	extractLocSite(domainFactory, valueObject, new HashMap());
	}

	public static ims.core.resource.place.domain.objects.LocSite extractLocSite(ims.domain.ILightweightDomainFactory domainFactory, ims.core.vo.LocSiteUpprNameVo valueObject, HashMap domMap) 
	{
		if (null == valueObject) 
		{
			return null;
		...
		if ( null == id) 
		{
			...
			// ims.core.vo.LocSiteUpprNameVo ID_LocSite field is unknown
		...
		domainObject.setParentOrganisation(ims.core.vo.domain.OrgVoAssembler.extractOrganisation(domainFactory, valueObject.getParentOrganisation(), domMap));
