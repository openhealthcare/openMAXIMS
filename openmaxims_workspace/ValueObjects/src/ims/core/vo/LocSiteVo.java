 ...
 */
public class LocSiteVo extends ims.core.vo.LocMostVo implements ims.vo.ImsCloneable, Comparable, ims.framework.interfaces.ILocation
{
	...
	public LocSiteVo(Integer id, int version)
	{
		super(id, version);
	}
	public LocSiteVo(ims.core.vo.beans.LocSiteVoBean bean)
	{
		this.id = bean.getId();
		...
		this.allsecureaccommodation = bean.getAllSecureAccommodation();
		this.commchannels = ims.core.vo.CommChannelVoCollection.buildFromBeanCollection(bean.getCommChannels());
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.LocSiteVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.name = bean.getName();
	...
	{
		ims.core.vo.beans.LocSiteVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.LocSiteVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.LocSiteVoBean();
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("ALLSECUREACCOMMODATION"))
			return getAllSecureAccommodation();
	...
	public boolean getAllSecureAccommodationIsNotNull()
	{
		return this.allsecureaccommodation != null;
	}
	...
	*/
	public void setParent(OrganisationVo value)
	{
		OrganisationVo valueParent = this.getParentOrganisation();
		if(valueParent != null)
		{
			valueParent.getLocationSites().remove(this);
		}	
		this.parentorganisation = value;
		if(value != null)
		{
			value.getLocationSites().add(this);
		}
	}
	...
	*/
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.name == null || this.name.length() == 0)
			...
			listOfErrors.add("The length of the field [name] in the value object [ims.core.vo.LocSiteVo] is too big. It should be less or equal to 120");
	...
	public Object clone()
	{
		...
		LocSiteVo clone = new LocSiteVo(this.id, this.version);
		...
		clone.allsecureaccommodation = this.allsecureaccommodation;
		if(this.commchannels == null)
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(LocSiteVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A LocSiteVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		LocSiteVo compareObj = (LocSiteVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
	...
	protected Boolean allsecureaccommodation;
