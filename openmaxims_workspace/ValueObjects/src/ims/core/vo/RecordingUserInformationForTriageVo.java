 ...
 */
public class RecordingUserInformationForTriageVo extends ims.core.clinical.vo.RecordingUserInformationRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public RecordingUserInformationForTriageVo()
	{
	}
	public RecordingUserInformationForTriageVo(Integer id, int version)
	{
		super(id, version);
	}
	public RecordingUserInformationForTriageVo(ims.core.vo.beans.RecordingUserInformationForTriageVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.RecordingUserInformationForTriageVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.recordinguser = bean.getRecordingUser() == null ? null : new ims.core.resource.people.vo.MemberOfStaffRefVo(new Integer(bean.getRecordingUser().getId()), bean.getRecordingUser().getVersion());
	...
	{
		ims.core.vo.beans.RecordingUserInformationForTriageVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.RecordingUserInformationForTriageVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.RecordingUserInformationForTriageVoBean();
	...
	public Object clone()
	{
		...
		RecordingUserInformationForTriageVo clone = new RecordingUserInformationForTriageVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(RecordingUserInformationForTriageVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A RecordingUserInformationForTriageVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((RecordingUserInformationForTriageVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((RecordingUserInformationForTriageVo)obj).getBoId());
	}
