 ...
 */
public class BedSpaceStateStatusVo extends ims.core.vo.BedSpaceStateStatusLiteVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public BedSpaceStateStatusVo(Integer id, int version)
	{
		super(id, version);
	}
	public BedSpaceStateStatusVo(ims.core.vo.beans.BedSpaceStateStatusVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.BedSpaceStateStatusVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.bedstatus = bean.getBedStatus() == null ? null : ims.core.vo.lookups.BedStatus.buildLookup(bean.getBedStatus());
	...
	{
		ims.core.vo.beans.BedSpaceStateStatusVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.BedSpaceStateStatusVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.BedSpaceStateStatusVoBean();
	...
	public Object clone()
	{
		...
		BedSpaceStateStatusVo clone = new BedSpaceStateStatusVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(BedSpaceStateStatusVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A BedSpaceStateStatusVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((BedSpaceStateStatusVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((BedSpaceStateStatusVo)obj).getBoId());
	}
