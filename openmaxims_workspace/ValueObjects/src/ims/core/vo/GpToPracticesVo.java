 ...
 */
public class GpToPracticesVo extends ims.core.resource.vo.GpToPracticeRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public GpToPracticesVo()
	{
	}
	public GpToPracticesVo(Integer id, int version)
	{
		super(id, version);
	}
	public GpToPracticesVo(ims.core.vo.beans.GpToPracticesVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.GpToPracticesVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.core.vo.beans.GpToPracticesVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.GpToPracticesVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.GpToPracticesVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.gpcode != null)
			if(this.gpcode.length() > 40)
				listOfErrors.add("The length of the field [gpcode] in the value object [ims.core.vo.GpToPracticesVo] is too big. It should be less or equal to 40");
	...
	public Object clone()
	{
		...
		GpToPracticesVo clone = new GpToPracticesVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(GpToPracticesVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A GpToPracticesVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		GpToPracticesVo compareObj = (GpToPracticesVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
