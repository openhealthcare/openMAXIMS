 ...
 */
public class PatientNoAllergyInfoVo extends ims.core.clinical.vo.PatientNoAllergyInfoRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public PatientNoAllergyInfoVo()
	{
	}
	public PatientNoAllergyInfoVo(Integer id, int version)
	{
		super(id, version);
	}
	public PatientNoAllergyInfoVo(ims.core.vo.beans.PatientNoAllergyInfoVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.PatientNoAllergyInfoVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.patient = bean.getPatient() == null ? null : new ims.core.patient.vo.PatientRefVo(new Integer(bean.getPatient().getId()), bean.getPatient().getVersion());
	...
	{
		ims.core.vo.beans.PatientNoAllergyInfoVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.PatientNoAllergyInfoVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.PatientNoAllergyInfoVoBean();
	...
	*/
	public StringBuffer createInfoTooltip()
	{
		...
		sb.append("<font color=\"#FF0000\"><b>No Known Allergies</b></font>&nbsp;<br>");
		sb.append("<b>Source : </b>");
		sb.append(this.sourceofinformation != null ? this.sourceofinformation.toString() : "");
		sb.append("<br>");
	...
	public Object clone()
	{
		...
		PatientNoAllergyInfoVo clone = new PatientNoAllergyInfoVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(PatientNoAllergyInfoVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A PatientNoAllergyInfoVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((PatientNoAllergyInfoVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((PatientNoAllergyInfoVo)obj).getBoId());
	}
