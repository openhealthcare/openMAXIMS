 ...
 */
public class OrgShortVo extends ims.core.vo.OrgLiteVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public OrgShortVo(Integer id, int version)
	{
		super(id, version);
	}
	public OrgShortVo(ims.core.vo.beans.OrgShortVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.OrgShortVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.name = bean.getName();
	...
	{
		ims.core.vo.beans.OrgShortVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.OrgShortVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.OrgShortVoBean();
	...
	* getNationalLocCode
	*/
	public String getNationalLocCode()
	{
	...
	*/
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.name == null || this.name.length() == 0)
			...
			listOfErrors.add("The length of the field [name] in the value object [ims.core.vo.OrgShortVo] is too big. It should be less or equal to 120");
		if(this.address != null)
		{
		...
		if(this.comment != null)
			if(this.comment.length() > 255)
				listOfErrors.add("The length of the field [comment] in the value object [ims.core.vo.OrgShortVo] is too big. It should be less or equal to 255");
		if(this.codemappings != null)
		{
	...
	public Object clone()
	{
		...
		OrgShortVo clone = new OrgShortVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(OrgShortVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A OrgShortVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		OrgShortVo compareObj = (OrgShortVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
