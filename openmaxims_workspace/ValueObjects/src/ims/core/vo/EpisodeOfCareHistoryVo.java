 ...
 */
public class EpisodeOfCareHistoryVo extends ims.core.admin.vo.EpisodeOfCareHistoryRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public EpisodeOfCareHistoryVo()
	{
	}
	public EpisodeOfCareHistoryVo(Integer id, int version)
	{
		super(id, version);
	}
	public EpisodeOfCareHistoryVo(ims.core.vo.beans.EpisodeOfCareHistoryVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.EpisodeOfCareHistoryVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.relationship = bean.getRelationship() == null ? null : ims.core.vo.lookups.CareSpelltoEpisodeRelationship.buildLookup(bean.getRelationship());
	...
	{
		ims.core.vo.beans.EpisodeOfCareHistoryVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.EpisodeOfCareHistoryVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.EpisodeOfCareHistoryVoBean();
	...
	public Object clone()
	{
		...
		EpisodeOfCareHistoryVo clone = new EpisodeOfCareHistoryVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(EpisodeOfCareHistoryVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A EpisodeOfCareHistoryVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((EpisodeOfCareHistoryVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((EpisodeOfCareHistoryVo)obj).getBoId());
	}
