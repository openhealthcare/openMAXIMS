...
public class WorkAllocationListVo extends ims.careuk.vo.WorkAllocationRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public WorkAllocationListVo()
	{
	}
	public WorkAllocationListVo(Integer id, int version)
	{
		super(id, version);
	}
	public WorkAllocationListVo(ims.core.vo.beans.WorkAllocationListVoBean bean)
	{
		this.id = bean.getId();
	...
	{
		ims.core.vo.beans.WorkAllocationListVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.WorkAllocationListVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.WorkAllocationListVoBean();
	...
	public Object clone()
	{
		...
		WorkAllocationListVo clone = new WorkAllocationListVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(WorkAllocationListVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A WorkAllocationListVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((WorkAllocationListVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((WorkAllocationListVo)obj).getBoId());
	}
