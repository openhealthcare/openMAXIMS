 ...
 */
public class EpisodeofCareVo extends ims.core.vo.EpisodeofCareShortVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public EpisodeofCareVo()
	{
	}
	public EpisodeofCareVo(Integer id, int version)
	{
		super(id, version);
	}
	public EpisodeofCareVo(ims.core.vo.beans.EpisodeofCareVoBean bean)
	{
		this.id = bean.getId();
		...
		this.carecontexts = ims.core.vo.CareContextVoCollection.buildFromBeanCollection(bean.getCareContexts());
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.EpisodeofCareVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.carespell = bean.getCareSpell() == null ? null : new ims.core.admin.vo.CareSpellRefVo(new Integer(bean.getCareSpell().getId()), bean.getCareSpell().getVersion());
	...
	{
		ims.core.vo.beans.EpisodeofCareVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.EpisodeofCareVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.EpisodeofCareVoBean();
	...
	public ims.core.vo.CareContextVoCollection getCareContexts()
	{
		return this.carecontexts;
	}
	public void setCareContexts(ims.core.vo.CareContextVoCollection value)
	{
	...
	public Object clone()
	{
		...
		EpisodeofCareVo clone = new EpisodeofCareVo(this.id, this.version);
		...
		if(this.carecontexts == null)
			...
			clone.carecontexts = (ims.core.vo.CareContextVoCollection)this.carecontexts.clone();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(EpisodeofCareVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A EpisodeofCareVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		EpisodeofCareVo compareObj = (EpisodeofCareVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
	...
	protected ims.core.vo.CareContextVoCollection carecontexts;
