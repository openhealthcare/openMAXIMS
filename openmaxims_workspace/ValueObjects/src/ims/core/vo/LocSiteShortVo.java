 ...
 */
public class LocSiteShortVo extends ims.core.vo.LocShortMappingsVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public LocSiteShortVo()
	{
	}
	public LocSiteShortVo(Integer id, int version)
	{
		super(id, version);
	}
	public LocSiteShortVo(ims.core.vo.beans.LocSiteShortVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.LocSiteShortVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.name = bean.getName();
	...
	{
		ims.core.vo.beans.LocSiteShortVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.LocSiteShortVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.LocSiteShortVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.name == null || this.name.length() == 0)
			...
			listOfErrors.add("The length of the field [name] in the value object [ims.core.vo.LocSiteShortVo] is too big. It should be less or equal to 120");
	...
	public Object clone()
	{
		...
		LocSiteShortVo clone = new LocSiteShortVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(LocSiteShortVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A LocSiteShortVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		LocSiteShortVo compareObj = (LocSiteShortVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
	...
	public int countFieldsWithValue()
	{
		...
		if(this.allsecureaccommodation != null)
			count++;
		if(this.commchannels != null)
			count++;
		return count;
