 ...
 */
public class ServiceShortVo extends ims.core.vo.ServiceLiteVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public ServiceShortVo()
	{
	}
	public ServiceShortVo(Integer id, int version)
	{
		super(id, version);
	}
	public ServiceShortVo(ims.core.vo.beans.ServiceShortVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.ServiceShortVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.servicename = bean.getServiceName();
	...
	{
		ims.core.vo.beans.ServiceShortVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.ServiceShortVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.ServiceShortVoBean();
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("ISACTIVE"))
			return getIsActive();
		if(fieldName.equals("ALTERNATESERVICECODE"))
			return getAlternateServiceCode();
	...
	public boolean getAlternateServiceCodeIsNotNull()
	{
		return this.alternateservicecode != null;
	}
	public String getAlternateServiceCode()
	{
		return this.alternateservicecode;
	}
	public static int getAlternateServiceCodeMaxLength()
	{
		return 15;
	}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.servicename == null || this.servicename.length() == 0)
			...
			listOfErrors.add("The length of the field [servicename] in the value object [ims.core.vo.ServiceShortVo] is too big. It should be less or equal to 100");
		if(this.servicecategory == null)
			listOfErrors.add("Category is mandatory");
		if(this.servicedescription != null)
			if(this.servicedescription.length() > 255)
				listOfErrors.add("The length of the field [servicedescription] in the value object [ims.core.vo.ServiceShortVo] is too big. It should be less or equal to 255");
		if(this.alternateservicecode != null)
			if(this.alternateservicecode.length() > 15)
				listOfErrors.add("The length of the field [alternateservicecode] in the value object [ims.core.vo.ServiceShortVo] is too big. It should be less or equal to 15");
	...
	public Object clone()
	{
		...
		ServiceShortVo clone = new ServiceShortVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(ServiceShortVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A ServiceShortVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		ServiceShortVo compareObj = (ServiceShortVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
	...
	protected String alternateservicecode;
