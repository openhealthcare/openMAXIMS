 ...
 */
public class CSPrimaryDiagnosisVo extends ims.core.clinical.vo.CsPrimaryDiagnosisRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public CSPrimaryDiagnosisVo()
	{
	}
	public CSPrimaryDiagnosisVo(Integer id, int version)
	{
		super(id, version);
	}
	public CSPrimaryDiagnosisVo(ims.core.vo.beans.CSPrimaryDiagnosisVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.CSPrimaryDiagnosisVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.core.vo.beans.CSPrimaryDiagnosisVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.CSPrimaryDiagnosisVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.CSPrimaryDiagnosisVoBean();
	...
	public Object clone()
	{
		...
		CSPrimaryDiagnosisVo clone = new CSPrimaryDiagnosisVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(CSPrimaryDiagnosisVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A CSPrimaryDiagnosisVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((CSPrimaryDiagnosisVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((CSPrimaryDiagnosisVo)obj).getBoId());
	}
