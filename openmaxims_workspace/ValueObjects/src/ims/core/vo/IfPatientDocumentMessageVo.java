 ...
 */
public class IfPatientDocumentMessageVo extends ims.hl7adtout.vo.PatientDocumentMessageQueueRefVo implements ims.vo.ImsCloneable, Comparable, ims.vo.interfaces.IHL7OutboundMessageHandler
{
	private static final long serialVersionUID = 1L;

	public IfPatientDocumentMessageVo()
	{
	}
	public IfPatientDocumentMessageVo(Integer id, int version)
	{
		super(id, version);
	}
	public IfPatientDocumentMessageVo(ims.core.vo.beans.IfPatientDocumentMessageVoBean bean)
	{
		this.id = bean.getId();
		...
		this.patientdocument = bean.getPatientDocument() == null ? null : bean.getPatientDocument().buildVo();
		this.msgtype = bean.getMsgType() == null ? null : ims.core.vo.lookups.MsgEventType.buildLookup(bean.getMsgType());
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.IfPatientDocumentMessageVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.wasprocessed = bean.getWasProcessed();
		...
		this.patientdocument = bean.getPatientDocument() == null ? null : bean.getPatientDocument().buildVo(map);
		this.msgtype = bean.getMsgType() == null ? null : ims.core.vo.lookups.MsgEventType.buildLookup(bean.getMsgType());
	}
	...
	{
		ims.core.vo.beans.IfPatientDocumentMessageVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.IfPatientDocumentMessageVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.IfPatientDocumentMessageVoBean();
	...
	public ims.core.vo.IfPatientDocumentVo getPatientDocument()
	{
		return this.patientdocument;
	}
	public void setPatientDocument(ims.core.vo.IfPatientDocumentVo value)
	{
		this.isValidated = false;
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.acktext != null)
			if(this.acktext.length() > 1000)
				listOfErrors.add("The length of the field [acktext] in the value object [ims.core.vo.IfPatientDocumentMessageVo] is too big. It should be less or equal to 1000");
		if(this.failuremsg != null)
			if(this.failuremsg.length() > 1000)
				listOfErrors.add("The length of the field [failuremsg] in the value object [ims.core.vo.IfPatientDocumentMessageVo] is too big. It should be less or equal to 1000");
	...
	public Object clone()
	{
		...
		IfPatientDocumentMessageVo clone = new IfPatientDocumentMessageVo(this.id, this.version);
		...
		if(this.patientdocument == null)
			clone.patientdocument = null;
		else
			clone.patientdocument = (ims.core.vo.IfPatientDocumentVo)this.patientdocument.clone();
		if(this.msgtype == null)
			clone.msgtype = null;
		else
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(IfPatientDocumentMessageVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A IfPatientDocumentMessageVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((IfPatientDocumentMessageVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((IfPatientDocumentMessageVo)obj).getBoId());
	}
	...
	protected ims.core.vo.IfPatientDocumentVo patientdocument;
