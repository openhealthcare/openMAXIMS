 ...
 */
public class CareContextSmallVo extends ims.core.admin.vo.CareContextRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public CareContextSmallVo()
	{
	}
	public CareContextSmallVo(Integer id, int version)
	{
		super(id, version);
	}
	public CareContextSmallVo(ims.core.vo.beans.CareContextSmallVoBean bean)
	{
		this.id = bean.getId();
		...
		this.carecontexthistory = ims.core.vo.CareContextHistVoCollection.buildFromBeanCollection(bean.getCareContextHistory());
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.CareContextSmallVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.context = bean.getContext() == null ? null : ims.core.vo.lookups.ContextType.buildLookup(bean.getContext());
	...
	{
		ims.core.vo.beans.CareContextSmallVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.CareContextSmallVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.CareContextSmallVoBean();
	...
	public ims.core.vo.CareContextHistVoCollection getCareContextHistory()
	{
		return this.carecontexthistory;
	}
	public void setCareContextHistory(ims.core.vo.CareContextHistVoCollection value)
	{
		this.isValidated = false;
	...
	public Object clone()
	{
		...
		CareContextSmallVo clone = new CareContextSmallVo(this.id, this.version);
		...
		if(this.carecontexthistory == null)
			...
			clone.carecontexthistory = (ims.core.vo.CareContextHistVoCollection)this.carecontexthistory.clone();
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(CareContextSmallVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A CareContextSmallVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((CareContextSmallVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((CareContextSmallVo)obj).getBoId());
	}
	...
	protected ims.core.vo.CareContextHistVoCollection carecontexthistory;
