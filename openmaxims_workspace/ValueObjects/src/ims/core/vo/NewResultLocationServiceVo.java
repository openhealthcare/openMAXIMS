 ...
 */
public class NewResultLocationServiceVo extends ims.core.resource.place.vo.LocationServiceRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public NewResultLocationServiceVo()
	{
	}
	public NewResultLocationServiceVo(Integer id, int version)
	{
		super(id, version);
	}
	public NewResultLocationServiceVo(ims.core.vo.beans.NewResultLocationServiceVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.NewResultLocationServiceVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.core.vo.beans.NewResultLocationServiceVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.NewResultLocationServiceVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.NewResultLocationServiceVoBean();
	...
	public Object clone()
	{
		...
		NewResultLocationServiceVo clone = new NewResultLocationServiceVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(NewResultLocationServiceVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A NewResultLocationServiceVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((NewResultLocationServiceVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((NewResultLocationServiceVo)obj).getBoId());
	}
