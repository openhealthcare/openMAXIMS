 ...
 */
public class LocationFullVo extends ims.core.vo.LocMostVo implements ims.vo.ImsCloneable, Comparable, ims.framework.interfaces.ILocation
{
	private static final long serialVersionUID = 1L;

	public LocationFullVo()
	{
	}
	public LocationFullVo(Integer id, int version)
	{
		super(id, version);
	}
	public LocationFullVo(ims.core.vo.beans.LocationFullVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.LocationFullVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.name = bean.getName();
	...
	{
		ims.core.vo.beans.LocationFullVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.LocationFullVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.LocationFullVoBean();
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("SERVICES"))
			return getServices();
		if(fieldName.equals("ACTIVITYLIMITGROUP"))
			return getActivityLimitGroup();
	...
	public ims.core.vo.LocationServiceVoCollection getServices()
	{
		return this.services;
	}
	public void setServices(ims.core.vo.LocationServiceVoCollection value)
	{
		this.isValidated = false;
		this.services = value;
	}
	public boolean getActivityLimitGroupIsNotNull()
	{
		return this.activitylimitgroup != null;
	}
	public ims.core.vo.ActivityGroupLimitsVoCollection getActivityLimitGroup()
	{
		return this.activitylimitgroup;
	}
	public void setActivityLimitGroup(ims.core.vo.ActivityGroupLimitsVoCollection value)
	{
		this.isValidated = false;
	...
	*/
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.name == null || this.name.length() == 0)
			...
			listOfErrors.add("The length of the field [name] in the value object [ims.core.vo.LocationFullVo] is too big. It should be less or equal to 120");
	...
	public Object clone()
	{
		...
		LocationFullVo clone = new LocationFullVo(this.id, this.version);
	...
	protected ims.core.vo.LocationServiceVoCollection services;
	protected ims.core.vo.ActivityGroupLimitsVoCollection activitylimitgroup;
