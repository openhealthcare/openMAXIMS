 ...
 */
public class TrackingForADTWardAndSpecialtyDialogVo extends ims.emergency.vo.TrackingRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public TrackingForADTWardAndSpecialtyDialogVo(Integer id, int version)
	{
		super(id, version);
	}
	public TrackingForADTWardAndSpecialtyDialogVo(ims.core.vo.beans.TrackingForADTWardAndSpecialtyDialogVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.TrackingForADTWardAndSpecialtyDialogVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.core.vo.beans.TrackingForADTWardAndSpecialtyDialogVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.TrackingForADTWardAndSpecialtyDialogVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.TrackingForADTWardAndSpecialtyDialogVoBean();
	...
	public Object clone()
	{
		...
		TrackingForADTWardAndSpecialtyDialogVo clone = new TrackingForADTWardAndSpecialtyDialogVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(TrackingForADTWardAndSpecialtyDialogVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A TrackingForADTWardAndSpecialtyDialogVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((TrackingForADTWardAndSpecialtyDialogVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((TrackingForADTWardAndSpecialtyDialogVo)obj).getBoId());
	}
