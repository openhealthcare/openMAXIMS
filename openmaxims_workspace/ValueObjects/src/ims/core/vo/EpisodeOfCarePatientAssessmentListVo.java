 ...
 */
public class EpisodeOfCarePatientAssessmentListVo extends ims.core.admin.vo.EpisodeOfCareRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public EpisodeOfCarePatientAssessmentListVo()
	{
	}
	public EpisodeOfCarePatientAssessmentListVo(Integer id, int version)
	{
		super(id, version);
	}
	public EpisodeOfCarePatientAssessmentListVo(ims.core.vo.beans.EpisodeOfCarePatientAssessmentListVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.EpisodeOfCarePatientAssessmentListVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.specialty = bean.getSpecialty() == null ? null : ims.core.vo.lookups.Specialty.buildLookup(bean.getSpecialty());
	...
	{
		ims.core.vo.beans.EpisodeOfCarePatientAssessmentListVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.EpisodeOfCarePatientAssessmentListVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.EpisodeOfCarePatientAssessmentListVoBean();
	...
	public Object clone()
	{
		...
		EpisodeOfCarePatientAssessmentListVo clone = new EpisodeOfCarePatientAssessmentListVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(EpisodeOfCarePatientAssessmentListVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A EpisodeOfCarePatientAssessmentListVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((EpisodeOfCarePatientAssessmentListVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((EpisodeOfCarePatientAssessmentListVo)obj).getBoId());
	}
