 ...
 */
public class AdmissionDetailLiteVo extends ims.core.admin.pas.vo.AdmissionDetailRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public AdmissionDetailLiteVo()
	{
	}
	public AdmissionDetailLiteVo(Integer id, int version)
	{
		super(id, version);
	}
	public AdmissionDetailLiteVo(ims.core.vo.beans.AdmissionDetailLiteVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.AdmissionDetailLiteVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.admissiondatetime = bean.getAdmissionDateTime() == null ? null : bean.getAdmissionDateTime().buildDateTime();
	...
	{
		ims.core.vo.beans.AdmissionDetailLiteVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.AdmissionDetailLiteVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.AdmissionDetailLiteVoBean();
	...
	*/
	...
	public Object clone()
	{
		...
		AdmissionDetailLiteVo clone = new AdmissionDetailLiteVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(AdmissionDetailLiteVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A AdmissionDetailLiteVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((AdmissionDetailLiteVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((AdmissionDetailLiteVo)obj).getBoId());
	}
