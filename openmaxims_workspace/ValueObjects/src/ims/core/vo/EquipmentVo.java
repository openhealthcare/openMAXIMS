 ...
 */
public class EquipmentVo extends ims.core.resource.equipment.vo.EquipmentRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public EquipmentVo(Integer id, int version)
	{
		super(id, version);
	}
	public EquipmentVo(ims.core.vo.beans.EquipmentVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.type = bean.getType() == null ? null : ims.core.vo.lookups.EquipmentType.buildLookup(bean.getType());
		...
		this.inactive = bean.getInactive();
		this.inactivationreason = bean.getInactivationReason();
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.EquipmentVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.type = bean.getType() == null ? null : ims.core.vo.lookups.EquipmentType.buildLookup(bean.getType());
	...
	{
		ims.core.vo.beans.EquipmentVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.EquipmentVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.EquipmentVoBean();
	...
	public Object getFieldValueByFieldName(String fieldName)
	{
		...
		if(fieldName.equals("INACTIVE"))
			return getInactive();
		if(fieldName.equals("INACTIVATIONREASON"))
			return getInactivationReason();
	...
	public ims.core.vo.lookups.EquipmentType getType()
	{
		return this.type;
	}
	public void setType(ims.core.vo.lookups.EquipmentType value)
	{
	...
	public boolean getInactivationReasonIsNotNull()
	{
		return this.inactivationreason != null;
	}
	public String getInactivationReason()
	{
		return this.inactivationreason;
	}
	public static int getInactivationReasonMaxLength()
	{
		return 255;
	}
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.type == null)
			listOfErrors.add("Equipment Name is a mandatory field");
		...
		if(this.inactivationreason != null)
			if(this.inactivationreason.length() > 255)
				listOfErrors.add("The length of the field [inactivationreason] in the value object [ims.core.vo.EquipmentVo] is too big. It should be less or equal to 255");
	...
	public Object clone()
	{
		...
		EquipmentVo clone = new EquipmentVo(this.id, this.version);
		
		if(this.type == null)
			clone.type = null;
		else
			clone.type = (ims.core.vo.lookups.EquipmentType)this.type.clone();
		...
		clone.inactive = this.inactive;
		clone.inactivationreason = this.inactivationreason;
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(EquipmentVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A EquipmentVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		EquipmentVo compareObj = (EquipmentVo)obj;
		int retVal = 0;
		if (retVal == 0)
		{
	...
	protected ims.core.vo.lookups.EquipmentType type;
	...
	protected String inactivationreason;
