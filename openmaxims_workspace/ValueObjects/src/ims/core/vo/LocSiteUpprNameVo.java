 ...
 */
public class LocSiteUpprNameVo extends ims.core.resource.place.vo.LocSiteRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public LocSiteUpprNameVo()
	{
	}
	public LocSiteUpprNameVo(Integer id, int version)
	{
		super(id, version);
	}
	public LocSiteUpprNameVo(ims.core.vo.beans.LocSiteUpprNameVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.LocSiteUpprNameVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.name = bean.getName();
	...
	{
		ims.core.vo.beans.LocSiteUpprNameVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.LocSiteUpprNameVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.LocSiteUpprNameVoBean();
	...
	public ims.core.vo.OrgVo getParentOrganisation()
	{
		return this.parentorganisation;
	}
	public void setParentOrganisation(ims.core.vo.OrgVo value)
	{
		this.isValidated = false;
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.name == null || this.name.length() == 0)
			...
			listOfErrors.add("The length of the field [name] in the value object [ims.core.vo.LocSiteUpprNameVo] is too big. It should be less or equal to 120");
		if(this.address != null)
		{
		...
		if(this.uppername == null || this.uppername.length() == 0)
			...
			listOfErrors.add("The length of the field [uppername] in the value object [ims.core.vo.LocSiteUpprNameVo] is too big. It should be less or equal to 30");
	...
	public Object clone()
	{
		...
		LocSiteUpprNameVo clone = new LocSiteUpprNameVo(this.id, this.version);
		...
		if(this.parentorganisation == null)
			...
			clone.parentorganisation = (ims.core.vo.OrgVo)this.parentorganisation.clone();
		if(this.commchannels == null)
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(LocSiteUpprNameVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A LocSiteUpprNameVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((LocSiteUpprNameVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((LocSiteUpprNameVo)obj).getBoId());
	}
	...
	protected ims.core.vo.OrgVo parentorganisation;
