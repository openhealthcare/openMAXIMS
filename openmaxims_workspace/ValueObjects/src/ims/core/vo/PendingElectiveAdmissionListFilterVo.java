...
public class PendingElectiveAdmissionListFilterVo extends ims.core.vo.BaseListFilterVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public PendingElectiveAdmissionListFilterVo()
	{
	}
	public PendingElectiveAdmissionListFilterVo(ims.core.vo.beans.PendingElectiveAdmissionListFilterVoBean bean)
	{
		...
		this.tci = bean.getTCI() == null ? null : bean.getTCI().buildDate();
		this.specialty = bean.getSpecialty() == null ? null : ims.core.vo.lookups.Specialty.buildLookup(bean.getSpecialty());
		this.tcidateonly = bean.getTCIDateOnly();
		this.idtype = bean.getIDType() == null ? null : ims.core.vo.lookups.PatIdType.buildLookup(bean.getIDType());
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.PendingElectiveAdmissionListFilterVoBean bean)
	{
		this.surname = bean.getSurname();
		this.forename = bean.getForename();
		this.hospnum = bean.getHospNum();
	...
	{
		ims.core.vo.beans.PendingElectiveAdmissionListFilterVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.PendingElectiveAdmissionListFilterVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.PendingElectiveAdmissionListFilterVoBean();
	...
	public ims.framework.utils.Date getTCI()
	{
		return this.tci;
	}
	public void setTCI(ims.framework.utils.Date value)
	{
	...
	public boolean getTCIDateOnlyIsNotNull()
	{
		return this.tcidateonly != null;
	}
	...
	public boolean equals(Object obj)
	{
		if(obj == null)
			return false;
		if(!(obj instanceof PendingElectiveAdmissionListFilterVo))
			return false;
		PendingElectiveAdmissionListFilterVo compareObj = (PendingElectiveAdmissionListFilterVo)obj;
	...
	public Object clone()
	{
		...
		PendingElectiveAdmissionListFilterVo clone = new PendingElectiveAdmissionListFilterVo();
		...
		if(this.tci == null)
			...
			clone.tci = (ims.framework.utils.Date)this.tci.clone();
		if(this.specialty == null)
			clone.specialty = null;
		else
			clone.specialty = (ims.core.vo.lookups.Specialty)this.specialty.clone();
		clone.tcidateonly = this.tcidateonly;
		if(this.idtype == null)
			clone.idtype = null;
		else
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(PendingElectiveAdmissionListFilterVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A PendingElectiveAdmissionListFilterVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		PendingElectiveAdmissionListFilterVo compareObj = (PendingElectiveAdmissionListFilterVo)obj;
		int retVal = 0;
		if (retVal == 0)
	...
	protected ims.framework.utils.Date tci;
	protected ims.core.vo.lookups.Specialty specialty;
	protected Boolean tcidateonly;
