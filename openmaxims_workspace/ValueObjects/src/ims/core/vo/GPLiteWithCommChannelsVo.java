 ...
 */
public class GPLiteWithCommChannelsVo extends ims.core.vo.GpLiteVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public GPLiteWithCommChannelsVo()
	{
	}
	public GPLiteWithCommChannelsVo(Integer id, int version)
	{
		super(id, version);
	}
	public GPLiteWithCommChannelsVo(ims.core.vo.beans.GPLiteWithCommChannelsVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.GPLiteWithCommChannelsVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.core.vo.beans.GPLiteWithCommChannelsVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.GPLiteWithCommChannelsVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.GPLiteWithCommChannelsVoBean();
	...
	public Object clone()
	{
		...
		GPLiteWithCommChannelsVo clone = new GPLiteWithCommChannelsVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(GPLiteWithCommChannelsVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A GPLiteWithCommChannelsVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((GPLiteWithCommChannelsVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((GPLiteWithCommChannelsVo)obj).getBoId());
	}
