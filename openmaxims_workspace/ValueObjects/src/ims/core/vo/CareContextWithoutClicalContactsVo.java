 ...
 */
public class CareContextWithoutClicalContactsVo extends ims.core.admin.vo.CareContextRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public CareContextWithoutClicalContactsVo()
	{
	}
	public CareContextWithoutClicalContactsVo(Integer id, int version)
	{
		super(id, version);
	}
	public CareContextWithoutClicalContactsVo(ims.core.vo.beans.CareContextWithoutClicalContactsVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.CareContextWithoutClicalContactsVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.context = bean.getContext() == null ? null : ims.core.vo.lookups.ContextType.buildLookup(bean.getContext());
	...
	{
		ims.core.vo.beans.CareContextWithoutClicalContactsVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.CareContextWithoutClicalContactsVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.CareContextWithoutClicalContactsVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.bednumber != null)
			if(this.bednumber.length() > 10)
				listOfErrors.add("The length of the field [bednumber] in the value object [ims.core.vo.CareContextWithoutClicalContactsVo] is too big. It should be less or equal to 10");
		if(this.carecontexthistory != null)
		{
	...
	public Object clone()
	{
		...
		CareContextWithoutClicalContactsVo clone = new CareContextWithoutClicalContactsVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(CareContextWithoutClicalContactsVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A CareContextWithoutClicalContactsVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((CareContextWithoutClicalContactsVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((CareContextWithoutClicalContactsVo)obj).getBoId());
	}
