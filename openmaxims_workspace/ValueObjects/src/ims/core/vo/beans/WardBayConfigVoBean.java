...
public class WardBayConfigVoBean extends ims.vo.ValueObjectBean
{
	public WardBayConfigVoBean()
	{
	}
	public WardBayConfigVoBean(ims.core.vo.WardBayConfigVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.WardBayConfigVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.core.vo.WardBayConfigVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.WardBayConfigVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.WardBayConfigVo vo = null;
		if(map != null)
			vo = (ims.core.vo.WardBayConfigVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.WardBayConfigVo();
	...
	public ims.core.vo.beans.BayConfigVoBean[] getBays()
	{
		return this.bays;
	}
	public void setBays(ims.core.vo.beans.BayConfigVoBean[] value)
	{
		this.bays = value;
	}
	...
	private ims.core.vo.beans.BayConfigVoBean[] bays;
