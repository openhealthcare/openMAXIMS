...
public class ClinicVoBean extends ims.vo.ValueObjectBean
{
	public ClinicVoBean()
	{
	}
	public ClinicVoBean(ims.core.vo.ClinicVo vo)
	{
		this.id = vo.getBoId();
		...
		this.cliniclocation = vo.getClinicLocation() == null ? null : (ims.core.vo.beans.LocShortVoBean)vo.getClinicLocation().getBean();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.ClinicVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.clinicname = vo.getClinicName();
		...
		this.cliniclocation = vo.getClinicLocation() == null ? null : (ims.core.vo.beans.LocShortVoBean)vo.getClinicLocation().getBean(map);
	}

	public ims.core.vo.ClinicVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.ClinicVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.ClinicVo vo = null;
		if(map != null)
			vo = (ims.core.vo.ClinicVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.ClinicVo();
	...
	public ims.core.vo.beans.LocShortVoBean getClinicLocation()
	{
		return this.cliniclocation;
	}
	public void setClinicLocation(ims.core.vo.beans.LocShortVoBean value)
	{
	...
	private ims.core.vo.beans.LocShortVoBean cliniclocation;
}
