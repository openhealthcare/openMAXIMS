...
public class RecordingUserInformationForTriageVoBean extends ims.vo.ValueObjectBean
{
	public RecordingUserInformationForTriageVoBean()
	{
	}
	public RecordingUserInformationForTriageVoBean(ims.core.vo.RecordingUserInformationForTriageVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.RecordingUserInformationForTriageVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.recordinguser = vo.getRecordingUser() == null ? null : new ims.vo.RefVoBean(vo.getRecordingUser().getBoId(), vo.getRecordingUser().getBoVersion());
	...
	public ims.core.vo.RecordingUserInformationForTriageVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.RecordingUserInformationForTriageVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.RecordingUserInformationForTriageVo vo = null;
		if(map != null)
			vo = (ims.core.vo.RecordingUserInformationForTriageVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.RecordingUserInformationForTriageVo();
