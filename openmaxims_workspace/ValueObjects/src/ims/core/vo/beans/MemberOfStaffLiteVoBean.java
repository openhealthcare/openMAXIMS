...
public class MemberOfStaffLiteVoBean extends ims.vo.ValueObjectBean
{
	public MemberOfStaffLiteVoBean()
	{
	}
	public MemberOfStaffLiteVoBean(ims.core.vo.MemberOfStaffLiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.MemberOfStaffLiteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.core.vo.MemberOfStaffLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.MemberOfStaffLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.MemberOfStaffLiteVo vo = null;
		if(map != null)
			vo = (ims.core.vo.MemberOfStaffLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.MemberOfStaffLiteVo();
