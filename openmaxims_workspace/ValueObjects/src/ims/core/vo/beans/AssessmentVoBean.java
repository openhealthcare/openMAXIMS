...
public class AssessmentVoBean extends ims.vo.ValueObjectBean
{
	public AssessmentVoBean()
	{
	}
	public AssessmentVoBean(ims.core.vo.AssessmentVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.AssessmentVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.core.vo.AssessmentVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.AssessmentVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.AssessmentVo vo = null;
		if(map != null)
			vo = (ims.core.vo.AssessmentVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.AssessmentVo();
