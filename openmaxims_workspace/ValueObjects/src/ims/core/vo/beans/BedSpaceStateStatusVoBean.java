...
public class BedSpaceStateStatusVoBean extends ims.vo.ValueObjectBean
{
	public BedSpaceStateStatusVoBean()
	{
	}
	public BedSpaceStateStatusVoBean(ims.core.vo.BedSpaceStateStatusVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.BedSpaceStateStatusVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.bedstatus = vo.getBedStatus() == null ? null : (ims.vo.LookupInstanceBean)vo.getBedStatus().getBean();
	...
	public ims.core.vo.BedSpaceStateStatusVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.BedSpaceStateStatusVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.BedSpaceStateStatusVo vo = null;
		if(map != null)
			vo = (ims.core.vo.BedSpaceStateStatusVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.BedSpaceStateStatusVo();
