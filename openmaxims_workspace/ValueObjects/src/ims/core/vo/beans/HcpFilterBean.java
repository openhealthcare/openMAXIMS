...
public class HcpFilterBean extends ims.vo.ValueObjectBean
{
	public HcpFilterBean()
	{
	}
	public HcpFilterBean(ims.core.vo.HcpFilter vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.HcpFilter vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.hcptype = vo.getHcpType() == null ? null : (ims.vo.LookupInstanceBean)vo.getHcpType().getBean();
	...
	public ims.core.vo.HcpFilter buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.HcpFilter buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.HcpFilter vo = null;
		if(map != null)
			vo = (ims.core.vo.HcpFilter)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.HcpFilter();
