...
public class EpisodeOfCarePatientAssessmentListVoBean extends ims.vo.ValueObjectBean
{
	public EpisodeOfCarePatientAssessmentListVoBean()
	{
	}
	public EpisodeOfCarePatientAssessmentListVoBean(ims.core.vo.EpisodeOfCarePatientAssessmentListVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.EpisodeOfCarePatientAssessmentListVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.specialty = vo.getSpecialty() == null ? null : (ims.vo.LookupInstanceBean)vo.getSpecialty().getBean();
	...
	public ims.core.vo.EpisodeOfCarePatientAssessmentListVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.EpisodeOfCarePatientAssessmentListVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.EpisodeOfCarePatientAssessmentListVo vo = null;
		if(map != null)
			vo = (ims.core.vo.EpisodeOfCarePatientAssessmentListVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.EpisodeOfCarePatientAssessmentListVo();
