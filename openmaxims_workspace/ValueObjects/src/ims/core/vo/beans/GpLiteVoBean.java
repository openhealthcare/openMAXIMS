...
public class GpLiteVoBean extends ims.vo.ValueObjectBean
{
	public GpLiteVoBean()
	{
	}
	public GpLiteVoBean(ims.core.vo.GpLiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.GpLiteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.core.vo.GpLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.GpLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.GpLiteVo vo = null;
		if(map != null)
			vo = (ims.core.vo.GpLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.GpLiteVo();
