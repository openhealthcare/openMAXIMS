...
public class NeedsAssessmentComponentEditVoBean extends ims.vo.ValueObjectBean
{
	public NeedsAssessmentComponentEditVoBean()
	{
	}
	public NeedsAssessmentComponentEditVoBean(ims.core.vo.NeedsAssessmentComponentEditVo vo)
	{
		this.id = vo.getBoId();
		...
		this.patientuserdefinedobject = vo.getPatientUserDefinedObject() == null ? null : new ims.vo.RefVoBean(vo.getPatientUserDefinedObject().getBoId(), vo.getPatientUserDefinedObject().getBoVersion());
		this.componentscore = vo.getComponentScore() == null ? null : vo.getComponentScore().getBeanCollection();
		this.carecontext = vo.getCareContext() == null ? null : new ims.vo.RefVoBean(vo.getCareContext().getBoId(), vo.getCareContext().getBoVersion());
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.NeedsAssessmentComponentEditVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.goalplanmeetingdate = vo.getGoalPlanMeetingDate() == null ? null : (ims.framework.utils.beans.DateBean)vo.getGoalPlanMeetingDate().getBean();
	...
	public ims.core.vo.NeedsAssessmentComponentEditVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.NeedsAssessmentComponentEditVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.NeedsAssessmentComponentEditVo vo = null;
		if(map != null)
			vo = (ims.core.vo.NeedsAssessmentComponentEditVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.NeedsAssessmentComponentEditVo();
	...
	public ims.vo.RefVoBean getPatientUserDefinedObject()
	{
		return this.patientuserdefinedobject;
	}
	public void setPatientUserDefinedObject(ims.vo.RefVoBean value)
	{
	...
	private ims.vo.RefVoBean patientuserdefinedobject;
