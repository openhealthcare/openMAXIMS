...
public class EpisodeOfCareSmallVoBean extends ims.vo.ValueObjectBean
{
	public EpisodeOfCareSmallVoBean()
	{
	}
	public EpisodeOfCareSmallVoBean(ims.core.vo.EpisodeOfCareSmallVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.EpisodeOfCareSmallVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.specialty = vo.getSpecialty() == null ? null : (ims.vo.LookupInstanceBean)vo.getSpecialty().getBean();
	...
	public ims.core.vo.EpisodeOfCareSmallVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.EpisodeOfCareSmallVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.EpisodeOfCareSmallVo vo = null;
		if(map != null)
			vo = (ims.core.vo.EpisodeOfCareSmallVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.EpisodeOfCareSmallVo();
	...
	public ims.core.vo.beans.EpisodeOfCareHistVoBean[] getEpisodeOfCareHistory()
	{
		return this.episodeofcarehistory;
	}
	public void setEpisodeOfCareHistory(ims.core.vo.beans.EpisodeOfCareHistVoBean[] value)
	{
	...
	private ims.core.vo.beans.EpisodeOfCareHistVoBean[] episodeofcarehistory;
}
