...
public class NeedsAssessmentEditVoBean extends ims.vo.ValueObjectBean
{
	public NeedsAssessmentEditVoBean()
	{
	}
	public NeedsAssessmentEditVoBean(ims.core.vo.NeedsAssessmentEditVo vo)
	{
		this.id = vo.getBoId();
		...
		this.patientuserdefinedobject = vo.getPatientUserDefinedObject() == null ? null : (ims.assessment.vo.beans.PatientUserDefinedObjectListVoBean)vo.getPatientUserDefinedObject().getBean();
		this.carecontext = vo.getCareContext() == null ? null : new ims.vo.RefVoBean(vo.getCareContext().getBoId(), vo.getCareContext().getBoVersion());
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.NeedsAssessmentEditVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.goalplanmeetingdate = vo.getGoalPlanMeetingDate() == null ? null : (ims.framework.utils.beans.DateBean)vo.getGoalPlanMeetingDate().getBean();
		...
		this.mobilisationdate = vo.getMobilisationDate() == null ? null : (ims.framework.utils.beans.DateBean)vo.getMobilisationDate().getBean();
		this.componentscore = vo.getComponentScore() == null ? null : vo.getComponentScore().getBeanCollection();
		this.patientuserdefinedobject = vo.getPatientUserDefinedObject() == null ? null : (ims.assessment.vo.beans.PatientUserDefinedObjectListVoBean)vo.getPatientUserDefinedObject().getBean(map);
		this.carecontext = vo.getCareContext() == null ? null : new ims.vo.RefVoBean(vo.getCareContext().getBoId(), vo.getCareContext().getBoVersion());
	}

	public ims.core.vo.NeedsAssessmentEditVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.NeedsAssessmentEditVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.NeedsAssessmentEditVo vo = null;
		if(map != null)
			vo = (ims.core.vo.NeedsAssessmentEditVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.NeedsAssessmentEditVo();
	...
	public ims.assessment.vo.beans.PatientUserDefinedObjectListVoBean getPatientUserDefinedObject()
	{
		return this.patientuserdefinedobject;
	}
	public void setPatientUserDefinedObject(ims.assessment.vo.beans.PatientUserDefinedObjectListVoBean value)
	{
	...
	private ims.assessment.vo.beans.PatientUserDefinedObjectListVoBean patientuserdefinedobject;
