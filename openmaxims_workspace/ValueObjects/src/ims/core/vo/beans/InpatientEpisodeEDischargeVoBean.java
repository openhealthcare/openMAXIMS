...
public class InpatientEpisodeEDischargeVoBean extends ims.vo.ValueObjectBean
{
	public InpatientEpisodeEDischargeVoBean()
	{
	}
	public InpatientEpisodeEDischargeVoBean(ims.core.vo.InpatientEpisodeEDischargeVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.InpatientEpisodeEDischargeVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.admissiondatetime = vo.getAdmissionDateTime() == null ? null : (ims.framework.utils.beans.DateTimeBean)vo.getAdmissionDateTime().getBean();
	...
	public ims.core.vo.InpatientEpisodeEDischargeVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.InpatientEpisodeEDischargeVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.InpatientEpisodeEDischargeVo vo = null;
		if(map != null)
			vo = (ims.core.vo.InpatientEpisodeEDischargeVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.InpatientEpisodeEDischargeVo();
