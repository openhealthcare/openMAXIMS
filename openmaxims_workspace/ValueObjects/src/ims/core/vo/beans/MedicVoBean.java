...
public class MedicVoBean extends ims.vo.ValueObjectBean
{
	public MedicVoBean()
	{
	}
	public MedicVoBean(ims.core.vo.MedicVo vo)
	{
		this.id = vo.getBoId();
		...
		this.medictype = vo.getMedicType() == null ? null : (ims.vo.LookupInstanceBean)vo.getMedicType().getBean();
		this.grade = vo.getGrade() == null ? null : (ims.vo.LookupInstanceBean)vo.getGrade().getBean();
		this.specialty = vo.getSpecialty() == null ? null : (ims.vo.LookupInstanceBean)vo.getSpecialty().getBean();
		this.secondspecialty = vo.getSecondSpecialty() == null ? null : (ims.vo.LookupInstanceBean)vo.getSecondSpecialty().getBean();
		this.thirdspecialty = vo.getThirdSpecialty() == null ? null : (ims.vo.LookupInstanceBean)vo.getThirdSpecialty().getBean();
		this.inpatienthandling = vo.getInpatientHandling();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.MedicVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.hcptype = vo.getHcpType() == null ? null : (ims.vo.LookupInstanceBean)vo.getHcpType().getBean();
	...
	public ims.core.vo.MedicVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.MedicVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.MedicVo vo = null;
		if(map != null)
			vo = (ims.core.vo.MedicVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.MedicVo();
	...
	public ims.vo.LookupInstanceBean getMedicType()
	{
		return this.medictype;
	}
	public void setMedicType(ims.vo.LookupInstanceBean value)
	{
		this.medictype = value;
	}
	public ims.vo.LookupInstanceBean getGrade()
	{
		return this.grade;
	}
	public void setGrade(ims.vo.LookupInstanceBean value)
	{
		this.grade = value;
	}
	...
	public ims.vo.LookupInstanceBean getSecondSpecialty()
	{
		return this.secondspecialty;
	}
	public void setSecondSpecialty(ims.vo.LookupInstanceBean value)
	{
		this.secondspecialty = value;
	}
	public ims.vo.LookupInstanceBean getThirdSpecialty()
	{
		return this.thirdspecialty;
	}
	public void setThirdSpecialty(ims.vo.LookupInstanceBean value)
	{
	...
	private ims.vo.LookupInstanceBean medictype;
	private ims.vo.LookupInstanceBean grade;
	private ims.vo.LookupInstanceBean specialty;
	private ims.vo.LookupInstanceBean secondspecialty;
	private ims.vo.LookupInstanceBean thirdspecialty;
