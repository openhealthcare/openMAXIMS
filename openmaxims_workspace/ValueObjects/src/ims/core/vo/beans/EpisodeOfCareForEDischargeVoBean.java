...
public class EpisodeOfCareForEDischargeVoBean extends ims.vo.ValueObjectBean
{
	public EpisodeOfCareForEDischargeVoBean()
	{
	}
	public EpisodeOfCareForEDischargeVoBean(ims.core.vo.EpisodeOfCareForEDischargeVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.EpisodeOfCareForEDischargeVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.specialty = vo.getSpecialty() == null ? null : (ims.vo.LookupInstanceBean)vo.getSpecialty().getBean();
	...
	public ims.core.vo.EpisodeOfCareForEDischargeVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.EpisodeOfCareForEDischargeVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.EpisodeOfCareForEDischargeVo vo = null;
		if(map != null)
			vo = (ims.core.vo.EpisodeOfCareForEDischargeVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.EpisodeOfCareForEDischargeVo();
