...
public class LocSiteVoBean extends ims.vo.ValueObjectBean
{
	public LocSiteVoBean()
	{
	}
	public LocSiteVoBean(ims.core.vo.LocSiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public ims.core.vo.LocSiteVo buildVo()
	{
	...
	public ims.core.vo.LocSiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		...
		if(map != null)
			vo = (ims.core.vo.LocSiteVo)map.getValueObject(this);
		if(vo == null)
		{
