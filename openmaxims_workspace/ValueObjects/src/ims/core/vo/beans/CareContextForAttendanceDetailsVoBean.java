...
public class CareContextForAttendanceDetailsVoBean extends ims.vo.ValueObjectBean
{
	public CareContextForAttendanceDetailsVoBean()
	{
	}
	public CareContextForAttendanceDetailsVoBean(ims.core.vo.CareContextForAttendanceDetailsVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.CareContextForAttendanceDetailsVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.context = vo.getContext() == null ? null : (ims.vo.LookupInstanceBean)vo.getContext().getBean();
	...
	public ims.core.vo.CareContextForAttendanceDetailsVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.CareContextForAttendanceDetailsVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.CareContextForAttendanceDetailsVo vo = null;
		if(map != null)
			vo = (ims.core.vo.CareContextForAttendanceDetailsVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.CareContextForAttendanceDetailsVo();
