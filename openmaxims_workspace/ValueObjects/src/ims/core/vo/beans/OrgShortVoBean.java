...
public class OrgShortVoBean extends ims.vo.ValueObjectBean
{
	public OrgShortVoBean()
	{
	}
	public OrgShortVoBean(ims.core.vo.OrgShortVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.OrgShortVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.name = vo.getName();
	...
	public ims.core.vo.OrgShortVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.OrgShortVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.OrgShortVo vo = null;
		if(map != null)
			vo = (ims.core.vo.OrgShortVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.OrgShortVo();
