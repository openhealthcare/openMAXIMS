...
public class NurseLiteVoBean extends ims.vo.ValueObjectBean
{
	public NurseLiteVoBean()
	{
	}
	public NurseLiteVoBean(ims.core.vo.NurseLiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.NurseLiteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.core.vo.NurseLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.NurseLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.NurseLiteVo vo = null;
		if(map != null)
			vo = (ims.core.vo.NurseLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.NurseLiteVo();
