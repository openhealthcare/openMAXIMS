...
public class AdmissionDetailLiteVoBean extends ims.vo.ValueObjectBean
{
	public AdmissionDetailLiteVoBean()
	{
	}
	public AdmissionDetailLiteVoBean(ims.core.vo.AdmissionDetailLiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.AdmissionDetailLiteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.admissiondatetime = vo.getAdmissionDateTime() == null ? null : (ims.framework.utils.beans.DateTimeBean)vo.getAdmissionDateTime().getBean();
	...
	public ims.core.vo.AdmissionDetailLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.AdmissionDetailLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.AdmissionDetailLiteVo vo = null;
		if(map != null)
			vo = (ims.core.vo.AdmissionDetailLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.AdmissionDetailLiteVo();
