...
public class MemberOfStaffWithAppUserLiteVoBean extends ims.vo.ValueObjectBean
{
	public MemberOfStaffWithAppUserLiteVoBean()
	{
	}
	public MemberOfStaffWithAppUserLiteVoBean(ims.core.vo.MemberOfStaffWithAppUserLiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.MemberOfStaffWithAppUserLiteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.core.vo.MemberOfStaffWithAppUserLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.MemberOfStaffWithAppUserLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.MemberOfStaffWithAppUserLiteVo vo = null;
		if(map != null)
			vo = (ims.core.vo.MemberOfStaffWithAppUserLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.MemberOfStaffWithAppUserLiteVo();
