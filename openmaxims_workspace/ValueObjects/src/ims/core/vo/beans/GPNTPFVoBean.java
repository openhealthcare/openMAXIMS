...
public class GPNTPFVoBean extends ims.vo.ValueObjectBean
{
	public GPNTPFVoBean()
	{
	}
	public GPNTPFVoBean(ims.core.vo.GPNTPFVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.GPNTPFVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.core.vo.GPNTPFVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.GPNTPFVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.GPNTPFVo vo = null;
		if(map != null)
			vo = (ims.core.vo.GPNTPFVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.GPNTPFVo();
	...
	public ims.core.vo.beans.GPToPracticeNTPFVoBean[] getPractices()
	{
		return this.practices;
	}
	public void setPractices(ims.core.vo.beans.GPToPracticeNTPFVoBean[] value)
	{
	...
	private ims.core.vo.beans.GPToPracticeNTPFVoBean[] practices;
