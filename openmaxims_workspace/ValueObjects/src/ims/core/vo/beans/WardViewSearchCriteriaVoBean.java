...
public class WardViewSearchCriteriaVoBean extends ims.vo.ValueObjectBean
{
	public WardViewSearchCriteriaVoBean()
	{
	}
	public WardViewSearchCriteriaVoBean(ims.core.vo.WardViewSearchCriteriaVo vo)
	{
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.WardViewSearchCriteriaVo vo)
	{
		// Interface field type not supported.
	...
	public ims.core.vo.WardViewSearchCriteriaVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.WardViewSearchCriteriaVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.WardViewSearchCriteriaVo vo = null;
		if(map != null)
			vo = (ims.core.vo.WardViewSearchCriteriaVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.WardViewSearchCriteriaVo();
