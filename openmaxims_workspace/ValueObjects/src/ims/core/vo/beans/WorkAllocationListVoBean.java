...
public class WorkAllocationListVoBean extends ims.vo.ValueObjectBean
{
	public WorkAllocationListVoBean()
	{
	}
	...
	public ims.core.vo.WorkAllocationListVo buildVo()
	{
	...
	public ims.core.vo.WorkAllocationListVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		...
		if(map != null)
			vo = (ims.core.vo.WorkAllocationListVo)map.getValueObject(this);
		if(vo == null)
		{
