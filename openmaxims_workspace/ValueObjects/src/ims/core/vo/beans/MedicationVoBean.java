...
public class MedicationVoBean extends ims.vo.ValueObjectBean
{
	public MedicationVoBean()
	{
	}
	public MedicationVoBean(ims.core.vo.MedicationVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.MedicationVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.medicationname = vo.getMedicationName();
	...
	public ims.core.vo.MedicationVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.MedicationVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.MedicationVo vo = null;
		if(map != null)
			vo = (ims.core.vo.MedicationVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.MedicationVo();
