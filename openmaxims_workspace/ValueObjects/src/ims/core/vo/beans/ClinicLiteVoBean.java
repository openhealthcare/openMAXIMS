...
public class ClinicLiteVoBean extends ims.vo.ValueObjectBean
{
	public ClinicLiteVoBean()
	{
	}
	public ClinicLiteVoBean(ims.core.vo.ClinicLiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.ClinicLiteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.clinicname = vo.getClinicName();
	...
	public ims.core.vo.ClinicLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.ClinicLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.ClinicLiteVo vo = null;
		if(map != null)
			vo = (ims.core.vo.ClinicLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.ClinicLiteVo();
