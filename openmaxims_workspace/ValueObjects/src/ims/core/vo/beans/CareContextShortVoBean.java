...
public class CareContextShortVoBean extends ims.vo.ValueObjectBean
{
	public CareContextShortVoBean()
	{
	}
	public CareContextShortVoBean(ims.core.vo.CareContextShortVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.CareContextShortVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.core.vo.CareContextShortVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.CareContextShortVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.CareContextShortVo vo = null;
		if(map != null)
			vo = (ims.core.vo.CareContextShortVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.CareContextShortVo();
