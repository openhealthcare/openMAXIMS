...
public class AuthoringInfoForTriageVoBean extends ims.vo.ValueObjectBean
{
	public AuthoringInfoForTriageVoBean()
	{
	}
	public AuthoringInfoForTriageVoBean(ims.core.vo.AuthoringInfoForTriageVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.AuthoringInfoForTriageVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.authoringhcp = vo.getAuthoringHcp() == null ? null : new ims.vo.RefVoBean(vo.getAuthoringHcp().getBoId(), vo.getAuthoringHcp().getBoVersion());
	...
	public ims.core.vo.AuthoringInfoForTriageVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.AuthoringInfoForTriageVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.AuthoringInfoForTriageVo vo = null;
		if(map != null)
			vo = (ims.core.vo.AuthoringInfoForTriageVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.AuthoringInfoForTriageVo();
