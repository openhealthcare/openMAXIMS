...
public class TherapistVoBean extends ims.vo.ValueObjectBean
{
	public TherapistVoBean()
	{
	}
	public TherapistVoBean(ims.core.vo.TherapistVo vo)
	{
		this.id = vo.getBoId();
		...
		this.therapisttype = vo.getTherapistType() == null ? null : (ims.vo.LookupInstanceBean)vo.getTherapistType().getBean();
		this.specialty = vo.getSpecialty() == null ? null : (ims.vo.LookupInstanceBean)vo.getSpecialty().getBean();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.TherapistVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.hcptype = vo.getHcpType() == null ? null : (ims.vo.LookupInstanceBean)vo.getHcpType().getBean();
	...
	public ims.core.vo.TherapistVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.TherapistVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.TherapistVo vo = null;
		if(map != null)
			vo = (ims.core.vo.TherapistVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.TherapistVo();
	...
	public ims.vo.LookupInstanceBean getTherapistType()
	{
		return this.therapisttype;
	}
	public void setTherapistType(ims.vo.LookupInstanceBean value)
	{
	...
	private ims.vo.LookupInstanceBean therapisttype;
