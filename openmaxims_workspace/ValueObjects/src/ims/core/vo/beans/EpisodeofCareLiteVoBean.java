...
public class EpisodeofCareLiteVoBean extends ims.vo.ValueObjectBean
{
	...
	public EpisodeofCareLiteVoBean(ims.core.vo.EpisodeofCareLiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.EpisodeofCareLiteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.carespell = vo.getCareSpell() == null ? null : new ims.vo.RefVoBean(vo.getCareSpell().getBoId(), vo.getCareSpell().getBoVersion());
	...
	public ims.core.vo.EpisodeofCareLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.EpisodeofCareLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.EpisodeofCareLiteVo vo = null;
		if(map != null)
			vo = (ims.core.vo.EpisodeofCareLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.EpisodeofCareLiteVo();
