...
public class PatientNoAllergyInfoVoBean extends ims.vo.ValueObjectBean
{
	public PatientNoAllergyInfoVoBean()
	{
	}
	public PatientNoAllergyInfoVoBean(ims.core.vo.PatientNoAllergyInfoVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.PatientNoAllergyInfoVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.patient = vo.getPatient() == null ? null : new ims.vo.RefVoBean(vo.getPatient().getBoId(), vo.getPatient().getBoVersion());
	...
	public ims.core.vo.PatientNoAllergyInfoVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.PatientNoAllergyInfoVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.PatientNoAllergyInfoVo vo = null;
		if(map != null)
			vo = (ims.core.vo.PatientNoAllergyInfoVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.PatientNoAllergyInfoVo();
