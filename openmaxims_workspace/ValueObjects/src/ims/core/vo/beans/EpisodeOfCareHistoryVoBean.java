...
public class EpisodeOfCareHistoryVoBean extends ims.vo.ValueObjectBean
{
	public EpisodeOfCareHistoryVoBean()
	{
	}
	public EpisodeOfCareHistoryVoBean(ims.core.vo.EpisodeOfCareHistoryVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.EpisodeOfCareHistoryVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.relationship = vo.getRelationship() == null ? null : (ims.vo.LookupInstanceBean)vo.getRelationship().getBean();
	...
	public ims.core.vo.EpisodeOfCareHistoryVo buildVo()
	{
	...
	public ims.core.vo.EpisodeOfCareHistoryVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		...
		if(map != null)
			vo = (ims.core.vo.EpisodeOfCareHistoryVo)map.getValueObject(this);
		if(vo == null)
		{
