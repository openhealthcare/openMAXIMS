...
public class VaccineVoBean extends ims.vo.ValueObjectBean
{
	public VaccineVoBean()
	{
	}
	public VaccineVoBean(ims.core.vo.VaccineVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.VaccineVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.vaccinename = vo.getVaccineName();
	...
	public ims.core.vo.VaccineVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.VaccineVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.VaccineVo vo = null;
		if(map != null)
			vo = (ims.core.vo.VaccineVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.VaccineVo();
