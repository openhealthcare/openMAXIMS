...
public class PendingElectiveAdmissionHl7VoBean extends ims.vo.ValueObjectBean
{
	public PendingElectiveAdmissionHl7VoBean()
	{
	}
	public PendingElectiveAdmissionHl7VoBean(ims.core.vo.PendingElectiveAdmissionHl7Vo vo)
	{
		this.id = vo.getBoId();
		...
		this.referringconsultant = vo.getReferringConsultant() == null ? null : new ims.vo.RefVoBean(vo.getReferringConsultant().getBoId(), vo.getReferringConsultant().getBoVersion());
		this.patientstatus = vo.getPatientStatus() == null ? null : (ims.vo.LookupInstanceBean)vo.getPatientStatus().getBean();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.PendingElectiveAdmissionHl7Vo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.core.vo.PendingElectiveAdmissionHl7Vo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		...
		if(map != null)
			vo = (ims.core.vo.PendingElectiveAdmissionHl7Vo)map.getValueObject(this);
		if(vo == null)
		{
	...
	public ims.vo.RefVoBean getReferringConsultant()
	{
		return this.referringconsultant;
	}
	public void setReferringConsultant(ims.vo.RefVoBean value)
	{
	...
	private ims.vo.RefVoBean referringconsultant;
