...
public class PatientDocumentMessageQueueVoBean extends ims.vo.ValueObjectBean
{
	public PatientDocumentMessageQueueVoBean()
	{
	}
	public PatientDocumentMessageQueueVoBean(ims.core.vo.PatientDocumentMessageQueueVo vo)
	{
		this.id = vo.getBoId();
		...
		this.patientdocument = vo.getPatientDocument() == null ? null : new ims.vo.RefVoBean(vo.getPatientDocument().getBoId(), vo.getPatientDocument().getBoVersion());
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.PatientDocumentMessageQueueVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.wasprocessed = vo.getWasProcessed();
	...
	public ims.core.vo.PatientDocumentMessageQueueVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.PatientDocumentMessageQueueVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.PatientDocumentMessageQueueVo vo = null;
		if(map != null)
			vo = (ims.core.vo.PatientDocumentMessageQueueVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.PatientDocumentMessageQueueVo();
	...
	public ims.vo.RefVoBean getPatientDocument()
	{
		return this.patientdocument;
	}
	public void setPatientDocument(ims.vo.RefVoBean value)
	{
	...
	private ims.vo.RefVoBean patientdocument;
}
