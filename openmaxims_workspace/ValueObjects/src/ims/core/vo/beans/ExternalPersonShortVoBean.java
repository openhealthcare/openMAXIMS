...
public class ExternalPersonShortVoBean extends ims.vo.ValueObjectBean
{
	public ExternalPersonShortVoBean()
	{
	}
	public ExternalPersonShortVoBean(ims.core.vo.ExternalPersonShortVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.ExternalPersonShortVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.core.vo.ExternalPersonShortVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.ExternalPersonShortVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.ExternalPersonShortVo vo = null;
		if(map != null)
			vo = (ims.core.vo.ExternalPersonShortVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.ExternalPersonShortVo();
