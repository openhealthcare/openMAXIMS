...
public class AllergenDetailsBean extends ims.vo.ValueObjectBean
{
	public AllergenDetailsBean()
	{
	}
	public AllergenDetailsBean(ims.core.vo.AllergenDetails vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.AllergenDetails vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.allergenname = vo.getAllergenName();
	...
	public ims.core.vo.AllergenDetails buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.AllergenDetails buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.AllergenDetails vo = null;
		if(map != null)
			vo = (ims.core.vo.AllergenDetails)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.AllergenDetails();
