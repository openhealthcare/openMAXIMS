...
public class LocShortVoBean extends ims.vo.ValueObjectBean
{
	public LocShortVoBean()
	{
	}
	public LocShortVoBean(ims.core.vo.LocShortVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.LocShortVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.name = vo.getName();
	...
	public ims.core.vo.LocShortVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.LocShortVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.LocShortVo vo = null;
		if(map != null)
			vo = (ims.core.vo.LocShortVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.LocShortVo();
