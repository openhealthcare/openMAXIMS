...
public class LocationServiceLiteVoBean extends ims.vo.ValueObjectBean
{
	public LocationServiceLiteVoBean()
	{
	}
	public LocationServiceLiteVoBean(ims.core.vo.LocationServiceLiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.LocationServiceLiteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.core.vo.LocationServiceLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.LocationServiceLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.LocationServiceLiteVo vo = null;
		if(map != null)
			vo = (ims.core.vo.LocationServiceLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.LocationServiceLiteVo();
