...
public class LocMostVoBean extends ims.vo.ValueObjectBean
{
	public LocMostVoBean()
	{
	}
	public LocMostVoBean(ims.core.vo.LocMostVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.LocMostVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.name = vo.getName();
	...
	public ims.core.vo.LocMostVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.LocMostVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.LocMostVo vo = null;
		if(map != null)
			vo = (ims.core.vo.LocMostVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.LocMostVo();
