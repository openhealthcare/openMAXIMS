...
public class MemberOfStaffShortVoBean extends ims.vo.ValueObjectBean
{
	public MemberOfStaffShortVoBean()
	{
	}
	public MemberOfStaffShortVoBean(ims.core.vo.MemberOfStaffShortVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.MemberOfStaffShortVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.core.vo.MemberOfStaffShortVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.MemberOfStaffShortVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.MemberOfStaffShortVo vo = null;
		if(map != null)
			vo = (ims.core.vo.MemberOfStaffShortVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.MemberOfStaffShortVo();
