...
public class DiagnosisVoBean extends ims.vo.ValueObjectBean
{
	public DiagnosisVoBean()
	{
	}
	public DiagnosisVoBean(ims.core.vo.DiagnosisVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.DiagnosisVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.diagnosisname = vo.getDiagnosisName();
	...
	public ims.core.vo.DiagnosisVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.DiagnosisVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.DiagnosisVo vo = null;
		if(map != null)
			vo = (ims.core.vo.DiagnosisVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.DiagnosisVo();
