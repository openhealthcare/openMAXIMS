...
public class ServiceLiteVoBean extends ims.vo.ValueObjectBean
{
	public ServiceLiteVoBean()
	{
	}
	public ServiceLiteVoBean(ims.core.vo.ServiceLiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.ServiceLiteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.servicename = vo.getServiceName();
	...
	public ims.core.vo.ServiceLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.ServiceLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.ServiceLiteVo vo = null;
		if(map != null)
			vo = (ims.core.vo.ServiceLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.ServiceLiteVo();
