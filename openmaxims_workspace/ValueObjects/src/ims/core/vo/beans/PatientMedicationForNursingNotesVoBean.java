...
public class PatientMedicationForNursingNotesVoBean extends ims.vo.ValueObjectBean
{
	public PatientMedicationForNursingNotesVoBean()
	{
	}
	public PatientMedicationForNursingNotesVoBean(ims.core.vo.PatientMedicationForNursingNotesVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.PatientMedicationForNursingNotesVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.medication = vo.getMedication() == null ? null : new ims.vo.RefVoBean(vo.getMedication().getBoId(), vo.getMedication().getBoVersion());
	...
	public ims.core.vo.PatientMedicationForNursingNotesVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.PatientMedicationForNursingNotesVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.PatientMedicationForNursingNotesVo vo = null;
		if(map != null)
			vo = (ims.core.vo.PatientMedicationForNursingNotesVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.PatientMedicationForNursingNotesVo();
