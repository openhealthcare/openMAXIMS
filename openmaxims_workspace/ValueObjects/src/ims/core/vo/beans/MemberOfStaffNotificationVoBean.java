...
public class MemberOfStaffNotificationVoBean extends ims.vo.ValueObjectBean
{
	public MemberOfStaffNotificationVoBean()
	{
	}
	public MemberOfStaffNotificationVoBean(ims.core.vo.MemberOfStaffNotificationVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.MemberOfStaffNotificationVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.core.vo.MemberOfStaffNotificationVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.MemberOfStaffNotificationVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.MemberOfStaffNotificationVo vo = null;
		if(map != null)
			vo = (ims.core.vo.MemberOfStaffNotificationVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.MemberOfStaffNotificationVo();
