...
public class PatientAllergyEDischargeVoBean extends ims.vo.ValueObjectBean
{
	public PatientAllergyEDischargeVoBean()
	{
	}
	public PatientAllergyEDischargeVoBean(ims.core.vo.PatientAllergyEDischargeVo vo)
	{
		this.id = vo.getBoId();
		...
		this.allergenreactions = vo.getAllergenReactions() == null ? null : vo.getAllergenReactions().getBeanCollection();
		...
		this.includeallergyindischargereports = vo.getIncludeAllergyInDischargeReports() == null ? null : vo.getIncludeAllergyInDischargeReports().getBeanCollection();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.PatientAllergyEDischargeVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.core.vo.PatientAllergyEDischargeVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.PatientAllergyEDischargeVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.PatientAllergyEDischargeVo vo = null;
		if(map != null)
			vo = (ims.core.vo.PatientAllergyEDischargeVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.PatientAllergyEDischargeVo();
	...
	public ims.core.vo.beans.PatientAllergyReactionVoBean[] getAllergenReactions()
	{
		return this.allergenreactions;
	}
	public void setAllergenReactions(ims.core.vo.beans.PatientAllergyReactionVoBean[] value)
	{
	...
	public ims.core.vo.beans.IncludeAllergyInDischargeReportsVoBean[] getIncludeAllergyInDischargeReports()
	{
		return this.includeallergyindischargereports;
	}
	public void setIncludeAllergyInDischargeReports(ims.core.vo.beans.IncludeAllergyInDischargeReportsVoBean[] value)
	{
	...
	private ims.core.vo.beans.PatientAllergyReactionVoBean[] allergenreactions;
	...
	private ims.core.vo.beans.IncludeAllergyInDischargeReportsVoBean[] includeallergyindischargereports;
