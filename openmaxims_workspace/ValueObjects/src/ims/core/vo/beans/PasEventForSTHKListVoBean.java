...
public class PasEventForSTHKListVoBean extends ims.vo.ValueObjectBean
{
	public PasEventForSTHKListVoBean()
	{
	}
	public PasEventForSTHKListVoBean(ims.core.vo.PasEventForSTHKListVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.PasEventForSTHKListVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
	...
	public ims.core.vo.PasEventForSTHKListVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.PasEventForSTHKListVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.PasEventForSTHKListVo vo = null;
		if(map != null)
			vo = (ims.core.vo.PasEventForSTHKListVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.PasEventForSTHKListVo();
