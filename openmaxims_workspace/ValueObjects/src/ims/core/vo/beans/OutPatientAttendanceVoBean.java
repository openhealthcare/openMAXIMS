...
public class OutPatientAttendanceVoBean extends ims.vo.ValueObjectBean
{
	public OutPatientAttendanceVoBean()
	{
	}
	public OutPatientAttendanceVoBean(ims.core.vo.OutPatientAttendanceVo vo)
	{
		this.id = vo.getBoId();
		...
		this.recordinguser = vo.getRecordingUser();
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.OutPatientAttendanceVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.appointmentdatetime = vo.getAppointmentDateTime() == null ? null : (ims.framework.utils.beans.DateTimeBean)vo.getAppointmentDateTime().getBean();
	...
	public ims.core.vo.OutPatientAttendanceVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.OutPatientAttendanceVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.OutPatientAttendanceVo vo = null;
		if(map != null)
			vo = (ims.core.vo.OutPatientAttendanceVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.OutPatientAttendanceVo();
