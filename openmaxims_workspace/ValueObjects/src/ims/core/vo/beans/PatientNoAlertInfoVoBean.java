...
public class PatientNoAlertInfoVoBean extends ims.vo.ValueObjectBean
{
	public PatientNoAlertInfoVoBean()
	{
	}
	public PatientNoAlertInfoVoBean(ims.core.vo.PatientNoAlertInfoVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.PatientNoAlertInfoVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.patient = vo.getPatient() == null ? null : new ims.vo.RefVoBean(vo.getPatient().getBoId(), vo.getPatient().getBoVersion());
	...
	public ims.core.vo.PatientNoAlertInfoVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.PatientNoAlertInfoVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.PatientNoAlertInfoVo vo = null;
		if(map != null)
			vo = (ims.core.vo.PatientNoAlertInfoVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.PatientNoAlertInfoVo();
