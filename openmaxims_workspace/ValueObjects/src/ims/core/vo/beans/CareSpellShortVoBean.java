...
public class CareSpellShortVoBean extends ims.vo.ValueObjectBean
{
	public CareSpellShortVoBean()
	{
	}
	public CareSpellShortVoBean(ims.core.vo.CareSpellShortVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.CareSpellShortVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.startdate = vo.getStartDate() == null ? null : (ims.framework.utils.beans.DateBean)vo.getStartDate().getBean();
	...
	public ims.core.vo.CareSpellShortVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.core.vo.CareSpellShortVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.core.vo.CareSpellShortVo vo = null;
		if(map != null)
			vo = (ims.core.vo.CareSpellShortVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.core.vo.CareSpellShortVo();
