 ...
 */
public class PatientTransportRequirementsVo extends ims.core.vo.PatientTransportRequirementsRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public PatientTransportRequirementsVo()
	{
	}
	public PatientTransportRequirementsVo(Integer id, int version)
	{
		super(id, version);
	}
	public PatientTransportRequirementsVo(ims.core.vo.beans.PatientTransportRequirementsVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.core.vo.beans.PatientTransportRequirementsVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.carecontext = bean.getCareContext() == null ? null : new ims.core.admin.vo.CareContextRefVo(new Integer(bean.getCareContext().getId()), bean.getCareContext().getVersion());
	...
	{
		ims.core.vo.beans.PatientTransportRequirementsVoBean bean = null;
		if(map != null)
			bean = (ims.core.vo.beans.PatientTransportRequirementsVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.core.vo.beans.PatientTransportRequirementsVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.specialrequirements != null)
			if(this.specialrequirements.length() > 255)
				listOfErrors.add("The length of the field [specialrequirements] in the value object [ims.core.vo.PatientTransportRequirementsVo] is too big. It should be less or equal to 255");
	...
	public Object clone()
	{
		...
		PatientTransportRequirementsVo clone = new PatientTransportRequirementsVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(PatientTransportRequirementsVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A PatientTransportRequirementsVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((PatientTransportRequirementsVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((PatientTransportRequirementsVo)obj).getBoId());
	}
