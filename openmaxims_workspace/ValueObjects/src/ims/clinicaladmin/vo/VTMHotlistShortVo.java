 ...
 */
public class VTMHotlistShortVo extends ims.clinical.configuration.vo.VTMHotlistRefVo implements ims.vo.ImsCloneable, Comparable, ims.vo.interfaces.IHotlistShort
{
	private static final long serialVersionUID = 1L;

	public VTMHotlistShortVo()
	{
	}
	public VTMHotlistShortVo(Integer id, int version)
	{
		super(id, version);
	}
	public VTMHotlistShortVo(ims.clinicaladmin.vo.beans.VTMHotlistShortVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinicaladmin.vo.beans.VTMHotlistShortVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.isglobal = bean.getIsGlobal();
	...
	{
		ims.clinicaladmin.vo.beans.VTMHotlistShortVoBean bean = null;
		if(map != null)
			bean = (ims.clinicaladmin.vo.beans.VTMHotlistShortVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.clinicaladmin.vo.beans.VTMHotlistShortVoBean();
	...
	*/
	...
	public Object clone()
	{
		...
		VTMHotlistShortVo clone = new VTMHotlistShortVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(VTMHotlistShortVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A VTMHotlistShortVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((VTMHotlistShortVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((VTMHotlistShortVo)obj).getBoId());
	}
