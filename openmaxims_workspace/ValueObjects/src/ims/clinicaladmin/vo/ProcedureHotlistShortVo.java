 ...
 */
public class ProcedureHotlistShortVo extends ims.clinical.configuration.vo.ProcedureHotlistRefVo implements ims.vo.ImsCloneable, Comparable, ims.vo.interfaces.IHotlistShort
{
	private static final long serialVersionUID = 1L;

	public ProcedureHotlistShortVo()
	{
	}
	public ProcedureHotlistShortVo(Integer id, int version)
	{
		super(id, version);
	}
	public ProcedureHotlistShortVo(ims.clinicaladmin.vo.beans.ProcedureHotlistShortVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinicaladmin.vo.beans.ProcedureHotlistShortVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.isglobal = bean.getIsGlobal();
	...
	{
		ims.clinicaladmin.vo.beans.ProcedureHotlistShortVoBean bean = null;
		if(map != null)
			bean = (ims.clinicaladmin.vo.beans.ProcedureHotlistShortVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.clinicaladmin.vo.beans.ProcedureHotlistShortVoBean();
	...
	*/
	...
	{
		return this.getID_ProcedureHotlist();
	}
	...
	public Object clone()
	{
		...
		ProcedureHotlistShortVo clone = new ProcedureHotlistShortVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(ProcedureHotlistShortVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A ProcedureHotlistShortVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((ProcedureHotlistShortVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((ProcedureHotlistShortVo)obj).getBoId());
	}
