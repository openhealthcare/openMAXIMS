 ...
 */
public class TNMStagingClassificationVersionLiteVo extends ims.oncology.configuration.vo.TNMStagingClassificationVersionRefVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public TNMStagingClassificationVersionLiteVo()
	{
	}
	public TNMStagingClassificationVersionLiteVo(Integer id, int version)
	{
		super(id, version);
	}
	public TNMStagingClassificationVersionLiteVo(ims.clinicaladmin.vo.beans.TNMStagingClassificationVersionLiteVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinicaladmin.vo.beans.TNMStagingClassificationVersionLiteVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.versionnumber = bean.getVersionNumber();
	...
	{
		ims.clinicaladmin.vo.beans.TNMStagingClassificationVersionLiteVoBean bean = null;
		if(map != null)
			bean = (ims.clinicaladmin.vo.beans.TNMStagingClassificationVersionLiteVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.clinicaladmin.vo.beans.TNMStagingClassificationVersionLiteVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.versionnumber == null || this.versionnumber.length() == 0)
			listOfErrors.add("VersionNumber is mandatory");
		else if(this.versionnumber.length() > 55)
			listOfErrors.add("The length of the field [versionnumber] in the value object [ims.clinicaladmin.vo.TNMStagingClassificationVersionLiteVo] is too big. It should be less or equal to 55");
		if(this.versiondescription != null)
			if(this.versiondescription.length() > 1500)
				listOfErrors.add("The length of the field [versiondescription] in the value object [ims.clinicaladmin.vo.TNMStagingClassificationVersionLiteVo] is too big. It should be less or equal to 1500");
		if(this.status == null)
	...
	public Object clone()
	{
		...
		TNMStagingClassificationVersionLiteVo clone = new TNMStagingClassificationVersionLiteVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(TNMStagingClassificationVersionLiteVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A TNMStagingClassificationVersionLiteVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((TNMStagingClassificationVersionLiteVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((TNMStagingClassificationVersionLiteVo)obj).getBoId());
	}
