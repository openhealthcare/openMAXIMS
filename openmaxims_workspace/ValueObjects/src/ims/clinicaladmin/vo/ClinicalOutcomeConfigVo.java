 ...
 */
public class ClinicalOutcomeConfigVo extends ims.clinicaladmin.vo.ClinicalOutcomeConfigLiteVo implements ims.vo.ImsCloneable, Comparable
{
	private static final long serialVersionUID = 1L;

	public ClinicalOutcomeConfigVo()
	{
	}
	public ClinicalOutcomeConfigVo(Integer id, int version)
	{
		super(id, version);
	}
	public ClinicalOutcomeConfigVo(ims.clinicaladmin.vo.beans.ClinicalOutcomeConfigVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinicaladmin.vo.beans.ClinicalOutcomeConfigVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.category = bean.getCategory() == null ? null : ims.clinical.vo.lookups.ClinicalOutcomeCategory.buildLookup(bean.getCategory());
	...
	{
		ims.clinicaladmin.vo.beans.ClinicalOutcomeConfigVoBean bean = null;
		if(map != null)
			bean = (ims.clinicaladmin.vo.beans.ClinicalOutcomeConfigVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.clinicaladmin.vo.beans.ClinicalOutcomeConfigVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.clinicaloutcome == null || this.clinicaloutcome.length() == 0)
			...
			listOfErrors.add("The length of the field [clinicaloutcome] in the value object [ims.clinicaladmin.vo.ClinicalOutcomeConfigVo] is too big. It should be less or equal to 500");
	...
	public Object clone()
	{
		...
		ClinicalOutcomeConfigVo clone = new ClinicalOutcomeConfigVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(ClinicalOutcomeConfigVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A ClinicalOutcomeConfigVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((ClinicalOutcomeConfigVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((ClinicalOutcomeConfigVo)obj).getBoId());
	}
