...
public class ProcedureHotlistShortVoBean extends ims.vo.ValueObjectBean
{
	public ProcedureHotlistShortVoBean()
	{
	}
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinicaladmin.vo.ProcedureHotlistShortVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.isglobal = vo.getIsGlobal();
	...
	public ims.clinicaladmin.vo.ProcedureHotlistShortVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.clinicaladmin.vo.ProcedureHotlistShortVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.clinicaladmin.vo.ProcedureHotlistShortVo vo = null;
		if(map != null)
			vo = (ims.clinicaladmin.vo.ProcedureHotlistShortVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.clinicaladmin.vo.ProcedureHotlistShortVo();
