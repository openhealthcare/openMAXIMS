...
public class TreatmentInterventionHotlistShortVoBean extends ims.vo.ValueObjectBean
{
	public TreatmentInterventionHotlistShortVoBean()
	{
	}
	public TreatmentInterventionHotlistShortVoBean(ims.clinicaladmin.vo.TreatmentInterventionHotlistShortVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinicaladmin.vo.TreatmentInterventionHotlistShortVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.specialty = vo.getSpecialty() == null ? null : (ims.vo.LookupInstanceBean)vo.getSpecialty().getBean();
	...
	public ims.clinicaladmin.vo.TreatmentInterventionHotlistShortVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
