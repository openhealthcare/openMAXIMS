...
public class ClinicalOutcomeConfigVoBean extends ims.vo.ValueObjectBean
{
	public ClinicalOutcomeConfigVoBean()
	{
	}
	public ClinicalOutcomeConfigVoBean(ims.clinicaladmin.vo.ClinicalOutcomeConfigVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinicaladmin.vo.ClinicalOutcomeConfigVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.category = vo.getCategory() == null ? null : (ims.vo.LookupInstanceBean)vo.getCategory().getBean();
	...
	public ims.clinicaladmin.vo.ClinicalOutcomeConfigVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.clinicaladmin.vo.ClinicalOutcomeConfigVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.clinicaladmin.vo.ClinicalOutcomeConfigVo vo = null;
		if(map != null)
			vo = (ims.clinicaladmin.vo.ClinicalOutcomeConfigVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.clinicaladmin.vo.ClinicalOutcomeConfigVo();
