...
public class ClinicalOutcomeConfigLiteVoBean extends ims.vo.ValueObjectBean
{
	public ClinicalOutcomeConfigLiteVoBean()
	{
	}
	public ClinicalOutcomeConfigLiteVoBean(ims.clinicaladmin.vo.ClinicalOutcomeConfigLiteVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.clinicaladmin.vo.ClinicalOutcomeConfigLiteVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.category = vo.getCategory() == null ? null : (ims.vo.LookupInstanceBean)vo.getCategory().getBean();
	...
	public ims.clinicaladmin.vo.ClinicalOutcomeConfigLiteVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.clinicaladmin.vo.ClinicalOutcomeConfigLiteVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.clinicaladmin.vo.ClinicalOutcomeConfigLiteVo vo = null;
		if(map != null)
			vo = (ims.clinicaladmin.vo.ClinicalOutcomeConfigLiteVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.clinicaladmin.vo.ClinicalOutcomeConfigLiteVo();
