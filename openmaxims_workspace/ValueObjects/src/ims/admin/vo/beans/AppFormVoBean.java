...
public class AppFormVoBean extends ims.vo.ValueObjectBean
{
	public AppFormVoBean()
	{
	}
	public AppFormVoBean(ims.admin.vo.AppFormVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.admin.vo.AppFormVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.name = vo.getName();
	...
	public ims.admin.vo.AppFormVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.admin.vo.AppFormVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.admin.vo.AppFormVo vo = null;
		if(map != null)
			vo = (ims.admin.vo.AppFormVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.admin.vo.AppFormVo();
