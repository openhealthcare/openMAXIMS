...
public class ReportVoBean extends ims.vo.ValueObjectBean
{
	public ReportVoBean()
	{
	}
	public ReportVoBean(ims.admin.vo.ReportVo vo)
	{
		this.id = vo.getBoId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.admin.vo.ReportVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.reportname = vo.getReportName();
	...
	public ims.admin.vo.ReportVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.admin.vo.ReportVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.admin.vo.ReportVo vo = null;
		if(map != null)
			vo = (ims.admin.vo.ReportVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.admin.vo.ReportVo();
	...
	public ims.admin.vo.beans.ReportTemplateVoBean[] getTemplates()
	{
		return this.templates;
	}
	public void setTemplates(ims.admin.vo.beans.ReportTemplateVoBean[] value)
	{
	...
	private ims.admin.vo.beans.ReportTemplateVoBean[] templates;
