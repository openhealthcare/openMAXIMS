...
public class InPatientADTFeedVoBean extends ims.vo.ValueObjectBean
{
	public InPatientADTFeedVoBean()
	{
	}
	public InPatientADTFeedVoBean(ims.admin.vo.InPatientADTFeedVo vo)
	{
		this.id = vo.getBoId();
		...
		this.partialadmission = vo.getPartialAdmission() == null ? null : new ims.vo.RefVoBean(vo.getPartialAdmission().getBoId(), vo.getPartialAdmission().getBoVersion());
	}

	public void populate(ims.vo.ValueObjectBeanMap map, ims.admin.vo.InPatientADTFeedVo vo)
	{
		this.id = vo.getBoId();
		this.version = vo.getBoVersion();
		this.wasprocessed = vo.getWasProcessed();
	...
	public ims.admin.vo.InPatientADTFeedVo buildVo()
	{
		return this.buildVo(new ims.vo.ValueObjectBeanMap());
	}

	public ims.admin.vo.InPatientADTFeedVo buildVo(ims.vo.ValueObjectBeanMap map)
	{
		ims.admin.vo.InPatientADTFeedVo vo = null;
		if(map != null)
			vo = (ims.admin.vo.InPatientADTFeedVo)map.getValueObject(this);
		if(vo == null)
		{
			vo = new ims.admin.vo.InPatientADTFeedVo();
	...
	public ims.vo.RefVoBean getPartialAdmission()
	{
		return this.partialadmission;
	}
	public void setPartialAdmission(ims.vo.RefVoBean value)
	{
	...
	private ims.vo.RefVoBean partialadmission;
}
