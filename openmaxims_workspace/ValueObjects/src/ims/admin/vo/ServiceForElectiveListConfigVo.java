 ...
 */
public class ServiceForElectiveListConfigVo extends ims.core.clinical.vo.ServiceRefVo implements ims.vo.ImsCloneable, Comparable
{
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.servicecategory == null)
			listOfErrors.add("ServiceCategory is mandatory");
