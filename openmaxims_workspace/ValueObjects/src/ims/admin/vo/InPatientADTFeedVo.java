 ...
 */
public class InPatientADTFeedVo extends ims.hl7adtout.vo.InPatientADTMessageQueueRefVo implements ims.vo.ImsCloneable, Comparable, ims.vo.interfaces.IHL7OutboundMessageHandler
{
	private static final long serialVersionUID = 1L;

	public InPatientADTFeedVo()
	{
	}
	public InPatientADTFeedVo(Integer id, int version)
	{
		super(id, version);
	}
	public InPatientADTFeedVo(ims.admin.vo.beans.InPatientADTFeedVoBean bean)
	{
		this.id = bean.getId();
		...
		this.partialadmission = bean.getPartialAdmission() == null ? null : new ims.emergency.vo.EDPartialAdmissionRefVo(new Integer(bean.getPartialAdmission().getId()), bean.getPartialAdmission().getVersion());
	}
	public void populate(ims.vo.ValueObjectBeanMap map, ims.admin.vo.beans.InPatientADTFeedVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
		this.wasprocessed = bean.getWasProcessed();
	...
	{
		ims.admin.vo.beans.InPatientADTFeedVoBean bean = null;
		if(map != null)
			bean = (ims.admin.vo.beans.InPatientADTFeedVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.admin.vo.beans.InPatientADTFeedVoBean();
	...
	public ims.emergency.vo.EDPartialAdmissionRefVo getPartialAdmission()
	{
		return this.partialadmission;
	}
	public void setPartialAdmission(ims.emergency.vo.EDPartialAdmissionRefVo value)
	{
		this.isValidated = false;
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.acktext != null)
			if(this.acktext.length() > 1000)
				listOfErrors.add("The length of the field [acktext] in the value object [ims.admin.vo.InPatientADTFeedVo] is too big. It should be less or equal to 1000");
		if(this.failuremsg != null)
			if(this.failuremsg.length() > 1000)
				listOfErrors.add("The length of the field [failuremsg] in the value object [ims.admin.vo.InPatientADTFeedVo] is too big. It should be less or equal to 1000");
	...
	public Object clone()
	{
		...
		InPatientADTFeedVo clone = new InPatientADTFeedVo(this.id, this.version);
		...
		clone.partialadmission = this.partialadmission;
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(InPatientADTFeedVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A InPatientADTFeedVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((InPatientADTFeedVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((InPatientADTFeedVo)obj).getBoId());
	}
	...
	protected ims.emergency.vo.EDPartialAdmissionRefVo partialadmission;
