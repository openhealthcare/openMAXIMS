 ...
 */
public class EDAttendanceFeedVo extends ims.hl7adtout.vo.EdAttendanceMessageQueueRefVo implements ims.vo.ImsCloneable, Comparable, ims.vo.interfaces.IHL7OutboundMessageHandler
{
	private static final long serialVersionUID = 1L;

	public EDAttendanceFeedVo()
	{
	}
	public EDAttendanceFeedVo(Integer id, int version)
	{
		super(id, version);
	}
	public EDAttendanceFeedVo(ims.admin.vo.beans.EDAttendanceFeedVoBean bean)
	{
		this.id = bean.getId();
	...
	public void populate(ims.vo.ValueObjectBeanMap map, ims.admin.vo.beans.EDAttendanceFeedVoBean bean)
	{
		this.id = bean.getId();
		this.version = bean.getVersion();
	...
	{
		ims.admin.vo.beans.EDAttendanceFeedVoBean bean = null;
		if(map != null)
			bean = (ims.admin.vo.beans.EDAttendanceFeedVoBean)map.getValueObjectBean(this);
		if (bean == null)
		{
			bean = new ims.admin.vo.beans.EDAttendanceFeedVoBean();
	...
	public String[] validate(String[] existingErrors)
	{
		...
		if(this.acktext != null)
			if(this.acktext.length() > 1000)
				listOfErrors.add("The length of the field [acktext] in the value object [ims.admin.vo.EDAttendanceFeedVo] is too big. It should be less or equal to 1000");
		if(this.failuremsg != null)
			if(this.failuremsg.length() > 1000)
				listOfErrors.add("The length of the field [failuremsg] in the value object [ims.admin.vo.EDAttendanceFeedVo] is too big. It should be less or equal to 1000");
	...
	public Object clone()
	{
		...
		EDAttendanceFeedVo clone = new EDAttendanceFeedVo(this.id, this.version);
	...
	public int compareTo(Object obj, boolean caseInsensitive)
	{
		...
		if (!(EDAttendanceFeedVo.class.isAssignableFrom(obj.getClass())))
		{
			throw new ClassCastException("A EDAttendanceFeedVo object cannot be compared an Object of type " + obj.getClass().getName());
		}
		if (this.id == null)
			return 1;
		if (((EDAttendanceFeedVo)obj).getBoId() == null)
			return -1;
		return this.id.compareTo(((EDAttendanceFeedVo)obj).getBoId());
	}
