...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void onComboBoxSupportValueChanged() throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.ctnStand().lyrParent().tabHeader().setTabActivatedEvent(new ims.framework.delegates.TabActivated()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onlyrParenttabHeaderActivated();
			}
		});
		this.form.ctnStand().lyrParent().tabDetails().setTabActivatedEvent(new ims.framework.delegates.TabActivated()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onlyrParenttabDetailsActivated();
			}
		});
		this.form.ctnStand().lyrParent().tabEmpty().setTabActivatedEvent(new ims.framework.delegates.TabActivated()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onlyrParenttabEmptyActivated();
			}
		});
		this.form.ctnStand().lyrParent().tabHeader().qmbAuthoringCP().setSearchEvent(new ComboBoxSearch()
		{
			private static final long serialVersionUID = 1L;
		...
		this.form.ctnStand().lyrParent().tabDetails().cmbSupport().setValueChangedEvent(new ValueChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onComboBoxSupportValueChanged();
			}
		});
		this.form.ctnStand().lyrParent().tabDetails().btnCancelDetails().setClickEvent(new Click()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
		...
		this.form.ctnStand().lyrParent().tabDetails().btnOk().setClickEvent(new Click()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
	...
	private void onlyrParenttabHeaderActivated()
	{
		this.form.ctnStand().lyrParent().showtabHeader();
	}
	private void onlyrParenttabDetailsActivated()
	{
		this.form.ctnStand().lyrParent().showtabDetails();
	}
	private void onlyrParenttabEmptyActivated()
	{
		this.form.ctnStand().lyrParent().showtabEmpty();
	}
