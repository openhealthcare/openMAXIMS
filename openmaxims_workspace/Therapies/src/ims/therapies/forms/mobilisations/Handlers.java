...
{
	abstract protected void bindcmbTreatmentLookup();
	abstract protected void defaultcmbTreatmentLookupValue();
	...
	abstract protected void oncmbTreatmentValueSet(Object value);
	abstract protected void onCmbTreatmentValueChanged() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onBtnOkDetailsClick() throws ims.framework.exceptions.PresentationLogicException;
	...
	abstract protected void onGrdTreatmentsSelectionChanged() throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.ctnMob().lyrMob().tabHeader().setTabActivatedEvent(new ims.framework.delegates.TabActivated()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onlyrMobtabHeaderActivated();
			}
		});
		this.form.ctnMob().lyrMob().tabDetails().setTabActivatedEvent(new ims.framework.delegates.TabActivated()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onlyrMobtabDetailsActivated();
			}
		});
		this.form.ctnMob().lyrMob().tabEmpty().setTabActivatedEvent(new ims.framework.delegates.TabActivated()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onlyrMobtabEmptyActivated();
			}
		});
		this.form.ctnMob().lyrMob().tabHeader().qmbAuthoringCP().setSearchEvent(new ComboBoxSearch()
		{
			private static final long serialVersionUID = 1L;
		...
		this.form.ctnMob().lyrMob().tabDetails().cmbTreatment().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				oncmbTreatmentValueSet(value);
			}
		});
		this.form.ctnMob().lyrMob().tabDetails().cmbTreatment().setValueChangedEvent(new ValueChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onCmbTreatmentValueChanged();
			}
		});
		this.form.ctnMob().lyrMob().tabDetails().btnOkDetails().setClickEvent(new Click()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
		...
		this.form.ctnMob().lyrMob().tabDetails().btnCancelDetails().setClickEvent(new Click()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
		...
		this.form.grdTreatments().setSelectionChangedEvent(new GridSelectionChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.enumerations.MouseButton mouseButton) throws ims.framework.exceptions.PresentationLogicException
			{
				onGrdTreatmentsSelectionChanged();
			}
		});
	...
	{
		defaultcmbTreatmentLookupValue();
	}
	private void onlyrMobtabHeaderActivated()
	{
		this.form.ctnMob().lyrMob().showtabHeader();
	}
	private void onlyrMobtabDetailsActivated()
	{
		this.form.ctnMob().lyrMob().showtabDetails();
	}
	private void onlyrMobtabEmptyActivated()
	{
		this.form.ctnMob().lyrMob().showtabEmpty();
	}
