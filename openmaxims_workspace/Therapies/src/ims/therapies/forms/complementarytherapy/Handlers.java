...
{
	abstract protected void bindcmbComplementaryLookup();
	abstract protected void defaultcmbComplementaryLookupValue();
	...
	abstract protected void oncmbComplementaryValueSet(Object value);
	...
	abstract protected void onGridTherapySelectionChanged() throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.ctnTherapy().lyrTherapy().tabHeader().qmbAuthoringCP().setSearchEvent(new ComboBoxSearch()
		{
			private static final long serialVersionUID = 1L;
		...
		this.form.ctnTherapy().lyrTherapy().tabDetails().cmbComplementary().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				oncmbComplementaryValueSet(value);
			}
		});
		...
		this.form.ctnTherapy().lyrTherapy().tabDetails().btnOk().setClickEvent(new Click()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
		...
		this.form.gridTherapy().setSelectionChangedEvent(new GridSelectionChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.enumerations.MouseButton mouseButton) throws ims.framework.exceptions.PresentationLogicException
			{
				onGridTherapySelectionChanged();
			}
		});
	...
	{
		defaultcmbComplementaryLookupValue();
	}
