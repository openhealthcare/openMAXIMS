...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.ctnDetail().lyrBoBath().tabBoBath().setTabActivatedEvent(new ims.framework.delegates.TabActivated()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onlyrBoBathtabBoBathActivated();
			}
		});
		this.form.ctnDetail().lyrBoBath().tabAreaDetail().setTabActivatedEvent(new ims.framework.delegates.TabActivated()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onlyrBoBathtabAreaDetailActivated();
			}
		});
		this.form.ctnDetail().lyrBoBath().tabEmpty().setTabActivatedEvent(new ims.framework.delegates.TabActivated()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onlyrBoBathtabEmptyActivated();
			}
		});
		this.form.ctnDetail().lyrBoBath().tabBoBath().qmbAuthoringCP().setSearchEvent(new ComboBoxSearch()
		{
			private static final long serialVersionUID = 1L;
		...
		this.form.ctnDetail().lyrBoBath().tabAreaDetail().btnCancelDetails().setClickEvent(new Click()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
		...
		this.form.ctnDetail().lyrBoBath().tabAreaDetail().btnOk().setClickEvent(new Click()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
		...
		this.form.gridDetails().setSelectionChangedEvent(new GridSelectionChanged()
		{
			private static final long serialVersionUID = 1L;
	...
	private void onlyrBoBathtabBoBathActivated()
	{
		this.form.ctnDetail().lyrBoBath().showtabBoBath();
	}
	private void onlyrBoBathtabAreaDetailActivated()
	{
		this.form.ctnDetail().lyrBoBath().showtabAreaDetail();
	}
	private void onlyrBoBathtabEmptyActivated()
	{
		this.form.ctnDetail().lyrBoBath().showtabEmpty();
	}
