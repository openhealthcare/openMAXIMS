...
{
	abstract protected void bindgrdAnalysisColStaticLookup();
	abstract protected void bindgrdAnalysisColDynamicLookup();
	...
	abstract protected void onRecbrPlinthValueChanged() throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.recbrPlinth().setValueChangedEvent(new ValueChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onRecbrPlinthValueChanged();
			}
		});
	}
	protected void bindLookups()
	{
		bindgrdAnalysisColStaticLookup();
		bindgrdAnalysisColDynamicLookup();
	}
