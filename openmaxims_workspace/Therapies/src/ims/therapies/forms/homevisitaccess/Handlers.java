...
{
	abstract protected void bindcmbAccomodationypeLookup();
	abstract protected void defaultcmbAccomodationypeLookupValue();
	abstract protected void bindcmbOwnershipStatusLookup();
	abstract protected void defaultcmbOwnershipStatusLookupValue();
	...
	abstract protected void oncmbAccomodationypeValueSet(Object value);
	abstract protected void oncmbOwnershipStatusValueSet(Object value);
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.cmbAccomodationype().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				oncmbAccomodationypeValueSet(value);
			}
		});
		this.form.cmbOwnershipStatus().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				oncmbOwnershipStatusValueSet(value);
			}
		});
	...
	{
		defaultcmbAccomodationypeLookupValue();
		defaultcmbOwnershipStatusLookupValue();
	}
