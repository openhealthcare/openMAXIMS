...
{
	abstract protected void bindansContactLookup();
	abstract protected void defaultansContactLookupValue();
	...
	abstract protected void onansContactValueSet(Object value);
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.ansContact().setValueSetEvent(new AnswerBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				onansContactValueSet(value);
			}
		});
