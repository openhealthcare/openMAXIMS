...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void onCmbThermalValueChanged() throws ims.framework.exceptions.PresentationLogicException;
	...
	abstract protected void onGrdThermalSelectionChanged() throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.ctnTherapy().lyrThermal().tabHeader().setTabActivatedEvent(new ims.framework.delegates.TabActivated()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onlyrThermaltabHeaderActivated();
			}
		});
		this.form.ctnTherapy().lyrThermal().tabDetails().setTabActivatedEvent(new ims.framework.delegates.TabActivated()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onlyrThermaltabDetailsActivated();
			}
		});
		this.form.ctnTherapy().lyrThermal().tabEmpty().setTabActivatedEvent(new ims.framework.delegates.TabActivated()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onlyrThermaltabEmptyActivated();
			}
		});
		this.form.ctnTherapy().lyrThermal().tabHeader().qmbAuthoringCP().setSearchEvent(new ComboBoxSearch()
		{
			private static final long serialVersionUID = 1L;
		...
		this.form.ctnTherapy().lyrThermal().tabDetails().cmbArea().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
		...
		this.form.ctnTherapy().lyrThermal().tabDetails().cmbThermal().setValueChangedEvent(new ValueChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onCmbThermalValueChanged();
			}
		});
		this.form.ctnTherapy().lyrThermal().tabDetails().cmbLaterality().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
		...
		this.form.ctnTherapy().lyrThermal().tabDetails().btnOk().setClickEvent(new Click()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
		...
		this.form.ctnTherapy().lyrThermal().tabDetails().btnClearDetails().setClickEvent(new Click()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
		...
		this.form.grdThermal().setSelectionChangedEvent(new GridSelectionChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.enumerations.MouseButton mouseButton) throws ims.framework.exceptions.PresentationLogicException
			{
				onGrdThermalSelectionChanged();
			}
		});
	...
	private void onlyrThermaltabHeaderActivated()
	{
		this.form.ctnTherapy().lyrThermal().showtabHeader();
	}
	private void onlyrThermaltabDetailsActivated()
	{
		this.form.ctnTherapy().lyrThermal().showtabDetails();
	}
	private void onlyrThermaltabEmptyActivated()
	{
		this.form.ctnTherapy().lyrThermal().showtabEmpty();
	}
