...
{
	abstract protected void bindgrdSurfaceColSurfaceLookup();
	...
	abstract protected void onCmbChairTypeValueChanged() throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.cmbChairType().setValueChangedEvent(new ValueChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onCmbChairTypeValueChanged();
			}
		});
	...
	{
		bindgrdSurfaceColSurfaceLookup();
