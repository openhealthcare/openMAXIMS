...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_COE.ClinicalNotes.CallingForm", "_cv_COE.ClinicalNotesVo", "_cv_COE.CarePlan", "_cv_COE.CarePlanID" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Nursing.ClinicalNotes.__internal_x_context__" + String.valueOf(getFormId());
	}
