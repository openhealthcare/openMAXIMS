...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_COE.CarePlanID", "_cv_Nursing.ShowCarePlanRvwDialog", "_cv_Core.Hospital", "_cv_Core.Ward" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Nursing.CarePlanReview.__internal_x_context__" + String.valueOf(getFormId());
	}
