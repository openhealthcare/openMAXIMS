...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_COE.TransferNote", "_cv_Core.ReportID", "_cv_Core.TemplateID" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Nursing.Transfer.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/arrow_bi_48.png";
	}
}
