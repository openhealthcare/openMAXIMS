...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Core.Reports.StartDate", "_cv_Core.Reports.EndDate", "_cv_Core.ReportID", "_cv_Core.TemplateID", "_cv_COE.ClinicalNotesVo", "_cv_COE.CarePlanID" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Nursing.ClinicalNotesView.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Core/progress_notes_48.png";
	}
}
