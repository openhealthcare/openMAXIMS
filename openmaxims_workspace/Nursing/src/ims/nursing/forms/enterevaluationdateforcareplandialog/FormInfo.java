...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "EnterEvaluationDateForCarePlanDialog";
	}
	public int getWidth()
	{
		return 288;
	...
	{
		return new String[] { "_cv_Nursing.NewNextEvaluationDateEntered" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Nursing.EnterEvaluationDateForCarePlanDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
