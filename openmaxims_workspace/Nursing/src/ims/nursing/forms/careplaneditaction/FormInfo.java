...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_Nursing.CarePlanAction" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Nursing.CarePlanEditAction.__internal_x_context__" + String.valueOf(getFormId());
	}
