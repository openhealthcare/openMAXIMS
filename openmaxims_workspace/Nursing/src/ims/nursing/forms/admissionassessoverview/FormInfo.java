...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "AdmissionAssessOverview";
	}
	public int getWidth()
	{
		return 848;
	...
	{
		return new String[] { "_cv_Nursing.AssessmentComponent", "_cv_Nursing.AssessmentHeaderInfo", "_cv_Core.AssessmentIsReadOnly" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Nursing.AdmissionAssessOverview.__internal_x_context__" + String.valueOf(getFormId());
	}
