...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_COE.MNARecord", "_cv_Core.ReportID", "_cv_Core.TemplateID", "_cv_COE.AddNew", "_cv_COE.MNAAssessments" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Nursing.MNAView.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Assessment/assessment_preview_48.png";
	}
}
