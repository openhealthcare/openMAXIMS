...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "PlanOfCareActionsReview";
	}
	public int getWidth()
	{
		return 814;
	...
	{
		return new String[] { "_cv_PlanOfCareActionsReview" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Nursing.PlanOfCareActionsReview.__internal_x_context__" + String.valueOf(getFormId());
	}
