...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void onChkSkinIntactValueChanged() throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.chkSkinIntact().setValueChangedEvent(new ValueChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onChkSkinIntactValueChanged();
			}
		});
		...
		this.form.drawingBodyChart().setDrawingControlShapeEditedEvent(new DrawingControlShapeEdited()
		{
			private static final long serialVersionUID = 1L;
		...
		this.form.drawingBodyChart().setDrawingControlShapeRemovedEvent(new DrawingControlShapeRemoved()
		{
			private static final long serialVersionUID = 1L;
			public void handle(int index) throws ims.framework.exceptions.PresentationLogicException
			{
		...
		this.form.drawingBodyChart().setDrawingControlNoteEvent(new DrawingControlNote()
		{
			private static final long serialVersionUID = 1L;
