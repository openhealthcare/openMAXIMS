...
{
	abstract protected void bindgrdStoolScaleColNoResultLookup();
	abstract protected void bindgrdStoolScaleColStoolTypeLookup();
	...
	abstract protected void onGrdStoolScaleGridHeaderClicked(int column) throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onGrdStoolScaleSelectionChanged() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onCustomControlAuthoringInfoValueChanged() throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.grdStoolScale().setGridHeaderClickedEvent(new GridHeaderClicked()
		{
			private static final long serialVersionUID = 1L;
			public void handle(int column) throws ims.framework.exceptions.PresentationLogicException
			{
				onGrdStoolScaleGridHeaderClicked(column);
			}
		});
		this.form.grdStoolScale().setSelectionChangedEvent(new GridSelectionChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.enumerations.MouseButton mouseButton) throws ims.framework.exceptions.PresentationLogicException
			{
				onGrdStoolScaleSelectionChanged();
			}
		});
		this.form.setcustomControlAuthoringInfoValueChangedEvent(new ValueChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onCustomControlAuthoringInfoValueChanged();
			}
		});
	...
	{
		bindgrdStoolScaleColNoResultLookup();
		bindgrdStoolScaleColStoolTypeLookup();
		bindcmbResultLookup();
		bindcmbTypeLookup();
	}
