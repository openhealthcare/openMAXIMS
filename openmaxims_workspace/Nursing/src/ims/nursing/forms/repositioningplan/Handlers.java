...
{
	abstract protected void bindansFrequencyLookup();
	abstract protected void defaultansFrequencyLookupValue();
	abstract protected void bindcmbBlanchingLookup();
	abstract protected void defaultcmbBlanchingLookupValue();
	abstract protected void bindansTestLookup();
	abstract protected void defaultansTestLookupValue();
	abstract protected void bindcmbFrequencyLookup();
	abstract protected void defaultcmbFrequencyLookupValue();
	abstract protected void bindchkSidesLookup();
	abstract protected void bindgrdDetailsColSkinTestLookup();
	abstract protected void onFormModeChanged();
	abstract protected void onFormOpen() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onansFrequencyValueSet(Object value);
	abstract protected void onAnsFrequencyValueChanged() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void oncmbBlanchingValueSet(Object value);
	abstract protected void onansTestValueSet(Object value);
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.ctnRepo().ansFrequency().setValueSetEvent(new AnswerBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				onansFrequencyValueSet(value);
			}
		});
		this.form.ctnRepo().ansFrequency().setValueChangedEvent(new ValueChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onAnsFrequencyValueChanged();
			}
		});
		this.form.ctnRepo().cmbBlanching().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				oncmbBlanchingValueSet(value);
			}
		});
		this.form.ctnRepo().ansTest().setValueSetEvent(new AnswerBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				onansTestValueSet(value);
			}
		});
		this.form.ctnRepo().cmbFrequency().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
	...
	protected void bindLookups()
	{
		...
		bindgrdDetailsColSkinTestLookup();
	}
	...
	{
		defaultansFrequencyLookupValue();
		defaultcmbBlanchingLookupValue();
		defaultansTestLookupValue();
