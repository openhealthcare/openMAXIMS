...
{
	abstract protected void bindgrdMRSAAssChildcolSiteLookup();
	abstract protected void bindgrdMRSAAssChildcolResultLookup();
	...
	abstract protected void onGrdMRSAAssChildSelectionChanged() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onGrdMRSAAssChildGridComboBoxSelectionChanged(int column, GenForm.grdMRSAAssChildRow row, Object value) throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.grdMRSAAssChild().setSelectionChangedEvent(new GridSelectionChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.enumerations.MouseButton mouseButton) throws ims.framework.exceptions.PresentationLogicException
			{
				onGrdMRSAAssChildSelectionChanged();
			}
		});
		this.form.grdMRSAAssChild().setGridComboBoxSelectionChangedEvent(new GridComboBoxSelectionChanged()
		{
			private static final long serialVersionUID = 1L;
			...
			{
				onGrdMRSAAssChildGridComboBoxSelectionChanged(column, new GenForm.grdMRSAAssChildRow(row), value);
			}
		});
		this.form.grdAssessment().setSelectionChangedEvent(new GridSelectionChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.enumerations.MouseButton mouseButton) throws ims.framework.exceptions.PresentationLogicException
			{
	...
	{
		bindgrdMRSAAssChildcolSiteLookup();
		bindgrdMRSAAssChildcolResultLookup();
	}
