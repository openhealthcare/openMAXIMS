...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void bindgrdValuablescolValuableLookup();
	abstract protected void bindgrdValuablescolHasValuableLookup();
	abstract protected void bindcmbMoveTypeLookup();
	abstract protected void defaultcmbMoveTypeLookupValue();
	...
	abstract protected void onQmbDestWardTextSubmited(String value) throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onQmbWardTextSubmited(String value) throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void oncmbMoveTypeValueSet(Object value);
	abstract protected void onCmbMoveTypeValueChanged() throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.ctnDetails().chkConfirm().setValueChangedEvent(new ValueChanged()
		{
			private static final long serialVersionUID = 1L;
		...
		this.form.ctnDetails().qmbDestWard().setSearchEvent(new ComboBoxSearch()
		{
			private static final long serialVersionUID = 1L;
			public void handle(String value) throws ims.framework.exceptions.PresentationLogicException
			{
				onQmbDestWardTextSubmited(value);
			}
		});
		this.form.ctnDetails().qmbWard().setSearchEvent(new ComboBoxSearch()
		{
			private static final long serialVersionUID = 1L;
			public void handle(String value) throws ims.framework.exceptions.PresentationLogicException
			{
		...
		this.form.ctnDetails().cmbMoveType().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				oncmbMoveTypeValueSet(value);
			}
		});
		this.form.ctnDetails().cmbMoveType().setValueChangedEvent(new ValueChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onCmbMoveTypeValueChanged();
			}
		});
	...
	{
		bindgrdValuablescolValuableLookup();
		bindgrdValuablescolHasValuableLookup();
	}
