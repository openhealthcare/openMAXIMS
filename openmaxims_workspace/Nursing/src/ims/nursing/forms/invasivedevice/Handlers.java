...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void bindansCultureLookup();
	abstract protected void defaultansCultureLookupValue();
	abstract protected void bindcmbRemovalReasonLookup();
	abstract protected void defaultcmbRemovalReasonLookupValue();
	abstract protected void bindcmbVipSoreLookup();
	abstract protected void defaultcmbVipSoreLookupValue();
	abstract protected void bindcmbActionLookup();
	abstract protected void defaultcmbActionLookupValue();
	abstract protected void onFormModeChanged();
	abstract protected void onFormOpen() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onCustomInsertedHCPValueChanged() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onDtimRemDateValueChanged() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onCmbTypeValueChanged() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onansCultureValueSet(Object value);
	abstract protected void oncmbRemovalReasonValueSet(Object value);
	abstract protected void onQmbRemovalByTextSubmited(String value) throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onCmbDeviceValueChanged() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void oncmbVipSoreValueSet(Object value);
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.ctnDetail().lyrDetails().tabDevice().setTabActivatedEvent(new ims.framework.delegates.TabActivated()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onlyrDetailstabDeviceActivated();
			}
		});
		this.form.ctnDetail().lyrDetails().tabVIP().setTabActivatedEvent(new ims.framework.delegates.TabActivated()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onlyrDetailstabVIPActivated();
			}
		});
		this.form.ctnDetail().lyrDetails().tabDevice().setcustomInsertedHCPValueChangedEvent(new ValueChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
		...
		this.form.ctnDetail().lyrDetails().tabDevice().dtimRemDate().setValueChangedEvent(new ValueChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onDtimRemDateValueChanged();
			}
		});
		this.form.ctnDetail().lyrDetails().tabDevice().cmbType().setValueChangedEvent(new ValueChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
		...
		this.form.ctnDetail().lyrDetails().tabDevice().ansCulture().setValueSetEvent(new AnswerBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				onansCultureValueSet(value);
			}
		});
		this.form.ctnDetail().lyrDetails().tabDevice().cmbRemovalReason().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
		...
		this.form.ctnDetail().lyrDetails().tabDevice().qmbRemovalBy().setSearchEvent(new ComboBoxSearch()
		{
			private static final long serialVersionUID = 1L;
			public void handle(String value) throws ims.framework.exceptions.PresentationLogicException
			{
				onQmbRemovalByTextSubmited(value);
			}
		});
		this.form.ctnDetail().lyrDetails().tabDevice().cmbDevice().setValueChangedEvent(new ValueChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
				onCmbDeviceValueChanged();
			}
		});
		this.form.ctnDetail().lyrDetails().tabVIP().cmbVipSore().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				oncmbVipSoreValueSet(value);
			}
		});
		this.form.ctnDetail().lyrDetails().tabVIP().cmbAction().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
	...
	{
		defaultansCultureLookupValue();
		defaultcmbRemovalReasonLookupValue();
		defaultcmbVipSoreLookupValue();
		defaultcmbActionLookupValue();
	}
	private void onlyrDetailstabDeviceActivated()
	{
		this.form.ctnDetail().lyrDetails().showtabDevice();
	}
	private void onlyrDetailstabVIPActivated()
	{
		this.form.ctnDetail().lyrDetails().showtabVIP();
	}
