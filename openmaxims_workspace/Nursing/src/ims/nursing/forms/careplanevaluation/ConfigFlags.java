...
public final class ConfigFlags extends ims.framework.FormConfigFlags implements Serializable
{
	...
	public final CAREPLAN_CARE_AS_PLANNEDClass CAREPLAN_CARE_AS_PLANNED;
	...
	public ConfigFlags(ims.framework.ConfigFlag configFlags)
	{
		...
		CAREPLAN_CARE_AS_PLANNED = new CAREPLAN_CARE_AS_PLANNEDClass(configFlags);
	...
	public final class CAREPLAN_CARE_AS_PLANNEDClass implements Serializable
	{
		private static final long serialVersionUID = 1L;
		private final ims.framework.ConfigFlag configFlags;

		public CAREPLAN_CARE_AS_PLANNEDClass(ims.framework.ConfigFlag configFlags)
		{
			this.configFlags = configFlags;
		}
		...
		public Boolean getValue()
		{
			return (Boolean)configFlags.get("CAREPLAN_CARE_AS_PLANNED");
		}
	}
