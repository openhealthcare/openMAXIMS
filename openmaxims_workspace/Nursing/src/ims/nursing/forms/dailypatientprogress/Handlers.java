...
abstract public class Handlers implements ims.framework.UILogic, IFormUILogicCode
{
	...
	abstract protected void bindcmbStatusReasonLookup();
	abstract protected void defaultcmbStatusReasonLookupValue();
	abstract protected void bindcmbAssessmentTypeLookup();
	abstract protected void defaultcmbAssessmentTypeLookupValue();
	abstract protected void onFormModeChanged();
	abstract protected void onFormOpen() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onFormDialogClosed(ims.framework.FormName formName, ims.framework.enumerations.DialogResult result) throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onImbSearchClick() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onGrdDetailsCellButtonClicked(ims.framework.controls.DynamicGridCell cell);
	abstract protected void onLnkDPPClick() throws ims.framework.exceptions.PresentationLogicException;
	abstract protected void onTreScoresTreeViewSelectionChanged(ims.framework.controls.TreeNode node) throws ims.framework.exceptions.PresentationLogicException;
	...
	abstract protected void oncmbStatusReasonValueSet(Object value);
	abstract protected void oncmbAssessmentTypeValueSet(Object value);
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.dynGridDetails().setDynamicGridCellButtonClickedEvent(new DynamicGridCellButtonClicked()
		{
			private static final long serialVersionUID = 1L;
			...
			{
				onGrdDetailsCellButtonClicked(cell);
			}
		});
		this.form.lnkDPP().setClickEvent(new Click()
		{
			private static final long serialVersionUID = 1L;
			public void handle() throws ims.framework.exceptions.PresentationLogicException
			{
		...
		this.form.treScores().setTreeViewSelectionChangedEvent(new TreeViewSelectionChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.controls.TreeNode node) throws ims.framework.exceptions.PresentationLogicException
			{
				onTreScoresTreeViewSelectionChanged(node);
			}
		});
		...
		this.form.cmbStatusReason().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				oncmbStatusReasonValueSet(value);
			}
		});
		this.form.cmbAssessmentType().setValueSetEvent(new ComboBoxValueSet()
		{
			private static final long serialVersionUID = 1L;
			public void handle(Object value)
			{
				oncmbAssessmentTypeValueSet(value);
			}
		});
		...
		this.form.getContextMenus().getDailyPatientProgressAssessmentViewItem().setClickEvent(new ims.framework.delegates.MenuItemClick()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.Control sender) throws ims.framework.exceptions.PresentationLogicException
			{
				onContextMenuItemClick(GenForm.ContextMenus.DailyPatientProgressAssessment.View, sender);
			}
		});
	}
	...
	protected void defaultAllLookupValues()
	{
		...
		defaultcmbStatusReasonLookupValue();
		defaultcmbAssessmentTypeLookupValue();
	}
