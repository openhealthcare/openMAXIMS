...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_COE.BradenAssessments", "_cv_Core.ReportID", "_cv_Core.TemplateID", "_cv_COE.AddNew", "_cv_COE.BradenScaleRecord" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Nursing.BradenScaleVIEW.__internal_x_context__" + String.valueOf(getFormId());
	}
