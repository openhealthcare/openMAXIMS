...
public abstract class BaseLogic extends Handlers
{
	...
	{
		return ims.nursing.domain.EnvirnmentalChecklistDialog.class;
	}
	public final void setContext(ims.framework.UIEngine engine, GenForm form, ims.nursing.domain.EnvirnmentalChecklistDialog domain)
	{
		setContext(engine, form);
		this.domain = domain;
	}
	protected final void bindgrdChecklistcolStatusLookup()
	{
	...
	protected ims.nursing.domain.EnvirnmentalChecklistDialog domain;
}
