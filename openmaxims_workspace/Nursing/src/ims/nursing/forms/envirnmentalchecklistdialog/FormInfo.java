...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return "EnvirnmentalChecklistDialog";
	}
	public int getWidth()
	{
		return 832;
	...
	{
		return new String[] { "_cv_COE.EnvironmentalChecklist", "_cv_COE.AssessmentMobility", "_cv_Nursing.AssessmentComponent" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Nursing.EnvirnmentalChecklistDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
	...
	{
		return "Images/Admin/checklist_48.png";
	}
}
