...
{
	abstract protected void bindgrdInterventionsColAssistanceLookup();
	...
	abstract protected void onGrdInterventionsSelectionChanged() throws ims.framework.exceptions.PresentationLogicException;
	...
	public final void setContext(ims.framework.UIEngine engine, GenForm form)
	{
		...
		this.form.grdInterventions().setSelectionChangedEvent(new GridSelectionChanged()
		{
			private static final long serialVersionUID = 1L;
			public void handle(ims.framework.enumerations.MouseButton mouseButton) throws ims.framework.exceptions.PresentationLogicException
			{
				onGrdInterventionsSelectionChanged();
			}
		});
	...
	{
		bindgrdInterventionsColAssistanceLookup();
	}
