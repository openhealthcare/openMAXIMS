...
public class GenForm extends FormBridge
{
	...
	public static class cmbAllRecordsComboBox extends ComboBoxBridge
	{
		...
		public void newRow(ims.nursing.vo.InterventionChartHeaderVo value, String text)
		{
			super.control.newRow(value, text);
		}
		public void newRow(ims.nursing.vo.InterventionChartHeaderVo value, String text, ims.framework.utils.Image image)
		{
			super.control.newRow(value, text, image);
		}
		public void newRow(ims.nursing.vo.InterventionChartHeaderVo value, String text, ims.framework.utils.Color textColor)
		{
			super.control.newRow(value, text, textColor);
		}
		public void newRow(ims.nursing.vo.InterventionChartHeaderVo value, String text, ims.framework.utils.Image image, ims.framework.utils.Color textColor)
		{
			super.control.newRow(value, text, image, textColor);
		}
		public boolean removeRow(ims.nursing.vo.InterventionChartHeaderVo value)
		{
			return super.control.removeRow(value);
		}
		public ims.nursing.vo.InterventionChartHeaderVo getValue()
		{
			return (ims.nursing.vo.InterventionChartHeaderVo)super.control.getValue();
		}
		public void setValue(ims.nursing.vo.InterventionChartHeaderVo value)
		{
	...
	public static class grdInterventionsRow extends GridRowBridge
	{
		private static final long serialVersionUID = 1L;
		
		protected grdInterventionsRow(GridRow row)
		{
			super(row);
		}
		...
		public ims.nursing.vo.lookups.StaffAssistance getColAssistance()
		{
			return (ims.nursing.vo.lookups.StaffAssistance)super.row.get(1);
		}
		public void setColAssistance(ims.nursing.vo.lookups.StaffAssistance value)
		{
		...
		public void setColLengthTimeReadOnly(boolean value)
		{
			super.row.setReadOnly(2, value);
		}
		public boolean isColLengthTimeReadOnly()
		{
			return super.row.isReadOnly(2);
		}
		public void showColLengthTimeOpened()
		{
			super.row.showOpened(2);
		}
		public String getColLengthTime()
		{
			return (String)super.row.get(2);
		}
		public void setColLengthTime(String value)
		{
			super.row.set(2, value);
		}
		public void setCellColLengthTimeTooltip(String value)
		{
		...
		public ims.nursing.vo.InterventionChartDetailsVo getValue()
		{
			return (ims.nursing.vo.InterventionChartDetailsVo)super.row.getValue();
		}
		public void setValue(ims.nursing.vo.InterventionChartDetailsVo value)
		{
			super.row.setValue(value);
		}
	}
	public static class grdInterventionsRowCollection extends GridRowCollectionBridge
	{
		private static final long serialVersionUID = 1L;
		
		private grdInterventionsRowCollection(GridRowCollection collection)
		{
			super(collection);
		}
		public grdInterventionsRow get(int index)
		{
			return new grdInterventionsRow(super.collection.get(index));
		}
		public grdInterventionsRow newRow()
		{
			return new grdInterventionsRow(super.collection.newRow());
		}
		public grdInterventionsRow newRow(boolean autoSelect)
		{
			return new grdInterventionsRow(super.collection.newRow(autoSelect));
		}
		public grdInterventionsRow newRowAt(int index)
		{
			return new grdInterventionsRow(super.collection.newRowAt(index));
		}
		public grdInterventionsRow newRowAt(int index, boolean autoSelect)
		{
			return new grdInterventionsRow(super.collection.newRowAt(index, autoSelect));
		}
	}
	public static class grdInterventionsGrid extends GridBridge
	{
		private static final long serialVersionUID = 1L;
		...
		public ims.nursing.vo.InterventionChartDetailsVo[] getValues()
		{
			ims.nursing.vo.InterventionChartDetailsVo[] listOfValues = new ims.nursing.vo.InterventionChartDetailsVo[this.getRows().size()];
		...
		public ims.nursing.vo.InterventionChartDetailsVo getValue()
		{
			return (ims.nursing.vo.InterventionChartDetailsVo)super.grid.getValue();
		}
		public void setValue(ims.nursing.vo.InterventionChartDetailsVo value)
		{
			super.grid.setValue(value);
		}
		public grdInterventionsRow getSelectedRow()
		{
			return super.grid.getSelectedRow() == null ? null : new grdInterventionsRow(super.grid.getSelectedRow());
		}
		public int getSelectedRowIndex()
		{
			return super.grid.getSelectedRowIndex();
		}
		public grdInterventionsRowCollection getRows()
		{
			return new grdInterventionsRowCollection(super.grid.getRows());
		}
		public grdInterventionsRow getRowByValue(ims.nursing.vo.InterventionChartDetailsVo value)
		{
			GridRow row = super.grid.getRowByValue(value);
			return row == null?null:new grdInterventionsRow(row);
		}
		...
		public void setColLengthTimeHeaderTooltip(String value)
		{
			super.grid.setColumnHeaderTooltip(2, value);
		}
		public String getColLengthTimeHeaderTooltip()
		{
	...
	{
		return this.getLocalContext().getSelectedInterventionRecord();
	}
	...
	protected void setContext(FormLoader loader, Form form, ims.framework.interfaces.IAppForm appForm, UIFactory factory, ims.framework.Context context, Boolean skipContextValidation, Integer startControlID, ims.framework.utils.SizeInfo runtimeSize, ims.framework.Control control, Integer startTabIndex) throws Exception
	{
		...
		// Label Controls
		RuntimeAnchoring anchoringHelper2 = new RuntimeAnchoring(designSize, runtimeSize, 552, 32, 72, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1001), new Integer(anchoringHelper2.getX()), new Integer(anchoringHelper2.getY()), new Integer(anchoringHelper2.getWidth()), new Integer(anchoringHelper2.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "All Records:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper3 = new RuntimeAnchoring(designSize, runtimeSize, 16, 32, 130, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		super.addControl(factory.getControl(Label.class, new Object[] { control, new Integer(startControlID.intValue() + 1002), new Integer(anchoringHelper3.getX()), new Integer(anchoringHelper3.getY()), new Integer(anchoringHelper3.getWidth()), new Integer(anchoringHelper3.getHeight()), ControlState.UNKNOWN, ControlState.UNKNOWN, ims.framework.enumerations.ControlAnchoring.TOPLEFT, "Authoring Date/Time:", new Integer(1), null, new Integer(0)}));
		RuntimeAnchoring anchoringHelper4 = new RuntimeAnchoring(designSize, runtimeSize, 16, 56, 92, 17, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		RuntimeAnchoring anchoringHelper7 = new RuntimeAnchoring(designSize, runtimeSize, 759, 592, 75, 23, ims.framework.enumerations.ControlAnchoring.BOTTOMRIGHT);
		...
		super.addControl(factory.getControl(Button.class, new Object[] { control, new Integer(startControlID.intValue() + 1007), new Integer(anchoringHelper8.getX()), new Integer(anchoringHelper8.getY()), new Integer(anchoringHelper8.getWidth()), new Integer(anchoringHelper8.getHeight()), new Integer(startTabIndex.intValue() + 8), ControlState.UNKNOWN, ControlState.HIDDEN, ims.framework.enumerations.ControlAnchoring.BOTTOMLEFT, "Edit", Boolean.TRUE, null, Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, null, ims.framework.utils.Color.Default, ims.framework.utils.Color.Default }));

		// Date Controls
		RuntimeAnchoring anchoringHelper9 = new RuntimeAnchoring(designSize, runtimeSize, 144, 32, 96, 20, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// ComboBox Controls
		RuntimeAnchoring anchoringHelper10 = new RuntimeAnchoring(designSize, runtimeSize, 624, 32, 208, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFTRIGHT);
		...
		RuntimeAnchoring anchoringHelper11 = new RuntimeAnchoring(designSize, runtimeSize, 144, 56, 144, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
		...
		// Grid Controls
		RuntimeAnchoring anchoringHelper12 = new RuntimeAnchoring(designSize, runtimeSize, 16, 88, 816, 488, ims.framework.enumerations.ControlAnchoring.ALL);
		Grid m_grdInterventionsTemp = (Grid)factory.getControl(Grid.class, new Object[] { control, new Integer(startControlID.intValue() + 1011), new Integer(anchoringHelper12.getX()), new Integer(anchoringHelper12.getY()), new Integer(anchoringHelper12.getWidth()), new Integer(anchoringHelper12.getHeight()), new Integer(startTabIndex.intValue() + 6), ControlState.READONLY, ControlState.EDITABLE, ims.framework.enumerations.ControlAnchoring.ALL,Boolean.TRUE, Boolean.FALSE, new Integer(24), Boolean.TRUE, contextMenus.contextMenuGenericGrid, Boolean.FALSE, Boolean.FALSE, new Integer(0), null, Boolean.TRUE, Boolean.TRUE});
		addControl(m_grdInterventionsTemp);
		grdInterventionsGrid grdInterventions = (grdInterventionsGrid)GridFlyweightFactory.getInstance().createGridBridge(grdInterventionsGrid.class, m_grdInterventionsTemp);
		grdInterventions.addTimeColumn("Time", 0, 0, 100, false, true, false, null, false, 1, true);
		grdInterventions.addComboBoxColumn("Assistance", 0, 0, 125, false, true, false, false, true, -1);
		grdInterventions.addStringColumn("Length of time", 0, 0, 100, false, false, 1, 50, true, ims.framework.enumerations.CharacterCasing.NORMAL);
		grdInterventions.addWrapTextColumn("Intervention", 0, 0, -1, false, false, 255, true);
		super.addGrid(grdInterventions);

		// Time Controls
		RuntimeAnchoring anchoringHelper13 = new RuntimeAnchoring(designSize, runtimeSize, 240, 32, 48, 21, ims.framework.enumerations.ControlAnchoring.TOPLEFT);
	...
	public grdInterventionsGrid grdInterventions()
	{
		return (grdInterventionsGrid)super.getGrid(0);
	}
	...
	public class LocalContext extends ContextBridge
	{
		...
		public LocalContext(Context context, ims.framework.FormInfo formInfo, String componentIdentifier)
		{
			...
			cxl_SelectedInterventionRecord = new ims.framework.ContextVariable("SelectedInterventionRecord", prefix + "_lv_Nursing.NurInterventionChart.__internal_x_context__SelectedInterventionRecord_" + componentIdentifier + "");
			cxl_InterventionChartRecord = new ims.framework.ContextVariable("InterventionChartRecord", prefix + "_lv_Nursing.NurInterventionChart.__internal_x_context__InterventionChartRecord_" + componentIdentifier + "");
		}
		
		public boolean getSelectedInterventionRecordIsNotNull()
		{
			return !cxl_SelectedInterventionRecord.getValueIsNull(context);
		}
		public ims.nursing.vo.InterventionChartHeaderVo getSelectedInterventionRecord()
		{
			return (ims.nursing.vo.InterventionChartHeaderVo)cxl_SelectedInterventionRecord.getValue(context);
		}
		public void setSelectedInterventionRecord(ims.nursing.vo.InterventionChartHeaderVo value)
		{
			cxl_SelectedInterventionRecord.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_SelectedInterventionRecord = null;
		public boolean getInterventionChartRecordIsNotNull()
		{
			return !cxl_InterventionChartRecord.getValueIsNull(context);
		}
		public ims.nursing.vo.InterventionChartVo getInterventionChartRecord()
		{
			return (ims.nursing.vo.InterventionChartVo)cxl_InterventionChartRecord.getValue(context);
		}
		public void setInterventionChartRecord(ims.nursing.vo.InterventionChartVo value)
		{
			cxl_InterventionChartRecord.setValue(context, value);
		}
		private ims.framework.ContextVariable cxl_InterventionChartRecord = null;
	}
	...
	private class ReportFields
	{
		...
		public IReportField[] getReportFields()
		{
			...
			fields[71] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NurInterventionChart.__internal_x_context__SelectedInterventionRecord_" + componentIdentifier, "BO-1029100000-ID", "ID_InterventionChart");
			fields[72] = new ims.framework.ReportField(this.context, prefix + "_lv_Nursing.NurInterventionChart.__internal_x_context__SelectedInterventionRecord_" + componentIdentifier, "BO-1029100000-AUTHORINGDATETIME", "AuthoringDateTime");
			return fields;
		}
