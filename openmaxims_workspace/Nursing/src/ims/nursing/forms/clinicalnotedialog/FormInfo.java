...
public final class FormInfo extends ims.framework.FormInfo
{
	...
	{
		return new String[] { "_cv_COE.CarePlan", "_cv_Core.YesNoDialogMessage" };
	}
	public String getLocalVariablesPrefix()
	{
		return "_lv_Nursing.ClinicalNoteDialog.__internal_x_context__" + String.valueOf(getFormId());
	}
