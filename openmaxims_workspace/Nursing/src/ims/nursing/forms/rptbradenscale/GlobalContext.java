...
public final class GlobalContext extends ims.framework.FormContext implements Serializable
{
	...
	{
		return !cx_BradenScale.getValueIsNull(context);
	}
	public String getBradenScale()
	{
		return (String)cx_BradenScale.getValue(context);
	}
		public void setBradenScale(String value)
		{
		cx_BradenScale.setValue(context, value);
		}

	private ims.framework.ContextVariable cx_BradenScale = new ims.framework.ContextVariable("BradenScale", "_cv_BradenScale");
